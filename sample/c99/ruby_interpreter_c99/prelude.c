...
prelude_eval(VALUE code, VALUE name, int line)
{
 ...
 rb_exc_raise(rb_errinfo());
    ...
    rb_iseq_eval(rb_iseq_new_with_opt(ast->root, name, name, ((VALUE)RUBY_Qnil), (((VALUE)(line))<<1 | RUBY_FIXNUM_FLAG),
          ((void*)0), ISEQ_TYPE_TOP, &optimization));
    rb_ast_dispose(ast);
}
...
Init_prelude(void)
{
    prelude_eval(rb_usascii_str_new_static(prelude_code0.L0, sizeof(prelude_code0)), rb_usascii_str_new_static(prelude_name0.L0, sizeof(prelude_name0)), 1);
    prelude_eval(rb_usascii_str_new_static(prelude_code1.L0, sizeof(prelude_code1)), rb_usascii_str_new_static(prelude_name1.L0, sizeof(prelude_name1)), 1);
