...
static size_t
shortlen(size_t len, unsigned int *ds)
{
    unsigned int num;
    int offset = 0;
...
rb_marshal_define_compat(VALUE newclass, VALUE oldclass, VALUE (*dumper)(VALUE), VALUE (*loader)(VALUE, VALUE))
{
    ...
    compat = ((marshal_compat_t*)ruby_xmalloc(sizeof(marshal_compat_t)));
    compat->newclass = ((VALUE)RUBY_Qnil);
    compat->oldclass = ((VALUE)RUBY_Qnil);
...
extern int (*__Static_assert_function (void)) [!!sizeof (struct { int __error_if_negative: (((VALUE)RUBY_FL_TAINT) == (int)((VALUE)RUBY_FL_TAINT)) ? 2 : -1; })];
     ...
     struct dump_arg *arg, const char *name)
{
    ...
    if (rb_class_of((VALUE)(ret)) == klass) {
        rb_raise(rb_eRuntimeError, "%li\v#%s returned same class instance",
   klass, name);
    }
...
{
    char *n = (!(((struct RBasic*)(path))->flags & RSTRING_NOEMBED) ? ((struct RString*)(path))->as.ary : ((struct RString*)(path))->as.heap.ptr);

    if (!rb_enc_asciicompat_inline(rb_enc_get(path))) {

 rb_raise(rb_eTypeError, "can't dump non-ascii %s name % li\v",
   type, path);
    }
    if (n[0] == '#') {
 rb_raise(rb_eTypeError, "can't dump anonymous %s % li\v",
   type, path);
    }
    return path;
}
...
w_nbyte(const char *s, long n, struct dump_arg *arg)
{
    VALUE buf = arg->str;
    rb_str_cat(buf, s, n);
    ((struct RBasic*)(buf))->flags |= arg->infection;
    if (arg->dest && (!(((struct RBasic*)(buf))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(buf))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(buf))->as.heap.len) >= 8192) {
...
load_mantissa(double d, const char *buf, long len)
{
 ...
 modf(ldexp(frexp(fabs(d), &e), (53-16)), &d);
 do {
     m = 0;
     switch (len) {
       default: m = *buf++ & 0xff;
     ...
     dig -= len < 32 / 8 ? 8 * (unsigned)len : 32;
...
{
    char buf[(15 +2) + ((53-16) + 7) / 8 + 10];

    if ((sizeof ((d)) == sizeof (float) ? __isinff (d) : sizeof ((d)) == sizeof (double) ? __isinf (d) : __isinfl (d))) {
 if (d < 0) w_bytes(("-inf"), strlen("-inf"), (arg));
 else w_bytes(("inf"), strlen("inf"), (arg));
    }
    else if ((sizeof ((d)) == sizeof (float) ? __isnanf (d) : sizeof ((d)) == sizeof (double) ? __isnan (d) : __isnanl (d))) {
 w_bytes(("nan"), strlen("nan"), (arg));
    }
    else if (d == 0.0) {
 if (1.0/d < 0) w_bytes(("-0"), strlen("-0"), (arg));
 else w_bytes(("0"), strlen("0"), (arg));
    }
    else {
 ...
 if (decpt < -3 || decpt > digs) {
     ...
     len += digs;
     len += ruby_snprintf(buf + len, sizeof(buf) - len, "e%d", decpt - 1);
 }
 else if (decpt > 0) {
...
w_symbol(VALUE sym, struct dump_arg *arg)
{
 ...
 sym = rb_sym2str(sym);
 if (!sym) {
     rb_raise(rb_eTypeError, "can't dump anonymous ID %ld", sym);
 }
 encname = encoding_name(sym, arg);
 if (!((VALUE)(encname) != ((VALUE)RUBY_Qnil)) ||
     rb_enc_str_coderange(sym) == RUBY_ENC_CODERANGE_7BIT) {
     encname = ((VALUE)RUBY_Qnil);
 }
 else {
     w_byte('I', arg);
 }
 w_byte(':', arg);
 w_bytes((!(((struct RBasic*)(sym))->flags & RSTRING_NOEMBED) ? ((struct RString*)(sym))->as.ary : ((struct RString*)(sym))->as.heap.ptr), (!(((struct RBasic*)(sym))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(sym))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(sym))->as.heap.len), arg);
...
{
    if (check && ((!(((VALUE)(klass) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(klass) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(klass))->flags & RUBY_T_MASK) != RUBY_T_NODE)?(((struct RBasic*)((klass)))->flags&((((VALUE)RUBY_FL_SINGLETON)))):0)) {
 VALUE origin = ((((struct RClass*)(klass))->ptr)->origin_);
 if ((rb_id_table_size((((struct RClass*)(klass))->m_tbl)) > 0 || (((((struct RClass*)(klass))->ptr)->iv_tbl) && ((((struct RClass*)(klass))->ptr)->iv_tbl)->num_entries > 1)) ||
     (origin != klass && (rb_id_table_size((((struct RClass*)(origin))->m_tbl)) > 0 || (((((struct RClass*)(origin))->ptr)->iv_tbl) && ((((struct RClass*)(origin))->ptr)->iv_tbl)->num_entries > 1)))) {
     rb_raise(rb_eTypeError, "singleton can't be dumped");
 }
 klass = RCLASS_SUPER(klass);
    }
    while ((int)(((struct RBasic*)(klass))->flags & RUBY_T_MASK) == RUBY_T_ICLASS) {
 VALUE path = rb_class_name(((struct RBasic*)(klass))->klass);
 w_byte('e', arg);
 w_unique(path, arg);
 klass = RCLASS_SUPER(klass);
    }
...
w_obj_each(st_data_t key, st_data_t val, st_data_t a)
{
    ...
    if ((id == rb_id_encoding() || id == (__builtin_constant_p("E") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("E")), (long)strlen(("E"))); (ID) rb_intern_id_cache; }) : rb_intern("E")) || !rb_id2str(id))) return ST_CONTINUE;
    w_symbol((rb_id2sym(id)), arg->arg);
    w_object(value, arg->arg, arg->limit);
    return ST_CONTINUE;
}
...
{
    ID id = (ID)key;
    if (!(id == rb_id_encoding() || id == (__builtin_constant_p("E") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("E")), (long)strlen(("E"))); (ID) rb_intern_id_cache; }) : rb_intern("E")) || !rb_id2str(id))) ++*(st_index_t *)a;
    return ST_CONTINUE;
}
...
encoding_name(VALUE obj, struct dump_arg *arg)
{
 ...
 return ((VALUE)RUBY_Qtrue);
    ...
    if (arg->encodings ?
 !st_lookup(arg->encodings, (st_data_t)(enc)->name, &name) :
 (arg->encodings = st_init_strcasetable(), 1)) {
 name = (st_data_t) ({ (__builtin_constant_p((enc)->name)) ? rb_str_new_static(((enc)->name), (long)strlen((enc)->name)) : rb_str_new_cstr((enc)->name); });
 st_insert(arg->encodings, (st_data_t)(enc)->name, name);
    }
    return (VALUE)name;
}
...
w_encoding(VALUE encname, struct dump_call_arg *arg)
{
 ...
 w_symbol((rb_id2sym((__builtin_constant_p("E") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("E")), (long)strlen(("E"))); (ID) rb_intern_id_cache; }) : rb_intern("E")))), arg->arg);
 w_object(encname, arg->arg, limit);
      case ((VALUE)RUBY_Qnil):
 return;
    }
    w_symbol((rb_id2sym(rb_id_encoding())), arg->arg);
    w_object(encname, arg->arg, limit);
}
...
{
    st_index_t enc = !!((VALUE)(encname) != ((VALUE)RUBY_Qnil));
    st_index_t num = 0;

    if ((((VALUE)(obj) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(obj) & (VALUE)~((VALUE)RUBY_Qnil)) == 0))) goto generic;
...
{
    struct dump_call_arg c_arg;
    VALUE ivobj = ((VALUE)RUBY_Qundef);
    st_data_t num;
    st_index_t hasiv = 0;
    VALUE encname = ((VALUE)RUBY_Qnil);
 ...
 if ((((long)obj)>>(int)(31)) == 0 || (((long)obj)>>(int)(31)) == -1) {
     w_byte('i', arg);
     w_long(((long)(((long)(obj))>>(int)(1))), arg);
 }
 else {
     w_object(rb_int2big(((long)(((long)(obj))>>(int)(1)))), arg, limit);
 }

    }
    else if (((((VALUE)(obj)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(obj) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(obj) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(obj))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL)))) {
 w_symbol(obj, arg);
    }
    else if (((((int)(long)(obj))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG)) {
 st_add_direct(arg->data, obj, arg->data->num_entries);
 w_byte('f', arg);
 w_float(rb_float_value_inline(obj), arg);
    }
    else {
 VALUE v;

 if (!(((struct RBasic*)(obj))->klass)) {
     rb_raise(rb_eTypeError, "can't dump internal %s",
       rb_builtin_type_name((int)(((struct RBasic*)(obj))->flags & RUBY_T_MASK)));
 }

 arg->infection |= (int)((!(((VALUE)(obj) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(obj) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(obj))->flags & RUBY_T_MASK) != RUBY_T_NODE)?(((struct RBasic*)((obj)))->flags&((((VALUE)RUBY_FL_TAINT)))):0);

 if (rb_obj_respond_to(obj, s_mdump, TRUE)) {
     st_add_direct(arg->data, obj, arg->data->num_entries);

     v = check_userdump_arg(obj, s_mdump, 0, 0, arg, "marshal_dump");
     w_class('U', obj, arg, FALSE);
     w_object(v, arg, limit);
     return;
 }
 if (rb_obj_respond_to(obj, s_dump, TRUE)) {
     VALUE ivobj2 = ((VALUE)RUBY_Qundef);
     st_index_t hasiv2;
     VALUE encname2;

     v = (((VALUE)((int)(limit)))<<1 | RUBY_FIXNUM_FLAG);
     v = check_userdump_arg(obj, s_dump, 1, &v, arg, "_dump");
     if (!( ((RUBY_T_STRING) == RUBY_T_FIXNUM) ? (((int)(long)(v))&RUBY_FIXNUM_FLAG) : ((RUBY_T_STRING) == RUBY_T_TRUE) ? ((v) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_STRING) == RUBY_T_FALSE) ? ((v) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_STRING) == RUBY_T_NIL) ? ((v) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_STRING) == RUBY_T_UNDEF) ? ((v) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_STRING) == RUBY_T_SYMBOL) ? ((((VALUE)(v)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(v) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(v) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(v))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_STRING) == RUBY_T_FLOAT) ? ( ((((int)(long)(v))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(v) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(v) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(v))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(v) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(v) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(v))->flags & RUBY_T_MASK) == (RUBY_T_STRING)))) {
  ...
  encname = encname2;
     ...
     if (hasiv) w_byte('I', arg);
     w_class('u', obj, arg, FALSE);
     w_bytes((!(((struct RBasic*)(v))->flags & RSTRING_NOEMBED) ? ((struct RString*)(v))->as.ary : ((struct RString*)(v))->as.heap.ptr), (!(((struct RBasic*)(v))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(v))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(v))->as.heap.len), arg);
     if (hasiv) {
 ...
 hasiv = has_ivars(obj, (encname = encoding_name(obj, arg)), &ivobj);
        {
            ...
            rb_alloc_func_t allocator = rb_get_alloc_func(((struct RBasic*)(obj))->klass);
  ...
  if (obj != real_obj && ivobj == ((VALUE)RUBY_Qundef)) hasiv = 0;
            }
        }
 if (hasiv) w_byte('I', arg);
 ...
 switch ((int)(((struct RBasic*)(obj))->flags & RUBY_T_MASK)) {
  ...
  w_bytes((!(((struct RBasic*)(path))->flags & RSTRING_NOEMBED) ? ((struct RString*)(path))->as.ary : ((struct RString*)(path))->as.heap.ptr), (!(((struct RBasic*)(path))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(path))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(path))->as.heap.len), arg);
  ...
  (* ({ volatile VALUE *rb_gc_guarded_ptr = &(path); ; rb_gc_guarded_ptr; }));
   ...
   case RUBY_T_BIGNUM:
     w_byte('l', arg);
     {
  char sign = ((((struct RBasic*)(obj))->flags & ((VALUE)((VALUE)RUBY_FL_USER1))) != 0) ? '+' : '-';
  size_t len = ((((struct RBasic*)(obj))->flags & ((VALUE)((VALUE)RUBY_FL_USER2))) ? (size_t)((((struct RBasic*)(obj))->flags >> (((VALUE)RUBY_FL_USHIFT)+3)) & (((VALUE)(((VALUE)RUBY_FL_USER5)|((VALUE)RUBY_FL_USER4)|((VALUE)RUBY_FL_USER3))) >> (((VALUE)RUBY_FL_USHIFT)+3))) : ((struct RBignum*)(obj))->as.heap.len);
  size_t slen;
  ...
  while (len--) {
   ...
   case RUBY_T_STRING:
     ...
     w_byte('"', arg);
     w_bytes((!(((struct RBasic*)(obj))->flags & RSTRING_NOEMBED) ? ((struct RString*)(obj))->as.ary : ((struct RString*)(obj))->as.heap.ptr), (!(((struct RBasic*)(obj))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(obj))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(obj))->as.heap.len), arg);
     break;
   ...
   case RUBY_T_REGEXP:
            ...
            w_byte('/', arg);
            {
                ...
                w_bytes((!(((struct RBasic*)(((struct RRegexp*)(obj))->src))->flags & RSTRING_NOEMBED) ? ((struct RString*)(((struct RRegexp*)(obj))->src))->as.ary : ((struct RString*)(((struct RRegexp*)(obj))->src))->as.heap.ptr), (!(((struct RBasic*)(((struct RRegexp*)(obj))->src))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(((struct RRegexp*)(obj))->src))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(((struct RRegexp*)(obj))->src))->as.heap.len), arg);
  ...
  for (i=0; i<rb_array_len(obj); i++) {
      w_object((rb_array_const_ptr(obj)[i]), arg, limit);
      if (len != rb_array_len(obj)) {
   ...
   case RUBY_T_HASH:
     ...
     if (!((VALUE)((((struct RHash*)(obj))->ifnone)) != ((VALUE)RUBY_Qnil))) {
  w_byte('{', arg);
     }
     else if (((!(((VALUE)(obj) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(obj) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(obj))->flags & RUBY_T_MASK) != RUBY_T_NODE)?(((struct RBasic*)((obj)))->flags&((((VALUE)RUBY_FL_USER2)))):0)) {
  rb_raise(rb_eTypeError, "can't dump hash with default proc");
     }
     else {
  w_byte('}', arg);
     }
     w_long((((struct RHash*)(obj))->ntbl ? ((struct RHash*)(obj))->ntbl->num_entries : (st_index_t)0), arg);
     rb_hash_foreach(obj, hash_each, (st_data_t)&c_arg);
     if (!!((VALUE)((((struct RHash*)(obj))->ifnone)) != ((VALUE)RUBY_Qnil))) {
  w_object((((struct RHash*)(obj))->ifnone), arg, limit);
     }
     break;

   case RUBY_T_STRUCT:
     w_class('S', obj, arg, TRUE);
     {
  ...
  for (i=0; i<len; i++) {
      w_symbol((rb_array_const_ptr(mem)[i]), arg);
      w_object((rb_struct_const_ptr(obj)[i]), arg, limit);
  }
     }
     break;

   case RUBY_T_OBJECT:
     w_class('o', obj, arg, TRUE);
     w_objivar(obj, &c_arg);
     break;
  ...
  if (!rb_obj_respond_to(obj, s_dump_data, TRUE)) {
      rb_raise(rb_eTypeError,
        "no _dump_data is defined for class %li\v",
        rb_obj_class(obj));
  }
  v = check_userdump_arg(obj, s_dump_data, 0, 0, arg, "_dump_data");
  w_class('d', obj, arg, TRUE);
  w_object(v, arg, limit);
     }
     break;

   default:
     rb_raise(rb_eTypeError, "can't dump %li\v",
       rb_obj_class(obj));
     break;
 }
 (* ({ volatile VALUE *rb_gc_guarded_ptr = &(obj); ; rb_gc_guarded_ptr; }));
    }
    if (hasiv) {
 w_ivar(hasiv, ivobj, encname, &c_arg);
    }
...
clear_dump_arg(struct dump_arg *arg)
{
 ...
 static inline void io_needed(void);
static inline void
io_needed(void)
{
...
marshal_dump(int argc, VALUE *argv)
{
    ...
    port = ((VALUE)RUBY_Qnil);
    rb_scan_args(argc, argv, "12", &obj, &a1, &a2);
    if (argc == 3) {
 if (!!((VALUE)(a2) != ((VALUE)RUBY_Qnil))) limit = rb_num2int_inline(a2);
 if (!((VALUE)(a1) != ((VALUE)RUBY_Qnil))) io_needed();
 port = a1;
    }
    else if (argc == 2) {
 if ((((int)(long)(a1))&RUBY_FIXNUM_FLAG)) limit = ((int)rb_fix2int((VALUE)(a1)));
 else if (!((VALUE)(a1) != ((VALUE)RUBY_Qnil))) io_needed();
 else port = a1;
    }
...
rb_marshal_dump_limited(VALUE obj, VALUE port, int limit)
{
    ...
    wrapper = ({ VALUE data_struct_obj = rb_data_typed_object_zalloc(0, sizeof(struct dump_arg), &dump_arg_data); (void)((arg) = (struct dump_arg *)(((struct RData*)(data_struct_obj))->data));; data_struct_obj; });
    arg->dest = 0;
 ...
 arg->dest = port;
 check_dump_arg(rb_check_funcall(port, s_binmode, 0, 0), arg, "binmode");
    }
    else {
 port = arg->str;
    }
 ...
 rb_str_resize(arg->str, 0);
    ...
    clear_dump_arg(arg);
    (* ({ volatile VALUE *rb_gc_guarded_ptr = &(wrapper); ; rb_gc_guarded_ptr; }));
...
r_prepare(struct load_arg *arg)
{
    ...
    st_insert(arg->data, (st_data_t)idx, (st_data_t)((VALUE)RUBY_Qundef));
    return idx;
}
...
{
    if (arg->buflen == 0) {
 long readable = arg->readable < 8192 ? arg->readable : 8192;
 VALUE str, n = rb_long2num_inline(readable);

 str = check_load_arg(rb_funcallv(arg->src, s_read, 1, &n), arg, "read");
 if (!((VALUE)(str) != ((VALUE)RUBY_Qnil))) too_short();
 rb_string_value(&(str));
 arg->infection |= (int)((!(((VALUE)(str) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(str) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(str))->flags & RUBY_T_MASK) != RUBY_T_NODE)?(((struct RBasic*)((str)))->flags&((((VALUE)RUBY_FL_TAINT)))):0);
 memcpy(arg->buf, (!(((struct RBasic*)(str))->flags & RSTRING_NOEMBED) ? ((struct RString*)(str))->as.ary : ((struct RString*)(str))->as.heap.ptr), (!(((struct RBasic*)(str))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(str))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(str))->as.heap.len));
 arg->offset = 0;
 arg->buflen = (!(((struct RBasic*)(str))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(str))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(str))->as.heap.len);
    }
    arg->buflen--;
...
r_byte(struct load_arg *arg)
{
    ...
    if (( ((RUBY_T_STRING) == RUBY_T_FIXNUM) ? (((int)(long)(arg->src))&RUBY_FIXNUM_FLAG) : ((RUBY_T_STRING) == RUBY_T_TRUE) ? ((arg->src) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_STRING) == RUBY_T_FALSE) ? ((arg->src) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_STRING) == RUBY_T_NIL) ? ((arg->src) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_STRING) == RUBY_T_UNDEF) ? ((arg->src) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_STRING) == RUBY_T_SYMBOL) ? ((((VALUE)(arg->src)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(arg->src) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(arg->src) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(arg->src))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_STRING) == RUBY_T_FLOAT) ? ( ((((int)(long)(arg->src))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(arg->src) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(arg->src) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(arg->src))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(arg->src) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(arg->src) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(arg->src))->flags & RUBY_T_MASK) == (RUBY_T_STRING)))) {
 if ((!(((struct RBasic*)(arg->src))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(arg->src))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(arg->src))->as.heap.len) > arg->offset) {
     c = (unsigned char)(!(((struct RBasic*)(arg->src))->flags & RSTRING_NOEMBED) ? ((struct RString*)(arg->src))->as.ary : ((struct RString*)(arg->src))->as.heap.ptr)[arg->offset++];
 }
 else {
     too_short();
 }
 ...
 if (arg->readable >0 || arg->buflen > 0) {
     ...
     VALUE v = check_load_arg(rb_funcallv(arg->src, s_getbyte, 0, 0), arg, "getbyte");
     if (!((VALUE)(v) != ((VALUE)RUBY_Qnil))) rb_eof_error();
     c = (unsigned char)rb_num2char_inline(v);
 }
    }
    return c;
}
...
{
    rb_raise(rb_eTypeError, "long too big for this architecture (size 8, given %d)", size);
}
...
{
    VALUE str, n = rb_long2num_inline(len);

    str = check_load_arg(rb_funcallv(arg->src, s_read, 1, &n), arg, "read");
    if (!((VALUE)(str) != ((VALUE)RUBY_Qnil))) too_short();
    rb_string_value(&(str));
    if ((!(((struct RBasic*)(str))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(str))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(str))->as.heap.len) != len) too_short();
    arg->infection |= (int)((!(((VALUE)(str) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(str) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(str))->flags & RUBY_T_MASK) != RUBY_T_NODE)?(((struct RBasic*)((str)))->flags&((((VALUE)RUBY_FL_TAINT)))):0);
...
r_bytes1_buffered(long len, struct load_arg *arg)
{
    ...
    if (len <= arg->buflen) {
 str =  ({ (__builtin_constant_p(arg->buf+arg->offset) && __builtin_constant_p(len)) ? rb_str_new_static((arg->buf+arg->offset), (len)) : rb_str_new((arg->buf+arg->offset), (len)); });
 arg->offset += len;
 arg->buflen -= len;
    }
    else {
 ...
 readable = readable < 8192 ? readable : 8192;
 read_len = need_len > readable ? need_len : readable;
 n = rb_long2num_inline(read_len);
 tmp = check_load_arg(rb_funcallv(arg->src, s_read, 1, &n), arg, "read");
 if (!((VALUE)(tmp) != ((VALUE)RUBY_Qnil))) too_short();
 rb_string_value(&(tmp));

 tmp_len = (!(((struct RBasic*)(tmp))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(tmp))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(tmp))->as.heap.len);

 if (tmp_len < need_len) too_short();
 arg->infection |= (int)((!(((VALUE)(tmp) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(tmp) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(tmp))->flags & RUBY_T_MASK) != RUBY_T_NODE)?(((struct RBasic*)((tmp)))->flags&((((VALUE)RUBY_FL_TAINT)))):0);

 str =  ({ (__builtin_constant_p(arg->buf+arg->offset) && __builtin_constant_p(buflen)) ? rb_str_new_static((arg->buf+arg->offset), (buflen)) : rb_str_new((arg->buf+arg->offset), (buflen)); });
 rb_str_cat(str, (!(((struct RBasic*)(tmp))->flags & RSTRING_NOEMBED) ? ((struct RString*)(tmp))->as.ary : ((struct RString*)(tmp))->as.heap.ptr), need_len);

 if (tmp_len > need_len) {
     buflen = tmp_len - need_len;
     memcpy(arg->buf, (!(((struct RBasic*)(tmp))->flags & RSTRING_NOEMBED) ? ((struct RString*)(tmp))->as.ary : ((struct RString*)(tmp))->as.heap.ptr)+need_len, buflen);
     arg->buflen = buflen;
 }
 else {
     arg->buflen = 0;
...
r_bytes0(long len, struct load_arg *arg)
{
    ...
    if (( ((RUBY_T_STRING) == RUBY_T_FIXNUM) ? (((int)(long)(arg->src))&RUBY_FIXNUM_FLAG) : ((RUBY_T_STRING) == RUBY_T_TRUE) ? ((arg->src) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_STRING) == RUBY_T_FALSE) ? ((arg->src) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_STRING) == RUBY_T_NIL) ? ((arg->src) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_STRING) == RUBY_T_UNDEF) ? ((arg->src) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_STRING) == RUBY_T_SYMBOL) ? ((((VALUE)(arg->src)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(arg->src) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(arg->src) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(arg->src))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_STRING) == RUBY_T_FLOAT) ? ( ((((int)(long)(arg->src))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(arg->src) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(arg->src) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(arg->src))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(arg->src) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(arg->src) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(arg->src))->flags & RUBY_T_MASK) == (RUBY_T_STRING)))) {
 if ((!(((struct RBasic*)(arg->src))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(arg->src))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(arg->src))->as.heap.len) - arg->offset >= len) {
     str =  ({ (__builtin_constant_p((!(((struct RBasic*)(arg->src))->flags & RSTRING_NOEMBED) ? ((struct RString*)(arg->src))->as.ary : ((struct RString*)(arg->src))->as.heap.ptr)+arg->offset) && __builtin_constant_p(len)) ? rb_str_new_static(((!(((struct RBasic*)(arg->src))->flags & RSTRING_NOEMBED) ? ((struct RString*)(arg->src))->as.ary : ((struct RString*)(arg->src))->as.heap.ptr)+arg->offset), (len)) : rb_str_new(((!(((struct RBasic*)(arg->src))->flags & RSTRING_NOEMBED) ? ((struct RString*)(arg->src))->as.ary : ((struct RString*)(arg->src))->as.heap.ptr)+arg->offset), (len)); });
     arg->offset += len;
 }
 else {
     too_short();
...
sym2encidx(VALUE sym, VALUE val)
{
    ...
    const char *p;
    long l;
    if (rb_enc_get_index(sym) != RUBY_ENCINDEX_US_ASCII) return -1;
    (!(((struct RBasic*)(sym))->flags & RSTRING_NOEMBED) ? ((p) = ((struct RString*)(sym))->as.ary, (l) = (long)((((struct RBasic*)(sym))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT))) : ((p) = ((struct RString*)(sym))->as.heap.ptr, (l) = ((struct RString*)(sym))->as.heap.len));
    if (l <= 0) return -1;
    if (l == sizeof(name_encoding) &&
 memcmp(p, name_encoding, sizeof(name_encoding)) == 0) {
 int idx = rb_enc_find_index(rb_string_value_cstr(&(val)));
 return idx;
    }
    else if (l == 1 && *p == 'E') {
 if (val == ((VALUE)RUBY_Qfalse)) return RUBY_ENCINDEX_US_ASCII;
 else if (val == ((VALUE)RUBY_Qtrue)) return RUBY_ENCINDEX_UTF_8;
...
{
    VALUE s = r_bytes0(r_long(arg), (arg));
    VALUE sym;
    int idx = -1;
    st_index_t n = arg->symbols->num_entries;

    if (rb_enc_str_asciionly_p(s)) rb_enc_associate_index(s, RUBY_ENCINDEX_US_ASCII);
...
{
    return r_bytes0(r_long(arg), (arg));
}

static VALUE
r_entry0(VALUE v, st_index_t num, struct load_arg *arg)
{
    st_data_t real_obj = (VALUE)((VALUE)RUBY_Qundef);
    ...
    if (arg->infection &&
 !( ((RUBY_T_CLASS) == RUBY_T_FIXNUM) ? (((int)(long)(v))&RUBY_FIXNUM_FLAG) : ((RUBY_T_CLASS) == RUBY_T_TRUE) ? ((v) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_CLASS) == RUBY_T_FALSE) ? ((v) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_CLASS) == RUBY_T_NIL) ? ((v) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_CLASS) == RUBY_T_UNDEF) ? ((v) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_CLASS) == RUBY_T_SYMBOL) ? ((((VALUE)(v)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(v) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(v) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(v))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_CLASS) == RUBY_T_FLOAT) ? ( ((((int)(long)(v))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(v) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(v) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(v))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(v) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(v) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(v))->flags & RUBY_T_MASK) == (RUBY_T_CLASS))) && !( ((RUBY_T_MODULE) == RUBY_T_FIXNUM) ? (((int)(long)(v))&RUBY_FIXNUM_FLAG) : ((RUBY_T_MODULE) == RUBY_T_TRUE) ? ((v) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_MODULE) == RUBY_T_FALSE) ? ((v) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_MODULE) == RUBY_T_NIL) ? ((v) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_MODULE) == RUBY_T_UNDEF) ? ((v) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_MODULE) == RUBY_T_SYMBOL) ? ((((VALUE)(v)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(v) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(v) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(v))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_MODULE) == RUBY_T_FLOAT) ? ( ((((int)(long)(v))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(v) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(v) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(v))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(v) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(v) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(v))->flags & RUBY_T_MASK) == (RUBY_T_MODULE)))) {
 (((!(((VALUE)(v) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(v) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(v))->flags & RUBY_T_MASK) != RUBY_T_NODE) && (int)(((struct RBasic*)(v))->flags & RUBY_T_MASK) != RUBY_T_BIGNUM && (int)(((struct RBasic*)(v))->flags & RUBY_T_MASK) != RUBY_T_FLOAT) ? (void)(((struct RBasic*)(v))->flags |= (RUBY_FL_TAINT)) : (void)0);
 if ((VALUE)real_obj != ((VALUE)RUBY_Qundef))
     (((!(((VALUE)((VALUE)real_obj) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)((VALUE)real_obj) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)((VALUE)real_obj))->flags & RUBY_T_MASK) != RUBY_T_NODE) && (int)(((struct RBasic*)((VALUE)real_obj))->flags & RUBY_T_MASK) != RUBY_T_BIGNUM && (int)(((struct RBasic*)((VALUE)real_obj))->flags & RUBY_T_MASK) != RUBY_T_FLOAT) ? (void)(((struct RBasic*)((VALUE)real_obj))->flags |= (RUBY_FL_TAINT)) : (void)0);
    }
    return v;
}
...
r_fixup_compat(VALUE v, struct load_arg *arg)
{
    ...
    if (arg->compat_tbl && st_delete(arg->compat_tbl, &key, &data)) {
        ...
        rb_alloc_func_t allocator = rb_get_alloc_func(rb_class_of((VALUE)(real_obj)));
...
{
    if (arg->proc) {
 v = check_load_arg(rb_funcallv(arg->proc, s_call, 1, &v), arg, "call");
    }
    return v;
}
...
path2class(VALUE path)
{
    ...
    if (!( ((RUBY_T_CLASS) == RUBY_T_FIXNUM) ? (((int)(long)(v))&RUBY_FIXNUM_FLAG) : ((RUBY_T_CLASS) == RUBY_T_TRUE) ? ((v) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_CLASS) == RUBY_T_FALSE) ? ((v) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_CLASS) == RUBY_T_NIL) ? ((v) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_CLASS) == RUBY_T_UNDEF) ? ((v) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_CLASS) == RUBY_T_SYMBOL) ? ((((VALUE)(v)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(v) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(v) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(v))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_CLASS) == RUBY_T_FLOAT) ? ( ((((int)(long)(v))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(v) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(v) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(v))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(v) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(v) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(v))->flags & RUBY_T_MASK) == (RUBY_T_CLASS)))) {
 rb_raise(rb_eArgError, "%li\v does not refer to class", path);
    }
    return v;
}
...
{
    if (!( ((RUBY_T_MODULE) == RUBY_T_FIXNUM) ? (((int)(long)(v))&RUBY_FIXNUM_FLAG) : ((RUBY_T_MODULE) == RUBY_T_TRUE) ? ((v) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_MODULE) == RUBY_T_FALSE) ? ((v) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_MODULE) == RUBY_T_NIL) ? ((v) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_MODULE) == RUBY_T_UNDEF) ? ((v) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_MODULE) == RUBY_T_SYMBOL) ? ((((VALUE)(v)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(v) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(v) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(v))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_MODULE) == RUBY_T_FLOAT) ? ( ((((int)(long)(v))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(v) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(v) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(v))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(v) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(v) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(v))->flags & RUBY_T_MASK) == (RUBY_T_MODULE)))) {
 rb_raise(rb_eArgError, "%li\v does not refer to module", path);
    }
    return v;
}
...
{
    long i = rb_array_len(extmod);
    while (i > 0) {
 VALUE m = (rb_array_const_ptr(extmod)[--i]);
...
r_object0(struct load_arg *arg, int *ivp, VALUE extmod)
{
      ...
      case 'e':
 {
     ...
     if (!((VALUE)(extmod) != ((VALUE)RUBY_Qnil))) extmod = rb_ary_tmp_new(0);

     if (( ((RUBY_T_CLASS) == RUBY_T_FIXNUM) ? (((int)(long)(m))&RUBY_FIXNUM_FLAG) : ((RUBY_T_CLASS) == RUBY_T_TRUE) ? ((m) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_CLASS) == RUBY_T_FALSE) ? ((m) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_CLASS) == RUBY_T_NIL) ? ((m) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_CLASS) == RUBY_T_UNDEF) ? ((m) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_CLASS) == RUBY_T_SYMBOL) ? ((((VALUE)(m)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(m) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(m) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(m))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_CLASS) == RUBY_T_FLOAT) ? ( ((((int)(long)(m))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(m) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(m) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(m))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(m) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(m) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(m))->flags & RUBY_T_MASK) == (RUBY_T_CLASS)))) {
  VALUE c;

  v = r_object0(arg, 0, ((VALUE)RUBY_Qnil));
  c = rb_class_of((VALUE)(v));
  if (c != m || ((!(((VALUE)(c) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(c) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(c))->flags & RUBY_T_MASK) != RUBY_T_NODE)?(((struct RBasic*)((c)))->flags&((((VALUE)RUBY_FL_SINGLETON)))):0)) {
      rb_raise(rb_eArgError,
        "prepended class %li\v differs from class %li\v",
        path, rb_class_name(c));
  }
  c = rb_singleton_class(v);
  while (rb_array_len(extmod) > 0) {
      m = rb_ary_pop(extmod);
      ...
      case 'C':
 {
     ...
     if (((!(((VALUE)(c) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(c) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(c))->flags & RUBY_T_MASK) != RUBY_T_NODE)?(((struct RBasic*)((c)))->flags&((((VALUE)RUBY_FL_SINGLETON)))):0)) {
  rb_raise(rb_eTypeError, "singleton can't be loaded");
     }
     v = r_object0(arg, 0, extmod);
     if ( ({ VALUE special_const_obj = (v); (int)((((VALUE)(special_const_obj) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(special_const_obj) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) ? ((VALUE)RUBY_Qtrue) : ((VALUE)RUBY_Qfalse)); }) || ( ((RUBY_T_OBJECT) == RUBY_T_FIXNUM) ? (((int)(long)(v))&RUBY_FIXNUM_FLAG) : ((RUBY_T_OBJECT) == RUBY_T_TRUE) ? ((v) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_OBJECT) == RUBY_T_FALSE) ? ((v) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_OBJECT) == RUBY_T_NIL) ? ((v) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_OBJECT) == RUBY_T_UNDEF) ? ((v) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_OBJECT) == RUBY_T_SYMBOL) ? ((((VALUE)(v)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(v) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(v) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(v))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_OBJECT) == RUBY_T_FLOAT) ? ( ((((int)(long)(v))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(v) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(v) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(v))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(v) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(v) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(v))->flags & RUBY_T_MASK) == (RUBY_T_OBJECT))) || ( ((RUBY_T_CLASS) == RUBY_T_FIXNUM) ? (((int)(long)(v))&RUBY_FIXNUM_FLAG) : ((RUBY_T_CLASS) == RUBY_T_TRUE) ? ((v) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_CLASS) == RUBY_T_FALSE) ? ((v) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_CLASS) == RUBY_T_NIL) ? ((v) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_CLASS) == RUBY_T_UNDEF) ? ((v) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_CLASS) == RUBY_T_SYMBOL) ? ((((VALUE)(v)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(v) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(v) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(v))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_CLASS) == RUBY_T_FLOAT) ? ( ((((int)(long)(v))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(v) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(v) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(v))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(v) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(v) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(v))->flags & RUBY_T_MASK) == (RUBY_T_CLASS)))) {
       format_error:
  rb_raise(rb_eArgError, "dump format error (user class)");
     }
     if (( ((RUBY_T_MODULE) == RUBY_T_FIXNUM) ? (((int)(long)(v))&RUBY_FIXNUM_FLAG) : ((RUBY_T_MODULE) == RUBY_T_TRUE) ? ((v) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_MODULE) == RUBY_T_FALSE) ? ((v) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_MODULE) == RUBY_T_NIL) ? ((v) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_MODULE) == RUBY_T_UNDEF) ? ((v) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_MODULE) == RUBY_T_SYMBOL) ? ((((VALUE)(v)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(v) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(v) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(v))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_MODULE) == RUBY_T_FLOAT) ? ( ((((int)(long)(v))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(v) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(v) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(v))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(v) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(v) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(v))->flags & RUBY_T_MASK) == (RUBY_T_MODULE))) || !!(((VALUE)(rb_class_inherited_p(c, ((struct RBasic*)(v))->klass)) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) {
  VALUE tmp = rb_obj_alloc(c);

  if (rb_type((VALUE)(v)) != rb_type((VALUE)(tmp))) goto format_error;
     }
     do { VALUE _obj_ = (v); rb_obj_write((VALUE)(_obj_), (VALUE *)(&((struct RBasicRaw *)(_obj_))->klass), (VALUE)(c), "marshal.c", 1644); } while (0);
 }
 break;
 ...
 {
     double d;
     VALUE str = r_bytes0(r_long(arg), (arg));
  ...
  char *e;
  d = ruby_strtod((ptr),(&e));
  d = load_mantissa(d, e, (!(((struct RBasic*)(str))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(str))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(str))->as.heap.len) - (e - ptr));
     }
     v = rb_float_new_inline(d);
     v = r_entry0((v), (arg)->data->num_entries, (arg));
            v = r_leave(v, arg);
 }
 break;
      ...
      case 'l':
 {
     ...
     data = r_bytes0(len * 2, arg);
            v = rb_integer_unpack((!(((struct RBasic*)(data))->flags & RSTRING_NOEMBED) ? ((struct RString*)(data))->as.ary : ((struct RString*)(data))->as.heap.ptr), len, 2, 0,
                (0x02 | 0x20) | (sign == '-' ? 0x200 : 0));
 ...
 break;
      ...
      case '"':
 v = r_entry0((r_string(arg)), (arg)->data->num_entries, (arg));
        v = r_leave(v, arg);
 break;
  ...
  *ivp = FALSE;
  ...
  char *ptr = (!(((struct RBasic*)(str))->flags & RSTRING_NOEMBED) ? ((struct RString*)(str))->as.ary : ((struct RString*)(str))->as.heap.ptr), *dst = ptr, *src = ptr;
      ...
      case '}':
 {
  ...
  arg->readable -= 2;
     ...
     arg->readable += 2;
     if (type == '}') {
  rb_hash_set_ifnone((VALUE)v, r_object(arg));
     }
            v = r_leave(v, arg);
 }
 break;
      ...
      case 'S':
 {
     ...
     if (!( ((RUBY_T_STRUCT) == RUBY_T_FIXNUM) ? (((int)(long)(v))&RUBY_FIXNUM_FLAG) : ((RUBY_T_STRUCT) == RUBY_T_TRUE) ? ((v) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_STRUCT) == RUBY_T_FALSE) ? ((v) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_STRUCT) == RUBY_T_NIL) ? ((v) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_STRUCT) == RUBY_T_UNDEF) ? ((v) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_STRUCT) == RUBY_T_SYMBOL) ? ((((VALUE)(v)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(v) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(v) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(v))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_STRUCT) == RUBY_T_FLOAT) ? ( ((((int)(long)(v))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(v) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(v) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(v))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(v) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(v) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(v))->flags & RUBY_T_MASK) == (RUBY_T_STRUCT)))) {
  rb_raise(rb_eTypeError, "class %li\v not a struct", rb_class_name(klass));
     }
     mem = rb_struct_s_members(klass);
            if (rb_array_len(mem) != len) {
                rb_raise(rb_eTypeError, "struct %li\v not compatible (struct size differs)",
                         rb_class_name(klass));
            }
     ...
     {
  VALUE keywords;
  int keyword_init = !(((VALUE)(rb_struct_s_keyword_init(klass)) & (VALUE)~((VALUE)RUBY_Qnil)) == 0);
  if (keyword_init) {
  ...
  for (i=0; i<len; i++) {
      VALUE n = rb_sym2str((rb_array_const_ptr(mem)[i]));
      slot = r_symbol(arg);

      if (!rb_str_equal(n, slot)) {
   rb_raise(rb_eTypeError, "struct %li\v not compatible (:%li\v for :%li\v)",
     rb_class_name(klass),
     slot, n);
      }
      if (keyword_init) {
   rb_hash_aset(keywords, (rb_array_const_ptr(mem)[i]), r_object(arg));
      }
      else {
 ...
 break;
  ...
  rb_raise(rb_eTypeError, "class %li\v needs to have method `_load'",
    name);
     }
     data = r_string(arg);
     if (ivp) {
  r_ivar(data, ((void*)0), arg);
  *ivp = FALSE;
     }
     v = check_load_arg(rb_funcallv(klass, s_load, 1, &data), arg, "_load");
     v = r_entry0((v), (arg)->data->num_entries, (arg));
  ...
  v = compat->loader(klass, v);
     ...
     v = obj_alloc_by_klass(klass, arg, &oldclass);
            if (!!((VALUE)(extmod) != ((VALUE)RUBY_Qnil))) {

  append_extmod(v, extmod);
            }
     if (!rb_obj_respond_to(v, s_mload, TRUE)) {
  rb_raise(rb_eTypeError, "instance of %li\v needs to have method `marshal_load'",
    name);
     }
     v = r_entry0((v), (arg)->data->num_entries, (arg));
     data = r_object(arg);
     check_load_arg(rb_funcallv(v, s_mload, 1, &data), arg, "marshal_load");
     v = r_fixup_compat(v, arg);
      ...
      case 'o':
 {
     ...
     if (!( ((RUBY_T_OBJECT) == RUBY_T_FIXNUM) ? (((int)(long)(v))&RUBY_FIXNUM_FLAG) : ((RUBY_T_OBJECT) == RUBY_T_TRUE) ? ((v) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_OBJECT) == RUBY_T_FALSE) ? ((v) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_OBJECT) == RUBY_T_NIL) ? ((v) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_OBJECT) == RUBY_T_UNDEF) ? ((v) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_OBJECT) == RUBY_T_SYMBOL) ? ((((VALUE)(v)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(v) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(v) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(v))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_OBJECT) == RUBY_T_FLOAT) ? ( ((((int)(long)(v))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(v) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(v) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(v))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(v) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(v) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(v))->flags & RUBY_T_MASK) == (RUBY_T_OBJECT)))) {
      ...
      case 'd':
 {
     ...
     v = obj_alloc_by_klass(klass, arg, &oldclass);
     if (!( ((RUBY_T_DATA) == RUBY_T_FIXNUM) ? (((int)(long)(v))&RUBY_FIXNUM_FLAG) : ((RUBY_T_DATA) == RUBY_T_TRUE) ? ((v) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_DATA) == RUBY_T_FALSE) ? ((v) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_DATA) == RUBY_T_NIL) ? ((v) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_DATA) == RUBY_T_UNDEF) ? ((v) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_DATA) == RUBY_T_SYMBOL) ? ((((VALUE)(v)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(v) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(v) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(v))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_DATA) == RUBY_T_FLOAT) ? ( ((((int)(long)(v))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(v) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(v) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(v))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(v) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(v) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(v))->flags & RUBY_T_MASK) == (RUBY_T_DATA)))) {
  rb_raise(rb_eArgError, "dump format error");
     }
     v = r_entry0((v), (arg)->data->num_entries, (arg));
     if (!rb_obj_respond_to(v, s_load_data, TRUE)) {
  rb_raise(rb_eTypeError,
    "class %li\v needs to have instance method `_load_data'",
    name);
     }
     r = r_object0(arg, 0, extmod);
     check_load_arg(rb_funcallv(v, s_load_data, 1, &r), arg, "_load_data");
     v = r_leave(v, arg);
 }
 break;
     ...
     do { if (!ivp || !*ivp) break; rb_raise(rb_eTypeError, "can't override instance variable of class/module `%li\v'", (str)); } while (0);
     v = r_entry0((v), (arg)->data->num_entries, (arg));
            v = r_leave(v, arg);
 }
 break;
     ...
     v = path2class(str);
     do { if (!ivp || !*ivp) break; rb_raise(rb_eTypeError, "can't override instance variable of class `%li\v'", (str)); } while (0);
     v = r_entry0((v), (arg)->data->num_entries, (arg));
            v = r_leave(v, arg);
 }
 break;
     ...
     v = must_be_module(rb_path_to_class(str), str);
     do { if (!ivp || !*ivp) break; rb_raise(rb_eTypeError, "can't override instance variable of module `%li\v'", (str)); } while (0);
     v = r_entry0((v), (arg)->data->num_entries, (arg));
            v = r_leave(v, arg);
 }
 break;
...
{
    return r_object0(arg, 0, ((VALUE)RUBY_Qnil));
}
...
marshal_load(int argc, VALUE *argv)
{
    ...
    port = argv[0];
    proc = argc > 1 ? argv[1] : ((VALUE)RUBY_Qnil);
...
rb_marshal_load_with_proc(VALUE port, VALUE proc)
{
 ...
 infection = (int)((!(((VALUE)(port) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(port) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(port))->flags & RUBY_T_MASK) != RUBY_T_NODE)?(((struct RBasic*)((port)))->flags&((((VALUE)RUBY_FL_TAINT)))):0);
 port = v;
    }
    else if (rb_respond_to(port, s_getbyte) && rb_respond_to(port, s_read)) {
 rb_check_funcall(port, s_binmode, 0, 0);
 infection = (int)((VALUE)RUBY_FL_TAINT);
    }
    else {
 io_needed();
    }
    wrapper = ({ VALUE data_struct_obj = rb_data_typed_object_zalloc(0, sizeof(struct load_arg), &load_arg_data); (void)((arg) = (struct load_arg *)(((struct RData*)(data_struct_obj))->data));; data_struct_obj; });
 ...
 rb_raise(rb_eTypeError, "incompatible marshal file format (can't be read)\n\tformat version %d.%d required; %d.%d given",
   ...
   4, 8, major, minor);
    ...
    if (!(((VALUE)((*rb_ruby_verbose_ptr())) & (VALUE)~((VALUE)RUBY_Qnil)) == 0) && minor != 8) {
 rb_warn("incompatible marshal file format (can be read)\n\tformat version %d.%d required; %d.%d given",

  4, 8, major, minor);
    }

    if (!!((VALUE)(proc) != ((VALUE)RUBY_Qnil))) arg->proc = proc;
    v = r_object(arg);
    clear_load_arg(arg);
    (* ({ volatile VALUE *rb_gc_guarded_ptr = &(wrapper); ; rb_gc_guarded_ptr; }));
...
Init_marshal(void)
{
    ...
    s_dump = (__builtin_constant_p("_dump") ?  (rb_intern2(("_dump"), (long)strlen("_dump"))) : (rb_intern)("_dump"));
    s_load = (__builtin_constant_p("_load") ?  (rb_intern2(("_load"), (long)strlen("_load"))) : (rb_intern)("_load"));
    s_mdump = (__builtin_constant_p("marshal_dump") ?  (rb_intern2(("marshal_dump"), (long)strlen("marshal_dump"))) : (rb_intern)("marshal_dump"));
    s_mload = (__builtin_constant_p("marshal_load") ?  (rb_intern2(("marshal_load"), (long)strlen("marshal_load"))) : (rb_intern)("marshal_load"));
    s_dump_data = (__builtin_constant_p("_dump_data") ?  (rb_intern2(("_dump_data"), (long)strlen("_dump_data"))) : (rb_intern)("_dump_data"));
    s_load_data = (__builtin_constant_p("_load_data") ?  (rb_intern2(("_load_data"), (long)strlen("_load_data"))) : (rb_intern)("_load_data"));
    s_alloc = (__builtin_constant_p("_alloc") ?  (rb_intern2(("_alloc"), (long)strlen("_alloc"))) : (rb_intern)("_alloc"));
    s_call = (__builtin_constant_p("call") ?  (rb_intern2(("call"), (long)strlen("call"))) : (rb_intern)("call"));
    s_getbyte = (__builtin_constant_p("getbyte") ?  (rb_intern2(("getbyte"), (long)strlen("getbyte"))) : (rb_intern)("getbyte"));
    s_read = (__builtin_constant_p("read") ?  (rb_intern2(("read"), (long)strlen("read"))) : (rb_intern)("read"));
    s_write = (__builtin_constant_p("write") ?  (rb_intern2(("write"), (long)strlen("write"))) : (rb_intern)("write"));
    s_binmode = (__builtin_constant_p("binmode") ?  (rb_intern2(("binmode"), (long)strlen("binmode"))) : (rb_intern)("binmode"));
    ...
    rb_define_const(rb_mMarshal, "MAJOR_VERSION", (((VALUE)(4))<<1 | RUBY_FIXNUM_FLAG));

    rb_define_const(rb_mMarshal, "MINOR_VERSION", (((VALUE)(8))<<1 | RUBY_FIXNUM_FLAG));
}
...
compat_allocator_table(void)
{
 ...
 rb_data_object_wrap((0),(compat_allocator_tbl),(RUBY_DATA_FUNC)(mark_marshal_compat_t),(RUBY_DATA_FUNC)(0));
...
{
    return rb_marshal_load_with_proc(port, ((VALUE)RUBY_Qnil));
}
