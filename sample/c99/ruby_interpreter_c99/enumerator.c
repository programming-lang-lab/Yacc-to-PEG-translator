...
enumerator_ptr(VALUE obj)
{
    ...
    ((ptr) = (struct enumerator*)rb_check_typeddata((obj), (&enumerator_data_type)));
    if (!ptr || ptr->obj == ((VALUE)RUBY_Qundef)) {
...
proc_entry_ptr(VALUE proc_entry)
{
    ...
    ((ptr) = (struct proc_entry*)rb_check_typeddata((proc_entry), (&proc_entry_data_type)));
...
obj_to_enum(int argc, VALUE *argv, VALUE obj)
{
 ...
 meth = *argv++;
    ...
    enumerator = rb_enumeratorize_with_size(obj, meth, argc, argv, (rb_enumerator_size_func *)(0));
    if (rb_block_given_p()) {
...
enumerator_allocate(VALUE klass)
{
    ...
    enum_obj = ({ VALUE data_struct_obj = rb_data_typed_object_zalloc(klass, sizeof(struct enumerator), &enumerator_data_type); (void)((ptr) = (struct enumerator *)(((struct RData*)(data_struct_obj))->data));; data_struct_obj; });
    ptr->obj = ((VALUE)RUBY_Qundef);
...
enumerator_init(VALUE enum_obj, VALUE obj, VALUE meth, int argc, const VALUE *argv, rb_enumerator_size_func *size_fn, VALUE size)
{
    ...
    ({do { VALUE frozen_obj = (enum_obj); if ((!(!(((VALUE)(frozen_obj) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(frozen_obj) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(frozen_obj))->flags & RUBY_T_MASK) != RUBY_T_NODE) || (((struct RBasic*)(frozen_obj))->flags&RUBY_FL_FREEZE))) { rb_error_frozen_object(frozen_obj); } } while (0);});
    ((ptr) = (struct enumerator*)rb_check_typeddata((enum_obj), (&enumerator_data_type)));
 ...
 rb_raise(rb_eArgError, "unallocated enumerator");
    ...
    if (argc) ptr->args = rb_ary_new_from_values(argc, argv);
    ptr->fib = 0;
    ptr->dst = ((VALUE)RUBY_Qnil);
    ptr->lookahead = ((VALUE)RUBY_Qundef);
    ptr->feedvalue = ((VALUE)RUBY_Qundef);
    ptr->stop_exc = ((VALUE)RUBY_Qfalse);
    ptr->size = size;
    ptr->size_fn = size_fn;
...
enumerator_initialize(int argc, VALUE *argv, VALUE obj)
{
    ...
    VALUE size = ((VALUE)RUBY_Qnil);

    if (rb_block_given_p()) {
 rb_check_arity(argc, 0, 1);
 recv = generator_init(generator_allocate(rb_cGenerator), rb_block_proc());
 if (argc) {
            if (!((VALUE)(argv[0]) != ((VALUE)RUBY_Qnil)) || rb_respond_to(argv[0], id_call) ||
                (( ((RUBY_T_FLOAT) == RUBY_T_FIXNUM) ? (((int)(long)(argv[0]))&RUBY_FIXNUM_FLAG) : ((RUBY_T_FLOAT) == RUBY_T_TRUE) ? ((argv[0]) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_FLOAT) == RUBY_T_FALSE) ? ((argv[0]) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_FLOAT) == RUBY_T_NIL) ? ((argv[0]) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_FLOAT) == RUBY_T_UNDEF) ? ((argv[0]) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_FLOAT) == RUBY_T_SYMBOL) ? ((((VALUE)(argv[0])&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(argv[0]) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(argv[0]) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(argv[0]))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_FLOAT) == RUBY_T_FLOAT) ? ( ((((int)(long)(argv[0]))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(argv[0]) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(argv[0]) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(argv[0]))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(argv[0]) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(argv[0]) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(argv[0]))->flags & RUBY_T_MASK) == (RUBY_T_FLOAT))) && rb_float_value_inline(argv[0]) == (__builtin_inff ()))) {
                size = argv[0];
            }
            else {
...
enumerator_init_copy(VALUE obj, VALUE orig)
{
 ...
 rb_raise(rb_eTypeError, "can't copy execution context");
    ...
    ((ptr1) = (struct enumerator*)rb_check_typeddata((obj), (&enumerator_data_type)));
 ...
 rb_raise(rb_eArgError, "unallocated enumerator");
    ...
    ptr1->args = ptr0->args;
    ptr1->fib = 0;
    ptr1->lookahead = ((VALUE)RUBY_Qundef);
    ptr1->feedvalue = ((VALUE)RUBY_Qundef);
    ptr1->size = ptr0->size;
...
{
    return rb_enumeratorize_with_size(obj, meth, argc, argv, (rb_enumerator_size_func *)(0));
}
...
rb_enumeratorize_with_size(VALUE obj, VALUE meth, int argc, const VALUE *argv, rb_enumerator_size_func *size_fn)
{
    ...
    if (!(((VALUE)(rb_obj_is_kind_of(obj, rb_cLazy)) & (VALUE)~((VALUE)RUBY_Qnil)) == 0))
 return lazy_to_enum_i(obj, meth, argc, argv, size_fn);
    else
 return enumerator_init(enumerator_allocate(rb_cEnumerator),
          obj, meth, argc, argv, size_fn, ((VALUE)RUBY_Qnil));
}
...
enumerator_block_call(VALUE obj, rb_block_call_func *func, VALUE arg)
{
    ...
    if (e->args) {
 argc = rb_long2int_inline(rb_array_len(e->args));
 argv = rb_array_const_ptr(e->args);
    }
...
enumerator_each(int argc, VALUE *argv, VALUE obj)
{
 ...
 if (args) {
     ...
     rb_long2int_inline(rb_array_len(args) + argc);
...
static VALUE
enumerator_with_index_i(VALUE val, VALUE m, int argc, const VALUE *argv, VALUE blockarg)
{
    struct MEMO *memo = (struct MEMO *)m;
    VALUE idx = memo->v1;
    rb_obj_write((VALUE)((memo)), (VALUE *)(&(memo)->v1), (VALUE)((rb_int_succ(idx))), "enumerator.c", 549);

    if (argc <= 1)
 return rb_yield_values(2, val, idx);

    return rb_yield_values(2, rb_ary_new_from_values(argc, argv), idx);
}
...
enumerator_with_index(int argc, VALUE *argv, VALUE obj)
{
    ...
    do { if (!rb_block_given_p()) return rb_enumeratorize_with_size((obj), (rb_id2sym(rb_frame_this_func())), (argc), (argv), (rb_enumerator_size_func *)((enumerator_enum_size))); } while (0);
    if (!((VALUE)(memo) != ((VALUE)RUBY_Qnil)))
 memo = (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG);
    else
 memo = rb_to_int(memo);
    return enumerator_block_call(obj, enumerator_with_index_i, (VALUE)((struct MEMO *)rb_imemo_new(imemo_memo, (VALUE)(memo), (VALUE)(0), (VALUE)(0), 0)));
}
static VALUE
enumerator_each_with_index(VALUE obj)
{
    return enumerator_with_index(0, ((void*)0), obj);
}

static VALUE
enumerator_with_object_i(VALUE val, VALUE memo, int argc, const VALUE *argv, VALUE blockarg)
{
    if (argc <= 1)
 return rb_yield_values(2, val, memo);

    return rb_yield_values(2, rb_ary_new_from_values(argc, argv), memo);
}
static VALUE
enumerator_with_object(VALUE obj, VALUE memo)
{
    do { if (!rb_block_given_p()) return rb_enumeratorize_with_size((obj), (rb_id2sym(rb_frame_this_func())), (1), (&memo), (rb_enumerator_size_func *)((enumerator_enum_size))); } while (0);
...
static VALUE
next_ii(VALUE i, VALUE obj, int argc, const VALUE *argv, VALUE blockarg)
{
    struct enumerator *e = enumerator_ptr(obj);
    VALUE feedvalue = ((VALUE)RUBY_Qnil);
    VALUE args = rb_ary_new_from_values(argc, argv);
    rb_fiber_yield(1, &args);
    if (e->feedvalue != ((VALUE)RUBY_Qundef)) {
        feedvalue = e->feedvalue;
        e->feedvalue = ((VALUE)RUBY_Qundef);
    }
    return feedvalue;
}
...
{
    struct enumerator *e = enumerator_ptr(obj);
    VALUE nil = ((VALUE)RUBY_Qnil);
    VALUE result;

    result = rb_block_call(obj, id_each, 0, 0, next_ii, obj);
    e->stop_exc =  ({ (__builtin_constant_p("iteration reached an end")) ? rb_exc_new((rb_eStopIteration), ("iteration reached an end"), (long)strlen("iteration reached an end")) : rb_exc_new_cstr((rb_eStopIteration), ("iteration reached an end")); });
...
enumerator_next_values(VALUE obj)
{
    ...
    if (e->lookahead != ((VALUE)RUBY_Qundef)) {
        vs = e->lookahead;
        e->lookahead = ((VALUE)RUBY_Qundef);
        return vs;
    }
...
{
    if (!( ((RUBY_T_ARRAY) == RUBY_T_FIXNUM) ? (((int)(long)(args))&RUBY_FIXNUM_FLAG) : ((RUBY_T_ARRAY) == RUBY_T_TRUE) ? ((args) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_ARRAY) == RUBY_T_FALSE) ? ((args) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_ARRAY) == RUBY_T_NIL) ? ((args) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_ARRAY) == RUBY_T_UNDEF) ? ((args) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_ARRAY) == RUBY_T_SYMBOL) ? ((((VALUE)(args)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(args) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(args) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(args))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_ARRAY) == RUBY_T_FLOAT) ? ( ((((int)(long)(args))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(args) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(args) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(args))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(args) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(args) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(args))->flags & RUBY_T_MASK) == (RUBY_T_ARRAY))))
        return args;

    switch (rb_array_len(args)) {
      case 0:
        return ((VALUE)RUBY_Qnil);

      case 1:
        return (rb_array_const_ptr(args)[0]);
...
inspect_enumerator(VALUE obj, VALUE dummy, int recur)
{
    ...
    ((e) = (struct enumerator*)rb_check_typeddata((obj), (&enumerator_data_type)));

    cname = rb_obj_class(obj);

    if (!e || e->obj == ((VALUE)RUBY_Qundef)) {
 return rb_sprintf("#<%li\v: uninitialized>", rb_class_path(cname));
    }

    if (recur) {
 str = rb_sprintf("#<%li\v: ...>", rb_class_path(cname));
 ...
 if (rb_obj_class(eobj) == cname) {
     ...
     str = rb_sprintf("#<%li\v: %+li\v>", rb_class_path(cname), eobj);
 }
 for (i = 0; i < rb_array_len(e->procs); i++) {
     str = rb_sprintf("#<%li\v: %li\v", cname, str);
     append_method((rb_array_const_ptr(e->procs)[i]), str, e->meth, e->args);
...
append_method(VALUE obj, VALUE str, ID default_method, VALUE default_args)
{
    ...
    if (method != ((VALUE)RUBY_Qfalse)) {
 if (!!((VALUE)(method) != ((VALUE)RUBY_Qnil))) {
     (!( (((RUBY_T_SYMBOL)) == RUBY_T_FIXNUM) ? (((int)(long)((VALUE)(method)))&RUBY_FIXNUM_FLAG) : (((RUBY_T_SYMBOL)) == RUBY_T_TRUE) ? (((VALUE)(method)) == ((VALUE)RUBY_Qtrue)) : (((RUBY_T_SYMBOL)) == RUBY_T_FALSE) ? (((VALUE)(method)) == ((VALUE)RUBY_Qfalse)) : (((RUBY_T_SYMBOL)) == RUBY_T_NIL) ? (((VALUE)(method)) == ((VALUE)RUBY_Qnil)) : (((RUBY_T_SYMBOL)) == RUBY_T_UNDEF) ? (((VALUE)(method)) == ((VALUE)RUBY_Qundef)) : (((RUBY_T_SYMBOL)) == RUBY_T_SYMBOL) ? ((((VALUE)((VALUE)(method))&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)((VALUE)(method)) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)((VALUE)(method)) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)((VALUE)(method)))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : (((RUBY_T_SYMBOL)) == RUBY_T_FLOAT) ? ( ((((int)(long)((VALUE)(method)))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)((VALUE)(method)) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)((VALUE)(method)) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)((VALUE)(method)))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)((VALUE)(method)) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)((VALUE)(method)) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)((VALUE)(method)))->flags & RUBY_T_MASK) == ((RUBY_T_SYMBOL)))) || ((RUBY_T_SYMBOL) == RUBY_T_DATA && (((struct RTypedData*)(method))->typed_flag == 1)) ? rb_unexpected_type((VALUE)(method), (RUBY_T_SYMBOL)) : (void)0);
 ...
 rb_str_buf_append(str, method);
    ...
    if (!((VALUE)(eargs) != ((VALUE)RUBY_Qnil))) {
 eargs = default_args;
    }
    if (eargs != ((VALUE)RUBY_Qfalse)) {
 long argc = rb_array_len(eargs);
 const VALUE *argv = rb_array_const_ptr(eargs);
 ...
 if (argc > 0) {
  ...
  rb_str_append(str, rb_inspect(arg));
   ({ (__builtin_constant_p(argc > 0 ? ", ": ")")) ? rb_str_cat((str), (argc > 0 ? ", ": ")"), (long)strlen(argc > 0 ? ", ": ")")) : rb_str_cat_cstr((str), (argc > 0 ? ", ": ")")); });
  ( (((!(((VALUE)(str) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(str) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(str))->flags & RUBY_T_MASK) != RUBY_T_NODE) && (int)(((struct RBasic*)(str))->flags & RUBY_T_MASK) != RUBY_T_BIGNUM && (int)(((struct RBasic*)(str))->flags & RUBY_T_MASK) != RUBY_T_FLOAT) && (!(((VALUE)(arg) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(arg) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(arg))->flags & RUBY_T_MASK) != RUBY_T_NODE)) ? (void)(((struct RBasic*)(str))->flags |= ((((struct RBasic*)(arg))->flags&(RUBY_FL_TAINT)))) : (void)0);
     }
 }
    }
...
enumerator_size(VALUE obj)
{
 ...
 for (i = 0; i < rb_array_len(e->procs); i++) {
     VALUE proc = (rb_array_const_ptr(e->procs)[i]);
 ...
 return (*e->size_fn)(e->obj, e->args, obj);
    ...
    if (e->args) {
 argc = (int)rb_array_len(e->args);
 argv = rb_array_const_ptr(e->args);
    }
    size = rb_check_funcall(e->size, id_call, argc, argv);
    if (size != ((VALUE)RUBY_Qundef)) return size;
    return e->size;
}
...
yielder_ptr(VALUE obj)
{
    ...
    ((ptr) = (struct yielder*)rb_check_typeddata((obj), (&yielder_data_type)));
    if (!ptr || ptr->proc == ((VALUE)RUBY_Qundef)) {
...
yielder_allocate(VALUE klass)
{
    ...
    obj = ({ VALUE data_struct_obj = rb_data_typed_object_zalloc(klass, sizeof(struct yielder), &yielder_data_type); (void)((ptr) = (struct yielder *)(((struct RData*)(data_struct_obj))->data));; data_struct_obj; });
    ptr->proc = ((VALUE)RUBY_Qundef);
...
static VALUE
yielder_yield_i(VALUE obj, VALUE memo, int argc, const VALUE *argv, VALUE blockarg)
{
...
generator_ptr(VALUE obj)
{
    ...
    ((ptr) = (struct generator*)rb_check_typeddata((obj), (&generator_data_type)));
    if (!ptr || ptr->proc == ((VALUE)RUBY_Qundef)) {
...
generator_allocate(VALUE klass)
{
    ...
    obj = ({ VALUE data_struct_obj = rb_data_typed_object_zalloc(klass, sizeof(struct generator), &generator_data_type); (void)((ptr) = (struct generator *)(((struct RData*)(data_struct_obj))->data));; data_struct_obj; });
    ptr->proc = ((VALUE)RUBY_Qundef);
...
generator_initialize(int argc, VALUE *argv, VALUE obj)
{
 ...
 if (!rb_obj_is_proc(proc))
     rb_raise(rb_eTypeError,
       "wrong argument type %li\v (expected Proc)",
       rb_obj_class(proc));
...
generator_init_copy(VALUE obj, VALUE orig)
{
    ...
    ((ptr1) = (struct generator*)rb_check_typeddata((obj), (&generator_data_type)));
...
generator_each(int argc, VALUE *argv, VALUE obj)
{
    ...
    VALUE args = rb_ary_new_capa(argc + 1);
...
enum_size(VALUE self)
{
    ...
    return (r == ((VALUE)RUBY_Qundef)) ? ((VALUE)RUBY_Qnil) : r;
}
...
static VALUE
lazy_init_iterator(VALUE val, VALUE m, int argc, const VALUE *argv, VALUE blockarg)
{
    VALUE result;
    if (argc == 1) {
 VALUE args[2];
 ...
 VALUE args;
 int len = rb_long2int_inline((long)argc + 1);
 VALUE *nargv = ((VALUE*)(((size_t)(len) < 1024 / sizeof(VALUE)) ? ((* ({ volatile VALUE *rb_gc_guarded_ptr = &(args); ; rb_gc_guarded_ptr; })) = 0, __builtin_alloca ((size_t)(len) * sizeof(VALUE))) : rb_alloc_tmp_buffer2(&(args), (long)(len), sizeof(VALUE))));
 ...
 rb_free_tmp_buffer(&(args));
    }
    if (result == ((VALUE)RUBY_Qundef)) rb_iter_break();
    return ((VALUE)RUBY_Qnil);
}

static VALUE
lazy_init_block_i(VALUE val, VALUE m, int argc, const VALUE *argv, VALUE blockarg)
{
...
{
    VALUE yielder = (rb_array_const_ptr(m)[0]);
    VALUE procs_array = (rb_array_const_ptr(m)[1]);
    VALUE memos = rb_attr_get(yielder, id_memo);
    long i = 0;
    struct MEMO *result;
    int cont = 1;

    result = ((struct MEMO *)rb_imemo_new(imemo_memo, (VALUE)(((VALUE)RUBY_Qnil)), (VALUE)(rb_enum_values_pack(argc, argv)), (VALUE)(argc > 1 ? 2 : 0), 0));


    for (i = 0; i < rb_array_len(procs_array); i++) {
 VALUE proc = (rb_array_const_ptr(procs_array)[i]);
 struct proc_entry *entry = proc_entry_ptr(proc);
 if (!(*entry->fn->proc)(proc, result, memos, i)) {
    ...
    if (cont) {
 rb_funcallv(yielder, id_yield, 1, &(result->v2));
    }
    if (((result)->u3.state & 1)) {
 rb_iter_break();
    }
    return result->v2;
}
...
lazy_generator_init(VALUE enumerator, VALUE procs)
{
 ...
 obj = enumerator;
    ...
    lazy_init_block,  ({ const VALUE args_to_new_ary[] = {obj, procs}; if (__builtin_constant_p(2)) { extern int (*__Static_assert_function (void)) [!!sizeof (struct { int __error_if_negative: (((int)(sizeof(args_to_new_ary) / sizeof((args_to_new_ary)[0]))) == (2)) ? 2 : -1; })]; } rb_ary_new_from_values(((int)(sizeof(args_to_new_ary) / sizeof((args_to_new_ary)[0]))), args_to_new_ary); }));
...
{
    VALUE obj, size = ((VALUE)RUBY_Qnil);
    VALUE generator;
...
lazy_set_args(VALUE lazy, VALUE args)
{
    ...
    rb_ivar_set(lazy, id_method, (rb_id2sym(id)));
    if (!((VALUE)(args) != ((VALUE)RUBY_Qnil))) {

 rb_ivar_set(lazy, id_arguments, ((VALUE)RUBY_Qfalse));
    }
    else {
  ...
  const lazyenum_funcs *fn)
{
    ...
    VALUE entry_obj = ({ VALUE data_struct_obj = rb_data_typed_object_zalloc(rb_cObject, sizeof(struct proc_entry), &proc_entry_data_type); (void)((entry) = (struct proc_entry *)(((struct RData*)(data_struct_obj))->data));; data_struct_obj; });
 ...
 entry->proc = rb_block_proc();
    ...
    new_procs = !(((VALUE)(e->procs) & (VALUE)~((VALUE)RUBY_Qnil)) == 0) ? rb_ary_dup(e->procs) : rb_ary_new();
    ...
    new_e = (((struct RData*)(new_obj))->data);
 ...
 new_e->meth = id_each;
    ...
    new_e->args = rb_ary_new_from_values(argc, argv);
    return new_obj;
}
static VALUE
enumerable_lazy(VALUE obj)
{
    ...
    rb_ivar_set(result, id_method, ((VALUE)RUBY_Qfalse));
    return result;
}
...
lazyenum_yield(VALUE proc_entry, struct MEMO *result)
{
    ...
    return rb_proc_call_with_block(entry->proc, 1, &result->v2, ((VALUE)RUBY_Qnil));
}
...
lazyenum_yield_values(VALUE proc_entry, struct MEMO *result)
{
    struct proc_entry *entry = proc_entry_ptr(proc_entry);
    int argc = 1;
    const VALUE *argv = &result->v2;
    if (((result)->u3.state & 2)) {
 const VALUE args = *argv;
 argc = rb_long2int_inline(rb_array_len(args));
 argv = rb_array_const_ptr(args);
    }
    return rb_proc_call_with_block(entry->proc, argc, argv, ((VALUE)RUBY_Qnil));
}
...
lazy_map_proc(VALUE proc_entry, struct MEMO *result, VALUE memos, long memo_index)
{
    ...
    rb_obj_write((VALUE)((result)), (VALUE *)(&(result)->v2), (VALUE)((value)), "enumerator.c", 1747);
    ((result)->u3.state &= ~2);
    return result;
}
...
lazy_map(VALUE obj)
{
 ...
 rb_raise(rb_eArgError, "tried to call lazy map without a block");
    ...
    return lazy_add_method(obj, 0, 0, ((VALUE)RUBY_Qnil), ((VALUE)RUBY_Qnil), &lazy_map_funcs);
}

static VALUE
lazy_flat_map_i(VALUE i, VALUE yielder, int argc, const VALUE *argv, VALUE blockarg)
{
...
lazy_flat_map_to_ary(VALUE obj, VALUE yielder)
{
 ...
 for (i = 0; i < rb_array_len(ary); i++) {
     rb_funcall(yielder, id_yield, 1, (rb_array_const_ptr(ary)[i]));
 }
    }
    return ((VALUE)RUBY_Qnil);
}
...
static VALUE
lazy_flat_map_proc(VALUE val, VALUE m, int argc, const VALUE *argv, VALUE blockarg)
{
    VALUE result = rb_yield_values2(argc - 1, &argv[1]);
    if (( ((RUBY_T_ARRAY) == RUBY_T_FIXNUM) ? (((int)(long)(result))&RUBY_FIXNUM_FLAG) : ((RUBY_T_ARRAY) == RUBY_T_TRUE) ? ((result) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_ARRAY) == RUBY_T_FALSE) ? ((result) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_ARRAY) == RUBY_T_NIL) ? ((result) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_ARRAY) == RUBY_T_UNDEF) ? ((result) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_ARRAY) == RUBY_T_SYMBOL) ? ((((VALUE)(result)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(result) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(result) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(result))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_ARRAY) == RUBY_T_FLOAT) ? ( ((((int)(long)(result))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(result) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(result) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(result))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(result) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(result) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(result))->flags & RUBY_T_MASK) == (RUBY_T_ARRAY)))) {
 long i;
 for (i = 0; i < rb_array_len(result); i++) {
     rb_funcall(argv[0], id_yield, 1, (rb_array_const_ptr(result)[i]));
 }
    }
    else {
...
lazy_select_proc(VALUE proc_entry, struct MEMO *result, VALUE memos, long memo_index)
{
    ...
    if (!!(((VALUE)(chain) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) return 0;
    return result;
}
...
lazy_select(VALUE obj)
{
 ...
 rb_raise(rb_eArgError, "tried to call lazy select without a block");
    ...
    return lazy_add_method(obj, 0, 0, ((VALUE)RUBY_Qnil), ((VALUE)RUBY_Qnil), &lazy_select_funcs);
}
...
lazy_reject(VALUE obj)
{
 ...
 rb_raise(rb_eArgError, "tried to call lazy reject without a block");
    ...
    return lazy_add_method(obj, 0, 0, ((VALUE)RUBY_Qnil), ((VALUE)RUBY_Qnil), &lazy_reject_funcs);
}
...
{
    struct proc_entry *entry = proc_entry_ptr(proc_entry);
    VALUE chain = rb_funcall(entry->memo, id_eqq, 1, result->v2);
    if (!!(((VALUE)(chain) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) return 0;
    return result;
}
...
{
    struct proc_entry *entry = proc_entry_ptr(proc_entry);
    VALUE value, chain = rb_funcall(entry->memo, id_eqq, 1, result->v2);

    if (!!(((VALUE)(chain) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) return 0;
    value = rb_proc_call_with_block(entry->proc, 1, &(result->v2), ((VALUE)RUBY_Qnil));
    rb_obj_write((VALUE)((result)), (VALUE *)(&(result)->v2), (VALUE)((value)), "enumerator.c", 1918);
    ((result)->u3.state &= ~2);
...
lazy_grep(VALUE obj, VALUE pattern)
{
 ...
 &lazy_grep_iter_funcs : &lazy_grep_funcs;
    return lazy_add_method(obj, 0, 0, pattern,  ({ const VALUE args_to_new_ary[] = {pattern}; if (__builtin_constant_p(1)) { extern int (*__Static_assert_function (void)) [!!sizeof (struct { int __error_if_negative: (((int)(sizeof(args_to_new_ary) / sizeof((args_to_new_ary)[0]))) == (1)) ? 2 : -1; })]; } rb_ary_new_from_values(((int)(sizeof(args_to_new_ary) / sizeof((args_to_new_ary)[0]))), args_to_new_ary); }), funcs);
}

static VALUE
lazy_grep_v_func(VALUE val, VALUE m, int argc, const VALUE *argv, VALUE blockarg)
{
...
static VALUE
lazy_grep_v_iter(VALUE val, VALUE m, int argc, const VALUE *argv, VALUE blockarg)
{
    VALUE i = rb_enum_values_pack(argc - 1, argv + 1);
    VALUE result = rb_funcall(m, id_eqq, 1, i);
...
lazy_grep_v(VALUE obj, VALUE pattern)
{
    return lazy_set_method(rb_block_call(rb_cLazy, id_new, 1, &obj,
      ...
      pattern),
       ({ const VALUE args_to_new_ary[] = {pattern}; if (__builtin_constant_p(1)) { extern int (*__Static_assert_function (void)) [!!sizeof (struct { int __error_if_negative: (((int)(sizeof(args_to_new_ary) / sizeof((args_to_new_ary)[0]))) == (1)) ? 2 : -1; })]; } rb_ary_new_from_values(((int)(sizeof(args_to_new_ary) / sizeof((args_to_new_ary)[0]))), args_to_new_ary); }), 0);
}
...
static VALUE
lazy_zip_arrays_func(VALUE val, VALUE arrays, int argc, const VALUE *argv, VALUE blockarg)
{
    ...
    count = !((VALUE)(memo) != ((VALUE)RUBY_Qnil)) ? 0 : rb_num2long_inline(memo);

    ary = rb_ary_new_capa(rb_array_len(arrays) + 1);
    rb_ary_push(ary, argv[1]);
    for (i = 0; i < rb_array_len(arrays); i++) {
 rb_ary_push(ary, rb_ary_entry((rb_array_const_ptr(arrays)[i]), count));
    }
    rb_funcall(yielder, id_yield, 1, ary);
    rb_ivar_set(yielder, id_memo, rb_long2num_inline(++count));
    return ((VALUE)RUBY_Qnil);
}

static VALUE
lazy_zip_func(VALUE val, VALUE zip_args, int argc, const VALUE *argv, VALUE blockarg)
{
    ...
    if (!((VALUE)(arg) != ((VALUE)RUBY_Qnil))) {
 arg = rb_ary_new_capa(rb_array_len(zip_args));
 for (i = 0; i < rb_array_len(zip_args); i++) {
     rb_ary_push(arg, rb_funcall((rb_array_const_ptr(zip_args)[i]), id_to_enum, 0));
 }
 rb_ivar_set(yielder, id_memo, arg);
    }

    ary = rb_ary_new_capa(rb_array_len(arg) + 1);
    v = ((VALUE)RUBY_Qnil);
    if (--argc > 0) {
 ++argv;
 v = argc > 1 ? rb_ary_new_from_values(argc, argv) : *argv;
    ...
    rb_ary_push(ary, v);
    for (i = 0; i < rb_array_len(arg); i++) {
 v = rb_rescue2(call_next, (rb_array_const_ptr(arg)[i]), next_stopped, 0,
...
lazy_zip(int argc, VALUE *argv, VALUE obj)
{
 ...
 if (!((VALUE)(v) != ((VALUE)RUBY_Qnil))) {
  ...
  if (!rb_respond_to(argv[i], id_each)) {
     ...
     ary = rb_ary_new_from_values(argc, argv);
     func = lazy_zip_func;
     break;
 }
 rb_ary_push(ary, v);
...
lazy_take_proc(VALUE proc_entry, struct MEMO *result, VALUE memos, long memo_index)
{
 ...
 memo = entry->memo;
    ...
    remain = rb_num2long_inline(memo);
    if (remain == 0) {
 ((result)->u3.state |= 1);
    }
    else {
 if (--remain == 0) ((result)->u3.state |= 1);
 rb_ary_store(memos, memo_index, rb_long2num_inline(remain));
    }
    return result;
}
...
{
    long len = rb_num2long_inline((rb_array_const_ptr(rb_ivar_get(entry, id_arguments))[0]));
    if (!((VALUE)(receiver) != ((VALUE)RUBY_Qnil)) || ((((int)(long)(receiver))&RUBY_FIXNUM_FLAG) && ((long)(((long)(receiver))>>(int)(1))) < len))
 return receiver;
...
lazy_take(VALUE obj, VALUE n)
{
 ...
 rb_raise(rb_eArgError, "attempt to take negative size");
    ...
    if (len == 0) {
       argv[0] = sym_cycle;
       argv[1] = (((VALUE)((int)(0)))<<1 | RUBY_FIXNUM_FLAG);
       argc = 2;
    }

    return lazy_add_method(obj, argc, argv, n,  ({ const VALUE args_to_new_ary[] = {n}; if (__builtin_constant_p(1)) { extern int (*__Static_assert_function (void)) [!!sizeof (struct { int __error_if_negative: (((int)(sizeof(args_to_new_ary) / sizeof((args_to_new_ary)[0]))) == (1)) ? 2 : -1; })]; } rb_ary_new_from_values(((int)(sizeof(args_to_new_ary) / sizeof((args_to_new_ary)[0]))), args_to_new_ary); }), &lazy_take_funcs);
}
...
lazy_take_while_proc(VALUE proc_entry, struct MEMO *result, VALUE memos, long memo_index)
{
    ...
    if (!!(((VALUE)(take) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) {
 ((result)->u3.state |= 1);
 return 0;
    }
    return result;
...
lazy_take_while(VALUE obj)
{
 ...
 rb_raise(rb_eArgError, "tried to call lazy take_while without a block");
    ...
    return lazy_add_method(obj, 0, 0, ((VALUE)RUBY_Qnil), ((VALUE)RUBY_Qnil), &lazy_take_while_funcs);
}

static VALUE
lazy_drop_size(VALUE proc_entry, VALUE receiver)
{
    long len = rb_num2long_inline((rb_array_const_ptr(rb_ivar_get(proc_entry, id_arguments))[0]));
    if (!((VALUE)(receiver) != ((VALUE)RUBY_Qnil)))
 return receiver;
    if ((((int)(long)(receiver))&RUBY_FIXNUM_FLAG)) {
 len = ((long)(((long)(receiver))>>(int)(1))) - len;
 return (((VALUE)(len < 0 ? 0 : len))<<1 | RUBY_FIXNUM_FLAG);
    }
    return rb_funcall(receiver, '-', 1, rb_long2num_inline(len));
}
...
lazy_drop(VALUE obj, VALUE n)
{
 ...
 rb_raise(rb_eArgError, "attempt to drop negative size");
    ...
    return lazy_add_method(obj, 2, argv, n,  ({ const VALUE args_to_new_ary[] = {n}; if (__builtin_constant_p(1)) { extern int (*__Static_assert_function (void)) [!!sizeof (struct { int __error_if_negative: (((int)(sizeof(args_to_new_ary) / sizeof((args_to_new_ary)[0]))) == (1)) ? 2 : -1; })]; } rb_ary_new_from_values(((int)(sizeof(args_to_new_ary) / sizeof((args_to_new_ary)[0]))), args_to_new_ary); }), &lazy_drop_funcs);
}
...
lazy_drop_while_proc(VALUE proc_entry, struct MEMO* result, VALUE memos, long memo_index)
{
 ...
 memo = entry->memo;
    ...
    if (!!(((VALUE)(memo) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) {
 VALUE drop = lazyenum_yield_values(proc_entry, result);
 if (!(((VALUE)(drop) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) return 0;
 rb_ary_store(memos, memo_index, ((VALUE)RUBY_Qtrue));
    }
    return result;
}
...
lazy_drop_while(VALUE obj)
{
 ...
 rb_raise(rb_eArgError, "tried to call lazy drop_while without a block");
    ...
    return lazy_add_method(obj, 0, 0, ((VALUE)RUBY_Qfalse), ((VALUE)RUBY_Qnil), &lazy_drop_while_funcs);
}

static VALUE
lazy_uniq_i(VALUE i, VALUE hash, int argc, const VALUE *argv, VALUE yielder)
{
    if (rb_hash_add_new_element(hash, i, ((VALUE)RUBY_Qfalse)))
 return ((VALUE)RUBY_Qnil);
    return rb_funcallv(yielder, id_yield, argc, argv);
}

static VALUE
lazy_uniq_func(VALUE i, VALUE hash, int argc, const VALUE *argv, VALUE blockarg)
{
...
static VALUE
lazy_uniq_iter(VALUE i, VALUE hash, int argc, const VALUE *argv, VALUE blockarg)
{
    VALUE yielder = (--argc, *argv++);
...
Init_Enumerator(void)
{
    ...
    sym_each = (rb_id2sym(id_each));
    sym_cycle = (rb_id2sym(rb_intern("cycle")));

    {void InitVM_Enumerator(void);InitVM_Enumerator();};
}
