...
f_gt_p(VALUE x, VALUE y)
{
    if ( ({ const VALUE integer_type_obj = (x); ((((int)(long)(integer_type_obj))&RUBY_FIXNUM_FLAG) || (!(((VALUE)(integer_type_obj) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(integer_type_obj) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(integer_type_obj))->flags & RUBY_T_MASK) == RUBY_T_BIGNUM)); })) {
        ...
        return !(((VALUE)(rb_int_gt(x, y)) & (VALUE)~((VALUE)RUBY_Qnil)) == 0);
    }
    else if (( ((((int)(long)(x))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(x) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(x) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(x))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)))
        return !(((VALUE)(rb_float_gt(x, y)) & (VALUE)~((VALUE)RUBY_Qnil)) == 0);
...
inline static VALUE f_abs(VALUE x){ return rb_funcall(x, id_abs, 0);}
inline static VALUE f_arg(VALUE x){ return rb_funcall(x, id_arg, 0);}
inline static VALUE f_denominator(VALUE x){ return rb_funcall(x, id_denominator, 0);}
...
f_negate(VALUE x)
{
    ...
    else if (( ((RUBY_T_COMPLEX) == RUBY_T_FIXNUM) ? (((int)(long)(x))&RUBY_FIXNUM_FLAG) : ((RUBY_T_COMPLEX) == RUBY_T_TRUE) ? ((x) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_COMPLEX) == RUBY_T_FALSE) ? ((x) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_COMPLEX) == RUBY_T_NIL) ? ((x) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_COMPLEX) == RUBY_T_UNDEF) ? ((x) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_COMPLEX) == RUBY_T_SYMBOL) ? ((((VALUE)(x)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(x) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(x) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(x))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_COMPLEX) == RUBY_T_FLOAT) ? ( ((((int)(long)(x))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(x) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(x) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(x))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(x) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(x) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(x))->flags & RUBY_T_MASK) == (RUBY_T_COMPLEX)))) {
        return nucomp_negate(x);
    }
    return rb_funcall(x, id_negate, 0);
}

inline static VALUE f_numerator(VALUE x){ return rb_funcall(x, id_numerator, 0);}
inline static VALUE f_real_p(VALUE x){ return rb_funcall(x, id_real_p, 0);}
...
{
    if (( ((RUBY_T_STRING) == RUBY_T_FIXNUM) ? (((int)(long)(x))&RUBY_FIXNUM_FLAG) : ((RUBY_T_STRING) == RUBY_T_TRUE) ? ((x) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_STRING) == RUBY_T_FALSE) ? ((x) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_STRING) == RUBY_T_NIL) ? ((x) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_STRING) == RUBY_T_UNDEF) ? ((x) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_STRING) == RUBY_T_SYMBOL) ? ((((VALUE)(x)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(x) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(x) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(x))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_STRING) == RUBY_T_FLOAT) ? ( ((((int)(long)(x))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(x) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(x) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(x))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(x) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(x) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(x))->flags & RUBY_T_MASK) == (RUBY_T_STRING))))
 return rb_float_new_inline(rb_str_to_dbl(x, 0));
    return rb_funcall(x, id_to_f, 0);
}

inline static VALUE f_to_r(VALUE x){ return rb_funcall(x, id_to_r, 0);}
...
f_eqeq_p(VALUE x, VALUE y)
{
    if ((((int)(long)(x))&RUBY_FIXNUM_FLAG) && (((int)(long)(y))&RUBY_FIXNUM_FLAG))
 return x == y;
    else if (( ((((int)(long)(x))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(x) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(x) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(x))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) || ( ((((int)(long)(y))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(y) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(y) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(y))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)))
 return rb_num2dbl((VALUE)(x)) == rb_num2dbl((VALUE)(y));
    return (int)rb_equal(x, y);
}

inline static VALUE f_expt(VALUE x, VALUE y){ return rb_funcall(x, id_expt, 1, y);}
inline static VALUE f_fdiv(VALUE x, VALUE y){ return rb_funcall(x, id_fdiv, 1, y);}
inline static VALUE f_quo(VALUE x, VALUE y){ return rb_funcall(x, id_quo, 1, y);}

inline static int
f_negative_p(VALUE x)
{
    if ( ({ const VALUE integer_type_obj = (x); ((((int)(long)(integer_type_obj))&RUBY_FIXNUM_FLAG) || (!(((VALUE)(integer_type_obj) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(integer_type_obj) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(integer_type_obj))->flags & RUBY_T_MASK) == RUBY_T_BIGNUM)); }))
        return ((((int)(long)(x))&RUBY_FIXNUM_FLAG) ? ((long)(x) < 0) : (!((((struct RBasic*)(x))->flags & ((VALUE)((VALUE)RUBY_FL_USER1))) != 0)));
    else if (( ((((int)(long)(x))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(x) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(x) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(x))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)))
        return rb_float_value_inline(x) < 0.0;
    else if (( ((RUBY_T_RATIONAL) == RUBY_T_FIXNUM) ? (((int)(long)(x))&RUBY_FIXNUM_FLAG) : ((RUBY_T_RATIONAL) == RUBY_T_TRUE) ? ((x) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_RATIONAL) == RUBY_T_FALSE) ? ((x) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_RATIONAL) == RUBY_T_NIL) ? ((x) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_RATIONAL) == RUBY_T_UNDEF) ? ((x) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_RATIONAL) == RUBY_T_SYMBOL) ? ((((VALUE)(x)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(x) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(x) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(x))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_RATIONAL) == RUBY_T_FLOAT) ? ( ((((int)(long)(x))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(x) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(x) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(x))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(x) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(x) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(x))->flags & RUBY_T_MASK) == (RUBY_T_RATIONAL))))
        return ((((int)(long)(((struct RRational*)(x))->num))&RUBY_FIXNUM_FLAG) ? ((long)(((struct RRational*)(x))->num) < 0) : (!((((struct RBasic*)(((struct RRational*)(x))->num))->flags & ((VALUE)((VALUE)RUBY_FL_USER1))) != 0)));
...
f_zero_p(VALUE x)
{
    if ( ({ const VALUE integer_type_obj = (x); ((((int)(long)(integer_type_obj))&RUBY_FIXNUM_FLAG) || (!(((VALUE)(integer_type_obj) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(integer_type_obj) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(integer_type_obj))->flags & RUBY_T_MASK) == RUBY_T_BIGNUM)); })) {
        ...
        const VALUE num = ((struct RRational*)(x))->num;
...
f_finite_p(VALUE x)
{
 ...
 return TRUE;
    ...
    return !(((VALUE)(rb_funcallv(x, id_finite_p, 0, 0)) & (VALUE)~((VALUE)RUBY_Qnil)) == 0);
}
...
{
    struct RComplex *(obj) = (struct RComplex*)(((RUBY_T_COMPLEX | (1 ? ((VALUE)RUBY_FL_WB_PROTECTED) : 0)) & ((VALUE)RUBY_FL_WB_PROTECTED)) ? rb_wb_protected_newobj_of(klass, (RUBY_T_COMPLEX | (1 ? ((VALUE)RUBY_FL_WB_PROTECTED) : 0)) & ~((VALUE)RUBY_FL_WB_PROTECTED)) : rb_wb_unprotected_newobj_of(klass, RUBY_T_COMPLEX | (1 ? ((VALUE)RUBY_FL_WB_PROTECTED) : 0)));

    rb_obj_write((VALUE)((obj)), (VALUE *)(&((struct RComplex *)(obj))->real), (VALUE)((real)), "complex.c", 299);
    rb_obj_write((VALUE)((obj)), (VALUE *)(&((struct RComplex *)(obj))->imag), (VALUE)((imag)), "complex.c", 300);
...
{
    return nucomp_s_new_internal(klass, (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG), (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG));
}
inline static VALUE
f_complex_new_bang1(VALUE klass, VALUE x)
{
    __builtin_choose_expr( __builtin_constant_p(!1 +0), __builtin_choose_expr(!1 +0, ((!( ((RUBY_T_COMPLEX) == RUBY_T_FIXNUM) ? (((int)(long)(x))&RUBY_FIXNUM_FLAG) : ((RUBY_T_COMPLEX) == RUBY_T_TRUE) ? ((x) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_COMPLEX) == RUBY_T_FALSE) ? ((x) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_COMPLEX) == RUBY_T_NIL) ? ((x) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_COMPLEX) == RUBY_T_UNDEF) ? ((x) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_COMPLEX) == RUBY_T_SYMBOL) ? ((((VALUE)(x)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(x) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(x) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(x))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_COMPLEX) == RUBY_T_FLOAT) ? ( ((((int)(long)(x))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(x) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(x) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(x))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(x) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(x) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(x))->flags & RUBY_T_MASK) == (RUBY_T_COMPLEX)))) ? (void)0 : rb_assert_failure("complex.c", 339, __func__, "!RB_TYPE_P(x, T_COMPLEX)")), (void)0), ((!(!1 +0) || (!( ((RUBY_T_COMPLEX) == RUBY_T_FIXNUM) ? (((int)(long)(x))&RUBY_FIXNUM_FLAG) : ((RUBY_T_COMPLEX) == RUBY_T_TRUE) ? ((x) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_COMPLEX) == RUBY_T_FALSE) ? ((x) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_COMPLEX) == RUBY_T_NIL) ? ((x) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_COMPLEX) == RUBY_T_UNDEF) ? ((x) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_COMPLEX) == RUBY_T_SYMBOL) ? ((((VALUE)(x)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(x) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(x) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(x))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_COMPLEX) == RUBY_T_FLOAT) ? ( ((((int)(long)(x))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(x) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(x) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(x))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(x) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(x) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(x))->flags & RUBY_T_MASK) == (RUBY_T_COMPLEX))))) ? (void)0 : rb_assert_failure("complex.c", 339, __func__, "!RB_TYPE_P(x, T_COMPLEX)")));
    return nucomp_s_new_internal(klass, x, (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG));
}

inline static VALUE
f_complex_new_bang2(VALUE klass, VALUE x, VALUE y)
{
    __builtin_choose_expr( __builtin_constant_p(!1 +0), __builtin_choose_expr(!1 +0, ((!( ((RUBY_T_COMPLEX) == RUBY_T_FIXNUM) ? (((int)(long)(x))&RUBY_FIXNUM_FLAG) : ((RUBY_T_COMPLEX) == RUBY_T_TRUE) ? ((x) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_COMPLEX) == RUBY_T_FALSE) ? ((x) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_COMPLEX) == RUBY_T_NIL) ? ((x) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_COMPLEX) == RUBY_T_UNDEF) ? ((x) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_COMPLEX) == RUBY_T_SYMBOL) ? ((((VALUE)(x)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(x) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(x) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(x))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_COMPLEX) == RUBY_T_FLOAT) ? ( ((((int)(long)(x))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(x) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(x) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(x))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(x) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(x) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(x))->flags & RUBY_T_MASK) == (RUBY_T_COMPLEX)))) ? (void)0 : rb_assert_failure("complex.c", 346, __func__, "!RB_TYPE_P(x, T_COMPLEX)")), (void)0), ((!(!1 +0) || (!( ((RUBY_T_COMPLEX) == RUBY_T_FIXNUM) ? (((int)(long)(x))&RUBY_FIXNUM_FLAG) : ((RUBY_T_COMPLEX) == RUBY_T_TRUE) ? ((x) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_COMPLEX) == RUBY_T_FALSE) ? ((x) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_COMPLEX) == RUBY_T_NIL) ? ((x) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_COMPLEX) == RUBY_T_UNDEF) ? ((x) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_COMPLEX) == RUBY_T_SYMBOL) ? ((((VALUE)(x)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(x) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(x) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(x))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_COMPLEX) == RUBY_T_FLOAT) ? ( ((((int)(long)(x))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(x) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(x) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(x))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(x) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(x) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(x))->flags & RUBY_T_MASK) == (RUBY_T_COMPLEX))))) ? (void)0 : rb_assert_failure("complex.c", 346, __func__, "!RB_TYPE_P(x, T_COMPLEX)")));
    __builtin_choose_expr( __builtin_constant_p(!1 +0), __builtin_choose_expr(!1 +0, ((!( ((RUBY_T_COMPLEX) == RUBY_T_FIXNUM) ? (((int)(long)(y))&RUBY_FIXNUM_FLAG) : ((RUBY_T_COMPLEX) == RUBY_T_TRUE) ? ((y) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_COMPLEX) == RUBY_T_FALSE) ? ((y) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_COMPLEX) == RUBY_T_NIL) ? ((y) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_COMPLEX) == RUBY_T_UNDEF) ? ((y) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_COMPLEX) == RUBY_T_SYMBOL) ? ((((VALUE)(y)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(y) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(y) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(y))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_COMPLEX) == RUBY_T_FLOAT) ? ( ((((int)(long)(y))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(y) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(y) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(y))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(y) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(y) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(y))->flags & RUBY_T_MASK) == (RUBY_T_COMPLEX)))) ? (void)0 : rb_assert_failure("complex.c", 347, __func__, "!RB_TYPE_P(y, T_COMPLEX)")), (void)0), ((!(!1 +0) || (!( ((RUBY_T_COMPLEX) == RUBY_T_FIXNUM) ? (((int)(long)(y))&RUBY_FIXNUM_FLAG) : ((RUBY_T_COMPLEX) == RUBY_T_TRUE) ? ((y) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_COMPLEX) == RUBY_T_FALSE) ? ((y) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_COMPLEX) == RUBY_T_NIL) ? ((y) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_COMPLEX) == RUBY_T_UNDEF) ? ((y) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_COMPLEX) == RUBY_T_SYMBOL) ? ((((VALUE)(y)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(y) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(y) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(y))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_COMPLEX) == RUBY_T_FLOAT) ? ( ((((int)(long)(y))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(y) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(y) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(y))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(y) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(y) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(y))->flags & RUBY_T_MASK) == (RUBY_T_COMPLEX))))) ? (void)0 : rb_assert_failure("complex.c", 347, __func__, "!RB_TYPE_P(y, T_COMPLEX)")));
...
nucomp_real_check(VALUE num)
{
 ...
 !( ((((int)(long)(num))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(num) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(num) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(num))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) &&
 !( ((RUBY_T_RATIONAL) == RUBY_T_FIXNUM) ? (((int)(long)(num))&RUBY_FIXNUM_FLAG) : ((RUBY_T_RATIONAL) == RUBY_T_TRUE) ? ((num) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_RATIONAL) == RUBY_T_FALSE) ? ((num) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_RATIONAL) == RUBY_T_NIL) ? ((num) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_RATIONAL) == RUBY_T_UNDEF) ? ((num) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_RATIONAL) == RUBY_T_SYMBOL) ? ((((VALUE)(num)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(num) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(num) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(num))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_RATIONAL) == RUBY_T_FLOAT) ? ( ((((int)(long)(num))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(num) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(num) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(num))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(num) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(num) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(num))->flags & RUBY_T_MASK) == (RUBY_T_RATIONAL)))) {
...
nucomp_s_canonicalize_internal(VALUE klass, VALUE real, VALUE imag)
{
    ...
    if (((!( ((((int)(long)(imag))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(imag) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(imag) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(imag))->flags & RUBY_T_MASK) == RUBY_T_FLOAT))) && f_zero_p(imag)) && canonicalization)
 return real;
 ...
 struct RComplex *dat = ((struct RComplex*)(imag));

 return nucomp_s_new_internal(klass,
         f_sub(real, dat->imag),
         f_add((((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG), dat->real));
    }
    else if (f_real_p(imag)) {
 struct RComplex *dat = ((struct RComplex*)(real));
 ...
 struct RComplex *adat = ((struct RComplex*)(real)), *bdat = ((struct RComplex*)(imag));
...
nucomp_s_new(int argc, VALUE *argv, VALUE klass)
{
 ...
 imag = (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG);
 break;
      default:
 nucomp_real_check(real);
...
{
    __builtin_choose_expr( __builtin_constant_p(!1 +0), __builtin_choose_expr(!1 +0, ((!( ((RUBY_T_COMPLEX) == RUBY_T_FIXNUM) ? (((int)(long)(x))&RUBY_FIXNUM_FLAG) : ((RUBY_T_COMPLEX) == RUBY_T_TRUE) ? ((x) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_COMPLEX) == RUBY_T_FALSE) ? ((x) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_COMPLEX) == RUBY_T_NIL) ? ((x) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_COMPLEX) == RUBY_T_UNDEF) ? ((x) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_COMPLEX) == RUBY_T_SYMBOL) ? ((((VALUE)(x)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(x) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(x) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(x))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_COMPLEX) == RUBY_T_FLOAT) ? ( ((((int)(long)(x))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(x) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(x) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(x))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(x) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(x) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(x))->flags & RUBY_T_MASK) == (RUBY_T_COMPLEX)))) ? (void)0 : rb_assert_failure("complex.c", 447, __func__, "!RB_TYPE_P(x, T_COMPLEX)")), (void)0), ((!(!1 +0) || (!( ((RUBY_T_COMPLEX) == RUBY_T_FIXNUM) ? (((int)(long)(x))&RUBY_FIXNUM_FLAG) : ((RUBY_T_COMPLEX) == RUBY_T_TRUE) ? ((x) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_COMPLEX) == RUBY_T_FALSE) ? ((x) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_COMPLEX) == RUBY_T_NIL) ? ((x) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_COMPLEX) == RUBY_T_UNDEF) ? ((x) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_COMPLEX) == RUBY_T_SYMBOL) ? ((((VALUE)(x)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(x) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(x) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(x))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_COMPLEX) == RUBY_T_FLOAT) ? ( ((((int)(long)(x))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(x) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(x) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(x))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(x) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(x) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(x))->flags & RUBY_T_MASK) == (RUBY_T_COMPLEX))))) ? (void)0 : rb_assert_failure("complex.c", 447, __func__, "!RB_TYPE_P(x, T_COMPLEX)")));
...
inline static VALUE m_cos_bang(VALUE x){ return rb_math_cos(x);}
inline static VALUE m_cosh_bang(VALUE x){ return rb_math_cosh(x);}
inline static VALUE m_exp_bang(VALUE x){ return rb_math_exp(x);}
...
inline static VALUE m_sin_bang(VALUE x){ return rb_math_sin(x);}
inline static VALUE m_sinh_bang(VALUE x){ return rb_math_sinh(x);}
...
m_cos(VALUE x)
{
 ...
 return m_cos_bang(x);
    {
 struct RComplex *dat = ((struct RComplex*)(x));
...
{
    __builtin_choose_expr( __builtin_constant_p(!1 +0), __builtin_choose_expr(!1 +0, ((!( ((RUBY_T_COMPLEX) == RUBY_T_FIXNUM) ? (((int)(long)(x))&RUBY_FIXNUM_FLAG) : ((RUBY_T_COMPLEX) == RUBY_T_TRUE) ? ((x) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_COMPLEX) == RUBY_T_FALSE) ? ((x) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_COMPLEX) == RUBY_T_NIL) ? ((x) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_COMPLEX) == RUBY_T_UNDEF) ? ((x) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_COMPLEX) == RUBY_T_SYMBOL) ? ((((VALUE)(x)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(x) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(x) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(x))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_COMPLEX) == RUBY_T_FLOAT) ? ( ((((int)(long)(x))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(x) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(x) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(x))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(x) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(x) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(x))->flags & RUBY_T_MASK) == (RUBY_T_COMPLEX)))) ? (void)0 : rb_assert_failure("complex.c", 575, __func__, "!RB_TYPE_P(x, T_COMPLEX)")), (void)0), ((!(!1 +0) || (!( ((RUBY_T_COMPLEX) == RUBY_T_FIXNUM) ? (((int)(long)(x))&RUBY_FIXNUM_FLAG) : ((RUBY_T_COMPLEX) == RUBY_T_TRUE) ? ((x) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_COMPLEX) == RUBY_T_FALSE) ? ((x) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_COMPLEX) == RUBY_T_NIL) ? ((x) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_COMPLEX) == RUBY_T_UNDEF) ? ((x) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_COMPLEX) == RUBY_T_SYMBOL) ? ((((VALUE)(x)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(x) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(x) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(x))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_COMPLEX) == RUBY_T_FLOAT) ? ( ((((int)(long)(x))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(x) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(x) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(x))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(x) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(x) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(x))->flags & RUBY_T_MASK) == (RUBY_T_COMPLEX))))) ? (void)0 : rb_assert_failure("complex.c", 575, __func__, "!RB_TYPE_P(x, T_COMPLEX)")));
    __builtin_choose_expr( __builtin_constant_p(!1 +0), __builtin_choose_expr(!1 +0, ((!( ((RUBY_T_COMPLEX) == RUBY_T_FIXNUM) ? (((int)(long)(y))&RUBY_FIXNUM_FLAG) : ((RUBY_T_COMPLEX) == RUBY_T_TRUE) ? ((y) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_COMPLEX) == RUBY_T_FALSE) ? ((y) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_COMPLEX) == RUBY_T_NIL) ? ((y) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_COMPLEX) == RUBY_T_UNDEF) ? ((y) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_COMPLEX) == RUBY_T_SYMBOL) ? ((((VALUE)(y)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(y) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(y) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(y))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_COMPLEX) == RUBY_T_FLOAT) ? ( ((((int)(long)(y))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(y) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(y) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(y))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(y) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(y) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(y))->flags & RUBY_T_MASK) == (RUBY_T_COMPLEX)))) ? (void)0 : rb_assert_failure("complex.c", 576, __func__, "!RB_TYPE_P(y, T_COMPLEX)")), (void)0), ((!(!1 +0) || (!( ((RUBY_T_COMPLEX) == RUBY_T_FIXNUM) ? (((int)(long)(y))&RUBY_FIXNUM_FLAG) : ((RUBY_T_COMPLEX) == RUBY_T_TRUE) ? ((y) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_COMPLEX) == RUBY_T_FALSE) ? ((y) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_COMPLEX) == RUBY_T_NIL) ? ((y) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_COMPLEX) == RUBY_T_UNDEF) ? ((y) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_COMPLEX) == RUBY_T_SYMBOL) ? ((((VALUE)(y)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(y) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(y) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(y))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_COMPLEX) == RUBY_T_FLOAT) ? ( ((((int)(long)(y))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(y) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(y) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(y))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(y) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(y) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(y))->flags & RUBY_T_MASK) == (RUBY_T_COMPLEX))))) ? (void)0 : rb_assert_failure("complex.c", 576, __func__, "!RB_TYPE_P(y, T_COMPLEX)")));
    if (f_zero_p(x) || f_zero_p(y)) {
 if (canonicalization) return x;
 return nucomp_s_new_internal(klass, x, rb_float_new_inline(0));
    }
 ...
 const double arg = rb_float_value_inline(y);
 if (arg == 3.14159265358979323846) {
     x = f_negate(x);
     if (canonicalization) return x;
     y = rb_float_new_inline(0);
 }
 else if (arg == 1.57079632679489661923) {
     y = x;
     x = rb_float_new_inline(0);
 }
 else if (arg == 1.57079632679489661923 +3.14159265358979323846) {
     y = f_negate(x);
     x = rb_float_new_inline(0);
 }
 else if (( ((((int)(long)(x))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(x) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(x) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(x))->flags & RUBY_T_MASK) == RUBY_T_FLOAT))) {
     const double abs = rb_float_value_inline(x);
     const double real = abs * cos(arg), imag = abs * sin(arg);
     x = rb_float_new_inline(real);
     if (canonicalization && imag == 0.0) return x;
     y = rb_float_new_inline(imag);
 }
 else {
     y = f_mul(x, rb_float_new_inline(sin(arg)));
     x = f_mul(x, rb_float_new_inline(cos(arg)));
...
nucomp_s_polar(int argc, VALUE *argv, VALUE klass)
{
 ...
 return nucomp_s_new_internal(klass, abs, (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG));
      default:
 nucomp_real_check(abs);
...
{
    struct RComplex *dat = ((struct RComplex*)(self));
    return dat->real;
}
static VALUE
...
{
    double v;
    if (!az && bz && ( ((((int)(long)(a))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(a) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(a) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(a))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) && (v = rb_float_value_inline(a), !(sizeof ((v)) == sizeof (float) ? __isnanf (v) : sizeof ((v)) == sizeof (double) ? __isnan (v) : __isnanl (v)))) {
 a = (sizeof ((v)) == sizeof (float) ? __builtin_signbitf (v) : sizeof ((v)) == sizeof (double) ? __builtin_signbit (v) : __builtin_signbitl (v)) ? rb_float_new_inline(-1.0) : rb_float_new_inline(1.0);
    }
    if (!bz && az && ( ((((int)(long)(b))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(b) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(b) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(b))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) && (v = rb_float_value_inline(b), !(sizeof ((v)) == sizeof (float) ? __isnanf (v) : sizeof ((v)) == sizeof (double) ? __isnan (v) : __isnanl (v)))) {
 b = (sizeof ((v)) == sizeof (float) ? __builtin_signbitf (v) : sizeof ((v)) == sizeof (double) ? __builtin_signbit (v) : __builtin_signbitl (v)) ? rb_float_new_inline(-1.0) : rb_float_new_inline(1.0);
    }
    return f_mul(a, b);
}
VALUE
  ...
  VALUE (*func)(VALUE, VALUE), ID id)
{
 ...
 flo = (( ((((int)(long)(adat->real))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(adat->real) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(adat->real) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(adat->real))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) || ( ((((int)(long)(adat->imag))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(adat->imag) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(adat->imag) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(adat->imag))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) ||
        ( ((((int)(long)(bdat->real))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(bdat->real) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(bdat->real) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(bdat->real))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) || ( ((((int)(long)(bdat->imag))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(bdat->imag) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(bdat->imag) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(bdat->imag))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)));

 if (f_gt_p(f_abs(bdat->real), f_abs(bdat->imag))) {
     VALUE r, n;

     r = (*func)(bdat->imag, bdat->real);
     n = f_mul(bdat->real, f_add((((VALUE)(1))<<1 | RUBY_FIXNUM_FLAG), f_mul(r, r)));
     if (flo)
  return f_complex_new2(rb_class_of((VALUE)(self)),
          (*func)(self, n),
     ...
     n = f_mul(bdat->imag, f_add((((VALUE)(1))<<1 | RUBY_FIXNUM_FLAG), f_mul(r, r)));
     if (flo)
  return f_complex_new2(rb_class_of((VALUE)(self)),
          (*func)(f_mul(self, r), n),
...
{
    return f_quo((((VALUE)(1))<<1 | RUBY_FIXNUM_FLAG), x);
}
static VALUE
nucomp_expt(VALUE self, VALUE other)
{
    if (k_numeric_p(other) && ((!( ((((int)(long)(other))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(other) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(other) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(other))->flags & RUBY_T_MASK) == RUBY_T_FLOAT))) && f_zero_p(other)))
 return f_complex_new_bang1(rb_class_of((VALUE)(self)), (((VALUE)(1))<<1 | RUBY_FIXNUM_FLAG));

    if (( ((RUBY_T_RATIONAL) == RUBY_T_FIXNUM) ? (((int)(long)(other))&RUBY_FIXNUM_FLAG) : ((RUBY_T_RATIONAL) == RUBY_T_TRUE) ? ((other) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_RATIONAL) == RUBY_T_FALSE) ? ((other) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_RATIONAL) == RUBY_T_NIL) ? ((other) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_RATIONAL) == RUBY_T_UNDEF) ? ((other) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_RATIONAL) == RUBY_T_SYMBOL) ? ((((VALUE)(other)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(other) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(other) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(other))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_RATIONAL) == RUBY_T_FLOAT) ? ( ((((int)(long)(other))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(other) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(other) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(other))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(other) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(other) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(other))->flags & RUBY_T_MASK) == (RUBY_T_RATIONAL))) && ((struct RRational*)(other))->den == (((VALUE)(1))<<1 | RUBY_FIXNUM_FLAG))
 other = ((struct RRational*)(other))->num;

    if (( ((RUBY_T_COMPLEX) == RUBY_T_FIXNUM) ? (((int)(long)(other))&RUBY_FIXNUM_FLAG) : ((RUBY_T_COMPLEX) == RUBY_T_TRUE) ? ((other) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_COMPLEX) == RUBY_T_FALSE) ? ((other) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_COMPLEX) == RUBY_T_NIL) ? ((other) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_COMPLEX) == RUBY_T_UNDEF) ? ((other) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_COMPLEX) == RUBY_T_SYMBOL) ? ((((VALUE)(other)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(other) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(other) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(other))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_COMPLEX) == RUBY_T_FLOAT) ? ( ((((int)(long)(other))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(other) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(other) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(other))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(other) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(other) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(other))->flags & RUBY_T_MASK) == (RUBY_T_COMPLEX)))) {
 struct RComplex *dat = ((struct RComplex*)(other));

 if (((!( ((((int)(long)(dat->imag))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(dat->imag) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(dat->imag) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(dat->imag))->flags & RUBY_T_MASK) == RUBY_T_FLOAT))) && f_zero_p(dat->imag)))
     other = dat->real;
    }
 ...
 return f_complex_polar(rb_class_of((VALUE)(self)), nr, ntheta);
    }
    if ((((int)(long)(other))&RUBY_FIXNUM_FLAG)) {
 if (f_gt_p(other, (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG))) {
     VALUE x, z;
     long n;

     x = self;
     z = x;
     n = ((long)(((long)(other))>>(int)(1))) - 1;
  ...
  while (1) {
   ...
   break;
      ...
      x = nucomp_s_new_internal(rb_class_of((VALUE)(self)),
           f_sub(f_mul(dat->real, dat->real),
          f_mul(dat->imag, dat->imag)),
           f_mul(f_mul((((VALUE)(2))<<1 | RUBY_FIXNUM_FLAG), dat->real), dat->imag));
      n = q;
  }
  z = f_mul(z, x);
  n--;
...
nucomp_eqeq_p(VALUE self, VALUE other)
{
 ...
 return ((f_eqeq_p(adat->real, bdat->real) && f_eqeq_p(adat->imag, bdat->imag)) ? ((VALUE)RUBY_Qtrue) : ((VALUE)RUBY_Qfalse));

    }
    if (k_numeric_p(other) && f_real_p(other)) {
 struct RComplex *dat = ((struct RComplex*)(self));

 return ((f_eqeq_p(dat->real, other) && f_zero_p(dat->imag)) ? ((VALUE)RUBY_Qtrue) : ((VALUE)RUBY_Qfalse));
    }
    return ((f_eqeq_p(other, self)) ? ((VALUE)RUBY_Qtrue) : ((VALUE)RUBY_Qfalse));
}
...
{
    if (k_numeric_p(other) && f_real_p(other))
 return rb_assoc_new(f_complex_new_bang1(rb_class_of((VALUE)(self)), other), self);
    if (( ((RUBY_T_COMPLEX) == RUBY_T_FIXNUM) ? (((int)(long)(other))&RUBY_FIXNUM_FLAG) : ((RUBY_T_COMPLEX) == RUBY_T_TRUE) ? ((other) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_COMPLEX) == RUBY_T_FALSE) ? ((other) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_COMPLEX) == RUBY_T_NIL) ? ((other) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_COMPLEX) == RUBY_T_UNDEF) ? ((other) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_COMPLEX) == RUBY_T_SYMBOL) ? ((((VALUE)(other)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(other) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(other) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(other))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_COMPLEX) == RUBY_T_FLOAT) ? ( ((((int)(long)(other))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(other) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(other) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(other))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(other) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(other) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(other))->flags & RUBY_T_MASK) == (RUBY_T_COMPLEX))))
...
nucomp_abs(VALUE self)
{
 ...
 if (( ((((int)(long)(dat->real))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(dat->real) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(dat->real) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(dat->real))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) && !( ((((int)(long)(dat->imag))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(dat->imag) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(dat->imag) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(dat->imag))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)))
     a = f_to_f(a);
 return a;
    }
...
{
    struct RComplex *dat = ((struct RComplex*)(self));
    return f_complex_new2(rb_class_of((VALUE)(self)), dat->real, f_negate(dat->imag));
}
static VALUE
...
nucomp_eql_p(VALUE self, VALUE other)
{
 ...
 return (((rb_class_of((VALUE)(adat->real)) == rb_class_of((VALUE)(bdat->real))) && (rb_class_of((VALUE)(adat->imag)) == rb_class_of((VALUE)(bdat->imag))) && f_eqeq_p(self, other)) ? ((VALUE)RUBY_Qtrue) : ((VALUE)RUBY_Qfalse));
...
f_signbit(VALUE x)
{
    if (( ((((int)(long)(x))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(x) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(x) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(x))->flags & RUBY_T_MASK) == RUBY_T_FLOAT))) {
 double f = rb_float_value_inline(x);
 return !(sizeof ((f)) == sizeof (float) ? __isnanf (f) : sizeof ((f)) == sizeof (double) ? __isnan (f) : __isnanl (f)) && (sizeof ((f)) == sizeof (float) ? __builtin_signbitf (f) : sizeof ((f)) == sizeof (double) ? __builtin_signbit (f) : __builtin_signbitl (f));
    }
...
f_format(VALUE self, VALUE (*func)(VALUE))
{
    ...
    s = (*func)(dat->real);
     ({ (__builtin_constant_p(!impos ? "-": "+")) ? rb_str_cat((s), (!impos ? "-": "+"), (long)strlen(!impos ? "-": "+")) : rb_str_cat_cstr((s), (!impos ? "-": "+")); });

    rb_str_concat(s, (*func)(f_abs(dat->imag)));
    if (!rb_isdigit((!(((struct RBasic*)(s))->flags & RSTRING_NOEMBED) ? ((struct RString*)(s))->as.ary : ((struct RString*)(s))->as.heap.ptr)[(!(((struct RBasic*)(s))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(s))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(s))->as.heap.len) - 1]))
  ({ (__builtin_constant_p("*")) ? rb_str_cat((s), ("*"), (long)strlen("*")) : rb_str_cat_cstr((s), ("*")); });
     ({ (__builtin_constant_p("i")) ? rb_str_cat((s), ("i"), (long)strlen("i")) : rb_str_cat_cstr((s), ("i")); });
...
rb_complex_infinite_p(VALUE self)
{
    ...
    if (!((VALUE)(f_infinite_p(dat->real)) != ((VALUE)RUBY_Qnil)) && !((VALUE)(f_infinite_p(dat->imag)) != ((VALUE)RUBY_Qnil))) {
 return ((VALUE)RUBY_Qnil);
    }
...
nucomp_loader(VALUE self, VALUE a)
{
    ...
    rb_obj_write((VALUE)((dat)), (VALUE *)(&((struct RComplex *)(dat))->real), (VALUE)((rb_ivar_get(a, id_i_real))), "complex.c", 1408);
    rb_obj_write((VALUE)((dat)), (VALUE *)(&((struct RComplex *)(dat))->imag), (VALUE)((rb_ivar_get(a, id_i_imag))), "complex.c", 1409);
...
nucomp_marshal_load(VALUE self, VALUE a)
{
    ...
    if (rb_array_len(a) != 2)
 rb_raise(rb_eArgError, "marshaled complex must have an array whose length is 2 but %ld", rb_array_len(a));
    rb_ivar_set(self, id_i_real, (rb_array_const_ptr(a)[0]));
    rb_ivar_set(self, id_i_imag, (rb_array_const_ptr(a)[1]));
    return self;
}
...
nucomp_to_i(VALUE self)
{
    ...
    if (!((!( ((((int)(long)(dat->imag))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(dat->imag) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(dat->imag) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(dat->imag))->flags & RUBY_T_MASK) == RUBY_T_FLOAT))) && f_zero_p(dat->imag))) {
 rb_raise(rb_eRangeError, "can't convert %li\v into Integer",
   self);
    }
...
nucomp_to_f(VALUE self)
{
    ...
    if (!((!( ((((int)(long)(dat->imag))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(dat->imag) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(dat->imag) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(dat->imag))->flags & RUBY_T_MASK) == RUBY_T_FLOAT))) && f_zero_p(dat->imag))) {
 rb_raise(rb_eRangeError, "can't convert %li\v into Float",
   self);
    }
...
nucomp_to_r(VALUE self)
{
    ...
    if (!((!( ((((int)(long)(dat->imag))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(dat->imag) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(dat->imag) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(dat->imag))->flags & RUBY_T_MASK) == RUBY_T_FLOAT))) && f_zero_p(dat->imag))) {
 rb_raise(rb_eRangeError, "can't convert %li\v into Rational",
   self);
    }
...
{
    return rb_complex_new(((((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG)), (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG));
}
...
{
    return rb_complex_new((self), (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG));
}
...
isdecimal(int c)
{
    return ((*__ctype_b_loc ())[(int) (((unsigned char)c))] & (unsigned short int) _ISdigit);
}
...
str2num(char *s)
{
 ...
 return rb_cstr_to_rat(s, 0);
    if (strpbrk(s, ".eE"))
 return rb_float_new_inline(rb_cstr_to_dbl(s, 0));
   ...
   VALUE *ret, char **b)
{
    ...
    if (isimagunit(**s)) {
 (*s)++;
 num = (((VALUE)((sign == '-') ? -1 : + 1))<<1 | RUBY_FIXNUM_FLAG);
 *ret = rb_complex_new(((((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG)), (num));
 return 1;
    }
 ...
 **b = '\0';
 num = str2num(bb);
 *ret = rb_complex_new((num), ((((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG)));
 return 0;
    }
    **b = '\0';
    num = str2num(bb);
 ...
 *ret = rb_complex_polar(num, num2);
 ...
 sign = read_sign(s, b);
 if (isimagunit(**s))
     num2 = (((VALUE)((sign == '-') ? -1 : + 1))<<1 | RUBY_FIXNUM_FLAG);
 else {
     if (!read_rat_nos(s, strict, b)) {
  *ret = rb_complex_new((num), ((((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG)));
  return 0;
...
{
    while (((*__ctype_b_loc ())[(int) (((unsigned char)**s))] & (unsigned short int) _ISspace))
 (*s)++;
}
    ...
    VALUE *num)
{
    ...
    buf = ((char*)(((size_t)(strlen(s) + 1) < 1024 / sizeof(char)) ? ((* ({ volatile VALUE *rb_gc_guarded_ptr = &(tmp); ; rb_gc_guarded_ptr; })) = 0, __builtin_alloca ((size_t)(strlen(s) + 1) * sizeof(char))) : rb_alloc_tmp_buffer2(&(tmp), (long)(strlen(s) + 1), sizeof(char))));
    b = buf;
...
string_to_c_strict(VALUE self)
{
    ...
    s = (!(((struct RBasic*)(self))->flags & RSTRING_NOEMBED) ? ((struct RString*)(self))->as.ary : ((struct RString*)(self))->as.heap.ptr);

    if (!s || memchr(s, '\0', (!(((struct RBasic*)(self))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(self))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(self))->as.heap.len)))
 rb_raise(rb_eArgError, "string contains null byte");

    if (s && s[(!(((struct RBasic*)(self))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(self))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(self))->as.heap.len)]) {
 rb_str_modify(self);
 s = (!(((struct RBasic*)(self))->flags & RSTRING_NOEMBED) ? ((struct RString*)(self))->as.ary : ((struct RString*)(self))->as.heap.ptr);
 s[(!(((struct RBasic*)(self))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(self))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(self))->as.heap.len)] = '\0';
    }
...
nucomp_s_convert(int argc, VALUE *argv, VALUE klass)
{
 ...
 {
     struct RComplex *dat = ((struct RComplex*)(a1));
 ...
 {
     struct RComplex *dat = ((struct RComplex*)(a2));
  ...
  a2 = dat->real;
    ...
    if (( ((RUBY_T_COMPLEX) == RUBY_T_FIXNUM) ? (((int)(long)(a1))&RUBY_FIXNUM_FLAG) : ((RUBY_T_COMPLEX) == RUBY_T_TRUE) ? ((a1) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_COMPLEX) == RUBY_T_FALSE) ? ((a1) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_COMPLEX) == RUBY_T_NIL) ? ((a1) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_COMPLEX) == RUBY_T_UNDEF) ? ((a1) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_COMPLEX) == RUBY_T_SYMBOL) ? ((((VALUE)(a1)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(a1) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(a1) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(a1))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_COMPLEX) == RUBY_T_FLOAT) ? ( ((((int)(long)(a1))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(a1) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(a1) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(a1))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(a1) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(a1) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(a1))->flags & RUBY_T_MASK) == (RUBY_T_COMPLEX)))) {
 if (argc == 1 || (((!( ((((int)(long)(a2))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(a2) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(a2) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(a2))->flags & RUBY_T_MASK) == RUBY_T_FLOAT))) && f_zero_p(a2))))
     return a1;
    }
 ...
 if (!k_numeric_p(a1))
     return rb_convert_type(a1, RUBY_T_COMPLEX, "Complex", "to_c");
    }
    else {
 if ((k_numeric_p(a1) && k_numeric_p(a2)) &&
     ...
     return f_add(a1,
    f_mul(a2,
          f_complex_new_bang2(rb_cComplex, (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG), (((VALUE)(1))<<1 | RUBY_FIXNUM_FLAG))));
    }
...
numeric_arg(VALUE self)
{
    if ((!f_negative_p(self)))
        return (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG);
    return rb_float_new_inline(3.14159265358979323846);
}
static VALUE
numeric_rect(VALUE self)
{
    return rb_assoc_new(self, (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG));
}
...
numeric_polar(VALUE self)
{
    ...
    if ( ({ const VALUE integer_type_obj = (self); ((((int)(long)(integer_type_obj))&RUBY_FIXNUM_FLAG) || (!(((VALUE)(integer_type_obj) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(integer_type_obj) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(integer_type_obj))->flags & RUBY_T_MASK) == RUBY_T_BIGNUM)); })) {
        abs = rb_int_abs(self);
        arg = numeric_arg(self);
    }
    else if (( ((((int)(long)(self))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(self) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(self) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(self))->flags & RUBY_T_MASK) == RUBY_T_FLOAT))) {
        abs = rb_float_abs(self);
        arg = float_arg(self);
    }
    else if (( ((RUBY_T_RATIONAL) == RUBY_T_FIXNUM) ? (((int)(long)(self))&RUBY_FIXNUM_FLAG) : ((RUBY_T_RATIONAL) == RUBY_T_TRUE) ? ((self) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_RATIONAL) == RUBY_T_FALSE) ? ((self) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_RATIONAL) == RUBY_T_NIL) ? ((self) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_RATIONAL) == RUBY_T_UNDEF) ? ((self) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_RATIONAL) == RUBY_T_SYMBOL) ? ((((VALUE)(self)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(self) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(self) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(self))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_RATIONAL) == RUBY_T_FLOAT) ? ( ((((int)(long)(self))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(self) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(self) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(self))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(self) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(self) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(self))->flags & RUBY_T_MASK) == (RUBY_T_RATIONAL)))) {
...
{
    if ((sizeof ((rb_float_value_inline(self))) == sizeof (float) ? __isnanf (rb_float_value_inline(self)) : sizeof ((rb_float_value_inline(self))) == sizeof (double) ? __isnan (rb_float_value_inline(self)) : __isnanl (rb_float_value_inline(self))))
 return self;
...
Init_Complex(void)
{
    ...
    __builtin_choose_expr( __builtin_constant_p(!1 +0), __builtin_choose_expr(!1 +0, ((fprintf(stderr, "assert() is now active\n")) ? (void)0 : rb_assert_failure("complex.c", 2195, __func__, "fprintf(stderr, \"assert() is now active\\n\")")), (void)0), ((!(!1 +0) || (fprintf(stderr, "assert() is now active\n"))) ? (void)0 : rb_assert_failure("complex.c", 2195, __func__, "fprintf(stderr, \"assert() is now active\\n\")")));

    id_abs = (__builtin_constant_p("abs") ?  (rb_intern2(("abs"), (long)strlen("abs"))) : (rb_intern)("abs"));
    id_arg = (__builtin_constant_p("arg") ?  (rb_intern2(("arg"), (long)strlen("arg"))) : (rb_intern)("arg"));
    id_denominator = (__builtin_constant_p("denominator") ?  (rb_intern2(("denominator"), (long)strlen("denominator"))) : (rb_intern)("denominator"));
    id_expt = (__builtin_constant_p("**") ?  (rb_intern2(("**"), (long)strlen("**"))) : (rb_intern)("**"));
    id_fdiv = (__builtin_constant_p("fdiv") ?  (rb_intern2(("fdiv"), (long)strlen("fdiv"))) : (rb_intern)("fdiv"));
    id_negate = (__builtin_constant_p("-@") ?  (rb_intern2(("-@"), (long)strlen("-@"))) : (rb_intern)("-@"));
    id_numerator = (__builtin_constant_p("numerator") ?  (rb_intern2(("numerator"), (long)strlen("numerator"))) : (rb_intern)("numerator"));
    id_quo = (__builtin_constant_p("quo") ?  (rb_intern2(("quo"), (long)strlen("quo"))) : (rb_intern)("quo"));
    id_real_p = (__builtin_constant_p("real?") ?  (rb_intern2(("real?"), (long)strlen("real?"))) : (rb_intern)("real?"));
    id_to_f = (__builtin_constant_p("to_f") ?  (rb_intern2(("to_f"), (long)strlen("to_f"))) : (rb_intern)("to_f"));
    id_to_i = (__builtin_constant_p("to_i") ?  (rb_intern2(("to_i"), (long)strlen("to_i"))) : (rb_intern)("to_i"));
    id_to_r = (__builtin_constant_p("to_r") ?  (rb_intern2(("to_r"), (long)strlen("to_r"))) : (rb_intern)("to_r"));
    id_i_real = (__builtin_constant_p("@real") ?  (rb_intern2(("@real"), (long)strlen("@real"))) : (rb_intern)("@real"));
    id_i_imag = (__builtin_constant_p("@image") ?  (rb_intern2(("@image"), (long)strlen("@image"))) : (rb_intern)("@image"));
    id_finite_p = (__builtin_constant_p("finite?") ?  (rb_intern2(("finite?"), (long)strlen("finite?"))) : (rb_intern)("finite?"));
    id_infinite_p = (__builtin_constant_p("infinite?") ?  (rb_intern2(("infinite?"), (long)strlen("infinite?"))) : (rb_intern)("infinite?"));
    id_rationalize = (__builtin_constant_p("rationalize") ?  (rb_intern2(("rationalize"), (long)strlen("rationalize"))) : (rb_intern)("rationalize"));
    id_PI = (__builtin_constant_p("PI") ?  (rb_intern2(("PI"), (long)strlen("PI"))) : (rb_intern)("PI"));

    rb_cComplex = rb_define_class("Complex", rb_cNumeric);

    rb_define_alloc_func(rb_cComplex, nucomp_s_alloc);
    rb_undef_method(rb_class_of((VALUE)(rb_cComplex)), "allocate");





    rb_undef_method(rb_class_of((VALUE)(rb_cComplex)), "new");
    ...
    rb_define_method(rb_cComplex, "quo", nucomp_div, 1);
    ...
    rb_define_private_method(rb_class_of((VALUE)(rb_cComplex)), "convert", nucomp_s_convert, -1);
