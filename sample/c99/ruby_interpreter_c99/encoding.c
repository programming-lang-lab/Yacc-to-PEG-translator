...
{
    return ((((struct RTypedData*)(obj))->typed_flag == 1) && (((struct RTypedData*)(obj))->type) == &encoding_data_type);
}

static VALUE
enc_new(rb_encoding *encoding)
{
    return rb_data_typed_object_wrap((rb_cEncoding),((void *)encoding),(&encoding_data_type));
}
...
{
    int idx;
    if (!encoding) return ((VALUE)RUBY_Qnil);
    idx = (int)((encoding)->ruby_encoding_index & (~(~0U<<24)));
...
{
    return enc ? (int)((enc)->ruby_encoding_index & (~(~0U<<24))) : 0;
}
...
{
    rb_raise(rb_eTypeError, "wrong argument type %li\v (expected Encoding)",
      rb_obj_class(enc));
}
...
must_encindex(int index)
{
 ...
 rb_raise(rb_eEncodingError, "encoding index out of bound: %d",
   index);
    ...
    if ((int)((enc)->ruby_encoding_index & (~(~0U<<24))) != (int)(index & (~(~0U<<24)))) {
 rb_raise(rb_eEncodingError, "wrong encoding index %d for %s (expected %d)",
   index, (enc)->name, (int)((enc)->ruby_encoding_index & (~(~0U<<24))));
    }
    if ((!(enc)->max_enc_len) && enc_autoload(enc) == -1) {
...
rb_to_encoding_index(VALUE enc)
{
 ...
 return idx;
    ...
    else if (!((VALUE)(enc = rb_check_string_type(enc)) != ((VALUE)RUBY_Qnil))) {
 return -1;
    }
    if (!rb_enc_asciicompat_inline(rb_enc_get(enc))) {
 return -1;
    }
    return rb_enc_find_index(rb_string_value_cstr(&(enc)));
}
...
str_find_encindex(VALUE enc)
{
 ...
 rb_raise(rb_eArgError, "invalid name encoding (non ASCII)");
    ...
    idx = rb_enc_find_index(rb_string_value_cstr(&(enc)));
    return idx;
}
...
str_to_encindex(VALUE enc)
{
    ...
    if (idx < 0) {
 rb_raise(rb_eArgError, "unknown encoding name - %li\v", enc);
    }
    return idx;
}
...
{
    if (enc_check_encoding(enc) >= 0) return ((struct RData*)(enc))->data;
...
enc_register_at(int index, const char *name, rb_encoding *base_encoding)
{
    ...
    if (!((name) && strlen(name) <= 63)) return -1;
    if (!ent->name) {
 ent->name = name = ruby_strdup(name);
    }
    else if ((st_locale_insensitive_strcasecmp((name), (ent->name)))) {
 return -1;
    }
    encoding = (rb_raw_encoding *)ent->enc;
    if (!encoding) {
 encoding = ruby_xmalloc(sizeof(rb_encoding));
    }
    if (base_encoding) {
 *encoding = *base_encoding;
 ...
 memset(encoding, 0, sizeof(*ent->enc));
    ...
    if (list && !((VALUE)(rb_ary_entry(list, index)) != ((VALUE)RUBY_Qnil))) {
...
rb_enc_register(const char *name, rb_encoding *encoding)
{
 ...
 if ((st_locale_insensitive_strcasecmp((name), ((oldenc)->name)))) {
     index = enc_register(name, encoding);
 }
 else if ((!(oldenc)->max_enc_len) || !((oldenc)->ruby_encoding_index & (1<<24))) {
...
set_base_encoding(int index, rb_encoding *base)
{
    ...
    if (((base)->ruby_encoding_index & (1<<24))) (((rb_raw_encoding *)enc)->ruby_encoding_index |= (1<<24));
    return enc;
}
...
rb_enc_set_dummy(int index)
{
    ...
    (((rb_raw_encoding *)enc)->ruby_encoding_index |= (1<<24));
    return index;
}
...
enc_replicate(VALUE encoding, VALUE name)
{
 ...
 rb_enc_replicate(rb_string_value_cstr(&(name)),
...
{
    return ((must_encoding(enc))->ruby_encoding_index & (1<<24)) ? ((VALUE)RUBY_Qtrue) : ((VALUE)RUBY_Qfalse);
}
static VALUE
enc_ascii_compatible_p(VALUE enc)
{
    return rb_enc_asciicompat_inline(must_encoding(enc)) ? ((VALUE)RUBY_Qtrue) : ((VALUE)RUBY_Qfalse);
}
...
{
    return (st_data_t)ruby_strdup((const char *)name);
}
...
{
    if (!((alias) && strlen(alias) <= 63)) return -1;
...
{
    ((rb_raw_encoding *)rb_enc_from_index(index))->flags |= 1U;
}

void
rb_enc_init(void)
{
    enc_table_expand(RUBY_ENCINDEX_BUILTIN_MAX + 1);
    if (!enc_table.names) {
 enc_table.names = st_init_strcasetable();
    }

    enc_register_at(RUBY_ENCINDEX_ASCII, (&OnigEncodingASCII)->name, &OnigEncodingASCII);
    enc_register_at(RUBY_ENCINDEX_UTF_8, (&OnigEncodingUTF_8)->name, &OnigEncodingUTF_8);
    enc_register_at(RUBY_ENCINDEX_US_ASCII, (&OnigEncodingUS_ASCII)->name, &OnigEncodingUS_ASCII);


    enc_register_at(RUBY_ENCINDEX_UTF_16BE, "UTF-16BE", ((void*)0));
    enc_register_at(RUBY_ENCINDEX_UTF_16LE, "UTF-16LE", ((void*)0));
    enc_register_at(RUBY_ENCINDEX_UTF_32BE, "UTF-32BE", ((void*)0));
    enc_register_at(RUBY_ENCINDEX_UTF_32LE, "UTF-32LE", ((void*)0));
    enc_register_at(RUBY_ENCINDEX_UTF_16, "UTF-16", ((void*)0));
    enc_register_at(RUBY_ENCINDEX_UTF_32, "UTF-32", ((void*)0));
    enc_register_at(RUBY_ENCINDEX_UTF8_MAC, "UTF8-MAC", ((void*)0));

    enc_register_at(RUBY_ENCINDEX_EUC_JP, "EUC-JP", ((void*)0));
    enc_register_at(RUBY_ENCINDEX_Windows_31J, "Windows-31J", ((void*)0));

    enc_table.count = RUBY_ENCINDEX_BUILTIN_MAX;
}
...
rb_enc_from_index(int index)
{
 ...
 rb_enc_init();
    ...
    if (index < 0 || enc_table.count <= (index &= (~(~0U<<24)))) {
 return 0;
    }
...
load_encoding(const char *name)
{
    ...
    VALUE debug = (*rb_ruby_debug_ptr());
    VALUE errinfo;
    char *s = (!(((struct RBasic*)(enclib))->flags & RSTRING_NOEMBED) ? ((struct RString*)(enclib))->as.ary : ((struct RString*)(enclib))->as.heap.ptr) + 4, *e = (!(((struct RBasic*)(enclib))->flags & RSTRING_NOEMBED) ? (((struct RString*)(enclib))->as.ary + (long)((((struct RBasic*)(enclib))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT))) : (((struct RString*)(enclib))->as.heap.ptr + ((struct RString*)(enclib))->as.heap.len)) - 3;
    int loaded;
    int idx;

    while (s < e) {
 if (!rb_isalnum(*s)) *s = '_';
 else if (rb_isupper(*s)) *s = (char)rb_tolower(*s);
 ++s;
    }
    ((!(((VALUE)(enclib) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(enclib) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(enclib))->flags & RUBY_T_MASK) != RUBY_T_NODE) ? (void)(((struct RBasic*)(enclib))->flags &= ~(VALUE)(((VALUE)RUBY_FL_TAINT))) : (void)0);
    rb_obj_freeze_inline((VALUE)enclib);
    (*rb_ruby_verbose_ptr()) = ((VALUE)RUBY_Qfalse);
    (*rb_ruby_debug_ptr()) = ((VALUE)RUBY_Qfalse);
    errinfo = rb_errinfo();
    loaded = rb_require_internal(enclib, rb_safe_level());
    (*rb_ruby_verbose_ptr()) = verbose;
    (*rb_ruby_debug_ptr()) = debug;
    rb_set_errinfo(errinfo);
    if (loaded < 0 || 1 < loaded) return -1;
    if ((idx = rb_enc_registered(name)) < 0) return -1;
    if ((!(enc_table.list[idx].enc)->max_enc_len)) return -1;
    return idx;
}
...
{
    int i;
    rb_encoding *base = enc_table.list[(int)((enc)->ruby_encoding_index & (~(~0U<<24)))].base;
 ...
 enc_register_at(i & (~(~0U<<24)), (enc)->name, base);
 ((rb_raw_encoding *)enc)->ruby_encoding_index = i;
 i &= (~(~0U<<24));
    }
    else {
 i = load_encoding((enc)->name);
    }
    return i;
}
...
{
    if ((((VALUE)(obj) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(obj) & (VALUE)~((VALUE)RUBY_Qnil)) == 0))) return ((((VALUE)(obj)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(obj) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(obj) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(obj))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL)));
 ...
 return 1;
      case RUBY_T_DATA:
 if (((((struct RTypedData*)(obj))->typed_flag == 1) && (((struct RTypedData*)(obj))->type) == &encoding_data_type)) return 1;
      default:
 return 0;
    }
}
...
rb_id_encoding(void)
{
    do { static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("encoding")), (long)strlen(("encoding"))); (id_encoding) = rb_intern_id_cache; } while (0);
    return id_encoding;
}
...
{
    int i = (int)((((struct RBasic*)(str))->flags & RUBY_ENCODING_MASK)>>RUBY_ENCODING_SHIFT);
    if (i == RUBY_ENCODING_INLINE_MAX) {
 VALUE iv;

 iv = rb_ivar_get(str, rb_id_encoding());
 i = rb_num2int_inline(iv);
    }
    return i;
}
...
rb_enc_get_index(VALUE obj)
{
 ...
 if (!((((VALUE)(obj)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(obj) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(obj) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(obj))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL)))) return -1;
 obj = rb_sym2str(obj);
    }
    switch ((int)(((struct RBasic*)(obj))->flags & RUBY_T_MASK)) {
      as_default:
 ...
 break;
      case RUBY_T_FILE:
 tmp = rb_funcallv(obj, (__builtin_constant_p("internal_encoding") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("internal_encoding")), (long)strlen(("internal_encoding"))); (ID) rb_intern_id_cache; }) : rb_intern("internal_encoding")), 0, 0);
 if (!((VALUE)(tmp) != ((VALUE)RUBY_Qnil))) obj = rb_funcallv(obj, (__builtin_constant_p("external_encoding") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("external_encoding")), (long)strlen(("external_encoding"))); (ID) rb_intern_id_cache; }) : rb_intern("external_encoding")), 0, 0);
 else obj = tmp;
 if (!((VALUE)(obj) != ((VALUE)RUBY_Qnil))) break;
      case RUBY_T_DATA:
 if (((((struct RTypedData*)(obj))->typed_flag == 1) && (((struct RTypedData*)(obj))->type) == &encoding_data_type)) {
...
{
    if (idx < RUBY_ENCODING_INLINE_MAX) {
 do { ((struct RBasic*)(obj))->flags &= ~RUBY_ENCODING_MASK; ((struct RBasic*)(obj))->flags |= (VALUE)(idx) << RUBY_ENCODING_SHIFT;} while (0);
 return;
    }
    do { ((struct RBasic*)(obj))->flags &= ~RUBY_ENCODING_MASK; ((struct RBasic*)(obj))->flags |= (VALUE)(RUBY_ENCODING_INLINE_MAX) << RUBY_ENCODING_SHIFT;} while (0);
    rb_ivar_set(obj, rb_id_encoding(), (((VALUE)((int)(idx)))<<1 | RUBY_FIXNUM_FLAG));
}
...
{
    rb_encoding *enc = enc_compatible_str(((!0)?(void)0:__builtin_choose_expr( __builtin_constant_p(!0 +0), __builtin_choose_expr(!0 +0, ((( ((RUBY_T_STRING) == RUBY_T_FIXNUM) ? (((int)(long)(str1))&RUBY_FIXNUM_FLAG) : ((RUBY_T_STRING) == RUBY_T_TRUE) ? ((str1) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_STRING) == RUBY_T_FALSE) ? ((str1) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_STRING) == RUBY_T_NIL) ? ((str1) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_STRING) == RUBY_T_UNDEF) ? ((str1) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_STRING) == RUBY_T_SYMBOL) ? ((((VALUE)(str1)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(str1) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(str1) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(str1))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_STRING) == RUBY_T_FLOAT) ? ( ((((int)(long)(str1))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(str1) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(str1) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(str1))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(str1) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(str1) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(str1))->flags & RUBY_T_MASK) == (RUBY_T_STRING)))) ? (void)0 : rb_assert_failure("encoding.c", 881, __func__, "RB_TYPE_P(str1, T_STRING)")), (void)0), ((!(!0 +0) || (( ((RUBY_T_STRING) == RUBY_T_FIXNUM) ? (((int)(long)(str1))&RUBY_FIXNUM_FLAG) : ((RUBY_T_STRING) == RUBY_T_TRUE) ? ((str1) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_STRING) == RUBY_T_FALSE) ? ((str1) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_STRING) == RUBY_T_NIL) ? ((str1) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_STRING) == RUBY_T_UNDEF) ? ((str1) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_STRING) == RUBY_T_SYMBOL) ? ((((VALUE)(str1)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(str1) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(str1) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(str1))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_STRING) == RUBY_T_FLOAT) ? ( ((((int)(long)(str1))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(str1) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(str1) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(str1))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(str1) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(str1) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(str1))->flags & RUBY_T_MASK) == (RUBY_T_STRING))))) ? (void)0 : rb_assert_failure("encoding.c", 881, __func__, "RB_TYPE_P(str1, T_STRING)"))), str1), ((!0)?(void)0:__builtin_choose_expr( __builtin_constant_p(!0 +0), __builtin_choose_expr(!0 +0, ((( ((RUBY_T_STRING) == RUBY_T_FIXNUM) ? (((int)(long)(str2))&RUBY_FIXNUM_FLAG) : ((RUBY_T_STRING) == RUBY_T_TRUE) ? ((str2) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_STRING) == RUBY_T_FALSE) ? ((str2) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_STRING) == RUBY_T_NIL) ? ((str2) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_STRING) == RUBY_T_UNDEF) ? ((str2) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_STRING) == RUBY_T_SYMBOL) ? ((((VALUE)(str2)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(str2) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(str2) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(str2))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_STRING) == RUBY_T_FLOAT) ? ( ((((int)(long)(str2))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(str2) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(str2) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(str2))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(str2) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(str2) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(str2))->flags & RUBY_T_MASK) == (RUBY_T_STRING)))) ? (void)0 : rb_assert_failure("encoding.c", 881, __func__, "RB_TYPE_P(str2, T_STRING)")), (void)0), ((!(!0 +0) || (( ((RUBY_T_STRING) == RUBY_T_FIXNUM) ? (((int)(long)(str2))&RUBY_FIXNUM_FLAG) : ((RUBY_T_STRING) == RUBY_T_TRUE) ? ((str2) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_STRING) == RUBY_T_FALSE) ? ((str2) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_STRING) == RUBY_T_NIL) ? ((str2) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_STRING) == RUBY_T_UNDEF) ? ((str2) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_STRING) == RUBY_T_SYMBOL) ? ((((VALUE)(str2)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(str2) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(str2) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(str2))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_STRING) == RUBY_T_FLOAT) ? ( ((((int)(long)(str2))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(str2) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(str2) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(str2))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(str2) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(str2) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(str2))->flags & RUBY_T_MASK) == (RUBY_T_STRING))))) ? (void)0 : rb_assert_failure("encoding.c", 881, __func__, "RB_TYPE_P(str2, T_STRING)"))), str2));
    if (!enc)
 rb_raise(rb_eEncCompatError, "incompatible character encodings: %s and %s",
   (rb_enc_get(str1))->name,
   (rb_enc_get(str2))->name);
    return enc;
}
...
enc_compatible_latter(VALUE str1, VALUE str2, int idx1, int idx2)
{
    ...
    isstr2 = ( ((RUBY_T_STRING) == RUBY_T_FIXNUM) ? (((int)(long)(str2))&RUBY_FIXNUM_FLAG) : ((RUBY_T_STRING) == RUBY_T_TRUE) ? ((str2) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_STRING) == RUBY_T_FALSE) ? ((str2) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_STRING) == RUBY_T_NIL) ? ((str2) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_STRING) == RUBY_T_UNDEF) ? ((str2) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_STRING) == RUBY_T_SYMBOL) ? ((((VALUE)(str2)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(str2) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(str2) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(str2))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_STRING) == RUBY_T_FLOAT) ? ( ((((int)(long)(str2))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(str2) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(str2) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(str2))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(str2) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(str2) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(str2))->flags & RUBY_T_MASK) == (RUBY_T_STRING)));
    if (isstr2 && (!(((struct RBasic*)(str2))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(str2))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(str2))->as.heap.len) == 0)
 return enc1;
    isstr1 = ( ((RUBY_T_STRING) == RUBY_T_FIXNUM) ? (((int)(long)(str1))&RUBY_FIXNUM_FLAG) : ((RUBY_T_STRING) == RUBY_T_TRUE) ? ((str1) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_STRING) == RUBY_T_FALSE) ? ((str1) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_STRING) == RUBY_T_NIL) ? ((str1) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_STRING) == RUBY_T_UNDEF) ? ((str1) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_STRING) == RUBY_T_SYMBOL) ? ((((VALUE)(str1)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(str1) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(str1) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(str1))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_STRING) == RUBY_T_FLOAT) ? ( ((((int)(long)(str1))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(str1) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(str1) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(str1))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(str1) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(str1) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(str1))->flags & RUBY_T_MASK) == (RUBY_T_STRING)));
    if (isstr1 && (!(((struct RBasic*)(str1))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(str1))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(str1))->as.heap.len) == 0)
 return (rb_enc_asciicompat_inline(enc1) && rb_enc_str_asciionly_p(str2)) ? enc1 : enc2;
    if (!rb_enc_asciicompat_inline(enc1) || !rb_enc_asciicompat_inline(enc2)) {
 return 0;
    }


    if (!isstr2 && idx2 == RUBY_ENCINDEX_US_ASCII)
 return enc1;
    if (!isstr1 && idx1 == RUBY_ENCINDEX_US_ASCII)
 return enc2;
 ...
 if (isstr2) {
  ...
  if (cr1 == RUBY_ENC_CODERANGE_7BIT) return enc2;
  if (cr2 == RUBY_ENC_CODERANGE_7BIT) return enc1;
     }
     if (cr2 == RUBY_ENC_CODERANGE_7BIT) {
  return enc1;
     }
 }
 if (cr1 == RUBY_ENC_CODERANGE_7BIT)
     return enc2;
    }
    return 0;
}
...
rb_obj_encoding(VALUE obj)
{
 ...
 rb_raise(rb_eTypeError, "unknown encoding");
    ...
    return rb_enc_from_encoding_index(idx & (~(~0U<<24)));
}

int
rb_enc_fast_mbclen(const char *p, const char *e, rb_encoding *enc)
{
    return onigenc_mbclen_approximate((OnigUChar*)p,(OnigUChar*)e,enc);
}

int
rb_enc_mbclen(const char *p, const char *e, rb_encoding *enc)
{
    int n = (enc)->precise_mbc_enc_len((OnigUChar*)p,(OnigUChar*)e,enc);
    if ((0 < (n)) && (n) <= e-p)
        return (n);
    else {
        int min = (enc)->min_enc_len;
...
rb_enc_precise_mbclen(const char *p, const char *e, rb_encoding *enc)
{
    ...
    if (e <= p)
        return (-1-(1));
    n = (enc)->precise_mbc_enc_len((OnigUChar*)p,(OnigUChar*)e,enc);
    if (e-p < n)
        return (-1-(n-(int)(e-p)));
    return n;
}
...
rb_enc_ascget(const char *p, const char *e, int *len, rb_encoding *enc)
{
    ...
    if (!(0 < (l)))
        return -1;
    c = ((enc))->mbc_to_code(((OnigUChar*)(p)),((OnigUChar*)(e)),(enc));
    if (!((c) < 128))
        return -1;
    if (len) *len = l;
    return c;
...
rb_enc_codepoint_len(const char *p, const char *e, int *len_p, rb_encoding *enc)
{
 ...
 rb_raise(rb_eArgError, "invalid byte sequence in %s", (enc)->name);
    ...
    if (len_p) *len_p = (r);
    return ((enc))->mbc_to_code(((OnigUChar*)(p)),((OnigUChar*)(e)),(enc));
}
...
{
    int n = (enc)->code_to_mbclen(c,enc);
    if (n == 0) {
 rb_raise(rb_eArgError, "invalid codepoint 0x%x in %s", c, (enc)->name);
    }
    return n;
}
...
{
    return (enc)->code_to_mbclen(code,enc);
}

int
rb_enc_toupper(int c, rb_encoding *enc)
{
    return (((c) < 0x80)?OnigEncAsciiToUpperCaseTable[c]:(c));
}

int
rb_enc_tolower(int c, rb_encoding *enc)
{
    return (((c) < 0x80)?OnigEncAsciiToLowerCaseTable[c]:(c));
}
static VALUE
enc_inspect(VALUE self)
{
    ...
    if (!((((struct RTypedData*)(self))->typed_flag == 1) && (((struct RTypedData*)(self))->type) == &encoding_data_type)) {
 not_encoding(self);
    }
    if (!(enc = (((struct RData*)(self))->data)) || rb_enc_from_index(rb_enc_to_index(enc)) != enc) {
 rb_raise(rb_eTypeError, "broken Encoding");
    }
    return rb_enc_sprintf(rb_usascii_encoding(),
     "#<%li\v:%s%s%s>", rb_obj_class(self),
     (enc)->name,
     (((enc)->ruby_encoding_index & (1<<24)) ? " (dummy)": ""),
     (!(enc)->max_enc_len) ? " (autoload)": "");
}
static VALUE
enc_name(VALUE self)
{
    return  ({ (__builtin_constant_p(((rb_encoding*)(((struct RData*)(self))->data))->name)) ? rb_fstring_new((((rb_encoding*)(((struct RData*)(self))->data))->name), (long)strlen(((rb_encoding*)(((struct RData*)(self))->data))->name)) : rb_fstring_cstr(((rb_encoding*)(((struct RData*)(self))->data))->name); });
}
...
enc_names_i(st_data_t name, st_data_t idx, st_data_t args)
{
 ...
 VALUE str =  ({ (__builtin_constant_p((char *)name)) ? rb_usascii_str_new_static(((char *)name), (long)strlen((char *)name)) : rb_usascii_str_new_cstr((char *)name); });
...
{
    int idx;
    if ((( ((RUBY_T_DATA) == RUBY_T_FIXNUM) ? (((int)(long)((enc)))&RUBY_FIXNUM_FLAG) : ((RUBY_T_DATA) == RUBY_T_TRUE) ? (((enc)) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_DATA) == RUBY_T_FALSE) ? (((enc)) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_DATA) == RUBY_T_NIL) ? (((enc)) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_DATA) == RUBY_T_UNDEF) ? (((enc)) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_DATA) == RUBY_T_SYMBOL) ? ((((VALUE)((enc))&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)((enc)) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)((enc)) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)((enc)))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_DATA) == RUBY_T_FLOAT) ? ( ((((int)(long)((enc)))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)((enc)) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)((enc)) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)((enc)))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)((enc)) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)((enc)) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)((enc)))->flags & RUBY_T_MASK) == (RUBY_T_DATA))) && ((((struct RTypedData*)(enc))->typed_flag == 1) && (((struct RTypedData*)(enc))->type) == &encoding_data_type)))
 return enc;
    idx = str_to_encindex(enc);
    if (idx == 2147483647) return ((VALUE)RUBY_Qnil);
    return rb_enc_from_encoding_index(idx);
}
static VALUE
enc_compatible_p(VALUE klass, VALUE str1, VALUE str2)
{
    ...
    if (!enc_capable(str1)) return ((VALUE)RUBY_Qnil);
    if (!enc_capable(str2)) return ((VALUE)RUBY_Qnil);
    enc = rb_enc_compatible(str1, str2);
    if (!enc) return ((VALUE)RUBY_Qnil);
...
rb_ascii8bit_encoding(void)
{
 ...
 rb_enc_init();
    ...
    return enc_table.list[RUBY_ENCINDEX_ASCII].enc;
}

int
rb_ascii8bit_encindex(void)
{
    return RUBY_ENCINDEX_ASCII;
}
...
rb_utf8_encoding(void)
{
 ...
 rb_enc_init();
    ...
    return enc_table.list[RUBY_ENCINDEX_UTF_8].enc;
}
...
rb_usascii_encoding(void)
{
 ...
 rb_enc_init();
    ...
    return enc_table.list[RUBY_ENCINDEX_US_ASCII].enc;
}

int
rb_usascii_encindex(void)
{
    return RUBY_ENCINDEX_US_ASCII;
}
...
rb_locale_encindex(void)
{
    ...
    if (idx < 0) idx = RUBY_ENCINDEX_ASCII;
...
enc_set_default_encoding(struct default_encoding *def, VALUE encoding, const char *name)
{
 ...
 def->index = -1;
 def->enc = 0;
 st_insert(enc_table.names, (st_data_t)ruby_strdup(name),
    (st_data_t)2147483647);
    }
    else {
...
set_encoding_const(const char *name, rb_encoding *enc)
{
    ...
    if (rb_isdigit(*s)) return;
    if (rb_isupper(*s)) {
 hasupper = 1;
 while (*++s && (rb_isalnum(*s) || *s == '_')) {
     if (rb_islower(*s)) haslower = 1;
 }
    }
    if (!*s) {
 if (s - name > 63) return;
 ...
 if (!haslower || !hasupper) {
     do {
  if (rb_islower(*s)) haslower = 1;
  if (rb_isupper(*s)) hasupper = 1;
     } while (*++s && (!haslower || !hasupper));
     len = s - name;
 }
 len += strlen(s);
 if (len++ > 63) return;
 memcpy((s = ((char*)__builtin_alloca (sizeof(char)*(len)))), (name), sizeof(char)*(size_t)(len));
 name = s;
 if (!valid) {
     if (rb_islower(*s)) *s = OnigEncAsciiToUpperCaseTable[(int)*s];
     for (; *s; ++s) {
  if (!rb_isalnum(*s)) *s = '_';
     }
     if (hasupper) {
...
{
    VALUE ary = (VALUE)arg;
    VALUE str =  ({ (__builtin_constant_p((char *)name)) ? rb_fstring_new(((char *)name), (long)strlen((char *)name)) : rb_fstring_cstr((char *)name); });
    rb_ary_push(ary, str);
    return ST_CONTINUE;
}
static VALUE
...
{
    VALUE ary = rb_ary_new_capa(enc_table.names->num_entries);
...
rb_enc_aliases_enc_i(st_data_t name, st_data_t orig, st_data_t arg)
{
 ...
 if ((st_locale_insensitive_strcasecmp(((char*)name), ((enc)->name))) == 0) {
     return ST_CONTINUE;
 }
 str =  ({ (__builtin_constant_p((enc)->name)) ? rb_fstring_new(((enc)->name), (long)strlen((enc)->name)) : rb_fstring_cstr((enc)->name); });
 rb_ary_store(ary, idx, str);
    }
    key =  ({ (__builtin_constant_p((char *)name)) ? rb_usascii_str_new_static(((char *)name), (long)strlen((char *)name)) : rb_usascii_str_new_cstr((char *)name); });
    rb_obj_freeze_inline((VALUE)key);
...
Init_Encoding(void)
{
    ...
    rb_undef_method(rb_class_of((VALUE)(rb_cEncoding)), "new");
    ...
    list = rb_ary_new_capa(enc_table.count);
 ...
 rb_ary_push(list, enc_new(enc_table.list[i].enc));
    ...
    rb_marshal_define_compat(rb_cEncoding, ((VALUE)RUBY_Qnil), ((void*)0), enc_m_loader);
}
