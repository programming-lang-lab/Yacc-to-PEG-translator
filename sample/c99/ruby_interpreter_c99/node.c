...
{
    if (id == 0) {
  ({ (__builtin_constant_p(("(null)"))) ? rb_str_cat((buf), (("(null)")), (long)strlen(("(null)"))) : rb_str_cat_cstr((buf), (("(null)"))); });
    }
    else {
 VALUE str = rb_id2str(id);
 if (str) {
      ({ (__builtin_constant_p((":"))) ? rb_str_cat((buf), ((":")), (long)strlen((":"))) : rb_str_cat_cstr((buf), ((":"))); }); rb_str_concat(buf, (str));
 }
 else {
      ({ (__builtin_constant_p(("(internal variable)"))) ? rb_str_cat((buf), (("(internal variable)")), (long)strlen(("(internal variable)"))) : rb_str_cat_cstr((buf), (("(internal variable)"))); });
 }
    }
}
...
add_option_i(VALUE key, VALUE val, VALUE args)
{
    ...
    add_indent(buf, indent);
     ({ (__builtin_constant_p(("+- "))) ? rb_str_cat((buf), (("+- ")), (long)strlen(("+- "))) : rb_str_cat_cstr((buf), (("+- "))); });
    rb_str_concat(buf, (rb_sym2str(key)));
     ({ (__builtin_constant_p((": "))) ? rb_str_cat((buf), ((": ")), (long)strlen((": "))) : rb_str_cat_cstr((buf), ((": "))); });
    rb_str_concat(buf, (rb_inspect(val)));
...
dump_option(VALUE buf, VALUE indent, VALUE opt)
{
    ...
    if (!( ((RUBY_T_HASH) == RUBY_T_FIXNUM) ? (((int)(long)(opt))&RUBY_FIXNUM_FLAG) : ((RUBY_T_HASH) == RUBY_T_TRUE) ? ((opt) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_HASH) == RUBY_T_FALSE) ? ((opt) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_HASH) == RUBY_T_NIL) ? ((opt) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_HASH) == RUBY_T_UNDEF) ? ((opt) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_HASH) == RUBY_T_SYMBOL) ? ((((VALUE)(opt)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(opt) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(opt) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(opt))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_HASH) == RUBY_T_FLOAT) ? ( ((((int)(long)(opt))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(opt) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(opt) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(opt))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(opt) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(opt) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(opt))->flags & RUBY_T_MASK) == (RUBY_T_HASH)))) {
 rb_str_concat(buf, (rb_inspect(opt)));
 return;
    }
    arg.buf = buf;
    arg.indent = indent;
...
dump_array(VALUE buf, VALUE indent, int comment, NODE *node)
{
    ...
    for ((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s: ", (((int)( comment ? (sizeof("nd_alen (length)") - 1) : (sizeof("nd_alen") - 1)))), (("nd_alen (length)")))), field_flag = 1; field_flag;  ({ (__builtin_constant_p(("\n"))) ? rb_str_cat((buf), (("\n")), (long)strlen(("\n"))) : rb_str_cat_cstr((buf), (("\n"))); }), field_flag = 0) rb_str_catf(buf, "%ld", (node->u2.argc));
    for (((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s:\n", (((int)( comment ? (sizeof("nd_head (element)") - 1) : (sizeof("nd_head") - 1)))), (("nd_head (element)")))),  ({ (__builtin_constant_p(next_indent)) ? rb_str_cat((indent), (next_indent), (long)strlen(next_indent)) : rb_str_cat_cstr((indent), (next_indent)); })), field_flag = 1; field_flag; rb_str_resize(indent, (!(((struct RBasic*)(indent))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(indent))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(indent))->as.heap.len) - 4), field_flag = 0) {dump_node(buf, indent, comment, node->u1.node);};
    while (node->u3.node && ((int) (((node->u3.node)->flags & (((VALUE)0x7f)<<8))>>8)) == NODE_ARRAY) {
 node = node->u3.node;
 for (((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s:\n", (((int)( comment ? (sizeof("nd_head (element)") - 1) : (sizeof("nd_head") - 1)))), (("nd_head (element)")))),  ({ (__builtin_constant_p(next_indent)) ? rb_str_cat((indent), (next_indent), (long)strlen(next_indent)) : rb_str_cat_cstr((indent), (next_indent)); })), field_flag = 1; field_flag; rb_str_resize(indent, (!(((struct RBasic*)(indent))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(indent))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(indent))->as.heap.len) - 4), field_flag = 0) {dump_node(buf, indent, comment, node->u1.node);};
    }
    (next_indent = "    ");
    for (((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s:\n", (((int)( comment ? (sizeof("nd_next (next element)") - 1) : (sizeof("nd_next") - 1)))), (("nd_next (next element)")))),  ({ (__builtin_constant_p(next_indent)) ? rb_str_cat((indent), (next_indent), (long)strlen(next_indent)) : rb_str_cat_cstr((indent), (next_indent)); })), field_flag = 1; field_flag; rb_str_resize(indent, (!(((struct RBasic*)(indent))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(indent))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(indent))->as.heap.len) - 4), field_flag = 0) {dump_node(buf, indent, comment, node->u3.node);};
}
...
dump_node(VALUE buf, VALUE indent, int comment, NODE *node)
{
    ...
    if (!node) {
 (add_indent(buf, indent),  ({ (__builtin_constant_p(("(null node)\n"))) ? rb_str_cat((buf), (("(null node)\n")), (long)strlen(("(null node)\n"))) : rb_str_cat_cstr((buf), (("(null node)\n"))); }));
 return;
    }

    (add_indent(buf, indent), rb_str_catf(buf, "@ %s (line: %d, code_range: (%d,%d)-(%d,%d))\n", ruby_node_name(((int) (((node)->flags & (((VALUE)0x7f)<<8))>>8))), (int)(((long)(node)->flags)>>(8 +7)), ((int)((node)->nd_loc.first_loc.lineno)), ((int)((node)->nd_loc.first_loc.column)), ((int)((node)->nd_loc.last_loc.lineno)), ((int)((node)->nd_loc.last_loc.column))));

    type = ((int) (((node)->flags & (((VALUE)0x7f)<<8))>>8));
    switch (type) {
      case NODE_BLOCK:
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # statement sequence\n"))) ? rb_str_cat((buf), (("| # statement sequence\n")), (long)strlen(("| # statement sequence\n"))) : rb_str_cat_cstr((buf), (("| # statement sequence\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # format: [nd_head]; ...; [nd_next]\n"))) ? rb_str_cat((buf), (("| # format: [nd_head]; ...; [nd_next]\n")), (long)strlen(("| # format: [nd_head]; ...; [nd_next]\n"))) : rb_str_cat_cstr((buf), (("| # format: [nd_head]; ...; [nd_next]\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # example: foo; bar\n"))) ? rb_str_cat((buf), (("| # example: foo; bar\n")), (long)strlen(("| # example: foo; bar\n"))) : rb_str_cat_cstr((buf), (("| # example: foo; bar\n"))); }); };
 i = 0;
 do {
     add_indent(buf, indent);
     rb_str_catf(buf, "+- nd_head (%s%d):\n",
   comment ? "statement #": "", ++i);
     if (!node->u3.node) (next_indent = "    ");
      ({ (__builtin_constant_p(next_indent)) ? rb_str_cat((indent), (next_indent), (long)strlen(next_indent)) : rb_str_cat_cstr((indent), (next_indent)); });
     dump_node(buf, indent, comment, node->u1.node);
     rb_str_resize(indent, (!(((struct RBasic*)(indent))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(indent))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(indent))->as.heap.len) - 4);
 } while (node->u3.node &&
   ((int) (((node->u3.node)->flags & (((VALUE)0x7f)<<8))>>8)) == NODE_BLOCK &&
   (node = node->u3.node, 1));
 if (node->u3.node) {
     (next_indent = "    ");
     for (((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s:\n", (((int)( comment ? (sizeof("nd_next (next block)") - 1) : (sizeof("nd_next") - 1)))), (("nd_next (next block)")))),  ({ (__builtin_constant_p(next_indent)) ? rb_str_cat((indent), (next_indent), (long)strlen(next_indent)) : rb_str_cat_cstr((indent), (next_indent)); })), field_flag = 1; field_flag; rb_str_resize(indent, (!(((struct RBasic*)(indent))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(indent))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(indent))->as.heap.len) - 4), field_flag = 0) {dump_node(buf, indent, comment, node->u3.node);};
 }
 return;

      case NODE_IF:
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # if statement\n"))) ? rb_str_cat((buf), (("| # if statement\n")), (long)strlen(("| # if statement\n"))) : rb_str_cat_cstr((buf), (("| # if statement\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # format: if [nd_cond] then [nd_body] else [nd_else] end\n"))) ? rb_str_cat((buf), (("| # format: if [nd_cond] then [nd_body] else [nd_else] end\n")), (long)strlen(("| # format: if [nd_cond] then [nd_body] else [nd_else] end\n"))) : rb_str_cat_cstr((buf), (("| # format: if [nd_cond] then [nd_body] else [nd_else] end\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # example: if x == 1 then foo else bar end\n"))) ? rb_str_cat((buf), (("| # example: if x == 1 then foo else bar end\n")), (long)strlen(("| # example: if x == 1 then foo else bar end\n"))) : rb_str_cat_cstr((buf), (("| # example: if x == 1 then foo else bar end\n"))); }); };
 for (((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s:\n", (((int)( comment ? (sizeof("nd_cond (condition expr)") - 1) : (sizeof("nd_cond") - 1)))), (("nd_cond (condition expr)")))),  ({ (__builtin_constant_p(next_indent)) ? rb_str_cat((indent), (next_indent), (long)strlen(next_indent)) : rb_str_cat_cstr((indent), (next_indent)); })), field_flag = 1; field_flag; rb_str_resize(indent, (!(((struct RBasic*)(indent))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(indent))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(indent))->as.heap.len) - 4), field_flag = 0) {dump_node(buf, indent, comment, node->u1.node);};
 for (((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s:\n", (((int)( comment ? (sizeof("nd_body (then clause)") - 1) : (sizeof("nd_body") - 1)))), (("nd_body (then clause)")))),  ({ (__builtin_constant_p(next_indent)) ? rb_str_cat((indent), (next_indent), (long)strlen(next_indent)) : rb_str_cat_cstr((indent), (next_indent)); })), field_flag = 1; field_flag; rb_str_resize(indent, (!(((struct RBasic*)(indent))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(indent))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(indent))->as.heap.len) - 4), field_flag = 0) {dump_node(buf, indent, comment, node->u2.node);};
 (next_indent = "    ");
 for (((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s:\n", (((int)( comment ? (sizeof("nd_else (else clause)") - 1) : (sizeof("nd_else") - 1)))), (("nd_else (else clause)")))),  ({ (__builtin_constant_p(next_indent)) ? rb_str_cat((indent), (next_indent), (long)strlen(next_indent)) : rb_str_cat_cstr((indent), (next_indent)); })), field_flag = 1; field_flag; rb_str_resize(indent, (!(((struct RBasic*)(indent))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(indent))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(indent))->as.heap.len) - 4), field_flag = 0) {dump_node(buf, indent, comment, node->u3.node);};
 return;

      case NODE_UNLESS:
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # unless statement\n"))) ? rb_str_cat((buf), (("| # unless statement\n")), (long)strlen(("| # unless statement\n"))) : rb_str_cat_cstr((buf), (("| # unless statement\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # format: unless [nd_cond] then [nd_body] else [nd_else] end\n"))) ? rb_str_cat((buf), (("| # format: unless [nd_cond] then [nd_body] else [nd_else] end\n")), (long)strlen(("| # format: unless [nd_cond] then [nd_body] else [nd_else] end\n"))) : rb_str_cat_cstr((buf), (("| # format: unless [nd_cond] then [nd_body] else [nd_else] end\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # example: unless x == 1 then foo else bar end\n"))) ? rb_str_cat((buf), (("| # example: unless x == 1 then foo else bar end\n")), (long)strlen(("| # example: unless x == 1 then foo else bar end\n"))) : rb_str_cat_cstr((buf), (("| # example: unless x == 1 then foo else bar end\n"))); }); };
 for (((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s:\n", (((int)( comment ? (sizeof("nd_cond (condition expr)") - 1) : (sizeof("nd_cond") - 1)))), (("nd_cond (condition expr)")))),  ({ (__builtin_constant_p(next_indent)) ? rb_str_cat((indent), (next_indent), (long)strlen(next_indent)) : rb_str_cat_cstr((indent), (next_indent)); })), field_flag = 1; field_flag; rb_str_resize(indent, (!(((struct RBasic*)(indent))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(indent))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(indent))->as.heap.len) - 4), field_flag = 0) {dump_node(buf, indent, comment, node->u1.node);};
 for (((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s:\n", (((int)( comment ? (sizeof("nd_body (then clause)") - 1) : (sizeof("nd_body") - 1)))), (("nd_body (then clause)")))),  ({ (__builtin_constant_p(next_indent)) ? rb_str_cat((indent), (next_indent), (long)strlen(next_indent)) : rb_str_cat_cstr((indent), (next_indent)); })), field_flag = 1; field_flag; rb_str_resize(indent, (!(((struct RBasic*)(indent))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(indent))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(indent))->as.heap.len) - 4), field_flag = 0) {dump_node(buf, indent, comment, node->u2.node);};
 (next_indent = "    ");
 for (((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s:\n", (((int)( comment ? (sizeof("nd_else (else clause)") - 1) : (sizeof("nd_else") - 1)))), (("nd_else (else clause)")))),  ({ (__builtin_constant_p(next_indent)) ? rb_str_cat((indent), (next_indent), (long)strlen(next_indent)) : rb_str_cat_cstr((indent), (next_indent)); })), field_flag = 1; field_flag; rb_str_resize(indent, (!(((struct RBasic*)(indent))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(indent))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(indent))->as.heap.len) - 4), field_flag = 0) {dump_node(buf, indent, comment, node->u3.node);};
 return;
      ...
      case NODE_CASE:
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # case statement\n"))) ? rb_str_cat((buf), (("| # case statement\n")), (long)strlen(("| # case statement\n"))) : rb_str_cat_cstr((buf), (("| # case statement\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # format: case [nd_head]; [nd_body]; end\n"))) ? rb_str_cat((buf), (("| # format: case [nd_head]; [nd_body]; end\n")), (long)strlen(("| # format: case [nd_head]; [nd_body]; end\n"))) : rb_str_cat_cstr((buf), (("| # format: case [nd_head]; [nd_body]; end\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # example: case x; when 1; foo; when 2; bar; else baz; end\n"))) ? rb_str_cat((buf), (("| # example: case x; when 1; foo; when 2; bar; else baz; end\n")), (long)strlen(("| # example: case x; when 1; foo; when 2; bar; else baz; end\n"))) : rb_str_cat_cstr((buf), (("| # example: case x; when 1; foo; when 2; bar; else baz; end\n"))); }); };
 for (((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s:\n", (((int)( comment ? (sizeof("nd_head (case expr)") - 1) : (sizeof("nd_head") - 1)))), (("nd_head (case expr)")))),  ({ (__builtin_constant_p(next_indent)) ? rb_str_cat((indent), (next_indent), (long)strlen(next_indent)) : rb_str_cat_cstr((indent), (next_indent)); })), field_flag = 1; field_flag; rb_str_resize(indent, (!(((struct RBasic*)(indent))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(indent))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(indent))->as.heap.len) - 4), field_flag = 0) {dump_node(buf, indent, comment, node->u1.node);};
 (next_indent = "    ");
 for (((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s:\n", (((int)( comment ? (sizeof("nd_body (when clauses)") - 1) : (sizeof("nd_body") - 1)))), (("nd_body (when clauses)")))),  ({ (__builtin_constant_p(next_indent)) ? rb_str_cat((indent), (next_indent), (long)strlen(next_indent)) : rb_str_cat_cstr((indent), (next_indent)); })), field_flag = 1; field_flag; rb_str_resize(indent, (!(((struct RBasic*)(indent))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(indent))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(indent))->as.heap.len) - 4), field_flag = 0) {dump_node(buf, indent, comment, node->u2.node);};
 return;
      case NODE_CASE2:
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # case statement with no head\n"))) ? rb_str_cat((buf), (("| # case statement with no head\n")), (long)strlen(("| # case statement with no head\n"))) : rb_str_cat_cstr((buf), (("| # case statement with no head\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # format: case; [nd_body]; end\n"))) ? rb_str_cat((buf), (("| # format: case; [nd_body]; end\n")), (long)strlen(("| # format: case; [nd_body]; end\n"))) : rb_str_cat_cstr((buf), (("| # format: case; [nd_body]; end\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # example: case; when 1; foo; when 2; bar; else baz; end\n"))) ? rb_str_cat((buf), (("| # example: case; when 1; foo; when 2; bar; else baz; end\n")), (long)strlen(("| # example: case; when 1; foo; when 2; bar; else baz; end\n"))) : rb_str_cat_cstr((buf), (("| # example: case; when 1; foo; when 2; bar; else baz; end\n"))); }); };
 for (((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s:\n", (((int)( comment ? (sizeof("nd_head (case expr)") - 1) : (sizeof("nd_head") - 1)))), (("nd_head (case expr)")))),  ({ (__builtin_constant_p(next_indent)) ? rb_str_cat((indent), (next_indent), (long)strlen(next_indent)) : rb_str_cat_cstr((indent), (next_indent)); })), field_flag = 1; field_flag; rb_str_resize(indent, (!(((struct RBasic*)(indent))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(indent))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(indent))->as.heap.len) - 4), field_flag = 0) {dump_node(buf, indent, comment, node->u1.node);};
 (next_indent = "    ");
 for (((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s:\n", (((int)( comment ? (sizeof("nd_body (when clauses)") - 1) : (sizeof("nd_body") - 1)))), (("nd_body (when clauses)")))),  ({ (__builtin_constant_p(next_indent)) ? rb_str_cat((indent), (next_indent), (long)strlen(next_indent)) : rb_str_cat_cstr((indent), (next_indent)); })), field_flag = 1; field_flag; rb_str_resize(indent, (!(((struct RBasic*)(indent))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(indent))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(indent))->as.heap.len) - 4), field_flag = 0) {dump_node(buf, indent, comment, node->u2.node);};
 return;
      ...
      case NODE_WHEN:
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # when clause\n"))) ? rb_str_cat((buf), (("| # when clause\n")), (long)strlen(("| # when clause\n"))) : rb_str_cat_cstr((buf), (("| # when clause\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # format: when [nd_head]; [nd_body]; (when or else) [nd_next]\n"))) ? rb_str_cat((buf), (("| # format: when [nd_head]; [nd_body]; (when or else) [nd_next]\n")), (long)strlen(("| # format: when [nd_head]; [nd_body]; (when or else) [nd_next]\n"))) : rb_str_cat_cstr((buf), (("| # format: when [nd_head]; [nd_body]; (when or else) [nd_next]\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # example: case x; when 1; foo; when 2; bar; else baz; end\n"))) ? rb_str_cat((buf), (("| # example: case x; when 1; foo; when 2; bar; else baz; end\n")), (long)strlen(("| # example: case x; when 1; foo; when 2; bar; else baz; end\n"))) : rb_str_cat_cstr((buf), (("| # example: case x; when 1; foo; when 2; bar; else baz; end\n"))); }); };
 for (((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s:\n", (((int)( comment ? (sizeof("nd_head (when value)") - 1) : (sizeof("nd_head") - 1)))), (("nd_head (when value)")))),  ({ (__builtin_constant_p(next_indent)) ? rb_str_cat((indent), (next_indent), (long)strlen(next_indent)) : rb_str_cat_cstr((indent), (next_indent)); })), field_flag = 1; field_flag; rb_str_resize(indent, (!(((struct RBasic*)(indent))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(indent))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(indent))->as.heap.len) - 4), field_flag = 0) {dump_node(buf, indent, comment, node->u1.node);};
 for (((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s:\n", (((int)( comment ? (sizeof("nd_body (when body)") - 1) : (sizeof("nd_body") - 1)))), (("nd_body (when body)")))),  ({ (__builtin_constant_p(next_indent)) ? rb_str_cat((indent), (next_indent), (long)strlen(next_indent)) : rb_str_cat_cstr((indent), (next_indent)); })), field_flag = 1; field_flag; rb_str_resize(indent, (!(((struct RBasic*)(indent))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(indent))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(indent))->as.heap.len) - 4), field_flag = 0) {dump_node(buf, indent, comment, node->u2.node);};
 (next_indent = "    ");
 for (((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s:\n", (((int)( comment ? (sizeof("nd_next (next when clause)") - 1) : (sizeof("nd_next") - 1)))), (("nd_next (next when clause)")))),  ({ (__builtin_constant_p(next_indent)) ? rb_str_cat((indent), (next_indent), (long)strlen(next_indent)) : rb_str_cat_cstr((indent), (next_indent)); })), field_flag = 1; field_flag; rb_str_resize(indent, (!(((struct RBasic*)(indent))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(indent))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(indent))->as.heap.len) - 4), field_flag = 0) {dump_node(buf, indent, comment, node->u3.node);};
 return;

      case NODE_WHILE:
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # while statement\n"))) ? rb_str_cat((buf), (("| # while statement\n")), (long)strlen(("| # while statement\n"))) : rb_str_cat_cstr((buf), (("| # while statement\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # format: while [nd_cond]; [nd_body]; end\n"))) ? rb_str_cat((buf), (("| # format: while [nd_cond]; [nd_body]; end\n")), (long)strlen(("| # format: while [nd_cond]; [nd_body]; end\n"))) : rb_str_cat_cstr((buf), (("| # format: while [nd_cond]; [nd_body]; end\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # example: while x == 1; foo; end\n"))) ? rb_str_cat((buf), (("| # example: while x == 1; foo; end\n")), (long)strlen(("| # example: while x == 1; foo; end\n"))) : rb_str_cat_cstr((buf), (("| # example: while x == 1; foo; end\n"))); }); };
 goto loop;
      case NODE_UNTIL:
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # until statement\n"))) ? rb_str_cat((buf), (("| # until statement\n")), (long)strlen(("| # until statement\n"))) : rb_str_cat_cstr((buf), (("| # until statement\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # format: until [nd_cond]; [nd_body]; end\n"))) ? rb_str_cat((buf), (("| # format: until [nd_cond]; [nd_body]; end\n")), (long)strlen(("| # format: until [nd_cond]; [nd_body]; end\n"))) : rb_str_cat_cstr((buf), (("| # format: until [nd_cond]; [nd_body]; end\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # example: until x == 1; foo; end\n"))) ? rb_str_cat((buf), (("| # example: until x == 1; foo; end\n")), (long)strlen(("| # example: until x == 1; foo; end\n"))) : rb_str_cat_cstr((buf), (("| # example: until x == 1; foo; end\n"))); }); };
      loop:
 for ((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s: ", (((int)( comment ? (sizeof("nd_state (begin-end-while?)") - 1) : (sizeof("nd_state") - 1)))), (("nd_state (begin-end-while?)")))), field_flag = 1; field_flag;  ({ (__builtin_constant_p(("\n"))) ? rb_str_cat((buf), (("\n")), (long)strlen(("\n"))) : rb_str_cat_cstr((buf), (("\n"))); }), field_flag = 0) {
     rb_str_catf(buf, "%d", ((int)node->u3.state));
      ({ (__builtin_constant_p(((node->u3.state == 1) ? " (while-end)": " (begin-end-while)"))) ? rb_str_cat((buf), (((node->u3.state == 1) ? " (while-end)": " (begin-end-while)")), (long)strlen(((node->u3.state == 1) ? " (while-end)": " (begin-end-while)"))) : rb_str_cat_cstr((buf), (((node->u3.state == 1) ? " (while-end)": " (begin-end-while)"))); });
 }
 for (((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s:\n", (((int)( comment ? (sizeof("nd_cond (condition)") - 1) : (sizeof("nd_cond") - 1)))), (("nd_cond (condition)")))),  ({ (__builtin_constant_p(next_indent)) ? rb_str_cat((indent), (next_indent), (long)strlen(next_indent)) : rb_str_cat_cstr((indent), (next_indent)); })), field_flag = 1; field_flag; rb_str_resize(indent, (!(((struct RBasic*)(indent))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(indent))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(indent))->as.heap.len) - 4), field_flag = 0) {dump_node(buf, indent, comment, node->u1.node);};
 (next_indent = "    ");
 for (((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s:\n", (((int)( comment ? (sizeof("nd_body (body)") - 1) : (sizeof("nd_body") - 1)))), (("nd_body (body)")))),  ({ (__builtin_constant_p(next_indent)) ? rb_str_cat((indent), (next_indent), (long)strlen(next_indent)) : rb_str_cat_cstr((indent), (next_indent)); })), field_flag = 1; field_flag; rb_str_resize(indent, (!(((struct RBasic*)(indent))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(indent))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(indent))->as.heap.len) - 4), field_flag = 0) {dump_node(buf, indent, comment, node->u2.node);};
 return;

      case NODE_ITER:
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # method call with block\n"))) ? rb_str_cat((buf), (("| # method call with block\n")), (long)strlen(("| # method call with block\n"))) : rb_str_cat_cstr((buf), (("| # method call with block\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # format: [nd_iter] { [nd_body] }\n"))) ? rb_str_cat((buf), (("| # format: [nd_iter] { [nd_body] }\n")), (long)strlen(("| # format: [nd_iter] { [nd_body] }\n"))) : rb_str_cat_cstr((buf), (("| # format: [nd_iter] { [nd_body] }\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # example: 3.times { foo }\n"))) ? rb_str_cat((buf), (("| # example: 3.times { foo }\n")), (long)strlen(("| # example: 3.times { foo }\n"))) : rb_str_cat_cstr((buf), (("| # example: 3.times { foo }\n"))); }); };
 goto iter;
      case NODE_FOR:
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # for statement\n"))) ? rb_str_cat((buf), (("| # for statement\n")), (long)strlen(("| # for statement\n"))) : rb_str_cat_cstr((buf), (("| # for statement\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # format: for * in [nd_iter] do [nd_body] end\n"))) ? rb_str_cat((buf), (("| # format: for * in [nd_iter] do [nd_body] end\n")), (long)strlen(("| # format: for * in [nd_iter] do [nd_body] end\n"))) : rb_str_cat_cstr((buf), (("| # format: for * in [nd_iter] do [nd_body] end\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # example: for i in 1..3 do foo end\n"))) ? rb_str_cat((buf), (("| # example: for i in 1..3 do foo end\n")), (long)strlen(("| # example: for i in 1..3 do foo end\n"))) : rb_str_cat_cstr((buf), (("| # example: for i in 1..3 do foo end\n"))); }); };
      iter:
 for (((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s:\n", (((int)( comment ? (sizeof("nd_iter (iteration receiver)") - 1) : (sizeof("nd_iter") - 1)))), (("nd_iter (iteration receiver)")))),  ({ (__builtin_constant_p(next_indent)) ? rb_str_cat((indent), (next_indent), (long)strlen(next_indent)) : rb_str_cat_cstr((indent), (next_indent)); })), field_flag = 1; field_flag; rb_str_resize(indent, (!(((struct RBasic*)(indent))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(indent))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(indent))->as.heap.len) - 4), field_flag = 0) {dump_node(buf, indent, comment, node->u3.node);};
 (next_indent = "    ");
 for (((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s:\n", (((int)( comment ? (sizeof("nd_body (body)") - 1) : (sizeof("nd_body") - 1)))), (("nd_body (body)")))),  ({ (__builtin_constant_p(next_indent)) ? rb_str_cat((indent), (next_indent), (long)strlen(next_indent)) : rb_str_cat_cstr((indent), (next_indent)); })), field_flag = 1; field_flag; rb_str_resize(indent, (!(((struct RBasic*)(indent))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(indent))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(indent))->as.heap.len) - 4), field_flag = 0) {dump_node(buf, indent, comment, node->u2.node);};
 return;

      case NODE_BREAK:
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # break statement\n"))) ? rb_str_cat((buf), (("| # break statement\n")), (long)strlen(("| # break statement\n"))) : rb_str_cat_cstr((buf), (("| # break statement\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # format: break [nd_stts]\n"))) ? rb_str_cat((buf), (("| # format: break [nd_stts]\n")), (long)strlen(("| # format: break [nd_stts]\n"))) : rb_str_cat_cstr((buf), (("| # format: break [nd_stts]\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # example: break 1\n"))) ? rb_str_cat((buf), (("| # example: break 1\n")), (long)strlen(("| # example: break 1\n"))) : rb_str_cat_cstr((buf), (("| # example: break 1\n"))); }); };
 goto jump;
      case NODE_NEXT:
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # next statement\n"))) ? rb_str_cat((buf), (("| # next statement\n")), (long)strlen(("| # next statement\n"))) : rb_str_cat_cstr((buf), (("| # next statement\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # format: next [nd_stts]\n"))) ? rb_str_cat((buf), (("| # format: next [nd_stts]\n")), (long)strlen(("| # format: next [nd_stts]\n"))) : rb_str_cat_cstr((buf), (("| # format: next [nd_stts]\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # example: next 1\n"))) ? rb_str_cat((buf), (("| # example: next 1\n")), (long)strlen(("| # example: next 1\n"))) : rb_str_cat_cstr((buf), (("| # example: next 1\n"))); }); };
 goto jump;
      case NODE_RETURN:
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # return statement\n"))) ? rb_str_cat((buf), (("| # return statement\n")), (long)strlen(("| # return statement\n"))) : rb_str_cat_cstr((buf), (("| # return statement\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # format: return [nd_stts]\n"))) ? rb_str_cat((buf), (("| # format: return [nd_stts]\n")), (long)strlen(("| # format: return [nd_stts]\n"))) : rb_str_cat_cstr((buf), (("| # format: return [nd_stts]\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # example: return 1\n"))) ? rb_str_cat((buf), (("| # example: return 1\n")), (long)strlen(("| # example: return 1\n"))) : rb_str_cat_cstr((buf), (("| # example: return 1\n"))); }); };
      jump:
 (next_indent = "    ");
 for (((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s:\n", (((int)( comment ? (sizeof("nd_stts (value)") - 1) : (sizeof("nd_stts") - 1)))), (("nd_stts (value)")))),  ({ (__builtin_constant_p(next_indent)) ? rb_str_cat((indent), (next_indent), (long)strlen(next_indent)) : rb_str_cat_cstr((indent), (next_indent)); })), field_flag = 1; field_flag; rb_str_resize(indent, (!(((struct RBasic*)(indent))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(indent))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(indent))->as.heap.len) - 4), field_flag = 0) {dump_node(buf, indent, comment, node->u1.node);};
 return;

      case NODE_REDO:
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # redo statement\n"))) ? rb_str_cat((buf), (("| # redo statement\n")), (long)strlen(("| # redo statement\n"))) : rb_str_cat_cstr((buf), (("| # redo statement\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # format: redo\n"))) ? rb_str_cat((buf), (("| # format: redo\n")), (long)strlen(("| # format: redo\n"))) : rb_str_cat_cstr((buf), (("| # format: redo\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # example: redo\n"))) ? rb_str_cat((buf), (("| # example: redo\n")), (long)strlen(("| # example: redo\n"))) : rb_str_cat_cstr((buf), (("| # example: redo\n"))); }); };
 return;

      case NODE_RETRY:
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # retry statement\n"))) ? rb_str_cat((buf), (("| # retry statement\n")), (long)strlen(("| # retry statement\n"))) : rb_str_cat_cstr((buf), (("| # retry statement\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # format: retry\n"))) ? rb_str_cat((buf), (("| # format: retry\n")), (long)strlen(("| # format: retry\n"))) : rb_str_cat_cstr((buf), (("| # format: retry\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # example: retry\n"))) ? rb_str_cat((buf), (("| # example: retry\n")), (long)strlen(("| # example: retry\n"))) : rb_str_cat_cstr((buf), (("| # example: retry\n"))); }); };
 return;

      case NODE_BEGIN:
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # begin statement\n"))) ? rb_str_cat((buf), (("| # begin statement\n")), (long)strlen(("| # begin statement\n"))) : rb_str_cat_cstr((buf), (("| # begin statement\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # format: begin; [nd_body]; end\n"))) ? rb_str_cat((buf), (("| # format: begin; [nd_body]; end\n")), (long)strlen(("| # format: begin; [nd_body]; end\n"))) : rb_str_cat_cstr((buf), (("| # format: begin; [nd_body]; end\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # example: begin; 1; end\n"))) ? rb_str_cat((buf), (("| # example: begin; 1; end\n")), (long)strlen(("| # example: begin; 1; end\n"))) : rb_str_cat_cstr((buf), (("| # example: begin; 1; end\n"))); }); };
 (next_indent = "    ");
 for (((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s:\n", (((int)( comment ? (sizeof("nd_body (body)") - 1) : (sizeof("nd_body") - 1)))), (("nd_body (body)")))),  ({ (__builtin_constant_p(next_indent)) ? rb_str_cat((indent), (next_indent), (long)strlen(next_indent)) : rb_str_cat_cstr((indent), (next_indent)); })), field_flag = 1; field_flag; rb_str_resize(indent, (!(((struct RBasic*)(indent))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(indent))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(indent))->as.heap.len) - 4), field_flag = 0) {dump_node(buf, indent, comment, node->u2.node);};
 return;

      case NODE_RESCUE:
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # rescue clause\n"))) ? rb_str_cat((buf), (("| # rescue clause\n")), (long)strlen(("| # rescue clause\n"))) : rb_str_cat_cstr((buf), (("| # rescue clause\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # format: begin; [nd_body]; (rescue) [nd_resq]; else [nd_else]; end\n"))) ? rb_str_cat((buf), (("| # format: begin; [nd_body]; (rescue) [nd_resq]; else [nd_else]; end\n")), (long)strlen(("| # format: begin; [nd_body]; (rescue) [nd_resq]; else [nd_else]; end\n"))) : rb_str_cat_cstr((buf), (("| # format: begin; [nd_body]; (rescue) [nd_resq]; else [nd_else]; end\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # example: begin; foo; rescue; bar; else; baz; end\n"))) ? rb_str_cat((buf), (("| # example: begin; foo; rescue; bar; else; baz; end\n")), (long)strlen(("| # example: begin; foo; rescue; bar; else; baz; end\n"))) : rb_str_cat_cstr((buf), (("| # example: begin; foo; rescue; bar; else; baz; end\n"))); }); };
 for (((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s:\n", (((int)( comment ? (sizeof("nd_head (body)") - 1) : (sizeof("nd_head") - 1)))), (("nd_head (body)")))),  ({ (__builtin_constant_p(next_indent)) ? rb_str_cat((indent), (next_indent), (long)strlen(next_indent)) : rb_str_cat_cstr((indent), (next_indent)); })), field_flag = 1; field_flag; rb_str_resize(indent, (!(((struct RBasic*)(indent))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(indent))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(indent))->as.heap.len) - 4), field_flag = 0) {dump_node(buf, indent, comment, node->u1.node);};
 for (((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s:\n", (((int)( comment ? (sizeof("nd_resq (rescue clause list)") - 1) : (sizeof("nd_resq") - 1)))), (("nd_resq (rescue clause list)")))),  ({ (__builtin_constant_p(next_indent)) ? rb_str_cat((indent), (next_indent), (long)strlen(next_indent)) : rb_str_cat_cstr((indent), (next_indent)); })), field_flag = 1; field_flag; rb_str_resize(indent, (!(((struct RBasic*)(indent))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(indent))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(indent))->as.heap.len) - 4), field_flag = 0) {dump_node(buf, indent, comment, node->u2.node);};
 (next_indent = "    ");
 for (((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s:\n", (((int)( comment ? (sizeof("nd_else (rescue else clause)") - 1) : (sizeof("nd_else") - 1)))), (("nd_else (rescue else clause)")))),  ({ (__builtin_constant_p(next_indent)) ? rb_str_cat((indent), (next_indent), (long)strlen(next_indent)) : rb_str_cat_cstr((indent), (next_indent)); })), field_flag = 1; field_flag; rb_str_resize(indent, (!(((struct RBasic*)(indent))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(indent))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(indent))->as.heap.len) - 4), field_flag = 0) {dump_node(buf, indent, comment, node->u3.node);};
 return;

      case NODE_RESBODY:
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # rescue clause (cont'd)\n"))) ? rb_str_cat((buf), (("| # rescue clause (cont'd)\n")), (long)strlen(("| # rescue clause (cont'd)\n"))) : rb_str_cat_cstr((buf), (("| # rescue clause (cont'd)\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # format: rescue [nd_args]; [nd_body]; (rescue) [nd_head]\n"))) ? rb_str_cat((buf), (("| # format: rescue [nd_args]; [nd_body]; (rescue) [nd_head]\n")), (long)strlen(("| # format: rescue [nd_args]; [nd_body]; (rescue) [nd_head]\n"))) : rb_str_cat_cstr((buf), (("| # format: rescue [nd_args]; [nd_body]; (rescue) [nd_head]\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # example: begin; foo; rescue; bar; else; baz; end\n"))) ? rb_str_cat((buf), (("| # example: begin; foo; rescue; bar; else; baz; end\n")), (long)strlen(("| # example: begin; foo; rescue; bar; else; baz; end\n"))) : rb_str_cat_cstr((buf), (("| # example: begin; foo; rescue; bar; else; baz; end\n"))); }); };
 for (((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s:\n", (((int)( comment ? (sizeof("nd_args (rescue exceptions)") - 1) : (sizeof("nd_args") - 1)))), (("nd_args (rescue exceptions)")))),  ({ (__builtin_constant_p(next_indent)) ? rb_str_cat((indent), (next_indent), (long)strlen(next_indent)) : rb_str_cat_cstr((indent), (next_indent)); })), field_flag = 1; field_flag; rb_str_resize(indent, (!(((struct RBasic*)(indent))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(indent))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(indent))->as.heap.len) - 4), field_flag = 0) {dump_node(buf, indent, comment, node->u3.node);};
 for (((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s:\n", (((int)( comment ? (sizeof("nd_body (rescue clause)") - 1) : (sizeof("nd_body") - 1)))), (("nd_body (rescue clause)")))),  ({ (__builtin_constant_p(next_indent)) ? rb_str_cat((indent), (next_indent), (long)strlen(next_indent)) : rb_str_cat_cstr((indent), (next_indent)); })), field_flag = 1; field_flag; rb_str_resize(indent, (!(((struct RBasic*)(indent))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(indent))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(indent))->as.heap.len) - 4), field_flag = 0) {dump_node(buf, indent, comment, node->u2.node);};
 (next_indent = "    ");
 for (((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s:\n", (((int)( comment ? (sizeof("nd_head (next rescue clause)") - 1) : (sizeof("nd_head") - 1)))), (("nd_head (next rescue clause)")))),  ({ (__builtin_constant_p(next_indent)) ? rb_str_cat((indent), (next_indent), (long)strlen(next_indent)) : rb_str_cat_cstr((indent), (next_indent)); })), field_flag = 1; field_flag; rb_str_resize(indent, (!(((struct RBasic*)(indent))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(indent))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(indent))->as.heap.len) - 4), field_flag = 0) {dump_node(buf, indent, comment, node->u1.node);};
 return;

      case NODE_ENSURE:
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # ensure clause\n"))) ? rb_str_cat((buf), (("| # ensure clause\n")), (long)strlen(("| # ensure clause\n"))) : rb_str_cat_cstr((buf), (("| # ensure clause\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # format: begin; [nd_head]; ensure; [nd_ensr]; end\n"))) ? rb_str_cat((buf), (("| # format: begin; [nd_head]; ensure; [nd_ensr]; end\n")), (long)strlen(("| # format: begin; [nd_head]; ensure; [nd_ensr]; end\n"))) : rb_str_cat_cstr((buf), (("| # format: begin; [nd_head]; ensure; [nd_ensr]; end\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # example: begin; foo; ensure; bar; end\n"))) ? rb_str_cat((buf), (("| # example: begin; foo; ensure; bar; end\n")), (long)strlen(("| # example: begin; foo; ensure; bar; end\n"))) : rb_str_cat_cstr((buf), (("| # example: begin; foo; ensure; bar; end\n"))); }); };
 for (((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s:\n", (((int)( comment ? (sizeof("nd_head (body)") - 1) : (sizeof("nd_head") - 1)))), (("nd_head (body)")))),  ({ (__builtin_constant_p(next_indent)) ? rb_str_cat((indent), (next_indent), (long)strlen(next_indent)) : rb_str_cat_cstr((indent), (next_indent)); })), field_flag = 1; field_flag; rb_str_resize(indent, (!(((struct RBasic*)(indent))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(indent))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(indent))->as.heap.len) - 4), field_flag = 0) {dump_node(buf, indent, comment, node->u1.node);};
 (next_indent = "    ");
 for (((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s:\n", (((int)( comment ? (sizeof("nd_ensr (ensure clause)") - 1) : (sizeof("nd_ensr") - 1)))), (("nd_ensr (ensure clause)")))),  ({ (__builtin_constant_p(next_indent)) ? rb_str_cat((indent), (next_indent), (long)strlen(next_indent)) : rb_str_cat_cstr((indent), (next_indent)); })), field_flag = 1; field_flag; rb_str_resize(indent, (!(((struct RBasic*)(indent))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(indent))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(indent))->as.heap.len) - 4), field_flag = 0) {dump_node(buf, indent, comment, node->u3.node);};
 return;

      case NODE_AND:
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # && operator\n"))) ? rb_str_cat((buf), (("| # && operator\n")), (long)strlen(("| # && operator\n"))) : rb_str_cat_cstr((buf), (("| # && operator\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # format: [nd_1st] && [nd_2nd]\n"))) ? rb_str_cat((buf), (("| # format: [nd_1st] && [nd_2nd]\n")), (long)strlen(("| # format: [nd_1st] && [nd_2nd]\n"))) : rb_str_cat_cstr((buf), (("| # format: [nd_1st] && [nd_2nd]\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # example: foo && bar\n"))) ? rb_str_cat((buf), (("| # example: foo && bar\n")), (long)strlen(("| # example: foo && bar\n"))) : rb_str_cat_cstr((buf), (("| # example: foo && bar\n"))); }); };
 goto andor;
      case NODE_OR:
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # || operator\n"))) ? rb_str_cat((buf), (("| # || operator\n")), (long)strlen(("| # || operator\n"))) : rb_str_cat_cstr((buf), (("| # || operator\n"))); }); };
 ...
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # example: foo || bar\n"))) ? rb_str_cat((buf), (("| # example: foo || bar\n")), (long)strlen(("| # example: foo || bar\n"))) : rb_str_cat_cstr((buf), (("| # example: foo || bar\n"))); }); };
      andor:
 while (1) {
     for (((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s:\n", (((int)( comment ? (sizeof("nd_1st (left expr)") - 1) : (sizeof("nd_1st") - 1)))), (("nd_1st (left expr)")))),  ({ (__builtin_constant_p(next_indent)) ? rb_str_cat((indent), (next_indent), (long)strlen(next_indent)) : rb_str_cat_cstr((indent), (next_indent)); })), field_flag = 1; field_flag; rb_str_resize(indent, (!(((struct RBasic*)(indent))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(indent))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(indent))->as.heap.len) - 4), field_flag = 0) {dump_node(buf, indent, comment, node->u1.node);};
     if (!node->u2.node || ((int) (((node->u2.node)->flags & (((VALUE)0x7f)<<8))>>8)) != (int)type)
  break;
     node = node->u2.node;
 }
 (next_indent = "    ");
 for (((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s:\n", (((int)( comment ? (sizeof("nd_2nd (right expr)") - 1) : (sizeof("nd_2nd") - 1)))), (("nd_2nd (right expr)")))),  ({ (__builtin_constant_p(next_indent)) ? rb_str_cat((indent), (next_indent), (long)strlen(next_indent)) : rb_str_cat_cstr((indent), (next_indent)); })), field_flag = 1; field_flag; rb_str_resize(indent, (!(((struct RBasic*)(indent))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(indent))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(indent))->as.heap.len) - 4), field_flag = 0) {dump_node(buf, indent, comment, node->u2.node);};
 return;

      case NODE_MASGN:
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # multiple assignment\n"))) ? rb_str_cat((buf), (("| # multiple assignment\n")), (long)strlen(("| # multiple assignment\n"))) : rb_str_cat_cstr((buf), (("| # multiple assignment\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # format: [nd_head], [nd_args] = [nd_value]\n"))) ? rb_str_cat((buf), (("| # format: [nd_head], [nd_args] = [nd_value]\n")), (long)strlen(("| # format: [nd_head], [nd_args] = [nd_value]\n"))) : rb_str_cat_cstr((buf), (("| # format: [nd_head], [nd_args] = [nd_value]\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # example: a, b = foo\n"))) ? rb_str_cat((buf), (("| # example: a, b = foo\n")), (long)strlen(("| # example: a, b = foo\n"))) : rb_str_cat_cstr((buf), (("| # example: a, b = foo\n"))); }); };
 for (((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s:\n", (((int)( comment ? (sizeof("nd_value (rhsn)") - 1) : (sizeof("nd_value") - 1)))), (("nd_value (rhsn)")))),  ({ (__builtin_constant_p(next_indent)) ? rb_str_cat((indent), (next_indent), (long)strlen(next_indent)) : rb_str_cat_cstr((indent), (next_indent)); })), field_flag = 1; field_flag; rb_str_resize(indent, (!(((struct RBasic*)(indent))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(indent))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(indent))->as.heap.len) - 4), field_flag = 0) {dump_node(buf, indent, comment, node->u2.node);};
 for (((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s:\n", (((int)( comment ? (sizeof("nd_head (lhsn)") - 1) : (sizeof("nd_head") - 1)))), (("nd_head (lhsn)")))),  ({ (__builtin_constant_p(next_indent)) ? rb_str_cat((indent), (next_indent), (long)strlen(next_indent)) : rb_str_cat_cstr((indent), (next_indent)); })), field_flag = 1; field_flag; rb_str_resize(indent, (!(((struct RBasic*)(indent))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(indent))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(indent))->as.heap.len) - 4), field_flag = 0) {dump_node(buf, indent, comment, node->u1.node);};
 if (node->u3.node != ((NODE *)-1)) {
     (next_indent = "    ");
     for (((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s:\n", (((int)( comment ? (sizeof("nd_args (splatn)") - 1) : (sizeof("nd_args") - 1)))), (("nd_args (splatn)")))),  ({ (__builtin_constant_p(next_indent)) ? rb_str_cat((indent), (next_indent), (long)strlen(next_indent)) : rb_str_cat_cstr((indent), (next_indent)); })), field_flag = 1; field_flag; rb_str_resize(indent, (!(((struct RBasic*)(indent))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(indent))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(indent))->as.heap.len) - 4), field_flag = 0) {dump_node(buf, indent, comment, node->u3.node);};
 }
 else {
     for ((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s: ", (((int)( comment ? (sizeof("nd_args (splatn)") - 1) : (sizeof("nd_args") - 1)))), (("nd_args (splatn)")))), field_flag = 1; field_flag;  ({ (__builtin_constant_p(("\n"))) ? rb_str_cat((buf), (("\n")), (long)strlen(("\n"))) : rb_str_cat_cstr((buf), (("\n"))); }), field_flag = 0)  ({ (__builtin_constant_p(("NODE_SPECIAL_NO_NAME_REST (rest argument without name)"))) ? rb_str_cat((buf), (("NODE_SPECIAL_NO_NAME_REST (rest argument without name)")), (long)strlen(("NODE_SPECIAL_NO_NAME_REST (rest argument without name)"))) : rb_str_cat_cstr((buf), (("NODE_SPECIAL_NO_NAME_REST (rest argument without name)"))); });
 }
 return;

      case NODE_LASGN:
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # local variable assignment\n"))) ? rb_str_cat((buf), (("| # local variable assignment\n")), (long)strlen(("| # local variable assignment\n"))) : rb_str_cat_cstr((buf), (("| # local variable assignment\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # format: [nd_vid](lvar) = [nd_value]\n"))) ? rb_str_cat((buf), (("| # format: [nd_vid](lvar) = [nd_value]\n")), (long)strlen(("| # format: [nd_vid](lvar) = [nd_value]\n"))) : rb_str_cat_cstr((buf), (("| # format: [nd_vid](lvar) = [nd_value]\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # example: x = foo\n"))) ? rb_str_cat((buf), (("| # example: x = foo\n")), (long)strlen(("| # example: x = foo\n"))) : rb_str_cat_cstr((buf), (("| # example: x = foo\n"))); }); };
 for ((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s: ", (((int)( comment ? (sizeof("nd_vid (local variable)") - 1) : (sizeof("nd_vid") - 1)))), (("nd_vid (local variable)")))), field_flag = 1; field_flag;  ({ (__builtin_constant_p(("\n"))) ? rb_str_cat((buf), (("\n")), (long)strlen(("\n"))) : rb_str_cat_cstr((buf), (("\n"))); }), field_flag = 0) add_id(buf, (node->u1.id));
 if (node->u2.node == ((NODE *)-1)) {
     for ((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s: ", (((int)( comment ? (sizeof("nd_value (rvalue)") - 1) : (sizeof("nd_value") - 1)))), (("nd_value (rvalue)")))), field_flag = 1; field_flag;  ({ (__builtin_constant_p(("\n"))) ? rb_str_cat((buf), (("\n")), (long)strlen(("\n"))) : rb_str_cat_cstr((buf), (("\n"))); }), field_flag = 0)  ({ (__builtin_constant_p(("NODE_SPECIAL_REQUIRED_KEYWORD (required keyword argument)"))) ? rb_str_cat((buf), (("NODE_SPECIAL_REQUIRED_KEYWORD (required keyword argument)")), (long)strlen(("NODE_SPECIAL_REQUIRED_KEYWORD (required keyword argument)"))) : rb_str_cat_cstr((buf), (("NODE_SPECIAL_REQUIRED_KEYWORD (required keyword argument)"))); });
 }
 else {
     (next_indent = "    ");
     for (((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s:\n", (((int)( comment ? (sizeof("nd_value (rvalue)") - 1) : (sizeof("nd_value") - 1)))), (("nd_value (rvalue)")))),  ({ (__builtin_constant_p(next_indent)) ? rb_str_cat((indent), (next_indent), (long)strlen(next_indent)) : rb_str_cat_cstr((indent), (next_indent)); })), field_flag = 1; field_flag; rb_str_resize(indent, (!(((struct RBasic*)(indent))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(indent))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(indent))->as.heap.len) - 4), field_flag = 0) {dump_node(buf, indent, comment, node->u2.node);};
 }
 return;
      case NODE_DASGN:
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # dynamic variable assignment (out of current scope)\n"))) ? rb_str_cat((buf), (("| # dynamic variable assignment (out of current scope)\n")), (long)strlen(("| # dynamic variable assignment (out of current scope)\n"))) : rb_str_cat_cstr((buf), (("| # dynamic variable assignment (out of current scope)\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # format: [nd_vid](dvar) = [nd_value]\n"))) ? rb_str_cat((buf), (("| # format: [nd_vid](dvar) = [nd_value]\n")), (long)strlen(("| # format: [nd_vid](dvar) = [nd_value]\n"))) : rb_str_cat_cstr((buf), (("| # format: [nd_vid](dvar) = [nd_value]\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # example: x = nil; 1.times { x = foo }\n"))) ? rb_str_cat((buf), (("| # example: x = nil; 1.times { x = foo }\n")), (long)strlen(("| # example: x = nil; 1.times { x = foo }\n"))) : rb_str_cat_cstr((buf), (("| # example: x = nil; 1.times { x = foo }\n"))); }); };
 for ((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s: ", (((int)( comment ? (sizeof("nd_vid (local variable)") - 1) : (sizeof("nd_vid") - 1)))), (("nd_vid (local variable)")))), field_flag = 1; field_flag;  ({ (__builtin_constant_p(("\n"))) ? rb_str_cat((buf), (("\n")), (long)strlen(("\n"))) : rb_str_cat_cstr((buf), (("\n"))); }), field_flag = 0) add_id(buf, (node->u1.id));
 (next_indent = "    ");
 for (((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s:\n", (((int)( comment ? (sizeof("nd_value (rvalue)") - 1) : (sizeof("nd_value") - 1)))), (("nd_value (rvalue)")))),  ({ (__builtin_constant_p(next_indent)) ? rb_str_cat((indent), (next_indent), (long)strlen(next_indent)) : rb_str_cat_cstr((indent), (next_indent)); })), field_flag = 1; field_flag; rb_str_resize(indent, (!(((struct RBasic*)(indent))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(indent))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(indent))->as.heap.len) - 4), field_flag = 0) {dump_node(buf, indent, comment, node->u2.node);};
 return;
      case NODE_DASGN_CURR:
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # dynamic variable assignment (in current scope)\n"))) ? rb_str_cat((buf), (("| # dynamic variable assignment (in current scope)\n")), (long)strlen(("| # dynamic variable assignment (in current scope)\n"))) : rb_str_cat_cstr((buf), (("| # dynamic variable assignment (in current scope)\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # format: [nd_vid](current dvar) = [nd_value]\n"))) ? rb_str_cat((buf), (("| # format: [nd_vid](current dvar) = [nd_value]\n")), (long)strlen(("| # format: [nd_vid](current dvar) = [nd_value]\n"))) : rb_str_cat_cstr((buf), (("| # format: [nd_vid](current dvar) = [nd_value]\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # example: 1.times { x = foo }\n"))) ? rb_str_cat((buf), (("| # example: 1.times { x = foo }\n")), (long)strlen(("| # example: 1.times { x = foo }\n"))) : rb_str_cat_cstr((buf), (("| # example: 1.times { x = foo }\n"))); }); };
 for ((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s: ", (((int)( comment ? (sizeof("nd_vid (local variable)") - 1) : (sizeof("nd_vid") - 1)))), (("nd_vid (local variable)")))), field_flag = 1; field_flag;  ({ (__builtin_constant_p(("\n"))) ? rb_str_cat((buf), (("\n")), (long)strlen(("\n"))) : rb_str_cat_cstr((buf), (("\n"))); }), field_flag = 0) add_id(buf, (node->u1.id));
 (next_indent = "    ");
 for (((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s:\n", (((int)( comment ? (sizeof("nd_value (rvalue)") - 1) : (sizeof("nd_value") - 1)))), (("nd_value (rvalue)")))),  ({ (__builtin_constant_p(next_indent)) ? rb_str_cat((indent), (next_indent), (long)strlen(next_indent)) : rb_str_cat_cstr((indent), (next_indent)); })), field_flag = 1; field_flag; rb_str_resize(indent, (!(((struct RBasic*)(indent))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(indent))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(indent))->as.heap.len) - 4), field_flag = 0) {dump_node(buf, indent, comment, node->u2.node);};
 return;
      case NODE_IASGN:
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # instance variable assignment\n"))) ? rb_str_cat((buf), (("| # instance variable assignment\n")), (long)strlen(("| # instance variable assignment\n"))) : rb_str_cat_cstr((buf), (("| # instance variable assignment\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # format: [nd_vid](ivar) = [nd_value]\n"))) ? rb_str_cat((buf), (("| # format: [nd_vid](ivar) = [nd_value]\n")), (long)strlen(("| # format: [nd_vid](ivar) = [nd_value]\n"))) : rb_str_cat_cstr((buf), (("| # format: [nd_vid](ivar) = [nd_value]\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # example: @x = foo\n"))) ? rb_str_cat((buf), (("| # example: @x = foo\n")), (long)strlen(("| # example: @x = foo\n"))) : rb_str_cat_cstr((buf), (("| # example: @x = foo\n"))); }); };
 for ((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s: ", (((int)( comment ? (sizeof("nd_vid (instance variable)") - 1) : (sizeof("nd_vid") - 1)))), (("nd_vid (instance variable)")))), field_flag = 1; field_flag;  ({ (__builtin_constant_p(("\n"))) ? rb_str_cat((buf), (("\n")), (long)strlen(("\n"))) : rb_str_cat_cstr((buf), (("\n"))); }), field_flag = 0) add_id(buf, (node->u1.id));
 (next_indent = "    ");
 for (((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s:\n", (((int)( comment ? (sizeof("nd_value (rvalue)") - 1) : (sizeof("nd_value") - 1)))), (("nd_value (rvalue)")))),  ({ (__builtin_constant_p(next_indent)) ? rb_str_cat((indent), (next_indent), (long)strlen(next_indent)) : rb_str_cat_cstr((indent), (next_indent)); })), field_flag = 1; field_flag; rb_str_resize(indent, (!(((struct RBasic*)(indent))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(indent))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(indent))->as.heap.len) - 4), field_flag = 0) {dump_node(buf, indent, comment, node->u2.node);};
 return;
      case NODE_CVASGN:
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # class variable assignment\n"))) ? rb_str_cat((buf), (("| # class variable assignment\n")), (long)strlen(("| # class variable assignment\n"))) : rb_str_cat_cstr((buf), (("| # class variable assignment\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # format: [nd_vid](cvar) = [nd_value]\n"))) ? rb_str_cat((buf), (("| # format: [nd_vid](cvar) = [nd_value]\n")), (long)strlen(("| # format: [nd_vid](cvar) = [nd_value]\n"))) : rb_str_cat_cstr((buf), (("| # format: [nd_vid](cvar) = [nd_value]\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # example: @@x = foo\n"))) ? rb_str_cat((buf), (("| # example: @@x = foo\n")), (long)strlen(("| # example: @@x = foo\n"))) : rb_str_cat_cstr((buf), (("| # example: @@x = foo\n"))); }); };
 for ((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s: ", (((int)( comment ? (sizeof("nd_vid (class variable)") - 1) : (sizeof("nd_vid") - 1)))), (("nd_vid (class variable)")))), field_flag = 1; field_flag;  ({ (__builtin_constant_p(("\n"))) ? rb_str_cat((buf), (("\n")), (long)strlen(("\n"))) : rb_str_cat_cstr((buf), (("\n"))); }), field_flag = 0) add_id(buf, (node->u1.id));
 (next_indent = "    ");
 for (((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s:\n", (((int)( comment ? (sizeof("nd_value (rvalue)") - 1) : (sizeof("nd_value") - 1)))), (("nd_value (rvalue)")))),  ({ (__builtin_constant_p(next_indent)) ? rb_str_cat((indent), (next_indent), (long)strlen(next_indent)) : rb_str_cat_cstr((indent), (next_indent)); })), field_flag = 1; field_flag; rb_str_resize(indent, (!(((struct RBasic*)(indent))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(indent))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(indent))->as.heap.len) - 4), field_flag = 0) {dump_node(buf, indent, comment, node->u2.node);};
 return;
      case NODE_GASGN:
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # global variable assignment\n"))) ? rb_str_cat((buf), (("| # global variable assignment\n")), (long)strlen(("| # global variable assignment\n"))) : rb_str_cat_cstr((buf), (("| # global variable assignment\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # format: [nd_entry](gvar) = [nd_value]\n"))) ? rb_str_cat((buf), (("| # format: [nd_entry](gvar) = [nd_value]\n")), (long)strlen(("| # format: [nd_entry](gvar) = [nd_value]\n"))) : rb_str_cat_cstr((buf), (("| # format: [nd_entry](gvar) = [nd_value]\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # example: $x = foo\n"))) ? rb_str_cat((buf), (("| # example: $x = foo\n")), (long)strlen(("| # example: $x = foo\n"))) : rb_str_cat_cstr((buf), (("| # example: $x = foo\n"))); }); };
 for ((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s: ", (((int)( comment ? (sizeof("nd_entry (global variable)") - 1) : (sizeof("nd_entry") - 1)))), (("nd_entry (global variable)")))), field_flag = 1; field_flag;  ({ (__builtin_constant_p(("\n"))) ? rb_str_cat((buf), (("\n")), (long)strlen(("\n"))) : rb_str_cat_cstr((buf), (("\n"))); }), field_flag = 0) add_id(buf, ((node->u3.entry)->id));
 (next_indent = "    ");
 for (((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s:\n", (((int)( comment ? (sizeof("nd_value (rvalue)") - 1) : (sizeof("nd_value") - 1)))), (("nd_value (rvalue)")))),  ({ (__builtin_constant_p(next_indent)) ? rb_str_cat((indent), (next_indent), (long)strlen(next_indent)) : rb_str_cat_cstr((indent), (next_indent)); })), field_flag = 1; field_flag; rb_str_resize(indent, (!(((struct RBasic*)(indent))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(indent))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(indent))->as.heap.len) - 4), field_flag = 0) {dump_node(buf, indent, comment, node->u2.node);};
 return;

      case NODE_CDECL:
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # constant declaration\n"))) ? rb_str_cat((buf), (("| # constant declaration\n")), (long)strlen(("| # constant declaration\n"))) : rb_str_cat_cstr((buf), (("| # constant declaration\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # format: [nd_else]::[nd_vid](constant) = [nd_value]\n"))) ? rb_str_cat((buf), (("| # format: [nd_else]::[nd_vid](constant) = [nd_value]\n")), (long)strlen(("| # format: [nd_else]::[nd_vid](constant) = [nd_value]\n"))) : rb_str_cat_cstr((buf), (("| # format: [nd_else]::[nd_vid](constant) = [nd_value]\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # example: X = foo\n"))) ? rb_str_cat((buf), (("| # example: X = foo\n")), (long)strlen(("| # example: X = foo\n"))) : rb_str_cat_cstr((buf), (("| # example: X = foo\n"))); }); };
 if (node->u1.id) {
     for ((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s: ", (((int)( comment ? (sizeof("nd_vid (constant)") - 1) : (sizeof("nd_vid") - 1)))), (("nd_vid (constant)")))), field_flag = 1; field_flag;  ({ (__builtin_constant_p(("\n"))) ? rb_str_cat((buf), (("\n")), (long)strlen(("\n"))) : rb_str_cat_cstr((buf), (("\n"))); }), field_flag = 0) add_id(buf, (node->u1.id));
     for ((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s: ", (((int)( comment ? (sizeof("nd_else (extension)") - 1) : (sizeof("nd_else") - 1)))), (("nd_else (extension)")))), field_flag = 1; field_flag;  ({ (__builtin_constant_p(("\n"))) ? rb_str_cat((buf), (("\n")), (long)strlen(("\n"))) : rb_str_cat_cstr((buf), (("\n"))); }), field_flag = 0)  ({ (__builtin_constant_p(("not used"))) ? rb_str_cat((buf), (("not used")), (long)strlen(("not used"))) : rb_str_cat_cstr((buf), (("not used"))); });
 }
 else {
     for ((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s: ", (((int)( comment ? (sizeof("nd_vid (constant)") - 1) : (sizeof("nd_vid") - 1)))), (("nd_vid (constant)")))), field_flag = 1; field_flag;  ({ (__builtin_constant_p(("\n"))) ? rb_str_cat((buf), (("\n")), (long)strlen(("\n"))) : rb_str_cat_cstr((buf), (("\n"))); }), field_flag = 0)  ({ (__builtin_constant_p(("0 (see extension field)"))) ? rb_str_cat((buf), (("0 (see extension field)")), (long)strlen(("0 (see extension field)"))) : rb_str_cat_cstr((buf), (("0 (see extension field)"))); });
     for (((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s:\n", (((int)( comment ? (sizeof("nd_else (extension)") - 1) : (sizeof("nd_else") - 1)))), (("nd_else (extension)")))),  ({ (__builtin_constant_p(next_indent)) ? rb_str_cat((indent), (next_indent), (long)strlen(next_indent)) : rb_str_cat_cstr((indent), (next_indent)); })), field_flag = 1; field_flag; rb_str_resize(indent, (!(((struct RBasic*)(indent))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(indent))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(indent))->as.heap.len) - 4), field_flag = 0) {dump_node(buf, indent, comment, node->u3.node);};
 }
 (next_indent = "    ");
 for (((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s:\n", (((int)( comment ? (sizeof("nd_value (rvalue)") - 1) : (sizeof("nd_value") - 1)))), (("nd_value (rvalue)")))),  ({ (__builtin_constant_p(next_indent)) ? rb_str_cat((indent), (next_indent), (long)strlen(next_indent)) : rb_str_cat_cstr((indent), (next_indent)); })), field_flag = 1; field_flag; rb_str_resize(indent, (!(((struct RBasic*)(indent))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(indent))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(indent))->as.heap.len) - 4), field_flag = 0) {dump_node(buf, indent, comment, node->u2.node);};
 return;
      ...
      case NODE_OP_ASGN1:
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # array assignment with operator\n"))) ? rb_str_cat((buf), (("| # array assignment with operator\n")), (long)strlen(("| # array assignment with operator\n"))) : rb_str_cat_cstr((buf), (("| # array assignment with operator\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # format: [nd_value] [ [nd_args->nd_body] ] [nd_vid]= [nd_args->nd_head]\n"))) ? rb_str_cat((buf), (("| # format: [nd_value] [ [nd_args->nd_body] ] [nd_vid]= [nd_args->nd_head]\n")), (long)strlen(("| # format: [nd_value] [ [nd_args->nd_body] ] [nd_vid]= [nd_args->nd_head]\n"))) : rb_str_cat_cstr((buf), (("| # format: [nd_value] [ [nd_args->nd_body] ] [nd_vid]= [nd_args->nd_head]\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # example: ary[1] += foo\n"))) ? rb_str_cat((buf), (("| # example: ary[1] += foo\n")), (long)strlen(("| # example: ary[1] += foo\n"))) : rb_str_cat_cstr((buf), (("| # example: ary[1] += foo\n"))); }); };
 for (((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s:\n", (((int)( comment ? (sizeof("nd_recv (receiver)") - 1) : (sizeof("nd_recv") - 1)))), (("nd_recv (receiver)")))),  ({ (__builtin_constant_p(next_indent)) ? rb_str_cat((indent), (next_indent), (long)strlen(next_indent)) : rb_str_cat_cstr((indent), (next_indent)); })), field_flag = 1; field_flag; rb_str_resize(indent, (!(((struct RBasic*)(indent))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(indent))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(indent))->as.heap.len) - 4), field_flag = 0) {dump_node(buf, indent, comment, node->u1.node);};
 for ((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s: ", (((int)( comment ? (sizeof("nd_mid (operator)") - 1) : (sizeof("nd_mid") - 1)))), (("nd_mid (operator)")))), field_flag = 1; field_flag;  ({ (__builtin_constant_p(("\n"))) ? rb_str_cat((buf), (("\n")), (long)strlen(("\n"))) : rb_str_cat_cstr((buf), (("\n"))); }), field_flag = 0) {
     switch (node->u2.id) {
       case 0:  ({ (__builtin_constant_p(("0 (||)"))) ? rb_str_cat((buf), (("0 (||)")), (long)strlen(("0 (||)"))) : rb_str_cat_cstr((buf), (("0 (||)"))); }); break;
       case 1:  ({ (__builtin_constant_p(("1 (&&)"))) ? rb_str_cat((buf), (("1 (&&)")), (long)strlen(("1 (&&)"))) : rb_str_cat_cstr((buf), (("1 (&&)"))); }); break;
       default: add_id(buf, (node->u2.id));
     }
 }
 for (((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s:\n", (((int)( comment ? (sizeof("nd_args->nd_head (index)") - 1) : (sizeof("nd_args->nd_head") - 1)))), (("nd_args->nd_head (index)")))),  ({ (__builtin_constant_p(next_indent)) ? rb_str_cat((indent), (next_indent), (long)strlen(next_indent)) : rb_str_cat_cstr((indent), (next_indent)); })), field_flag = 1; field_flag; rb_str_resize(indent, (!(((struct RBasic*)(indent))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(indent))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(indent))->as.heap.len) - 4), field_flag = 0) {dump_node(buf, indent, comment, node->u3.node->u1.node);};
 (next_indent = "    ");
 for (((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s:\n", (((int)( comment ? (sizeof("nd_args->nd_body (rvalue)") - 1) : (sizeof("nd_args->nd_body") - 1)))), (("nd_args->nd_body (rvalue)")))),  ({ (__builtin_constant_p(next_indent)) ? rb_str_cat((indent), (next_indent), (long)strlen(next_indent)) : rb_str_cat_cstr((indent), (next_indent)); })), field_flag = 1; field_flag; rb_str_resize(indent, (!(((struct RBasic*)(indent))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(indent))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(indent))->as.heap.len) - 4), field_flag = 0) {dump_node(buf, indent, comment, node->u3.node->u2.node);};
 return;

      case NODE_OP_ASGN2:
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # attr assignment with operator\n"))) ? rb_str_cat((buf), (("| # attr assignment with operator\n")), (long)strlen(("| # attr assignment with operator\n"))) : rb_str_cat_cstr((buf), (("| # attr assignment with operator\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # format: [nd_value].[attr] [nd_next->nd_mid]= [nd_value]\n"))) ? rb_str_cat((buf), (("| # format: [nd_value].[attr] [nd_next->nd_mid]= [nd_value]\n")), (long)strlen(("| # format: [nd_value].[attr] [nd_next->nd_mid]= [nd_value]\n"))) : rb_str_cat_cstr((buf), (("| # format: [nd_value].[attr] [nd_next->nd_mid]= [nd_value]\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| #           where [attr]: [nd_next->nd_vid]\n"))) ? rb_str_cat((buf), (("| #           where [attr]: [nd_next->nd_vid]\n")), (long)strlen(("| #           where [attr]: [nd_next->nd_vid]\n"))) : rb_str_cat_cstr((buf), (("| #           where [attr]: [nd_next->nd_vid]\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # example: struct.field += foo\n"))) ? rb_str_cat((buf), (("| # example: struct.field += foo\n")), (long)strlen(("| # example: struct.field += foo\n"))) : rb_str_cat_cstr((buf), (("| # example: struct.field += foo\n"))); }); };
 for (((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s:\n", (((int)( comment ? (sizeof("nd_recv (receiver)") - 1) : (sizeof("nd_recv") - 1)))), (("nd_recv (receiver)")))),  ({ (__builtin_constant_p(next_indent)) ? rb_str_cat((indent), (next_indent), (long)strlen(next_indent)) : rb_str_cat_cstr((indent), (next_indent)); })), field_flag = 1; field_flag; rb_str_resize(indent, (!(((struct RBasic*)(indent))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(indent))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(indent))->as.heap.len) - 4), field_flag = 0) {dump_node(buf, indent, comment, node->u1.node);};
 for ((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s: ", (((int)( comment ? (sizeof("nd_next->nd_vid (attr)") - 1) : (sizeof("nd_next->nd_vid") - 1)))), (("nd_next->nd_vid (attr)")))), field_flag = 1; field_flag;  ({ (__builtin_constant_p(("\n"))) ? rb_str_cat((buf), (("\n")), (long)strlen(("\n"))) : rb_str_cat_cstr((buf), (("\n"))); }), field_flag = 0) {
     if (node->u3.node->u3.id)  ({ (__builtin_constant_p(("? "))) ? rb_str_cat((buf), (("? ")), (long)strlen(("? "))) : rb_str_cat_cstr((buf), (("? "))); });
     add_id(buf, (node->u3.node->u1.id));
 }
 for ((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s: ", (((int)( comment ? (sizeof("nd_next->nd_mid (operator)") - 1) : (sizeof("nd_next->nd_mid") - 1)))), (("nd_next->nd_mid (operator)")))), field_flag = 1; field_flag;  ({ (__builtin_constant_p(("\n"))) ? rb_str_cat((buf), (("\n")), (long)strlen(("\n"))) : rb_str_cat_cstr((buf), (("\n"))); }), field_flag = 0) {
     switch (node->u3.node->u2.id) {
       case 0:  ({ (__builtin_constant_p(("0 (||)"))) ? rb_str_cat((buf), (("0 (||)")), (long)strlen(("0 (||)"))) : rb_str_cat_cstr((buf), (("0 (||)"))); }); break;
       case 1:  ({ (__builtin_constant_p(("1 (&&)"))) ? rb_str_cat((buf), (("1 (&&)")), (long)strlen(("1 (&&)"))) : rb_str_cat_cstr((buf), (("1 (&&)"))); }); break;
       default: add_id(buf, (node->u3.node->u2.id));
     }
 }
 (next_indent = "    ");
 for (((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s:\n", (((int)( comment ? (sizeof("nd_value (rvalue)") - 1) : (sizeof("nd_value") - 1)))), (("nd_value (rvalue)")))),  ({ (__builtin_constant_p(next_indent)) ? rb_str_cat((indent), (next_indent), (long)strlen(next_indent)) : rb_str_cat_cstr((indent), (next_indent)); })), field_flag = 1; field_flag; rb_str_resize(indent, (!(((struct RBasic*)(indent))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(indent))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(indent))->as.heap.len) - 4), field_flag = 0) {dump_node(buf, indent, comment, node->u2.node);};
 ...
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # assignment with && operator\n"))) ? rb_str_cat((buf), (("| # assignment with && operator\n")), (long)strlen(("| # assignment with && operator\n"))) : rb_str_cat_cstr((buf), (("| # assignment with && operator\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # format: [nd_head] &&= [nd_value]\n"))) ? rb_str_cat((buf), (("| # format: [nd_head] &&= [nd_value]\n")), (long)strlen(("| # format: [nd_head] &&= [nd_value]\n"))) : rb_str_cat_cstr((buf), (("| # format: [nd_head] &&= [nd_value]\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # example: foo &&= bar\n"))) ? rb_str_cat((buf), (("| # example: foo &&= bar\n")), (long)strlen(("| # example: foo &&= bar\n"))) : rb_str_cat_cstr((buf), (("| # example: foo &&= bar\n"))); }); };
 goto asgn_andor;
 ...
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # example: foo ||= bar\n"))) ? rb_str_cat((buf), (("| # example: foo ||= bar\n")), (long)strlen(("| # example: foo ||= bar\n"))) : rb_str_cat_cstr((buf), (("| # example: foo ||= bar\n"))); }); };
      asgn_andor:
 for (((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s:\n", (((int)( comment ? (sizeof("nd_head (variable)") - 1) : (sizeof("nd_head") - 1)))), (("nd_head (variable)")))),  ({ (__builtin_constant_p(next_indent)) ? rb_str_cat((indent), (next_indent), (long)strlen(next_indent)) : rb_str_cat_cstr((indent), (next_indent)); })), field_flag = 1; field_flag; rb_str_resize(indent, (!(((struct RBasic*)(indent))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(indent))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(indent))->as.heap.len) - 4), field_flag = 0) {dump_node(buf, indent, comment, node->u1.node);};
 (next_indent = "    ");
 for (((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s:\n", (((int)( comment ? (sizeof("nd_value (rvalue)") - 1) : (sizeof("nd_value") - 1)))), (("nd_value (rvalue)")))),  ({ (__builtin_constant_p(next_indent)) ? rb_str_cat((indent), (next_indent), (long)strlen(next_indent)) : rb_str_cat_cstr((indent), (next_indent)); })), field_flag = 1; field_flag; rb_str_resize(indent, (!(((struct RBasic*)(indent))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(indent))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(indent))->as.heap.len) - 4), field_flag = 0) {dump_node(buf, indent, comment, node->u2.node);};
 return;

      case NODE_OP_CDECL:
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # constant declaration with operator\n"))) ? rb_str_cat((buf), (("| # constant declaration with operator\n")), (long)strlen(("| # constant declaration with operator\n"))) : rb_str_cat_cstr((buf), (("| # constant declaration with operator\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # format: [nd_head](constant) [nd_aid]= [nd_value]\n"))) ? rb_str_cat((buf), (("| # format: [nd_head](constant) [nd_aid]= [nd_value]\n")), (long)strlen(("| # format: [nd_head](constant) [nd_aid]= [nd_value]\n"))) : rb_str_cat_cstr((buf), (("| # format: [nd_head](constant) [nd_aid]= [nd_value]\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # example: A::B ||= 1\n"))) ? rb_str_cat((buf), (("| # example: A::B ||= 1\n")), (long)strlen(("| # example: A::B ||= 1\n"))) : rb_str_cat_cstr((buf), (("| # example: A::B ||= 1\n"))); }); };
 for (((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s:\n", (((int)( comment ? (sizeof("nd_head (constant)") - 1) : (sizeof("nd_head") - 1)))), (("nd_head (constant)")))),  ({ (__builtin_constant_p(next_indent)) ? rb_str_cat((indent), (next_indent), (long)strlen(next_indent)) : rb_str_cat_cstr((indent), (next_indent)); })), field_flag = 1; field_flag; rb_str_resize(indent, (!(((struct RBasic*)(indent))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(indent))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(indent))->as.heap.len) - 4), field_flag = 0) {dump_node(buf, indent, comment, node->u1.node);};
 for ((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s: ", (((int)( comment ? (sizeof("nd_aid (operator)") - 1) : (sizeof("nd_aid") - 1)))), (("nd_aid (operator)")))), field_flag = 1; field_flag;  ({ (__builtin_constant_p(("\n"))) ? rb_str_cat((buf), (("\n")), (long)strlen(("\n"))) : rb_str_cat_cstr((buf), (("\n"))); }), field_flag = 0) {
     switch (node->u3.id) {
       case 0:  ({ (__builtin_constant_p(("0 (||)"))) ? rb_str_cat((buf), (("0 (||)")), (long)strlen(("0 (||)"))) : rb_str_cat_cstr((buf), (("0 (||)"))); }); break;
       case 1:  ({ (__builtin_constant_p(("1 (&&)"))) ? rb_str_cat((buf), (("1 (&&)")), (long)strlen(("1 (&&)"))) : rb_str_cat_cstr((buf), (("1 (&&)"))); }); break;
       default: add_id(buf, (node->u2.id));
 ...
 return;
      ...
      case NODE_CALL:
      case NODE_OPCALL:
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # method invocation\n"))) ? rb_str_cat((buf), (("| # method invocation\n")), (long)strlen(("| # method invocation\n"))) : rb_str_cat_cstr((buf), (("| # method invocation\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # format: [nd_recv].[nd_mid]([nd_args])\n"))) ? rb_str_cat((buf), (("| # format: [nd_recv].[nd_mid]([nd_args])\n")), (long)strlen(("| # format: [nd_recv].[nd_mid]([nd_args])\n"))) : rb_str_cat_cstr((buf), (("| # format: [nd_recv].[nd_mid]([nd_args])\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # example: obj.foo(1)\n"))) ? rb_str_cat((buf), (("| # example: obj.foo(1)\n")), (long)strlen(("| # example: obj.foo(1)\n"))) : rb_str_cat_cstr((buf), (("| # example: obj.foo(1)\n"))); }); };
 for ((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s: ", (((int)( comment ? (sizeof("nd_mid (method id)") - 1) : (sizeof("nd_mid") - 1)))), (("nd_mid (method id)")))), field_flag = 1; field_flag;  ({ (__builtin_constant_p(("\n"))) ? rb_str_cat((buf), (("\n")), (long)strlen(("\n"))) : rb_str_cat_cstr((buf), (("\n"))); }), field_flag = 0) add_id(buf, (node->u2.id));
 for (((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s:\n", (((int)( comment ? (sizeof("nd_recv (receiver)") - 1) : (sizeof("nd_recv") - 1)))), (("nd_recv (receiver)")))),  ({ (__builtin_constant_p(next_indent)) ? rb_str_cat((indent), (next_indent), (long)strlen(next_indent)) : rb_str_cat_cstr((indent), (next_indent)); })), field_flag = 1; field_flag; rb_str_resize(indent, (!(((struct RBasic*)(indent))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(indent))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(indent))->as.heap.len) - 4), field_flag = 0) {dump_node(buf, indent, comment, node->u1.node);};
 (next_indent = "    ");
 for (((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s:\n", (((int)( comment ? (sizeof("nd_args (arguments)") - 1) : (sizeof("nd_args") - 1)))), (("nd_args (arguments)")))),  ({ (__builtin_constant_p(next_indent)) ? rb_str_cat((indent), (next_indent), (long)strlen(next_indent)) : rb_str_cat_cstr((indent), (next_indent)); })), field_flag = 1; field_flag; rb_str_resize(indent, (!(((struct RBasic*)(indent))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(indent))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(indent))->as.heap.len) - 4), field_flag = 0) {dump_node(buf, indent, comment, node->u3.node);};
 return;

      case NODE_FCALL:
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # function call\n"))) ? rb_str_cat((buf), (("| # function call\n")), (long)strlen(("| # function call\n"))) : rb_str_cat_cstr((buf), (("| # function call\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # format: [nd_mid]([nd_args])\n"))) ? rb_str_cat((buf), (("| # format: [nd_mid]([nd_args])\n")), (long)strlen(("| # format: [nd_mid]([nd_args])\n"))) : rb_str_cat_cstr((buf), (("| # format: [nd_mid]([nd_args])\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # example: foo(1)\n"))) ? rb_str_cat((buf), (("| # example: foo(1)\n")), (long)strlen(("| # example: foo(1)\n"))) : rb_str_cat_cstr((buf), (("| # example: foo(1)\n"))); }); };
 for ((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s: ", (((int)( comment ? (sizeof("nd_mid (method id)") - 1) : (sizeof("nd_mid") - 1)))), (("nd_mid (method id)")))), field_flag = 1; field_flag;  ({ (__builtin_constant_p(("\n"))) ? rb_str_cat((buf), (("\n")), (long)strlen(("\n"))) : rb_str_cat_cstr((buf), (("\n"))); }), field_flag = 0) add_id(buf, (node->u2.id));
 (next_indent = "    ");
 for (((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s:\n", (((int)( comment ? (sizeof("nd_args (arguments)") - 1) : (sizeof("nd_args") - 1)))), (("nd_args (arguments)")))),  ({ (__builtin_constant_p(next_indent)) ? rb_str_cat((indent), (next_indent), (long)strlen(next_indent)) : rb_str_cat_cstr((indent), (next_indent)); })), field_flag = 1; field_flag; rb_str_resize(indent, (!(((struct RBasic*)(indent))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(indent))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(indent))->as.heap.len) - 4), field_flag = 0) {dump_node(buf, indent, comment, node->u3.node);};
 return;
      ...
      case NODE_VCALL:
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # function call with no argument\n"))) ? rb_str_cat((buf), (("| # function call with no argument\n")), (long)strlen(("| # function call with no argument\n"))) : rb_str_cat_cstr((buf), (("| # function call with no argument\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # format: [nd_mid]\n"))) ? rb_str_cat((buf), (("| # format: [nd_mid]\n")), (long)strlen(("| # format: [nd_mid]\n"))) : rb_str_cat_cstr((buf), (("| # format: [nd_mid]\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # example: foo\n"))) ? rb_str_cat((buf), (("| # example: foo\n")), (long)strlen(("| # example: foo\n"))) : rb_str_cat_cstr((buf), (("| # example: foo\n"))); }); };
 for ((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s: ", (((int)( comment ? (sizeof("nd_mid (method id)") - 1) : (sizeof("nd_mid") - 1)))), (("nd_mid (method id)")))), field_flag = 1; field_flag;  ({ (__builtin_constant_p(("\n"))) ? rb_str_cat((buf), (("\n")), (long)strlen(("\n"))) : rb_str_cat_cstr((buf), (("\n"))); }), field_flag = 0) add_id(buf, (node->u2.id));
 return;

      case NODE_QCALL:
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # safe method invocation\n"))) ? rb_str_cat((buf), (("| # safe method invocation\n")), (long)strlen(("| # safe method invocation\n"))) : rb_str_cat_cstr((buf), (("| # safe method invocation\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # format: [nd_recv]&.[nd_mid]([nd_args])\n"))) ? rb_str_cat((buf), (("| # format: [nd_recv]&.[nd_mid]([nd_args])\n")), (long)strlen(("| # format: [nd_recv]&.[nd_mid]([nd_args])\n"))) : rb_str_cat_cstr((buf), (("| # format: [nd_recv]&.[nd_mid]([nd_args])\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # example: obj&.foo(1)\n"))) ? rb_str_cat((buf), (("| # example: obj&.foo(1)\n")), (long)strlen(("| # example: obj&.foo(1)\n"))) : rb_str_cat_cstr((buf), (("| # example: obj&.foo(1)\n"))); }); };
 for ((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s: ", (((int)( comment ? (sizeof("nd_mid (method id)") - 1) : (sizeof("nd_mid") - 1)))), (("nd_mid (method id)")))), field_flag = 1; field_flag;  ({ (__builtin_constant_p(("\n"))) ? rb_str_cat((buf), (("\n")), (long)strlen(("\n"))) : rb_str_cat_cstr((buf), (("\n"))); }), field_flag = 0) add_id(buf, (node->u2.id));
 for (((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s:\n", (((int)( comment ? (sizeof("nd_recv (receiver)") - 1) : (sizeof("nd_recv") - 1)))), (("nd_recv (receiver)")))),  ({ (__builtin_constant_p(next_indent)) ? rb_str_cat((indent), (next_indent), (long)strlen(next_indent)) : rb_str_cat_cstr((indent), (next_indent)); })), field_flag = 1; field_flag; rb_str_resize(indent, (!(((struct RBasic*)(indent))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(indent))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(indent))->as.heap.len) - 4), field_flag = 0) {dump_node(buf, indent, comment, node->u1.node);};
 ...
 return;
      ...
      case NODE_SUPER:
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # super invocation\n"))) ? rb_str_cat((buf), (("| # super invocation\n")), (long)strlen(("| # super invocation\n"))) : rb_str_cat_cstr((buf), (("| # super invocation\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # format: super [nd_args]\n"))) ? rb_str_cat((buf), (("| # format: super [nd_args]\n")), (long)strlen(("| # format: super [nd_args]\n"))) : rb_str_cat_cstr((buf), (("| # format: super [nd_args]\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # example: super 1\n"))) ? rb_str_cat((buf), (("| # example: super 1\n")), (long)strlen(("| # example: super 1\n"))) : rb_str_cat_cstr((buf), (("| # example: super 1\n"))); }); };
 (next_indent = "    ");
 for (((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s:\n", (((int)( comment ? (sizeof("nd_args (arguments)") - 1) : (sizeof("nd_args") - 1)))), (("nd_args (arguments)")))),  ({ (__builtin_constant_p(next_indent)) ? rb_str_cat((indent), (next_indent), (long)strlen(next_indent)) : rb_str_cat_cstr((indent), (next_indent)); })), field_flag = 1; field_flag; rb_str_resize(indent, (!(((struct RBasic*)(indent))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(indent))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(indent))->as.heap.len) - 4), field_flag = 0) {dump_node(buf, indent, comment, node->u3.node);};
 return;

      case NODE_ZSUPER:
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # super invocation with no argument\n"))) ? rb_str_cat((buf), (("| # super invocation with no argument\n")), (long)strlen(("| # super invocation with no argument\n"))) : rb_str_cat_cstr((buf), (("| # super invocation with no argument\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # format: super\n"))) ? rb_str_cat((buf), (("| # format: super\n")), (long)strlen(("| # format: super\n"))) : rb_str_cat_cstr((buf), (("| # format: super\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # example: super\n"))) ? rb_str_cat((buf), (("| # example: super\n")), (long)strlen(("| # example: super\n"))) : rb_str_cat_cstr((buf), (("| # example: super\n"))); }); };
 return;

      case NODE_ARRAY:
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # array constructor\n"))) ? rb_str_cat((buf), (("| # array constructor\n")), (long)strlen(("| # array constructor\n"))) : rb_str_cat_cstr((buf), (("| # array constructor\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # format: [ [nd_head], [nd_next].. ] (length: [nd_alen])\n"))) ? rb_str_cat((buf), (("| # format: [ [nd_head], [nd_next].. ] (length: [nd_alen])\n")), (long)strlen(("| # format: [ [nd_head], [nd_next].. ] (length: [nd_alen])\n"))) : rb_str_cat_cstr((buf), (("| # format: [ [nd_head], [nd_next].. ] (length: [nd_alen])\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # example: [1, 2, 3]\n"))) ? rb_str_cat((buf), (("| # example: [1, 2, 3]\n")), (long)strlen(("| # example: [1, 2, 3]\n"))) : rb_str_cat_cstr((buf), (("| # example: [1, 2, 3]\n"))); }); };
 goto ary;
      case NODE_VALUES:
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # return arguments\n"))) ? rb_str_cat((buf), (("| # return arguments\n")), (long)strlen(("| # return arguments\n"))) : rb_str_cat_cstr((buf), (("| # return arguments\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # format: [ [nd_head], [nd_next].. ] (length: [nd_alen])\n"))) ? rb_str_cat((buf), (("| # format: [ [nd_head], [nd_next].. ] (length: [nd_alen])\n")), (long)strlen(("| # format: [ [nd_head], [nd_next].. ] (length: [nd_alen])\n"))) : rb_str_cat_cstr((buf), (("| # format: [ [nd_head], [nd_next].. ] (length: [nd_alen])\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # example: return 1, 2, 3\n"))) ? rb_str_cat((buf), (("| # example: return 1, 2, 3\n")), (long)strlen(("| # example: return 1, 2, 3\n"))) : rb_str_cat_cstr((buf), (("| # example: return 1, 2, 3\n"))); }); };
      ary:
 dump_array(buf, indent, comment, node);
 return;

      case NODE_ZARRAY:
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # empty array constructor\n"))) ? rb_str_cat((buf), (("| # empty array constructor\n")), (long)strlen(("| # empty array constructor\n"))) : rb_str_cat_cstr((buf), (("| # empty array constructor\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # format: []\n"))) ? rb_str_cat((buf), (("| # format: []\n")), (long)strlen(("| # format: []\n"))) : rb_str_cat_cstr((buf), (("| # format: []\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # example: []\n"))) ? rb_str_cat((buf), (("| # example: []\n")), (long)strlen(("| # example: []\n"))) : rb_str_cat_cstr((buf), (("| # example: []\n"))); }); };
 return;

      case NODE_HASH:
 if (!node->u2.argc) {
     if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # keyword arguments\n"))) ? rb_str_cat((buf), (("| # keyword arguments\n")), (long)strlen(("| # keyword arguments\n"))) : rb_str_cat_cstr((buf), (("| # keyword arguments\n"))); }); };
     if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # format: nd_head\n"))) ? rb_str_cat((buf), (("| # format: nd_head\n")), (long)strlen(("| # format: nd_head\n"))) : rb_str_cat_cstr((buf), (("| # format: nd_head\n"))); }); };
     if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # example: a: 1, b: 2\n"))) ? rb_str_cat((buf), (("| # example: a: 1, b: 2\n")), (long)strlen(("| # example: a: 1, b: 2\n"))) : rb_str_cat_cstr((buf), (("| # example: a: 1, b: 2\n"))); }); };
 }
 else {
     if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # hash constructor\n"))) ? rb_str_cat((buf), (("| # hash constructor\n")), (long)strlen(("| # hash constructor\n"))) : rb_str_cat_cstr((buf), (("| # hash constructor\n"))); }); };
     if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # format: { [nd_head] }\n"))) ? rb_str_cat((buf), (("| # format: { [nd_head] }\n")), (long)strlen(("| # format: { [nd_head] }\n"))) : rb_str_cat_cstr((buf), (("| # format: { [nd_head] }\n"))); }); };
     if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # example: { 1 => 2, 3 => 4 }\n"))) ? rb_str_cat((buf), (("| # example: { 1 => 2, 3 => 4 }\n")), (long)strlen(("| # example: { 1 => 2, 3 => 4 }\n"))) : rb_str_cat_cstr((buf), (("| # example: { 1 => 2, 3 => 4 }\n"))); }); };
 }
 for ((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s: ", (((int)( comment ? (sizeof("nd_alen (keyword arguments or hash literal)") - 1) : (sizeof("nd_alen") - 1)))), (("nd_alen (keyword arguments or hash literal)")))), field_flag = 1; field_flag;  ({ (__builtin_constant_p(("\n"))) ? rb_str_cat((buf), (("\n")), (long)strlen(("\n"))) : rb_str_cat_cstr((buf), (("\n"))); }), field_flag = 0) {
     switch (node->u2.argc) {
       case 0:  ({ (__builtin_constant_p(("0 (keyword argument)"))) ? rb_str_cat((buf), (("0 (keyword argument)")), (long)strlen(("0 (keyword argument)"))) : rb_str_cat_cstr((buf), (("0 (keyword argument)"))); }); break;
       case 1:  ({ (__builtin_constant_p(("1 (hash literal)"))) ? rb_str_cat((buf), (("1 (hash literal)")), (long)strlen(("1 (hash literal)"))) : rb_str_cat_cstr((buf), (("1 (hash literal)"))); }); break;
     }
 }
 (next_indent = "    ");
 for (((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s:\n", (((int)( comment ? (sizeof("nd_head (contents)") - 1) : (sizeof("nd_head") - 1)))), (("nd_head (contents)")))),  ({ (__builtin_constant_p(next_indent)) ? rb_str_cat((indent), (next_indent), (long)strlen(next_indent)) : rb_str_cat_cstr((indent), (next_indent)); })), field_flag = 1; field_flag; rb_str_resize(indent, (!(((struct RBasic*)(indent))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(indent))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(indent))->as.heap.len) - 4), field_flag = 0) {dump_node(buf, indent, comment, node->u1.node);};
 return;

      case NODE_YIELD:
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # yield invocation\n"))) ? rb_str_cat((buf), (("| # yield invocation\n")), (long)strlen(("| # yield invocation\n"))) : rb_str_cat_cstr((buf), (("| # yield invocation\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # format: yield [nd_head]\n"))) ? rb_str_cat((buf), (("| # format: yield [nd_head]\n")), (long)strlen(("| # format: yield [nd_head]\n"))) : rb_str_cat_cstr((buf), (("| # format: yield [nd_head]\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # example: yield 1\n"))) ? rb_str_cat((buf), (("| # example: yield 1\n")), (long)strlen(("| # example: yield 1\n"))) : rb_str_cat_cstr((buf), (("| # example: yield 1\n"))); }); };
 (next_indent = "    ");
 for (((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s:\n", (((int)( comment ? (sizeof("nd_head (arguments)") - 1) : (sizeof("nd_head") - 1)))), (("nd_head (arguments)")))),  ({ (__builtin_constant_p(next_indent)) ? rb_str_cat((indent), (next_indent), (long)strlen(next_indent)) : rb_str_cat_cstr((indent), (next_indent)); })), field_flag = 1; field_flag; rb_str_resize(indent, (!(((struct RBasic*)(indent))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(indent))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(indent))->as.heap.len) - 4), field_flag = 0) {dump_node(buf, indent, comment, node->u1.node);};
 return;

      case NODE_LVAR:
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # local variable reference\n"))) ? rb_str_cat((buf), (("| # local variable reference\n")), (long)strlen(("| # local variable reference\n"))) : rb_str_cat_cstr((buf), (("| # local variable reference\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # format: [nd_vid](lvar)\n"))) ? rb_str_cat((buf), (("| # format: [nd_vid](lvar)\n")), (long)strlen(("| # format: [nd_vid](lvar)\n"))) : rb_str_cat_cstr((buf), (("| # format: [nd_vid](lvar)\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # example: x\n"))) ? rb_str_cat((buf), (("| # example: x\n")), (long)strlen(("| # example: x\n"))) : rb_str_cat_cstr((buf), (("| # example: x\n"))); }); };
 for ((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s: ", (((int)( comment ? (sizeof("nd_vid (local variable)") - 1) : (sizeof("nd_vid") - 1)))), (("nd_vid (local variable)")))), field_flag = 1; field_flag;  ({ (__builtin_constant_p(("\n"))) ? rb_str_cat((buf), (("\n")), (long)strlen(("\n"))) : rb_str_cat_cstr((buf), (("\n"))); }), field_flag = 0) add_id(buf, (node->u1.id));
 return;
      case NODE_DVAR:
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # dynamic variable reference\n"))) ? rb_str_cat((buf), (("| # dynamic variable reference\n")), (long)strlen(("| # dynamic variable reference\n"))) : rb_str_cat_cstr((buf), (("| # dynamic variable reference\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # format: [nd_vid](dvar)\n"))) ? rb_str_cat((buf), (("| # format: [nd_vid](dvar)\n")), (long)strlen(("| # format: [nd_vid](dvar)\n"))) : rb_str_cat_cstr((buf), (("| # format: [nd_vid](dvar)\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # example: 1.times { x = 1; x }\n"))) ? rb_str_cat((buf), (("| # example: 1.times { x = 1; x }\n")), (long)strlen(("| # example: 1.times { x = 1; x }\n"))) : rb_str_cat_cstr((buf), (("| # example: 1.times { x = 1; x }\n"))); }); };
 for ((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s: ", (((int)( comment ? (sizeof("nd_vid (local variable)") - 1) : (sizeof("nd_vid") - 1)))), (("nd_vid (local variable)")))), field_flag = 1; field_flag;  ({ (__builtin_constant_p(("\n"))) ? rb_str_cat((buf), (("\n")), (long)strlen(("\n"))) : rb_str_cat_cstr((buf), (("\n"))); }), field_flag = 0) add_id(buf, (node->u1.id));
 return;
      case NODE_IVAR:
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # instance variable reference\n"))) ? rb_str_cat((buf), (("| # instance variable reference\n")), (long)strlen(("| # instance variable reference\n"))) : rb_str_cat_cstr((buf), (("| # instance variable reference\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # format: [nd_vid](ivar)\n"))) ? rb_str_cat((buf), (("| # format: [nd_vid](ivar)\n")), (long)strlen(("| # format: [nd_vid](ivar)\n"))) : rb_str_cat_cstr((buf), (("| # format: [nd_vid](ivar)\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # example: @x\n"))) ? rb_str_cat((buf), (("| # example: @x\n")), (long)strlen(("| # example: @x\n"))) : rb_str_cat_cstr((buf), (("| # example: @x\n"))); }); };
 for ((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s: ", (((int)( comment ? (sizeof("nd_vid (instance variable)") - 1) : (sizeof("nd_vid") - 1)))), (("nd_vid (instance variable)")))), field_flag = 1; field_flag;  ({ (__builtin_constant_p(("\n"))) ? rb_str_cat((buf), (("\n")), (long)strlen(("\n"))) : rb_str_cat_cstr((buf), (("\n"))); }), field_flag = 0) add_id(buf, (node->u1.id));
 return;
      case NODE_CONST:
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # constant reference\n"))) ? rb_str_cat((buf), (("| # constant reference\n")), (long)strlen(("| # constant reference\n"))) : rb_str_cat_cstr((buf), (("| # constant reference\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # format: [nd_vid](constant)\n"))) ? rb_str_cat((buf), (("| # format: [nd_vid](constant)\n")), (long)strlen(("| # format: [nd_vid](constant)\n"))) : rb_str_cat_cstr((buf), (("| # format: [nd_vid](constant)\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # example: X\n"))) ? rb_str_cat((buf), (("| # example: X\n")), (long)strlen(("| # example: X\n"))) : rb_str_cat_cstr((buf), (("| # example: X\n"))); }); };
 for ((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s: ", (((int)( comment ? (sizeof("nd_vid (constant)") - 1) : (sizeof("nd_vid") - 1)))), (("nd_vid (constant)")))), field_flag = 1; field_flag;  ({ (__builtin_constant_p(("\n"))) ? rb_str_cat((buf), (("\n")), (long)strlen(("\n"))) : rb_str_cat_cstr((buf), (("\n"))); }), field_flag = 0) add_id(buf, (node->u1.id));
 return;
      case NODE_CVAR:
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # class variable reference\n"))) ? rb_str_cat((buf), (("| # class variable reference\n")), (long)strlen(("| # class variable reference\n"))) : rb_str_cat_cstr((buf), (("| # class variable reference\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # format: [nd_vid](cvar)\n"))) ? rb_str_cat((buf), (("| # format: [nd_vid](cvar)\n")), (long)strlen(("| # format: [nd_vid](cvar)\n"))) : rb_str_cat_cstr((buf), (("| # format: [nd_vid](cvar)\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # example: @@x\n"))) ? rb_str_cat((buf), (("| # example: @@x\n")), (long)strlen(("| # example: @@x\n"))) : rb_str_cat_cstr((buf), (("| # example: @@x\n"))); }); };
 for ((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s: ", (((int)( comment ? (sizeof("nd_vid (class variable)") - 1) : (sizeof("nd_vid") - 1)))), (("nd_vid (class variable)")))), field_flag = 1; field_flag;  ({ (__builtin_constant_p(("\n"))) ? rb_str_cat((buf), (("\n")), (long)strlen(("\n"))) : rb_str_cat_cstr((buf), (("\n"))); }), field_flag = 0) add_id(buf, (node->u1.id));
 return;

      case NODE_GVAR:
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # global variable reference\n"))) ? rb_str_cat((buf), (("| # global variable reference\n")), (long)strlen(("| # global variable reference\n"))) : rb_str_cat_cstr((buf), (("| # global variable reference\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # format: [nd_entry](gvar)\n"))) ? rb_str_cat((buf), (("| # format: [nd_entry](gvar)\n")), (long)strlen(("| # format: [nd_entry](gvar)\n"))) : rb_str_cat_cstr((buf), (("| # format: [nd_entry](gvar)\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # example: $x\n"))) ? rb_str_cat((buf), (("| # example: $x\n")), (long)strlen(("| # example: $x\n"))) : rb_str_cat_cstr((buf), (("| # example: $x\n"))); }); };
 for ((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s: ", (((int)( comment ? (sizeof("nd_entry (global variable)") - 1) : (sizeof("nd_entry") - 1)))), (("nd_entry (global variable)")))), field_flag = 1; field_flag;  ({ (__builtin_constant_p(("\n"))) ? rb_str_cat((buf), (("\n")), (long)strlen(("\n"))) : rb_str_cat_cstr((buf), (("\n"))); }), field_flag = 0) add_id(buf, ((node->u3.entry)->id));
 return;

      case NODE_NTH_REF:
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # nth special variable reference\n"))) ? rb_str_cat((buf), (("| # nth special variable reference\n")), (long)strlen(("| # nth special variable reference\n"))) : rb_str_cat_cstr((buf), (("| # nth special variable reference\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # format: $[nd_nth]\n"))) ? rb_str_cat((buf), (("| # format: $[nd_nth]\n")), (long)strlen(("| # format: $[nd_nth]\n"))) : rb_str_cat_cstr((buf), (("| # format: $[nd_nth]\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # example: $1, $2, ..\n"))) ? rb_str_cat((buf), (("| # example: $1, $2, ..\n")), (long)strlen(("| # example: $1, $2, ..\n"))) : rb_str_cat_cstr((buf), (("| # example: $1, $2, ..\n"))); }); };
 for ((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s: ", (((int)( comment ? (sizeof("nd_nth (variable)") - 1) : (sizeof("nd_nth") - 1)))), (("nd_nth (variable)")))), field_flag = 1; field_flag;  ({ (__builtin_constant_p(("\n"))) ? rb_str_cat((buf), (("\n")), (long)strlen(("\n"))) : rb_str_cat_cstr((buf), (("\n"))); }), field_flag = 0) {  ({ (__builtin_constant_p(("$"))) ? rb_str_cat((buf), (("$")), (long)strlen(("$"))) : rb_str_cat_cstr((buf), (("$"))); }); rb_str_catf(buf, "%ld", (node->u2.argc)); }
 return;

      case NODE_BACK_REF:
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # back special variable reference\n"))) ? rb_str_cat((buf), (("| # back special variable reference\n")), (long)strlen(("| # back special variable reference\n"))) : rb_str_cat_cstr((buf), (("| # back special variable reference\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # format: $[nd_nth]\n"))) ? rb_str_cat((buf), (("| # format: $[nd_nth]\n")), (long)strlen(("| # format: $[nd_nth]\n"))) : rb_str_cat_cstr((buf), (("| # format: $[nd_nth]\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # example: $&, $`, $', $+\n"))) ? rb_str_cat((buf), (("| # example: $&, $`, $', $+\n")), (long)strlen(("| # example: $&, $`, $', $+\n"))) : rb_str_cat_cstr((buf), (("| # example: $&, $`, $', $+\n"))); }); };
 for ((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s: ", (((int)( comment ? (sizeof("nd_nth (variable)") - 1) : (sizeof("nd_nth") - 1)))), (("nd_nth (variable)")))), field_flag = 1; field_flag;  ({ (__builtin_constant_p(("\n"))) ? rb_str_cat((buf), (("\n")), (long)strlen(("\n"))) : rb_str_cat_cstr((buf), (("\n"))); }), field_flag = 0) {
     char name[3];
     name[0] = '$';
     name[1] = (char)node->u2.argc;
     name[2] = '\0';
      ({ (__builtin_constant_p((name))) ? rb_str_cat((buf), ((name)), (long)strlen((name))) : rb_str_cat_cstr((buf), ((name))); });
 }
 return;

      case NODE_MATCH:
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # match expression (against $_ implicitly)\n"))) ? rb_str_cat((buf), (("| # match expression (against $_ implicitly)\n")), (long)strlen(("| # match expression (against $_ implicitly)\n"))) : rb_str_cat_cstr((buf), (("| # match expression (against $_ implicitly)\n"))); }); };
        if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # format: [nd_lit] (in condition)\n"))) ? rb_str_cat((buf), (("| # format: [nd_lit] (in condition)\n")), (long)strlen(("| # format: [nd_lit] (in condition)\n"))) : rb_str_cat_cstr((buf), (("| # format: [nd_lit] (in condition)\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # example: if /foo/; foo; end\n"))) ? rb_str_cat((buf), (("| # example: if /foo/; foo; end\n")), (long)strlen(("| # example: if /foo/; foo; end\n"))) : rb_str_cat_cstr((buf), (("| # example: if /foo/; foo; end\n"))); }); };
 for ((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s: ", (((int)( comment ? (sizeof("nd_lit (regexp)") - 1) : (sizeof("nd_lit") - 1)))), (("nd_lit (regexp)")))), field_flag = 1; field_flag;  ({ (__builtin_constant_p(("\n"))) ? rb_str_cat((buf), (("\n")), (long)strlen(("\n"))) : rb_str_cat_cstr((buf), (("\n"))); }), field_flag = 0) rb_str_concat(buf, (rb_inspect(node->u1.value)));
 return;

      case NODE_MATCH2:
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # match expression (regexp first)\n"))) ? rb_str_cat((buf), (("| # match expression (regexp first)\n")), (long)strlen(("| # match expression (regexp first)\n"))) : rb_str_cat_cstr((buf), (("| # match expression (regexp first)\n"))); }); };
        if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # format: [nd_recv] =~ [nd_value]\n"))) ? rb_str_cat((buf), (("| # format: [nd_recv] =~ [nd_value]\n")), (long)strlen(("| # format: [nd_recv] =~ [nd_value]\n"))) : rb_str_cat_cstr((buf), (("| # format: [nd_recv] =~ [nd_value]\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # example: /foo/ =~ 'foo'\n"))) ? rb_str_cat((buf), (("| # example: /foo/ =~ 'foo'\n")), (long)strlen(("| # example: /foo/ =~ 'foo'\n"))) : rb_str_cat_cstr((buf), (("| # example: /foo/ =~ 'foo'\n"))); }); };
 for (((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s:\n", (((int)( comment ? (sizeof("nd_recv (regexp (receiver))") - 1) : (sizeof("nd_recv") - 1)))), (("nd_recv (regexp (receiver))")))),  ({ (__builtin_constant_p(next_indent)) ? rb_str_cat((indent), (next_indent), (long)strlen(next_indent)) : rb_str_cat_cstr((indent), (next_indent)); })), field_flag = 1; field_flag; rb_str_resize(indent, (!(((struct RBasic*)(indent))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(indent))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(indent))->as.heap.len) - 4), field_flag = 0) {dump_node(buf, indent, comment, node->u1.node);};
 if (!node->u3.node) (next_indent = "    ");
 for (((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s:\n", (((int)( comment ? (sizeof("nd_value (string (argument))") - 1) : (sizeof("nd_value") - 1)))), (("nd_value (string (argument))")))),  ({ (__builtin_constant_p(next_indent)) ? rb_str_cat((indent), (next_indent), (long)strlen(next_indent)) : rb_str_cat_cstr((indent), (next_indent)); })), field_flag = 1; field_flag; rb_str_resize(indent, (!(((struct RBasic*)(indent))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(indent))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(indent))->as.heap.len) - 4), field_flag = 0) {dump_node(buf, indent, comment, node->u2.node);};
 if (node->u3.node) {
     (next_indent = "    ");
     for (((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s:\n", (((int)( comment ? (sizeof("nd_args (named captures)") - 1) : (sizeof("nd_args") - 1)))), (("nd_args (named captures)")))),  ({ (__builtin_constant_p(next_indent)) ? rb_str_cat((indent), (next_indent), (long)strlen(next_indent)) : rb_str_cat_cstr((indent), (next_indent)); })), field_flag = 1; field_flag; rb_str_resize(indent, (!(((struct RBasic*)(indent))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(indent))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(indent))->as.heap.len) - 4), field_flag = 0) {dump_node(buf, indent, comment, node->u3.node);};
 }
 return;

      case NODE_MATCH3:
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # match expression (regexp second)\n"))) ? rb_str_cat((buf), (("| # match expression (regexp second)\n")), (long)strlen(("| # match expression (regexp second)\n"))) : rb_str_cat_cstr((buf), (("| # match expression (regexp second)\n"))); }); };
        if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # format: [nd_recv] =~ [nd_value]\n"))) ? rb_str_cat((buf), (("| # format: [nd_recv] =~ [nd_value]\n")), (long)strlen(("| # format: [nd_recv] =~ [nd_value]\n"))) : rb_str_cat_cstr((buf), (("| # format: [nd_recv] =~ [nd_value]\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # example: 'foo' =~ /foo/\n"))) ? rb_str_cat((buf), (("| # example: 'foo' =~ /foo/\n")), (long)strlen(("| # example: 'foo' =~ /foo/\n"))) : rb_str_cat_cstr((buf), (("| # example: 'foo' =~ /foo/\n"))); }); };
 for (((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s:\n", (((int)( comment ? (sizeof("nd_recv (string (receiver))") - 1) : (sizeof("nd_recv") - 1)))), (("nd_recv (string (receiver))")))),  ({ (__builtin_constant_p(next_indent)) ? rb_str_cat((indent), (next_indent), (long)strlen(next_indent)) : rb_str_cat_cstr((indent), (next_indent)); })), field_flag = 1; field_flag; rb_str_resize(indent, (!(((struct RBasic*)(indent))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(indent))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(indent))->as.heap.len) - 4), field_flag = 0) {dump_node(buf, indent, comment, node->u1.node);};
 (next_indent = "    ");
 for (((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s:\n", (((int)( comment ? (sizeof("nd_value (regexp (argument))") - 1) : (sizeof("nd_value") - 1)))), (("nd_value (regexp (argument))")))),  ({ (__builtin_constant_p(next_indent)) ? rb_str_cat((indent), (next_indent), (long)strlen(next_indent)) : rb_str_cat_cstr((indent), (next_indent)); })), field_flag = 1; field_flag; rb_str_resize(indent, (!(((struct RBasic*)(indent))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(indent))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(indent))->as.heap.len) - 4), field_flag = 0) {dump_node(buf, indent, comment, node->u2.node);};
 return;

      case NODE_LIT:
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # literal\n"))) ? rb_str_cat((buf), (("| # literal\n")), (long)strlen(("| # literal\n"))) : rb_str_cat_cstr((buf), (("| # literal\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # format: [nd_lit]\n"))) ? rb_str_cat((buf), (("| # format: [nd_lit]\n")), (long)strlen(("| # format: [nd_lit]\n"))) : rb_str_cat_cstr((buf), (("| # format: [nd_lit]\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # example: 1, /foo/\n"))) ? rb_str_cat((buf), (("| # example: 1, /foo/\n")), (long)strlen(("| # example: 1, /foo/\n"))) : rb_str_cat_cstr((buf), (("| # example: 1, /foo/\n"))); }); };
 goto lit;
      case NODE_STR:
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # string literal\n"))) ? rb_str_cat((buf), (("| # string literal\n")), (long)strlen(("| # string literal\n"))) : rb_str_cat_cstr((buf), (("| # string literal\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # format: [nd_lit]\n"))) ? rb_str_cat((buf), (("| # format: [nd_lit]\n")), (long)strlen(("| # format: [nd_lit]\n"))) : rb_str_cat_cstr((buf), (("| # format: [nd_lit]\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # example: 'foo'\n"))) ? rb_str_cat((buf), (("| # example: 'foo'\n")), (long)strlen(("| # example: 'foo'\n"))) : rb_str_cat_cstr((buf), (("| # example: 'foo'\n"))); }); };
 goto lit;
      case NODE_XSTR:
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # xstring literal\n"))) ? rb_str_cat((buf), (("| # xstring literal\n")), (long)strlen(("| # xstring literal\n"))) : rb_str_cat_cstr((buf), (("| # xstring literal\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # format: [nd_lit]\n"))) ? rb_str_cat((buf), (("| # format: [nd_lit]\n")), (long)strlen(("| # format: [nd_lit]\n"))) : rb_str_cat_cstr((buf), (("| # format: [nd_lit]\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # example: `foo`\n"))) ? rb_str_cat((buf), (("| # example: `foo`\n")), (long)strlen(("| # example: `foo`\n"))) : rb_str_cat_cstr((buf), (("| # example: `foo`\n"))); }); };
      lit:
 for ((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s: ", (((int)( comment ? (sizeof("nd_lit (literal)") - 1) : (sizeof("nd_lit") - 1)))), (("nd_lit (literal)")))), field_flag = 1; field_flag;  ({ (__builtin_constant_p(("\n"))) ? rb_str_cat((buf), (("\n")), (long)strlen(("\n"))) : rb_str_cat_cstr((buf), (("\n"))); }), field_flag = 0) rb_str_concat(buf, (rb_inspect(node->u1.value)));
 return;

      case NODE_DSTR:
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # string literal with interpolation\n"))) ? rb_str_cat((buf), (("| # string literal with interpolation\n")), (long)strlen(("| # string literal with interpolation\n"))) : rb_str_cat_cstr((buf), (("| # string literal with interpolation\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # format: [nd_lit]\n"))) ? rb_str_cat((buf), (("| # format: [nd_lit]\n")), (long)strlen(("| # format: [nd_lit]\n"))) : rb_str_cat_cstr((buf), (("| # format: [nd_lit]\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # example: \"foo#{ bar }baz\"\n"))) ? rb_str_cat((buf), (("| # example: \"foo#{ bar }baz\"\n")), (long)strlen(("| # example: \"foo#{ bar }baz\"\n"))) : rb_str_cat_cstr((buf), (("| # example: \"foo#{ bar }baz\"\n"))); }); };
 goto dlit;
      case NODE_DXSTR:
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # xstring literal with interpolation\n"))) ? rb_str_cat((buf), (("| # xstring literal with interpolation\n")), (long)strlen(("| # xstring literal with interpolation\n"))) : rb_str_cat_cstr((buf), (("| # xstring literal with interpolation\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # format: [nd_lit]\n"))) ? rb_str_cat((buf), (("| # format: [nd_lit]\n")), (long)strlen(("| # format: [nd_lit]\n"))) : rb_str_cat_cstr((buf), (("| # format: [nd_lit]\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # example: `foo#{ bar }baz`\n"))) ? rb_str_cat((buf), (("| # example: `foo#{ bar }baz`\n")), (long)strlen(("| # example: `foo#{ bar }baz`\n"))) : rb_str_cat_cstr((buf), (("| # example: `foo#{ bar }baz`\n"))); }); };
 goto dlit;
      case NODE_DREGX:
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # regexp literal with interpolation\n"))) ? rb_str_cat((buf), (("| # regexp literal with interpolation\n")), (long)strlen(("| # regexp literal with interpolation\n"))) : rb_str_cat_cstr((buf), (("| # regexp literal with interpolation\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # format: [nd_lit]\n"))) ? rb_str_cat((buf), (("| # format: [nd_lit]\n")), (long)strlen(("| # format: [nd_lit]\n"))) : rb_str_cat_cstr((buf), (("| # format: [nd_lit]\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # example: /foo#{ bar }baz/\n"))) ? rb_str_cat((buf), (("| # example: /foo#{ bar }baz/\n")), (long)strlen(("| # example: /foo#{ bar }baz/\n"))) : rb_str_cat_cstr((buf), (("| # example: /foo#{ bar }baz/\n"))); }); };
 goto dlit;
      case NODE_DSYM:
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # symbol literal with interpolation\n"))) ? rb_str_cat((buf), (("| # symbol literal with interpolation\n")), (long)strlen(("| # symbol literal with interpolation\n"))) : rb_str_cat_cstr((buf), (("| # symbol literal with interpolation\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # format: [nd_lit]\n"))) ? rb_str_cat((buf), (("| # format: [nd_lit]\n")), (long)strlen(("| # format: [nd_lit]\n"))) : rb_str_cat_cstr((buf), (("| # format: [nd_lit]\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # example: :\"foo#{ bar }baz\"\n"))) ? rb_str_cat((buf), (("| # example: :\"foo#{ bar }baz\"\n")), (long)strlen(("| # example: :\"foo#{ bar }baz\"\n"))) : rb_str_cat_cstr((buf), (("| # example: :\"foo#{ bar }baz\"\n"))); }); };
      dlit:
 for ((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s: ", (((int)( comment ? (sizeof("nd_lit (preceding string)") - 1) : (sizeof("nd_lit") - 1)))), (("nd_lit (preceding string)")))), field_flag = 1; field_flag;  ({ (__builtin_constant_p(("\n"))) ? rb_str_cat((buf), (("\n")), (long)strlen(("\n"))) : rb_str_cat_cstr((buf), (("\n"))); }), field_flag = 0) rb_str_concat(buf, (rb_inspect(node->u1.value)));
 for (((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s:\n", (((int)( comment ? (sizeof("nd_next->nd_head (interpolation)") - 1) : (sizeof("nd_next->nd_head") - 1)))), (("nd_next->nd_head (interpolation)")))),  ({ (__builtin_constant_p(next_indent)) ? rb_str_cat((indent), (next_indent), (long)strlen(next_indent)) : rb_str_cat_cstr((indent), (next_indent)); })), field_flag = 1; field_flag; rb_str_resize(indent, (!(((struct RBasic*)(indent))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(indent))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(indent))->as.heap.len) - 4), field_flag = 0) {dump_node(buf, indent, comment, node->u3.node->u1.node);};
 (next_indent = "    ");
 for (((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s:\n", (((int)( comment ? (sizeof("nd_next->nd_next (tailing strings)") - 1) : (sizeof("nd_next->nd_next") - 1)))), (("nd_next->nd_next (tailing strings)")))),  ({ (__builtin_constant_p(next_indent)) ? rb_str_cat((indent), (next_indent), (long)strlen(next_indent)) : rb_str_cat_cstr((indent), (next_indent)); })), field_flag = 1; field_flag; rb_str_resize(indent, (!(((struct RBasic*)(indent))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(indent))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(indent))->as.heap.len) - 4), field_flag = 0) {dump_node(buf, indent, comment, node->u3.node->u3.node);};
 return;

      case NODE_EVSTR:
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # interpolation expression\n"))) ? rb_str_cat((buf), (("| # interpolation expression\n")), (long)strlen(("| # interpolation expression\n"))) : rb_str_cat_cstr((buf), (("| # interpolation expression\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # format: \"..#{ [nd_lit] }..\"\n"))) ? rb_str_cat((buf), (("| # format: \"..#{ [nd_lit] }..\"\n")), (long)strlen(("| # format: \"..#{ [nd_lit] }..\"\n"))) : rb_str_cat_cstr((buf), (("| # format: \"..#{ [nd_lit] }..\"\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # example: \"foo#{ bar }baz\"\n"))) ? rb_str_cat((buf), (("| # example: \"foo#{ bar }baz\"\n")), (long)strlen(("| # example: \"foo#{ bar }baz\"\n"))) : rb_str_cat_cstr((buf), (("| # example: \"foo#{ bar }baz\"\n"))); }); };
 (next_indent = "    ");
 for (((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s:\n", (((int)( comment ? (sizeof("nd_body (body)") - 1) : (sizeof("nd_body") - 1)))), (("nd_body (body)")))),  ({ (__builtin_constant_p(next_indent)) ? rb_str_cat((indent), (next_indent), (long)strlen(next_indent)) : rb_str_cat_cstr((indent), (next_indent)); })), field_flag = 1; field_flag; rb_str_resize(indent, (!(((struct RBasic*)(indent))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(indent))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(indent))->as.heap.len) - 4), field_flag = 0) {dump_node(buf, indent, comment, node->u2.node);};
 return;
      ...
      case NODE_ARGSCAT:
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # splat argument following arguments\n"))) ? rb_str_cat((buf), (("| # splat argument following arguments\n")), (long)strlen(("| # splat argument following arguments\n"))) : rb_str_cat_cstr((buf), (("| # splat argument following arguments\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # format: ..(*[nd_head], [nd_body..])\n"))) ? rb_str_cat((buf), (("| # format: ..(*[nd_head], [nd_body..])\n")), (long)strlen(("| # format: ..(*[nd_head], [nd_body..])\n"))) : rb_str_cat_cstr((buf), (("| # format: ..(*[nd_head], [nd_body..])\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # example: foo(*ary, post_arg1, post_arg2)\n"))) ? rb_str_cat((buf), (("| # example: foo(*ary, post_arg1, post_arg2)\n")), (long)strlen(("| # example: foo(*ary, post_arg1, post_arg2)\n"))) : rb_str_cat_cstr((buf), (("| # example: foo(*ary, post_arg1, post_arg2)\n"))); }); };
 for (((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s:\n", (((int)( comment ? (sizeof("nd_head (preceding array)") - 1) : (sizeof("nd_head") - 1)))), (("nd_head (preceding array)")))),  ({ (__builtin_constant_p(next_indent)) ? rb_str_cat((indent), (next_indent), (long)strlen(next_indent)) : rb_str_cat_cstr((indent), (next_indent)); })), field_flag = 1; field_flag; rb_str_resize(indent, (!(((struct RBasic*)(indent))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(indent))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(indent))->as.heap.len) - 4), field_flag = 0) {dump_node(buf, indent, comment, node->u1.node);};
 (next_indent = "    ");
 for (((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s:\n", (((int)( comment ? (sizeof("nd_body (following array)") - 1) : (sizeof("nd_body") - 1)))), (("nd_body (following array)")))),  ({ (__builtin_constant_p(next_indent)) ? rb_str_cat((indent), (next_indent), (long)strlen(next_indent)) : rb_str_cat_cstr((indent), (next_indent)); })), field_flag = 1; field_flag; rb_str_resize(indent, (!(((struct RBasic*)(indent))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(indent))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(indent))->as.heap.len) - 4), field_flag = 0) {dump_node(buf, indent, comment, node->u2.node);};
 return;

      case NODE_ARGSPUSH:
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # splat argument following one argument\n"))) ? rb_str_cat((buf), (("| # splat argument following one argument\n")), (long)strlen(("| # splat argument following one argument\n"))) : rb_str_cat_cstr((buf), (("| # splat argument following one argument\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # format: ..(*[nd_head], [nd_body])\n"))) ? rb_str_cat((buf), (("| # format: ..(*[nd_head], [nd_body])\n")), (long)strlen(("| # format: ..(*[nd_head], [nd_body])\n"))) : rb_str_cat_cstr((buf), (("| # format: ..(*[nd_head], [nd_body])\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # example: foo(*ary, post_arg)\n"))) ? rb_str_cat((buf), (("| # example: foo(*ary, post_arg)\n")), (long)strlen(("| # example: foo(*ary, post_arg)\n"))) : rb_str_cat_cstr((buf), (("| # example: foo(*ary, post_arg)\n"))); }); };
 for (((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s:\n", (((int)( comment ? (sizeof("nd_head (preceding array)") - 1) : (sizeof("nd_head") - 1)))), (("nd_head (preceding array)")))),  ({ (__builtin_constant_p(next_indent)) ? rb_str_cat((indent), (next_indent), (long)strlen(next_indent)) : rb_str_cat_cstr((indent), (next_indent)); })), field_flag = 1; field_flag; rb_str_resize(indent, (!(((struct RBasic*)(indent))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(indent))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(indent))->as.heap.len) - 4), field_flag = 0) {dump_node(buf, indent, comment, node->u1.node);};
 (next_indent = "    ");
 for (((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s:\n", (((int)( comment ? (sizeof("nd_body (following element)") - 1) : (sizeof("nd_body") - 1)))), (("nd_body (following element)")))),  ({ (__builtin_constant_p(next_indent)) ? rb_str_cat((indent), (next_indent), (long)strlen(next_indent)) : rb_str_cat_cstr((indent), (next_indent)); })), field_flag = 1; field_flag; rb_str_resize(indent, (!(((struct RBasic*)(indent))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(indent))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(indent))->as.heap.len) - 4), field_flag = 0) {dump_node(buf, indent, comment, node->u2.node);};
 return;

      case NODE_SPLAT:
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # splat argument\n"))) ? rb_str_cat((buf), (("| # splat argument\n")), (long)strlen(("| # splat argument\n"))) : rb_str_cat_cstr((buf), (("| # splat argument\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # format: *[nd_head]\n"))) ? rb_str_cat((buf), (("| # format: *[nd_head]\n")), (long)strlen(("| # format: *[nd_head]\n"))) : rb_str_cat_cstr((buf), (("| # format: *[nd_head]\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # example: foo(*ary)\n"))) ? rb_str_cat((buf), (("| # example: foo(*ary)\n")), (long)strlen(("| # example: foo(*ary)\n"))) : rb_str_cat_cstr((buf), (("| # example: foo(*ary)\n"))); }); };
 (next_indent = "    ");
 for (((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s:\n", (((int)( comment ? (sizeof("nd_head (splat'ed array)") - 1) : (sizeof("nd_head") - 1)))), (("nd_head (splat'ed array)")))),  ({ (__builtin_constant_p(next_indent)) ? rb_str_cat((indent), (next_indent), (long)strlen(next_indent)) : rb_str_cat_cstr((indent), (next_indent)); })), field_flag = 1; field_flag; rb_str_resize(indent, (!(((struct RBasic*)(indent))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(indent))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(indent))->as.heap.len) - 4), field_flag = 0) {dump_node(buf, indent, comment, node->u1.node);};
 return;

      case NODE_BLOCK_PASS:
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # arguments with block argument\n"))) ? rb_str_cat((buf), (("| # arguments with block argument\n")), (long)strlen(("| # arguments with block argument\n"))) : rb_str_cat_cstr((buf), (("| # arguments with block argument\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # format: ..([nd_head], &[nd_body])\n"))) ? rb_str_cat((buf), (("| # format: ..([nd_head], &[nd_body])\n")), (long)strlen(("| # format: ..([nd_head], &[nd_body])\n"))) : rb_str_cat_cstr((buf), (("| # format: ..([nd_head], &[nd_body])\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # example: foo(x, &blk)\n"))) ? rb_str_cat((buf), (("| # example: foo(x, &blk)\n")), (long)strlen(("| # example: foo(x, &blk)\n"))) : rb_str_cat_cstr((buf), (("| # example: foo(x, &blk)\n"))); }); };
 for (((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s:\n", (((int)( comment ? (sizeof("nd_head (other arguments)") - 1) : (sizeof("nd_head") - 1)))), (("nd_head (other arguments)")))),  ({ (__builtin_constant_p(next_indent)) ? rb_str_cat((indent), (next_indent), (long)strlen(next_indent)) : rb_str_cat_cstr((indent), (next_indent)); })), field_flag = 1; field_flag; rb_str_resize(indent, (!(((struct RBasic*)(indent))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(indent))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(indent))->as.heap.len) - 4), field_flag = 0) {dump_node(buf, indent, comment, node->u1.node);};
 (next_indent = "    ");
 for (((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s:\n", (((int)( comment ? (sizeof("nd_body (block argument)") - 1) : (sizeof("nd_body") - 1)))), (("nd_body (block argument)")))),  ({ (__builtin_constant_p(next_indent)) ? rb_str_cat((indent), (next_indent), (long)strlen(next_indent)) : rb_str_cat_cstr((indent), (next_indent)); })), field_flag = 1; field_flag; rb_str_resize(indent, (!(((struct RBasic*)(indent))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(indent))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(indent))->as.heap.len) - 4), field_flag = 0) {dump_node(buf, indent, comment, node->u2.node);};
 return;

      case NODE_DEFN:
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # method definition\n"))) ? rb_str_cat((buf), (("| # method definition\n")), (long)strlen(("| # method definition\n"))) : rb_str_cat_cstr((buf), (("| # method definition\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # format: def [nd_mid] [nd_defn]; end\n"))) ? rb_str_cat((buf), (("| # format: def [nd_mid] [nd_defn]; end\n")), (long)strlen(("| # format: def [nd_mid] [nd_defn]; end\n"))) : rb_str_cat_cstr((buf), (("| # format: def [nd_mid] [nd_defn]; end\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # example; def foo; bar; end\n"))) ? rb_str_cat((buf), (("| # example; def foo; bar; end\n")), (long)strlen(("| # example; def foo; bar; end\n"))) : rb_str_cat_cstr((buf), (("| # example; def foo; bar; end\n"))); }); };
 for ((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s: ", (((int)( comment ? (sizeof("nd_mid (method name)") - 1) : (sizeof("nd_mid") - 1)))), (("nd_mid (method name)")))), field_flag = 1; field_flag;  ({ (__builtin_constant_p(("\n"))) ? rb_str_cat((buf), (("\n")), (long)strlen(("\n"))) : rb_str_cat_cstr((buf), (("\n"))); }), field_flag = 0) add_id(buf, (node->u2.id));
 (next_indent = "    ");
 for (((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s:\n", (((int)( comment ? (sizeof("nd_defn (method definition)") - 1) : (sizeof("nd_defn") - 1)))), (("nd_defn (method definition)")))),  ({ (__builtin_constant_p(next_indent)) ? rb_str_cat((indent), (next_indent), (long)strlen(next_indent)) : rb_str_cat_cstr((indent), (next_indent)); })), field_flag = 1; field_flag; rb_str_resize(indent, (!(((struct RBasic*)(indent))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(indent))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(indent))->as.heap.len) - 4), field_flag = 0) {dump_node(buf, indent, comment, node->u3.node);};
 return;

      case NODE_DEFS:
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # singleton method definition\n"))) ? rb_str_cat((buf), (("| # singleton method definition\n")), (long)strlen(("| # singleton method definition\n"))) : rb_str_cat_cstr((buf), (("| # singleton method definition\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # format: def [nd_recv].[nd_mid] [nd_defn]; end\n"))) ? rb_str_cat((buf), (("| # format: def [nd_recv].[nd_mid] [nd_defn]; end\n")), (long)strlen(("| # format: def [nd_recv].[nd_mid] [nd_defn]; end\n"))) : rb_str_cat_cstr((buf), (("| # format: def [nd_recv].[nd_mid] [nd_defn]; end\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # example; def obj.foo; bar; end\n"))) ? rb_str_cat((buf), (("| # example; def obj.foo; bar; end\n")), (long)strlen(("| # example; def obj.foo; bar; end\n"))) : rb_str_cat_cstr((buf), (("| # example; def obj.foo; bar; end\n"))); }); };
 for (((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s:\n", (((int)( comment ? (sizeof("nd_recv (receiver)") - 1) : (sizeof("nd_recv") - 1)))), (("nd_recv (receiver)")))),  ({ (__builtin_constant_p(next_indent)) ? rb_str_cat((indent), (next_indent), (long)strlen(next_indent)) : rb_str_cat_cstr((indent), (next_indent)); })), field_flag = 1; field_flag; rb_str_resize(indent, (!(((struct RBasic*)(indent))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(indent))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(indent))->as.heap.len) - 4), field_flag = 0) {dump_node(buf, indent, comment, node->u1.node);};
 for ((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s: ", (((int)( comment ? (sizeof("nd_mid (method name)") - 1) : (sizeof("nd_mid") - 1)))), (("nd_mid (method name)")))), field_flag = 1; field_flag;  ({ (__builtin_constant_p(("\n"))) ? rb_str_cat((buf), (("\n")), (long)strlen(("\n"))) : rb_str_cat_cstr((buf), (("\n"))); }), field_flag = 0) add_id(buf, (node->u2.id));
 (next_indent = "    ");
 for (((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s:\n", (((int)( comment ? (sizeof("nd_defn (method definition)") - 1) : (sizeof("nd_defn") - 1)))), (("nd_defn (method definition)")))),  ({ (__builtin_constant_p(next_indent)) ? rb_str_cat((indent), (next_indent), (long)strlen(next_indent)) : rb_str_cat_cstr((indent), (next_indent)); })), field_flag = 1; field_flag; rb_str_resize(indent, (!(((struct RBasic*)(indent))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(indent))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(indent))->as.heap.len) - 4), field_flag = 0) {dump_node(buf, indent, comment, node->u3.node);};
 return;
      ...
      case NODE_ALIAS:
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # method alias statement\n"))) ? rb_str_cat((buf), (("| # method alias statement\n")), (long)strlen(("| # method alias statement\n"))) : rb_str_cat_cstr((buf), (("| # method alias statement\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # format: alias [u1.node] [u2.node]\n"))) ? rb_str_cat((buf), (("| # format: alias [u1.node] [u2.node]\n")), (long)strlen(("| # format: alias [u1.node] [u2.node]\n"))) : rb_str_cat_cstr((buf), (("| # format: alias [u1.node] [u2.node]\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # example: alias bar foo\n"))) ? rb_str_cat((buf), (("| # example: alias bar foo\n")), (long)strlen(("| # example: alias bar foo\n"))) : rb_str_cat_cstr((buf), (("| # example: alias bar foo\n"))); }); };
 for (((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s:\n", (((int)( comment ? (sizeof("nd_1st (new name)") - 1) : (sizeof("nd_1st") - 1)))), (("nd_1st (new name)")))),  ({ (__builtin_constant_p(next_indent)) ? rb_str_cat((indent), (next_indent), (long)strlen(next_indent)) : rb_str_cat_cstr((indent), (next_indent)); })), field_flag = 1; field_flag; rb_str_resize(indent, (!(((struct RBasic*)(indent))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(indent))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(indent))->as.heap.len) - 4), field_flag = 0) {dump_node(buf, indent, comment, node->u1.node);};
 (next_indent = "    ");
 for (((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s:\n", (((int)( comment ? (sizeof("nd_2nd (old name)") - 1) : (sizeof("nd_2nd") - 1)))), (("nd_2nd (old name)")))),  ({ (__builtin_constant_p(next_indent)) ? rb_str_cat((indent), (next_indent), (long)strlen(next_indent)) : rb_str_cat_cstr((indent), (next_indent)); })), field_flag = 1; field_flag; rb_str_resize(indent, (!(((struct RBasic*)(indent))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(indent))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(indent))->as.heap.len) - 4), field_flag = 0) {dump_node(buf, indent, comment, node->u2.node);};
 return;

      case NODE_VALIAS:
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # global variable alias statement\n"))) ? rb_str_cat((buf), (("| # global variable alias statement\n")), (long)strlen(("| # global variable alias statement\n"))) : rb_str_cat_cstr((buf), (("| # global variable alias statement\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # format: alias [u1.id](gvar) [u2.id](gvar)\n"))) ? rb_str_cat((buf), (("| # format: alias [u1.id](gvar) [u2.id](gvar)\n")), (long)strlen(("| # format: alias [u1.id](gvar) [u2.id](gvar)\n"))) : rb_str_cat_cstr((buf), (("| # format: alias [u1.id](gvar) [u2.id](gvar)\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # example: alias $y $x\n"))) ? rb_str_cat((buf), (("| # example: alias $y $x\n")), (long)strlen(("| # example: alias $y $x\n"))) : rb_str_cat_cstr((buf), (("| # example: alias $y $x\n"))); }); };
 for ((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s: ", (((int)( comment ? (sizeof("nd_alias (new name)") - 1) : (sizeof("nd_alias") - 1)))), (("nd_alias (new name)")))), field_flag = 1; field_flag;  ({ (__builtin_constant_p(("\n"))) ? rb_str_cat((buf), (("\n")), (long)strlen(("\n"))) : rb_str_cat_cstr((buf), (("\n"))); }), field_flag = 0) add_id(buf, (node->u1.id));
 for ((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s: ", (((int)( comment ? (sizeof("nd_orig (old name)") - 1) : (sizeof("nd_orig") - 1)))), (("nd_orig (old name)")))), field_flag = 1; field_flag;  ({ (__builtin_constant_p(("\n"))) ? rb_str_cat((buf), (("\n")), (long)strlen(("\n"))) : rb_str_cat_cstr((buf), (("\n"))); }), field_flag = 0) add_id(buf, (node->u2.id));
 return;

      case NODE_UNDEF:
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # method alias statement\n"))) ? rb_str_cat((buf), (("| # method alias statement\n")), (long)strlen(("| # method alias statement\n"))) : rb_str_cat_cstr((buf), (("| # method alias statement\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # format: undef [u2.node]\n"))) ? rb_str_cat((buf), (("| # format: undef [u2.node]\n")), (long)strlen(("| # format: undef [u2.node]\n"))) : rb_str_cat_cstr((buf), (("| # format: undef [u2.node]\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # example: undef foo\n"))) ? rb_str_cat((buf), (("| # example: undef foo\n")), (long)strlen(("| # example: undef foo\n"))) : rb_str_cat_cstr((buf), (("| # example: undef foo\n"))); }); };
 (next_indent = "    ");
 for (((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s:\n", (((int)( comment ? (sizeof("nd_undef (old name)") - 1) : (sizeof("nd_undef") - 1)))), (("nd_undef (old name)")))),  ({ (__builtin_constant_p(next_indent)) ? rb_str_cat((indent), (next_indent), (long)strlen(next_indent)) : rb_str_cat_cstr((indent), (next_indent)); })), field_flag = 1; field_flag; rb_str_resize(indent, (!(((struct RBasic*)(indent))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(indent))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(indent))->as.heap.len) - 4), field_flag = 0) {dump_node(buf, indent, comment, node->u2.node);};
 return;

      case NODE_CLASS:
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # class definition\n"))) ? rb_str_cat((buf), (("| # class definition\n")), (long)strlen(("| # class definition\n"))) : rb_str_cat_cstr((buf), (("| # class definition\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # format: class [nd_cpath] < [nd_super]; [nd_body]; end\n"))) ? rb_str_cat((buf), (("| # format: class [nd_cpath] < [nd_super]; [nd_body]; end\n")), (long)strlen(("| # format: class [nd_cpath] < [nd_super]; [nd_body]; end\n"))) : rb_str_cat_cstr((buf), (("| # format: class [nd_cpath] < [nd_super]; [nd_body]; end\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # example: class C2 < C; ..; end\n"))) ? rb_str_cat((buf), (("| # example: class C2 < C; ..; end\n")), (long)strlen(("| # example: class C2 < C; ..; end\n"))) : rb_str_cat_cstr((buf), (("| # example: class C2 < C; ..; end\n"))); }); };
 for (((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s:\n", (((int)( comment ? (sizeof("nd_cpath (class path)") - 1) : (sizeof("nd_cpath") - 1)))), (("nd_cpath (class path)")))),  ({ (__builtin_constant_p(next_indent)) ? rb_str_cat((indent), (next_indent), (long)strlen(next_indent)) : rb_str_cat_cstr((indent), (next_indent)); })), field_flag = 1; field_flag; rb_str_resize(indent, (!(((struct RBasic*)(indent))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(indent))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(indent))->as.heap.len) - 4), field_flag = 0) {dump_node(buf, indent, comment, node->u1.node);};
 for (((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s:\n", (((int)( comment ? (sizeof("nd_super (superclass)") - 1) : (sizeof("nd_super") - 1)))), (("nd_super (superclass)")))),  ({ (__builtin_constant_p(next_indent)) ? rb_str_cat((indent), (next_indent), (long)strlen(next_indent)) : rb_str_cat_cstr((indent), (next_indent)); })), field_flag = 1; field_flag; rb_str_resize(indent, (!(((struct RBasic*)(indent))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(indent))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(indent))->as.heap.len) - 4), field_flag = 0) {dump_node(buf, indent, comment, node->u3.node);};
 (next_indent = "    ");
 for (((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s:\n", (((int)( comment ? (sizeof("nd_body (class definition)") - 1) : (sizeof("nd_body") - 1)))), (("nd_body (class definition)")))),  ({ (__builtin_constant_p(next_indent)) ? rb_str_cat((indent), (next_indent), (long)strlen(next_indent)) : rb_str_cat_cstr((indent), (next_indent)); })), field_flag = 1; field_flag; rb_str_resize(indent, (!(((struct RBasic*)(indent))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(indent))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(indent))->as.heap.len) - 4), field_flag = 0) {dump_node(buf, indent, comment, node->u2.node);};
 return;

      case NODE_MODULE:
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # module definition\n"))) ? rb_str_cat((buf), (("| # module definition\n")), (long)strlen(("| # module definition\n"))) : rb_str_cat_cstr((buf), (("| # module definition\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # format: module [nd_cpath]; [nd_body]; end\n"))) ? rb_str_cat((buf), (("| # format: module [nd_cpath]; [nd_body]; end\n")), (long)strlen(("| # format: module [nd_cpath]; [nd_body]; end\n"))) : rb_str_cat_cstr((buf), (("| # format: module [nd_cpath]; [nd_body]; end\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # example: module M; ..; end\n"))) ? rb_str_cat((buf), (("| # example: module M; ..; end\n")), (long)strlen(("| # example: module M; ..; end\n"))) : rb_str_cat_cstr((buf), (("| # example: module M; ..; end\n"))); }); };
 for (((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s:\n", (((int)( comment ? (sizeof("nd_cpath (module path)") - 1) : (sizeof("nd_cpath") - 1)))), (("nd_cpath (module path)")))),  ({ (__builtin_constant_p(next_indent)) ? rb_str_cat((indent), (next_indent), (long)strlen(next_indent)) : rb_str_cat_cstr((indent), (next_indent)); })), field_flag = 1; field_flag; rb_str_resize(indent, (!(((struct RBasic*)(indent))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(indent))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(indent))->as.heap.len) - 4), field_flag = 0) {dump_node(buf, indent, comment, node->u1.node);};
 (next_indent = "    ");
 for (((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s:\n", (((int)( comment ? (sizeof("nd_body (module definition)") - 1) : (sizeof("nd_body") - 1)))), (("nd_body (module definition)")))),  ({ (__builtin_constant_p(next_indent)) ? rb_str_cat((indent), (next_indent), (long)strlen(next_indent)) : rb_str_cat_cstr((indent), (next_indent)); })), field_flag = 1; field_flag; rb_str_resize(indent, (!(((struct RBasic*)(indent))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(indent))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(indent))->as.heap.len) - 4), field_flag = 0) {dump_node(buf, indent, comment, node->u2.node);};
 return;

      case NODE_SCLASS:
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # singleton class definition\n"))) ? rb_str_cat((buf), (("| # singleton class definition\n")), (long)strlen(("| # singleton class definition\n"))) : rb_str_cat_cstr((buf), (("| # singleton class definition\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # format: class << [nd_recv]; [nd_body]; end\n"))) ? rb_str_cat((buf), (("| # format: class << [nd_recv]; [nd_body]; end\n")), (long)strlen(("| # format: class << [nd_recv]; [nd_body]; end\n"))) : rb_str_cat_cstr((buf), (("| # format: class << [nd_recv]; [nd_body]; end\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # example: class << obj; ..; end\n"))) ? rb_str_cat((buf), (("| # example: class << obj; ..; end\n")), (long)strlen(("| # example: class << obj; ..; end\n"))) : rb_str_cat_cstr((buf), (("| # example: class << obj; ..; end\n"))); }); };
 for (((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s:\n", (((int)( comment ? (sizeof("nd_recv (receiver)") - 1) : (sizeof("nd_recv") - 1)))), (("nd_recv (receiver)")))),  ({ (__builtin_constant_p(next_indent)) ? rb_str_cat((indent), (next_indent), (long)strlen(next_indent)) : rb_str_cat_cstr((indent), (next_indent)); })), field_flag = 1; field_flag; rb_str_resize(indent, (!(((struct RBasic*)(indent))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(indent))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(indent))->as.heap.len) - 4), field_flag = 0) {dump_node(buf, indent, comment, node->u1.node);};
 (next_indent = "    ");
 for (((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s:\n", (((int)( comment ? (sizeof("nd_body (singleton class definition)") - 1) : (sizeof("nd_body") - 1)))), (("nd_body (singleton class definition)")))),  ({ (__builtin_constant_p(next_indent)) ? rb_str_cat((indent), (next_indent), (long)strlen(next_indent)) : rb_str_cat_cstr((indent), (next_indent)); })), field_flag = 1; field_flag; rb_str_resize(indent, (!(((struct RBasic*)(indent))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(indent))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(indent))->as.heap.len) - 4), field_flag = 0) {dump_node(buf, indent, comment, node->u2.node);};
 return;

      case NODE_COLON2:
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # scoped constant reference\n"))) ? rb_str_cat((buf), (("| # scoped constant reference\n")), (long)strlen(("| # scoped constant reference\n"))) : rb_str_cat_cstr((buf), (("| # scoped constant reference\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # format: [nd_head]::[nd_mid]\n"))) ? rb_str_cat((buf), (("| # format: [nd_head]::[nd_mid]\n")), (long)strlen(("| # format: [nd_head]::[nd_mid]\n"))) : rb_str_cat_cstr((buf), (("| # format: [nd_head]::[nd_mid]\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # example: M::C\n"))) ? rb_str_cat((buf), (("| # example: M::C\n")), (long)strlen(("| # example: M::C\n"))) : rb_str_cat_cstr((buf), (("| # example: M::C\n"))); }); };
 for ((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s: ", (((int)( comment ? (sizeof("nd_mid (constant name)") - 1) : (sizeof("nd_mid") - 1)))), (("nd_mid (constant name)")))), field_flag = 1; field_flag;  ({ (__builtin_constant_p(("\n"))) ? rb_str_cat((buf), (("\n")), (long)strlen(("\n"))) : rb_str_cat_cstr((buf), (("\n"))); }), field_flag = 0) add_id(buf, (node->u2.id));
 (next_indent = "    ");
 for (((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s:\n", (((int)( comment ? (sizeof("nd_head (receiver)") - 1) : (sizeof("nd_head") - 1)))), (("nd_head (receiver)")))),  ({ (__builtin_constant_p(next_indent)) ? rb_str_cat((indent), (next_indent), (long)strlen(next_indent)) : rb_str_cat_cstr((indent), (next_indent)); })), field_flag = 1; field_flag; rb_str_resize(indent, (!(((struct RBasic*)(indent))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(indent))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(indent))->as.heap.len) - 4), field_flag = 0) {dump_node(buf, indent, comment, node->u1.node);};
 return;

      case NODE_COLON3:
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # top-level constant reference\n"))) ? rb_str_cat((buf), (("| # top-level constant reference\n")), (long)strlen(("| # top-level constant reference\n"))) : rb_str_cat_cstr((buf), (("| # top-level constant reference\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # format: ::[nd_mid]\n"))) ? rb_str_cat((buf), (("| # format: ::[nd_mid]\n")), (long)strlen(("| # format: ::[nd_mid]\n"))) : rb_str_cat_cstr((buf), (("| # format: ::[nd_mid]\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # example: ::Object\n"))) ? rb_str_cat((buf), (("| # example: ::Object\n")), (long)strlen(("| # example: ::Object\n"))) : rb_str_cat_cstr((buf), (("| # example: ::Object\n"))); }); };
 for ((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s: ", (((int)( comment ? (sizeof("nd_mid (constant name)") - 1) : (sizeof("nd_mid") - 1)))), (("nd_mid (constant name)")))), field_flag = 1; field_flag;  ({ (__builtin_constant_p(("\n"))) ? rb_str_cat((buf), (("\n")), (long)strlen(("\n"))) : rb_str_cat_cstr((buf), (("\n"))); }), field_flag = 0) add_id(buf, (node->u2.id));
 return;

      case NODE_DOT2:
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # range constructor (incl.)\n"))) ? rb_str_cat((buf), (("| # range constructor (incl.)\n")), (long)strlen(("| # range constructor (incl.)\n"))) : rb_str_cat_cstr((buf), (("| # range constructor (incl.)\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # format: [nd_beg]..[nd_end]\n"))) ? rb_str_cat((buf), (("| # format: [nd_beg]..[nd_end]\n")), (long)strlen(("| # format: [nd_beg]..[nd_end]\n"))) : rb_str_cat_cstr((buf), (("| # format: [nd_beg]..[nd_end]\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # example: 1..5\n"))) ? rb_str_cat((buf), (("| # example: 1..5\n")), (long)strlen(("| # example: 1..5\n"))) : rb_str_cat_cstr((buf), (("| # example: 1..5\n"))); }); };
 goto dot;
      case NODE_DOT3:
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # range constructor (excl.)\n"))) ? rb_str_cat((buf), (("| # range constructor (excl.)\n")), (long)strlen(("| # range constructor (excl.)\n"))) : rb_str_cat_cstr((buf), (("| # range constructor (excl.)\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # format: [nd_beg]...[nd_end]\n"))) ? rb_str_cat((buf), (("| # format: [nd_beg]...[nd_end]\n")), (long)strlen(("| # format: [nd_beg]...[nd_end]\n"))) : rb_str_cat_cstr((buf), (("| # format: [nd_beg]...[nd_end]\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # example: 1...5\n"))) ? rb_str_cat((buf), (("| # example: 1...5\n")), (long)strlen(("| # example: 1...5\n"))) : rb_str_cat_cstr((buf), (("| # example: 1...5\n"))); }); };
 goto dot;
      case NODE_FLIP2:
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # flip-flop condition (incl.)\n"))) ? rb_str_cat((buf), (("| # flip-flop condition (incl.)\n")), (long)strlen(("| # flip-flop condition (incl.)\n"))) : rb_str_cat_cstr((buf), (("| # flip-flop condition (incl.)\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # format: [nd_beg]..[nd_end]\n"))) ? rb_str_cat((buf), (("| # format: [nd_beg]..[nd_end]\n")), (long)strlen(("| # format: [nd_beg]..[nd_end]\n"))) : rb_str_cat_cstr((buf), (("| # format: [nd_beg]..[nd_end]\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # example: if (x==1)..(x==5); foo; end\n"))) ? rb_str_cat((buf), (("| # example: if (x==1)..(x==5); foo; end\n")), (long)strlen(("| # example: if (x==1)..(x==5); foo; end\n"))) : rb_str_cat_cstr((buf), (("| # example: if (x==1)..(x==5); foo; end\n"))); }); };
 goto dot;
      case NODE_FLIP3:
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # flip-flop condition (excl.)\n"))) ? rb_str_cat((buf), (("| # flip-flop condition (excl.)\n")), (long)strlen(("| # flip-flop condition (excl.)\n"))) : rb_str_cat_cstr((buf), (("| # flip-flop condition (excl.)\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # format: [nd_beg]...[nd_end]\n"))) ? rb_str_cat((buf), (("| # format: [nd_beg]...[nd_end]\n")), (long)strlen(("| # format: [nd_beg]...[nd_end]\n"))) : rb_str_cat_cstr((buf), (("| # format: [nd_beg]...[nd_end]\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # example: if (x==1)...(x==5); foo; end\n"))) ? rb_str_cat((buf), (("| # example: if (x==1)...(x==5); foo; end\n")), (long)strlen(("| # example: if (x==1)...(x==5); foo; end\n"))) : rb_str_cat_cstr((buf), (("| # example: if (x==1)...(x==5); foo; end\n"))); }); };
      dot:
 for (((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s:\n", (((int)( comment ? (sizeof("nd_beg (begin)") - 1) : (sizeof("nd_beg") - 1)))), (("nd_beg (begin)")))),  ({ (__builtin_constant_p(next_indent)) ? rb_str_cat((indent), (next_indent), (long)strlen(next_indent)) : rb_str_cat_cstr((indent), (next_indent)); })), field_flag = 1; field_flag; rb_str_resize(indent, (!(((struct RBasic*)(indent))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(indent))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(indent))->as.heap.len) - 4), field_flag = 0) {dump_node(buf, indent, comment, node->u1.node);};
 (next_indent = "    ");
 for (((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s:\n", (((int)( comment ? (sizeof("nd_end (end)") - 1) : (sizeof("nd_end") - 1)))), (("nd_end (end)")))),  ({ (__builtin_constant_p(next_indent)) ? rb_str_cat((indent), (next_indent), (long)strlen(next_indent)) : rb_str_cat_cstr((indent), (next_indent)); })), field_flag = 1; field_flag; rb_str_resize(indent, (!(((struct RBasic*)(indent))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(indent))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(indent))->as.heap.len) - 4), field_flag = 0) {dump_node(buf, indent, comment, node->u2.node);};
 return;

      case NODE_SELF:
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # self\n"))) ? rb_str_cat((buf), (("| # self\n")), (long)strlen(("| # self\n"))) : rb_str_cat_cstr((buf), (("| # self\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # format: self\n"))) ? rb_str_cat((buf), (("| # format: self\n")), (long)strlen(("| # format: self\n"))) : rb_str_cat_cstr((buf), (("| # format: self\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # example: self\n"))) ? rb_str_cat((buf), (("| # example: self\n")), (long)strlen(("| # example: self\n"))) : rb_str_cat_cstr((buf), (("| # example: self\n"))); }); };
 return;

      case NODE_NIL:
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # nil\n"))) ? rb_str_cat((buf), (("| # nil\n")), (long)strlen(("| # nil\n"))) : rb_str_cat_cstr((buf), (("| # nil\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # format: nil\n"))) ? rb_str_cat((buf), (("| # format: nil\n")), (long)strlen(("| # format: nil\n"))) : rb_str_cat_cstr((buf), (("| # format: nil\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # example: nil\n"))) ? rb_str_cat((buf), (("| # example: nil\n")), (long)strlen(("| # example: nil\n"))) : rb_str_cat_cstr((buf), (("| # example: nil\n"))); }); };
 return;

      case NODE_TRUE:
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # true\n"))) ? rb_str_cat((buf), (("| # true\n")), (long)strlen(("| # true\n"))) : rb_str_cat_cstr((buf), (("| # true\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # format: true\n"))) ? rb_str_cat((buf), (("| # format: true\n")), (long)strlen(("| # format: true\n"))) : rb_str_cat_cstr((buf), (("| # format: true\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # example: true\n"))) ? rb_str_cat((buf), (("| # example: true\n")), (long)strlen(("| # example: true\n"))) : rb_str_cat_cstr((buf), (("| # example: true\n"))); }); };
 return;

      case NODE_FALSE:
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # false\n"))) ? rb_str_cat((buf), (("| # false\n")), (long)strlen(("| # false\n"))) : rb_str_cat_cstr((buf), (("| # false\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # format: false\n"))) ? rb_str_cat((buf), (("| # format: false\n")), (long)strlen(("| # format: false\n"))) : rb_str_cat_cstr((buf), (("| # format: false\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # example: false\n"))) ? rb_str_cat((buf), (("| # example: false\n")), (long)strlen(("| # example: false\n"))) : rb_str_cat_cstr((buf), (("| # example: false\n"))); }); };
 return;

      case NODE_ERRINFO:
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # virtual reference to $!\n"))) ? rb_str_cat((buf), (("| # virtual reference to $!\n")), (long)strlen(("| # virtual reference to $!\n"))) : rb_str_cat_cstr((buf), (("| # virtual reference to $!\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # format: rescue => id\n"))) ? rb_str_cat((buf), (("| # format: rescue => id\n")), (long)strlen(("| # format: rescue => id\n"))) : rb_str_cat_cstr((buf), (("| # format: rescue => id\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # example: rescue => id\n"))) ? rb_str_cat((buf), (("| # example: rescue => id\n")), (long)strlen(("| # example: rescue => id\n"))) : rb_str_cat_cstr((buf), (("| # example: rescue => id\n"))); }); };
 return;

      case NODE_DEFINED:
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # defined? expression\n"))) ? rb_str_cat((buf), (("| # defined? expression\n")), (long)strlen(("| # defined? expression\n"))) : rb_str_cat_cstr((buf), (("| # defined? expression\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # format: defined?([nd_head])\n"))) ? rb_str_cat((buf), (("| # format: defined?([nd_head])\n")), (long)strlen(("| # format: defined?([nd_head])\n"))) : rb_str_cat_cstr((buf), (("| # format: defined?([nd_head])\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # example: defined?(foo)\n"))) ? rb_str_cat((buf), (("| # example: defined?(foo)\n")), (long)strlen(("| # example: defined?(foo)\n"))) : rb_str_cat_cstr((buf), (("| # example: defined?(foo)\n"))); }); };
 for (((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s:\n", (((int)( comment ? (sizeof("nd_head (expr)") - 1) : (sizeof("nd_head") - 1)))), (("nd_head (expr)")))),  ({ (__builtin_constant_p(next_indent)) ? rb_str_cat((indent), (next_indent), (long)strlen(next_indent)) : rb_str_cat_cstr((indent), (next_indent)); })), field_flag = 1; field_flag; rb_str_resize(indent, (!(((struct RBasic*)(indent))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(indent))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(indent))->as.heap.len) - 4), field_flag = 0) {dump_node(buf, indent, comment, node->u1.node);};
 return;

      case NODE_POSTEXE:
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # post-execution\n"))) ? rb_str_cat((buf), (("| # post-execution\n")), (long)strlen(("| # post-execution\n"))) : rb_str_cat_cstr((buf), (("| # post-execution\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # format: END { [nd_body] }\n"))) ? rb_str_cat((buf), (("| # format: END { [nd_body] }\n")), (long)strlen(("| # format: END { [nd_body] }\n"))) : rb_str_cat_cstr((buf), (("| # format: END { [nd_body] }\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # example: END { foo }\n"))) ? rb_str_cat((buf), (("| # example: END { foo }\n")), (long)strlen(("| # example: END { foo }\n"))) : rb_str_cat_cstr((buf), (("| # example: END { foo }\n"))); }); };
 (next_indent = "    ");
 for (((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s:\n", (((int)( comment ? (sizeof("nd_body (END clause)") - 1) : (sizeof("nd_body") - 1)))), (("nd_body (END clause)")))),  ({ (__builtin_constant_p(next_indent)) ? rb_str_cat((indent), (next_indent), (long)strlen(next_indent)) : rb_str_cat_cstr((indent), (next_indent)); })), field_flag = 1; field_flag; rb_str_resize(indent, (!(((struct RBasic*)(indent))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(indent))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(indent))->as.heap.len) - 4), field_flag = 0) {dump_node(buf, indent, comment, node->u2.node);};
 return;

      case NODE_ATTRASGN:
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # attr assignment\n"))) ? rb_str_cat((buf), (("| # attr assignment\n")), (long)strlen(("| # attr assignment\n"))) : rb_str_cat_cstr((buf), (("| # attr assignment\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # format: [nd_recv].[nd_mid] = [nd_args]\n"))) ? rb_str_cat((buf), (("| # format: [nd_recv].[nd_mid] = [nd_args]\n")), (long)strlen(("| # format: [nd_recv].[nd_mid] = [nd_args]\n"))) : rb_str_cat_cstr((buf), (("| # format: [nd_recv].[nd_mid] = [nd_args]\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # example: struct.field = foo\n"))) ? rb_str_cat((buf), (("| # example: struct.field = foo\n")), (long)strlen(("| # example: struct.field = foo\n"))) : rb_str_cat_cstr((buf), (("| # example: struct.field = foo\n"))); }); };
 for (((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s:\n", (((int)( comment ? (sizeof("nd_recv (receiver)") - 1) : (sizeof("nd_recv") - 1)))), (("nd_recv (receiver)")))),  ({ (__builtin_constant_p(next_indent)) ? rb_str_cat((indent), (next_indent), (long)strlen(next_indent)) : rb_str_cat_cstr((indent), (next_indent)); })), field_flag = 1; field_flag; rb_str_resize(indent, (!(((struct RBasic*)(indent))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(indent))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(indent))->as.heap.len) - 4), field_flag = 0) {dump_node(buf, indent, comment, node->u1.node);};
 for ((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s: ", (((int)( comment ? (sizeof("nd_mid (method name)") - 1) : (sizeof("nd_mid") - 1)))), (("nd_mid (method name)")))), field_flag = 1; field_flag;  ({ (__builtin_constant_p(("\n"))) ? rb_str_cat((buf), (("\n")), (long)strlen(("\n"))) : rb_str_cat_cstr((buf), (("\n"))); }), field_flag = 0) add_id(buf, (node->u2.id));
 ...
 return;
      ...
      case NODE_PRELUDE:
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # pre-execution\n"))) ? rb_str_cat((buf), (("| # pre-execution\n")), (long)strlen(("| # pre-execution\n"))) : rb_str_cat_cstr((buf), (("| # pre-execution\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # format: BEGIN { [nd_head] }; [nd_body]\n"))) ? rb_str_cat((buf), (("| # format: BEGIN { [nd_head] }; [nd_body]\n")), (long)strlen(("| # format: BEGIN { [nd_head] }; [nd_body]\n"))) : rb_str_cat_cstr((buf), (("| # format: BEGIN { [nd_head] }; [nd_body]\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # example: bar; BEGIN { foo }\n"))) ? rb_str_cat((buf), (("| # example: bar; BEGIN { foo }\n")), (long)strlen(("| # example: bar; BEGIN { foo }\n"))) : rb_str_cat_cstr((buf), (("| # example: bar; BEGIN { foo }\n"))); }); };
 for (((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s:\n", (((int)( comment ? (sizeof("nd_head (prelude)") - 1) : (sizeof("nd_head") - 1)))), (("nd_head (prelude)")))),  ({ (__builtin_constant_p(next_indent)) ? rb_str_cat((indent), (next_indent), (long)strlen(next_indent)) : rb_str_cat_cstr((indent), (next_indent)); })), field_flag = 1; field_flag; rb_str_resize(indent, (!(((struct RBasic*)(indent))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(indent))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(indent))->as.heap.len) - 4), field_flag = 0) {dump_node(buf, indent, comment, node->u1.node);};
 if (!node->u3.value) (next_indent = "    ");
 for (((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s:\n", (((int)( comment ? (sizeof("nd_body (body)") - 1) : (sizeof("nd_body") - 1)))), (("nd_body (body)")))),  ({ (__builtin_constant_p(next_indent)) ? rb_str_cat((indent), (next_indent), (long)strlen(next_indent)) : rb_str_cat_cstr((indent), (next_indent)); })), field_flag = 1; field_flag; rb_str_resize(indent, (!(((struct RBasic*)(indent))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(indent))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(indent))->as.heap.len) - 4), field_flag = 0) {dump_node(buf, indent, comment, node->u2.node);};
 if (node->u3.value) {
     (next_indent = "    ");
     for (((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s:\n", (((int)( comment ? (sizeof("nd_compile_option (compile_option)") - 1) : (sizeof("nd_compile_option") - 1)))), (("nd_compile_option (compile_option)")))),  ({ (__builtin_constant_p(next_indent)) ? rb_str_cat((indent), (next_indent), (long)strlen(next_indent)) : rb_str_cat_cstr((indent), (next_indent)); })), field_flag = 1; field_flag; rb_str_resize(indent, (!(((struct RBasic*)(indent))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(indent))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(indent))->as.heap.len) - 4), field_flag = 0) {dump_option(buf, indent, node->u3.value);};
 }
 return;

      case NODE_LAMBDA:
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # lambda expression\n"))) ? rb_str_cat((buf), (("| # lambda expression\n")), (long)strlen(("| # lambda expression\n"))) : rb_str_cat_cstr((buf), (("| # lambda expression\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # format: -> [nd_body]\n"))) ? rb_str_cat((buf), (("| # format: -> [nd_body]\n")), (long)strlen(("| # format: -> [nd_body]\n"))) : rb_str_cat_cstr((buf), (("| # format: -> [nd_body]\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # example: -> { foo }\n"))) ? rb_str_cat((buf), (("| # example: -> { foo }\n")), (long)strlen(("| # example: -> { foo }\n"))) : rb_str_cat_cstr((buf), (("| # example: -> { foo }\n"))); }); };
 (next_indent = "    ");
 for (((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s:\n", (((int)( comment ? (sizeof("nd_body (lambda clause)") - 1) : (sizeof("nd_body") - 1)))), (("nd_body (lambda clause)")))),  ({ (__builtin_constant_p(next_indent)) ? rb_str_cat((indent), (next_indent), (long)strlen(next_indent)) : rb_str_cat_cstr((indent), (next_indent)); })), field_flag = 1; field_flag; rb_str_resize(indent, (!(((struct RBasic*)(indent))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(indent))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(indent))->as.heap.len) - 4), field_flag = 0) {dump_node(buf, indent, comment, node->u2.node);};
 return;

      case NODE_OPT_ARG:
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # optional arguments\n"))) ? rb_str_cat((buf), (("| # optional arguments\n")), (long)strlen(("| # optional arguments\n"))) : rb_str_cat_cstr((buf), (("| # optional arguments\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # format: def method_name([nd_body=some], [nd_next..])\n"))) ? rb_str_cat((buf), (("| # format: def method_name([nd_body=some], [nd_next..])\n")), (long)strlen(("| # format: def method_name([nd_body=some], [nd_next..])\n"))) : rb_str_cat_cstr((buf), (("| # format: def method_name([nd_body=some], [nd_next..])\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # example: def foo(a, b=1, c); end\n"))) ? rb_str_cat((buf), (("| # example: def foo(a, b=1, c); end\n")), (long)strlen(("| # example: def foo(a, b=1, c); end\n"))) : rb_str_cat_cstr((buf), (("| # example: def foo(a, b=1, c); end\n"))); }); };
 for (((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s:\n", (((int)( comment ? (sizeof("nd_body (body)") - 1) : (sizeof("nd_body") - 1)))), (("nd_body (body)")))),  ({ (__builtin_constant_p(next_indent)) ? rb_str_cat((indent), (next_indent), (long)strlen(next_indent)) : rb_str_cat_cstr((indent), (next_indent)); })), field_flag = 1; field_flag; rb_str_resize(indent, (!(((struct RBasic*)(indent))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(indent))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(indent))->as.heap.len) - 4), field_flag = 0) {dump_node(buf, indent, comment, node->u2.node);};
 (next_indent = "    ");
 for (((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s:\n", (((int)( comment ? (sizeof("nd_next (next)") - 1) : (sizeof("nd_next") - 1)))), (("nd_next (next)")))),  ({ (__builtin_constant_p(next_indent)) ? rb_str_cat((indent), (next_indent), (long)strlen(next_indent)) : rb_str_cat_cstr((indent), (next_indent)); })), field_flag = 1; field_flag; rb_str_resize(indent, (!(((struct RBasic*)(indent))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(indent))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(indent))->as.heap.len) - 4), field_flag = 0) {dump_node(buf, indent, comment, node->u3.node);};
 return;

      case NODE_KW_ARG:
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # keyword arguments\n"))) ? rb_str_cat((buf), (("| # keyword arguments\n")), (long)strlen(("| # keyword arguments\n"))) : rb_str_cat_cstr((buf), (("| # keyword arguments\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # format: def method_name([nd_body=some], [nd_next..])\n"))) ? rb_str_cat((buf), (("| # format: def method_name([nd_body=some], [nd_next..])\n")), (long)strlen(("| # format: def method_name([nd_body=some], [nd_next..])\n"))) : rb_str_cat_cstr((buf), (("| # format: def method_name([nd_body=some], [nd_next..])\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # example: def foo(a:1, b:2); end\n"))) ? rb_str_cat((buf), (("| # example: def foo(a:1, b:2); end\n")), (long)strlen(("| # example: def foo(a:1, b:2); end\n"))) : rb_str_cat_cstr((buf), (("| # example: def foo(a:1, b:2); end\n"))); }); };
 for (((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s:\n", (((int)( comment ? (sizeof("nd_body (body)") - 1) : (sizeof("nd_body") - 1)))), (("nd_body (body)")))),  ({ (__builtin_constant_p(next_indent)) ? rb_str_cat((indent), (next_indent), (long)strlen(next_indent)) : rb_str_cat_cstr((indent), (next_indent)); })), field_flag = 1; field_flag; rb_str_resize(indent, (!(((struct RBasic*)(indent))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(indent))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(indent))->as.heap.len) - 4), field_flag = 0) {dump_node(buf, indent, comment, node->u2.node);};
 (next_indent = "    ");
 for (((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s:\n", (((int)( comment ? (sizeof("nd_next (next)") - 1) : (sizeof("nd_next") - 1)))), (("nd_next (next)")))),  ({ (__builtin_constant_p(next_indent)) ? rb_str_cat((indent), (next_indent), (long)strlen(next_indent)) : rb_str_cat_cstr((indent), (next_indent)); })), field_flag = 1; field_flag; rb_str_resize(indent, (!(((struct RBasic*)(indent))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(indent))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(indent))->as.heap.len) - 4), field_flag = 0) {dump_node(buf, indent, comment, node->u3.node);};
 return;
      ...
      case NODE_POSTARG:
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # post arguments\n"))) ? rb_str_cat((buf), (("| # post arguments\n")), (long)strlen(("| # post arguments\n"))) : rb_str_cat_cstr((buf), (("| # post arguments\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # format: *[nd_1st], [nd_2nd..] = ..\n"))) ? rb_str_cat((buf), (("| # format: *[nd_1st], [nd_2nd..] = ..\n")), (long)strlen(("| # format: *[nd_1st], [nd_2nd..] = ..\n"))) : rb_str_cat_cstr((buf), (("| # format: *[nd_1st], [nd_2nd..] = ..\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # example: a, *rest, z = foo\n"))) ? rb_str_cat((buf), (("| # example: a, *rest, z = foo\n")), (long)strlen(("| # example: a, *rest, z = foo\n"))) : rb_str_cat_cstr((buf), (("| # example: a, *rest, z = foo\n"))); }); };
 if (node->u1.node != ((NODE *)-1)) {
     for (((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s:\n", (((int)( comment ? (sizeof("nd_1st (rest argument)") - 1) : (sizeof("nd_1st") - 1)))), (("nd_1st (rest argument)")))),  ({ (__builtin_constant_p(next_indent)) ? rb_str_cat((indent), (next_indent), (long)strlen(next_indent)) : rb_str_cat_cstr((indent), (next_indent)); })), field_flag = 1; field_flag; rb_str_resize(indent, (!(((struct RBasic*)(indent))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(indent))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(indent))->as.heap.len) - 4), field_flag = 0) {dump_node(buf, indent, comment, node->u1.node);};
 }
 else {
     for ((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s: ", (((int)( comment ? (sizeof("nd_1st (rest argument)") - 1) : (sizeof("nd_1st") - 1)))), (("nd_1st (rest argument)")))), field_flag = 1; field_flag;  ({ (__builtin_constant_p(("\n"))) ? rb_str_cat((buf), (("\n")), (long)strlen(("\n"))) : rb_str_cat_cstr((buf), (("\n"))); }), field_flag = 0)  ({ (__builtin_constant_p(("NODE_SPECIAL_NO_NAME_REST (rest argument without name)"))) ? rb_str_cat((buf), (("NODE_SPECIAL_NO_NAME_REST (rest argument without name)")), (long)strlen(("NODE_SPECIAL_NO_NAME_REST (rest argument without name)"))) : rb_str_cat_cstr((buf), (("NODE_SPECIAL_NO_NAME_REST (rest argument without name)"))); });
 }
 (next_indent = "    ");
 for (((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s:\n", (((int)( comment ? (sizeof("nd_2nd (post arguments)") - 1) : (sizeof("nd_2nd") - 1)))), (("nd_2nd (post arguments)")))),  ({ (__builtin_constant_p(next_indent)) ? rb_str_cat((indent), (next_indent), (long)strlen(next_indent)) : rb_str_cat_cstr((indent), (next_indent)); })), field_flag = 1; field_flag; rb_str_resize(indent, (!(((struct RBasic*)(indent))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(indent))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(indent))->as.heap.len) - 4), field_flag = 0) {dump_node(buf, indent, comment, node->u2.node);};
 return;

      case NODE_ARGS:
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # method parameters\n"))) ? rb_str_cat((buf), (("| # method parameters\n")), (long)strlen(("| # method parameters\n"))) : rb_str_cat_cstr((buf), (("| # method parameters\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # format: def method_name(.., [nd_opt=some], *[nd_rest], [nd_pid], .., &[nd_body])\n"))) ? rb_str_cat((buf), (("| # format: def method_name(.., [nd_opt=some], *[nd_rest], [nd_pid], .., &[nd_body])\n")), (long)strlen(("| # format: def method_name(.., [nd_opt=some], *[nd_rest], [nd_pid], .., &[nd_body])\n"))) : rb_str_cat_cstr((buf), (("| # format: def method_name(.., [nd_opt=some], *[nd_rest], [nd_pid], .., &[nd_body])\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # example: def foo(a, b, opt1=1, opt2=2, *rest, y, z, &blk); end\n"))) ? rb_str_cat((buf), (("| # example: def foo(a, b, opt1=1, opt2=2, *rest, y, z, &blk); end\n")), (long)strlen(("| # example: def foo(a, b, opt1=1, opt2=2, *rest, y, z, &blk); end\n"))) : rb_str_cat_cstr((buf), (("| # example: def foo(a, b, opt1=1, opt2=2, *rest, y, z, &blk); end\n"))); }); };
 for ((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s: ", (((int)( comment ? (sizeof("nd_ainfo->pre_args_num (count of mandatory (pre-)arguments)") - 1) : (sizeof("nd_ainfo->pre_args_num") - 1)))), (("nd_ainfo->pre_args_num (count of mandatory (pre-)arguments)")))), field_flag = 1; field_flag;  ({ (__builtin_constant_p(("\n"))) ? rb_str_cat((buf), (("\n")), (long)strlen(("\n"))) : rb_str_cat_cstr((buf), (("\n"))); }), field_flag = 0) rb_str_catf(buf, "%d", (node->u3.args->pre_args_num));
 for (((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s:\n", (((int)( comment ? (sizeof("nd_ainfo->pre_init (initialization of (pre-)arguments)") - 1) : (sizeof("nd_ainfo->pre_init") - 1)))), (("nd_ainfo->pre_init (initialization of (pre-)arguments)")))),  ({ (__builtin_constant_p(next_indent)) ? rb_str_cat((indent), (next_indent), (long)strlen(next_indent)) : rb_str_cat_cstr((indent), (next_indent)); })), field_flag = 1; field_flag; rb_str_resize(indent, (!(((struct RBasic*)(indent))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(indent))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(indent))->as.heap.len) - 4), field_flag = 0) {dump_node(buf, indent, comment, node->u3.args->pre_init);};
 for ((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s: ", (((int)( comment ? (sizeof("nd_ainfo->post_args_num (count of mandatory post-arguments)") - 1) : (sizeof("nd_ainfo->post_args_num") - 1)))), (("nd_ainfo->post_args_num (count of mandatory post-arguments)")))), field_flag = 1; field_flag;  ({ (__builtin_constant_p(("\n"))) ? rb_str_cat((buf), (("\n")), (long)strlen(("\n"))) : rb_str_cat_cstr((buf), (("\n"))); }), field_flag = 0) rb_str_catf(buf, "%d", (node->u3.args->post_args_num));
 for (((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s:\n", (((int)( comment ? (sizeof("nd_ainfo->post_init (initialization of post-arguments)") - 1) : (sizeof("nd_ainfo->post_init") - 1)))), (("nd_ainfo->post_init (initialization of post-arguments)")))),  ({ (__builtin_constant_p(next_indent)) ? rb_str_cat((indent), (next_indent), (long)strlen(next_indent)) : rb_str_cat_cstr((indent), (next_indent)); })), field_flag = 1; field_flag; rb_str_resize(indent, (!(((struct RBasic*)(indent))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(indent))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(indent))->as.heap.len) - 4), field_flag = 0) {dump_node(buf, indent, comment, node->u3.args->post_init);};
 for ((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s: ", (((int)( comment ? (sizeof("nd_ainfo->first_post_arg (first post argument)") - 1) : (sizeof("nd_ainfo->first_post_arg") - 1)))), (("nd_ainfo->first_post_arg (first post argument)")))), field_flag = 1; field_flag;  ({ (__builtin_constant_p(("\n"))) ? rb_str_cat((buf), (("\n")), (long)strlen(("\n"))) : rb_str_cat_cstr((buf), (("\n"))); }), field_flag = 0) add_id(buf, (node->u3.args->first_post_arg));
 for ((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s: ", (((int)( comment ? (sizeof("nd_ainfo->rest_arg (rest argument)") - 1) : (sizeof("nd_ainfo->rest_arg") - 1)))), (("nd_ainfo->rest_arg (rest argument)")))), field_flag = 1; field_flag;  ({ (__builtin_constant_p(("\n"))) ? rb_str_cat((buf), (("\n")), (long)strlen(("\n"))) : rb_str_cat_cstr((buf), (("\n"))); }), field_flag = 0) add_id(buf, (node->u3.args->rest_arg));
 for ((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s: ", (((int)( comment ? (sizeof("nd_ainfo->block_arg (block argument)") - 1) : (sizeof("nd_ainfo->block_arg") - 1)))), (("nd_ainfo->block_arg (block argument)")))), field_flag = 1; field_flag;  ({ (__builtin_constant_p(("\n"))) ? rb_str_cat((buf), (("\n")), (long)strlen(("\n"))) : rb_str_cat_cstr((buf), (("\n"))); }), field_flag = 0) add_id(buf, (node->u3.args->block_arg));
 for (((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s:\n", (((int)( comment ? (sizeof("nd_ainfo->opt_args (optional arguments)") - 1) : (sizeof("nd_ainfo->opt_args") - 1)))), (("nd_ainfo->opt_args (optional arguments)")))),  ({ (__builtin_constant_p(next_indent)) ? rb_str_cat((indent), (next_indent), (long)strlen(next_indent)) : rb_str_cat_cstr((indent), (next_indent)); })), field_flag = 1; field_flag; rb_str_resize(indent, (!(((struct RBasic*)(indent))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(indent))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(indent))->as.heap.len) - 4), field_flag = 0) {dump_node(buf, indent, comment, node->u3.args->opt_args);};
 for (((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s:\n", (((int)( comment ? (sizeof("nd_ainfo->kw_args (keyword arguments)") - 1) : (sizeof("nd_ainfo->kw_args") - 1)))), (("nd_ainfo->kw_args (keyword arguments)")))),  ({ (__builtin_constant_p(next_indent)) ? rb_str_cat((indent), (next_indent), (long)strlen(next_indent)) : rb_str_cat_cstr((indent), (next_indent)); })), field_flag = 1; field_flag; rb_str_resize(indent, (!(((struct RBasic*)(indent))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(indent))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(indent))->as.heap.len) - 4), field_flag = 0) {dump_node(buf, indent, comment, node->u3.args->kw_args);};
 (next_indent = "    ");
 for (((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s:\n", (((int)( comment ? (sizeof("nd_ainfo->kw_rest_arg (keyword rest argument)") - 1) : (sizeof("nd_ainfo->kw_rest_arg") - 1)))), (("nd_ainfo->kw_rest_arg (keyword rest argument)")))),  ({ (__builtin_constant_p(next_indent)) ? rb_str_cat((indent), (next_indent), (long)strlen(next_indent)) : rb_str_cat_cstr((indent), (next_indent)); })), field_flag = 1; field_flag; rb_str_resize(indent, (!(((struct RBasic*)(indent))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(indent))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(indent))->as.heap.len) - 4), field_flag = 0) {dump_node(buf, indent, comment, node->u3.args->kw_rest_arg);};
 return;

      case NODE_SCOPE:
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # new scope\n"))) ? rb_str_cat((buf), (("| # new scope\n")), (long)strlen(("| # new scope\n"))) : rb_str_cat_cstr((buf), (("| # new scope\n"))); }); };
 if (comment) { add_indent(buf, indent);  ({ (__builtin_constant_p(("| # format: [nd_tbl]: local table, [nd_args]: arguments, [nd_body]: body\n"))) ? rb_str_cat((buf), (("| # format: [nd_tbl]: local table, [nd_args]: arguments, [nd_body]: body\n")), (long)strlen(("| # format: [nd_tbl]: local table, [nd_args]: arguments, [nd_body]: body\n"))) : rb_str_cat_cstr((buf), (("| # format: [nd_tbl]: local table, [nd_args]: arguments, [nd_body]: body\n"))); }); };
 for ((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s: ", (((int)( comment ? (sizeof("nd_tbl (local table)") - 1) : (sizeof("nd_tbl") - 1)))), (("nd_tbl (local table)")))), field_flag = 1; field_flag;  ({ (__builtin_constant_p(("\n"))) ? rb_str_cat((buf), (("\n")), (long)strlen(("\n"))) : rb_str_cat_cstr((buf), (("\n"))); }), field_flag = 0) {
     ID *tbl = node->u1.tbl;
     int i;
     int size = tbl ? (int)*tbl++ : 0;
     if (size == 0)  ({ (__builtin_constant_p(("(empty)"))) ? rb_str_cat((buf), (("(empty)")), (long)strlen(("(empty)"))) : rb_str_cat_cstr((buf), (("(empty)"))); });
     for (i = 0; i < size; i++) {
  add_id(buf, (tbl[i])); if (i < size - 1)  ({ (__builtin_constant_p((","))) ? rb_str_cat((buf), ((",")), (long)strlen((","))) : rb_str_cat_cstr((buf), ((","))); });
     }
 }
 for (((add_indent(buf, indent), rb_str_catf(buf, "+- %.*s:\n", (((int)( comment ? (sizeof("nd_args (arguments)") - 1) : (sizeof("nd_args") - 1)))), (("nd_args (arguments)")))),  ({ (__builtin_constant_p(next_indent)) ? rb_str_cat((indent), (next_indent), (long)strlen(next_indent)) : rb_str_cat_cstr((indent), (next_indent)); })), field_flag = 1; field_flag; rb_str_resize(indent, (!(((struct RBasic*)(indent))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(indent))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(indent))->as.heap.len) - 4), field_flag = 0) {dump_node(buf, indent, comment, node->u3.node);};
 (next_indent = "    ");
 ...
 break;
    ...
    rb_bug("dump_node: unknown node: %s", ruby_node_name(((int) (((node)->flags & (((VALUE)0x7f)<<8))>>8))));
}

VALUE
rb_parser_dump_tree(NODE *node, int comment)
{
    VALUE buf =  ({ (__builtin_constant_p("###########################################################\n## Do NOT use this node dump for any purpose other than  ##\n## debug and research.  Compatibility is not guaranteed. ##\n###########################################################\n\n")) ? rb_str_new_static(("###########################################################\n## Do NOT use this node dump for any purpose other than  ##\n## debug and research.  Compatibility is not guaranteed. ##\n###########################################################\n\n"), (long)strlen("###########################################################\n## Do NOT use this node dump for any purpose other than  ##\n## debug and research.  Compatibility is not guaranteed. ##\n###########################################################\n\n")) : rb_str_new_cstr("###########################################################\n## Do NOT use this node dump for any purpose other than  ##\n## debug and research.  Compatibility is not guaranteed. ##\n###########################################################\n\n"); });





    dump_node(buf,  ({ (__builtin_constant_p("# ")) ? rb_str_new_static(("# "), (long)strlen("# ")) : rb_str_new_cstr("# "); }), comment, node);
    return buf;
}
...
{
    n->flags = RUBY_T_NODE;
    (n)->flags=(((n)->flags&~(((VALUE)0x7f)<<8))|((((unsigned long)(type))<<8)&(((VALUE)0x7f)<<8)));
    n->u1.value = a0;
    n->u2.value = a1;
    n->u3.value = a2;
...
{
    node_buffer_t *nb = ruby_xmalloc(__builtin_offsetof() + __builtin_offsetof() + 16 * sizeof(NODE));
    nb->idx = 0;
    nb->len = 16;
    nb->head = &nb->body;
    nb->head->next = ((void*)0);
...
rb_ast_newnode(rb_ast_t *ast)
{
 ...
 nbe = ruby_xmalloc(__builtin_offsetof() + n * sizeof(NODE));
 nb->idx = 0;
 nb->len = n;
 nbe->next = nb->head;
 nb->head = nbe;
...
{
    rb_ast_free(ast);
    rb_obj_write((VALUE)(ast), (VALUE *)(&ast->mark_ary), (VALUE)(((VALUE)RUBY_Qnil)), "node.c", 1168);
}
...
{
    long i;
    for (i = 0; i < rb_array_len(ast->mark_ary); i++) {
 if (obj == (rb_array_const_ptr(ast->mark_ary)[i])) {
     do { const VALUE _ary = (ast->mark_ary); VALUE *ptr = (VALUE *)((VALUE *)rb_array_const_ptr(_ary)); rb_obj_write((VALUE)(_ary), (VALUE *)(&ptr[i]), (VALUE)((((VALUE)RUBY_Qnil))), "node.c", 1183); ; } while (0);
 }
    }
}
