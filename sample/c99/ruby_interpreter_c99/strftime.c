       ...
       ptrdiff_t n, size_t maxsize)
{
 ...
 s = (!(((struct RBasic*)(ftime))->flags & RSTRING_NOEMBED) ? ((struct RString*)(ftime))->as.ary : ((struct RString*)(ftime))->as.heap.ptr);
 *endp = s + nlen;
 *start = s;
 return s += len;
}
    ...
    rb_encoding *enc)
{
 if (!s) {
  ...
  VALUE fmt =  ({ (__builtin_constant_p(format) && __builtin_constant_p(format_len)) ? rb_enc_str_new_static((format), (format_len), (enc)) : rb_enc_str_new((format), (format_len), (enc)); });
  rb_syserr_fail_str(34, fmt);
 }
}
...
{
 switch (flags & ((1U<<(UPPER))|(1U<<(LOWER)))) {
 case (1U<<(UPPER)):
  do {
   if (rb_islower(*s)) *s = rb_toupper(*s);
  } while (s++, --i);
  break;
 case (1U<<(LOWER)):
  do {
   if (rb_isupper(*s)) *s = rb_tolower(*s);
  } while (s++, --i);
  break;
 default:
  s += i;
...
{
 size_t len = (!(((struct RBasic*)(ftime))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(ftime))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(ftime))->as.heap.len);
 char *s = (!(((struct RBasic*)(ftime))->flags & RSTRING_NOEMBED) ? ((struct RString*)(ftime))->as.ary : ((struct RString*)(ftime))->as.heap.ptr);
 const char *start = s;
 ...
 if (format == ((void*)0) || format_len == 0 || vtm == ((void*)0)) {
 err:
  return 0;
 }
 ...
 for (; format < format_end; format++) {
  ...
  if (!tp) tp = format_end;
  do { if (s >= endp || (tp - format) >= endp - s - 1) { s = resize_buffer(ftime, s, &start, &endp, (tp - format), maxsize); buffer_size_check(s, format_end, format_len, enc); } } while (0);
 ...
 again:
  ...
  switch (*format) {
  case '%':
   do { if (!(flags & (1U<<(LEFT))) && precision > (1)) { do { if (s >= endp || (precision) >= endp - s - 1) { s = resize_buffer(ftime, s, &start, &endp, (precision), maxsize); buffer_size_check(s, format_end, format_len, enc); } } while (0); memset(s, padding ? padding : ' ', precision - (1)); s += precision - (1); } else { do { if (s >= endp || (1) >= endp - s - 1) { s = resize_buffer(ftime, s, &start, &endp, (1), maxsize); buffer_size_check(s, format_end, format_len, enc); } } while (0); } } while (0);;
   *s++ = '%';
   continue;

  case 'a':
   if (flags & (1U<<(CHCASE))) {
    flags &= ~((1U<<(LOWER))|(1U<<(CHCASE)));
    flags |= (1U<<(UPPER));
   }
  ...
  case 'c':
   do { len = s - start; rb_str_set_len(ftime, len); if (!rb_strftime_with_timespec(ftime, ("%a %b %e %H:%M:%S %Y"), (sizeof("%a %b %e %H:%M:%S %Y") - 1), enc, vtm, timev, ts, gmt, maxsize)) return 0; s = (!(((struct RBasic*)(ftime))->flags & RSTRING_NOEMBED) ? ((struct RString*)(ftime))->as.ary : ((struct RString*)(ftime))->as.heap.ptr); i = (!(((struct RBasic*)(ftime))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(ftime))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(ftime))->as.heap.len) - len; endp = (start = s) + rb_str_capacity(ftime); s += len; if (i > 0) case_conv(s, i, flags); if (precision > i) { do { if (s >= endp || (precision) >= endp - s - 1) { s = resize_buffer(ftime, s, &start, &endp, (precision), maxsize); buffer_size_check(s, format_end, format_len, enc); } } while (0); memmove(s + precision - i, s, i); memset(s, padding ? padding : ' ', precision - i); s += precision; } else s += i; } while (0);
   continue;

  case 'd':
   i = max((1), min((vtm->mday), (31)));
   do { precision = ((flags & (1U<<(LEFT))) ? (1) : (precision <= 0) ? (2) : (precision)); len = s - start; do { if (s >= endp || (precision) >= endp - s - 1) { s = resize_buffer(ftime, s, &start, &endp, (precision), maxsize); buffer_size_check(s, format_end, format_len, enc); } } while (0); rb_str_set_len(ftime, len); rb_str_catf(ftime, (&"%*d\0%0*d"[ (padding == '0' || (!padding && ('0') == '0')) ? (sizeof("%*d") - 1)+1 : 0]), precision, ((int)i)); (!(((struct RBasic*)(ftime))->flags & RSTRING_NOEMBED) ? ((s) = ((struct RString*)(ftime))->as.ary, (len) = (long)((((struct RBasic*)(ftime))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT))) : ((s) = ((struct RString*)(ftime))->as.heap.ptr, (len) = ((struct RString*)(ftime))->as.heap.len)); endp = (start = s) + rb_str_capacity(ftime); s += len; } while (0);
   continue;

  case 'H':
   i = max((0), min((vtm->hour), (23)));
   do { precision = ((flags & (1U<<(LEFT))) ? (1) : (precision <= 0) ? (2) : (precision)); len = s - start; do { if (s >= endp || (precision) >= endp - s - 1) { s = resize_buffer(ftime, s, &start, &endp, (precision), maxsize); buffer_size_check(s, format_end, format_len, enc); } } while (0); rb_str_set_len(ftime, len); rb_str_catf(ftime, (&"%*d\0%0*d"[ (padding == '0' || (!padding && ('0') == '0')) ? (sizeof("%*d") - 1)+1 : 0]), precision, ((int)i)); (!(((struct RBasic*)(ftime))->flags & RSTRING_NOEMBED) ? ((s) = ((struct RString*)(ftime))->as.ary, (len) = (long)((((struct RBasic*)(ftime))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT))) : ((s) = ((struct RString*)(ftime))->as.heap.ptr, (len) = ((struct RString*)(ftime))->as.heap.len)); endp = (start = s) + rb_str_capacity(ftime); s += len; } while (0);
   continue;
  ...
  case 'j':
   i = max((1), min((vtm->yday), (366)));
   do { precision = ((flags & (1U<<(LEFT))) ? (1) : (precision <= 0) ? (3) : (precision)); len = s - start; do { if (s >= endp || (precision) >= endp - s - 1) { s = resize_buffer(ftime, s, &start, &endp, (precision), maxsize); buffer_size_check(s, format_end, format_len, enc); } } while (0); rb_str_set_len(ftime, len); rb_str_catf(ftime, (&"%*d\0%0*d"[ (padding == '0' || (!padding && ('0') == '0')) ? (sizeof("%*d") - 1)+1 : 0]), precision, ((int)i)); (!(((struct RBasic*)(ftime))->flags & RSTRING_NOEMBED) ? ((s) = ((struct RString*)(ftime))->as.ary, (len) = (long)((((struct RBasic*)(ftime))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT))) : ((s) = ((struct RString*)(ftime))->as.heap.ptr, (len) = ((struct RString*)(ftime))->as.heap.len)); endp = (start = s) + rb_str_capacity(ftime); s += len; } while (0);
   continue;

  case 'm':
   i = max((1), min((vtm->mon), (12)));
   do { precision = ((flags & (1U<<(LEFT))) ? (1) : (precision <= 0) ? (2) : (precision)); len = s - start; do { if (s >= endp || (precision) >= endp - s - 1) { s = resize_buffer(ftime, s, &start, &endp, (precision), maxsize); buffer_size_check(s, format_end, format_len, enc); } } while (0); rb_str_set_len(ftime, len); rb_str_catf(ftime, (&"%*d\0%0*d"[ (padding == '0' || (!padding && ('0') == '0')) ? (sizeof("%*d") - 1)+1 : 0]), precision, ((int)i)); (!(((struct RBasic*)(ftime))->flags & RSTRING_NOEMBED) ? ((s) = ((struct RString*)(ftime))->as.ary, (len) = (long)((((struct RBasic*)(ftime))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT))) : ((s) = ((struct RString*)(ftime))->as.heap.ptr, (len) = ((struct RString*)(ftime))->as.heap.len)); endp = (start = s) + rb_str_capacity(ftime); s += len; } while (0);
   continue;

  case 'M':
   i = max((0), min((vtm->min), (59)));
   do { precision = ((flags & (1U<<(LEFT))) ? (1) : (precision <= 0) ? (2) : (precision)); len = s - start; do { if (s >= endp || (precision) >= endp - s - 1) { s = resize_buffer(ftime, s, &start, &endp, (precision), maxsize); buffer_size_check(s, format_end, format_len, enc); } } while (0); rb_str_set_len(ftime, len); rb_str_catf(ftime, (&"%*d\0%0*d"[ (padding == '0' || (!padding && ('0') == '0')) ? (sizeof("%*d") - 1)+1 : 0]), precision, ((int)i)); (!(((struct RBasic*)(ftime))->flags & RSTRING_NOEMBED) ? ((s) = ((struct RString*)(ftime))->as.ary, (len) = (long)((((struct RBasic*)(ftime))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT))) : ((s) = ((struct RString*)(ftime))->as.heap.ptr, (len) = ((struct RString*)(ftime))->as.heap.len)); endp = (start = s) + rb_str_capacity(ftime); s += len; } while (0);
   continue;

  case 'p':
  case 'P':
   if ((*format == 'p' && (flags & (1U<<(CHCASE)))) ||
       (*format == 'P' && !(flags & ((1U<<(CHCASE))|(1U<<(UPPER)))))) {
    flags &= ~((1U<<(UPPER))|(1U<<(CHCASE)));
    flags |= (1U<<(LOWER));
   }
   i = max((0), min((vtm->hour), (23)));
   if (i < 12)
  ...
  case 's':
                        if (ts) {
                                ...
                                if (~(time_t)0 <= 0)
                                    do { precision = ((flags & (1U<<(LEFT))) ? (1) : (precision <= 0) ? (1) : (precision)); len = s - start; do { if (s >= endp || (precision) >= endp - s - 1) { s = resize_buffer(ftime, s, &start, &endp, (precision), maxsize); buffer_size_check(s, format_end, format_len, enc); } } while (0); rb_str_set_len(ftime, len); rb_str_catf(ftime, (&"%*ld\0%0*ld"[ (padding == '0' || (!padding && ('0') == '0')) ? (sizeof("%*ld") - 1)+1 : 0]), precision, (sec)); (!(((struct RBasic*)(ftime))->flags & RSTRING_NOEMBED) ? ((s) = ((struct RString*)(ftime))->as.ary, (len) = (long)((((struct RBasic*)(ftime))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT))) : ((s) = ((struct RString*)(ftime))->as.heap.ptr, (len) = ((struct RString*)(ftime))->as.heap.len)); endp = (start = s) + rb_str_capacity(ftime); s += len; } while (0);
                                else
                                    do { precision = ((flags & (1U<<(LEFT))) ? (1) : (precision <= 0) ? (1) : (precision)); len = s - start; do { if (s >= endp || (precision) >= endp - s - 1) { s = resize_buffer(ftime, s, &start, &endp, (precision), maxsize); buffer_size_check(s, format_end, format_len, enc); } } while (0); rb_str_set_len(ftime, len); rb_str_catf(ftime, (&"%*lu\0%0*lu"[ (padding == '0' || (!padding && ('0') == '0')) ? (sizeof("%*lu") - 1)+1 : 0]), precision, (sec)); (!(((struct RBasic*)(ftime))->flags & RSTRING_NOEMBED) ? ((s) = ((struct RString*)(ftime))->as.ary, (len) = (long)((((struct RBasic*)(ftime))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT))) : ((s) = ((struct RString*)(ftime))->as.heap.ptr, (len) = ((struct RString*)(ftime))->as.heap.len)); endp = (start = s) + rb_str_capacity(ftime); s += len; } while (0);
                        }
                        else {
                                VALUE sec = (rb_funcall((timev), (__builtin_constant_p("div") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("div")), (long)strlen(("div"))); (ID) rb_intern_id_cache; }) : rb_intern("div")), 1, ((((VALUE)(1))<<1 | RUBY_FIXNUM_FLAG))));
                                do { VALUE tmp = (sec); if ((((int)(long)(tmp))&RUBY_FIXNUM_FLAG)) { do { precision = ((flags & (1U<<(LEFT))) ? (1) : (precision <= 0) ? ((1)) : (precision)); len = s - start; do { if (s >= endp || (precision) >= endp - s - 1) { s = resize_buffer(ftime, s, &start, &endp, (precision), maxsize); buffer_size_check(s, format_end, format_len, enc); } } while (0); rb_str_set_len(ftime, len); rb_str_catf(ftime, (&"%*ld\0%0*ld"[ (padding == '0' || (!padding && (('0')) == '0')) ? (sizeof("%*ld") - 1)+1 : 0]), precision, (((long)(((long)(tmp))>>(int)(1))))); (!(((struct RBasic*)(ftime))->flags & RSTRING_NOEMBED) ? ((s) = ((struct RString*)(ftime))->as.ary, (len) = (long)((((struct RBasic*)(ftime))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT))) : ((s) = ((struct RString*)(ftime))->as.heap.ptr, (len) = ((struct RString*)(ftime))->as.heap.len)); endp = (start = s) + rb_str_capacity(ftime); s += len; } while (0); } else { const int base = (("d"[0] == 'x') ? 16 : ("d"[0] == 'o') ? 8 : 10); precision = ((flags & (1U<<(LEFT))) ? (1) : (precision <= 0) ? (1) : (precision)); if (!padding) padding = ('0'); tmp = format_value(tmp, base); i = (!(((struct RBasic*)(tmp))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(tmp))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(tmp))->as.heap.len); do { if (!(flags & (1U<<(LEFT))) && precision > (i)) { do { if (s >= endp || (precision) >= endp - s - 1) { s = resize_buffer(ftime, s, &start, &endp, (precision), maxsize); buffer_size_check(s, format_end, format_len, enc); } } while (0); memset(s, padding ? padding : ' ', precision - (i)); s += precision - (i); } else { do { if (s >= endp || (i) >= endp - s - 1) { s = resize_buffer(ftime, s, &start, &endp, (i), maxsize); buffer_size_check(s, format_end, format_len, enc); } } while (0); } } while (0);; rb_str_set_len(ftime, s-start); rb_str_append(ftime, tmp); (!(((struct RBasic*)(ftime))->flags & RSTRING_NOEMBED) ? ((s) = ((struct RString*)(ftime))->as.ary, (len) = (long)((((struct RBasic*)(ftime))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT))) : ((s) = ((struct RString*)(ftime))->as.heap.ptr, (len) = ((struct RString*)(ftime))->as.heap.len)); endp = (start = s) + rb_str_capacity(ftime); s += len; } } while (0);
                        }
                        continue;

  case 'S':
   i = max((0), min((vtm->sec), (60)));
   do { precision = ((flags & (1U<<(LEFT))) ? (1) : (precision <= 0) ? (2) : (precision)); len = s - start; do { if (s >= endp || (precision) >= endp - s - 1) { s = resize_buffer(ftime, s, &start, &endp, (precision), maxsize); buffer_size_check(s, format_end, format_len, enc); } } while (0); rb_str_set_len(ftime, len); rb_str_catf(ftime, (&"%*d\0%0*d"[ (padding == '0' || (!padding && ('0') == '0')) ? (sizeof("%*d") - 1)+1 : 0]), precision, ((int)i)); (!(((struct RBasic*)(ftime))->flags & RSTRING_NOEMBED) ? ((s) = ((struct RString*)(ftime))->as.ary, (len) = (long)((((struct RBasic*)(ftime))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT))) : ((s) = ((struct RString*)(ftime))->as.heap.ptr, (len) = ((struct RString*)(ftime))->as.heap.len)); endp = (start = s) + rb_str_capacity(ftime); s += len; } while (0);
   continue;

  case 'U':
   do { precision = ((flags & (1U<<(LEFT))) ? (1) : (precision <= 0) ? (2) : (precision)); len = s - start; do { if (s >= endp || (precision) >= endp - s - 1) { s = resize_buffer(ftime, s, &start, &endp, (precision), maxsize); buffer_size_check(s, format_end, format_len, enc); } } while (0); rb_str_set_len(ftime, len); rb_str_catf(ftime, (&"%*d\0%0*d"[ (padding == '0' || (!padding && ('0') == '0')) ? (sizeof("%*d") - 1)+1 : 0]), precision, (weeknumber_v(vtm, 0))); (!(((struct RBasic*)(ftime))->flags & RSTRING_NOEMBED) ? ((s) = ((struct RString*)(ftime))->as.ary, (len) = (long)((((struct RBasic*)(ftime))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT))) : ((s) = ((struct RString*)(ftime))->as.heap.ptr, (len) = ((struct RString*)(ftime))->as.heap.len)); endp = (start = s) + rb_str_capacity(ftime); s += len; } while (0);
   continue;

  case 'w':
   i = max((0), min((vtm->wday), (6)));
   do { precision = ((flags & (1U<<(LEFT))) ? (1) : (precision <= 0) ? (1) : (precision)); len = s - start; do { if (s >= endp || (precision) >= endp - s - 1) { s = resize_buffer(ftime, s, &start, &endp, (precision), maxsize); buffer_size_check(s, format_end, format_len, enc); } } while (0); rb_str_set_len(ftime, len); rb_str_catf(ftime, (&"%*d\0%0*d"[ (padding == '0' || (!padding && ('0') == '0')) ? (sizeof("%*d") - 1)+1 : 0]), precision, ((int)i)); (!(((struct RBasic*)(ftime))->flags & RSTRING_NOEMBED) ? ((s) = ((struct RString*)(ftime))->as.ary, (len) = (long)((((struct RBasic*)(ftime))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT))) : ((s) = ((struct RString*)(ftime))->as.heap.ptr, (len) = ((struct RString*)(ftime))->as.heap.len)); endp = (start = s) + rb_str_capacity(ftime); s += len; } while (0);
   continue;

  case 'W':
   do { precision = ((flags & (1U<<(LEFT))) ? (1) : (precision <= 0) ? (2) : (precision)); len = s - start; do { if (s >= endp || (precision) >= endp - s - 1) { s = resize_buffer(ftime, s, &start, &endp, (precision), maxsize); buffer_size_check(s, format_end, format_len, enc); } } while (0); rb_str_set_len(ftime, len); rb_str_catf(ftime, (&"%*d\0%0*d"[ (padding == '0' || (!padding && ('0') == '0')) ? (sizeof("%*d") - 1)+1 : 0]), precision, (weeknumber_v(vtm, 1))); (!(((struct RBasic*)(ftime))->flags & RSTRING_NOEMBED) ? ((s) = ((struct RString*)(ftime))->as.ary, (len) = (long)((((struct RBasic*)(ftime))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT))) : ((s) = ((struct RString*)(ftime))->as.heap.ptr, (len) = ((struct RString*)(ftime))->as.heap.len)); endp = (start = s) + rb_str_capacity(ftime); s += len; } while (0);
   continue;

  case 'x':
   do { len = s - start; rb_str_set_len(ftime, len); if (!rb_strftime_with_timespec(ftime, ("%m/%d/%y"), (sizeof("%m/%d/%y") - 1), enc, vtm, timev, ts, gmt, maxsize)) return 0; s = (!(((struct RBasic*)(ftime))->flags & RSTRING_NOEMBED) ? ((struct RString*)(ftime))->as.ary : ((struct RString*)(ftime))->as.heap.ptr); i = (!(((struct RBasic*)(ftime))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(ftime))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(ftime))->as.heap.len) - len; endp = (start = s) + rb_str_capacity(ftime); s += len; if (i > 0) case_conv(s, i, flags); if (precision > i) { do { if (s >= endp || (precision) >= endp - s - 1) { s = resize_buffer(ftime, s, &start, &endp, (precision), maxsize); buffer_size_check(s, format_end, format_len, enc); } } while (0); memmove(s + precision - i, s, i); memset(s, padding ? padding : ' ', precision - i); s += precision; } else s += i; } while (0);
   continue;

  case 'X':
   do { len = s - start; rb_str_set_len(ftime, len); if (!rb_strftime_with_timespec(ftime, ("%H:%M:%S"), (sizeof("%H:%M:%S") - 1), enc, vtm, timev, ts, gmt, maxsize)) return 0; s = (!(((struct RBasic*)(ftime))->flags & RSTRING_NOEMBED) ? ((struct RString*)(ftime))->as.ary : ((struct RString*)(ftime))->as.heap.ptr); i = (!(((struct RBasic*)(ftime))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(ftime))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(ftime))->as.heap.len) - len; endp = (start = s) + rb_str_capacity(ftime); s += len; if (i > 0) case_conv(s, i, flags); if (precision > i) { do { if (s >= endp || (precision) >= endp - s - 1) { s = resize_buffer(ftime, s, &start, &endp, (precision), maxsize); buffer_size_check(s, format_end, format_len, enc); } } while (0); memmove(s + precision - i, s, i); memset(s, padding ? padding : ' ', precision - i); s += precision; } else s += i; } while (0);
   continue;

  case 'y':
   i = rb_num2int_inline((rb_funcall((vtm->year), '%', 1, ((((VALUE)(100))<<1 | RUBY_FIXNUM_FLAG)))));
   do { precision = ((flags & (1U<<(LEFT))) ? (1) : (precision <= 0) ? (2) : (precision)); len = s - start; do { if (s >= endp || (precision) >= endp - s - 1) { s = resize_buffer(ftime, s, &start, &endp, (precision), maxsize); buffer_size_check(s, format_end, format_len, enc); } } while (0); rb_str_set_len(ftime, len); rb_str_catf(ftime, (&"%*d\0%0*d"[ (padding == '0' || (!padding && ('0') == '0')) ? (sizeof("%*d") - 1)+1 : 0]), precision, ((int)i)); (!(((struct RBasic*)(ftime))->flags & RSTRING_NOEMBED) ? ((s) = ((struct RString*)(ftime))->as.ary, (len) = (long)((((struct RBasic*)(ftime))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT))) : ((s) = ((struct RString*)(ftime))->as.heap.ptr, (len) = ((struct RString*)(ftime))->as.heap.len)); endp = (start = s) + rb_str_capacity(ftime); s += len; } while (0);
   continue;

  case 'Y':
                        if ((((int)(long)(vtm->year))&RUBY_FIXNUM_FLAG)) {
    long y = ((long)(((long)(vtm->year))>>(int)(1)));
    do { precision = ((flags & (1U<<(LEFT))) ? (1) : (precision <= 0) ? (0 <= y ? 4 : 5) : (precision)); len = s - start; do { if (s >= endp || (precision) >= endp - s - 1) { s = resize_buffer(ftime, s, &start, &endp, (precision), maxsize); buffer_size_check(s, format_end, format_len, enc); } } while (0); rb_str_set_len(ftime, len); rb_str_catf(ftime, (&"%*ld\0%0*ld"[ (padding == '0' || (!padding && ('0') == '0')) ? (sizeof("%*ld") - 1)+1 : 0]), precision, (y)); (!(((struct RBasic*)(ftime))->flags & RSTRING_NOEMBED) ? ((s) = ((struct RString*)(ftime))->as.ary, (len) = (long)((((struct RBasic*)(ftime))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT))) : ((s) = ((struct RString*)(ftime))->as.heap.ptr, (len) = ((struct RString*)(ftime))->as.heap.len)); endp = (start = s) + rb_str_capacity(ftime); s += len; } while (0);
                        }
                        else {
    do { VALUE tmp = (vtm->year); if ((((int)(long)(tmp))&RUBY_FIXNUM_FLAG)) { do { precision = ((flags & (1U<<(LEFT))) ? (1) : (precision <= 0) ? ((4)) : (precision)); len = s - start; do { if (s >= endp || (precision) >= endp - s - 1) { s = resize_buffer(ftime, s, &start, &endp, (precision), maxsize); buffer_size_check(s, format_end, format_len, enc); } } while (0); rb_str_set_len(ftime, len); rb_str_catf(ftime, (&"%*ld\0%0*ld"[ (padding == '0' || (!padding && (('0')) == '0')) ? (sizeof("%*ld") - 1)+1 : 0]), precision, (((long)(((long)(tmp))>>(int)(1))))); (!(((struct RBasic*)(ftime))->flags & RSTRING_NOEMBED) ? ((s) = ((struct RString*)(ftime))->as.ary, (len) = (long)((((struct RBasic*)(ftime))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT))) : ((s) = ((struct RString*)(ftime))->as.heap.ptr, (len) = ((struct RString*)(ftime))->as.heap.len)); endp = (start = s) + rb_str_capacity(ftime); s += len; } while (0); } else { const int base = (("d"[0] == 'x') ? 16 : ("d"[0] == 'o') ? 8 : 10); precision = ((flags & (1U<<(LEFT))) ? (1) : (precision <= 0) ? (4) : (precision)); if (!padding) padding = ('0'); tmp = format_value(tmp, base); i = (!(((struct RBasic*)(tmp))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(tmp))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(tmp))->as.heap.len); do { if (!(flags & (1U<<(LEFT))) && precision > (i)) { do { if (s >= endp || (precision) >= endp - s - 1) { s = resize_buffer(ftime, s, &start, &endp, (precision), maxsize); buffer_size_check(s, format_end, format_len, enc); } } while (0); memset(s, padding ? padding : ' ', precision - (i)); s += precision - (i); } else { do { if (s >= endp || (i) >= endp - s - 1) { s = resize_buffer(ftime, s, &start, &endp, (i), maxsize); buffer_size_check(s, format_end, format_len, enc); } } while (0); } } while (0);; rb_str_set_len(ftime, s-start); rb_str_append(ftime, tmp); (!(((struct RBasic*)(ftime))->flags & RSTRING_NOEMBED) ? ((s) = ((struct RString*)(ftime))->as.ary, (len) = (long)((((struct RBasic*)(ftime))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT))) : ((s) = ((struct RString*)(ftime))->as.heap.ptr, (len) = ((struct RString*)(ftime))->as.heap.len)); endp = (start = s) + rb_str_capacity(ftime); s += len; } } while (0);
                        }
   continue;
  ...
  case 'z':
   if (gmt) {
    ...
    off = rb_num2long_inline(rb_funcall(vtm->utc_offset, (__builtin_constant_p("round") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("round")), (long)strlen(("round"))); (ID) rb_intern_id_cache; }) : rb_intern("round")), 0));
   }
   if (off < 0) {
    off = -off;
    sign = -1;
   ...
   case 0:
    ...
    do { if (s >= endp || (precision + 3) >= endp - s - 1) { s = resize_buffer(ftime, s, &start, &endp, (precision + 3), maxsize); buffer_size_check(s, format_end, format_len, enc); } } while (0);
    break;

   case 1:
    precision = precision <= 6 ? 2 : precision-4;
    do { if (s >= endp || (precision + 4) >= endp - s - 1) { s = resize_buffer(ftime, s, &start, &endp, (precision + 4), maxsize); buffer_size_check(s, format_end, format_len, enc); } } while (0);
    break;

   case 2:
    precision = precision <= 9 ? 2 : precision-7;
    do { if (s >= endp || (precision + 7) >= endp - s - 1) { s = resize_buffer(ftime, s, &start, &endp, (precision + 7), maxsize); buffer_size_check(s, format_end, format_len, enc); } } while (0);
    break;
   ...
   case 3:
    if (off % 3600 == 0) {
     ...
     precision = precision <= 9 ? 2 : precision-7;
     do { if (s >= endp || (precision + 9) >= endp - s - 1) { s = resize_buffer(ftime, s, &start, &endp, (precision + 9), maxsize); buffer_size_check(s, format_end, format_len, enc); } } while (0);
    }
    break;
   ...
   i = ruby_snprintf(s, endp - s, (padding == ' ' ? "%+*ld": "%+.*ld"),
   ...
   if (colons == 3 && off == 0)
    continue;
                        if (1 <= colons)
                            *s++ = ':';
   i = ruby_snprintf(s, endp - s, "%02d", (int)(off / 60));
   if (i < 0) goto err;
   s += i;
                        off = off % 60;
   if (colons == 3 && off == 0)
    continue;
                        if (2 <= colons) {
                            *s++ = ':';
                            i = ruby_snprintf(s, endp - s, "%02d", (int)off);
                            if (i < 0) goto err;
                            s += i;
                        }
   continue;
  ...
  case 'Z':
   ...
   if (vtm->zone == ((void*)0)) {
       i = 0;
                            ...
                            tp = vtm->zone;
       if (enc) {
    for (i = 0; i < 100 && tp[i]; i++) {
        if ((unsigned char)tp[i] > 0x7F) {
     VALUE str = rb_str_conv_enc_opts( ({ (__builtin_constant_p(tp)) ? rb_str_new_static((tp), (long)strlen(tp)) : rb_str_new_cstr(tp); }), rb_locale_encoding(), enc, RUBY_ECONV_UNDEF_REPLACE|RUBY_ECONV_INVALID_REPLACE, ((VALUE)RUBY_Qnil));
     i = strlcpy(tbuf, (!(((struct RBasic*)(str))->flags & RSTRING_NOEMBED) ? ((struct RString*)(str))->as.ary : ((struct RString*)(str))->as.heap.ptr), 100);
     tp = tbuf;
     break;
        }
    }
  ...
  case 'e':
   do { precision = ((flags & (1U<<(LEFT))) ? (1) : (precision <= 0) ? (2) : (precision)); len = s - start; do { if (s >= endp || (precision) >= endp - s - 1) { s = resize_buffer(ftime, s, &start, &endp, (precision), maxsize); buffer_size_check(s, format_end, format_len, enc); } } while (0); rb_str_set_len(ftime, len); rb_str_catf(ftime, (&"%*d\0%0*d"[ (padding == '0' || (!padding && (' ') == '0')) ? (sizeof("%*d") - 1)+1 : 0]), precision, (max((1), min((vtm->mday), (31))))); (!(((struct RBasic*)(ftime))->flags & RSTRING_NOEMBED) ? ((s) = ((struct RString*)(ftime))->as.ary, (len) = (long)((((struct RBasic*)(ftime))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT))) : ((s) = ((struct RString*)(ftime))->as.heap.ptr, (len) = ((struct RString*)(ftime))->as.heap.len)); endp = (start = s) + rb_str_capacity(ftime); s += len; } while (0);
   continue;

  case 'r':
   do { len = s - start; rb_str_set_len(ftime, len); if (!rb_strftime_with_timespec(ftime, ("%I:%M:%S %p"), (sizeof("%I:%M:%S %p") - 1), enc, vtm, timev, ts, gmt, maxsize)) return 0; s = (!(((struct RBasic*)(ftime))->flags & RSTRING_NOEMBED) ? ((struct RString*)(ftime))->as.ary : ((struct RString*)(ftime))->as.heap.ptr); i = (!(((struct RBasic*)(ftime))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(ftime))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(ftime))->as.heap.len) - len; endp = (start = s) + rb_str_capacity(ftime); s += len; if (i > 0) case_conv(s, i, flags); if (precision > i) { do { if (s >= endp || (precision) >= endp - s - 1) { s = resize_buffer(ftime, s, &start, &endp, (precision), maxsize); buffer_size_check(s, format_end, format_len, enc); } } while (0); memmove(s + precision - i, s, i); memset(s, padding ? padding : ' ', precision - i); s += precision; } else s += i; } while (0);
   continue;

  case 'R':
   do { len = s - start; rb_str_set_len(ftime, len); if (!rb_strftime_with_timespec(ftime, ("%H:%M"), (sizeof("%H:%M") - 1), enc, vtm, timev, ts, gmt, maxsize)) return 0; s = (!(((struct RBasic*)(ftime))->flags & RSTRING_NOEMBED) ? ((struct RString*)(ftime))->as.ary : ((struct RString*)(ftime))->as.heap.ptr); i = (!(((struct RBasic*)(ftime))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(ftime))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(ftime))->as.heap.len) - len; endp = (start = s) + rb_str_capacity(ftime); s += len; if (i > 0) case_conv(s, i, flags); if (precision > i) { do { if (s >= endp || (precision) >= endp - s - 1) { s = resize_buffer(ftime, s, &start, &endp, (precision), maxsize); buffer_size_check(s, format_end, format_len, enc); } } while (0); memmove(s + precision - i, s, i); memset(s, padding ? padding : ' ', precision - i); s += precision; } else s += i; } while (0);
   continue;
  ...
  case 'k':
   i = max((0), min((vtm->hour), (23)));
   do { precision = ((flags & (1U<<(LEFT))) ? (1) : (precision <= 0) ? (2) : (precision)); len = s - start; do { if (s >= endp || (precision) >= endp - s - 1) { s = resize_buffer(ftime, s, &start, &endp, (precision), maxsize); buffer_size_check(s, format_end, format_len, enc); } } while (0); rb_str_set_len(ftime, len); rb_str_catf(ftime, (&"%*d\0%0*d"[ (padding == '0' || (!padding && (' ') == '0')) ? (sizeof("%*d") - 1)+1 : 0]), precision, ((int)i)); (!(((struct RBasic*)(ftime))->flags & RSTRING_NOEMBED) ? ((s) = ((struct RString*)(ftime))->as.ary, (len) = (long)((((struct RBasic*)(ftime))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT))) : ((s) = ((struct RString*)(ftime))->as.heap.ptr, (len) = ((struct RString*)(ftime))->as.heap.len)); endp = (start = s) + rb_str_capacity(ftime); s += len; } while (0);
   continue;
  ...
  case 'v':
   do { len = s - start; rb_str_set_len(ftime, len); if (!rb_strftime_with_timespec(ftime, ("%e-%^b-%4Y"), (sizeof("%e-%^b-%4Y") - 1), enc, vtm, timev, ts, gmt, maxsize)) return 0; s = (!(((struct RBasic*)(ftime))->flags & RSTRING_NOEMBED) ? ((struct RString*)(ftime))->as.ary : ((struct RString*)(ftime))->as.heap.ptr); i = (!(((struct RBasic*)(ftime))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(ftime))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(ftime))->as.heap.len) - len; endp = (start = s) + rb_str_capacity(ftime); s += len; if (i > 0) case_conv(s, i, flags); if (precision > i) { do { if (s >= endp || (precision) >= endp - s - 1) { s = resize_buffer(ftime, s, &start, &endp, (precision), maxsize); buffer_size_check(s, format_end, format_len, enc); } } while (0); memmove(s + precision - i, s, i); memset(s, padding ? padding : ' ', precision - i); s += precision; } else s += i; } while (0);
   continue;
  ...
  case 'C':
                        do { VALUE tmp = ((rb_funcall((vtm->year), (__builtin_constant_p("div") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("div")), (long)strlen(("div"))); (ID) rb_intern_id_cache; }) : rb_intern("div")), 1, ((((VALUE)(100))<<1 | RUBY_FIXNUM_FLAG))))); if ((((int)(long)(tmp))&RUBY_FIXNUM_FLAG)) { do { precision = ((flags & (1U<<(LEFT))) ? (1) : (precision <= 0) ? ((2)) : (precision)); len = s - start; do { if (s >= endp || (precision) >= endp - s - 1) { s = resize_buffer(ftime, s, &start, &endp, (precision), maxsize); buffer_size_check(s, format_end, format_len, enc); } } while (0); rb_str_set_len(ftime, len); rb_str_catf(ftime, (&"%*ld\0%0*ld"[ (padding == '0' || (!padding && (('0')) == '0')) ? (sizeof("%*ld") - 1)+1 : 0]), precision, (((long)(((long)(tmp))>>(int)(1))))); (!(((struct RBasic*)(ftime))->flags & RSTRING_NOEMBED) ? ((s) = ((struct RString*)(ftime))->as.ary, (len) = (long)((((struct RBasic*)(ftime))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT))) : ((s) = ((struct RString*)(ftime))->as.heap.ptr, (len) = ((struct RString*)(ftime))->as.heap.len)); endp = (start = s) + rb_str_capacity(ftime); s += len; } while (0); } else { const int base = (("d"[0] == 'x') ? 16 : ("d"[0] == 'o') ? 8 : 10); precision = ((flags & (1U<<(LEFT))) ? (1) : (precision <= 0) ? (2) : (precision)); if (!padding) padding = ('0'); tmp = format_value(tmp, base); i = (!(((struct RBasic*)(tmp))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(tmp))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(tmp))->as.heap.len); do { if (!(flags & (1U<<(LEFT))) && precision > (i)) { do { if (s >= endp || (precision) >= endp - s - 1) { s = resize_buffer(ftime, s, &start, &endp, (precision), maxsize); buffer_size_check(s, format_end, format_len, enc); } } while (0); memset(s, padding ? padding : ' ', precision - (i)); s += precision - (i); } else { do { if (s >= endp || (i) >= endp - s - 1) { s = resize_buffer(ftime, s, &start, &endp, (i), maxsize); buffer_size_check(s, format_end, format_len, enc); } } while (0); } } while (0);; rb_str_set_len(ftime, s-start); rb_str_append(ftime, tmp); (!(((struct RBasic*)(ftime))->flags & RSTRING_NOEMBED) ? ((s) = ((struct RString*)(ftime))->as.ary, (len) = (long)((((struct RBasic*)(ftime))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT))) : ((s) = ((struct RString*)(ftime))->as.heap.ptr, (len) = ((struct RString*)(ftime))->as.heap.len)); endp = (start = s) + rb_str_capacity(ftime); s += len; } } while (0);
   continue;
  ...
  case 'V':
   do { precision = ((flags & (1U<<(LEFT))) ? (1) : (precision <= 0) ? (2) : (precision)); len = s - start; do { if (s >= endp || (precision) >= endp - s - 1) { s = resize_buffer(ftime, s, &start, &endp, (precision), maxsize); buffer_size_check(s, format_end, format_len, enc); } } while (0); rb_str_set_len(ftime, len); rb_str_catf(ftime, (&"%*d\0%0*d"[ (padding == '0' || (!padding && ('0') == '0')) ? (sizeof("%*d") - 1)+1 : 0]), precision, (iso8601wknum_v(vtm))); (!(((struct RBasic*)(ftime))->flags & RSTRING_NOEMBED) ? ((s) = ((struct RString*)(ftime))->as.ary, (len) = (long)((((struct RBasic*)(ftime))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT))) : ((s) = ((struct RString*)(ftime))->as.heap.ptr, (len) = ((struct RString*)(ftime))->as.heap.len)); endp = (start = s) + rb_str_capacity(ftime); s += len; } while (0);
   continue;

  case 'u':

   do { precision = ((flags & (1U<<(LEFT))) ? (1) : (precision <= 0) ? (1) : (precision)); len = s - start; do { if (s >= endp || (precision) >= endp - s - 1) { s = resize_buffer(ftime, s, &start, &endp, (precision), maxsize); buffer_size_check(s, format_end, format_len, enc); } } while (0); rb_str_set_len(ftime, len); rb_str_catf(ftime, (&"%*d\0%0*d"[ (padding == '0' || (!padding && ('0') == '0')) ? (sizeof("%*d") - 1)+1 : 0]), precision, (vtm->wday == 0 ? 7 : vtm->wday)); (!(((struct RBasic*)(ftime))->flags & RSTRING_NOEMBED) ? ((s) = ((struct RString*)(ftime))->as.ary, (len) = (long)((((struct RBasic*)(ftime))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT))) : ((s) = ((struct RString*)(ftime))->as.heap.ptr, (len) = ((struct RString*)(ftime))->as.heap.len)); endp = (start = s) + rb_str_capacity(ftime); s += len; } while (0);
   continue;
  ...
  case 'g':
                        {
                                ...
                                if (vtm->mon == 12 && w == 1)
                                        yv = (rb_funcall((yv), '+', 1, ((((VALUE)(1))<<1 | RUBY_FIXNUM_FLAG))));
                                else if (vtm->mon == 1 && w >= 52)
                                        yv = (rb_funcall((yv), '-', 1, ((((VALUE)(1))<<1 | RUBY_FIXNUM_FLAG))));

                                if (*format == 'G') {
                                        if ((((int)(long)(yv))&RUBY_FIXNUM_FLAG)) {
                                                const long y = ((long)(((long)(yv))>>(int)(1)));
                                                do { precision = ((flags & (1U<<(LEFT))) ? (1) : (precision <= 0) ? (0 <= y ? 4 : 5) : (precision)); len = s - start; do { if (s >= endp || (precision) >= endp - s - 1) { s = resize_buffer(ftime, s, &start, &endp, (precision), maxsize); buffer_size_check(s, format_end, format_len, enc); } } while (0); rb_str_set_len(ftime, len); rb_str_catf(ftime, (&"%*ld\0%0*ld"[ (padding == '0' || (!padding && ('0') == '0')) ? (sizeof("%*ld") - 1)+1 : 0]), precision, (y)); (!(((struct RBasic*)(ftime))->flags & RSTRING_NOEMBED) ? ((s) = ((struct RString*)(ftime))->as.ary, (len) = (long)((((struct RBasic*)(ftime))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT))) : ((s) = ((struct RString*)(ftime))->as.heap.ptr, (len) = ((struct RString*)(ftime))->as.heap.len)); endp = (start = s) + rb_str_capacity(ftime); s += len; } while (0);
                                        }
                                        else {
                                                do { VALUE tmp = (yv); if ((((int)(long)(tmp))&RUBY_FIXNUM_FLAG)) { do { precision = ((flags & (1U<<(LEFT))) ? (1) : (precision <= 0) ? ((4)) : (precision)); len = s - start; do { if (s >= endp || (precision) >= endp - s - 1) { s = resize_buffer(ftime, s, &start, &endp, (precision), maxsize); buffer_size_check(s, format_end, format_len, enc); } } while (0); rb_str_set_len(ftime, len); rb_str_catf(ftime, (&"%*ld\0%0*ld"[ (padding == '0' || (!padding && (('0')) == '0')) ? (sizeof("%*ld") - 1)+1 : 0]), precision, (((long)(((long)(tmp))>>(int)(1))))); (!(((struct RBasic*)(ftime))->flags & RSTRING_NOEMBED) ? ((s) = ((struct RString*)(ftime))->as.ary, (len) = (long)((((struct RBasic*)(ftime))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT))) : ((s) = ((struct RString*)(ftime))->as.heap.ptr, (len) = ((struct RString*)(ftime))->as.heap.len)); endp = (start = s) + rb_str_capacity(ftime); s += len; } while (0); } else { const int base = (("d"[0] == 'x') ? 16 : ("d"[0] == 'o') ? 8 : 10); precision = ((flags & (1U<<(LEFT))) ? (1) : (precision <= 0) ? (4) : (precision)); if (!padding) padding = ('0'); tmp = format_value(tmp, base); i = (!(((struct RBasic*)(tmp))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(tmp))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(tmp))->as.heap.len); do { if (!(flags & (1U<<(LEFT))) && precision > (i)) { do { if (s >= endp || (precision) >= endp - s - 1) { s = resize_buffer(ftime, s, &start, &endp, (precision), maxsize); buffer_size_check(s, format_end, format_len, enc); } } while (0); memset(s, padding ? padding : ' ', precision - (i)); s += precision - (i); } else { do { if (s >= endp || (i) >= endp - s - 1) { s = resize_buffer(ftime, s, &start, &endp, (i), maxsize); buffer_size_check(s, format_end, format_len, enc); } } while (0); } } while (0);; rb_str_set_len(ftime, s-start); rb_str_append(ftime, tmp); (!(((struct RBasic*)(ftime))->flags & RSTRING_NOEMBED) ? ((s) = ((struct RString*)(ftime))->as.ary, (len) = (long)((((struct RBasic*)(ftime))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT))) : ((s) = ((struct RString*)(ftime))->as.heap.ptr, (len) = ((struct RString*)(ftime))->as.heap.len)); endp = (start = s) + rb_str_capacity(ftime); s += len; } } while (0);
                                        }
                                }
                                else {
                                        yv = (rb_funcall((yv), '%', 1, ((((VALUE)(100))<<1 | RUBY_FIXNUM_FLAG))));
                                        y = ((long)(((long)(yv))>>(int)(1)));
                                        do { precision = ((flags & (1U<<(LEFT))) ? (1) : (precision <= 0) ? (2) : (precision)); len = s - start; do { if (s >= endp || (precision) >= endp - s - 1) { s = resize_buffer(ftime, s, &start, &endp, (precision), maxsize); buffer_size_check(s, format_end, format_len, enc); } } while (0); rb_str_set_len(ftime, len); rb_str_catf(ftime, (&"%*ld\0%0*ld"[ (padding == '0' || (!padding && ('0') == '0')) ? (sizeof("%*ld") - 1)+1 : 0]), precision, (y)); (!(((struct RBasic*)(ftime))->flags & RSTRING_NOEMBED) ? ((s) = ((struct RString*)(ftime))->as.ary, (len) = (long)((((struct RBasic*)(ftime))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT))) : ((s) = ((struct RString*)(ftime))->as.heap.ptr, (len) = ((struct RString*)(ftime))->as.heap.len)); endp = (start = s) + rb_str_capacity(ftime); s += len; } while (0);
                                }
                                continue;
                        }
  ...
  subsec:
                        ...
                        do { if (s >= endp || (precision) >= endp - s - 1) { s = resize_buffer(ftime, s, &start, &endp, (precision), maxsize); buffer_size_check(s, format_end, format_len, enc); } } while (0);

                        if (ts) {
                                long subsec = ts->tv_nsec;
                                if (9 < precision) {
                                        ruby_snprintf(s, endp - s, "%09ld", subsec);
                                        ...
                                        for (i = 0; i < 9-precision; i++)
                                                subsec /= 10;
                                        ruby_snprintf(s, endp - s, "%0*ld", precision, subsec);
                                        s += precision;
                                }
                        }
                        else {
                                VALUE subsec = (rb_funcall((timev), '%', 1, ((((VALUE)(1))<<1 | RUBY_FIXNUM_FLAG))));
                                int ww;
                                long n;

                                ww = precision;
                                while (9 <= ww) {
                                        subsec = (rb_funcall((subsec), '*', 1, ((((VALUE)(1000000000))<<1 | RUBY_FIXNUM_FLAG))));
                                        ww -= 9;
                                }
                                n = 1;
                                for (; 0 < ww; ww--)
                                        n *= 10;
                                if (n != 1)
                                        subsec = (rb_funcall((subsec), '*', 1, ((((VALUE)(n))<<1 | RUBY_FIXNUM_FLAG))));
                                subsec = (rb_funcall((subsec), (__builtin_constant_p("div") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("div")), (long)strlen(("div"))); (ID) rb_intern_id_cache; }) : rb_intern("div")), 1, ((((VALUE)(1))<<1 | RUBY_FIXNUM_FLAG))));

                                if ((((int)(long)(subsec))&RUBY_FIXNUM_FLAG)) {
                                        (void)ruby_snprintf(s, endp - s, "%0*ld", precision, ((long)(((long)(subsec))>>(int)(1))));
                                        s += precision;
                                }
                                else {
                                        VALUE args[2], result;
                                        args[0] = (((VALUE)(precision))<<1 | RUBY_FIXNUM_FLAG);
                                        args[1] = subsec;
                                        result = rb_str_format(2, args,
                                                       ({ (__builtin_constant_p("%0*d")) ? rb_fstring_new(("%0*d"), (long)strlen("%0*d")) : rb_fstring_cstr("%0*d"); }));
                                        (void)strlcpy(s, rb_string_value_cstr(&(result)), endp-s);
                                        s += precision;
                                }
   }
   continue;
  ...
  case 'F':
   do { len = s - start; rb_str_set_len(ftime, len); if (!rb_strftime_with_timespec(ftime, ("%Y-%m-%d"), (sizeof("%Y-%m-%d") - 1), enc, vtm, timev, ts, gmt, maxsize)) return 0; s = (!(((struct RBasic*)(ftime))->flags & RSTRING_NOEMBED) ? ((struct RString*)(ftime))->as.ary : ((struct RString*)(ftime))->as.heap.ptr); i = (!(((struct RBasic*)(ftime))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(ftime))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(ftime))->as.heap.len) - len; endp = (start = s) + rb_str_capacity(ftime); s += len; if (i > 0) case_conv(s, i, flags); if (precision > i) { do { if (s >= endp || (precision) >= endp - s - 1) { s = resize_buffer(ftime, s, &start, &endp, (precision), maxsize); buffer_size_check(s, format_end, format_len, enc); } } while (0); memmove(s + precision - i, s, i); memset(s, padding ? padding : ' ', precision - i); s += precision; } else s += i; } while (0);
   continue;
  ...
  case '5': case '6': case '7': case '8': case '9':
   {
    ...
    if (ov || u > 2147483647) goto unknown;
    precision = (int)u;
    format += n - 1;
    goto again;
   }
  ...
  if (i) {
   do { if (!(flags & (1U<<(LEFT))) && precision > (i)) { do { if (s >= endp || (precision) >= endp - s - 1) { s = resize_buffer(ftime, s, &start, &endp, (precision), maxsize); buffer_size_check(s, format_end, format_len, enc); } } while (0); memset(s, padding ? padding : ' ', precision - (i)); s += precision - (i); } else { do { if (s >= endp || (i) >= endp - s - 1) { s = resize_buffer(ftime, s, &start, &endp, (i), maxsize); buffer_size_check(s, format_end, format_len, enc); } } while (0); } } while (0);;
   memcpy(s, tp, i);
...
{
 VALUE result =  ({ (__builtin_constant_p(0) && __builtin_constant_p(0)) ? rb_enc_str_new_static((0), (0), (enc)) : rb_enc_str_new((0), (0), (enc)); });
 return rb_strftime_with_timespec(result, format, format_len, enc,
      vtm, timev, ((void*)0), gmt,
...
vtm2tm_noyear(const struct vtm *vtm, struct tm *result)
{
    ...
    tm.tm_year = ((int)rb_fix2int((VALUE)((rb_funcall((vtm->year), '%', 1, ((((VALUE)(400))<<1 | RUBY_FIXNUM_FLAG))))))) + 100;
    ...
    tm.tm_gmtoff = rb_num2long_inline(vtm->utc_offset);
