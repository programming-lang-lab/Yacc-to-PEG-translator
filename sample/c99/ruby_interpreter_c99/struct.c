...
rb_struct_s_members(VALUE klass)
{
    ...
    if (!((VALUE)(members) != ((VALUE)RUBY_Qnil))) {
 rb_raise(rb_eTypeError, "uninitialized struct");
    }
    if (!( ((RUBY_T_ARRAY) == RUBY_T_FIXNUM) ? (((int)(long)(members))&RUBY_FIXNUM_FLAG) : ((RUBY_T_ARRAY) == RUBY_T_TRUE) ? ((members) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_ARRAY) == RUBY_T_FALSE) ? ((members) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_ARRAY) == RUBY_T_NIL) ? ((members) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_ARRAY) == RUBY_T_UNDEF) ? ((members) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_ARRAY) == RUBY_T_SYMBOL) ? ((((VALUE)(members)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(members) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(members) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(members))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_ARRAY) == RUBY_T_FLOAT) ? ( ((((int)(long)(members))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(members) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(members) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(members))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(members) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(members) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(members))->flags & RUBY_T_MASK) == (RUBY_T_ARRAY)))) {
...
rb_struct_members(VALUE s)
{
    ...
    if (rb_struct_len(s) != rb_array_len(members)) {
 rb_raise(rb_eTypeError, "struct size differs (%ld required %ld given)",
   rb_array_len(members), rb_struct_len(s));
    }
    return members;
}
...
struct_member_pos_ideal(VALUE name, long mask)
{
    ...
    return ((rb_sym2id(name)) >> (RUBY_ID_SCOPE_SHIFT - 1)) & mask;
}
...
{
    VALUE back;
    const long members_length = rb_array_len(members);
 ...
 rb_ary_store(back, mask, (((VALUE)(members_length))<<1 | RUBY_FIXNUM_FLAG));
 mask -= 2;

 for (i=0; i < members_length; i++) {
     name = (rb_array_const_ptr(members)[i]);

     j = struct_member_pos_ideal(name, mask);

     for (;;) {
  if (!!(((VALUE)((rb_array_const_ptr(back)[j])) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) {
      rb_ary_store(back, j, name);
      rb_ary_store(back, j + 1, (((VALUE)(i))<<1 | RUBY_FIXNUM_FLAG));
      break;
  }
  j = struct_member_pos_probe(j, mask);
     }
 }
 (void)(((struct RBasic*)(back))->flags |= RUBY_FL_FREEZE);
    }
...
struct_member_pos(VALUE s, VALUE name)
{
    ...
    if ((__builtin_expect(!!(!((VALUE)(back) != ((VALUE)RUBY_Qnil))), 0))) {
 rb_raise(rb_eTypeError, "uninitialized struct");
    }
    if ((__builtin_expect(!!(!( ((RUBY_T_ARRAY) == RUBY_T_FIXNUM) ? (((int)(long)(back))&RUBY_FIXNUM_FLAG) : ((RUBY_T_ARRAY) == RUBY_T_TRUE) ? ((back) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_ARRAY) == RUBY_T_FALSE) ? ((back) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_ARRAY) == RUBY_T_NIL) ? ((back) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_ARRAY) == RUBY_T_UNDEF) ? ((back) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_ARRAY) == RUBY_T_SYMBOL) ? ((((VALUE)(back)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(back) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(back) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(back))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_ARRAY) == RUBY_T_FLOAT) ? ( ((((int)(long)(back))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(back) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(back) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(back))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(back) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(back) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(back))->flags & RUBY_T_MASK) == (RUBY_T_ARRAY)))), 0))) {
 rb_raise(rb_eTypeError, "corrupted struct");
    }

    p = rb_array_const_ptr(back);
    mask = rb_array_len(back);

    if (mask <= AREF_HASH_THRESHOLD) {
 if ((__builtin_expect(!!(rb_struct_len(s) != mask), 0))) {
     rb_raise(rb_eTypeError,
       "struct size differs (%ld required %ld given)",
       mask, rb_struct_len(s));
 }
 for (j = 0; j < mask; j++) {
     if (p[j] == name)
  return (int)j;
 ...
 return -1;
    ...
    if ((__builtin_expect(!!(rb_struct_len(s) != ((int)rb_fix2int((VALUE)((rb_array_const_ptr(back)[mask-1]))))), 0))) {
 rb_raise(rb_eTypeError, "struct size differs (%d required %ld given)",
   ((int)rb_fix2int((VALUE)((rb_array_const_ptr(back)[mask-1])))), rb_struct_len(s));
    }
    ...
    for (;;) {
 if (p[j] == name)
     return ((int)rb_fix2int((VALUE)(p[j + 1])));
 if (!!(((VALUE)(p[j]) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) {
     return -1;
 }
 j = struct_member_pos_probe(j, mask);
    }
...
{
    VALUE slot = (rb_id2sym(id));
    int i = struct_member_pos(obj, slot);
    if (i != -1) {
 return (rb_struct_const_ptr(obj)[i]);
    }
    rb_exc_raise(rb_name_err_new( ({ (__builtin_constant_p("`%1$s' is not a struct member")) ? rb_fstring_new(("`%1$s' is not a struct member"), (long)strlen("`%1$s' is not a struct member")) : rb_fstring_cstr("`%1$s' is not a struct member"); }), (obj), ((rb_id2sym(id)))));

    __builtin_unreachable();
}

static VALUE rb_struct_ref0(VALUE obj) {return (rb_struct_const_ptr(obj)[0]);}
static VALUE rb_struct_ref1(VALUE obj) {return (rb_struct_const_ptr(obj)[1]);}
static VALUE rb_struct_ref2(VALUE obj) {return (rb_struct_const_ptr(obj)[2]);}
static VALUE rb_struct_ref3(VALUE obj) {return (rb_struct_const_ptr(obj)[3]);}
static VALUE rb_struct_ref4(VALUE obj) {return (rb_struct_const_ptr(obj)[4]);}
static VALUE rb_struct_ref5(VALUE obj) {return (rb_struct_const_ptr(obj)[5]);}
static VALUE rb_struct_ref6(VALUE obj) {return (rb_struct_const_ptr(obj)[6]);}
static VALUE rb_struct_ref7(VALUE obj) {return (rb_struct_const_ptr(obj)[7]);}
static VALUE rb_struct_ref8(VALUE obj) {return (rb_struct_const_ptr(obj)[8]);}
static VALUE rb_struct_ref9(VALUE obj) {return (rb_struct_const_ptr(obj)[9]);}
...
{
    ({do { VALUE frozen_obj = (s); if ((!(!(((VALUE)(frozen_obj) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(frozen_obj) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(frozen_obj))->flags & RUBY_T_MASK) != RUBY_T_NODE) || (((struct RBasic*)(frozen_obj))->flags&RUBY_FL_FREEZE))) { rb_error_frozen_object(frozen_obj); } } while (0);});
    ({((void) 0);});
}
...
anonymous_struct(VALUE klass)
{
    ...
    rb_make_metaclass(nstr, ((struct RBasic*)(klass))->klass);
...
new_struct(VALUE name, VALUE super)
{
 ...
 rb_exc_raise(rb_name_err_new( ({ (__builtin_constant_p("identifier %1$s needs to be constant")) ? rb_fstring_new(("identifier %1$s needs to be constant"), (long)strlen("identifier %1$s needs to be constant")) : rb_fstring_cstr("identifier %1$s needs to be constant"); }), (super), (name)));

    }
    id = rb_to_id(name);
    if (rb_const_defined_at(super, id)) {
 rb_warn("redefining constant %li\v::%li\v", super, name);
 rb_mod_remove_const(super, (rb_id2sym(id)));
    }
...
{
    rb_control_frame_t *rb_vm_opt_struct_aref(rb_execution_context_t *, rb_control_frame_t *);
    const rb_iseq_t *iseq = rb_method_for_self_aref(name, off, rb_vm_opt_struct_aref);

    rb_add_method_iseq(nstr, (rb_sym2id(name)), iseq, ((void*)0), METHOD_VISI_PUBLIC);
}

static void
define_aset_method(VALUE nstr, VALUE name, VALUE off)
{
    rb_control_frame_t *rb_vm_opt_struct_aset(rb_execution_context_t *, rb_control_frame_t *);
...
rb_struct_s_inspect(VALUE klass)
{
    ...
    if (!(((VALUE)(rb_struct_s_keyword_init(klass)) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) {
  ({ (__builtin_constant_p("(keyword_init: true)")) ? rb_str_cat((inspect), ("(keyword_init: true)"), (long)strlen("(keyword_init: true)")) : rb_str_cat_cstr((inspect), ("(keyword_init: true)")); });
    }
    return inspect;
}
...
setup_struct(VALUE nstr, VALUE members)
{
    ...
    ptr_members = rb_array_const_ptr(members);
    len = rb_array_len(members);
    for (i=0; i< len; i++) {
 ID id = (rb_sym2id(ptr_members[i]));
 VALUE off = rb_long2num_inline(i);

 if (i < ((int)(sizeof(ref_func) / sizeof((ref_func)[0])))) {
     rb_define_method_id(nstr, id, ref_func[i], 0);
 }
 else {
     define_aref_method(nstr, ptr_members[i], off);
 }
 define_aset_method(nstr, (rb_id2sym(rb_id_attrset(id))), off);
    }
...
struct_make_members_list(va_list ar)
{
    ...
    st_table *tbl = rb_hash_tbl(list);

    memset(&(((struct RBasicRaw *)((VALUE)(list)))->klass), 0, sizeof(VALUE));
    while ((mem = __builtin_va_arg()) != 0) {
 VALUE sym =  ( { (__builtin_constant_p(mem)) ? rb_sym_intern_ascii((mem), (long)strlen(mem)) : rb_sym_intern_ascii_cstr(mem); });
 if (st_insert(tbl, sym, ((VALUE)RUBY_Qtrue))) {
    ...
    (void)(((struct RBasic*)(ary))->flags |= RUBY_FL_FREEZE);
    return ary;
}
...
rb_struct_define(const char *name, ...)
{
    ...
    __builtin_va_start(ar, name);
    ary = struct_make_members_list(ar);
    __builtin_va_end(ar);

    if (!name) st = anonymous_struct(rb_cStruct);
    else st = new_struct( ({ (__builtin_constant_p(name)) ? rb_str_new_static((name), (long)strlen(name)) : rb_str_new_cstr(name); }), rb_cStruct);
...
rb_struct_s_def(int argc, VALUE *argv, VALUE klass)
{
 ...
 ++argv;
    ...
    if (( ((RUBY_T_HASH) == RUBY_T_FIXNUM) ? (((int)(long)(argv[argc-1]))&RUBY_FIXNUM_FLAG) : ((RUBY_T_HASH) == RUBY_T_TRUE) ? ((argv[argc-1]) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_HASH) == RUBY_T_FALSE) ? ((argv[argc-1]) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_HASH) == RUBY_T_NIL) ? ((argv[argc-1]) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_HASH) == RUBY_T_UNDEF) ? ((argv[argc-1]) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_HASH) == RUBY_T_SYMBOL) ? ((((VALUE)(argv[argc-1])&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(argv[argc-1]) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(argv[argc-1]) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(argv[argc-1]))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_HASH) == RUBY_T_FLOAT) ? ( ((((int)(long)(argv[argc-1]))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(argv[argc-1]) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(argv[argc-1]) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(argv[argc-1]))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(argv[argc-1]) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(argv[argc-1]) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(argv[argc-1]))->flags & RUBY_T_MASK) == (RUBY_T_HASH)))) {
 VALUE kwargs[1];
 static ID keyword_ids[1];

 if (!keyword_ids[0]) {
     keyword_ids[0] = (__builtin_constant_p("keyword_init") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("keyword_init")), (long)strlen(("keyword_init"))); (ID) rb_intern_id_cache; }) : rb_intern("keyword_init"));
 }
 ...
 keyword_init = ((VALUE)RUBY_Qfalse);
    }

    rest = rb_ident_hash_new();
    memset(&(((struct RBasicRaw *)((VALUE)(rest)))->klass), 0, sizeof(VALUE));
    tbl = rb_hash_tbl(rest);
    for (i=0; i<argc; i++) {
 VALUE mem = rb_to_symbol(argv[i]);
 if (st_insert(tbl, mem, ((VALUE)RUBY_Qtrue))) {
     rb_raise(rb_eArgError, "duplicate member: %li\v", mem);
 }
    }
    rest = rb_hash_keys(rest);
    st_clear(tbl);
    memset(&(((struct RBasicRaw *)((VALUE)(rest)))->klass), 0, sizeof(VALUE));
    (void)(((struct RBasic*)(rest))->flags |= RUBY_FL_FREEZE);
...
struct_hash_set_i(VALUE key, VALUE val, VALUE arg)
{
    ...
    if (i < 0) {
 if (args->unknown_keywords == ((VALUE)RUBY_Qnil)) {
 ...
 rb_obj_write((VALUE)(args->self), (VALUE *)(&rb_struct_const_ptr(args->self)[i]), (VALUE)((val)), "struct.c", 612);
    }
    return ST_CONTINUE;
}
...
rb_struct_initialize_m(int argc, const VALUE *argv, VALUE self)
{
    ...
    n = num_members(klass);
    if (argc > 0 && !(((VALUE)(rb_struct_s_keyword_init(klass)) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) {
 struct struct_hash_set_arg arg;
 if (argc > 2 || !( ((RUBY_T_HASH) == RUBY_T_FIXNUM) ? (((int)(long)(argv[0]))&RUBY_FIXNUM_FLAG) : ((RUBY_T_HASH) == RUBY_T_TRUE) ? ((argv[0]) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_HASH) == RUBY_T_FALSE) ? ((argv[0]) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_HASH) == RUBY_T_NIL) ? ((argv[0]) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_HASH) == RUBY_T_UNDEF) ? ((argv[0]) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_HASH) == RUBY_T_SYMBOL) ? ((((VALUE)(argv[0])&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(argv[0]) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(argv[0]) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(argv[0]))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_HASH) == RUBY_T_FLOAT) ? ( ((((int)(long)(argv[0]))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(argv[0]) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(argv[0]) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(argv[0]))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(argv[0]) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(argv[0]) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(argv[0]))->flags & RUBY_T_MASK) == (RUBY_T_HASH)))) {
     rb_raise(rb_eArgError, "wrong number of arguments (given %d, expected 0)", argc);
 }
 rb_mem_clear((VALUE *)rb_struct_const_ptr(self), n);
 arg.self = self;
 arg.unknown_keywords = ((VALUE)RUBY_Qnil);
 rb_hash_foreach(argv[0], struct_hash_set_i, (VALUE)&arg);
 if (arg.unknown_keywords != ((VALUE)RUBY_Qnil)) {
     rb_raise(rb_eArgError, "unknown keywords: %s",
       (!(((struct RBasic*)(rb_ary_join(arg.unknown_keywords,  ({ (__builtin_constant_p(", ")) ? rb_str_new_static((", "), (long)strlen(", ")) : rb_str_new_cstr(", "); }))))->flags & RSTRING_NOEMBED) ? ((struct RString*)(rb_ary_join(arg.unknown_keywords,  ({ (__builtin_constant_p(", ")) ? rb_str_new_static((", "), (long)strlen(", ")) : rb_str_new_cstr(", "); }))))->as.ary : ((struct RString*)(rb_ary_join(arg.unknown_keywords,  ({ (__builtin_constant_p(", ")) ? rb_str_new_static((", "), (long)strlen(", ")) : rb_str_new_cstr(", "); }))))->as.heap.ptr));
 }
    }
    else {
 if (n < argc) {
 ...
 for (i=0; i<argc; i++) {
     rb_obj_write((VALUE)(self), (VALUE *)(&rb_struct_const_ptr(self)[i]), (VALUE)((argv[i])), "struct.c", 644);
 }
 if (n > argc) {
     rb_mem_clear((VALUE *)rb_struct_const_ptr(self)+argc, n-argc);
 }
    }
    return ((VALUE)RUBY_Qnil);
}
...
{
    return rb_struct_initialize_m(rb_long2int_inline(rb_array_len(values)), rb_array_const_ptr(values), self);
}
...
{
    long n;
    struct RStruct *(st) = (struct RStruct*)(((RUBY_T_STRUCT | (1 ? ((VALUE)RUBY_FL_WB_PROTECTED) : 0)) & ((VALUE)RUBY_FL_WB_PROTECTED)) ? rb_wb_protected_newobj_of(klass, (RUBY_T_STRUCT | (1 ? ((VALUE)RUBY_FL_WB_PROTECTED) : 0)) & ~((VALUE)RUBY_FL_WB_PROTECTED)) : rb_wb_unprotected_newobj_of(klass, RUBY_T_STRUCT | (1 ? ((VALUE)RUBY_FL_WB_PROTECTED) : 0)));

    n = num_members(klass);

    if (0 < n && n <= RSTRUCT_EMBED_LEN_MAX) {
        ((struct RBasic*)(st))->flags &= ~RSTRUCT_EMBED_LEN_MASK;
        ((struct RBasic*)(st))->flags |= n << RSTRUCT_EMBED_LEN_SHIFT;
 rb_mem_clear((VALUE *)st->as.ary, n);
    }
    else {
 st->as.heap.ptr = ((VALUE*)ruby_xmalloc2((size_t)(n),sizeof(VALUE)));
...
{
    return rb_class_new_instance(rb_long2int_inline(rb_array_len(values)), rb_array_const_ptr(values), klass);
}

VALUE
rb_struct_new(VALUE klass, ...)
{
    VALUE tmpargs[((int)(sizeof(ref_func) / sizeof((ref_func)[0])))], *mem = tmpargs;
    int size, i;
    va_list args;

    size = rb_long2int_inline(num_members(klass));
    if (size > ((int)(sizeof(tmpargs) / sizeof((tmpargs)[0])))) {
 tmpargs[0] = rb_ary_tmp_new(size);
 mem = ((VALUE *)rb_array_const_ptr(( __builtin_choose_expr( 1, rb_obj_wb_unprotect((VALUE)(tmpargs[0]), "struct.c", 697), ((VALUE)(tmpargs[0]))))));
    }
    __builtin_va_start(args, klass);
    for (i=0; i<size; i++) {
 mem[i] = __builtin_va_arg();
    }
...
rb_struct_each(VALUE s)
{
    ...
    do { if (!rb_block_given_p()) return rb_enumeratorize_with_size((s), (rb_id2sym(rb_frame_this_func())), (0), (0), (rb_enumerator_size_func *)((struct_enum_size))); } while (0);
    for (i=0; i<rb_struct_len(s); i++) {
 rb_yield((rb_struct_const_ptr(s)[i]));
    }
    return s;
}
static VALUE
rb_struct_each_pair(VALUE s)
{
 ...
 for (i=0; i<rb_struct_len(s); i++) {
     ...
     VALUE value = (rb_struct_const_ptr(s)[i]);
...
inspect_struct(VALUE s, VALUE dummy, int recur)
{
    ...
    VALUE members, str =  ({ (__builtin_constant_p("#<struct ")) ? rb_str_new_static(("#<struct "), (long)strlen("#<struct ")) : rb_str_new_cstr("#<struct "); });
    long i, len;
    char first = (!(((struct RBasic*)(cname))->flags & RSTRING_NOEMBED) ? ((struct RString*)(cname))->as.ary : ((struct RString*)(cname))->as.heap.ptr)[0];
 ...
 slot = (rb_array_const_ptr(members)[i]);
 id = (rb_sym2id(slot));
 if (rb_is_local_id(id) || rb_is_const_id(id)) {
  ...
  ({ (__builtin_constant_p("=")) ? rb_str_cat((str), ("="), (long)strlen("=")) : rb_str_cat_cstr((str), ("=")); });
 rb_str_append(str, rb_inspect((rb_struct_const_ptr(s)[i])));
    }
     ({ (__builtin_constant_p(">")) ? rb_str_cat((str), (">"), (long)strlen(">")) : rb_str_cat_cstr((str), (">")); });
    ( (((!(((VALUE)(str) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(str) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(str))->flags & RUBY_T_MASK) != RUBY_T_NODE) && (int)(((struct RBasic*)(str))->flags & RUBY_T_MASK) != RUBY_T_BIGNUM && (int)(((struct RBasic*)(str))->flags & RUBY_T_MASK) != RUBY_T_FLOAT) && (!(((VALUE)(s) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(s) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(s))->flags & RUBY_T_MASK) != RUBY_T_NODE)) ? (void)(((struct RBasic*)(str))->flags |= ((((struct RBasic*)(s))->flags&(RUBY_FL_TAINT)))) : (void)0);
...
{
    return rb_ary_new_from_values(rb_struct_len(s), rb_struct_const_ptr(s));
}
static VALUE
rb_struct_to_h(VALUE s)
{
    VALUE h = rb_hash_new_with_size(rb_struct_len(s));
    VALUE members = rb_struct_members(s);
    long i;

    for (i=0; i<rb_struct_len(s); i++) {
 rb_hash_aset(h, rb_ary_entry(members, i), (rb_struct_const_ptr(s)[i]));
    }
    return h;
}
...
rb_struct_init_copy(VALUE copy, VALUE s)
{
    ...
    if (!((copy) != (s) && (rb_obj_init_copy((copy), (s)), 1))) return copy;
    if (rb_struct_len(copy) != rb_struct_len(s)) {
 rb_raise(rb_eTypeError, "struct size mismatch");
    }

    for (i=0, len=rb_struct_len(copy); i<len; i++) {
 rb_obj_write((VALUE)(copy), (VALUE *)(&rb_struct_const_ptr(copy)[i]), (VALUE)(((rb_struct_const_ptr(s)[i]))), "struct.c", 902);
    }
...
rb_struct_pos(VALUE s, VALUE *name)
{
    ...
    if (( ((RUBY_T_SYMBOL) == RUBY_T_FIXNUM) ? (((int)(long)(idx))&RUBY_FIXNUM_FLAG) : ((RUBY_T_SYMBOL) == RUBY_T_TRUE) ? ((idx) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_SYMBOL) == RUBY_T_FALSE) ? ((idx) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_SYMBOL) == RUBY_T_NIL) ? ((idx) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_SYMBOL) == RUBY_T_UNDEF) ? ((idx) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_SYMBOL) == RUBY_T_SYMBOL) ? ((((VALUE)(idx)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(idx) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(idx) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(idx))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_SYMBOL) == RUBY_T_FLOAT) ? ( ((((int)(long)(idx))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(idx) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(idx) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(idx))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(idx) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(idx) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(idx))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL)))) {
 return struct_member_pos(s, idx);
    }
    else if (( ((RUBY_T_STRING) == RUBY_T_FIXNUM) ? (((int)(long)(idx))&RUBY_FIXNUM_FLAG) : ((RUBY_T_STRING) == RUBY_T_TRUE) ? ((idx) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_STRING) == RUBY_T_FALSE) ? ((idx) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_STRING) == RUBY_T_NIL) ? ((idx) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_STRING) == RUBY_T_UNDEF) ? ((idx) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_STRING) == RUBY_T_SYMBOL) ? ((((VALUE)(idx)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(idx) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(idx) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(idx))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_STRING) == RUBY_T_FLOAT) ? ( ((((int)(long)(idx))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(idx) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(idx) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(idx))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(idx) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(idx) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(idx))->flags & RUBY_T_MASK) == (RUBY_T_STRING)))) {
 idx = rb_check_symbol(name);
 if (!((VALUE)(idx) != ((VALUE)RUBY_Qnil))) return -1;
 return struct_member_pos(s, idx);
    }
    else {
 long len;
 i = rb_num2long_inline(idx);
 len = rb_struct_len(s);
 if (i < 0) {
     if (i + len < 0) {
  *name = (((VALUE)(i))<<1 | RUBY_FIXNUM_FLAG);
  return -1;
     }
     i += len;
 }
...
invalid_struct_pos(VALUE s, VALUE idx)
{
 ...
 long i = ((int)rb_fix2int((VALUE)(idx))), len = rb_struct_len(s);
 if (i < 0) {
 ...
 rb_exc_raise(rb_name_err_new( ({ (__builtin_constant_p("no member '%1$s' in struct")) ? rb_fstring_new(("no member '%1$s' in struct"), (long)strlen("no member '%1$s' in struct")) : rb_fstring_cstr("no member '%1$s' in struct"); }), (s), (idx)));
    }
}
VALUE
rb_struct_aref(VALUE s, VALUE idx)
{
    ...
    return (rb_struct_const_ptr(s)[i]);
}
VALUE
rb_struct_aset(VALUE s, VALUE idx, VALUE val)
{
    ...
    if (i < 0) invalid_struct_pos(s, idx);
    rb_struct_modify(s);
    rb_obj_write((VALUE)(s), (VALUE *)(&rb_struct_const_ptr(s)[i]), (VALUE)((val)), "struct.c", 1011);
    return val;
}
...
{
    return rb_struct_lookup_default(s, idx, ((VALUE)RUBY_Qnil));
}
...
{
    return rb_struct_aref(s, rb_long2num_inline(n));
}
static VALUE
rb_struct_values_at(int argc, VALUE *argv, VALUE s)
{
    return rb_get_values_at(s, rb_struct_len(s), argc, argv, struct_entry);
}
static VALUE
rb_struct_select(int argc, VALUE *argv, VALUE s)
{
    ...
    result = rb_ary_new();
    for (i = 0; i < rb_struct_len(s); i++) {
 if (!(((VALUE)(rb_yield((rb_struct_const_ptr(s)[i]))) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) {
     rb_ary_push(result, (rb_struct_const_ptr(s)[i]));
 }
    }
...
recursive_equal(VALUE s, VALUE s2, int recur)
{
    ...
    ptr = rb_struct_const_ptr(s);
    ptr2 = rb_struct_const_ptr(s2);
    len = rb_struct_len(s);
    for (i=0; i<len; i++) {
 if (!rb_equal(ptr[i], ptr2[i])) return ((VALUE)RUBY_Qfalse);
    }
...
{
    if (s == s2) return ((VALUE)RUBY_Qtrue);
    if (!( ((RUBY_T_STRUCT) == RUBY_T_FIXNUM) ? (((int)(long)(s2))&RUBY_FIXNUM_FLAG) : ((RUBY_T_STRUCT) == RUBY_T_TRUE) ? ((s2) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_STRUCT) == RUBY_T_FALSE) ? ((s2) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_STRUCT) == RUBY_T_NIL) ? ((s2) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_STRUCT) == RUBY_T_UNDEF) ? ((s2) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_STRUCT) == RUBY_T_SYMBOL) ? ((((VALUE)(s2)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(s2) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(s2) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(s2))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_STRUCT) == RUBY_T_FLOAT) ? ( ((((int)(long)(s2))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(s2) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(s2) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(s2))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(s2) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(s2) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(s2))->flags & RUBY_T_MASK) == (RUBY_T_STRUCT)))) return ((VALUE)RUBY_Qfalse);
    if (rb_obj_class(s) != rb_obj_class(s2)) return ((VALUE)RUBY_Qfalse);
    if (rb_struct_len(s) != rb_struct_len(s2)) {
...
rb_struct_hash(VALUE s)
{
    ...
    for (i = 0; i < len; i++) {
 n = rb_hash(ptr[i]);
 h = st_hash_uint((h), (rb_num2long_inline(n)));
    }
    h = st_hash_end(h);
    return (((VALUE)(h))<<1 | RUBY_FIXNUM_FLAG);
}
...
recursive_eql(VALUE s, VALUE s2, int recur)
{
    ...
    len = rb_struct_len(s);
    for (i=0; i<len; i++) {
 if (!rb_eql(ptr[i], ptr2[i])) return ((VALUE)RUBY_Qfalse);
    }
    return ((VALUE)RUBY_Qtrue);
}
static VALUE
...
{
    return (((VALUE)(rb_struct_len(s)))<<1 | RUBY_FIXNUM_FLAG);
}
static VALUE
rb_struct_dig(int argc, VALUE *argv, VALUE self)
{
    ...
    if (!--argc) return self;
    ++argv;
    return rb_obj_dig(argc, argv, self, ((VALUE)RUBY_Qnil));
}
void
InitVM_Struct(void)
{
...
Init_Struct(void)
{
    ...
    {void InitVM_Struct(void);InitVM_Struct();};
}
