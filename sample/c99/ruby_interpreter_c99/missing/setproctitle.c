...
static char *argv_start = ((void*)0);
static size_t argv_env_len = 0;
static size_t argv_len = 0;
static char **argv1_addr = ((void*)0);
...
ruby_init_setproctitle(int argc, char *argv[])
{
 ...
 extern char **environ;
 char *lastargv = ((void*)0);
 char *lastenvp = ((void*)0);
 char **envp = environ;
 int i;
 ...
 for (i = 0; envp[i] != ((void*)0); i++)
  ;
 if ((environ = calloc(i + 1, sizeof(*environ))) == ((void*)0)) {
  environ = envp;
  return;
 }
 ...
 for (i = 0; i < argc; i++) {
  if (lastargv == ((void*)0) || lastargv + 1 == argv[i])
...
setproctitle(const char *fmt, ...)
{
 ...
 if (fmt != ((void*)0)) {
  ruby_vsnprintf(ptitle, sizeof(ptitle) , fmt, ap);
 }
 __builtin_va_end(ap);
