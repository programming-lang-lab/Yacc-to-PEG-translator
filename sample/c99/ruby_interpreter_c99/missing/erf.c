...
static double p_gamma(double a, double x, double loggamma_a)
{
    ...
    fprintf(stderr, "erf.c:%d:p_gamma() could not converge.", 42);
    return result;
}
...
static double q_gamma(double a, double x, double loggamma_a)
{
    ...
    fprintf(stderr, "erf.c:%d:q_gamma() could not converge.", 65);
    return result;
}
...
{
    if (!finite(x)) {
        if ((sizeof ((x)) == sizeof (float) ? __isnanf (x) : sizeof ((x)) == sizeof (double) ? __isnan (x) : __isnanl (x))) return x;
        return (x>0 ? 1.0 : -1.0);
    }
    if (x >= 0) return p_gamma(0.5, x * x, 0.572364942924700087071713675675);
    else return - p_gamma(0.5, x * x, 0.572364942924700087071713675675);
}
...
double erfc(double x)
{
    ...
    if (x >= 0) return q_gamma(0.5, x * x, 0.572364942924700087071713675675);
    else return 1 + p_gamma(0.5, x * x, 0.572364942924700087071713675675);
}
