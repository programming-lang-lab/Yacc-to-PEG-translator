...
{
    return rb_ivar_lookup(str, id_associated, ((VALUE)RUBY_Qfalse));
}
static VALUE
pack_pack(int argc, VALUE *argv, VALUE ary)
{
    ...
    const char *p, *pend;
    VALUE fmt, opt = ((VALUE)RUBY_Qnil), res, from, associates = 0, buffer = 0;
    char type;
    long len, idx, plen;
    const char *ptr;
    int enc_info = 1;
    ...
    pend = p + (!(((struct RBasic*)(fmt))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(fmt))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(fmt))->as.heap.len);
    if (!!((VALUE)(opt) != ((VALUE)RUBY_Qnil))) {
 static ID keyword_ids[1];
 if (!keyword_ids[0])
     do { static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("buffer")), (long)strlen(("buffer"))); (keyword_ids[0]) = rb_intern_id_cache; } while (0);

 rb_get_kwargs(opt, keyword_ids, 0, 1, &buffer);

 if (buffer != ((VALUE)RUBY_Qundef) && !( ((RUBY_T_STRING) == RUBY_T_FIXNUM) ? (((int)(long)(buffer))&RUBY_FIXNUM_FLAG) : ((RUBY_T_STRING) == RUBY_T_TRUE) ? ((buffer) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_STRING) == RUBY_T_FALSE) ? ((buffer) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_STRING) == RUBY_T_NIL) ? ((buffer) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_STRING) == RUBY_T_UNDEF) ? ((buffer) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_STRING) == RUBY_T_SYMBOL) ? ((((VALUE)(buffer)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(buffer) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(buffer) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(buffer))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_STRING) == RUBY_T_FLOAT) ? ( ((((int)(long)(buffer))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(buffer) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(buffer) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(buffer))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(buffer) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(buffer) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(buffer))->flags & RUBY_T_MASK) == (RUBY_T_STRING))))
 ...
 if ((!(((struct RBasic*)(fmt))->flags & RSTRING_NOEMBED) ? ((struct RString*)(fmt))->as.ary : ((struct RString*)(fmt))->as.heap.ptr) + (!(((struct RBasic*)(fmt))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(fmt))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(fmt))->as.heap.len) != pend) {
 ...
 if (*p == '*') {
     len = strchr("@Xxu", type) ? 0
                : strchr("PMm", type) ? 1
                : rb_array_len(ary) - idx;
     p++;
 }
 else if (rb_isdigit(*p)) {
     (*__errno_location ()) = 0;
     len = (ruby_strtoul((p), ((char**)&p), (10)));
     if ((*__errno_location ())) {
 ...
 switch (type) {
   ...
   case 'B': case 'b':
   case 'H': case 'h':
     from = ((idx < rb_array_len(ary)) ? (rb_array_const_ptr(ary)[idx++]) : (rb_raise(rb_eArgError, toofew), 0));
     if (!((VALUE)(from) != ((VALUE)RUBY_Qnil))) {
  ptr = "";
  plen = 0;
     }
     else {
  rb_string_value(&(from));
  ptr = (!(((struct RBasic*)(from))->flags & RSTRING_NOEMBED) ? ((struct RString*)(from))->as.ary : ((struct RString*)(from))->as.heap.ptr);
  plen = (!(((struct RBasic*)(from))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(from))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(from))->as.heap.len);
  ( (((!(((VALUE)(res) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(res) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(res))->flags & RUBY_T_MASK) != RUBY_T_NODE) && (int)(((struct RBasic*)(res))->flags & RUBY_T_MASK) != RUBY_T_BIGNUM && (int)(((struct RBasic*)(res))->flags & RUBY_T_MASK) != RUBY_T_FLOAT) && (!(((VALUE)(from) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(from) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(from))->flags & RUBY_T_MASK) != RUBY_T_NODE)) ? (void)(((struct RBasic*)(res))->flags |= ((((struct RBasic*)(from))->flags&(RUBY_FL_TAINT)))) : (void)0);
     }
  ...
  break;
   ...
   case 's':
            integer_size = (natint?(int)sizeof(short):(int)(2));
            bigendian_p = 0;
            goto pack_integer;
   ...
   case 'l':
            integer_size = (natint?(int)sizeof(long):(int)(4));
            bigendian_p = 0;
            goto pack_integer;
   ...
   case 'q':
     integer_size = (natint?(int)sizeof(long long):(int)(8));
            bigendian_p = 0;
            goto pack_integer;
  ...
  bigendian_p = explicit_endian == '>';
            ...
            while (len-- > 0) {
                ...
                rb_integer_pack(from, intbuf, integer_size, 1, 0,
                    0x80 |
                    (bigendian_p ? (0x01 | 0x10) : (0x02 | 0x20)));
                rb_str_cat(res, intbuf, integer_size);
            }
     break;
  ...
  from = ((idx < rb_array_len(ary)) ? (rb_array_const_ptr(ary)[idx++]) : (rb_raise(rb_eArgError, toofew), 0));
  f = (float)rb_float_value_inline(rb_to_float(from));
  ...
  from = ((idx < rb_array_len(ary)) ? (rb_array_const_ptr(ary)[idx++]) : (rb_raise(rb_eArgError, toofew), 0));
  tmp.f = (float)rb_float_value_inline(rb_to_float(from));
  ((tmp).u = (0?__builtin_bswap32((tmp).u):((tmp).u)));
  rb_str_cat(res, tmp.buf, sizeof(float));
     }
     break;
  ...
  DOUBLE_SWAPPER tmp;;
  from = ((idx < rb_array_len(ary)) ? (rb_array_const_ptr(ary)[idx++]) : (rb_raise(rb_eArgError, toofew), 0));
  tmp.d = rb_float_value_inline(rb_to_float(from));
  ((tmp).u = (0?__builtin_bswap64((tmp).u):((tmp).u)));
  rb_str_cat(res, tmp.buf, sizeof(double));
     }
     break;
  ...
  from = ((idx < rb_array_len(ary)) ? (rb_array_const_ptr(ary)[idx++]) : (rb_raise(rb_eArgError, toofew), 0));
  d = rb_float_value_inline(rb_to_float(from));
  ...
  from = ((idx < rb_array_len(ary)) ? (rb_array_const_ptr(ary)[idx++]) : (rb_raise(rb_eArgError, toofew), 0));
  tmp.f = (float)rb_float_value_inline(rb_to_float(from));
  ((tmp).u = (0?((tmp).u):__builtin_bswap32((tmp).u)));
  rb_str_cat(res, tmp.buf, sizeof(float));
     }
     break;
  ...
  from = ((idx < rb_array_len(ary)) ? (rb_array_const_ptr(ary)[idx++]) : (rb_raise(rb_eArgError, toofew), 0));
  tmp.d = rb_float_value_inline(rb_to_float(from));
  ((tmp).u = (0?((tmp).u):__builtin_bswap64((tmp).u)));
  rb_str_cat(res, tmp.buf, sizeof(double));
     }
     break;
  ...
  len -= 10;
   ...
   case 'X':
   shrink:
     plen = (!(((struct RBasic*)(res))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(res))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(res))->as.heap.len);
     if (plen < len)
  rb_raise(rb_eArgError, "X outside of string");
   ...
   case '@':
     len -= (!(((struct RBasic*)(res))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(res))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(res))->as.heap.len);
     if (len > 0) goto grow;
     len = -len;
  ...
  ptr += todo;
   ...
   case 'M':
     from = rb_obj_as_string(((idx < rb_array_len(ary)) ? (rb_array_const_ptr(ary)[idx++]) : (rb_raise(rb_eArgError, toofew), 0)));
     if (len <= 1)
  len = 72;
   ...
   case 'P':
     ...
     if (!!((VALUE)(from) != ((VALUE)RUBY_Qnil))) {
  rb_string_value(&(from));
  if ((!(((struct RBasic*)(from))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(from))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(from))->as.heap.len) < len) {
      rb_raise(rb_eArgError, "too short buffer for P(%ld for %ld)",
        (!(((struct RBasic*)(from))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(from))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(from))->as.heap.len), len);
  }
     }
     len = 1;
  ...
  rb_str_cat(res, (char*)&t, sizeof(char*));
   ...
   case 'w':
     while (len-- > 0) {
  VALUE buf =  ({ (__builtin_constant_p(0) && __builtin_constant_p(0)) ? rb_str_new_static((0), (0)) : rb_str_new((0), (0)); });
                size_t numbytes;
                int sign;
                char *cp;
  ...
  from = ((idx < rb_array_len(ary)) ? (rb_array_const_ptr(ary)[idx++]) : (rb_raise(rb_eArgError, toofew), 0));
                from = rb_to_int(from);
                numbytes = rb_absint_numwords(from, 7, ((void*)0));
                if (numbytes == 0)
                    numbytes = 1;
                buf =  ({ (__builtin_constant_p(((void*)0)) && __builtin_constant_p(numbytes)) ? rb_str_new_static((((void*)0)), (numbytes)) : rb_str_new((((void*)0)), (numbytes)); });

                sign = rb_integer_pack(from, (!(((struct RBasic*)(buf))->flags & RSTRING_NOEMBED) ? ((struct RString*)(buf))->as.ary : ((struct RString*)(buf))->as.heap.ptr), (!(((struct RBasic*)(buf))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(buf))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(buf))->as.heap.len), 1, 1, (0x01 | 0x10));
                ...
                cp = (!(((struct RBasic*)(buf))->flags & RSTRING_NOEMBED) ? ((struct RString*)(buf))->as.ary : ((struct RString*)(buf))->as.heap.ptr);
                while (1 < numbytes) {
                  *cp |= 0x80;
                  cp++;
                  numbytes--;
                ...
                rb_str_cat(res, (!(((struct RBasic*)(buf))->flags & RSTRING_NOEMBED) ? ((struct RString*)(buf))->as.ary : ((struct RString*)(buf))->as.heap.ptr), (!(((struct RBasic*)(buf))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(buf))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(buf))->as.heap.len));
     }
     break;
  ...
  ruby_snprintf(unknown, sizeof(unknown), "\\x%.2x", type & 0xff);
     }
     rb_warning("unknown pack directive '%s' in '% li\v'",
         unknown, fmt);
     break;
   }
 }
 ...
 str_associate(res, associates);
    ...
    ( (((!(((VALUE)(res) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(res) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(res))->flags & RUBY_T_MASK) != RUBY_T_NODE) && (int)(((struct RBasic*)(res))->flags & RUBY_T_MASK) != RUBY_T_BIGNUM && (int)(((struct RBasic*)(res))->flags & RUBY_T_MASK) != RUBY_T_FLOAT) && (!(((VALUE)(fmt) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(fmt) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(fmt))->flags & RUBY_T_MASK) != RUBY_T_NODE)) ? (void)(((struct RBasic*)(res))->flags |= ((((struct RBasic*)(fmt))->flags&(RUBY_FL_TAINT)))) : (void)0);
    switch (enc_info) {
      case 1:
 do { VALUE rb_encoding_coderange_obj = (res); rb_enc_set_index((rb_encoding_coderange_obj), ((rb_usascii_encindex()))); ( ((struct RBasic*)(rb_encoding_coderange_obj))->flags = (((struct RBasic*)(rb_encoding_coderange_obj))->flags & ~RUBY_ENC_CODERANGE_MASK) | ((RUBY_ENC_CODERANGE_7BIT))); } while (0);
 break;
      case 2:
...
qpencode(VALUE str, VALUE from, long len)
{
    char buff[1024];
    long i = 0, n = 0, prev = (-1);
    unsigned char *s = (unsigned char*)(!(((struct RBasic*)(from))->flags & RSTRING_NOEMBED) ? ((struct RString*)(from))->as.ary : ((struct RString*)(from))->as.heap.ptr);
    unsigned char *send = s + (!(((struct RBasic*)(from))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(from))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(from))->as.heap.len);
...
{
    VALUE s =  ({ (__builtin_constant_p(ptr) && __builtin_constant_p(len)) ? rb_str_new_static((ptr), (len)) : rb_str_new((ptr), (len)); });

    ( (((!(((VALUE)(s) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(s) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(s))->flags & RUBY_T_MASK) != RUBY_T_NODE) && (int)(((struct RBasic*)(s))->flags & RUBY_T_MASK) != RUBY_T_BIGNUM && (int)(((struct RBasic*)(s))->flags & RUBY_T_MASK) != RUBY_T_FLOAT) && (!(((VALUE)(str) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(str) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(str))->flags & RUBY_T_MASK) != RUBY_T_NODE)) ? (void)(((struct RBasic*)(s))->flags |= ((((struct RBasic*)(str))->flags&(RUBY_FL_TAINT)))) : (void)0);
    return s;
}
...
pack_unpack_internal(VALUE str, VALUE fmt, int mode)
{
    ...
    ary = mode == 0 ? rb_ary_new() : ((VALUE)RUBY_Qnil);
    while (p < pend) {
 int explicit_endian = 0;
 type = *p++;
 ...
 switch (type) {
  ...
  do { VALUE item_val = (infected_str_new(s, len, str)); if ((mode) == 1) { rb_yield(item_val); } else if ((mode) == 0) { rb_ary_push(ary, item_val); } else { return item_val; } } while (0);
  s += end;
     }
     break;
  ...
  if (len > send-s) len = send-s;
  while (t < s+len && *t) t++;
  do { VALUE item_val = (infected_str_new(s, t-s, str)); if ((mode) == 1) { rb_yield(item_val); } else if ((mode) == 0) { rb_ary_push(ary, item_val); } else { return item_val; } } while (0);
  if (t < send) t++;
  s = star ? t : s+len;
     }
     break;
  ...
  if (p[-1] == '*' || len > (send - s) * 8)
      len = (send - s) * 8;
  bits = 0;
  bitstr =  ({ (__builtin_constant_p(0) && __builtin_constant_p(len)) ? rb_usascii_str_new_static((0), (len)) : rb_usascii_str_new((0), (len)); });
  t = (!(((struct RBasic*)(bitstr))->flags & RSTRING_NOEMBED) ? ((struct RString*)(bitstr))->as.ary : ((struct RString*)(bitstr))->as.heap.ptr);
  for (i=0; i<len; i++) {
      if (i & 7) bits >>= 1;
      else bits = (unsigned char)*s++;
      *t++ = (bits & 1) ? '1' : '0';
  }
  do { VALUE item_val = (bitstr); if ((mode) == 1) { rb_yield(item_val); } else if ((mode) == 0) { rb_ary_push(ary, item_val); } else { return item_val; } } while (0);
     }
     break;
  ...
  bigendian_p = explicit_endian == '>';
            ...
            do { tmp_len = 0; if (len > (long)((send-s)/(integer_size))) { if (!star) { tmp_len = len-(send-s)/(integer_size); } len = (send-s)/(integer_size); } } while (0);
            while (len-- > 0) {
                int flags = bigendian_p ? (0x01 | 0x10) : (0x02 | 0x20);
                VALUE val;
                if (signed_p)
                    flags |= 0x80;
                val = rb_integer_unpack(s, integer_size, 1, 0, flags);
                do { VALUE item_val = (val); if ((mode) == 1) { rb_yield(item_val); } else if ((mode) == 0) { rb_ary_push(ary, item_val); } else { return item_val; } } while (0);
                s += integer_size;
            }
            do { if (tmp_len > 0 && mode == 0) rb_ary_store(ary, rb_array_len(ary)+tmp_len-1, ((VALUE)RUBY_Qnil)); } while (0);
            break;

   case 'f':
   case 'F':
     do { tmp_len = 0; if (len > (long)((send-s)/(sizeof(float)))) { if (!star) { tmp_len = len-(send-s)/(sizeof(float)); } len = (send-s)/(sizeof(float)); } } while (0);
     while (len-- > 0) {
  float tmp;
  memcpy(&tmp, s, sizeof(float));
  s += sizeof(float);
  do { VALUE item_val = (rb_float_new_inline((double)tmp)); if ((mode) == 1) { rb_yield(item_val); } else if ((mode) == 0) { rb_ary_push(ary, item_val); } else { return item_val; } } while (0);
     }
     do { if (tmp_len > 0 && mode == 0) rb_ary_store(ary, rb_array_len(ary)+tmp_len-1, ((VALUE)RUBY_Qnil)); } while (0);
     break;
  ...
  s += sizeof(float);
  ((tmp).u = (0?__builtin_bswap32((tmp).u):((tmp).u)));
  do { VALUE item_val = (rb_float_new_inline(tmp.f)); if ((mode) == 1) { rb_yield(item_val); } else if ((mode) == 0) { rb_ary_push(ary, item_val); } else { return item_val; } } while (0);
     }
     do { if (tmp_len > 0 && mode == 0) rb_ary_store(ary, rb_array_len(ary)+tmp_len-1, ((VALUE)RUBY_Qnil)); } while (0);
     break;

   case 'E':
     do { tmp_len = 0; if (len > (long)((send-s)/(sizeof(double)))) { if (!star) { tmp_len = len-(send-s)/(sizeof(double)); } len = (send-s)/(sizeof(double)); } } while (0);
     while (len-- > 0) {
  DOUBLE_SWAPPER tmp;;
  memcpy(tmp.buf, s, sizeof(double));
  s += sizeof(double);
  ((tmp).u = (0?__builtin_bswap64((tmp).u):((tmp).u)));
  do { VALUE item_val = (rb_float_new_inline(tmp.d)); if ((mode) == 1) { rb_yield(item_val); } else if ((mode) == 0) { rb_ary_push(ary, item_val); } else { return item_val; } } while (0);
     }
     do { if (tmp_len > 0 && mode == 0) rb_ary_store(ary, rb_array_len(ary)+tmp_len-1, ((VALUE)RUBY_Qnil)); } while (0);
     break;
  ...
  s += sizeof(double);
  do { VALUE item_val = (rb_float_new_inline(tmp)); if ((mode) == 1) { rb_yield(item_val); } else if ((mode) == 0) { rb_ary_push(ary, item_val); } else { return item_val; } } while (0);
     }
     do { if (tmp_len > 0 && mode == 0) rb_ary_store(ary, rb_array_len(ary)+tmp_len-1, ((VALUE)RUBY_Qnil)); } while (0);
     break;
  ...
  l = utf8_to_uv(s, &alen);
  s += alen; len--;
  do { VALUE item_val = (rb_ulong2num_inline(l)); if ((mode) == 1) { rb_yield(item_val); } else if ((mode) == 0) { rb_ary_push(ary, item_val); } else { return item_val; } } while (0);
     }
     break;
  ...
  char *ptr = (!(((struct RBasic*)(buf))->flags & RSTRING_NOEMBED) ? ((struct RString*)(buf))->as.ary : ((struct RString*)(buf))->as.heap.ptr);
  long total = 0;
  ...
  while (s < send && (unsigned char)*s > ' ' && (unsigned char)*s < 'a') {
      ...
      total += len;
      if (total > (!(((struct RBasic*)(buf))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(buf))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(buf))->as.heap.len)) {
   len -= total - (!(((struct RBasic*)(buf))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(buf))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(buf))->as.heap.len);
   total = (!(((struct RBasic*)(buf))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(buf))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(buf))->as.heap.len);
      }
  ...
  do { VALUE item_val = (buf); if ((mode) == 1) { rb_yield(item_val); } else if ((mode) == 0) { rb_ary_push(ary, item_val); } else { return item_val; } } while (0);
     }
     break;

   case 'm':
     {
  VALUE buf = infected_str_new(0, (send - s + 3)*3/4, str);
  char *ptr = (!(((struct RBasic*)(buf))->flags & RSTRING_NOEMBED) ? ((struct RString*)(buf))->as.ary : ((struct RString*)(buf))->as.heap.ptr);
  int a = -1,b = -1,c = 0,d = 0;
   ...
   *ptr++ = (char)((a << 2 | b >> 4) & 0xff);
   *ptr++ = (char)((b << 4 | c >> 2) & 0xff);
   *ptr++ = (char)((c << 6 | d) & 0xff);
      }
      if (c == -1) {
   *ptr++ = (char)((a << 2 | b >> 4) & 0xff);
  ...
  rb_str_set_len(buf, ptr - (!(((struct RBasic*)(buf))->flags & RSTRING_NOEMBED) ? ((struct RString*)(buf))->as.ary : ((struct RString*)(buf))->as.heap.ptr));
  do { VALUE item_val = (buf); if ((mode) == 1) { rb_yield(item_val); } else if ((mode) == 0) { rb_ary_push(ary, item_val); } else { return item_val; } } while (0);
     }
     break;
  ...
  char *ptr = (!(((struct RBasic*)(buf))->flags & RSTRING_NOEMBED) ? ((struct RString*)(buf))->as.ary : ((struct RString*)(buf))->as.heap.ptr), *ss = s;
  int csum = 0;
  int c1, c2;
  ...
  rb_str_set_len(buf, ptr - (!(((struct RBasic*)(buf))->flags & RSTRING_NOEMBED) ? ((struct RString*)(buf))->as.ary : ((struct RString*)(buf))->as.heap.ptr));
  rb_str_cat(buf, ss, send-ss);
  csum = rb_isascii(csum) ? RUBY_ENC_CODERANGE_7BIT : RUBY_ENC_CODERANGE_VALID;
  do { VALUE rb_encoding_coderange_obj = (buf); rb_enc_set_index((rb_encoding_coderange_obj), ((rb_ascii8bit_encindex()))); ( ((struct RBasic*)(rb_encoding_coderange_obj))->flags = (((struct RBasic*)(rb_encoding_coderange_obj))->flags & ~RUBY_ENC_CODERANGE_MASK) | ((csum))); } while (0);
  do { VALUE item_val = (buf); if ((mode) == 1) { rb_yield(item_val); } else if ((mode) == 0) { rb_ary_push(ary, item_val); } else { return item_val; } } while (0);
     }
     break;

   case '@':
     if (len > (!(((struct RBasic*)(str))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(str))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(str))->as.heap.len))
  rb_raise(rb_eArgError, "@ outside of string");
     s = (!(((struct RBasic*)(str))->flags & RSTRING_NOEMBED) ? ((struct RString*)(str))->as.ary : ((struct RString*)(str))->as.heap.ptr) + len;
     break;

   case 'X':
     if (len > s - (!(((struct RBasic*)(str))->flags & RSTRING_NOEMBED) ? ((struct RString*)(str))->as.ary : ((struct RString*)(str))->as.heap.ptr))
  rb_raise(rb_eArgError, "X outside of string");
     s -= len;
     break;
  ...
  if (t) {
   ...
   rb_raise(rb_eArgError, "no associated pointer");
      ...
      p = rb_array_const_ptr(a);
      pend = p + rb_array_len(a);
      while (p < pend) {
   if (( ((RUBY_T_STRING) == RUBY_T_FIXNUM) ? (((int)(long)(*p))&RUBY_FIXNUM_FLAG) : ((RUBY_T_STRING) == RUBY_T_TRUE) ? ((*p) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_STRING) == RUBY_T_FALSE) ? ((*p) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_STRING) == RUBY_T_NIL) ? ((*p) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_STRING) == RUBY_T_UNDEF) ? ((*p) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_STRING) == RUBY_T_SYMBOL) ? ((((VALUE)(*p)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(*p) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(*p) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(*p))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_STRING) == RUBY_T_FLOAT) ? ( ((((int)(long)(*p))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(*p) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(*p) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(*p))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(*p) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(*p) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(*p))->flags & RUBY_T_MASK) == (RUBY_T_STRING))) && (!(((struct RBasic*)(*p))->flags & RSTRING_NOEMBED) ? ((struct RString*)(*p))->as.ary : ((struct RString*)(*p))->as.heap.ptr) == t) {
       if (len < (!(((struct RBasic*)(*p))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(*p))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(*p))->as.heap.len)) {
  ...
  do { VALUE item_val = (tmp); if ((mode) == 1) { rb_yield(item_val); } else if ((mode) == 0) { rb_ary_push(ary, item_val); } else { return item_val; } } while (0);
     }
     break;
   ...
   case 'w':
     {
                ...
                while (len > 0 && s < send) {
                    if (*s & 0x80) {
                        ...
                        s++;
                        do { VALUE item_val = (rb_integer_unpack(s0, s-s0, 1, 1, (0x01 | 0x10))); if ((mode) == 1) { rb_yield(item_val); } else if ((mode) == 0) { rb_ary_push(ary, item_val); } else { return item_val; } } while (0);
                        len--;
                        s0 = s;
                    }
                }
  ...
  type, (!(((struct RBasic*)(fmt))->flags & RSTRING_NOEMBED) ? ((struct RString*)(fmt))->as.ary : ((struct RString*)(fmt))->as.heap.ptr));
     break;
 }
    }
...
rb_uv_to_utf8(char buf[6], unsigned long uv)
{
 ...
 return 1;
    ...
    if (uv <= 0x7ff) {
 buf[0] = (char)((((uv>>6)&0xff)|0xc0) & 0xff);
 buf[1] = (char)(((uv&0x3f)|0x80) & 0xff);
 return 2;
    }
    if (uv <= 0xffff) {
 buf[0] = (char)((((uv>>12)&0xff)|0xe0) & 0xff);
 buf[1] = (char)((((uv>>6)&0x3f)|0x80) & 0xff);
 buf[2] = (char)(((uv&0x3f)|0x80) & 0xff);
 return 3;
    }
    if (uv <= 0x1fffff) {
 buf[0] = (char)((((uv>>18)&0xff)|0xf0) & 0xff);
 buf[1] = (char)((((uv>>12)&0x3f)|0x80) & 0xff);
 buf[2] = (char)((((uv>>6)&0x3f)|0x80) & 0xff);
 buf[3] = (char)(((uv&0x3f)|0x80) & 0xff);
 return 4;
    }
    if (uv <= 0x3ffffff) {
 buf[0] = (char)((((uv>>24)&0xff)|0xf8) & 0xff);
 buf[1] = (char)((((uv>>18)&0x3f)|0x80) & 0xff);
 buf[2] = (char)((((uv>>12)&0x3f)|0x80) & 0xff);
 buf[3] = (char)((((uv>>6)&0x3f)|0x80) & 0xff);
 buf[4] = (char)(((uv&0x3f)|0x80) & 0xff);
 return 5;
    }
    if (uv <= 0x7fffffff) {
 buf[0] = (char)((((uv>>30)&0xff)|0xfc) & 0xff);
 buf[1] = (char)((((uv>>24)&0x3f)|0x80) & 0xff);
 buf[2] = (char)((((uv>>18)&0x3f)|0x80) & 0xff);
 buf[3] = (char)((((uv>>12)&0x3f)|0x80) & 0xff);
 buf[4] = (char)((((uv>>6)&0x3f)|0x80) & 0xff);
 buf[5] = (char)(((uv&0x3f)|0x80) & 0xff);
 return 6;
    }
    rb_raise(rb_eRangeError, "pack(U): value out of range");
