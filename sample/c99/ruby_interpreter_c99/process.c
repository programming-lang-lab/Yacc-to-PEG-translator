...
extern int putgrent (const struct group *restrict __p,
       FILE *restrict __f);
...
extern int getgrent_r (struct group *restrict __resultbuf,
         char *restrict __buffer, size_t __buflen,
         struct group **restrict __result);
...
extern int getgrgid_r (__gid_t __gid, struct group *restrict __resultbuf,
         char *restrict __buffer, size_t __buflen,
         struct group **restrict __result);
...
extern int getgrnam_r (const char *restrict __name,
         struct group *restrict __resultbuf,
         char *restrict __buffer, size_t __buflen,
         struct group **restrict __result);
extern int fgetgrent_r (FILE *restrict __stream,
   struct group *restrict __resultbuf,
   char *restrict __buffer, size_t __buflen,
   struct group **restrict __result);
...
static uid_t obj2uid(VALUE id, VALUE *getpw_buf);
static inline uid_t
obj2uid0(VALUE id)
{
    uid_t uid;
    VALUE getpw_buf = 0;
    uid = obj2uid((id), &getpw_buf);
    (getpw_buf ? (void)rb_str_resize(getpw_buf, 0) : (void)0);
    return uid;
}
static gid_t obj2gid(VALUE id, VALUE *getgr_buf);
static inline gid_t
obj2gid0(VALUE id)
{
    gid_t gid;
    VALUE getgr_buf = 0;
    gid = obj2gid((id), &getgr_buf);
...
close_unless_reserved(int fd)
{
    ...
    if (rb_reserved_fd_p(fd)) {
        rb_async_bug_errno("BUG timer thread still running", 0 );
        return 0;
    }
    return close(fd);
}
...
get_pid(void)
{
    return (((VALUE)((int)(getpid())))<<1 | RUBY_FIXNUM_FLAG);
}
static VALUE
get_ppid(void)
{
    return (((VALUE)((int)(getppid())))<<1 | RUBY_FIXNUM_FLAG);
}
...
{
    return rb_current_thread()->last_status;
}
static VALUE
...
void
rb_last_status_set(int status, pid_t pid)
{
    rb_thread_t *th = rb_current_thread();
    th->last_status = rb_obj_alloc(rb_cProcessStatus);
    rb_ivar_set(th->last_status, ruby_static_id_status, (((VALUE)(status))<<1 | RUBY_FIXNUM_FLAG));
    rb_ivar_set(th->last_status, id_pid, (((VALUE)((int)(pid)))<<1 | RUBY_FIXNUM_FLAG));
}

void
rb_last_status_clear(void)
{
    rb_current_thread()->last_status = ((VALUE)RUBY_Qnil);
}
static VALUE
pst_to_i(VALUE st)
{
    return rb_ivar_get(st, ruby_static_id_status);
}
static VALUE
pst_pid(VALUE st)
{
...
static void
pst_message(VALUE str, pid_t pid, int status)
{
    rb_str_catf(str, "pid %ld", (long)pid);
    if ((((status) & 0xff) == 0x7f)) {
 int stopsig = (((status) & 0xff00) >> 8);
 ...
 if (signame) {
    ...
    if ((((status) & 0x7f) == 0)) {
 rb_str_catf(str, " exit %d", (((status) & 0xff00) >> 8));
    }

    if (((status) & 0x80)) {
  ({ (__builtin_constant_p(" (core dumped)")) ? rb_str_cat((str), (" (core dumped)"), (long)strlen(" (core dumped)")) : rb_str_cat_cstr((str), (" (core dumped)")); });
    }
...
pst_to_s(VALUE st)
{
    ...
    pid = rb_num2int_inline(pst_pid(st));
    status = rb_num2int_inline(pst_to_i(st));
...
pst_inspect(VALUE st)
{
    ...
    vpid = pst_pid(st);
    if (!((VALUE)(vpid) != ((VALUE)RUBY_Qnil))) {
        return rb_sprintf("#<%s: uninitialized>", rb_class2name(rb_class_of((VALUE)(st))));
    }
    pid = rb_num2int_inline(vpid);
    status = rb_num2int_inline(pst_to_i(st));

    str = rb_sprintf("#<%s: ", rb_class2name(rb_class_of((VALUE)(st))));
    pst_message(str, pid, status);
...
{
    if (st1 == st2) return ((VALUE)RUBY_Qtrue);
    return rb_equal(pst_to_i(st1), st2);
}
static VALUE
pst_bitand(VALUE st1, VALUE st2)
{
    int status = rb_num2int_inline(pst_to_i(st1)) & rb_num2int_inline(st2);

    return (((VALUE)((int)(status)))<<1 | RUBY_FIXNUM_FLAG);
}
static VALUE
...
{
    int status = rb_num2int_inline(pst_to_i(st));
...
pst_wstopsig(VALUE st)
{
    ...
    if ((((status) & 0xff) == 0x7f))
 return (((VALUE)((int)((((status) & 0xff00) >> 8))))<<1 | RUBY_FIXNUM_FLAG);
...
pst_wtermsig(VALUE st)
{
    ...
    if ((((signed char) (((status) & 0x7f) + 1) >> 1) > 0))
 return (((VALUE)((int)(((status) & 0x7f))))<<1 | RUBY_FIXNUM_FLAG);
    return ((VALUE)RUBY_Qnil);
}
static VALUE
...
pst_success_p(VALUE st)
{
    ...
    if (!(((status) & 0x7f) == 0))
 return ((VALUE)RUBY_Qnil);
    return (((status) & 0xff00) >> 8) == 0 ? ((VALUE)RUBY_Qtrue) : ((VALUE)RUBY_Qfalse);
}
static VALUE
...
static pid_t
do_waitpid(pid_t pid, int *st, int flags)
{
...
rb_waitpid_blocking(void *data)
{
    ...
    pid_t result = do_waitpid(arg->pid, arg->st, arg->flags);
    return (void *)(VALUE)result;
}

static pid_t
do_waitpid_nonblocking(pid_t pid, int *st, int flags)
{
    void *result;
    ...
    return (pid_t)(VALUE)result;
}

pid_t
rb_waitpid(pid_t pid, int *st, int flags)
{
    pid_t result;
...
proc_wait(int argc, VALUE *argv)
{
 ...
 VALUE vflags;
 pid = rb_num2int_inline(argv[0]);
 if (argc == 2 && !!((VALUE)(vflags = argv[1]) != ((VALUE)RUBY_Qnil))) {
     flags = ((unsigned int)rb_num2uint(vflags));
 }
    }
 ...
 return ((VALUE)RUBY_Qnil);
    ...
    return (((VALUE)((int)(pid)))<<1 | RUBY_FIXNUM_FLAG);
}
static VALUE
proc_wait2(int argc, VALUE *argv)
{
    VALUE pid = proc_wait(argc, argv);
    if (!((VALUE)(pid) != ((VALUE)RUBY_Qnil))) return ((VALUE)RUBY_Qnil);
...
proc_waitall(void)
{
 ...
 rb_ary_push(result, rb_assoc_new((((VALUE)((int)(pid)))<<1 | RUBY_FIXNUM_FLAG), rb_last_status_get()));
    }
    return result;
}
...
{
    pid_t cpid, pid = (pid_t)(VALUE)arg;
    int status;
...
VALUE
rb_detach_process(pid_t pid)
{
    VALUE watcher = rb_thread_create(detach_process_watcher, (void*)(VALUE)pid);
    rb_thread_local_aset(watcher, id_pid, (((VALUE)((int)(pid)))<<1 | RUBY_FIXNUM_FLAG));
    do { VALUE _obj_ = (watcher); rb_obj_write((VALUE)(_obj_), (VALUE *)(&((struct RBasicRaw *)(_obj_))->klass), (VALUE)(rb_cWaiter), "process.c", 1112); } while (0);
    return watcher;
}
static VALUE
proc_detach(VALUE obj, VALUE pid)
{
    return rb_detach_process(rb_num2int_inline(pid));
}
...
proc_exec_cmd(const char *prog, VALUE argv_str, VALUE envp_str)
{
    ...
    argv = ((char **)(!(((struct RBasic*)(argv_str))->flags & RSTRING_NOEMBED) ? ((struct RString*)(argv_str))->as.ary : ((struct RString*)(argv_str))->as.heap.ptr) + 1);
 ...
 return 2;
    ...
    envp = envp_str ? (char **)(!(((struct RBasic*)(envp_str))->flags & RSTRING_NOEMBED) ? ((struct RString*)(envp_str))->as.ary : ((struct RString*)(envp_str))->as.heap.ptr) : ((void*)0);
    if (envp_str)
        execve(prog, argv, envp);
    else
        execv(prog, argv);
    err = (*__errno_location ());
    ((err == 8) ? exec_with_sh((prog), (argv), (envp)) : (void)0);
    return err;
...
proc_exec_sh(const char *str, VALUE envp_str)
{
 ...
 s++;
    ...
    if (envp_str)
        execle("/bin/sh", "sh", "-c", str, (char *)((void*)0), (char **)(!(((struct RBasic*)(envp_str))->flags & RSTRING_NOEMBED) ? ((struct RString*)(envp_str))->as.ary : ((struct RString*)(envp_str))->as.heap.ptr));
    else
        execl("/bin/sh", "sh", "-c", str, (char *)((void*)0));
...
rb_proc_exec(const char *str)
{
    int ret;
    before_exec();
    ret = proc_exec_sh(str, ((VALUE)RUBY_Qfalse));
    after_exec();
...
static const rb_data_type_t exec_arg_data_type = {
    "exec_arg",
    {mark_exec_arg, ((RUBY_DATA_FUNC)-1), memsize_exec_arg},
    0, 0, 1
};
static VALUE
hide_obj(VALUE obj)
...
check_exec_redirect_fd(VALUE v, int iskey)
{
    ...
    else if (!!((VALUE)(tmp = rb_check_convert_type_with_id(v, RUBY_T_FILE, "IO", idTo_io)) != ((VALUE)RUBY_Qnil))) {
        rb_io_t *fptr;
        rb_io_check_closed((fptr) = ((struct RFile*)(rb_io_taint_check(tmp)))->fptr);
...
{
    if (ary == ((VALUE)RUBY_Qfalse)) {
        ary = hide_obj(rb_ary_new());
    }
    if (!( ((RUBY_T_ARRAY) == RUBY_T_FIXNUM) ? (((int)(long)(key))&RUBY_FIXNUM_FLAG) : ((RUBY_T_ARRAY) == RUBY_T_TRUE) ? ((key) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_ARRAY) == RUBY_T_FALSE) ? ((key) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_ARRAY) == RUBY_T_NIL) ? ((key) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_ARRAY) == RUBY_T_UNDEF) ? ((key) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_ARRAY) == RUBY_T_SYMBOL) ? ((((VALUE)(key)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(key) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(key) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(key))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_ARRAY) == RUBY_T_FLOAT) ? ( ((((int)(long)(key))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(key) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(key) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(key))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(key) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(key) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(key))->flags & RUBY_T_MASK) == (RUBY_T_ARRAY)))) {
        VALUE fd = check_exec_redirect_fd(key, !!((VALUE)(param) != ((VALUE)RUBY_Qnil)));
        rb_ary_push(ary, hide_obj(rb_assoc_new(fd, param)));
    }
    else {
        int i, n=0;
        for (i = 0 ; i < rb_array_len(key); i++) {
            VALUE v = (rb_array_const_ptr(key)[i]);
            VALUE fd = check_exec_redirect_fd(v, !!((VALUE)(param) != ((VALUE)RUBY_Qnil)));
            rb_ary_push(ary, hide_obj(rb_assoc_new(fd, param)));
            n++;
        }
    }
...
check_exec_redirect(VALUE key, VALUE val, struct rb_execarg *eargp)
{
    ...
    switch (rb_type((VALUE)(val))) {
      case RUBY_T_SYMBOL:
        ...
        if (id == id_close) {
            param = ((VALUE)RUBY_Qnil);
            eargp->fd_close = check_exec_redirect1(eargp->fd_close, key, param);
        }
        else if (id == id_in) {
            param = (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG);
            eargp->fd_dup2 = check_exec_redirect1(eargp->fd_dup2, key, param);
        }
        else if (id == id_out) {
            param = (((VALUE)(1))<<1 | RUBY_FIXNUM_FLAG);
            eargp->fd_dup2 = check_exec_redirect1(eargp->fd_dup2, key, param);
        }
        else if (id == id_err) {
            param = (((VALUE)(2))<<1 | RUBY_FIXNUM_FLAG);
            eargp->fd_dup2 = check_exec_redirect1(eargp->fd_dup2, key, param);
        }
        else {
   wrong_symbol:
            rb_raise(rb_eArgError, "wrong exec redirect symbol: %li\v",
                                   val);
        }
        break;
      ...
      case RUBY_T_ARRAY:
        ...
        if (rb_array_len(val) == 2 && ((((VALUE)(path)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(path) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(path) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(path))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) &&
            path == (rb_id2sym(id_child))) {
            ...
            if (!((VALUE)(flags) != ((VALUE)RUBY_Qnil)))
                flags = (((VALUE)((int)(00)))<<1 | RUBY_FIXNUM_FLAG);
            else if (( ((RUBY_T_STRING) == RUBY_T_FIXNUM) ? (((int)(long)(flags))&RUBY_FIXNUM_FLAG) : ((RUBY_T_STRING) == RUBY_T_TRUE) ? ((flags) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_STRING) == RUBY_T_FALSE) ? ((flags) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_STRING) == RUBY_T_NIL) ? ((flags) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_STRING) == RUBY_T_UNDEF) ? ((flags) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_STRING) == RUBY_T_SYMBOL) ? ((((VALUE)(flags)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(flags) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(flags) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(flags))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_STRING) == RUBY_T_FLOAT) ? ( ((((int)(long)(flags))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(flags) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(flags) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(flags))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(flags) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(flags) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(flags))->flags & RUBY_T_MASK) == (RUBY_T_STRING))))
                flags = (((VALUE)((int)(rb_io_modestr_oflags(rb_string_value_cstr(&(flags))))))<<1 | RUBY_FIXNUM_FLAG);
            else
                flags = rb_to_int(flags);
            perm = rb_ary_entry(val, 2);
            perm = !((VALUE)(perm) != ((VALUE)RUBY_Qnil)) ? (((VALUE)(0644))<<1 | RUBY_FIXNUM_FLAG) : rb_to_int(perm);
            param = hide_obj( ({ const VALUE args_to_new_ary[] = {hide_obj(rb_str_dup(path)), flags, perm, ((VALUE)RUBY_Qnil)}; if (__builtin_constant_p(4)) { extern int (*__Static_assert_function (void)) [!!sizeof (struct { int __error_if_negative: (((int)(sizeof(args_to_new_ary) / sizeof((args_to_new_ary)[0]))) == (4)) ? 2 : -1; })]; } rb_ary_new_from_values(((int)(sizeof(args_to_new_ary) / sizeof((args_to_new_ary)[0]))), args_to_new_ary); }));
      ...
      case RUBY_T_STRING:
        path = val;
        ((* ({ volatile VALUE *rb_gc_guarded_ptr = &(path); ; rb_gc_guarded_ptr; })) = rb_get_path(path));
        if (( ((RUBY_T_FILE) == RUBY_T_FIXNUM) ? (((int)(long)(key))&RUBY_FIXNUM_FLAG) : ((RUBY_T_FILE) == RUBY_T_TRUE) ? ((key) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_FILE) == RUBY_T_FALSE) ? ((key) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_FILE) == RUBY_T_NIL) ? ((key) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_FILE) == RUBY_T_UNDEF) ? ((key) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_FILE) == RUBY_T_SYMBOL) ? ((((VALUE)(key)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(key) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(key) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(key))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_FILE) == RUBY_T_FLOAT) ? ( ((((int)(long)(key))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(key) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(key) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(key))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(key) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(key) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(key))->flags & RUBY_T_MASK) == (RUBY_T_FILE))))
            key = check_exec_redirect_fd(key, 1);
        if ((((int)(long)(key))&RUBY_FIXNUM_FLAG) && (((int)rb_fix2int((VALUE)(key))) == 1 || ((int)rb_fix2int((VALUE)(key))) == 2))
            flags = (((VALUE)((int)(01|0100|01000)))<<1 | RUBY_FIXNUM_FLAG);
        else if (( ((RUBY_T_ARRAY) == RUBY_T_FIXNUM) ? (((int)(long)(key))&RUBY_FIXNUM_FLAG) : ((RUBY_T_ARRAY) == RUBY_T_TRUE) ? ((key) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_ARRAY) == RUBY_T_FALSE) ? ((key) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_ARRAY) == RUBY_T_NIL) ? ((key) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_ARRAY) == RUBY_T_UNDEF) ? ((key) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_ARRAY) == RUBY_T_SYMBOL) ? ((((VALUE)(key)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(key) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(key) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(key))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_ARRAY) == RUBY_T_FLOAT) ? ( ((((int)(long)(key))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(key) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(key) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(key))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(key) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(key) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(key))->flags & RUBY_T_MASK) == (RUBY_T_ARRAY)))) {
     int i;
     for (i = 0; i < rb_array_len(key); i++) {
  VALUE v = ((VALUE *)rb_array_const_ptr(( __builtin_choose_expr( 1, rb_obj_wb_unprotect((VALUE)(key), "process.c", 1610), ((VALUE)(key))))))[i];
  VALUE fd = check_exec_redirect_fd(v, 1);
  if (((int)rb_fix2int((VALUE)(fd))) != 1 && ((int)rb_fix2int((VALUE)(fd))) != 2) break;
     }
     if (i == rb_array_len(key))
  flags = (((VALUE)((int)(01|0100|01000)))<<1 | RUBY_FIXNUM_FLAG);
     else
  flags = (((VALUE)((int)(00)))<<1 | RUBY_FIXNUM_FLAG);
 }
            ...
            flags = (((VALUE)((int)(00)))<<1 | RUBY_FIXNUM_FLAG);
        perm = (((VALUE)(0644))<<1 | RUBY_FIXNUM_FLAG);
        param = hide_obj( ({ const VALUE args_to_new_ary[] = {hide_obj(rb_str_dup(path)), flags, perm, ((VALUE)RUBY_Qnil)}; if (__builtin_constant_p(4)) { extern int (*__Static_assert_function (void)) [!!sizeof (struct { int __error_if_negative: (((int)(sizeof(args_to_new_ary) / sizeof((args_to_new_ary)[0]))) == (4)) ? 2 : -1; })]; } rb_ary_new_from_values(((int)(sizeof(args_to_new_ary) / sizeof((args_to_new_ary)[0]))), args_to_new_ary); }));
 ...
 if (!!((VALUE)(val) != ((VALUE)RUBY_Qnil))) goto io;
      ...
      case RUBY_T_SYMBOL:

        {
            ...
            if (rtype != -1) {
                ...
                (* ({ volatile VALUE *rb_gc_guarded_ptr = &(execarg_obj); ; rb_gc_guarded_ptr; }));
                return ST_CONTINUE;
            }
        }
        ...
        if (id == id_pgroup) {
            ...
            if (!!(((VALUE)(val) & (VALUE)~((VALUE)RUBY_Qnil)) == 0))
                pgroup = -1;
            else if (val == ((VALUE)RUBY_Qtrue))
                pgroup = 0;
            else {
                pgroup = rb_num2int_inline(val);
                if (pgroup < 0) {
        ...
        if (id == id_unsetenv_others) {
            ...
            eargp->unsetenv_others_do = !(((VALUE)(val) & (VALUE)~((VALUE)RUBY_Qnil)) == 0) ? 1 : 0;
        }
        else if (id == id_chdir) {
            if (eargp->chdir_given) {
                rb_raise(rb_eArgError, "chdir option specified twice");
            }
            ((* ({ volatile VALUE *rb_gc_guarded_ptr = &(val); ; rb_gc_guarded_ptr; })) = rb_get_path(val));
     val = rb_str_encode_ospath(val);
            eargp->chdir_given = 1;
            eargp->chdir_dir = hide_obj(rb_str_dup(val));
        }
        else if (id == id_umask) {
     mode_t cmask = ((unsigned int)rb_num2uint(val));
            ...
            eargp->close_others_do = !(((VALUE)(val) & (VALUE)~((VALUE)RUBY_Qnil)) == 0) ? 1 : 0;
        }
        else if (id == id_in) {
            key = (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG);
            goto redirect;
        }
        else if (id == id_out) {
            key = (((VALUE)(1))<<1 | RUBY_FIXNUM_FLAG);
            goto redirect;
        }
        else if (id == id_err) {
            key = (((VALUE)(2))<<1 | RUBY_FIXNUM_FLAG);
            goto redirect;
        }
 else if (id == id_uid) {
...
check_exec_options_i(st_data_t st_key, st_data_t st_val, st_data_t arg)
{
 ...
 if (((((VALUE)(key)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(key) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(key) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(key))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))))
     rb_raise(rb_eArgError, "wrong exec option symbol: % li\v",
       key);
...
check_exec_options_i_extract(st_data_t st_key, st_data_t st_val, st_data_t arg)
{
 ...
 if (!((VALUE)(nonopts) != ((VALUE)RUBY_Qnil))) args[1] = nonopts = rb_hash_new();
...
check_exec_fds_1(struct rb_execarg *eargp, VALUE h, int maxhint, VALUE ary)
{
    ...
    if (ary != ((VALUE)RUBY_Qfalse)) {
        for (i = 0; i < rb_array_len(ary); i++) {
            VALUE elt = (rb_array_const_ptr(ary)[i]);
            int fd = ((int)rb_fix2int((VALUE)((rb_array_const_ptr(elt)[0]))));
            if (!(((VALUE)(rb_hash_lookup(h, (((VALUE)(fd))<<1 | RUBY_FIXNUM_FLAG))) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) {
                rb_raise(rb_eArgError, "fd %d specified twice", fd);
            }
            if (ary == eargp->fd_dup2)
                rb_hash_aset(h, (((VALUE)(fd))<<1 | RUBY_FIXNUM_FLAG), ((VALUE)RUBY_Qtrue));
            else if (ary == eargp->fd_dup2_child)
                rb_hash_aset(h, (((VALUE)(fd))<<1 | RUBY_FIXNUM_FLAG), (rb_array_const_ptr(elt)[1]));
            else
                rb_hash_aset(h, (((VALUE)(fd))<<1 | RUBY_FIXNUM_FLAG), (((VALUE)(-1))<<1 | RUBY_FIXNUM_FLAG));
            if (maxhint < fd)
                maxhint = fd;
            if (ary == eargp->fd_dup2 || ary == eargp->fd_dup2_child) {
                fd = ((int)rb_fix2int((VALUE)((rb_array_const_ptr(elt)[1]))));
                if (maxhint < fd)
                    maxhint = fd;
            }
        }
...
check_exec_fds(struct rb_execarg *eargp)
{
    ...
    if (eargp->fd_dup2_child) {
        ...
        for (i = 0; i < rb_array_len(ary); i++) {
            VALUE elt = (rb_array_const_ptr(ary)[i]);
            int newfd = ((int)rb_fix2int((VALUE)((rb_array_const_ptr(elt)[0]))));
            int oldfd = ((int)rb_fix2int((VALUE)((rb_array_const_ptr(elt)[1]))));
            int lastfd = oldfd;
            VALUE val = rb_hash_lookup(h, (((VALUE)(lastfd))<<1 | RUBY_FIXNUM_FLAG));
            long depth = 0;
            while ((((int)(long)(val))&RUBY_FIXNUM_FLAG) && 0 <= ((int)rb_fix2int((VALUE)(val)))) {
                lastfd = ((int)rb_fix2int((VALUE)(val)));
                val = rb_hash_lookup(h, val);
                if (rb_array_len(ary) < depth)
                    rb_raise(rb_eArgError, "cyclic child fd redirection from %d", oldfd);
                depth++;
            }
            if (val != ((VALUE)RUBY_Qtrue))
                rb_raise(rb_eArgError, "child fd %d is not redirected", oldfd);
            if (oldfd != lastfd) {
                VALUE val2;
                rb_ary_store(elt, 1, (((VALUE)(lastfd))<<1 | RUBY_FIXNUM_FLAG));
                rb_hash_aset(h, (((VALUE)(newfd))<<1 | RUBY_FIXNUM_FLAG), (((VALUE)(lastfd))<<1 | RUBY_FIXNUM_FLAG));
                val = (((VALUE)(oldfd))<<1 | RUBY_FIXNUM_FLAG);
                while ((((int)(long)(val2 = rb_hash_lookup(h, val)))&RUBY_FIXNUM_FLAG)) {
                    rb_hash_aset(h, val, (((VALUE)(lastfd))<<1 | RUBY_FIXNUM_FLAG));
                    val = val2;
                }
            }
        }
...
{
    if (((((struct RHash*)(opthash))->ntbl ? ((struct RHash*)(opthash))->ntbl->num_entries : (st_index_t)0) == 0))
        return;
...
check_exec_env_i(st_data_t st_key, st_data_t st_val, st_data_t arg)
{
    ...
    key = (key);
    if (!!((VALUE)(val) != ((VALUE)RUBY_Qnil))) val = (val);
...
rb_check_argv(int argc, VALUE *argv)
{
    ...
    if (!!((VALUE)(tmp) != ((VALUE)RUBY_Qnil))) {
 if (rb_array_len(tmp) != 2) {
     rb_raise(rb_eArgError, "wrong first argument");
 }
 prog = (rb_array_const_ptr(tmp)[0]);
 argv[0] = (rb_array_const_ptr(tmp)[1]);
 do { rb_string_value(&(prog)); rb_check_safe_obj(prog);} while (0);
 rb_string_value_cstr(&(prog));
 prog = rb_str_new_frozen(prog);
 name = (!(((struct RBasic*)(prog))->flags & RSTRING_NOEMBED) ? ((struct RString*)(prog))->as.ary : ((struct RString*)(prog))->as.heap.ptr);
    }
    for (i = 0; i < argc; i++) {
 do { rb_string_value(&(argv[i])); rb_check_safe_obj(argv[i]);} while (0);
 argv[i] = rb_str_new_frozen(argv[i]);
 rb_string_value_cstr(&(argv[i]));
    }
    security(name ? name : (!(((struct RBasic*)(argv[0]))->flags & RSTRING_NOEMBED) ? ((struct RString*)(argv[0]))->as.ary : ((struct RString*)(argv[0]))->as.heap.ptr));
    return prog;
}
...
{
    if ((((VALUE)(obj) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(obj) & (VALUE)~((VALUE)RUBY_Qnil)) == 0))) return ((VALUE)RUBY_Qnil);
...
rb_exec_fillarg(VALUE prog, int argc, VALUE *argv, VALUE env, VALUE opthash, VALUE execarg_obj)
{
    ...
    memset((eargp), 0, sizeof(struct rb_execarg)*(size_t)(1));
 ...
 struct string_part first = {0, 0};
        int has_meta = 0;
        for (p = (!(((struct RBasic*)(prog))->flags & RSTRING_NOEMBED) ? ((struct RString*)(prog))->as.ary : ((struct RString*)(prog))->as.heap.ptr); *p; p++) {
     if (*p == ' ' || *p == '\t') {
 ...
 if (!has_meta && first.ptr) {
  ...
  bsearch(&first, posix_sh_cmds, ((int)(sizeof(posix_sh_cmds) / sizeof((posix_sh_cmds)[0]))), sizeof(posix_sh_cmds[0]), compare_posix_sh))
  has_meta = 1;
 }
 if (!has_meta) {
        ...
        if (!eargp->use_shell) {
            ...
            p = (!(((struct RBasic*)(prog))->flags & RSTRING_NOEMBED) ? ((struct RString*)(prog))->as.ary : ((struct RString*)(prog))->as.heap.ptr);
            while (*p) {
                while (*p == ' ' || *p == '\t')
                    p++;
                if (*p) {
      const char *w = p;
                    while (*p && *p != ' ' && *p != '\t')
                        p++;
                    rb_str_cat(argv_buf, w, p-w);
                    rb_str_cat(argv_buf, "", 1);
                }
            }
            eargp->invoke.cmd.argv_buf = argv_buf;
            eargp->invoke.cmd.command_name = hide_obj( ({ (__builtin_constant_p((!(((struct RBasic*)(argv_buf))->flags & RSTRING_NOEMBED) ? ((struct RString*)(argv_buf))->as.ary : ((struct RString*)(argv_buf))->as.heap.ptr))) ? rb_str_new_static(((!(((struct RBasic*)(argv_buf))->flags & RSTRING_NOEMBED) ? ((struct RString*)(argv_buf))->as.ary : ((struct RString*)(argv_buf))->as.heap.ptr)), (long)strlen((!(((struct RBasic*)(argv_buf))->flags & RSTRING_NOEMBED) ? ((struct RString*)(argv_buf))->as.ary : ((struct RString*)(argv_buf))->as.heap.ptr))) : rb_str_new_cstr((!(((struct RBasic*)(argv_buf))->flags & RSTRING_NOEMBED) ? ((struct RString*)(argv_buf))->as.ary : ((struct RString*)(argv_buf))->as.heap.ptr)); }));
        }
    }
 ...
 if (!(((VALUE)(eargp->path_env) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) path_env = (!(((struct RBasic*)(eargp->path_env))->flags & RSTRING_NOEMBED) ? ((struct RString*)(eargp->path_env))->as.ary : ((struct RString*)(eargp->path_env))->as.heap.ptr);
 abspath = dln_find_exe_r((!(((struct RBasic*)(eargp->invoke.cmd.command_name))->flags & RSTRING_NOEMBED) ? ((struct RString*)(eargp->invoke.cmd.command_name))->as.ary : ((struct RString*)(eargp->invoke.cmd.command_name))->as.heap.ptr),
     path_env, fbuf, sizeof(fbuf));
 if (abspath)
     eargp->invoke.cmd.command_abspath =  ({ (__builtin_constant_p(abspath)) ? rb_str_new_static((abspath), (long)strlen(abspath)) : rb_str_new_cstr(abspath); });
 else
     eargp->invoke.cmd.command_abspath = ((VALUE)RUBY_Qnil);
    }
    ...
    if (!eargp->use_shell && !eargp->invoke.cmd.argv_buf) {
        ...
        for (i = 0; i < argc; i++) {
     VALUE arg = argv[i];
     const char *s = rb_string_value_cstr(&(arg));




     rb_str_cat(argv_buf, s, (!(((struct RBasic*)(arg))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(arg))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(arg))->as.heap.len) + 1);
        }
        eargp->invoke.cmd.argv_buf = argv_buf;
    }

    if (!eargp->use_shell) {
        const char *p, *ep, *null=((void*)0);
        VALUE argv_str;
        argv_str = hide_obj(rb_str_buf_new(sizeof(char*) * (argc + 2)));
        rb_str_cat(argv_str, (char *)&null, sizeof(null));
        p = (!(((struct RBasic*)(eargp->invoke.cmd.argv_buf))->flags & RSTRING_NOEMBED) ? ((struct RString*)(eargp->invoke.cmd.argv_buf))->as.ary : ((struct RString*)(eargp->invoke.cmd.argv_buf))->as.heap.ptr);
        ep = p + (!(((struct RBasic*)(eargp->invoke.cmd.argv_buf))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(eargp->invoke.cmd.argv_buf))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(eargp->invoke.cmd.argv_buf))->as.heap.len);
        while (p < ep) {
            rb_str_cat(argv_str, (char *)&p, sizeof(p));
            p += strlen(p) + 1;
        }
        rb_str_cat(argv_str, (char *)&null, sizeof(null));
...
rb_execarg_new(int argc, const VALUE *argv, int accept_shell)
{
    ...
    execarg_obj = ({ VALUE data_struct_obj = rb_data_typed_object_zalloc(0, sizeof(struct rb_execarg), &exec_arg_data_type); (void)((eargp) = (struct rb_execarg *)(((struct RData*)(data_struct_obj))->data));; data_struct_obj; });
...
{
    struct rb_execarg *eargp;
    ((eargp) = (struct rb_execarg*)rb_check_typeddata((execarg_obj), (&exec_arg_data_type)));
    return eargp;
}
...
rb_execarg_init(int argc, const VALUE *orig_argv, int accept_shell, VALUE execarg_obj)
{
    struct rb_execarg *eargp = rb_execarg_get(execarg_obj);
    VALUE prog, ret;
    VALUE env = ((VALUE)RUBY_Qnil), opthash = ((VALUE)RUBY_Qnil);
    VALUE argv_buf;
    VALUE *argv = ((VALUE*)(((size_t)(argc) < 1024 / sizeof(VALUE)) ? ((* ({ volatile VALUE *rb_gc_guarded_ptr = &(argv_buf); ; rb_gc_guarded_ptr; })) = 0, __builtin_alloca ((size_t)(argc) * sizeof(VALUE))) : rb_alloc_tmp_buffer2(&(argv_buf), (long)(argc), sizeof(VALUE))));
    memcpy((argv), (orig_argv), sizeof(VALUE)*(size_t)(argc));
    prog = rb_exec_getargs(&argc, &argv, accept_shell, &env, &opthash);
    rb_exec_fillarg(prog, argc, argv, env, opthash, execarg_obj);
    rb_free_tmp_buffer(&(argv_buf));
...
{
    struct rb_execarg *eargp = rb_execarg_get(execarg_obj);
    env = !!((VALUE)(env) != ((VALUE)RUBY_Qnil)) ? rb_check_exec_env(env, &eargp->path_env) : ((VALUE)RUBY_Qfalse);
    eargp->env_modification = env;
}
...
fill_envp_buf_i(st_data_t st_key, st_data_t st_val, st_data_t arg)
{
    ...
    VALUE envp_buf = (VALUE)arg;
     ...
     ({ (__builtin_constant_p(rb_string_value_cstr(&(key)))) ? rb_str_cat((envp_buf), (rb_string_value_cstr(&(key))), (long)strlen(rb_string_value_cstr(&(key)))) : rb_str_cat_cstr((envp_buf), (rb_string_value_cstr(&(key)))); });
     ({ (__builtin_constant_p("=")) ? rb_str_cat((envp_buf), ("="), (long)strlen("=")) : rb_str_cat_cstr((envp_buf), ("=")); });
     ({ (__builtin_constant_p(rb_string_value_cstr(&(val)))) ? rb_str_cat((envp_buf), (rb_string_value_cstr(&(val))), (long)strlen(rb_string_value_cstr(&(val)))) : rb_str_cat_cstr((envp_buf), (rb_string_value_cstr(&(val)))); });
    rb_str_cat(envp_buf, "", 1);
...
open_func(void *ptr)
{
    ...
    data->ret = rb_cloexec_open((fname), (data->oflags), (data->perm));
    data->err = (*__errno_location ());
    return ((void*)0);
}
...
rb_execarg_parent_start1(VALUE execarg_obj)
{
    ...
    if (ary != ((VALUE)RUBY_Qfalse)) {
        ...
        for (i = 0; i < rb_array_len(ary); i++) {
            VALUE elt = (rb_array_const_ptr(ary)[i]);
            int fd = ((int)rb_fix2int((VALUE)((rb_array_const_ptr(elt)[0]))));
            VALUE param = (rb_array_const_ptr(elt)[1]);
            VALUE vpath = (rb_array_const_ptr(param)[0]);
            int flags = rb_num2int_inline((rb_array_const_ptr(param)[1]));
            int perm = rb_num2int_inline((rb_array_const_ptr(param)[2]));
            VALUE fd2v = (rb_array_const_ptr(param)[3]);
            int fd2;
            if (!((VALUE)(fd2v) != ((VALUE)RUBY_Qnil))) {
                struct open_struct open_data;
                ((* ({ volatile VALUE *rb_gc_guarded_ptr = &(vpath); ; rb_gc_guarded_ptr; })) = rb_get_path(vpath));
  vpath = rb_str_encode_ospath(vpath);
              again:
                ...
                open_data.ret = -1;
                open_data.err = 4;
                rb_thread_call_without_gvl2(open_func, (void *)&open_data, ((rb_unblock_function_t *)-1), 0);
                if (open_data.ret == -1) {
                    if (open_data.err == 4) {
                ...
                do { const VALUE _ary = (param); VALUE *ptr = (VALUE *)((VALUE *)rb_array_const_ptr(_ary)); rb_obj_write((VALUE)(_ary), (VALUE *)(&ptr[3]), (VALUE)(((((VALUE)(fd2))<<1 | RUBY_FIXNUM_FLAG))), "process.c", 2375); ; } while (0);
                rb_thread_check_ints();
            }
            else {
                fd2 = rb_num2int_inline(fd2v);
            }
            rb_execarg_addopt(execarg_obj, (((VALUE)(fd))<<1 | RUBY_FIXNUM_FLAG), (((VALUE)(fd2))<<1 | RUBY_FIXNUM_FLAG));
        }
    }
    ...
    ary = eargp->fd_dup2;
    if (ary != ((VALUE)RUBY_Qfalse)) {
        size_t len = run_exec_dup2_tmpbuf_size(rb_array_len(ary));
        VALUE tmpbuf = hide_obj( ({ (__builtin_constant_p(0) && __builtin_constant_p(len)) ? rb_str_new_static((0), (len)) : rb_str_new((0), (len)); }));
    ...
    if (0 || unsetenv_others || envopts != ((VALUE)RUBY_Qfalse)) {
        ...
        hide_obj(envtbl);
        if (envopts != ((VALUE)RUBY_Qfalse)) {
     st_table *stenv = rb_hash_tbl_raw(envtbl);
            long i;
            for (i = 0; i < rb_array_len(envopts); i++) {
                VALUE pair = (rb_array_const_ptr(envopts)[i]);
                VALUE key = (rb_array_const_ptr(pair)[0]);
                VALUE val = (rb_array_const_ptr(pair)[1]);
                if (!((VALUE)(val) != ((VALUE)RUBY_Qnil))) {
      st_data_t stkey = (st_data_t)key;
      st_delete(stenv, &stkey, ((void*)0));
                }
                else {
      st_insert(stenv, (st_data_t)key, (st_data_t)val);
      rb_obj_written((VALUE)(envtbl), (VALUE)(((VALUE)RUBY_Qundef)), (VALUE)(key), "process.c", 2421);
      rb_obj_written((VALUE)(envtbl), (VALUE)(((VALUE)RUBY_Qundef)), (VALUE)(val), "process.c", 2422);
                }
            }
        }
        envp_buf = rb_str_buf_new(0);
        hide_obj(envp_buf);
        st_foreach(rb_hash_tbl_raw(envtbl), fill_envp_buf_i, (st_data_t)envp_buf);
        envp_str = rb_str_buf_new(sizeof(char*) * ((((struct RHash*)(envtbl))->ntbl ? ((struct RHash*)(envtbl))->ntbl->num_entries : (st_index_t)0) + 1));
        hide_obj(envp_str);
        p = (!(((struct RBasic*)(envp_buf))->flags & RSTRING_NOEMBED) ? ((struct RString*)(envp_buf))->as.ary : ((struct RString*)(envp_buf))->as.heap.ptr);
        ep = p + (!(((struct RBasic*)(envp_buf))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(envp_buf))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(envp_buf))->as.heap.len);
        while (p < ep) {
            rb_str_cat(envp_str, (char *)&p, sizeof(p));
            p += strlen(p) + 1;
        }
        p = ((void*)0);
        rb_str_cat(envp_str, (char *)&p, sizeof(p));
...
execarg_parent_end(VALUE execarg_obj)
{
    ...
    if (ary != ((VALUE)RUBY_Qfalse)) {
        ...
        for (i = 0; i < rb_array_len(ary); i++) {
            ...
            VALUE fd2v;
            int fd2;
            fd2v = (rb_array_const_ptr(param)[3]);
            if (!!((VALUE)(fd2v) != ((VALUE)RUBY_Qnil))) {
                fd2 = ((int)rb_fix2int((VALUE)(fd2v)));
                close_unless_reserved(fd2);
                do { const VALUE _ary = (param); VALUE *ptr = (VALUE *)((VALUE *)rb_array_const_ptr(_ary)); rb_obj_write((VALUE)(_ary), (VALUE *)(&ptr[3]), (VALUE)((((VALUE)RUBY_Qnil))), "process.c", 2485); ; } while (0);
            }
        }
    }
...
save_redirect_fd(int fd, struct rb_execarg *sargp, char *errmsg, size_t errmsg_buflen)
{
    if (sargp) {
        ...
        int save_fd = rb_cloexec_dup(fd), cloexec;
        if (save_fd == -1) {
            if ((*__errno_location ()) == 9)
                return 0;
            do { if (errmsg && 0 < errmsg_buflen) strlcpy(errmsg, ("dup"), errmsg_buflen); } while (0);
            return -1;
        }
        rb_update_max_fd(save_fd);
        newary = sargp->fd_dup2;
        if (newary == ((VALUE)RUBY_Qfalse)) {
            newary = hide_obj(rb_ary_new());
            sargp->fd_dup2 = newary;
        }
 cloexec = fd_get_cloexec(fd, errmsg, errmsg_buflen);
 redirection = hide_obj(rb_assoc_new((((VALUE)(fd))<<1 | RUBY_FIXNUM_FLAG), (((VALUE)(save_fd))<<1 | RUBY_FIXNUM_FLAG)));
 if (cloexec) rb_ary_push(redirection, ((VALUE)RUBY_Qtrue));
 rb_ary_push(newary, redirection);
        ...
        rb_ary_push(newary, hide_obj(rb_assoc_new((((VALUE)(save_fd))<<1 | RUBY_FIXNUM_FLAG), ((VALUE)RUBY_Qnil))));
    }
...
fd_get_cloexec(int fd, char *errmsg, size_t errmsg_buflen)
{
    ...
    ret = fcntl(fd, 1);
    if (ret == -1) {
        do { if (errmsg && 0 < errmsg_buflen) strlcpy(errmsg, ("fcntl(F_GETFD)"), errmsg_buflen); } while (0);
        return -1;
    }
    if (ret & 1) return 1;
...
fd_set_cloexec(int fd, char *errmsg, size_t errmsg_buflen)
{
    ...
    if (!(ret & 1)) {
        ...
        ret = fcntl(fd, 2, ret);
        if (ret == -1) {
            do { if (errmsg && 0 < errmsg_buflen) strlcpy(errmsg, ("fcntl(F_SETFD)"), errmsg_buflen); } while (0);
            return -1;
        }
    }
...
run_exec_dup2(VALUE ary, VALUE tmpbuf, struct rb_execarg *sargp, char *errmsg, size_t errmsg_buflen)
{
    ...
    n = rb_array_len(ary);
    pairs = (struct run_exec_dup2_fd_pair *)(!(((struct RBasic*)(tmpbuf))->flags & RSTRING_NOEMBED) ? ((struct RString*)(tmpbuf))->as.ary : ((struct RString*)(tmpbuf))->as.heap.ptr);


    for (i = 0; i < n; i++) {
        VALUE elt = (rb_array_const_ptr(ary)[i]);
        pairs[i].oldfd = ((int)rb_fix2int((VALUE)((rb_array_const_ptr(elt)[1]))));
        pairs[i].newfd = ((int)rb_fix2int((VALUE)((rb_array_const_ptr(elt)[0]))));
        pairs[i].cloexec = rb_array_len(elt) > 2 && !(((VALUE)((rb_array_const_ptr(elt)[2])) & (VALUE)~((VALUE)RUBY_Qnil)) == 0);
    ...
    for (i = 0; i < n; i++) {
        ...
        while (j != -1 && pairs[j].oldfd != -1 && pairs[j].num_newer == 0) {
            if (save_redirect_fd(pairs[j].newfd, sargp, errmsg, errmsg_buflen) < 0)
                goto fail;
            ret = dup2((pairs[j].oldfd), (pairs[j].newfd));
            if (ret == -1) {
                do { if (errmsg && 0 < errmsg_buflen) strlcpy(errmsg, ("dup2"), errmsg_buflen); } while (0);
                goto fail;
            }
     if (pairs[j].cloexec &&
  ...
  goto fail;
    ...
    for (i = 0; i < n; i++) {
        ...
        if (extra_fd == -1) {
            ...
            ret = dup2((pairs[i].oldfd), (extra_fd));
            if (ret == -1) {
                do { if (errmsg && 0 < errmsg_buflen) strlcpy(errmsg, ("dup2"), errmsg_buflen); } while (0);
                goto fail;
            }
    ...
    if (extra_fd != -1) {
        ret = close_unless_reserved(extra_fd);
        if (ret == -1) {
            do { if (errmsg && 0 < errmsg_buflen) strlcpy(errmsg, ("close"), errmsg_buflen); } while (0);
            goto fail;
        }
    }
...
run_exec_pgroup(const struct rb_execarg *eargp, struct rb_execarg *sargp, char *errmsg, size_t errmsg_buflen)
{
    ...
    if (ret == -1) do { if (errmsg && 0 < errmsg_buflen) strlcpy(errmsg, ("setpgid"), errmsg_buflen); } while (0);
    return ret;
}
...
run_exec_rlimit(VALUE ary, struct rb_execarg *sargp, char *errmsg, size_t errmsg_buflen)
{
    ...
    for (i = 0; i < rb_array_len(ary); i++) {
        VALUE elt = (rb_array_const_ptr(ary)[i]);
        int rtype = rb_num2int_inline((rb_array_const_ptr(elt)[0]));
        struct rlimit rlim;
        if (sargp) {
            VALUE tmp, newary;
            if (getrlimit(rtype, &rlim) == -1) {
                do { if (errmsg && 0 < errmsg_buflen) strlcpy(errmsg, ("getrlimit"), errmsg_buflen); } while (0);
                return -1;
            }
            tmp = hide_obj( ({ const VALUE args_to_new_ary[] = {(rb_array_const_ptr(elt)[0]), rb_ulong2num_inline(rlim.rlim_cur), rb_ulong2num_inline(rlim.rlim_max)}; if (__builtin_constant_p(3)) { extern int (*__Static_assert_function (void)) [!!sizeof (struct { int __error_if_negative: (((int)(sizeof(args_to_new_ary) / sizeof((args_to_new_ary)[0]))) == (3)) ? 2 : -1; })]; } rb_ary_new_from_values(((int)(sizeof(args_to_new_ary) / sizeof((args_to_new_ary)[0]))), args_to_new_ary); }));


            if (sargp->rlimit_limits == ((VALUE)RUBY_Qfalse))
                newary = sargp->rlimit_limits = hide_obj(rb_ary_new());
            else
                newary = sargp->rlimit_limits;
            rb_ary_push(newary, tmp);
        }
        rlim.rlim_cur = rb_num2ulong_inline((rb_array_const_ptr(elt)[1]));
        rlim.rlim_max = rb_num2ulong_inline((rb_array_const_ptr(elt)[2]));
        if (setrlimit(rtype, &rlim) == -1) {
            do { if (errmsg && 0 < errmsg_buflen) strlcpy(errmsg, ("setrlimit"), errmsg_buflen); } while (0);
            return -1;
        }
    }
    return 0;
...
rb_execarg_run_options(const struct rb_execarg *eargp, struct rb_execarg *sargp, char *errmsg, size_t errmsg_buflen)
{
    ...
    if (sargp) {
        ...
        memset((sargp), 0, sizeof(struct rb_execarg)*(size_t)(1));
        sargp->redirect_fds = ((VALUE)RUBY_Qnil);
    }
    ...
    if (eargp->chdir_given) {
        if (sargp) {
            ...
            sargp->chdir_given = 1;
            sargp->chdir_dir = hide_obj( ({ (__builtin_constant_p(cwd)) ? rb_str_new_static((cwd), (long)strlen(cwd)) : rb_str_new_cstr(cwd); }));
            ruby_xfree(cwd);
        }
        if (chdir((!(((struct RBasic*)(eargp->chdir_dir))->flags & RSTRING_NOEMBED) ? ((struct RString*)(eargp->chdir_dir))->as.ary : ((struct RString*)(eargp->chdir_dir))->as.heap.ptr)) == -1) {
            do { if (errmsg && 0 < errmsg_buflen) strlcpy(errmsg, ("chdir"), errmsg_buflen); } while (0);
            return -1;
        }
    }
 ...
 if (setgid(eargp->gid) < 0) {
     do { if (errmsg && 0 < errmsg_buflen) strlcpy(errmsg, ("setgid"), errmsg_buflen); } while (0);
     return -1;
 }
    }
 ...
 if (setuid(eargp->uid) < 0) {
     do { if (errmsg && 0 < errmsg_buflen) strlcpy(errmsg, ("setuid"), errmsg_buflen); } while (0);
     return -1;
 }
    }
...
{
    (*__errno_location ()) = exec_async_signal_safe(eargp, errmsg, errmsg_buflen);
    return -1;
}
...
exec_async_signal_safe(const struct rb_execarg *eargp, char *errmsg, size_t errmsg_buflen)
{
    ...
    struct rb_execarg *const sargp = ((void*)0);
 ...
 return (*__errno_location ());
    ...
    if (eargp->use_shell) {
 err = proc_exec_sh((!(((struct RBasic*)(eargp->invoke.sh.shell_script))->flags & RSTRING_NOEMBED) ? ((struct RString*)(eargp->invoke.sh.shell_script))->as.ary : ((struct RString*)(eargp->invoke.sh.shell_script))->as.heap.ptr), eargp->envp_str);
    }
    else {
 char *abspath = ((void*)0);
 if (!!((VALUE)(eargp->invoke.cmd.command_abspath) != ((VALUE)RUBY_Qnil)))
     abspath = (!(((struct RBasic*)(eargp->invoke.cmd.command_abspath))->flags & RSTRING_NOEMBED) ? ((struct RString*)(eargp->invoke.cmd.command_abspath))->as.ary : ((struct RString*)(eargp->invoke.cmd.command_abspath))->as.heap.ptr);
...
move_fds_to_avoid_crash(int *fdp, int n, VALUE fds)
{
    ...
    for (i = 0; i < n; i++) {
        int ret;
        while (!(((VALUE)(rb_hash_lookup(fds, (((VALUE)(fdp[i]))<<1 | RUBY_FIXNUM_FLAG))) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) {
            if (min <= fdp[i])
                min = fdp[i]+1;
            while (!(((VALUE)(rb_hash_lookup(fds, (((VALUE)(min))<<1 | RUBY_FIXNUM_FLAG))) & (VALUE)~((VALUE)RUBY_Qnil)) == 0))
                min++;
...
pipe_nocrash(int filedes[2], VALUE fds)
{
    ...
    if (ret == -1)
        return -1;
    if (!(((VALUE)(fds) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) {
...
send_child_error(int fd, char *errmsg, size_t errmsg_buflen)
{
    ...
    err = (*__errno_location ());
    if (write_retry(fd, &err, sizeof(err)) < 0) err = (*__errno_location ());
...
disable_child_handler_before_fork(struct child_handler_disabler_state *old)
{
    ...
    ret = pthread_sigmask(2, &all, &old->sigmask);
    if (ret != 0) {
...
disable_child_handler_fork_parent(struct child_handler_disabler_state *old)
{
    ...
    ret = pthread_setcancelstate(old->cancelstate, ((void*)0));
    if (ret != 0) {
 rb_syserr_fail(ret, "pthread_setcancelstate");
    }
    ...
    ret = pthread_sigmask(2, &old->sigmask, ((void*)0));
    if (ret != 0) {
 rb_syserr_fail(ret, "pthread_sigmask");
    }
...
disable_child_handler_fork_child(struct child_handler_disabler_state *old, char *errmsg, size_t errmsg_buflen)
{
 ...
 sig_t handler = signal(sig, ((__sighandler_t) 0));

 if (handler == ((__sighandler_t) -1) && (*__errno_location ()) == 22) {
     continue;
 }
 if (handler == ((__sighandler_t) -1)) {
     do { if (errmsg && 0 < errmsg_buflen) strlcpy(errmsg, ("signal to obtain old action"), errmsg_buflen); } while (0);
     return -1;
 }
 ...
 if (handler == ((__sighandler_t) 1)) {
    ...
    ret = sigprocmask(2, &old->sigmask, ((void*)0));
    if (ret != 0) {
        do { if (errmsg && 0 < errmsg_buflen) strlcpy(errmsg, ("sigprocmask"), errmsg_buflen); } while (0);
        return -1;
    }
    return 0;
}
        ...
        char *errmsg, size_t errmsg_buflen)
{
    ...
    while (1) {
        ( rb_io_flush(rb_stdout), rb_io_flush(rb_stderr) );
...
rb_fork_ruby(int *status)
{
 ...
 pid = fork();
 err = (*__errno_location ());
 (rb_threadptr_pending_interrupt_clear(rb_current_thread()), after_exec());
 disable_child_handler_fork_parent(&old);
 if (pid >= 0)
     return pid;

 if (handle_fork_error(err, status, ((void*)0), &try_gc))
     return -1;
    }
}
static VALUE
rb_f_fork(VALUE obj)
{
    ...
    switch (pid = rb_fork_ruby(((void*)0))) {
      case 0:
 rb_thread_atfork();
 if (rb_block_given_p()) {
     int status;
     rb_protect(rb_yield, ((VALUE)RUBY_Qundef), &status);
     ruby_stop(status);
 }
 return ((VALUE)RUBY_Qnil);
...
exit_status_code(VALUE status)
{
 ...
 break;
      default:
 istatus = rb_num2int_inline(status);
...
rb_exit(int status)
{
    if (rb_current_execution_context()->tag) {
 VALUE args[2];

 args[0] = (((VALUE)((int)(status)))<<1 | RUBY_FIXNUM_FLAG);
 args[1] =  ({ (__builtin_constant_p("exit")) ? rb_str_new_static(("exit"), (long)strlen("exit")) : rb_str_new_cstr("exit"); });
...
rb_f_abort(int argc, const VALUE *argv)
{
 ...
 if (!!((VALUE)(errinfo) != ((VALUE)RUBY_Qnil))) {
 ...
 rb_string_value(&(args[0]));
 rb_io_puts(1, args, rb_stderr);
 args[0] = (((VALUE)((int)(1)))<<1 | RUBY_FIXNUM_FLAG);
 rb_exc_raise(rb_class_new_instance(2, args, rb_eSystemExit));
    }
...
{
    pid_t pid;
    pid = rb_fork_async_signal_safe(((void*)0), rb_exec_atfork, eargp, eargp->redirect_fds, errmsg, errmsg_buflen);
    return pid;
}
...
do_spawn_process(VALUE arg)
{
    ...
    return (VALUE)rb_spawn_process((((struct RData*)(argp->execarg))->data),
...
rb_execarg_spawn(VALUE execarg_obj, char *errmsg, size_t errmsg_buflen)
{
    ...
    return (pid_t)rb_ensure(do_spawn_process, (VALUE)&args,
          execarg_parent_end, execarg_obj);
}
...
{
    return rb_spawn_internal(argc, argv, ((void*)0), 0);
}
static VALUE
rb_f_system(int argc, VALUE *argv)
{
    ...
    rb_last_status_clear();
    chfunc = signal(17, ((__sighandler_t) 0));

    pid = rb_spawn_internal(argc, argv, ((void*)0), 0);
 ...
 return ((VALUE)RUBY_Qnil);
    ...
    status = rb_num2int_inline(pst_to_i(rb_last_status_get()));
    if (status == 0) return ((VALUE)RUBY_Qtrue);
    return ((VALUE)RUBY_Qfalse);
}
static VALUE
...
proc_getpgrp(void)
{
    ...
    return (((VALUE)((int)(pgrp)))<<1 | RUBY_FIXNUM_FLAG);
...
proc_getpgid(VALUE obj, VALUE pid)
{
    ...
    i = getpgid(rb_num2int_inline(pid));
...
proc_setpgid(VALUE obj, VALUE pid, VALUE pgrp)
{
    ...
    ipid = rb_num2int_inline(pid);
    ipgrp = rb_num2int_inline(pgrp);
...
proc_getsid(int argc, VALUE *argv)
{
    ...
    if (rb_check_arity(argc, 0, 1) == 1 && !!((VALUE)(argv[0]) != ((VALUE)RUBY_Qnil)))
 pid = rb_num2int_inline(argv[0]);

    sid = getsid(pid);
    if (sid < 0) rb_sys_fail(0);
    return (((VALUE)((int)(sid)))<<1 | RUBY_FIXNUM_FLAG);
}
static VALUE
proc_setsid(void)
{
...
proc_getpriority(VALUE obj, VALUE which, VALUE who)
{
    ...
    iwhich = rb_num2int_inline(which);
    iwho = rb_num2int_inline(who);

    (*__errno_location ()) = 0;
    prio = getpriority(iwhich, iwho);
    if ((*__errno_location ())) rb_sys_fail(0);
    return (((VALUE)(prio))<<1 | RUBY_FIXNUM_FLAG);
}
static VALUE
...
rlimit_resource_name2int(const char *name, long len, int casetype)
{
    int resource;
    const char *p;
    switch (rb_toupper(*name)) {
      case 'A':

        do { if (len == (sizeof("AS") - 1) && (st_locale_insensitive_strcasecmp((name), ("AS"))) == 0) { resource = RLIMIT_AS; goto found; } } while (0);

        break;

      case 'C':

        do { if (len == (sizeof("CORE") - 1) && (st_locale_insensitive_strcasecmp((name), ("CORE"))) == 0) { resource = RLIMIT_CORE; goto found; } } while (0);


        do { if (len == (sizeof("CPU") - 1) && (st_locale_insensitive_strcasecmp((name), ("CPU"))) == 0) { resource = RLIMIT_CPU; goto found; } } while (0);

        break;

      case 'D':

        do { if (len == (sizeof("DATA") - 1) && (st_locale_insensitive_strcasecmp((name), ("DATA"))) == 0) { resource = RLIMIT_DATA; goto found; } } while (0);

        break;

      case 'F':

        do { if (len == (sizeof("FSIZE") - 1) && (st_locale_insensitive_strcasecmp((name), ("FSIZE"))) == 0) { resource = RLIMIT_FSIZE; goto found; } } while (0);

        break;

      case 'M':

        do { if (len == (sizeof("MEMLOCK") - 1) && (st_locale_insensitive_strcasecmp((name), ("MEMLOCK"))) == 0) { resource = __RLIMIT_MEMLOCK; goto found; } } while (0);


        do { if (len == (sizeof("MSGQUEUE") - 1) && (st_locale_insensitive_strcasecmp((name), ("MSGQUEUE"))) == 0) { resource = __RLIMIT_MSGQUEUE; goto found; } } while (0);

        break;

      case 'N':

        do { if (len == (sizeof("NOFILE") - 1) && (st_locale_insensitive_strcasecmp((name), ("NOFILE"))) == 0) { resource = RLIMIT_NOFILE; goto found; } } while (0);


        do { if (len == (sizeof("NPROC") - 1) && (st_locale_insensitive_strcasecmp((name), ("NPROC"))) == 0) { resource = __RLIMIT_NPROC; goto found; } } while (0);


        do { if (len == (sizeof("NICE") - 1) && (st_locale_insensitive_strcasecmp((name), ("NICE"))) == 0) { resource = __RLIMIT_NICE; goto found; } } while (0);

        break;

      case 'R':

        do { if (len == (sizeof("RSS") - 1) && (st_locale_insensitive_strcasecmp((name), ("RSS"))) == 0) { resource = __RLIMIT_RSS; goto found; } } while (0);


        do { if (len == (sizeof("RTPRIO") - 1) && (st_locale_insensitive_strcasecmp((name), ("RTPRIO"))) == 0) { resource = __RLIMIT_RTPRIO; goto found; } } while (0);


        do { if (len == (sizeof("RTTIME") - 1) && (st_locale_insensitive_strcasecmp((name), ("RTTIME"))) == 0) { resource = __RLIMIT_RTTIME; goto found; } } while (0);

        break;

      case 'S':

        do { if (len == (sizeof("STACK") - 1) && (st_locale_insensitive_strcasecmp((name), ("STACK"))) == 0) { resource = RLIMIT_STACK; goto found; } } while (0);





        do { if (len == (sizeof("SIGPENDING") - 1) && (st_locale_insensitive_strcasecmp((name), ("SIGPENDING"))) == 0) { resource = __RLIMIT_SIGPENDING; goto found; } } while (0);
...
rlimit_type_by_sym(VALUE key)
{
    ...
    const char *rname = (!(((struct RBasic*)(name))->flags & RSTRING_NOEMBED) ? ((struct RString*)(name))->as.ary : ((struct RString*)(name))->as.heap.ptr);
    long len = (!(((struct RBasic*)(name))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(name))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(name))->as.heap.len);
    int rtype = -1;
 ...
 rtype = rlimit_type_by_lname(rname + prefix_len, len - prefix_len);
    ...
    (* ({ volatile VALUE *rb_gc_guarded_ptr = &(key); ; rb_gc_guarded_ptr; }));
    return rtype;
}
...
rlimit_resource_type(VALUE rtype)
{
    ...
    switch (rb_type((VALUE)(rtype))) {
      case RUBY_T_SYMBOL:
 v = rb_sym2str(rtype);
 name = (!(((struct RBasic*)(v))->flags & RSTRING_NOEMBED) ? ((struct RString*)(v))->as.ary : ((struct RString*)(v))->as.heap.ptr);
 len = (!(((struct RBasic*)(v))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(v))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(v))->as.heap.len);
        break;
      ...
      default:
        ...
        if (!!((VALUE)(v) != ((VALUE)RUBY_Qnil))) {
            rtype = v;
      case RUBY_T_STRING:
            name = rb_string_value_cstr(&(rtype));
     len = (!(((struct RBasic*)(rtype))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(rtype))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(rtype))->as.heap.len);
            break;
        }
      ...
      case RUBY_T_FIXNUM:
      case RUBY_T_BIGNUM:
        return rb_num2int_inline(rtype);
    }
    ...
    rb_raise(rb_eArgError, "invalid resource name: % li\v", rtype);
 ...
 name = (!(((struct RBasic*)(v))->flags & RSTRING_NOEMBED) ? ((struct RString*)(v))->as.ary : ((struct RString*)(v))->as.heap.ptr);
      ...
      default:
        ...
        if (!!((VALUE)(v) != ((VALUE)RUBY_Qnil))) {
            rval = v;
      case RUBY_T_STRING:
            name = rb_string_value_cstr(&(rval));
            break;
        }
      ...
      case RUBY_T_FIXNUM:
      case RUBY_T_BIGNUM:
        return rb_num2ulong_inline(rval);
    }


    if (strcmp(name, "INFINITY") == 0) return ((__rlim_t) -1);


    if (strcmp(name, "SAVED_MAX") == 0) return ((__rlim_t) -1);


    if (strcmp(name, "SAVED_CUR") == 0) return ((__rlim_t) -1);

    rb_raise(rb_eArgError, "invalid resource value: %li\v", rval);
...
proc_getrlimit(VALUE obj, VALUE resource)
{
 ...
 rb_sys_fail("getrlimit");
    ...
    return rb_assoc_new(rb_ulong2num_inline(rlim.rlim_cur), rb_ulong2num_inline(rlim.rlim_max));
}
static VALUE
proc_setrlimit(int argc, VALUE *argv, VALUE obj)
{
    ...
    resource = argv[0];
    rlim_cur = argv[1];
    if (argc < 3 || !((VALUE)(rlim_max = argv[2]) != ((VALUE)RUBY_Qnil)))
        rlim_max = rlim_cur;
    ...
    )
{
    ...
    if ((((int)(long)(id))&RUBY_FIXNUM_FLAG) || !((VALUE)(tmp = rb_check_string_type(id)) != ((VALUE)RUBY_Qnil))) {
 uid = ((unsigned int)rb_num2uint(id));
    }
    else {
 const char *usrname = rb_string_value_cstr(&(id));
 struct passwd *pwptr;
 ...
 if (!*getpw_tmp) {
     ...
     if (getpw_buf_len < 0) getpw_buf_len = 0x1000;
     *getpw_tmp = rb_str_tmp_new(getpw_buf_len);
 }
 getpw_buf = (!(((struct RBasic*)(*getpw_tmp))->flags & RSTRING_NOEMBED) ? ((struct RString*)(*getpw_tmp))->as.ary : ((struct RString*)(*getpw_tmp))->as.heap.ptr);
...
{
    return (((VALUE)((unsigned int)(obj2uid0(id))))<<1 | RUBY_FIXNUM_FLAG);
}
    ...
    )
{
    ...
    if ((((int)(long)(id))&RUBY_FIXNUM_FLAG) || !((VALUE)(tmp = rb_check_string_type(id)) != ((VALUE)RUBY_Qnil))) {
 gid = ((unsigned int)rb_num2uint(id));
    }
    else {
 const char *grpname = rb_string_value_cstr(&(id));
 struct group *grptr;
 ...
 if (!*getgr_tmp) {
     ...
     if (getgr_buf_len < 0) getgr_buf_len = 0x1000;
     *getgr_tmp = rb_str_tmp_new(getgr_buf_len);
 }
 getgr_buf = (!(((struct RBasic*)(*getgr_tmp))->flags & RSTRING_NOEMBED) ? ((struct RString*)(*getgr_tmp))->as.ary : ((struct RString*)(*getgr_tmp))->as.heap.ptr);
...
{
    return (((VALUE)((unsigned int)(obj2gid0(id))))<<1 | RUBY_FIXNUM_FLAG);
}
static VALUE
p_sys_setuid(VALUE obj, VALUE id)
{
    check_uid_switch();
    if (setuid(obj2uid0(id)) != 0) rb_sys_fail(0);
    return ((VALUE)RUBY_Qnil);
}
static VALUE
...
{
    check_uid_switch();
    if (seteuid(obj2uid0(id)) != 0) rb_sys_fail(0);
    return ((VALUE)RUBY_Qnil);
}
static VALUE
p_sys_setreuid(VALUE obj, VALUE rid, VALUE eid)
{
    ...
    VALUE getpw_buf = 0;
    check_uid_switch();
    ruid = obj2uid((rid), &getpw_buf);
    euid = obj2uid((eid), &getpw_buf);
    (getpw_buf ? (void)rb_str_resize(getpw_buf, 0) : (void)0);
...
{
    uid_t uid = getuid();
    return (((VALUE)((unsigned int)(uid)))<<1 | RUBY_FIXNUM_FLAG);
}
static VALUE
...
p_uid_change_privilege(VALUE obj, VALUE id)
{
 ...
 if (setresuid((getuid() == uid)? (uid_t)-1: uid,
        (geteuid() == uid)? (uid_t)-1: uid,
        (SAVED_USER_ID == uid)? (uid_t)-1: uid) < 0) rb_sys_fail(0);
 SAVED_USER_ID = uid;
    }
    return id;
}
...
{
    check_gid_switch();
    if (setgid(obj2gid0(id)) != 0) rb_sys_fail(0);
    return ((VALUE)RUBY_Qnil);
}
static VALUE
...
{
    check_gid_switch();
    if (setegid(obj2gid0(id)) != 0) rb_sys_fail(0);
    return ((VALUE)RUBY_Qnil);
}
static VALUE
...
{
    gid_t gid = getgid();
    return (((VALUE)((unsigned int)(gid)))<<1 | RUBY_FIXNUM_FLAG);
}
static VALUE
...
proc_getgroups(VALUE obj)
{
    ...
    ngroups = getgroups(0, ((void*)0));
    if (ngroups == -1)
 rb_sys_fail(0);

    groups = ((gid_t*)(((size_t)(ngroups) < 1024 / sizeof(gid_t)) ? ((* ({ volatile VALUE *rb_gc_guarded_ptr = &(tmp); ; rb_gc_guarded_ptr; })) = 0, __builtin_alloca ((size_t)(ngroups) * sizeof(gid_t))) : rb_alloc_tmp_buffer2(&(tmp), (long)(ngroups), sizeof(gid_t))));
 ...
 rb_sys_fail(0);
    ...
    ary = rb_ary_new();
    for (i = 0; i < ngroups; i++)
 rb_ary_push(ary, (((VALUE)((unsigned int)(groups[i])))<<1 | RUBY_FIXNUM_FLAG));
...
proc_setgroups(VALUE obj, VALUE ary)
{
    ...
    (!( (((RUBY_T_ARRAY)) == RUBY_T_FIXNUM) ? (((int)(long)((VALUE)(ary)))&RUBY_FIXNUM_FLAG) : (((RUBY_T_ARRAY)) == RUBY_T_TRUE) ? (((VALUE)(ary)) == ((VALUE)RUBY_Qtrue)) : (((RUBY_T_ARRAY)) == RUBY_T_FALSE) ? (((VALUE)(ary)) == ((VALUE)RUBY_Qfalse)) : (((RUBY_T_ARRAY)) == RUBY_T_NIL) ? (((VALUE)(ary)) == ((VALUE)RUBY_Qnil)) : (((RUBY_T_ARRAY)) == RUBY_T_UNDEF) ? (((VALUE)(ary)) == ((VALUE)RUBY_Qundef)) : (((RUBY_T_ARRAY)) == RUBY_T_SYMBOL) ? ((((VALUE)((VALUE)(ary))&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)((VALUE)(ary)) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)((VALUE)(ary)) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)((VALUE)(ary)))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : (((RUBY_T_ARRAY)) == RUBY_T_FLOAT) ? ( ((((int)(long)((VALUE)(ary)))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)((VALUE)(ary)) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)((VALUE)(ary)) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)((VALUE)(ary)))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)((VALUE)(ary)) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)((VALUE)(ary)) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)((VALUE)(ary)))->flags & RUBY_T_MASK) == ((RUBY_T_ARRAY)))) || ((RUBY_T_ARRAY) == RUBY_T_DATA && (((struct RTypedData*)(ary))->typed_flag == 1)) ? rb_unexpected_type((VALUE)(ary), (RUBY_T_ARRAY)) : (void)0);

    ngroups = rb_long2int_inline(rb_array_len(ary));
 ...
 rb_raise(rb_eArgError, "too many groups, %d max", maxgroups());
    ...
    for (i = 0; i < ngroups; i++) {
 VALUE g = (rb_array_const_ptr(ary)[i]);

 groups[i] = obj2gid((g), &getgr_buf);
    }
    (getgr_buf ? (void)rb_str_resize(getgr_buf, 0) : (void)0);
...
{
    if (initgroups(rb_string_value_cstr(&(uname)), obj2gid0(base_grp)) != 0) {
 rb_sys_fail(0);
    }
    return proc_getgroups(obj);
}
...
{
    return (((VALUE)(maxgroups()))<<1 | RUBY_FIXNUM_FLAG);
}
static VALUE
proc_setmaxgroups(VALUE obj, VALUE val)
{
    int ngroups = ((int)rb_fix2int((VALUE)(val)));
 ...
 ngroups = ngroups_max;
    ...
    return (((VALUE)(_maxgroups))<<1 | RUBY_FIXNUM_FLAG);
}
...
proc_daemon(int argc, VALUE *argv)
{
    ...
    switch (rb_check_arity(argc, 0, 2)) {
      case 2: noclose = !(((VALUE)(argv[1]) & (VALUE)~((VALUE)RUBY_Qnil)) == 0);
      case 1: nochdir = !(((VALUE)(argv[0]) & (VALUE)~((VALUE)RUBY_Qnil)) == 0);
    }
...
rb_daemon(int nochdir, int noclose)
{
    ...
    int n;
    switch (rb_fork_ruby(((void*)0))) { case -1: return -1; case 0: rb_thread_atfork(); break; default: _exit(0); };
 ...
 err = chdir("/");
    ...
    if (!noclose && (n = rb_cloexec_open("/dev/null", 02, 0)) != -1) {
        rb_update_max_fd(n);
 (void)dup2(n, 0);
 (void)dup2(n, 1);
 (void)dup2(n, 2);
...
p_gid_change_privilege(VALUE obj, VALUE id)
{
 ...
 if (setresgid((getgid() == gid)? (gid_t)-1: gid,
        (getegid() == gid)? (gid_t)-1: gid,
        (SAVED_GROUP_ID == gid)? (gid_t)-1: gid) < 0) rb_sys_fail(0);
 SAVED_GROUP_ID = gid;
    }
    return id;
}
...
{
    uid_t euid = geteuid();
    return (((VALUE)((unsigned int)(euid)))<<1 | RUBY_FIXNUM_FLAG);
}
...
proc_getegid(VALUE obj)
{
    ...
    return (((VALUE)((unsigned int)(egid)))<<1 | RUBY_FIXNUM_FLAG);
}
static VALUE
...
static VALUE
p_uid_sw_ensure(uid_t id)
{
    under_uid_switch = 0;
    id = rb_seteuid_core(id);
    return (((VALUE)((unsigned int)(id)))<<1 | RUBY_FIXNUM_FLAG);
}
static VALUE
p_uid_switch(VALUE obj)
{
 ...
 if (rb_block_given_p()) {
     under_uid_switch = 1;
     return rb_ensure(rb_yield, ((VALUE)RUBY_Qnil), p_uid_sw_ensure, SAVED_USER_ID);
 }
 else {
     return (((VALUE)((unsigned int)(euid)))<<1 | RUBY_FIXNUM_FLAG);
 }
 ...
 if (rb_block_given_p()) {
     under_uid_switch = 1;
     return rb_ensure(rb_yield, ((VALUE)RUBY_Qnil), p_uid_sw_ensure, euid);
 }
 else {
     return (((VALUE)((unsigned int)(uid)))<<1 | RUBY_FIXNUM_FLAG);
 }
...
p_gid_switch(VALUE obj)
{
    ...
    if (gid != egid) {
 proc_setegid(obj, (((VALUE)((unsigned int)(gid)))<<1 | RUBY_FIXNUM_FLAG));
 if (rb_block_given_p()) {
     under_gid_switch = 1;
     return rb_ensure(rb_yield, ((VALUE)RUBY_Qnil), p_gid_sw_ensure, SAVED_GROUP_ID);
 }
 else {
     return (((VALUE)((unsigned int)(egid)))<<1 | RUBY_FIXNUM_FLAG);
 }
 ...
 proc_setegid(obj, (((VALUE)((unsigned int)(SAVED_GROUP_ID)))<<1 | RUBY_FIXNUM_FLAG));
 if (rb_block_given_p()) {
     under_gid_switch = 1;
     return rb_ensure(rb_yield, ((VALUE)RUBY_Qnil), p_gid_sw_ensure, egid);
 }
 else {
     return (((VALUE)((unsigned int)(gid)))<<1 | RUBY_FIXNUM_FLAG);
 }
...
rb_proc_times(VALUE obj)
{
 ...
 rb_sys_fail("getrusage");
    utime = rb_float_new_inline((double)usage_s.ru_utime.tv_sec + (double)usage_s.ru_utime.tv_usec/1e6);
    stime = rb_float_new_inline((double)usage_s.ru_stime.tv_sec + (double)usage_s.ru_stime.tv_usec/1e6);
    cutime = rb_float_new_inline((double)usage_c.ru_utime.tv_sec + (double)usage_c.ru_utime.tv_usec/1e6);
    cstime = rb_float_new_inline((double)usage_c.ru_stime.tv_sec + (double)usage_c.ru_stime.tv_usec/1e6);
    ret = rb_struct_new(rb_cProcessTms, utime, stime, cutime, cstime);
    (* ({ volatile VALUE *rb_gc_guarded_ptr = &(utime); ; rb_gc_guarded_ptr; }));
    (* ({ volatile VALUE *rb_gc_guarded_ptr = &(stime); ; rb_gc_guarded_ptr; }));
    (* ({ volatile VALUE *rb_gc_guarded_ptr = &(cutime); ; rb_gc_guarded_ptr; }));
    (* ({ volatile VALUE *rb_gc_guarded_ptr = &(cstime); ; rb_gc_guarded_ptr; }));
    return ret;
}
...
typedef long long timetick_int_t;
        ...
        timetick_int_t *denominators, int num_denominators)
{
    ...
    if (!( (1000000000) == 0 ? 0 : (1000000000) == -1 ? (ttp->giga_count) < -(9223372036854775807LL -ttp->count) : (1000000000) > 0 ? ((ttp->giga_count) > 0 ? (9223372036854775807LL -ttp->count) / (1000000000) < (ttp->giga_count) : ((-9223372036854775807LL -1LL)) / (1000000000) > (ttp->giga_count)) : ((ttp->giga_count) > 0 ? ((-9223372036854775807LL -1LL)) / (1000000000) < (ttp->giga_count) : (9223372036854775807LL -ttp->count) / (1000000000) > (ttp->giga_count)))) {

        timetick_int_t t = ttp->giga_count * 1000000000 + ttp->count;
        for (i = 0; i < num_numerators; i++) {
            timetick_int_t factor = numerators[i];
            if (__builtin_mul_overflow_p((factor), (t), (int)0))
                goto generic;
            t *= factor;
        }
        for (i = 0; i < num_denominators; i++) {
            t = ((t)<0 ? (-(-(((t))+1)/((denominators[i])))-1) : (t)/(denominators[i]));
        }
        return rb_ll2inum(t);
    }

  generic:
    v = rb_ll2inum(ttp->giga_count);
    v = rb_funcall(v, '*', 1, (((VALUE)(1000000000))<<1 | RUBY_FIXNUM_FLAG));
    v = rb_funcall(v, '+', 1, (((VALUE)(ttp->count))<<1 | RUBY_FIXNUM_FLAG));
    for (i = 0; i < num_numerators; i++) {
        timetick_int_t factor = numerators[i];
        if (factor == 1)
            continue;
        v = rb_funcall(v, '*', 1, rb_ll2inum(factor));
    }
    for (i = 0; i < num_denominators; i++) {
        v = rb_funcall(v, '/', 1, rb_ll2inum(denominators[i]));
    }
    return v;
}
...
make_clock_result(struct timetick *ttp,
        ...
        VALUE unit)
{
    if (unit == (rb_id2sym(id_nanosecond))) {
        numerators[num_numerators++] = 1000000000;
        return timetick2integer(ttp, numerators, num_numerators, denominators, num_denominators);
    }
    else if (unit == (rb_id2sym(id_microsecond))) {
        numerators[num_numerators++] = 1000000;
        return timetick2integer(ttp, numerators, num_numerators, denominators, num_denominators);
    }
    else if (unit == (rb_id2sym(id_millisecond))) {
        numerators[num_numerators++] = 1000;
        return timetick2integer(ttp, numerators, num_numerators, denominators, num_denominators);
    }
    else if (unit == (rb_id2sym(id_second))) {
        return timetick2integer(ttp, numerators, num_numerators, denominators, num_denominators);
    }
    else if (unit == (rb_id2sym(id_float_microsecond))) {
        numerators[num_numerators++] = 1000000;
        return timetick2dblnum(ttp, numerators, num_numerators, denominators, num_denominators);
    }
    else if (unit == (rb_id2sym(id_float_millisecond))) {
        numerators[num_numerators++] = 1000;
        return timetick2dblnum(ttp, numerators, num_numerators, denominators, num_denominators);
    }
    else if (!((VALUE)(unit) != ((VALUE)RUBY_Qnil)) || unit == (rb_id2sym(id_float_second))) {
        return timetick2dblnum(ttp, numerators, num_numerators, denominators, num_denominators);
    }
    else
        rb_raise(rb_eArgError, "unexpected unit: %li\v", unit);
}
VALUE
rb_clock_gettime(int argc, VALUE *argv)
{
    ...
    VALUE unit = (rb_check_arity(argc, 1, 2) == 2) ? argv[1] : ((VALUE)RUBY_Qnil);
    VALUE clk_id = argv[0];

    if (((((VALUE)(clk_id)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(clk_id) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(clk_id) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(clk_id))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL)))) {
        if (clk_id == (rb_id2sym(id_GETTIMEOFDAY_BASED_CLOCK_REALTIME))) {
            struct timeval tv;
        ...
        if (clk_id == (rb_id2sym(id_TIME_BASED_CLOCK_REALTIME))) {
            time_t t;
            t = time(((void*)0));
            if (t == (time_t)-1)
                rb_sys_fail("time");
        ...
        if (clk_id == (rb_id2sym(id_TIMES_BASED_CLOCK_MONOTONIC))) {
            struct tms buf;
            clock_t c;
            unsigned_clock_t uc;
            c = times(&buf);
        ...
        if (clk_id == (rb_id2sym(id_GETRUSAGE_BASED_CLOCK_PROCESS_CPUTIME_ID))) {
            struct rusage usage;
            int32_t usec;
        ...
        if (clk_id == (rb_id2sym(id_TIMES_BASED_CLOCK_PROCESS_CPUTIME_ID))) {
            struct tms buf;
        ...
        if (clk_id == (rb_id2sym(id_CLOCK_BASED_CLOCK_PROCESS_CPUTIME_ID))) {
            clock_t c;
            unsigned_clock_t uc;
            (*__errno_location ()) = 0;
            c = clock();
            ...
            tt.count = (int32_t)(uc % 1000000000);
            tt.giga_count = uc / 1000000000;
            denominators[num_denominators++] = ((__clock_t) 1000000);
            goto success;
        }
    }
    else {
...
rb_clock_getres(int argc, VALUE *argv)
{
    ...
    if (((((VALUE)(clk_id)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(clk_id) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(clk_id) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(clk_id))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL)))) {
        ...
        struct timespec ts;
        clockid_t c = rb_num2int_inline(clk_id);
...
InitVM_process(void)
{
    ...
    rb_define_const(rb_mProcess, "WNOHANG", (((VALUE)(1))<<1 | RUBY_FIXNUM_FLAG));
    ...
    rb_define_const(rb_mProcess, "WUNTRACED", (((VALUE)(2))<<1 | RUBY_FIXNUM_FLAG));
    ...
    rb_undef_method(rb_class_of((VALUE)(rb_cWaiter)), "new");
    rb_define_method(rb_cWaiter, "pid", detach_process_pid, 0);

    rb_cProcessStatus = rb_define_class_under(rb_mProcess, "Status", rb_cObject);
    rb_undef_method(rb_class_of((VALUE)(rb_cProcessStatus)), "new");
    ...
    rb_define_const(rb_mProcess, "PRIO_PROCESS", (((VALUE)(PRIO_PROCESS))<<1 | RUBY_FIXNUM_FLAG));

    rb_define_const(rb_mProcess, "PRIO_PGRP", (((VALUE)(PRIO_PGRP))<<1 | RUBY_FIXNUM_FLAG));

    rb_define_const(rb_mProcess, "PRIO_USER", (((VALUE)(PRIO_USER))<<1 | RUBY_FIXNUM_FLAG));
    ...
    {
        VALUE inf = rb_ulong2num_inline(((__rlim_t) -1));

 {
     VALUE v = ((__rlim_t) -1) == ((__rlim_t) -1) ? inf : rb_ulong2num_inline(((__rlim_t) -1));
...

 {
    ...
    rb_define_const(rb_mProcess, "RLIMIT_AS", (((VALUE)(RLIMIT_AS))<<1 | RUBY_FIXNUM_FLAG));
    ...
    rb_define_const(rb_mProcess, "RLIMIT_CORE", (((VALUE)(RLIMIT_CORE))<<1 | RUBY_FIXNUM_FLAG));
    ...
    rb_define_const(rb_mProcess, "RLIMIT_CPU", (((VALUE)(RLIMIT_CPU))<<1 | RUBY_FIXNUM_FLAG));
    ...
    rb_define_const(rb_mProcess, "RLIMIT_DATA", (((VALUE)(RLIMIT_DATA))<<1 | RUBY_FIXNUM_FLAG));
    ...
    rb_define_const(rb_mProcess, "RLIMIT_FSIZE", (((VALUE)(RLIMIT_FSIZE))<<1 | RUBY_FIXNUM_FLAG));
    ...
    rb_define_const(rb_mProcess, "RLIMIT_MEMLOCK", (((VALUE)(__RLIMIT_MEMLOCK))<<1 | RUBY_FIXNUM_FLAG));
    ...
    rb_define_const(rb_mProcess, "RLIMIT_MSGQUEUE", (((VALUE)(__RLIMIT_MSGQUEUE))<<1 | RUBY_FIXNUM_FLAG));
    ...
    rb_define_const(rb_mProcess, "RLIMIT_NICE", (((VALUE)(__RLIMIT_NICE))<<1 | RUBY_FIXNUM_FLAG));
    ...
    rb_define_const(rb_mProcess, "RLIMIT_NOFILE", (((VALUE)(RLIMIT_NOFILE))<<1 | RUBY_FIXNUM_FLAG));
    ...
    rb_define_const(rb_mProcess, "RLIMIT_NPROC", (((VALUE)(__RLIMIT_NPROC))<<1 | RUBY_FIXNUM_FLAG));
    ...
    rb_define_const(rb_mProcess, "RLIMIT_RSS", (((VALUE)(__RLIMIT_RSS))<<1 | RUBY_FIXNUM_FLAG));
    ...
    rb_define_const(rb_mProcess, "RLIMIT_RTPRIO", (((VALUE)(__RLIMIT_RTPRIO))<<1 | RUBY_FIXNUM_FLAG));
    ...
    rb_define_const(rb_mProcess, "RLIMIT_RTTIME", (((VALUE)(__RLIMIT_RTTIME))<<1 | RUBY_FIXNUM_FLAG));
    rb_define_const(rb_mProcess, "RLIMIT_SIGPENDING", (((VALUE)(__RLIMIT_SIGPENDING))<<1 | RUBY_FIXNUM_FLAG));
    ...
    rb_define_const(rb_mProcess, "RLIMIT_STACK", (((VALUE)(RLIMIT_STACK))<<1 | RUBY_FIXNUM_FLAG));
    ...
    rb_define_const(rb_mProcess, "CLOCK_REALTIME", (((VALUE)((int)(0)))<<1 | RUBY_FIXNUM_FLAG));
    ...
    rb_define_const(rb_mProcess, "CLOCK_MONOTONIC", (((VALUE)((int)(1)))<<1 | RUBY_FIXNUM_FLAG));
    ...
    rb_define_const(rb_mProcess, "CLOCK_PROCESS_CPUTIME_ID", (((VALUE)((int)(2)))<<1 | RUBY_FIXNUM_FLAG));
    ...
    rb_define_const(rb_mProcess, "CLOCK_THREAD_CPUTIME_ID", (((VALUE)((int)(3)))<<1 | RUBY_FIXNUM_FLAG));
    rb_define_const(rb_mProcess, "CLOCK_REALTIME_COARSE", (((VALUE)((int)(5)))<<1 | RUBY_FIXNUM_FLAG));



    rb_define_const(rb_mProcess, "CLOCK_REALTIME_ALARM", (((VALUE)((int)(8)))<<1 | RUBY_FIXNUM_FLAG));
    rb_define_const(rb_mProcess, "CLOCK_MONOTONIC_RAW", (((VALUE)((int)(4)))<<1 | RUBY_FIXNUM_FLAG));
    ...
    rb_define_const(rb_mProcess, "CLOCK_MONOTONIC_COARSE", (((VALUE)((int)(6)))<<1 | RUBY_FIXNUM_FLAG));



    rb_define_const(rb_mProcess, "CLOCK_BOOTTIME", (((VALUE)((int)(7)))<<1 | RUBY_FIXNUM_FLAG));



    rb_define_const(rb_mProcess, "CLOCK_BOOTTIME_ALARM", (((VALUE)((int)(9)))<<1 | RUBY_FIXNUM_FLAG));
    rb_define_module_function(rb_mProcess, "clock_gettime", rb_clock_gettime, -1);
    rb_define_module_function(rb_mProcess, "clock_getres", rb_clock_getres, -1);


    rb_cProcessTms = rb_struct_define_under(rb_mProcess, "Tms", "utime", "stime", "cutime", "cstime", ((void*)0));
    ...
    rb_define_module_function(rb_mProcID_Syscall, "setruid", rb_f_notimplement, 1);
    rb_define_module_function(rb_mProcID_Syscall, "setrgid", rb_f_notimplement, 1);
    ...
    rb_define_module_function(rb_mProcID_Syscall, "issetugid", rb_f_notimplement, 0);
}

void
Init_process(void)
{
    id_in = (__builtin_constant_p("in") ?  (rb_intern2(("in"), (long)strlen("in"))) : (rb_intern)("in"));
    id_out = (__builtin_constant_p("out") ?  (rb_intern2(("out"), (long)strlen("out"))) : (rb_intern)("out"));
    id_err = (__builtin_constant_p("err") ?  (rb_intern2(("err"), (long)strlen("err"))) : (rb_intern)("err"));
    id_pid = (__builtin_constant_p("pid") ?  (rb_intern2(("pid"), (long)strlen("pid"))) : (rb_intern)("pid"));
    id_uid = (__builtin_constant_p("uid") ?  (rb_intern2(("uid"), (long)strlen("uid"))) : (rb_intern)("uid"));
    id_gid = (__builtin_constant_p("gid") ?  (rb_intern2(("gid"), (long)strlen("gid"))) : (rb_intern)("gid"));
    id_close = (__builtin_constant_p("close") ?  (rb_intern2(("close"), (long)strlen("close"))) : (rb_intern)("close"));
    id_child = (__builtin_constant_p("child") ?  (rb_intern2(("child"), (long)strlen("child"))) : (rb_intern)("child"));

    id_pgroup = (__builtin_constant_p("pgroup") ?  (rb_intern2(("pgroup"), (long)strlen("pgroup"))) : (rb_intern)("pgroup"));




    id_unsetenv_others = (__builtin_constant_p("unsetenv_others") ?  (rb_intern2(("unsetenv_others"), (long)strlen("unsetenv_others"))) : (rb_intern)("unsetenv_others"));
    id_chdir = (__builtin_constant_p("chdir") ?  (rb_intern2(("chdir"), (long)strlen("chdir"))) : (rb_intern)("chdir"));
    id_umask = (__builtin_constant_p("umask") ?  (rb_intern2(("umask"), (long)strlen("umask"))) : (rb_intern)("umask"));
    id_close_others = (__builtin_constant_p("close_others") ?  (rb_intern2(("close_others"), (long)strlen("close_others"))) : (rb_intern)("close_others"));
    id_ENV = (__builtin_constant_p("ENV") ?  (rb_intern2(("ENV"), (long)strlen("ENV"))) : (rb_intern)("ENV"));
    id_nanosecond = (__builtin_constant_p("nanosecond") ?  (rb_intern2(("nanosecond"), (long)strlen("nanosecond"))) : (rb_intern)("nanosecond"));
    id_microsecond = (__builtin_constant_p("microsecond") ?  (rb_intern2(("microsecond"), (long)strlen("microsecond"))) : (rb_intern)("microsecond"));
    id_millisecond = (__builtin_constant_p("millisecond") ?  (rb_intern2(("millisecond"), (long)strlen("millisecond"))) : (rb_intern)("millisecond"));
    id_second = (__builtin_constant_p("second") ?  (rb_intern2(("second"), (long)strlen("second"))) : (rb_intern)("second"));
    id_float_microsecond = (__builtin_constant_p("float_microsecond") ?  (rb_intern2(("float_microsecond"), (long)strlen("float_microsecond"))) : (rb_intern)("float_microsecond"));
    id_float_millisecond = (__builtin_constant_p("float_millisecond") ?  (rb_intern2(("float_millisecond"), (long)strlen("float_millisecond"))) : (rb_intern)("float_millisecond"));
    id_float_second = (__builtin_constant_p("float_second") ?  (rb_intern2(("float_second"), (long)strlen("float_second"))) : (rb_intern)("float_second"));
    id_GETTIMEOFDAY_BASED_CLOCK_REALTIME = (__builtin_constant_p("GETTIMEOFDAY_BASED_CLOCK_REALTIME") ?  (rb_intern2(("GETTIMEOFDAY_BASED_CLOCK_REALTIME"), (long)strlen("GETTIMEOFDAY_BASED_CLOCK_REALTIME"))) : (rb_intern)("GETTIMEOFDAY_BASED_CLOCK_REALTIME"));
    id_TIME_BASED_CLOCK_REALTIME = (__builtin_constant_p("TIME_BASED_CLOCK_REALTIME") ?  (rb_intern2(("TIME_BASED_CLOCK_REALTIME"), (long)strlen("TIME_BASED_CLOCK_REALTIME"))) : (rb_intern)("TIME_BASED_CLOCK_REALTIME"));

    id_TIMES_BASED_CLOCK_MONOTONIC = (__builtin_constant_p("TIMES_BASED_CLOCK_MONOTONIC") ?  (rb_intern2(("TIMES_BASED_CLOCK_MONOTONIC"), (long)strlen("TIMES_BASED_CLOCK_MONOTONIC"))) : (rb_intern)("TIMES_BASED_CLOCK_MONOTONIC"));
    id_TIMES_BASED_CLOCK_PROCESS_CPUTIME_ID = (__builtin_constant_p("TIMES_BASED_CLOCK_PROCESS_CPUTIME_ID") ?  (rb_intern2(("TIMES_BASED_CLOCK_PROCESS_CPUTIME_ID"), (long)strlen("TIMES_BASED_CLOCK_PROCESS_CPUTIME_ID"))) : (rb_intern)("TIMES_BASED_CLOCK_PROCESS_CPUTIME_ID"));


    id_GETRUSAGE_BASED_CLOCK_PROCESS_CPUTIME_ID = (__builtin_constant_p("GETRUSAGE_BASED_CLOCK_PROCESS_CPUTIME_ID") ?  (rb_intern2(("GETRUSAGE_BASED_CLOCK_PROCESS_CPUTIME_ID"), (long)strlen("GETRUSAGE_BASED_CLOCK_PROCESS_CPUTIME_ID"))) : (rb_intern)("GETRUSAGE_BASED_CLOCK_PROCESS_CPUTIME_ID"));

    id_CLOCK_BASED_CLOCK_PROCESS_CPUTIME_ID = (__builtin_constant_p("CLOCK_BASED_CLOCK_PROCESS_CPUTIME_ID") ?  (rb_intern2(("CLOCK_BASED_CLOCK_PROCESS_CPUTIME_ID"), (long)strlen("CLOCK_BASED_CLOCK_PROCESS_CPUTIME_ID"))) : (rb_intern)("CLOCK_BASED_CLOCK_PROCESS_CPUTIME_ID"));



    id_hertz = (__builtin_constant_p("hertz") ?  (rb_intern2(("hertz"), (long)strlen("hertz"))) : (rb_intern)("hertz"));

    {void InitVM_process(void);InitVM_process();};
}
