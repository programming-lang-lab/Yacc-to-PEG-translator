...
Init_id(void)
{
    ...
    register_static_symid((idMax), ("max"), strlen("max"), enc);
    register_static_symid((idMin), ("min"), strlen("min"), enc);
    register_static_symid((idFreeze), ("freeze"), strlen("freeze"), enc);
    register_static_symid((idInspect), ("inspect"), strlen("inspect"), enc);
    register_static_symid((idIntern), ("intern"), strlen("intern"), enc);
    register_static_symid((idObject_id), ("object_id"), strlen("object_id"), enc);
    register_static_symid((idConst_missing), ("const_missing"), strlen("const_missing"), enc);
    register_static_symid((idMethodMissing), ("method_missing"), strlen("method_missing"), enc);
    register_static_symid((idMethod_added), ("method_added"), strlen("method_added"), enc);
    register_static_symid((idSingleton_method_added), ("singleton_method_added"), strlen("singleton_method_added"), enc);
    register_static_symid((idMethod_removed), ("method_removed"), strlen("method_removed"), enc);
    register_static_symid((idSingleton_method_removed), ("singleton_method_removed"), strlen("singleton_method_removed"), enc);
    register_static_symid((idMethod_undefined), ("method_undefined"), strlen("method_undefined"), enc);
    register_static_symid((idSingleton_method_undefined), ("singleton_method_undefined"), strlen("singleton_method_undefined"), enc);
    register_static_symid((idLength), ("length"), strlen("length"), enc);
    register_static_symid((idSize), ("size"), strlen("size"), enc);
    register_static_symid((idGets), ("gets"), strlen("gets"), enc);
    register_static_symid((idSucc), ("succ"), strlen("succ"), enc);
    register_static_symid((idEach), ("each"), strlen("each"), enc);
    register_static_symid((idProc), ("proc"), strlen("proc"), enc);
    register_static_symid((idLambda), ("lambda"), strlen("lambda"), enc);
    register_static_symid((idSend), ("send"), strlen("send"), enc);
    register_static_symid((id__send__), ("__send__"), strlen("__send__"), enc);
    register_static_symid((id__attached__), ("__attached__"), strlen("__attached__"), enc);
    register_static_symid((idInitialize), ("initialize"), strlen("initialize"), enc);
    register_static_symid((idInitialize_copy), ("initialize_copy"), strlen("initialize_copy"), enc);
    register_static_symid((idInitialize_clone), ("initialize_clone"), strlen("initialize_clone"), enc);
    register_static_symid((idInitialize_dup), ("initialize_dup"), strlen("initialize_dup"), enc);
    register_static_symid((idTo_int), ("to_int"), strlen("to_int"), enc);
    register_static_symid((idTo_ary), ("to_ary"), strlen("to_ary"), enc);
    register_static_symid((idTo_str), ("to_str"), strlen("to_str"), enc);
    register_static_symid((idTo_sym), ("to_sym"), strlen("to_sym"), enc);
    register_static_symid((idTo_hash), ("to_hash"), strlen("to_hash"), enc);
    register_static_symid((idTo_proc), ("to_proc"), strlen("to_proc"), enc);
    register_static_symid((idTo_io), ("to_io"), strlen("to_io"), enc);
    register_static_symid((idTo_a), ("to_a"), strlen("to_a"), enc);
    register_static_symid((idTo_s), ("to_s"), strlen("to_s"), enc);
    register_static_symid((idTo_i), ("to_i"), strlen("to_i"), enc);
    register_static_symid((idTo_r), ("to_r"), strlen("to_r"), enc);
    register_static_symid((idBt), ("bt"), strlen("bt"), enc);
    register_static_symid((idBt_locations), ("bt_locations"), strlen("bt_locations"), enc);
    register_static_symid((idCall), ("call"), strlen("call"), enc);
    register_static_symid((idMesg), ("mesg"), strlen("mesg"), enc);
    register_static_symid((idException), ("exception"), strlen("exception"), enc);
    register_static_symid((idNOT), ("not"), strlen("not"), enc);
    register_static_symid((idAND), ("and"), strlen("and"), enc);
    register_static_symid((idOR), ("or"), strlen("or"), enc);
    register_static_symid((idUScore), ("_"), strlen("_"), enc);
    register_static_symid((idNULL), (""), strlen(""), enc);
    register_static_symid((idEmptyP), ("empty?"), strlen("empty?"), enc);
    register_static_symid((idEqlP), ("eql?"), strlen("eql?"), enc);
    register_static_symid((idRespond_to), ("respond_to?"), strlen("respond_to?"), enc);
    register_static_symid((idRespond_to_missing), ("respond_to_missing?"), strlen("respond_to_missing?"), enc);
    register_static_symid((idIFUNC), ("<IFUNC>"), strlen("<IFUNC>"), enc);
    register_static_symid((idCFUNC), ("<CFUNC>"), strlen("<CFUNC>"), enc);
    register_static_symid((id_core_set_method_alias), ("core#set_method_alias"), strlen("core#set_method_alias"), enc);
    register_static_symid((id_core_set_variable_alias), ("core#set_variable_alias"), strlen("core#set_variable_alias"), enc);
    register_static_symid((id_core_undef_method), ("core#undef_method"), strlen("core#undef_method"), enc);
    register_static_symid((id_core_define_method), ("core#define_method"), strlen("core#define_method"), enc);
    register_static_symid((id_core_define_singleton_method), ("core#define_singleton_method"), strlen("core#define_singleton_method"), enc);
    register_static_symid((id_core_set_postexe), ("core#set_postexe"), strlen("core#set_postexe"), enc);
    register_static_symid((id_core_hash_from_ary), ("core#hash_from_ary"), strlen("core#hash_from_ary"), enc);
    register_static_symid((id_core_hash_merge_ary), ("core#hash_merge_ary"), strlen("core#hash_merge_ary"), enc);
    register_static_symid((id_core_hash_merge_ptr), ("core#hash_merge_ptr"), strlen("core#hash_merge_ptr"), enc);
    register_static_symid((id_core_hash_merge_kwd), ("core#hash_merge_kwd"), strlen("core#hash_merge_kwd"), enc);
    register_static_symid((idLASTLINE), ("$_"), strlen("$_"), enc);
    register_static_symid((idBACKREF), ("$~"), strlen("$~"), enc);
}




extern int (*__Static_assert_function (void)) [!!sizeof (struct { int __error_if_negative: (sizeof(op_tbl[0].name) == 3) ? 2 : -1; })];
...
Init_op_tbl(void)
{
 ...
 if (!rb_isalnum(i) && i != '_') {
    ...
    for (i = 0; i < ((int)(sizeof(op_tbl) / sizeof((op_tbl)[0]))); ++i) {
 register_static_symid(op_tbl[i].token, op_tbl[i].name, (!op_tbl[i].name[1] ? 1 : !op_tbl[i].name[2] ? 2 : 3), enc);
    }
}
...
rb_id_attrset(ID id)
{
 ...
 rb_name_error(id, "cannot make operator ID :%li\v attrset",
        rb_id2str(id));
    }
    else {
 scope = id_type(id);
 switch (scope) {
   case RUBY_ID_LOCAL: case RUBY_ID_INSTANCE: case RUBY_ID_GLOBAL:
   case RUBY_ID_CONST: case RUBY_ID_CLASS: case RUBY_ID_JUNK:
     break;
   case RUBY_ID_ATTRSET:
     return id;
   default:
     {
  if ((str = lookup_id_str(id)) != 0) {
      rb_name_error(id, "cannot make unknown type ID %d:%li\v attrset",
      scope, str);
  }
  else {
      rb_name_error_str(((VALUE)RUBY_Qnil), "cannot make unknown type anonymous ID %d:%lx attrset",
          scope, (VALUE)id);
  }
     }
 }
 ...
 rb_name_error(id, "cannot make anonymous %.*s ID %lx attrset",
...
is_special_global_name(const char *m, const char *e, rb_encoding *enc)
{
 ...
 if (++m >= e) return 0;
 if ((rb_isalnum((unsigned char)*(m)) || (*(m)) == '_' || !rb_isascii(*(m)))) {
     if (!rb_isascii(*m)) mb = 1;
     m += rb_enc_mbclen(m, e, enc);
 }
    }
    else {
 if (!rb_isdigit(*m)) return 0;
 do {
     if (!rb_isascii(*m)) mb = 1;
     ++m;
 } while (m < e && rb_isdigit(*m));
    }
    return m == e ? mb + 1 : 0;
}
...
rb_enc_symname_type(const char *name, long len, rb_encoding *enc, unsigned int allowed_attrset)
{
    const char *m = name;
    const char *e = m + len;
    int type = RUBY_ID_JUNK;

    if (!rb_enc_asciicompat_inline(enc)) return -1;
    if (!m || len <= 0) return -1;
    switch (*m) {
      case '\0':
 return -1;
 ...
 break;
      ...
      case '!':
 if (len == 1) return RUBY_ID_JUNK;
 switch (*++m) {
   case '=': case '~': ++m; break;
   default:
     if (allowed_attrset & (1U << RUBY_ID_JUNK)) goto id;
     return -1;
 }
 break;

      default:
 type = rb_isupper(*m) ? RUBY_ID_CONST : RUBY_ID_LOCAL;
      id:
 if (m >= e || (*m != '_' && !rb_isalpha(*m) && rb_isascii(*m))) {
     if (len > 1 && *(e-1) == '=') {
  type = rb_enc_symname_type(name, len-1, enc, allowed_attrset);
  if (type != RUBY_ID_ATTRSET) return RUBY_ID_ATTRSET;
     }
     return -1;
 }
 while (m < e && (rb_isalnum((unsigned char)*(m)) || (*(m)) == '_' || !rb_isascii(*(m)))) m += rb_enc_mbclen(m, e, enc);
 if (m >= e) break;
 switch (*m) {
   case '!': case '?':
     if (type == RUBY_ID_GLOBAL || type == RUBY_ID_CLASS || type == RUBY_ID_INSTANCE) return -1;
     type = RUBY_ID_JUNK;
     ++m;
     if (m + 1 < e || *m != '=') break;
...
{
    return rb_enc_symname_type(name, len, enc, ((1U<<RUBY_ID_LOCAL)|(1U<<RUBY_ID_CONST))) != -1;
}

static int
rb_str_symname_type(VALUE name, unsigned int allowed_attrset)
{
    const char *ptr = rb_string_value_ptr(&(name));
    ...
    (* ({ volatile VALUE *rb_gc_guarded_ptr = &(name); ; rb_gc_guarded_ptr; }));
    return type;
}
...
set_id_entry(rb_id_serial_t num, VALUE str, VALUE sym)
{
    ...
    if (idx >= (size_t)rb_array_len(ids) || !((VALUE)(ary = rb_ary_entry(ids, (long)idx)) != ((VALUE)RUBY_Qnil))) {
...
get_id_entry(rb_id_serial_t num, const enum id_entry_type t)
{
 ...
 if (idx < (size_t)rb_array_len(ids) && !!((VALUE)(ary = rb_ary_entry(ids, (long)idx)) != ((VALUE)RUBY_Qnil))) {
     ...
     if (!!((VALUE)(result) != ((VALUE)RUBY_Qnil))) return result;
 }
    }
    return 0;
}
...
unregister_sym(VALUE str, VALUE sym)
{
    ...
    if (!st_delete(global_symbols.str_sym, &str_data, ((void*)0))) {
 rb_bug("%p can't remove str from str_id (%s)", (void *)sym, (!(((struct RBasic*)(str))->flags & RSTRING_NOEMBED) ? ((struct RString*)(str))->as.ary : ((struct RString*)(str))->as.heap.ptr));
    }
}
...
{
    VALUE str =  ({ (__builtin_constant_p(name) && __builtin_constant_p(len)) ? rb_enc_str_new_static((name), (len), (enc)) : rb_enc_str_new((name), (len), (enc)); });
...
register_static_symid_str(ID id, VALUE str)
{
    ...
    VALUE sym = (((VALUE)(id)<<RUBY_SPECIAL_SHIFT)|RUBY_SYMBOL_FLAG);
...
{
    if (!rb_enc_asciicompat_inline(rb_enc_get(str))) return FALSE;
    switch (rb_enc_str_coderange(str)) {
      case RUBY_ENC_CODERANGE_BROKEN:
 rb_raise(rb_eEncodingError, "invalid symbol in encoding %s :%+li\v",
   (rb_enc_get(str))->name, str);
...
{
    const VALUE dsym = rb_newobj_of(klass, RUBY_T_SYMBOL | ((VALUE)RUBY_FL_WB_PROTECTED));
    long hashval;

    rb_enc_associate(dsym, enc);
    rb_obj_freeze_inline((VALUE)dsym);
    rb_obj_write((VALUE)(dsym), (VALUE *)(&((struct RSymbol*)(dsym))->fstr), (VALUE)(str), "symbol.c", 477);
    ((struct RSymbol*)(dsym))->id = type;


    hashval = (long)rb_str_hash(str);
    ((struct RSymbol*)(dsym))->hashval = (((long)hashval)>>(int)(1));

    register_sym(str, dsym);
    rb_hash_aset(global_symbols.dsymbol_fstr_hash, str, ((VALUE)RUBY_Qtrue));
...
{
    if ((__builtin_expect(!!(rb_objspace_garbage_object_p(sym)), 0))) {
 const VALUE fstr = ((struct RSymbol*)(sym))->fstr;
 const ID type = ((struct RSymbol*)(sym))->id & RUBY_ID_SCOPE_MASK;
 ((struct RSymbol*)(sym))->fstr = 0;
...
lookup_str_id(VALUE str)
{
 ...
 if ((((VALUE)(sym)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)) {
     return (((unsigned long)(sym))>>(int)(RUBY_SPECIAL_SHIFT));
 }
 else if ((!(((VALUE)(sym) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(sym) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(sym))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) {
     ID id = ((struct RSymbol*)(sym))->id;
     if (id & ~RUBY_ID_SCOPE_MASK) return id;
 }
 else {
     rb_bug("non-symbol object %s:%lx for %li\v in symbol table",
...
lookup_str_sym(const VALUE str)
{
 ...
 if ((!(((VALUE)(sym) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(sym) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(sym))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) {
...
rb_intern3(const char *name, long len, rb_encoding *enc)
{
    ...
    str =  ({ (__builtin_constant_p(name) && __builtin_constant_p(len)) ? rb_enc_str_new_static((name), (len), (enc)) : rb_enc_str_new((name), (len), (enc)); });
...
next_id_base(void)
{
 ...
 return num << RUBY_ID_SCOPE_SHIFT;
    }
}
...
intern_str(VALUE str, int mutable)
{
    ...
    id = rb_str_symname_type(str, (~(~0U<<(1<<RUBY_ID_SCOPE_SHIFT)) & ~(1U<<RUBY_ID_ATTRSET)));
    if (id == (ID)-1) id = RUBY_ID_JUNK;
 ...
 rb_raise(rb_eRuntimeError, "symbol table overflow (symbol %li\v)",
   str);
    }
    id |= nid;
    id |= RUBY_ID_STATIC_SYM;
    return register_static_symid_str(id, str);
}
...
{
    VALUE str = ((struct RSymbol*)(sym))->fstr;
...
rb_str_intern(VALUE str)
{
 ...
 str = rb_str_new_frozen(str);
    ...
    str = rb_fstring(str);
    type = rb_str_symname_type(str, (~(~0U<<(1<<RUBY_ID_SCOPE_SHIFT)) & ~(1U<<RUBY_ID_ATTRSET)));
    if (type < 0) type = RUBY_ID_JUNK;
...
rb_sym2id(VALUE sym)
{
    ID id;
    if ((((VALUE)(sym)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)) {
 id = (((unsigned long)(sym))>>(int)(RUBY_SPECIAL_SHIFT));
    }
    else if ((!(((VALUE)(sym) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(sym) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(sym))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) {
 sym = dsymbol_check(sym);
 id = ((struct RSymbol*)(sym))->id;
 if ((__builtin_expect(!!(!(id & ~RUBY_ID_SCOPE_MASK)), 0))) {
     VALUE fstr = ((struct RSymbol*)(sym))->fstr;
     ID num = next_id_base();

     ((struct RSymbol*)(sym))->id = id |= num;
...
rb_id2sym(ID x)
{
    if (!(!(x&RUBY_ID_STATIC_SYM)&&x>tLAST_OP_ID)) return (((VALUE)(x)<<RUBY_SPECIAL_SHIFT)|RUBY_SYMBOL_FLAG);
...
{
    if ((!(((VALUE)(sym) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(sym) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(sym))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) {
 return ((struct RSymbol*)(sym))->fstr;
    }
    else {
 return rb_id2str((((unsigned long)(sym))>>(int)(RUBY_SPECIAL_SHIFT)));
    }
}
...
{
    return next_id_base() | RUBY_ID_INTERNAL | RUBY_ID_STATIC_SYM;
}
...
symbols_i(st_data_t key, st_data_t value, st_data_t arg)
{
 ...
 rb_bug("invalid symbol: %s", (!(((struct RBasic*)((VALUE)key))->flags & RSTRING_NOEMBED) ? ((struct RString*)((VALUE)key))->as.ary : ((struct RString*)((VALUE)key))->as.heap.ptr));
    }
    else if (!(((struct RSymbol*)(sym))->id&~RUBY_ID_SCOPE_MASK) && rb_objspace_garbage_object_p(sym)) {
 ((struct RSymbol*)(sym))->fstr = 0;
 return ST_DELETE;
    }
    else {
...
{
    VALUE ary = rb_ary_new_capa(global_symbols.str_sym->num_entries);
...
{
    return (id_type(id)==RUBY_ID_CONST);
}

int
rb_is_class_id(ID id)
{
    return (id_type(id)==RUBY_ID_CLASS);
}

int
rb_is_global_id(ID id)
{
    return (id_type(id)==RUBY_ID_GLOBAL);
}

int
rb_is_instance_id(ID id)
{
    return (id_type(id)==RUBY_ID_INSTANCE);
}

int
rb_is_attrset_id(ID id)
{
    return ((id)==idASET||id_type(id)==RUBY_ID_ATTRSET);
}

int
rb_is_local_id(ID id)
{
    return (id_type(id)==RUBY_ID_LOCAL);
}

int
rb_is_junk_id(ID id)
{
    return (id_type(id)==RUBY_ID_JUNK);
}

int
rb_is_const_sym(VALUE sym)
{
    return (sym_type(sym)==RUBY_ID_CONST);
}

int
rb_is_class_sym(VALUE sym)
{
    return (sym_type(sym)==RUBY_ID_CLASS);
}

int
rb_is_global_sym(VALUE sym)
{
    return (sym_type(sym)==RUBY_ID_GLOBAL);
}

int
rb_is_instance_sym(VALUE sym)
{
    return (sym_type(sym)==RUBY_ID_INSTANCE);
}

int
rb_is_attrset_sym(VALUE sym)
{
    return (sym_type(sym)==RUBY_ID_ATTRSET);
}

int
rb_is_local_sym(VALUE sym)
{
    return (sym_type(sym)==RUBY_ID_LOCAL);
}

int
rb_is_junk_sym(VALUE sym)
{
    return (sym_type(sym)==RUBY_ID_JUNK);
}
ID
rb_check_id(volatile VALUE *namep)
{
    ...
    if ((((VALUE)(name)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)) {
 return (((unsigned long)(name))>>(int)(RUBY_SPECIAL_SHIFT));
    }
    else if ((!(((VALUE)(name) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(name) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(name))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) {
 if ((((struct RSymbol*)(name))->id&~RUBY_ID_SCOPE_MASK)) {
     return ((struct RSymbol*)(name))->id;
 }
 else {
     *namep = ((struct RSymbol*)(name))->fstr;
     return 0;
 }
    }
 ...
 if (!((VALUE)(tmp) != ((VALUE)RUBY_Qnil))) {
     rb_raise(rb_eTypeError, "%+li\v is not a symbol nor a string",
       name);
 }
 name = tmp;
 *namep = name;
...
{
    return rb_convert_type_with_id(obj, RUBY_T_SYMBOL, "Symbol", idTo_sym);
}
...
attrsetname_to_attr_id(VALUE name)
{
    ...
    const VALUE localname = rb_setup_fake_str(&fake_str,
           (!(((struct RBasic*)(name))->flags & RSTRING_NOEMBED) ? ((struct RString*)(name))->as.ary : ((struct RString*)(name))->as.heap.ptr), (!(((struct RBasic*)(name))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(name))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(name))->as.heap.len) - 1,
           rb_enc_get(name));
    rb_obj_freeze_inline((VALUE)localname);
...
{
    return rb_str_symname_type(name, 0) == RUBY_ID_CONST;
}

int
rb_is_class_name(VALUE name)
{
    return rb_str_symname_type(name, 0) == RUBY_ID_CLASS;
}

int
rb_is_global_name(VALUE name)
{
    return rb_str_symname_type(name, 0) == RUBY_ID_GLOBAL;
}

int
rb_is_instance_name(VALUE name)
{
    return rb_str_symname_type(name, 0) == RUBY_ID_INSTANCE;
}

int
rb_is_attrset_name(VALUE name)
{
    return rb_str_symname_type(name, (~(~0U<<(1<<RUBY_ID_SCOPE_SHIFT)) & ~(1U<<RUBY_ID_ATTRSET))) == RUBY_ID_ATTRSET;
}

int
rb_is_local_name(VALUE name)
{
    return rb_str_symname_type(name, 0) == RUBY_ID_LOCAL;
}
...
rb_is_method_name(VALUE name)
{
    switch (rb_str_symname_type(name, 0)) {
      case RUBY_ID_LOCAL: case RUBY_ID_ATTRSET: case RUBY_ID_JUNK:
 return TRUE;
    }
    return FALSE;
}
...
{
    return rb_str_symname_type(name, ((1U<<RUBY_ID_LOCAL)|(1U<<RUBY_ID_CONST))) == -1;
}
...
{
    memset((tbl), 0, sizeof(struct rb_id_table)*(size_t)(1));
    if (capa > 0) {
 capa = round_capa(capa);
 tbl->capa = (int)capa;
 tbl->items = ((item_t*)ruby_xcalloc((size_t)(capa),sizeof(item_t)));
    }
    return tbl;
}
...
{
    struct rb_id_table *tbl = ((struct rb_id_table*)ruby_xmalloc(sizeof(struct rb_id_table)));
...
rb_id_table_clear(struct rb_id_table *tbl)
{
    tbl->num = 0;
    tbl->used = 0;
    memset((tbl->items), 0, sizeof(item_t)*(size_t)(tbl->capa));
}
...
hash_table_index(struct rb_id_table* tbl, id_key_t key)
{
 ...
 int ix = key & mask;
 int d = 1;
 while (key != ((tbl)->items[ix].key)) {
     if (!((tbl)->items[ix].collision))
  return -1;
     ix = (ix + d) & mask;
     d++;
 }
...
hash_table_raw_insert(struct rb_id_table *tbl, id_key_t key, VALUE val)
{
    ...
    int ix = key & mask;
    int d = 1;
    __builtin_choose_expr( __builtin_constant_p(!1 +0), __builtin_choose_expr(!1 +0, ((key != 0) ? (void)0 : rb_assert_failure("./id_table.c", 152, __func__, "key != 0")), (void)0), ((!(!1 +0) || (key != 0)) ? (void)0 : rb_assert_failure("./id_table.c", 152, __func__, "key != 0")));
    while (((tbl)->items[ix].key)) {
 ((tbl)->items[ix].collision = 1);
 ix = (ix + d) & mask;
 d++;
    }
    tbl->num++;
...
hash_table_extend(struct rb_id_table* tbl)
{
 ...
 tmp_tbl.items = ((item_t*)ruby_xcalloc((size_t)(new_cap),sizeof(item_t)));
 for (i = 0; i < tbl->capa; i++) {
     id_key_t key = ((tbl)->items[i].key);
     if (key != 0) {
...
rb_id_table_foreach(struct rb_id_table *tbl, rb_id_table_foreach_func_t *func, void *data)
{
    ...
    for (i=0; i<capa; i++) {
 if (((tbl)->items[i].key)) {
     const id_key_t key = ((tbl)->items[i].key);
     enum rb_id_table_iterator_result ret = (*func)(key2id(key), tbl->items[i].val, data);
     __builtin_choose_expr( __builtin_constant_p(!1 +0), __builtin_choose_expr(!1 +0, ((key != 0) ? (void)0 : rb_assert_failure("./id_table.c", 278, __func__, "key != 0")), (void)0), ((!(!1 +0) || (key != 0)) ? (void)0 : rb_assert_failure("./id_table.c", 278, __func__, "key != 0")));
