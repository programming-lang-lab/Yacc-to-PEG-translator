...
static const OnigUChar EncKOI8_U_ToLowerCaseTable[256] = {
...
{
  if (code < 256)
    return ((EncKOI8_U_CtypeTable[code] & (1<<(ctype))) != 0);
  else
    return 0;
}
...
const OnigEncodingType OnigEncodingKOI8_U = {
