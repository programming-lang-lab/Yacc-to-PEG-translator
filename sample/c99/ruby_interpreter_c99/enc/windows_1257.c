    ...
    OnigEncoding enc )
{
  return onigenc_apply_all_case_fold_with_map(
             (int )(sizeof(CaseFoldMap) / sizeof((CaseFoldMap)[0])), CaseFoldMap, 1,
             flag, f, arg);
}
...
const OnigEncodingType OnigEncodingWindows_1257 = {
