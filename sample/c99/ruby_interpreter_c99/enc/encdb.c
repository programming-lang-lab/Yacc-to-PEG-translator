...
rb_encdb_declare("Big5");
rb_encdb_declare("Big5-HKSCS");
rb_encdb_declare("Big5-UAO");
rb_encdb_declare("CP949");
rb_encdb_declare("Emacs-Mule");
rb_encdb_declare("EUC-JP");
rb_encdb_declare("EUC-KR");
rb_encdb_declare("EUC-TW");
rb_encdb_declare("GB2312");
rb_encdb_declare("GB18030");
rb_encdb_declare("GBK");
rb_encdb_declare("ISO-8859-1");
rb_encdb_declare("ISO-8859-2");
rb_encdb_declare("ISO-8859-3");
rb_encdb_declare("ISO-8859-4");
rb_encdb_declare("ISO-8859-5");
rb_encdb_declare("ISO-8859-6");
rb_encdb_declare("ISO-8859-7");
rb_encdb_declare("ISO-8859-8");
rb_encdb_declare("ISO-8859-9");
rb_encdb_declare("ISO-8859-10");
rb_encdb_declare("ISO-8859-11");
rb_encdb_declare("ISO-8859-13");
rb_encdb_declare("ISO-8859-14");
rb_encdb_declare("ISO-8859-15");
rb_encdb_declare("ISO-8859-16");
rb_encdb_declare("KOI8-R");
rb_encdb_declare("KOI8-U");
rb_encdb_declare("Shift_JIS");
rb_encdb_declare("UTF-16BE");
rb_encdb_declare("UTF-16LE");
rb_encdb_declare("UTF-32BE");
rb_encdb_declare("UTF-32LE");
rb_encdb_declare("Windows-31J");
rb_encdb_declare("Windows-1250");
rb_encdb_declare("Windows-1251");
rb_encdb_declare("Windows-1252");
rb_encdb_declare("Windows-1253");
rb_encdb_declare("Windows-1254");
rb_encdb_declare("Windows-1257");
rb_encdb_alias(("BINARY"), ("ASCII-8BIT"));
rb_encdb_replicate(("IBM437"), ("ASCII-8BIT"));
rb_encdb_alias(("CP437"), ("IBM437"));
rb_encdb_replicate(("IBM737"), ("ASCII-8BIT"));
rb_encdb_alias(("CP737"), ("IBM737"));
rb_encdb_replicate(("IBM775"), ("ASCII-8BIT"));
rb_encdb_alias(("CP775"), ("IBM775"));
rb_encdb_replicate(("CP850"), ("ASCII-8BIT"));
rb_encdb_alias(("IBM850"), ("CP850"));
rb_encdb_replicate(("IBM852"), ("ASCII-8BIT"));
rb_encdb_replicate(("CP852"), ("IBM852"));
rb_encdb_replicate(("IBM855"), ("ASCII-8BIT"));
rb_encdb_replicate(("CP855"), ("IBM855"));
rb_encdb_replicate(("IBM857"), ("ASCII-8BIT"));
rb_encdb_alias(("CP857"), ("IBM857"));
rb_encdb_replicate(("IBM860"), ("ASCII-8BIT"));
rb_encdb_alias(("CP860"), ("IBM860"));
rb_encdb_replicate(("IBM861"), ("ASCII-8BIT"));
rb_encdb_alias(("CP861"), ("IBM861"));
rb_encdb_replicate(("IBM862"), ("ASCII-8BIT"));
rb_encdb_alias(("CP862"), ("IBM862"));
rb_encdb_replicate(("IBM863"), ("ASCII-8BIT"));
rb_encdb_alias(("CP863"), ("IBM863"));
rb_encdb_replicate(("IBM864"), ("ASCII-8BIT"));
rb_encdb_alias(("CP864"), ("IBM864"));
rb_encdb_replicate(("IBM865"), ("ASCII-8BIT"));
rb_encdb_alias(("CP865"), ("IBM865"));
rb_encdb_replicate(("IBM866"), ("ASCII-8BIT"));
rb_encdb_alias(("CP866"), ("IBM866"));
rb_encdb_replicate(("IBM869"), ("ASCII-8BIT"));
rb_encdb_alias(("CP869"), ("IBM869"));
rb_encdb_replicate(("Windows-1258"), ("ASCII-8BIT"));
rb_encdb_alias(("CP1258"), ("Windows-1258"));
rb_encdb_replicate(("GB1988"), ("ASCII-8BIT"));
rb_encdb_replicate(("macCentEuro"), ("ASCII-8BIT"));
rb_encdb_replicate(("macCroatian"), ("ASCII-8BIT"));
rb_encdb_replicate(("macCyrillic"), ("ASCII-8BIT"));
rb_encdb_replicate(("macGreek"), ("ASCII-8BIT"));
rb_encdb_replicate(("macIceland"), ("ASCII-8BIT"));
rb_encdb_replicate(("macRoman"), ("ASCII-8BIT"));
rb_encdb_replicate(("macRomania"), ("ASCII-8BIT"));
rb_encdb_replicate(("macThai"), ("ASCII-8BIT"));
rb_encdb_replicate(("macTurkish"), ("ASCII-8BIT"));
rb_encdb_replicate(("macUkraine"), ("ASCII-8BIT"));
rb_encdb_replicate(("CP950"), ("Big5"));
rb_enc_set_base(("Big5-HKSCS"), ("Big5"));
rb_encdb_alias(("Big5-HKSCS:2008"), ("Big5-HKSCS"));
rb_encdb_replicate(("CP951"), ("Big5-HKSCS"));
rb_enc_set_base(("Big5-UAO"), ("Big5"));
rb_encdb_dummy("IBM037");
rb_encdb_alias(("ebcdic-cp-us"), ("IBM037"));
rb_encdb_replicate(("stateless-ISO-2022-JP"), ("Emacs-Mule"));
rb_encdb_alias(("eucJP"), ("EUC-JP")) ;
rb_encdb_replicate(("eucJP-ms"), ("EUC-JP")) ;
rb_encdb_alias(("euc-jp-ms"), ("eucJP-ms"));
rb_encdb_replicate(("CP51932"), ("EUC-JP"));
rb_encdb_replicate(("EUC-JIS-2004"), ("EUC-JP")) ;
rb_encdb_alias(("EUC-JISX0213"), ("EUC-JIS-2004")) ;
rb_encdb_alias(("eucKR"), ("EUC-KR"));
rb_encdb_alias(("eucTW"), ("EUC-TW"));
rb_encdb_alias(("EUC-CN"), ("GB2312"));
rb_encdb_alias(("eucCN"), ("GB2312"));
rb_encdb_replicate(("GB12345"), ("GB2312"));
rb_encdb_alias(("CP936"), ("GBK"));
rb_encdb_dummy("ISO-2022-JP");
rb_encdb_alias(("ISO2022-JP"), ("ISO-2022-JP"));
rb_encdb_replicate(("ISO-2022-JP-2"), ("ISO-2022-JP"));
rb_encdb_alias(("ISO2022-JP2"), ("ISO-2022-JP-2"));
rb_encdb_replicate(("CP50220"), ("ISO-2022-JP"));
rb_encdb_replicate(("CP50221"), ("ISO-2022-JP"));
rb_encdb_alias(("ISO8859-1"), ("ISO-8859-1"));
rb_encdb_alias(("ISO8859-2"), ("ISO-8859-2"));
rb_encdb_alias(("ISO8859-3"), ("ISO-8859-3"));
rb_encdb_alias(("ISO8859-4"), ("ISO-8859-4"));
rb_encdb_alias(("ISO8859-5"), ("ISO-8859-5"));
rb_encdb_alias(("ISO8859-6"), ("ISO-8859-6"));
rb_encdb_replicate(("Windows-1256"), ("ISO-8859-6"));
rb_encdb_alias(("CP1256"), ("Windows-1256"));
rb_encdb_alias(("ISO8859-7"), ("ISO-8859-7"));
rb_encdb_alias(("ISO8859-8"), ("ISO-8859-8"));
rb_encdb_replicate(("Windows-1255"), ("ISO-8859-8"));
rb_encdb_alias(("CP1255"), ("Windows-1255"));
rb_encdb_alias(("ISO8859-9"), ("ISO-8859-9"));
rb_encdb_alias(("ISO8859-10"), ("ISO-8859-10"));
rb_encdb_alias(("ISO8859-11"), ("ISO-8859-11"));
rb_encdb_replicate(("TIS-620"), ("ISO-8859-11"));
rb_encdb_replicate(("Windows-874"), ("ISO-8859-11"));
rb_encdb_alias(("CP874"), ("Windows-874"));
rb_encdb_alias(("ISO8859-13"), ("ISO-8859-13"));
rb_encdb_alias(("ISO8859-14"), ("ISO-8859-14"));
rb_encdb_alias(("ISO8859-15"), ("ISO-8859-15"));
rb_encdb_alias(("ISO8859-16"), ("ISO-8859-16"));
rb_encdb_alias(("CP878"), ("KOI8-R"));
rb_encdb_replicate(("MacJapanese"), ("Shift_JIS"));
rb_encdb_alias(("MacJapan"), ("MacJapanese"));
rb_encdb_alias(("ASCII"), ("US-ASCII"));
rb_encdb_alias(("ANSI_X3.4-1968"), ("US-ASCII"));
rb_encdb_alias(("646"), ("US-ASCII"));
rb_encdb_dummy("UTF-7");
rb_encdb_alias(("CP65000"), ("UTF-7"));
rb_encdb_alias(("CP65001"), ("UTF-8"));
rb_encdb_replicate(("UTF8-MAC"), ("UTF-8"));
rb_encdb_alias(("UTF-8-MAC"), ("UTF8-MAC"));
rb_encdb_alias(("UTF-8-HFS"), ("UTF8-MAC")) ;
rb_encdb_set_unicode(rb_enc_set_dummy(rb_encdb_replicate((("UTF-16")), ("UTF-16BE"))));
rb_encdb_set_unicode(rb_enc_set_dummy(rb_encdb_replicate((("UTF-32")), ("UTF-32BE"))));
rb_encdb_alias(("UCS-2BE"), ("UTF-16BE"));
rb_encdb_alias(("UCS-4BE"), ("UTF-32BE"));
rb_encdb_alias(("UCS-4LE"), ("UTF-32LE"));
rb_encdb_alias(("CP932"), ("Windows-31J"));
rb_encdb_alias(("csWindows31J"), ("Windows-31J")) ;
rb_encdb_alias(("SJIS"), ("Windows-31J"));
rb_encdb_alias(("PCK"), ("Windows-31J"));
rb_encdb_alias(("CP1250"), ("Windows-1250"));
rb_encdb_alias(("CP1251"), ("Windows-1251"));
rb_encdb_alias(("CP1252"), ("Windows-1252"));
rb_encdb_alias(("CP1253"), ("Windows-1253"));
rb_encdb_alias(("CP1254"), ("Windows-1254"));
rb_encdb_alias(("CP1257"), ("Windows-1257"));
rb_encdb_replicate(("UTF8-DoCoMo"), ("UTF-8"));
rb_encdb_replicate(("SJIS-DoCoMo"), ("Windows-31J"));
rb_encdb_replicate(("UTF8-KDDI"), ("UTF-8"));
rb_encdb_replicate(("SJIS-KDDI"), ("Windows-31J"));
rb_encdb_replicate(("ISO-2022-JP-KDDI"), ("ISO-2022-JP"));
rb_encdb_replicate(("stateless-ISO-2022-JP-KDDI"), ("stateless-ISO-2022-JP"));
rb_encdb_replicate(("UTF8-SoftBank"), ("UTF-8"));
rb_encdb_replicate(("SJIS-SoftBank"), ("Windows-31J"));
}
