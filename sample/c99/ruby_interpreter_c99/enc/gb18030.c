...
static const signed char trans[][0x100] = {
  ...
  },
  {
            ...
            FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE,
            FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE,
            2, 2, 2, 2, 2, 2, 2, 2, 2, 2, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE,
            ACCEPT, ACCEPT, ACCEPT, ACCEPT, ACCEPT, ACCEPT, ACCEPT, ACCEPT, ACCEPT, ACCEPT, ACCEPT, ACCEPT, ACCEPT, ACCEPT, ACCEPT, ACCEPT,
            ACCEPT, ACCEPT, ACCEPT, ACCEPT, ACCEPT, ACCEPT, ACCEPT, ACCEPT, ACCEPT, ACCEPT, ACCEPT, ACCEPT, ACCEPT, ACCEPT, ACCEPT, ACCEPT,
            ACCEPT, ACCEPT, ACCEPT, ACCEPT, ACCEPT, ACCEPT, ACCEPT, ACCEPT, ACCEPT, ACCEPT, ACCEPT, ACCEPT, ACCEPT, ACCEPT, ACCEPT, ACCEPT,
  ...
  },
  {
            ...
            FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE,
            FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE,
            FAILURE, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3,
            ...
            3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3,
            3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3,
            3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, FAILURE
  },
  {
            FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE,
            FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE,
            FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE,
            ACCEPT, ACCEPT, ACCEPT, ACCEPT, ACCEPT, ACCEPT, ACCEPT, ACCEPT, ACCEPT, ACCEPT, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE,
            FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE,
            FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE,
            FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE,
            FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE,
...
static int
gb18030_mbc_enc_len(const OnigUChar* p, const OnigUChar* e, OnigEncoding enc )
{
  int firstbyte = *p++;
  ...
  if (s < 0) return s == ACCEPT ? (1) : (-1);
  if (p == e) return (-1-(2-1));
  s = trans[s][*p++];
  if (s < 0) return s == ACCEPT ? (2) : (-1);
  if (p == e) return (-1-(4-2));
  s = trans[s][*p++];
  if (s < 0) return s == ACCEPT ? (3) : (-1);
  if (p == e) return (-1-(4-3));
  s = trans[s][*p++];
  return s == ACCEPT ? (4) : (-1);
...
gb18030_mbc_to_code(const OnigUChar* p, const OnigUChar* end, OnigEncoding enc)
{
  int c, i, len;
  OnigCodePoint n;
...
static int
gb18030_code_to_mbc(OnigCodePoint code, OnigUChar *buf, OnigEncoding enc)
{
  return onigenc_mb4_code_to_mbc(enc, code, buf);
}

static int
gb18030_mbc_case_fold(OnigCaseFoldType flag, const OnigUChar** pp, const OnigUChar* end,
                      OnigUChar* lower, OnigEncoding enc)
{
...
static OnigUChar*
gb18030_left_adjust_char_head(const OnigUChar* start, const OnigUChar* s, const OnigUChar* end, OnigEncoding enc)
{
  const OnigUChar *p;
 ...
 break;
      ...
      break;
                                      ...
                                      ;
  switch (state) {
  case S_START: return (OnigUChar *)(s - 0);
  case S_one_C2: return (OnigUChar *)(s - 0);
  case S_one_C4: return (OnigUChar *)(s - 0);
  case S_one_CM: return (OnigUChar *)(s - 0);

  case S_odd_CM_one_CX: return (OnigUChar *)(s - 1);
  case S_even_CM_one_CX: return (OnigUChar *)(s - 0);

  case S_one_CMC4: return (OnigUChar *)(s - 1);
  case S_odd_CMC4: return (OnigUChar *)(s - 1);
  case S_one_C4_odd_CMC4: return (OnigUChar *)(s - 1);
  case S_even_CMC4: return (OnigUChar *)(s - 3);
  case S_one_C4_even_CMC4: return (OnigUChar *)(s - 3);

  case S_odd_CM_odd_CMC4: return (OnigUChar *)(s - 3);
  case S_even_CM_odd_CMC4: return (OnigUChar *)(s - 1);

  case S_odd_CM_even_CMC4: return (OnigUChar *)(s - 1);
  case S_even_CM_even_CMC4: return (OnigUChar *)(s - 3);

  case S_odd_C4CM: return (OnigUChar *)(s - 0);
  case S_one_CM_odd_C4CM: return (OnigUChar *)(s - 2);
  case S_even_C4CM: return (OnigUChar *)(s - 2);
  case S_one_CM_even_C4CM: return (OnigUChar *)(s - 0);

  case S_even_CM_odd_C4CM: return (OnigUChar *)(s - 0);
  case S_odd_CM_odd_C4CM: return (OnigUChar *)(s - 2);
  case S_even_CM_even_C4CM: return (OnigUChar *)(s - 2);
  case S_odd_CM_even_C4CM: return (OnigUChar *)(s - 0);
  }
...
static int
gb18030_is_allowed_reverse_match(const OnigUChar* s, const OnigUChar* end , OnigEncoding enc )
{
  return GB18030_MAP[*s] == C1 ? 1 : 0;
}
...
const OnigEncodingType OnigEncodingGB18030 = {
  gb18030_mbc_enc_len,
  "GB18030",
  4,
  1,
