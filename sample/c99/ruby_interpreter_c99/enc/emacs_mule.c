...
static const signed char trans[][0x100] = {
  {
            ...
            2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 4, 4, 5, 6, FAILURE, FAILURE,
  ...
  },
  {
            ...
            FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE,
            FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE,
            2, 2, 2, 2, 2, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE
  },
  {
            FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE,
            FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE,
            ...
            FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE,
            FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, FAILURE,
            FAILURE, FAILURE, FAILURE, FAILURE, FAILURE, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, FAILURE
  },
...
mbc_enc_len(const OnigUChar* p, const OnigUChar* e, OnigEncoding enc )
{
  ...
  if (s < 0) return s == ACCEPT ? (1) :
                                  (-1);
  if (p == e) return (-1-(EncLen_EmacsMule[firstbyte]-1));
  s = trans[s][*p++];
  if (s < 0) return s == ACCEPT ? (2) :
                                  (-1);
  if (p == e) return (-1-(EncLen_EmacsMule[firstbyte]-2));
  s = trans[s][*p++];
  if (s < 0) return s == ACCEPT ? (3) :
                                  (-1);
  if (p == e) return (-1-(EncLen_EmacsMule[firstbyte]-3));
  s = trans[s][*p++];
  return s == ACCEPT ? (4) :
                       (-1);
}
...
code_to_mbc(OnigCodePoint code, OnigUChar *buf, OnigEncoding enc)
{
  ...
  if ((code & 0xff000000) != 0) *p++ = (OnigUChar )(((code >> 24) & 0xff));
...
left_adjust_char_head(const OnigUChar* start, const OnigUChar* s, const OnigUChar* end, OnigEncoding enc)
{
  ...
  while (!((OnigUChar )(*p) < 0x9e) && p > start) p--;
  return (OnigUChar* )p;
}
...
const OnigEncodingType OnigEncodingEmacs_Mule = {
  mbc_enc_len,
  "Emacs-Mule",
  4,
  1,
