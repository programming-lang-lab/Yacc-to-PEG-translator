...
{
    rb_event_flag_t new_iseq_events = vm_events & (0x0001 | 0x0002 | 0x0004 | 0x0008 | 0x0010| 0x0100| 0x0200);
    rb_event_flag_t enabled_iseq_events = ruby_vm_event_enabled_flags & (0x0001 | 0x0002 | 0x0004 | 0x0008 | 0x0010| 0x0100| 0x0200);
...
alloc_event_hook(rb_event_hook_func_t func, rb_event_flag_t events, VALUE data, rb_event_hook_flag_t hook_flags)
{
    ...
    if ((events & 0xffff0000) && (events & ~0xffff0000)) {
 rb_raise(rb_eTypeError, "Can not specify normal event and internal event simultaneously.");
    }

    hook = ((rb_event_hook_t*)ruby_xmalloc(sizeof(rb_event_hook_t)));
...
{
    rb_threadptr_add_event_hook(rb_current_execution_context(), rb_thread_ptr(thval), func, events, data, RUBY_EVENT_HOOK_FLAG_SAFE);
}
...
rb_add_event_hook(rb_event_hook_func_t func, rb_event_flag_t events, VALUE data)
{
    ...
    connect_event_hook(rb_current_execution_context(), hook);
}
...
{
    rb_threadptr_add_event_hook(rb_current_execution_context(), rb_thread_ptr(thval), func, events, data, hook_flags);
}
...
{
    if ((__builtin_expect(!!(list->need_clean != FALSE), 0))) {
...
remove_event_hook(const rb_execution_context_t *ec, const rb_thread_t *filter_th, rb_event_hook_func_t func, VALUE data)
{
 ...
 if (func == 0 || hook->func == func) {
     if (hook->filter.th == filter_th || filter_th == ((rb_thread_t *)1)) {
  if (data == ((VALUE)RUBY_Qundef) || hook->data == data) {
...
{
    return rb_threadptr_remove_event_hook(rb_current_execution_context(), rb_thread_ptr(thval), func, ((VALUE)RUBY_Qundef));
}

int
rb_thread_remove_event_hook_with_data(VALUE thval, rb_event_hook_func_t func, VALUE data)
{
    return rb_threadptr_remove_event_hook(rb_current_execution_context(), rb_thread_ptr(thval), func, data);
}

int
rb_remove_event_hook(rb_event_hook_func_t func)
{
    return remove_event_hook(rb_current_execution_context(), ((void*)0), func, ((VALUE)RUBY_Qundef));
}

int
rb_remove_event_hook_with_data(rb_event_hook_func_t func, VALUE data)
{
    return remove_event_hook(rb_current_execution_context(), ((void*)0), func, data);
}
...
rb_clear_trace_func(void)
{
    ...
    rb_threadptr_remove_event_hook(ec, ((rb_thread_t *)1), 0, ((VALUE)RUBY_Qundef));
}

void
rb_ec_clear_current_thread_trace_func(const rb_execution_context_t *ec)
{
    rb_threadptr_remove_event_hook(ec, rb_ec_thread_ptr(ec), 0, ((VALUE)RUBY_Qundef));
}
...
rb_exec_event_hooks(rb_trace_arg_t *trace_arg, int pop_p)
{
    ...
    if (trace_arg->event & 0xffff0000) {
 if (ec->trace_arg && (ec->trace_arg->event & 0xffff0000)) {
...
rb_suppress_tracing(VALUE (*func)(VALUE), VALUE arg)
{
    ...
    rb_execution_context_t *const ec = rb_current_execution_context();
 ...
 ec->trace_arg = &dummy_trace_arg;
    ...
    do { rb_execution_context_t * const _ec = (ec); struct rb_vm_tag _tag; _tag.state = RUBY_TAG_NONE; _tag.tag = ((VALUE)RUBY_Qundef); _tag.prev = _ec->tag;;
    if ((__builtin_expect(!!((state = (__builtin_setjmp((_tag.buf)) ? rb_ec_tag_state((*(int volatile *)&(_ec))) : ((void)(_ec->tag = &_tag), 0))) == RUBY_TAG_NONE), 1))) {
 result = (*func)(arg);
    }
    else {
 (void)*&vm;
...
set_trace_func(VALUE obj, VALUE trace)
{
    ...
    if (!((VALUE)(trace) != ((VALUE)RUBY_Qnil))) {
 ...
 rb_raise(rb_eTypeError, "trace_func needs to be Proc");
    ...
    rb_add_event_hook(call_trace_func, 0x00ff, trace);
    return trace;
}
...
thread_add_trace_func(rb_execution_context_t *ec, rb_thread_t *filter_th, VALUE trace)
{
 ...
 rb_raise(rb_eTypeError, "trace_func needs to be Proc");
    ...
    rb_threadptr_add_event_hook(ec, filter_th, call_trace_func, 0x00ff, trace, RUBY_EVENT_HOOK_FLAG_SAFE);
}
static VALUE
thread_add_trace_func_m(VALUE obj, VALUE trace)
{
    thread_add_trace_func(rb_current_execution_context(), rb_thread_ptr(obj), trace);
    return trace;
}
static VALUE
thread_set_trace_func_m(VALUE target_thread, VALUE trace)
{
    ...
    rb_threadptr_remove_event_hook(ec, target_th, call_trace_func, ((VALUE)RUBY_Qundef));
...
{
    switch (event) {
      case 0x0001: return "line";
      case 0x0002: return "class";
      case 0x0004: return "end";
      case 0x0008: return "call";
      case 0x0010: return "return";
      case 0x0020: return "c-call";
      case 0x0040: return "c-return";
      case 0x0080: return "raise";
      default:
 return "unknown";
    }
}
...
get_event_id(rb_event_flag_t event)
{
 ...
 case 0x0001: do { static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("line")), (long)strlen(("line"))); (id) = rb_intern_id_cache; } while (0); return id;;
 case 0x0002: do { static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("class")), (long)strlen(("class"))); (id) = rb_intern_id_cache; } while (0); return id;;
 case 0x0004: do { static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("end")), (long)strlen(("end"))); (id) = rb_intern_id_cache; } while (0); return id;;
 case 0x0008: do { static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("call")), (long)strlen(("call"))); (id) = rb_intern_id_cache; } while (0); return id;;
 case 0x0010: do { static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("return")), (long)strlen(("return"))); (id) = rb_intern_id_cache; } while (0); return id;;
 case 0x0020: do { static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("c_call")), (long)strlen(("c_call"))); (id) = rb_intern_id_cache; } while (0); return id;;
 case 0x0040: do { static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("c_return")), (long)strlen(("c_return"))); (id) = rb_intern_id_cache; } while (0); return id;;
 case 0x0080: do { static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("raise")), (long)strlen(("raise"))); (id) = rb_intern_id_cache; } while (0); return id;;
 case 0x0100: do { static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("b_call")), (long)strlen(("b_call"))); (id) = rb_intern_id_cache; } while (0); return id;;
 case 0x0200: do { static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("b_return")), (long)strlen(("b_return"))); (id) = rb_intern_id_cache; } while (0); return id;;
 case 0x0400: do { static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("thread_begin")), (long)strlen(("thread_begin"))); (id) = rb_intern_id_cache; } while (0); return id;;
 case 0x0800: do { static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("thread_end")), (long)strlen(("thread_end"))); (id) = rb_intern_id_cache; } while (0); return id;;
 case 0x1000: do { static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("fiber_switch")), (long)strlen(("fiber_switch"))); (id) = rb_intern_id_cache; } while (0); return id;;
 ...
 *pathp = rb_iseq_path(iseq);
 ...
 if (event & (0x0002 |
    0x0008 |
    0x0100)) {
     *linep = ((int)rb_fix2int((VALUE)(rb_iseq_first_lineno(iseq))));
 }
 else {
...
call_trace_func(rb_event_flag_t event, VALUE proc, VALUE self, ID id, VALUE klass)
{
    int line;
    VALUE filename;
    VALUE eventname =  ({ (__builtin_constant_p(get_event_name(event))) ? rb_str_new_static((get_event_name(event)), (long)strlen(get_event_name(event))) : rb_str_new_cstr(get_event_name(event)); });
    VALUE argv[6];
    const rb_execution_context_t *ec = rb_current_execution_context();
 ...
 if (( ((RUBY_T_ICLASS) == RUBY_T_FIXNUM) ? (((int)(long)(klass))&RUBY_FIXNUM_FLAG) : ((RUBY_T_ICLASS) == RUBY_T_TRUE) ? ((klass) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_ICLASS) == RUBY_T_FALSE) ? ((klass) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_ICLASS) == RUBY_T_NIL) ? ((klass) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_ICLASS) == RUBY_T_UNDEF) ? ((klass) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_ICLASS) == RUBY_T_SYMBOL) ? ((((VALUE)(klass)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(klass) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(klass) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(klass))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_ICLASS) == RUBY_T_FLOAT) ? ( ((((int)(long)(klass))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(klass) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(klass) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(klass))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(klass) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(klass) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(klass))->flags & RUBY_T_MASK) == (RUBY_T_ICLASS)))) {
 ...
 else if (((!(((VALUE)(klass) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(klass) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(klass))->flags & RUBY_T_MASK) != RUBY_T_NODE)?(((struct RBasic*)((klass)))->flags&((((VALUE)RUBY_FL_SINGLETON)))):0)) {
    ...
    argv[0] = eventname;
    argv[1] = filename;
    argv[2] = (((VALUE)(line))<<1 | RUBY_FIXNUM_FLAG);
    argv[3] = id ? (rb_id2sym(id)) : ((VALUE)RUBY_Qnil);
    argv[4] = (self && (filename != ((VALUE)RUBY_Qnil))) ? rb_binding_new() : ((VALUE)RUBY_Qnil);
    argv[5] = klass ? klass : ((VALUE)RUBY_Qnil);

    rb_proc_call_with_block(proc, 6, argv, ((VALUE)RUBY_Qnil));
}
...
static const rb_data_type_t tp_data_type = {
    "tracepoint",
    {tp_mark, ((RUBY_DATA_FUNC)0), tp_memsize,},
    0, 0, 1
};
...
{
    rb_tp_t *tp;
    return ({ VALUE data_struct_obj = rb_data_typed_object_zalloc(klass, sizeof(rb_tp_t), &tp_data_type); (void)((tp) = (rb_tp_t *)(((struct RData*)(data_struct_obj))->data));; data_struct_obj; });
}
...
symbol2event_flag(VALUE v)
{
 ...
 0x0008 | 0x0100 | 0x0020;
    const rb_event_flag_t RUBY_EVENT_A_RETURN =
 0x0010 | 0x0200 | 0x0040;


    do { static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("line")), (long)strlen(("line"))); (id) = rb_intern_id_cache; } while (0); if (sym == (rb_id2sym(id))) return 0x0001;
    do { static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("class")), (long)strlen(("class"))); (id) = rb_intern_id_cache; } while (0); if (sym == (rb_id2sym(id))) return 0x0002;
    do { static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("end")), (long)strlen(("end"))); (id) = rb_intern_id_cache; } while (0); if (sym == (rb_id2sym(id))) return 0x0004;
    do { static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("call")), (long)strlen(("call"))); (id) = rb_intern_id_cache; } while (0); if (sym == (rb_id2sym(id))) return 0x0008;
    do { static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("return")), (long)strlen(("return"))); (id) = rb_intern_id_cache; } while (0); if (sym == (rb_id2sym(id))) return 0x0010;
    do { static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("c_call")), (long)strlen(("c_call"))); (id) = rb_intern_id_cache; } while (0); if (sym == (rb_id2sym(id))) return 0x0020;
    do { static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("c_return")), (long)strlen(("c_return"))); (id) = rb_intern_id_cache; } while (0); if (sym == (rb_id2sym(id))) return 0x0040;
    do { static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("raise")), (long)strlen(("raise"))); (id) = rb_intern_id_cache; } while (0); if (sym == (rb_id2sym(id))) return 0x0080;
    do { static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("b_call")), (long)strlen(("b_call"))); (id) = rb_intern_id_cache; } while (0); if (sym == (rb_id2sym(id))) return 0x0100;
    do { static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("b_return")), (long)strlen(("b_return"))); (id) = rb_intern_id_cache; } while (0); if (sym == (rb_id2sym(id))) return 0x0200;
    do { static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("thread_begin")), (long)strlen(("thread_begin"))); (id) = rb_intern_id_cache; } while (0); if (sym == (rb_id2sym(id))) return 0x0400;
    do { static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("thread_end")), (long)strlen(("thread_end"))); (id) = rb_intern_id_cache; } while (0); if (sym == (rb_id2sym(id))) return 0x0800;
    do { static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("fiber_switch")), (long)strlen(("fiber_switch"))); (id) = rb_intern_id_cache; } while (0); if (sym == (rb_id2sym(id))) return 0x1000;
    do { static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("a_call")), (long)strlen(("a_call"))); (id) = rb_intern_id_cache; } while (0); if (sym == (rb_id2sym(id))) return RUBY_EVENT_A_CALL;
    do { static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("a_return")), (long)strlen(("a_return"))); (id) = rb_intern_id_cache; } while (0); if (sym == (rb_id2sym(id))) return RUBY_EVENT_A_RETURN;

    rb_raise(rb_eArgError, "unknown event: %li\v", rb_sym2str(sym));
}
...
{
    rb_tp_t *tp;
    ((tp) = (rb_tp_t*)rb_check_typeddata((tpval), (&tp_data_type)));
    return tp;
}
...
get_trace_arg(void)
{
    rb_trace_arg_t *trace_arg = rb_current_execution_context()->trace_arg;
    if (trace_arg == 0) {
...
{
    return (rb_id2sym(get_event_id(trace_arg->event)));
}

static void
fill_path_and_lineno(rb_trace_arg_t *trace_arg)
{
    if (trace_arg->path == ((VALUE)RUBY_Qundef)) {
...
rb_tracearg_lineno(rb_trace_arg_t *trace_arg)
{
    ...
    return (((VALUE)(trace_arg->lineno))<<1 | RUBY_FIXNUM_FLAG);
}
VALUE
...
fill_id_and_klass(rb_trace_arg_t *trace_arg)
{
 ...
 if (trace_arg->klass) {
     if (( ((RUBY_T_ICLASS) == RUBY_T_FIXNUM) ? (((int)(long)(trace_arg->klass))&RUBY_FIXNUM_FLAG) : ((RUBY_T_ICLASS) == RUBY_T_TRUE) ? ((trace_arg->klass) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_ICLASS) == RUBY_T_FALSE) ? ((trace_arg->klass) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_ICLASS) == RUBY_T_NIL) ? ((trace_arg->klass) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_ICLASS) == RUBY_T_UNDEF) ? ((trace_arg->klass) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_ICLASS) == RUBY_T_SYMBOL) ? ((((VALUE)(trace_arg->klass)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(trace_arg->klass) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(trace_arg->klass) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(trace_arg->klass))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_ICLASS) == RUBY_T_FLOAT) ? ( ((((int)(long)(trace_arg->klass))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(trace_arg->klass) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(trace_arg->klass) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(trace_arg->klass))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(trace_arg->klass) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(trace_arg->klass) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(trace_arg->klass))->flags & RUBY_T_MASK) == (RUBY_T_ICLASS)))) {
  trace_arg->klass = ((struct RBasic*)(trace_arg->klass))->klass;
     }
 }
 else {
     trace_arg->klass = ((VALUE)RUBY_Qnil);
 }
...
rb_tracearg_method_id(rb_trace_arg_t *trace_arg)
{
    ...
    return trace_arg->id ? (rb_id2sym(trace_arg->id)) : ((VALUE)RUBY_Qnil);
}
...
{
    fill_id_and_klass(trace_arg);
    return trace_arg->called_id ? (rb_id2sym(trace_arg->called_id)) : ((VALUE)RUBY_Qnil);
}
...
{
    if (trace_arg->event & (0x0010 | 0x0040 | 0x0200)) {

    }
    else {
 rb_raise(rb_eRuntimeError, "not supported by this event");
    }
    if (trace_arg->data == ((VALUE)RUBY_Qundef)) {
...
{
    if (trace_arg->event & (0x100000 | 0x200000)) {
...
tp_call_trace(VALUE tpval, rb_trace_arg_t *trace_arg)
{
 ...
 rb_proc_call_with_block((VALUE)tp->proc, 1, &tpval, ((VALUE)RUBY_Qnil));
    }
}
...
tracepoint_enable_m(VALUE tpval)
{
    ...
    if (rb_block_given_p()) {
 return rb_ensure(rb_yield, ((VALUE)RUBY_Qundef),
    previous_tracing ? rb_tracepoint_enable : rb_tracepoint_disable,
    tpval);
    }
    else {
 return previous_tracing ? ((VALUE)RUBY_Qtrue) : ((VALUE)RUBY_Qfalse);
    }
}
static VALUE
...
{
    rb_tp_t *tp = tpptr(tpval);
    return tp->tracing ? ((VALUE)RUBY_Qtrue) : ((VALUE)RUBY_Qfalse);
}
...
{
    rb_thread_t *target_th = ((void*)0);

    if (!(((VALUE)(target_thval) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) {
 target_th = rb_thread_ptr(target_thval);



    }
    return tracepoint_new(rb_cTracePoint, target_th, events, func, data, ((VALUE)RUBY_Qundef));
}
static VALUE
...
tracepoint_inspect(VALUE self)
{
 ...
 switch (trace_arg->event) {
  ...
  return rb_sprintf("#<TracePoint:%li\v@%li\v:%d in `%li\v'>",
      rb_tracearg_event(trace_arg),
      rb_tracearg_path(trace_arg),
      ((int)rb_fix2int((VALUE)(rb_tracearg_lineno(trace_arg)))),
      sym);
     }
   case 0x0008:
   case 0x0020:
   case 0x0010:
   case 0x0040:
     return rb_sprintf("#<TracePoint:%li\v `%li\v'@%li\v:%d>",
         rb_tracearg_event(trace_arg),
   ...
   case 0x0400:
   case 0x0800:
     return rb_sprintf("#<TracePoint:%li\v %li\v>",
         rb_tracearg_event(trace_arg),
         rb_tracearg_self(trace_arg));
   default:
   default_inspect:
     return rb_sprintf("#<TracePoint:%li\v@%li\v:%d>",
         rb_tracearg_event(trace_arg),
         rb_tracearg_path(trace_arg),
         ((int)rb_fix2int((VALUE)(rb_tracearg_lineno(trace_arg)))));
 }
...
{
    rb_vm_t *vm = rb_current_vm();
    vm->postponed_job_buffer = ((rb_postponed_job_t*)ruby_xmalloc2((size_t)(1000),sizeof(rb_postponed_job_t)));
         ...
         unsigned int flags, rb_postponed_job_func_t func, void *data, int max, int expected_index)
{
    ...
    if (({ int oldvaldup = (expected_index); __atomic_compare_exchange_n(&(vm->postponed_job_index), &oldvaldup, (expected_index+1), 0, 5, 5); oldvaldup; }) == expected_index) {
 ...
 return PJRR_INTERRUPTED;
    ...
    __atomic_fetch_or(&((ec)->interrupt_flag), (POSTPONED_JOB_INTERRUPT_MASK), 5);
...
rb_postponed_job_register(unsigned int flags, rb_postponed_job_func_t func, void *data)
{
  ...
  begin:
    switch (postponed_job_register(ec, vm, flags, func, data, 1000, vm->postponed_job_index)) {
...
rb_postponed_job_register_one(unsigned int flags, rb_postponed_job_func_t func, void *data)
{
 ...
 if (pjob->func == func) {
    ...
    switch (postponed_job_register(ec, vm, flags, func, data, 1000 + 24, index)) {
      case PJRR_SUCESS : return 1;
      case PJRR_FULL : return 0;
      case PJRR_INTERRUPTED: goto begin;
      default: rb_bug("unreachable\n");
...
rb_postponed_job_flush(rb_vm_t *vm)
{
 ...
 if ((__builtin_setjmp((_tag.buf)) ? rb_ec_tag_state((*(int volatile *)&(_ec))) : ((void)(_ec->tag = &_tag), 0)) == RUBY_TAG_NONE) {
  ...
  if (({ int oldvaldup = (index); __atomic_compare_exchange_n(&(vm->postponed_job_index), &oldvaldup, (index-1), 0, 5, 5); oldvaldup; }) == index) {
