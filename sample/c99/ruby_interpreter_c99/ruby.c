...
enum feature_flag_bits {
    feature_gems , feature_did_you_mean , feature_rubyopt , feature_frozen_string_literal,
...
enum dump_flag_bits {
    dump_version_v,
    dump_version , dump_copyright , dump_usage , dump_help , dump_yydebug , dump_syntax , dump_parsetree , dump_parsetree_with_comment , dump_insns,
    dump_exit_bits = ((1U << dump_yydebug) | (1U << dump_syntax) |
        (1U << dump_parsetree) | (1U << dump_parsetree_with_comment) |
        (1U << dump_insns))
};
...
enum {
 ...
 0
 | (1U << feature_frozen_string_literal)
 | (1U << feature_debug_frozen_string_literal)
 ),
    DEFAULT_FEATURES = (
 ((1U << feature_debug_flag_first)-1)
...
{
    memset((opt), 0, sizeof(*opt)*(size_t)(1));
    init_ids(opt);
    opt->src.enc.index = rb_current_vm()->src_encoding_index;
    opt->ext.enc.index = -1;
...
usage(const char *name, int help)
{
 ...
 { "-0[octal]  specify record separator (\\0, if no argument)", (unsigned short)sizeof("-0[octal]"), (unsigned short)sizeof(""), },
 { "-a  autosplit mode with -n or -p (splits $_ into $F)", (unsigned short)sizeof("-a"), (unsigned short)sizeof(""), },
 { "-c  check syntax only", (unsigned short)sizeof("-c"), (unsigned short)sizeof(""), },
 { "-Cdirectory  cd to directory before executing your script", (unsigned short)sizeof("-Cdirectory"), (unsigned short)sizeof(""), },
 { "-d , --debug set debugging flags (set $DEBUG to true)", (unsigned short)sizeof("-d"), (unsigned short)sizeof(", --debug"), },
 { "-e 'command'  one line of script. Several -e's allowed. Omit [programfile]", (unsigned short)sizeof("-e 'command'"), (unsigned short)sizeof(""), },
 { "-Eex[:in] , --encoding=ex[:in] specify the default external and internal character encodings", (unsigned short)sizeof("-Eex[:in]"), (unsigned short)sizeof(", --encoding=ex[:in]"), },
 { "-Fpattern  split() pattern for autosplit (-a)", (unsigned short)sizeof("-Fpattern"), (unsigned short)sizeof(""), },
 { "-i[extension]  edit ARGV files in place (make backup if extension supplied)", (unsigned short)sizeof("-i[extension]"), (unsigned short)sizeof(""), },
 { "-Idirectory  specify $LOAD_PATH directory (may be used more than once)", (unsigned short)sizeof("-Idirectory"), (unsigned short)sizeof(""), },
 { "-l  enable line ending processing", (unsigned short)sizeof("-l"), (unsigned short)sizeof(""), },
 { "-n  assume 'while gets(); ... end' loop around your script", (unsigned short)sizeof("-n"), (unsigned short)sizeof(""), },
 { "-p  assume loop like -n but print line also like sed", (unsigned short)sizeof("-p"), (unsigned short)sizeof(""), },
 { "-rlibrary  require the library before executing your script", (unsigned short)sizeof("-rlibrary"), (unsigned short)sizeof(""), },
 { "-s  enable some switch parsing for switches after script name", (unsigned short)sizeof("-s"), (unsigned short)sizeof(""), },
 { "-S  look for the script using PATH environment variable", (unsigned short)sizeof("-S"), (unsigned short)sizeof(""), },
 { "-T[level=1]  turn on tainting checks", (unsigned short)sizeof("-T[level=1]"), (unsigned short)sizeof(""), },
 { "-v , --verbose print version number, then turn on verbose mode", (unsigned short)sizeof("-v"), (unsigned short)sizeof(", --verbose"), },
 { "-w  turn warnings on for your script", (unsigned short)sizeof("-w"), (unsigned short)sizeof(""), },
 { "-W[level=2]  set warning level; 0=silence, 1=medium, 2=verbose", (unsigned short)sizeof("-W[level=2]"), (unsigned short)sizeof(""), },
 { "-x[directory]  strip off text before #!ruby line and perhaps cd to directory", (unsigned short)sizeof("-x[directory]"), (unsigned short)sizeof(""), },
 { "-h  show this message, --help for more info", (unsigned short)sizeof("-h"), (unsigned short)sizeof(""), },
    };
    static const struct message help_msg[] = {
 { "--copyright  print the copyright", (unsigned short)sizeof("--copyright"), (unsigned short)sizeof(""), },
 { "--dump={insns|parsetree|...}[,...]  dump debug information. see below for available dump list", (unsigned short)sizeof("--dump={insns|parsetree|...}[,...]"), (unsigned short)sizeof(""), },

 { "--enable={gems|rubyopt|...}[,...] , --disable={gems|rubyopt|...}[,...] enable or disable features. see below for available features", (unsigned short)sizeof("--enable={gems|rubyopt|...}[,...]"), (unsigned short)sizeof(", --disable={gems|rubyopt|...}[,...]"), },

 { "--external-encoding=encoding , --internal-encoding=encoding specify the default external or internal character encoding", (unsigned short)sizeof("--external-encoding=encoding"), (unsigned short)sizeof(", --internal-encoding=encoding"), },

 { "--version  print the version", (unsigned short)sizeof("--version"), (unsigned short)sizeof(""), },
 { "--help  show this message, -h for short message", (unsigned short)sizeof("--help"), (unsigned short)sizeof(""), },
    };
    static const struct message dumps[] = {
 { "insns  instruction sequences", (unsigned short)sizeof("insns"), (unsigned short)sizeof(""), },
 { "yydebug  yydebug of yacc parser generator", (unsigned short)sizeof("yydebug"), (unsigned short)sizeof(""), },
 { "parsetree  AST", (unsigned short)sizeof("parsetree"), (unsigned short)sizeof(""), },
 { "parsetree_with_comment  AST with comments", (unsigned short)sizeof("parsetree_with_comment"), (unsigned short)sizeof(""), },
    };
    static const struct message features[] = {
 { "gems  rubygems (default: enabled)", (unsigned short)sizeof("gems"), (unsigned short)sizeof(""), },
 { "did_you_mean  did_you_mean (default: enabled)", (unsigned short)sizeof("did_you_mean"), (unsigned short)sizeof(""), },
 { "rubyopt  RUBYOPT environment variable (default: enabled)", (unsigned short)sizeof("rubyopt"), (unsigned short)sizeof(""), },
 { "frozen-string-literal  freeze all string literals (default: disabled)", (unsigned short)sizeof("frozen-string-literal"), (unsigned short)sizeof(""), },
    };
    int i;
    const int num = ((int)(sizeof(usage_msg) / sizeof((usage_msg)[0]))) - (help ? 1 : 0);


    printf("Usage: %s [switches] [--] [programfile] [arguments]\n", name);
    for (i = 0; i < num; ++i)
 show_usage_line((usage_msg[i]).str, (usage_msg[i]).namelen, (usage_msg[i]).secondlen, help);

    if (!help) return;

    for (i = 0; i < ((int)(sizeof(help_msg) / sizeof((help_msg)[0]))); ++i)
 show_usage_line((help_msg[i]).str, (help_msg[i]).namelen, (help_msg[i]).secondlen, help);
    puts("Dump List:");
    for (i = 0; i < ((int)(sizeof(dumps) / sizeof((dumps)[0]))); ++i)
 show_usage_line((dumps[i]).str, (dumps[i]).namelen, (dumps[i]).secondlen, help);
    puts("Features:");
    for (i = 0; i < ((int)(sizeof(features) / sizeof((features)[0]))); ++i)
 show_usage_line((features[i]).str, (features[i]).namelen, (features[i]).secondlen, help);
}
...
push_include(const char *path, VALUE (*filter)(VALUE))
{
    const char sep = ":"[0];
    const char *p, *s;
    VALUE load_path = rb_current_vm()->load_path;
 ...
 while (*p == sep)
     p++;
 if (!*p) break;
 for (s = p; *s && *s != sep; s = ((s) + mblen((s), 2147483647)));
 rb_ary_push(load_path, (*filter)( ({ (__builtin_constant_p(p) && __builtin_constant_p(s - p)) ? rb_str_new_static((p), (s - p)) : rb_str_new((p), (s - p)); })));
 p = s;
    }
}
void
...
expand_include_path(VALUE path)
{
 ...
 return path;
    if (*p == '.' && p[1] == '/')
 return path;
    return rb_file_expand_path(path, ((VALUE)RUBY_Qnil));
}
...
ruby_init_loadpath_safe(int safe_level)
{
    ...
    load_path = rb_current_vm()->load_path;

    if (safe_level == 0) {
 ruby_push_include(getenv("RUBYLIB"), identical_path);
    }

    id_initial_load_path_mark = (__builtin_constant_p("@gem_prelude_index") ?  (rb_intern2(("@gem_prelude_index"), (long)strlen("@gem_prelude_index"))) : (rb_intern)("@gem_prelude_index"));
    while (*paths) {
 size_t len = strlen(paths);
 VALUE path =  ({ (__builtin_constant_p((paths)) && __builtin_constant_p((len))) ? rb_str_new_static(((paths)), ((len))) : rb_str_new(((paths)), ((len))); });
 rb_ivar_set(path, id_initial_load_path_mark, path);
 rb_ary_push(load_path, path);
 paths += len + 1;
    }

    rb_const_set(rb_cObject, (__builtin_constant_p("TMP_RUBY_PREFIX") ?  (rb_intern2(("TMP_RUBY_PREFIX"), (long)strlen("TMP_RUBY_PREFIX"))) : (rb_intern)("TMP_RUBY_PREFIX")), rb_obj_freeze( ({ (__builtin_constant_p((ruby_exec_prefix)) && __builtin_constant_p((exec_prefix_len))) ? rb_str_new_static(((ruby_exec_prefix)), ((exec_prefix_len))) : rb_str_new(((ruby_exec_prefix)), ((exec_prefix_len))); })));
}
 ...
 *req_list = list = rb_ary_new();
 memset(&(((struct RBasicRaw *)((VALUE)(list)))->klass), 0, sizeof(VALUE));
    }
    feature =  ({ (__builtin_constant_p(mod)) ? rb_str_new_static((mod), (long)strlen(mod)) : rb_str_new_cstr(mod); });
    memset(&(((struct RBasicRaw *)((VALUE)(feature)))->klass), 0, sizeof(VALUE));
...
require_libraries(VALUE *req_list)
{
    ...
    do { static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("require")), (long)strlen(("require"))); (require) = rb_intern_id_cache; } while (0);
    while (list && rb_array_len(list) > 0) {
 VALUE feature = rb_ary_shift(list);
 rb_enc_associate(feature, extenc);
 memcpy(&((struct RBasicRaw *)((VALUE)(feature)))->klass, &(rb_cString), sizeof(VALUE));
 rb_obj_freeze_inline((VALUE)feature);
...
process_sflag(int *sflag)
{
 ...
 n = rb_array_len(argv);
 args = rb_array_const_ptr(argv);
 while (n > 0) {
     VALUE v = *args++;
     char *s = rb_string_value_ptr(&(v));
     char *p;
     int hyphen = FALSE;
  ...
  if (*p == '=') {
      *p++ = '\0';
      v =  ({ (__builtin_constant_p(p)) ? rb_str_new_static((p), (long)strlen(p)) : rb_str_new_cstr(p); });
      break;
  }
  if (*p == '-') {
      hyphen = TRUE;
  }
  else if (*p != '_' && !rb_isalnum(*p)) {
      VALUE name_error[2];
      name_error[0] =
    ({ (__builtin_constant_p("invalid name for global variable - ")) ? rb_str_new_static(("invalid name for global variable - "), (long)strlen("invalid name for global variable - ")) : rb_str_new_cstr("invalid name for global variable - "); });
      if (!(p = strchr(p, '='))) {
    ({ (__builtin_constant_p(s)) ? rb_str_cat((name_error[0]), (s), (long)strlen(s)) : rb_str_cat_cstr((name_error[0]), (s)); });
      }
      else {
...
moreswitches(const char *s, ruby_cmdline_options_t *opt, int envopt)
{
    ...
    while (rb_isspace(*s)) s++;
    if (!*s) return;
    argstr = rb_str_tmp_new((len = strlen(s)) + (envopt!=0));
    argary = rb_str_tmp_new(0);

    p = (!(((struct RBasic*)(argstr))->flags & RSTRING_NOEMBED) ? ((struct RString*)(argstr))->as.ary : ((struct RString*)(argstr))->as.heap.ptr);
    if (envopt) *p++ = ' ';
    memcpy(p, s, len + 1);
    ap = 0;
 ...
 *p++ = '\0';
 while (rb_isspace(*p)) ++p;
    ...
    argc = (!(((struct RBasic*)(argary))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(argary))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(argary))->as.heap.len) / sizeof(ap);
    ap = 0;
    rb_str_cat(argary, (char *)&ap, sizeof(ap));
    argv = (char **)(!(((struct RBasic*)(argary))->flags & RSTRING_NOEMBED) ? ((struct RString*)(argary))->as.ary : ((struct RString*)(argary))->as.heap.ptr);
...
name_match_p(const char *name, const char *str, size_t len)
{
    if (len == 0) return 0;
    do {
 while (rb_tolower(*str) == *name) {
     if (!--len || !*++str) return 1;
     ++name;
 }
 if (*str != '-' && *str != '_') return 0;
 while (rb_isalnum(*name)) name++;
...
{
    static const char list[] = "gems, did_you_mean, rubyopt, frozen_string_literal";
    unsigned int *argp = arg;
    unsigned int mask = ~0U;
    if (((len) < (int)sizeof("gems") && name_match_p(("gems"), (str), (len)))) {mask = (1U << feature_gems); goto found;} ; if (((len) < (int)sizeof("did_you_mean") && name_match_p(("did_you_mean"), (str), (len)))) {mask = (1U << feature_did_you_mean); goto found;} ; if (((len) < (int)sizeof("rubyopt") && name_match_p(("rubyopt"), (str), (len)))) {mask = (1U << feature_rubyopt); goto found;} ; if (((len) < (int)sizeof("frozen_string_literal") && name_match_p(("frozen_string_literal"), (str), (len)))) {mask = (1U << feature_frozen_string_literal); goto found;};
    if (((len) < (int)sizeof("all") && name_match_p(("all"), (str), (len)))) {
      found:
...
{
    static const char list[] = "frozen_string_literal";

    if ((((len)) < (int)sizeof(("frozen_string_literal")) && name_match_p((("frozen_string_literal")), ((str)), ((len))))) { *(unsigned int *)arg |= ((1U << feature_debug_frozen_string_literal)); return; };
...
{
    static const char list[] = "version, copyright, usage, help, yydebug, syntax, parsetree, parsetree_with_comment, insns";

    if ((((len)) < (int)sizeof(("version")) && name_match_p((("version")), ((str)), ((len))))) { *(unsigned int *)arg |= ((1U << dump_version)); return; } ; if ((((len)) < (int)sizeof(("copyright")) && name_match_p((("copyright")), ((str)), ((len))))) { *(unsigned int *)arg |= ((1U << dump_copyright)); return; } ; if ((((len)) < (int)sizeof(("usage")) && name_match_p((("usage")), ((str)), ((len))))) { *(unsigned int *)arg |= ((1U << dump_usage)); return; } ; if ((((len)) < (int)sizeof(("help")) && name_match_p((("help")), ((str)), ((len))))) { *(unsigned int *)arg |= ((1U << dump_help)); return; } ; if ((((len)) < (int)sizeof(("yydebug")) && name_match_p((("yydebug")), ((str)), ((len))))) { *(unsigned int *)arg |= ((1U << dump_yydebug)); return; } ; if ((((len)) < (int)sizeof(("syntax")) && name_match_p((("syntax")), ((str)), ((len))))) { *(unsigned int *)arg |= ((1U << dump_syntax)); return; } ; if ((((len)) < (int)sizeof(("parsetree")) && name_match_p((("parsetree")), ((str)), ((len))))) { *(unsigned int *)arg |= ((1U << dump_parsetree)); return; } ; if ((((len)) < (int)sizeof(("parsetree_with_comment")) && name_match_p((("parsetree_with_comment")), ((str)), ((len))))) { *(unsigned int *)arg |= ((1U << dump_parsetree_with_comment)); return; } ; if ((((len)) < (int)sizeof(("insns")) && name_match_p((("insns")), ((str)), ((len))))) { *(unsigned int *)arg |= ((1U << dump_insns)); return; };
...
set_option_encoding_once(const char *type, VALUE *name, const char *e, long elen)
{
    ...
    ename =  ({ (__builtin_constant_p(e) && __builtin_constant_p(elen)) ? rb_str_new_static((e), (elen)) : rb_str_new((e), (elen)); });

    if (*name &&
 rb_funcall(ename, (__builtin_constant_p("casecmp") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("casecmp")), (long)strlen(("casecmp"))); (ID) rb_intern_id_cache; }) : rb_intern("casecmp")), 1, *name) != (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG)) {
 rb_raise(rb_eRuntimeError,
   "%s already set to %li\v", type, *name);
    }
    *name = ename;
}
static long
proc_options(long argc, char **argv, ruby_cmdline_options_t *opt, int envopt)
{
 ...
 switch (*s) {
   ...
   case 'd':
     (*rb_ruby_debug_ptr()) = ((VALUE)RUBY_Qtrue);
     (*rb_ruby_verbose_ptr()) = ((VALUE)RUBY_Qtrue);
     s++;
     goto reswitch;

   case 'y':
     if (envopt) goto noenvopt;
     opt->dump |= (1U << dump_yydebug);
     s++;
     goto reswitch;
  ...
  if (*++s) {
      v = ((int)ruby_scan_oct((s),(1),(&numlen)));
      if (numlen == 0)
   v = 1;
      s += numlen;
  }
  if (!opt->warning) {
      switch (v) {
        case 0:
   (*rb_ruby_verbose_ptr()) = ((VALUE)RUBY_Qnil);
   break;
        case 1:
  ...
  s = *++argv;
     ...
     if (!opt->e_script) {
  opt->e_script =  ({ (__builtin_constant_p(0) && __builtin_constant_p(0)) ? rb_str_new_static((0), (0)) : rb_str_new((0), (0)); });
  if (opt->script == 0)
      opt->script = "-e";
     }
      ({ (__builtin_constant_p(s)) ? rb_str_cat((opt->e_script), (s), (long)strlen(s)) : rb_str_cat_cstr((opt->e_script), (s)); });
      ({ (__builtin_constant_p("\n")) ? rb_str_cat((opt->e_script), ("\n"), (long)strlen("\n")) : rb_str_cat_cstr((opt->e_script), ("\n")); });
     break;
  ...
  rb_raise(rb_eRuntimeError, "missing argument for -E");
   ...
   case 'U':
     set_option_encoding_once("default_internal", &(opt)->intern.enc.name, ("UTF-8"), (0));
     ++s;
     goto reswitch;
  ...
  if (enc_name) {
      opt->src.enc.name =  ({ (__builtin_constant_p(enc_name)) ? rb_str_new_static((enc_name), (long)strlen(enc_name)) : rb_str_new_cstr(enc_name); });
      if (!opt->ext.enc.name)
  ...
  if (*++s) {
      v = ((int)ruby_scan_oct((s),(2),(&numlen)));
      if (numlen == 0)
   v = 1;
      s += numlen;
  }
  ...
  v = ((int)ruby_scan_oct((s),(4),(&numlen)));
  s += numlen;
  if (v > 0377)
      rb_rs = ((VALUE)RUBY_Qnil);
  else if (v == 0 && numlen >= 2) {
      rb_rs =  ({ (__builtin_constant_p("")) ? rb_str_new_static((""), (long)strlen("")) : rb_str_new_cstr(""); });
  }
  else {
      c = v & 0xff;
      rb_rs =  ({ (__builtin_constant_p(&c) && __builtin_constant_p(1)) ? rb_str_new_static((&c), (1)) : rb_str_new((&c), (1)); });
  }
     }
     goto reswitch;
  ...
  opt->dump |= (1U << dump_copyright);
     }
     else if ((strncmp(("debug"), s, n = sizeof("debug") - 1) == 0 && (!(s[n]) || (((((VALUE)RUBY_Qtrue))) && (s[n]) == '-') || (s[n]) == '=') ? (((((((VALUE)RUBY_Qtrue))) || !envopt) ? (void)0 : rb_raise(rb_eRuntimeError, "invalid switch in RUBYOPT: --debug")), s += n, ((*(s) ? !*++(s) : (((VALUE)RUBY_Qfalse)) && (!argc || !((s) = argv[1]) || (--argc, ++argv, 0))) && (((VALUE)RUBY_Qfalse)) ? rb_raise(rb_eRuntimeError, "missing argument for --debug") : (void)0), 1) : 0)) {
  if (s && *s) {
     ...
     else if ((strncmp(("enable"), s, n = sizeof("enable") - 1) == 0 && (!(s[n]) || (((((VALUE)RUBY_Qtrue))) && (s[n]) == '-') || (s[n]) == '=') ? (((((((VALUE)RUBY_Qtrue))) || !envopt) ? (void)0 : rb_raise(rb_eRuntimeError, "invalid switch in RUBYOPT: --enable")), s += n, ((*(s) ? !*++(s) : (((VALUE)RUBY_Qtrue)) && (!argc || !((s) = argv[1]) || (--argc, ++argv, 0))) && (((VALUE)RUBY_Qtrue)) ? rb_raise(rb_eRuntimeError, "missing argument for --enable") : (void)0), 1) : 0)) {
  ruby_each_words(s, enable_option, &opt->features);
     }
     else if ((strncmp(("disable"), s, n = sizeof("disable") - 1) == 0 && (!(s[n]) || (((((VALUE)RUBY_Qtrue))) && (s[n]) == '-') || (s[n]) == '=') ? (((((((VALUE)RUBY_Qtrue))) || !envopt) ? (void)0 : rb_raise(rb_eRuntimeError, "invalid switch in RUBYOPT: --disable")), s += n, ((*(s) ? !*++(s) : (((VALUE)RUBY_Qtrue)) && (!argc || !((s) = argv[1]) || (--argc, ++argv, 0))) && (((VALUE)RUBY_Qtrue)) ? rb_raise(rb_eRuntimeError, "missing argument for --disable") : (void)0), 1) : 0)) {
  ruby_each_words(s, disable_option, &opt->features);
     }
     else if ((strncmp(("encoding"), s, n = sizeof("encoding") - 1) == 0 && (!(s[n]) || (((((VALUE)RUBY_Qfalse))) && (s[n]) == '-') || (s[n]) == '=') ? (((((((VALUE)RUBY_Qtrue))) || !envopt) ? (void)0 : rb_raise(rb_eRuntimeError, "invalid switch in RUBYOPT: --encoding")), s += n, ((*(s) ? !*++(s) : (((VALUE)RUBY_Qtrue)) && (!argc || !((s) = argv[1]) || (--argc, ++argv, 0))) && (((VALUE)RUBY_Qtrue)) ? rb_raise(rb_eRuntimeError, "missing argument for --encoding") : (void)0), 1) : 0)) {
  char *p;
       encoding:
  do {
      if (!(p = strchr(s, ':'))) { set_option_encoding_once("default_external", &(opt)->ext.enc.name, (s), (0)); break; } else if (p > s) { set_option_encoding_once("default_external", &(opt)->ext.enc.name, (s), (p-s)); };
      if (!*(s = ++p)) break;
      if (!(p = strchr(s, ':'))) { set_option_encoding_once("default_internal", &(opt)->intern.enc.name, (s), (0)); break; } else if (p > s) { set_option_encoding_once("default_internal", &(opt)->intern.enc.name, (s), (p-s)); };
      if (!*(s = ++p)) break;
     ...
     else if ((strncmp(("internal-encoding"), s, n = sizeof("internal-encoding") - 1) == 0 && (!(s[n]) || (((((VALUE)RUBY_Qfalse))) && (s[n]) == '-') || (s[n]) == '=') ? (((((((VALUE)RUBY_Qtrue))) || !envopt) ? (void)0 : rb_raise(rb_eRuntimeError, "invalid switch in RUBYOPT: --internal-encoding")), s += n, ((*(s) ? !*++(s) : (((VALUE)RUBY_Qtrue)) && (!argc || !((s) = argv[1]) || (--argc, ++argv, 0))) && (((VALUE)RUBY_Qtrue)) ? rb_raise(rb_eRuntimeError, "missing argument for --internal-encoding") : (void)0), 1) : 0)) {
  set_option_encoding_once("default_internal", &(opt)->intern.enc.name, (s), (0));
     }
     else if ((strncmp(("external-encoding"), s, n = sizeof("external-encoding") - 1) == 0 && (!(s[n]) || (((((VALUE)RUBY_Qfalse))) && (s[n]) == '-') || (s[n]) == '=') ? (((((((VALUE)RUBY_Qtrue))) || !envopt) ? (void)0 : rb_raise(rb_eRuntimeError, "invalid switch in RUBYOPT: --external-encoding")), s += n, ((*(s) ? !*++(s) : (((VALUE)RUBY_Qtrue)) && (!argc || !((s) = argv[1]) || (--argc, ++argv, 0))) && (((VALUE)RUBY_Qtrue)) ? rb_raise(rb_eRuntimeError, "missing argument for --external-encoding") : (void)0), 1) : 0)) {
  set_option_encoding_once("default_external", &(opt)->ext.enc.name, (s), (0));
     }
  ...
  opt->dump |= (1U << dump_yydebug);
     ...
     else if ((strncmp(("dump"), s, n = sizeof("dump") - 1) == 0 && (!(s[n]) || (((((VALUE)RUBY_Qfalse))) && (s[n]) == '-') || (s[n]) == '=') ? (((((((VALUE)RUBY_Qfalse))) || !envopt) ? (void)0 : rb_raise(rb_eRuntimeError, "invalid switch in RUBYOPT: --dump")), s += n, ((*(s) ? !*++(s) : (((VALUE)RUBY_Qtrue)) && (!argc || !((s) = argv[1]) || (--argc, ++argv, 0))) && (((VALUE)RUBY_Qtrue)) ? rb_raise(rb_eRuntimeError, "missing argument for --dump") : (void)0), 1) : 0)) {
  ruby_each_words(s, dump_option, &opt->dump);
     }
     else if (strcmp("help", s) == 0) {
  if (envopt) goto noenvopt_long;
  opt->dump |= (1U << dump_help);
  goto switch_end;
     }
     else {
  rb_raise(rb_eRuntimeError,
...
{
    Init_prelude();
    rb_const_remove(rb_cObject, (__builtin_constant_p("TMP_RUBY_PREFIX") ?  (rb_intern2(("TMP_RUBY_PREFIX"), (long)strlen("TMP_RUBY_PREFIX"))) : (rb_intern)("TMP_RUBY_PREFIX")));
}

static int
opt_enc_index(VALUE enc_name)
{
    const char *s = (!(((struct RBasic*)(enc_name))->flags & RSTRING_NOEMBED) ? ((struct RString*)(enc_name))->as.ary : ((struct RString*)(enc_name))->as.heap.ptr);
...
uscore_get(void)
{
 ...
 rb_raise(rb_eTypeError, "$_ value need to be String (%s given)",
   !((VALUE)(line) != ((VALUE)RUBY_Qnil)) ? "nil": rb_obj_classname(line));
    }
    return line;
}
static VALUE
...
{
    VALUE str = rb_funcall_passing_block(uscore_get(), (__builtin_constant_p("sub") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("sub")), (long)strlen(("sub"))); (ID) rb_intern_id_cache; }) : rb_intern("sub")), argc, argv);
    rb_lastline_set(str);
    return str;
}
static VALUE
...
{
    VALUE str = rb_funcall_passing_block(uscore_get(), (__builtin_constant_p("gsub") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("gsub")), (long)strlen(("gsub"))); (ID) rb_intern_id_cache; }) : rb_intern("gsub")), argc, argv);
    rb_lastline_set(str);
    return str;
}
static VALUE
rb_f_chop(void)
{
    VALUE str = rb_funcall_passing_block(uscore_get(), (__builtin_constant_p("chop") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("chop")), (long)strlen(("chop"))); (ID) rb_intern_id_cache; }) : rb_intern("chop")), 0, 0);
    rb_lastline_set(str);
    return str;
}
static VALUE
...
{
    VALUE str = rb_funcall_passing_block(uscore_get(), (__builtin_constant_p("chomp") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("chomp")), (long)strlen(("chomp"))); (ID) rb_intern_id_cache; }) : rb_intern("chomp")), argc, argv);
    rb_lastline_set(str);
    return str;
}
...
process_options(int argc, char **argv, ruby_cmdline_options_t *opt)
{
    ...
    if (opt->dump & ((1U << dump_usage)|(1U << dump_help))) {
 const char *const progname =
     (argc > 0 && argv && argv[0] ? argv[0] :
      origarg.argc > 0 && origarg.argv && origarg.argv[0] ? origarg.argv[0] :
      ruby_engine);
 usage(progname, (opt->dump & (1U << dump_help)));
 return ((VALUE)RUBY_Qtrue);
    }
    ...
    if ((opt->features & (1U << feature_rubyopt)) &&
 ...
 rb_warning("-K is specified; it is for 1.8 compatibility and may cause odd behavior");
    ...
    if (opt->dump & ((1U << dump_version) | (1U << dump_version_v))) {
 ruby_show_version();
 if (opt->dump & (1U << dump_version)) return ((VALUE)RUBY_Qtrue);
    }
    if (opt->dump & (1U << dump_copyright)) {
 (exit(ruby_show_copyright_to_die(0)));
 return ((VALUE)RUBY_Qtrue);
    }
 ...
 if (argc <= 0) {
  ...
  if (!opt->script) {
      opt->script = dln_find_file_r(argv[0], getenv("PATH"), fbuf, sizeof(fbuf));
  }
  if (!opt->script)
      opt->script = argv[0];
     }
 ...
 if (opt->script[0] == '-' && !opt->script[1]) {
     forbid_setid(("program input from stdin"), opt);
 }
    }

    opt->script_name =  ({ (__builtin_constant_p(opt->script)) ? rb_str_new_static((opt->script), (long)strlen(opt->script)) : rb_str_new_cstr(opt->script); });
    opt->script = (!(((struct RBasic*)(opt->script_name))->flags & RSTRING_NOEMBED) ? ((struct RString*)(opt->script_name))->as.ary : ((struct RString*)(opt->script_name))->as.heap.ptr);
    ...
    rb_enc_associate((rb_current_vm()->progname), lenc);
    rb_obj_freeze((rb_current_vm()->progname));
    parser = rb_parser_new();
    if (opt->dump & (1U << dump_yydebug)) {
 rb_parser_set_yydebug(parser, ((VALUE)RUBY_Qtrue));
    }
 ...
 rb_current_vm()->src_encoding_index = opt->src.enc.index;
    }
 ...
 long i;
 VALUE load_path = rb_current_vm()->load_path;
 const ID id_initial_load_path_mark = (__builtin_constant_p("@gem_prelude_index") ?  (rb_intern2(("@gem_prelude_index"), (long)strlen("@gem_prelude_index"))) : (rb_intern)("@gem_prelude_index"));
 for (i = 0; i < rb_array_len(load_path); ++i) {
     VALUE path = (rb_array_const_ptr(load_path)[i]);
     ...
     do { const VALUE _ary = (load_path); VALUE *ptr = (VALUE *)((VALUE *)rb_array_const_ptr(_ary)); ({
;
; int unaligned_member_access_result = (rb_obj_write((VALUE)(_ary), (VALUE *)(&ptr[i]), (VALUE)((path)), "ruby.c", 1620));
; unaligned_member_access_result; }); ; } while (0);
 }
    }
    Init_ext();
    if (opt->features & (1U << feature_gems)) {
 rb_define_module("Gem");
    }
    if (opt->features & (1U << feature_did_you_mean)) {
 ...
 rb_hash_aset((option), (rb_id2sym((__builtin_constant_p("frozen_string_literal") ?  (rb_intern2(("frozen_string_literal"), (long)strlen("frozen_string_literal"))) : (rb_intern)("frozen_string_literal")))), ((opt)->features & (1U << feature_frozen_string_literal) ? ((VALUE)RUBY_Qtrue) : ((VALUE)RUBY_Qfalse)));;
 rb_hash_aset((option), (rb_id2sym((__builtin_constant_p("debug_frozen_string_literal") ?  (rb_intern2(("debug_frozen_string_literal"), (long)strlen("debug_frozen_string_literal"))) : (rb_intern)("debug_frozen_string_literal")))), ((opt)->features & (1U << feature_debug_frozen_string_literal) ? ((VALUE)RUBY_Qtrue) : ((VALUE)RUBY_Qfalse)));;
 rb_funcallv(rb_cISeq, (__builtin_constant_p("compile_option=") ?  (rb_intern2(("compile_option="), (long)strlen("compile_option="))) : (rb_intern)("compile_option=")), 1, &option);

    }
    ruby_set_argv(argc, argv);
    process_sflag(&opt->sflag);

    (((toplevel_binding)) = (rb_binding_t*)(((struct RData*)(((rb_const_get(rb_cObject, (__builtin_constant_p("TOPLEVEL_BINDING") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("TOPLEVEL_BINDING")), (long)strlen(("TOPLEVEL_BINDING"))); (ID) rb_intern_id_cache; }) : rb_intern("TOPLEVEL_BINDING")))))))->data));
    ...
    if (opt->e_script) {
 VALUE progname = (rb_current_vm()->progname);
 rb_encoding *eenc;
 ...
 ast = load_file(parser, opt->script_name, f, 1, opt);
    ...
    ruby_set_script_name(opt->script_name);
    if (dump & (1U << dump_yydebug)) {
 dump &= ~(1U << dump_yydebug);
 if (!dump) return ((VALUE)RUBY_Qtrue);
    }
 ...
 rb_enc_set_default_internal(((VALUE)RUBY_Qnil));
 ...
 rb_define_global_function("chomp", rb_f_chomp, -1);
    ...
    if (dump & ((1U << dump_parsetree)|(1U << dump_parsetree_with_comment))) {
 rb_io_write(rb_stdout, rb_parser_dump_tree(ast->root, dump & (1U << dump_parsetree_with_comment)));
 rb_io_flush(rb_stdout);
 dump &= ~(1U << dump_parsetree)&~(1U << dump_parsetree_with_comment);
 if (!dump) {
     rb_ast_dispose(ast);
     return ((VALUE)RUBY_Qtrue);
 }
 ...
 if (!opt->e_script && strcmp(opt->script, "-")) {
     path = rb_realpath_internal(((VALUE)RUBY_Qnil), script_name, 1);





     if (!((int)((((struct RBasic*)(path))->flags & RUBY_ENCODING_MASK)>>RUBY_ENCODING_SHIFT) != RUBY_ENCODING_INLINE_MAX ? (int)((((struct RBasic*)(path))->flags & RUBY_ENCODING_MASK)>>RUBY_ENCODING_SHIFT) : rb_enc_get_index(path))) {
 ...
 rb_ast_dispose(ast);
    ...
    if (dump & (1U << dump_insns)) {
 rb_io_write(rb_stdout, rb_iseq_disasm((const rb_iseq_t *)iseq));
 rb_io_flush(rb_stdout);
 dump &= ~(1U << dump_insns);
 if (!dump) return ((VALUE)RUBY_Qtrue);
    }
    if (opt->dump & dump_exit_bits) return ((VALUE)RUBY_Qtrue);

    rb_define_virtual_variable(("$-p"), (opt->do_print) ? true_value : false_value, 0);
    rb_define_virtual_variable(("$-l"), (opt->do_line) ? true_value : false_value, 0);
    rb_define_virtual_variable(("$-a"), (opt->do_split) ? true_value : false_value, 0);
...
load_file_internal(VALUE argp_v)
{
    ...
    do { static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("set_encoding")), (long)strlen(("set_encoding"))); (set_encoding) = rb_intern_id_cache; } while (0);
    if (script) {
 VALUE c = 1;
 VALUE line;
 char *p, *str;
 ...
 if (opt->xflag) {
     line_start--;
   search_shebang:
     while (!!((VALUE)(line = rb_io_gets(f)) != ((VALUE)RUBY_Qnil))) {
  line_start++;
  (!(((struct RBasic*)(line))->flags & RSTRING_NOEMBED) ? ((str) = ((struct RString*)(line))->as.ary, (len) = (long)((((struct RBasic*)(line))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT))) : ((str) = ((struct RString*)(line))->as.heap.ptr, (len) = ((struct RString*)(line))->as.heap.len));
 ...
 if (c == (((VALUE)('#'))<<1 | RUBY_FIXNUM_FLAG)) {
  ...
  rb_io_ungetbyte(f,  ({ (__builtin_constant_p("!\n")) ? rb_str_new_static(("!\n"), (long)strlen("!\n")) : rb_str_new_cstr("!\n"); }));
     }
     else if (!!((VALUE)(c) != ((VALUE)RUBY_Qnil))) {
  rb_io_ungetbyte(f, c);
     }
     rb_io_ungetbyte(f, (((VALUE)('#'))<<1 | RUBY_FIXNUM_FLAG));
 ...
 f =  ({ (__builtin_constant_p(0) && __builtin_constant_p(0)) ? rb_str_new_static((0), (0)) : rb_str_new((0), (0)); });
 rb_enc_associate(f, enc);
 return (VALUE)rb_parser_compile_string_path(parser, orig_fname, f, line_start);
    }
    rb_funcall(f, set_encoding, 2, rb_enc_from_encoding(enc),  ({ (__builtin_constant_p("-")) ? rb_str_new_static(("-"), (long)strlen("-")) : rb_str_new_cstr("-"); }));
    ast = rb_parser_compile_file_path(parser, orig_fname, f, line_start);
    rb_funcall(f, set_encoding, 1, rb_parser_encoding(parser));
    if (script && rb_parser_end_seen_p(parser)) {
 rb_define_global_const("DATA", f);
 argp->f = ((VALUE)RUBY_Qnil);
    }
    return (VALUE)ast;
}
...
open_load_file(VALUE fname_v, int *xflag)
{
    ...
    rb_string_value_cstr(&(fname_v)));
    long flen = (!(((struct RBasic*)(fname_v))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(fname_v))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(fname_v))->as.heap.len);
    VALUE f;
    int e;
 ...
 if ((fd = rb_cloexec_open(fname, mode, 0)) < 0) {
  ...
  rb_load_fail(fname_v, strerror(e));
     ...
     if ((fd = rb_cloexec_open(fname, mode, 0)) < 0) {
  rb_load_fail(fname_v, strerror((*__errno_location ())));
     }
 }
 rb_update_max_fd(fd);
...
restore_load_file(VALUE arg)
{
    ...
    if (!!((VALUE)(f) != ((VALUE)RUBY_Qnil)) && f != rb_stdin) {
 rb_io_close(f);
    }
...
{
    VALUE fname_v =  ({ (__builtin_constant_p(fname)) ? rb_str_new_static((fname), (long)strlen(fname)) : rb_str_new_cstr(fname); });
...
{
    return (rb_current_vm()->orig_progname);
}
...
{
    const char *ptr = rb_string_value_cstr(&(title));
    setproctitle("%.*s", rb_long2int_inline((!(((struct RBasic*)(title))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(title))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(title))->as.heap.len)), ptr);
    return title;
}
...
set_arg0(VALUE val, ID id)
{
 ...
 rb_raise(rb_eRuntimeError, "$0 not initialized");
    ...
    (rb_current_vm()->progname) = rb_str_new_frozen(ruby_setproctitle(val));
}
...
external_str_new_cstr(const char *p)
{
    ...
    return  ({ (__builtin_constant_p(p)) ? rb_external_str_new((p), (long)strlen(p)) : rb_external_str_new_cstr(p); });
...
{
    if (name) {
 (rb_current_vm()->orig_progname) = (rb_current_vm()->progname) = external_str_new_cstr(name);
 rb_vm_set_progname((rb_current_vm()->progname));
    }
}
...
{
    (rb_current_vm()->orig_progname) = (rb_current_vm()->progname) = rb_str_dup(name);
    rb_vm_set_progname((rb_current_vm()->progname));
}
...
{
    VALUE *variable = data;
    *variable = !(((VALUE)(val) & (VALUE)~((VALUE)RUBY_Qnil)) == 0) ? ((VALUE)RUBY_Qtrue) : val;
}
...
opt_W_getter(ID id, void *data)
{
 ...
 return (((VALUE)(2))<<1 | RUBY_FIXNUM_FLAG);
      default:
 return ((VALUE)RUBY_Qnil);
    }
}
...
ruby_prog_init(void)
{
    rb_define_hooked_variable("$VERBOSE", &(*rb_ruby_verbose_ptr()), 0, verbose_setter);
    rb_define_hooked_variable("$-v", &(*rb_ruby_verbose_ptr()), 0, verbose_setter);
    rb_define_hooked_variable("$-w", &(*rb_ruby_verbose_ptr()), 0, verbose_setter);
    rb_define_hooked_variable("$-W", &(*rb_ruby_verbose_ptr()), opt_W_getter, rb_gvar_readonly_setter);
    rb_define_variable("$DEBUG", &(*rb_ruby_debug_ptr()));
    rb_define_variable("$-d", &(*rb_ruby_debug_ptr()));

    rb_define_hooked_variable("$0", &(rb_current_vm()->progname), 0, set_arg0);
    rb_define_hooked_variable("$PROGRAM_NAME", &(rb_current_vm()->progname), 0, set_arg0);
    ...
    rb_define_global_const("ARGV", rb_get_argv());
}
...
ruby_set_argv(int argc, char **argv)
{
 ...
 rb_obj_freeze_inline((VALUE)arg);
 rb_ary_push(av, arg);
    }
}
...
ruby_process_options(int argc, char **argv)
{
 ...
 origarg.argv = argv;
    ...
    rb_argv0 = rb_str_new_frozen((rb_current_vm()->progname));
...
fill_standard_fds(void)
{
    int f0, f1, f2, fds[2];
    struct stat buf;
    f0 = fstat(0, &buf) == -1 && (*__errno_location ()) == 9;
    f1 = fstat(1, &buf) == -1 && (*__errno_location ()) == 9;
    f2 = fstat(2, &buf) == -1 && (*__errno_location ()) == 9;
    if (f0) {
        if (pipe(fds) == 0) {
            close(fds[1]);
            if (fds[0] != 0) {
