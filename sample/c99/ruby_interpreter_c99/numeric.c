...
rb_num_get_rounding_option(VALUE opts)
{
 ...
 if (!round_kwds[0]) {
     round_kwds[0] = (__builtin_constant_p("half") ?  (rb_intern2(("half"), (long)strlen("half"))) : (rb_intern)("half"));
 }
 if (!rb_get_kwargs(opts, round_kwds, 0, 1, &rounding)) goto noopt;
 if (((((VALUE)(rounding)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(rounding) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(rounding) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(rounding))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL)))) {
     str = rb_sym2str(rounding);
 }
 else if (!((VALUE)(rounding) != ((VALUE)RUBY_Qnil))) {
     goto noopt;
 }
 else if (!( ((RUBY_T_STRING) == RUBY_T_FIXNUM) ? (((int)(long)(str = rounding))&RUBY_FIXNUM_FLAG) : ((RUBY_T_STRING) == RUBY_T_TRUE) ? ((str = rounding) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_STRING) == RUBY_T_FALSE) ? ((str = rounding) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_STRING) == RUBY_T_NIL) ? ((str = rounding) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_STRING) == RUBY_T_UNDEF) ? ((str = rounding) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_STRING) == RUBY_T_SYMBOL) ? ((((VALUE)(str = rounding)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(str = rounding) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(str = rounding) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(str = rounding))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_STRING) == RUBY_T_FLOAT) ? ( ((((int)(long)(str = rounding))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(str = rounding) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(str = rounding) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(str = rounding))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(str = rounding) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(str = rounding) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(str = rounding))->flags & RUBY_T_MASK) == (RUBY_T_STRING)))) {
     str = rb_check_string_type(rounding);
     if (!((VALUE)(str) != ((VALUE)RUBY_Qnil))) goto invalid;
 }
 s = (!(((struct RBasic*)(str))->flags & RSTRING_NOEMBED) ? ((struct RString*)(str))->as.ary : ((struct RString*)(str))->as.heap.ptr);
 switch ((!(((struct RBasic*)(str))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(str))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(str))->as.heap.len)) {
   case 2:
  ...
  return RUBY_NUM_ROUND_HALF_DOWN;
     break;
      ...
      invalid:
 rb_raise(rb_eArgError, "invalid rounding mode: % li\v", rounding);
    }
  noopt:
...
rb_num_to_uint(VALUE val, unsigned int *ret)
{
 ...
 if (v > (long)(2147483647 *2U +1U)) return 3;
 ...
 *ret = (unsigned int)v;
 ...
 if ((!((((struct RBasic*)(val))->flags & ((VALUE)((VALUE)RUBY_FL_USER1))) != 0))) return 2;
...
num_funcall_op_0(VALUE x, VALUE arg, int recursive)
{
 ...
 if (rb_isalnum(name[0])) {
     rb_name_error(func, "%li\v.%li\v",
     x, (rb_id2sym(func)));
 }
 else if (name[0] && name[1] == '@' && !name[2]) {
     rb_name_error(func, "%c%li\v",
     name[0], x);
 }
 else {
     rb_name_error(func, "%li\v%li\v",
...
num_funcall_op_1_recursion(VALUE x, ID func, VALUE y)
{
    const char *name = rb_id2name(func);
    if (rb_isalnum(name[0])) {
 rb_name_error(func, "%li\v.%li\v(%li\v)",
        x, (rb_id2sym(func)), y);
    }
    else {
 rb_name_error(func, "%li\v%li\v%li\v",
...
{
    if (rb_class_of((VALUE)(x)) == rb_class_of((VALUE)(y)))
...
{
    if ((((VALUE)(y) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(y) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) || (int)(((struct RBasic*)(y))->flags & RUBY_T_MASK) == RUBY_T_FLOAT) {
 y = rb_inspect(y);
    }
    else {
 y = rb_obj_class(y);
    }
    rb_raise(rb_eTypeError, "%li\v can't be coerced into %li\v",
      y, rb_obj_class(x));
}
...
do_coerce(VALUE *x, VALUE *y, int err)
{
    ...
    if (ary == ((VALUE)RUBY_Qundef)) {
 if (err) {
     coerce_failed(*x, *y);
 }
 return FALSE;
    }
    if (!err && !((VALUE)(ary) != ((VALUE)RUBY_Qnil))) {
 return FALSE;
    }
    if (!( ((RUBY_T_ARRAY) == RUBY_T_FIXNUM) ? (((int)(long)(ary))&RUBY_FIXNUM_FLAG) : ((RUBY_T_ARRAY) == RUBY_T_TRUE) ? ((ary) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_ARRAY) == RUBY_T_FALSE) ? ((ary) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_ARRAY) == RUBY_T_NIL) ? ((ary) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_ARRAY) == RUBY_T_UNDEF) ? ((ary) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_ARRAY) == RUBY_T_SYMBOL) ? ((((VALUE)(ary)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(ary) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(ary) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(ary))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_ARRAY) == RUBY_T_FLOAT) ? ( ((((int)(long)(ary))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(ary) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(ary) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(ary))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(ary) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(ary) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(ary))->flags & RUBY_T_MASK) == (RUBY_T_ARRAY))) || rb_array_len(ary) != 2) {
 rb_raise(rb_eTypeError, "coerce must return [x, y]");
    }

    *x = (rb_array_const_ptr(ary)[0]);
    *y = (rb_array_const_ptr(ary)[1]);
    return TRUE;
}
...
rb_num_coerce_relop(VALUE x, VALUE y, ID func)
{
    ...
    if (!do_coerce(&x, &y, FALSE) ||
 !((VALUE)(c = rb_funcall(x, func, 1, y)) != ((VALUE)RUBY_Qnil))) {
 rb_cmperr(x0, y0);
 return ((VALUE)RUBY_Qnil);
    }
    return c;
...
num_sadded(VALUE x, VALUE name)
{
    ...
    rb_raise(rb_eTypeError,
      "can't define singleton method \"%li\v\" for %li\v",
      rb_id2str(mid),
      rb_obj_class(x));
...
{
    return rb_complex_new((((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG), num);
}
static VALUE
num_uminus(VALUE num)
{
    ...
    zero = (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG);
...
{
    if (rb_equal((((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG), y)) rb_num_zerodiv();
    return rb_funcall(num_funcall1(x, '/', y), (__builtin_constant_p("floor") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("floor")), (long)strlen(("floor"))); (ID) rb_intern_id_cache; }) : rb_intern("floor")), 0);
}
static VALUE
...
num_remainder(VALUE x, VALUE y)
{
    ...
    if ((!rb_equal(z, (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG))) &&
...
{
    if ((((int)(long)(num))&RUBY_FIXNUM_FLAG)) {
 if (((num) == (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG))) {
     return ((VALUE)RUBY_Qtrue);
 }
    }
    else if (( ((RUBY_T_BIGNUM) == RUBY_T_FIXNUM) ? (((int)(long)(num))&RUBY_FIXNUM_FLAG) : ((RUBY_T_BIGNUM) == RUBY_T_TRUE) ? ((num) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_BIGNUM) == RUBY_T_FALSE) ? ((num) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_BIGNUM) == RUBY_T_NIL) ? ((num) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_BIGNUM) == RUBY_T_UNDEF) ? ((num) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_BIGNUM) == RUBY_T_SYMBOL) ? ((((VALUE)(num)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(num) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(num) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(num))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_BIGNUM) == RUBY_T_FLOAT) ? ( ((((int)(long)(num))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(num) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(num) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(num))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(num) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(num) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(num))->flags & RUBY_T_MASK) == (RUBY_T_BIGNUM)))) {
 if (rb_bigzero_p(num)) {
    ...
    else if (rb_equal(num, (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG))) {
 return ((VALUE)RUBY_Qtrue);
    }
    return ((VALUE)RUBY_Qfalse);
}
...
{
    if (!(((VALUE)(num_funcall0(num, (__builtin_constant_p("zero?") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("zero?")), (long)strlen(("zero?"))); (ID) rb_intern_id_cache; }) : rb_intern("zero?")))) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) {
 return ((VALUE)RUBY_Qnil);
    }
    return num;
}
...
{
    return num_funcall0(num, idTo_i);
}
static VALUE
num_positive_p(VALUE num)
{
    ...
    if ((((int)(long)(num))&RUBY_FIXNUM_FLAG)) {
 if (rb_method_basic_definition_p(rb_cInteger, mid))
     return (long)num > (long)(((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG) ? ((VALUE)RUBY_Qtrue) : ((VALUE)RUBY_Qfalse);
    }
    else if (( ((RUBY_T_BIGNUM) == RUBY_T_FIXNUM) ? (((int)(long)(num))&RUBY_FIXNUM_FLAG) : ((RUBY_T_BIGNUM) == RUBY_T_TRUE) ? ((num) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_BIGNUM) == RUBY_T_FALSE) ? ((num) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_BIGNUM) == RUBY_T_NIL) ? ((num) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_BIGNUM) == RUBY_T_UNDEF) ? ((num) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_BIGNUM) == RUBY_T_SYMBOL) ? ((((VALUE)(num)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(num) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(num) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(num))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_BIGNUM) == RUBY_T_FLOAT) ? ( ((((int)(long)(num))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(num) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(num) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(num))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(num) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(num) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(num))->flags & RUBY_T_MASK) == (RUBY_T_BIGNUM)))) {
 if (rb_method_basic_definition_p(rb_cInteger, mid))
     return ((((struct RBasic*)(num))->flags & ((VALUE)((VALUE)RUBY_FL_USER1))) != 0) && !rb_bigzero_p(num) ? ((VALUE)RUBY_Qtrue) : ((VALUE)RUBY_Qfalse);
    }
...
{
    return rb_num_negative_int_p(num) ? ((VALUE)RUBY_Qtrue) : ((VALUE)RUBY_Qfalse);
}
VALUE
rb_float_new_in_heap(double d)
{
    struct RFloat *(flt) = (struct RFloat*)(((RUBY_T_FLOAT | (1 ? ((VALUE)RUBY_FL_WB_PROTECTED) : 0)) & ((VALUE)RUBY_FL_WB_PROTECTED)) ? rb_wb_protected_newobj_of(rb_cFloat, (RUBY_T_FLOAT | (1 ? ((VALUE)RUBY_FL_WB_PROTECTED) : 0)) & ~((VALUE)RUBY_FL_WB_PROTECTED)) : rb_wb_unprotected_newobj_of(rb_cFloat, RUBY_T_FLOAT | (1 ? ((VALUE)RUBY_FL_WB_PROTECTED) : 0)));

    flt->float_value = d;
    rb_obj_freeze_inline((VALUE)flt);
    return (VALUE)flt;
}
static VALUE
flo_to_s(VALUE flt)
{
    enum {decimal_mant = 53 -15};
    enum {float_dig = 15 +1};
    char buf[float_dig + (decimal_mant + 8 - 1) / 8 + 10];
    double value = rb_float_value_inline(flt);
    VALUE s;
    char *p, *e;
    int sign, decpt, digs;

    if ((sizeof ((value)) == sizeof (float) ? __isinff (value) : sizeof ((value)) == sizeof (double) ? __isinf (value) : __isinfl (value))) {
 static const char minf[] = "-Infinity";
 const int pos = (value > 0);
 return  ({ (__builtin_constant_p(minf+pos) && __builtin_constant_p(strlen(minf)-pos)) ? rb_usascii_str_new_static((minf+pos), (strlen(minf)-pos)) : rb_usascii_str_new((minf+pos), (strlen(minf)-pos)); });
    }
    else if ((sizeof ((value)) == sizeof (float) ? __isnanf (value) : sizeof ((value)) == sizeof (double) ? __isnan (value) : __isnanl (value)))
 return  ({ (__builtin_constant_p("NaN")) ? rb_usascii_str_new_static(("NaN"), (long)strlen("NaN")) : rb_usascii_str_new_cstr("NaN"); });

    p = ruby_dtoa(value, 0, 0, &decpt, &sign, &e);
    s = sign ?  ({ (__builtin_constant_p("-")) ? rb_usascii_str_new_static(("-"), (long)strlen("-")) : rb_usascii_str_new_cstr("-"); }) :  ({ (__builtin_constant_p(0) && __builtin_constant_p(0)) ? rb_usascii_str_new_static((0), (0)) : rb_usascii_str_new((0), (0)); });
 ...
 if (decpt < digs) {
     ...
     rb_str_resize(s, (len = (!(((struct RBasic*)(s))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(s))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(s))->as.heap.len)) + decpt - digs + 2);
     ptr = (!(((struct RBasic*)(s))->flags & RSTRING_NOEMBED) ? ((struct RString*)(s))->as.ary : ((struct RString*)(s))->as.heap.ptr) + len;
     if (decpt > digs) {
 ...
 char *ptr;
 rb_str_cat(s, "0.", 2);
 rb_str_resize(s, (len = (!(((struct RBasic*)(s))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(s))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(s))->as.heap.len)) - decpt + digs);
 ptr = (!(((struct RBasic*)(s))->flags & RSTRING_NOEMBED) ? ((struct RString*)(s))->as.ary : ((struct RString*)(s))->as.heap.ptr);
...
{
    return rb_float_new_inline(-rb_float_value_inline(flt));
}
static VALUE
flo_plus(VALUE x, VALUE y)
{
    if (( ((RUBY_T_FIXNUM) == RUBY_T_FIXNUM) ? (((int)(long)(y))&RUBY_FIXNUM_FLAG) : ((RUBY_T_FIXNUM) == RUBY_T_TRUE) ? ((y) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_FIXNUM) == RUBY_T_FALSE) ? ((y) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_FIXNUM) == RUBY_T_NIL) ? ((y) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_FIXNUM) == RUBY_T_UNDEF) ? ((y) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_FIXNUM) == RUBY_T_SYMBOL) ? ((((VALUE)(y)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(y) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(y) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(y))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_FIXNUM) == RUBY_T_FLOAT) ? ( ((((int)(long)(y))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(y) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(y) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(y))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(y) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(y) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(y))->flags & RUBY_T_MASK) == (RUBY_T_FIXNUM)))) {
 return rb_float_new_inline(rb_float_value_inline(x) + (double)((long)(((long)(y))>>(int)(1))));
    }
 ...
 return rb_float_new_inline(rb_float_value_inline(x) + rb_big2dbl(y));
    }
    else if (( ((RUBY_T_FLOAT) == RUBY_T_FIXNUM) ? (((int)(long)(y))&RUBY_FIXNUM_FLAG) : ((RUBY_T_FLOAT) == RUBY_T_TRUE) ? ((y) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_FLOAT) == RUBY_T_FALSE) ? ((y) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_FLOAT) == RUBY_T_NIL) ? ((y) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_FLOAT) == RUBY_T_UNDEF) ? ((y) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_FLOAT) == RUBY_T_SYMBOL) ? ((((VALUE)(y)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(y) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(y) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(y))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_FLOAT) == RUBY_T_FLOAT) ? ( ((((int)(long)(y))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(y) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(y) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(y))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(y) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(y) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(y))->flags & RUBY_T_MASK) == (RUBY_T_FLOAT)))) {
 return rb_float_new_inline(rb_float_value_inline(x) + rb_float_value_inline(y));
    }
    else {
...
flo_div(VALUE x, VALUE y)
{
    ...
    if (( ((RUBY_T_FIXNUM) == RUBY_T_FIXNUM) ? (((int)(long)(y))&RUBY_FIXNUM_FLAG) : ((RUBY_T_FIXNUM) == RUBY_T_TRUE) ? ((y) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_FIXNUM) == RUBY_T_FALSE) ? ((y) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_FIXNUM) == RUBY_T_NIL) ? ((y) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_FIXNUM) == RUBY_T_UNDEF) ? ((y) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_FIXNUM) == RUBY_T_SYMBOL) ? ((((VALUE)(y)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(y) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(y) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(y))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_FIXNUM) == RUBY_T_FLOAT) ? ( ((((int)(long)(y))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(y) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(y) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(y))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(y) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(y) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(y))->flags & RUBY_T_MASK) == (RUBY_T_FIXNUM)))) {
 f_y = ((long)(((long)(y))>>(int)(1)));
 return rb_float_new_inline(rb_float_value_inline(x) / (double)f_y);
    }
    else if (( ((RUBY_T_BIGNUM) == RUBY_T_FIXNUM) ? (((int)(long)(y))&RUBY_FIXNUM_FLAG) : ((RUBY_T_BIGNUM) == RUBY_T_TRUE) ? ((y) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_BIGNUM) == RUBY_T_FALSE) ? ((y) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_BIGNUM) == RUBY_T_NIL) ? ((y) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_BIGNUM) == RUBY_T_UNDEF) ? ((y) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_BIGNUM) == RUBY_T_SYMBOL) ? ((((VALUE)(y)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(y) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(y) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(y))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_BIGNUM) == RUBY_T_FLOAT) ? ( ((((int)(long)(y))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(y) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(y) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(y))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(y) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(y) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(y))->flags & RUBY_T_MASK) == (RUBY_T_BIGNUM)))) {
 d = rb_big2dbl(y);
 return rb_float_new_inline(rb_float_value_inline(x) / d);
    }
    else if (( ((RUBY_T_FLOAT) == RUBY_T_FIXNUM) ? (((int)(long)(y))&RUBY_FIXNUM_FLAG) : ((RUBY_T_FLOAT) == RUBY_T_TRUE) ? ((y) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_FLOAT) == RUBY_T_FALSE) ? ((y) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_FLOAT) == RUBY_T_NIL) ? ((y) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_FLOAT) == RUBY_T_UNDEF) ? ((y) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_FLOAT) == RUBY_T_SYMBOL) ? ((((VALUE)(y)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(y) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(y) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(y))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_FLOAT) == RUBY_T_FLOAT) ? ( ((((int)(long)(y))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(y) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(y) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(y))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(y) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(y) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(y))->flags & RUBY_T_MASK) == (RUBY_T_FLOAT)))) {
 return rb_float_new_inline(rb_float_value_inline(x) / rb_float_value_inline(y));
    }
...
flodivmod(double x, double y, double *divp, double *modp)
{
    ...
    if ((sizeof ((y)) == sizeof (float) ? __isnanf (y) : sizeof ((y)) == sizeof (double) ? __isnan (y) : __isnanl (y))) {
 ...
 return;
    ...
    if ((x == 0.0) || ((sizeof ((y)) == sizeof (float) ? __isinff (y) : sizeof ((y)) == sizeof (double) ? __isinf (y) : __isinfl (y)) && !(sizeof ((x)) == sizeof (float) ? __isinff (x) : sizeof ((x)) == sizeof (double) ? __isinf (x) : __isinfl (x))))
        mod = x;
    else {
 ...
 mod = fmod(x, y);
    ...
    if ((sizeof ((x)) == sizeof (float) ? __isinff (x) : sizeof ((x)) == sizeof (double) ? __isinf (x) : __isinfl (x)) && !(sizeof ((y)) == sizeof (float) ? __isinff (y) : sizeof ((y)) == sizeof (double) ? __isinf (y) : __isinfl (y)))
 div = x;
    else {
 div = (x - mod) / y;
...
flo_mod(VALUE x, VALUE y)
{
    ...
    if (( ((RUBY_T_FIXNUM) == RUBY_T_FIXNUM) ? (((int)(long)(y))&RUBY_FIXNUM_FLAG) : ((RUBY_T_FIXNUM) == RUBY_T_TRUE) ? ((y) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_FIXNUM) == RUBY_T_FALSE) ? ((y) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_FIXNUM) == RUBY_T_NIL) ? ((y) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_FIXNUM) == RUBY_T_UNDEF) ? ((y) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_FIXNUM) == RUBY_T_SYMBOL) ? ((((VALUE)(y)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(y) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(y) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(y))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_FIXNUM) == RUBY_T_FLOAT) ? ( ((((int)(long)(y))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(y) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(y) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(y))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(y) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(y) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(y))->flags & RUBY_T_MASK) == (RUBY_T_FIXNUM)))) {
 fy = (double)((long)(((long)(y))>>(int)(1)));
    }
    else if (( ((RUBY_T_BIGNUM) == RUBY_T_FIXNUM) ? (((int)(long)(y))&RUBY_FIXNUM_FLAG) : ((RUBY_T_BIGNUM) == RUBY_T_TRUE) ? ((y) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_BIGNUM) == RUBY_T_FALSE) ? ((y) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_BIGNUM) == RUBY_T_NIL) ? ((y) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_BIGNUM) == RUBY_T_UNDEF) ? ((y) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_BIGNUM) == RUBY_T_SYMBOL) ? ((((VALUE)(y)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(y) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(y) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(y))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_BIGNUM) == RUBY_T_FLOAT) ? ( ((((int)(long)(y))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(y) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(y) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(y))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(y) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(y) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(y))->flags & RUBY_T_MASK) == (RUBY_T_BIGNUM)))) {
 fy = rb_big2dbl(y);
    }
    else if (( ((RUBY_T_FLOAT) == RUBY_T_FIXNUM) ? (((int)(long)(y))&RUBY_FIXNUM_FLAG) : ((RUBY_T_FLOAT) == RUBY_T_TRUE) ? ((y) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_FLOAT) == RUBY_T_FALSE) ? ((y) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_FLOAT) == RUBY_T_NIL) ? ((y) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_FLOAT) == RUBY_T_UNDEF) ? ((y) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_FLOAT) == RUBY_T_SYMBOL) ? ((((VALUE)(y)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(y) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(y) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(y))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_FLOAT) == RUBY_T_FLOAT) ? ( ((((int)(long)(y))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(y) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(y) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(y))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(y) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(y) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(y))->flags & RUBY_T_MASK) == (RUBY_T_FLOAT)))) {
 fy = rb_float_value_inline(y);
    }
    else {
 return rb_num_coerce_bin(x, y, '%');
    }
    return rb_float_new_inline(ruby_float_mod(rb_float_value_inline(x), fy));
}

static VALUE
dbl2ival(double d)
{
    if ((((d) < (9223372036854775807L>>1)+1) && ((d) >= (((long)(-9223372036854775807L -1L))>>(int)(1))))) {
 return (((VALUE)((long)d))<<1 | RUBY_FIXNUM_FLAG);
    }
    return rb_dbl2big(d);
}
static VALUE
flo_divmod(VALUE x, VALUE y)
{
 ...
 return rb_num_coerce_bin(x, y, id_divmod);
    ...
    flodivmod(rb_float_value_inline(x), fy, &div, &mod);
    a = dbl2ival(div);
    b = rb_float_new_inline(mod);
...
rb_float_pow(VALUE x, VALUE y)
{
 ...
 if (dx < 0 && dy != round(dy))
     return num_funcall1(rb_complex_raw((x), (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG)), idPow, y);
    }
    else {
 return rb_num_coerce_bin(x, y, idPow);
    }
    return rb_float_new_inline(pow(dx, dy));
}
static VALUE
num_eql(VALUE x, VALUE y)
{
    if (rb_type((VALUE)(x)) != rb_type((VALUE)(y))) return ((VALUE)RUBY_Qfalse);
...
{
    if (x == y) return (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG);
    return ((VALUE)RUBY_Qnil);
}
...
{
    VALUE result;
    if (x == y) return ((VALUE)RUBY_Qtrue);
    result = num_funcall1(y, idEq, x);
    if (!(((VALUE)(result) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) return ((VALUE)RUBY_Qtrue);
    return ((VALUE)RUBY_Qfalse);
}
VALUE
rb_float_equal(VALUE x, VALUE y)
{
    ...
    if (( ((RUBY_T_FIXNUM) == RUBY_T_FIXNUM) ? (((int)(long)(y))&RUBY_FIXNUM_FLAG) : ((RUBY_T_FIXNUM) == RUBY_T_TRUE) ? ((y) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_FIXNUM) == RUBY_T_FALSE) ? ((y) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_FIXNUM) == RUBY_T_NIL) ? ((y) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_FIXNUM) == RUBY_T_UNDEF) ? ((y) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_FIXNUM) == RUBY_T_SYMBOL) ? ((((VALUE)(y)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(y) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(y) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(y))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_FIXNUM) == RUBY_T_FLOAT) ? ( ((((int)(long)(y))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(y) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(y) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(y))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(y) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(y) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(y))->flags & RUBY_T_MASK) == (RUBY_T_FIXNUM))) || ( ((RUBY_T_BIGNUM) == RUBY_T_FIXNUM) ? (((int)(long)(y))&RUBY_FIXNUM_FLAG) : ((RUBY_T_BIGNUM) == RUBY_T_TRUE) ? ((y) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_BIGNUM) == RUBY_T_FALSE) ? ((y) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_BIGNUM) == RUBY_T_NIL) ? ((y) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_BIGNUM) == RUBY_T_UNDEF) ? ((y) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_BIGNUM) == RUBY_T_SYMBOL) ? ((((VALUE)(y)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(y) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(y) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(y))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_BIGNUM) == RUBY_T_FLOAT) ? ( ((((int)(long)(y))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(y) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(y) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(y))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(y) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(y) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(y))->flags & RUBY_T_MASK) == (RUBY_T_BIGNUM)))) {
        return rb_integer_float_eq(y, x);
    }
    else if (( ((RUBY_T_FLOAT) == RUBY_T_FIXNUM) ? (((int)(long)(y))&RUBY_FIXNUM_FLAG) : ((RUBY_T_FLOAT) == RUBY_T_TRUE) ? ((y) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_FLOAT) == RUBY_T_FALSE) ? ((y) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_FLOAT) == RUBY_T_NIL) ? ((y) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_FLOAT) == RUBY_T_UNDEF) ? ((y) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_FLOAT) == RUBY_T_SYMBOL) ? ((((VALUE)(y)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(y) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(y) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(y))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_FLOAT) == RUBY_T_FLOAT) ? ( ((((int)(long)(y))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(y) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(y) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(y))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(y) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(y) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(y))->flags & RUBY_T_MASK) == (RUBY_T_FLOAT)))) {
 b = rb_float_value_inline(y);
...
flo_hash(VALUE num)
{
    return rb_dbl_hash(rb_float_value_inline(num));
}

VALUE
rb_dbl_hash(double d)
{
    return (((VALUE)(rb_dbl_long_hash(d)))<<1 | RUBY_FIXNUM_FLAG);
}

VALUE
rb_dbl_cmp(double a, double b)
{
    if ((sizeof ((a)) == sizeof (float) ? __isnanf (a) : sizeof ((a)) == sizeof (double) ? __isnan (a) : __isnanl (a)) || (sizeof ((b)) == sizeof (float) ? __isnanf (b) : sizeof ((b)) == sizeof (double) ? __isnan (b) : __isnanl (b))) return ((VALUE)RUBY_Qnil);
    if (a == b) return (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG);
    if (a > b) return (((VALUE)(1))<<1 | RUBY_FIXNUM_FLAG);
    if (a < b) return (((VALUE)(-1))<<1 | RUBY_FIXNUM_FLAG);
    return ((VALUE)RUBY_Qnil);
}
static VALUE
flo_cmp(VALUE x, VALUE y)
{
    ...
    a = rb_float_value_inline(x);
    if ((sizeof ((a)) == sizeof (float) ? __isnanf (a) : sizeof ((a)) == sizeof (double) ? __isnan (a) : __isnanl (a))) return ((VALUE)RUBY_Qnil);
    if (( ((RUBY_T_FIXNUM) == RUBY_T_FIXNUM) ? (((int)(long)(y))&RUBY_FIXNUM_FLAG) : ((RUBY_T_FIXNUM) == RUBY_T_TRUE) ? ((y) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_FIXNUM) == RUBY_T_FALSE) ? ((y) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_FIXNUM) == RUBY_T_NIL) ? ((y) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_FIXNUM) == RUBY_T_UNDEF) ? ((y) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_FIXNUM) == RUBY_T_SYMBOL) ? ((((VALUE)(y)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(y) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(y) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(y))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_FIXNUM) == RUBY_T_FLOAT) ? ( ((((int)(long)(y))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(y) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(y) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(y))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(y) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(y) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(y))->flags & RUBY_T_MASK) == (RUBY_T_FIXNUM))) || ( ((RUBY_T_BIGNUM) == RUBY_T_FIXNUM) ? (((int)(long)(y))&RUBY_FIXNUM_FLAG) : ((RUBY_T_BIGNUM) == RUBY_T_TRUE) ? ((y) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_BIGNUM) == RUBY_T_FALSE) ? ((y) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_BIGNUM) == RUBY_T_NIL) ? ((y) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_BIGNUM) == RUBY_T_UNDEF) ? ((y) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_BIGNUM) == RUBY_T_SYMBOL) ? ((((VALUE)(y)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(y) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(y) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(y))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_BIGNUM) == RUBY_T_FLOAT) ? ( ((((int)(long)(y))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(y) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(y) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(y))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(y) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(y) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(y))->flags & RUBY_T_MASK) == (RUBY_T_BIGNUM)))) {
        VALUE rel = rb_integer_float_cmp(y, x);
        if ((((int)(long)(rel))&RUBY_FIXNUM_FLAG))
            return (((VALUE)(-((int)rb_fix2int((VALUE)(rel)))))<<1 | RUBY_FIXNUM_FLAG);
        return rel;
    }
    else if (( ((RUBY_T_FLOAT) == RUBY_T_FIXNUM) ? (((int)(long)(y))&RUBY_FIXNUM_FLAG) : ((RUBY_T_FLOAT) == RUBY_T_TRUE) ? ((y) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_FLOAT) == RUBY_T_FALSE) ? ((y) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_FLOAT) == RUBY_T_NIL) ? ((y) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_FLOAT) == RUBY_T_UNDEF) ? ((y) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_FLOAT) == RUBY_T_SYMBOL) ? ((((VALUE)(y)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(y) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(y) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(y))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_FLOAT) == RUBY_T_FLOAT) ? ( ((((int)(long)(y))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(y) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(y) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(y))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(y) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(y) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(y))->flags & RUBY_T_MASK) == (RUBY_T_FLOAT)))) {
 b = rb_float_value_inline(y);
 ...
 if ((sizeof ((a)) == sizeof (float) ? __isinff (a) : sizeof ((a)) == sizeof (double) ? __isinf (a) : __isinfl (a)) && (i = rb_check_funcall(y, (__builtin_constant_p("infinite?") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("infinite?")), (long)strlen(("infinite?"))); (ID) rb_intern_id_cache; }) : rb_intern("infinite?")), 0, 0)) != ((VALUE)RUBY_Qundef)) {
     if (!(((VALUE)(i) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) {
  int j = rb_cmpint(i, x, y);
  j = (a > 0.0) ? (j > 0 ? 0 : +1) : (j < 0 ? 0 : -1);
  return (((VALUE)(j))<<1 | RUBY_FIXNUM_FLAG);
     }
     if (a > 0.0) return (((VALUE)(1))<<1 | RUBY_FIXNUM_FLAG);
...
{
    return rb_num2int_inline(flo_cmp(x, y));
}
VALUE
rb_float_gt(VALUE x, VALUE y)
{
    ...
    if (( ((RUBY_T_FIXNUM) == RUBY_T_FIXNUM) ? (((int)(long)(y))&RUBY_FIXNUM_FLAG) : ((RUBY_T_FIXNUM) == RUBY_T_TRUE) ? ((y) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_FIXNUM) == RUBY_T_FALSE) ? ((y) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_FIXNUM) == RUBY_T_NIL) ? ((y) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_FIXNUM) == RUBY_T_UNDEF) ? ((y) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_FIXNUM) == RUBY_T_SYMBOL) ? ((((VALUE)(y)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(y) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(y) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(y))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_FIXNUM) == RUBY_T_FLOAT) ? ( ((((int)(long)(y))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(y) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(y) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(y))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(y) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(y) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(y))->flags & RUBY_T_MASK) == (RUBY_T_FIXNUM))) || ( ((RUBY_T_BIGNUM) == RUBY_T_FIXNUM) ? (((int)(long)(y))&RUBY_FIXNUM_FLAG) : ((RUBY_T_BIGNUM) == RUBY_T_TRUE) ? ((y) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_BIGNUM) == RUBY_T_FALSE) ? ((y) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_BIGNUM) == RUBY_T_NIL) ? ((y) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_BIGNUM) == RUBY_T_UNDEF) ? ((y) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_BIGNUM) == RUBY_T_SYMBOL) ? ((((VALUE)(y)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(y) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(y) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(y))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_BIGNUM) == RUBY_T_FLOAT) ? ( ((((int)(long)(y))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(y) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(y) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(y))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(y) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(y) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(y))->flags & RUBY_T_MASK) == (RUBY_T_BIGNUM)))) {
        VALUE rel = rb_integer_float_cmp(y, x);
        if ((((int)(long)(rel))&RUBY_FIXNUM_FLAG))
            return -((int)rb_fix2int((VALUE)(rel))) > 0 ? ((VALUE)RUBY_Qtrue) : ((VALUE)RUBY_Qfalse);
        return ((VALUE)RUBY_Qfalse);
    }
    else if (( ((RUBY_T_FLOAT) == RUBY_T_FIXNUM) ? (((int)(long)(y))&RUBY_FIXNUM_FLAG) : ((RUBY_T_FLOAT) == RUBY_T_TRUE) ? ((y) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_FLOAT) == RUBY_T_FALSE) ? ((y) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_FLOAT) == RUBY_T_NIL) ? ((y) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_FLOAT) == RUBY_T_UNDEF) ? ((y) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_FLOAT) == RUBY_T_SYMBOL) ? ((((VALUE)(y)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(y) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(y) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(y))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_FLOAT) == RUBY_T_FLOAT) ? ( ((((int)(long)(y))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(y) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(y) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(y))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(y) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(y) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(y))->flags & RUBY_T_MASK) == (RUBY_T_FLOAT)))) {
 b = rb_float_value_inline(y);
...
{
    if (( ((RUBY_T_FLOAT) == RUBY_T_FIXNUM) ? (((int)(long)(y))&RUBY_FIXNUM_FLAG) : ((RUBY_T_FLOAT) == RUBY_T_TRUE) ? ((y) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_FLOAT) == RUBY_T_FALSE) ? ((y) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_FLOAT) == RUBY_T_NIL) ? ((y) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_FLOAT) == RUBY_T_UNDEF) ? ((y) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_FLOAT) == RUBY_T_SYMBOL) ? ((((VALUE)(y)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(y) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(y) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(y))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_FLOAT) == RUBY_T_FLOAT) ? ( ((((int)(long)(y))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(y) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(y) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(y))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(y) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(y) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(y))->flags & RUBY_T_MASK) == (RUBY_T_FLOAT)))) {
 double a = rb_float_value_inline(x);
 double b = rb_float_value_inline(y);
...
{
    double val = fabs(rb_float_value_inline(flt));
    return rb_float_new_inline(val);
}
static VALUE
flo_zero_p(VALUE num)
{
    if (rb_float_value_inline(num) == 0.0) {
 return ((VALUE)RUBY_Qtrue);
    }
    return ((VALUE)RUBY_Qfalse);
}
...
{
    double value = rb_float_value_inline(num);

    return (sizeof ((value)) == sizeof (float) ? __isnanf (value) : sizeof ((value)) == sizeof (double) ? __isnan (value) : __isnanl (value)) ? ((VALUE)RUBY_Qtrue) : ((VALUE)RUBY_Qfalse);
}
VALUE
rb_flo_is_infinite_p(VALUE num)
{
    ...
    if ((sizeof ((value)) == sizeof (float) ? __isinff (value) : sizeof ((value)) == sizeof (double) ? __isinf (value) : __isinfl (value))) {
 return (((VALUE)(value < 0 ? -1 : 1))<<1 | RUBY_FIXNUM_FLAG);
    }
...
rb_flo_is_finite_p(VALUE num)
{
    ...
    if ((sizeof ((value)) == sizeof (float) ? __isinff (value) : sizeof ((value)) == sizeof (double) ? __isinf (value) : __isinfl (value)) || (sizeof ((value)) == sizeof (float) ? __isnanf (value) : sizeof ((value)) == sizeof (double) ? __isnan (value) : __isnanl (value)))
 return ((VALUE)RUBY_Qfalse);
...
{
    double x, y;
    x = rb_num2dbl((VALUE)(vx));
    y = nextafter(x, (__builtin_inff ()));
    return rb_float_new_inline(y);
}
static VALUE
...
flo_floor(int argc, VALUE *argv, VALUE num)
{
 ...
 ndigits = rb_num2int_inline(argv[0]);
    }
    number = rb_float_value_inline(num);
    if (number == 0.0) {
 return ndigits > 0 ? rb_float_new_inline(number) : (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG);
    }
    if (ndigits > 0) {
 int binexp;
 frexp(number, &binexp);
 ...
 if (number > 0.0 && float_round_underflow(ndigits, binexp))
     return rb_float_new_inline(0.0);
 f = pow(10, ndigits);
 f = floor(number * f) / f;
 return rb_float_new_inline(f);
    }
    else {
...
int_round_zero_p(VALUE num, int ndigits)
{
 ...
 bytes = rb_num2long_inline(rb_funcall(num, idSize, 0));
    }
    return (-0.415241 * ndigits - 0.125 > bytes);
}

static long
int_round_half_even(long x, long y)
{
    long z = +(x + y / 2) / y;
    if ((z * y - x) * 2 == y) {
 z &= ~1;
...
static long
int_round_half_up(long x, long y)
{
    return (x + y / 2) / y * y;
}

static long
int_round_half_down(long x, long y)
{
    return (x + y / 2 - 1) / y * y;
}
...
rb_int_round(VALUE num, int ndigits, enum ruby_num_rounding_mode mode)
{
 ...
 return (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG);
    ...
    if ((((int)(long)(num))&RUBY_FIXNUM_FLAG) && (((int)(long)(f))&RUBY_FIXNUM_FLAG)) {
 long x = ((long)(((long)(num))>>(int)(1))), y = ((long)(((long)(f))>>(int)(1)));
 int neg = x < 0;
 if (neg) x = -x;
 x = ((mode) == RUBY_NUM_ROUND_HALF_EVEN ? int_round_half_even (x, y) : (mode) == RUBY_NUM_ROUND_HALF_UP ? int_round_half_up (x, y) : int_round_half_down (x, y));
 if (neg) x = -x;
 return rb_long2num_inline(x);
    }
    if (( ((RUBY_T_FLOAT) == RUBY_T_FIXNUM) ? (((int)(long)(f))&RUBY_FIXNUM_FLAG) : ((RUBY_T_FLOAT) == RUBY_T_TRUE) ? ((f) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_FLOAT) == RUBY_T_FALSE) ? ((f) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_FLOAT) == RUBY_T_NIL) ? ((f) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_FLOAT) == RUBY_T_UNDEF) ? ((f) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_FLOAT) == RUBY_T_SYMBOL) ? ((((VALUE)(f)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(f) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(f) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(f))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_FLOAT) == RUBY_T_FLOAT) ? ( ((((int)(long)(f))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(f) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(f) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(f))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(f) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(f) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(f))->flags & RUBY_T_MASK) == (RUBY_T_FLOAT)))) {

 return (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG);
    }
    h = rb_int_idiv(f, (((VALUE)(2))<<1 | RUBY_FIXNUM_FLAG));
    r = rb_int_modulo(num, f);
    n = rb_int_minus(num, r);
    r = rb_int_cmp(r, h);
    if (((long)(r) > (long)(((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG)) ||
 (((r) == (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG)) && ((mode) == RUBY_NUM_ROUND_HALF_EVEN ? int_half_p_half_even (num, n, f) : (mode) == RUBY_NUM_ROUND_HALF_UP ? int_half_p_half_up (num, n, f) : int_half_p_half_down (num, n, f)))) {
 n = rb_int_plus(n, f);
    }
    return n;
}
...
flo_round(int argc, VALUE *argv, VALUE num)
{
 ...
 return rb_int_round(flo_to_i(num), ndigits, mode);
    ...
    if (ndigits == 0) {
 x = ((mode) == RUBY_NUM_ROUND_HALF_EVEN ? round_half_even (number, 1.0) : (mode) == RUBY_NUM_ROUND_HALF_UP ? round_half_up (number, 1.0) : round_half_down (number, 1.0));
 return dbl2ival(x);
    }
    if ((sizeof ((number)) == sizeof (float) ? __finitef (number) : sizeof ((number)) == sizeof (double) ? __finite (number) : __finitel (number))) {
 int binexp;
 frexp(number, &binexp);
 if (float_round_overflow(ndigits, binexp)) return num;
 if (float_round_underflow(ndigits, binexp)) return rb_float_new_inline(0);
 f = pow(10, ndigits);
 x = ((mode) == RUBY_NUM_ROUND_HALF_EVEN ? round_half_even (number, f) : (mode) == RUBY_NUM_ROUND_HALF_UP ? round_half_up (number, f) : round_half_down (number, f));
 return rb_float_new_inline(x / f);
    }
    return num;
}
...
flo_to_i(VALUE num)
{
    double f = rb_float_value_inline(num);
...
{
    if ((sizeof ((rb_float_value_inline(num))) == sizeof (float) ? __builtin_signbitf (rb_float_value_inline(num)) : sizeof ((rb_float_value_inline(num))) == sizeof (double) ? __builtin_signbit (rb_float_value_inline(num)) : __builtin_signbitl (rb_float_value_inline(num))))
...
{
    double f = rb_float_value_inline(num);
    return f > 0.0 ? ((VALUE)RUBY_Qtrue) : ((VALUE)RUBY_Qfalse);
}
static VALUE
...
ruby_float_step_size(double beg, double end, double unit, int excl)
{
    ...
    if ((sizeof ((unit)) == sizeof (float) ? __isinff (unit) : sizeof ((unit)) == sizeof (double) ? __isinf (unit) : __isinfl (unit))) {
...
{
    if (( ((RUBY_T_FLOAT) == RUBY_T_FIXNUM) ? (((int)(long)(from))&RUBY_FIXNUM_FLAG) : ((RUBY_T_FLOAT) == RUBY_T_TRUE) ? ((from) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_FLOAT) == RUBY_T_FALSE) ? ((from) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_FLOAT) == RUBY_T_NIL) ? ((from) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_FLOAT) == RUBY_T_UNDEF) ? ((from) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_FLOAT) == RUBY_T_SYMBOL) ? ((((VALUE)(from)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(from) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(from) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(from))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_FLOAT) == RUBY_T_FLOAT) ? ( ((((int)(long)(from))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(from) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(from) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(from))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(from) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(from) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(from))->flags & RUBY_T_MASK) == (RUBY_T_FLOAT))) || ( ((RUBY_T_FLOAT) == RUBY_T_FIXNUM) ? (((int)(long)(to))&RUBY_FIXNUM_FLAG) : ((RUBY_T_FLOAT) == RUBY_T_TRUE) ? ((to) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_FLOAT) == RUBY_T_FALSE) ? ((to) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_FLOAT) == RUBY_T_NIL) ? ((to) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_FLOAT) == RUBY_T_UNDEF) ? ((to) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_FLOAT) == RUBY_T_SYMBOL) ? ((((VALUE)(to)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(to) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(to) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(to))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_FLOAT) == RUBY_T_FLOAT) ? ( ((((int)(long)(to))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(to) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(to) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(to))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(to) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(to) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(to))->flags & RUBY_T_MASK) == (RUBY_T_FLOAT))) || ( ((RUBY_T_FLOAT) == RUBY_T_FIXNUM) ? (((int)(long)(step))&RUBY_FIXNUM_FLAG) : ((RUBY_T_FLOAT) == RUBY_T_TRUE) ? ((step) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_FLOAT) == RUBY_T_FALSE) ? ((step) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_FLOAT) == RUBY_T_NIL) ? ((step) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_FLOAT) == RUBY_T_UNDEF) ? ((step) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_FLOAT) == RUBY_T_SYMBOL) ? ((((VALUE)(step)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(step) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(step) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(step))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_FLOAT) == RUBY_T_FLOAT) ? ( ((((int)(long)(step))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(step) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(step) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(step))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(step) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(step) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(step))->flags & RUBY_T_MASK) == (RUBY_T_FLOAT)))) {
 double beg = rb_num2dbl((VALUE)(from));
 double end = rb_num2dbl((VALUE)(to));
 double unit = rb_num2dbl((VALUE)(step));
 double n = ruby_float_step_size(beg, end, unit, excl);
 long i;

 if ((sizeof ((unit)) == sizeof (float) ? __isinff (unit) : sizeof ((unit)) == sizeof (double) ? __isinf (unit) : __isinfl (unit))) {

     if (n) rb_yield(rb_float_new_inline(beg));
 }
 else if (unit == 0) {
     VALUE val = rb_float_new_inline(beg);
     for (;;)
  rb_yield(val);
 }
 else {
  ...
  rb_yield(rb_float_new_inline(d));
     }
 }
 return TRUE;
    }
...
{
    if ((((int)(long)(from))&RUBY_FIXNUM_FLAG) && (((int)(long)(to))&RUBY_FIXNUM_FLAG) && (((int)(long)(step))&RUBY_FIXNUM_FLAG)) {
 long delta, diff;

 diff = ((long)(((long)(step))>>(int)(1)));
 if (diff == 0) {
     return rb_float_new_inline((__builtin_inff ()));
 }
 delta = ((long)(((long)(to))>>(int)(1))) - ((long)(((long)(from))>>(int)(1)));
 if (diff < 0) {
     diff = -diff;
     delta = -delta;
 }
 ...
 return rb_ulong2num_inline(delta / diff + 1UL);
    }
    else if (( ((RUBY_T_FLOAT) == RUBY_T_FIXNUM) ? (((int)(long)(from))&RUBY_FIXNUM_FLAG) : ((RUBY_T_FLOAT) == RUBY_T_TRUE) ? ((from) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_FLOAT) == RUBY_T_FALSE) ? ((from) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_FLOAT) == RUBY_T_NIL) ? ((from) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_FLOAT) == RUBY_T_UNDEF) ? ((from) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_FLOAT) == RUBY_T_SYMBOL) ? ((((VALUE)(from)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(from) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(from) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(from))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_FLOAT) == RUBY_T_FLOAT) ? ( ((((int)(long)(from))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(from) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(from) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(from))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(from) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(from) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(from))->flags & RUBY_T_MASK) == (RUBY_T_FLOAT))) || ( ((RUBY_T_FLOAT) == RUBY_T_FIXNUM) ? (((int)(long)(to))&RUBY_FIXNUM_FLAG) : ((RUBY_T_FLOAT) == RUBY_T_TRUE) ? ((to) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_FLOAT) == RUBY_T_FALSE) ? ((to) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_FLOAT) == RUBY_T_NIL) ? ((to) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_FLOAT) == RUBY_T_UNDEF) ? ((to) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_FLOAT) == RUBY_T_SYMBOL) ? ((((VALUE)(to)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(to) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(to) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(to))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_FLOAT) == RUBY_T_FLOAT) ? ( ((((int)(long)(to))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(to) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(to) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(to))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(to) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(to) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(to))->flags & RUBY_T_MASK) == (RUBY_T_FLOAT))) || ( ((RUBY_T_FLOAT) == RUBY_T_FIXNUM) ? (((int)(long)(step))&RUBY_FIXNUM_FLAG) : ((RUBY_T_FLOAT) == RUBY_T_TRUE) ? ((step) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_FLOAT) == RUBY_T_FALSE) ? ((step) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_FLOAT) == RUBY_T_NIL) ? ((step) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_FLOAT) == RUBY_T_UNDEF) ? ((step) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_FLOAT) == RUBY_T_SYMBOL) ? ((((VALUE)(step)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(step) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(step) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(step))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_FLOAT) == RUBY_T_FLOAT) ? ( ((((int)(long)(step))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(step) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(step) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(step))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(step) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(step) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(step))->flags & RUBY_T_MASK) == (RUBY_T_FLOAT)))) {
 double n = ruby_float_step_size(rb_num2dbl((VALUE)(from)), rb_num2dbl((VALUE)(to)), rb_num2dbl((VALUE)(step)), excl);

 if ((sizeof ((n)) == sizeof (float) ? __isinff (n) : sizeof ((n)) == sizeof (double) ? __isinf (n) : __isinfl (n))) return rb_float_new_inline(n);
 ...
 VALUE result;
 ID cmp = '>';
 switch (rb_cmpint(rb_num_coerce_cmp(step, (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG), idCmp), step, (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG))) {
   case 0: return rb_float_new_inline((__builtin_inff ()));
   case -1: cmp = '<'; break;
 }
 if (!(((VALUE)(rb_funcall(from, cmp, 1, to)) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) return (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG);
 result = rb_funcall(rb_funcall(to, '-', 1, from), id_div, 1, step);
 if (!excl || !(((VALUE)(rb_funcall(rb_funcall(from, '+', 1, rb_funcall(result, '*', 1, step)), cmp, 1, to)) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) {
     result = rb_funcall(result, '+', 1, (((VALUE)(1))<<1 | RUBY_FIXNUM_FLAG));
 }
 return result;
    }
}
...
num_step_negative_p(VALUE num)
{
 ...
 if (rb_method_basic_definition_p(rb_cInteger, mid))
    ...
    if (r == ((VALUE)RUBY_Qundef)) {
 coerce_failed(num, (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG));
    }
    return !!(((VALUE)(r) & (VALUE)~((VALUE)RUBY_Qnil)) == 0);
}
...
num_step_scan_args(int argc, const VALUE *argv, VALUE *to, VALUE *step)
{
 ...
 if (values[0] != ((VALUE)RUBY_Qundef)) {
     if (argc > 0) rb_raise(rb_eArgError, "to is given twice");
     *to = values[0];
 }
 if (values[1] != ((VALUE)RUBY_Qundef)) {
 ...
 if (argc > 1 && !((VALUE)(*step) != ((VALUE)RUBY_Qnil))) {
     rb_raise(rb_eTypeError, "step must be numeric");
 }
 if (rb_equal(*step, (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG))) {
     rb_raise(rb_eArgError, "step can't be 0");
 }
    }
    if (!((VALUE)(*step) != ((VALUE)RUBY_Qnil))) {
 *step = (((VALUE)(1))<<1 | RUBY_FIXNUM_FLAG);
    }
    desc = num_step_negative_p(*step);
    if (!((VALUE)(*to) != ((VALUE)RUBY_Qnil))) {
 *to = desc ? rb_float_new_inline(-(__builtin_inff ())) : rb_float_new_inline((__builtin_inff ()));
    }
    return desc;
}
...
{
    VALUE to, step;
    int argc = args ? rb_long2int_inline(rb_array_len(args)) : 0;
    const VALUE *argv = args ? rb_array_const_ptr(args) : 0;
...
num_step(int argc, VALUE *argv, VALUE from)
{
    ...
    do { if (!rb_block_given_p()) return rb_enumeratorize_with_size((from), (rb_id2sym(rb_frame_this_func())), (argc), (argv), (rb_enumerator_size_func *)((num_step_size))); } while (0);

    desc = num_step_scan_args(argc, argv, &to, &step);
    if (rb_equal(step, (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG))) {
 inf = 1;
    }
    else if (( ((RUBY_T_FLOAT) == RUBY_T_FIXNUM) ? (((int)(long)(to))&RUBY_FIXNUM_FLAG) : ((RUBY_T_FLOAT) == RUBY_T_TRUE) ? ((to) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_FLOAT) == RUBY_T_FALSE) ? ((to) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_FLOAT) == RUBY_T_NIL) ? ((to) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_FLOAT) == RUBY_T_UNDEF) ? ((to) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_FLOAT) == RUBY_T_SYMBOL) ? ((((VALUE)(to)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(to) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(to) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(to))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_FLOAT) == RUBY_T_FLOAT) ? ( ((((int)(long)(to))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(to) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(to) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(to))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(to) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(to) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(to))->flags & RUBY_T_MASK) == (RUBY_T_FLOAT)))) {
 double f = rb_float_value_inline(to);
 inf = (sizeof ((f)) == sizeof (float) ? __isinff (f) : sizeof ((f)) == sizeof (double) ? __isinf (f) : __isinfl (f)) && ((sizeof ((f)) == sizeof (float) ? __builtin_signbitf (f) : sizeof ((f)) == sizeof (double) ? __builtin_signbit (f) : __builtin_signbitl (f)) ? desc : !desc);
    }
    else inf = 0;

    if ((((int)(long)(from))&RUBY_FIXNUM_FLAG) && (inf || (((int)(long)(to))&RUBY_FIXNUM_FLAG)) && (((int)(long)(step))&RUBY_FIXNUM_FLAG)) {
 long i = ((long)(((long)(from))>>(int)(1)));
 long diff = ((long)(((long)(step))>>(int)(1)));

 if (inf) {
     for (;; i += diff)
  rb_yield((((VALUE)(i))<<1 | RUBY_FIXNUM_FLAG));
 }
 else {
     long end = ((long)(((long)(to))>>(int)(1)));
 ...
 if (inf) {
  ...
  rb_yield(i);
     ...
     for (; !!(((VALUE)(rb_funcall(i, cmp, 1, to)) & (VALUE)~((VALUE)RUBY_Qnil)) == 0); i = rb_funcall(i, '+', 1, step))
  rb_yield(i);
 }
    }
    return from;
...
out_of_range_float(char (*pbuf)[24], VALUE val)
{
    ...
    ruby_snprintf(buf, sizeof(*pbuf), "%-.10g", rb_float_value_inline(val));
...
rb_num2long(VALUE val)
{
 ...
 rb_raise(rb_eTypeError, "no implicit conversion from nil to integer");
    ...
    if ((((int)(long)(val))&RUBY_FIXNUM_FLAG)) return ((long)(((long)(val))>>(int)(1)));

    else if (( ((RUBY_T_FLOAT) == RUBY_T_FIXNUM) ? (((int)(long)(val))&RUBY_FIXNUM_FLAG) : ((RUBY_T_FLOAT) == RUBY_T_TRUE) ? ((val) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_FLOAT) == RUBY_T_FALSE) ? ((val) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_FLOAT) == RUBY_T_NIL) ? ((val) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_FLOAT) == RUBY_T_UNDEF) ? ((val) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_FLOAT) == RUBY_T_SYMBOL) ? ((((VALUE)(val)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(val) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(val) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(val))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_FLOAT) == RUBY_T_FLOAT) ? ( ((((int)(long)(val))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(val) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(val) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(val))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(val) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(val) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(val))->flags & RUBY_T_MASK) == (RUBY_T_FLOAT)))) {
 if (rb_float_value_inline(val) < (2*(double)(9223372036854775807L/2+1))
     && (((double)(-9223372036854775807L -1L)-1) == (double)(-9223372036854775807L -1L) ? (-9223372036854775807L -1L) <= (rb_float_value_inline(val)): ((double)(-9223372036854775807L -1L)-1) < (rb_float_value_inline(val)))) {
     return (long)rb_float_value_inline(val);
 }
 else {
     do { char buf[24]; rb_raise(rb_eRangeError, "float %s out of range of integer", out_of_range_float(&buf, (val))); } while (0);
 }
    }
    else if (( ((RUBY_T_BIGNUM) == RUBY_T_FIXNUM) ? (((int)(long)(val))&RUBY_FIXNUM_FLAG) : ((RUBY_T_BIGNUM) == RUBY_T_TRUE) ? ((val) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_BIGNUM) == RUBY_T_FALSE) ? ((val) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_BIGNUM) == RUBY_T_NIL) ? ((val) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_BIGNUM) == RUBY_T_UNDEF) ? ((val) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_BIGNUM) == RUBY_T_SYMBOL) ? ((((VALUE)(val)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(val) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(val) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(val))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_BIGNUM) == RUBY_T_FLOAT) ? ( ((((int)(long)(val))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(val) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(val) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(val))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(val) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(val) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(val))->flags & RUBY_T_MASK) == (RUBY_T_BIGNUM)))) {
...
rb_num2ulong_internal(VALUE val, int *wrap_p)
{
 ...
 double d = rb_float_value_inline(val);
 if (d < (2*(double)((9223372036854775807L *2UL+1UL)/2+1)) && (((double)(-9223372036854775807L -1L)-1) == (double)(-9223372036854775807L -1L) ? (-9223372036854775807L -1L) <= (d): ((double)(-9223372036854775807L -1L)-1) < (d))) {
     if (wrap_p)
  *wrap_p = d <= -1.0;
     if (0 <= d)
  return (unsigned long)d;
     ...
     do { char buf[24]; rb_raise(rb_eRangeError, "float %s out of range of integer", out_of_range_float(&buf, (val))); } while (0);
    ...
    else if (( ((RUBY_T_BIGNUM) == RUBY_T_FIXNUM) ? (((int)(long)(val))&RUBY_FIXNUM_FLAG) : ((RUBY_T_BIGNUM) == RUBY_T_TRUE) ? ((val) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_BIGNUM) == RUBY_T_FALSE) ? ((val) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_BIGNUM) == RUBY_T_NIL) ? ((val) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_BIGNUM) == RUBY_T_UNDEF) ? ((val) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_BIGNUM) == RUBY_T_SYMBOL) ? ((((VALUE)(val)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(val) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(val) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(val))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_BIGNUM) == RUBY_T_FLOAT) ? ( ((((int)(long)(val))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(val) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(val) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(val))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(val) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(val) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(val))->flags & RUBY_T_MASK) == (RUBY_T_BIGNUM)))) {
        {
            ...
            if (wrap_p)
                *wrap_p = (!((((struct RBasic*)(val))->flags & ((VALUE)((VALUE)RUBY_FL_USER1))) != 0));
            return ul;
        }
    }
    else {
...
{
    return rb_num2ulong_internal(val, ((void*)0));
}


void
rb_out_of_int(long num)
{
...
{
    long num = (((int)(long)(val))&RUBY_FIXNUM_FLAG)?((long)(((long)(val))>>(int)(1))):rb_num2long(val);
...
rb_fix2uint(VALUE val)
{
 ...
 return rb_num2uint(val);
    ...
    num = ((unsigned long)((long)(((long)(val))>>(int)(1))));

    check_uint(num, rb_num_negative_int_p(val));
    return num;
}
 static void rb_out_of_short(long num);
static void
rb_out_of_short(long num)
{
...
rb_num2fix(VALUE val)
{
    ...
    if ((((int)(long)(val))&RUBY_FIXNUM_FLAG)) return val;
...
rb_num2ll(VALUE val)
{
 ...
 rb_raise(rb_eTypeError, "no implicit conversion from nil");
    ...
    if ((((int)(long)(val))&RUBY_FIXNUM_FLAG)) return (long long)((long)(((long)(val))>>(int)(1)));

    else if (( ((RUBY_T_FLOAT) == RUBY_T_FIXNUM) ? (((int)(long)(val))&RUBY_FIXNUM_FLAG) : ((RUBY_T_FLOAT) == RUBY_T_TRUE) ? ((val) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_FLOAT) == RUBY_T_FALSE) ? ((val) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_FLOAT) == RUBY_T_NIL) ? ((val) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_FLOAT) == RUBY_T_UNDEF) ? ((val) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_FLOAT) == RUBY_T_SYMBOL) ? ((((VALUE)(val)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(val) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(val) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(val))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_FLOAT) == RUBY_T_FLOAT) ? ( ((((int)(long)(val))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(val) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(val) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(val))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(val) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(val) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(val))->flags & RUBY_T_MASK) == (RUBY_T_FLOAT)))) {
 double d = rb_float_value_inline(val);
 if (d < (2*(double)(9223372036854775807LL/2+1)) && ((((double)(-9223372036854775807LL -1LL)-1) == (double)(-9223372036854775807LL -1LL) ? (-9223372036854775807LL -1LL) <= (d): ((double)(-9223372036854775807LL -1LL)-1) < (d)))) {
     return (long long)d;
 }
 else {
     do { char buf[24]; rb_raise(rb_eRangeError, "float %s out of range of long long", out_of_range_float(&buf, (val))); } while (0);
 }
    }
    else if (( ((RUBY_T_BIGNUM) == RUBY_T_FIXNUM) ? (((int)(long)(val))&RUBY_FIXNUM_FLAG) : ((RUBY_T_BIGNUM) == RUBY_T_TRUE) ? ((val) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_BIGNUM) == RUBY_T_FALSE) ? ((val) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_BIGNUM) == RUBY_T_NIL) ? ((val) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_BIGNUM) == RUBY_T_UNDEF) ? ((val) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_BIGNUM) == RUBY_T_SYMBOL) ? ((((VALUE)(val)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(val) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(val) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(val))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_BIGNUM) == RUBY_T_FLOAT) ? ( ((((int)(long)(val))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(val) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(val) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(val))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(val) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(val) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(val))->flags & RUBY_T_MASK) == (RUBY_T_BIGNUM)))) {
 return rb_big2ll(val);
    }
    else if (( ((RUBY_T_STRING) == RUBY_T_FIXNUM) ? (((int)(long)(val))&RUBY_FIXNUM_FLAG) : ((RUBY_T_STRING) == RUBY_T_TRUE) ? ((val) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_STRING) == RUBY_T_FALSE) ? ((val) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_STRING) == RUBY_T_NIL) ? ((val) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_STRING) == RUBY_T_UNDEF) ? ((val) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_STRING) == RUBY_T_SYMBOL) ? ((((VALUE)(val)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(val) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(val) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(val))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_STRING) == RUBY_T_FLOAT) ? ( ((((int)(long)(val))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(val) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(val) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(val))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(val) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(val) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(val))->flags & RUBY_T_MASK) == (RUBY_T_STRING)))) {
 rb_raise(rb_eTypeError, "no implicit conversion from string");
    }
    else if (( ((RUBY_T_TRUE) == RUBY_T_FIXNUM) ? (((int)(long)(val))&RUBY_FIXNUM_FLAG) : ((RUBY_T_TRUE) == RUBY_T_TRUE) ? ((val) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_TRUE) == RUBY_T_FALSE) ? ((val) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_TRUE) == RUBY_T_NIL) ? ((val) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_TRUE) == RUBY_T_UNDEF) ? ((val) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_TRUE) == RUBY_T_SYMBOL) ? ((((VALUE)(val)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(val) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(val) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(val))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_TRUE) == RUBY_T_FLOAT) ? ( ((((int)(long)(val))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(val) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(val) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(val))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(val) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(val) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(val))->flags & RUBY_T_MASK) == (RUBY_T_TRUE))) || ( ((RUBY_T_FALSE) == RUBY_T_FIXNUM) ? (((int)(long)(val))&RUBY_FIXNUM_FLAG) : ((RUBY_T_FALSE) == RUBY_T_TRUE) ? ((val) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_FALSE) == RUBY_T_FALSE) ? ((val) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_FALSE) == RUBY_T_NIL) ? ((val) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_FALSE) == RUBY_T_UNDEF) ? ((val) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_FALSE) == RUBY_T_SYMBOL) ? ((((VALUE)(val)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(val) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(val) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(val))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_FALSE) == RUBY_T_FLOAT) ? ( ((((int)(long)(val))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(val) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(val) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(val))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(val) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(val) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(val))->flags & RUBY_T_MASK) == (RUBY_T_FALSE)))) {
 rb_raise(rb_eTypeError, "no implicit conversion from boolean");
    }

    val = rb_to_int(val);
    return rb_num2ll_inline(val);
}

unsigned long long
rb_num2ull(VALUE val)
{
    if (( ((RUBY_T_NIL) == RUBY_T_FIXNUM) ? (((int)(long)(val))&RUBY_FIXNUM_FLAG) : ((RUBY_T_NIL) == RUBY_T_TRUE) ? ((val) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_NIL) == RUBY_T_FALSE) ? ((val) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_NIL) == RUBY_T_NIL) ? ((val) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_NIL) == RUBY_T_UNDEF) ? ((val) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_NIL) == RUBY_T_SYMBOL) ? ((((VALUE)(val)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(val) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(val) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(val))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_NIL) == RUBY_T_FLOAT) ? ( ((((int)(long)(val))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(val) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(val) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(val))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(val) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(val) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(val))->flags & RUBY_T_MASK) == (RUBY_T_NIL)))) {
 rb_raise(rb_eTypeError, "no implicit conversion from nil");
    }
    else if (( ((RUBY_T_FIXNUM) == RUBY_T_FIXNUM) ? (((int)(long)(val))&RUBY_FIXNUM_FLAG) : ((RUBY_T_FIXNUM) == RUBY_T_TRUE) ? ((val) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_FIXNUM) == RUBY_T_FALSE) ? ((val) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_FIXNUM) == RUBY_T_NIL) ? ((val) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_FIXNUM) == RUBY_T_UNDEF) ? ((val) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_FIXNUM) == RUBY_T_SYMBOL) ? ((((VALUE)(val)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(val) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(val) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(val))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_FIXNUM) == RUBY_T_FLOAT) ? ( ((((int)(long)(val))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(val) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(val) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(val))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(val) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(val) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(val))->flags & RUBY_T_MASK) == (RUBY_T_FIXNUM)))) {
 return (long long)((long)(((long)(val))>>(int)(1)));
    }
    else if (( ((RUBY_T_FLOAT) == RUBY_T_FIXNUM) ? (((int)(long)(val))&RUBY_FIXNUM_FLAG) : ((RUBY_T_FLOAT) == RUBY_T_TRUE) ? ((val) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_FLOAT) == RUBY_T_FALSE) ? ((val) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_FLOAT) == RUBY_T_NIL) ? ((val) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_FLOAT) == RUBY_T_UNDEF) ? ((val) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_FLOAT) == RUBY_T_SYMBOL) ? ((((VALUE)(val)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(val) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(val) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(val))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_FLOAT) == RUBY_T_FLOAT) ? ( ((((int)(long)(val))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(val) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(val) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(val))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(val) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(val) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(val))->flags & RUBY_T_MASK) == (RUBY_T_FLOAT)))) {
 double d = rb_float_value_inline(val);
 if (d < (2*(double)((9223372036854775807LL*2ULL+1ULL)/2+1)) && (((double)(-9223372036854775807LL -1LL)-1) == (double)(-9223372036854775807LL -1LL) ? (-9223372036854775807LL -1LL) <= (d): ((double)(-9223372036854775807LL -1LL)-1) < (d))) {
     if (0 <= d)
  return (unsigned long long)d;
     return (unsigned long long)(long long)d;
 }
 else {
     do { char buf[24]; rb_raise(rb_eRangeError, "float %s out of range of unsigned long long", out_of_range_float(&buf, (val))); } while (0);
 }
    }
    else if (( ((RUBY_T_BIGNUM) == RUBY_T_FIXNUM) ? (((int)(long)(val))&RUBY_FIXNUM_FLAG) : ((RUBY_T_BIGNUM) == RUBY_T_TRUE) ? ((val) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_BIGNUM) == RUBY_T_FALSE) ? ((val) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_BIGNUM) == RUBY_T_NIL) ? ((val) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_BIGNUM) == RUBY_T_UNDEF) ? ((val) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_BIGNUM) == RUBY_T_SYMBOL) ? ((((VALUE)(val)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(val) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(val) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(val))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_BIGNUM) == RUBY_T_FLOAT) ? ( ((((int)(long)(val))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(val) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(val) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(val))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(val) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(val) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(val))->flags & RUBY_T_MASK) == (RUBY_T_BIGNUM)))) {
...
rb_int_odd_p(VALUE num)
{
 ...
 return rb_big_odd_p(num);
    ...
    else if (rb_funcall(num, '%', 1, (((VALUE)(2))<<1 | RUBY_FIXNUM_FLAG)) != (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG)) {
 return ((VALUE)RUBY_Qtrue);
    }
    return ((VALUE)RUBY_Qfalse);
}
...
{
    mask = rb_to_int(mask);
    return num_zero_p(rb_int_and(num, mask)) ? ((VALUE)RUBY_Qfalse) : ((VALUE)RUBY_Qtrue);
}
static VALUE
...
{
    if ((((int)(long)(num))&RUBY_FIXNUM_FLAG)) {
 long i = ((long)(((long)(num))>>(int)(1))) + 1;
 return rb_long2num_inline(i);
    }
    if (( ((RUBY_T_BIGNUM) == RUBY_T_FIXNUM) ? (((int)(long)(num))&RUBY_FIXNUM_FLAG) : ((RUBY_T_BIGNUM) == RUBY_T_TRUE) ? ((num) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_BIGNUM) == RUBY_T_FALSE) ? ((num) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_BIGNUM) == RUBY_T_NIL) ? ((num) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_BIGNUM) == RUBY_T_UNDEF) ? ((num) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_BIGNUM) == RUBY_T_SYMBOL) ? ((((VALUE)(num)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(num) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(num) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(num))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_BIGNUM) == RUBY_T_FLOAT) ? ( ((((int)(long)(num))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(num) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(num) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(num))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(num) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(num) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(num))->flags & RUBY_T_MASK) == (RUBY_T_BIGNUM)))) {
 return rb_big_plus(num, (((VALUE)(1))<<1 | RUBY_FIXNUM_FLAG));
    }
    return num_funcall1(num, '+', (((VALUE)(1))<<1 | RUBY_FIXNUM_FLAG));
}
VALUE
rb_int_pred(VALUE num)
{
 ...
 return rb_long2num_inline(i);
    ...
    if (( ((RUBY_T_BIGNUM) == RUBY_T_FIXNUM) ? (((int)(long)(num))&RUBY_FIXNUM_FLAG) : ((RUBY_T_BIGNUM) == RUBY_T_TRUE) ? ((num) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_BIGNUM) == RUBY_T_FALSE) ? ((num) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_BIGNUM) == RUBY_T_NIL) ? ((num) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_BIGNUM) == RUBY_T_UNDEF) ? ((num) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_BIGNUM) == RUBY_T_SYMBOL) ? ((((VALUE)(num)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(num) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(num) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(num))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_BIGNUM) == RUBY_T_FLOAT) ? ( ((((int)(long)(num))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(num) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(num) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(num))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(num) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(num) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(num))->flags & RUBY_T_MASK) == (RUBY_T_BIGNUM)))) {
 return rb_big_minus(num, (((VALUE)(1))<<1 | RUBY_FIXNUM_FLAG));
    }
    return num_funcall1(num, '-', (((VALUE)(1))<<1 | RUBY_FIXNUM_FLAG));
}
VALUE
rb_enc_uint_chr(unsigned int code, rb_encoding *enc)
{
 ...
 break;
    ...
    str =  ({ (__builtin_constant_p(0) && __builtin_constant_p(n)) ? rb_enc_str_new_static((0), (n), (enc)) : rb_enc_str_new((0), (n), (enc)); });
    ((enc))->code_to_mbc((code),(OnigUChar*)((!(((struct RBasic*)(str))->flags & RSTRING_NOEMBED) ? ((struct RString*)(str))->as.ary : ((struct RString*)(str))->as.heap.ptr)),(enc));
    if (rb_enc_precise_mbclen((!(((struct RBasic*)(str))->flags & RSTRING_NOEMBED) ? ((struct RString*)(str))->as.ary : ((struct RString*)(str))->as.heap.ptr), (!(((struct RBasic*)(str))->flags & RSTRING_NOEMBED) ? (((struct RString*)(str))->as.ary + (long)((((struct RBasic*)(str))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT))) : (((struct RString*)(str))->as.heap.ptr + ((struct RString*)(str))->as.heap.len)), enc) != n) {
 rb_raise(rb_eRangeError, "invalid codepoint 0x%X in %s", code, (enc)->name);
    }
    return str;
}
...
int_chr(int argc, VALUE *argv, VALUE num)
{
    ...
    else if ((((int)(long)(num))&RUBY_FIXNUM_FLAG)) {
 rb_raise(rb_eRangeError, "%ld out of char range", ((long)(((long)(num))>>(int)(1))));
    }
    else {
 ...
 c = (char)i;
 if (i < 0x80) {
     return  ({ (__builtin_constant_p(&c) && __builtin_constant_p(1)) ? rb_usascii_str_new_static((&c), (1)) : rb_usascii_str_new((&c), (1)); });
 }
 else {
     return  ({ (__builtin_constant_p(&c) && __builtin_constant_p(1)) ? rb_str_new_static((&c), (1)) : rb_str_new((&c), (1)); });
 }
      case 1:
 break;
      default:
...
{
    return rb_long2num_inline(-((long)(((long)(num))>>(int)(1))));
}
...
{
    char buf[8*8 + 1], *const e = buf + sizeof buf, *b = e;
    long val = ((long)(((long)(x))>>(int)(1)));
    unsigned long u;
    int neg = 0;
 ...
 *--b = '-';
    ...
    return  ({ (__builtin_constant_p(b) && __builtin_constant_p(e - b)) ? rb_usascii_str_new_static((b), (e - b)) : rb_usascii_str_new((b), (e - b)); });
}
...
rb_int2str(VALUE x, int base)
{
 ...
 return rb_fix2str(x, base);
    ...
    else if (( ((RUBY_T_BIGNUM) == RUBY_T_FIXNUM) ? (((int)(long)(x))&RUBY_FIXNUM_FLAG) : ((RUBY_T_BIGNUM) == RUBY_T_TRUE) ? ((x) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_BIGNUM) == RUBY_T_FALSE) ? ((x) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_BIGNUM) == RUBY_T_NIL) ? ((x) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_BIGNUM) == RUBY_T_UNDEF) ? ((x) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_BIGNUM) == RUBY_T_SYMBOL) ? ((((VALUE)(x)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(x) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(x) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(x))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_BIGNUM) == RUBY_T_FLOAT) ? ( ((((int)(long)(x))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(x) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(x) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(x))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(x) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(x) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(x))->flags & RUBY_T_MASK) == (RUBY_T_BIGNUM)))) {
...
fix_plus(VALUE x, VALUE y)
{
 ...
 return rb_float_new_inline((double)((long)(((long)(x))>>(int)(1))) + rb_float_value_inline(y));
    }
    else if (( ((RUBY_T_COMPLEX) == RUBY_T_FIXNUM) ? (((int)(long)(y))&RUBY_FIXNUM_FLAG) : ((RUBY_T_COMPLEX) == RUBY_T_TRUE) ? ((y) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_COMPLEX) == RUBY_T_FALSE) ? ((y) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_COMPLEX) == RUBY_T_NIL) ? ((y) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_COMPLEX) == RUBY_T_UNDEF) ? ((y) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_COMPLEX) == RUBY_T_SYMBOL) ? ((((VALUE)(y)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(y) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(y) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(y))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_COMPLEX) == RUBY_T_FLOAT) ? ( ((((int)(long)(y))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(y) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(y) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(y))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(y) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(y) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(y))->flags & RUBY_T_MASK) == (RUBY_T_COMPLEX)))) {
...
fix_minus(VALUE x, VALUE y)
{
 ...
 x = rb_int2big(((long)(((long)(x))>>(int)(1))));
...
fix_mul(VALUE x, VALUE y)
{
 ...
 switch (x) {
   case (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG): return x;
   case (((VALUE)(1))<<1 | RUBY_FIXNUM_FLAG): return y;
 }
...
{
    if ((((int)(long)(y))&RUBY_FIXNUM_FLAG)) {
        return (double)((long)(((long)(x))>>(int)(1))) / (double)((long)(((long)(y))>>(int)(1)));
    }
    else if (( ((RUBY_T_BIGNUM) == RUBY_T_FIXNUM) ? (((int)(long)(y))&RUBY_FIXNUM_FLAG) : ((RUBY_T_BIGNUM) == RUBY_T_TRUE) ? ((y) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_BIGNUM) == RUBY_T_FALSE) ? ((y) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_BIGNUM) == RUBY_T_NIL) ? ((y) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_BIGNUM) == RUBY_T_UNDEF) ? ((y) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_BIGNUM) == RUBY_T_SYMBOL) ? ((((VALUE)(y)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(y) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(y) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(y))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_BIGNUM) == RUBY_T_FLOAT) ? ( ((((int)(long)(y))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(y) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(y) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(y))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(y) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(y) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(y))->flags & RUBY_T_MASK) == (RUBY_T_BIGNUM)))) {
        return rb_big_fdiv_double(rb_int2big(((long)(((long)(x))>>(int)(1)))), y);
    }
    else if (( ((RUBY_T_FLOAT) == RUBY_T_FIXNUM) ? (((int)(long)(y))&RUBY_FIXNUM_FLAG) : ((RUBY_T_FLOAT) == RUBY_T_TRUE) ? ((y) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_FLOAT) == RUBY_T_FALSE) ? ((y) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_FLOAT) == RUBY_T_NIL) ? ((y) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_FLOAT) == RUBY_T_UNDEF) ? ((y) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_FLOAT) == RUBY_T_SYMBOL) ? ((((VALUE)(y)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(y) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(y) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(y))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_FLOAT) == RUBY_T_FLOAT) ? ( ((((int)(long)(y))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(y) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(y) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(y))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(y) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(y) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(y))->flags & RUBY_T_MASK) == (RUBY_T_FLOAT)))) {
        return (double)((long)(((long)(x))>>(int)(1))) / rb_float_value_inline(y);
    }
    else {
...
{
    if ( ({ const VALUE integer_type_obj = (y); ((((int)(long)(integer_type_obj))&RUBY_FIXNUM_FLAG) || (!(((VALUE)(integer_type_obj) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(integer_type_obj) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(integer_type_obj))->flags & RUBY_T_MASK) == RUBY_T_BIGNUM)); }) && !((y) == (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG))) {
 VALUE gcd = rb_gcd(x, y);
 if (!((gcd) == (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG))) {
     x = rb_int_idiv(x, gcd);
     y = rb_int_idiv(y, gcd);
 }
    }
...
rb_int_fdiv(VALUE x, VALUE y)
{
    if ( ({ const VALUE integer_type_obj = (x); ((((int)(long)(integer_type_obj))&RUBY_FIXNUM_FLAG) || (!(((VALUE)(integer_type_obj) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(integer_type_obj) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(integer_type_obj))->flags & RUBY_T_MASK) == RUBY_T_BIGNUM)); })) {
        return rb_float_new_inline(rb_int_fdiv_double(x, y));
    }
    return ((VALUE)RUBY_Qnil);
}
static VALUE
...
{
    if ((((int)(long)(y))&RUBY_FIXNUM_FLAG)) {
 if (((y) == (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG))) rb_num_zerodiv();
    ...
    else if (( ((RUBY_T_FLOAT) == RUBY_T_FIXNUM) ? (((int)(long)(y))&RUBY_FIXNUM_FLAG) : ((RUBY_T_FLOAT) == RUBY_T_TRUE) ? ((y) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_FLOAT) == RUBY_T_FALSE) ? ((y) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_FLOAT) == RUBY_T_NIL) ? ((y) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_FLOAT) == RUBY_T_UNDEF) ? ((y) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_FLOAT) == RUBY_T_SYMBOL) ? ((((VALUE)(y)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(y) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(y) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(y))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_FLOAT) == RUBY_T_FLOAT) ? ( ((((int)(long)(y))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(y) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(y) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(y))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(y) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(y) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(y))->flags & RUBY_T_MASK) == (RUBY_T_FLOAT)))) {
 {
     ...
     if (op == '/') {
  div = (double)((long)(((long)(x))>>(int)(1))) / rb_float_value_inline(y);
  return rb_float_new_inline(div);
     }
     else {
  if (rb_float_value_inline(y) == 0) rb_num_zerodiv();
  div = (double)((long)(((long)(x))>>(int)(1))) / rb_float_value_inline(y);
 ...
 if (( ((RUBY_T_RATIONAL) == RUBY_T_FIXNUM) ? (((int)(long)(y))&RUBY_FIXNUM_FLAG) : ((RUBY_T_RATIONAL) == RUBY_T_TRUE) ? ((y) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_RATIONAL) == RUBY_T_FALSE) ? ((y) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_RATIONAL) == RUBY_T_NIL) ? ((y) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_RATIONAL) == RUBY_T_UNDEF) ? ((y) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_RATIONAL) == RUBY_T_SYMBOL) ? ((((VALUE)(y)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(y) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(y) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(y))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_RATIONAL) == RUBY_T_FLOAT) ? ( ((((int)(long)(y))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(y) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(y) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(y))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(y) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(y) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(y))->flags & RUBY_T_MASK) == (RUBY_T_RATIONAL))) &&
     op == '/' && ((long)(((long)(x))>>(int)(1))) == 1)
...
fix_mod(VALUE x, VALUE y)
{
 ...
 return rb_float_new_inline(ruby_float_mod((double)((long)(((long)(x))>>(int)(1))), rb_float_value_inline(y)));
    }
    else {
 return rb_num_coerce_bin(x, y, '%');
    }
...
fix_divmod(VALUE x, VALUE y)
{
    ...
    else if (( ((RUBY_T_FLOAT) == RUBY_T_FIXNUM) ? (((int)(long)(y))&RUBY_FIXNUM_FLAG) : ((RUBY_T_FLOAT) == RUBY_T_TRUE) ? ((y) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_FLOAT) == RUBY_T_FALSE) ? ((y) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_FLOAT) == RUBY_T_NIL) ? ((y) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_FLOAT) == RUBY_T_UNDEF) ? ((y) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_FLOAT) == RUBY_T_SYMBOL) ? ((((VALUE)(y)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(y) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(y) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(y))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_FLOAT) == RUBY_T_FLOAT) ? ( ((((int)(long)(y))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(y) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(y) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(y))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(y) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(y) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(y))->flags & RUBY_T_MASK) == (RUBY_T_FLOAT)))) {
 {
     ...
     flodivmod((double)((long)(((long)(x))>>(int)(1))), rb_float_value_inline(y), &div, &mod);
     a = dbl2ival(div);
     b = rb_float_new_inline(mod);
     return rb_assoc_new(a, b);
 }
...
int_pow(long x, unsigned long y)
{
    ...
    if (y == 0) return (((VALUE)(1))<<1 | RUBY_FIXNUM_FLAG);
    if (neg) x = -x;
    if (y & 1)
 z = x;
    else
 neg = 0;
    ...
    do {
 while (y % 2 == 0) {
     if (!(((x)<((long)1<<((8*8 -1)/2)))&&((x)>=-((long)1<<((8*8 -1)/2))))) {
  VALUE v;
       bignum:
  v = rb_big_pow(rb_int2big(x), rb_long2num_inline(y));
  if (( ((((int)(long)(v))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(v) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(v) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(v))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)))
      return v;
 ...
 {
            if (({ struct { long fixnum : 8 * 8 - 1; } c; __builtin_mul_overflow_p((x), (z), c.fixnum); })) {
  goto bignum;
     }
     z = x * z;
 }
...
{
    long a = ((long)(((long)(x))>>(int)(1)));

    if ((((int)(long)(y))&RUBY_FIXNUM_FLAG)) {
 long b = ((long)(((long)(y))>>(int)(1)));

 if (a == 1) return (((VALUE)(1))<<1 | RUBY_FIXNUM_FLAG);
 if (a == -1) {
     if (b % 2 == 0)
  return (((VALUE)(1))<<1 | RUBY_FIXNUM_FLAG);
     else
 ...
 if (b < 0)
     return num_funcall1(rb_rational_raw((x), (((VALUE)(1))<<1 | RUBY_FIXNUM_FLAG)), idPow, y);

 if (b == 0) return (((VALUE)(1))<<1 | RUBY_FIXNUM_FLAG);
 if (b == 1) return x;
 if (a == 0) {
     if (b > 0) return (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG);
     return rb_float_new_inline((__builtin_inff ()));
 }
 return int_pow(a, b);
    }
 ...
 if (a == 1) return (((VALUE)(1))<<1 | RUBY_FIXNUM_FLAG);
 if (a == -1) {
     if (int_even_p(y)) return (((VALUE)(1))<<1 | RUBY_FIXNUM_FLAG);
     else return (((VALUE)(-1))<<1 | RUBY_FIXNUM_FLAG);
 }
 if (rb_num_negative_int_p(y))
     return num_funcall1(rb_rational_raw((x), (((VALUE)(1))<<1 | RUBY_FIXNUM_FLAG)), idPow, y);
 if (a == 0) return (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG);
 x = rb_int2big(((long)(((long)(x))>>(int)(1))));
 return rb_big_pow(x, y);
    }
    else if (( ((RUBY_T_FLOAT) == RUBY_T_FIXNUM) ? (((int)(long)(y))&RUBY_FIXNUM_FLAG) : ((RUBY_T_FLOAT) == RUBY_T_TRUE) ? ((y) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_FLOAT) == RUBY_T_FALSE) ? ((y) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_FLOAT) == RUBY_T_NIL) ? ((y) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_FLOAT) == RUBY_T_UNDEF) ? ((y) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_FLOAT) == RUBY_T_SYMBOL) ? ((((VALUE)(y)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(y) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(y) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(y))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_FLOAT) == RUBY_T_FLOAT) ? ( ((((int)(long)(y))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(y) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(y) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(y))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(y) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(y) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(y))->flags & RUBY_T_MASK) == (RUBY_T_FLOAT)))) {
 double dy = rb_float_value_inline(y);
 if (dy == 0.0) return rb_float_new_inline(1.0);
 if (a == 0) {
     return rb_float_new_inline(dy < 0 ? (__builtin_inff ()) : 0.0);
 }
 if (a == 1) return rb_float_new_inline(1.0);
 {
     if (a < 0 && dy != round(dy))
  return num_funcall1(rb_complex_raw((x), (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG)), idPow, y);
     return rb_float_new_inline(pow((double)a, dy));
 }
    }
    else {
 return rb_num_coerce_bin(x, y, idPow);
...
{
    if (x == y) return ((VALUE)RUBY_Qtrue);
    if ((((int)(long)(y))&RUBY_FIXNUM_FLAG)) return ((VALUE)RUBY_Qfalse);
    else if (( ((RUBY_T_BIGNUM) == RUBY_T_FIXNUM) ? (((int)(long)(y))&RUBY_FIXNUM_FLAG) : ((RUBY_T_BIGNUM) == RUBY_T_TRUE) ? ((y) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_BIGNUM) == RUBY_T_FALSE) ? ((y) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_BIGNUM) == RUBY_T_NIL) ? ((y) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_BIGNUM) == RUBY_T_UNDEF) ? ((y) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_BIGNUM) == RUBY_T_SYMBOL) ? ((((VALUE)(y)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(y) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(y) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(y))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_BIGNUM) == RUBY_T_FLOAT) ? ( ((((int)(long)(y))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(y) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(y) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(y))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(y) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(y) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(y))->flags & RUBY_T_MASK) == (RUBY_T_BIGNUM)))) {
...
fix_cmp(VALUE x, VALUE y)
{
    if (x == y) return (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG);
    if ((((int)(long)(y))&RUBY_FIXNUM_FLAG)) {
 if (((long)(((long)(x))>>(int)(1))) > ((long)(((long)(y))>>(int)(1)))) return (((VALUE)(1))<<1 | RUBY_FIXNUM_FLAG);
 return (((VALUE)(-1))<<1 | RUBY_FIXNUM_FLAG);
    }
    else if (( ((RUBY_T_BIGNUM) == RUBY_T_FIXNUM) ? (((int)(long)(y))&RUBY_FIXNUM_FLAG) : ((RUBY_T_BIGNUM) == RUBY_T_TRUE) ? ((y) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_BIGNUM) == RUBY_T_FALSE) ? ((y) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_BIGNUM) == RUBY_T_NIL) ? ((y) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_BIGNUM) == RUBY_T_UNDEF) ? ((y) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_BIGNUM) == RUBY_T_SYMBOL) ? ((((VALUE)(y)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(y) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(y) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(y))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_BIGNUM) == RUBY_T_FLOAT) ? ( ((((int)(long)(y))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(y) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(y) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(y))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(y) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(y) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(y))->flags & RUBY_T_MASK) == (RUBY_T_BIGNUM)))) {
 VALUE cmp = rb_big_cmp(y, x);
 switch (cmp) {
   case (((VALUE)(+1))<<1 | RUBY_FIXNUM_FLAG): return (((VALUE)(-1))<<1 | RUBY_FIXNUM_FLAG);
   case (((VALUE)(-1))<<1 | RUBY_FIXNUM_FLAG): return (((VALUE)(+1))<<1 | RUBY_FIXNUM_FLAG);
 }
 return cmp;
    }
...
{
    if ((((int)(long)(y))&RUBY_FIXNUM_FLAG)) {
 if (((long)(((long)(x))>>(int)(1))) > ((long)(((long)(y))>>(int)(1)))) return ((VALUE)RUBY_Qtrue);
 return ((VALUE)RUBY_Qfalse);
    }
    else if (( ((RUBY_T_BIGNUM) == RUBY_T_FIXNUM) ? (((int)(long)(y))&RUBY_FIXNUM_FLAG) : ((RUBY_T_BIGNUM) == RUBY_T_TRUE) ? ((y) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_BIGNUM) == RUBY_T_FALSE) ? ((y) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_BIGNUM) == RUBY_T_NIL) ? ((y) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_BIGNUM) == RUBY_T_UNDEF) ? ((y) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_BIGNUM) == RUBY_T_SYMBOL) ? ((((VALUE)(y)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(y) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(y) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(y))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_BIGNUM) == RUBY_T_FLOAT) ? ( ((((int)(long)(y))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(y) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(y) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(y))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(y) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(y) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(y))->flags & RUBY_T_MASK) == (RUBY_T_BIGNUM)))) {
 return rb_big_cmp(y, x) == (((VALUE)(-1))<<1 | RUBY_FIXNUM_FLAG) ? ((VALUE)RUBY_Qtrue) : ((VALUE)RUBY_Qfalse);
    }
    else if (( ((RUBY_T_FLOAT) == RUBY_T_FIXNUM) ? (((int)(long)(y))&RUBY_FIXNUM_FLAG) : ((RUBY_T_FLOAT) == RUBY_T_TRUE) ? ((y) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_FLOAT) == RUBY_T_FALSE) ? ((y) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_FLOAT) == RUBY_T_NIL) ? ((y) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_FLOAT) == RUBY_T_UNDEF) ? ((y) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_FLOAT) == RUBY_T_SYMBOL) ? ((((VALUE)(y)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(y) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(y) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(y))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_FLOAT) == RUBY_T_FLOAT) ? ( ((((int)(long)(y))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(y) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(y) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(y))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(y) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(y) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(y))->flags & RUBY_T_MASK) == (RUBY_T_FLOAT)))) {
        return rb_integer_float_cmp(x, y) == (((VALUE)(1))<<1 | RUBY_FIXNUM_FLAG) ? ((VALUE)RUBY_Qtrue) : ((VALUE)RUBY_Qfalse);
    }
    else {
 return rb_num_coerce_relop(x, y, '>');
    }
...
fix_ge(VALUE x, VALUE y)
{
 ...
 return rel == (((VALUE)(1))<<1 | RUBY_FIXNUM_FLAG) || rel == (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG) ? ((VALUE)RUBY_Qtrue) : ((VALUE)RUBY_Qfalse);
    }
    else {
 return rb_num_coerce_relop(x, y, idGE);
    }
...
{
    if ((((int)(long)(y))&RUBY_FIXNUM_FLAG)) {
 long val = ((long)(((long)(x))>>(int)(1))) & ((long)(((long)(y))>>(int)(1)));
 return rb_long2num_inline(val);
    }
...
rb_fix_lshift(VALUE x, VALUE y)
{
    ...
    val = rb_num2long_inline(x);
    if (!(((int)(long)(y))&RUBY_FIXNUM_FLAG))
 return rb_big_lshift(rb_int2big(val), y);
    width = ((long)(((long)(y))>>(int)(1)));
    if (width < 0)
...
{
    if (width > (8*8 -1)
 || ((unsigned long)val)>>(8*8 -1-width) > 0) {
 return rb_big_lshift(rb_int2big(val), rb_ulong2num_inline(width));
    }
    val = val << width;
    return rb_long2num_inline(val);
}
...
fix_rshift(long val, unsigned long i)
{
 ...
 if (val < 0) return (((VALUE)(-1))<<1 | RUBY_FIXNUM_FLAG);
 return (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG);
    }
    val = ((val)>>(int)(i));
    return (((VALUE)(val))<<1 | RUBY_FIXNUM_FLAG);
}
...
fix_aref(VALUE fix, VALUE idx)
{
 ...
 idx = rb_big_norm(idx);
 if (!(((int)(long)(idx))&RUBY_FIXNUM_FLAG)) {
     if (!((((struct RBasic*)(idx))->flags & ((VALUE)((VALUE)RUBY_FL_USER1))) != 0) || val >= 0)
  return (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG);
     return (((VALUE)(1))<<1 | RUBY_FIXNUM_FLAG);
 }
    }
    i = ((long)(((long)(idx))>>(int)(1)));

    if (i < 0) return (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG);
    if (8*8 -1 <= i) {
 if (val < 0) return (((VALUE)(1))<<1 | RUBY_FIXNUM_FLAG);
 return (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG);
    }
...
int_to_f(VALUE num)
{
    ...
    if ((((int)(long)(num))&RUBY_FIXNUM_FLAG)) {
 val = (double)((long)(((long)(num))>>(int)(1)));
    }
    else if (( ((RUBY_T_BIGNUM) == RUBY_T_FIXNUM) ? (((int)(long)(num))&RUBY_FIXNUM_FLAG) : ((RUBY_T_BIGNUM) == RUBY_T_TRUE) ? ((num) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_BIGNUM) == RUBY_T_FALSE) ? ((num) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_BIGNUM) == RUBY_T_NIL) ? ((num) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_BIGNUM) == RUBY_T_UNDEF) ? ((num) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_BIGNUM) == RUBY_T_SYMBOL) ? ((((VALUE)(num)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(num) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(num) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(num))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_BIGNUM) == RUBY_T_FLOAT) ? ( ((((int)(long)(num))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(num) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(num) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(num))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(num) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(num) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(num))->flags & RUBY_T_MASK) == (RUBY_T_BIGNUM)))) {
 val = rb_big2dbl(num);
    }
...
fix_size(VALUE fix)
{
    return (((VALUE)(sizeof(long)))<<1 | RUBY_FIXNUM_FLAG);
}
...
{
    long v = ((long)(((long)(fix))>>(int)(1)));
    if (v < 0)
        v = ~v;
    return (((VALUE)((unsigned int) (sizeof(v) <= 4 ? 4 * 8 - nlz_int((unsigned int)(v)) : sizeof(v) <= 8 ? 8 * 8 - nlz_long((unsigned long)(v)) : sizeof(v) <= 8 ? 8 * 8 - nlz_long_long((unsigned long long)(v)) : 16 * 8 - nlz_int128((unsigned int)(v)))))<<1 | RUBY_FIXNUM_FLAG);
}
...
rb_int_digits_bigbase(VALUE num, VALUE base)
{
    ...
    ((!rb_num_negative_p(num)) ? (void) (0) : __assert_fail ("!rb_num_negative_p(num)", "numeric.c", 4793,  __PRETTY_FUNCTION__));

    if (( ((RUBY_T_BIGNUM) == RUBY_T_FIXNUM) ? (((int)(long)(base))&RUBY_FIXNUM_FLAG) : ((RUBY_T_BIGNUM) == RUBY_T_TRUE) ? ((base) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_BIGNUM) == RUBY_T_FALSE) ? ((base) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_BIGNUM) == RUBY_T_NIL) ? ((base) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_BIGNUM) == RUBY_T_UNDEF) ? ((base) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_BIGNUM) == RUBY_T_SYMBOL) ? ((((VALUE)(base)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(base) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(base) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(base))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_BIGNUM) == RUBY_T_FLOAT) ? ( ((((int)(long)(base))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(base) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(base) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(base))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(base) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(base) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(base))->flags & RUBY_T_MASK) == (RUBY_T_BIGNUM))))
        base = rb_big_norm(base);

    if ((((int)(long)(base))&RUBY_FIXNUM_FLAG) && ((long)(((long)(base))>>(int)(1))) < 2)
        rb_raise(rb_eArgError, "invalid radix %ld", ((long)(((long)(base))>>(int)(1))));
    else if (( ((RUBY_T_BIGNUM) == RUBY_T_FIXNUM) ? (((int)(long)(base))&RUBY_FIXNUM_FLAG) : ((RUBY_T_BIGNUM) == RUBY_T_TRUE) ? ((base) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_BIGNUM) == RUBY_T_FALSE) ? ((base) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_BIGNUM) == RUBY_T_NIL) ? ((base) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_BIGNUM) == RUBY_T_UNDEF) ? ((base) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_BIGNUM) == RUBY_T_SYMBOL) ? ((((VALUE)(base)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(base) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(base) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(base))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_BIGNUM) == RUBY_T_FLOAT) ? ( ((((int)(long)(base))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(base) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(base) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(base))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(base) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(base) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(base))->flags & RUBY_T_MASK) == (RUBY_T_BIGNUM))) && (!((((struct RBasic*)(base))->flags & ((VALUE)((VALUE)RUBY_FL_USER1))) != 0)))
        rb_raise(rb_eArgError, "negative radix");

    if ((((int)(long)(base))&RUBY_FIXNUM_FLAG) && (((int)(long)(num))&RUBY_FIXNUM_FLAG))
        return rb_fix_digits(num, ((long)(((long)(base))>>(int)(1))));

    if ((((int)(long)(num))&RUBY_FIXNUM_FLAG))
        return  ({ const VALUE args_to_new_ary[] = {num}; if (__builtin_constant_p(1)) { extern int (*__Static_assert_function (void)) [!!sizeof (struct { int __error_if_negative: (((int)(sizeof(args_to_new_ary) / sizeof((args_to_new_ary)[0]))) == (1)) ? 2 : -1; })]; } rb_ary_new_from_values(((int)(sizeof(args_to_new_ary) / sizeof((args_to_new_ary)[0]))), args_to_new_ary); });

    digits = rb_ary_new();
    while (!(((int)(long)(num))&RUBY_FIXNUM_FLAG) || ((long)(((long)(num))>>(int)(1))) > 0) {
        VALUE qr = rb_int_divmod(num, base);
        rb_ary_push(digits, (rb_array_const_ptr(qr)[1]));
        num = (rb_array_const_ptr(qr)[0]);
    }
...
rb_int_digits(int argc, VALUE *argv, VALUE num)
{
    ...
    if (rb_check_arity(argc, 0, 1)) {
        ...
        if (! ({ const VALUE integer_type_obj = (base_value); ((((int)(long)(integer_type_obj))&RUBY_FIXNUM_FLAG) || (!(((VALUE)(integer_type_obj) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(integer_type_obj) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(integer_type_obj))->flags & RUBY_T_MASK) == RUBY_T_BIGNUM)); }))
            rb_raise(rb_eTypeError, "wrong argument type %s (expected Integer)",
                     rb_obj_classname(argv[0]));
        if (( ((RUBY_T_BIGNUM) == RUBY_T_FIXNUM) ? (((int)(long)(base_value))&RUBY_FIXNUM_FLAG) : ((RUBY_T_BIGNUM) == RUBY_T_TRUE) ? ((base_value) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_BIGNUM) == RUBY_T_FALSE) ? ((base_value) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_BIGNUM) == RUBY_T_NIL) ? ((base_value) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_BIGNUM) == RUBY_T_UNDEF) ? ((base_value) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_BIGNUM) == RUBY_T_SYMBOL) ? ((((VALUE)(base_value)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(base_value) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(base_value) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(base_value))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_BIGNUM) == RUBY_T_FLOAT) ? ( ((((int)(long)(base_value))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(base_value) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(base_value) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(base_value))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(base_value) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(base_value) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(base_value))->flags & RUBY_T_MASK) == (RUBY_T_BIGNUM))))
            return rb_int_digits_bigbase(num, base_value);

        base = ((long)(((long)(base_value))>>(int)(1)));
        if (base < 0)
            rb_raise(rb_eArgError, "negative radix");
        else if (base < 2)
            rb_raise(rb_eArgError, "invalid radix %ld", base);
    ...
    if ((((int)(long)(num))&RUBY_FIXNUM_FLAG))
        ...
        return rb_int_digits_bigbase(num, (((VALUE)(base))<<1 | RUBY_FIXNUM_FLAG));
...
{
    return ruby_num_interval_step_size(from, (rb_array_const_ptr(args)[0]), (((VALUE)(1))<<1 | RUBY_FIXNUM_FLAG), FALSE);
}

static VALUE
int_upto(VALUE from, VALUE to)
{
    do { if (!rb_block_given_p()) return rb_enumeratorize_with_size((from), (rb_id2sym(rb_frame_this_func())), (1), (&to), (rb_enumerator_size_func *)((int_upto_size))); } while (0);
    if ((((int)(long)(from))&RUBY_FIXNUM_FLAG) && (((int)(long)(to))&RUBY_FIXNUM_FLAG)) {
 long i, end;

 end = ((long)(((long)(to))>>(int)(1)));
 for (i = ((long)(((long)(from))>>(int)(1))); i <= end; i++) {
     rb_yield((((VALUE)(i))<<1 | RUBY_FIXNUM_FLAG));
 }
    }
    else {
 ...
 while (!(c = rb_funcall(i, '>', 1, to))) {
     rb_yield(i);
     i = rb_funcall(i, '+', 1, (((VALUE)(1))<<1 | RUBY_FIXNUM_FLAG));
 }
 if (!((VALUE)(c) != ((VALUE)RUBY_Qnil))) rb_cmperr(i, to);
    }
    return from;
}
static VALUE
...
{
    do { if (!rb_block_given_p()) return rb_enumeratorize_with_size((from), (rb_id2sym(rb_frame_this_func())), (1), (&to), (rb_enumerator_size_func *)((int_downto_size))); } while (0);
    if ((((int)(long)(from))&RUBY_FIXNUM_FLAG) && (((int)(long)(to))&RUBY_FIXNUM_FLAG)) {
 long i, end;
...
{
    if ((((int)(long)(num))&RUBY_FIXNUM_FLAG)) {
 if (rb_num2long_inline(num) <= 0) return (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG);
    }
    else {
 if (!(((VALUE)(rb_funcall(num, '<', 1, (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG))) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) return (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG);
    }
    return num;
}
...
{
    do { if (!rb_block_given_p()) return rb_enumeratorize_with_size((num), (rb_id2sym(rb_frame_this_func())), (0), (0), (rb_enumerator_size_func *)((int_dotimes_size))); } while (0);

    if ((((int)(long)(num))&RUBY_FIXNUM_FLAG)) {
 long i, end;

 end = ((long)(((long)(num))>>(int)(1)));
 for (i=0; i<end; i++) {
     rb_yield_1((((VALUE)(i))<<1 | RUBY_FIXNUM_FLAG));
 }
    }
    else {
 VALUE i = (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG);

 for (;;) {
     if (!!(((VALUE)(rb_funcall(i, '<', 1, num)) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) break;
     rb_yield(i);
     i = rb_funcall(i, '+', 1, (((VALUE)(1))<<1 | RUBY_FIXNUM_FLAG));
 }
    }
...
unsigned long rb_ulong_isqrt(unsigned long n) { if (!((n) < (1UL << 53))) { unsigned int b = (unsigned int) (sizeof(n) <= 4 ? 4 * 8 - nlz_int((unsigned int)(n)) : sizeof(n) <= 8 ? 8 * 8 - nlz_long((unsigned long)(n)) : sizeof(n) <= 8 ? 8 * 8 - nlz_long_long((unsigned long long)(n)) : 16 * 8 - nlz_int128((unsigned int)(n))); unsigned long t; unsigned long x = (unsigned long)(n >> (b/2+1)); x |= ((unsigned long)1LU << (b-1)/2); while ((t = n/x) < (unsigned long)x) x = (unsigned long)((x + t) >> 1); return x; } return (unsigned long)sqrt((double)(n)); }
...
rb_int_s_isqrt(VALUE self, VALUE num)
{
    ...
    if ((((int)(long)(num))&RUBY_FIXNUM_FLAG)) {
 if (((long)(num) < 0)) {
     rb_raise(rb_eMathDomainError, "Numerical argument is out of domain - \"isqrt\"");
 }
 n = ((unsigned long)((long)(((long)(num))>>(int)(1))));
 sq = rb_ulong_isqrt(n);
 return (((VALUE)(sq))<<1 | RUBY_FIXNUM_FLAG);
    }
    else {
 size_t biglen;
 if (((rb_big_sign(num))==0)) {
     rb_raise(rb_eMathDomainError, "Numerical argument is out of domain - \"isqrt\"");
 }
 biglen = ((((struct RBasic*)(num))->flags & ((VALUE)((VALUE)RUBY_FL_USER2))) ? (size_t)((((struct RBasic*)(num))->flags >> (((VALUE)RUBY_FL_USHIFT)+3)) & (((VALUE)(((VALUE)RUBY_FL_USER5)|((VALUE)RUBY_FL_USER4)|((VALUE)RUBY_FL_USER3))) >> (((VALUE)RUBY_FL_USHIFT)+3))) : ((struct RBignum*)(num))->as.heap.len);
 if (biglen == 0) return (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG);


 if (biglen == 1) {
     n = ((((struct RBasic*)(num))->flags & ((VALUE)((VALUE)RUBY_FL_USER2))) ? ((struct RBignum*)(num))->as.ary : ((struct RBignum*)(num))->as.heap.digits)[0];
     sq = rb_ulong_isqrt(n);
...
Init_Numeric(void)
{
    ...
    id_coerce = (__builtin_constant_p("coerce") ?  (rb_intern2(("coerce"), (long)strlen("coerce"))) : (rb_intern)("coerce"));
    id_div = (__builtin_constant_p("div") ?  (rb_intern2(("div"), (long)strlen("div"))) : (rb_intern)("div"));
    id_divmod = (__builtin_constant_p("divmod") ?  (rb_intern2(("divmod"), (long)strlen("divmod"))) : (rb_intern)("divmod"));
    ...
    rb_define_method(rb_cNumeric, "clone", rb_immutable_obj_clone, -1);
    rb_define_method(rb_cNumeric, "dup", num_uplus, 0);
    ...
    rb_undef_method(rb_class_of((VALUE)(rb_cInteger)), "new");
    ...
    rb_define_method(rb_cInteger, "succ", rb_int_succ, 0);
    rb_define_method(rb_cInteger, "next", rb_int_succ, 0);
    rb_define_method(rb_cInteger, "pred", rb_int_pred, 0);
    ...
    rb_undef_method(rb_class_of((VALUE)(rb_cFloat)), "new");
    rb_define_const(rb_cFloat, "ROUNDS", (((VALUE)((__builtin_flt_rounds())))<<1 | RUBY_FIXNUM_FLAG));
    ...
    rb_define_const(rb_cFloat, "RADIX", (((VALUE)(2))<<1 | RUBY_FIXNUM_FLAG));





    rb_define_const(rb_cFloat, "MANT_DIG", (((VALUE)(53))<<1 | RUBY_FIXNUM_FLAG));
    ...
    rb_define_const(rb_cFloat, "DIG", (((VALUE)(15))<<1 | RUBY_FIXNUM_FLAG));
    ...
    rb_define_const(rb_cFloat, "MIN_EXP", (((VALUE)((-1021)))<<1 | RUBY_FIXNUM_FLAG));
    ...
    rb_define_const(rb_cFloat, "MAX_EXP", (((VALUE)(1024))<<1 | RUBY_FIXNUM_FLAG));
    ...
    rb_define_const(rb_cFloat, "MIN_10_EXP", (((VALUE)((-307)))<<1 | RUBY_FIXNUM_FLAG));
    ...
    rb_define_const(rb_cFloat, "MAX_10_EXP", (((VALUE)(308))<<1 | RUBY_FIXNUM_FLAG));
    rb_define_const(rb_cFloat, "MIN", rb_float_new_inline(2.2250738585072014e-308));





    rb_define_const(rb_cFloat, "MAX", rb_float_new_inline(1.7976931348623157e+308));
    ...
    rb_define_const(rb_cFloat, "EPSILON", rb_float_new_inline(2.2204460492503131e-16));



    rb_define_const(rb_cFloat, "INFINITY", rb_float_new_inline((__builtin_inff ())));



    rb_define_const(rb_cFloat, "NAN", rb_float_new_inline((__builtin_nanf (""))));
    ...
    rb_define_method(rb_cFloat, "==", rb_float_equal, 1);
    rb_define_method(rb_cFloat, "===", rb_float_equal, 1);
    ...
    rb_define_method(rb_cFloat, "eql?", rb_float_eql, 1);
    ...
    id_to = (__builtin_constant_p("to") ?  (rb_intern2(("to"), (long)strlen("to"))) : (rb_intern)("to"));
    id_by = (__builtin_constant_p("by") ?  (rb_intern2(("by"), (long)strlen("by"))) : (rb_intern)("by"));
}
