...
block_mark(const struct rb_block *block)
{
      ...
      case block_type_ifunc:
 {
     ...
     do { VALUE markobj = (captured->self); if (!(((VALUE)(markobj) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) {rb_gc_mark(markobj);} } while (0);
     do { VALUE markobj = ((VALUE)captured->code.val); if (!(((VALUE)(markobj) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) {rb_gc_mark(markobj);} } while (0);
     if (captured->ep && captured->ep[( 1)] != ((VALUE)RUBY_Qundef) ) {
  do { VALUE markobj = (VM_ENV_ENVVAL(captured->ep)); if (!(((VALUE)(markobj) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) {rb_gc_mark(markobj);} } while (0);
     }
 }
 break;
      case block_type_symbol:
 do { VALUE markobj = (block->as.symbol); if (!(((VALUE)(markobj) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) {rb_gc_mark(markobj);} } while (0);
 break;
      case block_type_proc:
 do { VALUE markobj = (block->as.proc); if (!(((VALUE)(markobj) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) {rb_gc_mark(markobj);} } while (0);
 break;
    }
}
...
{
    rb_proc_t *proc;
    return ({ VALUE data_struct_obj = rb_data_typed_object_zalloc(klass, sizeof(rb_proc_t), &proc_data_type); (void)((proc) = (rb_proc_t *)(((struct RData*)(data_struct_obj))->data));; data_struct_obj; });
}
...
rb_proc_lambda_p(VALUE procval)
{
    ...
    return proc->is_lambda ? ((VALUE)RUBY_Qtrue) : ((VALUE)RUBY_Qfalse);
}
...
rb_binding_alloc(VALUE klass)
{
    VALUE obj;
    rb_binding_t *bind;
    obj = ({ VALUE data_struct_obj = rb_data_typed_object_zalloc(klass, sizeof(rb_binding_t), &ruby_binding_data_type); (void)((bind) = (rb_binding_t *)(((struct RData*)(data_struct_obj))->data));; data_struct_obj; });
    return obj;
}
...
binding_dup(VALUE self)
{
    ...
    (((src)) = (rb_binding_t*)(((struct RData*)(((self))))->data));
    (((dst)) = (rb_binding_t*)(((struct RData*)(((bindval))))->data));
    rb_vm_block_copy(bindval, &dst->block, &src->block);
    ({
;
; int unaligned_member_access_result = (rb_obj_write((VALUE)(bindval), (VALUE *)(&dst->pathobj), (VALUE)(src->pathobj), "proc.c", 318));
; unaligned_member_access_result; });
...
bind_eval(int argc, VALUE *argv, VALUE bindval)
{
    ...
    args[1] = bindval;
    return rb_f_eval(argc+1, args, ((VALUE)RUBY_Qnil) );
}
 ...
 if (!VM_ENV_FLAGS(env->ep, VM_FRAME_FLAG_CFRAME)) {
  ...
  if (iseq->body->local_table[i] == lid) {
   ...
   if (!VM_ENV_FLAGS(ep, VM_FRAME_FLAG_MODIFIED_BLOCK_PARAM)) {
       ({
;
; int unaligned_member_access_result = (rb_obj_write((VALUE)(env), (VALUE *)(&env->env[i]), (VALUE)(rb_vm_bh_to_procval(rb_current_execution_context(), VM_ENV_BLOCK_HANDLER(ep))), "proc.c", 405));
; unaligned_member_access_result; });
...
check_local_id(VALUE bindval, volatile VALUE *pname)
{
 ...
 if (!rb_is_local_id(lid)) {
     rb_exc_raise(rb_name_err_new( ({ (__builtin_constant_p("wrong local variable name `%1$s' for %2$s")) ? rb_fstring_new(("wrong local variable name `%1$s' for %2$s"), (long)strlen("wrong local variable name `%1$s' for %2$s")) : rb_fstring_cstr("wrong local variable name `%1$s' for %2$s"); }), (bindval), ((rb_id2sym(lid)))));

 }
    }
    else {
 if (!rb_is_local_name(name)) {
     rb_exc_raise(rb_name_err_new( ({ (__builtin_constant_p("wrong local variable name `%1$s' for %2$s")) ? rb_fstring_new(("wrong local variable name `%1$s' for %2$s"), (long)strlen("wrong local variable name `%1$s' for %2$s")) : rb_fstring_cstr("wrong local variable name `%1$s' for %2$s"); }), (bindval), (name)));
...
bind_local_variable_get(VALUE bindval, VALUE sym)
{
    ...
    env = VM_ENV_ENVVAL_PTR(vm_block_ep(&bind->block));
    if ((ptr = get_local_variable_ptr(&env, lid)) == ((void*)0)) {
 sym = (rb_id2sym(lid));
      undefined:
 rb_exc_raise(rb_name_err_new( ({ (__builtin_constant_p("local variable `%1$s' is not defined for %2$s")) ? rb_fstring_new(("local variable `%1$s' is not defined for %2$s"), (long)strlen("local variable `%1$s' is not defined for %2$s")) : rb_fstring_cstr("local variable `%1$s' is not defined for %2$s"); }), (bindval), (sym)));
...
bind_local_variable_set(VALUE bindval, VALUE sym, VALUE val)
{
 ...
 env = VM_ENV_ENVVAL_PTR(vm_block_ep(&bind->block));
    ...
    ({
;
; int unaligned_member_access_result = (rb_obj_write((VALUE)(env), (VALUE *)(ptr), (VALUE)(val), "proc.c", 564));
; unaligned_member_access_result; });
...
bind_local_variable_defined_p(VALUE bindval, VALUE sym)
{
    ...
    if (!lid) return ((VALUE)RUBY_Qfalse);

    (((bind)) = (rb_binding_t*)(((struct RData*)(((bindval))))->data));
    env = VM_ENV_ENVVAL_PTR(vm_block_ep(&bind->block));
    return get_local_variable_ptr(&env, lid) ? ((VALUE)RUBY_Qtrue) : ((VALUE)RUBY_Qfalse);
}
...
cfunc_proc_new(VALUE klass, VALUE ifunc, int8_t is_lambda)
{
    rb_proc_t *proc;
    cfunc_proc_t *sproc;
    VALUE procval = ({ VALUE data_struct_obj = rb_data_typed_object_zalloc(klass, sizeof(cfunc_proc_t), &proc_data_type); (void)((sproc) = (cfunc_proc_t *)(((struct RData*)(data_struct_obj))->data));; data_struct_obj; });
    VALUE *ep;

    proc = &sproc->basic;
    vm_block_type_set(&proc->block, block_type_ifunc);

    *(VALUE **)&proc->block.as.captured.ep = ep = sproc->env + ( 3)-1;
    ep[( 0)] = VM_FRAME_MAGIC_IFUNC | VM_FRAME_FLAG_CFRAME | VM_ENV_FLAG_LOCAL | VM_ENV_FLAG_ESCAPED;
    ep[(-2)] = ((VALUE)RUBY_Qfalse);
    ep[(-1)] = 0;
    ep[( 1)] = ((VALUE)RUBY_Qundef);


    ({
;
; int unaligned_member_access_result = (rb_obj_write((VALUE)(procval), (VALUE *)(&proc->block.as.captured.code.ifunc), (VALUE)(ifunc), "proc.c", 632));
; unaligned_member_access_result; });
...
sym_proc_new(VALUE klass, VALUE sym)
{
    ...
    ({
;
; int unaligned_member_access_result = (rb_obj_write((VALUE)(procval), (VALUE *)(&proc->block.as.symbol), (VALUE)(sym), "proc.c", 645));
; unaligned_member_access_result; });
    return procval;
}

struct vm_ifunc *
rb_vm_ifunc_new(VALUE (*func)(), const void *data, int min_argc, int max_argc)
{
    union {
 struct vm_ifunc_argc argc;
 VALUE packed;
 ...
 rb_raise(rb_eRangeError, "maximum argument number out of range: %d",
   max_argc);
    ...
    return ((struct vm_ifunc *)rb_imemo_new(imemo_ifunc, (VALUE)(func), (VALUE)(data), (VALUE)(arity.packed), 0));
}
...
proc_new(VALUE klass, int8_t is_lambda)
{
    ...
    if ((block_handler = rb_vm_frame_block_handler(cfp)) == 0) {
 ...
 if ((((struct RBasic*)(procval))->klass) == klass) {
     return procval;
 }
 else {
     VALUE newprocval = proc_dup(procval);
     do { VALUE _obj_ = (newprocval); ({
;
; int unaligned_member_access_result = (rb_obj_write((VALUE)(_obj_), (VALUE *)(&((struct RBasicRaw *)(_obj_))->klass), (VALUE)(klass), "proc.c", 737));
; unaligned_member_access_result; }); } while (0);
     return newprocval;
 }
 break;
...
rb_proc_call(VALUE self, VALUE args)
{
    VALUE vret;
    rb_proc_t *proc;
    (((proc)) = (rb_proc_t*)(((struct RData*)(((self))))->data));
    vret = rb_vm_invoke_proc(rb_current_execution_context(), proc,
        check_argc(rb_array_len(args)), rb_array_const_ptr(args),
        0);
    (* ({ volatile VALUE *rb_gc_guarded_ptr = &(self); ; rb_gc_guarded_ptr; }));
...
{
    return !((VALUE)(procval) != ((VALUE)RUBY_Qnil)) ? 0 : procval;
}
...
proc_arity(VALUE self)
{
    ...
    return (((VALUE)(arity))<<1 | RUBY_FIXNUM_FLAG);
}
...
rb_proc_arity(VALUE self)
{
    ...
    return (proc->is_lambda ? min == max : max != (-1)) ? min : -min-1;
}
...
iseq_location(const rb_iseq_t *iseq)
{
    ...
    if (!iseq) return ((VALUE)RUBY_Qnil);
    rb_iseq_check(iseq);
    loc[0] = rb_iseq_path(iseq);
    loc[1] = iseq->body->location.first_lineno;

    return rb_ary_new_from_values(2, loc);
}
VALUE
...
{
    VALUE a, param = rb_ary_new_capa((arity < 0) ? -arity : arity);
    ...
    a =  ({ const VALUE args_to_new_ary[] = {(rb_id2sym(req))}; if (__builtin_constant_p(1)) { extern int (*__Static_assert_function (void)) [!!sizeof (struct { int __error_if_negative: (((int)(sizeof(args_to_new_ary) / sizeof((args_to_new_ary)[0]))) == (1)) ? 2 : -1; })]; } rb_ary_new_from_values(((int)(sizeof(args_to_new_ary) / sizeof((args_to_new_ary)[0]))), args_to_new_ary); });
    rb_obj_freeze_inline((VALUE)a);
    for (; n; --n) {
 rb_ary_push(param, a);
    }
    if (arity < 0) {
...
{
    rb_proc_t *proc;
    (((proc)) = (rb_proc_t*)(((struct RData*)(((prc))))->data));
    hash = st_hash_uint((hash), ((st_index_t)proc->block.as.captured.code.val));
    hash = st_hash_uint((hash), ((st_index_t)proc->block.as.captured.self));
    return st_hash_uint((hash), ((st_index_t)proc->block.as.captured.ep >> 16));
}

VALUE
rb_sym_to_proc(VALUE sym)
{
    static VALUE sym_proc_cache = ((VALUE)RUBY_Qfalse);
 ...
 rb_ary_store(sym_proc_cache, SYM_PROC_CACHE_SIZE*2 - 1, ((VALUE)RUBY_Qnil));
    }

    id = (rb_sym2id(sym));
    index = (id % SYM_PROC_CACHE_SIZE) << 1;

    aryp = ((VALUE *)rb_array_const_ptr(( __builtin_choose_expr( 1, rb_obj_wb_unprotect((VALUE)(sym_proc_cache), "proc.c", 1226), ((VALUE)(sym_proc_cache))))));
    if (aryp[index] == sym) {
 return aryp[index + 1];
    }
    else {
 proc = sym_proc_new(rb_cProc, (rb_id2sym(id)));
 aryp[index] = sym;
 aryp[index + 1] = proc;
 return proc;
    }
...
rb_block_to_s(VALUE self, const struct rb_block *block, const char *additional_info)
{
    ...
    VALUE str = rb_sprintf("#<%li\v:", cname);
      ...
      case block_type_iseq:
 {
     ...
     rb_str_catf(str, "%p@%li\v:%d", (void *)self,
   rb_iseq_path(iseq),
   ((int)rb_fix2int((VALUE)(iseq->body->location.first_lineno))));
 }
 break;
      case block_type_symbol:
 rb_str_catf(str, "%p(&%+li\v)", (void *)self, block->as.symbol);
 break;
      case block_type_ifunc:
 ...
 break;
    ...
    if (additional_info)  ({ (__builtin_constant_p(additional_info)) ? rb_str_cat((str), (additional_info), (long)strlen(additional_info)) : rb_str_cat_cstr((str), (additional_info)); });
     ({ (__builtin_constant_p(">")) ? rb_str_cat((str), (">"), (long)strlen(">")) : rb_str_cat_cstr((str), (">")); });
    (void)(((struct RBasic*)(str))->flags |= ((((struct RBasic*)(self))->flags&(RUBY_FL_TAINT))));
    return str;
}
static VALUE
proc_to_s(VALUE self)
{
    const rb_proc_t *proc;
    (((proc)) = (rb_proc_t*)(((struct RData*)(((self))))->data));
    return rb_block_to_s(self, &proc->block, proc->is_lambda ? " (lambda)": ((void*)0));
}
static VALUE
...
respond_to_missing_p(VALUE klass, VALUE obj, VALUE sym, int scope)
{
    ...
    if (obj == ((VALUE)RUBY_Qundef)) return 0;
    if (rb_method_basic_definition_p(klass, rmiss)) return 0;
    return !(((VALUE)(rb_funcall(obj, rmiss, 2, sym, scope ? ((VALUE)RUBY_Qfalse) : ((VALUE)RUBY_Qtrue))) & (VALUE)~((VALUE)RUBY_Qnil)) == 0);
}
...
{
    struct METHOD *data;
    VALUE method = ({ VALUE data_struct_obj = rb_data_typed_object_zalloc(mclass, sizeof(struct METHOD), &method_data_type); (void)((data) = (struct METHOD *)(((struct RData*)(data_struct_obj))->data));; data_struct_obj; });
    rb_method_entry_t *me;
    rb_method_definition_t *def;

    ({
;
; int unaligned_member_access_result = (rb_obj_write((VALUE)(method), (VALUE *)(&data->recv), (VALUE)(obj), "proc.c", 1378));
; unaligned_member_access_result; });
    ({
;
; int unaligned_member_access_result = (rb_obj_write((VALUE)(method), (VALUE *)(&data->klass), (VALUE)(klass), "proc.c", 1379));
; unaligned_member_access_result; });

    def = (((rb_method_definition_t*)ruby_xcalloc((size_t)(1),sizeof(rb_method_definition_t))));
    ...
    ({
;
; int unaligned_member_access_result = (rb_obj_write((VALUE)(method), (VALUE *)(&data->me), (VALUE)(me), "proc.c", 1387));
; unaligned_member_access_result; });

    ( (((!(((VALUE)(method) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(method) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(method))->flags & RUBY_T_MASK) != RUBY_T_NODE) && (int)(((struct RBasic*)(method))->flags & RUBY_T_MASK) != RUBY_T_BIGNUM && (int)(((struct RBasic*)(method))->flags & RUBY_T_MASK) != RUBY_T_FLOAT) && (!(((VALUE)(klass) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(klass) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(klass))->flags & RUBY_T_MASK) != RUBY_T_NODE)) ? (void)(((struct RBasic*)(method))->flags |= ((((struct RBasic*)(klass))->flags&(RUBY_FL_TAINT)))) : (void)0);
       ...
       VALUE obj, ID id, VALUE mclass, int scope, int error)
{
 ...
 if (respond_to_missing_p(klass, obj, (rb_id2sym(id)), scope)) {
     return mnew_missing(klass, obj, id, mclass);
 }
 if (!error) return ((VALUE)RUBY_Qnil);
 rb_print_undef(klass, id, METHOD_VISI_UNDEF);
    }
    if (visi == METHOD_VISI_UNDEF) {
 visi = (rb_method_visibility_t)(((me)->flags & (((VALUE)RUBY_FL_USER4) | ((VALUE)RUBY_FL_USER5))) >> ((((VALUE)RUBY_FL_USHIFT) + 4)+0));
 ...
 if (me->defined_class) {
     VALUE klass = RCLASS_SUPER(((((struct RClass*)(me->defined_class))->ptr)->origin_));
 ...
 goto again;
    ...
    method = ({ VALUE data_struct_obj = rb_data_typed_object_zalloc(mclass, sizeof(struct METHOD), &method_data_type); (void)((data) = (struct METHOD *)(((struct RData*)(data_struct_obj))->data));; data_struct_obj; });

    ({
;
; int unaligned_member_access_result = (rb_obj_write((VALUE)(method), (VALUE *)(&data->recv), (VALUE)(obj), "proc.c", 1433));
; unaligned_member_access_result; });
    ({
;
; int unaligned_member_access_result = (rb_obj_write((VALUE)(method), (VALUE *)(&data->klass), (VALUE)(klass), "proc.c", 1434));
; unaligned_member_access_result; });
    ({
;
; int unaligned_member_access_result = (rb_obj_write((VALUE)(method), (VALUE *)(&data->iclass), (VALUE)(iclass), "proc.c", 1435));
; unaligned_member_access_result; });
    ({
;
; int unaligned_member_access_result = (rb_obj_write((VALUE)(method), (VALUE *)(&data->me), (VALUE)(me), "proc.c", 1436));
; unaligned_member_access_result; });
...
method_eq(VALUE method, VALUE other)
{
 ...
 return ((VALUE)RUBY_Qfalse);
    if (rb_class_of((VALUE)(method)) != rb_class_of((VALUE)(other)))
 return ((VALUE)RUBY_Qfalse);

    rb_check_typeddata((VALUE)(method),(&method_data_type));
    m1 = (struct METHOD *)(((struct RData*)(method))->data);
    m2 = (struct METHOD *)(((struct RData*)(other))->data);
...
method_hash(VALUE method)
{
    ...
    ((m) = (struct METHOD*)rb_check_typeddata((method), (&method_data_type)));
    hash = rb_hash_start((st_index_t)m->recv);
    hash = rb_hash_method_entry(hash, m->me);
    hash = st_hash_end(hash);

    return (((VALUE)(hash))<<1 | RUBY_FIXNUM_FLAG);
}
static VALUE
method_unbind(VALUE obj)
{
    ...
    ((orig) = (struct METHOD*)rb_check_typeddata((obj), (&method_data_type)));
    method = ({ VALUE data_struct_obj = rb_data_typed_object_zalloc(rb_cUnboundMethod, sizeof(struct METHOD), &method_data_type); (void)((data) = (struct METHOD *)(((struct RData*)(data_struct_obj))->data));; data_struct_obj; });

    ({
;
; int unaligned_member_access_result = (rb_obj_write((VALUE)(method), (VALUE *)(&data->recv), (VALUE)(((VALUE)RUBY_Qundef)), "proc.c", 1574));
; unaligned_member_access_result; });
    ({
;
; int unaligned_member_access_result = (rb_obj_write((VALUE)(method), (VALUE *)(&data->klass), (VALUE)(orig->klass), "proc.c", 1575));
; unaligned_member_access_result; });
    ({
;
; int unaligned_member_access_result = (rb_obj_write((VALUE)(method), (VALUE *)(&data->me), (VALUE)(rb_method_entry_clone(orig->me)), "proc.c", 1576));
; unaligned_member_access_result; });
    ( (((!(((VALUE)(method) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(method) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(method))->flags & RUBY_T_MASK) != RUBY_T_NODE) && (int)(((struct RBasic*)(method))->flags & RUBY_T_MASK) != RUBY_T_BIGNUM && (int)(((struct RBasic*)(method))->flags & RUBY_T_MASK) != RUBY_T_FLOAT) && (!(((VALUE)(obj) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(obj) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(obj))->flags & RUBY_T_MASK) != RUBY_T_NODE)) ? (void)(((struct RBasic*)(method))->flags |= ((((struct RBasic*)(obj))->flags&(RUBY_FL_TAINT)))) : (void)0);
...
method_receiver(VALUE obj)
{
    ...
    ((data) = (struct METHOD*)rb_check_typeddata((obj), (&method_data_type)));
    return data->recv;
}
static VALUE
method_name(VALUE obj)
{
    ...
    ((data) = (struct METHOD*)rb_check_typeddata((obj), (&method_data_type)));
    return (rb_id2sym(data->me->called_id));
}
static VALUE
method_original_name(VALUE obj)
{
    ...
    ((data) = (struct METHOD*)rb_check_typeddata((obj), (&method_data_type)));
    return (rb_id2sym(data->me->def->original_id));
}
static VALUE
...
rb_method_name_error(VALUE klass, VALUE str)
{
 ...
 switch ((int)(((struct RBasic*)(obj))->flags & RUBY_T_MASK)) {
   ...
   case RUBY_T_CLASS:
     c = obj;
     s =  ({ (__builtin_constant_p("undefined method `%1$s' for `%2$s'")) ? rb_fstring_new(("undefined method `%1$s' for `%2$s'"), (long)strlen("undefined method `%1$s' for `%2$s'")) : rb_fstring_cstr("undefined method `%1$s' for `%2$s'"); });
 }
 goto normal_class;
    }
    else if (( ((RUBY_T_MODULE) == RUBY_T_FIXNUM) ? (((int)(long)(c))&RUBY_FIXNUM_FLAG) : ((RUBY_T_MODULE) == RUBY_T_TRUE) ? ((c) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_MODULE) == RUBY_T_FALSE) ? ((c) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_MODULE) == RUBY_T_NIL) ? ((c) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_MODULE) == RUBY_T_UNDEF) ? ((c) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_MODULE) == RUBY_T_SYMBOL) ? ((((VALUE)(c)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(c) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(c) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(c))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_MODULE) == RUBY_T_FLOAT) ? ( ((((int)(long)(c))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(c) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(c) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(c))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(c) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(c) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(c))->flags & RUBY_T_MASK) == (RUBY_T_MODULE)))) {
 s =  ({ (__builtin_constant_p("undefined method `%1$s' for module `%2$s'")) ? rb_fstring_new(("undefined method `%1$s' for module `%2$s'"), (long)strlen("undefined method `%1$s' for module `%2$s'")) : rb_fstring_cstr("undefined method `%1$s' for module `%2$s'"); });
    }
    else {
      normal_class:
 s =  ({ (__builtin_constant_p("undefined method `%1$s' for class `%2$s'")) ? rb_fstring_new(("undefined method `%1$s' for class `%2$s'"), (long)strlen("undefined method `%1$s' for class `%2$s'")) : rb_fstring_cstr("undefined method `%1$s' for class `%2$s'"); });
    }
    rb_exc_raise(rb_name_err_new(s, c, str));
...
obj_method(VALUE obj, VALUE vid, int scope)
{
    ...
    const VALUE klass = rb_class_of((VALUE)(obj));
...
rb_obj_singleton_method(VALUE obj, VALUE vid)
{
    ...
    if (!id) {
 if (!!((VALUE)(klass = rb_singleton_class_get(obj)) != ((VALUE)RUBY_Qnil)) &&
     respond_to_missing_p(klass, obj, vid, FALSE)) {
     id = rb_intern_str(vid);
     return mnew_missing(klass, obj, id, rb_cMethod);
 }
      undef:
 rb_exc_raise(rb_name_err_new( ({ (__builtin_constant_p("undefined singleton method `%1$s' for `%2$s'")) ? rb_fstring_new(("undefined singleton method `%1$s' for `%2$s'"), (long)strlen("undefined singleton method `%1$s' for `%2$s'")) : rb_fstring_cstr("undefined singleton method `%1$s' for `%2$s'"); }), (obj), (vid)));

    }
    if (!((VALUE)(klass = rb_singleton_class_get(obj)) != ((VALUE)RUBY_Qnil)) ||
 (!(me = rb_method_entry_at(klass, id)) || !(me = rb_method_entry_at(klass, id))->def || (me = rb_method_entry_at(klass, id))->def->type == VM_METHOD_TYPE_UNDEF) ||
 ((me->def)->type == VM_METHOD_TYPE_REFINED && (!((me->def)->body.refined.orig_me) || !((me->def)->body.refined.orig_me)->def || ((me->def)->body.refined.orig_me)->def->type == VM_METHOD_TYPE_UNDEF))) {
 vid = (rb_id2sym(id));
 goto undef;
    }
...
rb_mod_instance_method(VALUE mod, VALUE vid)
{
 ...
 rb_method_name_error(mod, vid);
    ...
    return mnew(mod, ((VALUE)RUBY_Qundef), id, rb_cUnboundMethod, FALSE);
}
static VALUE
rb_mod_public_instance_method(VALUE mod, VALUE vid)
{
 ...
 rb_method_name_error(mod, vid);
    ...
    return mnew(mod, ((VALUE)RUBY_Qundef), id, rb_cUnboundMethod, TRUE);
}
static VALUE
rb_mod_define_method(int argc, VALUE *argv, VALUE mod)
{
 ...
 const rb_execution_context_t *ec = rb_current_execution_context();
 VALUE block_handler = rb_vm_frame_block_handler(ec->cfp);
 if (block_handler == 0) rb_raise(rb_eArgError, proc_without_block);
 ...
 if (rb_obj_is_method(body)) {
    ...
    if (is_method) {
 struct METHOD *method = (struct METHOD *)(((struct RData*)(body))->data);
 if (method->me->owner != mod && !( ((RUBY_T_MODULE) == RUBY_T_FIXNUM) ? (((int)(long)(method->me->owner))&RUBY_FIXNUM_FLAG) : ((RUBY_T_MODULE) == RUBY_T_TRUE) ? ((method->me->owner) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_MODULE) == RUBY_T_FALSE) ? ((method->me->owner) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_MODULE) == RUBY_T_NIL) ? ((method->me->owner) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_MODULE) == RUBY_T_UNDEF) ? ((method->me->owner) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_MODULE) == RUBY_T_SYMBOL) ? ((((VALUE)(method->me->owner)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(method->me->owner) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(method->me->owner) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(method->me->owner))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_MODULE) == RUBY_T_FLOAT) ? ( ((((int)(long)(method->me->owner))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(method->me->owner) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(method->me->owner) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(method->me->owner))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(method->me->owner) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(method->me->owner) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(method->me->owner))->flags & RUBY_T_MASK) == (RUBY_T_MODULE))) &&
     !!(((VALUE)(rb_class_inherited_p(mod, method->me->owner)) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) {
     if (((!(((VALUE)(method->me->owner) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(method->me->owner) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(method->me->owner))->flags & RUBY_T_MASK) != RUBY_T_NODE)?(((struct RBasic*)((method->me->owner)))->flags&((((VALUE)RUBY_FL_SINGLETON)))):0)) {
  rb_raise(rb_eTypeError,
    "can't bind singleton method to a different class");
     }
     else {
  rb_raise(rb_eTypeError,
    "bind argument must be a subclass of % li\v",
    method->me->owner);
     }
 }
 ...
 (* ({ volatile VALUE *rb_gc_guarded_ptr = &(body); ; rb_gc_guarded_ptr; }));
    }
    else {
 VALUE procval = proc_dup(body);
 if (vm_proc_iseq(procval) != ((void*)0)) {
     rb_proc_t *proc;
     (((proc)) = (rb_proc_t*)(((struct RData*)(((procval))))->data));
     proc->is_lambda = TRUE;
...
method_clone(VALUE self)
{
    ...
    ((orig) = (struct METHOD*)rb_check_typeddata((self), (&method_data_type)));
    clone = ({ VALUE data_struct_obj = rb_data_typed_object_zalloc(rb_class_of((VALUE)(self)), sizeof(struct METHOD), &method_data_type); (void)((data) = (struct METHOD *)(((struct RData*)(data_struct_obj))->data));; data_struct_obj; });
    rb_clone_setup(clone,self);
    ({
;
; int unaligned_member_access_result = (rb_obj_write((VALUE)(clone), (VALUE *)(&data->recv), (VALUE)(orig->recv), "proc.c", 2065));
; unaligned_member_access_result; });
    ({
;
; int unaligned_member_access_result = (rb_obj_write((VALUE)(clone), (VALUE *)(&data->klass), (VALUE)(orig->klass), "proc.c", 2066));
; unaligned_member_access_result; });
    ({
;
; int unaligned_member_access_result = (rb_obj_write((VALUE)(clone), (VALUE *)(&data->me), (VALUE)(rb_method_entry_clone(orig->me)), "proc.c", 2067));
; unaligned_member_access_result; });
    return clone;
}
VALUE
...
{
    VALUE procval = rb_block_given_p() ? rb_block_proc() : ((VALUE)RUBY_Qnil);
        ...
        int safe)
{
 ...
 (*(volatile VALUE *)&(result)) = call_method_data(ec, data, argc, argv, passed_procval);
    }
...
rb_method_call_with_block(int argc, const VALUE *argv, VALUE method, VALUE passed_procval)
{
    ...
    ((data) = (struct METHOD*)rb_check_typeddata((method), (&method_data_type)));
    if (data->recv == ((VALUE)RUBY_Qundef)) {
 rb_raise(rb_eTypeError, "can't call unbound method; bind first");
    }
    if ((!!((!(((VALUE)((method)) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)((method)) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)((method)))->flags & RUBY_T_MASK) != RUBY_T_NODE)?(((struct RBasic*)(((method))))->flags&((RUBY_FL_TAINT))):0))) {
 const int safe_level_to_run = 1;
...
umethod_bind(VALUE method, VALUE recv)
{
    ...
    if (!( ((RUBY_T_MODULE) == RUBY_T_FIXNUM) ? (((int)(long)(methclass))&RUBY_FIXNUM_FLAG) : ((RUBY_T_MODULE) == RUBY_T_TRUE) ? ((methclass) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_MODULE) == RUBY_T_FALSE) ? ((methclass) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_MODULE) == RUBY_T_NIL) ? ((methclass) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_MODULE) == RUBY_T_UNDEF) ? ((methclass) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_MODULE) == RUBY_T_SYMBOL) ? ((((VALUE)(methclass)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(methclass) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(methclass) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(methclass))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_MODULE) == RUBY_T_FLOAT) ? ( ((((int)(long)(methclass))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(methclass) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(methclass) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(methclass))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(methclass) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(methclass) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(methclass))->flags & RUBY_T_MASK) == (RUBY_T_MODULE))) &&
 methclass != rb_class_of((VALUE)(recv)) && !rb_obj_is_kind_of(recv, methclass)) {
 if (((!(((VALUE)(methclass) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(methclass) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(methclass))->flags & RUBY_T_MASK) != RUBY_T_NODE)?(((struct RBasic*)((methclass)))->flags&((((VALUE)RUBY_FL_SINGLETON)))):0)) {
     rb_raise(rb_eTypeError,
       "singleton method called for a different object");
 }
 else {
     rb_raise(rb_eTypeError, "bind argument must be an instance of % li\v",
       methclass);
 }
    }

    klass = rb_class_of((VALUE)(recv));

    method = ({ VALUE data_struct_obj = rb_data_typed_object_zalloc(rb_cMethod, sizeof(struct METHOD), &method_data_type); (void)((bound) = (struct METHOD *)(((struct RData*)(data_struct_obj))->data));; data_struct_obj; });
    ({
;
; int unaligned_member_access_result = (rb_obj_write((VALUE)(method), (VALUE *)(&bound->recv), (VALUE)(recv), "proc.c", 2265));
; unaligned_member_access_result; });
    ({
;
; int unaligned_member_access_result = (rb_obj_write((VALUE)(method), (VALUE *)(&bound->klass), (VALUE)(data->klass), "proc.c", 2266));
; unaligned_member_access_result; });
    ({
;
; int unaligned_member_access_result = (rb_obj_write((VALUE)(method), (VALUE *)(&bound->me), (VALUE)(rb_method_entry_clone(data->me)), "proc.c", 2267));
; unaligned_member_access_result; });

    if (( ((RUBY_T_MODULE) == RUBY_T_FIXNUM) ? (((int)(long)(bound->me->owner))&RUBY_FIXNUM_FLAG) : ((RUBY_T_MODULE) == RUBY_T_TRUE) ? ((bound->me->owner) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_MODULE) == RUBY_T_FALSE) ? ((bound->me->owner) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_MODULE) == RUBY_T_NIL) ? ((bound->me->owner) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_MODULE) == RUBY_T_UNDEF) ? ((bound->me->owner) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_MODULE) == RUBY_T_SYMBOL) ? ((((VALUE)(bound->me->owner)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(bound->me->owner) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(bound->me->owner) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(bound->me->owner))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_MODULE) == RUBY_T_FLOAT) ? ( ((((int)(long)(bound->me->owner))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(bound->me->owner) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(bound->me->owner) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(bound->me->owner))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(bound->me->owner) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(bound->me->owner) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(bound->me->owner))->flags & RUBY_T_MASK) == (RUBY_T_MODULE)))) {
 ...
 ({
;
; int unaligned_member_access_result = (rb_obj_write((VALUE)(method), (VALUE *)(&bound->me), (VALUE)(rb_method_entry_complement_defined_class(bound->me, bound->me->called_id, klass)), "proc.c", 2277));
; unaligned_member_access_result; });
    }
...
{
    return rb_mod_method_arity(rb_class_of((VALUE)(obj)), id);
}
...
{
    return rb_mod_method_location(rb_class_of((VALUE)(obj)), id);
}
VALUE
...
method_inspect(VALUE method)
{
    ...
    ((data) = (struct METHOD*)rb_check_typeddata((method), (&method_data_type)));
    str = rb_sprintf("#<% li\v: ", rb_obj_class(method));
    (void)(((struct RBasic*)(str))->flags |= ((((struct RBasic*)(method))->flags&(RUBY_FL_TAINT))));
 ...
 defined_class = method_entry_defined_class(data->me);
    ...
    if (( ((RUBY_T_ICLASS) == RUBY_T_FIXNUM) ? (((int)(long)(defined_class))&RUBY_FIXNUM_FLAG) : ((RUBY_T_ICLASS) == RUBY_T_TRUE) ? ((defined_class) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_ICLASS) == RUBY_T_FALSE) ? ((defined_class) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_ICLASS) == RUBY_T_NIL) ? ((defined_class) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_ICLASS) == RUBY_T_UNDEF) ? ((defined_class) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_ICLASS) == RUBY_T_SYMBOL) ? ((((VALUE)(defined_class)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(defined_class) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(defined_class) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(defined_class))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_ICLASS) == RUBY_T_FLOAT) ? ( ((((int)(long)(defined_class))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(defined_class) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(defined_class) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(defined_class))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(defined_class) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(defined_class) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(defined_class))->flags & RUBY_T_MASK) == (RUBY_T_ICLASS)))) {
 defined_class = (((struct RBasic*)(defined_class))->klass);
    }

    if (((!(((VALUE)(mklass) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(mklass) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(mklass))->flags & RUBY_T_MASK) != RUBY_T_NODE)?(((struct RBasic*)((mklass)))->flags&((((VALUE)RUBY_FL_SINGLETON)))):0)) {
 VALUE v = rb_ivar_get(mklass, id__attached__);
 ...
 if (defined_class != mklass) {
     rb_str_catf(str, "(% li\v)", defined_class);
 }
    }
     ({ (__builtin_constant_p(sharp)) ? rb_str_cat((str), (sharp), (long)strlen(sharp)) : rb_str_cat_cstr((str), (sharp)); });
    rb_str_append(str, rb_id2str(data->me->called_id));
    if (data->me->called_id != data->me->def->original_id) {
 rb_str_catf(str, "(%li\v)",
      rb_id2str(data->me->def->original_id));
    }
    if (data->me->def->type == VM_METHOD_TYPE_NOTIMPLEMENTED) {
         ({ (__builtin_constant_p(" (not-implemented)")) ? rb_str_cat((str), (" (not-implemented)"), (long)strlen(" (not-implemented)")) : rb_str_cat_cstr((str), (" (not-implemented)")); });
    }
     ({ (__builtin_constant_p(">")) ? rb_str_cat((str), (">"), (long)strlen(">")) : rb_str_cat_cstr((str), (">")); });
...
method_super_method(VALUE method)
{
    ...
    ((data) = (struct METHOD*)rb_check_typeddata((method), (&method_data_type)));
    iclass = data->iclass;
    if (!iclass) return ((VALUE)RUBY_Qnil);
    super_class = RCLASS_SUPER(((((struct RClass*)(iclass))->ptr)->origin_));
    mid = data->me->called_id;
    if (!super_class) return ((VALUE)RUBY_Qnil);
...
env_clone(const rb_env_t *env, const rb_cref_t *cref)
{
 ...
 cref = rb_vm_cref_new_toplevel();
    ...
    new_body = ((VALUE*)ruby_xmalloc2((size_t)(env->env_size),sizeof(VALUE)));
    memcpy((new_body), (env->env), sizeof(VALUE)*(size_t)(env->env_size));
    new_ep = &new_body[env->ep - env->env];
    new_env = vm_env_new(new_ep, new_body, env->env_size, env->iseq);
    ({
;
; int unaligned_member_access_result = (rb_obj_write((VALUE)(new_env), (VALUE *)(&new_ep[(-2)]), (VALUE)((VALUE)cref), "proc.c", 2778));
; unaligned_member_access_result; });
    ((void)0);
    return new_env;
}
...
{
    VALUE bindval, binding_self = ((VALUE)RUBY_Qundef);
    rb_binding_t *bind;
    const rb_proc_t *proc;
    const rb_iseq_t *iseq = ((void*)0);
    const struct rb_block *block;
    const rb_env_t *env = ((void*)0);
 ...
 break;
      case block_type_proc:
 (((proc)) = (rb_proc_t*)(((struct RData*)(((block->as.proc))))->data));
 block = &proc->block;
 goto again;
      case block_type_symbol:
 goto error;
      case block_type_ifunc:
 {
  ...
  ({
;
; int unaligned_member_access_result = (rb_obj_write((VALUE)(env), (VALUE *)(&env->iseq), (VALUE)(rb_iseq_new(((void*)0),  ({ (__builtin_constant_p("<empty iseq>")) ? rb_str_new_static(("<empty iseq>"), (long)strlen("<empty iseq>")) : rb_str_new_cstr("<empty iseq>"); }),  ({ (__builtin_constant_p("<empty_iseq>")) ? rb_str_new_static(("<empty_iseq>"), (long)strlen("<empty_iseq>")) : rb_str_new_cstr("<empty_iseq>"); }), ((VALUE)RUBY_Qnil), 0, ISEQ_TYPE_TOP)), "proc.c", 2834));
; unaligned_member_access_result; });
  break;
     }
     else {
  ...
  return ((VALUE)RUBY_Qnil);
    ...
    ({
;
; int unaligned_member_access_result = (rb_obj_write((VALUE)(bindval), (VALUE *)(&bind->block.as.captured.self), (VALUE)(binding_self), "proc.c", 2847));
; unaligned_member_access_result; });
    ({
;
; int unaligned_member_access_result = (rb_obj_write((VALUE)(bindval), (VALUE *)(&bind->block.as.captured.code.iseq), (VALUE)(env->iseq), "proc.c", 2848));
; unaligned_member_access_result; });
    rb_vm_block_ep_update(bindval, &bind->block, env->ep);
    rb_obj_written((VALUE)(bindval), (VALUE)(((VALUE)RUBY_Qundef)), (VALUE)(VM_ENV_ENVVAL(env->ep)), "proc.c", 2850);

    if (iseq) {
 rb_iseq_check(iseq);
 ({
;
; int unaligned_member_access_result = (rb_obj_write((VALUE)(bindval), (VALUE *)(&bind->pathobj), (VALUE)(iseq->body->location.pathobj), "proc.c", 2854));
; unaligned_member_access_result; });
 bind->first_lineno = ((int)rb_fix2int((VALUE)(rb_iseq_first_lineno(iseq))));
    }
    else {
 ({
;
; int unaligned_member_access_result = (rb_obj_write((VALUE)(bindval), (VALUE *)(&bind->pathobj), (VALUE)(rb_iseq_pathobj_new( ({ (__builtin_constant_p("(binding)")) ? rb_fstring_new(("(binding)"), (long)strlen("(binding)")) : rb_fstring_cstr("(binding)"); }), ((VALUE)RUBY_Qnil))), "proc.c", 2859));
; unaligned_member_access_result; });
...
curry(VALUE dummy, VALUE args, int argc, VALUE *argv, VALUE passed_proc)
{
    ...
    proc = (rb_array_const_ptr(args)[0]);
    passed = (rb_array_const_ptr(args)[1]);
    arity = (rb_array_const_ptr(args)[2]);

    passed = rb_ary_plus(passed, rb_ary_new_from_values(argc, argv));
    rb_ary_freeze(passed);

    if (rb_array_len(passed) < ((int)rb_fix2int((VALUE)(arity)))) {
 if (!!((VALUE)(passed_proc) != ((VALUE)RUBY_Qnil))) {
 ...
 return rb_proc_call_with_block(proc, check_argc(rb_array_len(passed)), rb_array_const_ptr(passed), passed_proc);
    }
}
static VALUE
proc_curry(int argc, const VALUE *argv, VALUE self)
{
    ...
    if (!((VALUE)(arity) != ((VALUE)RUBY_Qnil))) {
 arity = (((VALUE)(min_arity))<<1 | RUBY_FIXNUM_FLAG);
    }
    else {
 sarity = ((int)rb_fix2int((VALUE)(arity)));
...
Init_Proc(void)
{
    ...
    rb_add_method(rb_cProc, (__builtin_constant_p("call") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("call")), (long)strlen(("call"))); (ID) rb_intern_id_cache; }) : rb_intern("call")), VM_METHOD_TYPE_OPTIMIZED,
    (void *)OPTIMIZED_METHOD_TYPE_CALL, METHOD_VISI_PUBLIC);
    rb_add_method(rb_cProc, (__builtin_constant_p("[]") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("[]")), (long)strlen(("[]"))); (ID) rb_intern_id_cache; }) : rb_intern("[]")), VM_METHOD_TYPE_OPTIMIZED,
    (void *)OPTIMIZED_METHOD_TYPE_CALL, METHOD_VISI_PUBLIC);
    rb_add_method(rb_cProc, (__builtin_constant_p("===") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("===")), (long)strlen(("==="))); (ID) rb_intern_id_cache; }) : rb_intern("===")), VM_METHOD_TYPE_OPTIMIZED,
    (void *)OPTIMIZED_METHOD_TYPE_CALL, METHOD_VISI_PUBLIC);
    rb_add_method(rb_cProc, (__builtin_constant_p("yield") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("yield")), (long)strlen(("yield"))); (ID) rb_intern_id_cache; }) : rb_intern("yield")), VM_METHOD_TYPE_OPTIMIZED,
    (void *)OPTIMIZED_METHOD_TYPE_CALL, METHOD_VISI_PUBLIC);
    ...
    rb_vm_register_special_exception_str(ruby_error_sysstack, rb_eSysStackError, rb_usascii_str_new_static(("stack level too deep"), (long)(sizeof("stack level too deep") - 1)));
    ...
    rb_undef_method(rb_class_of((VALUE)(rb_cMethod)), "new");
    ...
    rb_undef_method(rb_class_of((VALUE)(rb_cUnboundMethod)), "new");
...
Init_Binding(void)
{
    ...
    rb_undef_method(rb_class_of((VALUE)(rb_cBinding)), "new");
