...
file_path_convert(VALUE name)
{
    ...
    int fname_encidx = ((int)((((struct RBasic*)(name))->flags & RUBY_ENCODING_MASK)>>RUBY_ENCODING_SHIFT) != RUBY_ENCODING_INLINE_MAX ? (int)((((struct RBasic*)(name))->flags & RUBY_ENCODING_MASK)>>RUBY_ENCODING_SHIFT) : rb_enc_get_index(name));
    int fs_encidx;
    if (RUBY_ENCINDEX_US_ASCII != fname_encidx &&
 RUBY_ENCINDEX_ASCII != fname_encidx &&
...
check_path_encoding(VALUE str)
{
 ...
 rb_raise(rb_eEncCompatError, "path name must be ASCII-compatible (%s): %li\v",
   (enc)->name, rb_str_inspect(str));
    }
    return enc;
}
...
rb_get_path_check_to_string(VALUE obj, int level)
{
    ...
    if (((level) > 0 && (!!((!(((VALUE)((obj)) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)((obj)) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)((obj)))->flags & RUBY_T_MASK) != RUBY_T_NODE)?(((struct RBasic*)(((obj))))->flags&((RUBY_FL_TAINT))):0)))) {
 ...
 return obj;
    ...
    do { static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("to_path")), (long)strlen(("to_path"))); (to_path) = rb_intern_id_cache; } while (0);
...
rb_get_path_check_convert(VALUE obj, VALUE tmp, int level)
{
    ...
    if (obj != tmp && ((level) > 0 && (!!((!(((VALUE)((tmp)) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)((tmp)) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)((tmp)))->flags & RUBY_T_MASK) != RUBY_T_NODE)?(((struct RBasic*)(((tmp))))->flags&((RUBY_FL_TAINT))):0)))) {
 rb_insecure_operation();
    }
...
apply2files(int (*func)(const char *, void *), int argc, VALUE *argv, void *arg)
{
    ...
    const long len = (long)(__builtin_offsetof() + (size * argc));
    struct apply_arg *aa = ((len) < 1024 ? ((* ({ volatile VALUE *rb_gc_guarded_ptr = &(v); ; rb_gc_guarded_ptr; })) = 0, __builtin_alloca (len)) : rb_alloc_tmp_buffer(&(v), (len)));
 ...
 aa->fn[aa->i].ptr = (!(((struct RBasic*)(path))->flags & RSTRING_NOEMBED) ? ((struct RString*)(path))->as.ary : ((struct RString*)(path))->as.heap.ptr);
 aa->fn[aa->i].path = path;
    }

    rb_thread_call_without_gvl(no_gvl_apply2files, aa, ((rb_unblock_function_t *)-1), 0);
    if (aa->errnum) {
 ...
 rb_syserr_fail_path_in(__func__, (aa->errnum), (aa->fn[aa->i].path));
    }
    if (v) {
 rb_free_tmp_buffer(&(v));
    }
    return (((VALUE)(argc))<<1 | RUBY_FIXNUM_FLAG);
}
static VALUE
rb_file_path(VALUE obj)
{
    ...
    fptr = ((struct RFile*)(rb_io_taint_check(obj)))->fptr;
...
static const rb_data_type_t stat_data_type = {
    "stat",
    {((void*)0), ((RUBY_DATA_FUNC)-1), stat_memsize,},
    0, 0, 1
};
...
{
    struct stat *nst = 0;
    VALUE obj = rb_data_typed_object_wrap((klass),(0),(&stat_data_type));

    if (st) {
 nst = ((struct stat*)ruby_xmalloc(sizeof(struct stat)));
 *nst = *st;
 (((struct RTypedData*)(obj))->data) = nst;
    }
    return obj;
}
...
{
    struct stat* st;
    ((st) = (struct stat*)rb_check_typeddata((self), (&stat_data_type)));
...
rb_stat_cmp(VALUE self, VALUE other)
{
    if (rb_obj_is_kind_of(other, rb_obj_class(self))) {
        ...
        if (ts1.tv_sec == ts2.tv_sec) {
            if (ts1.tv_nsec == ts2.tv_nsec) return (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG);
            if (ts1.tv_nsec < ts2.tv_nsec) return (((VALUE)(-1))<<1 | RUBY_FIXNUM_FLAG);
            return (((VALUE)(1))<<1 | RUBY_FIXNUM_FLAG);
        }
        if (ts1.tv_sec < ts2.tv_sec) return (((VALUE)(-1))<<1 | RUBY_FIXNUM_FLAG);
        return (((VALUE)(1))<<1 | RUBY_FIXNUM_FLAG);
    }
...
{
    return rb_ulong2num_inline(get_stat(self)->st_dev);
}
static VALUE
rb_stat_dev_major(VALUE self)
{

    return rb_ulong2num_inline(gnu_dev_major (get_stat(self)->st_dev));
...
rb_stat_dev_minor(VALUE self)
{
    ...
    return rb_ulong2num_inline(gnu_dev_minor (get_stat(self)->st_dev));
...
{
    return rb_ulong2num_inline(get_stat(self)->st_ino);

}
static VALUE
rb_stat_mode(VALUE self)
{
    return (((VALUE)((unsigned int)(((get_stat(self)->st_mode) & ~(~1UL << (sizeof(get_stat(self)->st_mode) * 8 - 1))))))<<1 | RUBY_FIXNUM_FLAG);
}
static VALUE
rb_stat_nlink(VALUE self)
{
    return (((VALUE)((unsigned int)(get_stat(self)->st_nlink)))<<1 | RUBY_FIXNUM_FLAG);
}
static VALUE
rb_stat_uid(VALUE self)
{
    return (((VALUE)((unsigned int)(get_stat(self)->st_uid)))<<1 | RUBY_FIXNUM_FLAG);
}
static VALUE
rb_stat_gid(VALUE self)
{
    return (((VALUE)((unsigned int)(get_stat(self)->st_gid)))<<1 | RUBY_FIXNUM_FLAG);
}
static VALUE
rb_stat_rdev(VALUE self)
{

    return rb_ulong2num_inline(get_stat(self)->st_rdev);
...
rb_stat_rdev_major(VALUE self)
{
    ...
    return rb_ulong2num_inline(gnu_dev_major (get_stat(self)->st_rdev));
...
rb_stat_rdev_minor(VALUE self)
{
    ...
    return rb_ulong2num_inline(gnu_dev_minor (get_stat(self)->st_rdev));
...
{
    return rb_long2num_inline(get_stat(self)->st_size);
}
static VALUE
rb_stat_blksize(VALUE self)
{

    return rb_ulong2num_inline(get_stat(self)->st_blksize);
...
rb_stat_blocks(VALUE self)
{
    ...
    return rb_ulong2num_inline(get_stat(self)->st_blocks);
...
rb_stat_inspect(VALUE self)
{
 ...
 {"ctime", rb_stat_ctime},
    ...
    str =  ({ (__builtin_constant_p("#<")) ? rb_str_cat(rb_str_buf_new((long)strlen("#<")), ("#<"), (long)strlen("#<")) : rb_str_buf_new_cstr("#<"); });
     ({ (__builtin_constant_p(rb_obj_classname(self))) ? rb_str_cat((str), (rb_obj_classname(self)), (long)strlen(rb_obj_classname(self))) : rb_str_cat_cstr((str), (rb_obj_classname(self))); });
 ...
 if (i > 0) {
  ...
  ({ (__builtin_constant_p(member[i].name)) ? rb_str_cat((str), (member[i].name), (long)strlen(member[i].name)) : rb_str_cat_cstr((str), (member[i].name)); });
  ({ (__builtin_constant_p("=")) ? rb_str_cat((str), ("="), (long)strlen("=")) : rb_str_cat_cstr((str), ("=")); });
 v = (*member[i].func)(self);
 if (i == 2) {
     rb_str_catf(str, "0%lo", (unsigned long)rb_num2ulong_inline(v));
 }
 else if (i == 0 || i == 6) {
     rb_str_catf(str, "0x%lx", rb_num2ulong_inline(v));
 }
 else {
     ...
     ({ (__builtin_constant_p(">")) ? rb_str_cat((str), (">"), (long)strlen(">")) : rb_str_cat_cstr((str), (">")); });
    ( (((!(((VALUE)(str) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(str) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(str))->flags & RUBY_T_MASK) != RUBY_T_NODE) && (int)(((struct RBasic*)(str))->flags & RUBY_T_MASK) != RUBY_T_BIGNUM && (int)(((struct RBasic*)(str))->flags & RUBY_T_MASK) != RUBY_T_FLOAT) && (!(((VALUE)(self) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(self) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(self))->flags & RUBY_T_MASK) != RUBY_T_NODE)) ? (void)(((struct RBasic*)(str))->flags |= ((((struct RBasic*)(self))->flags&(RUBY_FL_TAINT)))) : (void)0);
...
rb_stat(VALUE file, struct stat *st)
{
    ...
    tmp = rb_check_convert_type_with_id(file, RUBY_T_FILE, "IO", idTo_io);
 ...
 result = stat_without_gvl((!(((struct RBasic*)(file))->flags & RSTRING_NOEMBED) ? ((struct RString*)(file))->as.ary : ((struct RString*)(file))->as.heap.ptr), st);
    }
    (* ({ volatile VALUE *rb_gc_guarded_ptr = &(file); ; rb_gc_guarded_ptr; }));
    return result;
}
static VALUE
rb_file_s_stat(VALUE klass, VALUE fname)
{
    ...
    if (stat_without_gvl((!(((struct RBasic*)(fname))->flags & RSTRING_NOEMBED) ? ((struct RString*)(fname))->as.ary : ((struct RString*)(fname))->as.heap.ptr), &st) < 0) {
 rb_sys_fail_path_in(__func__, fname);
    }
...
rb_file_s_lstat(VALUE klass, VALUE fname)
{
    ...
    ((* ({ volatile VALUE *rb_gc_guarded_ptr = &(fname); ; rb_gc_guarded_ptr; })) = rb_get_path(fname));
    fname = rb_str_encode_ospath(fname);
    if (lstat_without_gvl(rb_string_value_cstr(&(fname)), &st) == -1) {
 rb_sys_fail_path_in(__func__, fname);
    }
    return rb_stat_new(&st);
...
rb_file_lstat(VALUE obj)
{
    ...
    rb_io_check_closed((fptr) = ((struct RFile*)(rb_io_taint_check(obj)))->fptr);
    if (!((VALUE)(fptr->pathv) != ((VALUE)RUBY_Qnil))) return ((VALUE)RUBY_Qnil);
    path = rb_str_encode_ospath(fptr->pathv);
    if (lstat_without_gvl((!(((struct RBasic*)(path))->flags & RSTRING_NOEMBED) ? ((struct RString*)(path))->as.ary : ((struct RString*)(path))->as.heap.ptr), &st) == -1) {
 rb_sys_fail_path_in(__func__, fptr->pathv);
    }
    return rb_stat_new(&st);
...
rb_group_member(gid_t gid)
{
 ...
 return TRUE;
    ...
    while (groups <= (65536)) {
 gary = ((gid_t*)(((size_t)(groups) < 1024 / sizeof(gid_t)) ? ((* ({ volatile VALUE *rb_gc_guarded_ptr = &(v); ; rb_gc_guarded_ptr; })) = 0, __builtin_alloca ((size_t)(groups) * sizeof(gid_t))) : rb_alloc_tmp_buffer2(&(v), (long)(groups), sizeof(gid_t))));
...
rb_eaccess(VALUE fname, int mode)
{
    ...
    ((* ({ volatile VALUE *rb_gc_guarded_ptr = &(fname); ; rb_gc_guarded_ptr; })) = rb_get_path(fname));
    fname = rb_str_encode_ospath(fname);
    aa.path = rb_string_value_cstr(&(fname));
    aa.mode = mode;
...
rb_file_directory_p(VALUE obj, VALUE fname)
{
    ...
    if (rb_stat(fname, &st) < 0) return ((VALUE)RUBY_Qfalse);
    if (((((st.st_mode)) & 0170000) == (0040000))) return ((VALUE)RUBY_Qtrue);
...
rb_file_pipe_p(VALUE obj, VALUE fname)
{
    ...
    if (rb_stat(fname, &st) < 0) return ((VALUE)RUBY_Qfalse);
    if (((((st.st_mode)) & 0170000) == (0010000))) return ((VALUE)RUBY_Qtrue);
...
rb_file_symlink_p(VALUE obj, VALUE fname)
{
    ...
    ((* ({ volatile VALUE *rb_gc_guarded_ptr = &(fname); ; rb_gc_guarded_ptr; })) = rb_get_path(fname));
    fname = rb_str_encode_ospath(fname);
    if (lstat_without_gvl(rb_string_value_cstr(&(fname)), &st) < 0) return ((VALUE)RUBY_Qfalse);
    if (((((st.st_mode)) & 0170000) == (0120000))) return ((VALUE)RUBY_Qtrue);
...
rb_file_socket_p(VALUE obj, VALUE fname)
{
    ...
    if (rb_stat(fname, &st) < 0) return ((VALUE)RUBY_Qfalse);
    if (((((st.st_mode)) & 0170000) == (0140000))) return ((VALUE)RUBY_Qtrue);
...
rb_file_blockdev_p(VALUE obj, VALUE fname)
{
    ...
    if (rb_stat(fname, &st) < 0) return ((VALUE)RUBY_Qfalse);
    if (((((st.st_mode)) & 0170000) == (0060000))) return ((VALUE)RUBY_Qtrue);
...
rb_file_chardev_p(VALUE obj, VALUE fname)
{
    ...
    if (rb_stat(fname, &st) < 0) return ((VALUE)RUBY_Qfalse);
    if (((((st.st_mode)) & 0170000) == (0020000))) return ((VALUE)RUBY_Qtrue);
...
{
    if (rb_eaccess(fname, 4) < 0) return ((VALUE)RUBY_Qfalse);
    return ((VALUE)RUBY_Qtrue);
}
static VALUE
rb_file_readable_real_p(VALUE obj, VALUE fname)
{
    if (rb_access(fname, 4) < 0) return ((VALUE)RUBY_Qfalse);
    return ((VALUE)RUBY_Qtrue);
}
static VALUE
rb_file_world_readable_p(VALUE obj, VALUE fname)
{
    ...
    if (rb_stat(fname, &st) < 0) return ((VALUE)RUBY_Qnil);
    if ((st.st_mode & (((0400 >> 3) >> 3))) == ((0400 >> 3) >> 3)) {
 return (((VALUE)((unsigned int)(st.st_mode & ((0400 | (0400 >> 3) | ((0400 >> 3) >> 3))|(0200 | (0200 >> 3) | ((0200 >> 3) >> 3))|(0100 | (0100 >> 3) | ((0100 >> 3) >> 3))))))<<1 | RUBY_FIXNUM_FLAG);
    }
...
{
    if (rb_eaccess(fname, 2) < 0) return ((VALUE)RUBY_Qfalse);
    return ((VALUE)RUBY_Qtrue);
}
static VALUE
rb_file_writable_real_p(VALUE obj, VALUE fname)
{
    if (rb_access(fname, 2) < 0) return ((VALUE)RUBY_Qfalse);
    return ((VALUE)RUBY_Qtrue);
}
static VALUE
rb_file_world_writable_p(VALUE obj, VALUE fname)
{
    ...
    if (rb_stat(fname, &st) < 0) return ((VALUE)RUBY_Qnil);
    if ((st.st_mode & (((0200 >> 3) >> 3))) == ((0200 >> 3) >> 3)) {
 return (((VALUE)((unsigned int)(st.st_mode & ((0400 | (0400 >> 3) | ((0400 >> 3) >> 3))|(0200 | (0200 >> 3) | ((0200 >> 3) >> 3))|(0100 | (0100 >> 3) | ((0100 >> 3) >> 3))))))<<1 | RUBY_FIXNUM_FLAG);
    }
...
{
    if (rb_eaccess(fname, 1) < 0) return ((VALUE)RUBY_Qfalse);
    return ((VALUE)RUBY_Qtrue);
}
static VALUE
rb_file_executable_real_p(VALUE obj, VALUE fname)
{
    if (rb_access(fname, 1) < 0) return ((VALUE)RUBY_Qfalse);
    return ((VALUE)RUBY_Qtrue);
}
static VALUE
rb_file_file_p(VALUE obj, VALUE fname)
{
    ...
    if (rb_stat(fname, &st) < 0) return ((VALUE)RUBY_Qfalse);
    if (((((st.st_mode)) & 0170000) == (0100000))) return ((VALUE)RUBY_Qtrue);
    return ((VALUE)RUBY_Qfalse);
}
static VALUE
rb_file_zero_p(VALUE obj, VALUE fname)
{
    ...
    if (rb_stat(fname, &st) < 0) return ((VALUE)RUBY_Qfalse);
    if (st.st_size == 0) return ((VALUE)RUBY_Qtrue);
    return ((VALUE)RUBY_Qfalse);
}
static VALUE
rb_file_size_p(VALUE obj, VALUE fname)
{
    ...
    if (rb_stat(fname, &st) < 0) return ((VALUE)RUBY_Qnil);
    if (st.st_size == 0) return ((VALUE)RUBY_Qnil);
    return rb_long2num_inline(st.st_size);
}
static VALUE
rb_file_owned_p(VALUE obj, VALUE fname)
{
    ...
    if (rb_stat(fname, &st) < 0) return ((VALUE)RUBY_Qfalse);
    if (st.st_uid == geteuid()) return ((VALUE)RUBY_Qtrue);
    return ((VALUE)RUBY_Qfalse);
}
...
rb_file_rowned_p(VALUE obj, VALUE fname)
{
    ...
    if (rb_stat(fname, &st) < 0) return ((VALUE)RUBY_Qfalse);
    if (st.st_uid == getuid()) return ((VALUE)RUBY_Qtrue);
    return ((VALUE)RUBY_Qfalse);
}
static VALUE
rb_file_grpowned_p(VALUE obj, VALUE fname)
{
    ...
    if (rb_stat(fname, &st) < 0) return ((VALUE)RUBY_Qfalse);
    if (rb_group_member(st.st_gid)) return ((VALUE)RUBY_Qtrue);
...
check3rdbyte(VALUE fname, int mode)
{
    ...
    if (rb_stat(fname, &st) < 0) return ((VALUE)RUBY_Qfalse);
    if (st.st_mode & mode) return ((VALUE)RUBY_Qtrue);
    return ((VALUE)RUBY_Qfalse);
}
static VALUE
rb_file_suid_p(VALUE obj, VALUE fname)
{
    ...
    return check3rdbyte(fname, 04000);
...
rb_file_sgid_p(VALUE obj, VALUE fname)
{
    ...
    return check3rdbyte(fname, 02000);
...
rb_file_sticky_p(VALUE obj, VALUE fname)
{
    ...
    return check3rdbyte(fname, 01000);
...
rb_file_identical_p(VALUE obj, VALUE fname1, VALUE fname2)
{
    ...
    if (rb_stat(fname1, &st1) < 0) return ((VALUE)RUBY_Qfalse);
    if (rb_stat(fname2, &st2) < 0) return ((VALUE)RUBY_Qfalse);
    if (st1.st_dev != st2.st_dev) return ((VALUE)RUBY_Qfalse);
    if (st1.st_ino != st2.st_ino) return ((VALUE)RUBY_Qfalse);
    return ((VALUE)RUBY_Qtrue);
...
rb_file_ftype(const struct stat *st)
{
 ...
 t = "unknown";
    ...
    return  ({ (__builtin_constant_p(t)) ? rb_usascii_str_new_static((t), (long)strlen(t)) : rb_usascii_str_new_cstr(t); });
}
static VALUE
...
rb_file_s_chmod(int argc, VALUE *argv)
{
    ...
    (rb_check_arity(argc, 1, (-1)), argc-=1);
    mode = ((unsigned int)rb_num2uint(*argv++));
...
rb_file_chmod(VALUE obj, VALUE vmode)
{
    ...
    mode = rb_num2int_inline(vmode);

    rb_io_check_closed((fptr) = ((struct RFile*)(rb_io_taint_check(obj)))->fptr);

    if (fchmod(fptr->fd, mode) == -1) {
 if (1 || (*__errno_location ()) != 38)
     rb_sys_fail_path_in(__func__, fptr->pathv);
    }
    else {
 if (!1) return (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG);
    }
...
to_uid(VALUE u)
{
    if (!((VALUE)(u) != ((VALUE)RUBY_Qnil))) {
 return (uid_t)-1;
    }
    return ((unsigned int)rb_num2uint(u));
}

static inline gid_t
to_gid(VALUE g)
{
    if (!((VALUE)(g) != ((VALUE)RUBY_Qnil))) {
 return (gid_t)-1;
    }
    return ((unsigned int)rb_num2uint(g));
}
...
rb_file_s_chown(int argc, VALUE *argv)
{
    ...
    (rb_check_arity(argc, 2, (-1)), argc-=2);
...
utime_internal(const char *path, void *arg)
{
    ...
    struct timeval tvbuf[2], *tvp = ((void*)0);
 ...
 if (utimensat(-100, path, tsp, flags) < 0) {
...
utime_internal_i(int argc, VALUE *argv, int follow)
{
    ...
    struct timespec tss[2], *tsp = ((void*)0);
    ...
    if (!!((VALUE)(args.atime) != ((VALUE)RUBY_Qnil)) || !!((VALUE)(args.mtime) != ((VALUE)RUBY_Qnil))) {
 tsp = tss;
...
rb_file_s_lutime(int argc, VALUE *argv)
{
 ...
 static void syserr_fail2_in(const char *,int,VALUE,VALUE);
static void
syserr_fail2_in(const char *func, int e, VALUE s1, VALUE s2)
{
    ...
    const int max_pathlen = 4096;


    if (e == 17) {
 rb_syserr_fail_path_in(__func__, (e), (rb_str_ellipsize(s2, max_pathlen)));
    }
...
{
    ((* ({ volatile VALUE *rb_gc_guarded_ptr = &(from); ; rb_gc_guarded_ptr; })) = rb_get_path(from));
    ((* ({ volatile VALUE *rb_gc_guarded_ptr = &(to); ; rb_gc_guarded_ptr; })) = rb_get_path(to));
    from = rb_str_encode_ospath(from);
    to = rb_str_encode_ospath(to);

    if (link(rb_string_value_cstr(&(from)), rb_string_value_cstr(&(to))) < 0) {
 syserr_fail2_in(__func__, (*__errno_location ()), from, to);
    }
    return (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG);
}
static VALUE
rb_file_s_symlink(VALUE klass, VALUE from, VALUE to)
{
    ...
    if (symlink(rb_string_value_cstr(&(from)), rb_string_value_cstr(&(to))) < 0) {
 syserr_fail2_in(__func__, (*__errno_location ()), from, to);
    }
    return (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG);
}
...
readlink_without_gvl(VALUE path, VALUE buf, size_t size)
{
    ...
    ra.path = (!(((struct RBasic*)(path))->flags & RSTRING_NOEMBED) ? ((struct RString*)(path))->as.ary : ((struct RString*)(path))->as.heap.ptr);
    ra.buf = (!(((struct RBasic*)(buf))->flags & RSTRING_NOEMBED) ? ((struct RString*)(buf))->as.ary : ((struct RString*)(buf))->as.heap.ptr);
    ra.size = size;
...
rb_readlink(VALUE path, rb_encoding *enc)
{
    ...
    path = rb_str_encode_ospath(path);
    v =  ({ (__builtin_constant_p(0) && __builtin_constant_p(size)) ? rb_enc_str_new_static((0), (size), (enc)) : rb_enc_str_new((0), (size), (enc)); });
...
rb_file_s_rename(VALUE klass, VALUE from, VALUE to)
{
    ...
    ra.src = rb_string_value_cstr(&(f));
    ra.dst = rb_string_value_cstr(&(t));



    if ((int)(VALUE)rb_thread_call_without_gvl(no_gvl_rename, &ra,
      ((rb_unblock_function_t *)-1), 0) < 0) {
 int e = (*__errno_location ());
 syserr_fail2_in(__func__, e, from, to);
    }
...
rb_file_s_umask(int argc, VALUE *argv)
{
 ...
 omask = umask(((unsigned int)rb_num2uint(argv[0])));
    }
    else {
 rb_check_arity(argc, 0, 1);
    }
    return (((VALUE)((unsigned int)(omask)))<<1 | RUBY_FIXNUM_FLAG);
}
static inline char *
...
rb_enc_path_last_separator(const char *path, const char *end, rb_encoding *enc)
{
 ...
 if (((*path) == '/')) {
     ...
     ((path) = (((path)) + rb_enc_mbclen(((path)), ((end)), ((enc)))));
 }
    }
    return last;
}
...
copy_home_path(VALUE result, const char *dir)
{
    ...
    memcpy(buf = (!(((struct RBasic*)(result))->flags & RSTRING_NOEMBED) ? ((struct RString*)(result))->as.ary : ((struct RString*)(result))->as.heap.ptr), dir, dirlen);
...
rb_home_dir_of(VALUE user, VALUE result)
{
    ...
    const char *dir, *username = (!(((struct RBasic*)(user))->flags & RSTRING_NOEMBED) ? ((struct RString*)(user))->as.ary : ((struct RString*)(user))->as.heap.ptr);
    ...
    if (enc != fsenc) {
        dir = username = (!(((struct RBasic*)(rb_str_conv_enc(user, enc, fsenc)))->flags & RSTRING_NOEMBED) ? ((struct RString*)(rb_str_conv_enc(user, enc, fsenc)))->as.ary : ((struct RString*)(rb_str_conv_enc(user, enc, fsenc)))->as.heap.ptr);
    }
    ...
    if (!pwPtr) {
 endpwent();
 rb_raise(rb_eArgError, "user %li\v doesn't exist", user);
    }
...
ospath_new(const char *ptr, long len, rb_encoding *fsenc)
{
    ...
    return  ({ (__builtin_constant_p(ptr) && __builtin_constant_p(len)) ? rb_enc_str_new_static((ptr), (len), (fsenc)) : rb_enc_str_new((ptr), (len), (fsenc)); });
...
append_fspath(VALUE result, VALUE fname, char *dir, rb_encoding **enc, rb_encoding *fsenc)
{
 ...
 if (direnc != fsenc) {
     ...
     (!(((struct RBasic*)(dirname))->flags & RSTRING_NOEMBED) ? ((cwdp) = ((struct RString*)(dirname))->as.ary, (dirlen) = (long)((((struct RBasic*)(dirname))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT))) : ((cwdp) = ((struct RString*)(dirname))->as.heap.ptr, (dirlen) = ((struct RString*)(dirname))->as.heap.len));
 }
 else if (0) {
     (!(((struct RBasic*)(dirname))->flags & RSTRING_NOEMBED) ? ((cwdp) = ((struct RString*)(dirname))->as.ary, (dirlen) = (long)((((struct RBasic*)(dirname))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT))) : ((cwdp) = ((struct RString*)(dirname))->as.heap.ptr, (dirlen) = ((struct RString*)(dirname))->as.heap.len));
 }
 *enc = direnc;
    ...
    ruby_xfree(dir);
    if (!!((VALUE)(dirname) != ((VALUE)RUBY_Qnil))) rb_str_resize(dirname, 0);
...
rb_file_expand_path_internal(VALUE fname, VALUE dname, int abs_mode, int long_name, VALUE result)
{
    ...
    s = rb_string_value_ptr(&(fname));
    fend = s + (!(((struct RBasic*)(fname))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(fname))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(fname))->as.heap.len);
    enc = rb_enc_get(fname);
    ( p = buf = (!(((struct RBasic*)(result))->flags & RSTRING_NOEMBED) ? ((struct RString*)(result))->as.ary : ((struct RString*)(result))->as.heap.ptr), buflen = (!(((struct RBasic*)(result))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(result))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(result))->as.heap.len), pend = p + buflen);
    tainted = (!!((!(((VALUE)((fname)) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)((fname)) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)((fname)))->flags & RUBY_T_MASK) != RUBY_T_NODE)?(((struct RBasic*)(((fname))))->flags&((RUBY_FL_TAINT))):0));
 ...
 if (((s[1]) == '/') || s[1] == '\0') {
     ...
     s = rb_enc_path_next(b = s, fend, enc);
     b++;
     userlen = s - b;
     do { bdiff = p - buf; if (bdiff + userlen >= buflen) { do {buflen *= 2;} while (bdiff + userlen >= buflen); rb_str_resize(result, buflen); buf = (!(((struct RBasic*)(result))->flags & RSTRING_NOEMBED) ? ((struct RString*)(result))->as.ary : ((struct RString*)(result))->as.heap.ptr); p = buf + bdiff; pend = buf + buflen; }} while (0);
     memcpy(p, b, userlen);
     ( ((struct RBasic*)((result)))->flags = (((struct RBasic*)((result)))->flags & ~RUBY_ENC_CODERANGE_MASK) | (0));
 ...
 if (!rb_is_absolute_path((!(((struct RBasic*)(result))->flags & RSTRING_NOEMBED) ? ((struct RString*)(result))->as.ary : ((struct RString*)(result))->as.heap.ptr))) {
     if (userlen) {
  rb_enc_raise(enc, rb_eArgError, "non-absolute home of %.*s%.0li\v",
        (int)userlen, b, fname);
     }
     else {
 ...
 if (!!((VALUE)(dname) != ((VALUE)RUBY_Qnil))) {
     rb_file_expand_path_internal(dname, ((VALUE)RUBY_Qnil), abs_mode, long_name, result);
 ...
 len = s - b;
 p = buf + len;
 do { bdiff = p - buf; if (bdiff >= buflen) { do {buflen *= 2;} while (bdiff >= buflen); rb_str_resize(result, buflen); buf = (!(((struct RBasic*)(result))->flags & RSTRING_NOEMBED) ? ((struct RString*)(result))->as.ary : ((struct RString*)(result))->as.heap.ptr); p = buf + bdiff; pend = buf + buflen; }} while (0);
 memset(buf, '/', len);
 ...
 do { bdiff = p - buf; if (bdiff + 1 >= buflen) { do {buflen *= 2;} while (bdiff + 1 >= buflen); rb_str_resize(result, buflen); buf = (!(((struct RBasic*)(result))->flags & RSTRING_NOEMBED) ? ((struct RString*)(result))->as.ary : ((struct RString*)(result))->as.heap.ptr); p = buf + bdiff; pend = buf + buflen; }} while (0);
 *p = '/';
    }
 ...
 switch (*s) {
   ...
   *p = '\0';
   ...
   case '/':
     ...
     if (s > b) {
  do { long rootdiff = root - buf; do { const int skip = 1; rb_str_set_len(result, p-buf+skip); do { bdiff = p - buf; if (bdiff + ((s-b)+skip) >= buflen) { do {buflen *= 2;} while (bdiff + ((s-b)+skip) >= buflen); rb_str_resize(result, buflen); buf = (!(((struct RBasic*)(result))->flags & RSTRING_NOEMBED) ? ((struct RString*)(result))->as.ary : ((struct RString*)(result))->as.heap.ptr); p = buf + bdiff; pend = buf + buflen; }} while (0); p += skip; memcpy(p, (b), (s-b)); p += (s-b); } while (0); root = buf + rootdiff; } while (0);
  *p = '/';
     }
     b = ++s;
     break;
   default:
     ((s) = (((s)) + rb_enc_mbclen(((s)), ((fend)), ((enc)))));
     break;
 }
    }

    if (s > b) {
 do { const int skip = 1; rb_str_set_len(result, p-buf+skip); do { bdiff = p - buf; if (bdiff + ((s-b)+skip) >= buflen) { do {buflen *= 2;} while (bdiff + ((s-b)+skip) >= buflen); rb_str_resize(result, buflen); buf = (!(((struct RBasic*)(result))->flags & RSTRING_NOEMBED) ? ((struct RString*)(result))->as.ary : ((struct RString*)(result))->as.heap.ptr); p = buf + bdiff; pend = buf + buflen; }} while (0); p += skip; memcpy(p, (b), (s-b)); p += (s-b); } while (0);
 rb_str_set_len(result, p-buf);
    }
...
{
    return rb_file_expand_path_internal(fname, ((VALUE)RUBY_Qnil), 0, 0,  ({ (__builtin_constant_p(0) && __builtin_constant_p(4096 + 2)) ? rb_usascii_str_new_static((0), (4096 + 2)) : rb_usascii_str_new((0), (4096 + 2)); }));
}

VALUE
rb_file_expand_path(VALUE fname, VALUE dname)
{
    (((fname) = rb_get_path(fname)), (void)(!((VALUE)(dname) != ((VALUE)RUBY_Qnil)) ? (dname) : ((dname) = rb_get_path(dname))));
    return str_shrink(rb_file_expand_path_internal(fname, dname, 0, 1,  ({ (__builtin_constant_p(0) && __builtin_constant_p(4096 + 2)) ? rb_usascii_str_new_static((0), (4096 + 2)) : rb_usascii_str_new((0), (4096 + 2)); })));
}

VALUE
rb_file_expand_path_fast(VALUE fname, VALUE dname)
{
    return str_shrink(rb_file_expand_path_internal(fname, dname, 0, 0,  ({ (__builtin_constant_p(0) && __builtin_constant_p(4096 + 2)) ? rb_usascii_str_new_static((0), (4096 + 2)) : rb_usascii_str_new((0), (4096 + 2)); })));
}
VALUE
rb_file_s_expand_path(int argc, const VALUE *argv)
{
    rb_check_arity(argc, 1, 2);
    return rb_file_expand_path(argv[0], argc > 1 ? argv[1] : ((VALUE)RUBY_Qnil));
}
...
{
    (((fname) = rb_get_path(fname)), (void)(!((VALUE)(dname) != ((VALUE)RUBY_Qnil)) ? (dname) : ((dname) = rb_get_path(dname))));
    return str_shrink(rb_file_expand_path_internal(fname, dname, 1, 1,  ({ (__builtin_constant_p(0) && __builtin_constant_p(4096 + 2)) ? rb_usascii_str_new_static((0), (4096 + 2)) : rb_usascii_str_new((0), (4096 + 2)); })));
}
VALUE
rb_file_s_absolute_path(int argc, const VALUE *argv)
{
    rb_check_arity(argc, 1, 2);
    return rb_file_absolute_path(argv[0], argc > 1 ? argv[1] : ((VALUE)RUBY_Qnil));
}
      ...
      VALUE loopcheck, enum rb_realpath_mode mode, int last)
{
    ...
    ID resolving;
    do { static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("resolving")), (long)strlen(("resolving"))); (resolving) = rb_intern_id_cache; } while (0);
 ...
 const char *unresolved_nextname = unresolved_firstsep;
        while (unresolved_nextname < pend && ((*unresolved_nextname) == '/'))
     unresolved_nextname++;
        unresolved = unresolved_nextname;
        if (testnamelen == 1 && testname[0] == '.') {
        }
        else if (testnamelen == 2 && testname[0] == '.' && testname[1] == '.') {
            if (*prefixlenp < (!(((struct RBasic*)(*resolvedp))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(*resolvedp))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(*resolvedp))->as.heap.len)) {
  const char *resolved_str = (!(((struct RBasic*)(*resolvedp))->flags & RSTRING_NOEMBED) ? ((struct RString*)(*resolvedp))->as.ary : ((struct RString*)(*resolvedp))->as.heap.ptr);
  const char *resolved_names = resolved_str + *prefixlenp;
  const char *lastsep = rb_enc_path_last_separator(resolved_names, resolved_str + (!(((struct RBasic*)(*resolvedp))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(*resolvedp))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(*resolvedp))->as.heap.len), enc);
            ...
            if (*prefixlenp < (!(((struct RBasic*)(testpath))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(testpath))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(testpath))->as.heap.len))
                 ({ (__builtin_constant_p("/")) ? rb_str_cat((testpath), ("/"), (long)strlen("/")) : rb_str_cat_cstr((testpath), ("/")); });
            ...
            if (!!((VALUE)(checkval) != ((VALUE)RUBY_Qnil))) {
                if (checkval == (rb_id2sym(resolving))) {
      if (mode == RB_REALPATH_CHECK) {
   (*__errno_location ()) = 40;
   return -1;
      }
                    rb_syserr_fail_path_in(__func__, (40), (testpath));
                }
                else {
                ...
                struct stat sbuf;
                int ret;
                ret = lstat_without_gvl((!(((struct RBasic*)(testpath))->flags & RSTRING_NOEMBED) ? ((struct RString*)(testpath))->as.ary : ((struct RString*)(testpath))->as.heap.ptr), &sbuf);
                if (ret == -1) {
      int e = (*__errno_location ());
      if (e == 2 && !!((VALUE)(fallback) != ((VALUE)RUBY_Qnil))) {
   if (stat_without_gvl((!(((struct RBasic*)(fallback))->flags & RSTRING_NOEMBED) ? ((struct RString*)(fallback))->as.ary : ((struct RString*)(fallback))->as.heap.ptr), &sbuf) == 0) {
   ...
   if (mode == RB_REALPATH_STRICT || !last || *unresolved_firstsep)
       rb_syserr_fail_path_in(__func__, (e), (testpath));
                        *resolvedp = testpath;
                        break;
                    }
                    else {
   rb_syserr_fail_path_in(__func__, (e), (testpath));
      ...
      VALUE link;
      VALUE link_orig = ((VALUE)RUBY_Qnil);
      const char *link_prefix, *link_names;
                    long link_prefixlen;
                    rb_hash_aset(loopcheck, testpath, (rb_id2sym(resolving)));
      link = rb_readlink(testpath, enc);
                    link_prefix = (!(((struct RBasic*)(link))->flags & RSTRING_NOEMBED) ? ((struct RString*)(link))->as.ary : ((struct RString*)(link))->as.heap.ptr);
      link_names = skipprefixroot(link_prefix, link_prefix + (!(((struct RBasic*)(link))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(link))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(link))->as.heap.len), rb_enc_get(link));
   ...
   *prefixlenp = link_prefixlen;
   ...
   return -1;
      (* ({ volatile VALUE *rb_gc_guarded_ptr = &(link_orig); ; rb_gc_guarded_ptr; }));
      rb_hash_aset(loopcheck, testpath, rb_str_new_frozen(*resolvedp));
                }
                else

                {
                    VALUE s = rb_str_new_frozen(testpath);
...
rb_check_realpath_internal(VALUE basedir, VALUE path, enum rb_realpath_mode mode)
{
    ...
    VALUE loopcheck;
    VALUE curdir = ((VALUE)RUBY_Qnil);

    rb_encoding *enc, *origenc;
    char *path_names = ((void*)0), *basedir_names = ((void*)0), *curdir_names = ((void*)0);
    char *ptr, *prefixptr = ((void*)0), *pend;
    long len;

    unresolved_path = rb_str_new_frozen(path);

    if (!!((VALUE)(basedir) != ((VALUE)RUBY_Qnil))) {
        ((* ({ volatile VALUE *rb_gc_guarded_ptr = &(basedir); ; rb_gc_guarded_ptr; })) = rb_get_path(basedir));
        basedir = (rb_str_new_frozen(basedir));
    }

    enc = rb_enc_get(unresolved_path);
    origenc = enc;
    unresolved_path = (unresolved_path);
    (!(((struct RBasic*)(unresolved_path))->flags & RSTRING_NOEMBED) ? ((ptr) = ((struct RString*)(unresolved_path))->as.ary, (len) = (long)((((struct RBasic*)(unresolved_path))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT))) : ((ptr) = ((struct RString*)(unresolved_path))->as.heap.ptr, (len) = ((struct RString*)(unresolved_path))->as.heap.len));
    ...
    if (!!((VALUE)(basedir) != ((VALUE)RUBY_Qnil))) {
 (!(((struct RBasic*)(basedir))->flags & RSTRING_NOEMBED) ? ((ptr) = ((struct RString*)(basedir))->as.ary, (len) = (long)((((struct RBasic*)(basedir))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT))) : ((ptr) = ((struct RString*)(basedir))->as.heap.ptr, (len) = ((struct RString*)(basedir))->as.heap.len));
 basedir_names = skipprefixroot(ptr, ptr + len, rb_enc_get(basedir));
    ...
    (!(((struct RBasic*)(curdir))->flags & RSTRING_NOEMBED) ? ((ptr) = ((struct RString*)(curdir))->as.ary, (len) = (long)((((struct RBasic*)(curdir))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT))) : ((ptr) = ((struct RString*)(curdir))->as.heap.ptr, (len) = ((struct RString*)(curdir))->as.heap.len));
    curdir_names = skipprefixroot(ptr, ptr + len, rb_enc_get(curdir));
    resolved = rb_str_subseq(curdir, 0, curdir_names - ptr);

  root_found:
    (!(((struct RBasic*)(resolved))->flags & RSTRING_NOEMBED) ? ((prefixptr) = ((struct RString*)(resolved))->as.ary, (prefixlen) = (long)((((struct RBasic*)(resolved))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT))) : ((prefixptr) = ((struct RString*)(resolved))->as.heap.ptr, (prefixlen) = ((struct RString*)(resolved))->as.heap.len));
 ...
 rb_enc_associate_index(resolved, rb_filesystem_encindex());
    ...
    if (curdir_names) {
 if (realpath_rec(&prefixlen, &resolved, curdir_names, ((VALUE)RUBY_Qnil), loopcheck, mode, 0))
     return ((VALUE)RUBY_Qnil);
    }
    if (basedir_names) {
 if (realpath_rec(&prefixlen, &resolved, basedir_names, ((VALUE)RUBY_Qnil), loopcheck, mode, 0))
     return ((VALUE)RUBY_Qnil);
    }
    if (realpath_rec(&prefixlen, &resolved, path_names, ((VALUE)RUBY_Qnil), loopcheck, mode, 1))
 return ((VALUE)RUBY_Qnil);
 ...
 if (rb_enc_str_asciionly_p(resolved)) {
     ...
     resolved = rb_str_conv_enc(resolved, ((void*)0), origenc);
 }
    }

    ( (((!(((VALUE)(resolved) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(resolved) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(resolved))->flags & RUBY_T_MASK) != RUBY_T_NODE) && (int)(((struct RBasic*)(resolved))->flags & RUBY_T_MASK) != RUBY_T_BIGNUM && (int)(((struct RBasic*)(resolved))->flags & RUBY_T_MASK) != RUBY_T_FLOAT) && (!(((VALUE)(unresolved_path) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(unresolved_path) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(unresolved_path))->flags & RUBY_T_MASK) != RUBY_T_NODE)) ? (void)(((struct RBasic*)(resolved))->flags |= ((((struct RBasic*)(unresolved_path))->flags&(RUBY_FL_TAINT)))) : (void)0);
    (* ({ volatile VALUE *rb_gc_guarded_ptr = &(unresolved_path); ; rb_gc_guarded_ptr; }));
    (* ({ volatile VALUE *rb_gc_guarded_ptr = &(curdir); ; rb_gc_guarded_ptr; }));
    return resolved;
}
...
{
    VALUE basedir = (rb_check_arity(argc, 1, 2) > 1) ? argv[1] : ((VALUE)RUBY_Qnil);
    VALUE path = argv[0];
    ((* ({ volatile VALUE *rb_gc_guarded_ptr = &(path); ; rb_gc_guarded_ptr; })) = rb_get_path(path));
...
rmext(const char *p, long l0, long l1, const char *e, long l2, rb_encoding *enc)
{
 ...
 return last - p;
    ...
    s = p+l1-l2;
    if (((char *)onigenc_get_left_adjust_char_head((enc),(OnigUChar*)(p),(OnigUChar*)(s),(OnigUChar*)(p+l1))) != s) return 0;
...
ruby_enc_find_basename(const char *name, long *baselen, long *alllen, rb_encoding *enc)
{
 ...
 for (q = p; q - p < n && *q == '.'; q++);
 for (e = 0; q - p < n; ((q) = (((q)) + rb_enc_mbclen(((q)), ((end)), ((enc)))))) {
     if (*q == '.') e = q;
 }
 if (e) f = e - p;
 else f = n;
...
rb_file_s_basename(int argc, VALUE *argv)
{
    ...
    fext = ((VALUE)RUBY_Qnil);
    if (rb_check_arity(argc, 1, 2) == 2) {
 fext = argv[1];
 rb_string_value(&(fext));
 enc = check_path_encoding(fext);
    }
    fname = argv[0];
    ((fname) = rb_get_path_no_checksafe(fname));
    if (!((VALUE)(fext) != ((VALUE)RUBY_Qnil)) || !(enc = rb_enc_compatible(fname, fext))) {
 enc = rb_enc_get(fname);
 fext = ((VALUE)RUBY_Qnil);
    }
    if ((n = (!(((struct RBasic*)(fname))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(fname))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(fname))->as.heap.len)) == 0 || !*(name = (!(((struct RBasic*)(fname))->flags & RSTRING_NOEMBED) ? ((struct RString*)(fname))->as.ary : ((struct RString*)(fname))->as.heap.ptr)))
 return rb_str_new_shared(fname);

    p = ruby_enc_find_basename(name, &f, &n, enc);
    if (n >= 0) {
 if (!((VALUE)(fext) != ((VALUE)RUBY_Qnil))) {
     f = n;
 }
 else {
     const char *fp;
     fp = rb_string_value_cstr(&(fext));
     if (!(f = rmext(p, f, n, fp, (!(((struct RBasic*)(fext))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(fext))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(fext))->as.heap.len), enc))) {
  f = n;
     }
     (* ({ volatile VALUE *rb_gc_guarded_ptr = &(fext); ; rb_gc_guarded_ptr; }));
 }
 if (f == (!(((struct RBasic*)(fname))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(fname))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(fname))->as.heap.len)) return rb_str_new_shared(fname);
    }

    basename =  ({ (__builtin_constant_p(p) && __builtin_constant_p(f)) ? rb_str_new_static((p), (f)) : rb_str_new((p), (f)); });
    rb_enc_copy(basename, fname);
    ( (((!(((VALUE)(basename) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(basename) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(basename))->flags & RUBY_T_MASK) != RUBY_T_NODE) && (int)(((struct RBasic*)(basename))->flags & RUBY_T_MASK) != RUBY_T_BIGNUM && (int)(((struct RBasic*)(basename))->flags & RUBY_T_MASK) != RUBY_T_FLOAT) && (!(((VALUE)(fname) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(fname) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(fname))->flags & RUBY_T_MASK) != RUBY_T_NODE)) ? (void)(((struct RBasic*)(basename))->flags |= ((((struct RBasic*)(fname))->flags&(RUBY_FL_TAINT)))) : (void)0);
    return basename;
}
static VALUE
...
rb_file_dirname(VALUE fname)
{
    ...
    ((fname) = rb_get_path_no_checksafe(fname));
    name = rb_string_value_cstr(&(fname));
    end = name + (!(((struct RBasic*)(fname))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(fname))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(fname))->as.heap.len);
    enc = rb_enc_get(fname);
 ...
 p = root;
    ...
    if (p == name)
 return  ({ (__builtin_constant_p(".")) ? rb_usascii_str_new_static(("."), (long)strlen(".")) : rb_usascii_str_new_cstr("."); });
    dirname =  ({ (__builtin_constant_p(name) && __builtin_constant_p(p - name)) ? rb_str_new_static((name), (p - name)) : rb_str_new((name), (p - name)); });




    rb_enc_copy(dirname, fname);
    ( (((!(((VALUE)(dirname) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(dirname) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(dirname))->flags & RUBY_T_MASK) != RUBY_T_NODE) && (int)(((struct RBasic*)(dirname))->flags & RUBY_T_MASK) != RUBY_T_BIGNUM && (int)(((struct RBasic*)(dirname))->flags & RUBY_T_MASK) != RUBY_T_FLOAT) && (!(((VALUE)(fname) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(fname) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(fname))->flags & RUBY_T_MASK) != RUBY_T_NODE)) ? (void)(((struct RBasic*)(dirname))->flags |= ((((struct RBasic*)(fname))->flags&(RUBY_FL_TAINT)))) : (void)0);
    return dirname;
}
const char *
...
rb_file_s_extname(VALUE klass, VALUE fname)
{
    ...
    ((fname) = rb_get_path_no_checksafe(fname));
    name = rb_string_value_cstr(&(fname));
    len = (!(((struct RBasic*)(fname))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(fname))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(fname))->as.heap.len);
 ...
 return  ({ (__builtin_constant_p(0) && __builtin_constant_p(0)) ? rb_str_new_static((0), (0)) : rb_str_new((0), (0)); });
    ...
    ( (((!(((VALUE)(extname) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(extname) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(extname))->flags & RUBY_T_MASK) != RUBY_T_NODE) && (int)(((struct RBasic*)(extname))->flags & RUBY_T_MASK) != RUBY_T_BIGNUM && (int)(((struct RBasic*)(extname))->flags & RUBY_T_MASK) != RUBY_T_FLOAT) && (!(((VALUE)(fname) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(fname) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(fname))->flags & RUBY_T_MASK) != RUBY_T_NODE)) ? (void)(((struct RBasic*)(extname))->flags |= ((((struct RBasic*)(fname))->flags&(RUBY_FL_TAINT)))) : (void)0);
    return extname;
}
static VALUE
...
rb_file_join(VALUE ary)
{
    ...
    if (rb_array_len(ary) == 0) return  ({ (__builtin_constant_p(0) && __builtin_constant_p(0)) ? rb_str_new_static((0), (0)) : rb_str_new((0), (0)); });

    len = 1;
    for (i=0; i<rb_array_len(ary); i++) {
 tmp = (rb_array_const_ptr(ary)[i]);
 if (( ((RUBY_T_STRING) == RUBY_T_FIXNUM) ? (((int)(long)(tmp))&RUBY_FIXNUM_FLAG) : ((RUBY_T_STRING) == RUBY_T_TRUE) ? ((tmp) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_STRING) == RUBY_T_FALSE) ? ((tmp) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_STRING) == RUBY_T_NIL) ? ((tmp) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_STRING) == RUBY_T_UNDEF) ? ((tmp) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_STRING) == RUBY_T_SYMBOL) ? ((((VALUE)(tmp)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(tmp) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(tmp) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(tmp))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_STRING) == RUBY_T_FLOAT) ? ( ((((int)(long)(tmp))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(tmp) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(tmp) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(tmp))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(tmp) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(tmp) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(tmp))->flags & RUBY_T_MASK) == (RUBY_T_STRING)))) {
     check_path_encoding(tmp);
     len += (!(((struct RBasic*)(tmp))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(tmp))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(tmp))->as.heap.len);
 }
 else {
     len += 10;
 }
    }
    len += rb_array_len(ary) - 1;
    result = rb_str_buf_new(len);
    memset(&(((struct RBasicRaw *)((VALUE)(result)))->klass), 0, sizeof(VALUE));
    ( (((!(((VALUE)(result) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(result) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(result))->flags & RUBY_T_MASK) != RUBY_T_NODE) && (int)(((struct RBasic*)(result))->flags & RUBY_T_MASK) != RUBY_T_BIGNUM && (int)(((struct RBasic*)(result))->flags & RUBY_T_MASK) != RUBY_T_FLOAT) && (!(((VALUE)(ary) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(ary) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(ary))->flags & RUBY_T_MASK) != RUBY_T_NODE)) ? (void)(((struct RBasic*)(result))->flags |= ((((struct RBasic*)(ary))->flags&(RUBY_FL_TAINT)))) : (void)0);
    for (i=0; i<rb_array_len(ary); i++) {
 tmp = (rb_array_const_ptr(ary)[i]);
 switch (({ VALUE arg_obj = (tmp); (((VALUE)(arg_obj) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(arg_obj) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) ? -1 : (int)(((struct RBasic*)(arg_obj))->flags & RUBY_T_MASK); })) {
   case RUBY_T_STRING:
  ...
  tmp = rb_exec_recursive(file_inspect_join, ary, tmp);
     ...
     break;
   default:
     ((tmp) = rb_get_path_no_checksafe(tmp));
     checked = FALSE;
 }
 (!(((struct RBasic*)(result))->flags & RSTRING_NOEMBED) ? ((name) = ((struct RString*)(result))->as.ary, (len) = (long)((((struct RBasic*)(result))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT))) : ((name) = ((struct RString*)(result))->as.heap.ptr, (len) = ((struct RString*)(result))->as.heap.len));
 if (i == 0) {
     rb_enc_copy(result, tmp);
 }
 else {
     tail = chompdirsep(name, name + len, rb_enc_get(result));
     if ((!(((struct RBasic*)(tmp))->flags & RSTRING_NOEMBED) ? ((struct RString*)(tmp))->as.ary : ((struct RString*)(tmp))->as.heap.ptr) && (((!(((struct RBasic*)(tmp))->flags & RSTRING_NOEMBED) ? ((struct RString*)(tmp))->as.ary : ((struct RString*)(tmp))->as.heap.ptr)[0]) == '/')) {
...
rb_file_s_truncate(VALUE klass, VALUE path, VALUE len)
{
    ...
    ta.pos = rb_num2long_inline(len);
    ((* ({ volatile VALUE *rb_gc_guarded_ptr = &(path); ; rb_gc_guarded_ptr; })) = rb_get_path(path));
    path = rb_str_encode_ospath(path);
    ta.path = rb_string_value_cstr(&(path));
...
rb_file_flock(VALUE obj, VALUE operation)
{
    ...
    op[1] = op1 = rb_num2int_inline(operation);
    rb_io_check_closed((fptr) = ((struct RFile*)(rb_io_taint_check(obj)))->fptr);
    op[0] = fptr->fd;
 ...
 switch (e) {
   ...
   case 13:
     ...
     if (op1 & 4) return ((VALUE)RUBY_Qfalse);
...
test_check(int n, int argc, VALUE *argv)
{
    ...
    for (i=1; i<n; i++) {
 if (!( ((RUBY_T_FILE) == RUBY_T_FIXNUM) ? (((int)(long)(argv[i]))&RUBY_FIXNUM_FLAG) : ((RUBY_T_FILE) == RUBY_T_TRUE) ? ((argv[i]) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_FILE) == RUBY_T_FALSE) ? ((argv[i]) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_FILE) == RUBY_T_NIL) ? ((argv[i]) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_FILE) == RUBY_T_UNDEF) ? ((argv[i]) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_FILE) == RUBY_T_SYMBOL) ? ((((VALUE)(argv[i])&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(argv[i]) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(argv[i]) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(argv[i]))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_FILE) == RUBY_T_FLOAT) ? ( ((((int)(long)(argv[i]))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(argv[i]) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(argv[i]) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(argv[i]))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(argv[i]) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(argv[i]) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(argv[i]))->flags & RUBY_T_MASK) == (RUBY_T_FILE)))) {
     ((* ({ volatile VALUE *rb_gc_guarded_ptr = &(argv[i]); ; rb_gc_guarded_ptr; })) = rb_get_path(argv[i]));
 }
    }
}
static VALUE
rb_f_test(int argc, VALUE *argv)
{
 ...
 test_check((2), argc, argv);
 if (rb_stat(argv[1], &st1) < 0) return ((VALUE)RUBY_Qfalse);
 if (rb_stat(argv[2], &st2) < 0) return ((VALUE)RUBY_Qfalse);
 ...
 switch (cmd) {
   case '=':
     if (t1.tv_sec == t2.tv_sec && t1.tv_nsec == t2.tv_nsec) return ((VALUE)RUBY_Qtrue);
     return ((VALUE)RUBY_Qfalse);

   case '>':
     if (t1.tv_sec > t2.tv_sec) return ((VALUE)RUBY_Qtrue);
     if (t1.tv_sec == t2.tv_sec && t1.tv_nsec > t2.tv_nsec) return ((VALUE)RUBY_Qtrue);
     return ((VALUE)RUBY_Qfalse);
...
rb_stat_init(VALUE obj, VALUE fname)
{
    ...
    ((* ({ volatile VALUE *rb_gc_guarded_ptr = &(fname); ; rb_gc_guarded_ptr; })) = rb_get_path(fname));
    fname = rb_str_encode_ospath(fname);
    if (stat((rb_string_value_cstr(&(fname))), (&st)) == -1) {
 rb_sys_fail_path_in(__func__, fname);
    }
    if ((((struct RData*)(obj))->data)) {
 ruby_xfree((((struct RData*)(obj))->data));
 (((struct RData*)(obj))->data) = ((void*)0);
    }
    nst = ((struct stat*)ruby_xmalloc(sizeof(struct stat)));
    *nst = st;
    (((struct RData*)(obj))->data) = nst;
...
rb_stat_init_copy(VALUE copy, VALUE orig)
{
    ...
    if (!((copy) != (orig) && (rb_obj_init_copy((copy), (orig)), 1))) return copy;
    if ((((struct RData*)(copy))->data)) {
 ruby_xfree((((struct RData*)(copy))->data));
 (((struct RData*)(copy))->data) = 0;
    }
    if ((((struct RData*)(orig))->data)) {
 nst = ((struct stat*)ruby_xmalloc(sizeof(struct stat)));
 *nst = *(struct stat*)(((struct RData*)(orig))->data);
 (((struct RData*)(copy))->data) = nst;
    }
...
rb_stat_d(VALUE obj)
{
    if (((((get_stat(obj)->st_mode)) & 0170000) == (0040000))) return ((VALUE)RUBY_Qtrue);
    return ((VALUE)RUBY_Qfalse);
}
static VALUE
rb_stat_p(VALUE obj)
{
    ...
    if (((((get_stat(obj)->st_mode)) & 0170000) == (0010000))) return ((VALUE)RUBY_Qtrue);
...
rb_stat_l(VALUE obj)
{
    ...
    if (((((get_stat(obj)->st_mode)) & 0170000) == (0120000))) return ((VALUE)RUBY_Qtrue);
...
rb_stat_S(VALUE obj)
{
    ...
    if (((((get_stat(obj)->st_mode)) & 0170000) == (0140000))) return ((VALUE)RUBY_Qtrue);
...
rb_stat_b(VALUE obj)
{
    ...
    if (((((get_stat(obj)->st_mode)) & 0170000) == (0060000))) return ((VALUE)RUBY_Qtrue);
...
rb_stat_c(VALUE obj)
{
    if (((((get_stat(obj)->st_mode)) & 0170000) == (0020000))) return ((VALUE)RUBY_Qtrue);
...
{
    if (get_stat(obj)->st_uid == geteuid()) return ((VALUE)RUBY_Qtrue);
    return ((VALUE)RUBY_Qfalse);
}
...
{
    if (get_stat(obj)->st_uid == getuid()) return ((VALUE)RUBY_Qtrue);
    return ((VALUE)RUBY_Qfalse);
}
static VALUE
rb_stat_grpowned(VALUE obj)
{
    ...
    if (rb_group_member(get_stat(obj)->st_gid)) return ((VALUE)RUBY_Qtrue);
...
rb_stat_r(VALUE obj)
{
    ...
    if (geteuid() == 0) return ((VALUE)RUBY_Qtrue);


    if (rb_stat_owned(obj))
 return st->st_mode & 0400 ? ((VALUE)RUBY_Qtrue) : ((VALUE)RUBY_Qfalse);


    if (rb_stat_grpowned(obj))
 return st->st_mode & (0400 >> 3) ? ((VALUE)RUBY_Qtrue) : ((VALUE)RUBY_Qfalse);


    if (!(st->st_mode & ((0400 >> 3) >> 3))) return ((VALUE)RUBY_Qfalse);
...
rb_stat_R(VALUE obj)
{
    ...
    if (getuid() == 0) return ((VALUE)RUBY_Qtrue);
...
rb_stat_w(VALUE obj)
{
    ...
    if (rb_stat_owned(obj))
 return st->st_mode & 0200 ? ((VALUE)RUBY_Qtrue) : ((VALUE)RUBY_Qfalse);


    if (rb_stat_grpowned(obj))
 return st->st_mode & (0200 >> 3) ? ((VALUE)RUBY_Qtrue) : ((VALUE)RUBY_Qfalse);


    if (!(st->st_mode & ((0200 >> 3) >> 3))) return ((VALUE)RUBY_Qfalse);
...
rb_stat_x(VALUE obj)
{
    ...
    if (geteuid() == 0) {
 return st->st_mode & (0100 | (0100 >> 3) | ((0100 >> 3) >> 3)) ? ((VALUE)RUBY_Qtrue) : ((VALUE)RUBY_Qfalse);
    }


    if (rb_stat_owned(obj))
 return st->st_mode & 0100 ? ((VALUE)RUBY_Qtrue) : ((VALUE)RUBY_Qfalse);


    if (rb_stat_grpowned(obj))
 return st->st_mode & (0100 >> 3) ? ((VALUE)RUBY_Qtrue) : ((VALUE)RUBY_Qfalse);


    if (!(st->st_mode & ((0100 >> 3) >> 3))) return ((VALUE)RUBY_Qfalse);
...
rb_stat_f(VALUE obj)
{
    if (((((get_stat(obj)->st_mode)) & 0170000) == (0100000))) return ((VALUE)RUBY_Qtrue);
    return ((VALUE)RUBY_Qfalse);
}
static VALUE
rb_stat_z(VALUE obj)
{
    if (get_stat(obj)->st_size == 0) return ((VALUE)RUBY_Qtrue);
    return ((VALUE)RUBY_Qfalse);
}
static VALUE
rb_stat_s(VALUE obj)
{
    ...
    if (size == 0) return ((VALUE)RUBY_Qnil);
    return rb_long2num_inline(size);
}
static VALUE
rb_stat_suid(VALUE obj)
{

    if (get_stat(obj)->st_mode & 04000) return ((VALUE)RUBY_Qtrue);
...
rb_stat_sgid(VALUE obj)
{
    ...
    if (get_stat(obj)->st_mode & 02000) return ((VALUE)RUBY_Qtrue);
...
rb_stat_sticky(VALUE obj)
{
    ...
    if (get_stat(obj)->st_mode & 01000) return ((VALUE)RUBY_Qtrue);
...
rb_file_s_mkfifo(int argc, VALUE *argv)
{
    ...
    rb_check_arity(argc, 1, 2);
    if (argc > 1) {
 ma.mode = ((unsigned int)rb_num2uint(argv[1]));
    }
    path = argv[0];
    ((* ({ volatile VALUE *rb_gc_guarded_ptr = &(path); ; rb_gc_guarded_ptr; })) = rb_get_path(path));
    path = rb_str_encode_ospath(path);
    ma.path = (!(((struct RBasic*)(path))->flags & RSTRING_NOEMBED) ? ((struct RString*)(path))->as.ary : ((struct RString*)(path))->as.heap.ptr);
    if (rb_thread_call_without_gvl(nogvl_mkfifo, &ma, ((rb_unblock_function_t *)-1), 0)) {
 rb_sys_fail_path_in(__func__, path);
    }
    return (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG);
}
...
{
    struct stat st;
    const char *p0 = rb_string_value_cstr(&(path));
    const char *e0;
    rb_encoding *enc;
    char *p = 0, *s;
 ...
 newpath =  ({ (__builtin_constant_p(buf)) ? rb_str_new_static((buf), (long)strlen(buf)) : rb_str_new_cstr(buf); });
 ruby_xfree(buf);

  ({ (__builtin_constant_p("/")) ? rb_str_cat((newpath), ("/"), (long)strlen("/")) : rb_str_cat_cstr((newpath), ("/")); });
  ({ (__builtin_constant_p(p0)) ? rb_str_cat((newpath), (p0), (long)strlen(p0)) : rb_str_cat_cstr((newpath), (p0)); });
 path = newpath;
 p0 = (!(((struct RBasic*)(path))->flags & RSTRING_NOEMBED) ? ((struct RString*)(path))->as.ary : ((struct RString*)(path))->as.heap.ptr);
    }
    e0 = p0 + (!(((struct RBasic*)(path))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(path))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(path))->as.heap.len);
    enc = rb_enc_get(path);
    for (;;) {



 if (stat((p0), (&st)) == 0 && ((((st.st_mode)) & 0170000) == (0040000)) && (st.st_mode & ((0200 >> 3) >> 3))

     && !(p && execpath && (st.st_mode & 01000))

     && !access(p0, 2)) {
     rb_enc_warn(enc, "Insecure world writable dir %s in %sPATH, mode 0%o",
   p0, (execpath ? "": "LOAD_"), st.st_mode);
     if (p) *p = '/';
     (* ({ volatile VALUE *rb_gc_guarded_ptr = &(path); ; rb_gc_guarded_ptr; }));
     return 0;
 }
 s = rb_enc_path_last_separator(p0, e0, enc);
 if (p) *p = '/';
 if (!s || s == p0) return 1;
 p = s;
 e0 = p;
...
rb_path_check(const char *path)
{
    ...
    for (;;) {
 if (!path_check_0( ({ (__builtin_constant_p(p0) && __builtin_constant_p(p - p0)) ? rb_str_new_static((p0), (p - p0)) : rb_str_new((p0), (p - p0)); }), TRUE)) {
     return 0;
 }
 p0 = p + 1;
 if (p0 > pend) break;
...
{
    str_shrink(path);
    do { VALUE _obj_ = (path); rb_obj_write((VALUE)(_obj_), (VALUE *)(&((struct RBasicRaw *)(_obj_))->klass), (VALUE)(rb_obj_class(orig)), "file.c", 6010); } while (0);
...
{
    const char *f = rb_string_value_cstr(&(*filep));
 ...
 if (safe_level >= 1 && (!!((!(((VALUE)((fname)) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)((fname)) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)((fname)))->flags & RUBY_T_MASK) != RUBY_T_NODE)?(((struct RBasic*)(((fname))))->flags&((RUBY_FL_TAINT))):0))) {
     rb_raise(rb_eSecurityError, "loading from unsafe file %s", f);
 }
 f = (!(((struct RBasic*)(fname))->flags & RSTRING_NOEMBED) ? ((struct RString*)(fname))->as.ary : ((struct RString*)(fname))->as.heap.ptr);
 *filep = fname;
 expanded = 1;
    }

    if (expanded || rb_is_absolute_path(f) || is_explicit_relative(f)) {
 if (safe_level >= 1 && !path_check_0((fname), FALSE)) {
     rb_raise(rb_eSecurityError, "loading from unsafe path %s", f);
 }
 if (!expanded) fname = file_expand_path_1(fname);
 fnlen = (!(((struct RBasic*)(fname))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(fname))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(fname))->as.heap.len);
 for (i=0; ext[i]; i++) {
      ({ (__builtin_constant_p(ext[i])) ? rb_str_cat((fname), (ext[i]), (long)strlen(ext[i])) : rb_str_cat_cstr((fname), (ext[i])); });
     if (rb_file_load_ok((!(((struct RBasic*)(fname))->flags & RSTRING_NOEMBED) ? ((struct RString*)(fname))->as.ary : ((struct RString*)(fname))->as.heap.ptr))) {
 ...
 return 0;
    ...
    (* ({ volatile VALUE *rb_gc_guarded_ptr = &(load_path); ; rb_gc_guarded_ptr; })) = rb_get_expanded_load_path();
    if (!load_path) return 0;

    fname = rb_str_dup(*filep);
    memset(&(((struct RBasicRaw *)((VALUE)(fname)))->klass), 0, sizeof(VALUE));
    fnlen = (!(((struct RBasic*)(fname))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(fname))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(fname))->as.heap.len);
    tmp = rb_str_tmp_new(4096 + 2);
    rb_enc_associate_index(tmp, RUBY_ENCINDEX_US_ASCII);
    for (j=0; ext[j]; j++) {
  ({ (__builtin_constant_p(ext[j])) ? rb_str_cat((fname), (ext[j]), (long)strlen(ext[j])) : rb_str_cat_cstr((fname), (ext[j])); });
 for (i = 0; i < rb_array_len(load_path); i++) {
     VALUE str = (rb_array_const_ptr(load_path)[i]);

     (* ({ volatile VALUE *rb_gc_guarded_ptr = &(str); ; rb_gc_guarded_ptr; })) = rb_get_path_check(str, safe_level);
     if ((!(((struct RBasic*)(str))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(str))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(str))->as.heap.len) == 0) continue;
     rb_file_expand_path_internal(fname, str, 0, 0, tmp);
     if (rb_file_load_ok((!(((struct RBasic*)(tmp))->flags & RSTRING_NOEMBED) ? ((struct RString*)(tmp))->as.ary : ((struct RString*)(tmp))->as.heap.ptr))) {
  *filep = copy_path_class(tmp, *filep);
  return (int)(j+1);
     }
     ((!(((VALUE)(tmp) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(tmp) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(tmp))->flags & RUBY_T_MASK) != RUBY_T_NODE) ? (void)(((struct RBasic*)(tmp))->flags &= ~(VALUE)(((VALUE)RUBY_FL_TAINT))) : (void)0);
 }
 rb_str_set_len(fname, fnlen);
    }
    rb_str_resize(tmp, 0);
    (* ({ volatile VALUE *rb_gc_guarded_ptr = &(load_path); ; rb_gc_guarded_ptr; }));
    return 0;
}
...
{
    VALUE tmp, load_path;
    const char *f = rb_string_value_cstr(&(path));
    int expanded = 0;

    if (f[0] == '~') {
 tmp = file_expand_path_1(path);
 if (safe_level >= 1 && (!!((!(((VALUE)((tmp)) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)((tmp)) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)((tmp)))->flags & RUBY_T_MASK) != RUBY_T_NODE)?(((struct RBasic*)(((tmp))))->flags&((RUBY_FL_TAINT))):0))) {
     rb_raise(rb_eSecurityError, "loading from unsafe file %li\v", tmp);
 }
 path = copy_path_class(tmp, path);
 f = (!(((struct RBasic*)(path))->flags & RSTRING_NOEMBED) ? ((struct RString*)(path))->as.ary : ((struct RString*)(path))->as.heap.ptr);
 expanded = 1;
    }

    if (expanded || rb_is_absolute_path(f) || is_explicit_relative(f)) {
 if (safe_level >= 1 && !path_check_0((path), FALSE)) {
     rb_raise(rb_eSecurityError, "loading from unsafe path %li\v", path);
 }
 ...
 for (i = 0; i < rb_array_len(load_path); i++) {
  ...
  f = (!(((struct RBasic*)(tmp))->flags & RSTRING_NOEMBED) ? ((struct RString*)(tmp))->as.ary : ((struct RString*)(tmp))->as.heap.ptr);
 ...
 return 0;
  ...
  found:
    if (safe_level >= 1 && !path_check_0((tmp), FALSE)) {
 rb_raise(rb_eSecurityError, "loading from unsafe file %li\v", tmp);
    }
...
Init_File(void)
{
    ...
    rb_define_singleton_method(rb_cFile, "birthtime", rb_f_notimplement, 1);

    rb_define_singleton_method(rb_cFile, "utime", rb_file_s_utime, -1);
    rb_define_singleton_method(rb_cFile, "chmod", rb_file_s_chmod, -1);
    rb_define_singleton_method(rb_cFile, "chown", rb_file_s_chown, -1);
    rb_define_singleton_method(rb_cFile, "lchmod", rb_f_notimplement, -1);
    ...
    separator =  ({ (__builtin_constant_p("/")) ? rb_fstring_new(("/"), (long)strlen("/")) : rb_fstring_cstr("/"); });
    ...
    rb_define_const(rb_cFile, "ALT_SEPARATOR", ((VALUE)RUBY_Qnil));


    rb_define_const(rb_cFile, "PATH_SEPARATOR",  ({ (__builtin_constant_p(":")) ? rb_fstring_new((":"), (long)strlen(":")) : rb_fstring_cstr(":"); }));
    ...
    rb_define_method(rb_cFile, "birthtime", rb_f_notimplement, 0);
    ...
    rb_define_const(rb_mFConst, "RDONLY", (((VALUE)(00))<<1 | RUBY_FIXNUM_FLAG));

    rb_define_const(rb_mFConst, "WRONLY", (((VALUE)(01))<<1 | RUBY_FIXNUM_FLAG));

    rb_define_const(rb_mFConst, "RDWR", (((VALUE)(02))<<1 | RUBY_FIXNUM_FLAG));

    rb_define_const(rb_mFConst, "APPEND", (((VALUE)(02000))<<1 | RUBY_FIXNUM_FLAG));

    rb_define_const(rb_mFConst, "CREAT", (((VALUE)(0100))<<1 | RUBY_FIXNUM_FLAG));

    rb_define_const(rb_mFConst, "EXCL", (((VALUE)(0200))<<1 | RUBY_FIXNUM_FLAG));





    rb_define_const(rb_mFConst, "NONBLOCK", (((VALUE)(04000))<<1 | RUBY_FIXNUM_FLAG));


    rb_define_const(rb_mFConst, "TRUNC", (((VALUE)(01000))<<1 | RUBY_FIXNUM_FLAG));


    rb_define_const(rb_mFConst, "NOCTTY", (((VALUE)(0400))<<1 | RUBY_FIXNUM_FLAG));





    rb_define_const(rb_mFConst, "BINARY", (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG));




    rb_define_const(rb_mFConst, "SHARE_DELETE", (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG));


    rb_define_const(rb_mFConst, "SYNC", (((VALUE)(04010000))<<1 | RUBY_FIXNUM_FLAG));



    rb_define_const(rb_mFConst, "DSYNC", (((VALUE)(010000))<<1 | RUBY_FIXNUM_FLAG));



    rb_define_const(rb_mFConst, "RSYNC", (((VALUE)(04010000))<<1 | RUBY_FIXNUM_FLAG));



    rb_define_const(rb_mFConst, "NOFOLLOW", (((VALUE)(0400000))<<1 | RUBY_FIXNUM_FLAG));



    rb_define_const(rb_mFConst, "NOATIME", (((VALUE)(01000000))<<1 | RUBY_FIXNUM_FLAG));



    rb_define_const(rb_mFConst, "DIRECT", (((VALUE)(040000))<<1 | RUBY_FIXNUM_FLAG));



    rb_define_const(rb_mFConst, "TMPFILE", (((VALUE)((020000000 | 0200000)))<<1 | RUBY_FIXNUM_FLAG));



    rb_define_const(rb_mFConst, "LOCK_SH", (((VALUE)(1))<<1 | RUBY_FIXNUM_FLAG));

    rb_define_const(rb_mFConst, "LOCK_EX", (((VALUE)(2))<<1 | RUBY_FIXNUM_FLAG));

    rb_define_const(rb_mFConst, "LOCK_UN", (((VALUE)(8))<<1 | RUBY_FIXNUM_FLAG));

    rb_define_const(rb_mFConst, "LOCK_NB", (((VALUE)(4))<<1 | RUBY_FIXNUM_FLAG));


    rb_define_const(rb_mFConst, "NULL",  ({ (__builtin_constant_p(null_device)) ? rb_fstring_new((null_device), (long)strlen(null_device)) : rb_fstring_cstr(null_device); }));
    ...
    rb_define_method(rb_cStat, "birthtime", rb_f_notimplement, 0);
