...
void Init_class_id_under_autoload_spec(void) {
  rb_define_class_id_under(rb_cObject, (__builtin_constant_p("ClassIdUnderAutoload") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("ClassIdUnderAutoload")), (long)strlen(("ClassIdUnderAutoload"))); (ID) rb_intern_id_cache; }) : rb_intern("ClassIdUnderAutoload")), rb_cObject);
}
