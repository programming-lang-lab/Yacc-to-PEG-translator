...
VALUE sdaf_alloc_typed_func(VALUE klass) {
    ...
    bar->foo = 42;
    return rb_data_typed_object_wrap((klass),(bar),(&sample_typed_wrapped_struct_data_type));
}

VALUE sdaf_typed_get_struct(VALUE self) {
    struct sample_typed_wrapped_struct* bar;
    ((bar) = (struct sample_typed_wrapped_struct*)rb_check_typeddata((self), (&sample_typed_wrapped_struct_data_type)));

    return (((VALUE)((*bar).foo))<<1 | RUBY_FIXNUM_FLAG);
}

VALUE sws_typed_wrap_struct(VALUE self, VALUE val) {
    struct sample_typed_wrapped_struct* bar = (struct sample_typed_wrapped_struct *)malloc(sizeof(struct sample_typed_wrapped_struct));
    bar->foo = ((int)rb_fix2int((VALUE)(val)));
    return rb_data_typed_object_wrap((rb_cObject),(bar),(&sample_typed_wrapped_struct_data_type));
}

VALUE sws_typed_wrap_struct_null(VALUE self, VALUE val) {
    struct sample_typed_wrapped_struct* bar = (struct sample_typed_wrapped_struct *)malloc(sizeof(struct sample_typed_wrapped_struct));
    bar->foo = ((int)rb_fix2int((VALUE)(val)));
    return rb_data_typed_object_wrap((0),(bar),(&sample_typed_wrapped_struct_data_type));
}

VALUE sws_typed_get_struct(VALUE self, VALUE obj) {
    struct sample_typed_wrapped_struct* bar;
    ((bar) = (struct sample_typed_wrapped_struct*)rb_check_typeddata((obj), (&sample_typed_wrapped_struct_data_type)));
...
VALUE sws_typed_get_struct_different_type(VALUE self, VALUE obj) {
    ...
    ((bar) = (struct sample_typed_wrapped_struct_other*)rb_check_typeddata((obj), (&sample_typed_wrapped_struct_other_data_type)));
...
VALUE sws_typed_get_struct_parent_type(VALUE self, VALUE obj) {
    ...
    ((bar) = (struct sample_typed_wrapped_struct_parent*)rb_check_typeddata((obj), (&sample_typed_wrapped_struct_parent_data_type)));
...
VALUE sws_typed_get_struct_rdata(VALUE self, VALUE obj) {
  struct sample_typed_wrapped_struct* bar;
  bar = (struct sample_typed_wrapped_struct*) ((struct RTypedData*)(obj))->data;
  return (((VALUE)(bar->foo))<<1 | RUBY_FIXNUM_FLAG);
}

VALUE sws_typed_get_struct_data_ptr(VALUE self, VALUE obj) {
  struct sample_typed_wrapped_struct* bar;
  bar = (struct sample_typed_wrapped_struct*) (((struct RData*)(obj))->data);
  return (((VALUE)(bar->foo))<<1 | RUBY_FIXNUM_FLAG);
}
...
VALUE sws_typed_change_struct(VALUE self, VALUE obj, VALUE new_val) {
  ...
  new_struct->foo = ((int)rb_fix2int((VALUE)(new_val)));
  old_struct = ((struct RTypedData*)(obj))->data;
  free(old_struct);
  ((struct RTypedData*)(obj))->data = new_struct;
