...
static VALUE class_spec_define_call_super_method(VALUE self, VALUE obj, VALUE str_name) {
  rb_define_method(obj, (!(((struct RBasic*)(str_name))->flags & RSTRING_NOEMBED) ? ((struct RString*)(str_name))->as.ary : ((struct RString*)(str_name))->as.heap.ptr), class_spec_call_super_method, 0);
...
static VALUE class_spec_rb_class2name(VALUE self, VALUE klass) {
  return  ({ (__builtin_constant_p(rb_class2name(klass))) ? rb_str_new_static((rb_class2name(klass)), (long)strlen(rb_class2name(klass))) : rb_str_new_cstr(rb_class2name(klass)); });
}



static VALUE class_spec_rb_path2class(VALUE self, VALUE path) {
  return rb_path2class((!(((struct RBasic*)(path))->flags & RSTRING_NOEMBED) ? ((struct RString*)(path))->as.ary : ((struct RString*)(path))->as.heap.ptr));
}
...
static VALUE class_spec_rb_class_real(VALUE self, VALUE object) {
  if( (__builtin_constant_p(RUBY_T_FIXNUM) ? ( (((RUBY_T_FIXNUM)) == RUBY_T_FIXNUM) ? (((int)(long)((object)))&RUBY_FIXNUM_FLAG) : (((RUBY_T_FIXNUM)) == RUBY_T_TRUE) ? (((object)) == ((VALUE)RUBY_Qtrue)) : (((RUBY_T_FIXNUM)) == RUBY_T_FALSE) ? (((object)) == ((VALUE)RUBY_Qfalse)) : (((RUBY_T_FIXNUM)) == RUBY_T_NIL) ? (((object)) == ((VALUE)RUBY_Qnil)) : (((RUBY_T_FIXNUM)) == RUBY_T_UNDEF) ? (((object)) == ((VALUE)RUBY_Qundef)) : (((RUBY_T_FIXNUM)) == RUBY_T_SYMBOL) ? ((((VALUE)((object))&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)((object)) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)((object)) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)((object)))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : (((RUBY_T_FIXNUM)) == RUBY_T_FLOAT) ? ( ((((int)(long)((object)))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)((object)) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)((object)) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)((object)))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)((object)) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)((object)) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)((object)))->flags & RUBY_T_MASK) == ((RUBY_T_FIXNUM)))) : rb_type(object) == (RUBY_T_FIXNUM))) {
    return (((VALUE)(rb_class_real(((int)rb_fix2int((VALUE)(object))))))<<1 | RUBY_FIXNUM_FLAG);
  } else {
    return rb_class_real(rb_class_of((VALUE)(object)));
  }
}
...
static VALUE class_spec_cvar_defined(VALUE self, VALUE klass, VALUE id) {
  ID as_id = (__builtin_constant_p(rb_string_value_ptr(&(id))) ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2(((rb_string_value_ptr(&(id)))), (long)strlen((rb_string_value_ptr(&(id))))); (ID) rb_intern_id_cache; }) : rb_intern(rb_string_value_ptr(&(id))));
...
static VALUE class_spec_cvar_get(VALUE self, VALUE klass, VALUE name) {
  return rb_cvar_get(klass, (__builtin_constant_p(rb_string_value_ptr(&(name))) ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2(((rb_string_value_ptr(&(name)))), (long)strlen((rb_string_value_ptr(&(name))))); (ID) rb_intern_id_cache; }) : rb_intern(rb_string_value_ptr(&(name)))));
}



static VALUE class_spec_cvar_set(VALUE self, VALUE klass, VALUE name, VALUE val) {
  rb_cvar_set(klass, (__builtin_constant_p(rb_string_value_ptr(&(name))) ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2(((rb_string_value_ptr(&(name)))), (long)strlen((rb_string_value_ptr(&(name))))); (ID) rb_intern_id_cache; }) : rb_intern(rb_string_value_ptr(&(name)))), val);
  return ((VALUE)RUBY_Qnil);
}
...
static VALUE class_spec_cv_get(VALUE self, VALUE klass, VALUE name) {
  return rb_cv_get(klass, rb_string_value_ptr(&(name)));
}



static VALUE class_spec_cv_set(VALUE self, VALUE klass, VALUE name, VALUE val) {
  rb_cv_set(klass, rb_string_value_ptr(&(name)), val);
...
VALUE class_spec_define_attr(VALUE self, VALUE klass, VALUE sym, VALUE read, VALUE write) {
  ...
  int_read = read == ((VALUE)RUBY_Qtrue) ? 1 : 0;
  int_write = write == ((VALUE)RUBY_Qtrue) ? 1 : 0;
  rb_define_attr(klass, rb_id2name((rb_sym2id(sym))), int_read, int_write);
  return ((VALUE)RUBY_Qnil);
}
...
static VALUE class_spec_rb_define_class(VALUE self, VALUE name, VALUE super) {
  if(!((VALUE)(super) != ((VALUE)RUBY_Qnil))) super = 0;
  return rb_define_class((!(((struct RBasic*)(name))->flags & RSTRING_NOEMBED) ? ((struct RString*)(name))->as.ary : ((struct RString*)(name))->as.heap.ptr), super);
}
...
static VALUE class_spec_rb_define_class_under(VALUE self, VALUE outer,
  ...
  if(!((VALUE)(super) != ((VALUE)RUBY_Qnil))) super = 0;
  return rb_define_class_under(outer, (!(((struct RBasic*)(name))->flags & RSTRING_NOEMBED) ? ((struct RString*)(name))->as.ary : ((struct RString*)(name))->as.heap.ptr), super);
}
...
static VALUE class_spec_rb_define_class_id_under(VALUE self, VALUE outer,
                                                 VALUE name, VALUE super) {
  if(!((VALUE)(super) != ((VALUE)RUBY_Qnil))) super = 0;
  return rb_define_class_id_under(outer, (rb_sym2id(name)), super);
}



static VALUE class_spec_define_class_variable(VALUE self, VALUE klass, VALUE name, VALUE val) {
  rb_define_class_variable(klass, rb_string_value_ptr(&(name)), val);
  return ((VALUE)RUBY_Qnil);
}
