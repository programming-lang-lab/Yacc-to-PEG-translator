...
VALUE kernel_spec_call_proc(VALUE arg_array) {
  ...
  return rb_funcall(proc, (__builtin_constant_p("call") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("call")), (long)strlen(("call"))); (ID) rb_intern_id_cache; }) : rb_intern("call")), 1, arg);
}


static VALUE kernel_spec_rb_block_given_p(VALUE self) {
  return rb_block_given_p() ? ((VALUE)RUBY_Qtrue) : ((VALUE)RUBY_Qfalse);
}
...
VALUE block_call_inject(VALUE yield_value, VALUE data2) {
  ...
  VALUE elem_incr = (((VALUE)(((int)rb_fix2int((VALUE)(elem))) + 1))<<1 | RUBY_FIXNUM_FLAG);
  return elem_incr;
}

VALUE kernel_spec_rb_block_call(VALUE self, VALUE ary) {
  return rb_block_call(ary, (__builtin_constant_p("map") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("map")), (long)strlen(("map"))); (ID) rb_intern_id_cache; }) : rb_intern("map")), 0, ((void*)0), block_call_inject, ((VALUE)RUBY_Qnil));
}
...
VALUE block_call_inject_multi_arg(VALUE yield_value, VALUE data2, int argc, VALUE argv[]) {
  ...
  return (((VALUE)(((int)rb_fix2int((VALUE)(sum))) + ((int)rb_fix2int((VALUE)(elem)))))<<1 | RUBY_FIXNUM_FLAG);
}

VALUE kernel_spec_rb_block_call_multi_arg(VALUE self, VALUE ary) {
  VALUE method_args[1];
  method_args[0] = (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG);
  return rb_block_call(ary, (__builtin_constant_p("inject") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("inject")), (long)strlen(("inject"))); (ID) rb_intern_id_cache; }) : rb_intern("inject")), 1, method_args, block_call_inject_multi_arg, ((VALUE)RUBY_Qnil));
}

VALUE kernel_spec_rb_block_call_no_func(VALUE self, VALUE ary) {
  return rb_block_call(ary, (__builtin_constant_p("map") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("map")), (long)strlen(("map"))); (ID) rb_intern_id_cache; }) : rb_intern("map")), 0, ((void*)0), ((void*)0), ((VALUE)RUBY_Qnil));
}
...
VALUE kernel_spec_call_proc_with_catch(VALUE arg, VALUE data) {
  return rb_funcall(data, (__builtin_constant_p("call") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("call")), (long)strlen(("call"))); (ID) rb_intern_id_cache; }) : rb_intern("call")), 0);
}

VALUE kernel_spec_rb_catch(VALUE self, VALUE sym, VALUE main_proc) {
  return rb_catch(rb_string_value_ptr(&(sym)), kernel_spec_call_proc_with_catch, main_proc);
}
...
VALUE kernel_spec_rb_eval_string(VALUE self, VALUE str) {
  return rb_eval_string((!(((struct RBasic*)(str))->flags & RSTRING_NOEMBED) ? ((struct RString*)(str))->as.ary : ((struct RString*)(str))->as.heap.ptr));
}



VALUE kernel_spec_rb_raise(VALUE self, VALUE hash) {
  rb_hash_aset(hash, (rb_id2sym((__builtin_constant_p("stage") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("stage")), (long)strlen(("stage"))); (ID) rb_intern_id_cache; }) : rb_intern("stage")))), (rb_id2sym((__builtin_constant_p("before") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("before")), (long)strlen(("before"))); (ID) rb_intern_id_cache; }) : rb_intern("before")))));
  if (self != ((VALUE)RUBY_Qundef))
    rb_raise(rb_eTypeError, "Wrong argument type %s (expected %s)", "Integer", "String");
  rb_hash_aset(hash, (rb_id2sym((__builtin_constant_p("stage") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("stage")), (long)strlen(("stage"))); (ID) rb_intern_id_cache; }) : rb_intern("stage")))), (rb_id2sym((__builtin_constant_p("after") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("after")), (long)strlen(("after"))); (ID) rb_intern_id_cache; }) : rb_intern("after")))));
  return ((VALUE)RUBY_Qnil);
}
...
VALUE kernel_spec_rb_throw(VALUE self, VALUE result) {
  if (self != ((VALUE)RUBY_Qundef)) rb_throw("foo", result);
  return (rb_id2sym((__builtin_constant_p("rb_throw_failed") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("rb_throw_failed")), (long)strlen(("rb_throw_failed"))); (ID) rb_intern_id_cache; }) : rb_intern("rb_throw_failed"))));
}



VALUE kernel_spec_rb_throw_obj(VALUE self, VALUE obj, VALUE result) {
  if (self != ((VALUE)RUBY_Qundef)) rb_throw_obj(obj, result);
  return (rb_id2sym((__builtin_constant_p("rb_throw_failed") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("rb_throw_failed")), (long)strlen(("rb_throw_failed"))); (ID) rb_intern_id_cache; }) : rb_intern("rb_throw_failed"))));
}
...
VALUE kernel_spec_call_proc_with_raised_exc(VALUE arg_array, VALUE raised_exc) {
  ...
  return rb_funcallv(proc, (__builtin_constant_p("call") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("call")), (long)strlen(("call"))); (ID) rb_intern_id_cache; }) : rb_intern("call")), argc, argv);
}
...
static VALUE kernel_spec_rb_protect_yield(VALUE self, VALUE obj, VALUE ary) {
  ...
  rb_ary_store(ary, 0, (((VALUE)((int)(23)))<<1 | RUBY_FIXNUM_FLAG));
  if (status) {
    rb_jump_tag(status);
  }
  return res;
...
VALUE kernel_spec_rb_sys_fail(VALUE self, VALUE msg) {
  (*__errno_location ()) = 1;
  if(msg == ((VALUE)RUBY_Qnil)) {
    rb_sys_fail(0);
  } else if (self != ((VALUE)RUBY_Qundef)) {
    rb_sys_fail(rb_string_value_ptr(&(msg)));
  }
  return ((VALUE)RUBY_Qnil);
}
...
VALUE kernel_spec_rb_syserr_fail(VALUE self, VALUE err, VALUE msg) {
  if(msg == ((VALUE)RUBY_Qnil)) {
    rb_syserr_fail(rb_num2int_inline(err), ((void*)0));
  } else if (self != ((VALUE)RUBY_Qundef)) {
    rb_syserr_fail(rb_num2int_inline(err), rb_string_value_ptr(&(msg)));
  }
  return ((VALUE)RUBY_Qnil);
}
...
VALUE kernel_spec_rb_warn(VALUE self, VALUE msg) {
  rb_warn("%s", rb_string_value_ptr(&(msg)));
  return ((VALUE)RUBY_Qnil);
}
...
static VALUE kernel_spec_rb_yield_each(int argc, VALUE *args, VALUE self) {
  ...
  return (((VALUE)(4))<<1 | RUBY_FIXNUM_FLAG);
}
...
static VALUE do_rec(VALUE obj, VALUE arg, int is_rec) {
  if(is_rec) {
    ...
    return rb_exec_recursive(do_rec, obj, ((VALUE)RUBY_Qnil));
  } else {
    return ((VALUE)RUBY_Qnil);
  }
}
...
static VALUE kernel_spec_rb_exec_recursive(VALUE self, VALUE obj) {
  return rb_exec_recursive(do_rec, obj, ((VALUE)RUBY_Qtrue));
}



static void write_io(VALUE io) {
  rb_funcall(io, (__builtin_constant_p("write") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("write")), (long)strlen(("write"))); (ID) rb_intern_id_cache; }) : rb_intern("write")), 1,  ({ (__builtin_constant_p("e")) ? rb_str_new_static(("e"), (long)strlen("e")) : rb_str_new_cstr("e"); }));
}
...
static VALUE kernel_spec_rb_f_sprintf(VALUE self, VALUE ary) {
  return rb_f_sprintf((int)rb_array_len(ary), ((VALUE *)rb_array_const_ptr(( __builtin_choose_expr( 1, rb_obj_wb_unprotect((VALUE)(ary), "spec/ruby/optional/capi/ext/kernel_spec.c", 303), ((VALUE)(ary)))))));
}
...
static VALUE kernel_spec_rb_funcall3(VALUE self, VALUE obj, VALUE method) {
  return rb_funcallv_public(obj, (rb_sym2id(method)), 0, ((void*)0));
}



static VALUE kernel_spec_rb_funcall_with_block(VALUE self, VALUE obj, VALUE method, VALUE block) {
  return rb_funcall_with_block(obj, (rb_sym2id(method)), 0, ((void*)0), block);
}
