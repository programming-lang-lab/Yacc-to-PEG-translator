...
static VALUE module_specs_test_method(VALUE self) {
  return (rb_id2sym((__builtin_constant_p("test_method") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("test_method")), (long)strlen(("test_method"))); (ID) rb_intern_id_cache; }) : rb_intern("test_method"))));
}


static VALUE module_specs_const_defined(VALUE self, VALUE klass, VALUE id) {
  return rb_const_defined(klass, (rb_sym2id(id))) ? ((VALUE)RUBY_Qtrue) : ((VALUE)RUBY_Qfalse);
}



static VALUE module_specs_const_defined_at(VALUE self, VALUE klass, VALUE id) {
  return rb_const_defined_at(klass, (rb_sym2id(id))) ? ((VALUE)RUBY_Qtrue) : ((VALUE)RUBY_Qfalse);
}



static VALUE module_specs_const_get(VALUE self, VALUE klass, VALUE val) {
  return rb_const_get(klass, (rb_sym2id(val)));
}



static VALUE module_specs_const_get_at(VALUE self, VALUE klass, VALUE val) {
  return rb_const_get_at(klass, (rb_sym2id(val)));
}



static VALUE module_specs_const_get_from(VALUE self, VALUE klass, VALUE val) {
  return rb_const_get_from(klass, (rb_sym2id(val)));
}



static VALUE module_specs_const_set(VALUE self, VALUE klass, VALUE name, VALUE val) {
  rb_const_set(klass, (rb_sym2id(name)), val);
...
static VALUE module_specs_rb_define_alias(VALUE self, VALUE obj,
  ...
  rb_define_alias(obj, (!(((struct RBasic*)(new_name))->flags & RSTRING_NOEMBED) ? ((struct RString*)(new_name))->as.ary : ((struct RString*)(new_name))->as.heap.ptr), (!(((struct RBasic*)(old_name))->flags & RSTRING_NOEMBED) ? ((struct RString*)(old_name))->as.ary : ((struct RString*)(old_name))->as.heap.ptr));
  return ((VALUE)RUBY_Qnil);
}
...
static VALUE module_specs_rb_alias(VALUE self, VALUE obj,
  ...
  rb_alias(obj, (rb_sym2id(new_name)), (rb_sym2id(old_name)));
  return ((VALUE)RUBY_Qnil);
}
...
static VALUE module_specs_rb_define_module(VALUE self, VALUE name) {
  return rb_define_module((!(((struct RBasic*)(name))->flags & RSTRING_NOEMBED) ? ((struct RString*)(name))->as.ary : ((struct RString*)(name))->as.heap.ptr));
}



static VALUE module_specs_rb_define_module_under(VALUE self, VALUE outer, VALUE name) {
  return rb_define_module_under(outer, (!(((struct RBasic*)(name))->flags & RSTRING_NOEMBED) ? ((struct RString*)(name))->as.ary : ((struct RString*)(name))->as.heap.ptr));
}



static VALUE module_specs_define_const(VALUE self, VALUE klass, VALUE str_name, VALUE val) {
  rb_define_const(klass, (!(((struct RBasic*)(str_name))->flags & RSTRING_NOEMBED) ? ((struct RString*)(str_name))->as.ary : ((struct RString*)(str_name))->as.heap.ptr), val);
  return ((VALUE)RUBY_Qnil);
}
...
static VALUE module_specs_define_global_const(VALUE self, VALUE str_name, VALUE obj) {
  rb_define_global_const((!(((struct RBasic*)(str_name))->flags & RSTRING_NOEMBED) ? ((struct RString*)(str_name))->as.ary : ((struct RString*)(str_name))->as.heap.ptr), obj);
  return ((VALUE)RUBY_Qnil);
}
...
static VALUE module_specs_rb_define_global_function(VALUE self, VALUE str_name) {
  rb_define_global_function((!(((struct RBasic*)(str_name))->flags & RSTRING_NOEMBED) ? ((struct RString*)(str_name))->as.ary : ((struct RString*)(str_name))->as.heap.ptr), module_specs_test_method, 0);
  return ((VALUE)RUBY_Qnil);
}
...
static VALUE module_specs_rb_define_method(VALUE self, VALUE cls, VALUE str_name) {
  rb_define_method(cls, (!(((struct RBasic*)(str_name))->flags & RSTRING_NOEMBED) ? ((struct RString*)(str_name))->as.ary : ((struct RString*)(str_name))->as.heap.ptr), module_specs_test_method, 0);
  return ((VALUE)RUBY_Qnil);
}
...
static VALUE module_specs_rb_define_module_function(VALUE self, VALUE cls, VALUE str_name) {
  rb_define_module_function(cls, (!(((struct RBasic*)(str_name))->flags & RSTRING_NOEMBED) ? ((struct RString*)(str_name))->as.ary : ((struct RString*)(str_name))->as.heap.ptr), module_specs_test_method, 0);
  return ((VALUE)RUBY_Qnil);
}
...
static VALUE module_specs_rb_define_private_method(VALUE self, VALUE cls, VALUE str_name) {
  rb_define_private_method(cls, (!(((struct RBasic*)(str_name))->flags & RSTRING_NOEMBED) ? ((struct RString*)(str_name))->as.ary : ((struct RString*)(str_name))->as.heap.ptr), module_specs_test_method, 0);
  return ((VALUE)RUBY_Qnil);
}
...
static VALUE module_specs_rb_define_protected_method(VALUE self, VALUE cls, VALUE str_name) {
  rb_define_protected_method(cls, (!(((struct RBasic*)(str_name))->flags & RSTRING_NOEMBED) ? ((struct RString*)(str_name))->as.ary : ((struct RString*)(str_name))->as.heap.ptr), module_specs_test_method, 0);
  return ((VALUE)RUBY_Qnil);
}
...
static VALUE module_specs_rb_define_singleton_method(VALUE self, VALUE cls, VALUE str_name) {
  rb_define_singleton_method(cls, (!(((struct RBasic*)(str_name))->flags & RSTRING_NOEMBED) ? ((struct RString*)(str_name))->as.ary : ((struct RString*)(str_name))->as.heap.ptr), module_specs_test_method, 0);
  return ((VALUE)RUBY_Qnil);
}
...
static VALUE module_specs_rb_undef_method(VALUE self, VALUE cls, VALUE str_name) {
  rb_undef_method(cls, (!(((struct RBasic*)(str_name))->flags & RSTRING_NOEMBED) ? ((struct RString*)(str_name))->as.ary : ((struct RString*)(str_name))->as.heap.ptr));
  return ((VALUE)RUBY_Qnil);
}
...
static VALUE module_specs_rb_undef(VALUE self, VALUE cls, VALUE symbol_name) {
  rb_undef(cls, (rb_sym2id(symbol_name)));
  return ((VALUE)RUBY_Qnil);
}
