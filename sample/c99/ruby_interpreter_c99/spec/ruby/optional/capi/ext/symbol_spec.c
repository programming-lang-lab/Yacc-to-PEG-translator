...
VALUE symbol_spec_rb_intern(VALUE self, VALUE string) {
  return (rb_id2sym((__builtin_constant_p((!(((struct RBasic*)(string))->flags & RSTRING_NOEMBED) ? ((struct RString*)(string))->as.ary : ((struct RString*)(string))->as.heap.ptr)) ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((((!(((struct RBasic*)(string))->flags & RSTRING_NOEMBED) ? ((struct RString*)(string))->as.ary : ((struct RString*)(string))->as.heap.ptr))), (long)strlen(((!(((struct RBasic*)(string))->flags & RSTRING_NOEMBED) ? ((struct RString*)(string))->as.ary : ((struct RString*)(string))->as.heap.ptr)))); (ID) rb_intern_id_cache; }) : rb_intern((!(((struct RBasic*)(string))->flags & RSTRING_NOEMBED) ? ((struct RString*)(string))->as.ary : ((struct RString*)(string))->as.heap.ptr)))));
}

VALUE symbol_spec_rb_intern2(VALUE self, VALUE string, VALUE len) {
  return (rb_id2sym(rb_intern2((!(((struct RBasic*)(string))->flags & RSTRING_NOEMBED) ? ((struct RString*)(string))->as.ary : ((struct RString*)(string))->as.heap.ptr), ((long)(((long)(len))>>(int)(1))))));
}

VALUE symbol_spec_rb_intern_const(VALUE self, VALUE string) {
  return (rb_id2sym((__builtin_constant_p((!(((struct RBasic*)(string))->flags & RSTRING_NOEMBED) ? ((struct RString*)(string))->as.ary : ((struct RString*)(string))->as.heap.ptr)) ?  (rb_intern2(((!(((struct RBasic*)(string))->flags & RSTRING_NOEMBED) ? ((struct RString*)(string))->as.ary : ((struct RString*)(string))->as.heap.ptr)), (long)strlen((!(((struct RBasic*)(string))->flags & RSTRING_NOEMBED) ? ((struct RString*)(string))->as.ary : ((struct RString*)(string))->as.heap.ptr)))) : (rb_intern)((!(((struct RBasic*)(string))->flags & RSTRING_NOEMBED) ? ((struct RString*)(string))->as.ary : ((struct RString*)(string))->as.heap.ptr)))));
}

VALUE symbol_spec_rb_intern_c_compare(VALUE self, VALUE string, VALUE sym) {
  ID symbol = (__builtin_constant_p((!(((struct RBasic*)(string))->flags & RSTRING_NOEMBED) ? ((struct RString*)(string))->as.ary : ((struct RString*)(string))->as.heap.ptr)) ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((((!(((struct RBasic*)(string))->flags & RSTRING_NOEMBED) ? ((struct RString*)(string))->as.ary : ((struct RString*)(string))->as.heap.ptr))), (long)strlen(((!(((struct RBasic*)(string))->flags & RSTRING_NOEMBED) ? ((struct RString*)(string))->as.ary : ((struct RString*)(string))->as.heap.ptr)))); (ID) rb_intern_id_cache; }) : rb_intern((!(((struct RBasic*)(string))->flags & RSTRING_NOEMBED) ? ((struct RString*)(string))->as.ary : ((struct RString*)(string))->as.heap.ptr)));
  return ((rb_sym2id(sym)) == symbol) ? ((VALUE)RUBY_Qtrue) : ((VALUE)RUBY_Qfalse);
}

VALUE symbol_spec_rb_intern2_c_compare(VALUE self, VALUE string, VALUE len, VALUE sym) {
  ID symbol = rb_intern2((!(((struct RBasic*)(string))->flags & RSTRING_NOEMBED) ? ((struct RString*)(string))->as.ary : ((struct RString*)(string))->as.heap.ptr), ((long)(((long)(len))>>(int)(1))));
  return ((rb_sym2id(sym)) == symbol) ? ((VALUE)RUBY_Qtrue) : ((VALUE)RUBY_Qfalse);
}
...
VALUE symbol_spec_rb_intern3(VALUE self, VALUE string, VALUE len, VALUE enc) {
  return (rb_id2sym(rb_intern3((!(((struct RBasic*)(string))->flags & RSTRING_NOEMBED) ? ((struct RString*)(string))->as.ary : ((struct RString*)(string))->as.heap.ptr), ((long)(((long)(len))>>(int)(1))), rb_enc_get(enc))));
}

VALUE symbol_spec_rb_intern3_c_compare(VALUE self, VALUE string, VALUE len, VALUE enc, VALUE sym) {
  ID symbol = rb_intern3((!(((struct RBasic*)(string))->flags & RSTRING_NOEMBED) ? ((struct RString*)(string))->as.ary : ((struct RString*)(string))->as.heap.ptr), ((long)(((long)(len))>>(int)(1))), rb_enc_get(enc));
  return ((rb_sym2id(sym)) == symbol) ? ((VALUE)RUBY_Qtrue) : ((VALUE)RUBY_Qfalse);
}
...
VALUE symbol_spec_rb_id2name(VALUE self, VALUE symbol) {
  const char* c_str = rb_id2name((rb_sym2id(symbol)));
  return  ({ (__builtin_constant_p(c_str) && __builtin_constant_p(strlen(c_str))) ? rb_str_new_static((c_str), (strlen(c_str))) : rb_str_new((c_str), (strlen(c_str))); });
}



VALUE symbol_spec_rb_id2str(VALUE self, VALUE symbol) {
  return rb_id2str((rb_sym2id(symbol)));
}
...
VALUE symbol_spec_rb_is_class_id(VALUE self, VALUE sym) {
  return rb_is_class_id((rb_sym2id(sym))) ? ((VALUE)RUBY_Qtrue) : ((VALUE)RUBY_Qfalse);
}



VALUE symbol_spec_rb_is_const_id(VALUE self, VALUE sym) {
  return rb_is_const_id((rb_sym2id(sym))) ? ((VALUE)RUBY_Qtrue) : ((VALUE)RUBY_Qfalse);
}



VALUE symbol_spec_rb_is_instance_id(VALUE self, VALUE sym) {
  return rb_is_instance_id((rb_sym2id(sym))) ? ((VALUE)RUBY_Qtrue) : ((VALUE)RUBY_Qfalse);
}
