...
void Init_module_under_autoload_spec(void) {
  VALUE specs = rb_const_get(rb_cObject, (__builtin_constant_p("CApiModuleSpecs") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("CApiModuleSpecs")), (long)strlen(("CApiModuleSpecs"))); (ID) rb_intern_id_cache; }) : rb_intern("CApiModuleSpecs")));
