...
VALUE range_spec_rb_range_new(int argc, VALUE* argv, VALUE self) {
  int exclude_end = 0;
  if(argc == 3) {
    exclude_end = !(((VALUE)(argv[2]) & (VALUE)~((VALUE)RUBY_Qnil)) == 0);
  }
...
VALUE range_spec_rb_range_values(VALUE self, VALUE range) {
  ...
  rb_ary_store(ary, 2, excl ? ((VALUE)RUBY_Qtrue) : ((VALUE)RUBY_Qfalse));
  return ary;
}
...
VALUE range_spec_rb_range_beg_len(VALUE self, VALUE range, VALUE begpv, VALUE lenpv, VALUE lenv, VALUE errv) {
  long begp = ((long)(((long)(begpv))>>(int)(1)));
  long lenp = ((long)(((long)(lenpv))>>(int)(1)));
  long len = ((long)(((long)(lenv))>>(int)(1)));
  int err = ((int)rb_fix2int((VALUE)(errv)));
  VALUE ary = rb_ary_new();
  VALUE res = rb_range_beg_len(range, &begp, &lenp, len, err);
  rb_ary_store(ary, 0, (((VALUE)(begp))<<1 | RUBY_FIXNUM_FLAG));
  rb_ary_store(ary, 1, (((VALUE)(lenp))<<1 | RUBY_FIXNUM_FLAG));
