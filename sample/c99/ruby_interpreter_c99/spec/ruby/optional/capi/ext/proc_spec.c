...
VALUE proc_spec_rb_proc_new_function(VALUE args) {
  return rb_funcall(args, (__builtin_constant_p("inspect") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("inspect")), (long)strlen(("inspect"))); (ID) rb_intern_id_cache; }) : rb_intern("inspect")), 0);
}

VALUE proc_spec_rb_proc_new(VALUE self) {
  return rb_proc_new(proc_spec_rb_proc_new_function, ((VALUE)RUBY_Qnil));
}



VALUE proc_spec_rb_proc_arity(VALUE self, VALUE prc) {
  return (((VALUE)(rb_proc_arity(prc)))<<1 | RUBY_FIXNUM_FLAG);
}
...
VALUE proc_spec_rb_Proc_new_helper(void) {
  return rb_funcall(rb_cProc, (__builtin_constant_p("new") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("new")), (long)strlen(("new"))); (ID) rb_intern_id_cache; }) : rb_intern("new")), 0);
}

VALUE proc_spec_rb_Proc_new(VALUE self, VALUE scenario) {
  switch(((int)rb_fix2int((VALUE)(scenario)))) {
    case 0:
      return proc_spec_rb_Proc_new_helper();
    case 1:
      rb_funcall(self, (__builtin_constant_p("call_nothing") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("call_nothing")), (long)strlen(("call_nothing"))); (ID) rb_intern_id_cache; }) : rb_intern("call_nothing")), 0);
      return proc_spec_rb_Proc_new_helper();
    case 2:
      return rb_funcall(self, (__builtin_constant_p("call_Proc_new") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("call_Proc_new")), (long)strlen(("call_Proc_new"))); (ID) rb_intern_id_cache; }) : rb_intern("call_Proc_new")), 0);
    case 3:
      return rb_funcall(self, (__builtin_constant_p("call_rb_Proc_new") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("call_rb_Proc_new")), (long)strlen(("call_rb_Proc_new"))); (ID) rb_intern_id_cache; }) : rb_intern("call_rb_Proc_new")), 0);
    case 4:
      return rb_funcall(self, (__builtin_constant_p("call_rb_Proc_new_with_block") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("call_rb_Proc_new_with_block")), (long)strlen(("call_rb_Proc_new_with_block"))); (ID) rb_intern_id_cache; }) : rb_intern("call_rb_Proc_new_with_block")), 0);
    case 5:
      rb_funcall(self, (__builtin_constant_p("call_rb_Proc_new_with_block") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("call_rb_Proc_new_with_block")), (long)strlen(("call_rb_Proc_new_with_block"))); (ID) rb_intern_id_cache; }) : rb_intern("call_rb_Proc_new_with_block")), 0);
      return proc_spec_rb_Proc_new_helper();
    case 6:
      return rb_funcall(self, (__builtin_constant_p("call_block_given?") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("call_block_given?")), (long)strlen(("call_block_given?"))); (ID) rb_intern_id_cache; }) : rb_intern("call_block_given?")), 0);
    default:
