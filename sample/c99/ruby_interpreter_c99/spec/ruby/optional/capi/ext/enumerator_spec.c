...
VALUE enumerator_spec_rb_enumeratorize(int argc, VALUE *argv, VALUE self) {
  ...
  return rb_enumeratorize(obj, meth, (int)rb_array_len(args), ((VALUE *)rb_array_const_ptr(( __builtin_choose_expr( 1, rb_obj_wb_unprotect((VALUE)(args), "spec/ruby/optional/capi/ext/enumerator_spec.c", 12), ((VALUE)(args)))))));
}
