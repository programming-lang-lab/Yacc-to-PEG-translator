...
static VALUE encoding_spec_rb_usascii_encoding(VALUE self) {
  return  ({ (__builtin_constant_p(rb_usascii_encoding()->name)) ? rb_str_new_static((rb_usascii_encoding()->name), (long)strlen(rb_usascii_encoding()->name)) : rb_str_new_cstr(rb_usascii_encoding()->name); });
}



static VALUE encoding_spec_rb_usascii_encindex(VALUE self) {
  return (((VALUE)((int)(rb_usascii_encindex())))<<1 | RUBY_FIXNUM_FLAG);
}



static VALUE encoding_spec_rb_ascii8bit_encoding(VALUE self) {
  return  ({ (__builtin_constant_p(rb_ascii8bit_encoding()->name)) ? rb_str_new_static((rb_ascii8bit_encoding()->name), (long)strlen(rb_ascii8bit_encoding()->name)) : rb_str_new_cstr(rb_ascii8bit_encoding()->name); });
}



static VALUE encoding_spec_rb_ascii8bit_encindex(VALUE self) {
  return (((VALUE)((int)(rb_ascii8bit_encindex())))<<1 | RUBY_FIXNUM_FLAG);
}



static VALUE encoding_spec_rb_utf8_encoding(VALUE self) {
  return  ({ (__builtin_constant_p(rb_utf8_encoding()->name)) ? rb_str_new_static((rb_utf8_encoding()->name), (long)strlen(rb_utf8_encoding()->name)) : rb_str_new_cstr(rb_utf8_encoding()->name); });
}



static VALUE encoding_spec_rb_utf8_encindex(VALUE self) {
  return (((VALUE)((int)(rb_utf8_encindex())))<<1 | RUBY_FIXNUM_FLAG);
}



static VALUE encoding_spec_rb_locale_encoding(VALUE self) {
  return  ({ (__builtin_constant_p(rb_locale_encoding()->name)) ? rb_str_new_static((rb_locale_encoding()->name), (long)strlen(rb_locale_encoding()->name)) : rb_str_new_cstr(rb_locale_encoding()->name); });
}



static VALUE encoding_spec_rb_locale_encindex(VALUE self) {
  return (((VALUE)((int)(rb_locale_encindex())))<<1 | RUBY_FIXNUM_FLAG);
}



static VALUE encoding_spec_rb_filesystem_encoding(VALUE self) {
  return  ({ (__builtin_constant_p(rb_filesystem_encoding()->name)) ? rb_str_new_static((rb_filesystem_encoding()->name), (long)strlen(rb_filesystem_encoding()->name)) : rb_str_new_cstr(rb_filesystem_encoding()->name); });
}



static VALUE encoding_spec_rb_filesystem_encindex(VALUE self) {
  return (((VALUE)((int)(rb_filesystem_encindex())))<<1 | RUBY_FIXNUM_FLAG);
}
...
static VALUE encoding_spec_rb_default_internal_encoding(VALUE self) {
  ...
  if(enc == 0) return ((VALUE)RUBY_Qnil);
  return  ({ (__builtin_constant_p(enc->name)) ? rb_str_new_static((enc->name), (long)strlen(enc->name)) : rb_str_new_cstr(enc->name); });
}
...
static VALUE encoding_spec_rb_encdb_alias(VALUE self, VALUE alias, VALUE orig) {
  return (((VALUE)((int)(rb_encdb_alias((!(((struct RBasic*)(alias))->flags & RSTRING_NOEMBED) ? ((struct RString*)(alias))->as.ary : ((struct RString*)(alias))->as.heap.ptr), (!(((struct RBasic*)(orig))->flags & RSTRING_NOEMBED) ? ((struct RString*)(orig))->as.ary : ((struct RString*)(orig))->as.heap.ptr)))))<<1 | RUBY_FIXNUM_FLAG);
}



static VALUE encoding_spec_rb_enc_associate(VALUE self, VALUE obj, VALUE enc) {
  return rb_enc_associate(obj, !((VALUE)(enc) != ((VALUE)RUBY_Qnil)) ? ((void*)0) : rb_enc_find((!(((struct RBasic*)(enc))->flags & RSTRING_NOEMBED) ? ((struct RString*)(enc))->as.ary : ((struct RString*)(enc))->as.heap.ptr)));
}



static VALUE encoding_spec_rb_enc_associate_index(VALUE self, VALUE obj, VALUE index) {
  return rb_enc_associate_index(obj, ((int)rb_fix2int((VALUE)(index))));
}
...
static VALUE encoding_spec_rb_enc_compatible(VALUE self, VALUE a, VALUE b) {
  ...
  if(!enc) return (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG);
...
static VALUE encoding_spec_rb_enc_find(VALUE self, VALUE name) {
  return  ({ (__builtin_constant_p(rb_enc_find((!(((struct RBasic*)(name))->flags & RSTRING_NOEMBED) ? ((struct RString*)(name))->as.ary : ((struct RString*)(name))->as.heap.ptr))->name)) ? rb_str_new_static((rb_enc_find((!(((struct RBasic*)(name))->flags & RSTRING_NOEMBED) ? ((struct RString*)(name))->as.ary : ((struct RString*)(name))->as.heap.ptr))->name), (long)strlen(rb_enc_find((!(((struct RBasic*)(name))->flags & RSTRING_NOEMBED) ? ((struct RString*)(name))->as.ary : ((struct RString*)(name))->as.heap.ptr))->name)) : rb_str_new_cstr(rb_enc_find((!(((struct RBasic*)(name))->flags & RSTRING_NOEMBED) ? ((struct RString*)(name))->as.ary : ((struct RString*)(name))->as.heap.ptr))->name); });
}



static VALUE encoding_spec_rb_enc_find_index(VALUE self, VALUE name) {
  return (((VALUE)((int)(rb_enc_find_index((!(((struct RBasic*)(name))->flags & RSTRING_NOEMBED) ? ((struct RString*)(name))->as.ary : ((struct RString*)(name))->as.heap.ptr)))))<<1 | RUBY_FIXNUM_FLAG);
}



static VALUE encoding_spec_rb_enc_from_index(VALUE self, VALUE index) {
  return  ({ (__builtin_constant_p(rb_enc_from_index(rb_num2int_inline(index))->name)) ? rb_str_new_static((rb_enc_from_index(rb_num2int_inline(index))->name), (long)strlen(rb_enc_from_index(rb_num2int_inline(index))->name)) : rb_str_new_cstr(rb_enc_from_index(rb_num2int_inline(index))->name); });
}



static VALUE encoding_spec_rb_enc_from_encoding(VALUE self, VALUE name) {
  return rb_enc_from_encoding(rb_enc_find((!(((struct RBasic*)(name))->flags & RSTRING_NOEMBED) ? ((struct RString*)(name))->as.ary : ((struct RString*)(name))->as.heap.ptr)));
}



static VALUE encoding_spec_rb_enc_get(VALUE self, VALUE obj) {
  return  ({ (__builtin_constant_p(rb_enc_get(obj)->name)) ? rb_str_new_static((rb_enc_get(obj)->name), (long)strlen(rb_enc_get(obj)->name)) : rb_str_new_cstr(rb_enc_get(obj)->name); });
}
...
static VALUE encoding_spec_rb_enc_get_index(VALUE self, VALUE obj) {
  return (((VALUE)((int)(rb_enc_get_index(obj))))<<1 | RUBY_FIXNUM_FLAG);
}
...
static VALUE encoding_spec_rb_enc_set_index(VALUE self, VALUE obj, VALUE index) {
  int i = rb_num2int_inline(index);

  rb_encoding* enc = rb_enc_from_index(i);
  rb_enc_set_index(obj, i);

  return rb_ary_new_from_args(2,  ({ (__builtin_constant_p((enc)->name)) ? rb_str_new_static(((enc)->name), (long)strlen((enc)->name)) : rb_str_new_cstr((enc)->name); }),
                      ({ (__builtin_constant_p((rb_enc_get(obj))->name)) ? rb_str_new_static(((rb_enc_get(obj))->name), (long)strlen((rb_enc_get(obj))->name)) : rb_str_new_cstr((rb_enc_get(obj))->name); }));
}
...
static VALUE encoding_spec_rb_enc_str_coderange(VALUE self, VALUE str) {
  ...
  case RUBY_ENC_CODERANGE_UNKNOWN:
    return (rb_id2sym((__builtin_constant_p("coderange_unknown") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("coderange_unknown")), (long)strlen(("coderange_unknown"))); (ID) rb_intern_id_cache; }) : rb_intern("coderange_unknown"))));
  case RUBY_ENC_CODERANGE_7BIT:
    return (rb_id2sym((__builtin_constant_p("coderange_7bit") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("coderange_7bit")), (long)strlen(("coderange_7bit"))); (ID) rb_intern_id_cache; }) : rb_intern("coderange_7bit"))));
  case RUBY_ENC_CODERANGE_VALID:
    return (rb_id2sym((__builtin_constant_p("coderange_valid") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("coderange_valid")), (long)strlen(("coderange_valid"))); (ID) rb_intern_id_cache; }) : rb_intern("coderange_valid"))));
  case RUBY_ENC_CODERANGE_BROKEN:
    return (rb_id2sym((__builtin_constant_p("coderange_broken") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("coderange_broken")), (long)strlen(("coderange_broken"))); (ID) rb_intern_id_cache; }) : rb_intern("coderange_broken"))));
  default:
    return (rb_id2sym((__builtin_constant_p("coderange_unrecognized") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("coderange_unrecognized")), (long)strlen(("coderange_unrecognized"))); (ID) rb_intern_id_cache; }) : rb_intern("coderange_unrecognized"))));
  }
}
...
static VALUE encoding_spec_rb_enc_str_new(VALUE self, VALUE str, VALUE len, VALUE enc) {
  return  ({ (__builtin_constant_p((!(((struct RBasic*)(str))->flags & RSTRING_NOEMBED) ? ((struct RString*)(str))->as.ary : ((struct RString*)(str))->as.heap.ptr)) && __builtin_constant_p(((int)rb_fix2int((VALUE)(len))))) ? rb_enc_str_new_static(((!(((struct RBasic*)(str))->flags & RSTRING_NOEMBED) ? ((struct RString*)(str))->as.ary : ((struct RString*)(str))->as.heap.ptr)), (((int)rb_fix2int((VALUE)(len)))), (rb_to_encoding(enc))) : rb_enc_str_new(((!(((struct RBasic*)(str))->flags & RSTRING_NOEMBED) ? ((struct RString*)(str))->as.ary : ((struct RString*)(str))->as.heap.ptr)), (((int)rb_fix2int((VALUE)(len)))), (rb_to_encoding(enc))); });
}



static VALUE encoding_spec_ENCODING_GET(VALUE self, VALUE obj) {
  return (((VALUE)((int)(((int)((((struct RBasic*)(obj))->flags & RUBY_ENCODING_MASK)>>RUBY_ENCODING_SHIFT) != RUBY_ENCODING_INLINE_MAX ? (int)((((struct RBasic*)(obj))->flags & RUBY_ENCODING_MASK)>>RUBY_ENCODING_SHIFT) : rb_enc_get_index(obj)))))<<1 | RUBY_FIXNUM_FLAG);
}
...
static VALUE encoding_spec_rb_enc_to_index(VALUE self, VALUE name) {
  return (((VALUE)((int)(rb_enc_to_index(!((VALUE)(name) != ((VALUE)RUBY_Qnil)) ? ((void*)0) : rb_enc_find((!(((struct RBasic*)(name))->flags & RSTRING_NOEMBED) ? ((struct RString*)(name))->as.ary : ((struct RString*)(name))->as.heap.ptr))))))<<1 | RUBY_FIXNUM_FLAG);
}



static VALUE encoding_spec_rb_to_encoding(VALUE self, VALUE obj) {
  return  ({ (__builtin_constant_p(rb_to_encoding(obj)->name)) ? rb_str_new_static((rb_to_encoding(obj)->name), (long)strlen(rb_to_encoding(obj)->name)) : rb_str_new_cstr(rb_to_encoding(obj)->name); });
}



static VALUE encoding_spec_rb_to_encoding_index(VALUE self, VALUE obj) {
  return (((VALUE)((int)(rb_to_encoding_index(obj))))<<1 | RUBY_FIXNUM_FLAG);
}



static VALUE encoding_spec_rb_enc_nth(VALUE self, VALUE str, VALUE index) {
  char* start = (!(((struct RBasic*)(str))->flags & RSTRING_NOEMBED) ? ((struct RString*)(str))->as.ary : ((struct RString*)(str))->as.heap.ptr);
  char* end = start + (!(((struct RBasic*)(str))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(str))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(str))->as.heap.len);
  char* ptr = rb_enc_nth(start, end, ((long)(((long)(index))>>(int)(1))), rb_enc_get(str));
  return rb_long2num_inline(ptr - start);
}
...
static VALUE encoding_spec_rb_enc_codepoint_len(VALUE self, VALUE str) {
  ...
  return rb_ary_new_from_args(2, rb_long2num_inline(codepoint), rb_long2num_inline(len));
}
