...
static VALUE array_spec_RARRAY_PTR_iterate(VALUE self, VALUE array) {
  ...
  ptr = ((VALUE *)rb_array_const_ptr(( __builtin_choose_expr( 1, rb_obj_wb_unprotect((VALUE)(array), "spec/ruby/optional/capi/ext/array_spec.c", 21), ((VALUE)(array))))));
  for(i = 0; i < rb_array_len(array); i++) {
    rb_yield(ptr[i]);
  }
...
static VALUE array_spec_RARRAY_PTR_assign(VALUE self, VALUE array, VALUE value) {
  ...
  ptr = ((VALUE *)rb_array_const_ptr(( __builtin_choose_expr( 1, rb_obj_wb_unprotect((VALUE)(array), "spec/ruby/optional/capi/ext/array_spec.c", 32), ((VALUE)(array))))));
  for(i = 0; i < rb_array_len(array); i++) {
    ptr[i] = value;
  }
  return ((VALUE)RUBY_Qnil);
...
static VALUE array_spec_RARRAY_LEN(VALUE self, VALUE array) {
  return (((VALUE)(rb_array_len(array)))<<1 | RUBY_FIXNUM_FLAG);
}



static VALUE array_spec_RARRAY_AREF(VALUE self, VALUE array, VALUE index) {
  return (rb_array_const_ptr(array)[((int)rb_fix2int((VALUE)(index)))]);
}
...
static VALUE array_spec_rb_ary_aref(int argc, VALUE *argv, VALUE self) {
  ...
  return rb_ary_aref((int)rb_array_len(args), ((VALUE *)rb_array_const_ptr(( __builtin_choose_expr( 1, rb_obj_wb_unprotect((VALUE)(args), "spec/ruby/optional/capi/ext/array_spec.c", 56), ((VALUE)(args)))))), ary);
}
...
static VALUE array_spec_rb_ary_delete_at(VALUE self, VALUE array, VALUE index) {
  return rb_ary_delete_at(array, rb_num2long_inline(index));
}
...
static VALUE array_spec_rb_ary_entry(VALUE self, VALUE array, VALUE offset) {
  return rb_ary_entry(array, ((int)rb_fix2int((VALUE)(offset))));
}
...
static VALUE array_spec_rb_ary_new2(VALUE self, VALUE length) {
  return rb_ary_new_capa(rb_num2long_inline(length));
}
...
static VALUE array_spec_rb_ary_cat(int argc, VALUE *argv, VALUE self) {
  VALUE ary, args;
  rb_scan_args(argc, argv, "1*", &ary, &args);
  return rb_ary_cat(ary, ((VALUE *)rb_array_const_ptr(( __builtin_choose_expr( 1, rb_obj_wb_unprotect((VALUE)(args), "spec/ruby/optional/capi/ext/array_spec.c", 177), ((VALUE)(args)))))), rb_array_len(args));
}
...
static VALUE array_spec_rb_ary_rotate(VALUE self, VALUE array, VALUE count) {
  return rb_ary_rotate(array, rb_num2long_inline(count));
}
...
static VALUE array_spec_rb_ary_store(VALUE self, VALUE array, VALUE offset, VALUE value) {
  rb_ary_store(array, ((int)rb_fix2int((VALUE)(offset))), value);
...
static VALUE each_pair(VALUE obj) {
  return rb_funcall(obj, (__builtin_constant_p("each_pair") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("each_pair")), (long)strlen(("each_pair"))); (ID) rb_intern_id_cache; }) : rb_intern("each_pair")), 0);
}
...
static VALUE array_spec_rb_ary_subseq(VALUE self, VALUE ary, VALUE begin, VALUE len) {
  return rb_ary_subseq(ary, ((long)(((long)(begin))>>(int)(1))), ((long)(((long)(len))>>(int)(1))));
}
