...
{
  int result = rb_integer_pack(value, (void*)(!(((struct RBasic*)(words))->flags & RSTRING_NOEMBED) ? ((struct RString*)(words))->as.ary : ((struct RString*)(words))->as.heap.ptr), ((int)rb_fix2int((VALUE)(numwords))),
      ((int)rb_fix2int((VALUE)(wordsize))), ((int)rb_fix2int((VALUE)(nails))), ((int)rb_fix2int((VALUE)(flags))));
...
void Init_integer_spec(void) {
  ...
  rb_define_const(cls, "MSWORD", (((VALUE)((int)(0x01)))<<1 | RUBY_FIXNUM_FLAG));
  rb_define_const(cls, "LSWORD", (((VALUE)((int)(0x02)))<<1 | RUBY_FIXNUM_FLAG));
  rb_define_const(cls, "MSBYTE", (((VALUE)((int)(0x10)))<<1 | RUBY_FIXNUM_FLAG));
  rb_define_const(cls, "LSBYTE", (((VALUE)((int)(0x20)))<<1 | RUBY_FIXNUM_FLAG));
  rb_define_const(cls, "NATIVE", (((VALUE)((int)(0x40)))<<1 | RUBY_FIXNUM_FLAG));
  rb_define_const(cls, "PACK_2COMP", (((VALUE)((int)(0x80)))<<1 | RUBY_FIXNUM_FLAG));
  rb_define_const(cls, "LITTLE_ENDIAN", (((VALUE)((int)((0x02 | 0x20))))<<1 | RUBY_FIXNUM_FLAG));
  rb_define_const(cls, "BIG_ENDIAN", (((VALUE)((int)((0x01 | 0x10))))<<1 | RUBY_FIXNUM_FLAG));
  rb_define_const(cls, "FORCE_BIGNUM", (((VALUE)((int)(0x100)))<<1 | RUBY_FIXNUM_FLAG));
  rb_define_const(cls, "NEGATIVE", (((VALUE)((int)(0x200)))<<1 | RUBY_FIXNUM_FLAG));
