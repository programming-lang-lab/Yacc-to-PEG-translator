...
static int object_spec_FL_TEST_flag(VALUE flag_string) {
  char *flag_cstr = rb_string_value_cstr(&(flag_string));
  if (strcmp(flag_cstr, "FL_TAINT") == 0) {
    return ((VALUE)RUBY_FL_TAINT);
  } else if (strcmp(flag_cstr, "FL_FREEZE") == 0) {
    return ((VALUE)RUBY_FL_FREEZE);
  }
  return 0;
}

static VALUE object_spec_FL_TEST(VALUE self, VALUE obj, VALUE flag) {
  return (((VALUE)(((!(((VALUE)(obj) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(obj) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(obj))->flags & RUBY_T_MASK) != RUBY_T_NODE)?(((struct RBasic*)((obj)))->flags&((object_spec_FL_TEST_flag(flag)))):0)))<<1 | RUBY_FIXNUM_FLAG);
}
...
static VALUE object_spec_OBJ_TAINTED(VALUE self, VALUE obj) {
  return (!!((!(((VALUE)((obj)) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)((obj)) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)((obj)))->flags & RUBY_T_MASK) != RUBY_T_NODE)?(((struct RBasic*)(((obj))))->flags&((RUBY_FL_TAINT))):0)) ? ((VALUE)RUBY_Qtrue) : ((VALUE)RUBY_Qfalse);
}



static VALUE object_spec_OBJ_INFECT(VALUE self, VALUE host, VALUE source) {
  ( (((!(((VALUE)(host) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(host) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(host))->flags & RUBY_T_MASK) != RUBY_T_NODE) && (int)(((struct RBasic*)(host))->flags & RUBY_T_MASK) != RUBY_T_BIGNUM && (int)(((struct RBasic*)(host))->flags & RUBY_T_MASK) != RUBY_T_FLOAT) && (!(((VALUE)(source) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(source) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(source))->flags & RUBY_T_MASK) != RUBY_T_NODE)) ? (void)(((struct RBasic*)(host))->flags |= ((((struct RBasic*)(source))->flags&(RUBY_FL_TAINT)))) : (void)0);
  return ((VALUE)RUBY_Qnil);
}
...
static VALUE so_attr_get(VALUE self, VALUE obj, VALUE attr) {
  return rb_attr_get(obj, (rb_sym2id(attr)));
}
...
static VALUE so_check_convert_type(VALUE self, VALUE obj, VALUE klass, VALUE method) {
  return rb_check_convert_type(obj, RUBY_T_ARRAY, (!(((struct RBasic*)(klass))->flags & RSTRING_NOEMBED) ? ((struct RString*)(klass))->as.ary : ((struct RString*)(klass))->as.heap.ptr), (!(((struct RBasic*)(method))->flags & RSTRING_NOEMBED) ? ((struct RString*)(method))->as.ary : ((struct RString*)(method))->as.heap.ptr));
}



static VALUE so_check_to_integer(VALUE self, VALUE obj, VALUE method) {
  return rb_check_to_integer(obj, (!(((struct RBasic*)(method))->flags & RSTRING_NOEMBED) ? ((struct RString*)(method))->as.ary : ((struct RString*)(method))->as.heap.ptr));
}
...
static VALUE so_convert_type(VALUE self, VALUE obj, VALUE klass, VALUE method) {
  return rb_convert_type(obj, RUBY_T_ARRAY, (!(((struct RBasic*)(klass))->flags & RSTRING_NOEMBED) ? ((struct RString*)(klass))->as.ary : ((struct RString*)(klass))->as.heap.ptr), (!(((struct RBasic*)(method))->flags & RSTRING_NOEMBED) ? ((struct RString*)(method))->as.ary : ((struct RString*)(method))->as.heap.ptr));
}
...
static VALUE so_rb_obj_call_init(VALUE self, VALUE object,
  ...
  int c_nargs = ((int)rb_fix2int((VALUE)(nargs)));
  VALUE *c_args = __builtin_alloca (sizeof(VALUE) * c_nargs);
  int i;
...
static VALUE so_rbobjclassname(VALUE self, VALUE obj) {
  return  ({ (__builtin_constant_p(rb_obj_classname(obj))) ? rb_str_new_static((rb_obj_classname(obj)), (long)strlen(rb_obj_classname(obj))) : rb_str_new_cstr(rb_obj_classname(obj)); });
}
...
static VALUE object_specs_rb_obj_method_arity(VALUE self, VALUE obj, VALUE mid) {
  return (((VALUE)(rb_obj_method_arity(obj, (rb_sym2id(mid)))))<<1 | RUBY_FIXNUM_FLAG);
}
...
static VALUE so_respond_to(VALUE self, VALUE obj, VALUE sym) {
  return rb_respond_to(obj, (rb_sym2id(sym))) ? ((VALUE)RUBY_Qtrue) : ((VALUE)RUBY_Qfalse);
}



static VALUE so_obj_respond_to(VALUE self, VALUE obj, VALUE sym, VALUE priv) {
  return rb_obj_respond_to(obj, (rb_sym2id(sym)), priv == ((VALUE)RUBY_Qtrue) ? 1 : 0) ? ((VALUE)RUBY_Qtrue) : ((VALUE)RUBY_Qfalse);
}



static VALUE object_spec_rb_method_boundp(VALUE self, VALUE obj, VALUE method, VALUE exclude_private) {
  ID id = (rb_sym2id(method));
  return rb_method_boundp(obj, id, exclude_private == ((VALUE)RUBY_Qtrue) ? 1 : 0) ? ((VALUE)RUBY_Qtrue) : ((VALUE)RUBY_Qfalse);
}



static VALUE object_spec_rb_special_const_p(VALUE self, VALUE value) {
  if ( ({ VALUE special_const_obj = (value); (int)((((VALUE)(special_const_obj) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(special_const_obj) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) ? ((VALUE)RUBY_Qtrue) : ((VALUE)RUBY_Qfalse)); })) {
    return ((VALUE)RUBY_Qtrue);
  } else {
    return ((VALUE)RUBY_Qfalse);
  }
...
static VALUE so_to_id(VALUE self, VALUE obj) {
  return (rb_id2sym(rb_to_id(obj)));
}



static VALUE object_spec_RTEST(VALUE self, VALUE value) {
  return !(((VALUE)(value) & (VALUE)~((VALUE)RUBY_Qnil)) == 0) ? ((VALUE)RUBY_Qtrue) : ((VALUE)RUBY_Qfalse);
}



static VALUE so_is_type_nil(VALUE self, VALUE obj) {
  if(rb_type((VALUE)(obj)) == RUBY_T_NIL) {
    return ((VALUE)RUBY_Qtrue);
  }
  return ((VALUE)RUBY_Qfalse);
}
...
static VALUE so_is_type_object(VALUE self, VALUE obj) {
  if(rb_type((VALUE)(obj)) == RUBY_T_OBJECT) {
    return ((VALUE)RUBY_Qtrue);
  }
  return ((VALUE)RUBY_Qfalse);
}
...
static VALUE so_is_type_array(VALUE self, VALUE obj) {
  if(rb_type((VALUE)(obj)) == RUBY_T_ARRAY) {
    return ((VALUE)RUBY_Qtrue);
  }
  return ((VALUE)RUBY_Qfalse);
}
...
static VALUE so_is_type_module(VALUE self, VALUE obj) {
  if(rb_type((VALUE)(obj)) == RUBY_T_MODULE) {
    return ((VALUE)RUBY_Qtrue);
  }
  return ((VALUE)RUBY_Qfalse);
}
...
static VALUE so_is_type_class(VALUE self, VALUE obj) {
  if(rb_type((VALUE)(obj)) == RUBY_T_CLASS) {
    return ((VALUE)RUBY_Qtrue);
  }
  return ((VALUE)RUBY_Qfalse);
}
...
static VALUE so_is_type_data(VALUE self, VALUE obj) {
  if(rb_type((VALUE)(obj)) == RUBY_T_DATA) {
    return ((VALUE)RUBY_Qtrue);
  }
  return ((VALUE)RUBY_Qfalse);
}
...
static VALUE so_is_rb_type_p_nil(VALUE self, VALUE obj) {
  if( (__builtin_constant_p(RUBY_T_NIL) ? ( (((RUBY_T_NIL)) == RUBY_T_FIXNUM) ? (((int)(long)((obj)))&RUBY_FIXNUM_FLAG) : (((RUBY_T_NIL)) == RUBY_T_TRUE) ? (((obj)) == ((VALUE)RUBY_Qtrue)) : (((RUBY_T_NIL)) == RUBY_T_FALSE) ? (((obj)) == ((VALUE)RUBY_Qfalse)) : (((RUBY_T_NIL)) == RUBY_T_NIL) ? (((obj)) == ((VALUE)RUBY_Qnil)) : (((RUBY_T_NIL)) == RUBY_T_UNDEF) ? (((obj)) == ((VALUE)RUBY_Qundef)) : (((RUBY_T_NIL)) == RUBY_T_SYMBOL) ? ((((VALUE)((obj))&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)((obj)) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)((obj)) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)((obj)))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : (((RUBY_T_NIL)) == RUBY_T_FLOAT) ? ( ((((int)(long)((obj)))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)((obj)) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)((obj)) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)((obj)))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)((obj)) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)((obj)) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)((obj)))->flags & RUBY_T_MASK) == ((RUBY_T_NIL)))) : rb_type(obj) == (RUBY_T_NIL))) {
    return ((VALUE)RUBY_Qtrue);
  }
  return ((VALUE)RUBY_Qfalse);
}
...
static VALUE so_is_builtin_type_array(VALUE self, VALUE obj) {
  if((int)(((struct RBasic*)(obj))->flags & RUBY_T_MASK) == RUBY_T_ARRAY) {
    return ((VALUE)RUBY_Qtrue);
  }
  return ((VALUE)RUBY_Qfalse);
}
...
static VALUE so_is_builtin_type_data(VALUE self, VALUE obj) {
  if((int)(((struct RBasic*)(obj))->flags & RUBY_T_MASK) == RUBY_T_DATA) {
    return ((VALUE)RUBY_Qtrue);
  }
  return ((VALUE)RUBY_Qfalse);
}
...
static VALUE object_spec_rb_obj_instance_eval(VALUE self, VALUE obj) {
  return rb_obj_instance_eval(0, ((void*)0), obj);
}



static VALUE object_spec_rb_iv_get(VALUE self, VALUE obj, VALUE name) {
  return rb_iv_get(obj, (!(((struct RBasic*)(name))->flags & RSTRING_NOEMBED) ? ((struct RString*)(name))->as.ary : ((struct RString*)(name))->as.heap.ptr));
}



static VALUE object_spec_rb_iv_set(VALUE self, VALUE obj, VALUE name, VALUE value) {
  return rb_iv_set(obj, (!(((struct RBasic*)(name))->flags & RSTRING_NOEMBED) ? ((struct RString*)(name))->as.ary : ((struct RString*)(name))->as.heap.ptr), value);
}



static VALUE object_spec_rb_ivar_get(VALUE self, VALUE obj, VALUE sym_name) {
  return rb_ivar_get(obj, (rb_sym2id(sym_name)));
}



static VALUE object_spec_rb_ivar_set(VALUE self, VALUE obj, VALUE sym_name, VALUE value) {
  return rb_ivar_set(obj, (rb_sym2id(sym_name)), value);
}



static VALUE object_spec_rb_ivar_defined(VALUE self, VALUE obj, VALUE sym_name) {
  return rb_ivar_defined(obj, (rb_sym2id(sym_name)));
}
