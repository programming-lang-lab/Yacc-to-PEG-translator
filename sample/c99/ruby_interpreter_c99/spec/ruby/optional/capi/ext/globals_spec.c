...
void var_2x_setter(VALUE val, ID id, VALUE *var) {
    *var = (((VALUE)((int)(rb_num2int_inline(val) * 2)))<<1 | RUBY_FIXNUM_FLAG);
}

static VALUE sb_define_hooked_variable(VALUE self, VALUE var_name) {
  rb_define_hooked_variable(rb_string_value_ptr(&(var_name)), &g_hooked_var, 0, var_2x_setter);
...
static VALUE sb_define_readonly_variable(VALUE self, VALUE var_name, VALUE val) {
  g_ro_var = val;
  rb_define_readonly_variable(rb_string_value_ptr(&(var_name)), &g_ro_var);
  return ((VALUE)RUBY_Qnil);
}
...
static VALUE sb_define_variable(VALUE self, VALUE var_name, VALUE val) {
  g_var = val;
  rb_define_variable(rb_string_value_ptr(&(var_name)), &g_var);
  return ((VALUE)RUBY_Qnil);
}
...
static VALUE sb_gv_get(VALUE self, VALUE var) {
  return rb_gv_get(rb_string_value_ptr(&(var)));
}



static VALUE sb_gv_set(VALUE self, VALUE var, VALUE val) {
  return rb_gv_set(rb_string_value_ptr(&(var)), val);
}
