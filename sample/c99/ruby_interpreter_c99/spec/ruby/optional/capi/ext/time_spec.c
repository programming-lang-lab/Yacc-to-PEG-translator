...
static VALUE time_spec_rb_time_new(VALUE self, VALUE sec, VALUE usec) {
  return rb_time_new(rb_num2long_inline(sec), rb_num2long_inline(usec));
}



static VALUE time_spec_rb_time_nano_new(VALUE self, VALUE sec, VALUE nsec) {
  return rb_time_nano_new(rb_num2long_inline(sec), rb_num2long_inline(nsec));
}
...
static VALUE time_spec_rb_time_interval(VALUE self, VALUE ts) {
  ...
  rb_ary_push(ary, rb_long2num_inline(interval.tv_sec));
  rb_ary_push(ary, rb_long2num_inline(interval.tv_usec));
  return ary;
}
...
static VALUE time_spec_rb_time_timeval(VALUE self, VALUE ts) {
  ...
  VALUE ary = rb_ary_new();
  rb_ary_push(ary, rb_long2num_inline(tv.tv_sec));
  rb_ary_push(ary, rb_long2num_inline(tv.tv_usec));
  return ary;
}
...
static VALUE time_spec_rb_time_timespec(VALUE self, VALUE time) {
  ...
  VALUE ary = rb_ary_new();
  rb_ary_push(ary, rb_long2num_inline(ts.tv_sec));
  rb_ary_push(ary, rb_long2num_inline(ts.tv_nsec));
  return ary;
}
...
static VALUE time_spec_rb_time_timespec_new(VALUE self, VALUE sec, VALUE nsec, VALUE offset) {
  struct timespec ts;
  ts.tv_sec = rb_num2long_inline(sec);
  ts.tv_nsec = rb_num2long_inline(nsec);

  return rb_time_timespec_new(&ts, rb_num2int_inline(offset));
}
