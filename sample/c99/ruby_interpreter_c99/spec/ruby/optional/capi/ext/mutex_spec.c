...
VALUE mutex_spec_rb_mutex_callback(VALUE arg) {
  return rb_funcall(arg, (__builtin_constant_p("call") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("call")), (long)strlen(("call"))); (ID) rb_intern_id_cache; }) : rb_intern("call")), 0);
}
