...
void Init_gc_spec(void) {
  ...
  registered_tagged_value = (((VALUE)((int)(10)))<<1 | RUBY_FIXNUM_FLAG);
  registered_reference_value =  ({ (__builtin_constant_p("Globally registered data")) ? rb_str_new_static(("Globally registered data"), (long)strlen("Globally registered data")) : rb_str_new_cstr("Globally registered data"); });
