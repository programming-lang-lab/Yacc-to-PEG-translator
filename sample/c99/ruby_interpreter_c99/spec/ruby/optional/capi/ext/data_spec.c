...
VALUE sdaf_alloc_func(VALUE klass) {
  ...
  bar->foo = 42;
  return rb_data_object_wrap((klass),(bar),(RUBY_DATA_FUNC)(&sample_wrapped_struct_mark),(RUBY_DATA_FUNC)(&sample_wrapped_struct_free));
}

VALUE sdaf_get_struct(VALUE self) {
  struct sample_wrapped_struct* bar;
  ((bar) = (struct sample_wrapped_struct*)rb_data_object_get(self));
...
VALUE sws_wrap_struct(VALUE self, VALUE val) {
  ...
  return rb_data_object_wrap((rb_cObject),(bar),(RUBY_DATA_FUNC)(&sample_wrapped_struct_mark),(RUBY_DATA_FUNC)(&sample_wrapped_struct_free));
}

VALUE sws_wrap_struct_null(VALUE self, VALUE val) {
  struct sample_wrapped_struct* bar = (struct sample_wrapped_struct *)malloc(sizeof(struct sample_wrapped_struct));
  bar->foo = ((int)rb_fix2int((VALUE)(val)));
  return rb_data_object_wrap((0),(bar),(RUBY_DATA_FUNC)(&sample_wrapped_struct_mark),(RUBY_DATA_FUNC)(&sample_wrapped_struct_free));
}

VALUE sws_get_struct(VALUE self, VALUE obj) {
  struct sample_wrapped_struct* bar;
  ((bar) = (struct sample_wrapped_struct*)rb_data_object_get(obj));
...
VALUE sws_get_struct_rdata(VALUE self, VALUE obj) {
  struct sample_wrapped_struct* bar;
  bar = (struct sample_wrapped_struct*) ((struct RData*)(obj))->data;
  return (((VALUE)(bar->foo))<<1 | RUBY_FIXNUM_FLAG);
}
...
VALUE sws_change_struct(VALUE self, VALUE obj, VALUE new_val) {
  ...
  old_struct = ((struct RData*)(obj))->data;
  free(old_struct);
  ((struct RData*)(obj))->data = new_struct;
