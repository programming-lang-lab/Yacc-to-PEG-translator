...
rb_vm_get_sourceline(const rb_control_frame_t *cfp)
{
 ...
 if (line != 0) {
     ...
     return ((int)rb_fix2int((VALUE)(rb_iseq_first_lineno(iseq))));
 }
    }
    else {
 return 0;
...
static const rb_data_type_t location_data_type = {
    "frame_info",
    {location_mark, ((RUBY_DATA_FUNC)-1), location_memsize,},
    0, 0, 1
};
...
location_ptr(VALUE locobj)
{
    ...
    ((vloc) = (struct valued_frame_info*)(((struct RData*)((locobj)))->data));
    return vloc->loc;
}
...
{
    return (((VALUE)(location_lineno(location_ptr(self))))<<1 | RUBY_FIXNUM_FLAG);
}
...
location_label(rb_backtrace_location_t *loc)
{
 ...
 return loc->body.iseq.iseq->body->location.label;
      case LOCATION_TYPE_CFUNC:
 return id2str(loc->body.cfunc.mid);
      case LOCATION_TYPE_IFUNC:
      default:
...
{
    VALUE s = rb_enc_sprintf(rb_enc_compatible(file, name), "%s", (!(((struct RBasic*)(file))->flags & RSTRING_NOEMBED) ? ((struct RString*)(file))->as.ary : ((struct RString*)(file))->as.heap.ptr));
    if (lineno != 0) {
 rb_str_catf(s, ":%d", lineno);
    }
     ({ (__builtin_constant_p(":in ")) ? rb_str_cat((s), (":in "), (long)strlen(":in ")) : rb_str_cat_cstr((s), (":in ")); });
    if (!((VALUE)(name) != ((VALUE)RUBY_Qnil))) {
  ({ (__builtin_constant_p("unknown method")) ? rb_str_cat((s), ("unknown method"), (long)strlen("unknown method")) : rb_str_cat_cstr((s), ("unknown method")); });
    }
    else {
 rb_str_catf(s, "`%s'", (!(((struct RBasic*)(name))->flags & RSTRING_NOEMBED) ? ((struct RString*)(name))->as.ary : ((struct RString*)(name))->as.heap.ptr));
    }
    return s;
}
...
location_to_str(rb_backtrace_location_t *loc)
{
 ...
 if (loc->body.cfunc.prev_loc) {
     ...
     file = rb_current_vm()->progname;
     lineno = (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG);
 }
 name = id2str(loc->body.cfunc.mid);
 break;
      case LOCATION_TYPE_IFUNC:
      default:
...
{
    rb_backtrace_t *bt;
    VALUE obj = ({ VALUE data_struct_obj = rb_data_typed_object_zalloc(klass, sizeof(rb_backtrace_t), &backtrace_data_type); (void)((bt) = (rb_backtrace_t *)(((struct RData*)(data_struct_obj))->data));; data_struct_obj; });
    return obj;
}
        ...
        void *arg)
{
 ...
 size = start_cfp - last_cfp + 1;
    ...
    for (i=0, cfp = start_cfp; i<size; i++, cfp = ((cfp)-1)) {
 ...
 else if ((VM_FRAME_TYPE(cfp) == VM_FRAME_MAGIC_CFUNC)) {
...
bt_init(void *ptr, size_t size)
{
    ...
    ((arg->bt) = (rb_backtrace_t*)(((struct RData*)((arg->btobj)))->data));
...
backtrace_collect(rb_backtrace_t *bt, long lev, long n, VALUE (*func)(rb_backtrace_location_t *, void *arg), void *arg)
{
    ...
    if ((__builtin_expect(!!(lev < 0 || n < 0), 0))) {
...
backtrace_to_str_ary(VALUE self, long lev, long n)
{
    ...
    ((bt) = (rb_backtrace_t*)(((struct RData*)((self)))->data));
...
rb_backtrace_use_iseq_first_lineno_for_last_location(VALUE self)
{
    ...
    loc->body.iseq.lineno.lineno = ((int)rb_fix2int((VALUE)(iseq->body->location.first_lineno)));
    loc->type = LOCATION_TYPE_ISEQ_CALCED;
}
...
location_create(rb_backtrace_location_t *srcloc, void *btobj)
{
    VALUE obj;
    struct valued_frame_info *vloc;
    obj = ({ VALUE data_struct_obj = rb_data_typed_object_zalloc(rb_cBacktraceLocation, sizeof(struct valued_frame_info), &location_data_type); (void)((vloc) = (struct valued_frame_info *)(((struct RData*)(data_struct_obj))->data));; data_struct_obj; });
...
oldbt_init(void *ptr, size_t dmy)
{
    ...
    arg->filename = rb_current_vm()->progname;
    arg->lineno = 0;
}
...
oldbt_print(void *data, VALUE file, int lineno, VALUE name)
{
 ...
 fprintf(fp, "\tfrom %s:%d:in unknown method\n",
  (!(((struct RBasic*)(file))->flags & RSTRING_NOEMBED) ? ((struct RString*)(file))->as.ary : ((struct RString*)(file))->as.heap.ptr), lineno);
    }
    else {
 fprintf(fp, "\tfrom %s:%d:in `%s'\n",
  (!(((struct RBasic*)(file))->flags & RSTRING_NOEMBED) ? ((struct RString*)(file))->as.ary : ((struct RString*)(file))->as.heap.ptr), lineno, (!(((struct RBasic*)(name))->flags & RSTRING_NOEMBED) ? ((struct RString*)(name))->as.ary : ((struct RString*)(name))->as.heap.ptr));
    }
}
...
vm_backtrace_print(FILE *fp)
{
    ...
    arg.data = (void *)fp;
    backtrace_each(rb_current_execution_context(),
     oldbt_init,
     oldbt_iter_iseq,
     oldbt_iter_cfunc,
     &arg);
...
{
    const char *filename = !((VALUE)(file) != ((VALUE)RUBY_Qnil)) ? "ruby": (!(((struct RBasic*)(file))->flags & RSTRING_NOEMBED) ? ((struct RString*)(file))->as.ary : ((struct RString*)(file))->as.heap.ptr);
    if (!*(int *)arg) {
 ...
 *(int *)arg = 1;
 ...
 fprintf(stderr, "%s:%d:in `%s'\n", filename, line, (!(((struct RBasic*)(method))->flags & RSTRING_NOEMBED) ? ((struct RString*)(method))->as.ary : ((struct RString*)(method))->as.heap.ptr));
    }
}
...
oldbt_print_to(void *data, VALUE file, int lineno, VALUE name)
{
    ...
    VALUE str = rb_sprintf("\tfrom %li\v:%d:in ", file, lineno);

    if (!((VALUE)(name) != ((VALUE)RUBY_Qnil))) {
  ({ (__builtin_constant_p("unknown method\n")) ? rb_str_cat((str), ("unknown method\n"), (long)strlen("unknown method\n")) : rb_str_cat_cstr((str), ("unknown method\n")); });
    }
    else {
...
{
    return rb_ec_backtrace_str_ary(rb_current_execution_context(), 0, 0);
}
...
ec_backtrace_to_ary(const rb_execution_context_t *ec, int argc, const VALUE *argv, int lev_default, int lev_plus, int to_str)
{
    ...
    ((bt) = (rb_backtrace_t*)(((struct RData*)((btval)))->data));

    rb_scan_args(argc, argv, "02", &level, &vn);

    if (argc == 2 && !((VALUE)(vn) != ((VALUE)RUBY_Qnil))) argc--;
 ...
 r = backtrace_to_location_ary(btval, lev, n);
    ...
    (* ({ volatile VALUE *rb_gc_guarded_ptr = &(btval); ; rb_gc_guarded_ptr; }));
    return r;
}
...
{
    return ec_backtrace_to_ary(rb_current_execution_context(), argc, argv, 1, 1, 1);
}
static VALUE
rb_f_caller_locations(int argc, VALUE *argv)
{
    return ec_backtrace_to_ary(rb_current_execution_context(), argc, argv, 1, 1, 0);
}
...
Init_vm_backtrace(void)
{
    ...
    rb_undef_method(rb_class_of((VALUE)(rb_cBacktrace)), "new");
    ...
    rb_undef_method(rb_class_of((VALUE)(rb_cBacktraceLocation)), "new");
...
get_klass(const rb_control_frame_t *cfp)
{
 ...
 if (( ((RUBY_T_ICLASS) == RUBY_T_FIXNUM) ? (((int)(long)(klass))&RUBY_FIXNUM_FLAG) : ((RUBY_T_ICLASS) == RUBY_T_TRUE) ? ((klass) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_ICLASS) == RUBY_T_FALSE) ? ((klass) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_ICLASS) == RUBY_T_NIL) ? ((klass) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_ICLASS) == RUBY_T_UNDEF) ? ((klass) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_ICLASS) == RUBY_T_SYMBOL) ? ((((VALUE)(klass)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(klass) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(klass) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(klass))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_ICLASS) == RUBY_T_FLOAT) ? ( ((((int)(long)(klass))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(klass) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(klass) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(klass))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(klass) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(klass) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(klass))->flags & RUBY_T_MASK) == (RUBY_T_ICLASS)))) {
     return ((struct RBasic*)(klass))->klass;
 }
 else {
     return klass;
 }
...
collect_caller_bindings_iseq(void *arg, const rb_control_frame_t *cfp)
{
    ...
    VALUE frame = rb_ary_new_capa(5);

    rb_ary_store(frame, CALLER_BINDING_SELF, cfp->self);
    rb_ary_store(frame, CALLER_BINDING_CLASS, get_klass(cfp));
    rb_ary_store(frame, CALLER_BINDING_BINDING, ((VALUE)((cfp)) | (0x01)));
    rb_ary_store(frame, CALLER_BINDING_ISEQ, cfp->iseq ? (VALUE)cfp->iseq : ((VALUE)RUBY_Qnil));
    rb_ary_store(frame, CALLER_BINDING_CFP, ((VALUE)((cfp)) | (0x01)));
...
collect_caller_bindings_cfunc(void *arg, const rb_control_frame_t *cfp, ID mid)
{
    ...
    rb_ary_store(frame, CALLER_BINDING_SELF, cfp->self);
    rb_ary_store(frame, CALLER_BINDING_CLASS, get_klass(cfp));
    rb_ary_store(frame, CALLER_BINDING_BINDING, ((VALUE)RUBY_Qnil));
    rb_ary_store(frame, CALLER_BINDING_ISEQ, ((VALUE)RUBY_Qnil));
    rb_ary_store(frame, CALLER_BINDING_CFP, ((VALUE)((cfp)) | (0x01)));
...
collect_caller_bindings(const rb_execution_context_t *ec)
{
 ...
 if (!!((VALUE)(cfp_val) != ((VALUE)RUBY_Qnil))) {
     rb_control_frame_t *cfp = ((void *)(((cfp_val)) & ~0x03));
...
rb_debug_inspector_open(rb_debug_inspector_func_t func, void *data)
{
    ...
    dbg_context.backtrace_size = rb_array_len(dbg_context.backtrace);
...
rb_debug_inspector_frame_iseq_get(const rb_debug_inspector_t *dc, long index)
{
    ...
    return !(((VALUE)(iseq) & (VALUE)~((VALUE)RUBY_Qnil)) == 0) ? rb_iseqw_new((rb_iseq_t *)iseq) : ((VALUE)RUBY_Qnil);
}
...
{
    if (frame == ((VALUE)RUBY_Qnil)) return ((void*)0);

    if (( ((RUBY_T_IMEMO) == RUBY_T_FIXNUM) ? (((int)(long)(frame))&RUBY_FIXNUM_FLAG) : ((RUBY_T_IMEMO) == RUBY_T_TRUE) ? ((frame) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_IMEMO) == RUBY_T_FALSE) ? ((frame) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_IMEMO) == RUBY_T_NIL) ? ((frame) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_IMEMO) == RUBY_T_UNDEF) ? ((frame) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_IMEMO) == RUBY_T_SYMBOL) ? ((((VALUE)(frame)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(frame) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(frame) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(frame))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_IMEMO) == RUBY_T_FLOAT) ? ( ((((int)(long)(frame))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(frame) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(frame) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(frame))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(frame) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(frame) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(frame))->flags & RUBY_T_MASK) == (RUBY_T_IMEMO)))) {
...
rb_profile_frame_path(VALUE frame)
{
    ...
    return iseq ? rb_iseq_path(iseq) : ((VALUE)RUBY_Qnil);
}
...
{
    const rb_iseq_t *iseq = frame2iseq(frame);
    return iseq ? rb_iseq_realpath(iseq) : ((VALUE)RUBY_Qnil);
}
...
{
    const rb_iseq_t *iseq = frame2iseq(frame);
    return iseq ? rb_iseq_label(iseq) : ((VALUE)RUBY_Qnil);
}
...
{
    const rb_iseq_t *iseq = frame2iseq(frame);
    return iseq ? rb_iseq_base_label(iseq) : ((VALUE)RUBY_Qnil);
}
...
{
    const rb_iseq_t *iseq = frame2iseq(frame);
    return iseq ? rb_iseq_first_lineno(iseq) : ((VALUE)RUBY_Qnil);
}

static VALUE
frame2klass(VALUE frame)
{
    if (frame == ((VALUE)RUBY_Qnil)) return ((VALUE)RUBY_Qnil);
...
rb_profile_frame_classpath(VALUE frame)
{
    ...
    if (klass && !!((VALUE)(klass) != ((VALUE)RUBY_Qnil))) {
 if (( ((RUBY_T_ICLASS) == RUBY_T_FIXNUM) ? (((int)(long)(klass))&RUBY_FIXNUM_FLAG) : ((RUBY_T_ICLASS) == RUBY_T_TRUE) ? ((klass) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_ICLASS) == RUBY_T_FALSE) ? ((klass) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_ICLASS) == RUBY_T_NIL) ? ((klass) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_ICLASS) == RUBY_T_UNDEF) ? ((klass) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_ICLASS) == RUBY_T_SYMBOL) ? ((((VALUE)(klass)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(klass) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(klass) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(klass))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_ICLASS) == RUBY_T_FLOAT) ? ( ((((int)(long)(klass))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(klass) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(klass) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(klass))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(klass) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(klass) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(klass))->flags & RUBY_T_MASK) == (RUBY_T_ICLASS)))) {
...
rb_profile_frame_singleton_method_p(VALUE frame)
{
    ...
    if (klass && !!((VALUE)(klass) != ((VALUE)RUBY_Qnil)) && ((!(((VALUE)(klass) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(klass) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(klass))->flags & RUBY_T_MASK) != RUBY_T_NODE)?(((struct RBasic*)((klass)))->flags&((((VALUE)RUBY_FL_SINGLETON)))):0)) {
...
{
    const rb_iseq_t *iseq = frame2iseq(frame);
    return iseq ? rb_iseq_method_name(iseq) : ((VALUE)RUBY_Qnil);
}
...
rb_profile_frame_qualified_method_name(VALUE frame)
{
    ...
    if (method_name != ((VALUE)RUBY_Qnil)) {
 VALUE classpath = rb_profile_frame_classpath(frame);
 VALUE singleton_p = rb_profile_frame_singleton_method_p(frame);

 if (classpath != ((VALUE)RUBY_Qnil)) {
     return rb_sprintf("%li\v%s%li\v",
         classpath, singleton_p == ((VALUE)RUBY_Qtrue) ? ".": "#", method_name);
 }
 else {
     return method_name;
 }
...
rb_profile_frame_full_label(VALUE frame)
{
    ...
    if (!((VALUE)(qualified_method_name) != ((VALUE)RUBY_Qnil)) || base_label == qualified_method_name) {
 return label;
    }
    else {
 long label_length = (!(((struct RBasic*)(label))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(label))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(label))->as.heap.len);
 long base_label_length = (!(((struct RBasic*)(base_label))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(base_label))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(base_label))->as.heap.len);
 int prefix_len = rb_long2int_inline(label_length - base_label_length);

 return rb_sprintf("%.*s%li\v", prefix_len, (!(((struct RBasic*)(label))->flags & RSTRING_NOEMBED) ? ((struct RString*)(label))->as.ary : ((struct RString*)(label))->as.heap.ptr), qualified_method_name);
    }
}
