...
{
    if ((((int)(long)(y))&RUBY_FIXNUM_FLAG) && ((y) == (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG)))
 return x;
    else if ((((int)(long)(x))&RUBY_FIXNUM_FLAG) && ((x) == (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG)))
 return y;
...
{
    if ((((int)(long)(y))&RUBY_FIXNUM_FLAG) && ((long)(((long)(y))>>(int)(1))) == 1)
 return x;
...
f_lt_p(VALUE x, VALUE y)
{
 ...
 return (long)x < (long)y;
    return !(((VALUE)(rb_funcall(x, '<', 1, y)) & (VALUE)~((VALUE)RUBY_Qnil)) == 0);
}
...
inline static VALUE f_integer_p(VALUE x){ return rb_funcall(x, id_integer_p, 0);}

inline static VALUE
f_to_i(VALUE x)
{
    if (( ((RUBY_T_STRING) == RUBY_T_FIXNUM) ? (((int)(long)(x))&RUBY_FIXNUM_FLAG) : ((RUBY_T_STRING) == RUBY_T_TRUE) ? ((x) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_STRING) == RUBY_T_FALSE) ? ((x) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_STRING) == RUBY_T_NIL) ? ((x) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_STRING) == RUBY_T_UNDEF) ? ((x) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_STRING) == RUBY_T_SYMBOL) ? ((((VALUE)(x)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(x) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(x) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(x))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_STRING) == RUBY_T_FLOAT) ? ( ((((int)(long)(x))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(x) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(x) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(x))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(x) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(x) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(x))->flags & RUBY_T_MASK) == (RUBY_T_STRING))))
...
{
    if ( ({ const VALUE integer_type_obj = (x); ((((int)(long)(integer_type_obj))&RUBY_FIXNUM_FLAG) || (!(((VALUE)(integer_type_obj) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(integer_type_obj) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(integer_type_obj))->flags & RUBY_T_MASK) == RUBY_T_BIGNUM)); })) {
 return ((x) == (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG));
    }
 ...
 VALUE num = ((struct RRational*)(x))->num;

 return ((num) == (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG));
    }
    return (int)rb_equal(x, (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG));
}
...
{
    if ( ({ const VALUE integer_type_obj = (x); ((((int)(long)(integer_type_obj))&RUBY_FIXNUM_FLAG) || (!(((VALUE)(integer_type_obj) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(integer_type_obj) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(integer_type_obj))->flags & RUBY_T_MASK) == RUBY_T_BIGNUM)); })) {
 return x == (((VALUE)(1))<<1 | RUBY_FIXNUM_FLAG);
    }
    else if (( ((RUBY_T_RATIONAL) == RUBY_T_FIXNUM) ? (((int)(long)(x))&RUBY_FIXNUM_FLAG) : ((RUBY_T_RATIONAL) == RUBY_T_TRUE) ? ((x) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_RATIONAL) == RUBY_T_FALSE) ? ((x) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_RATIONAL) == RUBY_T_NIL) ? ((x) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_RATIONAL) == RUBY_T_UNDEF) ? ((x) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_RATIONAL) == RUBY_T_SYMBOL) ? ((((VALUE)(x)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(x) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(x) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(x))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_RATIONAL) == RUBY_T_FLOAT) ? ( ((((int)(long)(x))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(x) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(x) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(x))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(x) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(x) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(x))->flags & RUBY_T_MASK) == (RUBY_T_RATIONAL)))) {
 VALUE num = ((struct RRational*)(x))->num;
 VALUE den = ((struct RRational*)(x))->den;

 return num == (((VALUE)(1))<<1 | RUBY_FIXNUM_FLAG) && den == (((VALUE)(1))<<1 | RUBY_FIXNUM_FLAG);
    }
    return (int)rb_equal(x, (((VALUE)(1))<<1 | RUBY_FIXNUM_FLAG));
}
...
k_integer_p(VALUE x)
{
    return  ({ const VALUE integer_type_obj = (x); ((((int)(long)(integer_type_obj))&RUBY_FIXNUM_FLAG) || (!(((VALUE)(integer_type_obj) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(integer_type_obj) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(integer_type_obj))->flags & RUBY_T_MASK) == RUBY_T_BIGNUM)); });
}

inline static int
k_float_p(VALUE x)
{
    return ( ((((int)(long)(x))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(x) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(x) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(x))->flags & RUBY_T_MASK) == RUBY_T_FLOAT));
}

inline static int
k_rational_p(VALUE x)
{
    return ( ((RUBY_T_RATIONAL) == RUBY_T_FIXNUM) ? (((int)(long)(x))&RUBY_FIXNUM_FLAG) : ((RUBY_T_RATIONAL) == RUBY_T_TRUE) ? ((x) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_RATIONAL) == RUBY_T_FALSE) ? ((x) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_RATIONAL) == RUBY_T_NIL) ? ((x) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_RATIONAL) == RUBY_T_UNDEF) ? ((x) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_RATIONAL) == RUBY_T_SYMBOL) ? ((((VALUE)(x)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(x) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(x) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(x))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_RATIONAL) == RUBY_T_FLOAT) ? ( ((((int)(long)(x))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(x) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(x) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(x))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(x) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(x) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(x))->flags & RUBY_T_MASK) == (RUBY_T_RATIONAL)));
}
inline static long
i_gcd(long x, long y)
{
...
f_gcd_normal(VALUE x, VALUE y)
{
    ...
    if ((((int)(long)(x))&RUBY_FIXNUM_FLAG) && (((int)(long)(y))&RUBY_FIXNUM_FLAG))
 return rb_long2num_inline(i_gcd(((long)(((long)(x))>>(int)(1))), ((long)(((long)(y))>>(int)(1)))));

    if (((((int)(long)(x))&RUBY_FIXNUM_FLAG) ? ((long)(x) < 0) : (!((((struct RBasic*)(x))->flags & ((VALUE)((VALUE)RUBY_FL_USER1))) != 0))))
 x = rb_int_uminus(x);
    if (((((int)(long)(y))&RUBY_FIXNUM_FLAG) ? ((long)(y) < 0) : (!((((struct RBasic*)(y))->flags & ((VALUE)((VALUE)RUBY_FL_USER1))) != 0))))
 y = rb_int_uminus(y);

    if (((((int)(long)(x))&RUBY_FIXNUM_FLAG) ? ((x) == (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG)) : rb_bigzero_p(x)))
 return y;
    if (((((int)(long)(y))&RUBY_FIXNUM_FLAG) ? ((y) == (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG)) : rb_bigzero_p(y)))
 return x;

    for (;;) {
 if ((((int)(long)(x))&RUBY_FIXNUM_FLAG)) {
     if (((x) == (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG)))
  return y;
     if ((((int)(long)(y))&RUBY_FIXNUM_FLAG))
  return rb_long2num_inline(i_gcd(((long)(((long)(x))>>(int)(1))), ((long)(((long)(y))>>(int)(1)))));
 }
...
{
    if (((((int)(long)(x))&RUBY_FIXNUM_FLAG) ? ((x) == (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG)) : rb_bigzero_p(x)) || ((((int)(long)(y))&RUBY_FIXNUM_FLAG) ? ((y) == (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG)) : rb_bigzero_p(y)))
 return (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG);
...
{
    struct RRational *(obj) = (struct RRational*)(((RUBY_T_RATIONAL | (1 ? ((VALUE)RUBY_FL_WB_PROTECTED) : 0)) & ((VALUE)RUBY_FL_WB_PROTECTED)) ? rb_wb_protected_newobj_of(klass, (RUBY_T_RATIONAL | (1 ? ((VALUE)RUBY_FL_WB_PROTECTED) : 0)) & ~((VALUE)RUBY_FL_WB_PROTECTED)) : rb_wb_unprotected_newobj_of(klass, RUBY_T_RATIONAL | (1 ? ((VALUE)RUBY_FL_WB_PROTECTED) : 0)));

    rb_obj_write((VALUE)((obj)), (VALUE *)(&((struct RRational *)(obj))->num), (VALUE)((num)), "rational.c", 411);
    rb_obj_write((VALUE)((obj)), (VALUE *)(&((struct RRational *)(obj))->den), (VALUE)((den)), "rational.c", 412);
    (void)(((struct RBasic*)(obj))->flags |= RUBY_FL_FREEZE);
...
{
    return nurat_s_new_internal(klass, (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG), (((VALUE)(1))<<1 | RUBY_FIXNUM_FLAG));
}
inline static VALUE
f_rational_new_bang1(VALUE klass, VALUE x)
{
    return nurat_s_new_internal(klass, x, (((VALUE)(1))<<1 | RUBY_FIXNUM_FLAG));
}
...
{
    if (! ({ const VALUE integer_type_obj = (num); ((((int)(long)(integer_type_obj))&RUBY_FIXNUM_FLAG) || (!(((VALUE)(integer_type_obj) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(integer_type_obj) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(integer_type_obj))->flags & RUBY_T_MASK) == RUBY_T_BIGNUM)); })) {
...
{
    __builtin_choose_expr( __builtin_constant_p(!1 +0), __builtin_choose_expr(!1 +0, ((num != ((void*)0) &&  ({ const VALUE integer_type_obj = (*num); ((((int)(long)(integer_type_obj))&RUBY_FIXNUM_FLAG) || (!(((VALUE)(integer_type_obj) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(integer_type_obj) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(integer_type_obj))->flags & RUBY_T_MASK) == RUBY_T_BIGNUM)); })) ? (void)0 : rb_assert_failure("rational.c", 499, __func__, "num != NULL && RB_INTEGER_TYPE_P(*num)")), (void)0), ((!(!1 +0) || (num != ((void*)0) &&  ({ const VALUE integer_type_obj = (*num); ((((int)(long)(integer_type_obj))&RUBY_FIXNUM_FLAG) || (!(((VALUE)(integer_type_obj) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(integer_type_obj) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(integer_type_obj))->flags & RUBY_T_MASK) == RUBY_T_BIGNUM)); }))) ? (void)0 : rb_assert_failure("rational.c", 499, __func__, "num != NULL && RB_INTEGER_TYPE_P(*num)")));
    __builtin_choose_expr( __builtin_constant_p(!1 +0), __builtin_choose_expr(!1 +0, ((den != ((void*)0) &&  ({ const VALUE integer_type_obj = (*den); ((((int)(long)(integer_type_obj))&RUBY_FIXNUM_FLAG) || (!(((VALUE)(integer_type_obj) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(integer_type_obj) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(integer_type_obj))->flags & RUBY_T_MASK) == RUBY_T_BIGNUM)); })) ? (void)0 : rb_assert_failure("rational.c", 500, __func__, "den != NULL && RB_INTEGER_TYPE_P(*den)")), (void)0), ((!(!1 +0) || (den != ((void*)0) &&  ({ const VALUE integer_type_obj = (*den); ((((int)(long)(integer_type_obj))&RUBY_FIXNUM_FLAG) || (!(((VALUE)(integer_type_obj) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(integer_type_obj) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(integer_type_obj))->flags & RUBY_T_MASK) == RUBY_T_BIGNUM)); }))) ? (void)0 : rb_assert_failure("rational.c", 500, __func__, "den != NULL && RB_INTEGER_TYPE_P(*den)")));
    if (((((int)(long)(*den))&RUBY_FIXNUM_FLAG) ? ((long)(*den) < 0) : (!((((struct RBasic*)(*den))->flags & ((VALUE)((VALUE)RUBY_FL_USER1))) != 0)))) {
        *num = rb_int_uminus(*num);
        *den = rb_int_uminus(*den);
    }
    else if (((((int)(long)(*den))&RUBY_FIXNUM_FLAG) ? ((*den) == (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG)) : rb_bigzero_p(*den))) {
        rb_num_zerodiv();
    }
}
...
{
    VALUE gcd;
    if (*x == (((VALUE)(1))<<1 | RUBY_FIXNUM_FLAG) || *y == (((VALUE)(1))<<1 | RUBY_FIXNUM_FLAG)) return;
    gcd = f_gcd(*x, *y);
    *x = f_idiv(*x, gcd);
    *y = f_idiv(*y, gcd);
}
...
{
    __builtin_choose_expr( __builtin_constant_p(!1 +0), __builtin_choose_expr(!1 +0, ((!k_rational_p(x)) ? (void)0 : rb_assert_failure("rational.c", 563, __func__, "!k_rational_p(x)")), (void)0), ((!(!1 +0) || (!k_rational_p(x))) ? (void)0 : rb_assert_failure("rational.c", 563, __func__, "!k_rational_p(x)")));
    __builtin_choose_expr( __builtin_constant_p(!1 +0), __builtin_choose_expr(!1 +0, ((!k_rational_p(y)) ? (void)0 : rb_assert_failure("rational.c", 564, __func__, "!k_rational_p(y)")), (void)0), ((!(!1 +0) || (!k_rational_p(y))) ? (void)0 : rb_assert_failure("rational.c", 564, __func__, "!k_rational_p(y)")));
...
{
    __builtin_choose_expr( __builtin_constant_p(!1 +0), __builtin_choose_expr(!1 +0, ((!k_rational_p(x)) ? (void)0 : rb_assert_failure("rational.c", 571, __func__, "!k_rational_p(x)")), (void)0), ((!(!1 +0) || (!k_rational_p(x))) ? (void)0 : rb_assert_failure("rational.c", 571, __func__, "!k_rational_p(x)")));
    __builtin_choose_expr( __builtin_constant_p(!1 +0), __builtin_choose_expr(!1 +0, ((!k_rational_p(y)) ? (void)0 : rb_assert_failure("rational.c", 572, __func__, "!k_rational_p(y)")), (void)0), ((!(!1 +0) || (!k_rational_p(y))) ? (void)0 : rb_assert_failure("rational.c", 572, __func__, "!k_rational_p(y)")));
...
{
    struct RRational *dat = ((struct RRational*)(self));
    return dat->num;
}
static VALUE
...
{
    const int unused = (__builtin_choose_expr( __builtin_constant_p(!1 +0), __builtin_choose_expr(!1 +0, ((( ((RUBY_T_RATIONAL) == RUBY_T_FIXNUM) ? (((int)(long)(self))&RUBY_FIXNUM_FLAG) : ((RUBY_T_RATIONAL) == RUBY_T_TRUE) ? ((self) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_RATIONAL) == RUBY_T_FALSE) ? ((self) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_RATIONAL) == RUBY_T_NIL) ? ((self) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_RATIONAL) == RUBY_T_UNDEF) ? ((self) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_RATIONAL) == RUBY_T_SYMBOL) ? ((((VALUE)(self)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(self) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(self) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(self))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_RATIONAL) == RUBY_T_FLOAT) ? ( ((((int)(long)(self))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(self) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(self) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(self))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(self) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(self) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(self))->flags & RUBY_T_MASK) == (RUBY_T_RATIONAL)))) ? (void)0 : rb_assert_failure("rational.c", 663, __func__, "RB_TYPE_P(self, T_RATIONAL)")), (void)0), ((!(!1 +0) || (( ((RUBY_T_RATIONAL) == RUBY_T_FIXNUM) ? (((int)(long)(self))&RUBY_FIXNUM_FLAG) : ((RUBY_T_RATIONAL) == RUBY_T_TRUE) ? ((self) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_RATIONAL) == RUBY_T_FALSE) ? ((self) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_RATIONAL) == RUBY_T_NIL) ? ((self) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_RATIONAL) == RUBY_T_UNDEF) ? ((self) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_RATIONAL) == RUBY_T_SYMBOL) ? ((((VALUE)(self)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(self) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(self) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(self))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_RATIONAL) == RUBY_T_FLOAT) ? ( ((((int)(long)(self))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(self) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(self) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(self))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(self) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(self) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(self))->flags & RUBY_T_MASK) == (RUBY_T_RATIONAL))))) ? (void)0 : rb_assert_failure("rational.c", 663, __func__, "RB_TYPE_P(self, T_RATIONAL)"))), 0);
    struct RRational *dat = ((struct RRational*)(self));
    (void)unused;
    return f_rational_new2(rb_class_of((VALUE)(self)), rb_int_uminus(dat->num), dat->den);
}
...
f_imul(long a, long b)
{
 ...
 return rb_long2num_inline(b);
    else if (b == 1)
 return rb_long2num_inline(a);

    if (__builtin_mul_overflow_p((a), (b), (int)0))
 r = rb_big_mul(rb_int2big(a), rb_int2big(b));
    else
        r = rb_long2num_inline(a * b);
    return r;
}
inline static VALUE
f_addsub(VALUE self, VALUE anum, VALUE aden, VALUE bnum, VALUE bden, int k)
{
    ...
    if ((((int)(long)(anum))&RUBY_FIXNUM_FLAG) && (((int)(long)(aden))&RUBY_FIXNUM_FLAG) &&
 (((int)(long)(bnum))&RUBY_FIXNUM_FLAG) && (((int)(long)(bden))&RUBY_FIXNUM_FLAG)) {
 long an = ((long)(((long)(anum))>>(int)(1)));
 long ad = ((long)(((long)(aden))>>(int)(1)));
 long bn = ((long)(((long)(bnum))>>(int)(1)));
 long bd = ((long)(((long)(bden))>>(int)(1)));
 long ig = i_gcd(ad, bd);

 VALUE g = rb_long2num_inline(ig);
 ...
 den = rb_int_mul(a, b);
    ...
    return f_rational_new_no_reduce2(rb_class_of((VALUE)(self)), num, den);
}
...
{
    if ( ({ const VALUE integer_type_obj = (other); ((((int)(long)(integer_type_obj))&RUBY_FIXNUM_FLAG) || (!(((VALUE)(integer_type_obj) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(integer_type_obj) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(integer_type_obj))->flags & RUBY_T_MASK) == RUBY_T_BIGNUM)); })) {
 {
     struct RRational *dat = ((struct RRational*)(self));

     return f_rational_new_no_reduce2(rb_class_of((VALUE)(self)),
          rb_int_plus(dat->num, rb_int_mul(other, dat->den)),
          dat->den);
 }
    }
    else if (( ((((int)(long)(other))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(other) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(other) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(other))->flags & RUBY_T_MASK) == RUBY_T_FLOAT))) {
 return rb_float_new_inline(nurat_to_double(self) + rb_float_value_inline(other));
    }
    else if (( ((RUBY_T_RATIONAL) == RUBY_T_FIXNUM) ? (((int)(long)(other))&RUBY_FIXNUM_FLAG) : ((RUBY_T_RATIONAL) == RUBY_T_TRUE) ? ((other) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_RATIONAL) == RUBY_T_FALSE) ? ((other) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_RATIONAL) == RUBY_T_NIL) ? ((other) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_RATIONAL) == RUBY_T_UNDEF) ? ((other) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_RATIONAL) == RUBY_T_SYMBOL) ? ((((VALUE)(other)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(other) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(other) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(other))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_RATIONAL) == RUBY_T_FLOAT) ? ( ((((int)(long)(other))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(other) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(other) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(other))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(other) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(other) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(other))->flags & RUBY_T_MASK) == (RUBY_T_RATIONAL)))) {
 {
     struct RRational *adat = ((struct RRational*)(self)), *bdat = ((struct RRational*)(other));
...
f_muldiv(VALUE self, VALUE anum, VALUE aden, VALUE bnum, VALUE bden, int k)
{
    ...
    __builtin_choose_expr( __builtin_constant_p(!1 +0), __builtin_choose_expr(!1 +0, ((( ((RUBY_T_RATIONAL) == RUBY_T_FIXNUM) ? (((int)(long)(self))&RUBY_FIXNUM_FLAG) : ((RUBY_T_RATIONAL) == RUBY_T_TRUE) ? ((self) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_RATIONAL) == RUBY_T_FALSE) ? ((self) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_RATIONAL) == RUBY_T_NIL) ? ((self) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_RATIONAL) == RUBY_T_UNDEF) ? ((self) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_RATIONAL) == RUBY_T_SYMBOL) ? ((((VALUE)(self)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(self) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(self) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(self))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_RATIONAL) == RUBY_T_FLOAT) ? ( ((((int)(long)(self))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(self) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(self) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(self))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(self) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(self) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(self))->flags & RUBY_T_MASK) == (RUBY_T_RATIONAL)))) ? (void)0 : rb_assert_failure("rational.c", 841, __func__, "RB_TYPE_P(self, T_RATIONAL)")), (void)0), ((!(!1 +0) || (( ((RUBY_T_RATIONAL) == RUBY_T_FIXNUM) ? (((int)(long)(self))&RUBY_FIXNUM_FLAG) : ((RUBY_T_RATIONAL) == RUBY_T_TRUE) ? ((self) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_RATIONAL) == RUBY_T_FALSE) ? ((self) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_RATIONAL) == RUBY_T_NIL) ? ((self) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_RATIONAL) == RUBY_T_UNDEF) ? ((self) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_RATIONAL) == RUBY_T_SYMBOL) ? ((((VALUE)(self)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(self) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(self) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(self))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_RATIONAL) == RUBY_T_FLOAT) ? ( ((((int)(long)(self))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(self) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(self) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(self))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(self) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(self) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(self))->flags & RUBY_T_MASK) == (RUBY_T_RATIONAL))))) ? (void)0 : rb_assert_failure("rational.c", 841, __func__, "RB_TYPE_P(self, T_RATIONAL)")));
    __builtin_choose_expr( __builtin_constant_p(!1 +0), __builtin_choose_expr(!1 +0, (( ({ const VALUE integer_type_obj = (anum); ((((int)(long)(integer_type_obj))&RUBY_FIXNUM_FLAG) || (!(((VALUE)(integer_type_obj) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(integer_type_obj) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(integer_type_obj))->flags & RUBY_T_MASK) == RUBY_T_BIGNUM)); })) ? (void)0 : rb_assert_failure("rational.c", 842, __func__, "RB_INTEGER_TYPE_P(anum)")), (void)0), ((!(!1 +0) || ( ({ const VALUE integer_type_obj = (anum); ((((int)(long)(integer_type_obj))&RUBY_FIXNUM_FLAG) || (!(((VALUE)(integer_type_obj) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(integer_type_obj) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(integer_type_obj))->flags & RUBY_T_MASK) == RUBY_T_BIGNUM)); }))) ? (void)0 : rb_assert_failure("rational.c", 842, __func__, "RB_INTEGER_TYPE_P(anum)")));
    __builtin_choose_expr( __builtin_constant_p(!1 +0), __builtin_choose_expr(!1 +0, (( ({ const VALUE integer_type_obj = (aden); ((((int)(long)(integer_type_obj))&RUBY_FIXNUM_FLAG) || (!(((VALUE)(integer_type_obj) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(integer_type_obj) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(integer_type_obj))->flags & RUBY_T_MASK) == RUBY_T_BIGNUM)); })) ? (void)0 : rb_assert_failure("rational.c", 843, __func__, "RB_INTEGER_TYPE_P(aden)")), (void)0), ((!(!1 +0) || ( ({ const VALUE integer_type_obj = (aden); ((((int)(long)(integer_type_obj))&RUBY_FIXNUM_FLAG) || (!(((VALUE)(integer_type_obj) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(integer_type_obj) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(integer_type_obj))->flags & RUBY_T_MASK) == RUBY_T_BIGNUM)); }))) ? (void)0 : rb_assert_failure("rational.c", 843, __func__, "RB_INTEGER_TYPE_P(aden)")));
    __builtin_choose_expr( __builtin_constant_p(!1 +0), __builtin_choose_expr(!1 +0, (( ({ const VALUE integer_type_obj = (bnum); ((((int)(long)(integer_type_obj))&RUBY_FIXNUM_FLAG) || (!(((VALUE)(integer_type_obj) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(integer_type_obj) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(integer_type_obj))->flags & RUBY_T_MASK) == RUBY_T_BIGNUM)); })) ? (void)0 : rb_assert_failure("rational.c", 844, __func__, "RB_INTEGER_TYPE_P(bnum)")), (void)0), ((!(!1 +0) || ( ({ const VALUE integer_type_obj = (bnum); ((((int)(long)(integer_type_obj))&RUBY_FIXNUM_FLAG) || (!(((VALUE)(integer_type_obj) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(integer_type_obj) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(integer_type_obj))->flags & RUBY_T_MASK) == RUBY_T_BIGNUM)); }))) ? (void)0 : rb_assert_failure("rational.c", 844, __func__, "RB_INTEGER_TYPE_P(bnum)")));
    __builtin_choose_expr( __builtin_constant_p(!1 +0), __builtin_choose_expr(!1 +0, (( ({ const VALUE integer_type_obj = (bden); ((((int)(long)(integer_type_obj))&RUBY_FIXNUM_FLAG) || (!(((VALUE)(integer_type_obj) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(integer_type_obj) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(integer_type_obj))->flags & RUBY_T_MASK) == RUBY_T_BIGNUM)); })) ? (void)0 : rb_assert_failure("rational.c", 845, __func__, "RB_INTEGER_TYPE_P(bden)")), (void)0), ((!(!1 +0) || ( ({ const VALUE integer_type_obj = (bden); ((((int)(long)(integer_type_obj))&RUBY_FIXNUM_FLAG) || (!(((VALUE)(integer_type_obj) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(integer_type_obj) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(integer_type_obj))->flags & RUBY_T_MASK) == RUBY_T_BIGNUM)); }))) ? (void)0 : rb_assert_failure("rational.c", 845, __func__, "RB_INTEGER_TYPE_P(bden)")));

    if (k == '/') {
 VALUE t;

 if (((((int)(long)(bnum))&RUBY_FIXNUM_FLAG) ? ((long)(bnum) < 0) : (!((((struct RBasic*)(bnum))->flags & ((VALUE)((VALUE)RUBY_FL_USER1))) != 0)))) {
...
nurat_mul(VALUE self, VALUE other)
{
    if ( ({ const VALUE integer_type_obj = (other); ((((int)(long)(integer_type_obj))&RUBY_FIXNUM_FLAG) || (!(((VALUE)(integer_type_obj) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(integer_type_obj) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(integer_type_obj))->flags & RUBY_T_MASK) == RUBY_T_BIGNUM)); })) {
 {
     ...
     return f_muldiv(self,
       dat->num, dat->den,
       other, (((VALUE)(1))<<1 | RUBY_FIXNUM_FLAG), '*');
 }
    }
    else if (( ((((int)(long)(other))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(other) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(other) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(other))->flags & RUBY_T_MASK) == RUBY_T_FLOAT))) {
 return rb_float_new_inline(nurat_to_double(self) * rb_float_value_inline(other));
...
nurat_fdiv(VALUE self, VALUE other)
{
    VALUE div;
    if (f_zero_p(other))
 return rb_float_new_inline(nurat_to_double(self) / 0.0);
    if ((((int)(long)(other))&RUBY_FIXNUM_FLAG) && other == (((VALUE)(1))<<1 | RUBY_FIXNUM_FLAG))
 return nurat_to_f(self);
    div = nurat_div(self, other);
    if (( ((RUBY_T_RATIONAL) == RUBY_T_FIXNUM) ? (((int)(long)(div))&RUBY_FIXNUM_FLAG) : ((RUBY_T_RATIONAL) == RUBY_T_TRUE) ? ((div) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_RATIONAL) == RUBY_T_FALSE) ? ((div) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_RATIONAL) == RUBY_T_NIL) ? ((div) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_RATIONAL) == RUBY_T_UNDEF) ? ((div) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_RATIONAL) == RUBY_T_SYMBOL) ? ((((VALUE)(div)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(div) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(div) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(div))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_RATIONAL) == RUBY_T_FLOAT) ? ( ((((int)(long)(div))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(div) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(div) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(div))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(div) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(div) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(div))->flags & RUBY_T_MASK) == (RUBY_T_RATIONAL))))
 return nurat_to_f(div);
    if (( ((((int)(long)(div))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(div) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(div) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(div))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)))
 return div;
    return rb_funcall(div, (__builtin_constant_p("to_f") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("to_f")), (long)strlen(("to_f"))); (ID) rb_intern_id_cache; }) : rb_intern("to_f")), 0);
}

inline static VALUE
f_odd_p(VALUE integer)
{
    if (rb_funcall(integer, '%', 1, (((VALUE)(2))<<1 | RUBY_FIXNUM_FLAG)) != (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG)) {
...
{
    if (k_numeric_p(other) && ((!k_float_p(other)) && f_zero_p(other)))
 return f_rational_new_bang1(rb_class_of((VALUE)(self)), (((VALUE)(1))<<1 | RUBY_FIXNUM_FLAG));

    if (k_rational_p(other)) {
 struct RRational *dat = ((struct RRational*)(other));
 ...
 if (f_one_p(dat->den))
    ...
    if (k_numeric_p(other) && (!k_float_p(other))) {
 struct RRational *dat = ((struct RRational*)(self));
 if (f_one_p(dat->den)) {
     if (f_one_p(dat->num)) {
  return f_rational_new_bang1(rb_class_of((VALUE)(self)), (((VALUE)(1))<<1 | RUBY_FIXNUM_FLAG));
     }
     else if (f_minus_one_p(dat->num) &&  ({ const VALUE integer_type_obj = (other); ((((int)(long)(integer_type_obj))&RUBY_FIXNUM_FLAG) || (!(((VALUE)(integer_type_obj) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(integer_type_obj) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(integer_type_obj))->flags & RUBY_T_MASK) == RUBY_T_BIGNUM)); })) {
  return f_rational_new_bang1(rb_class_of((VALUE)(self)), (((VALUE)(f_odd_p(other) ? -1 : 1))<<1 | RUBY_FIXNUM_FLAG));
     }
     else if (((((int)(long)(dat->num))&RUBY_FIXNUM_FLAG) ? ((dat->num) == (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG)) : rb_bigzero_p(dat->num))) {
  if (rb_num_negative_p(other)) {
                    rb_num_zerodiv();
  }
  else {
      return f_rational_new_bang1(rb_class_of((VALUE)(self)), (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG));
  }
     }
 }
    }
    ...
    if ((((int)(long)(other))&RUBY_FIXNUM_FLAG)) {
 {
     VALUE num, den;

     struct RRational *dat = ((struct RRational*)(self));

            if (((((int)(long)(other))&RUBY_FIXNUM_FLAG) ? ((long)(other) > (long)(((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG)) : ((((struct RBasic*)(other))->flags & ((VALUE)((VALUE)RUBY_FL_USER1))) != 0))) {
  num = rb_int_pow(dat->num, other);
  den = rb_int_pow(dat->den, other);
            }
            else if (((((int)(long)(other))&RUBY_FIXNUM_FLAG) ? ((long)(other) < 0) : (!((((struct RBasic*)(other))->flags & ((VALUE)((VALUE)RUBY_FL_USER1))) != 0)))) {
  num = rb_int_pow(dat->den, rb_int_uminus(other));
  den = rb_int_pow(dat->num, rb_int_uminus(other));
            }
            else {
  num = (((VALUE)(1))<<1 | RUBY_FIXNUM_FLAG);
  den = (((VALUE)(1))<<1 | RUBY_FIXNUM_FLAG);
     }
     if (( ((((int)(long)(num))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(num) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(num) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(num))->flags & RUBY_T_MASK) == RUBY_T_FLOAT))) {
  if (( ((((int)(long)(den))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(den) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(den) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(den))->flags & RUBY_T_MASK) == RUBY_T_FLOAT))) return rb_float_new_inline((__builtin_nanf ("")));
  return num;
     }
     if (( ((((int)(long)(den))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(den) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(den) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(den))->flags & RUBY_T_MASK) == RUBY_T_FLOAT))) {
  num = (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG);
  den = (((VALUE)(1))<<1 | RUBY_FIXNUM_FLAG);
     }
     return f_rational_new2(rb_class_of((VALUE)(self)), num, den);
 }
    }
    else if (( ((RUBY_T_BIGNUM) == RUBY_T_FIXNUM) ? (((int)(long)(other))&RUBY_FIXNUM_FLAG) : ((RUBY_T_BIGNUM) == RUBY_T_TRUE) ? ((other) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_BIGNUM) == RUBY_T_FALSE) ? ((other) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_BIGNUM) == RUBY_T_NIL) ? ((other) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_BIGNUM) == RUBY_T_UNDEF) ? ((other) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_BIGNUM) == RUBY_T_SYMBOL) ? ((((VALUE)(other)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(other) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(other) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(other))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_BIGNUM) == RUBY_T_FLOAT) ? ( ((((int)(long)(other))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(other) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(other) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(other))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(other) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(other) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(other))->flags & RUBY_T_MASK) == (RUBY_T_BIGNUM)))) {
 rb_warn("in a**b, b may be too big");
 return rb_float_pow(nurat_to_f(self), other);
    }
    else if (( ((((int)(long)(other))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(other) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(other) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(other))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) || ( ((RUBY_T_RATIONAL) == RUBY_T_FIXNUM) ? (((int)(long)(other))&RUBY_FIXNUM_FLAG) : ((RUBY_T_RATIONAL) == RUBY_T_TRUE) ? ((other) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_RATIONAL) == RUBY_T_FALSE) ? ((other) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_RATIONAL) == RUBY_T_NIL) ? ((other) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_RATIONAL) == RUBY_T_UNDEF) ? ((other) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_RATIONAL) == RUBY_T_SYMBOL) ? ((((VALUE)(other)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(other) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(other) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(other))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_RATIONAL) == RUBY_T_FLOAT) ? ( ((((int)(long)(other))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(other) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(other) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(other))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(other) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(other) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(other))->flags & RUBY_T_MASK) == (RUBY_T_RATIONAL)))) {
 return rb_float_pow(nurat_to_f(self), other);
    }
    else {
 return rb_num_coerce_bin(self, other, (__builtin_constant_p("**") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("**")), (long)strlen(("**"))); (ID) rb_intern_id_cache; }) : rb_intern("**")));
    }
}
VALUE
rb_rational_cmp(VALUE self, VALUE other)
{
    if ( ({ const VALUE integer_type_obj = (other); ((((int)(long)(integer_type_obj))&RUBY_FIXNUM_FLAG) || (!(((VALUE)(integer_type_obj) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(integer_type_obj) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(integer_type_obj))->flags & RUBY_T_MASK) == RUBY_T_BIGNUM)); })) {
 {
     ...
     if (dat->den == (((VALUE)(1))<<1 | RUBY_FIXNUM_FLAG))
  return rb_int_cmp(dat->num, other);
     other = f_rational_new_bang1(rb_class_of((VALUE)(self)), other);
     goto other_is_rational;
 }
    }
    else if (( ((((int)(long)(other))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(other) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(other) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(other))->flags & RUBY_T_MASK) == RUBY_T_FLOAT))) {
 return rb_dbl_cmp(nurat_to_double(self), rb_float_value_inline(other));
    }
    else if (( ((RUBY_T_RATIONAL) == RUBY_T_FIXNUM) ? (((int)(long)(other))&RUBY_FIXNUM_FLAG) : ((RUBY_T_RATIONAL) == RUBY_T_TRUE) ? ((other) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_RATIONAL) == RUBY_T_FALSE) ? ((other) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_RATIONAL) == RUBY_T_NIL) ? ((other) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_RATIONAL) == RUBY_T_UNDEF) ? ((other) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_RATIONAL) == RUBY_T_SYMBOL) ? ((((VALUE)(other)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(other) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(other) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(other))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_RATIONAL) == RUBY_T_FLOAT) ? ( ((((int)(long)(other))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(other) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(other) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(other))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(other) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(other) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(other))->flags & RUBY_T_MASK) == (RUBY_T_RATIONAL)))) {
 other_is_rational:
 {
     ...
     if ((((int)(long)(adat->num))&RUBY_FIXNUM_FLAG) && (((int)(long)(adat->den))&RUBY_FIXNUM_FLAG) &&
  (((int)(long)(bdat->num))&RUBY_FIXNUM_FLAG) && (((int)(long)(bdat->den))&RUBY_FIXNUM_FLAG)) {
  num1 = f_imul(((long)(((long)(adat->num))>>(int)(1))), ((long)(((long)(bdat->den))>>(int)(1))));
  num2 = f_imul(((long)(((long)(bdat->num))>>(int)(1))), ((long)(((long)(adat->den))>>(int)(1))));
     }
     else {
  num1 = rb_int_mul(adat->num, bdat->den);
  num2 = rb_int_mul(bdat->num, adat->den);
     }
     return rb_int_cmp(rb_int_minus(num1, num2), (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG));
 }
    }
    else {
...
nurat_eqeq_p(VALUE self, VALUE other)
{
    if ( ({ const VALUE integer_type_obj = (other); ((((int)(long)(integer_type_obj))&RUBY_FIXNUM_FLAG) || (!(((VALUE)(integer_type_obj) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(integer_type_obj) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(integer_type_obj))->flags & RUBY_T_MASK) == RUBY_T_BIGNUM)); })) {
 {
     ...
     if (((((int)(long)(dat->num))&RUBY_FIXNUM_FLAG) ? ((dat->num) == (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG)) : rb_bigzero_p(dat->num)) && ((((int)(long)(other))&RUBY_FIXNUM_FLAG) ? ((other) == (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG)) : rb_bigzero_p(other)))
  return ((VALUE)RUBY_Qtrue);

     if (!(((int)(long)(dat->den))&RUBY_FIXNUM_FLAG))
  return ((VALUE)RUBY_Qfalse);
     if (((long)(((long)(dat->den))>>(int)(1))) != 1)
  return ((VALUE)RUBY_Qfalse);
 ...
 return ((((rb_dbl_cmp(d, rb_float_value_inline(other))) == (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG))) ? ((VALUE)RUBY_Qtrue) : ((VALUE)RUBY_Qfalse));
    }
    else if (( ((RUBY_T_RATIONAL) == RUBY_T_FIXNUM) ? (((int)(long)(other))&RUBY_FIXNUM_FLAG) : ((RUBY_T_RATIONAL) == RUBY_T_TRUE) ? ((other) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_RATIONAL) == RUBY_T_FALSE) ? ((other) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_RATIONAL) == RUBY_T_NIL) ? ((other) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_RATIONAL) == RUBY_T_UNDEF) ? ((other) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_RATIONAL) == RUBY_T_SYMBOL) ? ((((VALUE)(other)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(other) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(other) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(other))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_RATIONAL) == RUBY_T_FLOAT) ? ( ((((int)(long)(other))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(other) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(other) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(other))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(other) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(other) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(other))->flags & RUBY_T_MASK) == (RUBY_T_RATIONAL)))) {
 {
     struct RRational *adat = ((struct RRational*)(self)), *bdat = ((struct RRational*)(other));

     if (((((int)(long)(adat->num))&RUBY_FIXNUM_FLAG) ? ((adat->num) == (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG)) : rb_bigzero_p(adat->num)) && ((((int)(long)(bdat->num))&RUBY_FIXNUM_FLAG) ? ((bdat->num) == (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG)) : rb_bigzero_p(bdat->num)))
  return ((VALUE)RUBY_Qtrue);

     return ((rb_int_equal(adat->num, bdat->num) && rb_int_equal(adat->den, bdat->den)) ? ((VALUE)RUBY_Qtrue) : ((VALUE)RUBY_Qfalse));
...
{
    if ( ({ const VALUE integer_type_obj = (other); ((((int)(long)(integer_type_obj))&RUBY_FIXNUM_FLAG) || (!(((VALUE)(integer_type_obj) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(integer_type_obj) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(integer_type_obj))->flags & RUBY_T_MASK) == RUBY_T_BIGNUM)); })) {
 return rb_assoc_new(f_rational_new_bang1(rb_class_of((VALUE)(self)), other), self);
    }
    else if (( ((((int)(long)(other))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(other) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(other) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(other))->flags & RUBY_T_MASK) == RUBY_T_FLOAT))) {
 ...
 return rb_assoc_new(other, self);
    ...
    else if (( ((RUBY_T_COMPLEX) == RUBY_T_FIXNUM) ? (((int)(long)(other))&RUBY_FIXNUM_FLAG) : ((RUBY_T_COMPLEX) == RUBY_T_TRUE) ? ((other) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_COMPLEX) == RUBY_T_FALSE) ? ((other) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_COMPLEX) == RUBY_T_NIL) ? ((other) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_COMPLEX) == RUBY_T_UNDEF) ? ((other) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_COMPLEX) == RUBY_T_SYMBOL) ? ((((VALUE)(other)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(other) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(other) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(other))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_COMPLEX) == RUBY_T_FLOAT) ? ( ((((int)(long)(other))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(other) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(other) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(other))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(other) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(other) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(other))->flags & RUBY_T_MASK) == (RUBY_T_COMPLEX)))) {
 if (((!k_float_p(((struct RComplex*)(other))->imag)) && f_zero_p(((struct RComplex*)(other))->imag)))
     return rb_assoc_new(f_rational_new_bang1
    (rb_class_of((VALUE)(self)), ((struct RComplex*)(other))->real), self);
 else
     return rb_assoc_new(other, rb_Complex(self, (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG)));
    }
...
{
    struct RRational *dat = ((struct RRational*)(self));
    return ((((((int)(long)(dat->num))&RUBY_FIXNUM_FLAG) ? ((long)(dat->num) > (long)(((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG)) : ((((struct RBasic*)(dat->num))->flags & ((VALUE)((VALUE)RUBY_FL_USER1))) != 0))) ? ((VALUE)RUBY_Qtrue) : ((VALUE)RUBY_Qfalse));
}
...
{
    struct RRational *dat = ((struct RRational*)(self));
    return ((((((int)(long)(dat->num))&RUBY_FIXNUM_FLAG) ? ((long)(dat->num) < 0) : (!((((struct RBasic*)(dat->num))->flags & ((VALUE)((VALUE)RUBY_FL_USER1))) != 0)))) ? ((VALUE)RUBY_Qtrue) : ((VALUE)RUBY_Qfalse));
}
VALUE
rb_rational_abs(VALUE self)
{
    struct RRational *dat = ((struct RRational*)(self));
    if (((((int)(long)(dat->num))&RUBY_FIXNUM_FLAG) ? ((long)(dat->num) < 0) : (!((((struct RBasic*)(dat->num))->flags & ((VALUE)((VALUE)RUBY_FL_USER1))) != 0)))) {
        VALUE num = rb_int_abs(dat->num);
        return nurat_s_canonicalize_internal_no_reduce(rb_class_of((VALUE)(self)), num, dat->den);
    }
    return self;
}
...
nurat_round_half_up(VALUE self)
{
    ...
    num = dat->num;
    den = dat->den;
    neg = ((((int)(long)(num))&RUBY_FIXNUM_FLAG) ? ((long)(num) < 0) : (!((((struct RBasic*)(num))->flags & ((VALUE)((VALUE)RUBY_FL_USER1))) != 0)));

    if (neg)
 num = rb_int_uminus(num);

    num = rb_int_plus(rb_int_mul(num, (((VALUE)(2))<<1 | RUBY_FIXNUM_FLAG)), den);
    den = rb_int_mul(den, (((VALUE)(2))<<1 | RUBY_FIXNUM_FLAG));
...
nurat_round_half_down(VALUE self)
{
 ...
 num = rb_int_uminus(num);
    ...
    num = rb_int_plus(rb_int_mul(num, (((VALUE)(2))<<1 | RUBY_FIXNUM_FLAG)), den);
    num = rb_int_minus(num, (((VALUE)(1))<<1 | RUBY_FIXNUM_FLAG));
    den = rb_int_mul(den, (((VALUE)(2))<<1 | RUBY_FIXNUM_FLAG));
    num = rb_int_idiv(num, den);
...
nurat_round_half_even(VALUE self)
{
 ...
 num = rb_int_uminus(num);
    ...
    if (((((int)(long)((rb_array_const_ptr(qr)[1])))&RUBY_FIXNUM_FLAG) ? (((rb_array_const_ptr(qr)[1])) == (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG)) : rb_bigzero_p((rb_array_const_ptr(qr)[1]))))
 num = rb_int_and(num, (((VALUE)(((int)~1)))<<1 | RUBY_FIXNUM_FLAG));
...
f_round_common(int argc, VALUE *argv, VALUE self, VALUE (*func)(VALUE))
{
 ...
 rb_raise(rb_eTypeError, "not an integer");
    ...
    b = rb_int_pow((((VALUE)(10))<<1 | RUBY_FIXNUM_FLAG), n);
    s = nurat_mul(self, b);

    if (k_float_p(s)) {
 if (((((int)(long)(n))&RUBY_FIXNUM_FLAG) ? ((long)(n) < 0) : (!((((struct RBasic*)(n))->flags & ((VALUE)((VALUE)RUBY_FL_USER1))) != 0))))
     return (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG);
 return self;
    }

    if (!k_rational_p(s)) {
 s = f_rational_new_bang1(rb_class_of((VALUE)(self)), s);
    }

    s = (*func)(s);

    s = nurat_div(f_rational_new_bang1(rb_class_of((VALUE)(self)), s), b);

    if (( ((RUBY_T_RATIONAL) == RUBY_T_FIXNUM) ? (((int)(long)(s))&RUBY_FIXNUM_FLAG) : ((RUBY_T_RATIONAL) == RUBY_T_TRUE) ? ((s) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_RATIONAL) == RUBY_T_FALSE) ? ((s) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_RATIONAL) == RUBY_T_NIL) ? ((s) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_RATIONAL) == RUBY_T_UNDEF) ? ((s) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_RATIONAL) == RUBY_T_SYMBOL) ? ((((VALUE)(s)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(s) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(s) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(s))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_RATIONAL) == RUBY_T_FLOAT) ? ( ((((int)(long)(s))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(s) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(s) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(s))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(s) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(s) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(s))->flags & RUBY_T_MASK) == (RUBY_T_RATIONAL))) && ((int)rb_fix2int((VALUE)(rb_int_cmp(n, (((VALUE)(1))<<1 | RUBY_FIXNUM_FLAG))))) < 0)
 s = nurat_truncate(s);
...
nurat_round_n(int argc, VALUE *argv, VALUE self)
{
 ...
 argc = rb_scan_args(argc, argv, "*:", ((void*)0), &opt),
 rb_num_get_rounding_option(opt));
    VALUE (*round_func)(VALUE) = ((mode) == RUBY_NUM_ROUND_HALF_EVEN ? nurat_round_half_even : (mode) == RUBY_NUM_ROUND_HALF_UP ? nurat_round_half_up : nurat_round_half_down);
...
{
    return rb_float_new_inline(nurat_to_double(self));
}
static VALUE
...
nurat_rationalize_internal(VALUE a, VALUE b, VALUE *p, VALUE *q)
{
    ...
    p0 = (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG);
    p1 = (((VALUE)(1))<<1 | RUBY_FIXNUM_FLAG);
    q0 = (((VALUE)(1))<<1 | RUBY_FIXNUM_FLAG);
    q1 = (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG);

    while (1) {
 c = rb_funcall((a), (__builtin_constant_p("ceil") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("ceil")), (long)strlen(("ceil"))); (ID) rb_intern_id_cache; }) : rb_intern("ceil")), 0);
 if (f_lt_p(c, b))
     break;
 k = f_sub(c, (((VALUE)(1))<<1 | RUBY_FIXNUM_FLAG));
 p2 = f_add(f_mul(k, p1), p0);
 q2 = f_add(f_mul(k, q1), q0);
 t = rb_funcall(((((VALUE)(1))<<1 | RUBY_FIXNUM_FLAG)), (__builtin_constant_p("quo") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("quo")), (long)strlen(("quo"))); (ID) rb_intern_id_cache; }) : rb_intern("quo")), 1, ((f_sub(b, k))));
 b = rb_funcall(((((VALUE)(1))<<1 | RUBY_FIXNUM_FLAG)), (__builtin_constant_p("quo") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("quo")), (long)strlen(("quo"))); (ID) rb_intern_id_cache; }) : rb_intern("quo")), 1, ((f_sub(a, k))));
 a = t;
 p0 = p1;
 q0 = q1;
 p1 = p2;
...
nurat_rationalize(int argc, VALUE *argv, VALUE self)
{
 ...
 return self;
    ...
    return f_rational_new2(rb_class_of((VALUE)(self)), p, q);
}
...
nurat_hash(VALUE self)
{
    ...
    struct RRational *dat = ((struct RRational*)(self));
    n = rb_hash(dat->num);
    h[0] = rb_num2long_inline(n);
    n = rb_hash(dat->den);
    h[1] = rb_num2long_inline(n);
...
f_format(VALUE self, VALUE (*func)(VALUE))
{
    ...
    s = (*func)(dat->num);
     ({ (__builtin_constant_p("/")) ? rb_str_cat((s), ("/"), (long)strlen("/")) : rb_str_cat_cstr((s), ("/")); });
...
{
    return f_format(self, rb_obj_as_string);
}
static VALUE
nurat_inspect(VALUE self)
{
    ...
    s =  ({ (__builtin_constant_p("(")) ? rb_usascii_str_new_static(("("), (long)strlen("(")) : rb_usascii_str_new_cstr("("); });
...
nurat_loader(VALUE self, VALUE a)
{
    ...
    nurat_int_check(den);
    nurat_canonicalize(&num, &den);
    rb_obj_write((VALUE)((dat)), (VALUE *)(&((struct RRational *)(dat))->num), (VALUE)((num)), "rational.c", 1857);
    rb_obj_write((VALUE)((dat)), (VALUE *)(&((struct RRational *)(dat))->den), (VALUE)((den)), "rational.c", 1858);
    (void)(((struct RBasic*)(self))->flags |= RUBY_FL_FREEZE);
...
nurat_marshal_load(VALUE self, VALUE a)
{
    ...
    (!( (((RUBY_T_ARRAY)) == RUBY_T_FIXNUM) ? (((int)(long)((VALUE)(a)))&RUBY_FIXNUM_FLAG) : (((RUBY_T_ARRAY)) == RUBY_T_TRUE) ? (((VALUE)(a)) == ((VALUE)RUBY_Qtrue)) : (((RUBY_T_ARRAY)) == RUBY_T_FALSE) ? (((VALUE)(a)) == ((VALUE)RUBY_Qfalse)) : (((RUBY_T_ARRAY)) == RUBY_T_NIL) ? (((VALUE)(a)) == ((VALUE)RUBY_Qnil)) : (((RUBY_T_ARRAY)) == RUBY_T_UNDEF) ? (((VALUE)(a)) == ((VALUE)RUBY_Qundef)) : (((RUBY_T_ARRAY)) == RUBY_T_SYMBOL) ? ((((VALUE)((VALUE)(a))&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)((VALUE)(a)) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)((VALUE)(a)) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)((VALUE)(a)))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : (((RUBY_T_ARRAY)) == RUBY_T_FLOAT) ? ( ((((int)(long)((VALUE)(a)))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)((VALUE)(a)) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)((VALUE)(a)) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)((VALUE)(a)))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)((VALUE)(a)) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)((VALUE)(a)) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)((VALUE)(a)))->flags & RUBY_T_MASK) == ((RUBY_T_ARRAY)))) || ((RUBY_T_ARRAY) == RUBY_T_DATA && (((struct RTypedData*)(a))->typed_flag == 1)) ? rb_unexpected_type((VALUE)(a), (RUBY_T_ARRAY)) : (void)0);
    if (rb_array_len(a) != 2)
 rb_raise(rb_eArgError, "marshaled rational must have an array whose length is 2 but %ld", rb_array_len(a));

    num = (rb_array_const_ptr(a)[0]);
    den = (rb_array_const_ptr(a)[1]);
    nurat_int_check(num);
    nurat_int_check(den);
    nurat_canonicalize(&num, &den);
...
{
    struct RRational *dat = ((struct RRational*)(x));
    return f_rational_new_no_reduce2(rb_class_of((VALUE)(x)), dat->den, dat->num);
}
VALUE
...
{
    return rb_funcall((rb_funcall((self), (__builtin_constant_p("to_r") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("to_r")), (long)strlen(("to_r"))); (ID) rb_intern_id_cache; }) : rb_intern("to_r")), 0)), (__builtin_constant_p("numerator") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("numerator")), (long)strlen(("numerator"))); (ID) rb_intern_id_cache; }) : rb_intern("numerator")), 0);
}
...
{
    return rb_funcall((rb_funcall((self), (__builtin_constant_p("to_r") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("to_r")), (long)strlen(("to_r"))); (ID) rb_intern_id_cache; }) : rb_intern("to_r")), 0)), (__builtin_constant_p("denominator") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("denominator")), (long)strlen(("denominator"))); (ID) rb_intern_id_cache; }) : rb_intern("denominator")), 0);
}
VALUE
rb_numeric_quo(VALUE x, VALUE y)
{
    if (( ((((int)(long)(y))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(y) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(y) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(y))->flags & RUBY_T_MASK) == RUBY_T_FLOAT))) {
        return rb_funcall(x, (__builtin_constant_p("fdiv") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("fdiv")), (long)strlen(("fdiv"))); (ID) rb_intern_id_cache; }) : rb_intern("fdiv")), 1, y);
    }

    if (canonicalization) {
        x = rb_rational_raw((x), (((VALUE)(1))<<1 | RUBY_FIXNUM_FLAG));
    }
    else {
        x = rb_convert_type(x, RUBY_T_RATIONAL, "Rational", "to_r");
    }
...
{
    double d = rb_float_value_inline(self);
    VALUE r;
...
{
    return rb_rational_new(((((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG)), (((VALUE)(1))<<1 | RUBY_FIXNUM_FLAG));
}
static VALUE
nilclass_rationalize(int argc, VALUE *argv, VALUE self)
{
    rb_scan_args(argc, argv, "01", ((void*)0));
    return nilclass_to_r(self);
}
static VALUE
integer_to_r(VALUE self)
{
    return rb_rational_new((self), (((VALUE)(1))<<1 | RUBY_FIXNUM_FLAG));
}
static VALUE
...
float_decode_internal(VALUE self, VALUE *rf, VALUE *rn)
{
    ...
    f = frexp(rb_float_value_inline(self), &n);
    f = ldexp(f, 53);
    n -= 53;
    *rf = rb_dbl2big(f);
    *rn = (((VALUE)(n))<<1 | RUBY_FIXNUM_FLAG);
}
static VALUE
float_to_r(VALUE self)
{
    ...
    {
 long ln = ((long)(((long)(n))>>(int)(1)));

 if (ln == 0)
     return rb_rational_new((f), (((VALUE)(1))<<1 | RUBY_FIXNUM_FLAG));
 if (ln > 0)
     return rb_rational_new((rb_int_lshift(f, n)), (((VALUE)(1))<<1 | RUBY_FIXNUM_FLAG));
 ln = -ln;
 return rb_rational_new((f), (rb_int_lshift((((VALUE)(1))<<1 | RUBY_FIXNUM_FLAG), (((VALUE)(ln))<<1 | RUBY_FIXNUM_FLAG))));
    }
...
rb_flt_rationalize(VALUE flt)
{
    ...
    if (((((int)(long)(f))&RUBY_FIXNUM_FLAG) ? ((f) == (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG)) : rb_bigzero_p(f)) || ((int)rb_fix2int((VALUE)(n))) >= 0)
        return rb_rational_new((rb_int_lshift(f, n)), (((VALUE)(1))<<1 | RUBY_FIXNUM_FLAG));
...

    {
        ...
        two_times_f = rb_int_mul((((VALUE)(2))<<1 | RUBY_FIXNUM_FLAG), f);
        den = rb_int_lshift((((VALUE)(1))<<1 | RUBY_FIXNUM_FLAG), rb_int_minus((((VALUE)(1))<<1 | RUBY_FIXNUM_FLAG), n));

        a = rb_rational_new((rb_int_minus(two_times_f, (((VALUE)(1))<<1 | RUBY_FIXNUM_FLAG))), (den));
        b = rb_rational_new((rb_int_plus(two_times_f, (((VALUE)(1))<<1 | RUBY_FIXNUM_FLAG))), (den));
    }
    if (nurat_eqeq_p(a, b))
        return float_to_r(flt);
...
float_rationalize(int argc, VALUE *argv, VALUE self)
{
    ...
    if (d < 0.0)
        return rb_rational_uminus(float_rationalize(argc, argv, rb_float_new_inline(-d)));
...
negate_num(VALUE num)
{
 ...
 (((struct RBasic*)(num))->flags ^= ((VALUE)((VALUE)RUBY_FL_USER1)));
...
{
    VALUE fp = (((VALUE)(1))<<1 | RUBY_FIXNUM_FLAG), exp, fn = (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG), n = (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG);
    int expsign = 0, ok = 0;
    char *e;

    *div = (((VALUE)(1))<<1 | RUBY_FIXNUM_FLAG);
    *num = (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG);
    if (*s < end && **s != '.') {
 n = rb_int_parse_cstr(*s, end-*s, &e, ((void*)0),
         10, RB_INT_PARSE_UNDERSCORE);
 if (!((VALUE)(n) != ((VALUE)RUBY_Qnil)))
     return 0;
 *s = e;
 *num = n;
 ok = 1;
 ...
 fp = rb_int_parse_cstr(*s, end-*s, &e, &count,
          10, RB_INT_PARSE_UNDERSCORE);
 if (!((VALUE)(fp) != ((VALUE)RUBY_Qnil)))
     return 1;
 *s = e;
 {
     VALUE l = rb_int_pow((((VALUE)(10))<<1 | RUBY_FIXNUM_FLAG), rb_ulong2num_inline(count));
     n = n == (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG) ? fp : rb_int_plus(rb_int_mul(*num, l), fp);
     *num = n;
     *div = l;
     fn = rb_ulong2num_inline(count);
 }
 ok = 1;
    }
 ...
 exp = rb_int_parse_cstr(*s, end-*s, &e, ((void*)0),
    10, RB_INT_PARSE_UNDERSCORE);
 if (!((VALUE)(exp) != ((VALUE)RUBY_Qnil)))
     return 1;
 *s = e;
 if (exp != (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG)) {
     if (expsign == '-') {
  if (fn != (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG)) exp = rb_int_plus(exp, fn);
  *div = rb_int_pow((((VALUE)(10))<<1 | RUBY_FIXNUM_FLAG), exp);
     }
     else {
  if (fn != (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG)) exp = rb_int_minus(exp, fn);
  if (((((int)(long)(exp))&RUBY_FIXNUM_FLAG) ? ((long)(exp) < 0) : (!((((struct RBasic*)(exp))->flags & ((VALUE)((VALUE)RUBY_FL_USER1))) != 0)))) {
      *div = rb_int_pow((((VALUE)(10))<<1 | RUBY_FIXNUM_FLAG), negate_num(exp));
  }
  else {
      *num = rb_int_mul(n, rb_int_pow((((VALUE)(10))<<1 | RUBY_FIXNUM_FLAG), exp));
      *div = (((VALUE)(1))<<1 | RUBY_FIXNUM_FLAG);
  }
     }
 }
...
{
    while (s < e && ((*__ctype_b_loc ())[(int) (((unsigned char)*s))] & (unsigned short int) _ISspace))
 ++s;
    return s;
}
...
parse_rat(const char *s, const char *const e, int strict)
{
 ...
 if (strict) return ((VALUE)RUBY_Qnil);
 return canonicalization ? (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG) : nurat_s_alloc(rb_cRational);
    }
 ...
 if (!read_num(&s, e, &den, &ddiv)) {
 ...
 else if (den == (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG)) {
     rb_num_zerodiv();
 }
     ...
     if (ndiv != (((VALUE)(1))<<1 | RUBY_FIXNUM_FLAG)) den = rb_int_mul(den, ndiv);
     if (ddiv != (((VALUE)(1))<<1 | RUBY_FIXNUM_FLAG)) num = rb_int_mul(num, ddiv);
 }
    }
    else if (strict && skip_ws(s, e) != e) {
 return ((VALUE)RUBY_Qnil);
 ...
 num = negate_num(num);
    ...
    if (!canonicalization || den != (((VALUE)(1))<<1 | RUBY_FIXNUM_FLAG))
...
string_to_r_strict(VALUE self)
{
    ...
    num = parse_rat((!(((struct RBasic*)(self))->flags & RSTRING_NOEMBED) ? ((struct RString*)(self))->as.ary : ((struct RString*)(self))->as.heap.ptr), (!(((struct RBasic*)(self))->flags & RSTRING_NOEMBED) ? (((struct RString*)(self))->as.ary + (long)((((struct RBasic*)(self))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT))) : (((struct RString*)(self))->as.heap.ptr + ((struct RString*)(self))->as.heap.len)), 1);
    if (!((VALUE)(num) != ((VALUE)RUBY_Qnil))) {
 rb_raise(rb_eArgError, "invalid value for convert(): %+li\v",
   self);
    }
...
string_to_r(VALUE self)
{
    ...
    num = parse_rat((!(((struct RBasic*)(self))->flags & RSTRING_NOEMBED) ? ((struct RString*)(self))->as.ary : ((struct RString*)(self))->as.heap.ptr), (!(((struct RBasic*)(self))->flags & RSTRING_NOEMBED) ? (((struct RString*)(self))->as.ary + (long)((((struct RBasic*)(self))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT))) : (((struct RString*)(self))->as.heap.ptr + ((struct RString*)(self))->as.heap.len)), 0);
...
nurat_s_convert(int argc, VALUE *argv, VALUE klass)
{
    ...
    if (!((VALUE)(a1) != ((VALUE)RUBY_Qnil)) || (argc == 2 && !((VALUE)(a2) != ((VALUE)RUBY_Qnil))))
 rb_raise(rb_eTypeError, "can't convert nil into Rational");

    if (( ((RUBY_T_COMPLEX) == RUBY_T_FIXNUM) ? (((int)(long)(a1))&RUBY_FIXNUM_FLAG) : ((RUBY_T_COMPLEX) == RUBY_T_TRUE) ? ((a1) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_COMPLEX) == RUBY_T_FALSE) ? ((a1) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_COMPLEX) == RUBY_T_NIL) ? ((a1) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_COMPLEX) == RUBY_T_UNDEF) ? ((a1) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_COMPLEX) == RUBY_T_SYMBOL) ? ((((VALUE)(a1)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(a1) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(a1) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(a1))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_COMPLEX) == RUBY_T_FLOAT) ? ( ((((int)(long)(a1))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(a1) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(a1) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(a1))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(a1) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(a1) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(a1))->flags & RUBY_T_MASK) == (RUBY_T_COMPLEX)))) {
 if (((!k_float_p(((struct RComplex*)(a1))->imag)) && f_zero_p(((struct RComplex*)(a1))->imag)))
     a1 = ((struct RComplex*)(a1))->real;
    }

    if (( ((RUBY_T_COMPLEX) == RUBY_T_FIXNUM) ? (((int)(long)(a2))&RUBY_FIXNUM_FLAG) : ((RUBY_T_COMPLEX) == RUBY_T_TRUE) ? ((a2) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_COMPLEX) == RUBY_T_FALSE) ? ((a2) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_COMPLEX) == RUBY_T_NIL) ? ((a2) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_COMPLEX) == RUBY_T_UNDEF) ? ((a2) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_COMPLEX) == RUBY_T_SYMBOL) ? ((((VALUE)(a2)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(a2) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(a2) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(a2))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_COMPLEX) == RUBY_T_FLOAT) ? ( ((((int)(long)(a2))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(a2) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(a2) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(a2))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(a2) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(a2) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(a2))->flags & RUBY_T_MASK) == (RUBY_T_COMPLEX)))) {
 if (((!k_float_p(((struct RComplex*)(a2))->imag)) && f_zero_p(((struct RComplex*)(a2))->imag)))
     a2 = ((struct RComplex*)(a2))->real;
    }

    backref = rb_backref_get();
    rb_match_busy(backref);

    if (( ((((int)(long)(a1))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(a1) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(a1) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(a1))->flags & RUBY_T_MASK) == RUBY_T_FLOAT))) {
 a1 = float_to_r(a1);
    }
    else if (( ((RUBY_T_STRING) == RUBY_T_FIXNUM) ? (((int)(long)(a1))&RUBY_FIXNUM_FLAG) : ((RUBY_T_STRING) == RUBY_T_TRUE) ? ((a1) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_STRING) == RUBY_T_FALSE) ? ((a1) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_STRING) == RUBY_T_NIL) ? ((a1) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_STRING) == RUBY_T_UNDEF) ? ((a1) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_STRING) == RUBY_T_SYMBOL) ? ((((VALUE)(a1)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(a1) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(a1) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(a1))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_STRING) == RUBY_T_FLOAT) ? ( ((((int)(long)(a1))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(a1) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(a1) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(a1))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(a1) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(a1) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(a1))->flags & RUBY_T_MASK) == (RUBY_T_STRING)))) {
 a1 = string_to_r_strict(a1);
    }

    if (( ((((int)(long)(a2))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(a2) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(a2) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(a2))->flags & RUBY_T_MASK) == RUBY_T_FLOAT))) {
 a2 = float_to_r(a2);
    }
    else if (( ((RUBY_T_STRING) == RUBY_T_FIXNUM) ? (((int)(long)(a2))&RUBY_FIXNUM_FLAG) : ((RUBY_T_STRING) == RUBY_T_TRUE) ? ((a2) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_STRING) == RUBY_T_FALSE) ? ((a2) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_STRING) == RUBY_T_NIL) ? ((a2) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_STRING) == RUBY_T_UNDEF) ? ((a2) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_STRING) == RUBY_T_SYMBOL) ? ((((VALUE)(a2)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(a2) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(a2) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(a2))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_STRING) == RUBY_T_FLOAT) ? ( ((((int)(long)(a2))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(a2) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(a2) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(a2))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(a2) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(a2) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(a2))->flags & RUBY_T_MASK) == (RUBY_T_STRING)))) {
 a2 = string_to_r_strict(a2);
    }

    rb_backref_set(backref);

    if (( ((RUBY_T_RATIONAL) == RUBY_T_FIXNUM) ? (((int)(long)(a1))&RUBY_FIXNUM_FLAG) : ((RUBY_T_RATIONAL) == RUBY_T_TRUE) ? ((a1) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_RATIONAL) == RUBY_T_FALSE) ? ((a1) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_RATIONAL) == RUBY_T_NIL) ? ((a1) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_RATIONAL) == RUBY_T_UNDEF) ? ((a1) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_RATIONAL) == RUBY_T_SYMBOL) ? ((((VALUE)(a1)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(a1) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(a1) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(a1))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_RATIONAL) == RUBY_T_FLOAT) ? ( ((((int)(long)(a1))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(a1) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(a1) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(a1))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(a1) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(a1) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(a1))->flags & RUBY_T_MASK) == (RUBY_T_RATIONAL)))) {
 if (argc == 1 || (((!k_float_p(a2)) && f_one_p(a2))))
     return a1;
    }

    if (argc == 1) {
 if (!(k_numeric_p(a1) && k_integer_p(a1)))
     return rb_convert_type_with_id(a1, RUBY_T_RATIONAL, "Rational", idTo_r);
    }
    else {
...
Init_Rational(void)
{
    ...
    __builtin_choose_expr( __builtin_constant_p(!1 +0), __builtin_choose_expr(!1 +0, ((fprintf(stderr, "assert() is now active\n")) ? (void)0 : rb_assert_failure("rational.c", 2687, __func__, "fprintf(stderr, \"assert() is now active\\n\")")), (void)0), ((!(!1 +0) || (fprintf(stderr, "assert() is now active\n"))) ? (void)0 : rb_assert_failure("rational.c", 2687, __func__, "fprintf(stderr, \"assert() is now active\\n\")")));

    id_abs = (__builtin_constant_p("abs") ?  (rb_intern2(("abs"), (long)strlen("abs"))) : (rb_intern)("abs"));
    id_idiv = (__builtin_constant_p("div") ?  (rb_intern2(("div"), (long)strlen("div"))) : (rb_intern)("div"));
    id_integer_p = (__builtin_constant_p("integer?") ?  (rb_intern2(("integer?"), (long)strlen("integer?"))) : (rb_intern)("integer?"));
    id_to_i = (__builtin_constant_p("to_i") ?  (rb_intern2(("to_i"), (long)strlen("to_i"))) : (rb_intern)("to_i"));
    id_i_num = (__builtin_constant_p("@numerator") ?  (rb_intern2(("@numerator"), (long)strlen("@numerator"))) : (rb_intern)("@numerator"));
    id_i_den = (__builtin_constant_p("@denominator") ?  (rb_intern2(("@denominator"), (long)strlen("@denominator"))) : (rb_intern)("@denominator"));

    rb_cRational = rb_define_class("Rational", rb_cNumeric);

    rb_define_alloc_func(rb_cRational, nurat_s_alloc);
    rb_undef_method(rb_class_of((VALUE)(rb_cRational)), "allocate");





    rb_undef_method(rb_class_of((VALUE)(rb_cRational)), "new");
    ...
    rb_define_private_method(rb_class_of((VALUE)(rb_cRational)), "convert", nurat_s_convert, -1);
