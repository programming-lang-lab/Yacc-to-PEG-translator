...
error_pos(const VALUE str)
{
    ...
    if (!!((VALUE)(pos) != ((VALUE)RUBY_Qnil))) {
 !((VALUE)(str) != ((VALUE)RUBY_Qnil)) ? rb_write_error_str(pos) : (void)rb_str_concat((str), (pos));
    }
}
...
error_pos_str(void)
{
    ...
    if (!!((VALUE)(sourcefile) != ((VALUE)RUBY_Qnil))) {
 ID caller_name;
 if (sourceline == 0) {
     return rb_sprintf("%li\v: ", sourcefile);
 }
 else if ((caller_name = rb_frame_callee()) != 0) {
     return rb_sprintf("%li\v:%d:in `%li\v': ",
         sourcefile, sourceline,
         rb_id2str(caller_name));
 }
 else {
     return rb_sprintf("%li\v:%d: ", sourcefile, sourceline);
 }
    }
...
{
    ID set_backtrace = (__builtin_constant_p("set_backtrace") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("set_backtrace")), (long)strlen(("set_backtrace"))); (ID) rb_intern_id_cache; }) : rb_intern("set_backtrace"));

    if (rb_backtrace_p(bt)) {
 if (rb_method_basic_definition_p(rb_class_of((VALUE)(info)), set_backtrace)) {
...
print_errinfo(const VALUE eclass, const VALUE errat, const VALUE emesg, const VALUE str, int colored)
{
    ...
    if (emesg != ((VALUE)RUBY_Qundef)) {
 if (!((VALUE)(errat) != ((VALUE)RUBY_Qnil)) || rb_array_len(errat) == 0 ||
     !((VALUE)(mesg = (rb_array_const_ptr(errat)[0])) != ((VALUE)RUBY_Qnil))) {
     error_pos(str);
 }
 else {
     !((VALUE)(str) != ((VALUE)RUBY_Qnil)) ? rb_write_error_str(mesg) : (void)rb_str_concat((str), (mesg));
      ({ !((VALUE)(str) != ((VALUE)RUBY_Qnil)) ?  ({ (__builtin_constant_p(": ")) ? rb_write_error2((": "), (long)strlen(": ")) : rb_write_error(": "); }) : (void)( (__builtin_constant_p(": ")) ? rb_str_concat((str),  ({ (__builtin_constant_p((": ")) && __builtin_constant_p((long)strlen(": "))) ? rb_str_new_static(((": ")), ((long)strlen(": "))) : rb_str_new(((": ")), ((long)strlen(": "))); })) : rb_str_concat((str),  ({ (__builtin_constant_p(": ")) ? rb_str_new_static((": "), (long)strlen(": ")) : rb_str_new_cstr(": "); })) ); });
 }

        if (colored)  ({ !((VALUE)(str) != ((VALUE)RUBY_Qnil)) ?  ({ (__builtin_constant_p(bold)) ? rb_write_error2((bold), (long)strlen(bold)) : rb_write_error(bold); }) : (void)( (__builtin_constant_p(bold)) ? rb_str_concat((str),  ({ (__builtin_constant_p((bold)) && __builtin_constant_p((long)strlen(bold))) ? rb_str_new_static(((bold)), ((long)strlen(bold))) : rb_str_new(((bold)), ((long)strlen(bold))); })) : rb_str_concat((str),  ({ (__builtin_constant_p(bold)) ? rb_str_new_static((bold), (long)strlen(bold)) : rb_str_new_cstr(bold); })) ); });

 if (!!((VALUE)(emesg) != ((VALUE)RUBY_Qnil))) {
     einfo = (!(((struct RBasic*)(emesg))->flags & RSTRING_NOEMBED) ? ((struct RString*)(emesg))->as.ary : ((struct RString*)(emesg))->as.heap.ptr);
            elen = (!(((struct RBasic*)(emesg))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(emesg))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(emesg))->as.heap.len);
 }
    }

    if (eclass == rb_eRuntimeError && elen == 0) {
        if (colored)  ({ !((VALUE)(str) != ((VALUE)RUBY_Qnil)) ?  ({ (__builtin_constant_p(underline)) ? rb_write_error2((underline), (long)strlen(underline)) : rb_write_error(underline); }) : (void)( (__builtin_constant_p(underline)) ? rb_str_concat((str),  ({ (__builtin_constant_p((underline)) && __builtin_constant_p((long)strlen(underline))) ? rb_str_new_static(((underline)), ((long)strlen(underline))) : rb_str_new(((underline)), ((long)strlen(underline))); })) : rb_str_concat((str),  ({ (__builtin_constant_p(underline)) ? rb_str_new_static((underline), (long)strlen(underline)) : rb_str_new_cstr(underline); })) ); });
  ({ !((VALUE)(str) != ((VALUE)RUBY_Qnil)) ?  ({ (__builtin_constant_p("unhandled exception\n")) ? rb_write_error2(("unhandled exception\n"), (long)strlen("unhandled exception\n")) : rb_write_error("unhandled exception\n"); }) : (void)( (__builtin_constant_p("unhandled exception\n")) ? rb_str_concat((str),  ({ (__builtin_constant_p(("unhandled exception\n")) && __builtin_constant_p((long)strlen("unhandled exception\n"))) ? rb_str_new_static((("unhandled exception\n")), ((long)strlen("unhandled exception\n"))) : rb_str_new((("unhandled exception\n")), ((long)strlen("unhandled exception\n"))); })) : rb_str_concat((str),  ({ (__builtin_constant_p("unhandled exception\n")) ? rb_str_new_static(("unhandled exception\n"), (long)strlen("unhandled exception\n")) : rb_str_new_cstr("unhandled exception\n"); })) ); });
    }
    else {
 VALUE epath;
 ...
 if (elen == 0) {
            if (colored)  ({ !((VALUE)(str) != ((VALUE)RUBY_Qnil)) ?  ({ (__builtin_constant_p(underline)) ? rb_write_error2((underline), (long)strlen(underline)) : rb_write_error(underline); }) : (void)( (__builtin_constant_p(underline)) ? rb_str_concat((str),  ({ (__builtin_constant_p((underline)) && __builtin_constant_p((long)strlen(underline))) ? rb_str_new_static(((underline)), ((long)strlen(underline))) : rb_str_new(((underline)), ((long)strlen(underline))); })) : rb_str_concat((str),  ({ (__builtin_constant_p(underline)) ? rb_str_new_static((underline), (long)strlen(underline)) : rb_str_new_cstr(underline); })) ); });
     !((VALUE)(str) != ((VALUE)RUBY_Qnil)) ? rb_write_error_str(epath) : (void)rb_str_concat((str), (epath));
      ({ !((VALUE)(str) != ((VALUE)RUBY_Qnil)) ?  ({ (__builtin_constant_p("\n")) ? rb_write_error2(("\n"), (long)strlen("\n")) : rb_write_error("\n"); }) : (void)( (__builtin_constant_p("\n")) ? rb_str_concat((str),  ({ (__builtin_constant_p(("\n")) && __builtin_constant_p((long)strlen("\n"))) ? rb_str_new_static((("\n")), ((long)strlen("\n"))) : rb_str_new((("\n")), ((long)strlen("\n"))); })) : rb_str_concat((str),  ({ (__builtin_constant_p("\n")) ? rb_str_new_static(("\n"), (long)strlen("\n")) : rb_str_new_cstr("\n"); })) ); });
 }
 else {
     const char *tail = 0;
     long len = elen;

     if ((!(((struct RBasic*)(epath))->flags & RSTRING_NOEMBED) ? ((struct RString*)(epath))->as.ary : ((struct RString*)(epath))->as.heap.ptr)[0] == '#')
  epath = 0;
     if ((tail = memchr(einfo, '\n', elen)) != 0) {
  len = tail - einfo;
  tail++;
     }
     !((VALUE)(str) != ((VALUE)RUBY_Qnil)) ? rb_write_error_str(tail ? rb_str_subseq(emesg, 0, len) : emesg) : (void)rb_str_concat((str), (tail ? rb_str_subseq(emesg, 0, len) : emesg));
     if (epath) {
   ({ !((VALUE)(str) != ((VALUE)RUBY_Qnil)) ?  ({ (__builtin_constant_p(" (")) ? rb_write_error2((" ("), (long)strlen(" (")) : rb_write_error(" ("); }) : (void)( (__builtin_constant_p(" (")) ? rb_str_concat((str),  ({ (__builtin_constant_p((" (")) && __builtin_constant_p((long)strlen(" ("))) ? rb_str_new_static(((" (")), ((long)strlen(" ("))) : rb_str_new(((" (")), ((long)strlen(" ("))); })) : rb_str_concat((str),  ({ (__builtin_constant_p(" (")) ? rb_str_new_static((" ("), (long)strlen(" (")) : rb_str_new_cstr(" ("); })) ); });
                if (colored)  ({ !((VALUE)(str) != ((VALUE)RUBY_Qnil)) ?  ({ (__builtin_constant_p(underline)) ? rb_write_error2((underline), (long)strlen(underline)) : rb_write_error(underline); }) : (void)( (__builtin_constant_p(underline)) ? rb_str_concat((str),  ({ (__builtin_constant_p((underline)) && __builtin_constant_p((long)strlen(underline))) ? rb_str_new_static(((underline)), ((long)strlen(underline))) : rb_str_new(((underline)), ((long)strlen(underline))); })) : rb_str_concat((str),  ({ (__builtin_constant_p(underline)) ? rb_str_new_static((underline), (long)strlen(underline)) : rb_str_new_cstr(underline); })) ); });
                !((VALUE)(str) != ((VALUE)RUBY_Qnil)) ? rb_write_error_str(epath) : (void)rb_str_concat((str), (epath));
                if (colored)  ({ !((VALUE)(str) != ((VALUE)RUBY_Qnil)) ?  ({ (__builtin_constant_p(reset)) ? rb_write_error2((reset), (long)strlen(reset)) : rb_write_error(reset); }) : (void)( (__builtin_constant_p(reset)) ? rb_str_concat((str),  ({ (__builtin_constant_p((reset)) && __builtin_constant_p((long)strlen(reset))) ? rb_str_new_static(((reset)), ((long)strlen(reset))) : rb_str_new(((reset)), ((long)strlen(reset))); })) : rb_str_concat((str),  ({ (__builtin_constant_p(reset)) ? rb_str_new_static((reset), (long)strlen(reset)) : rb_str_new_cstr(reset); })) ); });
                if (colored)  ({ !((VALUE)(str) != ((VALUE)RUBY_Qnil)) ?  ({ (__builtin_constant_p(bold)) ? rb_write_error2((bold), (long)strlen(bold)) : rb_write_error(bold); }) : (void)( (__builtin_constant_p(bold)) ? rb_str_concat((str),  ({ (__builtin_constant_p((bold)) && __builtin_constant_p((long)strlen(bold))) ? rb_str_new_static(((bold)), ((long)strlen(bold))) : rb_str_new(((bold)), ((long)strlen(bold))); })) : rb_str_concat((str),  ({ (__builtin_constant_p(bold)) ? rb_str_new_static((bold), (long)strlen(bold)) : rb_str_new_cstr(bold); })) ); });
   ({ !((VALUE)(str) != ((VALUE)RUBY_Qnil)) ?  ({ (__builtin_constant_p(")\n")) ? rb_write_error2((")\n"), (long)strlen(")\n")) : rb_write_error(")\n"); }) : (void)( (__builtin_constant_p(")\n")) ? rb_str_concat((str),  ({ (__builtin_constant_p((")\n")) && __builtin_constant_p((long)strlen(")\n"))) ? rb_str_new_static(((")\n")), ((long)strlen(")\n"))) : rb_str_new(((")\n")), ((long)strlen(")\n"))); })) : rb_str_concat((str),  ({ (__builtin_constant_p(")\n")) ? rb_str_new_static((")\n"), (long)strlen(")\n")) : rb_str_new_cstr(")\n"); })) ); });
     }
     if (tail) {
  !((VALUE)(str) != ((VALUE)RUBY_Qnil)) ? rb_write_error_str(rb_str_subseq(emesg, tail - einfo, elen - len - 1)) : (void)rb_str_concat((str), (rb_str_subseq(emesg, tail - einfo, elen - len - 1)));
     }
     if (tail ? einfo[elen-1] != '\n' : !epath) !((VALUE)(str) != ((VALUE)RUBY_Qnil)) ? rb_write_error2(("\n"),(1)) : (void)rb_str_concat((str),  ({ (__builtin_constant_p(("\n")) && __builtin_constant_p((1))) ? rb_str_new_static((("\n")), ((1))) : rb_str_new((("\n")), ((1))); }));
 }
    }
    if (colored)  ({ !((VALUE)(str) != ((VALUE)RUBY_Qnil)) ?  ({ (__builtin_constant_p(reset)) ? rb_write_error2((reset), (long)strlen(reset)) : rb_write_error(reset); }) : (void)( (__builtin_constant_p(reset)) ? rb_str_concat((str),  ({ (__builtin_constant_p((reset)) && __builtin_constant_p((long)strlen(reset))) ? rb_str_new_static(((reset)), ((long)strlen(reset))) : rb_str_new(((reset)), ((long)strlen(reset))); })) : rb_str_concat((str),  ({ (__builtin_constant_p(reset)) ? rb_str_new_static((reset), (long)strlen(reset)) : rb_str_new_cstr(reset); })) ); });
}
...
{
    if (!!((VALUE)(errat) != ((VALUE)RUBY_Qnil))) {
 long i;
 long len = rb_array_len(errat);
 ...
 for (i = 1; i < len; i++) {
     VALUE line = (rb_array_const_ptr(errat)[reverse ? len - i : i]);
  ...
  VALUE bt =  ({ (__builtin_constant_p("\t")) ? rb_str_new_static(("\t"), (long)strlen("\t")) : rb_str_new_cstr("\t"); });
  if (reverse) rb_str_catf(bt, "%*ld: ", width, len - i);
  !((VALUE)(str) != ((VALUE)RUBY_Qnil)) ? rb_write_error_str(rb_str_catf(bt, "from %li\v\n", line)) : (void)rb_str_concat((str), (rb_str_catf(bt, "from %li\v\n", line)));
     }
     if (skip && i == 8 && len > (8 +5 +5)) {
  !((VALUE)(str) != ((VALUE)RUBY_Qnil)) ? rb_write_error_str(rb_sprintf("\t ... %ld levels...\n", len - 8 - 5)) : (void)rb_str_concat((str), (rb_sprintf("\t ... %ld levels...\n", len - 8 - 5)));
...
{
    volatile VALUE eclass = ((VALUE)RUBY_Qundef), emesg = ((VALUE)RUBY_Qundef);

    if (!((VALUE)(errinfo) != ((VALUE)RUBY_Qnil)))
 return;

    if (errat == ((VALUE)RUBY_Qundef)) {
 errat = ((VALUE)RUBY_Qnil);
    }
    if ((eclass = rb_class_of((VALUE)(errinfo))) != ((VALUE)RUBY_Qundef)) {
 VALUE e = rb_check_funcall(errinfo, (__builtin_constant_p("message") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("message")), (long)strlen(("message"))); (ID) rb_intern_id_cache; }) : rb_intern("message")), 0, 0);
 if (e != ((VALUE)RUBY_Qundef)) {
     if (!( ((RUBY_T_STRING) == RUBY_T_FIXNUM) ? (((int)(long)(e))&RUBY_FIXNUM_FLAG) : ((RUBY_T_STRING) == RUBY_T_TRUE) ? ((e) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_STRING) == RUBY_T_FALSE) ? ((e) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_STRING) == RUBY_T_NIL) ? ((e) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_STRING) == RUBY_T_UNDEF) ? ((e) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_STRING) == RUBY_T_SYMBOL) ? ((((VALUE)(e)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(e) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(e) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(e))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_STRING) == RUBY_T_FLOAT) ? ( ((((int)(long)(e))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(e) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(e) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(e))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(e) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(e) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(e))->flags & RUBY_T_MASK) == (RUBY_T_STRING)))) e = rb_check_string_type(e);
     emesg = e;
 }
    }
    if (!((VALUE)(reverse) != ((VALUE)RUBY_Qnil)) || !((VALUE)(highlight) != ((VALUE)RUBY_Qnil))) {
 VALUE tty = (VALUE)rb_stderr_tty_p();
 if (!((VALUE)(reverse) != ((VALUE)RUBY_Qnil))) reverse = tty;
 if (!((VALUE)(highlight) != ((VALUE)RUBY_Qnil))) highlight = tty;
    }
    if (reverse) {
 static const char traceback[] = "Traceback (most recent call last):\n";
 const int bold_part = (sizeof("Traceback") - 1);
 char buff[sizeof(traceback)+sizeof(bold)+sizeof(reset)-2], *p = buff;
 const char *msg = traceback;
 long len = sizeof(traceback) - 1;
 if (highlight) {

     (memcpy(p, bold, sizeof(bold)-1), p += (sizeof(bold)-1));
     (memcpy(p, traceback, bold_part), p += (bold_part));
     (memcpy(p, reset, sizeof(reset)-1), p += (sizeof(reset)-1));
     (memcpy(p, traceback + bold_part, sizeof(traceback)-bold_part-1), p += (sizeof(traceback)-bold_part-1));

     len = p - (msg = buff);
 }
 !((VALUE)(str) != ((VALUE)RUBY_Qnil)) ? rb_write_error2((msg),(len)) : (void)rb_str_concat((str),  ({ (__builtin_constant_p((msg)) && __builtin_constant_p((len))) ? rb_str_new_static(((msg)), ((len))) : rb_str_new(((msg)), ((len))); }));
...
rb_ec_error_print(rb_execution_context_t * volatile ec, volatile VALUE errinfo)
{
 ...
 errat = rb_get_backtrace(errinfo);
    ...
    rb_error_write(errinfo, errat, ((VALUE)RUBY_Qnil), ((VALUE)RUBY_Qnil), ((VALUE)RUBY_Qnil));

    _ec->tag = _tag.prev; } while (0);
    ec->errinfo = errinfo;
    ((ec)->raised_flag |= (raised_flag));
}
...
{
    const int is_mod = ( ((RUBY_T_MODULE) == RUBY_T_FIXNUM) ? (((int)(long)(klass))&RUBY_FIXNUM_FLAG) : ((RUBY_T_MODULE) == RUBY_T_TRUE) ? ((klass) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_MODULE) == RUBY_T_FALSE) ? ((klass) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_MODULE) == RUBY_T_NIL) ? ((klass) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_MODULE) == RUBY_T_UNDEF) ? ((klass) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_MODULE) == RUBY_T_SYMBOL) ? ((((VALUE)(klass)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(klass) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(klass) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(klass))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_MODULE) == RUBY_T_FLOAT) ? ( ((((int)(long)(klass))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(klass) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(klass) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(klass))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(klass) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(klass) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(klass))->flags & RUBY_T_MASK) == (RUBY_T_MODULE)));
    VALUE mesg;
    switch (visi & METHOD_VISI_MASK) {
      case METHOD_VISI_UNDEF:
      case METHOD_VISI_PUBLIC: mesg = ( is_mod ?  ({ (__builtin_constant_p("undefined method `%1$s' for module `%2$s'")) ? rb_fstring_new(("undefined method `%1$s' for module `%2$s'"), (long)strlen("undefined method `%1$s' for module `%2$s'")) : rb_fstring_cstr("undefined method `%1$s' for module `%2$s'"); }) :  ({ (__builtin_constant_p("undefined method `%1$s' for class `%2$s'")) ? rb_fstring_new(("undefined method `%1$s' for class `%2$s'"), (long)strlen("undefined method `%1$s' for class `%2$s'")) : rb_fstring_cstr("undefined method `%1$s' for class `%2$s'"); })); break;
      case METHOD_VISI_PRIVATE: mesg = ( is_mod ?  ({ (__builtin_constant_p("undefined private method `%1$s' for module `%2$s'")) ? rb_fstring_new(("undefined private method `%1$s' for module `%2$s'"), (long)strlen("undefined private method `%1$s' for module `%2$s'")) : rb_fstring_cstr("undefined private method `%1$s' for module `%2$s'"); }) :  ({ (__builtin_constant_p("undefined private method `%1$s' for class `%2$s'")) ? rb_fstring_new(("undefined private method `%1$s' for class `%2$s'"), (long)strlen("undefined private method `%1$s' for class `%2$s'")) : rb_fstring_cstr("undefined private method `%1$s' for class `%2$s'"); })); break;
      case METHOD_VISI_PROTECTED: mesg = ( is_mod ?  ({ (__builtin_constant_p("undefined protected method `%1$s' for module `%2$s'")) ? rb_fstring_new(("undefined protected method `%1$s' for module `%2$s'"), (long)strlen("undefined protected method `%1$s' for module `%2$s'")) : rb_fstring_cstr("undefined protected method `%1$s' for module `%2$s'"); }) :  ({ (__builtin_constant_p("undefined protected method `%1$s' for class `%2$s'")) ? rb_fstring_new(("undefined protected method `%1$s' for class `%2$s'"), (long)strlen("undefined protected method `%1$s' for class `%2$s'")) : rb_fstring_cstr("undefined protected method `%1$s' for class `%2$s'"); })); break;
      default: __builtin_unreachable();
    }
    rb_exc_raise(rb_name_err_new(mesg, klass, (rb_id2sym(id))));
}
...
rb_print_inaccessible(VALUE klass, ID id, rb_method_visibility_t visi)
{
    ...
    switch (visi & METHOD_VISI_MASK) {
      case METHOD_VISI_UNDEF:
      case METHOD_VISI_PUBLIC: mesg = ( is_mod ?  ({ (__builtin_constant_p("method `%1$s' for module `%2$s' is ")) ? rb_fstring_new(("method `%1$s' for module `%2$s' is "), (long)strlen("method `%1$s' for module `%2$s' is ")) : rb_fstring_cstr("method `%1$s' for module `%2$s' is "); }) :  ({ (__builtin_constant_p("method `%1$s' for class `%2$s' is ")) ? rb_fstring_new(("method `%1$s' for class `%2$s' is "), (long)strlen("method `%1$s' for class `%2$s' is ")) : rb_fstring_cstr("method `%1$s' for class `%2$s' is "); })); break;
      case METHOD_VISI_PRIVATE: mesg = ( is_mod ?  ({ (__builtin_constant_p("method `%1$s' for module `%2$s' is  private")) ? rb_fstring_new(("method `%1$s' for module `%2$s' is  private"), (long)strlen("method `%1$s' for module `%2$s' is  private")) : rb_fstring_cstr("method `%1$s' for module `%2$s' is  private"); }) :  ({ (__builtin_constant_p("method `%1$s' for class `%2$s' is  private")) ? rb_fstring_new(("method `%1$s' for class `%2$s' is  private"), (long)strlen("method `%1$s' for class `%2$s' is  private")) : rb_fstring_cstr("method `%1$s' for class `%2$s' is  private"); })); break;
      case METHOD_VISI_PROTECTED: mesg = ( is_mod ?  ({ (__builtin_constant_p("method `%1$s' for module `%2$s' is  protected")) ? rb_fstring_new(("method `%1$s' for module `%2$s' is  protected"), (long)strlen("method `%1$s' for module `%2$s' is  protected")) : rb_fstring_cstr("method `%1$s' for module `%2$s' is  protected"); }) :  ({ (__builtin_constant_p("method `%1$s' for class `%2$s' is  protected")) ? rb_fstring_new(("method `%1$s' for class `%2$s' is  protected"), (long)strlen("method `%1$s' for class `%2$s' is  protected")) : rb_fstring_cstr("method `%1$s' for class `%2$s' is  protected"); })); break;
      default: __builtin_unreachable();
    }
    rb_exc_raise(rb_name_err_new(mesg, klass, (rb_id2sym(id))));
}
...
{
    VALUE st = rb_ivar_get(err, ruby_static_id_status);
    return rb_num2int_inline(st);
}
...
error_handle(int ex)
{
 ...
 return 1;
    switch (ex & RUBY_TAG_MASK) {
      case 0:
 status = 0;
 break;

      case RUBY_TAG_RETURN:
 error_pos(((VALUE)RUBY_Qnil));
  ({ (__builtin_constant_p("unexpected return\n")) ? rb_write_error2(("unexpected return\n"), (long)strlen("unexpected return\n")) : rb_write_error("unexpected return\n"); });
 break;
      case RUBY_TAG_NEXT:
 error_pos(((VALUE)RUBY_Qnil));
  ({ (__builtin_constant_p("unexpected next\n")) ? rb_write_error2(("unexpected next\n"), (long)strlen("unexpected next\n")) : rb_write_error("unexpected next\n"); });
 break;
      case RUBY_TAG_BREAK:
 error_pos(((VALUE)RUBY_Qnil));
  ({ (__builtin_constant_p("unexpected break\n")) ? rb_write_error2(("unexpected break\n"), (long)strlen("unexpected break\n")) : rb_write_error("unexpected break\n"); });
 break;
      case RUBY_TAG_REDO:
 error_pos(((VALUE)RUBY_Qnil));
  ({ (__builtin_constant_p("unexpected redo\n")) ? rb_write_error2(("unexpected redo\n"), (long)strlen("unexpected redo\n")) : rb_write_error("unexpected redo\n"); });
 break;
      case RUBY_TAG_RETRY:
 error_pos(((VALUE)RUBY_Qnil));
  ({ (__builtin_constant_p("retry outside of rescue clause\n")) ? rb_write_error2(("retry outside of rescue clause\n"), (long)strlen("retry outside of rescue clause\n")) : rb_write_error("retry outside of rescue clause\n"); });
 break;
      case RUBY_TAG_THROW:

 error_pos(((VALUE)RUBY_Qnil));
  ({ (__builtin_constant_p("unexpected throw\n")) ? rb_write_error2(("unexpected throw\n"), (long)strlen("unexpected throw\n")) : rb_write_error("unexpected throw\n"); });
 break;
      case RUBY_TAG_RAISE: {
 ...
 if (rb_obj_is_kind_of(errinfo, rb_eSystemExit)) {
   ...
   rb_ivar_get(errinfo, ruby_static_id_signo) != (((VALUE)(11))<<1 | RUBY_FIXNUM_FLAG)) {
...
{
    struct end_proc_data *link = ((struct end_proc_data*)ruby_xmalloc(sizeof(struct end_proc_data)));
...
rb_exec_end_proc(void)
{
 ...
 _ec->tag = _tag.prev;
 error_handle(state);
 if (!!((VALUE)(ec->errinfo) != ((VALUE)RUBY_Qnil))) errinfo = ec->errinfo;
 (void)(_ec->tag = &_tag);
 goto again;
    }
    _ec->tag = _tag.prev; } while (0);
...
ruby_init(void)
{
    ...
    if (state) {
        if (!(((VALUE)((*rb_ruby_debug_ptr())) & (VALUE)~((VALUE)RUBY_Qnil)) == 0))
            error_print(rb_current_execution_context());
 exit(1);
    }
}
void *
ruby_options(int argc, char **argv)
{
    ...
    do { rb_execution_context_t * const _ec = (rb_current_execution_context()); struct rb_vm_tag _tag; _tag.state = RUBY_TAG_NONE; _tag.tag = ((VALUE)RUBY_Qundef); _tag.prev = _ec->tag;;
    if ((state = (__builtin_setjmp((_tag.buf)) ? rb_ec_tag_state((*(int volatile *)&(_ec))) : ((void)(_ec->tag = &_tag), 0))) == RUBY_TAG_NONE) {
 do if (__builtin_setjmp(((rb_current_thread())->root_jmpbuf)) == 0) { iseq = ruby_process_options(argc, argv); } else { rb_fiber_start(); } while (0);
    }
    else {
 rb_clear_trace_func();
 state = error_handle(state);
 iseq = (void *)(((VALUE)(state))<<1 | RUBY_FIXNUM_FLAG);
    }
    _ec->tag = _tag.prev; } while (0);
    return iseq;
}
...
{
    ruby_sig_finalize();
    rb_current_execution_context()->errinfo = ((VALUE)RUBY_Qnil);
...
ruby_cleanup(volatile int ex)
{
    ...
    if ((state = (__builtin_setjmp((_tag.buf)) ? rb_ec_tag_state((*(int volatile *)&(_ec))) : ((void)(_ec->tag = &_tag), 0))) == RUBY_TAG_NONE) {
 do if (__builtin_setjmp(((th)->root_jmpbuf)) == 0) { { rb_vm_check_ints(th->ec); }; } else { rb_fiber_start(); } while (0);

      step_0: step++;
 errs[1] = th->ec->errinfo;
 th->ec->safe_level = 0;
 ruby_init_stack(&errs[(1)]);

 do if (__builtin_setjmp(((th)->root_jmpbuf)) == 0) { ruby_finalize_0(); } else { rb_fiber_start(); } while (0);
 ...
 do if (__builtin_setjmp(((th)->root_jmpbuf)) == 0) { rb_thread_terminate_all(); } else { rb_fiber_start(); } while (0);
    }
    else {
 switch (step) {
   case 0: goto step_0;
 ...
 if (rb_obj_is_kind_of(err, rb_eSystemExit)) {
     ...
     VALUE sig = rb_ivar_get(err, ruby_static_id_signo);
     state = rb_num2int_inline(sig);
     break;
 }
 else if (sysex == 0) {
     sysex = 1;
    ...
    rb_threadptr_unlock_all_locking_mutexes(rb_current_thread());
    _ec->tag = _tag.prev; } while (0);
    rb_thread_stop_timer_thread();
    ruby_vm_destruct(rb_current_vm());
...
ruby_exec_internal(void *n)
{
    ...
    do { rb_execution_context_t * const _ec = (th->ec); struct rb_vm_tag _tag; _tag.state = RUBY_TAG_NONE; _tag.tag = ((VALUE)RUBY_Qundef); _tag.prev = _ec->tag;;
    if ((state = (__builtin_setjmp((_tag.buf)) ? rb_ec_tag_state((*(int volatile *)&(_ec))) : ((void)(_ec->tag = &_tag), 0))) == RUBY_TAG_NONE) {
 do if (__builtin_setjmp(((th)->root_jmpbuf)) == 0) { { rb_iseq_eval_main(iseq); }; } else { rb_fiber_start(); } while (0);
...
ruby_executable_node(void *n, int *status)
{
    ...
    switch (v) {
      case ((VALUE)RUBY_Qtrue): s = 0; break;
      case ((VALUE)RUBY_Qfalse): s = 1; break;
      default:
 if (!(((int)(long)(v))&RUBY_FIXNUM_FLAG)) return TRUE;
 s = ((int)rb_fix2int((VALUE)(v)));
    }
    if (status) *status = s;
    return FALSE;
}
...
rb_frozen_class_p(VALUE klass)
{
 ...
 static void rb_longjmp(rb_execution_context_t *, int, volatile VALUE, VALUE);
...
{
    if (!!((VALUE)(cause) != ((VALUE)RUBY_Qnil)) && cause != exc) {
 rb_ivar_set(exc, id_cause, cause);
 if (!rb_ivar_defined(cause, id_cause)) {
     rb_ivar_set(cause, id_cause, ((VALUE)RUBY_Qnil));
 }
    }
    return exc;
}
...
exc_setup_message(const rb_execution_context_t *ec, VALUE mesg, VALUE *cause)
{
 ...
 mesg = ec->errinfo;
 if ((((int)(long)(mesg))&RUBY_FIXNUM_FLAG)) rb_ec_tag_jump(ec, RUBY_TAG_FATAL);
 nocause = 1;
    }
    if (!((VALUE)(mesg) != ((VALUE)RUBY_Qnil))) {
 ...
 nocause = 0;
    ...
    if (*cause == ((VALUE)RUBY_Qundef)) {
 if (nocause) {
     *cause = ((VALUE)RUBY_Qnil);
 }
...
setup_exception(rb_execution_context_t *ec, int tag, volatile VALUE mesg, VALUE cause)
{
    ...
    if ((file && !!((VALUE)(mesg) != ((VALUE)RUBY_Qnil))) || (cause != ((VALUE)RUBY_Qundef))) {
 volatile int state = 0;

 do { rb_execution_context_t * const _ec = (ec); struct rb_vm_tag _tag; _tag.state = RUBY_TAG_NONE; _tag.tag = ((VALUE)RUBY_Qundef); _tag.prev = _ec->tag;;
 if ((__builtin_setjmp((_tag.buf)) ? rb_ec_tag_state((*(int volatile *)&(_ec))) : ((void)(_ec->tag = &_tag), 0)) == RUBY_TAG_NONE && !(state = rb_ec_set_raised(ec))) {
     VALUE bt = rb_get_backtrace(mesg);
     if (!!((VALUE)(bt) != ((VALUE)RUBY_Qnil)) || cause == ((VALUE)RUBY_Qundef)) {
  if ((!(!(((VALUE)(mesg) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(mesg) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(mesg))->flags & RUBY_T_MASK) != RUBY_T_NODE) || (((struct RBasic*)(mesg))->flags&RUBY_FL_FREEZE))) {
 ...
 ec->errinfo = mesg;
    ...
    if (!(((VALUE)((*rb_ruby_debug_ptr())) & (VALUE)~((VALUE)RUBY_Qnil)) == 0) && !!((VALUE)(e = ec->errinfo) != ((VALUE)RUBY_Qnil)) &&
 ...
 if ((state = (__builtin_setjmp((_tag.buf)) ? rb_ec_tag_state((*(int volatile *)&(_ec))) : ((void)(_ec->tag = &_tag), 0))) == RUBY_TAG_NONE) {
     ...
     ec->errinfo = mesg;
     if (file && line) {
  e = rb_sprintf("Exception `%li\v' at %s:%d - %li\v\n",
          rb_obj_class(mesg), file, line, e);
     }
     else if (file) {
  e = rb_sprintf("Exception `%li\v' at %s - %li\v\n",
          rb_obj_class(mesg), file, e);
     }
     else {
  e = rb_sprintf("Exception `%li\v' - %li\v\n",
          rb_obj_class(mesg), e);
     }
     rb_write_error_str(e);
 }
 _ec->tag = _tag.prev; } while (0);
 if (state == RUBY_TAG_FATAL && ec->errinfo == rb_current_vm()->special_exceptions[ruby_error_reenter]) {
     ec->errinfo = mesg;
 }
 else if (state) {
     rb_ec_reset_raised(ec);
    ...
    if (rb_ec_set_raised(ec)) {
      fatal:
 ec->errinfo = rb_current_vm()->special_exceptions[ruby_error_reenter];
 rb_ec_reset_raised(ec);
 rb_ec_tag_jump(ec, RUBY_TAG_FATAL);
    }

    if (tag != RUBY_TAG_FATAL) {
 ...
 do { const rb_event_flag_t flag_arg_ = (0x0080); if ((__builtin_expect(!!(ruby_vm_event_flags & (flag_arg_)), 0))) { rb_exec_event_hook_orig(ec, flag_arg_, ec->cfp->self, 0, 0, 0, mesg, 0); } } while (0);
    }
}
...
rb_exc_raise(VALUE mesg)
{
 ...
 mesg = make_exception(1, &mesg, FALSE);
    ...
    rb_longjmp(rb_current_execution_context(), RUBY_TAG_RAISE, mesg, ((VALUE)RUBY_Qundef));
}
void
rb_exc_fatal(VALUE mesg)
{
 ...
 mesg = make_exception(1, &mesg, FALSE);
    ...
    rb_longjmp(rb_current_execution_context(), RUBY_TAG_FATAL, mesg, ((VALUE)RUBY_Qnil));
}
...
extract_raise_opts(int argc, const VALUE *argv, VALUE *opts)
{
 ...
 if (( ((RUBY_T_HASH) == RUBY_T_FIXNUM) ? (((int)(long)(opt))&RUBY_FIXNUM_FLAG) : ((RUBY_T_HASH) == RUBY_T_TRUE) ? ((opt) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_HASH) == RUBY_T_FALSE) ? ((opt) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_HASH) == RUBY_T_NIL) ? ((opt) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_HASH) == RUBY_T_UNDEF) ? ((opt) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_HASH) == RUBY_T_SYMBOL) ? ((((VALUE)(opt)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(opt) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(opt) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(opt))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_HASH) == RUBY_T_FLOAT) ? ( ((((int)(long)(opt))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(opt) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(opt) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(opt))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(opt) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(opt) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(opt))->flags & RUBY_T_MASK) == (RUBY_T_HASH)))) {
     if (!((((struct RHash*)(opt))->ntbl ? ((struct RHash*)(opt))->ntbl->num_entries : (st_index_t)0) == 0)) {
  ID keywords[1];
  do { static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("cause")), (long)strlen(("cause"))); (keywords[0]) = rb_intern_id_cache; } while (0);
  rb_get_kwargs(opt, keywords, 0, -1-raise_max_opt, opts);
  if (((((struct RHash*)(opt))->ntbl ? ((struct RHash*)(opt))->ntbl->num_entries : (st_index_t)0) == 0)) --argc;
  return argc;
     }
 }
    }
    for (i = 0; i < raise_max_opt; ++i) {
 opts[i] = ((VALUE)RUBY_Qundef);
    }
    return argc;
}
static VALUE
...
make_exception(int argc, const VALUE *argv, int isstr)
{
 ...
 if (isstr) {
     ...
     if (!!((VALUE)(mesg) != ((VALUE)RUBY_Qnil))) {
  mesg = rb_exc_new_str(rb_eRuntimeError, mesg);
  break;
     }
 }
 n = 0;
...
rb_raise_jump(VALUE mesg, VALUE cause)
{
    ...
    rb_vm_pop_frame(ec);
    do { const rb_event_flag_t flag_arg_ = (0x0040); if ((__builtin_expect(!!(ruby_vm_event_flags & (flag_arg_)), 0))) { rb_exec_event_hook_orig(ec, flag_arg_, self, me->def->original_id, mid, klass, ((VALUE)RUBY_Qnil), 0); } } while (0);

    rb_longjmp(ec, RUBY_TAG_RAISE, mesg, cause);
}
void
rb_jump_tag(int tag)
{
    if ((__builtin_expect(!!(tag < RUBY_TAG_RETURN || tag > RUBY_TAG_FATAL), 0))) {
 rb_bug("Unknown longjmp status %d", tag);
    }
    rb_ec_tag_jump(rb_current_execution_context(), tag);
}
...
{
    if (rb_vm_frame_block_handler(rb_current_execution_context()->cfp) == 0) {
 return FALSE;
    }
    else {
 return TRUE;
...
VALUE
rb_rescue2(VALUE (* b_proc) (), VALUE data1,
    VALUE (* r_proc) (), VALUE data2, ...)
{
    enum ruby_tag_type state;
    rb_execution_context_t * volatile ec = rb_current_execution_context();
    rb_control_frame_t *volatile cfp = ec->cfp;
    volatile VALUE result = ((VALUE)RUBY_Qfalse);
 ...
 if (state == RUBY_TAG_RAISE) {
     ...
     __builtin_va_start((args), (data2));
     while ((eclass = __builtin_va_arg()) != 0) {
...
VALUE
rb_rescue(VALUE (* b_proc)(), VALUE data1,
   VALUE (* r_proc)(), VALUE data2)
{
...
{
    volatile VALUE result = ((VALUE)RUBY_Qnil);
    ...
    memcpy((&org_jmpbuf), (&rb_ec_thread_ptr(ec)->root_jmpbuf), sizeof(rb_jmpbuf_t)*(size_t)(1));
    if ((state = (__builtin_setjmp((_tag.buf)) ? rb_ec_tag_state((*(int volatile *)&(_ec))) : ((void)(_ec->tag = &_tag), 0))) == RUBY_TAG_NONE) {
 do if (__builtin_setjmp(((rb_ec_thread_ptr(ec))->root_jmpbuf)) == 0) { result = (*proc) (data); } else { rb_fiber_start(); } while (0);
    }
    else {
 rb_vm_rewind_cfp(ec, cfp);
    }
    memcpy((&rb_ec_thread_ptr(ec)->root_jmpbuf), (&org_jmpbuf), sizeof(rb_jmpbuf_t)*(size_t)(1));
    ec->protect_tag = protect_tag.prev;
    _ec->tag = _tag.prev; } while (0);

    if (pstate != ((void*)0)) *pstate = state;
    return result;
}
VALUE
...
{
    return frame_func_id(rb_current_execution_context()->cfp);
}
ID
rb_frame_callee(void)
{
    return frame_called_id(rb_current_execution_context()->cfp);
}
...
{
    rb_control_frame_t *prev_cfp = previous_frame(rb_current_execution_context());
...
{
    if (!(!(((VALUE)(include) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(include) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && ((int)(((struct RBasic*)(include))->flags & RUBY_T_MASK) == RUBY_T_CLASS || (int)(((struct RBasic*)(include))->flags & RUBY_T_MASK) == RUBY_T_MODULE))) {
 (!( (((RUBY_T_CLASS)) == RUBY_T_FIXNUM) ? (((int)(long)((VALUE)(include)))&RUBY_FIXNUM_FLAG) : (((RUBY_T_CLASS)) == RUBY_T_TRUE) ? (((VALUE)(include)) == ((VALUE)RUBY_Qtrue)) : (((RUBY_T_CLASS)) == RUBY_T_FALSE) ? (((VALUE)(include)) == ((VALUE)RUBY_Qfalse)) : (((RUBY_T_CLASS)) == RUBY_T_NIL) ? (((VALUE)(include)) == ((VALUE)RUBY_Qnil)) : (((RUBY_T_CLASS)) == RUBY_T_UNDEF) ? (((VALUE)(include)) == ((VALUE)RUBY_Qundef)) : (((RUBY_T_CLASS)) == RUBY_T_SYMBOL) ? ((((VALUE)((VALUE)(include))&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)((VALUE)(include)) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)((VALUE)(include)) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)((VALUE)(include)))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : (((RUBY_T_CLASS)) == RUBY_T_FLOAT) ? ( ((((int)(long)((VALUE)(include)))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)((VALUE)(include)) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)((VALUE)(include)) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)((VALUE)(include)))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)((VALUE)(include)) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)((VALUE)(include)) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)((VALUE)(include)))->flags & RUBY_T_MASK) == ((RUBY_T_CLASS)))) || ((RUBY_T_CLASS) == RUBY_T_DATA && (((struct RTypedData*)(include))->typed_flag == 1)) ? rb_unexpected_type((VALUE)(include), (RUBY_T_CLASS)) : (void)0);
    }
...
rb_mod_include(int argc, VALUE *argv, VALUE module)
{
    ...
    do { static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("append_features")), (long)strlen(("append_features"))); (id_append_features) = rb_intern_id_cache; } while (0);
    do { static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("included")), (long)strlen(("included"))); (id_included) = rb_intern_id_cache; } while (0);

    rb_check_arity(argc, 1, (-1));
    for (i = 0; i < argc; i++)
 (!( (((RUBY_T_MODULE)) == RUBY_T_FIXNUM) ? (((int)(long)((VALUE)(argv[i])))&RUBY_FIXNUM_FLAG) : (((RUBY_T_MODULE)) == RUBY_T_TRUE) ? (((VALUE)(argv[i])) == ((VALUE)RUBY_Qtrue)) : (((RUBY_T_MODULE)) == RUBY_T_FALSE) ? (((VALUE)(argv[i])) == ((VALUE)RUBY_Qfalse)) : (((RUBY_T_MODULE)) == RUBY_T_NIL) ? (((VALUE)(argv[i])) == ((VALUE)RUBY_Qnil)) : (((RUBY_T_MODULE)) == RUBY_T_UNDEF) ? (((VALUE)(argv[i])) == ((VALUE)RUBY_Qundef)) : (((RUBY_T_MODULE)) == RUBY_T_SYMBOL) ? ((((VALUE)((VALUE)(argv[i]))&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)((VALUE)(argv[i])) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)((VALUE)(argv[i])) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)((VALUE)(argv[i])))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : (((RUBY_T_MODULE)) == RUBY_T_FLOAT) ? ( ((((int)(long)((VALUE)(argv[i])))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)((VALUE)(argv[i])) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)((VALUE)(argv[i])) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)((VALUE)(argv[i])))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)((VALUE)(argv[i])) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)((VALUE)(argv[i])) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)((VALUE)(argv[i])))->flags & RUBY_T_MASK) == ((RUBY_T_MODULE)))) || ((RUBY_T_MODULE) == RUBY_T_DATA && (((struct RTypedData*)(argv[i]))->typed_flag == 1)) ? rb_unexpected_type((VALUE)(argv[i]), (RUBY_T_MODULE)) : (void)0);
    while (argc--) {
...
{
    if (!(!(((VALUE)(prepend) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(prepend) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && ((int)(((struct RBasic*)(prepend))->flags & RUBY_T_MASK) == RUBY_T_CLASS || (int)(((struct RBasic*)(prepend))->flags & RUBY_T_MASK) == RUBY_T_MODULE))) {
 (!( (((RUBY_T_CLASS)) == RUBY_T_FIXNUM) ? (((int)(long)((VALUE)(prepend)))&RUBY_FIXNUM_FLAG) : (((RUBY_T_CLASS)) == RUBY_T_TRUE) ? (((VALUE)(prepend)) == ((VALUE)RUBY_Qtrue)) : (((RUBY_T_CLASS)) == RUBY_T_FALSE) ? (((VALUE)(prepend)) == ((VALUE)RUBY_Qfalse)) : (((RUBY_T_CLASS)) == RUBY_T_NIL) ? (((VALUE)(prepend)) == ((VALUE)RUBY_Qnil)) : (((RUBY_T_CLASS)) == RUBY_T_UNDEF) ? (((VALUE)(prepend)) == ((VALUE)RUBY_Qundef)) : (((RUBY_T_CLASS)) == RUBY_T_SYMBOL) ? ((((VALUE)((VALUE)(prepend))&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)((VALUE)(prepend)) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)((VALUE)(prepend)) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)((VALUE)(prepend)))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : (((RUBY_T_CLASS)) == RUBY_T_FLOAT) ? ( ((((int)(long)((VALUE)(prepend)))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)((VALUE)(prepend)) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)((VALUE)(prepend)) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)((VALUE)(prepend)))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)((VALUE)(prepend)) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)((VALUE)(prepend)) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)((VALUE)(prepend)))->flags & RUBY_T_MASK) == ((RUBY_T_CLASS)))) || ((RUBY_T_CLASS) == RUBY_T_DATA && (((struct RTypedData*)(prepend))->typed_flag == 1)) ? rb_unexpected_type((VALUE)(prepend), (RUBY_T_CLASS)) : (void)0);
    }
...
rb_mod_prepend(int argc, VALUE *argv, VALUE module)
{
    ...
    do { static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("prepend_features")), (long)strlen(("prepend_features"))); (id_prepend_features) = rb_intern_id_cache; } while (0);
    do { static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("prepended")), (long)strlen(("prepended"))); (id_prepended) = rb_intern_id_cache; } while (0);
...
hidden_identity_hash_new(void)
{
    ...
    memset(&(((struct RBasicRaw *)((VALUE)(hash)))->klass), 0, sizeof(VALUE));
    return hash;
}
...
{
    if (( ((RUBY_T_MODULE) == RUBY_T_FIXNUM) ? (((int)(long)(superclass))&RUBY_FIXNUM_FLAG) : ((RUBY_T_MODULE) == RUBY_T_TRUE) ? ((superclass) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_MODULE) == RUBY_T_FALSE) ? ((superclass) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_MODULE) == RUBY_T_NIL) ? ((superclass) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_MODULE) == RUBY_T_UNDEF) ? ((superclass) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_MODULE) == RUBY_T_SYMBOL) ? ((((VALUE)(superclass)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(superclass) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(superclass) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(superclass))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_MODULE) == RUBY_T_FLOAT) ? ( ((((int)(long)(superclass))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(superclass) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(superclass) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(superclass))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(superclass) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(superclass) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(superclass))->flags & RUBY_T_MASK) == (RUBY_T_MODULE)))) {
...
rb_using_refinement(rb_cref_t *cref, VALUE klass, VALUE module)
{
 ...
 if (!!((VALUE)(c = rb_hash_lookup(CREF_REFINEMENTS(cref), klass)) != ((VALUE)RUBY_Qnil))) {
  ...
  c = RCLASS_SUPER(c);
    ...
    ((!(((VALUE)(module) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(module) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(module))->flags & RUBY_T_MASK) != RUBY_T_NODE) ? (void)(((struct RBasic*)(module))->flags |= (RMODULE_IS_OVERLAID)) : (void)0);
    superclass = refinement_superclass(superclass);
    c = iclass = rb_include_class_new(module, superclass);
    ((((struct RClass*)(c))->ptr)->refined_class) = klass;

    (((struct RClass*)(rb_obj_wb_unprotect(c, "eval.c", 1323)))->m_tbl) =
      (((struct RClass*)(rb_obj_wb_unprotect(module, "eval.c", 1324)))->m_tbl);
...
using_module_recursive(const rb_cref_t *cref, VALUE klass)
{
 ...
 break;
      ...
      case RUBY_T_ICLASS:
 module = ((struct RBasic*)(klass))->klass;
 break;
 ...
 break;
    ...
    do { static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("__refinements__")), (long)strlen(("__refinements__"))); (id_refinements) = rb_intern_id_cache; } while (0);
    refinements = rb_attr_get(module, id_refinements);
    if (!((VALUE)(refinements) != ((VALUE)RUBY_Qnil))) return;
...
rb_refinement_module_get_refined_class(VALUE module)
{
    ...
    do { static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("__refined_class__")), (long)strlen(("__refined_class__"))); (id_refined_class) = rb_intern_id_cache; } while (0);
    ...
    VALUE klass, VALUE refinement)
{
    ...
    if (!!((VALUE)(c = rb_hash_lookup(activated_refinements, klass)) != ((VALUE)RUBY_Qnil))) {
 superclass = c;
 while (c && ( ((RUBY_T_ICLASS) == RUBY_T_FIXNUM) ? (((int)(long)(c))&RUBY_FIXNUM_FLAG) : ((RUBY_T_ICLASS) == RUBY_T_TRUE) ? ((c) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_ICLASS) == RUBY_T_FALSE) ? ((c) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_ICLASS) == RUBY_T_NIL) ? ((c) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_ICLASS) == RUBY_T_UNDEF) ? ((c) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_ICLASS) == RUBY_T_SYMBOL) ? ((((VALUE)(c)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(c) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(c) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(c))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_ICLASS) == RUBY_T_FLOAT) ? ( ((((int)(long)(c))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(c) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(c) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(c))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(c) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(c) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(c))->flags & RUBY_T_MASK) == (RUBY_T_ICLASS)))) {
     if (((struct RBasic*)(c))->klass == refinement) {
  ...
  return;
    ...
    ((!(((VALUE)(refinement) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(refinement) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(refinement))->flags & RUBY_T_MASK) != RUBY_T_NODE) ? (void)(((struct RBasic*)(refinement))->flags |= (RMODULE_IS_OVERLAID)) : (void)0);
    superclass = refinement_superclass(superclass);
...
rb_mod_refine(VALUE module, VALUE klass)
{
 ...
 rb_ivar_set(module, id_refinements, refinements);
    ...
    do { static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("__activated_refinements__")), (long)strlen(("__activated_refinements__"))); (id_activated_refinements) = rb_intern_id_cache; } while (0);
    activated_refinements = rb_attr_get(module, id_activated_refinements);
    if (!((VALUE)(activated_refinements) != ((VALUE)RUBY_Qnil))) {
 ...
 ((!(((VALUE)(refinement) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(refinement) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(refinement))->flags & RUBY_T_MASK) != RUBY_T_NODE) ? (void)(((struct RBasic*)(refinement))->flags |= (RMODULE_IS_REFINEMENT)) : (void)0);
 do { static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("__refined_class__")), (long)strlen(("__refined_class__"))); (id_refined_class) = rb_intern_id_cache; } while (0);
 rb_ivar_set(refinement, id_refined_class, klass);
 do { static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("__defined_at__")), (long)strlen(("__defined_at__"))); (id_defined_at) = rb_intern_id_cache; } while (0);
...
ignored_block(VALUE module, const char *klass)
{
    const char *anon = "";
    (!( (((RUBY_T_MODULE)) == RUBY_T_FIXNUM) ? (((int)(long)((VALUE)(module)))&RUBY_FIXNUM_FLAG) : (((RUBY_T_MODULE)) == RUBY_T_TRUE) ? (((VALUE)(module)) == ((VALUE)RUBY_Qtrue)) : (((RUBY_T_MODULE)) == RUBY_T_FALSE) ? (((VALUE)(module)) == ((VALUE)RUBY_Qfalse)) : (((RUBY_T_MODULE)) == RUBY_T_NIL) ? (((VALUE)(module)) == ((VALUE)RUBY_Qnil)) : (((RUBY_T_MODULE)) == RUBY_T_UNDEF) ? (((VALUE)(module)) == ((VALUE)RUBY_Qundef)) : (((RUBY_T_MODULE)) == RUBY_T_SYMBOL) ? ((((VALUE)((VALUE)(module))&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)((VALUE)(module)) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)((VALUE)(module)) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)((VALUE)(module)))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : (((RUBY_T_MODULE)) == RUBY_T_FLOAT) ? ( ((((int)(long)((VALUE)(module)))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)((VALUE)(module)) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)((VALUE)(module)) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)((VALUE)(module)))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)((VALUE)(module)) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)((VALUE)(module)) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)((VALUE)(module)))->flags & RUBY_T_MASK) == ((RUBY_T_MODULE)))) || ((RUBY_T_MODULE) == RUBY_T_DATA && (((struct RTypedData*)(module))->typed_flag == 1)) ? rb_unexpected_type((VALUE)(module), (RUBY_T_MODULE)) : (void)0);
    if (!!(((VALUE)(rb_search_class_path(module)) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) {
 anon = ", maybe for Module.new";
    }
    rb_warn("%susing doesn't call the given block%s.", klass, anon);
}
static VALUE
...
used_modules_i(VALUE _, VALUE mod, VALUE ary)
{
    ID id_defined_at;
    do { static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("__defined_at__")), (long)strlen(("__defined_at__"))); (id_defined_at) = rb_intern_id_cache; } while (0);
    while (((!(((VALUE)(rb_class_of(mod)) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(rb_class_of(mod)) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(rb_class_of(mod)))->flags & RUBY_T_MASK) != RUBY_T_NODE)?(((struct RBasic*)((rb_class_of(mod))))->flags&((RMODULE_IS_REFINEMENT))):0)) {
...
rb_mod_s_used_modules(void)
{
 ...
 cref = CREF_NEXT(cref);
    ...
    return rb_funcall(ary, (__builtin_constant_p("uniq") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("uniq")), (long)strlen(("uniq"))); (ID) rb_intern_id_cache; }) : rb_intern("uniq")), 0);
}
void
...
rb_obj_extend(int argc, VALUE *argv, VALUE obj)
{
    ...
    do { static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("extend_object")), (long)strlen(("extend_object"))); (id_extend_object) = rb_intern_id_cache; } while (0);
    do { static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("extended")), (long)strlen(("extended"))); (id_extended) = rb_intern_id_cache; } while (0);
...
errinfo_place(const rb_execution_context_t *ec)
{
    ...
    while (((void *)(end_cfp) > (void *)(cfp))) {
 if (VM_FRAME_RUBYFRAME_P(cfp)) {
     if (cfp->iseq->body->type == ISEQ_TYPE_RESCUE) {
  return &cfp->ep[(-( 3))];
     }
     else if (cfp->iseq->body->type == ISEQ_TYPE_ENSURE &&
       !( ((RUBY_T_IMEMO) == RUBY_T_FIXNUM) ? (((int)(long)((VALUE)(cfp->ep[(-( 3))])))&RUBY_FIXNUM_FLAG) : ((RUBY_T_IMEMO) == RUBY_T_TRUE) ? (((VALUE)(cfp->ep[(-( 3))])) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_IMEMO) == RUBY_T_FALSE) ? (((VALUE)(cfp->ep[(-( 3))])) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_IMEMO) == RUBY_T_NIL) ? (((VALUE)(cfp->ep[(-( 3))])) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_IMEMO) == RUBY_T_UNDEF) ? (((VALUE)(cfp->ep[(-( 3))])) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_IMEMO) == RUBY_T_SYMBOL) ? ((((VALUE)((VALUE)(cfp->ep[(-( 3))]))&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)((VALUE)(cfp->ep[(-( 3))])) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)((VALUE)(cfp->ep[(-( 3))])) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)((VALUE)(cfp->ep[(-( 3))])))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_IMEMO) == RUBY_T_FLOAT) ? ( ((((int)(long)((VALUE)(cfp->ep[(-( 3))])))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)((VALUE)(cfp->ep[(-( 3))])) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)((VALUE)(cfp->ep[(-( 3))])) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)((VALUE)(cfp->ep[(-( 3))])))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)((VALUE)(cfp->ep[(-( 3))])) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)((VALUE)(cfp->ep[(-( 3))])) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)((VALUE)(cfp->ep[(-( 3))])))->flags & RUBY_T_MASK) == (RUBY_T_IMEMO))) &&
       !(((int)(long)(cfp->ep[(-( 3))]))&RUBY_FIXNUM_FLAG)) {
  return &cfp->ep[(-( 3))];
     }
 }
 cfp = ((cfp)+1);
...
get_errinfo(void)
{
    return get_ec_errinfo(rb_current_execution_context());
}
...
rb_errinfo(void)
{
    return rb_current_execution_context()->errinfo;
}
void
rb_set_errinfo(VALUE err)
{
    if (!!((VALUE)(err) != ((VALUE)RUBY_Qnil)) && !rb_obj_is_kind_of(err, rb_eException)) {
 rb_raise(rb_eTypeError, "assigning non-exception to $!");
    }
    rb_current_execution_context()->errinfo = err;
}
...
{
    ID fname = prev_frame_func();

    if (fname) {
 return (rb_id2sym(fname));
    }
    else {
 return ((VALUE)RUBY_Qnil);
    }
...
Init_eval(void)
{
    ...
    rb_vm_register_special_exception_str(ruby_error_reenter, rb_eFatal, rb_usascii_str_new_static(("exception reentered"), (long)(sizeof("exception reentered") - 1)));
    rb_vm_register_special_exception_str(ruby_error_stackfatal, rb_eFatal, rb_usascii_str_new_static(("machine stack overflow in critical region"), (long)(sizeof("machine stack overflow in critical region") - 1)));

    ruby_static_id_signo = (__builtin_constant_p("signo") ?  (rb_intern2(("signo"), (long)strlen("signo"))) : (rb_intern)("signo"));
    ruby_static_id_status = (__builtin_constant_p("status") ?  (rb_intern2(("status"), (long)strlen("status"))) : (rb_intern)("status"));
