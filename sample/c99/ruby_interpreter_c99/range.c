...
{
    if (!(((int)(long)(beg))&RUBY_FIXNUM_FLAG) || !(((int)(long)(end))&RUBY_FIXNUM_FLAG)) {
 VALUE v;

 v = rb_funcall(beg, idCmp, 1, end);
 if (!((VALUE)(v) != ((VALUE)RUBY_Qnil)))
     rb_raise(rb_eArgError, "bad value for range");
    }

    (rb_obj_write((VALUE)(range), (VALUE *)(&rb_struct_const_ptr(range)[2]), (VALUE)((exclude_end)), "range.c", 48));
    (rb_obj_write((VALUE)(range), (VALUE *)(&rb_struct_const_ptr(range)[0]), (VALUE)((beg)), "range.c", 49));
    (rb_obj_write((VALUE)(range), (VALUE *)(&rb_struct_const_ptr(range)[1]), (VALUE)((end)), "range.c", 50));
}
...
rb_range_new(VALUE beg, VALUE end, int exclude_end)
{
    ...
    range_init(range, beg, end, ((exclude_end) ? ((VALUE)RUBY_Qtrue) : ((VALUE)RUBY_Qfalse)));
    return range;
}
...
{
    ({do { VALUE frozen_obj = (range); if ((!(!(((VALUE)(frozen_obj) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(frozen_obj) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(frozen_obj))->flags & RUBY_T_MASK) != RUBY_T_NODE) || (((struct RBasic*)(frozen_obj))->flags&RUBY_FL_FREEZE))) { rb_error_frozen_object(frozen_obj); } } while (0);});

    if ((((struct RStruct*)(range))->as.ary[2]) != ((VALUE)RUBY_Qnil)) {
 rb_exc_raise(rb_name_err_new( ({ (__builtin_constant_p("`initialize' called twice")) ? rb_fstring_new(("`initialize' called twice"), (long)strlen("`initialize' called twice")) : rb_fstring_cstr("`initialize' called twice"); }), (range), ((rb_id2sym(idInitialize)))));
    }
}
static VALUE
range_initialize(int argc, VALUE *argv, VALUE range)
{
    ...
    range_modify(range);
    range_init(range, beg, end, ((!(((VALUE)(flags) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) ? ((VALUE)RUBY_Qtrue) : ((VALUE)RUBY_Qfalse)));
...
{
    return !(((VALUE)((((struct RStruct*)(range))->as.ary[2])) & (VALUE)~((VALUE)RUBY_Qnil)) == 0) ? ((VALUE)RUBY_Qtrue) : ((VALUE)RUBY_Qfalse);
}

static VALUE
recursive_equal(VALUE range, VALUE obj, int recur)
{
    if (recur) return ((VALUE)RUBY_Qtrue);
    if (!rb_equal((((struct RStruct*)(range))->as.ary[0]), (((struct RStruct*)(obj))->as.ary[0])))
 return ((VALUE)RUBY_Qfalse);
    if (!rb_equal((((struct RStruct*)(range))->as.ary[1]), (((struct RStruct*)(obj))->as.ary[1])))
 return ((VALUE)RUBY_Qfalse);

    if (!(((VALUE)((((struct RStruct*)(range))->as.ary[2])) & (VALUE)~((VALUE)RUBY_Qnil)) == 0) != !(((VALUE)((((struct RStruct*)(obj))->as.ary[2])) & (VALUE)~((VALUE)RUBY_Qnil)) == 0))
 return ((VALUE)RUBY_Qfalse);
...
{
    VALUE r = rb_funcall(a, idCmp, 1, b);

    if (!((VALUE)(r) != ((VALUE)RUBY_Qnil)))
 return 2147483647;
...
{
    if (recur) return ((VALUE)RUBY_Qtrue);
    if (!rb_eql((((struct RStruct*)(range))->as.ary[0]), (((struct RStruct*)(obj))->as.ary[0])))
 return ((VALUE)RUBY_Qfalse);
    if (!rb_eql((((struct RStruct*)(range))->as.ary[1]), (((struct RStruct*)(obj))->as.ary[1])))
 return ((VALUE)RUBY_Qfalse);
...
{
    st_index_t hash = !(((VALUE)((((struct RStruct*)(range))->as.ary[2])) & (VALUE)~((VALUE)RUBY_Qnil)) == 0);
    VALUE v;

    hash = rb_hash_start(hash);
    v = rb_hash((((struct RStruct*)(range))->as.ary[0]));
    hash = st_hash_uint((hash), (rb_num2long_inline(v)));
    v = rb_hash((((struct RStruct*)(range))->as.ary[1]));
    hash = st_hash_uint((hash), (rb_num2long_inline(v)));
    hash = st_hash_uint((hash), (!(((VALUE)((((struct RStruct*)(range))->as.ary[2])) & (VALUE)~((VALUE)RUBY_Qnil)) == 0) << 24));
...
{
    int c;
    VALUE b = (((struct RStruct*)(range))->as.ary[0]);
    VALUE e = (((struct RStruct*)(range))->as.ary[1]);
    VALUE v = b;

    if (!(((VALUE)((((struct RStruct*)(range))->as.ary[2])) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) {
 while (r_less(v, e) < 0) {
     (*func) (v, arg, 0, 0, 0);
     v = rb_funcallv(v, idSucc, 0, 0);
 }
    }
    else {
...
static VALUE
sym_step_i(VALUE i, VALUE arg, int argc, const VALUE *argv, VALUE blockarg)
{
    VALUE *iter = (VALUE *)arg;

    if ((((int)(long)(iter[0]))&RUBY_FIXNUM_FLAG)) {
 iter[0] -= (((VALUE)(1))<<1 | RUBY_FIXNUM_FLAG) & ~RUBY_FIXNUM_FLAG;
    }
    else {
 iter[0] = rb_funcall(iter[0], '-', 1, (((VALUE)(1))<<1 | RUBY_FIXNUM_FLAG));
    }
    if (iter[0] == (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG)) {
...
static VALUE
step_i(VALUE i, VALUE arg, int argc, const VALUE *argv, VALUE blockarg)
{
    VALUE *iter = (VALUE *)arg;
...
discrete_object_p(VALUE obj)
{
    ...
    return rb_respond_to(obj, idSucc);
}

static int
linear_object_p(VALUE obj)
{
    if ((((int)(long)(obj))&RUBY_FIXNUM_FLAG) || ((((int)(long)(obj))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG)) return TRUE;
    if ((((VALUE)(obj) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(obj) & (VALUE)~((VALUE)RUBY_Qnil)) == 0))) return FALSE;
...
{
    VALUE b = (((struct RStruct*)(range))->as.ary[0]), e = (((struct RStruct*)(range))->as.ary[1]);
    VALUE step = (((VALUE)(1))<<1 | RUBY_FIXNUM_FLAG);
    if (args) {
 step = check_step_domain((rb_array_const_ptr(args)[0]));
    }

    if (rb_obj_is_kind_of(b, rb_cNumeric) && rb_obj_is_kind_of(e, rb_cNumeric)) {
 return ruby_num_interval_step_size(b, e, step, !(((VALUE)((((struct RStruct*)(range))->as.ary[2])) & (VALUE)~((VALUE)RUBY_Qnil)) == 0));
    }
    return ((VALUE)RUBY_Qnil);
}
static VALUE
range_step(int argc, VALUE *argv, VALUE range)
{
    ...
    do { if (!rb_block_given_p()) return rb_enumeratorize_with_size((range), (rb_id2sym(rb_frame_this_func())), (argc), (argv), (rb_enumerator_size_func *)((range_step_size))); } while (0);

    b = (((struct RStruct*)(range))->as.ary[0]);
    e = (((struct RStruct*)(range))->as.ary[1]);
    if (argc == 0) {
 ...
 step = check_step_domain(step);
    ...
    if ((((int)(long)(b))&RUBY_FIXNUM_FLAG) && (((int)(long)(e))&RUBY_FIXNUM_FLAG) && (((int)(long)(step))&RUBY_FIXNUM_FLAG)) {
 long end = ((long)(((long)(e))>>(int)(1)));
 long i, unit = ((long)(((long)(step))>>(int)(1)));

 if (!!(((VALUE)((((struct RStruct*)(range))->as.ary[2])) & (VALUE)~((VALUE)RUBY_Qnil)) == 0))
     end += 1;
 i = ((long)(((long)(b))>>(int)(1)));
 while (i < end) {
     rb_yield(rb_long2num_inline(i));
     if (i + unit < i) break;
     i += unit;
 }

    }
    else if (((((VALUE)(b)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(b) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(b) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(b))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) && ((((VALUE)(e)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(e) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(e) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(e))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL)))) {
 VALUE args[2], iter[2];

 args[0] = rb_sym2str(e);
 args[1] = !(((VALUE)((((struct RStruct*)(range))->as.ary[2])) & (VALUE)~((VALUE)RUBY_Qnil)) == 0) ? ((VALUE)RUBY_Qtrue) : ((VALUE)RUBY_Qfalse);
 iter[0] = (((VALUE)(1))<<1 | RUBY_FIXNUM_FLAG);
 iter[1] = step;
 rb_block_call(rb_sym2str(b), (__builtin_constant_p("upto") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("upto")), (long)strlen(("upto"))); (ID) rb_intern_id_cache; }) : rb_intern("upto")), 2, args, sym_step_i, (VALUE)iter);
    }
    else if (ruby_float_step(b, e, step, !(((VALUE)((((struct RStruct*)(range))->as.ary[2])) & (VALUE)~((VALUE)RUBY_Qnil)) == 0))) {

    }
    else if (rb_obj_is_kind_of(b, rb_cNumeric) ||
      !!((VALUE)(rb_check_to_integer(b, "to_int")) != ((VALUE)RUBY_Qnil)) ||
      !!((VALUE)(rb_check_to_integer(e, "to_int")) != ((VALUE)RUBY_Qnil))) {
 ID op = !(((VALUE)((((struct RStruct*)(range))->as.ary[2])) & (VALUE)~((VALUE)RUBY_Qnil)) == 0) ? '<' : idLE;
 VALUE v = b;
 int i = 0;

 while (!(((VALUE)(rb_funcall(v, op, 1, e)) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) {
     rb_yield(v);
     i++;
     v = rb_funcall(b, '+', 1, rb_funcall((((VALUE)((int)(i)))<<1 | RUBY_FIXNUM_FLAG), '*', 1, step));
 }
    }
    else {
 ...
 if (!!((VALUE)(tmp) != ((VALUE)RUBY_Qnil))) {
     ...
     iter[0] = (((VALUE)(1))<<1 | RUBY_FIXNUM_FLAG);
     iter[1] = step;
     rb_block_call(b, (__builtin_constant_p("upto") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("upto")), (long)strlen(("upto"))); (ID) rb_intern_id_cache; }) : rb_intern("upto")), 2, args, step_i, (VALUE)iter);
 }
 else {
     VALUE args[2];
  ...
  rb_raise(rb_eTypeError, "can't iterate from %s",
    rb_obj_classname(b));
     ...
     args[0] = (((VALUE)(1))<<1 | RUBY_FIXNUM_FLAG);
     args[1] = step;
...
int64_as_double_to_num(int64_t i)
{
    ...
    if (i < 0) {
 convert.i = -i;
 return rb_float_new_inline(-convert.d);
    }
    else {
 convert.i = i;
 return rb_float_new_inline(convert.d);
...
is_integer_p(VALUE v)
{
    ...
    return !(((VALUE)(is_int) & (VALUE)~((VALUE)RUBY_Qnil)) == 0) && is_int != ((VALUE)RUBY_Qundef);
}
static VALUE
range_bsearch(VALUE range)
{
    VALUE beg, end, satisfied = ((VALUE)RUBY_Qnil);
    int smaller;
    beg = (((struct RStruct*)(range))->as.ary[0]);
    end = (((struct RStruct*)(range))->as.ary[1]);

    if ((((int)(long)(beg))&RUBY_FIXNUM_FLAG) && (((int)(long)(end))&RUBY_FIXNUM_FLAG)) {
 long low = ((long)(((long)(beg))>>(int)(1)));
 long high = ((long)(((long)(end))>>(int)(1)));
 long mid, org_high;
 do { do { if (!rb_block_given_p()) return rb_enumeratorize_with_size((range), (rb_id2sym(rb_frame_this_func())), (0), (0), (rb_enumerator_size_func *)((0))); } while (0); if (!(((VALUE)((((struct RStruct*)(range))->as.ary[2])) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) high--; org_high = high; while (low < high) { mid = ((high < 0) == (low < 0)) ? low + ((high - low) / 2) : (low < -high) ? -((-1 - low - high)/2 + 1) : (low + high) / 2; do { VALUE val = ((((VALUE)(mid))<<1 | RUBY_FIXNUM_FLAG)); VALUE v = rb_yield(val); if ((((int)(long)(v))&RUBY_FIXNUM_FLAG)) { if (v == (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG)) return val; smaller = (long)v < 0; } else if (v == ((VALUE)RUBY_Qtrue)) { satisfied = val; smaller = 1; } else if (v == ((VALUE)RUBY_Qfalse) || v == ((VALUE)RUBY_Qnil)) { smaller = 0; } else if (rb_obj_is_kind_of(v, rb_cNumeric)) { int cmp = rb_cmpint(rb_funcall(v, idCmp, 1, (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG)), v, (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG)); if (!cmp) return val; smaller = cmp < 0; } else { rb_raise(rb_eTypeError, "wrong argument type %li\v (must be numeric, true, false or nil)", rb_obj_class(v)); } } while (0); if (smaller) { high = mid; } else { low = mid + 1; } } if (low == org_high) { do { VALUE val = ((((VALUE)(low))<<1 | RUBY_FIXNUM_FLAG)); VALUE v = rb_yield(val); if ((((int)(long)(v))&RUBY_FIXNUM_FLAG)) { if (v == (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG)) return val; smaller = (long)v < 0; } else if (v == ((VALUE)RUBY_Qtrue)) { satisfied = val; smaller = 1; } else if (v == ((VALUE)RUBY_Qfalse) || v == ((VALUE)RUBY_Qnil)) { smaller = 0; } else if (rb_obj_is_kind_of(v, rb_cNumeric)) { int cmp = rb_cmpint(rb_funcall(v, idCmp, 1, (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG)), v, (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG)); if (!cmp) return val; smaller = cmp < 0; } else { rb_raise(rb_eTypeError, "wrong argument type %li\v (must be numeric, true, false or nil)", rb_obj_class(v)); } } while (0); if (!smaller) return ((VALUE)RUBY_Qnil); } return satisfied; } while (0);
    }

    else if (( ((RUBY_T_FLOAT) == RUBY_T_FIXNUM) ? (((int)(long)(beg))&RUBY_FIXNUM_FLAG) : ((RUBY_T_FLOAT) == RUBY_T_TRUE) ? ((beg) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_FLOAT) == RUBY_T_FALSE) ? ((beg) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_FLOAT) == RUBY_T_NIL) ? ((beg) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_FLOAT) == RUBY_T_UNDEF) ? ((beg) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_FLOAT) == RUBY_T_SYMBOL) ? ((((VALUE)(beg)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(beg) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(beg) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(beg))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_FLOAT) == RUBY_T_FLOAT) ? ( ((((int)(long)(beg))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(beg) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(beg) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(beg))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(beg) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(beg) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(beg))->flags & RUBY_T_MASK) == (RUBY_T_FLOAT))) || ( ((RUBY_T_FLOAT) == RUBY_T_FIXNUM) ? (((int)(long)(end))&RUBY_FIXNUM_FLAG) : ((RUBY_T_FLOAT) == RUBY_T_TRUE) ? ((end) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_FLOAT) == RUBY_T_FALSE) ? ((end) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_FLOAT) == RUBY_T_NIL) ? ((end) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_FLOAT) == RUBY_T_UNDEF) ? ((end) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_FLOAT) == RUBY_T_SYMBOL) ? ((((VALUE)(end)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(end) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(end) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(end))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_FLOAT) == RUBY_T_FLOAT) ? ( ((((int)(long)(end))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(end) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(end) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(end))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(end) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(end) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(end))->flags & RUBY_T_MASK) == (RUBY_T_FLOAT)))) {
 int64_t low = double_as_int64(rb_float_value_inline(rb_Float(beg)));
 int64_t high = double_as_int64(rb_float_value_inline(rb_Float(end)));
 int64_t mid, org_high;
 do { do { if (!rb_block_given_p()) return rb_enumeratorize_with_size((range), (rb_id2sym(rb_frame_this_func())), (0), (0), (rb_enumerator_size_func *)((0))); } while (0); if (!(((VALUE)((((struct RStruct*)(range))->as.ary[2])) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) high--; org_high = high; while (low < high) { mid = ((high < 0) == (low < 0)) ? low + ((high - low) / 2) : (low < -high) ? -((-1 - low - high)/2 + 1) : (low + high) / 2; do { VALUE val = (int64_as_double_to_num(mid)); VALUE v = rb_yield(val); if ((((int)(long)(v))&RUBY_FIXNUM_FLAG)) { if (v == (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG)) return val; smaller = (long)v < 0; } else if (v == ((VALUE)RUBY_Qtrue)) { satisfied = val; smaller = 1; } else if (v == ((VALUE)RUBY_Qfalse) || v == ((VALUE)RUBY_Qnil)) { smaller = 0; } else if (rb_obj_is_kind_of(v, rb_cNumeric)) { int cmp = rb_cmpint(rb_funcall(v, idCmp, 1, (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG)), v, (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG)); if (!cmp) return val; smaller = cmp < 0; } else { rb_raise(rb_eTypeError, "wrong argument type %li\v (must be numeric, true, false or nil)", rb_obj_class(v)); } } while (0); if (smaller) { high = mid; } else { low = mid + 1; } } if (low == org_high) { do { VALUE val = (int64_as_double_to_num(low)); VALUE v = rb_yield(val); if ((((int)(long)(v))&RUBY_FIXNUM_FLAG)) { if (v == (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG)) return val; smaller = (long)v < 0; } else if (v == ((VALUE)RUBY_Qtrue)) { satisfied = val; smaller = 1; } else if (v == ((VALUE)RUBY_Qfalse) || v == ((VALUE)RUBY_Qnil)) { smaller = 0; } else if (rb_obj_is_kind_of(v, rb_cNumeric)) { int cmp = rb_cmpint(rb_funcall(v, idCmp, 1, (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG)), v, (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG)); if (!cmp) return val; smaller = cmp < 0; } else { rb_raise(rb_eTypeError, "wrong argument type %li\v (must be numeric, true, false or nil)", rb_obj_class(v)); } } while (0); if (!smaller) return ((VALUE)RUBY_Qnil); } return satisfied; } while (0);
    }
 ...
 VALUE mid, org_high;
 do { if (!rb_block_given_p()) return rb_enumeratorize_with_size((range), (rb_id2sym(rb_frame_this_func())), (0), (0), (rb_enumerator_size_func *)((0))); } while (0);
 if (!(((VALUE)((((struct RStruct*)(range))->as.ary[2])) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) high = rb_funcall(high, '-', 1, (((VALUE)(1))<<1 | RUBY_FIXNUM_FLAG));
 org_high = high;

 while (rb_cmpint(rb_funcall(low, idCmp, 1, high), low, high) < 0) {
     mid = rb_funcall(rb_funcall(high, '+', 1, low), id_div, 1, (((VALUE)(2))<<1 | RUBY_FIXNUM_FLAG));
     do { VALUE val = (mid); VALUE v = rb_yield(val); if ((((int)(long)(v))&RUBY_FIXNUM_FLAG)) { if (v == (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG)) return val; smaller = (long)v < 0; } else if (v == ((VALUE)RUBY_Qtrue)) { satisfied = val; smaller = 1; } else if (v == ((VALUE)RUBY_Qfalse) || v == ((VALUE)RUBY_Qnil)) { smaller = 0; } else if (rb_obj_is_kind_of(v, rb_cNumeric)) { int cmp = rb_cmpint(rb_funcall(v, idCmp, 1, (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG)), v, (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG)); if (!cmp) return val; smaller = cmp < 0; } else { rb_raise(rb_eTypeError, "wrong argument type %li\v (must be numeric, true, false or nil)", rb_obj_class(v)); } } while (0);
     if (smaller) {
  high = mid;
     }
     else {
  low = rb_funcall(mid, '+', 1, (((VALUE)(1))<<1 | RUBY_FIXNUM_FLAG));
     }
 }
 if (rb_equal(low, org_high)) {
     do { VALUE val = (low); VALUE v = rb_yield(val); if ((((int)(long)(v))&RUBY_FIXNUM_FLAG)) { if (v == (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG)) return val; smaller = (long)v < 0; } else if (v == ((VALUE)RUBY_Qtrue)) { satisfied = val; smaller = 1; } else if (v == ((VALUE)RUBY_Qfalse) || v == ((VALUE)RUBY_Qnil)) { smaller = 0; } else if (rb_obj_is_kind_of(v, rb_cNumeric)) { int cmp = rb_cmpint(rb_funcall(v, idCmp, 1, (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG)), v, (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG)); if (!cmp) return val; smaller = cmp < 0; } else { rb_raise(rb_eTypeError, "wrong argument type %li\v (must be numeric, true, false or nil)", rb_obj_class(v)); } } while (0);
     if (!smaller) return ((VALUE)RUBY_Qnil);
 }
 return satisfied;
    }
    else {
...
static VALUE
each_i(VALUE v, VALUE arg, int argc, const VALUE *argv, VALUE blockarg)
{
    rb_yield(v);
    return ((VALUE)RUBY_Qnil);
}
...
static VALUE
sym_each_i(VALUE v, VALUE arg, int argc, const VALUE *argv, VALUE blockarg)
{
...
range_size(VALUE range)
{
    VALUE b = (((struct RStruct*)(range))->as.ary[0]), e = (((struct RStruct*)(range))->as.ary[1]);
    if (rb_obj_is_kind_of(b, rb_cNumeric) && rb_obj_is_kind_of(e, rb_cNumeric)) {
 return ruby_num_interval_step_size(b, e, (((VALUE)(1))<<1 | RUBY_FIXNUM_FLAG), !(((VALUE)((((struct RStruct*)(range))->as.ary[2])) & (VALUE)~((VALUE)RUBY_Qnil)) == 0));
    }
    return ((VALUE)RUBY_Qnil);
}
...
range_each(VALUE range)
{
    ...
    do { if (!rb_block_given_p()) return rb_enumeratorize_with_size((range), (rb_id2sym(rb_frame_this_func())), (0), (0), (rb_enumerator_size_func *)((range_enum_size))); } while (0);

    beg = (((struct RStruct*)(range))->as.ary[0]);
    end = (((struct RStruct*)(range))->as.ary[1]);

    if ((((int)(long)(beg))&RUBY_FIXNUM_FLAG) && (((int)(long)(end))&RUBY_FIXNUM_FLAG)) {
 long lim = ((long)(((long)(end))>>(int)(1)));
 long i;

 if (!!(((VALUE)((((struct RStruct*)(range))->as.ary[2])) & (VALUE)~((VALUE)RUBY_Qnil)) == 0))
     lim += 1;
 for (i = ((long)(((long)(beg))>>(int)(1))); i < lim; i++) {
     rb_yield((((VALUE)(i))<<1 | RUBY_FIXNUM_FLAG));
 }
    }
    else if (((((VALUE)(beg)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(beg) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(beg) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(beg))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) && ((((VALUE)(end)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(end) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(end) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(end))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL)))) {
 VALUE args[2];

 args[0] = rb_sym2str(end);
 args[1] = !(((VALUE)((((struct RStruct*)(range))->as.ary[2])) & (VALUE)~((VALUE)RUBY_Qnil)) == 0) ? ((VALUE)RUBY_Qtrue) : ((VALUE)RUBY_Qfalse);
 rb_block_call(rb_sym2str(beg), (__builtin_constant_p("upto") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("upto")), (long)strlen(("upto"))); (ID) rb_intern_id_cache; }) : rb_intern("upto")), 2, args, sym_each_i, 0);
    }
    else {
 ...
 if (!!((VALUE)(tmp) != ((VALUE)RUBY_Qnil))) {
     ...
     args[0] = end;
     args[1] = !(((VALUE)((((struct RStruct*)(range))->as.ary[2])) & (VALUE)~((VALUE)RUBY_Qnil)) == 0) ? ((VALUE)RUBY_Qtrue) : ((VALUE)RUBY_Qfalse);
     rb_block_call(tmp, (__builtin_constant_p("upto") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("upto")), (long)strlen(("upto"))); (ID) rb_intern_id_cache; }) : rb_intern("upto")), 2, args, each_i, 0);
 }
 else {
...
{
    return (((struct RStruct*)(range))->as.ary[0]);
}
static VALUE
range_end(VALUE range)
{
    return (((struct RStruct*)(range))->as.ary[1]);
}


static VALUE
first_i(VALUE i, VALUE cbarg, int argc, const VALUE *argv, VALUE blockarg)
{
    VALUE *ary = (VALUE *)cbarg;
    long n = rb_num2long_inline(ary[0]);
 ...
 rb_iter_break();
    ...
    rb_ary_push(ary[1], i);
    n--;
    ary[0] = (((VALUE)((int)(n)))<<1 | RUBY_FIXNUM_FLAG);
    return ((VALUE)RUBY_Qnil);
}
static VALUE
range_first(int argc, VALUE *argv, VALUE range)
{
    ...
    if (argc == 0) return (((struct RStruct*)(range))->as.ary[0]);

    rb_scan_args(argc, argv, "1", &n);
    ary[0] = n;
    ary[1] = rb_ary_new_capa(rb_num2long_inline(n));
...
{
    if (argc == 0) return (((struct RStruct*)(range))->as.ary[1]);
...
range_min(int argc, VALUE *argv, VALUE range)
{
 ...
 VALUE b = (((struct RStruct*)(range))->as.ary[0]);
 VALUE e = (((struct RStruct*)(range))->as.ary[1]);
 int c = (((((int)(long)(b))&RUBY_FIXNUM_FLAG) && (((int)(long)(e))&RUBY_FIXNUM_FLAG) && (((cmp_opt).opt_inited & (1U << cmp_opt_Fixnum)) ? ((cmp_opt).opt_methods & (1U << cmp_opt_Fixnum)) : (((cmp_opt).opt_inited |= (1U << cmp_opt_Fixnum)), rb_method_basic_definition_p(rb_cInteger, idCmp) && ((cmp_opt).opt_methods |= (1U << cmp_opt_Fixnum))))) ? (((long)b > (long)e) ? 1 : ((long)b < (long)e) ? -1 : 0) : ((( ((RUBY_T_STRING) == RUBY_T_FIXNUM) ? (((int)(long)((b)))&RUBY_FIXNUM_FLAG) : ((RUBY_T_STRING) == RUBY_T_TRUE) ? (((b)) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_STRING) == RUBY_T_FALSE) ? (((b)) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_STRING) == RUBY_T_NIL) ? (((b)) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_STRING) == RUBY_T_UNDEF) ? (((b)) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_STRING) == RUBY_T_SYMBOL) ? ((((VALUE)((b))&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)((b)) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)((b)) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)((b)))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_STRING) == RUBY_T_FLOAT) ? ( ((((int)(long)((b)))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)((b)) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)((b)) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)((b)))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)((b)) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)((b)) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)((b)))->flags & RUBY_T_MASK) == (RUBY_T_STRING))) && rb_class_of((VALUE)(b)) == rb_cString) && (( ((RUBY_T_STRING) == RUBY_T_FIXNUM) ? (((int)(long)((e)))&RUBY_FIXNUM_FLAG) : ((RUBY_T_STRING) == RUBY_T_TRUE) ? (((e)) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_STRING) == RUBY_T_FALSE) ? (((e)) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_STRING) == RUBY_T_NIL) ? (((e)) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_STRING) == RUBY_T_UNDEF) ? (((e)) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_STRING) == RUBY_T_SYMBOL) ? ((((VALUE)((e))&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)((e)) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)((e)) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)((e)))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_STRING) == RUBY_T_FLOAT) ? ( ((((int)(long)((e)))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)((e)) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)((e)) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)((e)))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)((e)) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)((e)) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)((e)))->flags & RUBY_T_MASK) == (RUBY_T_STRING))) && rb_class_of((VALUE)(e)) == rb_cString) && (((cmp_opt).opt_inited & (1U << cmp_opt_String)) ? ((cmp_opt).opt_methods & (1U << cmp_opt_String)) : (((cmp_opt).opt_inited |= (1U << cmp_opt_String)), rb_method_basic_definition_p(rb_cString, idCmp) && ((cmp_opt).opt_methods |= (1U << cmp_opt_String))))) ? rb_str_cmp(b, e) : (( ((((int)(long)(b))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(b) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(b) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(b))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) && ( ((((int)(long)(e))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(e) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(e) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(e))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) && (((cmp_opt).opt_inited & (1U << cmp_opt_Float)) ? ((cmp_opt).opt_methods & (1U << cmp_opt_Float)) : (((cmp_opt).opt_inited |= (1U << cmp_opt_Float)), rb_method_basic_definition_p(rb_cFloat, idCmp) && ((cmp_opt).opt_methods |= (1U << cmp_opt_Float))))) ? rb_float_cmp(b, e) : rb_cmpint(rb_funcallv(b, idCmp, 1, &e), b, e));

 if (c > 0 || (c == 0 && !(((VALUE)((((struct RStruct*)(range))->as.ary[2])) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)))
     return ((VALUE)RUBY_Qnil);
 return b;
    }
}
...
{
    VALUE e = (((struct RStruct*)(range))->as.ary[1]);
    int nm = (((int)(long)(e))&RUBY_FIXNUM_FLAG) || rb_obj_is_kind_of(e, rb_cNumeric);

    if (rb_block_given_p() || (!(((VALUE)((((struct RStruct*)(range))->as.ary[2])) & (VALUE)~((VALUE)RUBY_Qnil)) == 0) && !nm) || argc) {
 return rb_call_super(argc, argv);
    }
    else {
 struct cmp_opt_data cmp_opt = { 0, 0 };
 ...
 if (c > 0)
     return ((VALUE)RUBY_Qnil);
 if (!(((VALUE)((((struct RStruct*)(range))->as.ary[2])) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) {
     if (!(((int)(long)(e))&RUBY_FIXNUM_FLAG) && !rb_obj_is_kind_of(e, rb_cInteger)) {
  rb_raise(rb_eTypeError, "cannot exclude non Integer end value");
     }
     if (c == 0) return ((VALUE)RUBY_Qnil);
     if (!(((int)(long)(b))&RUBY_FIXNUM_FLAG) && !rb_obj_is_kind_of(b,rb_cInteger)) {
  rb_raise(rb_eTypeError, "cannot exclude end value with non Integer begin value");
     }
     if ((((int)(long)(e))&RUBY_FIXNUM_FLAG)) {
  return rb_long2num_inline(((long)(((long)(e))>>(int)(1))) - 1);
     }
     return rb_funcall(e, '-', 1, (((VALUE)(1))<<1 | RUBY_FIXNUM_FLAG));
 }
 return e;
    }
}
...
rb_range_values(VALUE range, VALUE *begp, VALUE *endp, int *exclp)
{
 ...
 b = (((struct RStruct*)(range))->as.ary[0]);
 e = (((struct RStruct*)(range))->as.ary[1]);
 excl = !(((VALUE)((((struct RStruct*)(range))->as.ary[2])) & (VALUE)~((VALUE)RUBY_Qnil)) == 0);
    }
    else {
 VALUE x;
 b = rb_check_funcall(range, id_beg, 0, 0);
 if (b == ((VALUE)RUBY_Qundef)) return (int)((VALUE)RUBY_Qfalse);
 e = rb_check_funcall(range, id_end, 0, 0);
 if (e == ((VALUE)RUBY_Qundef)) return (int)((VALUE)RUBY_Qfalse);
 x = rb_check_funcall(range, (__builtin_constant_p("exclude_end?") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("exclude_end?")), (long)strlen(("exclude_end?"))); (ID) rb_intern_id_cache; }) : rb_intern("exclude_end?")), 0, 0);
 if (x == ((VALUE)RUBY_Qundef)) return (int)((VALUE)RUBY_Qfalse);
 excl = !(((VALUE)(x) & (VALUE)~((VALUE)RUBY_Qnil)) == 0);
    }
    *begp = b;
    *endp = e;
    *exclp = excl;
...
rb_range_beg_len(VALUE range, long *begp, long *lenp, long len, int err)
{
 ...
 return ((VALUE)RUBY_Qfalse);
    beg = rb_num2long_inline(b);
    end = rb_num2long_inline(e);
    origbeg = beg;
    origend = end;
    if (beg < 0) {
 beg += len;
...
range_to_s(VALUE range)
{
    ...
    str = rb_obj_as_string((((struct RStruct*)(range))->as.ary[0]));
    str2 = rb_obj_as_string((((struct RStruct*)(range))->as.ary[1]));
    str = rb_str_dup(str);
    rb_str_cat(str, "...", !(((VALUE)((((struct RStruct*)(range))->as.ary[2])) & (VALUE)~((VALUE)RUBY_Qnil)) == 0) ? 3 : 2);
    rb_str_append(str, str2);
    ( (((!(((VALUE)(str) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(str) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(str))->flags & RUBY_T_MASK) != RUBY_T_NODE) && (int)(((struct RBasic*)(str))->flags & RUBY_T_MASK) != RUBY_T_BIGNUM && (int)(((struct RBasic*)(str))->flags & RUBY_T_MASK) != RUBY_T_FLOAT) && (!(((VALUE)(range) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(range) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(range))->flags & RUBY_T_MASK) != RUBY_T_NODE)) ? (void)(((struct RBasic*)(str))->flags |= ((((struct RBasic*)(range))->flags&(RUBY_FL_TAINT)))) : (void)0);
...
inspect_range(VALUE range, VALUE dummy, int recur)
{
    ...
    if (recur) {
 return  ({ (__builtin_constant_p(!(((VALUE)((((struct RStruct*)(range))->as.ary[2])) & (VALUE)~((VALUE)RUBY_Qnil)) == 0) ? "(... ... ...)": "(... .. ...)")) ? rb_str_new_static((!(((VALUE)((((struct RStruct*)(range))->as.ary[2])) & (VALUE)~((VALUE)RUBY_Qnil)) == 0) ? "(... ... ...)": "(... .. ...)"), (long)strlen(!(((VALUE)((((struct RStruct*)(range))->as.ary[2])) & (VALUE)~((VALUE)RUBY_Qnil)) == 0) ? "(... ... ...)": "(... .. ...)")) : rb_str_new_cstr(!(((VALUE)((((struct RStruct*)(range))->as.ary[2])) & (VALUE)~((VALUE)RUBY_Qnil)) == 0) ? "(... ... ...)": "(... .. ...)"); });
    }
    str = rb_inspect((((struct RStruct*)(range))->as.ary[0]));
    str2 = rb_inspect((((struct RStruct*)(range))->as.ary[1]));
    str = rb_str_dup(str);
    rb_str_cat(str, "...", !(((VALUE)((((struct RStruct*)(range))->as.ary[2])) & (VALUE)~((VALUE)RUBY_Qnil)) == 0) ? 3 : 2);
    rb_str_append(str, str2);
    ( (((!(((VALUE)(str) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(str) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(str))->flags & RUBY_T_MASK) != RUBY_T_NODE) && (int)(((struct RBasic*)(str))->flags & RUBY_T_MASK) != RUBY_T_BIGNUM && (int)(((struct RBasic*)(str))->flags & RUBY_T_MASK) != RUBY_T_FLOAT) && (!(((VALUE)(range) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(range) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(range))->flags & RUBY_T_MASK) != RUBY_T_NODE)) ? (void)(((struct RBasic*)(str))->flags |= ((((struct RBasic*)(range))->flags&(RUBY_FL_TAINT)))) : (void)0);
...
{
    return rb_funcall(range, (__builtin_constant_p("include?") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("include?")), (long)strlen(("include?"))); (ID) rb_intern_id_cache; }) : rb_intern("include?")), 1, val);
}
static VALUE
range_include(VALUE range, VALUE val)
{
    VALUE beg = (((struct RStruct*)(range))->as.ary[0]);
    VALUE end = (((struct RStruct*)(range))->as.ary[1]);
    int nv = (((int)(long)(beg))&RUBY_FIXNUM_FLAG) || (((int)(long)(end))&RUBY_FIXNUM_FLAG) ||
      linear_object_p(beg) || linear_object_p(end);

    if (nv ||
 !!((VALUE)(rb_check_to_integer(beg, "to_int")) != ((VALUE)RUBY_Qnil)) ||
 !!((VALUE)(rb_check_to_integer(end, "to_int")) != ((VALUE)RUBY_Qnil))) {
 return r_cover_p(range, beg, end, val);
    }
    else if (( ((RUBY_T_STRING) == RUBY_T_FIXNUM) ? (((int)(long)(beg))&RUBY_FIXNUM_FLAG) : ((RUBY_T_STRING) == RUBY_T_TRUE) ? ((beg) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_STRING) == RUBY_T_FALSE) ? ((beg) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_STRING) == RUBY_T_NIL) ? ((beg) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_STRING) == RUBY_T_UNDEF) ? ((beg) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_STRING) == RUBY_T_SYMBOL) ? ((((VALUE)(beg)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(beg) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(beg) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(beg))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_STRING) == RUBY_T_FLOAT) ? ( ((((int)(long)(beg))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(beg) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(beg) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(beg))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(beg) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(beg) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(beg))->flags & RUBY_T_MASK) == (RUBY_T_STRING))) && ( ((RUBY_T_STRING) == RUBY_T_FIXNUM) ? (((int)(long)(end))&RUBY_FIXNUM_FLAG) : ((RUBY_T_STRING) == RUBY_T_TRUE) ? ((end) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_STRING) == RUBY_T_FALSE) ? ((end) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_STRING) == RUBY_T_NIL) ? ((end) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_STRING) == RUBY_T_UNDEF) ? ((end) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_STRING) == RUBY_T_SYMBOL) ? ((((VALUE)(end)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(end) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(end) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(end))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_STRING) == RUBY_T_FLOAT) ? ( ((((int)(long)(end))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(end) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(end) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(end))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(end) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(end) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(end))->flags & RUBY_T_MASK) == (RUBY_T_STRING)))) {
 VALUE rb_str_include_range_p(VALUE beg, VALUE end, VALUE val, VALUE exclusive);
 return rb_str_include_range_p(beg, end, val, (((struct RStruct*)(range))->as.ary[2]));
    }
...
{
    if (r_less(beg, val) <= 0) {
 int excl = !(((VALUE)((((struct RStruct*)(range))->as.ary[2])) & (VALUE)~((VALUE)RUBY_Qnil)) == 0);
...
{
    VALUE v;
    struct RObject *(m) = (struct RObject*)(((RUBY_T_OBJECT | (1 ? ((VALUE)RUBY_FL_WB_PROTECTED) : 1)) & ((VALUE)RUBY_FL_WB_PROTECTED)) ? rb_wb_protected_newobj_of(rb_cObject, (RUBY_T_OBJECT | (1 ? ((VALUE)RUBY_FL_WB_PROTECTED) : 1)) & ~((VALUE)RUBY_FL_WB_PROTECTED)) : rb_wb_unprotected_newobj_of(rb_cObject, RUBY_T_OBJECT | (1 ? ((VALUE)RUBY_FL_WB_PROTECTED) : 1)));

    v = (VALUE)m;

    rb_ivar_set(v, id_excl, (((struct RStruct*)(range))->as.ary[2]));
    rb_ivar_set(v, id_beg, (((struct RStruct*)(range))->as.ary[0]));
    rb_ivar_set(v, id_end, (((struct RStruct*)(range))->as.ary[1]));
    return v;
}
...
range_loader(VALUE range, VALUE obj)
{
    ...
    if (!!((VALUE)(excl) != ((VALUE)RUBY_Qnil))) {
 range_init(range, beg, end, ((!(((VALUE)(excl) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) ? ((VALUE)RUBY_Qtrue) : ((VALUE)RUBY_Qfalse)));
    }
    return range;
}
...
Init_Range(void)
{
    ...
    id_beg = (__builtin_constant_p("begin") ?  (rb_intern2(("begin"), (long)strlen("begin"))) : (rb_intern)("begin"));
    id_end = (__builtin_constant_p("end") ?  (rb_intern2(("end"), (long)strlen("end"))) : (rb_intern)("end"));
    id_excl = (__builtin_constant_p("excl") ?  (rb_intern2(("excl"), (long)strlen("excl"))) : (rb_intern)("excl"));
