...
rb_class_subclass_add(VALUE super, VALUE klass)
{
    ...
    if (super && super != ((VALUE)RUBY_Qundef)) {
 entry = ((rb_subclass_entry_t*)ruby_xmalloc(sizeof(rb_subclass_entry_t)));
 entry->klass = klass;
 entry->next = ((void*)0);

 head = (((struct RClass*)(super))->ptr)->subclasses;
 if (head) {
     entry->next = head;
     (((struct RClass*)(head->klass))->ptr)->parent_subclasses = &entry->next;
 }

 (((struct RClass*)(super))->ptr)->subclasses = entry;
 (((struct RClass*)(klass))->ptr)->parent_subclasses = &(((struct RClass*)(super))->ptr)->subclasses;
    }
}
...
rb_module_add_to_subclasses_list(VALUE module, VALUE iclass)
{
    ...
    head = (((struct RClass*)(module))->ptr)->subclasses;
    if (head) {
 entry->next = head;
 (((struct RClass*)(head->klass))->ptr)->module_subclasses = &entry->next;
    }

    (((struct RClass*)(module))->ptr)->subclasses = entry;
    (((struct RClass*)(iclass))->ptr)->module_subclasses = &(((struct RClass*)(module))->ptr)->subclasses;
}
...
rb_class_remove_from_super_subclasses(VALUE klass)
{
    ...
    if ((((struct RClass*)(klass))->ptr)->parent_subclasses) {
 entry = *(((struct RClass*)(klass))->ptr)->parent_subclasses;

 *(((struct RClass*)(klass))->ptr)->parent_subclasses = entry->next;
 if (entry->next) {
     (((struct RClass*)(entry->next->klass))->ptr)->parent_subclasses = (((struct RClass*)(klass))->ptr)->parent_subclasses;
 }
 ruby_xfree(entry);
    }

    (((struct RClass*)(klass))->ptr)->parent_subclasses = ((void*)0);
}
...
rb_class_remove_from_module_subclasses(VALUE klass)
{
    ...
    if ((((struct RClass*)(klass))->ptr)->module_subclasses) {
 entry = *(((struct RClass*)(klass))->ptr)->module_subclasses;
 *(((struct RClass*)(klass))->ptr)->module_subclasses = entry->next;

 if (entry->next) {
     (((struct RClass*)(entry->next->klass))->ptr)->module_subclasses = (((struct RClass*)(klass))->ptr)->module_subclasses;
 }

 ruby_xfree(entry);
    }

    (((struct RClass*)(klass))->ptr)->module_subclasses = ((void*)0);
}

void
rb_class_foreach_subclass(VALUE klass, void (*f)(VALUE, VALUE), VALUE arg)
{
    rb_subclass_entry_t *cur = (((struct RClass*)(klass))->ptr)->subclasses;
...
{
    rb_class_foreach_subclass(klass, class_detach_subclasses, ((VALUE)RUBY_Qnil));
}
...
{
    rb_class_foreach_subclass(klass, class_detach_module_subclasses, ((VALUE)RUBY_Qnil));
}
static VALUE
class_alloc(VALUE flags, VALUE klass)
{
    struct RClass *(obj) = (struct RClass*)((((flags & RUBY_T_MASK) | ((VALUE)RUBY_FL_PROMOTED1) | (1 ? ((VALUE)RUBY_FL_WB_PROTECTED) : 0)) & ((VALUE)RUBY_FL_WB_PROTECTED)) ? rb_wb_protected_newobj_of(klass, ((flags & RUBY_T_MASK) | ((VALUE)RUBY_FL_PROMOTED1) | (1 ? ((VALUE)RUBY_FL_WB_PROTECTED) : 0)) & ~((VALUE)RUBY_FL_WB_PROTECTED)) : rb_wb_unprotected_newobj_of(klass, (flags & RUBY_T_MASK) | ((VALUE)RUBY_FL_PROMOTED1) | (1 ? ((VALUE)RUBY_FL_WB_PROTECTED) : 0)));
    obj->ptr = (((rb_classext_t*)ruby_xcalloc((size_t)(1),sizeof(rb_classext_t))));
    RCLASS_SET_ORIGIN((VALUE)obj, (VALUE)obj);
    ((((struct RClass*)(obj))->ptr)->class_serial) = rb_next_class_serial();
    ((((struct RClass*)(obj))->ptr)->refined_class) = ((VALUE)RUBY_Qnil);
    (((struct RClass*)(obj))->ptr)->allocator = 0;
...
{
    (((struct RClass*)(c))->m_tbl) = rb_id_table_create(0);
}
VALUE
rb_class_boot(VALUE super)
{
    VALUE klass = class_alloc(RUBY_T_CLASS, rb_cClass);

    RCLASS_SET_SUPER(klass, super);
    RCLASS_M_TBL_INIT(klass);

    ( (((!(((VALUE)(klass) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(klass) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(klass))->flags & RUBY_T_MASK) != RUBY_T_NODE) && (int)(((struct RBasic*)(klass))->flags & RUBY_T_MASK) != RUBY_T_BIGNUM && (int)(((struct RBasic*)(klass))->flags & RUBY_T_MASK) != RUBY_T_FLOAT) && (!(((VALUE)(super) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(super) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(super))->flags & RUBY_T_MASK) != RUBY_T_NODE)) ? (void)(((struct RBasic*)(klass))->flags |= ((((struct RBasic*)(super))->flags&(RUBY_FL_TAINT)))) : (void)0);
    return (VALUE)klass;
}
void
rb_check_inheritable(VALUE super)
{
    if (!( ((RUBY_T_CLASS) == RUBY_T_FIXNUM) ? (((int)(long)(super))&RUBY_FIXNUM_FLAG) : ((RUBY_T_CLASS) == RUBY_T_TRUE) ? ((super) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_CLASS) == RUBY_T_FALSE) ? ((super) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_CLASS) == RUBY_T_NIL) ? ((super) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_CLASS) == RUBY_T_UNDEF) ? ((super) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_CLASS) == RUBY_T_SYMBOL) ? ((((VALUE)(super)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(super) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(super) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(super))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_CLASS) == RUBY_T_FLOAT) ? ( ((((int)(long)(super))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(super) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(super) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(super))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(super) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(super) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(super))->flags & RUBY_T_MASK) == (RUBY_T_CLASS)))) {
 rb_raise(rb_eTypeError, "superclass must be a Class (%li\v given)",
   rb_obj_class(super));
    }
    if (((struct RBasic*)(super))->flags & ((VALUE)RUBY_FL_SINGLETON)) {
...
{
    (!( (((RUBY_T_CLASS)) == RUBY_T_FIXNUM) ? (((int)(long)((VALUE)(super)))&RUBY_FIXNUM_FLAG) : (((RUBY_T_CLASS)) == RUBY_T_TRUE) ? (((VALUE)(super)) == ((VALUE)RUBY_Qtrue)) : (((RUBY_T_CLASS)) == RUBY_T_FALSE) ? (((VALUE)(super)) == ((VALUE)RUBY_Qfalse)) : (((RUBY_T_CLASS)) == RUBY_T_NIL) ? (((VALUE)(super)) == ((VALUE)RUBY_Qnil)) : (((RUBY_T_CLASS)) == RUBY_T_UNDEF) ? (((VALUE)(super)) == ((VALUE)RUBY_Qundef)) : (((RUBY_T_CLASS)) == RUBY_T_SYMBOL) ? ((((VALUE)((VALUE)(super))&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)((VALUE)(super)) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)((VALUE)(super)) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)((VALUE)(super)))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : (((RUBY_T_CLASS)) == RUBY_T_FLOAT) ? ( ((((int)(long)((VALUE)(super)))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)((VALUE)(super)) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)((VALUE)(super)) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)((VALUE)(super)))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)((VALUE)(super)) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)((VALUE)(super)) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)((VALUE)(super)))->flags & RUBY_T_MASK) == ((RUBY_T_CLASS)))) || ((RUBY_T_CLASS) == RUBY_T_DATA && (((struct RTypedData*)(super))->typed_flag == 1)) ? rb_unexpected_type((VALUE)(super), (RUBY_T_CLASS)) : (void)0);
...
clone_method(VALUE old_klass, VALUE new_klass, ID mid, const rb_method_entry_t *me)
{
 ...
 rb_add_method_iseq(new_klass, mid, me->def->body.iseq.iseqptr, new_cref, (rb_method_visibility_t)(((me)->flags & (((VALUE)RUBY_FL_USER4) | ((VALUE)RUBY_FL_USER5))) >> ((((VALUE)RUBY_FL_USHIFT) + 4)+0)));
    }
    else {
 rb_method_entry_set(new_klass, mid, me, (rb_method_visibility_t)(((me)->flags & (((VALUE)RUBY_FL_USER4) | ((VALUE)RUBY_FL_USER5))) >> ((((VALUE)RUBY_FL_USHIFT) + 4)+0)));
    }
}
...
{
    rb_const_entry_t *nce = ((rb_const_entry_t*)ruby_xmalloc(sizeof(rb_const_entry_t)));
    memcpy((nce), (ce), sizeof(rb_const_entry_t)*(size_t)(1));
    rb_obj_written((VALUE)(arg->klass), (VALUE)(((VALUE)RUBY_Qundef)), (VALUE)(ce->value), "class.c", 285);
    rb_obj_written((VALUE)(arg->klass), (VALUE)(((VALUE)RUBY_Qundef)), (VALUE)(ce->file), "class.c", 286);
...
class_init_copy_check(VALUE clone, VALUE orig)
{
 ...
 rb_raise(rb_eTypeError, "already initialized class");
    ...
    if (((!(((VALUE)(orig) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(orig) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(orig))->flags & RUBY_T_MASK) != RUBY_T_NODE)?(((struct RBasic*)((orig)))->flags&((((VALUE)RUBY_FL_SINGLETON)))):0)) {
...
{
    if (( ((RUBY_T_CLASS) == RUBY_T_FIXNUM) ? (((int)(long)(clone))&RUBY_FIXNUM_FLAG) : ((RUBY_T_CLASS) == RUBY_T_TRUE) ? ((clone) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_CLASS) == RUBY_T_FALSE) ? ((clone) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_CLASS) == RUBY_T_NIL) ? ((clone) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_CLASS) == RUBY_T_UNDEF) ? ((clone) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_CLASS) == RUBY_T_SYMBOL) ? ((((VALUE)(clone)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(clone) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(clone) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(clone))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_CLASS) == RUBY_T_FLOAT) ? ( ((((int)(long)(clone))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(clone) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(clone) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(clone))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(clone) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(clone) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(clone))->flags & RUBY_T_MASK) == (RUBY_T_CLASS)))) {
 class_init_copy_check(clone, orig);
    }
    if (!((clone) != (orig) && (rb_obj_init_copy((clone), (orig)), 1))) return clone;
    if (!((!(((VALUE)(rb_class_of((VALUE)(clone))) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(rb_class_of((VALUE)(clone))) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(rb_class_of((VALUE)(clone))))->flags & RUBY_T_MASK) != RUBY_T_NODE)?(((struct RBasic*)((rb_class_of((VALUE)(clone)))))->flags&((((VALUE)RUBY_FL_SINGLETON)))):0)) {
 do { VALUE _obj_ = (clone); rb_obj_write((VALUE)(_obj_), (VALUE *)(&((struct RBasicRaw *)(_obj_))->klass), (VALUE)(rb_singleton_class_clone(orig)), "class.c", 321); } while (0);
 rb_singleton_class_attached(((struct RBasic*)(clone))->klass, (VALUE)clone);
    }
    RCLASS_SET_SUPER(clone, RCLASS_SUPER(orig));
    (((struct RClass*)(clone))->ptr)->allocator = (((struct RClass*)(orig))->ptr)->allocator;
    if (((((struct RClass*)(clone))->ptr)->iv_tbl)) {
 st_free_table(((((struct RClass*)(clone))->ptr)->iv_tbl));
 ((((struct RClass*)(clone))->ptr)->iv_tbl) = 0;
    }
    if (((((struct RClass*)(clone))->ptr)->const_tbl)) {
 rb_free_const_table(((((struct RClass*)(clone))->ptr)->const_tbl));
 ((((struct RClass*)(clone))->ptr)->const_tbl) = 0;
    }
    (((struct RClass*)(clone))->m_tbl) = 0;
    if (((((struct RClass*)(orig))->ptr)->iv_tbl)) {
 st_data_t id;

 ((((struct RClass*)(clone))->ptr)->iv_tbl) = rb_st_copy(clone, ((((struct RClass*)(orig))->ptr)->iv_tbl));
 do { static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("__tmp_classpath__")), (long)strlen(("__tmp_classpath__"))); (id) = rb_intern_id_cache; } while (0);
 st_delete(((((struct RClass*)(clone))->ptr)->iv_tbl), &id, 0);
 do { static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("__classpath__")), (long)strlen(("__classpath__"))); (id) = rb_intern_id_cache; } while (0);
 st_delete(((((struct RClass*)(clone))->ptr)->iv_tbl), &id, 0);
 do { static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("__classid__")), (long)strlen(("__classid__"))); (id) = rb_intern_id_cache; } while (0);
 st_delete(((((struct RClass*)(clone))->ptr)->iv_tbl), &id, 0);
    }
    if (((((struct RClass*)(orig))->ptr)->const_tbl)) {
 struct clone_const_arg arg;

 arg.tbl = ((((struct RClass*)(clone))->ptr)->const_tbl) = rb_id_table_create(0);
 arg.klass = clone;
 rb_id_table_foreach(((((struct RClass*)(orig))->ptr)->const_tbl), clone_const_i, &arg);
    }
    if ((((struct RClass*)(orig))->m_tbl)) {
 struct clone_method_arg arg;
 arg.old_klass = orig;
 arg.new_klass = clone;
 RCLASS_M_TBL_INIT(clone);
 rb_id_table_foreach((((struct RClass*)(orig))->m_tbl), clone_method_i, &arg);
    }
...
{
    return rb_singleton_class_clone_and_attach(obj, ((VALUE)RUBY_Qundef));
}

VALUE
rb_singleton_class_clone_and_attach(VALUE obj, VALUE attach)
{
    const VALUE klass = ((struct RBasic*)(obj))->klass;
 ...
 VALUE clone = class_alloc(((struct RBasic*)(klass))->flags, 0);

 if ((int)(((struct RBasic*)(obj))->flags & RUBY_T_MASK) == RUBY_T_CLASS) {
     do { VALUE _obj_ = (clone); rb_obj_write((VALUE)(_obj_), (VALUE *)(&((struct RBasicRaw *)(_obj_))->klass), (VALUE)(clone), "class.c", 382); } while (0);
 }
 else {
     do { VALUE _obj_ = (clone); rb_obj_write((VALUE)(_obj_), (VALUE *)(&((struct RBasicRaw *)(_obj_))->klass), (VALUE)(rb_singleton_class_clone(klass)), "class.c", 385); } while (0);
 }

 RCLASS_SET_SUPER(clone, RCLASS_SUPER(klass));
 (((struct RClass*)(clone))->ptr)->allocator = (((struct RClass*)(klass))->ptr)->allocator;
 if (((((struct RClass*)(klass))->ptr)->iv_tbl)) {
     ((((struct RClass*)(clone))->ptr)->iv_tbl) = rb_st_copy(clone, ((((struct RClass*)(klass))->ptr)->iv_tbl));
 }
 if (((((struct RClass*)(klass))->ptr)->const_tbl)) {
     struct clone_const_arg arg;
     arg.tbl = ((((struct RClass*)(clone))->ptr)->const_tbl) = rb_id_table_create(0);
     arg.klass = clone;
     rb_id_table_foreach(((((struct RClass*)(klass))->ptr)->const_tbl), clone_const_i, &arg);
 }
 if (attach != ((VALUE)RUBY_Qundef)) {
 ...
 RCLASS_M_TBL_INIT(clone);
 {
     ...
     arg.old_klass = klass;
     arg.new_klass = clone;
     rb_id_table_foreach((((struct RClass*)(klass))->m_tbl), clone_method_i, &arg);
 }
 rb_singleton_class_attached(((struct RBasic*)(clone))->klass, clone);
 ((!(((VALUE)(clone) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(clone) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(clone))->flags & RUBY_T_MASK) != RUBY_T_NODE) ? (void)(((struct RBasic*)(clone))->flags |= (((VALUE)RUBY_FL_SINGLETON))) : (void)0);
...
rb_singleton_class_attached(VALUE klass, VALUE obj)
{
 ...
 rb_class_ivar_set(klass, id__attached__, obj);
    }
}
static int
rb_singleton_class_has_metaclass_p(VALUE sklass)
{
    return rb_attr_get(((struct RBasic*)(sklass))->klass, id__attached__) == sklass;
}

int
rb_singleton_class_internal_p(VALUE sklass)
{
    return (( ((RUBY_T_CLASS) == RUBY_T_FIXNUM) ? (((int)(long)(rb_attr_get(sklass, id__attached__)))&RUBY_FIXNUM_FLAG) : ((RUBY_T_CLASS) == RUBY_T_TRUE) ? ((rb_attr_get(sklass, id__attached__)) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_CLASS) == RUBY_T_FALSE) ? ((rb_attr_get(sklass, id__attached__)) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_CLASS) == RUBY_T_NIL) ? ((rb_attr_get(sklass, id__attached__)) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_CLASS) == RUBY_T_UNDEF) ? ((rb_attr_get(sklass, id__attached__)) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_CLASS) == RUBY_T_SYMBOL) ? ((((VALUE)(rb_attr_get(sklass, id__attached__))&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(rb_attr_get(sklass, id__attached__)) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(rb_attr_get(sklass, id__attached__)) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(rb_attr_get(sklass, id__attached__)))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_CLASS) == RUBY_T_FLOAT) ? ( ((((int)(long)(rb_attr_get(sklass, id__attached__)))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(rb_attr_get(sklass, id__attached__)) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(rb_attr_get(sklass, id__attached__)) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(rb_attr_get(sklass, id__attached__)))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(rb_attr_get(sklass, id__attached__)) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(rb_attr_get(sklass, id__attached__)) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(rb_attr_get(sklass, id__attached__)))->flags & RUBY_T_MASK) == (RUBY_T_CLASS))) &&
...
{
    VALUE super;
    VALUE metaclass = rb_class_boot(((VALUE)RUBY_Qundef));

    ((!(((VALUE)(metaclass) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(metaclass) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(metaclass))->flags & RUBY_T_MASK) != RUBY_T_NODE) ? (void)(((struct RBasic*)(metaclass))->flags |= (((VALUE)RUBY_FL_SINGLETON))) : (void)0);
    rb_singleton_class_attached(metaclass, klass);

    if ((((struct RBasic*)(klass))->klass == (klass))) {
 do { VALUE _obj_ = (klass); rb_obj_write((VALUE)(_obj_), (VALUE *)(&((struct RBasicRaw *)(_obj_))->klass), (VALUE)(metaclass), "class.c", 495); } while (0);
 do { VALUE _obj_ = (metaclass); rb_obj_write((VALUE)(_obj_), (VALUE *)(&((struct RBasicRaw *)(_obj_))->klass), (VALUE)(metaclass), "class.c", 496); } while (0);
    }
    else {
 VALUE tmp = ((struct RBasic*)(klass))->klass;
 do { VALUE _obj_ = (klass); rb_obj_write((VALUE)(_obj_), (VALUE *)(&((struct RBasicRaw *)(_obj_))->klass), (VALUE)(metaclass), "class.c", 500); } while (0);
 do { VALUE _obj_ = (metaclass); rb_obj_write((VALUE)(_obj_), (VALUE *)(&((struct RBasicRaw *)(_obj_))->klass), (VALUE)(((((!(((VALUE)(((struct RBasic*)(tmp))->klass) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(((struct RBasic*)(tmp))->klass) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(((struct RBasic*)(tmp))->klass))->flags & RUBY_T_MASK) != RUBY_T_NODE)?(((struct RBasic*)((((struct RBasic*)(tmp))->klass)))->flags&((((VALUE)RUBY_FL_SINGLETON)))):0) && rb_singleton_class_has_metaclass_p(tmp)) ? ((struct RBasic*)(tmp))->klass : make_metaclass(tmp))), "class.c", 501); } while (0);
    }

    super = RCLASS_SUPER(klass);
    while (( ((RUBY_T_ICLASS) == RUBY_T_FIXNUM) ? (((int)(long)(super))&RUBY_FIXNUM_FLAG) : ((RUBY_T_ICLASS) == RUBY_T_TRUE) ? ((super) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_ICLASS) == RUBY_T_FALSE) ? ((super) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_ICLASS) == RUBY_T_NIL) ? ((super) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_ICLASS) == RUBY_T_UNDEF) ? ((super) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_ICLASS) == RUBY_T_SYMBOL) ? ((((VALUE)(super)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(super) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(super) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(super))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_ICLASS) == RUBY_T_FLOAT) ? ( ((((int)(long)(super))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(super) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(super) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(super))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(super) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(super) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(super))->flags & RUBY_T_MASK) == (RUBY_T_ICLASS)))) super = RCLASS_SUPER(super);
    RCLASS_SET_SUPER(metaclass, super ? ((((!(((VALUE)(((struct RBasic*)(super))->klass) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(((struct RBasic*)(super))->klass) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(((struct RBasic*)(super))->klass))->flags & RUBY_T_MASK) != RUBY_T_NODE)?(((struct RBasic*)((((struct RBasic*)(super))->klass)))->flags&((((VALUE)RUBY_FL_SINGLETON)))):0) && rb_singleton_class_has_metaclass_p(super)) ? ((struct RBasic*)(super))->klass : make_metaclass(super)) : rb_cClass);

    ( (((!(((VALUE)(metaclass) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(metaclass) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(metaclass))->flags & RUBY_T_MASK) != RUBY_T_NODE) && (int)(((struct RBasic*)(metaclass))->flags & RUBY_T_MASK) != RUBY_T_BIGNUM && (int)(((struct RBasic*)(metaclass))->flags & RUBY_T_MASK) != RUBY_T_FLOAT) && (!(((VALUE)(RCLASS_SUPER(metaclass)) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(RCLASS_SUPER(metaclass)) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(RCLASS_SUPER(metaclass)))->flags & RUBY_T_MASK) != RUBY_T_NODE)) ? (void)(((struct RBasic*)(metaclass))->flags |= ((((struct RBasic*)(RCLASS_SUPER(metaclass)))->flags&(RUBY_FL_TAINT)))) : (void)0);
...
{
    VALUE orig_class = ((struct RBasic*)(obj))->klass;
    VALUE klass = rb_class_boot(orig_class);

    ((!(((VALUE)(klass) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(klass) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(klass))->flags & RUBY_T_MASK) != RUBY_T_NODE) ? (void)(((struct RBasic*)(klass))->flags |= (((VALUE)RUBY_FL_SINGLETON))) : (void)0);
    do { VALUE _obj_ = (obj); rb_obj_write((VALUE)(_obj_), (VALUE *)(&((struct RBasicRaw *)(_obj_))->klass), (VALUE)(klass), "class.c", 526); } while (0);
    rb_singleton_class_attached(klass, obj);

    do { VALUE _obj_ = (klass); rb_obj_write((VALUE)(_obj_), (VALUE *)(&((struct RBasicRaw *)(_obj_))->klass), (VALUE)(((struct RBasic*)(rb_class_real(orig_class)))->klass), "class.c", 529); } while (0);
    return klass;
}
...
Init_class_hierarchy(void)
{
    ...
    rb_const_set(rb_cObject, (__builtin_constant_p("BasicObject") ?  (rb_intern2(("BasicObject"), (long)strlen("BasicObject"))) : (rb_intern)("BasicObject")), rb_cBasicObject);
    do { VALUE _obj_ = (rb_cClass); rb_obj_write((VALUE)(_obj_), (VALUE *)(&((struct RBasicRaw *)(_obj_))->klass), (VALUE)(rb_cClass), "class.c", 559); } while (0);
    do { VALUE _obj_ = (rb_cModule); rb_obj_write((VALUE)(_obj_), (VALUE *)(&((struct RBasicRaw *)(_obj_))->klass), (VALUE)(rb_cClass), "class.c", 560); } while (0);
    do { VALUE _obj_ = (rb_cObject); rb_obj_write((VALUE)(_obj_), (VALUE *)(&((struct RBasicRaw *)(_obj_))->klass), (VALUE)(rb_cClass), "class.c", 561); } while (0);
    do { VALUE _obj_ = (rb_cBasicObject); rb_obj_write((VALUE)(_obj_), (VALUE *)(&((struct RBasicRaw *)(_obj_))->klass), (VALUE)(rb_cClass), "class.c", 562); } while (0);
}
VALUE
...
rb_define_class_id(ID id, VALUE super)
{
    ...
    rb_make_metaclass(klass, ((struct RBasic*)(super))->klass);
...
rb_class_inherited(VALUE super, VALUE klass)
{
    ID inherited;
    if (!super) super = rb_cObject;
    do { static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("inherited")), (long)strlen(("inherited"))); (inherited) = rb_intern_id_cache; } while (0);
...
rb_define_class(const char *name, VALUE super)
{
    ...
    id = (__builtin_constant_p(name) ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2(((name)), (long)strlen((name))); (ID) rb_intern_id_cache; }) : rb_intern(name));
 ...
 if (!( ((RUBY_T_CLASS) == RUBY_T_FIXNUM) ? (((int)(long)(klass))&RUBY_FIXNUM_FLAG) : ((RUBY_T_CLASS) == RUBY_T_TRUE) ? ((klass) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_CLASS) == RUBY_T_FALSE) ? ((klass) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_CLASS) == RUBY_T_NIL) ? ((klass) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_CLASS) == RUBY_T_UNDEF) ? ((klass) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_CLASS) == RUBY_T_SYMBOL) ? ((((VALUE)(klass)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(klass) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(klass) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(klass))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_CLASS) == RUBY_T_FLOAT) ? ( ((((int)(long)(klass))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(klass) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(klass) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(klass))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(klass) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(klass) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(klass))->flags & RUBY_T_MASK) == (RUBY_T_CLASS)))) {
     rb_raise(rb_eTypeError, "%s is not a class (%li\v)",
...
{
    return rb_define_class_id_under(outer, (__builtin_constant_p(name) ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2(((name)), (long)strlen((name))); (ID) rb_intern_id_cache; }) : rb_intern(name)), super);
}
VALUE
rb_define_class_id_under(VALUE outer, ID id, VALUE super)
{
 ...
 if (!( ((RUBY_T_CLASS) == RUBY_T_FIXNUM) ? (((int)(long)(klass))&RUBY_FIXNUM_FLAG) : ((RUBY_T_CLASS) == RUBY_T_TRUE) ? ((klass) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_CLASS) == RUBY_T_FALSE) ? ((klass) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_CLASS) == RUBY_T_NIL) ? ((klass) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_CLASS) == RUBY_T_UNDEF) ? ((klass) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_CLASS) == RUBY_T_SYMBOL) ? ((((VALUE)(klass)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(klass) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(klass) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(klass))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_CLASS) == RUBY_T_FLOAT) ? ( ((((int)(long)(klass))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(klass) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(klass) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(klass))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(klass) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(klass) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(klass))->flags & RUBY_T_MASK) == (RUBY_T_CLASS)))) {
     rb_raise(rb_eTypeError, "%li\v::%li\v is not a class (%li\v)",
       outer, rb_id2str(id), rb_obj_class(klass));
 }
 if (rb_class_real(RCLASS_SUPER(klass)) != super) {
     rb_raise(rb_eTypeError, "superclass mismatch for class %li\v::%li\v (%li\v is given but was %li\v)",
       outer, rb_id2str(id), RCLASS_SUPER(klass), super);
 }
 return klass;
    }
    if (!super) {
 rb_raise(rb_eArgError, "no super class for `%li\v::%li\v'",
...
rb_module_new(void)
{
    VALUE mdl = class_alloc(RUBY_T_MODULE, rb_cModule);
...
rb_define_module(const char *name)
{
 ...
 if (!( ((RUBY_T_MODULE) == RUBY_T_FIXNUM) ? (((int)(long)(module))&RUBY_FIXNUM_FLAG) : ((RUBY_T_MODULE) == RUBY_T_TRUE) ? ((module) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_MODULE) == RUBY_T_FALSE) ? ((module) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_MODULE) == RUBY_T_NIL) ? ((module) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_MODULE) == RUBY_T_UNDEF) ? ((module) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_MODULE) == RUBY_T_SYMBOL) ? ((((VALUE)(module)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(module) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(module) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(module))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_MODULE) == RUBY_T_FLOAT) ? ( ((((int)(long)(module))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(module) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(module) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(module))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(module) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(module) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(module))->flags & RUBY_T_MASK) == (RUBY_T_MODULE)))) {
     rb_raise(rb_eTypeError, "%s is not a module (%li\v)",
...
{
    return rb_define_module_id_under(outer, (__builtin_constant_p(name) ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2(((name)), (long)strlen((name))); (ID) rb_intern_id_cache; }) : rb_intern(name)));
}
...
rb_define_module_id_under(VALUE outer, ID id)
{
 ...
 if (!( ((RUBY_T_MODULE) == RUBY_T_FIXNUM) ? (((int)(long)(module))&RUBY_FIXNUM_FLAG) : ((RUBY_T_MODULE) == RUBY_T_TRUE) ? ((module) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_MODULE) == RUBY_T_FALSE) ? ((module) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_MODULE) == RUBY_T_NIL) ? ((module) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_MODULE) == RUBY_T_UNDEF) ? ((module) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_MODULE) == RUBY_T_SYMBOL) ? ((((VALUE)(module)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(module) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(module) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(module))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_MODULE) == RUBY_T_FLOAT) ? ( ((((int)(long)(module))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(module) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(module) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(module))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(module) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(module) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(module))->flags & RUBY_T_MASK) == (RUBY_T_MODULE)))) {
     rb_raise(rb_eTypeError, "%li\v::%li\v is not a module (%li\v)",
...
{
    VALUE klass = class_alloc(RUBY_T_ICLASS, rb_cClass);

    if ((int)(((struct RBasic*)(module))->flags & RUBY_T_MASK) == RUBY_T_ICLASS) {
 module = ((struct RBasic*)(module))->klass;
    }
    if (!((((struct RClass*)(module))->ptr)->iv_tbl)) {
 ((((struct RClass*)(module))->ptr)->iv_tbl) = st_init_numtable();
    }
    if (!((((struct RClass*)(module))->ptr)->const_tbl)) {
 ((((struct RClass*)(module))->ptr)->const_tbl) = rb_id_table_create(0);
    }
    ((((struct RClass*)(klass))->ptr)->iv_tbl) = ((((struct RClass*)(module))->ptr)->iv_tbl);
    ((((struct RClass*)(klass))->ptr)->const_tbl) = ((((struct RClass*)(module))->ptr)->const_tbl);

    (((struct RClass*)(rb_obj_wb_unprotect(klass, "class.c", 834)))->m_tbl) =
      (((struct RClass*)(rb_obj_wb_unprotect(((((struct RClass*)(module))->ptr)->origin_), "class.c", 835)))->m_tbl);

    RCLASS_SET_SUPER(klass, super);
    if (( ((RUBY_T_ICLASS) == RUBY_T_FIXNUM) ? (((int)(long)(module))&RUBY_FIXNUM_FLAG) : ((RUBY_T_ICLASS) == RUBY_T_TRUE) ? ((module) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_ICLASS) == RUBY_T_FALSE) ? ((module) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_ICLASS) == RUBY_T_NIL) ? ((module) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_ICLASS) == RUBY_T_UNDEF) ? ((module) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_ICLASS) == RUBY_T_SYMBOL) ? ((((VALUE)(module)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(module) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(module) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(module))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_ICLASS) == RUBY_T_FLOAT) ? ( ((((int)(long)(module))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(module) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(module) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(module))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(module) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(module) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(module))->flags & RUBY_T_MASK) == (RUBY_T_ICLASS)))) {
 do { VALUE _obj_ = (klass); rb_obj_write((VALUE)(_obj_), (VALUE *)(&((struct RBasicRaw *)(_obj_))->klass), (VALUE)(((struct RBasic*)(module))->klass), "class.c", 839); } while (0);
    }
    else {
 do { VALUE _obj_ = (klass); rb_obj_write((VALUE)(_obj_), (VALUE *)(&((struct RBasicRaw *)(_obj_))->klass), (VALUE)(module), "class.c", 842); } while (0);
    }
    ( (((!(((VALUE)(klass) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(klass) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(klass))->flags & RUBY_T_MASK) != RUBY_T_NODE) && (int)(((struct RBasic*)(klass))->flags & RUBY_T_MASK) != RUBY_T_BIGNUM && (int)(((struct RBasic*)(klass))->flags & RUBY_T_MASK) != RUBY_T_FLOAT) && (!(((VALUE)(module) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(module) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(module))->flags & RUBY_T_MASK) != RUBY_T_NODE)) ? (void)(((struct RBasic*)(klass))->flags |= ((((struct RBasic*)(module))->flags&(RUBY_FL_TAINT)))) : (void)0);
    ( (((!(((VALUE)(klass) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(klass) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(klass))->flags & RUBY_T_MASK) != RUBY_T_NODE) && (int)(((struct RBasic*)(klass))->flags & RUBY_T_MASK) != RUBY_T_BIGNUM && (int)(((struct RBasic*)(klass))->flags & RUBY_T_MASK) != RUBY_T_FLOAT) && (!(((VALUE)(super) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(super) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(super))->flags & RUBY_T_MASK) != RUBY_T_NODE)) ? (void)(((struct RBasic*)(klass))->flags |= ((((struct RBasic*)(super))->flags&(RUBY_FL_TAINT)))) : (void)0);
...
ensure_includable(VALUE klass, VALUE module)
{
    ...
    (!( (((RUBY_T_MODULE)) == RUBY_T_FIXNUM) ? (((int)(long)((VALUE)(module)))&RUBY_FIXNUM_FLAG) : (((RUBY_T_MODULE)) == RUBY_T_TRUE) ? (((VALUE)(module)) == ((VALUE)RUBY_Qtrue)) : (((RUBY_T_MODULE)) == RUBY_T_FALSE) ? (((VALUE)(module)) == ((VALUE)RUBY_Qfalse)) : (((RUBY_T_MODULE)) == RUBY_T_NIL) ? (((VALUE)(module)) == ((VALUE)RUBY_Qnil)) : (((RUBY_T_MODULE)) == RUBY_T_UNDEF) ? (((VALUE)(module)) == ((VALUE)RUBY_Qundef)) : (((RUBY_T_MODULE)) == RUBY_T_SYMBOL) ? ((((VALUE)((VALUE)(module))&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)((VALUE)(module)) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)((VALUE)(module)) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)((VALUE)(module)))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : (((RUBY_T_MODULE)) == RUBY_T_FLOAT) ? ( ((((int)(long)((VALUE)(module)))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)((VALUE)(module)) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)((VALUE)(module)) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)((VALUE)(module)))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)((VALUE)(module)) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)((VALUE)(module)) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)((VALUE)(module)))->flags & RUBY_T_MASK) == ((RUBY_T_MODULE)))) || ((RUBY_T_MODULE) == RUBY_T_DATA && (((struct RTypedData*)(module))->typed_flag == 1)) ? rb_unexpected_type((VALUE)(module), (RUBY_T_MODULE)) : (void)0);
    if (!!((VALUE)(rb_refinement_module_get_refined_class(module)) != ((VALUE)RUBY_Qnil))) {
...
rb_include_module(VALUE klass, VALUE module)
{
    ...
    changed = include_modules_at(klass, ((((struct RClass*)(klass))->ptr)->origin_), module, TRUE);
    if (changed < 0)
...
include_modules_at(const VALUE klass, VALUE c, VALUE module, int search_super)
{
    ...
    struct rb_id_table *const klass_m_tbl = (((struct RClass*)(((((struct RClass*)(klass))->ptr)->origin_)))->m_tbl);

    while (module) {
 int superclass_seen = FALSE;
 struct rb_id_table *tbl;

 if (((((struct RClass*)(module))->ptr)->origin_) != module)
     goto skip;
 if (klass_m_tbl && klass_m_tbl == (((struct RClass*)(module))->m_tbl))
     return -1;

 for (p = RCLASS_SUPER(klass); p; p = RCLASS_SUPER(p)) {
     int type = (int)(((struct RBasic*)(p))->flags & RUBY_T_MASK);
     if (type == RUBY_T_ICLASS) {
  if ((((struct RClass*)(p))->m_tbl) == (((struct RClass*)(module))->m_tbl)) {
      if (!superclass_seen) {
   c = p;
      }
      goto skip;
 ...
 {
     VALUE m = module;
     if ((int)(((struct RBasic*)(m))->flags & RUBY_T_MASK) == RUBY_T_ICLASS) m = ((struct RBasic*)(m))->klass;
     rb_module_add_to_subclasses_list(m, iclass);
 }

 if (((!(((VALUE)(klass) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(klass) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(klass))->flags & RUBY_T_MASK) != RUBY_T_NODE)?(((struct RBasic*)((klass)))->flags&((RMODULE_IS_REFINEMENT))):0)) {
     VALUE refined_class =
  rb_refinement_module_get_refined_class(klass);

     rb_id_table_foreach((((struct RClass*)(module))->m_tbl), add_refined_method_entry_i, (void *)refined_class);
     ((!(((VALUE)(c) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(c) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(c))->flags & RUBY_T_MASK) != RUBY_T_NODE) ? (void)(((struct RBasic*)(c))->flags |= (RMODULE_INCLUDED_INTO_REFINEMENT)) : (void)0);
 }

 tbl = (((struct RClass*)(module))->m_tbl);
 if (tbl && rb_id_table_size(tbl)) method_changed = 1;

 tbl = ((((struct RClass*)(module))->ptr)->const_tbl);
...
move_refined_method(ID key, VALUE value, void *data)
{
    ...
    struct rb_id_table *tbl = (((struct RClass*)(klass))->m_tbl);

    if (me->def->type == VM_METHOD_TYPE_REFINED) {
 if (me->def->body.refined.orig_me) {
     const rb_method_entry_t *orig_me = me->def->body.refined.orig_me, *new_me;
     rb_obj_write((VALUE)(me), (VALUE *)(&me->def->body.refined.orig_me), (VALUE)(((void*)0)), "class.c", 955);
     new_me = rb_method_entry_clone(me);
     rb_id_table_insert(tbl, key, (VALUE)new_me);
     rb_obj_written((VALUE)(klass), (VALUE)(((VALUE)RUBY_Qundef)), (VALUE)(new_me), "class.c", 958);
...
rb_prepend_module(VALUE klass, VALUE module)
{
    ...
    origin = ((((struct RClass*)(klass))->ptr)->origin_);
    if (origin == klass) {
 origin = class_alloc(RUBY_T_ICLASS, klass);
 rb_obj_wb_unprotect(origin, "class.c", 983);
 RCLASS_SET_SUPER(origin, RCLASS_SUPER(klass));
 RCLASS_SET_SUPER(klass, origin);
 RCLASS_SET_ORIGIN(klass, origin);
 (((struct RClass*)(origin))->m_tbl) = (((struct RClass*)(klass))->m_tbl);
 RCLASS_M_TBL_INIT(klass);
 rb_id_table_foreach((((struct RClass*)(origin))->m_tbl), move_refined_method, (void *)klass);
    }
...
rb_mod_included_modules(VALUE mod)
{
    ...
    VALUE p;
    VALUE origin = ((((struct RClass*)(mod))->ptr)->origin_);

    for (p = RCLASS_SUPER(mod); p; p = RCLASS_SUPER(p)) {
 if (p != origin && (int)(((struct RBasic*)(p))->flags & RUBY_T_MASK) == RUBY_T_ICLASS) {
     VALUE m = ((struct RBasic*)(p))->klass;
     if (( ((RUBY_T_MODULE) == RUBY_T_FIXNUM) ? (((int)(long)(m))&RUBY_FIXNUM_FLAG) : ((RUBY_T_MODULE) == RUBY_T_TRUE) ? ((m) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_MODULE) == RUBY_T_FALSE) ? ((m) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_MODULE) == RUBY_T_NIL) ? ((m) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_MODULE) == RUBY_T_UNDEF) ? ((m) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_MODULE) == RUBY_T_SYMBOL) ? ((((VALUE)(m)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(m) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(m) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(m))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_MODULE) == RUBY_T_FLOAT) ? ( ((((int)(long)(m))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(m) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(m) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(m))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(m) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(m) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(m))->flags & RUBY_T_MASK) == (RUBY_T_MODULE))))
  rb_ary_push(ary, m);
 }
    }
    return ary;
...
rb_mod_include_p(VALUE mod, VALUE mod2)
{
    ...
    (!( (((RUBY_T_MODULE)) == RUBY_T_FIXNUM) ? (((int)(long)((VALUE)(mod2)))&RUBY_FIXNUM_FLAG) : (((RUBY_T_MODULE)) == RUBY_T_TRUE) ? (((VALUE)(mod2)) == ((VALUE)RUBY_Qtrue)) : (((RUBY_T_MODULE)) == RUBY_T_FALSE) ? (((VALUE)(mod2)) == ((VALUE)RUBY_Qfalse)) : (((RUBY_T_MODULE)) == RUBY_T_NIL) ? (((VALUE)(mod2)) == ((VALUE)RUBY_Qnil)) : (((RUBY_T_MODULE)) == RUBY_T_UNDEF) ? (((VALUE)(mod2)) == ((VALUE)RUBY_Qundef)) : (((RUBY_T_MODULE)) == RUBY_T_SYMBOL) ? ((((VALUE)((VALUE)(mod2))&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)((VALUE)(mod2)) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)((VALUE)(mod2)) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)((VALUE)(mod2)))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : (((RUBY_T_MODULE)) == RUBY_T_FLOAT) ? ( ((((int)(long)((VALUE)(mod2)))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)((VALUE)(mod2)) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)((VALUE)(mod2)) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)((VALUE)(mod2)))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)((VALUE)(mod2)) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)((VALUE)(mod2)) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)((VALUE)(mod2)))->flags & RUBY_T_MASK) == ((RUBY_T_MODULE)))) || ((RUBY_T_MODULE) == RUBY_T_DATA && (((struct RTypedData*)(mod2))->typed_flag == 1)) ? rb_unexpected_type((VALUE)(mod2), (RUBY_T_MODULE)) : (void)0);
    for (p = RCLASS_SUPER(mod); p; p = RCLASS_SUPER(p)) {
 if ((int)(((struct RBasic*)(p))->flags & RUBY_T_MASK) == RUBY_T_ICLASS) {
     if (((struct RBasic*)(p))->klass == mod2) return ((VALUE)RUBY_Qtrue);
 }
    }
...
rb_mod_ancestors(VALUE mod)
{
 ...
 if ((int)(((struct RBasic*)(p))->flags & RUBY_T_MASK) == RUBY_T_ICLASS) {
     rb_ary_push(ary, ((struct RBasic*)(p))->klass);
 }
 else if (p == ((((struct RClass*)(p))->ptr)->origin_)) {
     rb_ary_push(ary, p);
 }
    }
    return ary;
...
{
    rb_ary_push((VALUE)ary, (rb_id2sym((ID)name)));
}
...
method_entry_i(ID key, VALUE value, void *data)
{
 ...
 if ((!(me) || !(me)->def || (me)->def->type == VM_METHOD_TYPE_UNDEF)) {
     ...
     type = (rb_method_visibility_t)(((me)->flags & (((VALUE)RUBY_FL_USER4) | ((VALUE)RUBY_FL_USER5))) >> ((((VALUE)RUBY_FL_USHIFT) + 4)+0));
 }
...
class_instance_method_list(int argc, const VALUE *argv, VALUE mod, int obj, int (*func) (st_data_t, st_data_t, st_data_t))
{
 ...
 recur = !(((VALUE)(r) & (VALUE)~((VALUE)RUBY_Qnil)) == 0);
    }

    if (!recur && ((((struct RClass*)(mod))->ptr)->origin_) != mod) {
 mod = ((((struct RClass*)(mod))->ptr)->origin_);
 prepended = 1;
    }
 ...
 if ((((struct RClass*)(mod))->m_tbl)) rb_id_table_foreach((((struct RClass*)(mod))->m_tbl), method_entry_i, &me_arg);
 if ((int)(((struct RBasic*)(mod))->flags & RUBY_T_MASK) == RUBY_T_ICLASS && !prepended) continue;
 if (obj && ((!(((VALUE)(mod) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(mod) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(mod))->flags & RUBY_T_MASK) != RUBY_T_NODE)?(((struct RBasic*)((mod)))->flags&((((VALUE)RUBY_FL_SINGLETON)))):0)) continue;
 if (!recur) break;
    }
    ary = rb_ary_new();
...
rb_obj_methods(int argc, const VALUE *argv, VALUE obj)
{
    ...
    if (argc > 0 && !!(((VALUE)(argv[0]) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) {
 return rb_obj_singleton_methods(argc, argv, obj);
    }
    return class_instance_method_list(argc, argv, rb_class_of((VALUE)(obj)), 1, ins_methods_i);
}
VALUE
rb_obj_protected_methods(int argc, const VALUE *argv, VALUE obj)
{
    return class_instance_method_list(argc, argv, rb_class_of((VALUE)(obj)), 1, ins_methods_prot_i);
}
VALUE
rb_obj_private_methods(int argc, const VALUE *argv, VALUE obj)
{
    return class_instance_method_list(argc, argv, rb_class_of((VALUE)(obj)), 1, ins_methods_priv_i);
}
VALUE
rb_obj_public_methods(int argc, const VALUE *argv, VALUE obj)
{
    return class_instance_method_list(argc, argv, rb_class_of((VALUE)(obj)), 1, ins_methods_pub_i);
}
VALUE
rb_obj_singleton_methods(int argc, const VALUE *argv, VALUE obj)
{
 ...
 rb_scan_args(argc, argv, "01", &recur);
    ...
    origin = ((((struct RClass*)(klass))->ptr)->origin_);
    me_arg.list = st_init_numtable();
    me_arg.recur = !(((VALUE)(recur) & (VALUE)~((VALUE)RUBY_Qnil)) == 0);
    if (klass && ((!(((VALUE)(klass) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(klass) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(klass))->flags & RUBY_T_MASK) != RUBY_T_NODE)?(((struct RBasic*)((klass)))->flags&((((VALUE)RUBY_FL_SINGLETON)))):0)) {
 if ((mtbl = (((struct RClass*)(origin))->m_tbl)) != 0) rb_id_table_foreach(mtbl, method_entry_i, &me_arg);
 klass = RCLASS_SUPER(klass);
    }
    if (!(((VALUE)(recur) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) {
 while (klass && (((!(((VALUE)(klass) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(klass) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(klass))->flags & RUBY_T_MASK) != RUBY_T_NODE)?(((struct RBasic*)((klass)))->flags&((((VALUE)RUBY_FL_SINGLETON)))):0) || ( ((RUBY_T_ICLASS) == RUBY_T_FIXNUM) ? (((int)(long)(klass))&RUBY_FIXNUM_FLAG) : ((RUBY_T_ICLASS) == RUBY_T_TRUE) ? ((klass) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_ICLASS) == RUBY_T_FALSE) ? ((klass) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_ICLASS) == RUBY_T_NIL) ? ((klass) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_ICLASS) == RUBY_T_UNDEF) ? ((klass) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_ICLASS) == RUBY_T_SYMBOL) ? ((((VALUE)(klass)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(klass) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(klass) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(klass))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_ICLASS) == RUBY_T_FLOAT) ? ( ((((int)(long)(klass))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(klass) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(klass) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(klass))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(klass) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(klass) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(klass))->flags & RUBY_T_MASK) == (RUBY_T_ICLASS))))) {
     if (klass != origin && (mtbl = (((struct RClass*)(klass))->m_tbl)) != 0) rb_id_table_foreach(mtbl, method_entry_i, &me_arg);
     klass = RCLASS_SUPER(klass);
 }
    }
    ary = rb_ary_new();
...
void
rb_define_method_id(VALUE klass, ID mid, VALUE (*func)(), int argc)
{
...
{
    rb_add_method_cfunc(klass, (__builtin_constant_p(name) ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2(((name)), (long)strlen((name))); (ID) rb_intern_id_cache; }) : rb_intern(name)), func, argc, METHOD_VISI_PUBLIC);
}

void
rb_define_protected_method(VALUE klass, const char *name, VALUE (*func)(), int argc)
{
    rb_add_method_cfunc(klass, (__builtin_constant_p(name) ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2(((name)), (long)strlen((name))); (ID) rb_intern_id_cache; }) : rb_intern(name)), func, argc, METHOD_VISI_PROTECTED);
}

void
rb_define_private_method(VALUE klass, const char *name, VALUE (*func)(), int argc)
{
    rb_add_method_cfunc(klass, (__builtin_constant_p(name) ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2(((name)), (long)strlen((name))); (ID) rb_intern_id_cache; }) : rb_intern(name)), func, argc, METHOD_VISI_PRIVATE);
}

void
rb_undef_method(VALUE klass, const char *name)
{
    rb_add_method(klass, (__builtin_constant_p(name) ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2(((name)), (long)strlen((name))); (ID) rb_intern_id_cache; }) : rb_intern(name)), VM_METHOD_TYPE_UNDEF, 0, METHOD_VISI_UNDEF);
}
...
{
    struct rb_id_table *mtbl = (((struct RClass*)(super))->m_tbl);
    if (mtbl) {
...
{
    do { if (obj == (((VALUE)RUBY_Qnil))) { return (rb_cNilClass); }} while (0);
    do { if (obj == (((VALUE)RUBY_Qfalse))) { return (rb_cFalseClass); }} while (0);
    do { if (obj == (((VALUE)RUBY_Qtrue))) { return (rb_cTrueClass); }} while (0);
...
singleton_class_of(VALUE obj)
{
    ...
    if ((((int)(long)(obj))&RUBY_FIXNUM_FLAG) || ((((int)(long)(obj))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (((VALUE)(obj)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)) {
      no_singleton:
 ...
 switch ((int)(((struct RBasic*)(obj))->flags & RUBY_T_MASK)) {
   case RUBY_T_FLOAT: case RUBY_T_BIGNUM: case RUBY_T_SYMBOL:
     goto no_singleton;
   case RUBY_T_STRING:
     if ((((struct RBasic*)(obj))->flags&(RSTRING_FSTR))) goto no_singleton;
     break;
 }
    }

    klass = ((struct RBasic*)(obj))->klass;
    if (!(((!(((VALUE)(klass) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(klass) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(klass))->flags & RUBY_T_MASK) != RUBY_T_NODE)?(((struct RBasic*)((klass)))->flags&((((VALUE)RUBY_FL_SINGLETON)))):0) &&
   rb_ivar_get(klass, id__attached__) == obj)) {
 rb_serial_t serial = ((((struct RClass*)(klass))->ptr)->class_serial);
 klass = rb_make_metaclass(obj, klass);
 ((((struct RClass*)(klass))->ptr)->class_serial) = serial;
    }

    if ((!!((!(((VALUE)((obj)) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)((obj)) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)((obj)))->flags & RUBY_T_MASK) != RUBY_T_NODE)?(((struct RBasic*)(((obj))))->flags&((RUBY_FL_TAINT))):0))) {
 (((!(((VALUE)(klass) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(klass) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(klass))->flags & RUBY_T_MASK) != RUBY_T_NODE) && (int)(((struct RBasic*)(klass))->flags & RUBY_T_MASK) != RUBY_T_BIGNUM && (int)(((struct RBasic*)(klass))->flags & RUBY_T_MASK) != RUBY_T_FLOAT) ? (void)(((struct RBasic*)(klass))->flags |= (RUBY_FL_TAINT)) : (void)0);
    }
    else {
 ((!(((VALUE)(klass) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(klass) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(klass))->flags & RUBY_T_MASK) != RUBY_T_NODE) ? (void)(((struct RBasic*)(klass))->flags &= ~(VALUE)(((VALUE)RUBY_FL_TAINT))) : (void)0);
    }
    (void)(((struct RBasic*)(klass))->flags |= ((((struct RBasic*)(obj))->flags&RUBY_FL_FREEZE)));
...
rb_freeze_singleton_class(VALUE x)
{
    ...
    if (!(((struct RBasic*)(x))->flags & ((VALUE)RUBY_FL_SINGLETON))) {
 VALUE klass = (((struct RBasic*)(x))->klass);
 if (klass && (klass = ((((struct RClass*)(klass))->ptr)->origin_)) != 0 &&
     ((!(((VALUE)(klass) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(klass) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(klass))->flags & RUBY_T_MASK) != RUBY_T_NODE)?(((struct RBasic*)((klass)))->flags&(((((VALUE)RUBY_FL_SINGLETON)|((VALUE)RUBY_FL_FREEZE))))):0) == ((VALUE)RUBY_FL_SINGLETON)) {
     (void)(((struct RBasic*)(klass))->flags |= RUBY_FL_FREEZE);
 }
    }
}
VALUE
rb_singleton_class_get(VALUE obj)
{
 ...
 return rb_special_singleton_class(obj);
    ...
    klass = ((struct RBasic*)(obj))->klass;
    if (!((!(((VALUE)(klass) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(klass) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(klass))->flags & RUBY_T_MASK) != RUBY_T_NODE)?(((struct RBasic*)((klass)))->flags&((((VALUE)RUBY_FL_SINGLETON)))):0)) return ((VALUE)RUBY_Qnil);
    if (rb_ivar_get(klass, id__attached__) != obj) return ((VALUE)RUBY_Qnil);
    return klass;
}
VALUE
...
{
    rb_alias(klass, (__builtin_constant_p(name1) ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2(((name1)), (long)strlen((name1))); (ID) rb_intern_id_cache; }) : rb_intern(name1)), (__builtin_constant_p(name2) ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2(((name2)), (long)strlen((name2))); (ID) rb_intern_id_cache; }) : rb_intern(name2)));
}
void
rb_define_attr(VALUE klass, const char *name, int read, int write)
{
    rb_attr(klass, (__builtin_constant_p(name) ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2(((name)), (long)strlen((name))); (ID) rb_intern_id_cache; }) : rb_intern(name)), read, write, FALSE);
}

VALUE
rb_keyword_error_new(const char *error, VALUE keys)
{
    const VALUE *ptr = rb_array_const_ptr(keys);
    long i = 0, len = rb_array_len(keys);
    VALUE error_message = rb_sprintf("%s keyword%.*s", error, len > 1, "s");

    if (len > 0) {
  ({ (__builtin_constant_p(": ")) ? rb_str_cat((error_message), (": "), (long)strlen(": ")) : rb_str_cat_cstr((error_message), (": ")); });
 while (1) {
     const VALUE k = ptr[i];
     (!( (((RUBY_T_SYMBOL)) == RUBY_T_FIXNUM) ? (((int)(long)((VALUE)(k)))&RUBY_FIXNUM_FLAG) : (((RUBY_T_SYMBOL)) == RUBY_T_TRUE) ? (((VALUE)(k)) == ((VALUE)RUBY_Qtrue)) : (((RUBY_T_SYMBOL)) == RUBY_T_FALSE) ? (((VALUE)(k)) == ((VALUE)RUBY_Qfalse)) : (((RUBY_T_SYMBOL)) == RUBY_T_NIL) ? (((VALUE)(k)) == ((VALUE)RUBY_Qnil)) : (((RUBY_T_SYMBOL)) == RUBY_T_UNDEF) ? (((VALUE)(k)) == ((VALUE)RUBY_Qundef)) : (((RUBY_T_SYMBOL)) == RUBY_T_SYMBOL) ? ((((VALUE)((VALUE)(k))&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)((VALUE)(k)) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)((VALUE)(k)) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)((VALUE)(k)))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : (((RUBY_T_SYMBOL)) == RUBY_T_FLOAT) ? ( ((((int)(long)((VALUE)(k)))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)((VALUE)(k)) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)((VALUE)(k)) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)((VALUE)(k)))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)((VALUE)(k)) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)((VALUE)(k)) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)((VALUE)(k)))->flags & RUBY_T_MASK) == ((RUBY_T_SYMBOL)))) || ((RUBY_T_SYMBOL) == RUBY_T_DATA && (((struct RTypedData*)(k))->typed_flag == 1)) ? rb_unexpected_type((VALUE)(k), (RUBY_T_SYMBOL)) : (void)0);
...
unknown_keyword_error(VALUE hash, const ID *table, int keywords)
{
 ...
 st_data_t key = (rb_id2sym(table[i]));
 st_delete(tbl, &key, ((void*)0));
    }
...
separate_symbol(st_data_t key, st_data_t value, st_data_t arg)
{
    ...
    if (!((((VALUE)(key)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(key) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(key) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(key))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL)))) kwdhash++;
...
rb_extract_keywords(VALUE *orighash)
{
    ...
    if (((((struct RHash*)(hash))->ntbl ? ((struct RHash*)(hash))->ntbl->num_entries : (st_index_t)0) == 0)) {
 *orighash = 0;
 return hash;
    }
    st_foreach(rb_hash_tbl_raw(hash), separate_symbol, (st_data_t)&parthash);
    *orighash = parthash[1];
    if (parthash[1] && (((struct RBasic*)(hash))->klass) != rb_cHash) {
 do { VALUE _obj_ = (parthash[1]); rb_obj_write((VALUE)(_obj_), (VALUE *)(&((struct RBasicRaw *)(_obj_))->klass), (VALUE)((((struct RBasic*)(hash))->klass)), "class.c", 1841); } while (0);
    }
    return parthash[0];
}
...
rb_get_kwargs(VALUE keyword_hash, const ID *table, int required, int optional, VALUE *values)
{
    ...
    if (!((VALUE)(keyword_hash) != ((VALUE)RUBY_Qnil))) keyword_hash = 0;
 ...
 for (j = 0; j < required + optional; j++) {
     values[j] = ((VALUE)RUBY_Qundef);
 }
    }
    if (required) {
 for (; i < required; i++) {
     VALUE keyword = (rb_id2sym(table[i]));
     if (keyword_hash) {
  st_data_t val;
  if ((key = (st_data_t)(keyword), values ? st_delete(rb_hash_tbl_raw(keyword_hash), &key, (&val)) : st_lookup(rb_hash_tbl_raw(keyword_hash), key, (&val)))) {
      if (values) values[i] = (VALUE)val;
      continue;
  }
     }
     if (!((VALUE)(missing) != ((VALUE)RUBY_Qnil))) missing = rb_ary_tmp_new(1);
     rb_ary_push(missing, keyword);
 }
 if (!!((VALUE)(missing) != ((VALUE)RUBY_Qnil))) {
 ...
 for (i = 0; i < optional; i++) {
     st_data_t val;
     if ((key = (st_data_t)((rb_id2sym(table[required+i]))), values ? st_delete(rb_hash_tbl_raw(keyword_hash), &key, (&val)) : st_lookup(rb_hash_tbl_raw(keyword_hash), key, (&val)))) {
 ...
 if ((((struct RHash*)(keyword_hash))->ntbl ? ((struct RHash*)(keyword_hash))->ntbl->num_entries : (st_index_t)0) > (unsigned int)(values ? 0 : j)) {
...
rb_scan_args(int argc, const VALUE *argv, const char *fmt, ...)
{
    ...
    VALUE hash = ((VALUE)RUBY_Qnil), last_hash = 0;
...
{
    return rb_id_table_size((((struct RClass*)(c))->m_tbl)) == 0 ? FALSE : TRUE;
}
