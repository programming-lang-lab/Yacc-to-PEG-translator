...
rb_construct_expanded_load_path(enum expand_type type, int *has_relative, int *has_non_cache)
{
 ...
 if (!non_cache) {
  ...
  (type == EXPAND_NON_CACHE)) {
      ...
      rb_ary_push(ary, (rb_array_const_ptr(expanded_load_path)[i]));
      continue;
     }
 }
 ...
 expanded_path = rb_check_realpath(((VALUE)RUBY_Qnil), as_str);
 if (!((VALUE)(expanded_path) != ((VALUE)RUBY_Qnil))) expanded_path = as_str;
...
{
    rb_vm_t *vm = rb_current_vm();
    const VALUE non_cache = ((VALUE)RUBY_Qtrue);
...
{
    return rb_current_vm()->loaded_features;
}
...
{
    return rb_current_vm()->loaded_features_index;
}

static st_table *
get_loading_table(void)
{
    return rb_current_vm()->loading_table;
}
...
features_index_add_single(VALUE short_feature, VALUE offset)
{
    ...
    VALUE this_feature_index = ((VALUE)RUBY_Qnil);
    char *short_feature_cstr;

    (!( (((RUBY_T_FIXNUM)) == RUBY_T_FIXNUM) ? (((int)(long)((VALUE)(offset)))&RUBY_FIXNUM_FLAG) : (((RUBY_T_FIXNUM)) == RUBY_T_TRUE) ? (((VALUE)(offset)) == ((VALUE)RUBY_Qtrue)) : (((RUBY_T_FIXNUM)) == RUBY_T_FALSE) ? (((VALUE)(offset)) == ((VALUE)RUBY_Qfalse)) : (((RUBY_T_FIXNUM)) == RUBY_T_NIL) ? (((VALUE)(offset)) == ((VALUE)RUBY_Qnil)) : (((RUBY_T_FIXNUM)) == RUBY_T_UNDEF) ? (((VALUE)(offset)) == ((VALUE)RUBY_Qundef)) : (((RUBY_T_FIXNUM)) == RUBY_T_SYMBOL) ? ((((VALUE)((VALUE)(offset))&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)((VALUE)(offset)) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)((VALUE)(offset)) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)((VALUE)(offset)))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : (((RUBY_T_FIXNUM)) == RUBY_T_FLOAT) ? ( ((((int)(long)((VALUE)(offset)))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)((VALUE)(offset)) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)((VALUE)(offset)) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)((VALUE)(offset)))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)((VALUE)(offset)) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)((VALUE)(offset)) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)((VALUE)(offset)))->flags & RUBY_T_MASK) == ((RUBY_T_FIXNUM)))) || ((RUBY_T_FIXNUM) == RUBY_T_DATA && (((struct RTypedData*)(offset))->typed_flag == 1)) ? rb_unexpected_type((VALUE)(offset), (RUBY_T_FIXNUM)) : (void)0);
    (!( (((RUBY_T_STRING)) == RUBY_T_FIXNUM) ? (((int)(long)((VALUE)(short_feature)))&RUBY_FIXNUM_FLAG) : (((RUBY_T_STRING)) == RUBY_T_TRUE) ? (((VALUE)(short_feature)) == ((VALUE)RUBY_Qtrue)) : (((RUBY_T_STRING)) == RUBY_T_FALSE) ? (((VALUE)(short_feature)) == ((VALUE)RUBY_Qfalse)) : (((RUBY_T_STRING)) == RUBY_T_NIL) ? (((VALUE)(short_feature)) == ((VALUE)RUBY_Qnil)) : (((RUBY_T_STRING)) == RUBY_T_UNDEF) ? (((VALUE)(short_feature)) == ((VALUE)RUBY_Qundef)) : (((RUBY_T_STRING)) == RUBY_T_SYMBOL) ? ((((VALUE)((VALUE)(short_feature))&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)((VALUE)(short_feature)) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)((VALUE)(short_feature)) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)((VALUE)(short_feature)))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : (((RUBY_T_STRING)) == RUBY_T_FLOAT) ? ( ((((int)(long)((VALUE)(short_feature)))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)((VALUE)(short_feature)) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)((VALUE)(short_feature)) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)((VALUE)(short_feature)))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)((VALUE)(short_feature)) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)((VALUE)(short_feature)) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)((VALUE)(short_feature)))->flags & RUBY_T_MASK) == ((RUBY_T_STRING)))) || ((RUBY_T_STRING) == RUBY_T_DATA && (((struct RTypedData*)(short_feature))->typed_flag == 1)) ? rb_unexpected_type((VALUE)(short_feature), (RUBY_T_STRING)) : (void)0);
    short_feature_cstr = rb_string_value_cstr(&(short_feature));

    features_index = get_loaded_features_index_raw();
    st_lookup(features_index, (st_data_t)short_feature_cstr, (st_data_t *)&this_feature_index);

    if (!((VALUE)(this_feature_index) != ((VALUE)RUBY_Qnil))) {
 st_insert(features_index, (st_data_t)ruby_strdup(short_feature_cstr), (st_data_t)offset);
    }
    else if (( ((RUBY_T_FIXNUM) == RUBY_T_FIXNUM) ? (((int)(long)(this_feature_index))&RUBY_FIXNUM_FLAG) : ((RUBY_T_FIXNUM) == RUBY_T_TRUE) ? ((this_feature_index) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_FIXNUM) == RUBY_T_FALSE) ? ((this_feature_index) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_FIXNUM) == RUBY_T_NIL) ? ((this_feature_index) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_FIXNUM) == RUBY_T_UNDEF) ? ((this_feature_index) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_FIXNUM) == RUBY_T_SYMBOL) ? ((((VALUE)(this_feature_index)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(this_feature_index) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(this_feature_index) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(this_feature_index))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_FIXNUM) == RUBY_T_FLOAT) ? ( ((((int)(long)(this_feature_index))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(this_feature_index) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(this_feature_index) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(this_feature_index))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(this_feature_index) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(this_feature_index) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(this_feature_index))->flags & RUBY_T_MASK) == (RUBY_T_FIXNUM)))) {
 VALUE feature_indexes[2];
 feature_indexes[0] = this_feature_index;
 feature_indexes[1] = offset;
 this_feature_index = (VALUE)ruby_xcalloc(1, sizeof(struct RArray));
 ((struct RBasic*)(this_feature_index))->flags = RUBY_T_ARRAY;
 rb_ary_cat(this_feature_index, feature_indexes, ((int)(sizeof(feature_indexes) / sizeof((feature_indexes)[0]))));
 st_insert(features_index, (st_data_t)short_feature_cstr, (st_data_t)this_feature_index);
    }
    else {
 (!( (((RUBY_T_ARRAY)) == RUBY_T_FIXNUM) ? (((int)(long)((VALUE)(this_feature_index)))&RUBY_FIXNUM_FLAG) : (((RUBY_T_ARRAY)) == RUBY_T_TRUE) ? (((VALUE)(this_feature_index)) == ((VALUE)RUBY_Qtrue)) : (((RUBY_T_ARRAY)) == RUBY_T_FALSE) ? (((VALUE)(this_feature_index)) == ((VALUE)RUBY_Qfalse)) : (((RUBY_T_ARRAY)) == RUBY_T_NIL) ? (((VALUE)(this_feature_index)) == ((VALUE)RUBY_Qnil)) : (((RUBY_T_ARRAY)) == RUBY_T_UNDEF) ? (((VALUE)(this_feature_index)) == ((VALUE)RUBY_Qundef)) : (((RUBY_T_ARRAY)) == RUBY_T_SYMBOL) ? ((((VALUE)((VALUE)(this_feature_index))&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)((VALUE)(this_feature_index)) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)((VALUE)(this_feature_index)) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)((VALUE)(this_feature_index)))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : (((RUBY_T_ARRAY)) == RUBY_T_FLOAT) ? ( ((((int)(long)((VALUE)(this_feature_index)))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)((VALUE)(this_feature_index)) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)((VALUE)(this_feature_index)) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)((VALUE)(this_feature_index)))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)((VALUE)(this_feature_index)) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)((VALUE)(this_feature_index)) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)((VALUE)(this_feature_index)))->flags & RUBY_T_MASK) == ((RUBY_T_ARRAY)))) || ((RUBY_T_ARRAY) == RUBY_T_DATA && (((struct RTypedData*)(this_feature_index))->typed_flag == 1)) ? rb_unexpected_type((VALUE)(this_feature_index), (RUBY_T_ARRAY)) : (void)0);
...
features_index_add(VALUE feature, VALUE offset)
{
    ...
    feature_str = rb_string_value_ptr(&(feature));
    feature_end = feature_str + (!(((struct RBasic*)(feature))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(feature))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(feature))->as.heap.len);
...
get_loaded_features_index(void)
{
 ...
 for (i = 0; i < rb_array_len(features); i++) {
     VALUE entry, as_str;
     as_str = entry = rb_ary_entry(features, i);
     rb_string_value(&(as_str));
     as_str = rb_fstring(rb_str_freeze(as_str));
     if (as_str != entry)
  rb_ary_store(features, i, as_str);
     features_index_add(as_str, (((VALUE)(i))<<1 | RUBY_FIXNUM_FLAG));
 }
      ...
      int type, VALUE load_path)
{
 ...
 return 0;
    ...
    if (type == 's' ? !(strcmp((&name[plen+len]), ".so") == 0) :
 type == 'r' ? !(strcmp((&name[plen+len]), ".rb") == 0) :
 0) {
 return 0;
    }
    ...
    if (plen > 0) --plen;
    for (i = 0; i < rb_array_len(load_path); ++i) {
 VALUE p = (rb_array_const_ptr(load_path)[i]);
 const char *s = rb_string_value_ptr(&(p));
 long n = (!(((struct RBasic*)(p))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(p))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(p))->as.heap.len);
...
{
    VALUE features, this_feature_index = ((VALUE)RUBY_Qnil), v, p, load_path = 0;
    const char *f, *e;
    long i, len, elen, n;
 ...
 for (i = 0; ; i++) {
     VALUE entry;
     long index;
     if (( ((RUBY_T_ARRAY) == RUBY_T_FIXNUM) ? (((int)(long)(this_feature_index))&RUBY_FIXNUM_FLAG) : ((RUBY_T_ARRAY) == RUBY_T_TRUE) ? ((this_feature_index) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_ARRAY) == RUBY_T_FALSE) ? ((this_feature_index) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_ARRAY) == RUBY_T_NIL) ? ((this_feature_index) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_ARRAY) == RUBY_T_UNDEF) ? ((this_feature_index) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_ARRAY) == RUBY_T_SYMBOL) ? ((((VALUE)(this_feature_index)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(this_feature_index) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(this_feature_index) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(this_feature_index))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_ARRAY) == RUBY_T_FLOAT) ? ( ((((int)(long)(this_feature_index))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(this_feature_index) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(this_feature_index) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(this_feature_index))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(this_feature_index) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(this_feature_index) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(this_feature_index))->flags & RUBY_T_MASK) == (RUBY_T_ARRAY)))) {
  if (i >= rb_array_len(this_feature_index)) break;
  entry = (rb_array_const_ptr(this_feature_index)[i]);
     }
     else {
  if (i > 0) break;
  entry = this_feature_index;
     }
     index = ((long)(((long)(entry))>>(int)(1)));

     v = (rb_array_const_ptr(features)[index]);
     f = rb_string_value_ptr(&(v));
     if ((n = (!(((struct RBasic*)(v))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(v))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(v))->as.heap.len)) < len) continue;
  ...
  if (!(p = loaded_feature_path(f, n, feature, len, type, load_path)))
      continue;
  expanded = 1;
  f += (!(((struct RBasic*)(p))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(p))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(p))->as.heap.len) + 1;
     }
     if (!*(e = f + len)) {
  if (ext) continue;
  return 'u';
     ...
     if (*e != '.') continue;
     if ((!rb || !ext) && ((strcmp((e), ".so") == 0 || strcmp((e), ".o") == 0) || (strcmp((e), ".so") == 0))) {
  return 's';
     }
 ...
 if (ext && *ext) return 0;
 bufstr = rb_str_tmp_new(len + 3);
 buf = (!(((struct RBasic*)(bufstr))->flags & RSTRING_NOEMBED) ? ((struct RString*)(bufstr))->as.ary : ((struct RString*)(bufstr))->as.heap.ptr);
 memcpy((buf), (feature), sizeof(char)*(size_t)(len));
 for (i = 0; (e = loadable_ext[i]) != 0; i++) {
     strlcpy(buf + len, e, 3 + 1);
 ...
 for (i = 0; i < ((int)(sizeof(so_ext) / sizeof((so_ext)[0]))); i++) {
     strlcpy(buf + len, so_ext[i], 3 + 1);
     if (st_get_key(loading_tbl, (st_data_t)buf, &data)) {
  rb_str_resize(bufstr, 0);
  if (fn) *fn = (const char*)data;
  return 's';
...
rb_feature_provided(const char *feature, const char **loading)
{
 ...
 fullpath = rb_file_expand_path_fast(rb_get_path( ({ (__builtin_constant_p(feature)) ? rb_str_new_static((feature), (long)strlen(feature)) : rb_str_new_cstr(feature); })), ((VALUE)RUBY_Qnil));
 feature = (!(((struct RBasic*)(fullpath))->flags & RSTRING_NOEMBED) ? ((struct RString*)(fullpath))->as.ary : ((struct RString*)(fullpath))->as.heap.ptr);
    }
    if (ext && !strchr(ext, '/')) {
 if ((strcmp((ext), ".rb") == 0)) {
 ...
 else if ((strcmp((ext), ".so") == 0 || strcmp((ext), ".o") == 0) || (strcmp((ext), ".so") == 0)) {
 ...
 return TRUE;
    (* ({ volatile VALUE *rb_gc_guarded_ptr = &(fullpath); ; rb_gc_guarded_ptr; }));
    return FALSE;
}
...
rb_provide_feature(VALUE feature)
{
    ...
    features = get_loaded_features();
    if ((!(!(((VALUE)(features) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(features) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(features))->flags & RUBY_T_MASK) != RUBY_T_NODE) || (((struct RBasic*)(features))->flags&RUBY_FL_FREEZE))) {
 rb_raise(rb_eRuntimeError,
   "$LOADED_FEATURES is frozen; cannot append feature");
    ...
    features_index_add(feature, (((VALUE)(rb_array_len(features)-1))<<1 | RUBY_FIXNUM_FLAG));
    reset_loaded_features_snapshot();
}
...
{
    rb_provide_feature( ({ (__builtin_constant_p(feature)) ? rb_fstring_new((feature), (long)strlen(feature)) : rb_fstring_cstr(feature); }));
}
...
rb_load_internal0(rb_execution_context_t *ec, VALUE fname, int wrap)
{
 ...
 if ((iseq = rb_iseq_load_iseq(fname)) != ((void*)0)) {
     ...
     iseq = rb_iseq_new_top(ast->root,  ({ (__builtin_constant_p("<top (required)>")) ? rb_fstring_new(("<top (required)>"), (long)strlen("<top (required)>")) : rb_fstring_cstr("<top (required)>"); }),
       fname, rb_realpath_internal(((VALUE)RUBY_Qnil), fname, 1), ((void*)0));
     rb_ast_dispose(ast);
 }
 rb_iseq_eval(iseq);
    }
 ...
 VALUE exc = rb_vm_make_jump_tag_but_local_jump(state, ((VALUE)RUBY_Qundef));
 if (!((VALUE)(exc) != ((VALUE)RUBY_Qnil))) return state;
 th->ec->errinfo = exc;
 return RUBY_TAG_RAISE;
    }

    if (!!((VALUE)(th->ec->errinfo) != ((VALUE)RUBY_Qnil))) {
...
rb_load_internal(VALUE fname, int wrap)
{
    ...
    if (state) {
 if (state == RUBY_TAG_RAISE) rb_exc_raise(ec->errinfo);
...
{
    VALUE tmp = rb_find_file(((* ({ volatile VALUE *rb_gc_guarded_ptr = &(fname); ; rb_gc_guarded_ptr; })) = rb_get_path(fname)));
...
rb_load_protect(VALUE fname, int wrap, int *pstate)
{
 ...
 path = file_to_load(fname);
    ...
    if (state == RUBY_TAG_NONE) state = rb_load_internal0(rb_current_execution_context(), path, wrap);
    if (state != RUBY_TAG_NONE) *pstate = state;
}
static VALUE
rb_f_load(int argc, VALUE *argv)
{
 ...
 path = fname;
    ...
    rb_load_internal(path, !(((VALUE)(wrap) & (VALUE)~((VALUE)RUBY_Qnil)) == 0));
...
load_lock(const char *ftptr)
{
 ...
 struct MEMO *memo = ((struct MEMO *)data);
...
search_required(VALUE fname, volatile VALUE *path, int safe_level)
{
    ...
    *path = 0;
    ext = strrchr(ftptr = (!(((struct RBasic*)(fname))->flags & RSTRING_NOEMBED) ? ((struct RString*)(fname))->as.ary : ((struct RString*)(fname))->as.heap.ptr), '.');
    if (ext && !strchr(ext, '/')) {
 if ((strcmp((ext), ".rb") == 0)) {
  ...
  ext = strrchr(ftptr = (!(((struct RBasic*)(tmp))->flags & RSTRING_NOEMBED) ? ((struct RString*)(tmp))->as.ary : ((struct RString*)(tmp))->as.heap.ptr), '.');
  ...
  return 's';
     ...
     tmp = rb_str_subseq(fname, 0, ext - (!(((struct RBasic*)(fname))->flags & RSTRING_NOEMBED) ? ((struct RString*)(fname))->as.ary : ((struct RString*)(fname))->as.heap.ptr));
      ({ (__builtin_constant_p(".so")) ? rb_str_cat((tmp), (".so"), (long)strlen(".so")) : rb_str_cat_cstr((tmp), (".so")); });
     rb_obj_freeze_inline((VALUE)tmp);
 ...
 ftptr = (!(((struct RBasic*)(tmp))->flags & RSTRING_NOEMBED) ? ((struct RString*)(tmp))->as.ary : ((struct RString*)(tmp))->as.heap.ptr);
...
load_ext(VALUE path)
{
    ...
    return (VALUE)dln_load((!(((struct RBasic*)(path))->flags & RSTRING_NOEMBED) ? ((struct RString*)(path))->as.ary : ((struct RString*)(path))->as.heap.ptr));
}
int
rb_require_internal(VALUE fname, int safe)
{
 ...
 if (found) {
     if (!path || !(ftptr = load_lock((!(((struct RBasic*)(path))->flags & RSTRING_NOEMBED) ? ((struct RString*)(path))->as.ary : ((struct RString*)(path))->as.heap.ptr)))) {
  result = 0;
     }
     else if (!*ftptr) {
  rb_provide_feature(path);
  result = RUBY_TAG_RETURN;
     }
     else {
  switch (found) {
    case 'r':
    ...
    case 's':
      handle = (long)rb_vm_call_cfunc(rb_vm_top_self(), load_ext,
          path, 0, path);
      rb_ary_push(ruby_dln_librefs, rb_long2num_inline(handle));
      break;
  }
  if (!state) {
      rb_provide_feature(path);
...
ruby_require_internal(const char *fname, unsigned int len)
{
    ...
    return result == RUBY_TAG_RETURN ? 1 : result ? -1 : 0;
}
...
rb_require_safe(VALUE fname, int safe)
{
    ...
    if (result > RUBY_TAG_RETURN) {
 if (result == RUBY_TAG_RAISE) rb_exc_raise(rb_errinfo());
 rb_ec_tag_jump(rb_current_execution_context(), result);
    }
    if (result < 0) {
 load_failed(fname);
    }

    return result ? ((VALUE)RUBY_Qtrue) : ((VALUE)RUBY_Qfalse);
}

VALUE
rb_require(const char *fname)
{
    VALUE fn =  ({ (__builtin_constant_p(fname)) ? rb_str_new_static((fname), (long)strlen(fname)) : rb_str_new_cstr(fname); });
 ...
 *value = (st_data_t)((struct MEMO *)rb_imemo_new(imemo_memo, (VALUE)(0), (VALUE)(0), (VALUE)(init), 0));
...
Init_load(void)
{
    ...
    rb_alias_variable(rb_intern2(("$-I"), strlen("$-I")), id_load_path);
    rb_alias_variable(rb_intern2(("$LOAD_PATH"), strlen("$LOAD_PATH")), id_load_path);
