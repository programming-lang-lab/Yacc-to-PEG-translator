...
static VALUE strscan_scan_full (VALUE self, VALUE re, VALUE succp, VALUE getp);
...
static VALUE strscan_search_full (VALUE self, VALUE re, VALUE succp, VALUE getp);
...
{
    ( (((!(((VALUE)(str) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(str) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(str))->flags & RUBY_T_MASK) != RUBY_T_NODE) && (int)(((struct RBasic*)(str))->flags & RUBY_T_MASK) != RUBY_T_BIGNUM && (int)(((struct RBasic*)(str))->flags & RUBY_T_MASK) != RUBY_T_FLOAT) && (!(((VALUE)(p->str) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(p->str) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(p->str))->flags & RUBY_T_MASK) != RUBY_T_NODE)) ? (void)(((struct RBasic*)(str))->flags |= ((((struct RBasic*)(p->str))->flags&(RUBY_FL_TAINT)))) : (void)0);
    return str;
}
...
{
    VALUE str =  ({ (__builtin_constant_p(ptr) && __builtin_constant_p(len)) ? rb_str_new_static((ptr), (len)) : rb_str_new((ptr), (len)); });
...
{
    if (beg_i > ((!(((struct RBasic*)((p)->str))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)((p)->str))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)((p)->str))->as.heap.len))) return ((VALUE)RUBY_Qnil);
    end_i = minl(end_i, ((!(((struct RBasic*)((p)->str))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)((p)->str))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)((p)->str))->as.heap.len)));
    return infect(str_new(p, ((!(((struct RBasic*)((p)->str))->flags & RSTRING_NOEMBED) ? ((struct RString*)((p)->str))->as.ary : ((struct RString*)((p)->str))->as.heap.ptr)) + beg_i, end_i - beg_i), p);
}
...
{
    if (beg_i > ((!(((struct RBasic*)((p)->str))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)((p)->str))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)((p)->str))->as.heap.len))) return ((VALUE)RUBY_Qnil);
    len = minl(len, ((!(((struct RBasic*)((p)->str))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)((p)->str))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)((p)->str))->as.heap.len)) - beg_i);
    return infect(str_new(p, ((!(((struct RBasic*)((p)->str))->flags & RSTRING_NOEMBED) ? ((struct RString*)((p)->str))->as.ary : ((struct RString*)((p)->str))->as.heap.ptr)) + beg_i, len), p);
}
...
{
    struct strscanner *p;
    VALUE obj = ({ VALUE data_struct_obj = rb_data_typed_object_zalloc(klass, sizeof(struct strscanner), &strscanner_type); (void)((p) = (struct strscanner *)(((struct RData*)(data_struct_obj))->data));; data_struct_obj; });

    (p)->flags &= ~(1 << 0);
    onig_region_init(&(p->regs));
    p->str = ((VALUE)RUBY_Qnil);
    return obj;
}
...
strscan_init_copy(VALUE vself, VALUE vorig)
{
 ...
 if (rb_reg_region_copy(&self->regs, &orig->regs))
     rb_memerror();
 (* ({ volatile VALUE *rb_gc_guarded_ptr = &(vorig); ; rb_gc_guarded_ptr; }));
    }
...
strscan_reset(VALUE self)
{
    ...
    do { (p) = check_strscan(self); if (!((VALUE)((p)->str) != ((VALUE)RUBY_Qnil))) rb_raise(rb_eArgError, "uninitialized StringScanner object");} while (0);
    p->curr = 0;
    (p)->flags &= ~(1 << 0);
    return self;
}
...
strscan_terminate(VALUE self)
{
    ...
    do { (p) = check_strscan(self); if (!((VALUE)((p)->str) != ((VALUE)RUBY_Qnil))) rb_raise(rb_eArgError, "uninitialized StringScanner object");} while (0);
    p->curr = ((!(((struct RBasic*)((p)->str))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)((p)->str))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)((p)->str))->as.heap.len));
    (p)->flags &= ~(1 << 0);
    return self;
}
...
strscan_get_pos(VALUE self)
{
    ...
    do { (p) = check_strscan(self); if (!((VALUE)((p)->str) != ((VALUE)RUBY_Qnil))) rb_raise(rb_eArgError, "uninitialized StringScanner object");} while (0);
    return (((VALUE)(p->curr))<<1 | RUBY_FIXNUM_FLAG);
}
static VALUE
strscan_get_charpos(VALUE self)
{
    ...
    substr = rb_funcall(p->str, id_byteslice, 2, (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG), (((VALUE)((int)(p->curr)))<<1 | RUBY_FIXNUM_FLAG));
...
strscan_set_pos(VALUE self, VALUE v)
{
    ...
    do { (p) = check_strscan(self); if (!((VALUE)((p)->str) != ((VALUE)RUBY_Qnil))) rb_raise(rb_eArgError, "uninitialized StringScanner object");} while (0);
    i = rb_num2int_inline(v);
    if (i < 0) i += ((!(((struct RBasic*)((p)->str))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)((p)->str))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)((p)->str))->as.heap.len));
    if (i < 0) rb_raise(rb_eRangeError, "index out of range");
    if (i > ((!(((struct RBasic*)((p)->str))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)((p)->str))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)((p)->str))->as.heap.len))) rb_raise(rb_eRangeError, "index out of range");
    p->curr = i;
...
strscan_do_scan(VALUE self, VALUE regex, int succptr, int getstr, int headonly)
{
    ...
    rb_check_type((VALUE)(regex),(RUBY_T_REGEXP));
    do { (p) = check_strscan(self); if (!((VALUE)((p)->str) != ((VALUE)RUBY_Qnil))) rb_raise(rb_eArgError, "uninitialized StringScanner object");} while (0);

    (p)->flags &= ~(1 << 0);
    if ((((!(((struct RBasic*)((p)->str))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)((p)->str))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)((p)->str))->as.heap.len)) - (p)->curr) < 0) {
        return ((VALUE)RUBY_Qnil);
    }

    p->regex = regex;
    re = rb_reg_prepare_re(regex, p->str);
    tmpreg = re != (((struct RRegexp*)(regex))->ptr);
    if (!tmpreg) ((struct RRegexp*)(regex))->usecnt++;

    if (headonly) {
        ret = onig_match(re, (OnigUChar* )(((!(((struct RBasic*)((p)->str))->flags & RSTRING_NOEMBED) ? ((struct RString*)((p)->str))->as.ary : ((struct RString*)((p)->str))->as.heap.ptr)) + (p)->curr),
                         (OnigUChar* )((((!(((struct RBasic*)((p)->str))->flags & RSTRING_NOEMBED) ? ((struct RString*)((p)->str))->as.ary : ((struct RString*)((p)->str))->as.heap.ptr)) + (p)->curr) + (((!(((struct RBasic*)((p)->str))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)((p)->str))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)((p)->str))->as.heap.len)) - (p)->curr)),
                         (OnigUChar* )(((!(((struct RBasic*)((p)->str))->flags & RSTRING_NOEMBED) ? ((struct RString*)((p)->str))->as.ary : ((struct RString*)((p)->str))->as.heap.ptr)) + (p)->curr), &(p->regs), 0U);
    }
    else {
        ret = onig_search(re,
                          (OnigUChar* )(((!(((struct RBasic*)((p)->str))->flags & RSTRING_NOEMBED) ? ((struct RString*)((p)->str))->as.ary : ((struct RString*)((p)->str))->as.heap.ptr)) + (p)->curr), (OnigUChar* )((((!(((struct RBasic*)((p)->str))->flags & RSTRING_NOEMBED) ? ((struct RString*)((p)->str))->as.ary : ((struct RString*)((p)->str))->as.heap.ptr)) + (p)->curr) + (((!(((struct RBasic*)((p)->str))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)((p)->str))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)((p)->str))->as.heap.len)) - (p)->curr)),
                          (OnigUChar* )(((!(((struct RBasic*)((p)->str))->flags & RSTRING_NOEMBED) ? ((struct RString*)((p)->str))->as.ary : ((struct RString*)((p)->str))->as.heap.ptr)) + (p)->curr), (OnigUChar* )((((!(((struct RBasic*)((p)->str))->flags & RSTRING_NOEMBED) ? ((struct RString*)((p)->str))->as.ary : ((struct RString*)((p)->str))->as.heap.ptr)) + (p)->curr) + (((!(((struct RBasic*)((p)->str))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)((p)->str))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)((p)->str))->as.heap.len)) - (p)->curr)),
                          &(p->regs), 0U);
    }
    if (!tmpreg) ((struct RRegexp*)(regex))->usecnt--;
    if (tmpreg) {
        if (((struct RRegexp*)(regex))->usecnt) {
            onig_free(re);
        }
        else {
            onig_free((((struct RRegexp*)(regex))->ptr));
            (((struct RRegexp*)(regex))->ptr) = re;
        }
    }
    ...
    if (getstr) {
        ...
        return (((VALUE)(p->regs.end[0]))<<1 | RUBY_FIXNUM_FLAG);
    }
}
static VALUE
...
{
    return strscan_do_scan(self, re, !(((VALUE)(s) & (VALUE)~((VALUE)RUBY_Qnil)) == 0), !(((VALUE)(f) & (VALUE)~((VALUE)RUBY_Qnil)) == 0), 1);
}
static VALUE
...
{
    return strscan_do_scan(self, re, !(((VALUE)(s) & (VALUE)~((VALUE)RUBY_Qnil)) == 0), !(((VALUE)(f) & (VALUE)~((VALUE)RUBY_Qnil)) == 0), 0);
}
...
strscan_getch(VALUE self)
{
    ...
    do { (p) = check_strscan(self); if (!((VALUE)((p)->str) != ((VALUE)RUBY_Qnil))) rb_raise(rb_eArgError, "uninitialized StringScanner object");} while (0);
    (p)->flags &= ~(1 << 0);
    if (((p)->curr >= (!(((struct RBasic*)(p->str))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(p->str))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(p->str))->as.heap.len)))
        return ((VALUE)RUBY_Qnil);

    len = rb_enc_mbclen((((!(((struct RBasic*)((p)->str))->flags & RSTRING_NOEMBED) ? ((struct RString*)((p)->str))->as.ary : ((struct RString*)((p)->str))->as.heap.ptr)) + (p)->curr), (((!(((struct RBasic*)((p)->str))->flags & RSTRING_NOEMBED) ? ((struct RString*)((p)->str))->as.ary : ((struct RString*)((p)->str))->as.heap.ptr)) + ((!(((struct RBasic*)((p)->str))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)((p)->str))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)((p)->str))->as.heap.len))), rb_enc_get(p->str));
    len = minl(len, (((!(((struct RBasic*)((p)->str))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)((p)->str))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)((p)->str))->as.heap.len)) - (p)->curr));
    p->prev = p->curr;
    p->curr += len;
    (p)->flags |= (1 << 0);
...
strscan_bol_p(VALUE self)
{
    ...
    do { (p) = check_strscan(self); if (!((VALUE)((p)->str) != ((VALUE)RUBY_Qnil))) rb_raise(rb_eArgError, "uninitialized StringScanner object");} while (0);
    if ((((!(((struct RBasic*)((p)->str))->flags & RSTRING_NOEMBED) ? ((struct RString*)((p)->str))->as.ary : ((struct RString*)((p)->str))->as.heap.ptr)) + (p)->curr) > (((!(((struct RBasic*)((p)->str))->flags & RSTRING_NOEMBED) ? ((struct RString*)((p)->str))->as.ary : ((struct RString*)((p)->str))->as.heap.ptr)) + ((!(((struct RBasic*)((p)->str))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)((p)->str))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)((p)->str))->as.heap.len)))) return ((VALUE)RUBY_Qnil);
    if (p->curr == 0) return ((VALUE)RUBY_Qtrue);
    return (*((((!(((struct RBasic*)((p)->str))->flags & RSTRING_NOEMBED) ? ((struct RString*)((p)->str))->as.ary : ((struct RString*)((p)->str))->as.heap.ptr)) + (p)->curr) - 1) == '\n') ? ((VALUE)RUBY_Qtrue) : ((VALUE)RUBY_Qfalse);
}
static VALUE
strscan_eos_p(VALUE self)
{
    ...
    do { (p) = check_strscan(self); if (!((VALUE)((p)->str) != ((VALUE)RUBY_Qnil))) rb_raise(rb_eArgError, "uninitialized StringScanner object");} while (0);
    return ((p)->curr >= (!(((struct RBasic*)(p->str))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(p->str))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(p->str))->as.heap.len)) ? ((VALUE)RUBY_Qtrue) : ((VALUE)RUBY_Qfalse);
}
...
strscan_rest_p(VALUE self)
{
    ...
    do { (p) = check_strscan(self); if (!((VALUE)((p)->str) != ((VALUE)RUBY_Qnil))) rb_raise(rb_eArgError, "uninitialized StringScanner object");} while (0);
    return ((p)->curr >= (!(((struct RBasic*)(p->str))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(p->str))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(p->str))->as.heap.len)) ? ((VALUE)RUBY_Qfalse) : ((VALUE)RUBY_Qtrue);
}
static VALUE
strscan_matched_p(VALUE self)
{
    ...
    do { (p) = check_strscan(self); if (!((VALUE)((p)->str) != ((VALUE)RUBY_Qnil))) rb_raise(rb_eArgError, "uninitialized StringScanner object");} while (0);
    return ((p)->flags & (1 << 0)) ? ((VALUE)RUBY_Qtrue) : ((VALUE)RUBY_Qfalse);
}
static VALUE
strscan_matched(VALUE self)
{
    ...
    do { (p) = check_strscan(self); if (!((VALUE)((p)->str) != ((VALUE)RUBY_Qnil))) rb_raise(rb_eArgError, "uninitialized StringScanner object");} while (0);
    if (! ((p)->flags & (1 << 0))) return ((VALUE)RUBY_Qnil);
    return extract_range(p, p->prev + p->regs.beg[0],
                            p->prev + p->regs.end[0]);
}
static VALUE
strscan_matched_size(VALUE self)
{
    ...
    do { (p) = check_strscan(self); if (!((VALUE)((p)->str) != ((VALUE)RUBY_Qnil))) rb_raise(rb_eArgError, "uninitialized StringScanner object");} while (0);
    if (! ((p)->flags & (1 << 0))) return ((VALUE)RUBY_Qnil);
    return (((VALUE)((int)(p->regs.end[0] - p->regs.beg[0])))<<1 | RUBY_FIXNUM_FLAG);
}
...
name_to_backref_number(struct re_registers *regs, VALUE regexp, const char* name, const char* name_end, rb_encoding *enc)
{
    ...
    num = onig_name_to_backref_number((((struct RRegexp*)(regexp))->ptr),
 ...
 rb_enc_raise(enc, rb_eIndexError, "undefined group name reference: %.*s",
       rb_long2int_inline(name_end - name), name);
    }
...
strscan_aref(VALUE self, VALUE idx)
{
    ...
    switch (rb_type((VALUE)(idx))) {
        case RUBY_T_SYMBOL:
            idx = rb_sym2str(idx);

        case RUBY_T_STRING:
            if (!p->regex) return ((VALUE)RUBY_Qnil);
            (!(((struct RBasic*)(idx))->flags & RSTRING_NOEMBED) ? ((name) = ((struct RString*)(idx))->as.ary, (i) = (long)((((struct RBasic*)(idx))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT))) : ((name) = ((struct RString*)(idx))->as.heap.ptr, (i) = ((struct RString*)(idx))->as.heap.len));
    ...
    if (i >= p->regs.num_regs) return ((VALUE)RUBY_Qnil);
    if (p->regs.beg[i] == -1) return ((VALUE)RUBY_Qnil);
...
strscan_size(VALUE self)
{
    ...
    do { (p) = check_strscan(self); if (!((VALUE)((p)->str) != ((VALUE)RUBY_Qnil))) rb_raise(rb_eArgError, "uninitialized StringScanner object");} while (0);
    if (! ((p)->flags & (1 << 0))) return ((VALUE)RUBY_Qnil);
    return (((VALUE)(p->regs.num_regs))<<1 | RUBY_FIXNUM_FLAG);
}
static VALUE
strscan_captures(VALUE self)
{
    ...
    new_ary = rb_ary_new_capa(num_regs);
...
strscan_post_match(VALUE self)
{
    ...
    do { (p) = check_strscan(self); if (!((VALUE)((p)->str) != ((VALUE)RUBY_Qnil))) rb_raise(rb_eArgError, "uninitialized StringScanner object");} while (0);
    if (! ((p)->flags & (1 << 0))) return ((VALUE)RUBY_Qnil);
    return extract_range(p, p->prev + p->regs.end[0], ((!(((struct RBasic*)((p)->str))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)((p)->str))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)((p)->str))->as.heap.len)));
}
...
strscan_rest(VALUE self)
{
    ...
    return extract_range(p, p->curr, ((!(((struct RBasic*)((p)->str))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)((p)->str))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)((p)->str))->as.heap.len)));
}
...
strscan_rest_size(VALUE self)
{
    ...
    i = (((!(((struct RBasic*)((p)->str))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)((p)->str))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)((p)->str))->as.heap.len)) - (p)->curr);
    return (((VALUE)(i))<<1 | RUBY_FIXNUM_FLAG);
}
...
strscan_inspect(VALUE self)
{
    ...
    p = check_strscan(self);
    if (!((VALUE)(p->str) != ((VALUE)RUBY_Qnil))) {
 a = rb_sprintf("#<%li\v (uninitialized)>", rb_obj_class(self));
 return infect(a, p);
    }
    if (((p)->curr >= (!(((struct RBasic*)(p->str))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(p->str))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(p->str))->as.heap.len))) {
 a = rb_sprintf("#<%li\v fin>", rb_obj_class(self));
 return infect(a, p);
    }
    if (p->curr == 0) {
 b = inspect2(p);
 a = rb_sprintf("#<%li\v %ld/%ld @ %li\v>",
         rb_obj_class(self),
         p->curr, ((!(((struct RBasic*)((p)->str))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)((p)->str))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)((p)->str))->as.heap.len)),
         b);
 return infect(a, p);
    ...
    a = inspect1(p);
    b = inspect2(p);
    a = rb_sprintf("#<%li\v %ld/%ld %li\v @ %li\v>",
     rb_obj_class(self),
     p->curr, ((!(((struct RBasic*)((p)->str))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)((p)->str))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)((p)->str))->as.heap.len)),
     a, b);
    return infect(a, p);
...
inspect1(struct strscanner *p)
{
    ...
    if (p->curr == 0) return  ({ (__builtin_constant_p("")) ? rb_str_new_static((""), (long)strlen("")) : rb_str_new_cstr(""); });
    if (p->curr > 5) {
 ...
 len = p->curr;
    ...
    rb_str_cat(str, (((!(((struct RBasic*)((p)->str))->flags & RSTRING_NOEMBED) ? ((struct RString*)((p)->str))->as.ary : ((struct RString*)((p)->str))->as.heap.ptr)) + (p)->curr) - len, len);
...
inspect2(struct strscanner *p)
{
    ...
    if (((p)->curr >= (!(((struct RBasic*)(p->str))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(p->str))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(p->str))->as.heap.len))) return  ({ (__builtin_constant_p("")) ? rb_str_new_static((""), (long)strlen("")) : rb_str_new_cstr(""); });
    len = (((!(((struct RBasic*)((p)->str))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)((p)->str))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)((p)->str))->as.heap.len)) - (p)->curr);
    if (len > 5) {
 str =  ({ (__builtin_constant_p((((!(((struct RBasic*)((p)->str))->flags & RSTRING_NOEMBED) ? ((struct RString*)((p)->str))->as.ary : ((struct RString*)((p)->str))->as.heap.ptr)) + (p)->curr)) && __builtin_constant_p(5)) ? rb_str_new_static(((((!(((struct RBasic*)((p)->str))->flags & RSTRING_NOEMBED) ? ((struct RString*)((p)->str))->as.ary : ((struct RString*)((p)->str))->as.heap.ptr)) + (p)->curr)), (5)) : rb_str_new(((((!(((struct RBasic*)((p)->str))->flags & RSTRING_NOEMBED) ? ((struct RString*)((p)->str))->as.ary : ((struct RString*)((p)->str))->as.heap.ptr)) + (p)->curr)), (5)); });
  ({ (__builtin_constant_p("...")) ? rb_str_cat((str), ("..."), (long)strlen("...")) : rb_str_cat_cstr((str), ("...")); });
    }
    else {
 str =  ({ (__builtin_constant_p((((!(((struct RBasic*)((p)->str))->flags & RSTRING_NOEMBED) ? ((struct RString*)((p)->str))->as.ary : ((struct RString*)((p)->str))->as.heap.ptr)) + (p)->curr)) && __builtin_constant_p(len)) ? rb_str_new_static(((((!(((struct RBasic*)((p)->str))->flags & RSTRING_NOEMBED) ? ((struct RString*)((p)->str))->as.ary : ((struct RString*)((p)->str))->as.heap.ptr)) + (p)->curr)), (len)) : rb_str_new(((((!(((struct RBasic*)((p)->str))->flags & RSTRING_NOEMBED) ? ((struct RString*)((p)->str))->as.ary : ((struct RString*)((p)->str))->as.heap.ptr)) + (p)->curr)), (len)); });
    }
    return rb_str_dump(str);
}
void
Init_strscan(void)
{
    ID id_scanerr = (__builtin_constant_p("ScanError") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("ScanError")), (long)strlen(("ScanError"))); (ID) rb_intern_id_cache; }) : rb_intern("ScanError"));
    VALUE tmp;

    id_byteslice = (__builtin_constant_p("byteslice") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("byteslice")), (long)strlen(("byteslice"))); (ID) rb_intern_id_cache; }) : rb_intern("byteslice"));
 ...
 rb_const_set(rb_cObject, id_scanerr, ScanError);
    ...
    tmp =  ({ (__builtin_constant_p("0.7.0")) ? rb_str_new_static(("0.7.0"), (long)strlen("0.7.0")) : rb_str_new_cstr("0.7.0"); });
    rb_obj_freeze(tmp);
    rb_const_set(StringScanner, (__builtin_constant_p("Version") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("Version")), (long)strlen(("Version"))); (ID) rb_intern_id_cache; }) : rb_intern("Version")), tmp);
    tmp =  ({ (__builtin_constant_p("$Id: strscan.c 61085 2017-12-08 22:42:19Z stomar $")) ? rb_str_new_static(("$Id: strscan.c 61085 2017-12-08 22:42:19Z stomar $"), (long)strlen("$Id: strscan.c 61085 2017-12-08 22:42:19Z stomar $")) : rb_str_new_cstr("$Id: strscan.c 61085 2017-12-08 22:42:19Z stomar $"); });
    rb_obj_freeze(tmp);
    rb_const_set(StringScanner, (__builtin_constant_p("Id") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("Id")), (long)strlen(("Id"))); (ID) rb_intern_id_cache; }) : rb_intern("Id")), tmp);
    ...
    rb_alias(StringScanner, (__builtin_constant_p("bol?") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("bol?")), (long)strlen(("bol?"))); (ID) rb_intern_id_cache; }) : rb_intern("bol?")), (__builtin_constant_p("beginning_of_line?") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("beginning_of_line?")), (long)strlen(("beginning_of_line?"))); (ID) rb_intern_id_cache; }) : rb_intern("beginning_of_line?")));
