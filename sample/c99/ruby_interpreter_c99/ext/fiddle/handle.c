...
rb_fiddle_handle_close(VALUE self)
{
    ...
    ((fiddle_handle) = (struct dl_handle*)rb_check_typeddata((self), (&fiddle_handle_data_type)));
 ...
 return (((VALUE)((int)(ret)))<<1 | RUBY_FIXNUM_FLAG);
    }
...
rb_fiddle_handle_s_allocate(VALUE klass)
{
    ...
    obj = ({ VALUE data_struct_obj = rb_data_typed_object_zalloc(rb_cHandle, sizeof(struct dl_handle), &fiddle_handle_data_type); (void)((fiddle_handle) = (struct dl_handle *)(((struct RData*)(data_struct_obj))->data));; data_struct_obj; });
    fiddle_handle->ptr = 0;
    fiddle_handle->open = 0;
...
predefined_fiddle_handle(void *handle)
{
    ...
    struct dl_handle *fiddle_handle = (((struct RData*)(obj))->data);
...
rb_fiddle_handle_initialize(int argc, VALUE argv[], VALUE self)
{
 ...
 break;
      case 1:
 clib = !((VALUE)(lib) != ((VALUE)RUBY_Qnil)) ? ((void*)0) : (rb_check_safe_obj(rb_string_value(&lib)), rb_string_value_cstr(&(lib)));
 cflag = RTLD_LAZY | RTLD_GLOBAL;
 break;
      case 2:
 clib = !((VALUE)(lib) != ((VALUE)RUBY_Qnil)) ? ((void*)0) : (rb_check_safe_obj(rb_string_value(&lib)), rb_string_value_cstr(&(lib)));
 cflag = rb_num2int_inline(flag);
 break;
      default:
...
rb_fiddle_handle_close_enabled_p(VALUE self)
{
    ...
    if(fiddle_handle->enable_close) return ((VALUE)RUBY_Qtrue);
...
rb_fiddle_handle_to_i(VALUE self)
{
    ...
    ((fiddle_handle) = (struct dl_handle*)rb_check_typeddata((self), (&fiddle_handle_data_type)));
    return (rb_long2num_inline((long)(fiddle_handle)));
}
...
{
    return fiddle_handle_sym(((void*)0), sym);
}
...
fiddle_handle_sym(void *handle, VALUE symbol)
{
    ...
    void (*func)();
    const char *name = (rb_check_safe_obj(rb_string_value(&symbol)), rb_string_value_cstr(&(symbol)));
    ...
    func = (void (*)())(VALUE)dlsym(handle, name);
                 ;
    if( !func ){
 rb_raise(rb_eFiddleError, "unknown symbol \"%li\v\"", symbol);
    }

    return (rb_long2num_inline((long)(func)));
}
...
Init_fiddle_handle(void)
{
    ...
    rb_define_const(rb_cHandle, "NEXT", predefined_fiddle_handle(((void*)0)));
    rb_define_const(rb_cHandle, "DEFAULT", predefined_fiddle_handle(((void*)0)));
    rb_define_const(rb_cHandle, "RTLD_GLOBAL", (((VALUE)((int)(RTLD_GLOBAL)))<<1 | RUBY_FIXNUM_FLAG));
    rb_define_const(rb_cHandle, "RTLD_LAZY", (((VALUE)((int)(RTLD_LAZY)))<<1 | RUBY_FIXNUM_FLAG));
    rb_define_const(rb_cHandle, "RTLD_NOW", (((VALUE)((int)(RTLD_NOW)))<<1 | RUBY_FIXNUM_FLAG));
