...
dealloc(void * ptr)
{
    ...
    if (cls->argv) ruby_xfree(cls->argv);
    ruby_xfree(cls);
}
...
with_gvl_callback(void *ptr)
{
    ...
    int argc = rb_long2int_inline(rb_array_len(rbargs));
    ...
    for (i = 0; i < argc; i++) {
        type = rb_num2int_inline((rb_array_const_ptr(rbargs)[i]));
        switch (type) {
   case 0:
     argc = 0;
     break;
   case 4:
     rb_ary_push(params, (((VALUE)((int)(*(int *)x->args[i])))<<1 | RUBY_FIXNUM_FLAG));
     break;
   case -4:
     rb_ary_push(params, (((VALUE)((unsigned int)(*(unsigned int *)x->args[i])))<<1 | RUBY_FIXNUM_FLAG));
     break;
   case 1:
     rb_ary_push(params,
   rb_funcall(cPointer, (__builtin_constant_p("[]") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("[]")), (long)strlen(("[]"))); (ID) rb_intern_id_cache; }) : rb_intern("[]")), 1,
       (rb_long2num_inline((long)(*(void **)x->args[i])))));
     break;
   case 5:
     rb_ary_push(params, rb_long2num_inline(*(long *)x->args[i]));
     break;
   case -5:
     rb_ary_push(params, rb_ulong2num_inline(*(unsigned long *)x->args[i]));
     break;
   case 2:
     rb_ary_push(params, (((VALUE)((int)(*(signed char *)x->args[i])))<<1 | RUBY_FIXNUM_FLAG));
     break;
   case -2:
     rb_ary_push(params, (((VALUE)((unsigned int)(*(unsigned char *)x->args[i])))<<1 | RUBY_FIXNUM_FLAG));
     break;
   case 3:
     rb_ary_push(params, (((VALUE)((int)(*(signed short *)x->args[i])))<<1 | RUBY_FIXNUM_FLAG));
     break;
   case -3:
     rb_ary_push(params, (((VALUE)((unsigned int)(*(unsigned short *)x->args[i])))<<1 | RUBY_FIXNUM_FLAG));
     break;
   case 8:
   ...
   case 6:
     rb_ary_push(params, rb_ll2inum(*(long long *)x->args[i]));
     break;
   case -6:
     rb_ary_push(params, rb_ull2inum(*(unsigned long long *)x->args[i]));
     break;
   ...
   default:
    ...
    ret = rb_funcallv(self, (__builtin_constant_p("call") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("call")), (long)strlen(("call"))); (ID) rb_intern_id_cache; }) : rb_intern("call")), argc, rb_array_const_ptr(params));
    (* ({ volatile VALUE *rb_gc_guarded_ptr = &(params); ; rb_gc_guarded_ptr; }));

    type = rb_num2int_inline(ctype);
    switch (type) {
      case 0:
 break;
      case 5:
 *(long *)x->resp = rb_num2long_inline(ret);
 break;
      case -5:
 *(unsigned long *)x->resp = rb_num2ulong_inline(ret);
 break;
      case 2:
      case 3:
      case 4:
 *(ffi_sarg *)x->resp = rb_num2int_inline(ret);
 break;
      case -2:
      case -3:
      case -4:
 *(ffi_arg *)x->resp = ((unsigned int)rb_num2uint(ret));
 break;
      case 1:
 *(void **)x->resp = ((void*)(rb_num2ulong_inline(ret)));
 break;
      case 8:
 *(double *)x->resp = rb_num2dbl((VALUE)(ret));
 break;
      case 7:
 *(float *)x->resp = (float)rb_num2dbl((VALUE)(ret));
 break;

      case 6:
 *(long long *)x->resp = rb_num2ll_inline(ret);
 break;
      case -6:
 *(unsigned long long *)x->resp = rb_num2ull(ret);
 break;
...
allocate(VALUE klass)
{
    ...
    VALUE i = ({ VALUE data_struct_obj = rb_data_typed_object_zalloc(klass, sizeof(fiddle_closure), &closure_data_type); (void)((closure) = (fiddle_closure *)(((struct RData*)(data_struct_obj))->data));; data_struct_obj; });





    closure->pcl = mmap(((void*)0), sizeof(ffi_closure), PROT_READ | PROT_WRITE,
...
initialize(int rbargc, VALUE argv[], VALUE self)
{
 ...
 abi = (((VALUE)((int)(FFI_DEFAULT_ABI)))<<1 | RUBY_FIXNUM_FLAG);

    rb_check_type((VALUE)(args),(RUBY_T_ARRAY));

    argc = rb_long2int_inline(rb_array_len(args));

    ((cl) = (fiddle_closure*)rb_check_typeddata((self), (&closure_data_type)));

    cl->argv = (ffi_type **)ruby_xcalloc(argc + 1, sizeof(ffi_type *));

    for (i = 0; i < argc; i++) {
        int type = rb_num2int_inline((rb_array_const_ptr(args)[i]));
        cl->argv[i] = int_to_ffi_type(type);
    }
    cl->argv[argc] = ((void*)0);
    ...
    result = ffi_prep_cif(cif, rb_num2int_inline(abi), argc,
                int_to_ffi_type(rb_num2int_inline(ret)),
  cl->argv);
...
to_i(VALUE self)
{
    ...
    return (rb_long2num_inline((long)(code)));
}
