 ...
 *wrap = 0;
 return ((void*)0);
    ...
    *wrap = (addrnum != func) ? func : 0;
    return (freefunc_t)(VALUE)((void*)(rb_num2ulong_inline(addrnum)));
}
...
rb_fiddle_ptr_new2(VALUE klass, void *ptr, long size, freefunc_t func)
{
    ...
    val = ({ VALUE data_struct_obj = rb_data_typed_object_zalloc(klass, sizeof(struct ptr_data), &fiddle_ptr_data_type); (void)((data) = (struct ptr_data *)(((struct RData*)(data_struct_obj))->data));; data_struct_obj; });
    data->ptr = ptr;
    data->free = func;
    data->size = size;
    (((!(((VALUE)(val) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(val) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(val))->flags & RUBY_T_MASK) != RUBY_T_NODE) && (int)(((struct RBasic*)(val))->flags & RUBY_T_MASK) != RUBY_T_BIGNUM && (int)(((struct RBasic*)(val))->flags & RUBY_T_MASK) != RUBY_T_FLOAT) ? (void)(((struct RBasic*)(val))->flags |= (RUBY_FL_TAINT)) : (void)0);
...
rb_fiddle_ptr2cptr(VALUE val)
{
 ...
 ((data) = (struct ptr_data*)rb_check_typeddata((val), (&fiddle_ptr_data_type)));
 ptr = data->ptr;
    }
    else if (val == ((VALUE)RUBY_Qnil)) {
 ptr = ((void*)0);
    }
    else{
...
rb_fiddle_ptr_s_allocate(VALUE klass)
{
    ...
    obj = ({ VALUE data_struct_obj = rb_data_typed_object_zalloc(klass, sizeof(struct ptr_data), &fiddle_ptr_data_type); (void)((data) = (struct ptr_data *)(((struct RData*)(data_struct_obj))->data));; data_struct_obj; });
    data->ptr = 0;
    data->size = 0;
    data->free = 0;
...
rb_fiddle_ptr_initialize(int argc, VALUE argv[], VALUE self)
{
 ...
 p = ((void*)(rb_num2ulong_inline(addrnum)));
    }
    if (argc >= 2) {
 s = rb_num2long_inline(size);
    }
    if (argc >= 3) {
 f = get_freefunc(sym, &funcwrap);
    ...
    if (p) {
 ((data) = (struct ptr_data*)rb_check_typeddata((self), (&fiddle_ptr_data_type)));
...
rb_fiddle_ptr_s_malloc(int argc, VALUE argv[], VALUE klass)
{
 ...
 rb_bug("rb_fiddle_ptr_s_malloc");
    ...
    if (wrap) ((struct ptr_data *)((((struct RData*)(obj))->data)))->wrap[1] = wrap;
...
rb_fiddle_ptr_to_i(VALUE self)
{
    ...
    ((data) = (struct ptr_data*)rb_check_typeddata((self), (&fiddle_ptr_data_type)));
    return (rb_long2num_inline((long)(data->ptr)));
}
...
rb_fiddle_ptr_null_p(VALUE self)
{
    ...
    ((data) = (struct ptr_data*)rb_check_typeddata((self), (&fiddle_ptr_data_type)));
    return data->ptr ? ((VALUE)RUBY_Qfalse) : ((VALUE)RUBY_Qtrue);
}
...
rb_fiddle_ptr_free_get(VALUE self)
{
    ...
    ((pdata) = (struct ptr_data*)rb_check_typeddata((self), (&fiddle_ptr_data_type)));

    if (!pdata->free)
 return ((VALUE)RUBY_Qnil);

    address = (rb_long2num_inline((long)(pdata->free)));
    ret_type = (((VALUE)((int)(0)))<<1 | RUBY_FIXNUM_FLAG);
    arg_types = rb_ary_new();
    rb_ary_push(arg_types, (((VALUE)((int)(1)))<<1 | RUBY_FIXNUM_FLAG));
...
rb_fiddle_ptr_to_s(int argc, VALUE argv[], VALUE self)
{
    ...
    switch (rb_scan_args(argc, argv, "01", &arg1)) {
      case 0:
 val =  ({ (__builtin_constant_p((char*)(data->ptr))) ? rb_tainted_str_new(((char*)(data->ptr)), (long)strlen((char*)(data->ptr))) : rb_tainted_str_new_cstr((char*)(data->ptr)); });
 break;
      case 1:
 len = rb_num2int_inline(arg1);
...
rb_fiddle_ptr_inspect(VALUE self)
{
    ...
    ((data) = (struct ptr_data*)rb_check_typeddata((self), (&fiddle_ptr_data_type)));
    return rb_sprintf("#<%li\v:%p ptr=%p size=%ld free=%p>",
...
rb_fiddle_ptr_eql(VALUE self, VALUE other)
{
    ...
    if(!rb_obj_is_kind_of(other, rb_cPointer)) return ((VALUE)RUBY_Qfalse);

    ptr1 = rb_fiddle_ptr2cptr(self);
    ptr2 = rb_fiddle_ptr2cptr(other);

    return ptr1 == ptr2 ? ((VALUE)RUBY_Qtrue) : ((VALUE)RUBY_Qfalse);
}
static VALUE
rb_fiddle_ptr_cmp(VALUE self, VALUE other)
{
    ...
    if(!rb_obj_is_kind_of(other, rb_cPointer)) return ((VALUE)RUBY_Qnil);

    ptr1 = rb_fiddle_ptr2cptr(self);
    ptr2 = rb_fiddle_ptr2cptr(other);
    diff = (long)ptr1 - (long)ptr2;
    if (!diff) return (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG);
    return diff > 0 ? (((VALUE)((int)(1)))<<1 | RUBY_FIXNUM_FLAG) : (((VALUE)((int)(-1)))<<1 | RUBY_FIXNUM_FLAG);
}
...
rb_fiddle_ptr_plus(VALUE self, VALUE other)
{
    ...
    size = ((struct ptr_data *)((((struct RData*)(self))->data)))->size;
    num = rb_num2long_inline(other);
...
rb_fiddle_ptr_aref(int argc, VALUE argv[], VALUE self)
{
    ...
    switch( rb_scan_args(argc, argv, "11", &arg0, &arg1) ){
      case 1:
 offset = rb_num2ulong_inline(arg0);
 retval = (((VALUE)((int)(*((char *)data->ptr + offset))))<<1 | RUBY_FIXNUM_FLAG);
 break;
      case 2:
 offset = rb_num2ulong_inline(arg0);
 len = rb_num2ulong_inline(arg1);
...
rb_fiddle_ptr_aset(int argc, VALUE argv[], VALUE self)
{
    ...
    switch( rb_scan_args(argc, argv, "21", &arg0, &arg1, &arg2) ){
      case 2:
 offset = rb_num2ulong_inline(arg0);
 ((char*)data->ptr)[offset] = ((unsigned int)rb_num2uint(arg1));
 retval = arg1;
 break;
      case 3:
 offset = rb_num2ulong_inline(arg0);
 len = rb_num2ulong_inline(arg1);
 if (( ((RUBY_T_STRING) == RUBY_T_FIXNUM) ? (((int)(long)(arg2))&RUBY_FIXNUM_FLAG) : ((RUBY_T_STRING) == RUBY_T_TRUE) ? ((arg2) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_STRING) == RUBY_T_FALSE) ? ((arg2) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_STRING) == RUBY_T_NIL) ? ((arg2) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_STRING) == RUBY_T_UNDEF) ? ((arg2) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_STRING) == RUBY_T_SYMBOL) ? ((((VALUE)(arg2)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(arg2) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(arg2) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(arg2))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_STRING) == RUBY_T_FLOAT) ? ( ((((int)(long)(arg2))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(arg2) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(arg2) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(arg2))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(arg2) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(arg2) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(arg2))->flags & RUBY_T_MASK) == (RUBY_T_STRING)))) {
     mem = rb_string_value_ptr(&(arg2));
 }
 else if( rb_obj_is_kind_of(arg2, rb_cPointer) ){
     mem = rb_fiddle_ptr2cptr(arg2);
 }
 else{
     mem = ((void*)(rb_num2ulong_inline(arg2)));
 }
...
{
    ((struct ptr_data *)((((struct RData*)(self))->data)))->size = rb_num2long_inline(size);
    return size;
}
...
{
    return rb_long2num_inline(((struct ptr_data *)((((struct RData*)(self))->data)))->size);
}
static VALUE
rb_fiddle_ptr_s_to_ptr(VALUE self, VALUE val)
{
    ...
    if (!(((VALUE)(rb_obj_is_kind_of(val, rb_cIO)) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)){
 rb_io_t *fptr;
 FILE *fp;
 rb_io_check_closed((fptr) = ((struct RFile*)(rb_io_taint_check(val)))->fptr);
 fp = rb_io_stdio_file(fptr);
 ptr = rb_fiddle_ptr_new(fp, 0, ((void*)0));
    }
    else if (!(((VALUE)(rb_obj_is_kind_of(val, rb_cString)) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)){
 char *str = rb_string_value_ptr(&(val));
 ptr = rb_fiddle_ptr_new(str, (!(((struct RBasic*)(val))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(val))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(val))->as.heap.len), ((void*)0));
    }
    else if ((vptr = rb_check_funcall(val, id_to_ptr, 0, 0)) != ((VALUE)RUBY_Qundef)){
 ...
 if (num == val) wrap = 0;
 ptr = rb_fiddle_ptr_new(((void*)(rb_num2ulong_inline(num))), 0, ((void*)0));
    }
    ( (((!(((VALUE)(ptr) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(ptr) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(ptr))->flags & RUBY_T_MASK) != RUBY_T_NODE) && (int)(((struct RBasic*)(ptr))->flags & RUBY_T_MASK) != RUBY_T_BIGNUM && (int)(((struct RBasic*)(ptr))->flags & RUBY_T_MASK) != RUBY_T_FLOAT) && (!(((VALUE)(val) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(val) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(val))->flags & RUBY_T_MASK) != RUBY_T_NODE)) ? (void)(((struct RBasic*)(ptr))->flags |= ((((struct RBasic*)(val))->flags&(RUBY_FL_TAINT)))) : (void)0);
    if (wrap) ((struct ptr_data *)((((struct RData*)(ptr))->data)))->wrap[0] = wrap;
    return ptr;
}
...
{
    id_to_ptr = (__builtin_constant_p("to_ptr") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("to_ptr")), (long)strlen(("to_ptr"))); (ID) rb_intern_id_cache; }) : rb_intern("to_ptr"));
