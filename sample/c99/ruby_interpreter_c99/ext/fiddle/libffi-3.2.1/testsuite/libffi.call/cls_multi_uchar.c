...
static void test_func_gn(ffi_cif *cif , void *rval, void **avals,
    void *data )
{
...
void test_func(ffi_cif *cif , void *rval , void **avals,
        void *data )
{
...
int main (void)
{
  ...
  cl_arg_types[0] = &ffi_type_uint8;
  cl_arg_types[1] = &ffi_type_uint8;
  cl_arg_types[2] = &ffi_type_uint8;
  cl_arg_types[3] = &ffi_type_uint8;
  cl_arg_types[4] = ((void*)0);


  (void)(!(ffi_prep_cif(&cif, FFI_DEFAULT_ABI, 4, &ffi_type_uint8, cl_arg_types) == FFI_OK) ? (abort(), 1) : 0);


  ffi_call(&cif, ((void (*)(void))test_func_fn), &res_call, args_dbl);

  printf("res: %d\n", (unsigned char)res_call);


  (void)(!(ffi_prep_closure_loc(pcl, &cif, test_func_gn, ((void*)0), code) == FFI_OK) ? (abort(), 1) : 0);
