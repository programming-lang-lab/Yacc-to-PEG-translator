...
int main (void)
{
  ...
  ts6_type_elements[2] = ((void*)0);

  args[0] = &ts6_type;
  values[0] = &ts6_arg;


  (void)(!(ffi_prep_cif(&cif, FFI_DEFAULT_ABI, 1, &ts6_type, args) == FFI_OK) ? (abort(), 1) : 0);
  ...
  ffi_call(&cif, ((void (*)(void))struct6), ts6_result, values);

  (void)(!(ts6_result->f == 5.55f + 1) ? (abort(), 1) : 0);
  (void)(!(ts6_result->d == 6.66 + 1) ? (abort(), 1) : 0);
