...
static size_t my_f(float a, char *s, int i)
{
...
int main (void)
{
  ...
  (void)(!(ffi_prep_cif(&cif, FFI_DEFAULT_ABI, 3, &ffi_type_sint32, args) == FFI_OK) ? (abort(), 1) : 0);


  s = "a";
  v1 = 1;
  v2 = 0.0;
  ffi_call(&cif, ((void (*)(void))my_f), &rint, values);
  (void)(!(rint == 2) ? (abort(), 1) : 0);

  s = "1234567";
  v2 = -1.0;
  v1 = -2;
  ffi_call(&cif, ((void (*)(void))my_f), &rint, values);
  (void)(!(rint == 4) ? (abort(), 1) : 0);

  s = "1234567890123456789012345";
  v2 = 1.0;
  v1 = 2;
  ffi_call(&cif, ((void (*)(void))my_f), &rint, values);
  (void)(!(rint == 28) ? (abort(), 1) : 0);
