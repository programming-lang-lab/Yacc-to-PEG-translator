...
int main (void)
{
  ...
  ts8_type_elements[4] = ((void*)0);

  args[0] = &ts8_type;
  values[0] = &ts8_arg;


  (void)(!(ffi_prep_cif(&cif, FFI_DEFAULT_ABI, 1, &ts8_type, args) == FFI_OK) ? (abort(), 1) : 0);
  ...
  ffi_call(&cif, ((void (*)(void))struct8), ts8_result, values);
  ...
  (void)(!(ts8_result->f1 == 5.55f + 1) ? (abort(), 1) : 0);
  (void)(!(ts8_result->f2 == 55.5f + 1) ? (abort(), 1) : 0);
  (void)(!(ts8_result->f3 == -5.55f + 1) ? (abort(), 1) : 0);
  (void)(!(ts8_result->f4 == -55.5f + 1) ? (abort(), 1) : 0);
