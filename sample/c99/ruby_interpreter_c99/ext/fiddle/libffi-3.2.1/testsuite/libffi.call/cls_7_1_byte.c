...
static void
cls_struct_7byte_gn(ffi_cif* cif , void* resp, void** args,
      void* userdata )
{
...
int main (void)
{
  ...
  cls_struct_fields[2] = &ffi_type_uint8;
  cls_struct_fields[3] = &ffi_type_uint8;
  cls_struct_fields[4] = &ffi_type_uint8;
  cls_struct_fields[5] = &ffi_type_uint8;
  cls_struct_fields[6] = &ffi_type_uint8;
  cls_struct_fields[7] = ((void*)0);

  dbl_arg_types[0] = &cls_struct_type;
  dbl_arg_types[1] = &cls_struct_type;
  dbl_arg_types[2] = ((void*)0);

  (void)(!(ffi_prep_cif(&cif, FFI_DEFAULT_ABI, 2, &cls_struct_type, dbl_arg_types) == FFI_OK) ? (abort(), 1) : 0);
  ...
  ffi_call(&cif, ((void (*)(void))cls_struct_7byte_fn), &res_dbl, args_dbl);
  ...
  (void)(!(ffi_prep_closure_loc(pcl, &cif, cls_struct_7byte_gn, ((void*)0), code) == FFI_OK) ? (abort(), 1) : 0);
