...
static void
cls_struct_combined_gn(ffi_cif* cif , void* resp, void** args,
         void* userdata )
{
...
int main (void)
{
  ...
  cls_struct_type.type = 13;
  cls_struct_type.elements = cls_struct_fields;

  cls_struct_type1.size = 0;
  cls_struct_type1.alignment = 0;
  cls_struct_type1.type = 13;
  cls_struct_type1.elements = cls_struct_fields1;

  cls_struct_type2.size = 0;
  cls_struct_type2.alignment = 0;
  cls_struct_type2.type = 13;
  cls_struct_type2.elements = cls_struct_fields2;

  cls_struct_fields[0] = &ffi_type_double;
  cls_struct_fields[1] = &ffi_type_float;
  cls_struct_fields[2] = &ffi_type_sint32;
  cls_struct_fields[3] = ((void*)0);

  cls_struct_fields1[0] = &ffi_type_sint32;
  cls_struct_fields1[1] = &ffi_type_double;
  cls_struct_fields1[2] = &ffi_type_float;
  cls_struct_fields1[3] = ((void*)0);

  cls_struct_fields2[0] = &cls_struct_type;
  cls_struct_fields2[1] = &cls_struct_type1;
  cls_struct_fields2[2] = ((void*)0);


  dbl_arg_types[0] = &cls_struct_type;
  dbl_arg_types[1] = &cls_struct_type1;
  dbl_arg_types[2] = &cls_struct_type2;
  dbl_arg_types[3] = ((void*)0);

  (void)(!(ffi_prep_cif(&cif, FFI_DEFAULT_ABI, 3, &cls_struct_type2, dbl_arg_types) == FFI_OK) ? (abort(), 1) : 0);
  ...
  ffi_call(&cif, ((void (*)(void))cls_struct_combined_fn), &res_dbl, args_dbl);

  (void)(!(res_dbl.d.a == (e_dbl.a + f_dbl.dd + g_dbl.d.a)) ? (abort(), 1) : 0);
  (void)(!(res_dbl.d.b == (e_dbl.b + f_dbl.ff + g_dbl.d.b)) ? (abort(), 1) : 0);
  (void)(!(res_dbl.d.c == (e_dbl.c + f_dbl.ii + g_dbl.d.c)) ? (abort(), 1) : 0);
  (void)(!(res_dbl.e.ii == (e_dbl.c + f_dbl.ii + g_dbl.e.ii)) ? (abort(), 1) : 0);
  (void)(!(res_dbl.e.dd == (e_dbl.a + f_dbl.dd + g_dbl.e.dd)) ? (abort(), 1) : 0);
  (void)(!(res_dbl.e.ff == (e_dbl.b + f_dbl.ff + g_dbl.e.ff)) ? (abort(), 1) : 0);

  (void)(!(ffi_prep_closure_loc(pcl, &cif, cls_struct_combined_gn, ((void*)0), code) == FFI_OK) ? (abort(), 1) : 0);
