...
static void
cls_struct_combined_gn(ffi_cif* cif , void* resp ,
...
int main (void)
{
  ...
  cls_struct_fields0[4] = ((void*)0);

  dbl_arg_types[0] = &cls_struct_type0;
  dbl_arg_types[1] = ((void*)0);

  (void)(!(ffi_prep_cif(&cif, FFI_DEFAULT_ABI, 1, &ffi_type_void, dbl_arg_types) == FFI_OK) ? (abort(), 1) : 0);
