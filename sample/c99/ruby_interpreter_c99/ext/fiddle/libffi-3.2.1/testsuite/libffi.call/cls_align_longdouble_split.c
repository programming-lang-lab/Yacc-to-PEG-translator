 ...
 cls_struct_align a2)
{
 ...
 printf("%Lg %Lg %Lg %Lg %Lg %Lg %Lg %Lg %Lg %Lg %Lg %Lg %Lg %Lg: %Lg %Lg %Lg %Lg %Lg %Lg %Lg\n",
...
static void
cls_struct_align_gn(ffi_cif* cif , void* resp, void** args,
      void* userdata )
{
...
int main (void)
{
 ...
 ffi_call(&cif, ((void (*)(void))cls_struct_align_fn), &res_dbl, args_dbl);

 printf("res: %Lg %Lg %Lg %Lg %Lg %Lg %Lg\n", res_dbl.a, res_dbl.b,
  res_dbl.c, res_dbl.d, res_dbl.e, res_dbl.f, res_dbl.g);


 (void)(!(ffi_prep_closure_loc(pcl, &cif, cls_struct_align_gn, ((void*)0), code) == FFI_OK) ? (abort(), 1) : 0);
