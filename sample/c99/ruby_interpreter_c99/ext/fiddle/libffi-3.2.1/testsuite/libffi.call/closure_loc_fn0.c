...
static void
closure_loc_test_fn0(ffi_cif* cif , void* resp, void** args,
   void* userdata)
{
  *(ffi_arg*)resp =
...
int main (void)
{
  ...
  cl_arg_types[1] = &ffi_type_sint32;
  cl_arg_types[2] = &ffi_type_uint64;
  cl_arg_types[3] = &ffi_type_sint32;
  cl_arg_types[4] = &ffi_type_sint16;
  cl_arg_types[5] = &ffi_type_uint64;
  cl_arg_types[6] = &ffi_type_sint32;
  cl_arg_types[7] = &ffi_type_sint32;
  cl_arg_types[8] = &ffi_type_double;
  cl_arg_types[9] = &ffi_type_sint32;
  cl_arg_types[10] = &ffi_type_sint32;
  cl_arg_types[11] = &ffi_type_float;
  cl_arg_types[12] = &ffi_type_sint32;
  cl_arg_types[13] = &ffi_type_sint32;
  cl_arg_types[14] = &ffi_type_sint32;
  cl_arg_types[15] = &ffi_type_sint32;
  cl_arg_types[16] = ((void*)0);


  (void)(!(ffi_prep_cif(&cif, FFI_DEFAULT_ABI, 16, &ffi_type_sint32, cl_arg_types) == FFI_OK) ? (abort(), 1) : 0);


  pcl = ffi_closure_alloc(sizeof(ffi_closure), &codeloc);
  (void)(!(pcl != ((void*)0)) ? (abort(), 1) : 0);
  (void)(!(codeloc != ((void*)0)) ? (abort(), 1) : 0);

  (void)(!(ffi_prep_closure_loc(pcl, &cif, closure_loc_test_fn0, (void *) 3 , codeloc) == FFI_OK) ? (abort(), 1) : 0);


  (void)(!(memcmp(pcl, codeloc, sizeof(*pcl)) == 0) ? (abort(), 1) : 0);
