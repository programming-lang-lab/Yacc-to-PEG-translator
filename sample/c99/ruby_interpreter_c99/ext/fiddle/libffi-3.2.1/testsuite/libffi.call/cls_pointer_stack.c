...
static void
cls_pointer_gn(ffi_cif* cif , void* resp,
...
int main (void)
{
 ...
 (void)(!(ffi_prep_cif(&cif, FFI_DEFAULT_ABI, 2, &ffi_type_pointer, arg_types) == FFI_OK) ? (abort(), 1) : 0);
 ...
 printf("\n");
 ffi_call(&cif, ((void (*)(void))cls_pointer_fn1), &res, args);
 ...
 (void)(!(ffi_prep_closure_loc(pcl, &cif, cls_pointer_gn, ((void*)0), code) == FFI_OK) ? (abort(), 1) : 0);
