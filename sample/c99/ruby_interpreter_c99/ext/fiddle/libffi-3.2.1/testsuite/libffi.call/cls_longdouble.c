...
static void
cls_ldouble_gn(ffi_cif* cif , void* resp,
...
int main(void)
{
 ...
 (void)(!(ffi_prep_cif(&cif, FFI_DEFAULT_ABI, 8, &ffi_type_longdouble, arg_types) == FFI_OK) ? (abort(), 1) : 0);
 ...
 ffi_call(&cif, ((void (*)(void))cls_ldouble_fn), &res, args);

 printf("res: %Lg\n", res);


 (void)(!(ffi_prep_closure_loc(pcl, &cif, cls_ldouble_gn, ((void*)0), code) == FFI_OK) ? (abort(), 1) : 0);
