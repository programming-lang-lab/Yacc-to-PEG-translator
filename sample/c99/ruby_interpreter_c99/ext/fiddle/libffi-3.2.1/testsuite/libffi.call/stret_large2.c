...
int main (void)
{
 ...
 ffi_call(&cif, ((void (*)(void))cls_struct_116byte_fn), &res_dbl, args_dbl);
 ...
 (void)(!(ffi_prep_closure_loc(pcl, &cif, cls_struct_116byte_gn, ((void*)0), code) == FFI_OK) ? (abort(), 1) : 0);
