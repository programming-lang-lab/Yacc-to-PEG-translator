...
int main (void)
{
  ...
  (void)(!(ffi_prep_cif(&cif, FFI_DEFAULT_ABI, 3, &ffi_type_double, args) == FFI_OK) ? (abort(), 1) : 0);
  ...
  ffi_call(&cif, ((void (*)(void))floating_1), &rd, values);

  (void)(!(rd - floating_1(f, d, ld) < 2.2204460492503131e-16) ? (abort(), 1) : 0);
  ...
  ffi_call(&cif, ((void (*)(void))floating_2), &rd, values);

  (void)(!(rd - floating_2(ld, d, f) < 2.2204460492503131e-16) ? (abort(), 1) : 0);
