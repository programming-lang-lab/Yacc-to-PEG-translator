...
static void cls_struct_16byte_gn(ffi_cif* cif , void* resp,
...
int main (void)
{
  ...
  ffi_call(&cif, ((void (*)(void))cls_struct_16byte_fn), &res_dbl, args_dbl);
  ...
  (void)(!(ffi_prep_closure_loc(pcl, &cif, cls_struct_16byte_gn, ((void*)0), code) == FFI_OK) ? (abort(), 1) : 0);
