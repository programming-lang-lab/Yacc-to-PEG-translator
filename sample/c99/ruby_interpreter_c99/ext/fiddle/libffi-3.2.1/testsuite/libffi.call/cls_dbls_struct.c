...
void
closure_test_gn(ffi_cif* cif , void* resp ,
...
int main(int argc , char** argv )
{
 ...
 ts1_type_elements[2] = ((void*)0);

 cl_arg_types[0] = &ts1_type;


 (void)(!(ffi_prep_cif(&cif, FFI_DEFAULT_ABI, 1, &ffi_type_void, cl_arg_types) == FFI_OK) ? (abort(), 1) : 0);


 (void)(!(ffi_prep_closure_loc(pcl, &cif, closure_test_gn, ((void*)0), code) == FFI_OK) ? (abort(), 1) : 0);
