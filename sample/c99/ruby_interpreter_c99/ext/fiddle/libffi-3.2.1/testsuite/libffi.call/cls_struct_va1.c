...
main (void)
{
  ...
  (void)(!(ffi_prep_cif_var(&cif, FFI_DEFAULT_ABI, 1, 4, &ffi_type_sint32, arg_types) == FFI_OK) ? (abort(), 1) : 0);
  ...
  (void)(!(ffi_prep_closure_loc(pcl, &cif, test_fn, ((void*)0), code) == FFI_OK) ? (abort(), 1) : 0);
