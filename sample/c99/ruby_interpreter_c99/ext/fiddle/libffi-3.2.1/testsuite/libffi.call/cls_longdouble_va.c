...
static void
cls_longdouble_va_fn(ffi_cif* cif , void* resp,
...
int main (void)
{
 ...
 (void)(!(ffi_prep_cif_var(&cif, FFI_DEFAULT_ABI, 1, 2, &ffi_type_sint32, arg_types) == FFI_OK) ? (abort(), 1) : 0);
 ...
 ffi_call(&cif, ((void (*)(void))printf), &res, args);

 printf("res: %d\n", (int) res);


 (void)(!(ffi_prep_closure_loc(pcl, &cif, cls_longdouble_va_fn, ((void*)0), code) == FFI_OK) ? (abort(), 1) : 0);
