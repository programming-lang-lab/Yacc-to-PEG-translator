...
int main (void)
{
  ...
  cl_arg_types[0] = &ffi_type_sint8;
  cl_arg_types[1] = &ffi_type_sint16;
  cl_arg_types[2] = &ffi_type_sint8;
  cl_arg_types[3] = &ffi_type_sint16;
  cl_arg_types[4] = ((void*)0);


  (void)(!(ffi_prep_cif(&cif, FFI_DEFAULT_ABI, 4, &ffi_type_sint16, cl_arg_types) == FFI_OK) ? (abort(), 1) : 0);
