...
static void
cls_struct_4_1byte_gn(ffi_cif* cif , void* resp, void** args,
        void* userdata )
{
...
int main (void)
{
  ...
  ffi_call(&cif, ((void (*)(void))cls_struct_4_1byte_fn), &res_dbl, args_dbl);

  printf("res: %d %d %d %d\n", res_dbl.a, res_dbl.b, res_dbl.c, res_dbl.d);


  (void)(!(ffi_prep_closure_loc(pcl, &cif, cls_struct_4_1byte_gn, ((void*)0), code) == FFI_OK) ? (abort(), 1) : 0);
