...
int main (void)
{
 ...
 ffi_call(&cif, ((void (*)(void))cls_struct_72byte_fn), &res_dbl, args_dbl);

 printf("res: %g %g %g %g %g %g %g %g %g\n", res_dbl.a, res_dbl.b, res_dbl.c,
  res_dbl.d, res_dbl.e, res_dbl.f, res_dbl.g, res_dbl.h, res_dbl.i);


 (void)(!(ffi_prep_closure_loc(pcl, &cif, cls_struct_72byte_gn, ((void*)0), code) == FFI_OK) ? (abort(), 1) : 0);
