...
static void
cls_struct_64byte_gn(ffi_cif* cif , void* resp, void** args,
       void* userdata )
{
...
int main (void)
{
  ...
  (void)(!(ffi_prep_cif(&cif, FFI_DEFAULT_ABI, 4, &cls_struct_type, dbl_arg_types) == FFI_OK) ? (abort(), 1) : 0);
  ...
  ffi_call(&cif, ((void (*)(void))cls_struct_64byte_fn), &res_dbl, args_dbl);

  printf("res: %g %g %g %g %g %g %g %g\n", res_dbl.a, res_dbl.b, res_dbl.c,
  res_dbl.d, res_dbl.e, res_dbl.f, res_dbl.g, res_dbl.h);


  (void)(!(ffi_prep_closure_loc(pcl, &cif, cls_struct_64byte_gn, ((void*)0), code) == FFI_OK) ? (abort(), 1) : 0);
