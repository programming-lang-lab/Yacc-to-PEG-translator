...
static void
cls_struct_19byte_gn(ffi_cif* cif , void* resp, void** args,
       void* userdata )
{
...
int main (void)
{
  ...
  ffi_call(&cif, ((void (*)(void))cls_struct_19byte_fn), &res_dbl, args_dbl);

  printf("res: %g %d %d %g %d\n", res_dbl.a, res_dbl.b, res_dbl.c,
  res_dbl.d, res_dbl.e);


  (void)(!(ffi_prep_closure_loc(pcl, &cif, cls_struct_19byte_gn, ((void*)0), code) == FFI_OK) ? (abort(), 1) : 0);
