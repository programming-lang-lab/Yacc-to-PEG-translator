...
int main (void)
{
  ...
  ts5_type_elements[0] = &ffi_type_sint8;
  ts5_type_elements[1] = &ffi_type_sint8;
  ts5_type_elements[2] = ((void*)0);
  ...
  (void)(!(ffi_prep_cif(&cif, FFI_DEFAULT_ABI, 2, &ts5_type, args) == FFI_OK) ? (abort(), 1) : 0);
  ...
  ffi_call (&cif, ((void (*)(void))struct5), ts5_result, values);

  (void)(!(ts5_result->c1 == 7) ? (abort(), 1) : 0);
  (void)(!(ts5_result->c2 == 3) ? (abort(), 1) : 0);
