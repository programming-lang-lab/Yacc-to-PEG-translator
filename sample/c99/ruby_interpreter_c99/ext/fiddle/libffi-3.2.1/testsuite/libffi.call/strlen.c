...
int main (void)
{
  ...
  (void)(!(ffi_prep_cif(&cif, FFI_DEFAULT_ABI, 1, &ffi_type_sint32, args) == FFI_OK) ? (abort(), 1) : 0);


  s = "a";
  ffi_call(&cif, ((void (*)(void))my_strlen), &rint, values);
  (void)(!(rint == 1) ? (abort(), 1) : 0);

  s = "1234567";
  ffi_call(&cif, ((void (*)(void))my_strlen), &rint, values);
  (void)(!(rint == 7) ? (abort(), 1) : 0);

  s = "1234567890123456789012345";
  ffi_call(&cif, ((void (*)(void))my_strlen), &rint, values);
  (void)(!(rint == 25) ? (abort(), 1) : 0);
