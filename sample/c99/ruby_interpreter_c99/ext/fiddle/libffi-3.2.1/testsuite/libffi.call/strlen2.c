...
static size_t my_f(char *s, float a)
{
...
int main (void)
{
  ...
  (void)(!(ffi_prep_cif(&cif, FFI_DEFAULT_ABI, 2, &ffi_type_sint32, args) == FFI_OK) ? (abort(), 1) : 0);


  s = "a";
  v2 = 0.0;
  ffi_call(&cif, ((void (*)(void))my_f), &rint, values);
  (void)(!(rint == 1) ? (abort(), 1) : 0);

  s = "1234567";
  v2 = -1.0;
  ffi_call(&cif, ((void (*)(void))my_f), &rint, values);
  (void)(!(rint == 6) ? (abort(), 1) : 0);

  s = "1234567890123456789012345";
  v2 = 1.0;
  ffi_call(&cif, ((void (*)(void))my_f), &rint, values);
  (void)(!(rint == 26) ? (abort(), 1) : 0);
