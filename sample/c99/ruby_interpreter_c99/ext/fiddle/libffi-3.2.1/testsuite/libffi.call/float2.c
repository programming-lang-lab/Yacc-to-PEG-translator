...
int main (void)
{
  ...
  (void)(!(ffi_prep_cif(&cif, FFI_DEFAULT_ABI, 1, &ffi_type_longdouble, args) == FFI_OK) ? (abort(), 1) : 0);
  ...
  ld = 666;
  ffi_call(&cif, ((void (*)(void))ldblit), &ld, values);





  printf ("%Lf, %Lf, %Lf, %Lf\n", ld, ldblit(f), ld - ldblit(f), 1.08420217248550443401e-19L);



  if (ld - ldblit(f) < 1.08420217248550443401e-19L)
