...
int main (void)
{
  ...
  (void)(!(ffi_prep_cif(&cif, FFI_DEFAULT_ABI, 2, &cls_struct_type1, dbl_arg_types) == FFI_OK) ? (abort(), 1) : 0);
  ...
  (void)(!(res_dbl.x.a == (e_dbl.a + f_dbl.x.a)) ? (abort(), 1) : 0);
  (void)(!(res_dbl.x.b == (e_dbl.b + f_dbl.x.b + f_dbl.y)) ? (abort(), 1) : 0);
  (void)(!(res_dbl.y == (e_dbl.b + f_dbl.x.b)) ? (abort(), 1) : 0);
