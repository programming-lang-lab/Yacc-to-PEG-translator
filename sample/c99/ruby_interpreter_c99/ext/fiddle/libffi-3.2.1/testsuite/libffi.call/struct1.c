...
int main (void)
{
  ...
  ts1_type_elements[0] = &ffi_type_uint8;
  ts1_type_elements[1] = &ffi_type_double;
  ts1_type_elements[2] = &ffi_type_uint32;
  ts1_type_elements[3] = ((void*)0);

  args[0] = &ts1_type;
  values[0] = &ts1_arg;


  (void)(!(ffi_prep_cif(&cif, FFI_DEFAULT_ABI, 1, &ts1_type, args) == FFI_OK) ? (abort(), 1) : 0);
  ...
  ffi_call(&cif, ((void (*)(void))struct1), ts1_result, values);

  (void)(!(ts1_result->ui == 556) ? (abort(), 1) : 0);
  (void)(!(ts1_result->d == 3.14159 - 1) ? (abort(), 1) : 0);
