...
int main(void)
{
 ...
 rect_type.elements[2] = ((void*)0);




 arglist[0] = &ffi_type_sint32;
 arglist[1] = &ffi_type_pointer;
 arglist[2] = &point_type;
 arglist[3] = &rect_type;
 arglist[4] = &ffi_type_sint32;
 arglist[5] = ((void*)0);

 r = ffi_prep_cif(&cif, FFI_DEFAULT_ABI,
   5, &ffi_type_sint32, arglist);
 if (r != FFI_OK) {
  abort();
 }
 ...
 ffi_call(&cif, ((void (*)(void))doit), &result, values);
