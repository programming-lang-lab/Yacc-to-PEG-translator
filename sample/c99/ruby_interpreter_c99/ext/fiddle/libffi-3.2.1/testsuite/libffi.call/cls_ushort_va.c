...
static void cls_ret_T_fn(ffi_cif* cif , void* resp, void** args,
    void* userdata )
 {
...
int main (void)
{
  ...
  (void)(!(ffi_prep_cif_var(&cif, FFI_DEFAULT_ABI, 1, 2, &ffi_type_uint16, cl_arg_types) == FFI_OK) ? (abort(), 1) : 0);


  (void)(!(ffi_prep_closure_loc(pcl, &cif, cls_ret_T_fn, ((void*)0), code) == FFI_OK) ? (abort(), 1) : 0);
