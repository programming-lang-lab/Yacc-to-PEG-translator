...
ffi_prep_args (void *stack, extended_cif *ecif)
{
 ...
 {
   stackp = (char *) (((((size_t) (stackp))-1) | ((a)-1))+1);
   argp = stackp;
 }
        ...
        void *user_data, void *codeloc)
{
  ...
  if (cif->rtype->type == 13 && !cif->flags)
  ...
  ffi_cacheflush_OBSD((unsigned int)codeloc, 24);
