...
int_to_ffi_type(int type)
{
 ...
 return &ffi_type_pointer;
      case 2:
 return (signed_p ? &ffi_type_sint8 : &ffi_type_uint8);
      case 3:
 return (signed_p ? &ffi_type_sint16 : &ffi_type_uint16);
      case 4:
 return (signed_p ? &ffi_type_sint32 : &ffi_type_uint32);
      case 5:
 return (signed_p ? &ffi_type_sint64 : &ffi_type_uint64);
...
value_to_generic(int type, VALUE src, fiddle_generic * dst)
{
 ...
 break;
      case 1:
 dst->pointer = ((void*)(rb_num2ulong_inline(rb_Integer(src))));
 break;
      case 2:
 dst->schar = (signed char)rb_num2int_inline(src);
 break;
      case -2:
 dst->uchar = (unsigned char)((unsigned int)rb_num2uint(src));
 break;
      case 3:
 dst->sshort = (unsigned short)rb_num2int_inline(src);
 break;
      case -3:
 dst->sshort = (signed short)((unsigned int)rb_num2uint(src));
 break;
      case 4:
 dst->sint = rb_num2int_inline(src);
 break;
      case -4:
 dst->uint = ((unsigned int)rb_num2uint(src));
 break;
      case 5:
 dst->slong = rb_num2long_inline(src);
 break;
      case -5:
 dst->ulong = rb_num2ulong_inline(src);
 break;

      case 6:
 dst->slong_long = rb_num2ll_inline(src);
 break;
      case -6:
 dst->ulong_long = rb_num2ull(src);
 break;

      case 7:
 dst->ffloat = (float)rb_num2dbl((VALUE)(src));
 break;
      case 8:
 dst->ddouble = rb_num2dbl((VALUE)(src));
 break;
      default:
 rb_raise(rb_eRuntimeError, "unknown type %d", type);
    }
...
{
    int type = rb_num2int_inline(rettype);
    VALUE cPointer;
 ...
 return ((VALUE)RUBY_Qnil);
      case 1:
        return rb_funcall(cPointer, (__builtin_constant_p("[]") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("[]")), (long)strlen(("[]"))); (ID) rb_intern_id_cache; }) : rb_intern("[]")), 1,
          (rb_long2num_inline((long)((void *)retval.pointer))));
      case 2:
 return (((VALUE)((int)((signed char)retval.fffi_sarg)))<<1 | RUBY_FIXNUM_FLAG);
      case -2:
 return (((VALUE)((int)((unsigned char)retval.fffi_arg)))<<1 | RUBY_FIXNUM_FLAG);
      case 3:
 return (((VALUE)((int)((signed short)retval.fffi_sarg)))<<1 | RUBY_FIXNUM_FLAG);
      case -3:
 return (((VALUE)((int)((unsigned short)retval.fffi_arg)))<<1 | RUBY_FIXNUM_FLAG);
      case 4:
 return (((VALUE)((int)((signed int)retval.fffi_sarg)))<<1 | RUBY_FIXNUM_FLAG);
      case -4:
 return (((VALUE)((unsigned int)((unsigned int)retval.fffi_arg)))<<1 | RUBY_FIXNUM_FLAG);
      case 5:
 return rb_long2num_inline(retval.slong);
      case -5:
 return rb_ulong2num_inline(retval.ulong);

      case 6:
 return rb_ll2inum(retval.slong_long);
      case -6:
 return rb_ull2inum(retval.ulong_long);
