...
begin(VALUE object)
{
    return rb_funcall(object, (__builtin_constant_p("try_method") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("try_method")), (long)strlen(("try_method"))); (ID) rb_intern_id_cache; }) : rb_intern("try_method")), 0);
}

static VALUE
ensure(VALUE object)
{
    return rb_funcall(object, (__builtin_constant_p("ensured_method") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("ensured_method")), (long)strlen(("ensured_method"))); (ID) rb_intern_id_cache; }) : rb_intern("ensured_method")), 0);
}
