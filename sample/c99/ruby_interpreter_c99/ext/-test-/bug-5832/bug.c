...
{
    return rb_funcall(obj, (__builtin_constant_p("callback") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("callback")), (long)strlen(("callback"))); (ID) rb_intern_id_cache; }) : rb_intern("callback")), 0);
}
