...
double
missing_nextafter(double x, double y)
{
    double x1, x2, d;
    int e;
    ...
    if (x == 0) {
        ...
        x1 = ldexp(0.5, (-1021) - 53 + 1);
        if (x1 == 0)
            x1 = 2.2250738585072014e-308;
        if (0 < y)
            return x1;
        else
            return -x1;
    ...
    if (x < 0) {
        if ((sizeof ((x)) == sizeof (float) ? __isinff (x) : sizeof ((x)) == sizeof (double) ? __isinf (x) : __isinfl (x)))
            return -1.7976931348623157e+308;
        if (x == -1.7976931348623157e+308 && y < 0 && (sizeof ((y)) == sizeof (float) ? __isinff (y) : sizeof ((y)) == sizeof (double) ? __isinf (y) : __isinfl (y)))
            return y;
    }
    else {
        if ((sizeof ((x)) == sizeof (float) ? __isinff (x) : sizeof ((x)) == sizeof (double) ? __isinf (x) : __isinfl (x)))
            return 1.7976931348623157e+308;
        if (x == 1.7976931348623157e+308 && 0 < y && (sizeof ((y)) == sizeof (float) ? __isinff (y) : sizeof ((y)) == sizeof (double) ? __isinf (y) : __isinfl (y)))
            return y;
    }
