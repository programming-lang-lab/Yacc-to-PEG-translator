...
{
    return rb_funcallv(self, (__builtin_constant_p("target") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("target")), (long)strlen(("target"))); (ID) rb_intern_id_cache; }) : rb_intern("target")), argc, argv);
}

static VALUE
with_funcall_passing_block(int argc, VALUE *argv, VALUE self)
{
    return rb_funcall_passing_block(self, (__builtin_constant_p("target") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("target")), (long)strlen(("target"))); (ID) rb_intern_id_cache; }) : rb_intern("target")), argc, argv);
}
...
extra_args_name(VALUE self)
{
    ...
    return rb_funcall(self, (__builtin_constant_p("name") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("name")), (long)strlen(("name"))); (ID) rb_intern_id_cache; }) : rb_intern("name")), 0, 0);
}
