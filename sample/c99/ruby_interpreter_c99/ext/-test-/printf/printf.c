...
{
    return rb_enc_sprintf(rb_usascii_encoding(), "<%li\v>", obj);
}
...
printf_test_call(int argc, VALUE *argv, VALUE self)
{
    ...
    rb_check_type((VALUE)(type),(RUBY_T_STRING));
    if ((!(((struct RBasic*)(type))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(type))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(type))->as.heap.len) != 1) rb_raise(rb_eArgError, "wrong length(%ld)", (!(((struct RBasic*)(type))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(type))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(type))->as.heap.len));
    switch (cnv = (!(((struct RBasic*)(type))->flags & RSTRING_NOEMBED) ? ((struct RString*)(type))->as.ary : ((struct RString*)(type))->as.heap.ptr)[0]) {
      case 'd': case 'x': case 'o': case 'X':
 n = rb_num2int_inline(num);
 break;
      case 's':
 s = rb_string_value_cstr(&(num));
 break;
 ...
 VALUE v;
 rb_check_type((VALUE)(opt),(RUBY_T_HASH));
 if (!(((VALUE)(rb_hash_aref(opt, (rb_id2sym((__builtin_constant_p("space") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("space")), (long)strlen(("space"))); (ID) rb_intern_id_cache; }) : rb_intern("space")))))) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) {
     *p++ = ' ';
 }
 if (!(((VALUE)(rb_hash_aref(opt, (rb_id2sym((__builtin_constant_p("hash") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("hash")), (long)strlen(("hash"))); (ID) rb_intern_id_cache; }) : rb_intern("hash")))))) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) {
     *p++ = '#';
 }
 if (!(((VALUE)(rb_hash_aref(opt, (rb_id2sym((__builtin_constant_p("plus") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("plus")), (long)strlen(("plus"))); (ID) rb_intern_id_cache; }) : rb_intern("plus")))))) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) {
     *p++ = '+';
 }
 if (!(((VALUE)(rb_hash_aref(opt, (rb_id2sym((__builtin_constant_p("minus") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("minus")), (long)strlen(("minus"))); (ID) rb_intern_id_cache; }) : rb_intern("minus")))))) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) {
     *p++ = '-';
 }
 if (!(((VALUE)(rb_hash_aref(opt, (rb_id2sym((__builtin_constant_p("zero") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("zero")), (long)strlen(("zero"))); (ID) rb_intern_id_cache; }) : rb_intern("zero")))))) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) {
     *p++ = '0';
 }
 if (!!((VALUE)(v = rb_hash_aref(opt, (rb_id2sym((__builtin_constant_p("width") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("width")), (long)strlen(("width"))); (ID) rb_intern_id_cache; }) : rb_intern("width")))))) != ((VALUE)RUBY_Qnil))) {
     p = uint_to_str(p, format + sizeof(format), ((unsigned int)rb_num2uint(v)));
 }
 if (!!((VALUE)(v = rb_hash_aref(opt, (rb_id2sym((__builtin_constant_p("prec") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("prec")), (long)strlen(("prec"))); (ID) rb_intern_id_cache; }) : rb_intern("prec")))))) != ((VALUE)RUBY_Qnil))) {
     *p++ = '.';
 ...
 result = rb_enc_sprintf(rb_usascii_encoding(), format, n);
    ...
    return rb_assoc_new(result,  ({ (__builtin_constant_p(format)) ? rb_usascii_str_new_static((format), (long)strlen(format)) : rb_usascii_str_new_cstr(format); }));
}

static VALUE
snprintf_count(VALUE self, VALUE str)
{
    int n = ruby_snprintf(((void*)0), 0, "%s", rb_string_value_cstr(&(str)));
