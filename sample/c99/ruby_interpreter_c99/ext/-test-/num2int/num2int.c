...
{
    char buf[128];
    sprintf(buf, "%d", rb_num2short_inline(num));
    return  ({ (__builtin_constant_p(buf)) ? rb_str_new_static((buf), (long)strlen(buf)) : rb_str_new_cstr(buf); });
}
...
{
    char buf[128];
    sprintf(buf, "%u", rb_num2ushort(num));
    return  ({ (__builtin_constant_p(buf)) ? rb_str_new_static((buf), (long)strlen(buf)) : rb_str_new_cstr(buf); });
}
...
{
    char buf[128];
    sprintf(buf, "%d", rb_num2int_inline(num));
    return  ({ (__builtin_constant_p(buf)) ? rb_str_new_static((buf), (long)strlen(buf)) : rb_str_new_cstr(buf); });
}
...
{
    char buf[128];
    sprintf(buf, "%u", ((unsigned int)rb_num2uint(num)));
    return  ({ (__builtin_constant_p(buf)) ? rb_str_new_static((buf), (long)strlen(buf)) : rb_str_new_cstr(buf); });
}
...
{
    char buf[128];
    sprintf(buf, "%ld", rb_num2long_inline(num));
    return  ({ (__builtin_constant_p(buf)) ? rb_str_new_static((buf), (long)strlen(buf)) : rb_str_new_cstr(buf); });
}
...
{
    char buf[128];
    sprintf(buf, "%lu", rb_num2ulong_inline(num));
    return  ({ (__builtin_constant_p(buf)) ? rb_str_new_static((buf), (long)strlen(buf)) : rb_str_new_cstr(buf); });
}
...
{
    char buf[128];
    sprintf(buf, "%lld", rb_num2ll_inline(num));
    return  ({ (__builtin_constant_p(buf)) ? rb_str_new_static((buf), (long)strlen(buf)) : rb_str_new_cstr(buf); });
}
...
{
    char buf[128];
    sprintf(buf, "%llu", rb_num2ull(num));
    return  ({ (__builtin_constant_p(buf)) ? rb_str_new_static((buf), (long)strlen(buf)) : rb_str_new_cstr(buf); });
}
...
{
    char buf[128];
    sprintf(buf, "%d", (rb_fix2short((VALUE)(num))));
    return  ({ (__builtin_constant_p(buf)) ? rb_str_new_static((buf), (long)strlen(buf)) : rb_str_new_cstr(buf); });
}
...
{
    char buf[128];
    sprintf(buf, "%d", ((int)rb_fix2int((VALUE)(num))));
    return  ({ (__builtin_constant_p(buf)) ? rb_str_new_static((buf), (long)strlen(buf)) : rb_str_new_cstr(buf); });
}
...
{
    char buf[128];
    sprintf(buf, "%u", ((unsigned int)rb_fix2uint(num)));
    return  ({ (__builtin_constant_p(buf)) ? rb_str_new_static((buf), (long)strlen(buf)) : rb_str_new_cstr(buf); });
}
...
{
    char buf[128];
    sprintf(buf, "%ld", ((long)(((long)(num))>>(int)(1))));
    return  ({ (__builtin_constant_p(buf)) ? rb_str_new_static((buf), (long)strlen(buf)) : rb_str_new_cstr(buf); });
}
...
{
    char buf[128];
    sprintf(buf, "%lu", ((unsigned long)((long)(((long)(num))>>(int)(1)))));
    return  ({ (__builtin_constant_p(buf)) ? rb_str_new_static((buf), (long)strlen(buf)) : rb_str_new_cstr(buf); });
}
