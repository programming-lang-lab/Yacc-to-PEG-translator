...
{
    VALUE val = rb_ivar_get(m, (__builtin_constant_p("@value") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("@value")), (long)strlen(("@value"))); (ID) rb_intern_id_cache; }) : rb_intern("@value")));
    *(int *)(((struct RData*)(self))->data) = rb_num2int_inline(val);
    return self;
}
...
{
    rb_ivar_set(self, (__builtin_constant_p("@value") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("@value")), (long)strlen(("@value"))); (ID) rb_intern_id_cache; }) : rb_intern("@value")), data);
    return self;
}
