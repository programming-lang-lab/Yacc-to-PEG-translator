...
{
    return rb_str2big_poweroftwo(str, rb_num2int_inline(vbase), !(((VALUE)(badcheck) & (VALUE)~((VALUE)RUBY_Qnil)) == 0));
}

static VALUE
str2big_normal(VALUE str, VALUE vbase, VALUE badcheck)
{
    return rb_str2big_normal(str, rb_num2int_inline(vbase), !(((VALUE)(badcheck) & (VALUE)~((VALUE)RUBY_Qnil)) == 0));
}

static VALUE
str2big_karatsuba(VALUE str, VALUE vbase, VALUE badcheck)
{
    return rb_str2big_karatsuba(str, rb_num2int_inline(vbase), !(((VALUE)(badcheck) & (VALUE)~((VALUE)RUBY_Qnil)) == 0));
}
void
Init_str2big(VALUE klass)
{
    ...
    rb_define_method(rb_cString, "str2big_gmp", rb_f_notimplement, 2);
}
