...
rb_integer_pack_raw_m(VALUE val, VALUE buf, VALUE numwords_arg, VALUE wordsize_arg, VALUE nails, VALUE flags)
{
  int sign;
  size_t numwords = 0;
  size_t wordsize = rb_num2ulong_inline(wordsize_arg);

  rb_string_value(&(buf));
  rb_str_modify(buf);
  sign = rb_integer_pack(val,
      (!(((struct RBasic*)(buf))->flags & RSTRING_NOEMBED) ? ((struct RString*)(buf))->as.ary : ((struct RString*)(buf))->as.heap.ptr), rb_num2ulong_inline(numwords_arg),
      rb_num2ulong_inline(wordsize_arg), rb_num2ulong_inline(nails), rb_num2int_inline(flags));

  return  ({ const VALUE args_to_new_ary[] = {(((VALUE)((int)(sign)))<<1 | RUBY_FIXNUM_FLAG),  ({ (__builtin_constant_p((!(((struct RBasic*)(buf))->flags & RSTRING_NOEMBED) ? ((struct RString*)(buf))->as.ary : ((struct RString*)(buf))->as.heap.ptr)) && __builtin_constant_p(wordsize * numwords)) ? rb_str_new_static(((!(((struct RBasic*)(buf))->flags & RSTRING_NOEMBED) ? ((struct RString*)(buf))->as.ary : ((struct RString*)(buf))->as.heap.ptr)), (wordsize * numwords)) : rb_str_new(((!(((struct RBasic*)(buf))->flags & RSTRING_NOEMBED) ? ((struct RString*)(buf))->as.ary : ((struct RString*)(buf))->as.heap.ptr)), (wordsize * numwords)); })}; if (__builtin_constant_p(2)) { extern int (*__Static_assert_function (void)) [!!sizeof (struct { int __error_if_negative: (((int)(sizeof(args_to_new_ary) / sizeof((args_to_new_ary)[0]))) == (2)) ? 2 : -1; })]; } rb_ary_new_from_values(((int)(sizeof(args_to_new_ary) / sizeof((args_to_new_ary)[0]))), args_to_new_ary); });
}
...
{
  int sign;
  size_t numwords = rb_num2ulong_inline(numwords_arg);
  size_t wordsize = rb_num2ulong_inline(wordsize_arg);
  VALUE buf;

  if (numwords != 0 && wordsize != 0 && 9223372036854775807L / wordsize < numwords)
      rb_raise(rb_eArgError, "too big numwords * wordsize");
  buf =  ({ (__builtin_constant_p(((void*)0)) && __builtin_constant_p(numwords * wordsize)) ? rb_str_new_static((((void*)0)), (numwords * wordsize)) : rb_str_new((((void*)0)), (numwords * wordsize)); });
  sign = rb_integer_pack(val,
      (!(((struct RBasic*)(buf))->flags & RSTRING_NOEMBED) ? ((struct RString*)(buf))->as.ary : ((struct RString*)(buf))->as.heap.ptr), numwords,
      wordsize, rb_num2ulong_inline(nails), rb_num2int_inline(flags));

  return rb_assoc_new((((VALUE)((int)(sign)))<<1 | RUBY_FIXNUM_FLAG), buf);
}
...
rb_integer_unpack_m(VALUE klass, VALUE buf, VALUE numwords, VALUE wordsize, VALUE nails, VALUE flags)
{
    ...
    return rb_integer_unpack((!(((struct RBasic*)(buf))->flags & RSTRING_NOEMBED) ? ((struct RString*)(buf))->as.ary : ((struct RString*)(buf))->as.heap.ptr),
            rb_num2ulong_inline(numwords), rb_num2ulong_inline(wordsize),
            rb_num2ulong_inline(nails), rb_num2int_inline(flags));
}
...
{
  size_t size;
  int neg = (((int)(long)(val))&RUBY_FIXNUM_FLAG) ? ((long)(((long)(val))>>(int)(1))) < 0 : (!((((struct RBasic*)(val))->flags & ((VALUE)((VALUE)RUBY_FL_USER1))) != 0));
  size = rb_absint_numwords(val, 1, ((void*)0)) - (neg && rb_absint_singlebit_p(val));
  return rb_ulong2num_inline(size);
}
...
Init_intpack(VALUE klass)
{
    ...
    rb_define_const(rb_cInteger, "INTEGER_PACK_MSWORD_FIRST", (((VALUE)((int)(0x01)))<<1 | RUBY_FIXNUM_FLAG));
    rb_define_const(rb_cInteger, "INTEGER_PACK_LSWORD_FIRST", (((VALUE)((int)(0x02)))<<1 | RUBY_FIXNUM_FLAG));
    rb_define_const(rb_cInteger, "INTEGER_PACK_MSBYTE_FIRST", (((VALUE)((int)(0x10)))<<1 | RUBY_FIXNUM_FLAG));
    rb_define_const(rb_cInteger, "INTEGER_PACK_LSBYTE_FIRST", (((VALUE)((int)(0x20)))<<1 | RUBY_FIXNUM_FLAG));
    rb_define_const(rb_cInteger, "INTEGER_PACK_NATIVE_BYTE_ORDER", (((VALUE)((int)(0x40)))<<1 | RUBY_FIXNUM_FLAG));
    rb_define_const(rb_cInteger, "INTEGER_PACK_2COMP", (((VALUE)((int)(0x80)))<<1 | RUBY_FIXNUM_FLAG));
    rb_define_const(rb_cInteger, "INTEGER_PACK_LITTLE_ENDIAN", (((VALUE)((int)((0x02 | 0x20))))<<1 | RUBY_FIXNUM_FLAG));
    rb_define_const(rb_cInteger, "INTEGER_PACK_BIG_ENDIAN", (((VALUE)((int)((0x01 | 0x10))))<<1 | RUBY_FIXNUM_FLAG));
    rb_define_const(rb_cInteger, "INTEGER_PACK_FORCE_BIGNUM", (((VALUE)((int)(0x100)))<<1 | RUBY_FIXNUM_FLAG));
    rb_define_const(rb_cInteger, "INTEGER_PACK_NEGATIVE", (((VALUE)((int)(0x200)))<<1 | RUBY_FIXNUM_FLAG));
    rb_define_const(rb_cInteger, "INTEGER_PACK_FORCE_GENERIC_IMPLEMENTATION", (((VALUE)((int)(0x400)))<<1 | RUBY_FIXNUM_FLAG));
