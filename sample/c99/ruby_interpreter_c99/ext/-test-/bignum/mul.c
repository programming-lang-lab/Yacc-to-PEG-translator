...
{
    if ((((int)(long)(x))&RUBY_FIXNUM_FLAG))
        return rb_int2big(((long)(((long)(x))>>(int)(1))));
...
{
    rb_define_const(rb_cInteger, "SIZEOF_BDIGIT", (((VALUE)((int)(4)))<<1 | RUBY_FIXNUM_FLAG));
    rb_define_const(rb_cInteger, "BITSPERDIG", (((VALUE)((int)(4 * 8)))<<1 | RUBY_FIXNUM_FLAG));
    ...
    rb_define_method(rb_cInteger, "big_mul_gmp", rb_f_notimplement, 1);
}
