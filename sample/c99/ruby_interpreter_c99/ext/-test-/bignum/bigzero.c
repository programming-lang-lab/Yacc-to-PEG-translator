...
{
    long len = rb_num2ulong_inline(length);
    VALUE z = rb_big_new(len, 1);
    memset((((((struct RBasic*)(z))->flags & ((VALUE)((VALUE)RUBY_FL_USER2))) ? ((struct RBignum*)(z))->as.ary : ((struct RBignum*)(z))->as.heap.digits)), 0, sizeof(unsigned int)*(size_t)(len));
    return z;
}
