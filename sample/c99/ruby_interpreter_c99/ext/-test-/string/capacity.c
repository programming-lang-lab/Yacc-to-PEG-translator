...
{
    return
 (!(((struct RBasic*)((str)))->flags&(((VALUE)RUBY_FL_USER1)))) ? (((VALUE)(RSTRING_EMBED_LEN_MAX))<<1 | RUBY_FIXNUM_FLAG) : ((((struct RBasic*)(((str))))->flags&((((VALUE)RUBY_FL_USER1)|RUBY_ELTS_SHARED))) == (((VALUE)RUBY_FL_USER1)|RUBY_ELTS_SHARED)) ? (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG) : (((VALUE)(((struct RString*)(str))->as.heap.aux.capa))<<1 | RUBY_FIXNUM_FLAG);
