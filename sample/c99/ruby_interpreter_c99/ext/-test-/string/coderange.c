...
{
    return coderange_int2sym(((int)((struct RBasic*)(str))->flags & RUBY_ENC_CODERANGE_MASK));
}
...
{
    sym_7bit = (rb_id2sym((__builtin_constant_p("7bit") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("7bit")), (long)strlen(("7bit"))); (ID) rb_intern_id_cache; }) : rb_intern("7bit"))));
    sym_valid = (rb_id2sym((__builtin_constant_p("valid") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("valid")), (long)strlen(("valid"))); (ID) rb_intern_id_cache; }) : rb_intern("valid"))));
    sym_unknown = (rb_id2sym((__builtin_constant_p("unknown") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("unknown")), (long)strlen(("unknown"))); (ID) rb_intern_id_cache; }) : rb_intern("unknown"))));
    sym_broken = (rb_id2sym((__builtin_constant_p("broken") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("broken")), (long)strlen(("broken"))); (ID) rb_intern_id_cache; }) : rb_intern("broken"))));
