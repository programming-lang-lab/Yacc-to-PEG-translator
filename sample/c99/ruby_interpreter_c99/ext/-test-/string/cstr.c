...
bug_str_cstr_term(VALUE str)
{
    ...
    rb_gc();
    enc = rb_enc_get(str);
    c = rb_enc_codepoint_len((&s[len]),(&s[len+(enc)->min_enc_len]),0,(enc));
    return (((VALUE)((int)(c)))<<1 | RUBY_FIXNUM_FLAG);
}
...
bug_str_cstr_unterm(VALUE str, VALUE c)
{
    ...
    rb_str_modify(str);
    len = (!(((struct RBasic*)(str))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(str))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(str))->as.heap.len);
    (!(((struct RBasic*)(str))->flags & RSTRING_NOEMBED) ? ((struct RString*)(str))->as.ary : ((struct RString*)(str))->as.heap.ptr)[len] = rb_num2char_inline(c);
    return str;
}
...
bug_str_cstr_term_char(VALUE str)
{
 ...
 c = ((enc))->mbc_to_code(((OnigUChar*)(s)),((OnigUChar*)(s + len)),(enc));
 if (!c) return ((VALUE)RUBY_Qnil);
    }
...
{
    long beg = rb_num2long_inline(vbeg);
    long len = rb_num2long_inline(vlen);
    rb_str_modify(str);
    if (len < 0) rb_raise(rb_eArgError, "negative length: %ld", len);
    if ((!(((struct RBasic*)(str))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(str))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(str))->as.heap.len) < beg) rb_raise(rb_eIndexError, "beg: %ld", beg);
    if ((!(((struct RBasic*)(str))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(str))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(str))->as.heap.len) < beg + len) rb_raise(rb_eIndexError, "end: %ld", beg + len);
    str = rb_str_new_shared(str);
    if ((!(((struct RBasic*)((str)))->flags&(((VALUE)RUBY_FL_USER1))))) {
 ((struct RString*)(str))->basic.flags &= ~RSTRING_EMBED_LEN_MASK;
 ((struct RString*)(str))->basic.flags |= len << RSTRING_EMBED_LEN_SHIFT;
 memmove(((struct RString*)(str))->as.ary, ((struct RString*)(str))->as.ary + beg, len);
    }
    else {
 ((struct RString*)(str))->as.heap.ptr += beg;
...
{
    VALUE str2 =  ({ (__builtin_constant_p(((void*)0)) && __builtin_constant_p(0)) ? rb_str_new_static((((void*)0)), (0)) : rb_str_new((((void*)0)), (0)); });
    long capacity = (!(((struct RBasic*)(str))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(str))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(str))->as.heap.len) + (rb_enc_get(str))->min_enc_len;
    char *buf = ((char*)ruby_xmalloc2((size_t)(capacity),sizeof(char)));
    (!( (((RUBY_T_STRING)) == RUBY_T_FIXNUM) ? (((int)(long)((VALUE)(str)))&RUBY_FIXNUM_FLAG) : (((RUBY_T_STRING)) == RUBY_T_TRUE) ? (((VALUE)(str)) == ((VALUE)RUBY_Qtrue)) : (((RUBY_T_STRING)) == RUBY_T_FALSE) ? (((VALUE)(str)) == ((VALUE)RUBY_Qfalse)) : (((RUBY_T_STRING)) == RUBY_T_NIL) ? (((VALUE)(str)) == ((VALUE)RUBY_Qnil)) : (((RUBY_T_STRING)) == RUBY_T_UNDEF) ? (((VALUE)(str)) == ((VALUE)RUBY_Qundef)) : (((RUBY_T_STRING)) == RUBY_T_SYMBOL) ? ((((VALUE)((VALUE)(str))&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)((VALUE)(str)) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)((VALUE)(str)) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)((VALUE)(str)))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : (((RUBY_T_STRING)) == RUBY_T_FLOAT) ? ( ((((int)(long)((VALUE)(str)))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)((VALUE)(str)) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)((VALUE)(str)) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)((VALUE)(str)))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)((VALUE)(str)) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)((VALUE)(str)) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)((VALUE)(str)))->flags & RUBY_T_MASK) == ((RUBY_T_STRING)))) || ((RUBY_T_STRING) == RUBY_T_DATA && (((struct RTypedData*)(str))->typed_flag == 1)) ? rb_unexpected_type((VALUE)(str), (RUBY_T_STRING)) : (void)0);
    ...
    memcpy(buf, (!(((struct RBasic*)(str))->flags & RSTRING_NOEMBED) ? ((struct RString*)(str))->as.ary : ((struct RString*)(str))->as.heap.ptr), capacity);
    ((struct RBasic*)(str2))->flags &= ~RSTRING_EMBED_LEN_MASK;
    ((struct RString*)(str2))->as.heap.aux.capa = capacity;
    ((struct RString*)(str2))->as.heap.ptr = buf;
    ((struct RString*)(str2))->as.heap.len = (!(((struct RBasic*)(str))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(str))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(str))->as.heap.len);
    do { char *const term_fill_ptr = ((!(((struct RBasic*)(str2))->flags & RSTRING_NOEMBED) ? (((struct RString*)(str2))->as.ary + (long)((((struct RBasic*)(str2))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT))) : (((struct RString*)(str2))->as.heap.ptr + ((struct RString*)(str2))->as.heap.len))); const int term_fill_len = ((rb_enc_get(str))->min_enc_len); *term_fill_ptr = '\0'; if ((__builtin_expect(!!(term_fill_len > 1), 0))) memset(term_fill_ptr, 0, term_fill_len);} while (0);
    return str2;
}
...
{
    return (!(((struct RBasic*)((str)))->flags&(((VALUE)RUBY_FL_USER1)))) ? ((VALUE)RUBY_Qtrue) : ((VALUE)RUBY_Qfalse);
}
