...
wait_for_single_fd(VALUE ign, VALUE fd, VALUE events, VALUE timeout)
{
 ...
 tvp = &tv;
    ...
    rc = rb_wait_for_single_fd(rb_num2int_inline(fd), rb_num2int_inline(events), tvp);
    if (rc == -1)
 rb_sys_fail("rb_wait_for_single_fd");
    return (((VALUE)((int)(rc)))<<1 | RUBY_FIXNUM_FLAG);
}

void
Init_wait_for_single_fd(void)
{
    rb_define_const(rb_cObject, "RB_WAITFD_IN", (((VALUE)((int)(0x001)))<<1 | RUBY_FIXNUM_FLAG));
    rb_define_const(rb_cObject, "RB_WAITFD_OUT", (((VALUE)((int)(0x004)))<<1 | RUBY_FIXNUM_FLAG));
    rb_define_const(rb_cObject, "RB_WAITFD_PRI", (((VALUE)((int)(0x002)))<<1 | RUBY_FIXNUM_FLAG));
