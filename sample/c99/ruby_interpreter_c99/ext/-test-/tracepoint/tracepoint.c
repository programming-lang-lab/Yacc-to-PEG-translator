...
tracepoint_track_objspace_events_i(VALUE tpval, void *data)
{
      ...
      case 0x100000:
 {
     ...
     if (track->objects_count < (sizeof(((struct tracepoint_track *)((void*)0))->objects)/sizeof(VALUE)))
...
tracepoint_track_objspace_events(VALUE self)
{
    ...
    VALUE tpval = rb_tracepoint_new(0, 0x100000 | 0x200000 |
        0x400000 | 0x800000 |
        0x1000000,
    ...
    rb_ensure(rb_yield, ((VALUE)RUBY_Qundef), rb_tracepoint_disable, tpval);

    rb_ary_push(result, rb_ulong2num_inline(track.newobj_count));
    rb_ary_push(result, rb_ulong2num_inline(track.free_count));
    rb_ary_push(result, rb_ulong2num_inline(track.gc_start_count));
    rb_ary_push(result, rb_ulong2num_inline(track.gc_end_mark_count));
    rb_ary_push(result, rb_ulong2num_inline(track.gc_end_sweep_count));
...
{
    VALUE tpval = rb_tracepoint_new(0, 0x100000 | 0x0008, 0, 0);
    rb_tracepoint_enable(tpval);
