...
{
    VALUE io = (VALUE)data;
    VALUE string = rb_funcall(io, id_read, 1, (((VALUE)((int)(size)))<<1 | RUBY_FIXNUM_FLAG));

    *read = 0;

    if(! !((VALUE)(string) != ((VALUE)RUBY_Qnil))) {
 void * str = (void *)rb_string_value_ptr(&(string));
 *read = (size_t)(!(((struct RBasic*)(string))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(string))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(string))->as.heap.len);
 memcpy(buf, str, *read);
    }
...
{
    yaml_parser_t * parser;
    VALUE obj = ({ VALUE data_struct_obj = rb_data_typed_object_zalloc(klass, sizeof(yaml_parser_t), &psych_parser_type); (void)((parser) = (yaml_parser_t *)(((struct RData*)(data_struct_obj))->data));; data_struct_obj; });
...
static VALUE make_exception(yaml_parser_t * parser, VALUE path)
{
    ...
    return rb_funcall(ePsychSyntaxError, (__builtin_constant_p("new") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("new")), (long)strlen(("new"))); (ID) rb_intern_id_cache; }) : rb_intern("new")), 6,
     path,
     (((VALUE)((int)(line)))<<1 | RUBY_FIXNUM_FLAG),
     (((VALUE)((int)(column)))<<1 | RUBY_FIXNUM_FLAG),
     (((VALUE)((int)(parser->problem_offset)))<<1 | RUBY_FIXNUM_FLAG),
     parser->problem ?  ({ (__builtin_constant_p(parser->problem)) ? rb_usascii_str_new_static((parser->problem), (long)strlen(parser->problem)) : rb_usascii_str_new_cstr(parser->problem); }) : ((VALUE)RUBY_Qnil),
     parser->context ?  ({ (__builtin_constant_p(parser->context)) ? rb_usascii_str_new_static((parser->context), (long)strlen(parser->context)) : rb_usascii_str_new_cstr(parser->context); }) : ((VALUE)RUBY_Qnil));
}
...
static VALUE transcode_io(VALUE src, int * parser_encoding)
{
    ...
    io_external_encoding = rb_funcall(src, (__builtin_constant_p("external_encoding") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("external_encoding")), (long)strlen(("external_encoding"))); (ID) rb_intern_id_cache; }) : rb_intern("external_encoding")), 0);


    if (!((VALUE)(io_external_encoding) != ((VALUE)RUBY_Qnil))) {
...
{
    VALUE *args = (VALUE *)pointer;
    return rb_funcallv_public(args[0], id_start_document, 3, args + 1);
}
...
{
    VALUE *args = (VALUE *)pointer;
    return rb_funcallv_public(args[0], id_scalar, 6, args + 1);
}

static VALUE protected_start_sequence(VALUE pointer)
{
    VALUE *args = (VALUE *)pointer;
    return rb_funcallv_public(args[0], id_start_sequence, 4, args + 1);
}
...
{
    VALUE *args = (VALUE *)pointer;
    return rb_funcallv_public(args[0], id_start_mapping, 4, args + 1);
}
...
{
    VALUE *args = (VALUE *)pointer;
    return rb_funcallv_public(args[0], id_event_location, 4, args + 1);
}
static VALUE parse(int argc, VALUE *argv, VALUE self)
{
 ...
 if(rb_respond_to(yaml, id_path))
     ...
     path =  ({ (__builtin_constant_p("<unknown>")) ? rb_str_new_static(("<unknown>"), (long)strlen("<unknown>")) : rb_str_new_cstr("<unknown>"); });
    }

    ((parser) = (yaml_parser_t*)rb_check_typeddata((self), (&psych_parser_type)));

    yaml_parser_delete(parser);
    yaml_parser_initialize(parser);

    if ((!!((!(((VALUE)((yaml)) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)((yaml)) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)((yaml)))->flags & RUBY_T_MASK) != RUBY_T_NODE)?(((struct RBasic*)(((yaml))))->flags&((RUBY_FL_TAINT))):0))) tainted = 1;

    if (rb_respond_to(yaml, id_read)) {
 yaml = transcode_io(yaml, &parser_encoding);
 yaml_parser_set_encoding(parser, parser_encoding);
 yaml_parser_set_input(parser, io_reader, (void *)yaml);
 if (!(((VALUE)(rb_obj_is_kind_of(yaml, rb_cIO)) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) tainted = 1;
    } else {
 rb_string_value(&(yaml));
 yaml = transcode_string(yaml, &parser_encoding);
 yaml_parser_set_encoding(parser, parser_encoding);
 yaml_parser_set_input_string(
  parser,
  (const unsigned char *)(!(((struct RBasic*)(yaml))->flags & RSTRING_NOEMBED) ? ((struct RString*)(yaml))->as.ary : ((struct RString*)(yaml))->as.heap.ptr),
  (size_t)(!(((struct RBasic*)(yaml))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(yaml))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(yaml))->as.heap.len)
  );
    }
 ...
 start_line = (((VALUE)((int)((long)event.start_mark.line)))<<1 | RUBY_FIXNUM_FLAG);
 start_column = (((VALUE)((int)((long)event.start_mark.column)))<<1 | RUBY_FIXNUM_FLAG);
 end_line = (((VALUE)((int)((long)event.end_mark.line)))<<1 | RUBY_FIXNUM_FLAG);
 end_column = (((VALUE)((int)((long)event.end_mark.column)))<<1 | RUBY_FIXNUM_FLAG);
 ...
 switch(event.type) {
    ...
    args[0] = handler;
    args[1] = (((VALUE)((int)((long)event.data.stream_start.encoding)))<<1 | RUBY_FIXNUM_FLAG);
  ...
  VALUE version = event.data.document_start.version_directive ?
   ...
   (long)2,
   (((VALUE)((int)((long)event.data.document_start.version_directive->major)))<<1 | RUBY_FIXNUM_FLAG),
   (((VALUE)((int)((long)event.data.document_start.version_directive->minor)))<<1 | RUBY_FIXNUM_FLAG)
   ) : rb_ary_new();
  ...
  if(event.data.document_start.tag_directives.start) {
   ...
   event.data.document_start.tag_directives.end;
      for(; start != end; start++) {
   VALUE handle = ((VALUE)RUBY_Qnil);
   VALUE prefix = ((VALUE)RUBY_Qnil);
   if(start->handle) {
       handle =  ({ (__builtin_constant_p((const char *)start->handle)) ? rb_str_new_static(((const char *)start->handle), (long)strlen((const char *)start->handle)) : rb_str_new_cstr((const char *)start->handle); });
       if (tainted) (((!(((VALUE)(handle) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(handle) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(handle))->flags & RUBY_T_MASK) != RUBY_T_NODE) && (int)(((struct RBasic*)(handle))->flags & RUBY_T_MASK) != RUBY_T_BIGNUM && (int)(((struct RBasic*)(handle))->flags & RUBY_T_MASK) != RUBY_T_FLOAT) ? (void)(((struct RBasic*)(handle))->flags |= (RUBY_FL_TAINT)) : (void)0);
       do { rb_enc_associate_index((handle), (encoding)); if(internal_enc) (handle) = rb_str_export_to_enc((handle), (internal_enc)); } while (0);
   }

   if(start->prefix) {
       prefix =  ({ (__builtin_constant_p((const char *)start->prefix)) ? rb_str_new_static(((const char *)start->prefix), (long)strlen((const char *)start->prefix)) : rb_str_new_cstr((const char *)start->prefix); });
       if (tainted) (((!(((VALUE)(prefix) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(prefix) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(prefix))->flags & RUBY_T_MASK) != RUBY_T_NODE) && (int)(((struct RBasic*)(prefix))->flags & RUBY_T_MASK) != RUBY_T_BIGNUM && (int)(((struct RBasic*)(prefix))->flags & RUBY_T_MASK) != RUBY_T_FLOAT) ? (void)(((struct RBasic*)(prefix))->flags |= (RUBY_FL_TAINT)) : (void)0);
       do { rb_enc_associate_index((prefix), (encoding)); if(internal_enc) (prefix) = rb_str_export_to_enc((prefix), (internal_enc)); } while (0);
   }

   rb_ary_push(tag_directives, rb_ary_new_from_args((long)2, handle, prefix));
      }
  }
  args[0] = handler;
  args[1] = version;
  args[2] = tag_directives;
  args[3] = event.data.document_start.implicit == 1 ? ((VALUE)RUBY_Qtrue) : ((VALUE)RUBY_Qfalse);
  ...
  args[0] = handler;
  args[1] = event.data.document_end.implicit == 1 ? ((VALUE)RUBY_Qtrue) : ((VALUE)RUBY_Qfalse);
  rb_protect(protected_end_document, (VALUE)args, &state);
   ...
   case YAML_ALIAS_EVENT:
     {
  VALUE args[2];
  VALUE alias = ((VALUE)RUBY_Qnil);
  if(event.data.alias.anchor) {
      alias =  ({ (__builtin_constant_p((const char *)event.data.alias.anchor)) ? rb_str_new_static(((const char *)event.data.alias.anchor), (long)strlen((const char *)event.data.alias.anchor)) : rb_str_new_cstr((const char *)event.data.alias.anchor); });
      if (tainted) (((!(((VALUE)(alias) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(alias) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(alias))->flags & RUBY_T_MASK) != RUBY_T_NODE) && (int)(((struct RBasic*)(alias))->flags & RUBY_T_MASK) != RUBY_T_BIGNUM && (int)(((struct RBasic*)(alias))->flags & RUBY_T_MASK) != RUBY_T_FLOAT) ? (void)(((struct RBasic*)(alias))->flags |= (RUBY_FL_TAINT)) : (void)0);
      do { rb_enc_associate_index((alias), (encoding)); if(internal_enc) (alias) = rb_str_export_to_enc((alias), (internal_enc)); } while (0);
  }
  ...
  rb_protect(protected_alias, (VALUE)args, &state);
   ...
   case YAML_SCALAR_EVENT:
     {
  VALUE args[7];
  VALUE anchor = ((VALUE)RUBY_Qnil);
  VALUE tag = ((VALUE)RUBY_Qnil);
  VALUE plain_implicit, quoted_implicit, style;
  VALUE val =  ({ (__builtin_constant_p((const char *)event.data.scalar.value) && __builtin_constant_p((long)event.data.scalar.length)) ? rb_str_new_static(((const char *)event.data.scalar.value), ((long)event.data.scalar.length)) : rb_str_new(((const char *)event.data.scalar.value), ((long)event.data.scalar.length)); });



  if (tainted) (((!(((VALUE)(val) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(val) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(val))->flags & RUBY_T_MASK) != RUBY_T_NODE) && (int)(((struct RBasic*)(val))->flags & RUBY_T_MASK) != RUBY_T_BIGNUM && (int)(((struct RBasic*)(val))->flags & RUBY_T_MASK) != RUBY_T_FLOAT) ? (void)(((struct RBasic*)(val))->flags |= (RUBY_FL_TAINT)) : (void)0);

  do { rb_enc_associate_index((val), (encoding)); if(internal_enc) (val) = rb_str_export_to_enc((val), (internal_enc)); } while (0);

  if(event.data.scalar.anchor) {
      anchor =  ({ (__builtin_constant_p((const char *)event.data.scalar.anchor)) ? rb_str_new_static(((const char *)event.data.scalar.anchor), (long)strlen((const char *)event.data.scalar.anchor)) : rb_str_new_cstr((const char *)event.data.scalar.anchor); });
      if (tainted) (((!(((VALUE)(anchor) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(anchor) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(anchor))->flags & RUBY_T_MASK) != RUBY_T_NODE) && (int)(((struct RBasic*)(anchor))->flags & RUBY_T_MASK) != RUBY_T_BIGNUM && (int)(((struct RBasic*)(anchor))->flags & RUBY_T_MASK) != RUBY_T_FLOAT) ? (void)(((struct RBasic*)(anchor))->flags |= (RUBY_FL_TAINT)) : (void)0);
      do { rb_enc_associate_index((anchor), (encoding)); if(internal_enc) (anchor) = rb_str_export_to_enc((anchor), (internal_enc)); } while (0);
  }

  if(event.data.scalar.tag) {
      tag =  ({ (__builtin_constant_p((const char *)event.data.scalar.tag)) ? rb_str_new_static(((const char *)event.data.scalar.tag), (long)strlen((const char *)event.data.scalar.tag)) : rb_str_new_cstr((const char *)event.data.scalar.tag); });
      if (tainted) (((!(((VALUE)(tag) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(tag) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(tag))->flags & RUBY_T_MASK) != RUBY_T_NODE) && (int)(((struct RBasic*)(tag))->flags & RUBY_T_MASK) != RUBY_T_BIGNUM && (int)(((struct RBasic*)(tag))->flags & RUBY_T_MASK) != RUBY_T_FLOAT) ? (void)(((struct RBasic*)(tag))->flags |= (RUBY_FL_TAINT)) : (void)0);
      do { rb_enc_associate_index((tag), (encoding)); if(internal_enc) (tag) = rb_str_export_to_enc((tag), (internal_enc)); } while (0);
  }

  plain_implicit =
      event.data.scalar.plain_implicit == 0 ? ((VALUE)RUBY_Qfalse) : ((VALUE)RUBY_Qtrue);

  quoted_implicit =
      event.data.scalar.quoted_implicit == 0 ? ((VALUE)RUBY_Qfalse) : ((VALUE)RUBY_Qtrue);

  style = (((VALUE)((int)((long)event.data.scalar.style)))<<1 | RUBY_FIXNUM_FLAG);
  ...
  if(event.data.sequence_start.anchor) {
      anchor =  ({ (__builtin_constant_p((const char *)event.data.sequence_start.anchor)) ? rb_str_new_static(((const char *)event.data.sequence_start.anchor), (long)strlen((const char *)event.data.sequence_start.anchor)) : rb_str_new_cstr((const char *)event.data.sequence_start.anchor); });
      if (tainted) (((!(((VALUE)(anchor) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(anchor) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(anchor))->flags & RUBY_T_MASK) != RUBY_T_NODE) && (int)(((struct RBasic*)(anchor))->flags & RUBY_T_MASK) != RUBY_T_BIGNUM && (int)(((struct RBasic*)(anchor))->flags & RUBY_T_MASK) != RUBY_T_FLOAT) ? (void)(((struct RBasic*)(anchor))->flags |= (RUBY_FL_TAINT)) : (void)0);
      do { rb_enc_associate_index((anchor), (encoding)); if(internal_enc) (anchor) = rb_str_export_to_enc((anchor), (internal_enc)); } while (0);
  }
  ...
  if(event.data.sequence_start.tag) {
      tag =  ({ (__builtin_constant_p((const char *)event.data.sequence_start.tag)) ? rb_str_new_static(((const char *)event.data.sequence_start.tag), (long)strlen((const char *)event.data.sequence_start.tag)) : rb_str_new_cstr((const char *)event.data.sequence_start.tag); });
      if (tainted) (((!(((VALUE)(tag) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(tag) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(tag))->flags & RUBY_T_MASK) != RUBY_T_NODE) && (int)(((struct RBasic*)(tag))->flags & RUBY_T_MASK) != RUBY_T_BIGNUM && (int)(((struct RBasic*)(tag))->flags & RUBY_T_MASK) != RUBY_T_FLOAT) ? (void)(((struct RBasic*)(tag))->flags |= (RUBY_FL_TAINT)) : (void)0);
      do { rb_enc_associate_index((tag), (encoding)); if(internal_enc) (tag) = rb_str_export_to_enc((tag), (internal_enc)); } while (0);
  }

  implicit =
      event.data.sequence_start.implicit == 0 ? ((VALUE)RUBY_Qfalse) : ((VALUE)RUBY_Qtrue);

  style = (((VALUE)((int)((long)event.data.sequence_start.style)))<<1 | RUBY_FIXNUM_FLAG);
  ...
  if(event.data.mapping_start.anchor) {
      anchor =  ({ (__builtin_constant_p((const char *)event.data.mapping_start.anchor)) ? rb_str_new_static(((const char *)event.data.mapping_start.anchor), (long)strlen((const char *)event.data.mapping_start.anchor)) : rb_str_new_cstr((const char *)event.data.mapping_start.anchor); });
      if (tainted) (((!(((VALUE)(anchor) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(anchor) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(anchor))->flags & RUBY_T_MASK) != RUBY_T_NODE) && (int)(((struct RBasic*)(anchor))->flags & RUBY_T_MASK) != RUBY_T_BIGNUM && (int)(((struct RBasic*)(anchor))->flags & RUBY_T_MASK) != RUBY_T_FLOAT) ? (void)(((struct RBasic*)(anchor))->flags |= (RUBY_FL_TAINT)) : (void)0);
      do { rb_enc_associate_index((anchor), (encoding)); if(internal_enc) (anchor) = rb_str_export_to_enc((anchor), (internal_enc)); } while (0);
  }

  if(event.data.mapping_start.tag) {
      tag =  ({ (__builtin_constant_p((const char *)event.data.mapping_start.tag)) ? rb_str_new_static(((const char *)event.data.mapping_start.tag), (long)strlen((const char *)event.data.mapping_start.tag)) : rb_str_new_cstr((const char *)event.data.mapping_start.tag); });
      if (tainted) (((!(((VALUE)(tag) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(tag) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(tag))->flags & RUBY_T_MASK) != RUBY_T_NODE) && (int)(((struct RBasic*)(tag))->flags & RUBY_T_MASK) != RUBY_T_BIGNUM && (int)(((struct RBasic*)(tag))->flags & RUBY_T_MASK) != RUBY_T_FLOAT) ? (void)(((struct RBasic*)(tag))->flags |= (RUBY_FL_TAINT)) : (void)0);
      do { rb_enc_associate_index((tag), (encoding)); if(internal_enc) (tag) = rb_str_export_to_enc((tag), (internal_enc)); } while (0);
  }

  implicit =
      event.data.mapping_start.implicit == 0 ? ((VALUE)RUBY_Qfalse) : ((VALUE)RUBY_Qtrue);

  style = (((VALUE)((int)((long)event.data.mapping_start.style)))<<1 | RUBY_FIXNUM_FLAG);
...
static VALUE mark(VALUE self)
{
    ...
    ((parser) = (yaml_parser_t*)rb_check_typeddata((self), (&psych_parser_type)));
    mark_klass = rb_const_get_at(cPsychParser, (__builtin_constant_p("Mark") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("Mark")), (long)strlen(("Mark"))); (ID) rb_intern_id_cache; }) : rb_intern("Mark")));
    args[0] = (((VALUE)((int)(parser->mark.index)))<<1 | RUBY_FIXNUM_FLAG);
    args[1] = (((VALUE)((int)(parser->mark.line)))<<1 | RUBY_FIXNUM_FLAG);
    args[2] = (((VALUE)((int)(parser->mark.column)))<<1 | RUBY_FIXNUM_FLAG);
...
void Init_psych_parser(void)
{
    ...
    rb_define_const(cPsychParser, "ANY", (((VALUE)((int)(YAML_ANY_ENCODING)))<<1 | RUBY_FIXNUM_FLAG));


    rb_define_const(cPsychParser, "UTF8", (((VALUE)((int)(YAML_UTF8_ENCODING)))<<1 | RUBY_FIXNUM_FLAG));


    rb_define_const(cPsychParser, "UTF16LE", (((VALUE)((int)(YAML_UTF16LE_ENCODING)))<<1 | RUBY_FIXNUM_FLAG));


    rb_define_const(cPsychParser, "UTF16BE", (((VALUE)((int)(YAML_UTF16BE_ENCODING)))<<1 | RUBY_FIXNUM_FLAG));

    rb_require("psych/syntax_error");
    ePsychSyntaxError = rb_const_get(mPsych, (__builtin_constant_p("SyntaxError") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("SyntaxError")), (long)strlen(("SyntaxError"))); (ID) rb_intern_id_cache; }) : rb_intern("SyntaxError")));
    ...
    id_empty = (__builtin_constant_p("empty") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("empty")), (long)strlen(("empty"))); (ID) rb_intern_id_cache; }) : rb_intern("empty"));
    id_start_stream = (__builtin_constant_p("start_stream") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("start_stream")), (long)strlen(("start_stream"))); (ID) rb_intern_id_cache; }) : rb_intern("start_stream"));
    id_end_stream = (__builtin_constant_p("end_stream") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("end_stream")), (long)strlen(("end_stream"))); (ID) rb_intern_id_cache; }) : rb_intern("end_stream"));
    id_start_document = (__builtin_constant_p("start_document") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("start_document")), (long)strlen(("start_document"))); (ID) rb_intern_id_cache; }) : rb_intern("start_document"));
    id_end_document = (__builtin_constant_p("end_document") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("end_document")), (long)strlen(("end_document"))); (ID) rb_intern_id_cache; }) : rb_intern("end_document"));
    id_alias = (__builtin_constant_p("alias") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("alias")), (long)strlen(("alias"))); (ID) rb_intern_id_cache; }) : rb_intern("alias"));
    id_scalar = (__builtin_constant_p("scalar") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("scalar")), (long)strlen(("scalar"))); (ID) rb_intern_id_cache; }) : rb_intern("scalar"));
    id_start_sequence = (__builtin_constant_p("start_sequence") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("start_sequence")), (long)strlen(("start_sequence"))); (ID) rb_intern_id_cache; }) : rb_intern("start_sequence"));
    id_end_sequence = (__builtin_constant_p("end_sequence") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("end_sequence")), (long)strlen(("end_sequence"))); (ID) rb_intern_id_cache; }) : rb_intern("end_sequence"));
    id_start_mapping = (__builtin_constant_p("start_mapping") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("start_mapping")), (long)strlen(("start_mapping"))); (ID) rb_intern_id_cache; }) : rb_intern("start_mapping"));
    id_end_mapping = (__builtin_constant_p("end_mapping") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("end_mapping")), (long)strlen(("end_mapping"))); (ID) rb_intern_id_cache; }) : rb_intern("end_mapping"));
    id_event_location = (__builtin_constant_p("event_location") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("event_location")), (long)strlen(("event_location"))); (ID) rb_intern_id_cache; }) : rb_intern("event_location"));
}
