...
static VALUE libyaml_version(VALUE module)
{
    ...
    list[0] = (((VALUE)((int)((long)major)))<<1 | RUBY_FIXNUM_FLAG);
    list[1] = (((VALUE)((int)((long)minor)))<<1 | RUBY_FIXNUM_FLAG);
    list[2] = (((VALUE)((int)((long)patch)))<<1 | RUBY_FIXNUM_FLAG);

    return rb_ary_new_from_values((long)3, list);
}
