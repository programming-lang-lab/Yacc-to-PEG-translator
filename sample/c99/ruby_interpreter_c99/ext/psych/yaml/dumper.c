...
yaml_emitter_open(yaml_emitter_t *emitter)
{
    ...
    ((emitter) ? (void) (0) : __assert_fail ("emitter", "ext/psych/yaml/dumper.c", 67,  __PRETTY_FUNCTION__));
    ((!emitter->opened) ? (void) (0) : __assert_fail ("!emitter->opened", "ext/psych/yaml/dumper.c", 68,  __PRETTY_FUNCTION__));
...
yaml_emitter_close(yaml_emitter_t *emitter)
{
    ...
    ((emitter) ? (void) (0) : __assert_fail ("emitter", "ext/psych/yaml/dumper.c", 91,  __PRETTY_FUNCTION__));
    ((emitter->opened) ? (void) (0) : __assert_fail ("emitter->opened", "ext/psych/yaml/dumper.c", 92,  __PRETTY_FUNCTION__));
...
yaml_emitter_dump(yaml_emitter_t *emitter, yaml_document_t *document)
{
    ...
    ((emitter) ? (void) (0) : __assert_fail ("emitter", "ext/psych/yaml/dumper.c", 117,  __PRETTY_FUNCTION__));
    ((document) ? (void) (0) : __assert_fail ("document", "ext/psych/yaml/dumper.c", 118,  __PRETTY_FUNCTION__));
    ...
    ((emitter->opened) ? (void) (0) : __assert_fail ("emitter->opened", "ext/psych/yaml/dumper.c", 132,  __PRETTY_FUNCTION__));
...
yaml_emitter_delete_document_and_anchors(yaml_emitter_t *emitter)
{
    ...
    (yaml_free((emitter->document->nodes).start), (emitter->document->nodes).start = (emitter->document->nodes).top = (emitter->document->nodes).end = 0);
    yaml_free(emitter->anchors);

    emitter->anchors = ((void*)0);
...
yaml_emitter_generate_anchor(yaml_emitter_t *emitter, int anchor_id)
{
    yaml_char_t *anchor = yaml_malloc(16);
...
yaml_emitter_dump_node(yaml_emitter_t *emitter, int index)
{
    ...
    switch (node->type) {
        ...
        default:
            ((0) ? (void) (0) : __assert_fail ("0", "ext/psych/yaml/dumper.c", 289,  __PRETTY_FUNCTION__));
            break;
    }
