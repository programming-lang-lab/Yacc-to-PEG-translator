...
yaml_emitter_flush(yaml_emitter_t *emitter)
{
    ...
    ((emitter) ? (void) (0) : __assert_fail ("emitter", "ext/psych/yaml/writer.c", 36,  __PRETTY_FUNCTION__));
    ((emitter->write_handler) ? (void) (0) : __assert_fail ("emitter->write_handler", "ext/psych/yaml/writer.c", 37,  __PRETTY_FUNCTION__));
    ((emitter->encoding) ? (void) (0) : __assert_fail ("emitter->encoding", "ext/psych/yaml/writer.c", 38,  __PRETTY_FUNCTION__));
