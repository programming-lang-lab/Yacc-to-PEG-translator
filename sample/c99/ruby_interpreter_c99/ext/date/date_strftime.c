         ...
         const struct tmx *tmx)
{
 ...
 "October", "November", "December",
    ...
    if (s == ((void*)0) || format == ((void*)0) || tmx == ((void*)0) || maxsize == 0)
 return 0;


    if (strchr(format, '%') == ((void*)0) && strlen(format) + 1 >= maxsize) {
      err:
 (*__errno_location ()) = 34;
 return 0;
    }
 ...
 switch (*++format) {
  ...
  flags |= (1U<<(UPPER));
     ...
     {
  int wday = (tmx->funcs->wday)(tmx->dat);
  if (wday < 0 || wday > 6)
      i = 1, tp = "?";
  else {
      if (*format == 'A')
  ...
  if (mon < 1 || mon > 12)
   ...
   case 'C':
     do { VALUE tmp = ((rb_funcall(((tmx->funcs->year)(tmx->dat)), (__builtin_constant_p("div") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("div")), (long)strlen(("div"))); (ID) rb_intern_id_cache; }) : rb_intern("div")), 1, ((((VALUE)(100))<<1 | RUBY_FIXNUM_FLAG))))); if ((((int)(long)(tmp))&RUBY_FIXNUM_FLAG)) { do { int l; if (precision <= 0) precision = ((2)); if (flags & (1U<<(LEFT))) precision = 1; l = ruby_snprintf(s, endp - s, ((padding == '0' || (!padding && (('0')) == '0')) ? "%0*ld": "%*ld"), precision, (((long)(((long)(tmp))>>(int)(1))))); if (l < 0) goto err; s += l; } while (0); } else { VALUE args[2], result; size_t l; if (precision <= 0) precision = (2); if (flags & (1U<<(LEFT))) precision = 1; args[0] = (((VALUE)(precision))<<1 | RUBY_FIXNUM_FLAG); args[1] = ((rb_funcall(((tmx->funcs->year)(tmx->dat)), (__builtin_constant_p("div") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("div")), (long)strlen(("div"))); (ID) rb_intern_id_cache; }) : rb_intern("div")), 1, ((((VALUE)(100))<<1 | RUBY_FIXNUM_FLAG))))); if (padding == '0' || (!padding && ('0') == '0')) result = rb_str_format(2, args,  ({ (__builtin_constant_p("%0*d")) ? rb_str_new_static(("%0*d"), (long)strlen("%0*d")) : rb_str_new_cstr("%0*d"); })); else result = rb_str_format(2, args,  ({ (__builtin_constant_p("%*d")) ? rb_str_new_static(("%*d"), (long)strlen("%*d")) : rb_str_new_cstr("%*d"); })); l = strlcpy(s, rb_string_value_cstr(&(result)), endp - s); if ((size_t)(endp - s) <= l) goto err; s += l; } } while (0);
     continue;

   case 'c':
     do { i = date_strftime_with_tmx(s, endp - s, ("%a %b %e %H:%M:%S %Y"), tmx); if (!i) return 0; if (flags & (1U<<(UPPER))) upcase(s, i); if (!(flags & (1U<<(LEFT))) && precision > i) { if (start + maxsize < s + precision) { (*__errno_location ()) = 34; return 0; } memmove(s + precision - i, s, i); memset(s, padding ? padding : ' ', precision - i); s += precision; } else s += i; } while (0);
     continue;

   case 'D':
     do { i = date_strftime_with_tmx(s, endp - s, ("%m/%d/%y"), tmx); if (!i) return 0; if (flags & (1U<<(UPPER))) upcase(s, i); if (!(flags & (1U<<(LEFT))) && precision > i) { if (start + maxsize < s + precision) { (*__errno_location ()) = 34; return 0; } memmove(s + precision - i, s, i); memset(s, padding ? padding : ' ', precision - i); s += precision; } else s += i; } while (0);
     continue;

   case 'd':
   case 'e':
     v = ((tmx->funcs->mday)(tmx->dat));
     do { int l; if (precision <= 0) precision = (2); if (flags & (1U<<(LEFT))) precision = 1; l = ruby_snprintf(s, endp - s, ((padding == '0' || (!padding && ((*format == 'd') ? '0' : ' ') == '0')) ? "%0*d": "%*d"), precision, (v)); if (l < 0) goto err; s += l; } while (0);
     continue;

   case 'F':
     do { i = date_strftime_with_tmx(s, endp - s, ("%Y-%m-%d"), tmx); if (!i) return 0; if (flags & (1U<<(UPPER))) upcase(s, i); if (!(flags & (1U<<(LEFT))) && precision > i) { if (start + maxsize < s + precision) { (*__errno_location ()) = 34; return 0; } memmove(s + precision - i, s, i); memset(s, padding ? padding : ' ', precision - i); s += precision; } else s += i; } while (0);
     continue;

   case 'G':
   case 'Y':
     {
  VALUE year = (*format == 'G') ? (tmx->funcs->cwyear)(tmx->dat) : (tmx->funcs->year)(tmx->dat);
  if ((((int)(long)(year))&RUBY_FIXNUM_FLAG)) {
      long y = ((long)(((long)(year))>>(int)(1)));
      do { int l; if (precision <= 0) precision = (0 <= y ? 4 : 5); if (flags & (1U<<(LEFT))) precision = 1; l = ruby_snprintf(s, endp - s, ((padding == '0' || (!padding && ('0') == '0')) ? "%0*ld": "%*ld"), precision, (y)); if (l < 0) goto err; s += l; } while (0);
  }
  else {
      do { VALUE tmp = (year); if ((((int)(long)(tmp))&RUBY_FIXNUM_FLAG)) { do { int l; if (precision <= 0) precision = ((4)); if (flags & (1U<<(LEFT))) precision = 1; l = ruby_snprintf(s, endp - s, ((padding == '0' || (!padding && (('0')) == '0')) ? "%0*ld": "%*ld"), precision, (((long)(((long)(tmp))>>(int)(1))))); if (l < 0) goto err; s += l; } while (0); } else { VALUE args[2], result; size_t l; if (precision <= 0) precision = (4); if (flags & (1U<<(LEFT))) precision = 1; args[0] = (((VALUE)(precision))<<1 | RUBY_FIXNUM_FLAG); args[1] = (year); if (padding == '0' || (!padding && ('0') == '0')) result = rb_str_format(2, args,  ({ (__builtin_constant_p("%0*d")) ? rb_str_new_static(("%0*d"), (long)strlen("%0*d")) : rb_str_new_cstr("%0*d"); })); else result = rb_str_format(2, args,  ({ (__builtin_constant_p("%*d")) ? rb_str_new_static(("%*d"), (long)strlen("%*d")) : rb_str_new_cstr("%*d"); })); l = strlcpy(s, rb_string_value_cstr(&(result)), endp - s); if ((size_t)(endp - s) <= l) goto err; s += l; } } while (0);
  }
     }
     continue;
   ...
   case 'g':
   case 'y':
     v = rb_num2int_inline((rb_funcall(((*format == 'g') ? (tmx->funcs->cwyear)(tmx->dat) : (tmx->funcs->year)(tmx->dat)), '%', 1, ((((VALUE)(100))<<1 | RUBY_FIXNUM_FLAG)))));
     do { int l; if (precision <= 0) precision = (2); if (flags & (1U<<(LEFT))) precision = 1; l = ruby_snprintf(s, endp - s, ((padding == '0' || (!padding && ('0') == '0')) ? "%0*d": "%*d"), precision, (v)); if (l < 0) goto err; s += l; } while (0);
     continue;

   case 'H':
   case 'k':
     v = ((tmx->funcs->hour)(tmx->dat));
     do { int l; if (precision <= 0) precision = (2); if (flags & (1U<<(LEFT))) precision = 1; l = ruby_snprintf(s, endp - s, ((padding == '0' || (!padding && ((*format == 'H') ? '0' : ' ') == '0')) ? "%0*d": "%*d"), precision, (v)); if (l < 0) goto err; s += l; } while (0);
     continue;
  ...
  v -= 12;
     do { int l; if (precision <= 0) precision = (2); if (flags & (1U<<(LEFT))) precision = 1; l = ruby_snprintf(s, endp - s, ((padding == '0' || (!padding && ((*format == 'I') ? '0' : ' ') == '0')) ? "%0*d": "%*d"), precision, (v)); if (l < 0) goto err; s += l; } while (0);
     continue;

   case 'j':
     v = ((tmx->funcs->yday)(tmx->dat));
     do { int l; if (precision <= 0) precision = (3); if (flags & (1U<<(LEFT))) precision = 1; l = ruby_snprintf(s, endp - s, ((padding == '0' || (!padding && ('0') == '0')) ? "%0*d": "%*d"), precision, (v)); if (l < 0) goto err; s += l; } while (0);
     continue;
  ...
  w = 9;
     if (precision <= 0)
  precision = w;
     do if (s >= endp || (precision) >= endp - s - 1) goto err; while (0);

     {
  VALUE subsec = (tmx->funcs->sec_fraction)(tmx->dat);
  int ww;
  long n;
  ...
  if ((((int)(long)(subsec))&RUBY_FIXNUM_FLAG)) {
      (void)ruby_snprintf(s, endp - s, "%0*ld",
       precision, ((long)(((long)(subsec))>>(int)(1))));
      s += precision;
  }
  else {
      VALUE args[2], result;
      ...
      args[1] = subsec;
      result = rb_str_format(2, args,  ({ (__builtin_constant_p("%0*d")) ? rb_str_new_static(("%0*d"), (long)strlen("%0*d")) : rb_str_new_cstr("%0*d"); }));
   ...
   case 'M':
     v = ((tmx->funcs->min)(tmx->dat));
     do { int l; if (precision <= 0) precision = (2); if (flags & (1U<<(LEFT))) precision = 1; l = ruby_snprintf(s, endp - s, ((padding == '0' || (!padding && ('0') == '0')) ? "%0*d": "%*d"), precision, (v)); if (l < 0) goto err; s += l; } while (0);
     continue;

   case 'm':
     v = ((tmx->funcs->mon)(tmx->dat));
     do { int l; if (precision <= 0) precision = (2); if (flags & (1U<<(LEFT))) precision = 1; l = ruby_snprintf(s, endp - s, ((padding == '0' || (!padding && ('0') == '0')) ? "%0*d": "%*d"), precision, (v)); if (l < 0) goto err; s += l; } while (0);
     continue;

   case 'n':
     do { if (!(flags & (1U<<(LEFT))) && precision > (1)) { do if (s >= endp || (precision) >= endp - s - 1) goto err; while (0); memset(s, padding ? padding : ' ', precision - (1)); s += precision - (1); } else { do if (s >= endp || (1) >= endp - s - 1) goto err; while (0); } } while (0);;
     *s++ = '\n';
     continue;
  ...
  tp = ampm[1];
   ...
   case 'Q':
     do { VALUE tmp = ((tmx->funcs->msecs)(tmx->dat)); if ((((int)(long)(tmp))&RUBY_FIXNUM_FLAG)) { do { int l; if (precision <= 0) precision = ((1)); if (flags & (1U<<(LEFT))) precision = 1; l = ruby_snprintf(s, endp - s, ((padding == '0' || (!padding && (('0')) == '0')) ? "%0*ld": "%*ld"), precision, (((long)(((long)(tmp))>>(int)(1))))); if (l < 0) goto err; s += l; } while (0); } else { VALUE args[2], result; size_t l; if (precision <= 0) precision = (1); if (flags & (1U<<(LEFT))) precision = 1; args[0] = (((VALUE)(precision))<<1 | RUBY_FIXNUM_FLAG); args[1] = ((tmx->funcs->msecs)(tmx->dat)); if (padding == '0' || (!padding && ('0') == '0')) result = rb_str_format(2, args,  ({ (__builtin_constant_p("%0*d")) ? rb_str_new_static(("%0*d"), (long)strlen("%0*d")) : rb_str_new_cstr("%0*d"); })); else result = rb_str_format(2, args,  ({ (__builtin_constant_p("%*d")) ? rb_str_new_static(("%*d"), (long)strlen("%*d")) : rb_str_new_cstr("%*d"); })); l = strlcpy(s, rb_string_value_cstr(&(result)), endp - s); if ((size_t)(endp - s) <= l) goto err; s += l; } } while (0);
     continue;

   case 'R':
     do { i = date_strftime_with_tmx(s, endp - s, ("%H:%M"), tmx); if (!i) return 0; if (flags & (1U<<(UPPER))) upcase(s, i); if (!(flags & (1U<<(LEFT))) && precision > i) { if (start + maxsize < s + precision) { (*__errno_location ()) = 34; return 0; } memmove(s + precision - i, s, i); memset(s, padding ? padding : ' ', precision - i); s += precision; } else s += i; } while (0);
     continue;

   case 'r':
     do { i = date_strftime_with_tmx(s, endp - s, ("%I:%M:%S %p"), tmx); if (!i) return 0; if (flags & (1U<<(UPPER))) upcase(s, i); if (!(flags & (1U<<(LEFT))) && precision > i) { if (start + maxsize < s + precision) { (*__errno_location ()) = 34; return 0; } memmove(s + precision - i, s, i); memset(s, padding ? padding : ' ', precision - i); s += precision; } else s += i; } while (0);
     continue;

   case 'S':
     v = ((tmx->funcs->sec)(tmx->dat));
     do { int l; if (precision <= 0) precision = (2); if (flags & (1U<<(LEFT))) precision = 1; l = ruby_snprintf(s, endp - s, ((padding == '0' || (!padding && ('0') == '0')) ? "%0*d": "%*d"), precision, (v)); if (l < 0) goto err; s += l; } while (0);
     continue;

   case 's':
     do { VALUE tmp = ((tmx->funcs->secs)(tmx->dat)); if ((((int)(long)(tmp))&RUBY_FIXNUM_FLAG)) { do { int l; if (precision <= 0) precision = ((1)); if (flags & (1U<<(LEFT))) precision = 1; l = ruby_snprintf(s, endp - s, ((padding == '0' || (!padding && (('0')) == '0')) ? "%0*ld": "%*ld"), precision, (((long)(((long)(tmp))>>(int)(1))))); if (l < 0) goto err; s += l; } while (0); } else { VALUE args[2], result; size_t l; if (precision <= 0) precision = (1); if (flags & (1U<<(LEFT))) precision = 1; args[0] = (((VALUE)(precision))<<1 | RUBY_FIXNUM_FLAG); args[1] = ((tmx->funcs->secs)(tmx->dat)); if (padding == '0' || (!padding && ('0') == '0')) result = rb_str_format(2, args,  ({ (__builtin_constant_p("%0*d")) ? rb_str_new_static(("%0*d"), (long)strlen("%0*d")) : rb_str_new_cstr("%0*d"); })); else result = rb_str_format(2, args,  ({ (__builtin_constant_p("%*d")) ? rb_str_new_static(("%*d"), (long)strlen("%*d")) : rb_str_new_cstr("%*d"); })); l = strlcpy(s, rb_string_value_cstr(&(result)), endp - s); if ((size_t)(endp - s) <= l) goto err; s += l; } } while (0);
     continue;

   case 'T':
     do { i = date_strftime_with_tmx(s, endp - s, ("%H:%M:%S"), tmx); if (!i) return 0; if (flags & (1U<<(UPPER))) upcase(s, i); if (!(flags & (1U<<(LEFT))) && precision > i) { if (start + maxsize < s + precision) { (*__errno_location ()) = 34; return 0; } memmove(s + precision - i, s, i); memset(s, padding ? padding : ' ', precision - i); s += precision; } else s += i; } while (0);
     continue;

   case 'U':
   case 'W':
     v = ((*format == 'U') ? (tmx->funcs->wnum0)(tmx->dat) : (tmx->funcs->wnum1)(tmx->dat));
     do { int l; if (precision <= 0) precision = (2); if (flags & (1U<<(LEFT))) precision = 1; l = ruby_snprintf(s, endp - s, ((padding == '0' || (!padding && ('0') == '0')) ? "%0*d": "%*d"), precision, (v)); if (l < 0) goto err; s += l; } while (0);
     continue;

   case 'u':
     v = ((tmx->funcs->cwday)(tmx->dat));
     do { int l; if (precision <= 0) precision = (1); if (flags & (1U<<(LEFT))) precision = 1; l = ruby_snprintf(s, endp - s, ((padding == '0' || (!padding && ('0') == '0')) ? "%0*d": "%*d"), precision, (v)); if (l < 0) goto err; s += l; } while (0);
     continue;

   case 'V':
     v = ((tmx->funcs->cweek)(tmx->dat));
     do { int l; if (precision <= 0) precision = (2); if (flags & (1U<<(LEFT))) precision = 1; l = ruby_snprintf(s, endp - s, ((padding == '0' || (!padding && ('0') == '0')) ? "%0*d": "%*d"), precision, (v)); if (l < 0) goto err; s += l; } while (0);
     continue;

   case 'v':
     do { i = date_strftime_with_tmx(s, endp - s, ("%e-%b-%Y"), tmx); if (!i) return 0; if (flags & (1U<<(UPPER))) upcase(s, i); if (!(flags & (1U<<(LEFT))) && precision > i) { if (start + maxsize < s + precision) { (*__errno_location ()) = 34; return 0; } memmove(s + precision - i, s, i); memset(s, padding ? padding : ' ', precision - i); s += precision; } else s += i; } while (0);
     continue;

   case 'w':
     v = ((tmx->funcs->wday)(tmx->dat));
     do { int l; if (precision <= 0) precision = (1); if (flags & (1U<<(LEFT))) precision = 1; l = ruby_snprintf(s, endp - s, ((padding == '0' || (!padding && ('0') == '0')) ? "%0*d": "%*d"), precision, (v)); if (l < 0) goto err; s += l; } while (0);
     continue;
  ...
  flags |= (1U<<(LOWER));
     ...
     {
  char *zone = (tmx->funcs->zone)(tmx->dat);
  if (zone == ((void*)0))
      tp = "";
  else
      tp = zone;
  ...
  if ((aoff / 3600) < 10)
      ...
      hl = 2;
  hw = 2;
  if (flags & (1U<<(LEFT)) && hl == 1)
      hw = 1;

  switch (colons) {
    case 0:
      precision = precision <= (3 + hw) ? hw : precision - 3;
      do if (s >= endp || (precision + 3) >= endp - s - 1) goto err; while (0);
      break;

    case 1:
      precision = precision <= (4 + hw) ? hw : precision - 4;
      do if (s >= endp || (precision + 4) >= endp - s - 1) goto err; while (0);
      break;

    case 2:
      precision = precision <= (7 + hw) ? hw : precision - 7;
      do if (s >= endp || (precision + 7) >= endp - s - 1) goto err; while (0);
      break;
  ...
  if (padding == ' ' && precision > hl) {
      i = ruby_snprintf(s, endp - s, "%*s", precision - hl, "");
      precision = hl;
      if (i < 0) goto err;
      s += i;
  }
  ...
  i = ruby_snprintf(s, endp - s, "%.*ld", precision, off / 3600);
  if (i < 0) goto err;
  s += i;
  off = off % 3600;
  if (colons == 3 && off == 0)
  ...
  if (2 <= colons) {
   ...
   case '+':
     do { i = date_strftime_with_tmx(s, endp - s, ("%a %b %e %H:%M:%S %Z %Y"), tmx); if (!i) return 0; if (flags & (1U<<(UPPER))) upcase(s, i); if (!(flags & (1U<<(LEFT))) && precision > i) { if (start + maxsize < s + precision) { (*__errno_location ()) = 34; return 0; } memmove(s + precision - i, s, i); memset(s, padding ? padding : ' ', precision - i); s += precision; } else s += i; } while (0);
     continue;
  ...
  format -= l;
   ...
   case '_':
     do { if (precision > 0 || flags & ((1U<<(LOCALE_E)) | (1U<<(LOCALE_O)) | (1U<<(COLONS)))) goto unknown; } while (0);
     padding = ' ';
     goto again;
  ...
  if (prec > 2147483647 || prec > maxsize) {
      (*__errno_location ()) = 34;
      return 0;
  }
  precision = (int)prec;
 ...
 if (i) {
     do { if (!(flags & (1U<<(LEFT))) && precision > (i)) { do if (s >= endp || (precision) >= endp - s - 1) goto err; while (0); memset(s, padding ? padding : ' ', precision - (i)); s += precision - (i); } else { do if (s >= endp || (i) >= endp - s - 1) goto err; while (0); } } while (0);;
     memcpy(s, tp, i);
