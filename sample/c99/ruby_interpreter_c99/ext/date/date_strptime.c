...
num_pattern_p(const char *s)
{
 ...
 if (*s &&
     (strchr("CDdeFGgHIjkLlMmNQRrSsTUuVvWwXxYy", *s) ||
      ((*__ctype_b_loc ())[(int) (((unsigned char)*s))] & (unsigned short int) _ISdigit)))
     return 1;
    }
    return 0;
}
...
read_digits(const char *s, VALUE *n, size_t width)
{
 ...
 l = width;
    ...
    if ((4 * l * sizeof(char)) <= (sizeof(long)*8)) {
 const char *os = s;
 long v;
 ...
 if (os == s)
     return 0;
 *n = rb_long2num_inline(v);
 return l;
    }
    else {
 VALUE vbuf = 0;
 char *s2 = ((char*)(((size_t)(l + 1) < 1024 / sizeof(char)) ? ((* ({ volatile VALUE *rb_gc_guarded_ptr = &(vbuf); ; rb_gc_guarded_ptr; })) = 0, __builtin_alloca ((size_t)(l + 1) * sizeof(char))) : rb_alloc_tmp_buffer2(&(vbuf), (long)(l + 1), sizeof(char))));
 memcpy(s2, s, l);
 s2[l] = '\0';
...
valid_range_p(VALUE v, int a, int b)
{
 ...
 int vi = ((int)rb_fix2int((VALUE)(v)));
 return !(vi < a || vi > b);
    }
    return !(rb_funcall(v, '<', 1, (((VALUE)((int)(a)))<<1 | RUBY_FIXNUM_FLAG)) || rb_funcall(v, '>', 1, (((VALUE)((int)(b)))<<1 | RUBY_FIXNUM_FLAG)));
}
   ...
   const char *fmt, size_t flen, VALUE hash)
{
 ...
 switch (fmt[fi]) {
       ...
       case ':':
  {
      ...
      for (i = 0; i < (int)(sizeof extz_pats / sizeof extz_pats[0]); i++)
   if (strncmp(extz_pats[i], &fmt[fi],
     strlen(extz_pats[i])) == 0) {
       fi += i;
       goto again;
   }
      { rb_hash_aset(hash, (rb_id2sym((__builtin_constant_p("_fail") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("_fail")), (long)strlen(("_fail"))); (ID) rb_intern_id_cache; }) : rb_intern("_fail")))), ((VALUE)RUBY_Qtrue)); return 0; };
  }
       ...
       case 'a':
  {
      ...
      for (i = 0; i < (int)(sizeof day_names / sizeof day_names[0]); i++) {
   size_t l = strlen(day_names[i]);
   if (strncasecmp(day_names[i], &str[si], l) == 0) {
       si += l;
       rb_hash_aset(hash, (rb_id2sym((__builtin_constant_p("wday") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("wday")), (long)strlen(("wday"))); (ID) rb_intern_id_cache; }) : rb_intern("wday")))), (((VALUE)(i % 7))<<1 | RUBY_FIXNUM_FLAG));
       goto matched;
   }
      }
      { rb_hash_aset(hash, (rb_id2sym((__builtin_constant_p("_fail") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("_fail")), (long)strlen(("_fail"))); (ID) rb_intern_id_cache; }) : rb_intern("_fail")))), ((VALUE)RUBY_Qtrue)); return 0; };
       ...
       case 'h':
  {
   ...
   if (strncasecmp(month_names[i], &str[si], l) == 0) {
       si += l;
       rb_hash_aset(hash, (rb_id2sym((__builtin_constant_p("mon") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("mon")), (long)strlen(("mon"))); (ID) rb_intern_id_cache; }) : rb_intern("mon")))), (((VALUE)((i % 12) + 1))<<1 | RUBY_FIXNUM_FLAG));
       goto matched;
   }
      }
      { rb_hash_aset(hash, (rb_id2sym((__builtin_constant_p("_fail") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("_fail")), (long)strlen(("_fail"))); (ID) rb_intern_id_cache; }) : rb_intern("_fail")))), ((VALUE)RUBY_Qtrue)); return 0; };
       ...
       case 'C':
  {
      ...
      if (num_pattern_p(&fmt[fi + 1]))
   { size_t l; l = read_digits(&str[si], &n, 2); if (l == 0) { rb_hash_aset(hash, (rb_id2sym((__builtin_constant_p("_fail") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("_fail")), (long)strlen(("_fail"))); (ID) rb_intern_id_cache; }) : rb_intern("_fail")))), ((VALUE)RUBY_Qtrue)); return 0; }; si += l; }
      else
   { size_t l; l = read_digits(&str[si], &n, 9223372036854775807L); if (l == 0) { rb_hash_aset(hash, (rb_id2sym((__builtin_constant_p("_fail") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("_fail")), (long)strlen(("_fail"))); (ID) rb_intern_id_cache; }) : rb_intern("_fail")))), ((VALUE)RUBY_Qtrue)); return 0; }; si += l; }
      rb_hash_aset(hash, (rb_id2sym((__builtin_constant_p("_cent") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("_cent")), (long)strlen(("_cent"))); (ID) rb_intern_id_cache; }) : rb_intern("_cent")))), n);
      goto matched;
  }

       case 'c':
  { size_t l; l = date__strptime_internal(&str[si], slen - si, "%a %b %e %H:%M:%S %Y", sizeof "%a %b %e %H:%M:%S %Y"- 1, hash); if ((!!((VALUE)(rb_hash_aref(hash, (rb_id2sym((__builtin_constant_p("_fail") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("_fail")), (long)strlen(("_fail"))); (ID) rb_intern_id_cache; }) : rb_intern("_fail")))))) != ((VALUE)RUBY_Qnil)))) return 0; si += l; };
  goto matched;

       case 'D':
  { size_t l; l = date__strptime_internal(&str[si], slen - si, "%m/%d/%y", sizeof "%m/%d/%y"- 1, hash); if ((!!((VALUE)(rb_hash_aref(hash, (rb_id2sym((__builtin_constant_p("_fail") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("_fail")), (long)strlen(("_fail"))); (ID) rb_intern_id_cache; }) : rb_intern("_fail")))))) != ((VALUE)RUBY_Qnil)))) return 0; si += l; };
  goto matched;
       ...
       case 'e':
  {
      ...
      if (str[si] == ' ') {
   si++;
   { size_t l; l = read_digits(&str[si], &n, 1); if (l == 0) { rb_hash_aset(hash, (rb_id2sym((__builtin_constant_p("_fail") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("_fail")), (long)strlen(("_fail"))); (ID) rb_intern_id_cache; }) : rb_intern("_fail")))), ((VALUE)RUBY_Qtrue)); return 0; }; si += l; };
      } else {
   { size_t l; l = read_digits(&str[si], &n, 2); if (l == 0) { rb_hash_aset(hash, (rb_id2sym((__builtin_constant_p("_fail") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("_fail")), (long)strlen(("_fail"))); (ID) rb_intern_id_cache; }) : rb_intern("_fail")))), ((VALUE)RUBY_Qtrue)); return 0; }; si += l; };
      }
   ...
   { rb_hash_aset(hash, (rb_id2sym((__builtin_constant_p("_fail") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("_fail")), (long)strlen(("_fail"))); (ID) rb_intern_id_cache; }) : rb_intern("_fail")))), ((VALUE)RUBY_Qtrue)); return 0; };
      ...
      goto matched;
       ...
       case 'F':
  { size_t l; l = date__strptime_internal(&str[si], slen - si, "%Y-%m-%d", sizeof "%Y-%m-%d"- 1, hash); if ((!!((VALUE)(rb_hash_aref(hash, (rb_id2sym((__builtin_constant_p("_fail") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("_fail")), (long)strlen(("_fail"))); (ID) rb_intern_id_cache; }) : rb_intern("_fail")))))) != ((VALUE)RUBY_Qnil)))) return 0; si += l; };
  goto matched;
       ...
       case 'G':
  {
      ...
      if (num_pattern_p(&fmt[fi + 1]))
   { size_t l; l = read_digits(&str[si], &n, 4); if (l == 0) { rb_hash_aset(hash, (rb_id2sym((__builtin_constant_p("_fail") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("_fail")), (long)strlen(("_fail"))); (ID) rb_intern_id_cache; }) : rb_intern("_fail")))), ((VALUE)RUBY_Qtrue)); return 0; }; si += l; }
      else
   { size_t l; l = read_digits(&str[si], &n, 9223372036854775807L); if (l == 0) { rb_hash_aset(hash, (rb_id2sym((__builtin_constant_p("_fail") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("_fail")), (long)strlen(("_fail"))); (ID) rb_intern_id_cache; }) : rb_intern("_fail")))), ((VALUE)RUBY_Qtrue)); return 0; }; si += l; }
      rb_hash_aset(hash, (rb_id2sym((__builtin_constant_p("cwyear") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("cwyear")), (long)strlen(("cwyear"))); (ID) rb_intern_id_cache; }) : rb_intern("cwyear")))), n);
      goto matched;
  }
       ...
       case 'g':
  {
   ...
   { rb_hash_aset(hash, (rb_id2sym((__builtin_constant_p("_fail") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("_fail")), (long)strlen(("_fail"))); (ID) rb_intern_id_cache; }) : rb_intern("_fail")))), ((VALUE)RUBY_Qtrue)); return 0; };
      rb_hash_aset(hash, (rb_id2sym((__builtin_constant_p("cwyear") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("cwyear")), (long)strlen(("cwyear"))); (ID) rb_intern_id_cache; }) : rb_intern("cwyear")))), n);
      if (!((VALUE)(rb_hash_aref(hash, (rb_id2sym((__builtin_constant_p("_cent") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("_cent")), (long)strlen(("_cent"))); (ID) rb_intern_id_cache; }) : rb_intern("_cent")))))) != ((VALUE)RUBY_Qnil)))
   rb_hash_aset(hash, (rb_id2sym((__builtin_constant_p("_cent") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("_cent")), (long)strlen(("_cent"))); (ID) rb_intern_id_cache; }) : rb_intern("_cent")))), (((VALUE)(rb_funcall(n, (__builtin_constant_p(">=") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2(((">=")), (long)strlen((">="))); (ID) rb_intern_id_cache; }) : rb_intern(">=")), 1, (((VALUE)(69))<<1 | RUBY_FIXNUM_FLAG)) ? 19 : 20))<<1 | RUBY_FIXNUM_FLAG));
       ...
       case 'j':
  {
      ...
      { size_t l; l = read_digits(&str[si], &n, 3); if (l == 0) { rb_hash_aset(hash, (rb_id2sym((__builtin_constant_p("_fail") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("_fail")), (long)strlen(("_fail"))); (ID) rb_intern_id_cache; }) : rb_intern("_fail")))), ((VALUE)RUBY_Qtrue)); return 0; }; si += l; };
      if (!valid_range_p(n, 1, 366))
   { rb_hash_aset(hash, (rb_id2sym((__builtin_constant_p("_fail") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("_fail")), (long)strlen(("_fail"))); (ID) rb_intern_id_cache; }) : rb_intern("_fail")))), ((VALUE)RUBY_Qtrue)); return 0; };
      rb_hash_aset(hash, (rb_id2sym((__builtin_constant_p("yday") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("yday")), (long)strlen(("yday"))); (ID) rb_intern_id_cache; }) : rb_intern("yday")))), n);
      goto matched;
  }
       ...
       case 'N':
  {
   ...
   si++;
      ...
      osi = si;
      if (num_pattern_p(&fmt[fi + 1]))
   { size_t l; l = read_digits(&str[si], &n, c == 'L' ? 3 : 9); if (l == 0) { rb_hash_aset(hash, (rb_id2sym((__builtin_constant_p("_fail") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("_fail")), (long)strlen(("_fail"))); (ID) rb_intern_id_cache; }) : rb_intern("_fail")))), ((VALUE)RUBY_Qtrue)); return 0; }; si += l; }
      else
   { size_t l; l = read_digits(&str[si], &n, 9223372036854775807L); if (l == 0) { rb_hash_aset(hash, (rb_id2sym((__builtin_constant_p("_fail") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("_fail")), (long)strlen(("_fail"))); (ID) rb_intern_id_cache; }) : rb_intern("_fail")))), ((VALUE)RUBY_Qtrue)); return 0; }; si += l; }
      if (sign == -1)
   n = rb_funcall(n, (__builtin_constant_p("-@") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("-@")), (long)strlen(("-@"))); (ID) rb_intern_id_cache; }) : rb_intern("-@")), 0);
      rb_hash_aset(hash, (rb_id2sym((__builtin_constant_p("sec_fraction") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("sec_fraction")), (long)strlen(("sec_fraction"))); (ID) rb_intern_id_cache; }) : rb_intern("sec_fraction")))), rb_rational_new((n), (rb_funcall((((VALUE)(10))<<1 | RUBY_FIXNUM_FLAG), (__builtin_constant_p("**") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("**")), (long)strlen(("**"))); (ID) rb_intern_id_cache; }) : rb_intern("**")), 1, rb_ulong2num_inline(si - osi)))));
       ...
       case 'M':
  {
   ...
   { rb_hash_aset(hash, (rb_id2sym((__builtin_constant_p("_fail") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("_fail")), (long)strlen(("_fail"))); (ID) rb_intern_id_cache; }) : rb_intern("_fail")))), ((VALUE)RUBY_Qtrue)); return 0; };
      rb_hash_aset(hash, (rb_id2sym((__builtin_constant_p("min") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("min")), (long)strlen(("min"))); (ID) rb_intern_id_cache; }) : rb_intern("min")))), n);
      goto matched;
  }
       ...
       case 'm':
  {
      ...
      if (!valid_range_p(n, 1, 12))
   { rb_hash_aset(hash, (rb_id2sym((__builtin_constant_p("_fail") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("_fail")), (long)strlen(("_fail"))); (ID) rb_intern_id_cache; }) : rb_intern("_fail")))), ((VALUE)RUBY_Qtrue)); return 0; };
      rb_hash_aset(hash, (rb_id2sym((__builtin_constant_p("mon") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("mon")), (long)strlen(("mon"))); (ID) rb_intern_id_cache; }) : rb_intern("mon")))), n);
      goto matched;
  }

       case 'n':
       case 't':
  { size_t l; l = date__strptime_internal(&str[si], slen - si, " ", sizeof " "- 1, hash); if ((!!((VALUE)(rb_hash_aref(hash, (rb_id2sym((__builtin_constant_p("_fail") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("_fail")), (long)strlen(("_fail"))); (ID) rb_intern_id_cache; }) : rb_intern("_fail")))))) != ((VALUE)RUBY_Qnil)))) return 0; si += l; };
  goto matched;
       ...
       case 'p':
  {
   ...
   if (strncasecmp(merid_names[i], &str[si], l) == 0) {
       si += l;
       rb_hash_aset(hash, (rb_id2sym((__builtin_constant_p("_merid") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("_merid")), (long)strlen(("_merid"))); (ID) rb_intern_id_cache; }) : rb_intern("_merid")))), (((VALUE)((i % 2) == 0 ? 0 : 12))<<1 | RUBY_FIXNUM_FLAG));
       goto matched;
   }
      }
      { rb_hash_aset(hash, (rb_id2sym((__builtin_constant_p("_fail") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("_fail")), (long)strlen(("_fail"))); (ID) rb_intern_id_cache; }) : rb_intern("_fail")))), ((VALUE)RUBY_Qtrue)); return 0; };
       ...
       case 'Q':
  {
   ...
   si++;
      ...
      if (sign == -1)
   n = rb_funcall(n, (__builtin_constant_p("-@") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("-@")), (long)strlen(("-@"))); (ID) rb_intern_id_cache; }) : rb_intern("-@")), 0);
      rb_hash_aset(hash, (rb_id2sym((__builtin_constant_p("seconds") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("seconds")), (long)strlen(("seconds"))); (ID) rb_intern_id_cache; }) : rb_intern("seconds")))), rb_rational_new((n), (rb_funcall((((VALUE)(10))<<1 | RUBY_FIXNUM_FLAG), (__builtin_constant_p("**") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("**")), (long)strlen(("**"))); (ID) rb_intern_id_cache; }) : rb_intern("**")), 1, (((VALUE)(3))<<1 | RUBY_FIXNUM_FLAG)))));
      ...
      goto matched;
       ...
       case 'R':
  { size_t l; l = date__strptime_internal(&str[si], slen - si, "%H:%M", sizeof "%H:%M"- 1, hash); if ((!!((VALUE)(rb_hash_aref(hash, (rb_id2sym((__builtin_constant_p("_fail") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("_fail")), (long)strlen(("_fail"))); (ID) rb_intern_id_cache; }) : rb_intern("_fail")))))) != ((VALUE)RUBY_Qnil)))) return 0; si += l; };
  goto matched;

       case 'r':
  { size_t l; l = date__strptime_internal(&str[si], slen - si, "%I:%M:%S %p", sizeof "%I:%M:%S %p"- 1, hash); if ((!!((VALUE)(rb_hash_aref(hash, (rb_id2sym((__builtin_constant_p("_fail") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("_fail")), (long)strlen(("_fail"))); (ID) rb_intern_id_cache; }) : rb_intern("_fail")))))) != ((VALUE)RUBY_Qnil)))) return 0; si += l; };
  goto matched;
       ...
       case 'S':
  {
   ...
   { rb_hash_aset(hash, (rb_id2sym((__builtin_constant_p("_fail") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("_fail")), (long)strlen(("_fail"))); (ID) rb_intern_id_cache; }) : rb_intern("_fail")))), ((VALUE)RUBY_Qtrue)); return 0; };
      rb_hash_aset(hash, (rb_id2sym((__builtin_constant_p("sec") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("sec")), (long)strlen(("sec"))); (ID) rb_intern_id_cache; }) : rb_intern("sec")))), n);
      goto matched;
  }
       ...
       case 's':
  {
   ...
   si++;
      ...
      if (sign == -1)
   n = rb_funcall(n, (__builtin_constant_p("-@") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("-@")), (long)strlen(("-@"))); (ID) rb_intern_id_cache; }) : rb_intern("-@")), 0);
      rb_hash_aset(hash, (rb_id2sym((__builtin_constant_p("seconds") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("seconds")), (long)strlen(("seconds"))); (ID) rb_intern_id_cache; }) : rb_intern("seconds")))), n);
      goto matched;
  }

       case 'T':
  { size_t l; l = date__strptime_internal(&str[si], slen - si, "%H:%M:%S", sizeof "%H:%M:%S"- 1, hash); if ((!!((VALUE)(rb_hash_aref(hash, (rb_id2sym((__builtin_constant_p("_fail") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("_fail")), (long)strlen(("_fail"))); (ID) rb_intern_id_cache; }) : rb_intern("_fail")))))) != ((VALUE)RUBY_Qnil)))) return 0; si += l; };
  goto matched;
       ...
       case 'W':
  {
   ...
   { rb_hash_aset(hash, (rb_id2sym((__builtin_constant_p("_fail") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("_fail")), (long)strlen(("_fail"))); (ID) rb_intern_id_cache; }) : rb_intern("_fail")))), ((VALUE)RUBY_Qtrue)); return 0; };
      rb_hash_aset(hash, (rb_id2sym((__builtin_constant_p(c == 'U' ? "wnum0": "wnum1") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2(((c == 'U' ? "wnum0": "wnum1")), (long)strlen((c == 'U' ? "wnum0": "wnum1"))); (ID) rb_intern_id_cache; }) : rb_intern(c == 'U' ? "wnum0": "wnum1")))), n);
      goto matched;
  }
       ...
       case 'u':
  {
   ...
   { rb_hash_aset(hash, (rb_id2sym((__builtin_constant_p("_fail") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("_fail")), (long)strlen(("_fail"))); (ID) rb_intern_id_cache; }) : rb_intern("_fail")))), ((VALUE)RUBY_Qtrue)); return 0; };
      rb_hash_aset(hash, (rb_id2sym((__builtin_constant_p("cwday") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("cwday")), (long)strlen(("cwday"))); (ID) rb_intern_id_cache; }) : rb_intern("cwday")))), n);
      goto matched;
  }
       ...
       case 'V':
  {
   ...
   { rb_hash_aset(hash, (rb_id2sym((__builtin_constant_p("_fail") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("_fail")), (long)strlen(("_fail"))); (ID) rb_intern_id_cache; }) : rb_intern("_fail")))), ((VALUE)RUBY_Qtrue)); return 0; };
      rb_hash_aset(hash, (rb_id2sym((__builtin_constant_p("cweek") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("cweek")), (long)strlen(("cweek"))); (ID) rb_intern_id_cache; }) : rb_intern("cweek")))), n);
      goto matched;
  }

       case 'v':
  { size_t l; l = date__strptime_internal(&str[si], slen - si, "%e-%b-%Y", sizeof "%e-%b-%Y"- 1, hash); if ((!!((VALUE)(rb_hash_aref(hash, (rb_id2sym((__builtin_constant_p("_fail") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("_fail")), (long)strlen(("_fail"))); (ID) rb_intern_id_cache; }) : rb_intern("_fail")))))) != ((VALUE)RUBY_Qnil)))) return 0; si += l; };
  goto matched;
       ...
       case 'w':
  {
   ...
   { rb_hash_aset(hash, (rb_id2sym((__builtin_constant_p("_fail") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("_fail")), (long)strlen(("_fail"))); (ID) rb_intern_id_cache; }) : rb_intern("_fail")))), ((VALUE)RUBY_Qtrue)); return 0; };
      rb_hash_aset(hash, (rb_id2sym((__builtin_constant_p("wday") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("wday")), (long)strlen(("wday"))); (ID) rb_intern_id_cache; }) : rb_intern("wday")))), n);
      goto matched;
  }
  ...
  goto matched;
       ...
       case 'Y':
    {
     ...
     { size_t l; l = read_digits(&str[si], &n, 9223372036854775807L); if (l == 0) { rb_hash_aset(hash, (rb_id2sym((__builtin_constant_p("_fail") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("_fail")), (long)strlen(("_fail"))); (ID) rb_intern_id_cache; }) : rb_intern("_fail")))), ((VALUE)RUBY_Qtrue)); return 0; }; si += l; }
      if (sign == -1)
   n = rb_funcall(n, (__builtin_constant_p("-@") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("-@")), (long)strlen(("-@"))); (ID) rb_intern_id_cache; }) : rb_intern("-@")), 0);
        rb_hash_aset(hash, (rb_id2sym((__builtin_constant_p("year") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("year")), (long)strlen(("year"))); (ID) rb_intern_id_cache; }) : rb_intern("year")))), n);
        goto matched;
    }
       ...
       case 'z':
  {
   ...
   "\\A((?:gmt|utc?)?[-+]\\d+(?:[,.:]\\d+(?::\\d+)?)?|(?-i:[[:alpha:].\\s]+)(?:standard|daylight)\\s+time\\b|(?-i:[[:alpha:]]+)(?:\\s+dst)?\\b)";
      static VALUE pat = ((VALUE)RUBY_Qnil);
      VALUE m, b;

      if (!((VALUE)(pat) != ((VALUE)RUBY_Qnil))) {
   ...
   rb_gc_register_mark_object(pat);
      ...
      b = rb_backref_get();
      rb_match_busy(b);
      m = rb_funcall(pat, (__builtin_constant_p("match") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("match")), (long)strlen(("match"))); (ID) rb_intern_id_cache; }) : rb_intern("match")), 1,  ({ (__builtin_constant_p(&str[si])) ? rb_usascii_str_new_static((&str[si]), (long)strlen(&str[si])) : rb_usascii_str_new_cstr(&str[si]); }));

      if (!!((VALUE)(m) != ((VALUE)RUBY_Qnil))) {
   VALUE s, l, o;

   s = rb_reg_nth_match(1, m);
   l = rb_funcall(m, (__builtin_constant_p("end") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("end")), (long)strlen(("end"))); (ID) rb_intern_id_cache; }) : rb_intern("end")), 1, (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG));
   o = date_zone_to_diff(s);
   si += rb_num2long_inline(l);
   rb_hash_aset(hash, (rb_id2sym((__builtin_constant_p("zone") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("zone")), (long)strlen(("zone"))); (ID) rb_intern_id_cache; }) : rb_intern("zone")))), s);
   rb_hash_aset(hash, (rb_id2sym((__builtin_constant_p("offset") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("offset")), (long)strlen(("offset"))); (ID) rb_intern_id_cache; }) : rb_intern("offset")))), o);
   rb_backref_set(b);
   goto matched;
      }
      rb_backref_set(b);
  ...
  goto matched;
       ...
       case '+':
  { size_t l; l = date__strptime_internal(&str[si], slen - si, "%a %b %e %H:%M:%S %Z %Y", sizeof "%a %b %e %H:%M:%S %Z %Y"- 1, hash); if ((!!((VALUE)(rb_hash_aref(hash, (rb_id2sym((__builtin_constant_p("_fail") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("_fail")), (long)strlen(("_fail"))); (ID) rb_intern_id_cache; }) : rb_intern("_fail")))))) != ((VALUE)RUBY_Qnil)))) return 0; si += l; };
  goto matched;
  ...
  goto matched;
   ...
   case '\f':
   case '\r':
     while (((*__ctype_b_loc ())[(int) (((unsigned char)str[si]))] & (unsigned short int) _ISspace))
  si++;
     fi++;
     break;
   default:
        ...
        const char *fmt, size_t flen, VALUE hash)
{
 ...
 s =  ({ (__builtin_constant_p(&str[si]) && __builtin_constant_p(slen - si)) ? rb_usascii_str_new_static((&str[si]), (slen - si)) : rb_usascii_str_new((&str[si]), (slen - si)); });
 rb_hash_aset(hash, (rb_id2sym((__builtin_constant_p("leftover") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("leftover")), (long)strlen(("leftover"))); (ID) rb_intern_id_cache; }) : rb_intern("leftover")))), s);
    }

    if ((!!((VALUE)(rb_hash_aref(hash, (rb_id2sym((__builtin_constant_p("_fail") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("_fail")), (long)strlen(("_fail"))); (ID) rb_intern_id_cache; }) : rb_intern("_fail")))))) != ((VALUE)RUBY_Qnil))))
 return ((VALUE)RUBY_Qnil);

    cent = rb_hash_aref(hash, (rb_id2sym((__builtin_constant_p("_cent") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("_cent")), (long)strlen(("_cent"))); (ID) rb_intern_id_cache; }) : rb_intern("_cent")))));
    if (!!((VALUE)(cent) != ((VALUE)RUBY_Qnil))) {
 VALUE year;

 year = rb_hash_aref(hash, (rb_id2sym((__builtin_constant_p("cwyear") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("cwyear")), (long)strlen(("cwyear"))); (ID) rb_intern_id_cache; }) : rb_intern("cwyear")))));
 if (!!((VALUE)(year) != ((VALUE)RUBY_Qnil)))
     rb_hash_aset(hash, (rb_id2sym((__builtin_constant_p("cwyear") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("cwyear")), (long)strlen(("cwyear"))); (ID) rb_intern_id_cache; }) : rb_intern("cwyear")))), rb_funcall(year, '+', 1, rb_funcall(cent, '*', 1, (((VALUE)(100))<<1 | RUBY_FIXNUM_FLAG))));
 year = rb_hash_aref(hash, (rb_id2sym((__builtin_constant_p("year") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("year")), (long)strlen(("year"))); (ID) rb_intern_id_cache; }) : rb_intern("year")))));
 if (!!((VALUE)(year) != ((VALUE)RUBY_Qnil)))
     rb_hash_aset(hash, (rb_id2sym((__builtin_constant_p("year") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("year")), (long)strlen(("year"))); (ID) rb_intern_id_cache; }) : rb_intern("year")))), rb_funcall(year, '+', 1, rb_funcall(cent, '*', 1, (((VALUE)(100))<<1 | RUBY_FIXNUM_FLAG))));
 rb_hash_delete(hash, (rb_id2sym((__builtin_constant_p("_cent") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("_cent")), (long)strlen(("_cent"))); (ID) rb_intern_id_cache; }) : rb_intern("_cent")))));
    }

    merid = rb_hash_aref(hash, (rb_id2sym((__builtin_constant_p("_merid") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("_merid")), (long)strlen(("_merid"))); (ID) rb_intern_id_cache; }) : rb_intern("_merid")))));
    if (!!((VALUE)(merid) != ((VALUE)RUBY_Qnil))) {
 VALUE hour;

 hour = rb_hash_aref(hash, (rb_id2sym((__builtin_constant_p("hour") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("hour")), (long)strlen(("hour"))); (ID) rb_intern_id_cache; }) : rb_intern("hour")))));
 if (!!((VALUE)(hour) != ((VALUE)RUBY_Qnil))) {
     hour = rb_funcall(hour, '%', 1, (((VALUE)(12))<<1 | RUBY_FIXNUM_FLAG));
     rb_hash_aset(hash, (rb_id2sym((__builtin_constant_p("hour") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("hour")), (long)strlen(("hour"))); (ID) rb_intern_id_cache; }) : rb_intern("hour")))), rb_funcall(hour, '+', 1, merid));
 }
 rb_hash_delete(hash, (rb_id2sym((__builtin_constant_p("_merid") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("_merid")), (long)strlen(("_merid"))); (ID) rb_intern_id_cache; }) : rb_intern("_merid")))));
    }
