...
init_inetsock_internal(struct inetsock_arg *arg)
{
    ...
    if (type != 1 && (!!((VALUE)(arg->local.host) != ((VALUE)RUBY_Qnil)) || !!((VALUE)(arg->local.serv) != ((VALUE)RUBY_Qnil)))) {
...
rsock_revlookup_flag(VALUE revlookup, int *norevlookup)
{
    ...
    switch (revlookup) {
      case ((VALUE)RUBY_Qtrue): {*norevlookup = (0); return 1;};
      case ((VALUE)RUBY_Qfalse): {*norevlookup = (1); return 1;};
      case ((VALUE)RUBY_Qnil): break;
      default:
 (!( (((RUBY_T_SYMBOL)) == RUBY_T_FIXNUM) ? (((int)(long)((VALUE)(revlookup)))&RUBY_FIXNUM_FLAG) : (((RUBY_T_SYMBOL)) == RUBY_T_TRUE) ? (((VALUE)(revlookup)) == ((VALUE)RUBY_Qtrue)) : (((RUBY_T_SYMBOL)) == RUBY_T_FALSE) ? (((VALUE)(revlookup)) == ((VALUE)RUBY_Qfalse)) : (((RUBY_T_SYMBOL)) == RUBY_T_NIL) ? (((VALUE)(revlookup)) == ((VALUE)RUBY_Qnil)) : (((RUBY_T_SYMBOL)) == RUBY_T_UNDEF) ? (((VALUE)(revlookup)) == ((VALUE)RUBY_Qundef)) : (((RUBY_T_SYMBOL)) == RUBY_T_SYMBOL) ? ((((VALUE)((VALUE)(revlookup))&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)((VALUE)(revlookup)) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)((VALUE)(revlookup)) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)((VALUE)(revlookup)))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : (((RUBY_T_SYMBOL)) == RUBY_T_FLOAT) ? ( ((((int)(long)((VALUE)(revlookup)))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)((VALUE)(revlookup)) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)((VALUE)(revlookup)) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)((VALUE)(revlookup)))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)((VALUE)(revlookup)) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)((VALUE)(revlookup)) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)((VALUE)(revlookup)))->flags & RUBY_T_MASK) == ((RUBY_T_SYMBOL)))) || ((RUBY_T_SYMBOL) == RUBY_T_DATA && (((struct RTypedData*)(revlookup))->typed_flag == 1)) ? rb_unexpected_type((VALUE)(revlookup), (RUBY_T_SYMBOL)) : (void)0);
 id = (rb_sym2id(revlookup));
 if (id == id_numeric) {*norevlookup = (1); return 1;};
 if (id == id_hostname) {*norevlookup = (0); return 1;};
...
ip_inspect(VALUE sock)
{
    ...
    rb_io_t *fptr = ((struct RFile*)(sock))->fptr;
    union_sockaddr addr;
 ...
 const char last = (slen > 1 && (!(((struct RBasic*)(str))->flags & RSTRING_NOEMBED) ? ((struct RString*)(str))->as.ary : ((struct RString*)(str))->as.heap.ptr)[slen - 1] == '>') ?
     (--slen, '>') : 0;
 ...
 if (!rb_getnameinfo(&addr.addr, len, hbuf, sizeof(hbuf),
      ...
      ({ (__builtin_constant_p(", ")) ? rb_str_cat((str), (", "), (long)strlen(", ")) : rb_str_cat_cstr((str), (", ")); });
      ({ (__builtin_constant_p(hbuf)) ? rb_str_cat((str), (hbuf), (long)strlen(hbuf)) : rb_str_cat_cstr((str), (hbuf)); });
      ({ (__builtin_constant_p(", ")) ? rb_str_cat((str), (", "), (long)strlen(", ")) : rb_str_cat_cstr((str), (", ")); });
      ({ (__builtin_constant_p(pbuf)) ? rb_str_cat((str), (pbuf), (long)strlen(pbuf)) : rb_str_cat_cstr((str), (pbuf)); });
 }
...
{
    union_sockaddr addr;
    struct rb_addrinfo *res = rsock_addrinfo(host, ((VALUE)RUBY_Qnil), 0, SOCK_STREAM, 0);
...
rsock_init_ipsocket(void)
{
    ...
    id_numeric = (__builtin_constant_p("numeric") ?  (rb_intern2(("numeric"), (long)strlen("numeric"))) : (rb_intern)("numeric"));
    id_hostname = (__builtin_constant_p("hostname") ?  (rb_intern2(("hostname"), (long)strlen("hostname"))) : (rb_intern)("hostname"));
}
