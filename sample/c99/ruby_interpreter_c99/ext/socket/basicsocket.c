...
{
    rb_io_t *fptr;
    VALUE sock = rsock_init_sock(rb_obj_alloc(klass), rb_num2int_inline(fd));
...
bsock_setsockopt(int argc, VALUE *argv, VALUE sock)
{
    ...
    if (argc == 1) {
        lev = rb_funcall(argv[0], (__builtin_constant_p("level") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("level")), (long)strlen(("level"))); (ID) rb_intern_id_cache; }) : rb_intern("level")), 0);
        optname = rb_funcall(argv[0], (__builtin_constant_p("optname") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("optname")), (long)strlen(("optname"))); (ID) rb_intern_id_cache; }) : rb_intern("optname")), 0);
        val = rb_funcall(argv[0], (__builtin_constant_p("data") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("data")), (long)strlen(("data"))); (ID) rb_intern_id_cache; }) : rb_intern("data")), 0);
    }
    else {
 ...
 break;
      default:
 rb_string_value(&(val));
 v = (!(((struct RBasic*)(val))->flags & RSTRING_NOEMBED) ? ((struct RString*)(val))->as.ary : ((struct RString*)(val))->as.heap.ptr);
 vlen = (socklen_t)rb_long2int_inline((!(((struct RBasic*)(val))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(val))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(val))->as.heap.len));
 break;
    }
...
bsock_getsockopt(VALUE sock, VALUE lev, VALUE optname)
{
    ...
    option = rsock_optname_arg(family, level, optname);
    len = 256;
    buf = ((char*)__builtin_alloca (sizeof(char)*(len)));
 ...
 rsock_sys_fail_path("getsockopt(2)", fptr->pathv);
    ...
    return rsock_sockopt_new(family, level, option,  ({ (__builtin_constant_p(buf) && __builtin_constant_p(len)) ? rb_str_new_static((buf), (len)) : rb_str_new((buf), (len)); }));
}
static VALUE
bsock_getsockname(VALUE sock)
{
 ...
 rb_sys_fail("getsockname(2)");
    ...
    return  ({ (__builtin_constant_p((char*)&buf) && __builtin_constant_p(len)) ? rb_str_new_static(((char*)&buf), (len)) : rb_str_new(((char*)&buf), (len)); });
}
static VALUE
...
bsock_getpeereid(VALUE self)
{
    ...
    rb_io_check_closed((fptr) = ((struct RFile*)(rb_io_taint_check(self)))->fptr);
    if (getsockopt(fptr->fd, 1, 17, &cred, &len) == -1)
 rb_sys_fail("getsockopt(SO_PEERCRED)");
    return rb_assoc_new((((VALUE)((unsigned int)(cred.uid)))<<1 | RUBY_FIXNUM_FLAG), (((VALUE)((unsigned int)(cred.gid)))<<1 | RUBY_FIXNUM_FLAG));
}
static VALUE
...
rsock_bsock_send(int argc, VALUE *argv, VALUE sock)
{
    ...
    rb_string_value(&(arg.mesg));
    if (!!((VALUE)(to) != ((VALUE)RUBY_Qnil))) {
 rsock_sockaddr_string_value(&(to));
 to = rb_str_new_frozen(to);
 arg.to = (struct sockaddr *)(!(((struct RBasic*)(to))->flags & RSTRING_NOEMBED) ? ((struct RString*)(to))->as.ary : ((struct RString*)(to))->as.heap.ptr);
 arg.tolen = (socklen_t)rb_long2int_inline((!(((struct RBasic*)(to))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(to))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(to))->as.heap.len));
 ...
 funcname = "send(2)";
    ...
    rb_io_check_closed((fptr) = ((struct RFile*)(rb_io_taint_check(sock)))->fptr);
    arg.fd = fptr->fd;
    arg.flags = rb_num2int_inline(flags);
    while (rsock_maybe_fd_writable(arg.fd),
    (n = (ssize_t)(long)rb_thread_io_blocking_region((func), (&arg), (&arg)->fd)) < 0) {
...
bsock_do_not_reverse_lookup(VALUE sock)
{
    ...
    rb_io_check_closed((fptr) = ((struct RFile*)(rb_io_taint_check(sock)))->fptr);
    return (fptr->mode & 0x100) ? ((VALUE)RUBY_Qtrue) : ((VALUE)RUBY_Qfalse);
}
static VALUE
bsock_do_not_reverse_lookup_set(VALUE sock, VALUE state)
{
    ...
    rb_io_check_closed((fptr) = ((struct RFile*)(rb_io_taint_check(sock)))->fptr);
    if (!(((VALUE)(state) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) {
 fptr->mode |= 0x100;
    }
    else {
 fptr->mode &= ~0x100;
...
{
    return rsock_do_not_reverse_lookup?((VALUE)RUBY_Qtrue):((VALUE)RUBY_Qfalse);
}
static VALUE
bsock_do_not_rev_lookup_set(VALUE self, VALUE val)
{
    rsock_do_not_reverse_lookup = !(((VALUE)(val) & (VALUE)~((VALUE)RUBY_Qnil)) == 0);
    return val;
}
