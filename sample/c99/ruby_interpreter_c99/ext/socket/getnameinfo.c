...
int
getnameinfo__compat(const struct sockaddr *sa, socklen_t salen, char *host, socklen_t hostlen, char *serv, socklen_t servlen, int flags)
{
 struct afd *afd;
 struct hostent *hp;
 u_short port;
 ...
 if (!((void)(sa), (void)(salen), 1)) return 6;
        len = salen;
 ...
 if (serv == ((void*)0) || servlen == 0) {
  ...
  ruby_snprintf(numserv, sizeof(numserv), "%d", ntohs(port));
 ...
 case 2:
  ...
  if (((((in_addr_t)(v4a)) & 0xf0000000) == 0xe0000000) || ((((in_addr_t)(v4a)) & 0xe0000000) == 0xe0000000))
   flags |= 0x00000002;
  v4a >>= 24;
  if (v4a == 0)
   flags |= 0x00000002;
