...
{
    rsock_syserr_fail_host_port((*__errno_location ()), mesg, host, port);
}
...
rsock_syserr_fail_host_port(int err, const char *mesg, VALUE host, VALUE port)
{
    ...
    message = rb_sprintf("%s for %+li\v port % li\v",
    mesg, host, port);
...
{
    rsock_syserr_fail_path((*__errno_location ()), mesg, path);
}
...
rsock_syserr_fail_path(int err, const char *mesg, VALUE path)
{
 ...
 message = rb_sprintf("%s for % li\v", mesg, path);
 rb_syserr_fail_str(err, message);
    }
    else {
...
{
    rsock_syserr_fail_sockaddr((*__errno_location ()), mesg, addr, len);
}
...
rsock_syserr_fail_sockaddr(int err, const char *mesg, struct sockaddr *addr, socklen_t len)
{
    ...
    rai = rsock_addrinfo_new(addr, len, 0, 0, 0, ((VALUE)RUBY_Qnil), ((VALUE)RUBY_Qnil));
...
{
    rsock_syserr_fail_raddrinfo((*__errno_location ()), mesg, rai);
}
...
rsock_syserr_fail_raddrinfo(int err, const char *mesg, VALUE rai)
{
    ...
    message = rb_sprintf("%s for %li\v", mesg, str);
...
{
    rsock_syserr_fail_raddrinfo_or_sockaddr((*__errno_location ()), mesg, addr, rai);
}

void
rsock_syserr_fail_raddrinfo_or_sockaddr(int err, const char *mesg, VALUE addr, VALUE rai)
{
    if (!((VALUE)(rai) != ((VALUE)RUBY_Qnil))) {
        rb_string_value(&(addr));

 rsock_syserr_fail_sockaddr(err, mesg,
            (struct sockaddr *)(!(((struct RBasic*)(addr))->flags & RSTRING_NOEMBED) ? ((struct RString*)(addr))->as.ary : ((struct RString*)(addr))->as.heap.ptr),
            (socklen_t)(!(((struct RBasic*)(addr))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(addr))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(addr))->as.heap.len));
    }
    else
 rsock_syserr_fail_raddrinfo(err, mesg, rai);
}
...
sock_initialize(int argc, VALUE *argv, VALUE sock)
{
    ...
    fd = rsock_socket(d, t, rb_num2int_inline(protocol));
...
sock_connect(VALUE sock, VALUE addr)
{
    ...
    rsock_sockaddr_string_value_with_addrinfo(&(addr), &(rai));
    addr = rb_str_new_frozen(addr);
    rb_io_check_closed((fptr) = ((struct RFile*)(rb_io_taint_check(sock)))->fptr);
    fd = fptr->fd;
    n = rsock_connect(fd, (struct sockaddr*)(!(((struct RBasic*)(addr))->flags & RSTRING_NOEMBED) ? ((struct RString*)(addr))->as.ary : ((struct RString*)(addr))->as.heap.ptr), (socklen_t)rb_long2int_inline((!(((struct RBasic*)(addr))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(addr))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(addr))->as.heap.len)), 0);
    if (n < 0) {
...
sock_connect_nonblock(VALUE sock, VALUE addr, VALUE ex)
{
    ...
    n = connect(fptr->fd, (struct sockaddr*)(!(((struct RBasic*)(addr))->flags & RSTRING_NOEMBED) ? ((struct RString*)(addr))->as.ary : ((struct RString*)(addr))->as.heap.ptr), (socklen_t)rb_long2int_inline((!(((struct RBasic*)(addr))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(addr))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(addr))->as.heap.len)));
    if (n < 0) {
...
sock_bind(VALUE sock, VALUE addr)
{
    ...
    rsock_sockaddr_string_value_with_addrinfo(&(addr), &(rai));
    rb_io_check_closed((fptr) = ((struct RFile*)(rb_io_taint_check(sock)))->fptr);
    if (bind(fptr->fd, (struct sockaddr*)(!(((struct RBasic*)(addr))->flags & RSTRING_NOEMBED) ? ((struct RString*)(addr))->as.ary : ((struct RString*)(addr))->as.heap.ptr), (socklen_t)rb_long2int_inline((!(((struct RBasic*)(addr))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(addr))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(addr))->as.heap.len))) < 0)
...
sock_accept_nonblock(VALUE sock, VALUE ex)
{
    ...
    if (((((VALUE)(sock2)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(sock2) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(sock2) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(sock2))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))))
 return sock2;
    return rb_assoc_new(sock2, rsock_io_socket_addrinfo(sock2, &buf.addr, len));
}
static VALUE
...
make_addrinfo(struct rb_addrinfo *res0, int norevlookup)
{
 ...
 if (res->ai_canonname) {
     do { const VALUE _ary = (ary); VALUE *ptr = (VALUE *)((VALUE *)rb_array_const_ptr(_ary)); rb_obj_write((VALUE)(_ary), (VALUE *)(&ptr[2]), (VALUE)(( ({ (__builtin_constant_p(res->ai_canonname)) ? rb_str_new_static((res->ai_canonname), (long)strlen(res->ai_canonname)) : rb_str_new_cstr(res->ai_canonname); }))), "ext/socket/socket.c", 949); ; } while (0);
 }
 rb_ary_push(ary, (((VALUE)(res->ai_family))<<1 | RUBY_FIXNUM_FLAG));
 rb_ary_push(ary, (((VALUE)(res->ai_socktype))<<1 | RUBY_FIXNUM_FLAG));
 rb_ary_push(ary, (((VALUE)(res->ai_protocol))<<1 | RUBY_FIXNUM_FLAG));
...
sock_sockaddr(struct sockaddr *addr, socklen_t len)
{
 ...
 break;
      ...
      case 10:
 ptr = (char*)&((struct sockaddr_in6*)addr)->sin6_addr.__in6_u.__u6_addr8;
 len = (socklen_t)sizeof(((struct sockaddr_in6*)addr)->sin6_addr.__in6_u.__u6_addr8);
 break;
 ...
 break;
    ...
    return  ({ (__builtin_constant_p(ptr) && __builtin_constant_p(len)) ? rb_str_new_static((ptr), (len)) : rb_str_new((ptr), (len)); });
}
static VALUE
sock_s_gethostbyname(VALUE obj, VALUE host)
{
    struct rb_addrinfo *res =
 rsock_addrinfo(host, ((VALUE)RUBY_Qnil), 0, SOCK_STREAM, 0x00000002);
...
sock_s_gethostbyaddr(int argc, VALUE *argv)
{
    ...
    rb_string_value(&(addr));
    if (!!((VALUE)(family) != ((VALUE)RUBY_Qnil))) {
 t = rsock_family_arg(family);
    }

    else if ((!(((struct RBasic*)(addr))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(addr))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(addr))->as.heap.len) == 16) {
 t = 10;
    }

    h = gethostbyaddr((!(((struct RBasic*)(addr))->flags & RSTRING_NOEMBED) ? ((struct RString*)(addr))->as.ary : ((struct RString*)(addr))->as.heap.ptr), (socklen_t)rb_long2int_inline((!(((struct RBasic*)(addr))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(addr))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(addr))->as.heap.len)), t);
    if (h == ((void*)0)) {
 ...
 rb_raise(rb_eSocket, "host not found");
    ...
    ary = rb_ary_new();
    rb_ary_push(ary,  ({ (__builtin_constant_p(h->h_name)) ? rb_str_new_static((h->h_name), (long)strlen(h->h_name)) : rb_str_new_cstr(h->h_name); }));
    names = rb_ary_new();
 ...
 for (pch = h->h_aliases; *pch; pch++) {
    ...
    rb_ary_push(ary, (((VALUE)((int)(h->h_addrtype)))<<1 | RUBY_FIXNUM_FLAG));

    for (pch = h->h_addr_list; *pch; pch++) {
 rb_ary_push(ary,  ({ (__builtin_constant_p(*pch) && __builtin_constant_p(h->h_length)) ? rb_str_new_static((*pch), (h->h_length)) : rb_str_new((*pch), (h->h_length)); }));
    }
...
sock_s_getservbyname(int argc, VALUE *argv)
{
    ...
    rb_string_value(&(service));
    if (!!((VALUE)(proto) != ((VALUE)RUBY_Qnil))) rb_string_value(&(proto));
    servicename = rb_string_value_cstr(&(service));
    if (!!((VALUE)(proto) != ((VALUE)RUBY_Qnil))) protoname = rb_string_value_cstr(&(proto));
 ...
 port = (ruby_strtoul((servicename), (&end), (0)));
 if (*end != '\0') {
     rb_raise(rb_eSocket, "no such service %s/%s", servicename, protoname);
 }
    }
    return (((VALUE)(port))<<1 | RUBY_FIXNUM_FLAG);
}
static VALUE
sock_s_getservbyport(int argc, VALUE *argv)
{
    ...
    portnum = rb_num2long_inline(port);
 ...
 rb_raise(rb_eSocket, "no such service for port %d/%s", (int)portnum, protoname);
    ...
    return  ({ (__builtin_constant_p(sp->s_name)) ? rb_tainted_str_new((sp->s_name), (long)strlen(sp->s_name)) : rb_tainted_str_new_cstr(sp->s_name); });
}
static VALUE
sock_s_getaddrinfo(int argc, VALUE *argv)
{
 ...
 hints.ai_flags = rb_num2int_inline(flags);
    ...
    if (!((VALUE)(revlookup) != ((VALUE)RUBY_Qnil)) || !rsock_revlookup_flag(revlookup, &norevlookup)) {
...
{
    VALUE sa, af = ((VALUE)RUBY_Qnil), host = ((VALUE)RUBY_Qnil), port = ((VALUE)RUBY_Qnil), flags, tmp;
    char *hptr, *pptr;
    ...
    sa = flags = ((VALUE)RUBY_Qnil);
    rb_scan_args(argc, argv, "11", &sa, &flags);

    fl = 0;
    if (!!((VALUE)(flags) != ((VALUE)RUBY_Qnil))) {
 fl = rb_num2int_inline(flags);
    }
    tmp = rb_check_sockaddr_string_type(sa);
    if (!!((VALUE)(tmp) != ((VALUE)RUBY_Qnil))) {
 sa = tmp;
 if (sizeof(ss) < (size_t)(!(((struct RBasic*)(sa))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(sa))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(sa))->as.heap.len)) {
     rb_raise(rb_eTypeError, "sockaddr length too big");
 }
 memcpy(&ss, (!(((struct RBasic*)(sa))->flags & RSTRING_NOEMBED) ? ((struct RString*)(sa))->as.ary : ((struct RString*)(sa))->as.heap.ptr), (!(((struct RBasic*)(sa))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(sa))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(sa))->as.heap.len));
        if (!((void)(&ss.addr), (void)((!(((struct RBasic*)(sa))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(sa))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(sa))->as.heap.len)), 1)) {
     rb_raise(rb_eTypeError, "sockaddr size differs - should not happen");
 }
 sap = &ss.addr;
        salen = (socklen_t)rb_long2int_inline((!(((struct RBasic*)(sa))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(sa))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(sa))->as.heap.len));
 goto call_nameinfo;
    }
 ...
 sa = tmp;
 memset((&hints), 0, sizeof(struct addrinfo)*(size_t)(1));
 if (rb_array_len(sa) == 3) {
     af = (rb_array_const_ptr(sa)[0]);
     port = (rb_array_const_ptr(sa)[1]);
     host = (rb_array_const_ptr(sa)[2]);
 }
 else if (rb_array_len(sa) >= 4) {
     af = (rb_array_const_ptr(sa)[0]);
     port = (rb_array_const_ptr(sa)[1]);
     host = (rb_array_const_ptr(sa)[3]);
 ...
 if (!((VALUE)(host) != ((VALUE)RUBY_Qnil))) {
     ...
     strncpy(hbuf, rb_string_value_cstr(&(host)), sizeof(hbuf));
 ...
 if (!((VALUE)(port) != ((VALUE)RUBY_Qnil))) {
     ...
     ruby_snprintf(pbuf, sizeof(pbuf), "%ld", rb_num2long_inline(port));
     pptr = pbuf;
 }
 else {
     strncpy(pbuf, rb_string_value_cstr(&(port)), sizeof(pbuf));
     pbuf[sizeof(pbuf) - 1] = '\0';
     pptr = pbuf;
 }
 hints.ai_socktype = (fl & 0x00000010) ? SOCK_DGRAM : SOCK_STREAM;

        hints.ai_family = !((VALUE)(af) != ((VALUE)RUBY_Qnil)) ? 0 : rsock_family_arg(af);
...
{
    struct rb_addrinfo *res = rsock_addrinfo(host, port, 0, 0, 0);
    VALUE addr =  ({ (__builtin_constant_p((char*)res->ai->ai_addr) && __builtin_constant_p(res->ai->ai_addrlen)) ? rb_str_new_static(((char*)res->ai->ai_addr), (res->ai->ai_addrlen)) : rb_str_new(((char*)res->ai->ai_addr), (res->ai->ai_addrlen)); });

    rb_freeaddrinfo(res);
    ( (((!(((VALUE)(addr) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(addr) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(addr))->flags & RUBY_T_MASK) != RUBY_T_NODE) && (int)(((struct RBasic*)(addr))->flags & RUBY_T_MASK) != RUBY_T_BIGNUM && (int)(((struct RBasic*)(addr))->flags & RUBY_T_MASK) != RUBY_T_FLOAT) && (!(((VALUE)(port) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(port) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(port))->flags & RUBY_T_MASK) != RUBY_T_NODE)) ? (void)(((struct RBasic*)(addr))->flags |= ((((struct RBasic*)(port))->flags&(RUBY_FL_TAINT)))) : (void)0);
    ( (((!(((VALUE)(addr) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(addr) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(addr))->flags & RUBY_T_MASK) != RUBY_T_NODE) && (int)(((struct RBasic*)(addr))->flags & RUBY_T_MASK) != RUBY_T_BIGNUM && (int)(((struct RBasic*)(addr))->flags & RUBY_T_MASK) != RUBY_T_FLOAT) && (!(((VALUE)(host) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(host) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(host))->flags & RUBY_T_MASK) != RUBY_T_NODE)) ? (void)(((struct RBasic*)(addr))->flags |= ((((struct RBasic*)(host))->flags&(RUBY_FL_TAINT)))) : (void)0);
...
sock_s_unpack_sockaddr_in(VALUE self, VALUE addr)
{
    ...
    sockaddr = (struct sockaddr_in*)rsock_sockaddr_string_value_ptr(&(addr));
    if ((!(((struct RBasic*)(addr))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(addr))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(addr))->as.heap.len) <
        (char*)&((struct sockaddr *)sockaddr)->sa_family +
        sizeof(((struct sockaddr *)sockaddr)->sa_family) -
        (char*)sockaddr)
        rb_raise(rb_eArgError, "too short sockaddr");
    if (((struct sockaddr *)sockaddr)->sa_family != 2
    ...
    host = rsock_make_ipaddr((struct sockaddr*)sockaddr, (socklen_t)rb_long2int_inline((!(((struct RBasic*)(addr))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(addr))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(addr))->as.heap.len)));
    ( (((!(((VALUE)(host) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(host) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(host))->flags & RUBY_T_MASK) != RUBY_T_NODE) && (int)(((struct RBasic*)(host))->flags & RUBY_T_MASK) != RUBY_T_BIGNUM && (int)(((struct RBasic*)(host))->flags & RUBY_T_MASK) != RUBY_T_FLOAT) && (!(((VALUE)(addr) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(addr) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(addr))->flags & RUBY_T_MASK) != RUBY_T_NODE)) ? (void)(((struct RBasic*)(host))->flags |= ((((struct RBasic*)(addr))->flags&(RUBY_FL_TAINT)))) : (void)0);
    return rb_assoc_new((((VALUE)((int)(ntohs(sockaddr->sin_port))))<<1 | RUBY_FIXNUM_FLAG), host);
}
static socklen_t
sockaddr_len(struct sockaddr *addr)
{
    ...
    switch (addr->sa_family) {
      ...
      case 17:
        return (socklen_t)(__builtin_offsetof() + ((struct sockaddr_ll *)addr)->sll_halen);


      default:
        return (socklen_t)(__builtin_offsetof() + sizeof(addr->sa_family));
    }
}
...
sockaddr_obj(struct sockaddr *addr, socklen_t len)
{
    ...
    return rsock_addrinfo_new(addr, len, addr->sa_family, 0, 0, ((VALUE)RUBY_Qnil), ((VALUE)RUBY_Qnil));
}
...
socket_s_ip_address_list(VALUE self)
{
    ...
    char initbuf[4096+((int)(sizeof(struct ifconf) + sizeof(union_sockaddr)))];
    char *buf = initbuf;
    int bufsize;
    struct ifconf conf;
    struct ifreq *req;
    VALUE list = ((VALUE)RUBY_Qnil);
  ...
  retry:
    ...
    if (bufsize - ((int)(sizeof(struct ifconf) + sizeof(union_sockaddr))) < conf.ifc_len) {
 if (bufsize < conf.ifc_len) {

     bufsize = conf.ifc_len + ((int)(sizeof(struct ifconf) + sizeof(union_sockaddr)));
 }
 else {
     bufsize = bufsize << 1;
 }
...
Init_socket(void)
{
    ...
    rb_define_singleton_method(rb_cSocket, "socketpair", rb_f_notimplement, -1);
    rb_define_singleton_method(rb_cSocket, "pair", rb_f_notimplement, -1);
    rb_define_singleton_method(rb_cSocket, "gethostname", rb_f_notimplement, 0);
    ...
    sym_wait_writable = (rb_id2sym(rb_intern("wait_writable")));
}
