...
rsock_raise_socket_error(const char *reason, int error)
{
    ...
    int e;
    if (error == 11 && (e = (*__errno_location ())) != 0)
...
rsock_init_sock(VALUE sock, int fd)
{
 ...
 rb_syserr_fail(9, "not a socket file descriptor");
    }

    rb_update_max_fd(fd);
    do { (fp) = rb_io_make_open_file(sock);} while (0);
    fp->fd = fd;
    fp->mode = (0x00000001|0x00000002)|0x00000020;
...
rsock_sendto_blocking(void *data)
{
    ...
    VALUE mesg = arg->mesg;
    return (VALUE)sendto(arg->fd, (!(((struct RBasic*)(mesg))->flags & RSTRING_NOEMBED) ? ((struct RString*)(mesg))->as.ary : ((struct RString*)(mesg))->as.heap.ptr), (!(((struct RBasic*)(mesg))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(mesg))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(mesg))->as.heap.len),
...
rsock_send_blocking(void *data)
{
    struct rsock_send_arg *arg = data;
    VALUE mesg = arg->mesg;
    return (VALUE)send(arg->fd, (!(((struct RBasic*)(mesg))->flags & RSTRING_NOEMBED) ? ((struct RString*)(mesg))->as.ary : ((struct RString*)(mesg))->as.heap.ptr), (!(((struct RBasic*)(mesg))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(mesg))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(mesg))->as.heap.len),
                       arg->flags);
}
...
recvfrom_blocking(void *data)
{
    ...
    ssize_t ret;
    ret = recvfrom(arg->fd, (!(((struct RBasic*)(arg->str))->flags & RSTRING_NOEMBED) ? ((struct RString*)(arg->str))->as.ary : ((struct RString*)(arg->str))->as.heap.ptr), (!(((struct RBasic*)(arg->str))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(arg->str))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(arg->str))->as.heap.len),
...
rsock_strbuf(VALUE str, long buflen)
{
    ...
    if (!((VALUE)(str) != ((VALUE)RUBY_Qnil))) return rb_tainted_str_new(0, buflen);
...
rsock_s_recvfrom(VALUE sock, int argc, VALUE *argv, enum sock_recv_type from)
{
    ...
    if (flg == ((VALUE)RUBY_Qnil)) arg.flags = 0;
    else arg.flags = rb_num2int_inline(flg);
    buflen = rb_num2int_inline(len);
 ...
 rb_raise(rb_eIOError, "recv for buffered IO");
    ...
    if (slen != (!(((struct RBasic*)(str))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(str))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(str))->as.heap.len)) {
 ...
 if (arg.alen && arg.alen != sizeof(arg.buf))
     return rb_assoc_new(str, rsock_ipaddr(&arg.buf.addr, arg.alen, fptr->mode & 0x100));
 else
     return rb_assoc_new(str, ((VALUE)RUBY_Qnil));
     ...
     VALUE ex, enum sock_recv_type from)
{
    ...
    long slen;
    int fd, flags;
    VALUE addr = ((VALUE)RUBY_Qnil);
    socklen_t len0;

    flags = rb_num2int_inline(flg);
    buflen = rb_num2int_inline(len);
    str = rsock_strbuf(str, buflen);
 ...
 rb_io_set_nonblock(fptr);
    ...
    len0 = alen;
    slen = recvfrom(fd, (!(((struct RBasic*)(str))->flags & RSTRING_NOEMBED) ? ((struct RString*)(str))->as.ary : ((struct RString*)(str))->as.heap.ptr), buflen, flags, &buf.addr, &alen);
    if (slen != -1 && len0 < alen)
        alen = len0;
    ...
    switch (from) {
      ...
      case RECV_IP:
        if (alen && alen != sizeof(buf))
            addr = rsock_ipaddr(&buf.addr, alen, fptr->mode & 0x100);
        break;
...
rsock_write_nonblock(VALUE sock, VALUE str, VALUE ex)
{
 ...
 rb_io_flush(sock);
    ...
    n = (long)send(fptr->fd, (!(((struct RBasic*)(str))->flags & RSTRING_NOEMBED) ? ((struct RString*)(str))->as.ary : ((struct RString*)(str))->as.heap.ptr), (!(((struct RBasic*)(str))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(str))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(str))->as.heap.len), MSG_DONTWAIT);
    if (n < 0) {
 int e = (*__errno_location ());

 if (e == 11 || e == 11) {
     if (ex == ((VALUE)RUBY_Qfalse)) return sym_wait_writable;
...
int rsock_detect_cloexec(int fd)
{
    ...
    if (flags == -1)
 rb_bug("rsock_detect_cloexec: fcntl(%d, F_GETFD) failed: %s", fd, strerror((*__errno_location ())));
...
rsock_socket0(int domain, int type, int proto)
{
    ...
    if (cloexec_state > 0) {
        ...
        else if (ret == -1 && (*__errno_location ()) == 22) {
...
wait_connectable(int fd)
{
    ...
    if (getsockopt(fd, 1, 4, (void *)&sockerr, &sockerrlen) < 0)
        return -1;
    revents = rb_wait_for_single_fd(fd, 0x001|0x004, ((void*)0));
...
rsock_connect(int fd, const struct sockaddr *sockaddr, int len, int socks)
{
    ...
    status = (int)(long)rb_thread_io_blocking_region((func), (&arg), (&arg)->fd);
...
rsock_s_accept(VALUE klass, int fd, struct sockaddr *sockaddr, socklen_t *len)
{
  ...
  retry:
    ...
    fd2 = (int)(long)rb_thread_io_blocking_region((accept_blocking), (&arg), (&arg)->fd);
    if (fd2 < 0) {
 int e = (*__errno_location ());
 switch (e) {
   case 24:
 ...
 rb_syserr_fail(e, "accept(2)");
    ...
    rb_update_max_fd(fd2);
    if (!klass) return (((VALUE)((int)(fd2)))<<1 | RUBY_FIXNUM_FLAG);
    return rsock_init_sock(rb_obj_alloc(klass), fd2);
}
...
rsock_getfamily(rb_io_t *fptr)
{
    ...
    int cached = fptr->mode & (0x00200000|0x00400000|0x00800000);

    if (cached) {
        switch (cached) {

     case 0x00200000: return 1;

     case 0x00400000: return 2;
     case 0x00800000: return 10;
 }
    }
    ...
    switch (ss.addr.sa_family) {
      ...
      case 1: fptr->mode |= 0x00200000; break;

      case 2: fptr->mode |= 0x00400000; break;
      case 10: fptr->mode |= 0x00800000; break;
    }
...
rsock_init_socket_init(void)
{
    ...
    sym_wait_readable = (rb_id2sym(rb_intern("wait_readable")));
