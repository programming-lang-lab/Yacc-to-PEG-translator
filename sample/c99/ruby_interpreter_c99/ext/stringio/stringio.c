...
strio_substr(struct StringIO *ptr, long pos, long len, rb_encoding *enc)
{
    ...
    long rlen = (!(((struct RBasic*)(str))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(str))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(str))->as.heap.len) - pos;

    if (len > rlen) len = rlen;
    if (len < 0) len = 0;
    if (len == 0) return  ({ (__builtin_constant_p(0) && __builtin_constant_p(0)) ? rb_enc_str_new_static((0), (0), (enc)) : rb_enc_str_new((0), (0), (enc)); });
...
{
    if ((!(!(((VALUE)(ptr->string) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(ptr->string) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(ptr->string))->flags & RUBY_T_MASK) != RUBY_T_NODE) || (((struct RBasic*)(ptr->string))->flags&RUBY_FL_FREEZE))) {
...
strio_init(int argc, VALUE *argv, struct StringIO *ptr, VALUE self)
{
    ...
    switch (rb_scan_args(argc, argv, "02", &string, &mode)) {
      case 2:
 if ((((int)(long)(mode))&RUBY_FIXNUM_FLAG)) {
     int flags = ((int)rb_fix2int((VALUE)(mode)));
     ptr->flags = rb_io_oflags_fmode(flags);
     trunc = flags & 01000;
 }
 else {
     const char *m = rb_string_value_cstr(&(mode));
     ptr->flags = rb_io_modestr_fmode(m);
     trunc = *m == 'w';
 }
 rb_string_value(&(string));
 if ((ptr->flags & 0x00000002) && (!(!(((VALUE)(string) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(string) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(string))->flags & RUBY_T_MASK) != RUBY_T_NODE) || (((struct RBasic*)(string))->flags&RUBY_FL_FREEZE))) {
     rb_syserr_fail(13, 0);
 }
 if (trunc) {
 ...
 break;
      case 1:
 rb_string_value(&(string));
 ptr->flags = (!(!(((VALUE)(string) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(string) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(string))->flags & RUBY_T_MASK) != RUBY_T_NODE) || (((struct RBasic*)(string))->flags&RUBY_FL_FREEZE)) ? 0x00000001 : (0x00000001|0x00000002);
 break;
      case 0:
 string =  ({ (__builtin_constant_p("") && __builtin_constant_p(0)) ? rb_enc_str_new_static((""), (0), (rb_default_external_encoding())) : rb_enc_str_new((""), (0), (rb_default_external_encoding())); });
...
strio_eof(VALUE self)
{
    ...
    if (ptr->pos < (!(((struct RBasic*)(ptr->string))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(ptr->string))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(ptr->string))->as.heap.len)) return ((VALUE)RUBY_Qfalse);
    return ((VALUE)RUBY_Qtrue);
}
...
strio_copy(VALUE copy, VALUE orig)
{
    ...
    ptr = get_strio(orig);
    if (((struct StringIO*)rb_check_typeddata((copy), &strio_data_type))) {
 strio_free((((struct RData*)(copy))->data));
    }
    (((struct RData*)(copy))->data) = ptr;
    ( (((!(((VALUE)(copy) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(copy) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(copy))->flags & RUBY_T_MASK) != RUBY_T_NODE) && (int)(((struct RBasic*)(copy))->flags & RUBY_T_MASK) != RUBY_T_BIGNUM && (int)(((struct RBasic*)(copy))->flags & RUBY_T_MASK) != RUBY_T_FLOAT) && (!(((VALUE)(orig) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(orig) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(orig))->flags & RUBY_T_MASK) != RUBY_T_NODE)) ? (void)(((struct RBasic*)(copy))->flags |= ((((struct RBasic*)(orig))->flags&(RUBY_FL_TAINT)))) : (void)0);
...
{
    rb_io_taint_check(self);
    if (argc == 1 && !( ((RUBY_T_STRING) == RUBY_T_FIXNUM) ? (((int)(long)(*argv))&RUBY_FIXNUM_FLAG) : ((RUBY_T_STRING) == RUBY_T_TRUE) ? ((*argv) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_STRING) == RUBY_T_FALSE) ? ((*argv) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_STRING) == RUBY_T_NIL) ? ((*argv) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_STRING) == RUBY_T_UNDEF) ? ((*argv) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_STRING) == RUBY_T_SYMBOL) ? ((((VALUE)(*argv)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(*argv) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(*argv) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(*argv))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_STRING) == RUBY_T_FLOAT) ? ( ((((int)(long)(*argv))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(*argv) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(*argv) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(*argv))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(*argv) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(*argv) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(*argv))->flags & RUBY_T_MASK) == (RUBY_T_STRING)))) {
...
strio_seek(int argc, VALUE *argv, VALUE self)
{
 ...
 rb_raise(rb_eIOError, "closed stream");
    ...
    switch (!((VALUE)(whence) != ((VALUE)RUBY_Qnil)) ? 0 : rb_num2long_inline(whence)) {
      case 0:
 offset = 0;
 break;
      case 1:
 ...
 break;
      case 2:
 offset = (!(((struct RBasic*)(ptr->string))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(ptr->string))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(ptr->string))->as.heap.len);
 break;
      default:
 (rb_syserr_fail(22, "invalid whence"));
    }
    if (amount > 9223372036854775807L - offset || amount + offset < 0) {
 (rb_syserr_fail(22, 0));
    }
...
strio_each_byte(VALUE self)
{
    ...
    while (ptr->pos < (!(((struct RBasic*)(ptr->string))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(ptr->string))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(ptr->string))->as.heap.len)) {
 char c = (!(((struct RBasic*)(ptr->string))->flags & RSTRING_NOEMBED) ? ((struct RString*)(ptr->string))->as.ary : ((struct RString*)(ptr->string))->as.heap.ptr)[ptr->pos++];
 rb_yield((((VALUE)((long)((c)&0xff)))<<1 | RUBY_FIXNUM_FLAG));
    }
    return self;
}
...
strio_bytes(VALUE self)
{
    ...
    if (!rb_block_given_p())
 return rb_enumeratorize(self, (rb_id2sym((__builtin_constant_p("each_byte") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("each_byte")), (long)strlen(("each_byte"))); (ID) rb_intern_id_cache; }) : rb_intern("each_byte")))), 0, 0);
...
{
    struct StringIO *ptr = readable(self);
    rb_encoding *enc = ((ptr)->enc ? (ptr)->enc : rb_enc_get((ptr)->string));
    VALUE str = ptr->string;
    long pos = ptr->pos;
    int len;
    char *p;

    if (pos >= (!(((struct RBasic*)(str))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(str))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(str))->as.heap.len)) {
 return ((VALUE)RUBY_Qnil);
    }
    p = (!(((struct RBasic*)(str))->flags & RSTRING_NOEMBED) ? ((struct RString*)(str))->as.ary : ((struct RString*)(str))->as.heap.ptr)+pos;
    len = rb_enc_mbclen(p, (!(((struct RBasic*)(str))->flags & RSTRING_NOEMBED) ? (((struct RString*)(str))->as.ary + (long)((((struct RBasic*)(str))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT))) : (((struct RString*)(str))->as.heap.ptr + ((struct RString*)(str))->as.heap.len)), enc);
    ptr->pos += len;
    return enc_subseq(str, pos, len, enc);
}
...
strio_getbyte(VALUE self)
{
    struct StringIO *ptr = readable(self);
    int c;
    if (ptr->pos >= (!(((struct RBasic*)(ptr->string))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(ptr->string))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(ptr->string))->as.heap.len)) {
 return ((VALUE)RUBY_Qnil);
    }
    c = (!(((struct RBasic*)(ptr->string))->flags & RSTRING_NOEMBED) ? ((struct RString*)(ptr->string))->as.ary : ((struct RString*)(ptr->string))->as.heap.ptr)[ptr->pos++];
    return (((VALUE)((long)((c)&0xff)))<<1 | RUBY_FIXNUM_FLAG);
}
...
strio_extend(struct StringIO *ptr, long pos, long len)
{
    ...
    if (len > 9223372036854775807L - pos)
 rb_raise(rb_eArgError, "string size too big");

    check_modifiable(ptr);
    olen = (!(((struct RBasic*)(ptr->string))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(ptr->string))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(ptr->string))->as.heap.len);
    if (pos + len > olen) {
 rb_str_resize(ptr->string, pos + len);
 if (pos > olen)
     memset(((!(((struct RBasic*)(ptr->string))->flags & RSTRING_NOEMBED) ? ((struct RString*)(ptr->string))->as.ary : ((struct RString*)(ptr->string))->as.heap.ptr) + olen), 0, sizeof(char)*(size_t)(pos - olen));
    }
    else {
...
strio_ungetc(VALUE self, VALUE c)
{
    ...
    if ( ({ const VALUE integer_type_obj = (c); ((((int)(long)(integer_type_obj))&RUBY_FIXNUM_FLAG) || (!(((VALUE)(integer_type_obj) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(integer_type_obj) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(integer_type_obj))->flags & RUBY_T_MASK) == RUBY_T_BIGNUM)); })) {
 ...
 ((enc))->code_to_mbc((cc),(OnigUChar*)(buf),(enc));
 ...
 strio_unget_bytes(ptr, (!(((struct RBasic*)(c))->flags & RSTRING_NOEMBED) ? ((struct RString*)(c))->as.ary : ((struct RString*)(c))->as.heap.ptr), (!(((struct RBasic*)(c))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(c))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(c))->as.heap.len));
 (* ({ volatile VALUE *rb_gc_guarded_ptr = &(c); ; rb_gc_guarded_ptr; }));
 return ((VALUE)RUBY_Qnil);
    }
}
...
strio_ungetbyte(VALUE self, VALUE c)
{
 ...
 buf[0] = (char)((int)rb_fix2int((VALUE)(c)));
 return strio_unget_bytes(ptr, buf, 1);
    }
    else {
 do { rb_string_value(&(c)); rb_check_safe_obj(c);} while (0);
 cp = (!(((struct RBasic*)(c))->flags & RSTRING_NOEMBED) ? ((struct RString*)(c))->as.ary : ((struct RString*)(c))->as.heap.ptr);
 cl = (!(((struct RBasic*)(c))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(c))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(c))->as.heap.len);
 if (cl == 0) return ((VALUE)RUBY_Qnil);
...
{
    VALUE c = rb_funcallv(self, (__builtin_constant_p("getc") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("getc")), (long)strlen(("getc"))); (ID) rb_intern_id_cache; }) : rb_intern("getc")), 0, 0);
    if (!((VALUE)(c) != ((VALUE)RUBY_Qnil))) rb_eof_error();
    return c;
}
...
{
    VALUE c = rb_funcallv(self, (__builtin_constant_p("getbyte") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("getbyte")), (long)strlen(("getbyte"))); (ID) rb_intern_id_cache; }) : rb_intern("getbyte")), 0, 0);
    if (!((VALUE)(c) != ((VALUE)RUBY_Qnil))) rb_eof_error();
    return c;
}
static VALUE
strio_each_char(VALUE self)
{
    ...
    while (!!((VALUE)(c = strio_getc(self)) != ((VALUE)RUBY_Qnil))) {
 rb_yield(c);
    }
    return self;
}
...
strio_chars(VALUE self)
{
    ...
    if (!rb_block_given_p())
 return rb_enumeratorize(self, (rb_id2sym((__builtin_constant_p("each_char") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("each_char")), (long)strlen(("each_char"))); (ID) rb_intern_id_cache; }) : rb_intern("each_char")))), 0, 0);
...
strio_each_codepoint(VALUE self)
{
    ...
    ptr = readable(self);
    enc = ((ptr)->enc ? (ptr)->enc : rb_enc_get((ptr)->string));
    for (;;) {
 if (ptr->pos >= (!(((struct RBasic*)(ptr->string))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(ptr->string))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(ptr->string))->as.heap.len)) {
     return self;
 }

 c = rb_enc_codepoint_len((!(((struct RBasic*)(ptr->string))->flags & RSTRING_NOEMBED) ? ((struct RString*)(ptr->string))->as.ary : ((struct RString*)(ptr->string))->as.heap.ptr)+ptr->pos,
     (!(((struct RBasic*)(ptr->string))->flags & RSTRING_NOEMBED) ? (((struct RString*)(ptr->string))->as.ary + (long)((((struct RBasic*)(ptr->string))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT))) : (((struct RString*)(ptr->string))->as.heap.ptr + ((struct RString*)(ptr->string))->as.heap.len)), &n, enc);
...
strio_codepoints(VALUE self)
{
    ...
    if (!rb_block_given_p())
 return rb_enumeratorize(self, (rb_id2sym((__builtin_constant_p("each_codepoint") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("each_codepoint")), (long)strlen(("each_codepoint"))); (ID) rb_intern_id_cache; }) : rb_intern("each_codepoint")))), 0, 0);
...
prepare_getline_args(struct getline_arg *arg, int argc, VALUE *argv)
{
 ...
 break;
      ...
      case 2:
 if (!!((VALUE)(str) != ((VALUE)RUBY_Qnil))) rb_string_value(&(str));
 if (!!((VALUE)(lim) != ((VALUE)RUBY_Qnil))) limit = rb_num2long_inline(lim);
 break;
    }
    arg->rs = str;
    arg->limit = limit;
 ...
 arg->chomp = (vchomp != ((VALUE)RUBY_Qundef)) && !(((VALUE)(vchomp) & (VALUE)~((VALUE)RUBY_Qnil)) == 0);
    }
    return arg;
}
...
strio_getline(struct getline_arg *arg, struct StringIO *ptr)
{
    ...
    if (ptr->pos >= (n = (!(((struct RBasic*)(ptr->string))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(ptr->string))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(ptr->string))->as.heap.len))) {
 return ((VALUE)RUBY_Qnil);
    }
    s = (!(((struct RBasic*)(ptr->string))->flags & RSTRING_NOEMBED) ? ((struct RString*)(ptr->string))->as.ary : ((struct RString*)(ptr->string))->as.heap.ptr);
    e = s + (!(((struct RBasic*)(ptr->string))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(ptr->string))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(ptr->string))->as.heap.len);
    s += ptr->pos;
    if (limit > 0 && (size_t)limit < (size_t)(e - s)) {
 e = ((char *)onigenc_get_right_adjust_char_head((((ptr)->enc ? (ptr)->enc : rb_enc_get((ptr)->string))),(OnigUChar*)(s),(OnigUChar*)(s + limit),(OnigUChar*)(e)));
    }
 ...
 str = strio_substr(ptr, ptr->pos, e - s - w, enc);
    ...
    else if ((n = (!(((struct RBasic*)(str))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(str))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(str))->as.heap.len)) == 0) {
 p = s;
 while (p[(p + 1 < e) && (*p == '\r') && 0] == '\n') {
     p += *p == '\r';
     if (++p == e) {
 ...
 str = strio_substr(ptr, s - (!(((struct RBasic*)(ptr->string))->flags & RSTRING_NOEMBED) ? ((struct RString*)(ptr->string))->as.ary : ((struct RString*)(ptr->string))->as.heap.ptr), e - s - w, enc);
    }
    else if (n == 1) {
 if ((p = memchr(s, (!(((struct RBasic*)(str))->flags & RSTRING_NOEMBED) ? ((struct RString*)(str))->as.ary : ((struct RString*)(str))->as.heap.ptr)[0], e - s)) != 0) {
     e = p + 1;
 ...
 if (n < e - s) {
     if (e - s < 1024) {
  for (p = s; p + n <= e; ++p) {
      if (memcmp((p), ((!(((struct RBasic*)(str))->flags & RSTRING_NOEMBED) ? ((struct RString*)(str))->as.ary : ((struct RString*)(str))->as.heap.ptr)), sizeof(char)*(size_t)(n)) == 0) {
   e = p + (arg->chomp ? 0 : n);
   break;
      }
  }
 ...
 str = strio_substr(ptr, ptr->pos, e - s - w, enc);
    ...
    ptr->pos = e - (!(((struct RBasic*)(ptr->string))->flags & RSTRING_NOEMBED) ? ((struct RString*)(ptr->string))->as.ary : ((struct RString*)(ptr->string))->as.heap.ptr);
    ptr->lineno++;
    return str;
}
static VALUE
strio_gets(int argc, VALUE *argv, VALUE self)
{
 ...
 struct StringIO *ptr = readable(self);
 return  ({ (__builtin_constant_p(0) && __builtin_constant_p(0)) ? rb_enc_str_new_static((0), (0), (((ptr)->enc ? (ptr)->enc : rb_enc_get((ptr)->string)))) : rb_enc_str_new((0), (0), (((ptr)->enc ? (ptr)->enc : rb_enc_get((ptr)->string)))); });
    }
...
{
    VALUE line = rb_funcallv(self, (__builtin_constant_p("gets") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("gets")), (long)strlen(("gets"))); (ID) rb_intern_id_cache; }) : rb_intern("gets")), argc, argv);
    if (!((VALUE)(line) != ((VALUE)RUBY_Qnil))) rb_eof_error();
    return line;
}
static VALUE
strio_each(int argc, VALUE *argv, VALUE self)
{
 ...
 rb_raise(rb_eArgError, "invalid limit: 0 for each_line");
    ...
    while (!!((VALUE)(line = strio_getline(&arg, readable(self))) != ((VALUE)RUBY_Qnil))) {
 rb_yield(line);
    }
    return self;
}
...
strio_lines(int argc, VALUE *argv, VALUE self)
{
    ...
    if (!rb_block_given_p())
 return rb_enumeratorize(self, (rb_id2sym((__builtin_constant_p("each_line") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("each_line")), (long)strlen(("each_line"))); (ID) rb_intern_id_cache; }) : rb_intern("each_line")))), argc, argv);
...
strio_write(VALUE self, VALUE str)
{
 ...
 if (enc == ascii8bit || enc2 == ascii8bit) {
     rb_enc_str_buf_cat(ptr->string, (!(((struct RBasic*)(str))->flags & RSTRING_NOEMBED) ? ((struct RString*)(str))->as.ary : ((struct RString*)(str))->as.heap.ptr), len, enc);
     ( (((!(((VALUE)(ptr->string) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(ptr->string) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(ptr->string))->flags & RUBY_T_MASK) != RUBY_T_NODE) && (int)(((struct RBasic*)(ptr->string))->flags & RUBY_T_MASK) != RUBY_T_BIGNUM && (int)(((struct RBasic*)(ptr->string))->flags & RUBY_T_MASK) != RUBY_T_FLOAT) && (!(((VALUE)(str) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(str) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(str))->flags & RUBY_T_MASK) != RUBY_T_NODE)) ? (void)(((struct RBasic*)(ptr->string))->flags |= ((((struct RBasic*)(str))->flags&(RUBY_FL_TAINT)))) : (void)0);
 }
 else {
 ...
 memmove((!(((struct RBasic*)(ptr->string))->flags & RSTRING_NOEMBED) ? ((struct RString*)(ptr->string))->as.ary : ((struct RString*)(ptr->string))->as.heap.ptr)+ptr->pos, (!(((struct RBasic*)(str))->flags & RSTRING_NOEMBED) ? ((struct RString*)(str))->as.ary : ((struct RString*)(str))->as.heap.ptr), len);
 ( (((!(((VALUE)(ptr->string) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(ptr->string) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(ptr->string))->flags & RUBY_T_MASK) != RUBY_T_NODE) && (int)(((struct RBasic*)(ptr->string))->flags & RUBY_T_MASK) != RUBY_T_BIGNUM && (int)(((struct RBasic*)(ptr->string))->flags & RUBY_T_MASK) != RUBY_T_FLOAT) && (!(((VALUE)(str) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(str) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(str))->flags & RUBY_T_MASK) != RUBY_T_NODE)) ? (void)(((struct RBasic*)(ptr->string))->flags |= ((((struct RBasic*)(str))->flags&(RUBY_FL_TAINT)))) : (void)0);
    }
    ( (((!(((VALUE)(ptr->string) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(ptr->string) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(ptr->string))->flags & RUBY_T_MASK) != RUBY_T_NODE) && (int)(((struct RBasic*)(ptr->string))->flags & RUBY_T_MASK) != RUBY_T_BIGNUM && (int)(((struct RBasic*)(ptr->string))->flags & RUBY_T_MASK) != RUBY_T_FLOAT) && (!(((VALUE)(self) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(self) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(self))->flags & RUBY_T_MASK) != RUBY_T_NODE)) ? (void)(((struct RBasic*)(ptr->string))->flags |= ((((struct RBasic*)(self))->flags&(RUBY_FL_TAINT)))) : (void)0);
...
strio_read(int argc, VALUE *argv, VALUE self)
{
 ...
 if (!!((VALUE)(str) != ((VALUE)RUBY_Qnil))) {
     ...
     rb_str_modify(str);
      ...
      case 1:
 if (!!((VALUE)(argv[0]) != ((VALUE)RUBY_Qnil))) {
     len = rb_num2long_inline(argv[0]);
     if (len < 0) {
  rb_raise(rb_eArgError, "negative length %ld given", len);
     }
     if (len > 0 && ptr->pos >= (!(((struct RBasic*)(ptr->string))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(ptr->string))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(ptr->string))->as.heap.len)) {
  if (!!((VALUE)(str) != ((VALUE)RUBY_Qnil))) rb_str_resize(str, 0);
  return ((VALUE)RUBY_Qnil);
     }
     binary = 1;
     break;
      ...
      case 0:
 len = (!(((struct RBasic*)(ptr->string))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(ptr->string))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(ptr->string))->as.heap.len);
 if (len <= ptr->pos) {
     rb_encoding *enc = binary ? rb_ascii8bit_encoding() : ((ptr)->enc ? (ptr)->enc : rb_enc_get((ptr)->string));
     if (!((VALUE)(str) != ((VALUE)RUBY_Qnil))) {
 ...
 long rest = (!(((struct RBasic*)(ptr->string))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(ptr->string))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(ptr->string))->as.heap.len) - ptr->pos;
 if (len > rest) len = rest;
 rb_str_resize(str, len);
 memcpy(((!(((struct RBasic*)(str))->flags & RSTRING_NOEMBED) ? ((struct RString*)(str))->as.ary : ((struct RString*)(str))->as.heap.ptr)), ((!(((struct RBasic*)(ptr->string))->flags & RSTRING_NOEMBED) ? ((struct RString*)(ptr->string))->as.ary : ((struct RString*)(ptr->string))->as.heap.ptr) + ptr->pos), sizeof(char)*(size_t)(len));
 if (binary)
     rb_enc_associate(str, rb_ascii8bit_encoding());
 else
     rb_enc_copy(str, ptr->string);
    }
    ptr->pos += (!(((struct RBasic*)(str))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(str))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(str))->as.heap.len);
    return str;
}
static VALUE
strio_sysread(int argc, VALUE *argv, VALUE self)
{
    VALUE val = rb_funcallv(self, (__builtin_constant_p("read") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("read")), (long)strlen(("read"))); (ID) rb_intern_id_cache; }) : rb_intern("read")), argc, argv);
...
strio_size(VALUE self)
{
    ...
    if (!((VALUE)(string) != ((VALUE)RUBY_Qnil))) {
 rb_raise(rb_eIOError, "not opened");
    }
    return rb_ulong2num_inline((!(((struct RBasic*)(string))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(string))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(string))->as.heap.len));
}
static VALUE
strio_truncate(VALUE self, VALUE len)
{
    ...
    long plen = (!(((struct RBasic*)(string))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(string))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(string))->as.heap.len);
    if (l < 0) {
 (rb_syserr_fail(22, "negative length"));
    }
    rb_str_resize(string, l);
    if (plen < l) {
 memset(((!(((struct RBasic*)(string))->flags & RSTRING_NOEMBED) ? ((struct RString*)(string))->as.ary : ((struct RString*)(string))->as.heap.ptr) + plen), 0, sizeof(char)*(size_t)(l - plen));
    }
    return len;
}
static VALUE
...
{
    struct StringIO *ptr = get_strio(self);
    return rb_enc_from_encoding(((ptr)->enc ? (ptr)->enc : rb_enc_get((ptr)->string)));
}
static VALUE
...
strio_set_encoding(int argc, VALUE *argv, VALUE self)
{
    ...
    if (!((VALUE)(ext_enc) != ((VALUE)RUBY_Qnil))) {
...
Init_stringio(void)
{
    ...
    rb_define_method(StringIO, "fcntl", strio_unimpl, -1);

    rb_define_method(StringIO, "flush", strio_self, 0);

    rb_define_method(StringIO, "fsync", strio_0, 0);
    ...
    rb_define_method(StringIO, "sync=", strio_first, 1);
    rb_define_method(StringIO, "tell", strio_get_pos, 0);
    ...
    rb_define_method(StringIO, "isatty", strio_false, 0);
    rb_define_method(StringIO, "tty?", strio_false, 0);


    rb_define_method(StringIO, "pid", strio_nil, 0);


    rb_define_method(StringIO, "fileno", strio_nil, 0);
 ...
 rb_define_method(mWritable, "<<", rb_io_addstr, 1);
 rb_define_method(mWritable, "print", rb_io_print, -1);
 rb_define_method(mWritable, "printf", rb_io_printf, -1);
 rb_define_method(mWritable, "puts", rb_io_puts, -1);
 rb_define_method(mWritable, "syswrite", rb_io_write, 1);
 rb_define_method(mWritable, "write_nonblock", strio_syswrite_nonblock, -1);
 rb_include_module(StringIO, mWritable);
    }

    sym_exception = (rb_id2sym((__builtin_constant_p("exception") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("exception")), (long)strlen(("exception"))); (ID) rb_intern_id_cache; }) : rb_intern("exception"))));
}
