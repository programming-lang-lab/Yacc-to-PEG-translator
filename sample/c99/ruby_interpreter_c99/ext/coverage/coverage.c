...
static VALUE me2counter = ((VALUE)RUBY_Qnil);
...
rb_coverage_start(int argc, VALUE *argv, VALUE klass)
{
 ...
 mode = 0;
    ...
    else if (opt == (rb_id2sym((__builtin_constant_p("all") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("all")), (long)strlen(("all"))); (ID) rb_intern_id_cache; }) : rb_intern("all"))))) {
 mode = 1 | 2 | 4;
    }
    else {
 mode = 0;
 opt = rb_convert_type(opt, RUBY_T_HASH, "Hash", "to_hash");

 if (!(((VALUE)(rb_hash_lookup(opt, (rb_id2sym((__builtin_constant_p("lines") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("lines")), (long)strlen(("lines"))); (ID) rb_intern_id_cache; }) : rb_intern("lines")))))) & (VALUE)~((VALUE)RUBY_Qnil)) == 0))
     mode |= 1;
 if (!(((VALUE)(rb_hash_lookup(opt, (rb_id2sym((__builtin_constant_p("branches") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("branches")), (long)strlen(("branches"))); (ID) rb_intern_id_cache; }) : rb_intern("branches")))))) & (VALUE)~((VALUE)RUBY_Qnil)) == 0))
     mode |= 2;
 if (!(((VALUE)(rb_hash_lookup(opt, (rb_id2sym((__builtin_constant_p("methods") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("methods")), (long)strlen(("methods"))); (ID) rb_intern_id_cache; }) : rb_intern("methods")))))) & (VALUE)~((VALUE)RUBY_Qnil)) == 0))
     mode |= 4;
 if (mode == 0) {
...
branch_coverage(VALUE branches)
{
    ...
    VALUE structure = rb_ary_dup((rb_array_const_ptr(branches)[0]));
    VALUE counters = rb_ary_dup((rb_array_const_ptr(branches)[1]));
    int i, j;
    long id = 0;

    for (i = 0; i < rb_array_len(structure); i++) {
 VALUE branches = (rb_array_const_ptr(structure)[i]);
 VALUE base_type = (rb_array_const_ptr(branches)[0]);
 VALUE base_first_lineno = (rb_array_const_ptr(branches)[1]);
 VALUE base_first_column = (rb_array_const_ptr(branches)[2]);
 VALUE base_last_lineno = (rb_array_const_ptr(branches)[3]);
 VALUE base_last_column = (rb_array_const_ptr(branches)[4]);
 VALUE children = rb_hash_new();
 rb_hash_aset(ret,  ({ const VALUE args_to_new_ary[] = {base_type, (((VALUE)(id++))<<1 | RUBY_FIXNUM_FLAG), base_first_lineno, base_first_column, base_last_lineno, base_last_column}; if (__builtin_constant_p(6)) { extern int (*__Static_assert_function (void)) [!!sizeof (struct { int __error_if_negative: (((int)(sizeof(args_to_new_ary) / sizeof((args_to_new_ary)[0]))) == (6)) ? 2 : -1; })]; } rb_ary_new_from_values(((int)(sizeof(args_to_new_ary) / sizeof((args_to_new_ary)[0]))), args_to_new_ary); }), children);
 for (j = 5; j < rb_array_len(branches); j += 6) {
     VALUE target_label = (rb_array_const_ptr(branches)[j]);
     VALUE target_first_lineno = (rb_array_const_ptr(branches)[j + 1]);
     VALUE target_first_column = (rb_array_const_ptr(branches)[j + 2]);
     VALUE target_last_lineno = (rb_array_const_ptr(branches)[j + 3]);
     VALUE target_last_column = (rb_array_const_ptr(branches)[j + 4]);
     int idx = ((int)rb_fix2int((VALUE)((rb_array_const_ptr(branches)[j + 5]))));
     rb_hash_aset(children,  ({ const VALUE args_to_new_ary[] = {target_label, (((VALUE)(id++))<<1 | RUBY_FIXNUM_FLAG), target_first_lineno, target_first_column, target_last_lineno, target_last_column}; if (__builtin_constant_p(6)) { extern int (*__Static_assert_function (void)) [!!sizeof (struct { int __error_if_negative: (((int)(sizeof(args_to_new_ary) / sizeof((args_to_new_ary)[0]))) == (6)) ? 2 : -1; })]; } rb_ary_new_from_values(((int)(sizeof(args_to_new_ary) / sizeof((args_to_new_ary)[0]))), args_to_new_ary); }), (rb_array_const_ptr(counters)[idx]));
 }
    }
...
method_coverage_i(void *vstart, void *vend, size_t stride, void *data)
{
 ...
 if (( ((RUBY_T_IMEMO) == RUBY_T_FIXNUM) ? (((int)(long)(v))&RUBY_FIXNUM_FLAG) : ((RUBY_T_IMEMO) == RUBY_T_TRUE) ? ((v) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_IMEMO) == RUBY_T_FALSE) ? ((v) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_IMEMO) == RUBY_T_NIL) ? ((v) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_IMEMO) == RUBY_T_UNDEF) ? ((v) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_IMEMO) == RUBY_T_SYMBOL) ? ((((VALUE)(v)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(v) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(v) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(v))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_IMEMO) == RUBY_T_FLOAT) ? ( ((((int)(long)(v))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(v) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(v) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(v))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(v) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(v) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(v))->flags & RUBY_T_MASK) == (RUBY_T_IMEMO))) && imemo_type(v) == imemo_ment) {
     const rb_method_entry_t *me = (rb_method_entry_t *) v;
     VALUE path, first_lineno, first_column, last_lineno, last_column;
     VALUE data[5], ncoverage, methods;
     VALUE methods_id = (rb_id2sym((__builtin_constant_p("methods") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("methods")), (long)strlen(("methods"))); (ID) rb_intern_id_cache; }) : rb_intern("methods"))));
     VALUE klass;
  ...
  rb_bug("T_ICLASS");
     ...
     last_lineno = data[3];
     last_column = data[4];
     if (((long)(((long)(first_lineno))>>(int)(1))) <= 0) continue;
     ncoverage = rb_hash_aref(ncoverages, path);
     if (!((VALUE)(ncoverage) != ((VALUE)RUBY_Qnil))) continue;
     methods = rb_hash_aref(ncoverage, methods_id);

     {
  VALUE method_id = (rb_id2sym(me->def->original_id));
  VALUE rcount = rb_hash_aref(me2counter, (VALUE) me);
  VALUE key =  ({ const VALUE args_to_new_ary[] = {klass, method_id, first_lineno, first_column, last_lineno, last_column}; if (__builtin_constant_p(6)) { extern int (*__Static_assert_function (void)) [!!sizeof (struct { int __error_if_negative: (((int)(sizeof(args_to_new_ary) / sizeof((args_to_new_ary)[0]))) == (6)) ? 2 : -1; })]; } rb_ary_new_from_values(((int)(sizeof(args_to_new_ary) / sizeof((args_to_new_ary)[0]))), args_to_new_ary); });
  VALUE rcount2 = rb_hash_aref(methods, key);

  if (!((VALUE)(rcount) != ((VALUE)RUBY_Qnil))) rcount = (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG);
  if (!((VALUE)(rcount2) != ((VALUE)RUBY_Qnil))) rcount2 = (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG);
  if (!((((long)(((long)(rcount))>>(int)(1))) + ((long)(((long)(rcount2))>>(int)(1)))) < (9223372036854775807L>>1)+1)) {
      rcount = (((VALUE)((9223372036854775807L>>1)))<<1 | RUBY_FIXNUM_FLAG);
  }
  else {
      rcount = (((VALUE)(((long)(((long)(rcount))>>(int)(1))) + ((long)(((long)(rcount2))>>(int)(1)))))<<1 | RUBY_FIXNUM_FLAG);
  }
...
coverage_peek_result_i(st_data_t key, st_data_t val, st_data_t h)
{
 ...
 VALUE lines = rb_ary_dup((rb_array_const_ptr(coverage)[0]));
 rb_ary_freeze(lines);
 coverage = lines;
    }
    else {
 ...
 if (current_mode & 1) {
     ...
     rb_ary_freeze(lines);
     rb_hash_aset(h, (rb_id2sym((__builtin_constant_p("lines") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("lines")), (long)strlen(("lines"))); (ID) rb_intern_id_cache; }) : rb_intern("lines")))), lines);
 }

 if (current_mode & 2) {
     VALUE branches = (rb_array_const_ptr(coverage)[1]);
     rb_hash_aset(h, (rb_id2sym((__builtin_constant_p("branches") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("branches")), (long)strlen(("branches"))); (ID) rb_intern_id_cache; }) : rb_intern("branches")))), branch_coverage(branches));
 }

 if (current_mode & 4) {
     rb_hash_aset(h, (rb_id2sym((__builtin_constant_p("methods") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("methods")), (long)strlen(("methods"))); (ID) rb_intern_id_cache; }) : rb_intern("methods")))), rb_hash_new());
 }
...
rb_coverage_peek_result(VALUE klass)
{
 ...
 rb_raise(rb_eRuntimeError, "coverage measurement is not enabled");
    ...
    st_foreach(rb_hash_tbl(coverages), coverage_peek_result_i, ncoverages);
...
{
    VALUE coverages = rb_get_coverages();
    return !(((VALUE)(coverages) & (VALUE)~((VALUE)RUBY_Qnil)) == 0) ? ((VALUE)RUBY_Qtrue) : ((VALUE)RUBY_Qfalse);
}
void
Init_coverage(void)
{
