...
fsdbm_close(VALUE obj)
{
    ...
    do { (((dbmp)) = (struct dbmdata*)rb_check_typeddata(((obj)), (&sdbm_type))); if ((dbmp)->di_dbm == 0) closed_sdbm();} while (0);
...
fsdbm_closed(VALUE obj)
{
    ...
    ((dbmp) = (struct dbmdata*)rb_check_typeddata((obj), (&sdbm_type)));
    if (dbmp->di_dbm == 0)
...
fsdbm_alloc(VALUE klass)
{
    ...
    return ({ VALUE data_struct_obj = rb_data_typed_object_zalloc(klass, sizeof(struct dbmdata), &sdbm_type); (void)((dbmp) = (struct dbmdata *)(((struct RData*)(data_struct_obj))->data));; data_struct_obj; });
}
static VALUE
fsdbm_initialize(int argc, VALUE *argv, VALUE obj)
{
 ...
 mode = 0666;
    ...
    else if (!((VALUE)(vmode) != ((VALUE)RUBY_Qnil))) {
 mode = -1;
    }
    else {
 mode = rb_num2int_inline(vmode);
    ...
    dbm = 0;
    if (mode >= 0)
 dbm = sdbm_open((!(((struct RBasic*)(file))->flags & RSTRING_NOEMBED) ? ((struct RString*)(file))->as.ary : ((struct RString*)(file))->as.heap.ptr), 02|0100, mode);
    if (!dbm)
 dbm = sdbm_open((!(((struct RBasic*)(file))->flags & RSTRING_NOEMBED) ? ((struct RString*)(file))->as.ary : ((struct RString*)(file))->as.heap.ptr), 02, 0);
    if (!dbm)
 dbm = sdbm_open((!(((struct RBasic*)(file))->flags & RSTRING_NOEMBED) ? ((struct RString*)(file))->as.ary : ((struct RString*)(file))->as.heap.ptr), 00, 0);

    if (!dbm) {
 if (mode == -1) return ((VALUE)RUBY_Qnil);
...
fsdbm_s_open(int argc, VALUE *argv, VALUE klass)
{
    ...
    if (!((VALUE)(fsdbm_initialize(argc, argv, obj)) != ((VALUE)RUBY_Qnil))) {
 return ((VALUE)RUBY_Qnil);
    }
...
fsdbm_fetch(VALUE obj, VALUE keystr, VALUE ifnone)
{
    ...
    do { do { rb_string_value(&(keystr)); rb_check_safe_obj(keystr);} while (0); (keystr) = rb_str_export(keystr);} while (0);
    key.dptr = (!(((struct RBasic*)(keystr))->flags & RSTRING_NOEMBED) ? ((struct RString*)(keystr))->as.ary : ((struct RString*)(keystr))->as.heap.ptr);
    key.dsize = rb_long2int_inline((!(((struct RBasic*)(keystr))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(keystr))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(keystr))->as.heap.len));

    do { do { ((((dbmp))) = (struct dbmdata*)rb_check_typeddata((((obj))), (&sdbm_type))); if (((dbmp))->di_dbm == 0) closed_sdbm();} while (0); (dbm) = (dbmp)->di_dbm;} while (0);
    value = sdbm_fetch(dbm, key);
    if (value.dptr == 0) {
 if (ifnone == ((VALUE)RUBY_Qnil) && rb_block_given_p())
...
{
    return fsdbm_fetch(obj, keystr, ((VALUE)RUBY_Qnil));
}
static VALUE
fsdbm_fetch_m(int argc, VALUE *argv, VALUE obj)
{
    ...
    if (argc == 1 && !rb_block_given_p() && !((VALUE)(valstr) != ((VALUE)RUBY_Qnil)))
...
fsdbm_key(VALUE obj, VALUE valstr)
{
    ...
    do { do { rb_string_value(&(valstr)); rb_check_safe_obj(valstr);} while (0); (valstr) = rb_str_export(valstr);} while (0);
    val.dptr = (!(((struct RBasic*)(valstr))->flags & RSTRING_NOEMBED) ? ((struct RString*)(valstr))->as.ary : ((struct RString*)(valstr))->as.heap.ptr);
    val.dsize = rb_long2int_inline((!(((struct RBasic*)(valstr))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(valstr))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(valstr))->as.heap.len));

    do { do { ((((dbmp))) = (struct dbmdata*)rb_check_typeddata((((obj))), (&sdbm_type))); if (((dbmp))->di_dbm == 0) closed_sdbm();} while (0); (dbm) = (dbmp)->di_dbm;} while (0);
    for (key = sdbm_firstkey(dbm); key.dptr; key = sdbm_nextkey(dbm)) {
 val = sdbm_fetch(dbm, key);
 if (val.dsize == (!(((struct RBasic*)(valstr))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(valstr))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(valstr))->as.heap.len) &&
     memcmp(val.dptr, (!(((struct RBasic*)(valstr))->flags & RSTRING_NOEMBED) ? ((struct RString*)(valstr))->as.ary : ((struct RString*)(valstr))->as.heap.ptr), val.dsize) == 0)
...
{
    VALUE new = rb_ary_new_capa(argc);
    int i;

    for (i=0; i<argc; i++) {
        rb_ary_push(new, fsdbm_fetch(obj, argv[i], ((VALUE)RUBY_Qnil)));
    }
...
{
    if ((!(!(((VALUE)(obj) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(obj) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(obj))->flags & RUBY_T_MASK) != RUBY_T_NODE) || (((struct RBasic*)(obj))->flags&RUBY_FL_FREEZE))) rb_error_frozen("SDBM");
}
static VALUE
...
fsdbm_shift(VALUE obj)
{
    ...
    if (!key.dptr) return ((VALUE)RUBY_Qnil);
    val = sdbm_fetch(dbm, key);
...
fsdbm_delete_if(VALUE obj)
{
 ...
 valstr = rb_external_str_new(val.dptr, val.dsize);
        ...
        if (status != 0) break;
 if (!(((VALUE)(ret) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) rb_ary_push(ary, keystr);
 do { do { ((((dbmp))) = (struct dbmdata*)rb_check_typeddata((((obj))), (&sdbm_type))); if (((dbmp))->di_dbm == 0) closed_sdbm();} while (0); (dbm) = (dbmp)->di_dbm;} while (0);
    }

    for (i = 0; i < rb_array_len(ary); i++) {
 keystr = (rb_array_const_ptr(ary)[i]);
 do { do { rb_string_value(&(keystr)); rb_check_safe_obj(keystr);} while (0); (keystr) = rb_str_export(keystr);} while (0);
 key.dptr = (!(((struct RBasic*)(keystr))->flags & RSTRING_NOEMBED) ? ((struct RString*)(keystr))->as.ary : ((struct RString*)(keystr))->as.heap.ptr);
 key.dsize = rb_long2int_inline((!(((struct RBasic*)(keystr))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(keystr))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(keystr))->as.heap.len));
 if (sdbm_delete(dbm, key)) {
    ...
    if (n > 0) dbmp->di_size = n - rb_long2int_inline(rb_array_len(ary));
...
fsdbm_store(VALUE obj, VALUE keystr, VALUE valstr)
{
 ...
 return ((VALUE)RUBY_Qnil);
    ...
    do { do { ((((dbmp))) = (struct dbmdata*)rb_check_typeddata((((obj))), (&sdbm_type))); if (((dbmp))->di_dbm == 0) closed_sdbm();} while (0); (dbm) = (dbmp)->di_dbm;} while (0);
    dbmp->di_size = -1;
    if (sdbm_store(dbm, key, val, 1)) {



 if ((*__errno_location ()) == 1) rb_sys_fail(0);
...
static VALUE
update_i(VALUE pair, VALUE dbm, int argc, const VALUE *argv, VALUE blockarg)
{
    const VALUE *ptr;
    rb_check_type((VALUE)(pair),(RUBY_T_ARRAY));
    if (rb_array_len(pair) < 2) {
 rb_raise(rb_eArgError, "pair must be [key, value]");
    }
    ptr = rb_array_const_ptr(pair);
...
{
    rb_block_call(other, (__builtin_constant_p("each_pair") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("each_pair")), (long)strlen(("each_pair"))); (ID) rb_intern_id_cache; }) : rb_intern("each_pair")), 0, 0, update_i, obj);
    return obj;
}
static VALUE
...
fsdbm_length(VALUE obj)
{
    ...
    do { do { ((((dbmp))) = (struct dbmdata*)rb_check_typeddata((((obj))), (&sdbm_type))); if (((dbmp))->di_dbm == 0) closed_sdbm();} while (0); (dbm) = (dbmp)->di_dbm;} while (0);
    if (dbmp->di_size > 0) return (((VALUE)(dbmp->di_size))<<1 | RUBY_FIXNUM_FLAG);
...
fsdbm_has_key(VALUE obj, VALUE keystr)
{
    ...
    do { do { ((((dbmp))) = (struct dbmdata*)rb_check_typeddata((((obj))), (&sdbm_type))); if (((dbmp))->di_dbm == 0) closed_sdbm();} while (0); (dbm) = (dbmp)->di_dbm;} while (0);
    val = sdbm_fetch(dbm, key);
    if (val.dptr) return ((VALUE)RUBY_Qtrue);
    return ((VALUE)RUBY_Qfalse);
}
static VALUE
fsdbm_has_value(VALUE obj, VALUE valstr)
{
    ...
    for (key = sdbm_firstkey(dbm); key.dptr; key = sdbm_nextkey(dbm)) {
 val = sdbm_fetch(dbm, key);
 if (val.dsize == rb_long2int_inline((!(((struct RBasic*)(valstr))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(valstr))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(valstr))->as.heap.len)) &&
     memcmp(val.dptr, (!(((struct RBasic*)(valstr))->flags & RSTRING_NOEMBED) ? ((struct RString*)(valstr))->as.ary : ((struct RString*)(valstr))->as.heap.ptr), val.dsize) == 0)
     return ((VALUE)RUBY_Qtrue);
    }
    return ((VALUE)RUBY_Qfalse);
