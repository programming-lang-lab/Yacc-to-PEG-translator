...
Init_sizeof(void)
{
    ...
    rb_hash_aset(s,  ({ (__builtin_constant_p("int")) ? rb_str_new_static(("int"), (long)strlen("int")) : rb_str_new_cstr("int"); }), (((VALUE)(4))<<1 | RUBY_FIXNUM_FLAG));


    rb_hash_aset(s,  ({ (__builtin_constant_p("short")) ? rb_str_new_static(("short"), (long)strlen("short")) : rb_str_new_cstr("short"); }), (((VALUE)(2))<<1 | RUBY_FIXNUM_FLAG));


    rb_hash_aset(s,  ({ (__builtin_constant_p("long")) ? rb_str_new_static(("long"), (long)strlen("long")) : rb_str_new_cstr("long"); }), (((VALUE)(8))<<1 | RUBY_FIXNUM_FLAG));


    rb_hash_aset(s,  ({ (__builtin_constant_p("long long")) ? rb_str_new_static(("long long"), (long)strlen("long long")) : rb_str_new_cstr("long long"); }), (((VALUE)(8))<<1 | RUBY_FIXNUM_FLAG));
    rb_hash_aset(s,  ({ (__builtin_constant_p("off_t")) ? rb_str_new_static(("off_t"), (long)strlen("off_t")) : rb_str_new_cstr("off_t"); }), (((VALUE)(8))<<1 | RUBY_FIXNUM_FLAG));


    rb_hash_aset(s,  ({ (__builtin_constant_p("void*")) ? rb_str_new_static(("void*"), (long)strlen("void*")) : rb_str_new_cstr("void*"); }), (((VALUE)(8))<<1 | RUBY_FIXNUM_FLAG));


    rb_hash_aset(s,  ({ (__builtin_constant_p("float")) ? rb_str_new_static(("float"), (long)strlen("float")) : rb_str_new_cstr("float"); }), (((VALUE)(4))<<1 | RUBY_FIXNUM_FLAG));


    rb_hash_aset(s,  ({ (__builtin_constant_p("double")) ? rb_str_new_static(("double"), (long)strlen("double")) : rb_str_new_cstr("double"); }), (((VALUE)(8))<<1 | RUBY_FIXNUM_FLAG));


    rb_hash_aset(s,  ({ (__builtin_constant_p("time_t")) ? rb_str_new_static(("time_t"), (long)strlen("time_t")) : rb_str_new_cstr("time_t"); }), (((VALUE)(8))<<1 | RUBY_FIXNUM_FLAG));


    rb_hash_aset(s,  ({ (__builtin_constant_p("clock_t")) ? rb_str_new_static(("clock_t"), (long)strlen("clock_t")) : rb_str_new_cstr("clock_t"); }), (((VALUE)(8))<<1 | RUBY_FIXNUM_FLAG));


    rb_hash_aset(s,  ({ (__builtin_constant_p("size_t")) ? rb_str_new_static(("size_t"), (long)strlen("size_t")) : rb_str_new_cstr("size_t"); }), (((VALUE)(8))<<1 | RUBY_FIXNUM_FLAG));


    rb_hash_aset(s,  ({ (__builtin_constant_p("ptrdiff_t")) ? rb_str_new_static(("ptrdiff_t"), (long)strlen("ptrdiff_t")) : rb_str_new_cstr("ptrdiff_t"); }), (((VALUE)(8))<<1 | RUBY_FIXNUM_FLAG));


    rb_hash_aset(s,  ({ (__builtin_constant_p("int8_t")) ? rb_str_new_static(("int8_t"), (long)strlen("int8_t")) : rb_str_new_cstr("int8_t"); }), (((VALUE)(1))<<1 | RUBY_FIXNUM_FLAG));


    rb_hash_aset(s,  ({ (__builtin_constant_p("uint8_t")) ? rb_str_new_static(("uint8_t"), (long)strlen("uint8_t")) : rb_str_new_cstr("uint8_t"); }), (((VALUE)(1))<<1 | RUBY_FIXNUM_FLAG));


    rb_hash_aset(s,  ({ (__builtin_constant_p("int16_t")) ? rb_str_new_static(("int16_t"), (long)strlen("int16_t")) : rb_str_new_cstr("int16_t"); }), (((VALUE)(2))<<1 | RUBY_FIXNUM_FLAG));


    rb_hash_aset(s,  ({ (__builtin_constant_p("uint16_t")) ? rb_str_new_static(("uint16_t"), (long)strlen("uint16_t")) : rb_str_new_cstr("uint16_t"); }), (((VALUE)(2))<<1 | RUBY_FIXNUM_FLAG));


    rb_hash_aset(s,  ({ (__builtin_constant_p("int32_t")) ? rb_str_new_static(("int32_t"), (long)strlen("int32_t")) : rb_str_new_cstr("int32_t"); }), (((VALUE)(4))<<1 | RUBY_FIXNUM_FLAG));


    rb_hash_aset(s,  ({ (__builtin_constant_p("uint32_t")) ? rb_str_new_static(("uint32_t"), (long)strlen("uint32_t")) : rb_str_new_cstr("uint32_t"); }), (((VALUE)(4))<<1 | RUBY_FIXNUM_FLAG));


    rb_hash_aset(s,  ({ (__builtin_constant_p("int64_t")) ? rb_str_new_static(("int64_t"), (long)strlen("int64_t")) : rb_str_new_cstr("int64_t"); }), (((VALUE)(8))<<1 | RUBY_FIXNUM_FLAG));


    rb_hash_aset(s,  ({ (__builtin_constant_p("uint64_t")) ? rb_str_new_static(("uint64_t"), (long)strlen("uint64_t")) : rb_str_new_cstr("uint64_t"); }), (((VALUE)(8))<<1 | RUBY_FIXNUM_FLAG));


    rb_hash_aset(s,  ({ (__builtin_constant_p("int128_t")) ? rb_str_new_static(("int128_t"), (long)strlen("int128_t")) : rb_str_new_cstr("int128_t"); }), (((VALUE)(16))<<1 | RUBY_FIXNUM_FLAG));


    rb_hash_aset(s,  ({ (__builtin_constant_p("uint128_t")) ? rb_str_new_static(("uint128_t"), (long)strlen("uint128_t")) : rb_str_new_cstr("uint128_t"); }), (((VALUE)(16))<<1 | RUBY_FIXNUM_FLAG));


    rb_hash_aset(s,  ({ (__builtin_constant_p("intptr_t")) ? rb_str_new_static(("intptr_t"), (long)strlen("intptr_t")) : rb_str_new_cstr("intptr_t"); }), (((VALUE)(8))<<1 | RUBY_FIXNUM_FLAG));


    rb_hash_aset(s,  ({ (__builtin_constant_p("uintptr_t")) ? rb_str_new_static(("uintptr_t"), (long)strlen("uintptr_t")) : rb_str_new_cstr("uintptr_t"); }), (((VALUE)(8))<<1 | RUBY_FIXNUM_FLAG));


    rb_hash_aset(s,  ({ (__builtin_constant_p("ssize_t")) ? rb_str_new_static(("ssize_t"), (long)strlen("ssize_t")) : rb_str_new_cstr("ssize_t"); }), (((VALUE)(8))<<1 | RUBY_FIXNUM_FLAG));
    rb_obj_freeze_inline((VALUE)s);
