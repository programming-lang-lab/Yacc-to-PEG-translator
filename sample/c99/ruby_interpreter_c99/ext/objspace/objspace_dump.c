...
static void dump_append(struct dump_config *, const char *, ...) ;
static void
...
dump_append_string_value(struct dump_config *dc, VALUE obj)
{
    ...
    dump_append(dc, "\"");
    for (i = 0, value = (!(((struct RBasic*)(obj))->flags & RSTRING_NOEMBED) ? ((struct RString*)(obj))->as.ary : ((struct RString*)(obj))->as.heap.ptr); i < (!(((struct RBasic*)(obj))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(obj))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(obj))->as.heap.len); i++) {
 switch ((c = value[i])) {
   case '\\':
   case '"':
     dump_append(dc, "\\%c", c);
...
obj_type(VALUE obj)
{
 ...
 case RUBY_T_NONE: return "NONE";
 case RUBY_T_NIL: return "NIL";
 case RUBY_T_OBJECT: return "OBJECT";
 case RUBY_T_CLASS: return "CLASS";
 case RUBY_T_ICLASS: return "ICLASS";
 case RUBY_T_MODULE: return "MODULE";
 case RUBY_T_FLOAT: return "FLOAT";
 case RUBY_T_STRING: return "STRING";
 case RUBY_T_REGEXP: return "REGEXP";
 case RUBY_T_ARRAY: return "ARRAY";
 case RUBY_T_HASH: return "HASH";
 case RUBY_T_STRUCT: return "STRUCT";
 case RUBY_T_BIGNUM: return "BIGNUM";
 case RUBY_T_FILE: return "FILE";
 case RUBY_T_FIXNUM: return "FIXNUM";
 case RUBY_T_TRUE: return "TRUE";
 case RUBY_T_FALSE: return "FALSE";
 case RUBY_T_DATA: return "DATA";
 case RUBY_T_MATCH: return "MATCH";
 case RUBY_T_SYMBOL: return "SYMBOL";
 case RUBY_T_RATIONAL: return "RATIONAL";
 case RUBY_T_COMPLEX: return "COMPLEX";
 case RUBY_T_IMEMO: return "IMEMO";
 case RUBY_T_UNDEF: return "UNDEF";
 case RUBY_T_NODE: return "NODE";
 case RUBY_T_ZOMBIE: return "ZOMBIE";
...
{
    if (value == ((VALUE)RUBY_Qtrue)) {
 dump_append(dc, "true");
    }
    else if (value == ((VALUE)RUBY_Qfalse)) {
 dump_append(dc, "false");
    }
    else if (value == ((VALUE)RUBY_Qnil)) {
 dump_append(dc, "null");
    }
    else if ((((int)(long)(value))&RUBY_FIXNUM_FLAG)) {
 dump_append(dc, "%ld", ((long)(((long)(value))>>(int)(1))));
    }
    else if (((((int)(long)(value))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG)) {
 dump_append(dc, "%#g", rb_float_value_inline(value));
    }
    else if (((((VALUE)(value)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(value) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(value) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(value))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL)))) {
...
{
    dump_append(dc, ", \"bytesize\":%ld", (!(((struct RBasic*)(obj))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(obj))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(obj))->as.heap.len));
    if (!(!(((struct RBasic*)((obj)))->flags&(((VALUE)RUBY_FL_USER1)))) && !((((struct RBasic*)(((obj))))->flags&((((VALUE)RUBY_FL_USER1)|RUBY_ELTS_SHARED))) == (((VALUE)RUBY_FL_USER1)|RUBY_ELTS_SHARED)) && (long)rb_str_capacity(obj) != (!(((struct RBasic*)(obj))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(obj))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(obj))->as.heap.len))
 dump_append(dc, ", \"capacity\":%zu", rb_str_capacity(obj));

    if ((rb_enc_str_coderange(obj) == RUBY_ENC_CODERANGE_7BIT)) {
...
imemo_name(int imemo)
{
 ...
 case(imemo_env): return "env";
 case(imemo_cref): return "cref";
 case(imemo_svar): return "svar";
 case(imemo_throw_data): return "throw_data";
 case(imemo_ifunc): return "ifunc";
 case(imemo_memo): return "memo";
 case(imemo_ment): return "ment";
 case(imemo_iseq): return "iseq";
 case(imemo_alloc): return "alloc";
 case(imemo_ast): return "ast";
 case(imemo_parser_strterm): return "parser_strterm";
      default:
 return "unknown";
...
dump_object(VALUE obj, struct dump_config *dc)
{
 ...
 return;
    ...
    dc->cur_obj_klass = (int)(((struct RBasic*)(obj))->flags & RUBY_T_MASK) == RUBY_T_NODE ? 0 : (((struct RBasic*)(obj))->klass);
 ...
 break;
      ...
      case RUBY_T_STRING:
 if ((!(((struct RBasic*)((obj)))->flags&(((VALUE)RUBY_FL_USER1)))))
     dump_append(dc, ", \"embedded\":true");
 if ((rb_enc_str_coderange(obj) == RUBY_ENC_CODERANGE_BROKEN))
     dump_append(dc, ", \"broken\":true");
 if (((!(((VALUE)(obj) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(obj) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(obj))->flags & RUBY_T_MASK) != RUBY_T_NODE)?(((struct RBasic*)((obj)))->flags&((RSTRING_FSTR))):0))
 ...
 if (!((int)((((struct RBasic*)(obj))->flags & RUBY_ENCODING_MASK)>>RUBY_ENCODING_SHIFT) == 0))
     dump_append(dc, ", \"encoding\":\"%s\"", (rb_enc_from_index(((int)((((struct RBasic*)(obj))->flags & RUBY_ENCODING_MASK)>>RUBY_ENCODING_SHIFT) != RUBY_ENCODING_INLINE_MAX ? (int)((((struct RBasic*)(obj))->flags & RUBY_ENCODING_MASK)>>RUBY_ENCODING_SHIFT) : rb_enc_get_index(obj))))->name);
 break;

      case RUBY_T_HASH:
 dump_append(dc, ", \"size\":%zu", (size_t)(((struct RHash*)(obj))->ntbl ? ((struct RHash*)(obj))->ntbl->num_entries : (st_index_t)0));
 if (((!(((VALUE)(obj) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(obj) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(obj))->flags & RUBY_T_MASK) != RUBY_T_NODE)?(((struct RBasic*)((obj)))->flags&((((VALUE)RUBY_FL_USER2)))):0))
     dump_append(dc, ", \"default\":\"%p\"", (void *)(((struct RHash*)(obj))->ifnone));
 break;

      case RUBY_T_ARRAY:
 dump_append(dc, ", \"length\":%ld", rb_array_len(obj));
 if (rb_array_len(obj) > 0 && ((!(((VALUE)(obj) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(obj) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(obj))->flags & RUBY_T_MASK) != RUBY_T_NODE)?(((struct RBasic*)((obj)))->flags&((RUBY_ELTS_SHARED))):0))
     dump_append(dc, ", \"shared\":true");
 if (rb_array_len(obj) > 0 && ((!(((VALUE)(obj) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(obj) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(obj))->flags & RUBY_T_MASK) != RUBY_T_NODE)?(((struct RBasic*)((obj)))->flags&(((VALUE)RARRAY_EMBED_FLAG))):0))
     dump_append(dc, ", \"embedded\":true");
 break;
 ...
 if ((((struct RTypedData*)(obj))->typed_flag == 1))
     dump_append(dc, ", \"struct\":\"%s\"", (((struct RTypedData*)(obj))->type)->wrap_struct_name);
 break;

      case RUBY_T_FLOAT:
 dump_append(dc, ", \"value\":\"%g\"", rb_float_value_inline(obj));
 break;

      case RUBY_T_OBJECT:
 dump_append(dc, ", \"ivars\":%u", ((((struct RBasic*)(obj))->flags & ROBJECT_EMBED) ? ROBJECT_EMBED_LEN_MAX : ((struct RObject*)(obj))->as.heap.numiv));
 break;
 ...
 if (!(((VALUE)(ainfo->mid) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) {
     VALUE m = rb_sym2str(ainfo->mid);
     dump_append(dc, ", \"method\":\"%s\"", (!(((struct RBasic*)(m))->flags & RSTRING_NOEMBED) ? ((struct RString*)(m))->as.ary : ((struct RString*)(m))->as.heap.ptr));
 }
...
heap_i(void *vstart, void *vend, size_t stride, void *data)
{
 ...
 if (dc->full_heap || ((struct RBasic*)(v))->flags)
     dump_object(v, dc);
    }
    return 0;
}
...
root_obj_i(const char *category, VALUE obj, void *data)
{
    ...
    if (dc->root_category != ((void*)0) && category != dc->root_category)
 dump_append(dc, "]}\n");
    if (dc->root_category == ((void*)0) || category != dc->root_category)
...
dump_output(struct dump_config *dc, VALUE opts, VALUE output, const char *filename)
{
    ...
    if (!(((VALUE)(opts) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) {
 output = rb_hash_aref(opts, sym_output);

 if (((VALUE)RUBY_Qtrue) == rb_hash_lookup2(opts, sym_full, ((VALUE)RUBY_Qfalse)))
     dc->full_heap = 1;
    }

    if (output == sym_stdout) {
 dc->stream = stdout;
 dc->string = ((VALUE)RUBY_Qnil);
    }
    else if (output == sym_file) {
 rb_io_t *fptr;
 rb_require("tempfile");
 tmp = rb_assoc_new( ({ (__builtin_constant_p(filename)) ? rb_str_new_static((filename), (long)strlen(filename)) : rb_str_new_cstr(filename); }),  ({ (__builtin_constant_p(".json")) ? rb_str_new_static((".json"), (long)strlen(".json")) : rb_str_new_cstr(".json"); }));
 tmp = rb_funcallv(rb_path2class("Tempfile"), (__builtin_constant_p("create") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("create")), (long)strlen(("create"))); (ID) rb_intern_id_cache; }) : rb_intern("create")), 1, &tmp);
      io:
 dc->string = rb_io_get_write_io(tmp);
 rb_io_flush(dc->string);
 rb_io_check_closed((fptr) = ((struct RFile*)(rb_io_taint_check(dc->string)))->fptr);
 dc->stream = rb_io_stdio_file(fptr);
    }
    else if (output == sym_string) {
 dc->string =  ({ (__builtin_constant_p("")) ? rb_str_new_static((""), (long)strlen("")) : rb_str_new_cstr(""); });
    }
    else if (!!((VALUE)(tmp = rb_io_check_io(output)) != ((VALUE)RUBY_Qnil))) {
 output = sym_file;
 goto io;
    }
    else {
 rb_raise(rb_eArgError, "wrong output option: %li\v", output);
    }
    return output;
}
...
objspace_dump(int argc, VALUE *argv, VALUE os)
{
    ...
    VALUE obj = ((VALUE)RUBY_Qnil), opts = ((VALUE)RUBY_Qnil), output;
...
objspace_dump_all(int argc, VALUE *argv, VALUE os)
{
    ...
    VALUE opts = ((VALUE)RUBY_Qnil), output;
    struct dump_config dc = {0,};
...
Init_objspace_dump(VALUE rb_mObjSpace)
{
    ...
    sym_output = (rb_id2sym((__builtin_constant_p("output") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("output")), (long)strlen(("output"))); (ID) rb_intern_id_cache; }) : rb_intern("output"))));
    sym_stdout = (rb_id2sym((__builtin_constant_p("stdout") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("stdout")), (long)strlen(("stdout"))); (ID) rb_intern_id_cache; }) : rb_intern("stdout"))));
    sym_string = (rb_id2sym((__builtin_constant_p("string") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("string")), (long)strlen(("string"))); (ID) rb_intern_id_cache; }) : rb_intern("string"))));
    sym_file = (rb_id2sym((__builtin_constant_p("file") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("file")), (long)strlen(("file"))); (ID) rb_intern_id_cache; }) : rb_intern("file"))));
    sym_full = (rb_id2sym((__builtin_constant_p("full") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("full")), (long)strlen(("full"))); (ID) rb_intern_id_cache; }) : rb_intern("full"))));
