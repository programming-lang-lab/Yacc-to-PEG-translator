...
static UTF32 unescape_unicode(const unsigned char *p)
{
    ...
    UTF32 result = 0;
    b = digit_values[p[0]];
    if (b < 0) return (UTF32)0x0000FFFD;
...
{
    int cs = 0x666;
    VALUE last_name = ((VALUE)RUBY_Qnil);
    ...
    *result = !((VALUE)(object_class) != ((VALUE)RUBY_Qnil)) ? rb_hash_new() : rb_class_new_instance(0, 0, object_class);
 {
...
tr2:
 {
        ...
        json->parsing_name = 0;
        if (np == ((void*)0)) { p--; {p++; cs = 3; goto _out;} } else {p = (( np))-1;}
    }
 goto st3;
st3:
 if ( ++p == pe )
...
tr11:
 {
        ...
        if (np == ((void*)0)) {
            ...
            if (!((VALUE)(json->object_class) != ((VALUE)RUBY_Qnil))) {
 ...
 _out: {}
    ...
    if (cs >= JSON_object_first_final) {
        if (json->create_additions) {
            ...
            if (!!((VALUE)(klassname) != ((VALUE)RUBY_Qnil))) {
                VALUE klass = rb_funcall(mJSON, i_deep_const_get, 1, klassname);
                if (!(((VALUE)(rb_funcall(klass, i_json_creatable_p, 0)) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) {
...
tr2:
 {
        ...
        if (np == ((void*)0)) { p--; {p++; cs = 29; goto _out;} } else {p = (( np))-1;}
    }
 goto st29;
tr3:
 {
        char *np;
        if(pe > p + 8 && !strncmp("-Infinity", p, 9)) {
            if (json->allow_nan) {
                *result = CMinusInfinity;
                {p = (( p + 10))-1;}
                p--; {p++; cs = 29; goto _out;}
            } else {
                enc_raise(rb_utf8_encoding(), eParserError, "%u: unexpected token at '%s'", 247, p);
            }
        }
...
tr25:
 {
        if (json->allow_nan) {
            *result = CInfinity;
            ...
            enc_raise(rb_utf8_encoding(), eParserError, "%u: unexpected token at '%s'", 231, p - 8);
        }
    }
 goto st29;
tr27:
 {
        if (json->allow_nan) {
            *result = CNaN;
            ...
            enc_raise(rb_utf8_encoding(), eParserError, "%u: unexpected token at '%s'", 224, p - 2);
        }
    }
 goto st29;
tr31:
...
case 5:
 ...
 _out: {}
    ...
    if (cs >= JSON_integer_first_final) {
        ...
        *result = rb_cstr2inum((json->fbuffer->ptr), 10);
        return p + 1;
    } else {
        return ((void*)0);
    }
...
case 7:
 ...
 _out: {}
    ...
    if (cs >= JSON_float_first_final) {
        ...
        fbuffer_append(json->fbuffer, json->memo, len);
        fbuffer_append_char(json->fbuffer, '\0');
        if (!((VALUE)(json->decimal_class) != ((VALUE)RUBY_Qnil))) {
          *result = rb_float_new(rb_cstr_to_dbl((json->fbuffer->ptr), 1));
        } else {
          VALUE text;
          text =  ({ (__builtin_constant_p((json->fbuffer->ptr))) ? rb_str_new_static(((json->fbuffer->ptr)), (long)strlen((json->fbuffer->ptr))) : rb_str_new_cstr((json->fbuffer->ptr)); });
...
static char *JSON_parse_array(JSON_Parser *json, char *p, char *pe, VALUE *result, int current_nesting)
{
    ...
    *result = !((VALUE)(array_class) != ((VALUE)RUBY_Qnil)) ? rb_ary_new() : rb_class_new_instance(0, 0, array_class);
 {
 cs = JSON_array_start;
 }
 {
...
tr2:
 {
        ...
        if (np == ((void*)0)) {
            ...
            if (!((VALUE)(json->array_class) != ((VALUE)RUBY_Qnil))) {
...
case 16:
 ...
 _out: {}
    ...
    if(cs >= JSON_array_first_final) {
        ...
        enc_raise(rb_utf8_encoding(), eParserError, "%u: unexpected token at '%s'", 416, p);
        return ((void*)0);
    }
}
                ...
                case 'u':
                    if (pe > stringEnd - 4) {
                      enc_raise(
                        ...
                        "%u: incomplete unicode character escape sequence at '%s'", 458, p
                      );
                    } else {
                        UTF32 ch = unescape_unicode((unsigned char *) ++pe);
                        pe += 3;
                        if ((UTF32)0xD800 == (ch & 0xFC00)) {
                            pe++;
                            if (pe > stringEnd - 6) {
                              enc_raise(
                                rb_utf8_encoding(), eParserError,
                                "%u: incomplete surrogate pair at '%s'", 468, p
                                );
                            }
                            if (pe[0] == '\\' && pe[1] == 'u') {
...
match_i(VALUE regexp, VALUE klass, VALUE memo)
{
    ...
    if (!(((VALUE)(rb_funcall(klass, i_json_creatable_p, 0)) & (VALUE)~((VALUE)RUBY_Qnil)) == 0) &&
      !(((VALUE)(rb_funcall(regexp, i_match, 1, rb_ary_entry(memo, 0))) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) {
...
case 7:
 ...
 _out: {}
    ...
    if (json->create_additions && !(((VALUE)(match_string = json->match_string) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) {
          VALUE klass;
    ...
    if (json->symbolize_names && json->parsing_name) {
      *result = rb_str_intern(*result);
      ...
      rb_str_resize(*result, (!(((struct RBasic*)(*result))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(*result))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(*result))->as.heap.len));
    }
...
static VALUE convert_encoding(VALUE source)
{
  ...
  if (enc == rb_ascii8bit_encoding()) {
    if ((!(!(((VALUE)(source) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(source) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(source))->flags & RUBY_T_MASK) != RUBY_T_NODE) || (((struct RBasic*)(source))->flags&RUBY_FL_FREEZE))) {
      source = rb_str_dup(source);
    }
    rb_enc_associate((source), rb_utf8_encoding());
  } else {
...
{
    VALUE source, opts;
    JSON_Parser *json; ((json) = (JSON_Parser*)rb_check_typeddata((self), (&JSON_Parser_type)));
    ...
    if (!!((VALUE)(opts) != ((VALUE)RUBY_Qnil))) {
            ...
            VALUE tmp = (rb_id2sym(i_max_nesting));
            if (!(((VALUE)(rb_funcall(opts, i_key_p, 1, tmp)) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) {
                ...
                if (!(((VALUE)(max_nesting) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) {
                    ...
                    json->max_nesting = ((int)rb_fix2int((VALUE)(max_nesting)));
                } else {
                    json->max_nesting = 0;
                }
            } else {
            ...
            tmp = (rb_id2sym(i_allow_nan));
            if (!(((VALUE)(rb_funcall(opts, i_key_p, 1, tmp)) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) {
                json->allow_nan = !(((VALUE)(rb_hash_aref(opts, tmp)) & (VALUE)~((VALUE)RUBY_Qnil)) == 0) ? 1 : 0;
            } else {
                json->allow_nan = 0;
            }
            tmp = (rb_id2sym(i_symbolize_names));
            if (!(((VALUE)(rb_funcall(opts, i_key_p, 1, tmp)) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) {
                json->symbolize_names = !(((VALUE)(rb_hash_aref(opts, tmp)) & (VALUE)~((VALUE)RUBY_Qnil)) == 0) ? 1 : 0;
            } else {
                json->symbolize_names = 0;
            }
            tmp = (rb_id2sym(i_create_additions));
            if (!(((VALUE)(rb_funcall(opts, i_key_p, 1, tmp)) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) {
                json->create_additions = !(((VALUE)(rb_hash_aref(opts, tmp)) & (VALUE)~((VALUE)RUBY_Qnil)) == 0);
            } else {
            ...
            tmp = (rb_id2sym(i_create_id));
            if (!(((VALUE)(rb_funcall(opts, i_key_p, 1, tmp)) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) {
                json->create_id = rb_hash_aref(opts, tmp);
            } else {
                json->create_id = rb_funcall(mJSON, i_create_id, 0);
            }
            tmp = (rb_id2sym(i_object_class));
            if (!(((VALUE)(rb_funcall(opts, i_key_p, 1, tmp)) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) {
                json->object_class = rb_hash_aref(opts, tmp);
            } else {
                json->object_class = ((VALUE)RUBY_Qnil);
            }
            tmp = (rb_id2sym(i_array_class));
            if (!(((VALUE)(rb_funcall(opts, i_key_p, 1, tmp)) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) {
                json->array_class = rb_hash_aref(opts, tmp);
            } else {
                json->array_class = ((VALUE)RUBY_Qnil);
            }
            tmp = (rb_id2sym(i_decimal_class));
            if (!(((VALUE)(rb_funcall(opts, i_key_p, 1, tmp)) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) {
                json->decimal_class = rb_hash_aref(opts, tmp);
            } else {
                json->decimal_class = ((VALUE)RUBY_Qnil);
            }
            tmp = (rb_id2sym(i_match_string));
            if (!(((VALUE)(rb_funcall(opts, i_key_p, 1, tmp)) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) {
                VALUE match_string = rb_hash_aref(opts, tmp);
                json->match_string = !(((VALUE)(match_string) & (VALUE)~((VALUE)RUBY_Qnil)) == 0) ? match_string : ((VALUE)RUBY_Qnil);
            } else {
                json->match_string = ((VALUE)RUBY_Qnil);
            }
    ...
    source = convert_encoding(rb_string_value(&(source)));
    rb_string_value(&(source));
    json->len = (!(((struct RBasic*)(source))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(source))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(source))->as.heap.len);
    json->source = (!(((struct RBasic*)(source))->flags & RSTRING_NOEMBED) ? ((struct RString*)(source))->as.ary : ((struct RString*)(source))->as.heap.ptr);;
    json->Vsource = source;
    return self;
}
enum {JSON_start = 1};
...
static VALUE cParser_parse(VALUE self)
{
  ...
  JSON_Parser *json; ((json) = (JSON_Parser*)rb_check_typeddata((self), (&JSON_Parser_type))); if (!json->Vsource) rb_raise(rb_eTypeError, "uninitialized instance");
 {
 cs = JSON_start;
 }
 p = json->source;
...
tr2:
 {
        ...
        if (np == ((void*)0)) { p--; {p++; cs = 10; goto _out;} } else {p = (( np))-1;}
    }
 goto st10;
st10:
 if ( ++p == pe )
...
case 9:
 ...
 _out: {}
  ...
  if (cs >= JSON_first_final && p == pe) {
    ...
    enc_raise(rb_utf8_encoding(), eParserError, "%u: unexpected token at '%s'", 765, p);
...
static size_t JSON_memsize(const void *ptr)
{
    ...
    return sizeof(*json) + (json->fbuffer->capa);
}
...
{
    JSON_Parser *json;
    VALUE obj = ({ VALUE data_struct_obj = rb_data_typed_object_zalloc(klass, sizeof(JSON_Parser), &JSON_Parser_type); (void)((json) = (JSON_Parser *)(((struct RData*)(data_struct_obj))->data));; data_struct_obj; });
...
void Init_parser(void)
{
    ...
    CNaN = rb_const_get(mJSON, (__builtin_constant_p("NaN") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("NaN")), (long)strlen(("NaN"))); (ID) rb_intern_id_cache; }) : rb_intern("NaN")));
    CInfinity = rb_const_get(mJSON, (__builtin_constant_p("Infinity") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("Infinity")), (long)strlen(("Infinity"))); (ID) rb_intern_id_cache; }) : rb_intern("Infinity")));
    CMinusInfinity = rb_const_get(mJSON, (__builtin_constant_p("MinusInfinity") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("MinusInfinity")), (long)strlen(("MinusInfinity"))); (ID) rb_intern_id_cache; }) : rb_intern("MinusInfinity")));

    i_json_creatable_p = (__builtin_constant_p("json_creatable?") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("json_creatable?")), (long)strlen(("json_creatable?"))); (ID) rb_intern_id_cache; }) : rb_intern("json_creatable?"));
    i_json_create = (__builtin_constant_p("json_create") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("json_create")), (long)strlen(("json_create"))); (ID) rb_intern_id_cache; }) : rb_intern("json_create"));
    ...
    i_create_additions = (__builtin_constant_p("create_additions") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("create_additions")), (long)strlen(("create_additions"))); (ID) rb_intern_id_cache; }) : rb_intern("create_additions"));
    i_chr = (__builtin_constant_p("chr") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("chr")), (long)strlen(("chr"))); (ID) rb_intern_id_cache; }) : rb_intern("chr"));
    ...
    i_symbolize_names = (__builtin_constant_p("symbolize_names") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("symbolize_names")), (long)strlen(("symbolize_names"))); (ID) rb_intern_id_cache; }) : rb_intern("symbolize_names"));
    i_object_class = (__builtin_constant_p("object_class") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("object_class")), (long)strlen(("object_class"))); (ID) rb_intern_id_cache; }) : rb_intern("object_class"));
    i_array_class = (__builtin_constant_p("array_class") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("array_class")), (long)strlen(("array_class"))); (ID) rb_intern_id_cache; }) : rb_intern("array_class"));
    i_decimal_class = (__builtin_constant_p("decimal_class") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("decimal_class")), (long)strlen(("decimal_class"))); (ID) rb_intern_id_cache; }) : rb_intern("decimal_class"));
    ...
    i_match_string = (__builtin_constant_p("match_string") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("match_string")), (long)strlen(("match_string"))); (ID) rb_intern_id_cache; }) : rb_intern("match_string"));
    ...
    i_deep_const_get = (__builtin_constant_p("deep_const_get") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("deep_const_get")), (long)strlen(("deep_const_get"))); (ID) rb_intern_id_cache; }) : rb_intern("deep_const_get"));
    i_aset = (__builtin_constant_p("[]=") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("[]=")), (long)strlen(("[]="))); (ID) rb_intern_id_cache; }) : rb_intern("[]="));
    ...
    i_leftshift = (__builtin_constant_p("<<") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("<<")), (long)strlen(("<<"))); (ID) rb_intern_id_cache; }) : rb_intern("<<"));
