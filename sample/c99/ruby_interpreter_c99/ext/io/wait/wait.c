...
{
    VALUE timeout = ((VALUE)RUBY_Qnil);
    rb_check_arity(argc, 0, 1);
    if (!argc || !((VALUE)(timeout = argv[0]) != ((VALUE)RUBY_Qnil))) {
 return ((void*)0);
    }
    else {
...
io_nread(VALUE io)
{
    ...
    if (len > 0) return (((VALUE)(len))<<1 | RUBY_FIXNUM_FLAG);
    if (!((void)(fptr->fd),((VALUE)RUBY_Qtrue))) return (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG);
    if (ioctl(fptr->fd, 0x541B, &n)) return (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG);
    if (n > 0) return (((VALUE)((int)(n)))<<1 | RUBY_FIXNUM_FLAG);
...
io_ready_p(VALUE io)
{
    ...
    rb_io_check_closed((fptr) = ((struct RFile*)(rb_io_taint_check(io)))->fptr);
    rb_io_check_readable(fptr);
    if (rb_io_read_pending(fptr)) return ((VALUE)RUBY_Qtrue);
    if (wait_for_single_fd(fptr, 0x001, &tv))
...
io_wait_writable(int argc, VALUE *argv, VALUE io)
{
    ...
    tv = get_timeout(argc, argv, &timerec);
    if (wait_for_single_fd(fptr, 0x004, tv)) {
 return io;
    }
    return ((VALUE)RUBY_Qnil);
}
...
{
    if (mode == (rb_id2sym((__builtin_constant_p("r") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("r")), (long)strlen(("r"))); (ID) rb_intern_id_cache; }) : rb_intern("r"))))) {
 return 0x001;
    }
    if (mode == (rb_id2sym((__builtin_constant_p("read") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("read")), (long)strlen(("read"))); (ID) rb_intern_id_cache; }) : rb_intern("read"))))) {
 return 0x001;
    }
    if (mode == (rb_id2sym((__builtin_constant_p("readable") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("readable")), (long)strlen(("readable"))); (ID) rb_intern_id_cache; }) : rb_intern("readable"))))) {
 return 0x001;
    }
    if (mode == (rb_id2sym((__builtin_constant_p("w") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("w")), (long)strlen(("w"))); (ID) rb_intern_id_cache; }) : rb_intern("w"))))) {
 return 0x004;
    }
    if (mode == (rb_id2sym((__builtin_constant_p("write") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("write")), (long)strlen(("write"))); (ID) rb_intern_id_cache; }) : rb_intern("write"))))) {
 return 0x004;
    }
    if (mode == (rb_id2sym((__builtin_constant_p("writable") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("writable")), (long)strlen(("writable"))); (ID) rb_intern_id_cache; }) : rb_intern("writable"))))) {
 return 0x004;
    }
    if (mode == (rb_id2sym((__builtin_constant_p("rw") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("rw")), (long)strlen(("rw"))); (ID) rb_intern_id_cache; }) : rb_intern("rw"))))) {
 return 0x001|0x004;
    }
    if (mode == (rb_id2sym((__builtin_constant_p("read_write") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("read_write")), (long)strlen(("read_write"))); (ID) rb_intern_id_cache; }) : rb_intern("read_write"))))) {
 return 0x001|0x004;
    }
    if (mode == (rb_id2sym((__builtin_constant_p("readable_writable") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("readable_writable")), (long)strlen(("readable_writable"))); (ID) rb_intern_id_cache; }) : rb_intern("readable_writable"))))) {
 return 0x001|0x004;
    }
    rb_raise(rb_eArgError, "unsupported mode: %li\v", mode);
    return 0;
}
static VALUE
io_wait_readwrite(int argc, VALUE *argv, VALUE io)
{
    rb_io_t *fptr;
    struct timeval timerec;
    struct timeval *tv = ((void*)0);
    int event = 0;
    int i;

    rb_io_check_closed((fptr) = ((struct RFile*)(rb_io_taint_check(io)))->fptr);
    for (i = 0; i < argc; ++i) {
 if (((((VALUE)(argv[i])&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(argv[i]) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(argv[i]) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(argv[i]))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL)))) {
    ...
    rb_io_check_closed(fptr);
    if (!event) event = 0x001;
    if ((event & 0x001) && rb_io_read_pending(fptr))
 return ((VALUE)RUBY_Qtrue);
