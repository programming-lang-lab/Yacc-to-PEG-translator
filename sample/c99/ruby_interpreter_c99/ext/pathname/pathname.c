...
get_strpath(VALUE obj)
{
    ...
    if (!( ((RUBY_T_STRING) == RUBY_T_FIXNUM) ? (((int)(long)(strpath))&RUBY_FIXNUM_FLAG) : ((RUBY_T_STRING) == RUBY_T_TRUE) ? ((strpath) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_STRING) == RUBY_T_FALSE) ? ((strpath) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_STRING) == RUBY_T_NIL) ? ((strpath) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_STRING) == RUBY_T_UNDEF) ? ((strpath) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_STRING) == RUBY_T_SYMBOL) ? ((((VALUE)(strpath)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(strpath) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(strpath) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(strpath))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_STRING) == RUBY_T_FLOAT) ? ( ((((int)(long)(strpath))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(strpath) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(strpath) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(strpath))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(strpath) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(strpath) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(strpath))->flags & RUBY_T_MASK) == (RUBY_T_STRING))))
...
path_initialize(VALUE self, VALUE arg)
{
    ...
    if (( ((RUBY_T_STRING) == RUBY_T_FIXNUM) ? (((int)(long)(arg))&RUBY_FIXNUM_FLAG) : ((RUBY_T_STRING) == RUBY_T_TRUE) ? ((arg) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_STRING) == RUBY_T_FALSE) ? ((arg) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_STRING) == RUBY_T_NIL) ? ((arg) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_STRING) == RUBY_T_UNDEF) ? ((arg) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_STRING) == RUBY_T_SYMBOL) ? ((((VALUE)(arg)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(arg) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(arg) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(arg))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_STRING) == RUBY_T_FLOAT) ? ( ((((int)(long)(arg))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(arg) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(arg) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(arg))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(arg) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(arg) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(arg))->flags & RUBY_T_MASK) == (RUBY_T_STRING)))) {
        ...
        str = rb_check_funcall(arg, id_to_path, 0, ((void*)0));
        if (str == ((VALUE)RUBY_Qundef))
            str = arg;
        rb_string_value(&(str));
    }
    if (memchr((!(((struct RBasic*)(str))->flags & RSTRING_NOEMBED) ? ((struct RString*)(str))->as.ary : ((struct RString*)(str))->as.heap.ptr), '\0', (!(((struct RBasic*)(str))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(str))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(str))->as.heap.len)))
        rb_raise(rb_eArgError, "pathname contains null byte");
    str = rb_obj_dup(str);

    set_strpath(self, str);
    ( (((!(((VALUE)(self) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(self) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(self))->flags & RUBY_T_MASK) != RUBY_T_NODE) && (int)(((struct RBasic*)(self))->flags & RUBY_T_MASK) != RUBY_T_BIGNUM && (int)(((struct RBasic*)(self))->flags & RUBY_T_MASK) != RUBY_T_FLOAT) && (!(((VALUE)(str) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(str) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(str))->flags & RUBY_T_MASK) != RUBY_T_NODE)) ? (void)(((struct RBasic*)(self))->flags |= ((((struct RBasic*)(str))->flags&(RUBY_FL_TAINT)))) : (void)0);
    return self;
}
static VALUE
...
path_cmp(VALUE self, VALUE other)
{
    ...
    p1 = (!(((struct RBasic*)(s1))->flags & RSTRING_NOEMBED) ? ((struct RString*)(s1))->as.ary : ((struct RString*)(s1))->as.heap.ptr);
    p2 = (!(((struct RBasic*)(s2))->flags & RSTRING_NOEMBED) ? ((struct RString*)(s2))->as.ary : ((struct RString*)(s2))->as.heap.ptr);
    e1 = p1 + (!(((struct RBasic*)(s1))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(s1))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(s1))->as.heap.len);
    e2 = p2 + (!(((struct RBasic*)(s2))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(s2))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(s2))->as.heap.len);
    while (p1 < e1 && p2 < e2) {
        int c1, c2;
        c1 = (unsigned char)*p1++;
        c2 = (unsigned char)*p2++;
...
{
    return (((VALUE)((long)(rb_str_hash(get_strpath(self)))))<<1 | RUBY_FIXNUM_FLAG);
}
static VALUE
...
path_inspect(VALUE self)
{
    ...
    return rb_sprintf("#<%s:%li\v>", c, str);
}
static VALUE
...
path_sub_ext(VALUE self, VALUE repl)
{
    ...
    extlen = (!(((struct RBasic*)(str))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(str))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(str))->as.heap.len);
    ext = ruby_enc_find_extname(p, &extlen, rb_enc_get(str));
    if (ext == ((void*)0)) {
        ext = p + (!(((struct RBasic*)(str))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(str))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(str))->as.heap.len);
    }
    else if (extlen <= 1) {
        ext += extlen;
    }
...
path_split(VALUE self)
{
    ...
    return rb_ary_new_from_args(2, dirname, basename);
}
...
path_empty_p(VALUE self)
{
    ...
    if (!(((VALUE)(rb_funcall(rb_mFileTest, id_directory_p, 1, path)) & (VALUE)~((VALUE)RUBY_Qnil)) == 0))
...
static VALUE
s_glob_i(VALUE elt, VALUE klass, int argc, const VALUE *argv, VALUE blockarg)
{
...
static VALUE
glob_i(VALUE elt, VALUE self, int argc, const VALUE *argv, VALUE blockarg)
{
...
path_glob(int argc, VALUE *argv, VALUE self)
{
    ...
    n = rb_scan_args(argc, argv, "11", &args[0], &args[1]);
    if (n == 1)
      args[1] = (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG);

    args[2] = rb_hash_new();
    rb_hash_aset(args[2], (rb_id2sym(id_base)), get_strpath(self));
...
static VALUE
each_entry_i(VALUE elt, VALUE klass, int argc, const VALUE *argv, VALUE blockarg)
{
    return rb_yield(rb_class_new_instance(1, &elt, klass));
}
...
Init_pathname(void)
{
    {void InitVM_pathname(void);InitVM_pathname();};
    ...
    rb_define_method(rb_cPathname, "birthtime", rb_f_notimplement, 0);
