...
static const char *syslog_ident = ((void*)0);
...
static void syslog_write(int pri, int argc, VALUE *argv)
{
    ...
    syslog(pri, "%s", (!(((struct RBasic*)(str))->flags & RSTRING_NOEMBED) ? ((struct RString*)(str))->as.ary : ((struct RString*)(str))->as.heap.ptr));
}
...
static VALUE mSyslog_open(int argc, VALUE *argv, VALUE self)
{
    ...
    if (!((VALUE)(ident) != ((VALUE)RUBY_Qnil))) {
        ident = rb_gv_get("$0");
    }
    ident_ptr = rb_string_value_cstr(&(ident));
    rb_check_safe_obj(ident);
    syslog_ident = ruby_strdup(ident_ptr);

    if (!((VALUE)(opt) != ((VALUE)RUBY_Qnil))) {
 syslog_options = 0x01 | 0x02;
    } else {
 syslog_options = rb_num2int_inline(opt);
    }

    if (!((VALUE)(fac) != ((VALUE)RUBY_Qnil))) {
 syslog_facility = (1<<3);
    } else {
 syslog_facility = rb_num2int_inline(fac);
    }
...
{
    return syslog_opened ? ((VALUE)RUBY_Qtrue) : ((VALUE)RUBY_Qfalse);
}
...
{
    return syslog_opened ?  ({ (__builtin_constant_p(syslog_ident)) ? rb_str_new_static((syslog_ident), (long)strlen(syslog_ident)) : rb_str_new_cstr(syslog_ident); }) : ((VALUE)RUBY_Qnil);
}
...
{
    return syslog_opened ? (((VALUE)((int)(syslog_options)))<<1 | RUBY_FIXNUM_FLAG) : ((VALUE)RUBY_Qnil);
}
...
{
    return syslog_opened ? (((VALUE)((int)(syslog_facility)))<<1 | RUBY_FIXNUM_FLAG) : ((VALUE)RUBY_Qnil);
}
...
{
    return syslog_opened ? (((VALUE)((int)(syslog_mask)))<<1 | RUBY_FIXNUM_FLAG) : ((VALUE)RUBY_Qnil);
}
static VALUE mSyslog_set_mask(VALUE self, VALUE mask)
{
    ...
    setlogmask(syslog_mask = rb_num2int_inline(mask));
...
static VALUE mSyslog_log(int argc, VALUE *argv, VALUE self)
{
    ...
    if (!(((int)(long)(pri))&RUBY_FIXNUM_FLAG)) {
 rb_raise(rb_eTypeError, "type mismatch: %li\v given", rb_obj_class(pri));
    }

    syslog_write(((int)rb_fix2int((VALUE)(pri))), argc, argv);
...
{
    rb_check_type((VALUE)(self),(RUBY_T_MODULE));

    if (!syslog_opened)
 return rb_sprintf("<#%li\v: opened=false>", self);

    return rb_sprintf("<#%li\v: opened=true, ident=\"%s\", options=%d, facility=%d, mask=%d>",
        self,
        syslog_ident,
        syslog_options,
        syslog_facility,
...
static VALUE mSyslog_emerg(int argc, VALUE *argv, VALUE self) { syslog_write((0), argc, argv); return self; }


static VALUE mSyslog_alert(int argc, VALUE *argv, VALUE self) { syslog_write((1), argc, argv); return self; }


static VALUE mSyslog_crit(int argc, VALUE *argv, VALUE self) { syslog_write((2), argc, argv); return self; }


static VALUE mSyslog_err(int argc, VALUE *argv, VALUE self) { syslog_write((3), argc, argv); return self; }


static VALUE mSyslog_warning(int argc, VALUE *argv, VALUE self) { syslog_write((4), argc, argv); return self; }


static VALUE mSyslog_notice(int argc, VALUE *argv, VALUE self) { syslog_write((5), argc, argv); return self; }


static VALUE mSyslog_info(int argc, VALUE *argv, VALUE self) { syslog_write((6), argc, argv); return self; }


static VALUE mSyslog_debug(int argc, VALUE *argv, VALUE self) { syslog_write((7), argc, argv); return self; }
...
{
    return (((VALUE)((1 << (rb_num2int_inline(pri)))))<<1 | RUBY_FIXNUM_FLAG);
}
...
{
    return (((VALUE)(((1 << ((rb_num2int_inline(pri))+1)) - 1)))<<1 | RUBY_FIXNUM_FLAG);
}
...
void Init_syslog(void)
{
    ...
    rb_define_const(mSyslogOption, "LOG_PID", (((VALUE)((int)(0x01)))<<1 | RUBY_FIXNUM_FLAG));


    rb_define_const(mSyslogOption, "LOG_CONS", (((VALUE)((int)(0x02)))<<1 | RUBY_FIXNUM_FLAG));


    rb_define_const(mSyslogOption, "LOG_ODELAY", (((VALUE)((int)(0x04)))<<1 | RUBY_FIXNUM_FLAG));


    rb_define_const(mSyslogOption, "LOG_NDELAY", (((VALUE)((int)(0x08)))<<1 | RUBY_FIXNUM_FLAG));


    rb_define_const(mSyslogOption, "LOG_NOWAIT", (((VALUE)((int)(0x10)))<<1 | RUBY_FIXNUM_FLAG));


    rb_define_const(mSyslogOption, "LOG_PERROR", (((VALUE)((int)(0x20)))<<1 | RUBY_FIXNUM_FLAG));
    rb_define_const(mSyslogFacility, "LOG_AUTH", (((VALUE)((int)((4<<3))))<<1 | RUBY_FIXNUM_FLAG));


    rb_define_const(mSyslogFacility, "LOG_AUTHPRIV", (((VALUE)((int)((10<<3))))<<1 | RUBY_FIXNUM_FLAG));





    rb_define_const(mSyslogFacility, "LOG_CRON", (((VALUE)((int)((9<<3))))<<1 | RUBY_FIXNUM_FLAG));


    rb_define_const(mSyslogFacility, "LOG_DAEMON", (((VALUE)((int)((3<<3))))<<1 | RUBY_FIXNUM_FLAG));


    rb_define_const(mSyslogFacility, "LOG_FTP", (((VALUE)((int)((11<<3))))<<1 | RUBY_FIXNUM_FLAG));


    rb_define_const(mSyslogFacility, "LOG_KERN", (((VALUE)((int)((0<<3))))<<1 | RUBY_FIXNUM_FLAG));


    rb_define_const(mSyslogFacility, "LOG_LPR", (((VALUE)((int)((6<<3))))<<1 | RUBY_FIXNUM_FLAG));


    rb_define_const(mSyslogFacility, "LOG_MAIL", (((VALUE)((int)((2<<3))))<<1 | RUBY_FIXNUM_FLAG));


    rb_define_const(mSyslogFacility, "LOG_NEWS", (((VALUE)((int)((7<<3))))<<1 | RUBY_FIXNUM_FLAG));
    rb_define_const(mSyslogFacility, "LOG_SYSLOG", (((VALUE)((int)((5<<3))))<<1 | RUBY_FIXNUM_FLAG));


    rb_define_const(mSyslogFacility, "LOG_USER", (((VALUE)((int)((1<<3))))<<1 | RUBY_FIXNUM_FLAG));


    rb_define_const(mSyslogFacility, "LOG_UUCP", (((VALUE)((int)((8<<3))))<<1 | RUBY_FIXNUM_FLAG));


    rb_define_const(mSyslogFacility, "LOG_LOCAL0", (((VALUE)((int)((16<<3))))<<1 | RUBY_FIXNUM_FLAG));


    rb_define_const(mSyslogFacility, "LOG_LOCAL1", (((VALUE)((int)((17<<3))))<<1 | RUBY_FIXNUM_FLAG));


    rb_define_const(mSyslogFacility, "LOG_LOCAL2", (((VALUE)((int)((18<<3))))<<1 | RUBY_FIXNUM_FLAG));


    rb_define_const(mSyslogFacility, "LOG_LOCAL3", (((VALUE)((int)((19<<3))))<<1 | RUBY_FIXNUM_FLAG));


    rb_define_const(mSyslogFacility, "LOG_LOCAL4", (((VALUE)((int)((20<<3))))<<1 | RUBY_FIXNUM_FLAG));


    rb_define_const(mSyslogFacility, "LOG_LOCAL5", (((VALUE)((int)((21<<3))))<<1 | RUBY_FIXNUM_FLAG));


    rb_define_const(mSyslogFacility, "LOG_LOCAL6", (((VALUE)((int)((22<<3))))<<1 | RUBY_FIXNUM_FLAG));


    rb_define_const(mSyslogFacility, "LOG_LOCAL7", (((VALUE)((int)((23<<3))))<<1 | RUBY_FIXNUM_FLAG));
    rb_define_const(mSyslogLevel, "LOG_EMERG", (((VALUE)((int)(0)))<<1 | RUBY_FIXNUM_FLAG)); rb_define_module_function(mSyslog, "emerg", mSyslog_emerg, -1);


    rb_define_const(mSyslogLevel, "LOG_ALERT", (((VALUE)((int)(1)))<<1 | RUBY_FIXNUM_FLAG)); rb_define_module_function(mSyslog, "alert", mSyslog_alert, -1);


    rb_define_const(mSyslogLevel, "LOG_CRIT", (((VALUE)((int)(2)))<<1 | RUBY_FIXNUM_FLAG)); rb_define_module_function(mSyslog, "crit", mSyslog_crit, -1);


    rb_define_const(mSyslogLevel, "LOG_ERR", (((VALUE)((int)(3)))<<1 | RUBY_FIXNUM_FLAG)); rb_define_module_function(mSyslog, "err", mSyslog_err, -1);


    rb_define_const(mSyslogLevel, "LOG_WARNING", (((VALUE)((int)(4)))<<1 | RUBY_FIXNUM_FLAG)); rb_define_module_function(mSyslog, "warning", mSyslog_warning, -1);


    rb_define_const(mSyslogLevel, "LOG_NOTICE", (((VALUE)((int)(5)))<<1 | RUBY_FIXNUM_FLAG)); rb_define_module_function(mSyslog, "notice", mSyslog_notice, -1);


    rb_define_const(mSyslogLevel, "LOG_INFO", (((VALUE)((int)(6)))<<1 | RUBY_FIXNUM_FLAG)); rb_define_module_function(mSyslog, "info", mSyslog_info, -1);


    rb_define_const(mSyslogLevel, "LOG_DEBUG", (((VALUE)((int)(7)))<<1 | RUBY_FIXNUM_FLAG)); rb_define_module_function(mSyslog, "debug", mSyslog_debug, -1);
    ...
    rb_funcall(mSyslogConstants, (__builtin_constant_p("include") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("include")), (long)strlen(("include"))); (ID) rb_intern_id_cache; }) : rb_intern("include")), 1, mSyslogMacros);

    rb_define_singleton_method(mSyslogConstants, "included", mSyslogMacros_included, 1);
    rb_funcall(mSyslog, (__builtin_constant_p("include") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("include")), (long)strlen(("include"))); (ID) rb_intern_id_cache; }) : rb_intern("include")), 1, mSyslogConstants);
}
