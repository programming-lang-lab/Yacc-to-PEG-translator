...
int rb_Digest_SHA256_Init(SHA256_CTX *);
void rb_Digest_SHA256_Update(SHA256_CTX*, const uint8_t*, size_t);
int rb_Digest_SHA256_Finish(SHA256_CTX*, uint8_t[32]);
char* rb_Digest_SHA256_End(SHA256_CTX*, char[(32 * 2 + 1)]);
char* rb_Digest_SHA256_Data(const uint8_t*, size_t, char[(32 * 2 + 1)]);

int rb_Digest_SHA384_Init(SHA384_CTX*);
void rb_Digest_SHA384_Update(SHA384_CTX*, const uint8_t*, size_t);
int rb_Digest_SHA384_Finish(SHA384_CTX*, uint8_t[48]);
char* rb_Digest_SHA384_End(SHA384_CTX*, char[(48 * 2 + 1)]);
char* rb_Digest_SHA384_Data(const uint8_t*, size_t, char[(48 * 2 + 1)]);

int rb_Digest_SHA512_Init(SHA512_CTX*);
void rb_Digest_SHA512_Update(SHA512_CTX*, const uint8_t*, size_t);
int rb_Digest_SHA512_Finish(SHA512_CTX*, uint8_t[64]);
char* rb_Digest_SHA512_End(SHA512_CTX*, char[(64 * 2 + 1)]);
char* rb_Digest_SHA512_Data(const uint8_t*, size_t, char[(64 * 2 + 1)]);
typedef uint8_t sha2_byte;
typedef uint32_t sha2_word32;
typedef uint64_t sha2_word64;
void rb_Digest_SHA512_Last(SHA512_CTX*);
void rb_Digest_SHA256_Transform(SHA256_CTX*, const sha2_word32*);
void rb_Digest_SHA512_Transform(SHA512_CTX*, const sha2_word64*);
...
int rb_Digest_SHA256_Init(SHA256_CTX* context) {
...
void rb_Digest_SHA256_Transform(SHA256_CTX* context, const sha2_word32* data) {
 ...
 do {
  ...
  { sha2_word32 tmp = (*data++); tmp = (tmp >> 16) | (tmp << 16); (W256[j]) = ((tmp & (sha2_word32)0xff00ff00UL) >> 8) | ((tmp & (sha2_word32)0x00ff00ffUL) << 8); };
...
void rb_Digest_SHA256_Update(SHA256_CTX* context, const sha2_byte *data, size_t len) {
 ...
 ((context != (SHA256_CTX*)0 && data != (sha2_byte*)0) ? (void) (0) : __assert_fail ("context != (SHA256_CTX*)0 && data != (sha2_byte*)0", "ext/digest/sha2/sha2.c", 538,  __PRETTY_FUNCTION__));

 usedspace = (unsigned int)((context->bitcount >> 3) % 64);
 if (usedspace > 0) {
  ...
  if (len >= freespace) {
   ...
   len -= freespace;
   data += freespace;
   rb_Digest_SHA256_Transform(context, (sha2_word32*)context->buffer);
  } else {
...
int rb_Digest_SHA256_Finish(SHA256_CTX* context, sha2_byte digest[]) {
 sha2_word32 *d = (sha2_word32*)digest;
 unsigned int usedspace;


 ((context != (SHA256_CTX*)0) ? (void) (0) : __assert_fail ("context != (SHA256_CTX*)0", "ext/digest/sha2/sha2.c", 583,  __PRETTY_FUNCTION__));
 ...
 if (digest != (sha2_byte*)0) {
  ...
  memcpy((&context->buffer[(64 - 8)]), (&context->bitcount), (sizeof(sha2_word64)));
...

  {
   ...
   int j;
   for (j = 0; j < 8; j++) {
    { sha2_word32 tmp = (context->state[j]); tmp = (tmp >> 16) | (tmp << 16); (context->state[j]) = ((tmp & (sha2_word32)0xff00ff00UL) >> 8) | ((tmp & (sha2_word32)0x00ff00ffUL) << 8); };
    *d++ = context->state[j];
   }
  }
...
char *rb_Digest_SHA256_End(SHA256_CTX* context, char buffer[]) {
 sha2_byte digest[32], *d = digest;
 int i;


 ((context != (SHA256_CTX*)0) ? (void) (0) : __assert_fail ("context != (SHA256_CTX*)0", "ext/digest/sha2/sha2.c", 648,  __PRETTY_FUNCTION__));

 if (buffer != (char*)0) {
  rb_Digest_SHA256_Finish(context, digest);
  for (i = 0; i < 32; i++) {
...
char* rb_Digest_SHA256_Data(const sha2_byte* data, size_t len, char digest[(32 * 2 + 1)]) {
 SHA256_CTX context;

 rb_Digest_SHA256_Init(&context);
 rb_Digest_SHA256_Update(&context, data, len);
 return rb_Digest_SHA256_End(&context, digest);
}



int rb_Digest_SHA512_Init(SHA512_CTX* context) {
...
void rb_Digest_SHA512_Transform(SHA512_CTX* context, const sha2_word64* data) {
...
void rb_Digest_SHA512_Update(SHA512_CTX* context, const sha2_byte *data, size_t len) {
 unsigned int freespace, usedspace;
 ...
 ((context != (SHA512_CTX*)0 && data != (sha2_byte*)0) ? (void) (0) : __assert_fail ("context != (SHA512_CTX*)0 && data != (sha2_byte*)0", "ext/digest/sha2/sha2.c", 863,  __PRETTY_FUNCTION__));

 usedspace = (unsigned int)((context->bitcount[0] >> 3) % 128);
 if (usedspace > 0) {
  ...
  if (len >= freespace) {
   ...
   len -= freespace;
   data += freespace;
   rb_Digest_SHA512_Transform(context, (sha2_word64*)context->buffer);
  } else {
 ...
 while (len >= 128) {
  ...
  memcpy((context->buffer), (data), (128));
  rb_Digest_SHA512_Transform(context, (sha2_word64*)context->buffer);
...
void rb_Digest_SHA512_Last(SHA512_CTX* context) {
 unsigned int usedspace;
 ...
 memcpy((&context->buffer[(128 - 16)]), (&context->bitcount[1]), (sizeof(sha2_word64)));

 memcpy((&context->buffer[(128 - 16)+8]), (&context->bitcount[0]), (sizeof(sha2_word64)));
...
int rb_Digest_SHA512_Finish(SHA512_CTX* context, sha2_byte digest[]) {
 sha2_word64 *d = (sha2_word64*)digest;


 ((context != (SHA512_CTX*)0) ? (void) (0) : __assert_fail ("context != (SHA512_CTX*)0", "ext/digest/sha2/sha2.c", 950,  __PRETTY_FUNCTION__));


 if (digest != (sha2_byte*)0) {
  rb_Digest_SHA512_Last(context);
...
char *rb_Digest_SHA512_End(SHA512_CTX* context, char buffer[]) {
 sha2_byte digest[64], *d = digest;
 int i;


 ((context != (SHA512_CTX*)0) ? (void) (0) : __assert_fail ("context != (SHA512_CTX*)0", "ext/digest/sha2/sha2.c", 981,  __PRETTY_FUNCTION__));

 if (buffer != (char*)0) {
  rb_Digest_SHA512_Finish(context, digest);
  for (i = 0; i < 64; i++) {
   *buffer++ = sha2_hex_digits[(*d & 0xf0) >> 4];
   *buffer++ = sha2_hex_digits[*d & 0x0f];
   d++;
...
char* rb_Digest_SHA512_Data(const sha2_byte* data, size_t len, char digest[(64 * 2 + 1)]) {
 SHA512_CTX context;

 rb_Digest_SHA512_Init(&context);
 rb_Digest_SHA512_Update(&context, data, len);
 return rb_Digest_SHA512_End(&context, digest);
}



int rb_Digest_SHA384_Init(SHA384_CTX* context) {
...
void rb_Digest_SHA384_Update(SHA384_CTX* context, const sha2_byte* data, size_t len) {
 rb_Digest_SHA512_Update((SHA512_CTX*)context, data, len);
}

int rb_Digest_SHA384_Finish(SHA384_CTX* context, sha2_byte digest[]) {
 sha2_word64 *d = (sha2_word64*)digest;


 ((context != (SHA384_CTX*)0) ? (void) (0) : __assert_fail ("context != (SHA384_CTX*)0", "ext/digest/sha2/sha2.c", 1026,  __PRETTY_FUNCTION__));


 if (digest != (sha2_byte*)0) {
  rb_Digest_SHA512_Last((SHA512_CTX*)context);
...
char *rb_Digest_SHA384_End(SHA384_CTX* context, char buffer[]) {
 sha2_byte digest[48], *d = digest;
 int i;


 ((context != (SHA384_CTX*)0) ? (void) (0) : __assert_fail ("context != (SHA384_CTX*)0", "ext/digest/sha2/sha2.c", 1057,  __PRETTY_FUNCTION__));

 if (buffer != (char*)0) {
  rb_Digest_SHA384_Finish(context, digest);
  for (i = 0; i < 48; i++) {
   *buffer++ = sha2_hex_digits[(*d & 0xf0) >> 4];
   *buffer++ = sha2_hex_digits[*d & 0x0f];
   d++;
...
char* rb_Digest_SHA384_Data(const sha2_byte* data, size_t len, char digest[(48 * 2 + 1)]) {
 SHA384_CTX context;

 rb_Digest_SHA384_Init(&context);
 rb_Digest_SHA384_Update(&context, data, len);
 return rb_Digest_SHA384_End(&context, digest);
}
