...
static const rb_digest_metadata_t sha256 = { 3, 32, 64, sizeof(SHA256_CTX), (rb_digest_hash_init_func_t)rb_Digest_SHA256_Init, (rb_digest_hash_update_func_t)rb_Digest_SHA256_Update, (rb_digest_hash_finish_func_t)rb_Digest_SHA256_Finish, }; static const rb_digest_metadata_t sha384 = { 3, 48, 128, sizeof(SHA384_CTX), (rb_digest_hash_init_func_t)rb_Digest_SHA384_Init, (rb_digest_hash_update_func_t)rb_Digest_SHA384_Update, (rb_digest_hash_finish_func_t)rb_Digest_SHA384_Finish, }; static const rb_digest_metadata_t sha512 = { 3, 64, 128, sizeof(SHA512_CTX), (rb_digest_hash_init_func_t)rb_Digest_SHA512_Init, (rb_digest_hash_update_func_t)rb_Digest_SHA512_Update, (rb_digest_hash_finish_func_t)rb_Digest_SHA512_Finish, };
...
Init_sha2(void)
{
    ...
    VALUE cDigest_SHA256; VALUE cDigest_SHA384; VALUE cDigest_SHA512;

    rb_require("digest");

    id_metadata = (__builtin_constant_p("metadata") ?  (rb_intern2(("metadata"), (long)strlen("metadata"))) : (rb_intern)("metadata"));

    mDigest = rb_path2class("Digest");
    cDigest_Base = rb_path2class("Digest::Base");
    cDigest_SHA256 = rb_define_class_under(mDigest, "SHA256", cDigest_Base); rb_ivar_set(cDigest_SHA256, id_metadata, rb_data_object_wrap((0),((void *)&sha256),(RUBY_DATA_FUNC)(0),(RUBY_DATA_FUNC)(0))); cDigest_SHA384 = rb_define_class_under(mDigest, "SHA384", cDigest_Base); rb_ivar_set(cDigest_SHA384, id_metadata, rb_data_object_wrap((0),((void *)&sha384),(RUBY_DATA_FUNC)(0),(RUBY_DATA_FUNC)(0))); cDigest_SHA512 = rb_define_class_under(mDigest, "SHA512", cDigest_Base); rb_ivar_set(cDigest_SHA512, id_metadata, rb_data_object_wrap((0),((void *)&sha512),(RUBY_DATA_FUNC)(0),(RUBY_DATA_FUNC)(0)));
}
