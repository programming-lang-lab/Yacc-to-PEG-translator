...
extern void Init_digest_base(void);
static VALUE
hexencode_str_new(VALUE str_digest)
{
    ...
    rb_string_value(&(str_digest));
    digest = (!(((struct RBasic*)(str_digest))->flags & RSTRING_NOEMBED) ? ((struct RString*)(str_digest))->as.ary : ((struct RString*)(str_digest))->as.heap.ptr);
    digest_len = (!(((struct RBasic*)(str_digest))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(str_digest))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(str_digest))->as.heap.len);

    if (9223372036854775807L / 2 < digest_len) {
        rb_raise(rb_eRuntimeError, "digest string too long");
    }

    str =  ({ (__builtin_constant_p(0) && __builtin_constant_p(digest_len * 2)) ? rb_usascii_str_new_static((0), (digest_len * 2)) : rb_usascii_str_new((0), (digest_len * 2)); });

    for (i = 0, p = (!(((struct RBasic*)(str))->flags & RSTRING_NOEMBED) ? ((struct RString*)(str))->as.ary : ((struct RString*)(str))->as.heap.ptr); i < digest_len; i++) {
    ...
    (* ({ volatile VALUE *rb_gc_guarded_ptr = &(str_digest); ; rb_gc_guarded_ptr; }));
...
rb_digest_instance_inspect(VALUE self)
{
    ...
    str = rb_str_buf_new(2 + strlen(cname) + 2 + digest_len * 2 + 1);
     ...
     ({ (__builtin_constant_p(cname)) ? rb_str_cat((str), (cname), (long)strlen(cname)) : rb_str_cat_cstr((str), (cname)); });
     ({ (__builtin_constant_p(": ")) ? rb_str_cat((str), (": "), (long)strlen(": ")) : rb_str_cat_cstr((str), (": ")); });
...
rb_digest_instance_equal(VALUE self, VALUE other)
{
    ...
    if (rb_obj_is_kind_of(other, rb_mDigest_Instance) == ((VALUE)RUBY_Qtrue)) {
        str1 = rb_digest_instance_digest(0, 0, self);
        str2 = rb_digest_instance_digest(0, 0, other);
    } else {
        str1 = rb_digest_instance_to_s(self);
        str2 = rb_check_string_type(other);
        if (!((VALUE)(str2) != ((VALUE)RUBY_Qnil))) return ((VALUE)RUBY_Qfalse);
    }


    rb_string_value(&(str1));
    rb_string_value(&(str2));

    if ((!(((struct RBasic*)(str1))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(str1))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(str1))->as.heap.len) == (!(((struct RBasic*)(str2))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(str2))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(str2))->as.heap.len) &&
...
rb_digest_instance_digest_length(VALUE self)
{
    ...
    rb_string_value(&(digest));
    return (((VALUE)((int)((!(((struct RBasic*)(digest))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(digest))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(digest))->as.heap.len))))<<1 | RUBY_FIXNUM_FLAG);
}
static VALUE
...
get_digest_base_metadata(VALUE klass)
{
    ...
    for (p = klass; !!((VALUE)(p) != ((VALUE)RUBY_Qnil)); p = rb_class_superclass(p)) {
    ...
    ((algo) = (rb_digest_metadata_t*)rb_data_object_get(obj));
...
rb_digest_base_alloc(VALUE klass)
{
 ...
 rb_raise(rb_eNotImpError, "Digest::Base is an abstract class");
    ...
    pctx = (((struct RTypedData*)(obj))->data);
    algo_init(algo, pctx);
...
rb_digest_base_copy(VALUE copy, VALUE obj)
{
 ...
 rb_raise(rb_eTypeError, "different algorithms");
    ...
    ((pctx1) = (void*)rb_check_typeddata((obj), (&digest_type)));
    ((pctx2) = (void*)rb_check_typeddata((copy), (&digest_type)));
...
rb_digest_base_reset(VALUE self)
{
    ...
    ((pctx) = (void*)rb_check_typeddata((self), (&digest_type)));
...
rb_digest_base_finish(VALUE self)
{
    ...
    str =  ({ (__builtin_constant_p(0) && __builtin_constant_p(algo->digest_len)) ? rb_str_new_static((0), (algo->digest_len)) : rb_str_new((0), (algo->digest_len)); });
    algo->finish_func(pctx, (unsigned char *)(!(((struct RBasic*)(str))->flags & RSTRING_NOEMBED) ? ((struct RString*)(str))->as.ary : ((struct RString*)(str))->as.heap.ptr));
...
rb_digest_base_digest_length(VALUE self)
{
    ...
    return (((VALUE)((int)(algo->digest_len)))<<1 | RUBY_FIXNUM_FLAG);
}
...
rb_digest_base_block_length(VALUE self)
{
    ...
    return (((VALUE)((int)(algo->block_len)))<<1 | RUBY_FIXNUM_FLAG);
}

void
Init_digest(void)
{
    id_reset = (__builtin_constant_p("reset") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("reset")), (long)strlen(("reset"))); (ID) rb_intern_id_cache; }) : rb_intern("reset"));
    id_update = (__builtin_constant_p("update") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("update")), (long)strlen(("update"))); (ID) rb_intern_id_cache; }) : rb_intern("update"));
    id_finish = (__builtin_constant_p("finish") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("finish")), (long)strlen(("finish"))); (ID) rb_intern_id_cache; }) : rb_intern("finish"));
    id_digest = (__builtin_constant_p("digest") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("digest")), (long)strlen(("digest"))); (ID) rb_intern_id_cache; }) : rb_intern("digest"));
    id_hexdigest = (__builtin_constant_p("hexdigest") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("hexdigest")), (long)strlen(("hexdigest"))); (ID) rb_intern_id_cache; }) : rb_intern("hexdigest"));
    id_digest_length = (__builtin_constant_p("digest_length") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("digest_length")), (long)strlen(("digest_length"))); (ID) rb_intern_id_cache; }) : rb_intern("digest_length"));
    ...
    id_metadata = (__builtin_constant_p("metadata") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("metadata")), (long)strlen(("metadata"))); (ID) rb_intern_id_cache; }) : rb_intern("metadata"));
