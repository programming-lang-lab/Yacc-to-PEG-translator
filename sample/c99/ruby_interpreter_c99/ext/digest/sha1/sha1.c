...
void rb_Digest_SHA1_Transform (uint32_t state[5], const uint8_t buffer[64]);
int rb_Digest_SHA1_Init (SHA1_CTX *context);
void rb_Digest_SHA1_Update (SHA1_CTX *context, const uint8_t *data, size_t len);
int rb_Digest_SHA1_Finish (SHA1_CTX *context, uint8_t digest[20]);
...
void rb_Digest_SHA1_Transform(uint32_t state[5], const uint8_t buffer[64])
{
    ...
    ((buffer != 0) ? (void) (0) : __assert_fail ("buffer != 0", "ext/digest/sha1/sha1.c", 141,  __PRETTY_FUNCTION__));
    ((state != 0) ? (void) (0) : __assert_fail ("state != 0", "ext/digest/sha1/sha1.c", 142,  __PRETTY_FUNCTION__));
...
int rb_Digest_SHA1_Init(SHA1_CTX *context)
{
    ...
    ((context != 0) ? (void) (0) : __assert_fail ("context != 0", "ext/digest/sha1/sha1.c", 205,  __PRETTY_FUNCTION__));
...
void rb_Digest_SHA1_Update(SHA1_CTX *context, const uint8_t *data, size_t len)
{
    ...
    ((context != 0) ? (void) (0) : __assert_fail ("context != 0", "ext/digest/sha1/sha1.c", 225,  __PRETTY_FUNCTION__));
    ((data != 0) ? (void) (0) : __assert_fail ("data != 0", "ext/digest/sha1/sha1.c", 226,  __PRETTY_FUNCTION__));
 ...
 rb_Digest_SHA1_Transform(context->state, context->buffer);
 for ( ; i + 63 < len; i += 64)
     rb_Digest_SHA1_Transform(context->state, &data[i]);
 j = 0;
    } else {
 i = 0;
    }
...
int rb_Digest_SHA1_Finish(SHA1_CTX* context, uint8_t digest[20])
{
    ...
    ((digest != 0) ? (void) (0) : __assert_fail ("digest != 0", "ext/digest/sha1/sha1.c", 253,  __PRETTY_FUNCTION__));
    ((context != 0) ? (void) (0) : __assert_fail ("context != 0", "ext/digest/sha1/sha1.c", 254,  __PRETTY_FUNCTION__));

    for (i = 0; i < 8; i++) {
 finalcount[i] = (uint8_t)((context->count[(i >= 4 ? 0 : 1)]
  >> ((3-(i & 3)) * 8) ) & 255);
    }
    rb_Digest_SHA1_Update(context, (const uint8_t *)"\200", 1);
    while ((context->count[0] & 504) != 448)
 rb_Digest_SHA1_Update(context, (const uint8_t *)"\0", 1);
    rb_Digest_SHA1_Update(context, finalcount, 8);
