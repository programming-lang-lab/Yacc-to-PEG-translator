...
static const rb_digest_metadata_t sha1 = {
    ...
    64,
    sizeof(SHA1_CTX),
    (rb_digest_hash_init_func_t)rb_Digest_SHA1_Init,
    (rb_digest_hash_update_func_t)rb_Digest_SHA1_Update,
    (rb_digest_hash_finish_func_t)rb_Digest_SHA1_Finish,
};
void
Init_sha1(void)
{
    ...
    rb_iv_set(cDigest_SHA1, "metadata",
       rb_data_object_wrap((0),((void *)&sha1),(RUBY_DATA_FUNC)(0),(RUBY_DATA_FUNC)(0)));
}
