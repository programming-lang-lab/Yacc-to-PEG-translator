...
int rb_Digest_MD5_Init (MD5_CTX *pms);
void rb_Digest_MD5_Update (MD5_CTX *pms, const uint8_t *data, size_t nbytes);
int rb_Digest_MD5_Finish (MD5_CTX *pms, uint8_t *digest);
static void
md5_process(MD5_CTX *pms, const uint8_t *data )
{
 ...
 X = xbuf;
    ...
    t = a + (((b) & (c)) | (~(b) & (d))) + X[0] + (((uint32_t)~0) ^ 0x28955b87); a = (((t) << (7)) | ((t) >> (32 - (7)))) + b;
    t = d + (((a) & (b)) | (~(a) & (c))) + X[1] + (((uint32_t)~0) ^ 0x173848a9); d = (((t) << (12)) | ((t) >> (32 - (12)))) + a;
    t = c + (((d) & (a)) | (~(d) & (b))) + X[2] + 0x242070db; c = (((t) << (17)) | ((t) >> (32 - (17)))) + d;
    t = b + (((c) & (d)) | (~(c) & (a))) + X[3] + (((uint32_t)~0) ^ 0x3e423111); b = (((t) << (22)) | ((t) >> (32 - (22)))) + c;
    t = a + (((b) & (c)) | (~(b) & (d))) + X[4] + (((uint32_t)~0) ^ 0x0a83f050); a = (((t) << (7)) | ((t) >> (32 - (7)))) + b;
    t = d + (((a) & (b)) | (~(a) & (c))) + X[5] + 0x4787c62a; d = (((t) << (12)) | ((t) >> (32 - (12)))) + a;
    t = c + (((d) & (a)) | (~(d) & (b))) + X[6] + (((uint32_t)~0) ^ 0x57cfb9ec); c = (((t) << (17)) | ((t) >> (32 - (17)))) + d;
    t = b + (((c) & (d)) | (~(c) & (a))) + X[7] + (((uint32_t)~0) ^ 0x02b96afe); b = (((t) << (22)) | ((t) >> (32 - (22)))) + c;
    t = a + (((b) & (c)) | (~(b) & (d))) + X[8] + 0x698098d8; a = (((t) << (7)) | ((t) >> (32 - (7)))) + b;
    t = d + (((a) & (b)) | (~(a) & (c))) + X[9] + (((uint32_t)~0) ^ 0x74bb0850); d = (((t) << (12)) | ((t) >> (32 - (12)))) + a;
    t = c + (((d) & (a)) | (~(d) & (b))) + X[10] + (((uint32_t)~0) ^ 0x0000a44e); c = (((t) << (17)) | ((t) >> (32 - (17)))) + d;
    t = b + (((c) & (d)) | (~(c) & (a))) + X[11] + (((uint32_t)~0) ^ 0x76a32841); b = (((t) << (22)) | ((t) >> (32 - (22)))) + c;
    t = a + (((b) & (c)) | (~(b) & (d))) + X[12] + 0x6b901122; a = (((t) << (7)) | ((t) >> (32 - (7)))) + b;
    t = d + (((a) & (b)) | (~(a) & (c))) + X[13] + (((uint32_t)~0) ^ 0x02678e6c); d = (((t) << (12)) | ((t) >> (32 - (12)))) + a;
    t = c + (((d) & (a)) | (~(d) & (b))) + X[14] + (((uint32_t)~0) ^ 0x5986bc71); c = (((t) << (17)) | ((t) >> (32 - (17)))) + d;
    t = b + (((c) & (d)) | (~(c) & (a))) + X[15] + 0x49b40821; b = (((t) << (22)) | ((t) >> (32 - (22)))) + c;
    t = a + (((b) & (d)) | ((c) & ~(d))) + X[1] + (((uint32_t)~0) ^ 0x09e1da9d); a = (((t) << (5)) | ((t) >> (32 - (5)))) + b;
    t = d + (((a) & (c)) | ((b) & ~(c))) + X[6] + (((uint32_t)~0) ^ 0x3fbf4cbf); d = (((t) << (9)) | ((t) >> (32 - (9)))) + a;
    t = c + (((d) & (b)) | ((a) & ~(b))) + X[11] + 0x265e5a51; c = (((t) << (14)) | ((t) >> (32 - (14)))) + d;
    t = b + (((c) & (a)) | ((d) & ~(a))) + X[0] + (((uint32_t)~0) ^ 0x16493855); b = (((t) << (20)) | ((t) >> (32 - (20)))) + c;
    t = a + (((b) & (d)) | ((c) & ~(d))) + X[5] + (((uint32_t)~0) ^ 0x29d0efa2); a = (((t) << (5)) | ((t) >> (32 - (5)))) + b;
    t = d + (((a) & (c)) | ((b) & ~(c))) + X[10] + 0x02441453; d = (((t) << (9)) | ((t) >> (32 - (9)))) + a;
    t = c + (((d) & (b)) | ((a) & ~(b))) + X[15] + (((uint32_t)~0) ^ 0x275e197e); c = (((t) << (14)) | ((t) >> (32 - (14)))) + d;
    t = b + (((c) & (a)) | ((d) & ~(a))) + X[4] + (((uint32_t)~0) ^ 0x182c0437); b = (((t) << (20)) | ((t) >> (32 - (20)))) + c;
    t = a + (((b) & (d)) | ((c) & ~(d))) + X[9] + 0x21e1cde6; a = (((t) << (5)) | ((t) >> (32 - (5)))) + b;
    t = d + (((a) & (c)) | ((b) & ~(c))) + X[14] + (((uint32_t)~0) ^ 0x3cc8f829); d = (((t) << (9)) | ((t) >> (32 - (9)))) + a;
    t = c + (((d) & (b)) | ((a) & ~(b))) + X[3] + (((uint32_t)~0) ^ 0x0b2af278); c = (((t) << (14)) | ((t) >> (32 - (14)))) + d;
    t = b + (((c) & (a)) | ((d) & ~(a))) + X[8] + 0x455a14ed; b = (((t) << (20)) | ((t) >> (32 - (20)))) + c;
    t = a + (((b) & (d)) | ((c) & ~(d))) + X[13] + (((uint32_t)~0) ^ 0x561c16fa); a = (((t) << (5)) | ((t) >> (32 - (5)))) + b;
    t = d + (((a) & (c)) | ((b) & ~(c))) + X[2] + (((uint32_t)~0) ^ 0x03105c07); d = (((t) << (9)) | ((t) >> (32 - (9)))) + a;
    t = c + (((d) & (b)) | ((a) & ~(b))) + X[7] + 0x676f02d9; c = (((t) << (14)) | ((t) >> (32 - (14)))) + d;
    t = b + (((c) & (a)) | ((d) & ~(a))) + X[12] + (((uint32_t)~0) ^ 0x72d5b375); b = (((t) << (20)) | ((t) >> (32 - (20)))) + c;
    t = a + ((b) ^ (c) ^ (d)) + X[5] + (((uint32_t)~0) ^ 0x0005c6bd); a = (((t) << (4)) | ((t) >> (32 - (4)))) + b;
    t = d + ((a) ^ (b) ^ (c)) + X[8] + (((uint32_t)~0) ^ 0x788e097e); d = (((t) << (11)) | ((t) >> (32 - (11)))) + a;
    t = c + ((d) ^ (a) ^ (b)) + X[11] + 0x6d9d6122; c = (((t) << (16)) | ((t) >> (32 - (16)))) + d;
    t = b + ((c) ^ (d) ^ (a)) + X[14] + (((uint32_t)~0) ^ 0x021ac7f3); b = (((t) << (23)) | ((t) >> (32 - (23)))) + c;
    t = a + ((b) ^ (c) ^ (d)) + X[1] + (((uint32_t)~0) ^ 0x5b4115bb); a = (((t) << (4)) | ((t) >> (32 - (4)))) + b;
    t = d + ((a) ^ (b) ^ (c)) + X[4] + 0x4bdecfa9; d = (((t) << (11)) | ((t) >> (32 - (11)))) + a;
    t = c + ((d) ^ (a) ^ (b)) + X[7] + (((uint32_t)~0) ^ 0x0944b49f); c = (((t) << (16)) | ((t) >> (32 - (16)))) + d;
    t = b + ((c) ^ (d) ^ (a)) + X[10] + (((uint32_t)~0) ^ 0x4140438f); b = (((t) << (23)) | ((t) >> (32 - (23)))) + c;
    t = a + ((b) ^ (c) ^ (d)) + X[13] + 0x289b7ec6; a = (((t) << (4)) | ((t) >> (32 - (4)))) + b;
    t = d + ((a) ^ (b) ^ (c)) + X[0] + (((uint32_t)~0) ^ 0x155ed805); d = (((t) << (11)) | ((t) >> (32 - (11)))) + a;
    t = c + ((d) ^ (a) ^ (b)) + X[3] + (((uint32_t)~0) ^ 0x2b10cf7a); c = (((t) << (16)) | ((t) >> (32 - (16)))) + d;
    t = b + ((c) ^ (d) ^ (a)) + X[6] + 0x04881d05; b = (((t) << (23)) | ((t) >> (32 - (23)))) + c;
    t = a + ((b) ^ (c) ^ (d)) + X[9] + (((uint32_t)~0) ^ 0x262b2fc6); a = (((t) << (4)) | ((t) >> (32 - (4)))) + b;
    t = d + ((a) ^ (b) ^ (c)) + X[12] + (((uint32_t)~0) ^ 0x1924661a); d = (((t) << (11)) | ((t) >> (32 - (11)))) + a;
    t = c + ((d) ^ (a) ^ (b)) + X[15] + 0x1fa27cf8; c = (((t) << (16)) | ((t) >> (32 - (16)))) + d;
    t = b + ((c) ^ (d) ^ (a)) + X[2] + (((uint32_t)~0) ^ 0x3b53a99a); b = (((t) << (23)) | ((t) >> (32 - (23)))) + c;
    t = a + ((c) ^ ((b) | ~(d))) + X[0] + (((uint32_t)~0) ^ 0x0bd6ddbb); a = (((t) << (6)) | ((t) >> (32 - (6)))) + b;
    t = d + ((b) ^ ((a) | ~(c))) + X[7] + 0x432aff97; d = (((t) << (10)) | ((t) >> (32 - (10)))) + a;
    t = c + ((a) ^ ((d) | ~(b))) + X[14] + (((uint32_t)~0) ^ 0x546bdc58); c = (((t) << (15)) | ((t) >> (32 - (15)))) + d;
    t = b + ((d) ^ ((c) | ~(a))) + X[5] + (((uint32_t)~0) ^ 0x036c5fc6); b = (((t) << (21)) | ((t) >> (32 - (21)))) + c;
    t = a + ((c) ^ ((b) | ~(d))) + X[12] + 0x655b59c3; a = (((t) << (6)) | ((t) >> (32 - (6)))) + b;
    t = d + ((b) ^ ((a) | ~(c))) + X[3] + (((uint32_t)~0) ^ 0x70f3336d); d = (((t) << (10)) | ((t) >> (32 - (10)))) + a;
    t = c + ((a) ^ ((d) | ~(b))) + X[10] + (((uint32_t)~0) ^ 0x00100b82); c = (((t) << (15)) | ((t) >> (32 - (15)))) + d;
    t = b + ((d) ^ ((c) | ~(a))) + X[1] + (((uint32_t)~0) ^ 0x7a7ba22e); b = (((t) << (21)) | ((t) >> (32 - (21)))) + c;
    t = a + ((c) ^ ((b) | ~(d))) + X[8] + 0x6fa87e4f; a = (((t) << (6)) | ((t) >> (32 - (6)))) + b;
    t = d + ((b) ^ ((a) | ~(c))) + X[15] + (((uint32_t)~0) ^ 0x01d3191f); d = (((t) << (10)) | ((t) >> (32 - (10)))) + a;
    t = c + ((a) ^ ((d) | ~(b))) + X[6] + (((uint32_t)~0) ^ 0x5cfebceb); c = (((t) << (15)) | ((t) >> (32 - (15)))) + d;
    t = b + ((d) ^ ((c) | ~(a))) + X[13] + 0x4e0811a1; b = (((t) << (21)) | ((t) >> (32 - (21)))) + c;
    t = a + ((c) ^ ((b) | ~(d))) + X[4] + (((uint32_t)~0) ^ 0x08ac817d); a = (((t) << (6)) | ((t) >> (32 - (6)))) + b;
    t = d + ((b) ^ ((a) | ~(c))) + X[11] + (((uint32_t)~0) ^ 0x42c50dca); d = (((t) << (10)) | ((t) >> (32 - (10)))) + a;
    t = c + ((a) ^ ((d) | ~(b))) + X[2] + 0x2ad7d2bb; c = (((t) << (15)) | ((t) >> (32 - (15)))) + d;
    t = b + ((d) ^ ((c) | ~(a))) + X[9] + (((uint32_t)~0) ^ 0x14792c6e); b = (((t) << (21)) | ((t) >> (32 - (21)))) + c;
...
int
rb_Digest_MD5_Init(MD5_CTX *pms)
{
    pms->count[0] = pms->count[1] = 0;
    pms->state[0] = 0x67452301;
    pms->state[1] = ((uint32_t)~0) ^ 0x10325476;
    pms->state[2] = ((uint32_t)~0) ^ 0x67452301;
    pms->state[3] = 0x10325476;
    return 1;
}

void
rb_Digest_MD5_Update(MD5_CTX *pms, const uint8_t *data, size_t nbytes)
{
...
int
rb_Digest_MD5_Finish(MD5_CTX *pms, uint8_t *digest)
{
 ...
 data[i] = (uint8_t)(pms->count[i >> 2] >> ((i & 3) << 3));
    ...
    rb_Digest_MD5_Update(pms, pad, ((55 - (pms->count[0] >> 3)) & 63) + 1);

    rb_Digest_MD5_Update(pms, data, 8);
    for (i = 0; i < 16; ++i)
