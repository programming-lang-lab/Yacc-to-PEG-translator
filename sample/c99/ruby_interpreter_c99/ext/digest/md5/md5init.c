...
static const rb_digest_metadata_t md5 = {
    ...
    64,
    sizeof(MD5_CTX),
    (rb_digest_hash_init_func_t)rb_Digest_MD5_Init,
    (rb_digest_hash_update_func_t)rb_Digest_MD5_Update,
    (rb_digest_hash_finish_func_t)rb_Digest_MD5_Finish,
};
void
Init_md5(void)
{
    ...
    rb_iv_set(cDigest_MD5, "metadata",
       rb_data_object_wrap((0),((void *)&md5),(RUBY_DATA_FUNC)(0),(RUBY_DATA_FUNC)(0)));
}
