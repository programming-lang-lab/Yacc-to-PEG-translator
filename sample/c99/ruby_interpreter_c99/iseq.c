...
ISEQ_FLIP_CNT_INCREMENT(const rb_iseq_t *iseq)
{
    ...
    do { const VALUE _ary = ((iseq)->body->mark_ary); VALUE *ptr = (VALUE *)((VALUE *)rb_array_const_ptr(_ary)); ({
;
; int unaligned_member_access_result = (rb_obj_write((VALUE)(_ary), (VALUE *)(&ptr[ISEQ_MARK_ARY_FLIP_CNT]), (VALUE)(((((VALUE)(cnt+1))<<1 | RUBY_FIXNUM_FLAG))), "./iseq.h", 61));
...
ISEQ_ORIGINAL_ISEQ_CLEAR(const rb_iseq_t *iseq)
{
    do { const VALUE _ary = ((iseq)->body->mark_ary); VALUE *ptr = (VALUE *)((VALUE *)rb_array_const_ptr(_ary)); ({
;
; int unaligned_member_access_result = (rb_obj_write((VALUE)(_ary), (VALUE *)(&ptr[ISEQ_MARK_ARY_ORIGINAL_ISEQ]), (VALUE)((((VALUE)RUBY_Qnil))), "./iseq.h", 76));
; unaligned_member_access_result; }); ; } while (0);
}
...
ISEQ_ORIGINAL_ISEQ_ALLOC(const rb_iseq_t *iseq, long size)
{
    ...
    do { const VALUE _ary = ((iseq)->body->mark_ary); VALUE *ptr = (VALUE *)((VALUE *)rb_array_const_ptr(_ary)); ({
;
; int unaligned_member_access_result = (rb_obj_write((VALUE)(_ary), (VALUE *)(&ptr[ISEQ_MARK_ARY_ORIGINAL_ISEQ]), (VALUE)((str)), "./iseq.h", 83));
; unaligned_member_access_result; }); ; } while (0);
...
{
    if ((!(((VALUE)(obj) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(obj) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && !((struct RBasic*)(obj))->klass)) {
...
rb_iseq_free(const rb_iseq_t *iseq)
{
 ...
 if (iseq->body) {
  ...
  ruby_xfree(iseq->body->cc_entries);
     ...
     if (iseq->body->param.keyword != ((void*)0)) {
...
rb_iseq_mark(const rb_iseq_t *iseq)
{
 ...
 do { VALUE markobj = (body->mark_ary); if (!(((VALUE)(markobj) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) {rb_gc_mark(markobj);} } while (0);
 rb_gc_mark(body->location.label);
 rb_gc_mark(body->location.base_label);
 rb_gc_mark(body->location.pathobj);
 do { VALUE markobj = ((VALUE)body->parent_iseq); if (!(((VALUE)(markobj) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) {rb_gc_mark(markobj);} } while (0);
    }

    if (((!(((VALUE)(iseq) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(iseq) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(iseq))->flags & RUBY_T_MASK) != RUBY_T_NODE)?(((struct RBasic*)((iseq)))->flags&((((VALUE)RUBY_FL_USER5)))):0)) {
 rb_gc_mark(iseq->aux.loader.obj);
    }
    else if (ISEQ_COMPILE_DATA(iseq) != ((void*)0)) {
 const struct iseq_compile_data *const compile_data = ISEQ_COMPILE_DATA(iseq);
 do { VALUE markobj = (compile_data->mark_ary); if (!(((VALUE)(markobj) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) {rb_gc_mark(markobj);} } while (0);
 do { VALUE markobj = (compile_data->err_info); if (!(((VALUE)(markobj) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) {rb_gc_mark(markobj);} } while (0);
 do { VALUE markobj = (compile_data->catch_table_ary); if (!(((VALUE)(markobj) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) {rb_gc_mark(markobj);} } while (0);
    }
...
iseq_memsize(const rb_iseq_t *iseq)
{
 ...
 cur = compile_data->storage_head;
 while (cur) {
     size += cur->size + (sizeof(struct iseq_compile_data_storage) - 1);
     cur = cur->next;
 }
    }
...
iseq_alloc(void)
{
    ...
    iseq->body = (((struct rb_iseq_constant_body*)ruby_xcalloc((size_t)(1),sizeof(struct rb_iseq_constant_body))));
    return iseq;
}
...
rb_iseq_pathobj_set(const rb_iseq_t *iseq, VALUE path, VALUE realpath)
{
    ({
;
; int unaligned_member_access_result = (rb_obj_write((VALUE)(iseq), (VALUE *)(&iseq->body->location.pathobj), (VALUE)(rb_iseq_pathobj_new(path, realpath)), "iseq.c", 239));
; unaligned_member_access_result; });
...
iseq_location_setup(rb_iseq_t *iseq, VALUE name, VALUE path, VALUE realpath, VALUE first_lineno, const rb_code_range_t *code_range)
{
    ...
    ({
;
; int unaligned_member_access_result = (rb_obj_write((VALUE)(iseq), (VALUE *)(&loc->label), (VALUE)(name), "iseq.c", 248));
; unaligned_member_access_result; });
    ({
;
; int unaligned_member_access_result = (rb_obj_write((VALUE)(iseq), (VALUE *)(&loc->base_label), (VALUE)(name), "iseq.c", 249));
; unaligned_member_access_result; });
...
prepare_iseq_build(rb_iseq_t *iseq,
     ...
     const rb_compile_option_t *option)
{
    VALUE coverage = ((VALUE)RUBY_Qfalse);
    VALUE err_info = ((VALUE)RUBY_Qnil);

    if (parent && (type == ISEQ_TYPE_MAIN || type == ISEQ_TYPE_TOP))
 err_info = ((VALUE)RUBY_Qfalse);
 ...
 ({
;
; int unaligned_member_access_result = (rb_obj_write((VALUE)(iseq), (VALUE *)(&iseq->body->location.base_label), (VALUE)(iseq->body->local_iseq->body->location.label), "iseq.c", 314));
; unaligned_member_access_result; });
    }
    ({
;
; int unaligned_member_access_result = (rb_obj_write((VALUE)(iseq), (VALUE *)(&iseq->body->mark_ary), (VALUE)(iseq_mark_ary_create(0)), "iseq.c", 316));
; unaligned_member_access_result; });

    ISEQ_COMPILE_DATA_ALLOC(iseq);
    ({
;
; int unaligned_member_access_result = (rb_obj_write((VALUE)(iseq), (VALUE *)(&ISEQ_COMPILE_DATA(iseq)->err_info), (VALUE)(err_info), "iseq.c", 319));
; unaligned_member_access_result; });
    ({
;
; int unaligned_member_access_result = (rb_obj_write((VALUE)(iseq), (VALUE *)(&ISEQ_COMPILE_DATA(iseq)->mark_ary), (VALUE)(rb_ary_tmp_new(3)), "iseq.c", 320));
; unaligned_member_access_result; });

    ISEQ_COMPILE_DATA(iseq)->storage_head = ISEQ_COMPILE_DATA(iseq)->storage_current =
      (struct iseq_compile_data_storage *)
 ((char*)ruby_xmalloc2((size_t)((512) + (sizeof(struct iseq_compile_data_storage) - 1)),sizeof(char)));


    ({
;
; int unaligned_member_access_result = (rb_obj_write((VALUE)(iseq), (VALUE *)(&ISEQ_COMPILE_DATA(iseq)->catch_table_ary), (VALUE)(rb_ary_tmp_new(3)), "iseq.c", 327));
; unaligned_member_access_result; });
    ...
    ISEQ_COMPILE_DATA(iseq)->ivar_cache_table = ((void*)0);

    if (option->coverage_enabled) {
 VALUE coverages = rb_get_coverages();
 if (!(((VALUE)(coverages) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) {
     coverage = rb_hash_lookup(coverages, rb_iseq_path(iseq));
     if (!((VALUE)(coverage) != ((VALUE)RUBY_Qnil))) coverage = ((VALUE)RUBY_Qfalse);
 }
    }
    do { const VALUE _ary = ((iseq)->body->mark_ary); VALUE *ptr = (VALUE *)((VALUE *)rb_array_const_ptr(_ary)); ({
;
; int unaligned_member_access_result = (rb_obj_write((VALUE)(_ary), (VALUE *)(&ptr[ISEQ_MARK_ARY_COVERAGE]), (VALUE)((coverage)), "iseq.c", 343));
; unaligned_member_access_result; }); ; } while (0);
...
finish_iseq_build(rb_iseq_t *iseq)
{
    ...
    if (!(((VALUE)(err) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) {
 VALUE path = pathobj_path(iseq->body->location.pathobj);
 if (err == ((VALUE)RUBY_Qtrue)) err =  ({ (__builtin_constant_p("compile error")) ? rb_exc_new((rb_eSyntaxError), ("compile error"), (long)strlen("compile error")) : rb_exc_new_cstr((rb_eSyntaxError), ("compile error")); });
 rb_funcallv(err, (__builtin_constant_p("set_backtrace") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("set_backtrace")), (long)strlen(("set_backtrace"))); (ID) rb_intern_id_cache; }) : rb_intern("set_backtrace")), 1, &path);
 rb_exc_raise(err);
    }

    iseq->aux.trace_events = 0;
    if (ruby_vm_event_enabled_flags & (0x0001 | 0x0002 | 0x0004 | 0x0008 | 0x0010| 0x0100| 0x0200)) {
 rb_iseq_trace_set(iseq, ruby_vm_event_enabled_flags & (0x0001 | 0x0002 | 0x0004 | 0x0008 | 0x0010| 0x0100| 0x0200));
    }
    return ((VALUE)RUBY_Qtrue);
}
...
{
    { VALUE flag = rb_hash_aref((opt), (rb_id2sym((__builtin_constant_p("inline_const_cache") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("inline_const_cache")), (long)strlen(("inline_const_cache"))); (ID) rb_intern_id_cache; }) : rb_intern("inline_const_cache"))))); if (flag == ((VALUE)RUBY_Qtrue)) { (option)->inline_const_cache = 1; } else if (flag == ((VALUE)RUBY_Qfalse)) { (option)->inline_const_cache = 0; } };
    { VALUE flag = rb_hash_aref((opt), (rb_id2sym((__builtin_constant_p("peephole_optimization") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("peephole_optimization")), (long)strlen(("peephole_optimization"))); (ID) rb_intern_id_cache; }) : rb_intern("peephole_optimization"))))); if (flag == ((VALUE)RUBY_Qtrue)) { (option)->peephole_optimization = 1; } else if (flag == ((VALUE)RUBY_Qfalse)) { (option)->peephole_optimization = 0; } };
    { VALUE flag = rb_hash_aref((opt), (rb_id2sym((__builtin_constant_p("tailcall_optimization") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("tailcall_optimization")), (long)strlen(("tailcall_optimization"))); (ID) rb_intern_id_cache; }) : rb_intern("tailcall_optimization"))))); if (flag == ((VALUE)RUBY_Qtrue)) { (option)->tailcall_optimization = 1; } else if (flag == ((VALUE)RUBY_Qfalse)) { (option)->tailcall_optimization = 0; } };
    { VALUE flag = rb_hash_aref((opt), (rb_id2sym((__builtin_constant_p("specialized_instruction") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("specialized_instruction")), (long)strlen(("specialized_instruction"))); (ID) rb_intern_id_cache; }) : rb_intern("specialized_instruction"))))); if (flag == ((VALUE)RUBY_Qtrue)) { (option)->specialized_instruction = 1; } else if (flag == ((VALUE)RUBY_Qfalse)) { (option)->specialized_instruction = 0; } };
    { VALUE flag = rb_hash_aref((opt), (rb_id2sym((__builtin_constant_p("operands_unification") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("operands_unification")), (long)strlen(("operands_unification"))); (ID) rb_intern_id_cache; }) : rb_intern("operands_unification"))))); if (flag == ((VALUE)RUBY_Qtrue)) { (option)->operands_unification = 1; } else if (flag == ((VALUE)RUBY_Qfalse)) { (option)->operands_unification = 0; } };
    { VALUE flag = rb_hash_aref((opt), (rb_id2sym((__builtin_constant_p("instructions_unification") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("instructions_unification")), (long)strlen(("instructions_unification"))); (ID) rb_intern_id_cache; }) : rb_intern("instructions_unification"))))); if (flag == ((VALUE)RUBY_Qtrue)) { (option)->instructions_unification = 1; } else if (flag == ((VALUE)RUBY_Qfalse)) { (option)->instructions_unification = 0; } };
    { VALUE flag = rb_hash_aref((opt), (rb_id2sym((__builtin_constant_p("stack_caching") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("stack_caching")), (long)strlen(("stack_caching"))); (ID) rb_intern_id_cache; }) : rb_intern("stack_caching"))))); if (flag == ((VALUE)RUBY_Qtrue)) { (option)->stack_caching = 1; } else if (flag == ((VALUE)RUBY_Qfalse)) { (option)->stack_caching = 0; } };
    { VALUE flag = rb_hash_aref((opt), (rb_id2sym((__builtin_constant_p("frozen_string_literal") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("frozen_string_literal")), (long)strlen(("frozen_string_literal"))); (ID) rb_intern_id_cache; }) : rb_intern("frozen_string_literal"))))); if (flag == ((VALUE)RUBY_Qtrue)) { (option)->frozen_string_literal = 1; } else if (flag == ((VALUE)RUBY_Qfalse)) { (option)->frozen_string_literal = 0; } };
    { VALUE flag = rb_hash_aref((opt), (rb_id2sym((__builtin_constant_p("debug_frozen_string_literal") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("debug_frozen_string_literal")), (long)strlen(("debug_frozen_string_literal"))); (ID) rb_intern_id_cache; }) : rb_intern("debug_frozen_string_literal"))))); if (flag == ((VALUE)RUBY_Qtrue)) { (option)->debug_frozen_string_literal = 1; } else if (flag == ((VALUE)RUBY_Qfalse)) { (option)->debug_frozen_string_literal = 0; } };
    { VALUE flag = rb_hash_aref((opt), (rb_id2sym((__builtin_constant_p("coverage_enabled") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("coverage_enabled")), (long)strlen(("coverage_enabled"))); (ID) rb_intern_id_cache; }) : rb_intern("coverage_enabled"))))); if (flag == ((VALUE)RUBY_Qtrue)) { (option)->coverage_enabled = 1; } else if (flag == ((VALUE)RUBY_Qfalse)) { (option)->coverage_enabled = 0; } };
    { VALUE num = rb_hash_aref(opt, (rb_id2sym((__builtin_constant_p("debug_level") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("debug_level")), (long)strlen(("debug_level"))); (ID) rb_intern_id_cache; }) : rb_intern("debug_level"))))); if (!!((VALUE)(num) != ((VALUE)RUBY_Qnil))) (option)->debug_level = rb_num2int_inline(num); };
...
{
    (!( (((RUBY_T_HASH)) == RUBY_T_FIXNUM) ? (((int)(long)((VALUE)(opt)))&RUBY_FIXNUM_FLAG) : (((RUBY_T_HASH)) == RUBY_T_TRUE) ? (((VALUE)(opt)) == ((VALUE)RUBY_Qtrue)) : (((RUBY_T_HASH)) == RUBY_T_FALSE) ? (((VALUE)(opt)) == ((VALUE)RUBY_Qfalse)) : (((RUBY_T_HASH)) == RUBY_T_NIL) ? (((VALUE)(opt)) == ((VALUE)RUBY_Qnil)) : (((RUBY_T_HASH)) == RUBY_T_UNDEF) ? (((VALUE)(opt)) == ((VALUE)RUBY_Qundef)) : (((RUBY_T_HASH)) == RUBY_T_SYMBOL) ? ((((VALUE)((VALUE)(opt))&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)((VALUE)(opt)) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)((VALUE)(opt)) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)((VALUE)(opt)))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : (((RUBY_T_HASH)) == RUBY_T_FLOAT) ? ( ((((int)(long)((VALUE)(opt)))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)((VALUE)(opt)) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)((VALUE)(opt)) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)((VALUE)(opt)))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)((VALUE)(opt)) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)((VALUE)(opt)) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)((VALUE)(opt)))->flags & RUBY_T_MASK) == ((RUBY_T_HASH)))) || ((RUBY_T_HASH) == RUBY_T_DATA && (((struct RTypedData*)(opt))->typed_flag == 1)) ? rb_unexpected_type((VALUE)(opt), (RUBY_T_HASH)) : (void)0);
...
make_compile_option_value(rb_compile_option_t *option)
{
    ...
    {
 rb_hash_aset((opt), (rb_id2sym((__builtin_constant_p("inline_const_cache") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("inline_const_cache")), (long)strlen(("inline_const_cache"))); (ID) rb_intern_id_cache; }) : rb_intern("inline_const_cache")))), (option)->inline_const_cache ? ((VALUE)RUBY_Qtrue) : ((VALUE)RUBY_Qfalse));
 rb_hash_aset((opt), (rb_id2sym((__builtin_constant_p("peephole_optimization") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("peephole_optimization")), (long)strlen(("peephole_optimization"))); (ID) rb_intern_id_cache; }) : rb_intern("peephole_optimization")))), (option)->peephole_optimization ? ((VALUE)RUBY_Qtrue) : ((VALUE)RUBY_Qfalse));
 rb_hash_aset((opt), (rb_id2sym((__builtin_constant_p("tailcall_optimization") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("tailcall_optimization")), (long)strlen(("tailcall_optimization"))); (ID) rb_intern_id_cache; }) : rb_intern("tailcall_optimization")))), (option)->tailcall_optimization ? ((VALUE)RUBY_Qtrue) : ((VALUE)RUBY_Qfalse));
 rb_hash_aset((opt), (rb_id2sym((__builtin_constant_p("specialized_instruction") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("specialized_instruction")), (long)strlen(("specialized_instruction"))); (ID) rb_intern_id_cache; }) : rb_intern("specialized_instruction")))), (option)->specialized_instruction ? ((VALUE)RUBY_Qtrue) : ((VALUE)RUBY_Qfalse));
 rb_hash_aset((opt), (rb_id2sym((__builtin_constant_p("operands_unification") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("operands_unification")), (long)strlen(("operands_unification"))); (ID) rb_intern_id_cache; }) : rb_intern("operands_unification")))), (option)->operands_unification ? ((VALUE)RUBY_Qtrue) : ((VALUE)RUBY_Qfalse));
 rb_hash_aset((opt), (rb_id2sym((__builtin_constant_p("instructions_unification") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("instructions_unification")), (long)strlen(("instructions_unification"))); (ID) rb_intern_id_cache; }) : rb_intern("instructions_unification")))), (option)->instructions_unification ? ((VALUE)RUBY_Qtrue) : ((VALUE)RUBY_Qfalse));
 rb_hash_aset((opt), (rb_id2sym((__builtin_constant_p("stack_caching") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("stack_caching")), (long)strlen(("stack_caching"))); (ID) rb_intern_id_cache; }) : rb_intern("stack_caching")))), (option)->stack_caching ? ((VALUE)RUBY_Qtrue) : ((VALUE)RUBY_Qfalse));
 rb_hash_aset((opt), (rb_id2sym((__builtin_constant_p("frozen_string_literal") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("frozen_string_literal")), (long)strlen(("frozen_string_literal"))); (ID) rb_intern_id_cache; }) : rb_intern("frozen_string_literal")))), (option)->frozen_string_literal ? ((VALUE)RUBY_Qtrue) : ((VALUE)RUBY_Qfalse));
 rb_hash_aset((opt), (rb_id2sym((__builtin_constant_p("debug_frozen_string_literal") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("debug_frozen_string_literal")), (long)strlen(("debug_frozen_string_literal"))); (ID) rb_intern_id_cache; }) : rb_intern("debug_frozen_string_literal")))), (option)->debug_frozen_string_literal ? ((VALUE)RUBY_Qtrue) : ((VALUE)RUBY_Qfalse));
 rb_hash_aset((opt), (rb_id2sym((__builtin_constant_p("coverage_enabled") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("coverage_enabled")), (long)strlen(("coverage_enabled"))); (ID) rb_intern_id_cache; }) : rb_intern("coverage_enabled")))), (option)->coverage_enabled ? ((VALUE)RUBY_Qtrue) : ((VALUE)RUBY_Qfalse));
 rb_hash_aset((opt), (rb_id2sym((__builtin_constant_p("debug_level") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("debug_level")), (long)strlen(("debug_level"))); (ID) rb_intern_id_cache; }) : rb_intern("debug_level")))), (((VALUE)((int)((option)->debug_level)))<<1 | RUBY_FIXNUM_FLAG));
    }
...
rb_iseq_new(const NODE *node, VALUE name, VALUE path, VALUE realpath,
     const rb_iseq_t *parent, enum iseq_type type)
{
    return rb_iseq_new_with_opt(node, name, path, realpath, (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG), parent, type,
...
{
    return rb_iseq_new_with_opt(node, name, path, realpath, (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG), parent, ISEQ_TYPE_TOP,
    &COMPILE_OPTION_DEFAULT);
}
...
{
    return rb_iseq_new_with_opt(node,  ({ (__builtin_constant_p("<main>")) ? rb_fstring_new(("<main>"), (long)strlen("<main>")) : rb_fstring_cstr("<main>"); }),
    path, realpath, (((VALUE)(0))<<1 | RUBY_FIXNUM_FLAG),
...
{
    if (rb_respond_to(rb_cISeq, (__builtin_constant_p("translate") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("translate")), (long)strlen(("translate"))); (ID) rb_intern_id_cache; }) : rb_intern("translate")))) {
 VALUE v1 = iseqw_new(iseq);
 VALUE v2 = rb_funcall(rb_cISeq, (__builtin_constant_p("translate") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("translate")), (long)strlen(("translate"))); (ID) rb_intern_id_cache; }) : rb_intern("translate")), 1, v1);
 if (v1 != v2 && rb_class_of((VALUE)(v2)) == rb_cISeq) {
       ...
       enum iseq_type type, const rb_compile_option_t *option)
{
    ...
    const rb_code_range_t *code_range = ((void*)0);
...
{
    VALUE iseqv = rb_check_funcall(rb_cISeq, (__builtin_constant_p("load_iseq") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("load_iseq")), (long)strlen(("load_iseq"))); (ID) rb_intern_id_cache; }) : rb_intern("load_iseq")), 1, &fname);

    if (!(((VALUE)(iseqv) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(iseqv) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (((struct RBasic*)(iseqv))->klass) == rb_cISeq) {
...
static inline VALUE CHECK_INTEGER(VALUE v) {(void)rb_num2long_inline(v); return v;}

static enum iseq_type
iseq_type_from_sym(VALUE type)
{
    const ID id_top = (__builtin_constant_p("top") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("top")), (long)strlen(("top"))); (ID) rb_intern_id_cache; }) : rb_intern("top"));
    const ID id_method = (__builtin_constant_p("method") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("method")), (long)strlen(("method"))); (ID) rb_intern_id_cache; }) : rb_intern("method"));
    const ID id_block = (__builtin_constant_p("block") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("block")), (long)strlen(("block"))); (ID) rb_intern_id_cache; }) : rb_intern("block"));
    const ID id_class = (__builtin_constant_p("class") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("class")), (long)strlen(("class"))); (ID) rb_intern_id_cache; }) : rb_intern("class"));
    const ID id_rescue = (__builtin_constant_p("rescue") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("rescue")), (long)strlen(("rescue"))); (ID) rb_intern_id_cache; }) : rb_intern("rescue"));
    const ID id_ensure = (__builtin_constant_p("ensure") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("ensure")), (long)strlen(("ensure"))); (ID) rb_intern_id_cache; }) : rb_intern("ensure"));
    const ID id_eval = (__builtin_constant_p("eval") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("eval")), (long)strlen(("eval"))); (ID) rb_intern_id_cache; }) : rb_intern("eval"));
    const ID id_main = (__builtin_constant_p("main") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("main")), (long)strlen(("main"))); (ID) rb_intern_id_cache; }) : rb_intern("main"));
    const ID id_defined_guard = (__builtin_constant_p("defined_guard") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("defined_guard")), (long)strlen(("defined_guard"))); (ID) rb_intern_id_cache; }) : rb_intern("defined_guard"));
...
iseq_load(VALUE data, const rb_iseq_t *parent, VALUE opt)
{
    ...
    data = rb_to_array_type(data);

    magic = rb_str_to_str(rb_ary_entry(data, i++));
    ...
    misc = rb_to_hash_type(rb_ary_entry(data, i++));
    ((void)magic, (void)version1, (void)version2, (void)format_type);

    name = rb_str_to_str(rb_ary_entry(data, i++));
    path = rb_str_to_str(rb_ary_entry(data, i++));
    realpath = rb_ary_entry(data, i++);
    realpath = !((VALUE)(realpath) != ((VALUE)RUBY_Qnil)) ? ((VALUE)RUBY_Qnil) : rb_str_to_str(realpath);
    first_lineno = CHECK_INTEGER(rb_ary_entry(data, i++));

    type = rb_to_symbol_type(rb_ary_entry(data, i++));
    locals = rb_to_array_type(rb_ary_entry(data, i++));
    params = rb_to_hash_type(rb_ary_entry(data, i++));
    exception = rb_to_array_type(rb_ary_entry(data, i++));
    body = rb_to_array_type(rb_ary_entry(data, i++));

    iseq->body->local_iseq = iseq;

    iseq_type = iseq_type_from_sym(type);
    if (iseq_type == (enum iseq_type)-1) {
 rb_raise(rb_eTypeError, "unsupport type: :%li\v", rb_sym2str(type));
    }

    code_range = rb_hash_aref(misc, (rb_id2sym((__builtin_constant_p("code_range") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("code_range")), (long)strlen(("code_range"))); (ID) rb_intern_id_cache; }) : rb_intern("code_range")))));
    if (( ((RUBY_T_ARRAY) == RUBY_T_FIXNUM) ? (((int)(long)(code_range))&RUBY_FIXNUM_FLAG) : ((RUBY_T_ARRAY) == RUBY_T_TRUE) ? ((code_range) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_ARRAY) == RUBY_T_FALSE) ? ((code_range) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_ARRAY) == RUBY_T_NIL) ? ((code_range) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_ARRAY) == RUBY_T_UNDEF) ? ((code_range) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_ARRAY) == RUBY_T_SYMBOL) ? ((((VALUE)(code_range)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(code_range) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(code_range) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(code_range))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_ARRAY) == RUBY_T_FLOAT) ? ( ((((int)(long)(code_range))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(code_range) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(code_range) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(code_range))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(code_range) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(code_range) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(code_range))->flags & RUBY_T_MASK) == (RUBY_T_ARRAY))) && rb_array_len(code_range) == 4) {
 tmp_loc.first_loc.lineno = rb_num2int_inline(rb_ary_entry(code_range, 0));
 tmp_loc.first_loc.column = rb_num2int_inline(rb_ary_entry(code_range, 1));
 tmp_loc.last_loc.lineno = rb_num2int_inline(rb_ary_entry(code_range, 2));
 tmp_loc.last_loc.column = rb_num2int_inline(rb_ary_entry(code_range, 3));
    }
...
{
    VALUE data, opt=((VALUE)RUBY_Qnil);
    rb_scan_args(argc, argv, "11", &data, &opt);
    return iseq_load(data, ((void*)0), opt);
}

VALUE
rb_iseq_load(VALUE data, VALUE parent, VALUE opt)
{
    return iseq_load(data, !(((VALUE)(parent) & (VALUE)~((VALUE)RUBY_Qnil)) == 0) ? (rb_iseq_t *)parent : ((void*)0), opt);
}

rb_iseq_t *
rb_iseq_compile_with_option(VALUE src, VALUE file, VALUE realpath, VALUE line, const struct rb_block *base_block, VALUE opt)
{
    rb_iseq_t *iseq = ((void*)0);
    const rb_iseq_t *const parent = base_block ? vm_block_iseq(base_block) : ((void*)0);
    rb_compile_option_t option;
    ...
    make_compile_option(&option, opt);
    ln = rb_num2int_inline(line);
    rb_string_value_cstr(&(file));
    if (( ((RUBY_T_FILE) == RUBY_T_FIXNUM) ? (((int)(long)(src))&RUBY_FIXNUM_FLAG) : ((RUBY_T_FILE) == RUBY_T_TRUE) ? ((src) == ((VALUE)RUBY_Qtrue)) : ((RUBY_T_FILE) == RUBY_T_FALSE) ? ((src) == ((VALUE)RUBY_Qfalse)) : ((RUBY_T_FILE) == RUBY_T_NIL) ? ((src) == ((VALUE)RUBY_Qnil)) : ((RUBY_T_FILE) == RUBY_T_UNDEF) ? ((src) == ((VALUE)RUBY_Qundef)) : ((RUBY_T_FILE) == RUBY_T_SYMBOL) ? ((((VALUE)(src)&~((~(VALUE)0)<<RUBY_SPECIAL_SHIFT)) == RUBY_SYMBOL_FLAG)||(!(((VALUE)(src) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(src) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(src))->flags & RUBY_T_MASK) == (RUBY_T_SYMBOL))) : ((RUBY_T_FILE) == RUBY_T_FLOAT) ? ( ((((int)(long)(src))&RUBY_FLONUM_MASK) == RUBY_FLONUM_FLAG) || (!(((VALUE)(src) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(src) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(src))->flags & RUBY_T_MASK) == RUBY_T_FLOAT)) : (!(((VALUE)(src) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(src) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(src))->flags & RUBY_T_MASK) == (RUBY_T_FILE)))) {
 ...
 ast = (*parse)(parser, file, src, ln);
    ...
    if (!ast->root) {
 rb_ast_dispose(ast);
 rb_exc_raise(rb_current_execution_context()->errinfo);
    }
    else {
             VALUE label = parent ?
     parent->body->location.label :
      ({ (__builtin_constant_p("<compiled>")) ? rb_fstring_new(("<compiled>"), (long)strlen("<compiled>")) : rb_fstring_cstr("<compiled>"); });
...
{
    return rb_iseq_compile_with_option(src, file, ((VALUE)RUBY_Qnil), line, 0, ((VALUE)RUBY_Qnil));
}

rb_iseq_t *
rb_iseq_compile_on_base(VALUE src, VALUE file, VALUE line, const struct rb_block *base_block)
{
    return rb_iseq_compile_with_option(src, file, ((VALUE)RUBY_Qnil), line, base_block, ((VALUE)RUBY_Qnil));
}
...
{
    return (rb_array_const_ptr((iseq)->body->mark_ary)[ISEQ_MARK_ARY_COVERAGE]);
}
...
static const rb_data_type_t iseqw_data_type = {
    "T_IMEMO/iseq",
    {iseqw_mark, ((void*)0), iseqw_memsize,},
    0, 0, 1|RUBY_FL_WB_PROTECTED
};
...
iseqw_new(const rb_iseq_t *iseq)
{
    ...
    deconst.in = iseq;
    obj = rb_data_typed_object_wrap((rb_cISeq),(deconst.out),(&iseqw_data_type));
    rb_obj_written((VALUE)(obj), (VALUE)(((VALUE)RUBY_Qundef)), (VALUE)(iseq), "iseq.c", 816);
...
{
    VALUE src, file = ((VALUE)RUBY_Qnil), path = ((VALUE)RUBY_Qnil), line = (((VALUE)(1))<<1 | RUBY_FIXNUM_FLAG), opt = ((VALUE)RUBY_Qnil);
    int i;

    rb_secure(1);

    i = rb_scan_args(argc, argv, "1*:", &src, ((void*)0), &opt);
    if (i > 4+!((VALUE)(opt) != ((VALUE)RUBY_Qnil))) rb_error_arity(argc, 1, 5);
    switch (i) {
      case 5: opt = argv[--i];
      case 4: line = argv[--i];
      case 3: path = argv[--i];
    ...
    if (!((VALUE)(file) != ((VALUE)RUBY_Qnil))) file =  ({ (__builtin_constant_p("<compiled>")) ? rb_fstring_new(("<compiled>"), (long)strlen("<compiled>")) : rb_fstring_cstr("<compiled>"); });
    if (!((VALUE)(line) != ((VALUE)RUBY_Qnil))) line = (((VALUE)(1))<<1 | RUBY_FIXNUM_FLAG);
...
{
    VALUE file, line = (((VALUE)(1))<<1 | RUBY_FIXNUM_FLAG), opt = ((VALUE)RUBY_Qnil);
    VALUE parser, f, exc = ((VALUE)RUBY_Qnil), ret;
    rb_ast_t *ast;
    rb_compile_option_t option;
    int i;

    rb_secure(1);
    i = rb_scan_args(argc, argv, "1*:", &file, ((void*)0), &opt);
    if (i > 1+!((VALUE)(opt) != ((VALUE)RUBY_Qnil))) rb_error_arity(argc, 1, 2);
    switch (i) {
      case 2: opt = argv[--i];
    }
    ((* ({ volatile VALUE *rb_gc_guarded_ptr = &(file); ; rb_gc_guarded_ptr; })) = rb_get_path(file));
    file = rb_fstring(file);

    f = rb_file_open_str(file, "r");

    parser = rb_parser_new();
    rb_parser_set_context(parser, ((void*)0), FALSE);
    ast = rb_parser_compile_file_path(parser, file, f, rb_num2int_inline(line));
    if (!ast->root) exc = rb_current_execution_context()->errinfo;
 ...
 rb_exc_raise(exc);
    ...
    ret = iseqw_new(rb_iseq_new_with_opt(ast->root,  ({ (__builtin_constant_p("<main>")) ? rb_fstring_new(("<main>"), (long)strlen("<main>")) : rb_fstring_cstr("<main>"); }),
      file,
      rb_realpath_internal(((VALUE)RUBY_Qnil), file, 1),
      line, ((void*)0), ISEQ_TYPE_TOP, &option));
    rb_ast_dispose(ast);
    return ret;
}
static VALUE
...
{
    rb_iseq_t *iseq = (((struct RData*)(iseqw))->data);
...
iseqw_inspect(VALUE self)
{
    ...
    if (!iseq->body->location.label) {
 return rb_sprintf("#<%li\v: uninitialized>", klass);
    }
    else {
 return rb_sprintf("<%li\v:%li\v@%li\v:%d>",
     klass,
     iseq->body->location.label, rb_iseq_path(iseq),
     ((int)rb_fix2int((VALUE)(rb_iseq_first_lineno(iseq)))));
    }
}
static VALUE
...
get_insn_info_binary_search(const rb_iseq_t *iseq, size_t pos)
{
    ...
    if (debug) {
 printf("size: %zu\n", size);
 printf("insns_info[%zu]: position: %d, line: %d, pos: %zu\n",
...
local_var_name(const rb_iseq_t *diseq, VALUE level, VALUE op)
{
 ...
 diseq = diseq->body->parent_iseq;
    ...
    lid = diseq->body->local_table[diseq->body->local_table_size +
       ( 3) - 1 - op];
    return id_to_name(lid, (((VALUE)('*'))<<1 | RUBY_FIXNUM_FLAG));
}
         ...
         int len, size_t pos, const VALUE *pnop, VALUE child)
{
    ...
    switch (type) {
      case 'O':
 ret = rb_sprintf("%ld", (VALUE)(pos + len + op));
 break;

      case 'N':
 {
     const char *type_str;
     if (insn == YARVINSN_branchiftype && (type_str = rb_type_str((enum ruby_value_type)op)) != ((void*)0)) {
  ret =  ({ (__builtin_constant_p(type_str)) ? rb_str_new_static((type_str), (long)strlen(type_str)) : rb_str_new_cstr(type_str); });
     }
     else if (insn == YARVINSN_defined && op_no == 0 &&
       ((enum defined_type)op == DEFINED_FUNC ? (ret =  ({ (__builtin_constant_p("func")) ? rb_fstring_new(("func"), (long)strlen("func")) : rb_fstring_cstr("func"); }), 1) :
        (enum defined_type)op == DEFINED_REF ? (ret =  ({ (__builtin_constant_p("ref")) ? rb_fstring_new(("ref"), (long)strlen("ref")) : rb_fstring_cstr("ref"); }), 1) :
 ...
 if (types[op_no+1] == 'N' && pnop) {
     ...
     ret = rb_inspect((((VALUE)(op))<<1 | RUBY_FIXNUM_FLAG));
 }
 break;
      }
      case 'I':
 ret = rb_inspect((rb_id2sym(op)));
 break;

      case 'V':
 op = obj_resurrect(op);
 if (insn == YARVINSN_defined && op_no == 1 && (((int)(long)(op))&RUBY_FIXNUM_FLAG)) {

     int type = rb_num2int_inline(op);
     if (type) {
  if (type & 1) {
 ...
 ret = rb_inspect(op);
 if (rb_class_of((VALUE)(op)) == rb_cISeq) {
     if (child) {
      ...
      case 'S':
 {
  ...
  ret =  ({ (__builtin_constant_p("nil")) ? rb_str_new_static(("nil"), (long)strlen("nil")) : rb_str_new_cstr("nil"); });
     }
     break;
 }
      case 'G':
 ...
 break;
      ...
      case 'K':
 ret = rb_sprintf("<is:%td>", (union iseq_inline_storage_entry *)op - iseq->body->is_entries);
 break;
      ...
      case 'C':
 {
     ...
     if (ci->mid) {
  rb_ary_push(ary, rb_sprintf("mid:%li\v", rb_id2str(ci->mid)));
     }
  ...
  rb_ary_push(ary, rb_sprintf("kw:[%li\v]", rb_ary_join(kw_ary,  ({ (__builtin_constant_p(",")) ? rb_str_new_static((","), (long)strlen(",")) : rb_str_new_cstr(","); }))));
     }

     if (ci->flag) {
  VALUE flags = rb_ary_new();

  if (ci->flag & (0x01 << VM_CALL_ARGS_SPLAT_bit)) rb_ary_push(flags,  ({ (__builtin_constant_p("ARGS_SPLAT")) ? rb_str_new_static(("ARGS_SPLAT"), (long)strlen("ARGS_SPLAT")) : rb_str_new_cstr("ARGS_SPLAT"); }));
  if (ci->flag & (0x01 << VM_CALL_ARGS_BLOCKARG_bit)) rb_ary_push(flags,  ({ (__builtin_constant_p("ARGS_BLOCKARG")) ? rb_str_new_static(("ARGS_BLOCKARG"), (long)strlen("ARGS_BLOCKARG")) : rb_str_new_cstr("ARGS_BLOCKARG"); }));
  if (ci->flag & (0x01 << VM_CALL_ARGS_BLOCKARG_BLOCKPARAM_bit)) rb_ary_push(flags,  ({ (__builtin_constant_p("ARGS_BLOCKARG_BLOCKPARAM")) ? rb_str_new_static(("ARGS_BLOCKARG_BLOCKPARAM"), (long)strlen("ARGS_BLOCKARG_BLOCKPARAM")) : rb_str_new_cstr("ARGS_BLOCKARG_BLOCKPARAM"); }));
  if (ci->flag & (0x01 << VM_CALL_FCALL_bit)) rb_ary_push(flags,  ({ (__builtin_constant_p("FCALL")) ? rb_str_new_static(("FCALL"), (long)strlen("FCALL")) : rb_str_new_cstr("FCALL"); }));
  if (ci->flag & (0x01 << VM_CALL_VCALL_bit)) rb_ary_push(flags,  ({ (__builtin_constant_p("VCALL")) ? rb_str_new_static(("VCALL"), (long)strlen("VCALL")) : rb_str_new_cstr("VCALL"); }));
  if (ci->flag & (0x01 << VM_CALL_ARGS_SIMPLE_bit)) rb_ary_push(flags,  ({ (__builtin_constant_p("ARGS_SIMPLE")) ? rb_str_new_static(("ARGS_SIMPLE"), (long)strlen("ARGS_SIMPLE")) : rb_str_new_cstr("ARGS_SIMPLE"); }));
  if (ci->flag & (0x01 << VM_CALL_BLOCKISEQ_bit)) rb_ary_push(flags,  ({ (__builtin_constant_p("BLOCKISEQ")) ? rb_str_new_static(("BLOCKISEQ"), (long)strlen("BLOCKISEQ")) : rb_str_new_cstr("BLOCKISEQ"); }));
  if (ci->flag & (0x01 << VM_CALL_TAILCALL_bit)) rb_ary_push(flags,  ({ (__builtin_constant_p("TAILCALL")) ? rb_str_new_static(("TAILCALL"), (long)strlen("TAILCALL")) : rb_str_new_cstr("TAILCALL"); }));
  if (ci->flag & (0x01 << VM_CALL_SUPER_bit)) rb_ary_push(flags,  ({ (__builtin_constant_p("SUPER")) ? rb_str_new_static(("SUPER"), (long)strlen("SUPER")) : rb_str_new_cstr("SUPER"); }));
  if (ci->flag & (0x01 << VM_CALL_KWARG_bit)) rb_ary_push(flags,  ({ (__builtin_constant_p("KWARG")) ? rb_str_new_static(("KWARG"), (long)strlen("KWARG")) : rb_str_new_cstr("KWARG"); }));
  if (ci->flag & (0x01 << VM_CALL_KW_SPLAT_bit)) rb_ary_push(flags,  ({ (__builtin_constant_p("KW_SPLAT")) ? rb_str_new_static(("KW_SPLAT"), (long)strlen("KW_SPLAT")) : rb_str_new_cstr("KW_SPLAT"); }));
  if (ci->flag & (0x01 << VM_CALL_OPT_SEND_bit)) rb_ary_push(flags,  ({ (__builtin_constant_p("OPT_SEND")) ? rb_str_new_static(("OPT_SEND"), (long)strlen("OPT_SEND")) : rb_str_new_cstr("OPT_SEND"); }));
  rb_ary_push(ary, rb_ary_join(flags,  ({ (__builtin_constant_p("|")) ? rb_str_new_static(("|"), (long)strlen("|")) : rb_str_new_cstr("|"); })));
     }
     ret = rb_sprintf("<callinfo!%li\v>", rb_ary_join(ary,  ({ (__builtin_constant_p(", ")) ? rb_str_new_static((", "), (long)strlen(", ")) : rb_str_new_cstr(", "); })));
 }
 break;

      case 'E':
 ret =  ({ (__builtin_constant_p("<callcache>")) ? rb_str_new_static(("<callcache>"), (long)strlen("<callcache>")) : rb_str_new_cstr("<callcache>"); });
 break;

      case 'H':
 ret =  ({ (__builtin_constant_p("<cdhash>")) ? rb_str_new_static(("<cdhash>"), (long)strlen("<cdhash>")) : rb_str_new_cstr("<cdhash>"); });
 break;
      ...
      case 'F':
 {
  ...
  ret =  ({ (__builtin_constant_p(info.dli_sname)) ? rb_str_new_static((info.dli_sname), (long)strlen(info.dli_sname)) : rb_str_new_cstr(info.dli_sname); });
  break;
     }

     ret =  ({ (__builtin_constant_p("<funcptr>")) ? rb_str_new_static(("<funcptr>"), (long)strlen("<funcptr>")) : rb_str_new_cstr("<funcptr>"); });
 }
 break;
      ...
      const rb_iseq_t *iseq, VALUE child)
{
    ...
    int j;
    const char *types = insn_op_types(insn);
    VALUE str =  ({ (__builtin_constant_p(0) && __builtin_constant_p(0)) ? rb_str_new_static((0), (0)) : rb_str_new((0), (0)); });
    const char *insn_name_buff;

    insn_name_buff = insn_name(insn);
    if (1) {
 rb_str_catf(str, "%04zu %-16s ", pos, insn_name_buff);
    }
    else {
 rb_str_catf(str, "%04zu %-16.*s ", pos,
 ...
 printf("%s\n", (!(((struct RBasic*)(str))->flags & RSTRING_NOEMBED) ? ((struct RString*)(str))->as.ary : ((struct RString*)(str))->as.heap.ptr));
    }
    return len;
}
...
iseq_inspect(const rb_iseq_t *iseq)
{
 ...
 return rb_sprintf("#<ISeq:%s@%s:%d (%d,%d)-(%d,%d)>",
     (!(((struct RBasic*)(iseq->body->location.label))->flags & RSTRING_NOEMBED) ? ((struct RString*)(iseq->body->location.label))->as.ary : ((struct RString*)(iseq->body->location.label))->as.heap.ptr), (!(((struct RBasic*)(rb_iseq_path(iseq)))->flags & RSTRING_NOEMBED) ? ((struct RString*)(rb_iseq_path(iseq)))->as.ary : ((struct RString*)(rb_iseq_path(iseq)))->as.heap.ptr),
...
rb_iseq_disasm(const rb_iseq_t *iseq)
{
    ...
    size = iseq->body->iseq_size;
     ...
     ({ (__builtin_constant_p("== disasm: ")) ? rb_str_cat((str), ("== disasm: "), (long)strlen("== disasm: ")) : rb_str_cat_cstr((str), ("== disasm: ")); });

    rb_str_concat(str, iseq_inspect(iseq));
    if ((l = (!(((struct RBasic*)(str))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(str))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(str))->as.heap.len)) < header_minlen) {
 rb_str_resize(str, header_minlen);
 memset((!(((struct RBasic*)(str))->flags & RSTRING_NOEMBED) ? ((struct RString*)(str))->as.ary : ((struct RString*)(str))->as.heap.ptr) + l, '=', header_minlen - l);
    }
     ({ (__builtin_constant_p("\n")) ? rb_str_cat((str), ("\n"), (long)strlen("\n")) : rb_str_cat_cstr((str), ("\n")); });


    if (iseq->body->catch_table) {
  ({ (__builtin_constant_p("== catch table\n")) ? rb_str_cat((str), ("== catch table\n"), (long)strlen("== catch table\n")) : rb_str_cat_cstr((str), ("== catch table\n")); });
    }
    if (iseq->body->catch_table) {
 for (i = 0; i < iseq->body->catch_table->size; i++) {
   ...
   (int)entry->end, (int)entry->sp, (int)entry->cont);
     if (entry->iseq && !(done_iseq && st_lookup((done_iseq),((st_data_t)entry->iseq),(st_data_t *)0))) {
 ...
 for (i = 0; i < iseq->body->local_table_size; i++) {
  ...
  if (li >= argc && li < argc + opts) {
      ruby_snprintf(opti, sizeof(opti), "Opt=%ld",
        iseq->body->param.opt_table[li - argc]);
  }
     }

     ruby_snprintf(argi, sizeof(argi), "%s%s%s%s%s",
     ...
     width = (!(((struct RBasic*)(str))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(str))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(str))->as.heap.len) + 11;
     if (name)
  rb_str_append(str, name);
     else
   ({ (__builtin_constant_p("?")) ? rb_str_cat((str), ("?"), (long)strlen("?")) : rb_str_cat_cstr((str), ("?")); });
     if (*argi) rb_str_catf(str, "<%s>", argi);
     if ((width -= (!(((struct RBasic*)(str))->flags & RSTRING_NOEMBED) ? (long)((((struct RBasic*)(str))->flags >> RSTRING_EMBED_LEN_SHIFT) & (RSTRING_EMBED_LEN_MASK >> RSTRING_EMBED_LEN_SHIFT)) : ((struct RString*)(str))->as.heap.len)) > 0) rb_str_catf(str, "%*s", (int)width, "");
 }
  ({ (__builtin_constant_p("\n")) ? rb_str_cat((str), ("\n"), (long)strlen("\n")) : rb_str_cat_cstr((str), ("\n")); });
    }
 ...
 n += rb_iseq_disasm_insn(str, code, n, iseq, child);
    ...
    for (l = 0; l < rb_array_len(child); l++) {
 VALUE isv = rb_ary_entry(child, l);
 if (done_iseq && st_lookup((done_iseq),((st_data_t)isv),(st_data_t *)0)) continue;
...
rb_iseq_all_children(const rb_iseq_t *iseq)
{
 ...
 for (i = 0; i < iseq->body->catch_table->size; i++) {
     ...
     if (child) {
  rb_hash_aset(all_children, child, ((VALUE)RUBY_Qtrue));
     }
 }
    }
...
iseqw_each_child(VALUE self)
{
    ...
    rb_hash_foreach(all_children, iseqw_each_child_i, ((VALUE)RUBY_Qnil));
    return self;
}
...
push_event_info(const rb_iseq_t *iseq, rb_event_flag_t events, int line, VALUE ary)
{
    ...
    if (events & 0x0002) rb_ary_push(ary,  ({ const VALUE args_to_new_ary[] = {rb_iseq_first_lineno(iseq), (rb_id2sym((__builtin_constant_p("class") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("class")), (long)strlen(("class"))); (ID) rb_intern_id_cache; }) : rb_intern("class"))))}; if (__builtin_constant_p(2)) { extern int (*__Static_assert_function (void)) [!!sizeof (struct { int __error_if_negative: (((int)(sizeof(args_to_new_ary) / sizeof((args_to_new_ary)[0]))) == (2)) ? 2 : -1; })]; } rb_ary_new_from_values(((int)(sizeof(args_to_new_ary) / sizeof((args_to_new_ary)[0]))), args_to_new_ary); }));;
    if (events & 0x0008) rb_ary_push(ary,  ({ const VALUE args_to_new_ary[] = {rb_iseq_first_lineno(iseq), (rb_id2sym((__builtin_constant_p("call") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("call")), (long)strlen(("call"))); (ID) rb_intern_id_cache; }) : rb_intern("call"))))}; if (__builtin_constant_p(2)) { extern int (*__Static_assert_function (void)) [!!sizeof (struct { int __error_if_negative: (((int)(sizeof(args_to_new_ary) / sizeof((args_to_new_ary)[0]))) == (2)) ? 2 : -1; })]; } rb_ary_new_from_values(((int)(sizeof(args_to_new_ary) / sizeof((args_to_new_ary)[0]))), args_to_new_ary); }));;
    if (events & 0x0100) rb_ary_push(ary,  ({ const VALUE args_to_new_ary[] = {rb_iseq_first_lineno(iseq), (rb_id2sym((__builtin_constant_p("b_call") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("b_call")), (long)strlen(("b_call"))); (ID) rb_intern_id_cache; }) : rb_intern("b_call"))))}; if (__builtin_constant_p(2)) { extern int (*__Static_assert_function (void)) [!!sizeof (struct { int __error_if_negative: (((int)(sizeof(args_to_new_ary) / sizeof((args_to_new_ary)[0]))) == (2)) ? 2 : -1; })]; } rb_ary_new_from_values(((int)(sizeof(args_to_new_ary) / sizeof((args_to_new_ary)[0]))), args_to_new_ary); }));;
    if (events & 0x0001) rb_ary_push(ary,  ({ const VALUE args_to_new_ary[] = {(((VALUE)(line))<<1 | RUBY_FIXNUM_FLAG), (rb_id2sym((__builtin_constant_p("line") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("line")), (long)strlen(("line"))); (ID) rb_intern_id_cache; }) : rb_intern("line"))))}; if (__builtin_constant_p(2)) { extern int (*__Static_assert_function (void)) [!!sizeof (struct { int __error_if_negative: (((int)(sizeof(args_to_new_ary) / sizeof((args_to_new_ary)[0]))) == (2)) ? 2 : -1; })]; } rb_ary_new_from_values(((int)(sizeof(args_to_new_ary) / sizeof((args_to_new_ary)[0]))), args_to_new_ary); }));;
    if (events & 0x0004) rb_ary_push(ary,  ({ const VALUE args_to_new_ary[] = {(((VALUE)(line))<<1 | RUBY_FIXNUM_FLAG), (rb_id2sym((__builtin_constant_p("end") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("end")), (long)strlen(("end"))); (ID) rb_intern_id_cache; }) : rb_intern("end"))))}; if (__builtin_constant_p(2)) { extern int (*__Static_assert_function (void)) [!!sizeof (struct { int __error_if_negative: (((int)(sizeof(args_to_new_ary) / sizeof((args_to_new_ary)[0]))) == (2)) ? 2 : -1; })]; } rb_ary_new_from_values(((int)(sizeof(args_to_new_ary) / sizeof((args_to_new_ary)[0]))), args_to_new_ary); }));;
    if (events & 0x0010) rb_ary_push(ary,  ({ const VALUE args_to_new_ary[] = {(((VALUE)(line))<<1 | RUBY_FIXNUM_FLAG), (rb_id2sym((__builtin_constant_p("return") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("return")), (long)strlen(("return"))); (ID) rb_intern_id_cache; }) : rb_intern("return"))))}; if (__builtin_constant_p(2)) { extern int (*__Static_assert_function (void)) [!!sizeof (struct { int __error_if_negative: (((int)(sizeof(args_to_new_ary) / sizeof((args_to_new_ary)[0]))) == (2)) ? 2 : -1; })]; } rb_ary_new_from_values(((int)(sizeof(args_to_new_ary) / sizeof((args_to_new_ary)[0]))), args_to_new_ary); }));;
    if (events & 0x0200) rb_ary_push(ary,  ({ const VALUE args_to_new_ary[] = {(((VALUE)(line))<<1 | RUBY_FIXNUM_FLAG), (rb_id2sym((__builtin_constant_p("b_return") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("b_return")), (long)strlen(("b_return"))); (ID) rb_intern_id_cache; }) : rb_intern("b_return"))))}; if (__builtin_constant_p(2)) { extern int (*__Static_assert_function (void)) [!!sizeof (struct { int __error_if_negative: (((int)(sizeof(args_to_new_ary) / sizeof((args_to_new_ary)[0]))) == (2)) ? 2 : -1; })]; } rb_ary_new_from_values(((int)(sizeof(args_to_new_ary) / sizeof((args_to_new_ary)[0]))), args_to_new_ary); }));;
...
iseqw_s_of(VALUE klass, VALUE body)
{
 ...
 iseq = rb_method_iseq(body);
    ...
    return iseq ? iseqw_new(iseq) : ((VALUE)RUBY_Qnil);
}
static VALUE
iseqw_s_disasm(VALUE klass, VALUE body)
{
    VALUE iseqw = iseqw_s_of(klass, body);
    return !((VALUE)(iseqw) != ((VALUE)RUBY_Qnil)) ? ((VALUE)RUBY_Qnil) : rb_iseq_disasm(iseqw_check(iseqw));
}
...
exception_type2symbol(VALUE type)
{
    ID id;
    switch (type) {
      case CATCH_TYPE_RESCUE: do { static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("rescue")), (long)strlen(("rescue"))); (id) = rb_intern_id_cache; } while (0); break;
      case CATCH_TYPE_ENSURE: do { static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("ensure")), (long)strlen(("ensure"))); (id) = rb_intern_id_cache; } while (0); break;
      case CATCH_TYPE_RETRY: do { static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("retry")), (long)strlen(("retry"))); (id) = rb_intern_id_cache; } while (0); break;
      case CATCH_TYPE_BREAK: do { static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("break")), (long)strlen(("break"))); (id) = rb_intern_id_cache; } while (0); break;
      case CATCH_TYPE_REDO: do { static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("redo")), (long)strlen(("redo"))); (id) = rb_intern_id_cache; } while (0); break;
      case CATCH_TYPE_NEXT: do { static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("next")), (long)strlen(("next"))); (id) = rb_intern_id_cache; } while (0); break;
      default:
...
iseq_data_to_ary(const rb_iseq_t *iseq)
{
    ...
    static VALUE sym_top;
    static VALUE sym_method;
    static VALUE sym_block;
    static VALUE sym_class;
    static VALUE sym_rescue;
    static VALUE sym_ensure;
    static VALUE sym_eval;
    static VALUE sym_main;
    static VALUE sym_defined_guard;

    if (sym_top == 0) {
 int i;
 for (i=0; i<VM_INSTRUCTION_SIZE; i++) {
     insn_syms[i] = (rb_id2sym((__builtin_constant_p(insn_name(i)) ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2(((insn_name(i))), (long)strlen((insn_name(i)))); (ID) rb_intern_id_cache; }) : rb_intern(insn_name(i)))));
 }
 sym_top = (rb_id2sym((__builtin_constant_p("top") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("top")), (long)strlen(("top"))); (ID) rb_intern_id_cache; }) : rb_intern("top"))));
 sym_method = (rb_id2sym((__builtin_constant_p("method") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("method")), (long)strlen(("method"))); (ID) rb_intern_id_cache; }) : rb_intern("method"))));
 sym_block = (rb_id2sym((__builtin_constant_p("block") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("block")), (long)strlen(("block"))); (ID) rb_intern_id_cache; }) : rb_intern("block"))));
 sym_class = (rb_id2sym((__builtin_constant_p("class") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("class")), (long)strlen(("class"))); (ID) rb_intern_id_cache; }) : rb_intern("class"))));
 sym_rescue = (rb_id2sym((__builtin_constant_p("rescue") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("rescue")), (long)strlen(("rescue"))); (ID) rb_intern_id_cache; }) : rb_intern("rescue"))));
 sym_ensure = (rb_id2sym((__builtin_constant_p("ensure") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("ensure")), (long)strlen(("ensure"))); (ID) rb_intern_id_cache; }) : rb_intern("ensure"))));
 sym_eval = (rb_id2sym((__builtin_constant_p("eval") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("eval")), (long)strlen(("eval"))); (ID) rb_intern_id_cache; }) : rb_intern("eval"))));
 sym_main = (rb_id2sym((__builtin_constant_p("main") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("main")), (long)strlen(("main"))); (ID) rb_intern_id_cache; }) : rb_intern("main"))));
 sym_defined_guard = (rb_id2sym((__builtin_constant_p("defined_guard") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("defined_guard")), (long)strlen(("defined_guard"))); (ID) rb_intern_id_cache; }) : rb_intern("defined_guard"))));
    }
 ...
 if (lid) {
     if (rb_id2str(lid)) {
  rb_ary_push(locals, (rb_id2sym(lid)));
     }
     else {
  rb_ary_push(locals, rb_ulong2num_inline(iseq->body->local_table_size-i+1));
     }
 }
 else {
     rb_ary_push(locals, (rb_id2sym((__builtin_constant_p("#arg_rest") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("#arg_rest")), (long)strlen(("#arg_rest"))); (ID) rb_intern_id_cache; }) : rb_intern("#arg_rest")))));
 }
    }
 ...
 if (iseq->body->param.flags.has_opt) {
          ...
          VALUE arg_opt_labels = rb_ary_new_capa(len);

          for (j = 0; j < len; j++) {
              VALUE l = register_label(labels_table, iseq->body->param.opt_table[j]);
              rb_ary_push(arg_opt_labels, l);
          }
          rb_hash_aset(params, (rb_id2sym((__builtin_constant_p("opt") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("opt")), (long)strlen(("opt"))); (ID) rb_intern_id_cache; }) : rb_intern("opt")))), arg_opt_labels);
        }


 if (iseq->body->param.flags.has_lead) rb_hash_aset(params, (rb_id2sym((__builtin_constant_p("lead_num") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("lead_num")), (long)strlen(("lead_num"))); (ID) rb_intern_id_cache; }) : rb_intern("lead_num")))), (((VALUE)(iseq->body->param.lead_num))<<1 | RUBY_FIXNUM_FLAG));
 if (iseq->body->param.flags.has_post) rb_hash_aset(params, (rb_id2sym((__builtin_constant_p("post_num") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("post_num")), (long)strlen(("post_num"))); (ID) rb_intern_id_cache; }) : rb_intern("post_num")))), (((VALUE)(iseq->body->param.post_num))<<1 | RUBY_FIXNUM_FLAG));
 if (iseq->body->param.flags.has_post) rb_hash_aset(params, (rb_id2sym((__builtin_constant_p("post_start") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("post_start")), (long)strlen(("post_start"))); (ID) rb_intern_id_cache; }) : rb_intern("post_start")))), (((VALUE)(iseq->body->param.post_start))<<1 | RUBY_FIXNUM_FLAG));
 if (iseq->body->param.flags.has_rest) rb_hash_aset(params, (rb_id2sym((__builtin_constant_p("rest_start") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("rest_start")), (long)strlen(("rest_start"))); (ID) rb_intern_id_cache; }) : rb_intern("rest_start")))), (((VALUE)(iseq->body->param.rest_start))<<1 | RUBY_FIXNUM_FLAG));
 if (iseq->body->param.flags.has_block) rb_hash_aset(params, (rb_id2sym((__builtin_constant_p("block_start") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("block_start")), (long)strlen(("block_start"))); (ID) rb_intern_id_cache; }) : rb_intern("block_start")))), (((VALUE)(iseq->body->param.block_start))<<1 | RUBY_FIXNUM_FLAG));
 if (iseq->body->param.flags.has_kw) {
     VALUE keywords = rb_ary_new();
     int i, j;
     for (i=0; i<iseq->body->param.keyword->required_num; i++) {
  rb_ary_push(keywords, (rb_id2sym(iseq->body->param.keyword->table[i])));
     }
     for (j=0; i<iseq->body->param.keyword->num; i++, j++) {
  VALUE key =  ({ const VALUE args_to_new_ary[] = {(rb_id2sym(iseq->body->param.keyword->table[i]))}; if (__builtin_constant_p(1)) { extern int (*__Static_assert_function (void)) [!!sizeof (struct { int __error_if_negative: (((int)(sizeof(args_to_new_ary) / sizeof((args_to_new_ary)[0]))) == (1)) ? 2 : -1; })]; } rb_ary_new_from_values(((int)(sizeof(args_to_new_ary) / sizeof((args_to_new_ary)[0]))), args_to_new_ary); });
  if (iseq->body->param.keyword->default_values[j] != ((VALUE)RUBY_Qundef)) {
      rb_ary_push(key, iseq->body->param.keyword->default_values[j]);
  }
  rb_ary_push(keywords, key);
     }

     rb_hash_aset(params, (rb_id2sym((__builtin_constant_p("kwbits") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("kwbits")), (long)strlen(("kwbits"))); (ID) rb_intern_id_cache; }) : rb_intern("kwbits")))),
                  (((VALUE)(iseq->body->param.keyword->bits_start))<<1 | RUBY_FIXNUM_FLAG));
     rb_hash_aset(params, (rb_id2sym((__builtin_constant_p("keyword") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("keyword")), (long)strlen(("keyword"))); (ID) rb_intern_id_cache; }) : rb_intern("keyword")))), keywords);
 }
 if (iseq->body->param.flags.has_kwrest) rb_hash_aset(params, (rb_id2sym((__builtin_constant_p("kwrest") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("kwrest")), (long)strlen(("kwrest"))); (ID) rb_intern_id_cache; }) : rb_intern("kwrest")))), (((VALUE)(iseq->body->param.keyword->rest_start))<<1 | RUBY_FIXNUM_FLAG));
 if (iseq->body->param.flags.ambiguous_param0) rb_hash_aset(params, (rb_id2sym((__builtin_constant_p("ambiguous_param0") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("ambiguous_param0")), (long)strlen(("ambiguous_param0"))); (ID) rb_intern_id_cache; }) : rb_intern("ambiguous_param0")))), ((VALUE)RUBY_Qtrue));
    }
 ...
 for (j=0; j<len-1; j++, seq++) {
  ...
  break;
       ...
       case 'L':
       case 'N':
  rb_ary_push(ary, (((VALUE)(*seq))<<1 | RUBY_FIXNUM_FLAG));
  break;
       case 'V':
       ...
       case 'G':
  {
      ...
      rb_ary_push(ary, (rb_id2sym(entry->id)));
  }
  break;
       case 'K':
  {
      union iseq_inline_storage_entry *is = (union iseq_inline_storage_entry *)*seq;
      rb_ary_push(ary, (((VALUE)(is - iseq->body->is_entries))<<1 | RUBY_FIXNUM_FLAG));
  }
  break;
       case 'C':
  {
      ...
      rb_hash_aset(e, (rb_id2sym((__builtin_constant_p("mid") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("mid")), (long)strlen(("mid"))); (ID) rb_intern_id_cache; }) : rb_intern("mid")))), ci->mid ? (rb_id2sym(ci->mid)) : ((VALUE)RUBY_Qnil));
      rb_hash_aset(e, (rb_id2sym((__builtin_constant_p("flag") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("flag")), (long)strlen(("flag"))); (ID) rb_intern_id_cache; }) : rb_intern("flag")))), (((VALUE)((unsigned int)(ci->flag)))<<1 | RUBY_FIXNUM_FLAG));

      if (ci->flag & (0x01 << VM_CALL_KWARG_bit)) {
   struct rb_call_info_with_kwarg *ci_kw = (struct rb_call_info_with_kwarg *)ci;
   int i;
   VALUE kw = rb_ary_new_capa((long)ci_kw->kw_arg->keyword_len);

   orig_argc -= ci_kw->kw_arg->keyword_len;
   for (i = 0; i < ci_kw->kw_arg->keyword_len; i++) {
       rb_ary_push(kw, ci_kw->kw_arg->keywords[i]);
   }
   rb_hash_aset(e, (rb_id2sym((__builtin_constant_p("kw_arg") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("kw_arg")), (long)strlen(("kw_arg"))); (ID) rb_intern_id_cache; }) : rb_intern("kw_arg")))), kw);
      }

      rb_hash_aset(e, (rb_id2sym((__builtin_constant_p("orig_argc") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("orig_argc")), (long)strlen(("orig_argc"))); (ID) rb_intern_id_cache; }) : rb_intern("orig_argc")))),
    (((VALUE)(orig_argc))<<1 | RUBY_FIXNUM_FLAG));
      rb_ary_push(ary, e);
         }
  break;
       case 'E':
  rb_ary_push(ary, ((VALUE)RUBY_Qfalse));
  break;
       case 'I':
  rb_ary_push(ary, (rb_id2sym(*seq)));
  break;
       case 'H':
  {
      VALUE hash = *seq;
      ...
      for (i=0; i<rb_array_len(val); i+=2) {
   VALUE pos = ((int)rb_fix2int((VALUE)(rb_ary_entry(val, i+1))));
       ...
       case 'F':
  {
      ...
      VALUE val = rb_long2num_inline((long)*seq);
 ...
 rb_ary_push(ary, (((VALUE)((unsigned int)(entry->sp)))<<1 | RUBY_FIXNUM_FLAG));
 rb_ary_push(exception, ary);
    ...
    for (l=0, pos=0; l<rb_array_len(nbody); l++) {
 VALUE ary = (rb_array_const_ptr(nbody)[l]);
 st_data_t label;
 ...
 if (ti < iseq->body->insns_info_size) {
  ...
  if (line > 0 && last_line != line) {
      rb_ary_push(body, (((VALUE)(line))<<1 | RUBY_FIXNUM_FLAG));
      last_line = line;
  }

  if (events & 0x0001) rb_ary_push(body, (rb_id2sym((__builtin_constant_p("RUBY_EVENT_LINE") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("RUBY_EVENT_LINE")), (long)strlen(("RUBY_EVENT_LINE"))); (ID) rb_intern_id_cache; }) : rb_intern("RUBY_EVENT_LINE")))));;
  if (events & 0x0002) rb_ary_push(body, (rb_id2sym((__builtin_constant_p("RUBY_EVENT_CLASS") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("RUBY_EVENT_CLASS")), (long)strlen(("RUBY_EVENT_CLASS"))); (ID) rb_intern_id_cache; }) : rb_intern("RUBY_EVENT_CLASS")))));;
  if (events & 0x0004) rb_ary_push(body, (rb_id2sym((__builtin_constant_p("RUBY_EVENT_END") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("RUBY_EVENT_END")), (long)strlen(("RUBY_EVENT_END"))); (ID) rb_intern_id_cache; }) : rb_intern("RUBY_EVENT_END")))));;
  if (events & 0x0008) rb_ary_push(body, (rb_id2sym((__builtin_constant_p("RUBY_EVENT_CALL") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("RUBY_EVENT_CALL")), (long)strlen(("RUBY_EVENT_CALL"))); (ID) rb_intern_id_cache; }) : rb_intern("RUBY_EVENT_CALL")))));;
  if (events & 0x0010) rb_ary_push(body, (rb_id2sym((__builtin_constant_p("RUBY_EVENT_RETURN") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("RUBY_EVENT_RETURN")), (long)strlen(("RUBY_EVENT_RETURN"))); (ID) rb_intern_id_cache; }) : rb_intern("RUBY_EVENT_RETURN")))));;
  if (events & 0x0100) rb_ary_push(body, (rb_id2sym((__builtin_constant_p("RUBY_EVENT_B_CALL") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("RUBY_EVENT_B_CALL")), (long)strlen(("RUBY_EVENT_B_CALL"))); (ID) rb_intern_id_cache; }) : rb_intern("RUBY_EVENT_B_CALL")))));;
  if (events & 0x0200) rb_ary_push(body, (rb_id2sym((__builtin_constant_p("RUBY_EVENT_B_RETURN") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("RUBY_EVENT_B_RETURN")), (long)strlen(("RUBY_EVENT_B_RETURN"))); (ID) rb_intern_id_cache; }) : rb_intern("RUBY_EVENT_B_RETURN")))));;
 ...
 rb_ary_push(body, ary);
 pos += rb_long2int_inline(rb_array_len(ary));
    }
    (* ({ volatile VALUE *rb_gc_guarded_ptr = &(nbody); ; rb_gc_guarded_ptr; }));

    st_free_table(labels_table);

    rb_hash_aset(misc, (rb_id2sym((__builtin_constant_p("arg_size") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("arg_size")), (long)strlen(("arg_size"))); (ID) rb_intern_id_cache; }) : rb_intern("arg_size")))), (((VALUE)(iseq->body->param.size))<<1 | RUBY_FIXNUM_FLAG));
    rb_hash_aset(misc, (rb_id2sym((__builtin_constant_p("local_size") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("local_size")), (long)strlen(("local_size"))); (ID) rb_intern_id_cache; }) : rb_intern("local_size")))), (((VALUE)(iseq->body->local_table_size))<<1 | RUBY_FIXNUM_FLAG));
    rb_hash_aset(misc, (rb_id2sym((__builtin_constant_p("stack_max") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("stack_max")), (long)strlen(("stack_max"))); (ID) rb_intern_id_cache; }) : rb_intern("stack_max")))), (((VALUE)(iseq->body->stack_max))<<1 | RUBY_FIXNUM_FLAG));
    rb_hash_aset(misc, (rb_id2sym((__builtin_constant_p("code_range") ?  ({ static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("code_range")), (long)strlen(("code_range"))); (ID) rb_intern_id_cache; }) : rb_intern("code_range")))),
      ({ const VALUE args_to_new_ary[] = {(((VALUE)(iseq->body->location.code_range.first_loc.lineno))<<1 | RUBY_FIXNUM_FLAG), (((VALUE)(iseq->body->location.code_range.first_loc.column))<<1 | RUBY_FIXNUM_FLAG), (((VALUE)(iseq->body->location.code_range.last_loc.lineno))<<1 | RUBY_FIXNUM_FLAG), (((VALUE)(iseq->body->location.code_range.last_loc.column))<<1 | RUBY_FIXNUM_FLAG)}; if (__builtin_constant_p(4)) { extern int (*__Static_assert_function (void)) [!!sizeof (struct { int __error_if_negative: (((int)(sizeof(args_to_new_ary) / sizeof((args_to_new_ary)[0]))) == (4)) ? 2 : -1; })]; } rb_ary_new_from_values(((int)(sizeof(args_to_new_ary) / sizeof((args_to_new_ary)[0]))), args_to_new_ary); }));
    rb_ary_push(val,  ({ (__builtin_constant_p("YARVInstructionSequence/SimpleDataFormat")) ? rb_str_new_static(("YARVInstructionSequence/SimpleDataFormat"), (long)strlen("YARVInstructionSequence/SimpleDataFormat")) : rb_str_new_cstr("YARVInstructionSequence/SimpleDataFormat"); }));
    rb_ary_push(val, (((VALUE)(2))<<1 | RUBY_FIXNUM_FLAG));
    rb_ary_push(val, (((VALUE)(5))<<1 | RUBY_FIXNUM_FLAG));
    rb_ary_push(val, (((VALUE)(1))<<1 | RUBY_FIXNUM_FLAG));
...
{
    int i, r;
    VALUE a, args = rb_ary_new_capa(iseq->body->param.size);
    ID req, opt, rest, block, key, keyrest;
    do { static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("req")), (long)strlen(("req"))); (req) = rb_intern_id_cache; } while (0);
    do { static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("opt")), (long)strlen(("opt"))); (opt) = rb_intern_id_cache; } while (0);
    if (is_proc) {
 for (i = 0; i < iseq->body->param.lead_num; i++) {
     rb_ary_push(a = rb_ary_new_capa(2), (rb_id2sym(opt)));
     rb_ary_push(a, rb_id2str(iseq->body->local_table[(i)]) ? (rb_id2sym(iseq->body->local_table[(i)])) : ((VALUE)RUBY_Qnil));
     rb_ary_push(args, a);
 }
    }
    else {
 for (i = 0; i < iseq->body->param.lead_num; i++) {
     rb_ary_push(args, ( rb_ary_push(a = rb_ary_new_capa(2), (rb_id2sym(req))), rb_id2str(iseq->body->local_table[(i)]) ? rb_ary_push(a, (rb_id2sym(iseq->body->local_table[(i)]))) : a));
 }
    }
    r = iseq->body->param.lead_num + iseq->body->param.opt_num;
    for (; i < r; i++) {
 rb_ary_push(a = rb_ary_new_capa(2), (rb_id2sym(opt)));
 if (rb_id2str(iseq->body->local_table[(i)])) {
     rb_ary_push(a, (rb_id2sym(iseq->body->local_table[(i)])));
 }
 rb_ary_push(args, a);
    }
    if (iseq->body->param.flags.has_rest) {
 do { static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("rest")), (long)strlen(("rest"))); (rest) = rb_intern_id_cache; } while (0);
 rb_ary_push(args, ( rb_ary_push(a = rb_ary_new_capa(2), (rb_id2sym(rest))), rb_id2str(iseq->body->local_table[(iseq->body->param.rest_start)]) ? rb_ary_push(a, (rb_id2sym(iseq->body->local_table[(iseq->body->param.rest_start)]))) : a));
    }
 ...
 if (iseq->body->param.keyword->required_num > 0) {
     ID keyreq;
     do { static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("keyreq")), (long)strlen(("keyreq"))); (keyreq) = rb_intern_id_cache; } while (0);
     for (; i < iseq->body->param.keyword->required_num; i++) {
  rb_ary_push(a = rb_ary_new_capa(2), (rb_id2sym(keyreq)));
  if (rb_id2str(iseq->body->param.keyword->table[i])) {
      rb_ary_push(a, (rb_id2sym(iseq->body->param.keyword->table[i])));
  }
  rb_ary_push(args, a);
     }
 }
 do { static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("key")), (long)strlen(("key"))); (key) = rb_intern_id_cache; } while (0);
 for (; i < iseq->body->param.keyword->num; i++) {
     rb_ary_push(a = rb_ary_new_capa(2), (rb_id2sym(key)));
     if (rb_id2str(iseq->body->param.keyword->table[i])) {
  rb_ary_push(a, (rb_id2sym(iseq->body->param.keyword->table[i])));
     }
     rb_ary_push(args, a);
 ...
 do { static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("keyrest")), (long)strlen(("keyrest"))); (keyrest) = rb_intern_id_cache; } while (0);
 rb_ary_push(args, ( rb_ary_push(a = rb_ary_new_capa(2), (rb_id2sym(keyrest))), rb_id2str(iseq->body->local_table[(iseq->body->param.keyword->rest_start)]) ? rb_ary_push(a, (rb_id2sym(iseq->body->local_table[(iseq->body->param.keyword->rest_start)]))) : a));
    }
    if (iseq->body->param.flags.has_block) {
 do { static ID rb_intern_id_cache; if (!rb_intern_id_cache) rb_intern_id_cache = rb_intern2((("block")), (long)strlen(("block"))); (block) = rb_intern_id_cache; } while (0);
 rb_ary_push(args, ( rb_ary_push(a = rb_ary_new_capa(2), (rb_id2sym(block))), rb_id2str(iseq->body->local_table[(iseq->body->param.block_start)]) ? rb_ary_push(a, (rb_id2sym(iseq->body->local_table[(iseq->body->param.block_start)]))) : a));
    }
    return args;
}
...
rb_iseq_defined_string(enum defined_type type)
{
 ...
 "expression",
    ...
    if ((unsigned)(type - 1) >= (unsigned)((int)(sizeof(expr_names) / sizeof((expr_names)[0])))) return 0;
    estr = expr_names[type - 1];
    if (!estr[0]) return 0;
    defs = rb_current_vm()->defined_strings;
    if (!defs) {
 defs = ruby_xcalloc(((int)(sizeof(expr_names) / sizeof((expr_names)[0]))), sizeof(VALUE));
 rb_current_vm()->defined_strings = defs;
    }
    str = defs[type-1];
    if (!str) {
 str =  ({ (__builtin_constant_p(estr)) ? rb_str_new_static((estr), (long)strlen(estr)) : rb_str_new_cstr(estr); });
...
rb_iseq_trace_set(const rb_iseq_t *iseq, rb_event_flag_t turnon_events)
{
 ...
 for (i=0; i<iseq->body->iseq_size;) {
  ...
  if (!((VALUE)table[insn] != iseq_encoded[i])) {
      iseq_encoded[i] = ((VALUE)table[insn + VM_INSTRUCTION_SIZE/2]);
  }
     }
     else if (((VALUE)table[insn] != iseq_encoded[i])) {
  iseq_encoded[i] = ((VALUE)table[insn]);
     }
     i += insn_len(insn);
 }
...
Init_ISeq(void)
{
    ...
    rb_undef_method(rb_class_of((VALUE)(rb_cISeq)), "translate");
    rb_undef_method(rb_class_of((VALUE)(rb_cISeq)), "load_iseq");
}
