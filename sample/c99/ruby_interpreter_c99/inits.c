...
rb_call_inits(void)
{
    {void Init_Method(void); Init_Method();};
    {void Init_RandomSeedCore(void); Init_RandomSeedCore();};
    {void Init_sym(void); Init_sym();};
    {void Init_var_tables(void); Init_var_tables();};
    {void Init_Object(void); Init_Object();};
    {void Init_top_self(void); Init_top_self();};
    {void Init_Encoding(void); Init_Encoding();};
    {void Init_Comparable(void); Init_Comparable();};
    {void Init_Enumerable(void); Init_Enumerable();};
    {void Init_String(void); Init_String();};
    {void Init_Exception(void); Init_Exception();};
    {void Init_eval(void); Init_eval();};
    {void Init_safe(void); Init_safe();};
    {void Init_jump(void); Init_jump();};
    {void Init_Numeric(void); Init_Numeric();};
    {void Init_Bignum(void); Init_Bignum();};
    {void Init_syserr(void); Init_syserr();};
    {void Init_Array(void); Init_Array();};
    {void Init_Hash(void); Init_Hash();};
    {void Init_Struct(void); Init_Struct();};
    {void Init_Regexp(void); Init_Regexp();};
    {void Init_pack(void); Init_pack();};
    {void Init_transcode(void); Init_transcode();};
    {void Init_marshal(void); Init_marshal();};
    {void Init_Range(void); Init_Range();};
    {void Init_IO(void); Init_IO();};
    {void Init_Dir(void); Init_Dir();};
    {void Init_Time(void); Init_Time();};
    {void Init_Random(void); Init_Random();};
    {void Init_signal(void); Init_signal();};
    {void Init_load(void); Init_load();};
    {void Init_Proc(void); Init_Proc();};
    {void Init_Binding(void); Init_Binding();};
    {void Init_Math(void); Init_Math();};
    {void Init_GC(void); Init_GC();};
    {void Init_Enumerator(void); Init_Enumerator();};
    {void Init_VM(void); Init_VM();};
    {void Init_ISeq(void); Init_ISeq();};
    {void Init_Thread(void); Init_Thread();};
    {void Init_process(void); Init_process();};
    {void Init_Cont(void); Init_Cont();};
    {void Init_Rational(void); Init_Rational();};
    {void Init_Complex(void); Init_Complex();};
    {void Init_version(void); Init_version();};
    {void Init_vm_trace(void); Init_vm_trace();};
}
